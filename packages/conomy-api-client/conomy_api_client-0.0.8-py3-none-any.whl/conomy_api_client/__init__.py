...
class DataClient(object):
    ...
    ENDPOINTS = {
        ...
        'publications': {'/': 'publication/',
                         ...
                         'c_news':   'publication/conomy_api_client-news/',  # 'c' in key means 'Conomy'
                         'c_fact':   'publication/conomy_api_client-facts/',  # ...
                         },
    ...
    def get_publications(self, type_=None, mock=False, page=1):
        ...
        return self.send_resp(method='GET', endpoint_url=endpoint_url).json()
...
# dc = DataClient("acef8368bfd30888235a4d989a4c48b1c05b9bba", "https://data.stage.conomy.ru/api/")
dc = DataClient("979617efb82e966b8e30942e347a8d9ec2ddb889", "http://127.0.0.1:9000/api/")
print(dc.divds_by_tic("VTBR"))