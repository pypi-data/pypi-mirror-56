...
class BatchMeasureDialog(object):
    ...
    def setupUi(self, Dialog, parameters: dict = None):
        ...
        self.leAnalysisFileSuffix.setGeometry(QtCore.QRect(210, 172, 271, 21))
        ...
        self.leScriptFileSuffix.setGeometry(QtCore.QRect(200, 272, 271, 21))
        self.leScriptFileSuffix.setObjectName("leScriptFileSuffix")
        self.label_7 = QtWidgets.QLabel(self.groupBox_2)
        self.label_7.setGeometry(QtCore.QRect(50, 242, 171, 31))
        self.label_7.setObjectName("label_7")
        self.cbSaveResults = QtWidgets.QCheckBox(self.groupBox_2)
        self.cbSaveResults.setGeometry(QtCore.QRect(30, 227, 181, 20))
        self.cbSaveResults.setObjectName("cbSaveResults")
        self.label_8 = QtWidgets.QLabel(self.groupBox_2)
        self.label_8.setGeometry(QtCore.QRect(50, 267, 171, 31))
        self.label_8.setObjectName("label_8")
        self.leFolderResults = QtWidgets.QLineEdit(self.groupBox_2)
        self.leFolderResults.setGeometry(QtCore.QRect(200, 247, 271, 21))
        self.leFolderResults.setObjectName("leFolderResults")
        self.pbFolderResults = QtWidgets.QPushButton(Dialog)
        self.pbFolderResults.setGeometry(QtCore.QRect(492, 353, 51, 32))
        ...
        self.cbNormalization.setGeometry(QtCore.QRect(205, 147, 281, 26))
        ...
        self.leXYResolution.setGeometry(QtCore.QRect(190, 67, 51, 21))
        ...
        self.cbIndexZero.setGeometry(QtCore.QRect(400, 39, 104, 26))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.cbSaveResults.setText(_translate("Dialog", "save results"))
