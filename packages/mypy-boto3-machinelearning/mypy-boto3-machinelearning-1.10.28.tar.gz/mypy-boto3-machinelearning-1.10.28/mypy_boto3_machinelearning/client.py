"Main interface for machinelearning Client"
...
class Client(BaseClient):
    ...
    def add_tags(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/AddTags>`_
    ...
    def create_batch_prediction(
        ...
        ``BatchPrediction`` , and uses an ``MLModel`` and the data files referenced by the
        ...
        the ``BatchPrediction`` status to ``PENDING`` . After the ``BatchPrediction`` completes,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateBatchPrediction>`_
        ...
        **Request Syntax**
        ...
        :param OutputUri: **[REQUIRED]**
          ...
          about how to set permissions, see the `Amazon Machine Learning Developer Guide
          <http://docs.aws.amazon.com/machine-learning/latest/dg>`__ .
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The ``CreateBatchPrediction`` operation is asynchronous. You can poll for status updates
            by using the ``>GetBatchPrediction`` operation and checking the ``Status`` parameter of
            the result.
    ...
    def create_data_source_from_rds(
        ...
        <http://aws.amazon.com/rds/>`__ (Amazon RDS). A ``DataSource`` references data that can be
        used to perform ``CreateMLModel`` , ``CreateEvaluation`` , or ``CreateBatchPrediction``
        operations.

        ``CreateDataSourceFromRDS`` is an asynchronous operation. In response to
        ``CreateDataSourceFromRDS`` , Amazon Machine Learning (Amazon ML) immediately returns and
        sets the ``DataSource`` status to ``PENDING`` . After the ``DataSource`` is created and
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateDataSourceFromRDS>`_
        ...
        **Request Syntax**
        ...
        :param RDSData: **[REQUIRED]**
          ...
          * DatabaseCredentials - AWS Identity and Access Management (IAM) credentials that are used
          to connect to the Amazon RDS database.

          * ResourceRole - A role (DataPipelineDefaultResourceRole) assumed by an EC2 instance to
          carry out the copy task from Amazon RDS to Amazon Simple Storage Service (Amazon S3). For
          ...
          * ServiceRole - A role (DataPipelineDefaultRole) assumed by the AWS Data Pipeline service
          to monitor the progress of the copy task from Amazon RDS to Amazon S3. For more
          information, see `Role templates
          <http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html>`__ for
          data pipelines.

          * SecurityInfo - The security information to use to access an RDS DB instance. You need to
          set up appropriate ingress rules for the security entity IDs provided to allow access to
          the Amazon RDS instance. Specify a [``SubnetId`` , ``SecurityGroupIds`` ] pair for a
          VPC-based RDS DB instance.

          * SelectSqlQuery - A query that is used to retrieve the observation data for the
          ``Datasource`` .

          * S3StagingLocation - The Amazon S3 location for staging Amazon RDS data. The data
          ...
          * DataRearrangement - A JSON string that represents the splitting and rearrangement
          ...
          - **DataRearrangement** *(string) --*
            ...
            to a ``DataSource`` . If the ``DataRearrangement`` parameter is not provided, all of the
            input data is used to create the ``Datasource`` .

            There are multiple parameters that control what data is used to create a datasource:

            * **``percentBegin``**  Use ``percentBegin`` to indicate the beginning of the range of
            the data used to create the Datasource. If you do not include ``percentBegin`` and
            ...
            * **``complement``**  The ``complement`` parameter instructs Amazon ML to use the data
            that is not included in the range of ``percentBegin`` to ``percentEnd`` to create a
            datasource. The ``complement`` parameter is useful if you need to create complementary
            datasources for training and evaluation. To create a complementary datasource, use the
            same values for ``percentBegin`` and ``percentEnd`` , along with the ``complement``
            parameter. For example, the following two datasources do not share any data, and can be
            used to train and evaluate a model. The first datasource has 25 percent of the data, and
            ...
            * **``strategy``**  To change how Amazon ML splits the data for a datasource, use the
            ``strategy`` parameter. The default value for the ``strategy`` parameter is
            ``sequential`` , meaning that Amazon ML takes all of the data records between the
            ``percentBegin`` and ``percentEnd`` parameters for the datasource, in the order that the
            records appear in the input data. The following two ``DataRearrangement`` lines are
            examples of sequentially ordered training and evaluation datasources: Datasource for
            evaluation: ``{"splitting":{"percentBegin":70, "percentEnd":100,
            "strategy":"sequential"}}``  Datasource for training: ``{"splitting":{"percentBegin":70,
            "percentEnd":100, "strategy":"sequential", "complement":"true"}}``  To randomly split
            ...
            used as the seed value for the random data splitting (for example, you can use the S3
            path to your data as the random seed string). If you choose the random split strategy,
            Amazon ML assigns each row of data a pseudo-random number between 0 and 100, and then
            selects the rows that have an assigned number between ``percentBegin`` and
            ``percentEnd`` . Pseudo-random numbers are assigned using both the input seed string
            value and the byte offset as a seed, so changing the data results in a different split.
            Any existing ordering is preserved. The random splitting strategy ensures that variables
            in the training and evaluation data are distributed similarly. It is useful in the cases
            where the input data may have an implicit sort order, which would otherwise result in
            training and evaluation datasources containing non-similar data records. The following
            two ``DataRearrangement`` lines are examples of non-sequentially ordered training and
            evaluation datasources: Datasource for evaluation: ``{"splitting":{"percentBegin":70,
          ...
          - **ResourceRole** *(string) --* **[REQUIRED]**
            ...
            task. For more information, see `Role templates
            <http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-iam-roles.html>`__ for
            data pipelines.
          ...
          - **SubnetId** *(string) --* **[REQUIRED]**
            ...
            The subnet ID to be used to access a VPC-based RDS DB instance. This attribute is used
            by Data Pipeline to carry out the copy task from Amazon RDS to Amazon S3.
        ...
        :param RoleARN: **[REQUIRED]**
          ...
          pipeline in the user's account and copy data using the ``SelectSqlQuery`` query from
        ...
        :param ComputeStatistics:
          ...
          during ``MLModel`` training. This parameter must be set to ``true`` if the DataSourceneeds
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The ``CreateDataSourceFromRDS`` > operation is asynchronous. You can poll for updates by
            using the ``GetBatchPrediction`` operation and checking the ``Status`` parameter. You
            can inspect the ``Message`` when ``Status`` shows up as ``FAILED`` . You can also check
            the progress of the copy operation by going to the ``DataPipeline`` console and looking
    ...
    def create_data_source_from_redshift(
        ...
        ``CreateDataSourceFromRedshift`` , Amazon Machine Learning (Amazon ML) immediately returns
        ...
        If Amazon ML can't accept the input source, it sets the ``Status`` parameter to ``FAILED``
        and includes an error message in the ``Message`` attribute of the ``GetDataSource``
        operation response.

        The observations should be contained in the database hosted on an Amazon Redshift cluster
        and should be specified by a ``SelectSqlQuery`` query. Amazon ML executes an ``Unload``
        command in Amazon Redshift to transfer the result set of the ``SelectSqlQuery`` query to
        ``S3StagingLocation`` .
        ...
        ``DataSource`` also requires a recipe. A recipe describes how each input variable will be
        used in training an ``MLModel`` . Will the variable be included or excluded from training?
        Will the variable be manipulated; for example, will it be combined with another variable or
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateDataSourceFromRedshift>`_
        ...
        **Request Syntax**
        ...
        :param DataSpec: **[REQUIRED]**
          ...
          * DatabaseCredentials - The AWS Identity and Access Management (IAM) credentials that are
          ...
          * S3StagingLocation - The Amazon Simple Storage Service (Amazon S3) location for staging
          Amazon Redshift data. The data retrieved from Amazon Redshift using the ``SelectSqlQuery``
          ...
          * DataRearrangement - A JSON string that represents the splitting and rearrangement
          ...
          - **DatabaseCredentials** *(dict) --* **[REQUIRED]**
            ...
            - **Username** *(string) --* **[REQUIRED]**
              ...
              A username to be used by Amazon Machine Learning (Amazon ML)to connect to a database
              on an Amazon Redshift cluster. The username should have sufficient permissions to
              execute the ``RedshiftSelectSqlQuery`` query. The username should be valid for an
              Amazon Redshift `USER
              <http://docs.aws.amazon.com/redshift/latest/dg/r_CREATE_USER.html>`__ .

            - **Password** *(string) --* **[REQUIRED]**

              A password to be used by Amazon ML to connect to a database on an Amazon Redshift
              cluster. The password should have sufficient permissions to execute a
              ``RedshiftSelectSqlQuery`` query. The password should be valid for an Amazon Redshift
              `USER <http://docs.aws.amazon.com/redshift/latest/dg/r_CREATE_USER.html>`__ .
        ...
        :param RoleARN: **[REQUIRED]**
          ...
          A fully specified role Amazon Resource Name (ARN). Amazon ML assumes the role on behalf of
        ...
        :param ComputeStatistics:
          ...
          The compute statistics for a ``DataSource`` . The statistics are generated from the
          observation data referenced by a ``DataSource`` . Amazon ML uses the statistics internally
          during ``MLModel`` training. This parameter must be set to ``true`` if the ``DataSource``
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The ``CreateDataSourceFromRedshift`` operation is asynchronous. You can poll for updates
    ...
    def create_data_source_from_s3(
        ...
        ``CreateDataSourceFromS3`` , Amazon Machine Learning (Amazon ML) immediately returns and
        sets the ``DataSource`` status to ``PENDING`` . After the ``DataSource`` has been created
        ...
        The observation data used in a ``DataSource`` should be ready to use; that is, it should
        have a consistent structure, and missing data values should be kept to a minimum. The
        ...
        predictions. If you plan to use the ``DataSource`` to train an ``MLModel`` , the
        ``DataSource`` also needs a recipe. A recipe describes how each input variable will be used
        in training an ``MLModel`` . Will the variable be included or excluded from training? Will
        the variable be manipulated; for example, will it be combined with another variable or will
        it be split apart into word combinations? The recipe provides answers to these questions.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateDataSourceFromS3>`_
        ...
        :param DataSpec: **[REQUIRED]**
          ...
          * DataRearrangement - A JSON string that represents the splitting and rearrangement
          ...
          - **DataLocationS3** *(string) --* **[REQUIRED]**
            ...
            file or an Amazon Simple Storage Service (Amazon S3) directory or bucket containing data
            files.
    ...
    def create_evaluation(
        ...
        provides a summary so that you know how effective the ``MLModel`` functions on the test
        data. Evaluation generates a relevant performance metric, such as BinaryAUC, RegressionRMSE
        ...
        Amazon Machine Learning (Amazon ML) immediately returns and sets the evaluation status to
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateEvaluation>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            ``CreateEvaluation`` operation is asynchronous. You can poll for status updates by using
            the ``GetEvcaluation`` operation and checking the ``Status`` parameter.
    ...
    def create_ml_model(
        ...
        creation operation.
         ...
         ``CreateMLModel`` requires a ``DataSource`` with computed statistics, which can be created
         by setting ``ComputeStatistics`` to ``true`` in ``CreateDataSourceFromRDS`` ,
         ``CreateDataSourceFromS3`` , or ``CreateDataSourceFromRedshift`` operations.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateMLModel>`_
        ...
        **Request Syntax**
        ...
        :param Parameters:
          ...
          * ``sgd.shuffleType`` - Whether Amazon ML shuffles the training data. Shuffling the data
          ...
          valid values are ``auto`` and ``none`` . The default value is ``none`` . We strongly
          ...
          * ``sgd.l2RegularizationAmount`` - The coefficient regularization L2 norm. It controls
          overfitting the data by penalizing large coefficients. This tends to drive coefficients to
          small, nonzero values. If you use this parameter, start by specifying a small value, such
          as ``1.0E-08`` . The value is a double that ranges from ``0`` to ``MAX_DOUBLE`` . The
          default is to not use L2 normalization. This parameter can't be used when ``L1`` is
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents the output of a ``CreateMLModel`` operation, and is an acknowledgement that
    ...
    def create_realtime_endpoint(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/CreateRealtimeEndpoint>`_
    ...
    def delete_batch_prediction(
        ...
        **Caution:** The result of the ``DeleteBatchPrediction`` operation is irreversible.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DeleteBatchPrediction>`_
    ...
    def delete_data_source(self, DataSourceId: str) -> ClientDeleteDataSourceResponseTypeDef:
        ...
        **Caution:** The results of the ``DeleteDataSource`` operation are irreversible.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DeleteDataSource>`_
    ...
    def delete_evaluation(self, EvaluationId: str) -> ClientDeleteEvaluationResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DeleteEvaluation>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Amazon Machine Learning (Amazon ML) received the request.
    ...
    def delete_ml_model(self, MLModelId: str) -> ClientDeleteMlModelResponseTypeDef:
        ...
        **Caution:** The result of the ``DeleteMLModel`` operation is irreversible.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DeleteMLModel>`_
    ...
    def delete_realtime_endpoint(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DeleteRealtimeEndpoint>`_
    ...
    def delete_tags(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DeleteTags>`_
            ...
            - **Results** *(list) --*
              ...
              - *(dict) --*
                ...
                - **OutputUri** *(string) --*
                  ...
                  The following substrings are not allowed in the ``s3 key`` portion of the
                  ``outputURI`` field: ':', '//', '/./', '/../'.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            essentially a list of ``DataSource`` .
              ...
              - *(dict) --*
                ...
                - **RedshiftMetadata** *(dict) --*
                  ...
                  - **DatabaseUserName** *(string) --*
                    ...
                    be valid for an Amazon Redshift `USER
                    <http://docs.aws.amazon.com/redshift/latest/dg/r_CREATE_USER.html>`__ .
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents the output of a ``DescribeMLModels`` operation. The content is essentially a
            list of ``MLModel`` .
              ...
              - *(dict) --*
                ...
                - **TrainingParameters** *(dict) --*
                  ...
                  * ``sgd.shuffleType`` - Whether Amazon ML shuffles the training data. Shuffling
                  ...
                  data types. The valid values are ``auto`` and ``none`` . The default value is
                  ``none`` .
                  ...
                  * ``sgd.l1RegularizationAmount`` - The coefficient regularization L1 norm, which
                  ...
                  L1 normalization. This parameter can't be used when ``L2`` is specified. Use this
                  parameter sparingly.
    ...
    def describe_tags(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/DescribeTags>`_
            ...
            - **Tags** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Value** *(string) --*
                  ...
                  An optional string, typically used to describe or define the tag. Valid characters
                  include Unicode letters, digits, white space, _, ., /, =
                      , +, -, %, and @.
    ...
    def get_batch_prediction(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/GetBatchPrediction>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ComputeTime** *(integer) --*
              ...
              the ``BatchPrediction`` , normalized and scaled on computation resources.
    ...
    def get_data_source(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/GetDataSource>`_
          ...
          - *(dict) --*
            ...
            - **RedshiftMetadata** *(dict) --*
              ...
              - **SelectSqlQuery** *(string) --*
                ...
                The SQL query that is specified during  CreateDataSourceFromRedshift . Returns only
            ...
            - **ComputeTime** *(integer) --*
              ...
              The approximate CPU time in milliseconds that Amazon Machine Learning spent processing
              the ``DataSource`` , normalized and scaled on computation resources. ``ComputeTime``
              is only available if the ``DataSource`` is in the ``COMPLETED`` state and the
    ...
    def get_evaluation(self, EvaluationId: str) -> ClientGetEvaluationResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/GetEvaluation>`_
          ...
          - *(dict) --*
            ...
            - **PerformanceMetrics** *(dict) --*
              ...
              * MulticlassAvgFScore: A multiclass ``MLModel`` uses the F1 score technique to measure
              ...
              For more information about performance metrics, please see the `Amazon Machine
              Learning Developer Guide <http://docs.aws.amazon.com/machine-learning/latest/dg>`__ .
            ...
            - **ComputeTime** *(integer) --*
              ...
              is only available if the ``Evaluation`` is in the ``COMPLETED`` state.

            - **FinishedAt** *(datetime) --*

              The epoch time when Amazon Machine Learning marked the ``Evaluation`` as ``COMPLETED``
              or ``FAILED`` . ``FinishedAt`` is only available when the ``Evaluation`` is in the
              ``COMPLETED`` or ``FAILED`` state.
    ...
    def get_ml_model(self, MLModelId: str, Verbose: bool = None) -> ClientGetMlModelResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/GetMLModel>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TrainingParameters** *(dict) --*
              ...
              * ``sgd.maxMLModelSizeInBytes`` - The maximum allowed size of the model. Depending on
              the input data, the size of the model might affect its performance. The value is an
              integer that ranges from ``100000`` to ``2147483648`` . The default value is
              ``33554432`` .
              ...
              * ``sgd.shuffleType`` - Whether Amazon ML shuffles the training data. Shuffling data
              improves a model's ability to find the optimal solution for a variety of data types.
              The valid values are ``auto`` and ``none`` . The default value is ``none`` . We
              ...
              * ``sgd.l1RegularizationAmount`` - The coefficient regularization L1 norm. It controls
              ...
              start by specifying a small value, such as ``1.0E-08`` . The value is a double that
              ranges from ``0`` to ``MAX_DOUBLE`` . The default is to not use L1 normalization. This
              parameter can't be used when ``L2`` is specified. Use this parameter sparingly.

              * ``sgd.l2RegularizationAmount`` - The coefficient regularization L2 norm. It controls
              overfitting the data by penalizing large coefficients. This tends to drive
              coefficients to small, nonzero values. If you use this parameter, start by specifying
              a small value, such as ``1.0E-08`` . The value is a double that ranges from ``0`` to
              ``MAX_DOUBLE`` . The default is to not use L2 normalization. This parameter can't be
            ...
            - **ScoreThreshold** *(float) --*
              ...
              the MLModel, such as ``true`` . Output values less than the threshold receive a
            ...
            - **ComputeTime** *(integer) --*
              ...
              The approximate CPU time in milliseconds that Amazon Machine Learning spent processing
              the ``MLModel`` , normalized and scaled on computation resources. ``ComputeTime`` is
              only available if the ``MLModel`` is in the ``COMPLETED`` state.
            ...
            - **Recipe** *(string) --*
              ...
              information about the observation data to use during training, and manipulations to
    ...
    def predict(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/Predict>`_
        ...
        **Request Syntax**
        ...
        :param Record: **[REQUIRED]**
          ...
          - *(string) --*
            ...
            The name of a variable. Currently it's used to specify the name of the target value,
            label, weight, and tags.

            - *(string) --*

              The value of a variable. Currently it's used to specify values of the target value,
              weights, and tag variables and for filtering variable values.
          ...
          - *(dict) --*
            ...
            - **Prediction** *(dict) --*
              ...
              * ``PredictedValue`` - Present for a ``REGRESSION``  ``MLModel`` request.
              ...
              - **predictedScores** *(dict) --* Provides the raw classification score corresponding
              to each label.
              ...
              - **details** *(dict) --* Provides any additional details regarding the prediction.
                ...
                - Indicates the type of the ``MLModel`` . ``Algorithm`` - Indicates the algorithm
                that was used for the ``MLModel`` .
    ...
    def update_batch_prediction(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/UpdateBatchPrediction>`_
    ...
    def update_data_source(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/UpdateDataSource>`_
    ...
    def update_evaluation(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/UpdateEvaluation>`_
    ...
    def update_ml_model(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/machinelearning-2014-12-12/UpdateMLModel>`_
        ...
        **Request Syntax**
        ...
        :param ScoreThreshold:
          ...
          from the ``MLModel`` , such as ``true`` . Output values less than the ``ScoreThreshold``
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **MLModelId** *(string) --*
              ...
              The ID assigned to the ``MLModel`` during creation. This value should be identical to
              the value of the ``MLModelID`` in the request.
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_batch_predictions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_data_sources` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_evaluations` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_ml_models` operation.
        """
    ...
    def get_waiter(
        ...
        """
        Get Waiter `batch_prediction_available`.
        """
    ...
    def get_waiter(
        ...
        """
        Get Waiter `data_source_available`.
        """
    ...
    def get_waiter(
        ...
        """
        Get Waiter `evaluation_available`.
        """
