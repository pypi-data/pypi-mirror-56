"Main interface for xray Client"
...
class Client(BaseClient):
    ...
    def batch_get_traces(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/BatchGetTraces>`_
              ...
              - *(dict) --*
                ...
                - **Segments** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    can be compiled from documents uploaded with  PutTraceSegments , or an
                    ``inferred`` segment for a downstream service, generated from a subsegment sent
                    by the service that called it.
    ...
    def create_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/CreateGroup>`_
        ...
        **Request Syntax**
        ...
        :param GroupName: **[REQUIRED]**
          ...
          The case-sensitive name of the new group. Default is a reserved name and names must be
          unique.
    ...
    def create_sampling_rule(
        ...
        rules with  GetSamplingRules , and evaluate each rule in ascending order of *priority* for
        each request. If a rule matches, the service records a trace, borrowing it from the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/CreateSamplingRule>`_
            ...
            - **SamplingRuleRecord** *(dict) --*
              ...
              - **SamplingRule** *(dict) --*
                ...
                - **ReservoirSize** *(integer) --*
                  ...
                  the fixed rate. The reservoir is not used directly by services, but applies to all
    ...
    def delete_group(self, GroupName: str = None, GroupARN: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/DeleteGroup>`_
    ...
    def delete_sampling_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/DeleteSamplingRule>`_
    ...
    def get_encryption_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetEncryptionConfig>`_
    ...
    def get_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetGroup>`_
    ...
    def get_groups(self, NextToken: str = None) -> ClientGetGroupsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetGroups>`_
    ...
    def get_sampling_rules(self, NextToken: str = None) -> ClientGetSamplingRulesResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetSamplingRules>`_
    ...
    def get_sampling_statistic_summaries(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetSamplingStatisticSummaries>`_
    ...
    def get_sampling_targets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetSamplingTargets>`_
        ...
        **Request Syntax**
        ...
        :param SamplingStatisticsDocuments: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            seconds unless the service has been assigned a longer reporting interval after a
            previous call to  GetSamplingTargets .
          ...
          - *(dict) --*
            ...
            - **SamplingTargetDocuments** *(list) --*
              ...
              - *(dict) --*
                ...
                target for a rule, X-Ray calculates a new reservoir for each service based on the
                recent sampling results of all services that called  GetSamplingTargets .
    ...
    def get_service_graph(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetServiceGraph>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ContainsOldGroupVersions** *(boolean) --*
              ...
              returned service graph may show traces from an older version of the group's filter
              expression.
    ...
    def get_time_series_service_statistics(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetTimeSeriesServiceStatistics>`_
        ...
        **Request Syntax**
        ...
        :param EntitySelectorExpression:
          ...
          A filter expression defining entities that will be aggregated for statistics. Supports ID,
          service, and edge functions. If no selector expression is specified, edge statistics are
          returned.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ContainsOldGroupVersions** *(boolean) --*
              ...
              A flag indicating whether or not a group's filter expression has been consistent, or
              if a returned aggregation may show statistics from an older version of the group's
              filter expression.
    ...
    def get_trace_graph(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetTraceGraph>`_
    ...
    def get_trace_summaries(
        ...
        """
        Retrieves IDs and metadata for traces available for a specified time frame using an optional
        ...
        For a full list of indexed fields and keywords that you can use in filter expressions, see
        `Using Filter Expressions
        <https://docs.aws.amazon.com/xray/latest/devguide/xray-console-filters.html>`__ in the *AWS
        X-Ray Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/GetTraceSummaries>`_
        ...
        **Request Syntax**
        ...
        :param FilterExpression:
          ...
          Specify a filter expression to retrieve trace summaries for services or requests that meet
          certain requirements.

        :type NextToken: string
        :param NextToken:

          Specify the pagination token returned by a previous request to retrieve the next page of
          results.
            ...
            - **TraceSummaries** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ResponseTime** *(float) --*
                  ...
                  If the service performs work asynchronously, the response time measures the time
                  before the response is sent to the user, while the duration measures the amount of
                  time before the last traced activity completes.
    ...
    def put_encryption_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/PutEncryptionConfig>`_
    ...
    def put_telemetry_records(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/PutTelemetryRecords>`_
    ...
    def put_trace_segments(
        ...
        Segments must include the following fields. For the full segment document schema, see `AWS
        X-Ray Segment Documents
        <https://docs.aws.amazon.com/xray/latest/devguide/xray-api-segmentdocuments.html>`__ in the
        ...
        * ``in_progress`` - Set to ``true`` instead of specifying an ``end_time`` to record that a
        ...
        application receives a request that will take a long time to serve, to trace the fact that
        the request was received. When the response is sent, send the complete segment to overwrite
        ...
        * A 96-bit identifier for the trace, globally unique, in 24 hexadecimal digits.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/PutTraceSegments>`_
    ...
    def update_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/UpdateGroup>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Group** *(dict) --*
              ...
              of the group that was updated, and the updated filter expression assigned to the
              group.
    ...
    def update_sampling_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/xray-2016-04-12/UpdateSamplingRule>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `batch_get_traces` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_groups` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_sampling_rules` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_sampling_statistic_summaries` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_service_graph` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_time_series_service_statistics` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_trace_graph` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_trace_summaries` operation.
        """
