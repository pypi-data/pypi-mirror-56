...
class BatchGetTracesPaginateResponseTracesSegmentsTypeDef(
    ...
    from documents uploaded with  PutTraceSegments , or an ``inferred`` segment for a downstream
    service, generated from a subsegment sent by the service that called it.
...
class BatchGetTracesPaginateResponseTracesTypeDef(_BatchGetTracesPaginateResponseTracesTypeDef):
    ...
    - **Duration** *(float) --*
      ...
      The length of time in seconds between the start time of the root segment and the end time of
    ...
    - **Segments** *(list) --*
      ...
      - *(dict) --*
        ...
        compiled from documents uploaded with  PutTraceSegments , or an ``inferred`` segment for a
        downstream service, generated from a subsegment sent by the service that called it.
...
class ClientCreateGroupResponseGroupTypeDef(_ClientCreateGroupResponseGroupTypeDef):
    ...
    group that was generated based on the group name, and the filter expression that was assigned to
    the group.
...
class ClientCreateSamplingRuleResponseSamplingRuleRecordSamplingRuleTypeDef(
    ...
    - **ReservoirSize** *(integer) --*
      ...
      rate. The reservoir is not used directly by services, but applies to all services using the
      rule collectively.
...
class ClientGetSamplingTargetsResponseSamplingTargetDocumentsTypeDef(
    ...
    rule, X-Ray calculates a new reservoir for each service based on the recent sampling results of
...
class ClientGetServiceGraphResponseServicesEdgesSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for `ClientGetServiceGraphResponseServicesEdgesSummaryStatistics`
    `ErrorStatistics`
...
class ClientGetServiceGraphResponseServicesEdgesTypeDef(
    ...
    - **ResponseTimeHistogram** *(list) --*
      ...
      - *(dict) --*
        ...
        An entry in a histogram for a statistic. A histogram maps the range of observed values on
        the X axis, and the prevalence of each value on the Y axis.
...
class ClientGetTimeSeriesServiceStatisticsResponseTimeSeriesServiceStatisticsEdgeSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for
    `ClientGetTimeSeriesServiceStatisticsResponseTimeSeriesServiceStatisticsEdgeSummaryStatistics`
    `ErrorStatistics`
...
class ClientGetTimeSeriesServiceStatisticsResponseTimeSeriesServiceStatisticsEdgeSummaryStatisticsTypeDef(
    ...
    """
    Type definition for `ClientGetTimeSeriesServiceStatisticsResponseTimeSeriesServiceStatistics`
...
class ClientGetTimeSeriesServiceStatisticsResponseTimeSeriesServiceStatisticsServiceSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for
    `ClientGetTimeSeriesServiceStatisticsResponseTimeSeriesServiceStatisticsServiceSummaryStatistics`
    `ErrorStatistics`
...
class ClientGetTraceGraphResponseServicesEdgesSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for `ClientGetTraceGraphResponseServicesEdgesSummaryStatistics`
    `ErrorStatistics`
...
class ClientGetTraceSummariesResponseTraceSummariesErrorRootCausesServicesEntityPathExceptionsTypeDef(
    ...
    """
    Type definition for
    `ClientGetTraceSummariesResponseTraceSummariesErrorRootCausesServicesEntityPath` `Exceptions`
...
class ClientGetTraceSummariesResponseTraceSummariesErrorRootCausesServicesEntityPathTypeDef(
    ...
    """
    Type definition for `ClientGetTraceSummariesResponseTraceSummariesErrorRootCausesServices`
    `EntityPath`
...
class ClientGetTraceSummariesResponseTraceSummariesErrorRootCausesTypeDef(
    ...
    - **Services** *(list) --*
      ...
      A list of services corresponding to an error. A service identifies a segment and it contains a
...
class ClientGetTraceSummariesResponseTraceSummariesFaultRootCausesServicesEntityPathExceptionsTypeDef(
    ...
    """
    Type definition for
    `ClientGetTraceSummariesResponseTraceSummariesFaultRootCausesServicesEntityPath` `Exceptions`
...
class ClientGetTraceSummariesResponseTraceSummariesFaultRootCausesServicesEntityPathTypeDef(
    ...
    """
    Type definition for `ClientGetTraceSummariesResponseTraceSummariesFaultRootCausesServices`
    `EntityPath`

    A collection of segments and corresponding subsegments associated to a trace summary fault
    error.
...
class ClientGetTraceSummariesResponseTraceSummariesFaultRootCausesTypeDef(
    ...
    - **Services** *(list) --*
      ...
      A list of corresponding services. A service identifies a segment and it contains a name,
...
class ClientGetTraceSummariesResponseTraceSummariesResponseTimeRootCausesServicesEntityPathTypeDef(
    ...
    """
    Type definition for
    `ClientGetTraceSummariesResponseTraceSummariesResponseTimeRootCausesServices` `EntityPath`
...
class ClientGetTraceSummariesResponseTraceSummariesResponseTimeRootCausesServicesTypeDef(
    ...
    """
    Type definition for `ClientGetTraceSummariesResponseTraceSummariesResponseTimeRootCauses`
    `Services`
...
class ClientGetTraceSummariesResponseTraceSummariesResponseTimeRootCausesTypeDef(
    ...
    - **Services** *(list) --*
      ...
      A list of corresponding services. A service identifies a segment and contains a name, account
...
class ClientGetTraceSummariesResponseTraceSummariesTypeDef(
    ...
    - **ResponseTime** *(float) --*
      ...
      service performs work asynchronously, the response time measures the time before the response
      is sent to the user, while the duration measures the amount of time before the last traced
      activity completes.
...
_ClientGetTraceSummariesSamplingStrategyTypeDef = TypedDict(
    "_ClientGetTraceSummariesSamplingStrategyTypeDef", {"Name": str, "Value": float}, total=False
)
...
class GetServiceGraphPaginateResponseServicesEdgesSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for `GetServiceGraphPaginateResponseServicesEdgesSummaryStatistics`
    `ErrorStatistics`
...
class GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatisticsEdgeSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for
    `GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatisticsEdgeSummaryStatistics`
    `ErrorStatistics`
...
class GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatisticsEdgeSummaryStatisticsTypeDef(
    ...
    """
    Type definition for `GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatistics`
    `EdgeSummaryStatistics`
...
class GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatisticsServiceSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for
    `GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatisticsServiceSummaryStatistics`
    `ErrorStatistics`
...
class GetTimeSeriesServiceStatisticsPaginateResponseTimeSeriesServiceStatisticsTypeDef(
    ...
    """
    Type definition for `GetTimeSeriesServiceStatisticsPaginateResponse`
...
class GetTraceGraphPaginateResponseServicesEdgesSummaryStatisticsErrorStatisticsTypeDef(
    ...
    """
    Type definition for `GetTraceGraphPaginateResponseServicesEdgesSummaryStatistics`
    `ErrorStatistics`
...
class GetTraceSummariesPaginateResponseTraceSummariesAnnotationsAnnotationValueTypeDef(
    ...
    """
    Type definition for `GetTraceSummariesPaginateResponseTraceSummariesAnnotations`
    `AnnotationValue`
...
class GetTraceSummariesPaginateResponseTraceSummariesErrorRootCausesServicesEntityPathExceptionsTypeDef(
    ...
    """
    Type definition for
    `GetTraceSummariesPaginateResponseTraceSummariesErrorRootCausesServicesEntityPath` `Exceptions`
...
class GetTraceSummariesPaginateResponseTraceSummariesErrorRootCausesServicesEntityPathTypeDef(
    ...
    """
    Type definition for `GetTraceSummariesPaginateResponseTraceSummariesErrorRootCausesServices`
    `EntityPath`
...
class GetTraceSummariesPaginateResponseTraceSummariesFaultRootCausesServicesEntityPathExceptionsTypeDef(
    ...
    """
    Type definition for
    `GetTraceSummariesPaginateResponseTraceSummariesFaultRootCausesServicesEntityPath` `Exceptions`
...
class GetTraceSummariesPaginateResponseTraceSummariesFaultRootCausesServicesEntityPathTypeDef(
    ...
    """
    Type definition for `GetTraceSummariesPaginateResponseTraceSummariesFaultRootCausesServices`
    `EntityPath`
...
class GetTraceSummariesPaginateResponseTraceSummariesResponseTimeRootCausesServicesEntityPathTypeDef(
    ...
    """
    Type definition for
    `GetTraceSummariesPaginateResponseTraceSummariesResponseTimeRootCausesServices` `EntityPath`
...
class GetTraceSummariesPaginateResponseTraceSummariesResponseTimeRootCausesServicesTypeDef(
    ...
    """
    Type definition for `GetTraceSummariesPaginateResponseTraceSummariesResponseTimeRootCauses`
    `Services`
...
_GetTraceSummariesPaginateSamplingStrategyTypeDef = TypedDict(
    "_GetTraceSummariesPaginateSamplingStrategyTypeDef", {"Name": str, "Value": float}, total=False
)
