"Main interface for mediaconnect Client"
...
class Client(BaseClient):
    ...
    def create_flow(
        ...
        (up to 20) and entitlements (up to 50).
        ...
        **Request Syntax**
        ...
        :param Source: **[REQUIRED]** The settings for the source of the flow.
          ...
          - **Decryption** *(dict) --* The type of encryption that is used on the content ingested from this
          source.
          ...
          - **EntitlementArn** *(string) --* The ARN of the entitlement that allows you to subscribe to this
          flow. The entitlement is set by the flow originator, and the ARN is generated as part of the
          originator's flow.
          ...
          - **StreamId** *(string) --* The stream ID that you want to use for this transport. This parameter
    ...
    def describe_flow(self, FlowArn: str) -> ClientDescribeFlowResponseTypeDef:
        ...
        well as details about the source, outputs, and entitlements.
    ...
    def list_entitlements(
        ...
        **Request Syntax**
        ...
        :param MaxResults: The maximum number of results to return per API request. For example, you submit
        a ListEntitlements request with MaxResults set at 5. Although 20 items match your request, the
        service returns no more than the first 5 items. (The service also returns a NextToken value that you
        can use to fetch the next batch of results.) The service might return fewer results than the
        MaxResults value. If MaxResults is not included in the request, the service defaults to pagination
        ...
        example, you submit a ListEntitlements request with MaxResults set at 5. The service returns the
        first batch of results (up to 5) and a NextToken value. To see the next batch of results, you can
        submit the ListEntitlements request a second time and specify the NextToken value.
    ...
    def list_flows(
        ...
        **Request Syntax**
        ...
        :type MaxResults: integer
        :param MaxResults: The maximum number of results to return per API request. For example, you submit
        a ListFlows request with MaxResults set at 5. Although 20 items match your request, the service
        returns no more than the first 5 items. (The service also returns a NextToken value that you can use
        to fetch the next batch of results.) The service might return fewer results than the MaxResults
        value. If MaxResults is not included in the request, the service defaults to pagination with a
        maximum of 10 results per page.

        :type NextToken: string
        :param NextToken: The token that identifies which batch of results that you want to see. For
        example, you submit a ListFlows request with MaxResults set at 5. The service returns the first
        batch of results (up to 5) and a NextToken value. To see the next batch of results, you can submit
    ...
    def update_flow_entitlement(
        ...
        subscribers, the service will remove the outputs that are are used by the subscribers that are
        removed.
        ...
        **Request Syntax**
        ...
        :param Description: A description of the entitlement. This description appears only on the AWS
        Elemental MediaConnect console and will not be seen by the subscriber or end user.

        :type Encryption: dict
        :param Encryption: The type of encryption that will be used on the output associated with this
        entitlement.
          ...
          - **DeviceId** *(string) --* The value of one of the devices that you configured with your digital
          rights management (DRM) platform key provider. This parameter is required for SPEKE encryption and
          is not valid for static key encryption.

          - **KeyType** *(string) --* The type of key that is used for the encryption. If no keyType is
          provided, the service will use the default setting (static-key).

          - **Region** *(string) --* The AWS Region that the API Gateway proxy endpoint was created in. This
          ...
          key server to identify the current endpoint. The resource ID is also known as the content ID. This
          parameter is required for SPEKE encryption and is not valid for static key encryption.

          - **RoleArn** *(string) --* The ARN of the role that you created during setup (when you set up AWS
        ...
        :param Subscribers: The AWS account IDs that you want to share your content with. The receiving
        accounts (subscribers) will be allowed to create their own flow using your content as the source.
    ...
    def update_flow_output(
        ...
        **Request Syntax**
        ...
        :param CidrAllowList: The range of IP addresses that should be allowed to initiate output requests
        to this flow. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR)
        block; for example, 10.0.0.0/16.

          - *(string) --*

        :type Description: string
        :param Description: A description of the output. This description appears only on the AWS Elemental
        ...
        :type Encryption: dict
        :param Encryption: The type of key used for the encryption. If no keyType is provided, the service
        ...
        :param StreamId: The stream ID that you want to use for this transport. This parameter applies only
        to Zixi-based streams.
    ...
    def update_flow_source(
        ...
        **Request Syntax**
        ...
        :type Description: string
        :param Description: A description for the source. This value is not used or seen outside of the
        current AWS Elemental MediaConnect account.

        :type EntitlementArn: string
        :param EntitlementArn: The ARN of the entitlement that allows you to subscribe to this flow. The
        entitlement is set by the flow originator, and the ARN is generated as part of the originator's
        flow.
        ...
        :type MaxLatency: integer
        :param MaxLatency: The maximum latency in milliseconds. This parameter applies only to RIST-based
        ...
        :param WhitelistCidr: The range of IP addresses that should be allowed to contribute content to your
        source. These IP addresses should be in the form of a Classless Inter-Domain Routing (CIDR) block;
