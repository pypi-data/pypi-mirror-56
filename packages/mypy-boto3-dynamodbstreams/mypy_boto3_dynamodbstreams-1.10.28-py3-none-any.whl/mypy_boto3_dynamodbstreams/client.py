"Main interface for dynamodbstreams Client"
...
class Client(BaseClient):
    ...
    def describe_stream(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/streams-dynamodb-2012-08-10/DescribeStream>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **StreamDescription** *(dict) --*
              ...
              DynamoDB table associated with the stream, the shard IDs within the stream, and the
              beginning and ending sequence numbers of stream records within the shards.
              ...
              - **LastEvaluatedShardId** *(string) --*
                ...
                the result set is when ``LastEvaluatedShardId`` is empty.
    ...
    def get_records(self, ShardIterator: str, Limit: int = None) -> ClientGetRecordsResponseTypeDef:
        ...
        the position in the shard from which you want to start reading stream records sequentially.
        If there are no stream records available in the portion of the shard that the iterator
        points to, ``GetRecords`` returns an empty list. Note that it might take multiple calls to
        get to a portion of the shard that contains stream records.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/streams-dynamodb-2012-08-10/GetRecords>`_
              ...
              - *(dict) --*
                ...
                - **dynamodb** *(dict) --*
                  ...
                  - **ApproximateCreationDateTime** *(datetime) --*
                    ...
                    time <http://www.epochconverter.com/>`__ format.
    ...
    def get_shard_iterator(
        self, StreamArn: str, ShardId: str, ShardIteratorType: str, SequenceNumber: str = None
    ) -> ClientGetShardIteratorResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/streams-dynamodb-2012-08-10/GetShardIterator>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ShardIterator** *(string) --*
              ...
              shard iterator specifies this position using the sequence number of a stream record in
              a shard.
    ...
    def list_streams(
        ...
        ``TableName`` parameter is present, then ``ListStreams`` will return only the streams ARNs
        for that table.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/streams-dynamodb-2012-08-10/ListStreams>`_
