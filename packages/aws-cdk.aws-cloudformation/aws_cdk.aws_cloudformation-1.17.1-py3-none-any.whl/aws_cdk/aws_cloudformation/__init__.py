...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-cloudformation", "1.17.1", __name__, "aws-cloudformation@1.17.1.jsii.tgz")
...
class CustomResource(aws_cdk.core.Resource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.CustomResource"):
    ...
    def get_att_string(self, attribute_name: str) -> str:
        """Returns the value of an attribute of the custom resource of type string. Attributes are returned from the custom resource provider through the ``Data`` map where the key is the attribute name.
...
class NestedStack(aws_cdk.core.Stack, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-cloudformation.NestedStack"):
    ...
    def stack_id(self) -> str:
        ...
        Example::
            # Example automatically generated. See https://github.com/aws/jsii/issues/826
            "arn:aws:cloudformation:us-east-2:123456789012:stack/mystack-mynestedstack-sggfrhxhum7w/f449b250-b969-11e0-a185-5081d0136786"@attributeundefined
        """
    ...
    def stack_name(self) -> str:
        ...
        Example::
            # Example automatically generated. See https://github.com/aws/jsii/issues/826
            mystack - mynestedstack - sggfrhxhum7w@attributeundefined
        """
    ...
    def parent_stack(self) -> typing.Optional[aws_cdk.core.Stack]:
