...
class Client(BaseClient):
    ...
    def create_stream(
        ...
        **Request Syntax**
        ...
        :param MediaType:
          ...
          processing the stream. For more information about media types, see `Media Types
          <http://www.iana.org/assignments/media-types/media-types.xhtml>`__ . If you choose to
          specify the ``MediaType`` , see `Naming Requirements
          <https://tools.ietf.org/html/rfc6838#section-4.2>`__ for guidelines.
        ...
        :param KmsKeyId:
          ...
          The ID of the AWS Key Management Service (AWS KMS) key that you want Kinesis Video Streams
        ...
        :param DataRetentionInHours:
          ...
          The number of hours that you want to retain the data in the stream. Kinesis Video Streams
        ...
        :param Tags:
          ...
          A list of tags to associate with the specified stream. Each tag is a key-value pair (the
          value is optional).
    ...
    def get_data_endpoint(
        ...
        .. note::
          ...
          The returned endpoint does not have the API name appended. The client needs to add the API
        ...
        **Request Syntax**
        ...
        :param StreamARN:
          ...
          The Amazon Resource Name (ARN) of the stream that you want to get the endpoint for. You
          must specify either this parameter or a ``StreamName`` in the request.
    ...
    def list_tags_for_stream(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If you specify this parameter and the result of a ``ListTagsForStream`` call is truncated,
          the response includes a token that you can use in the next request to fetch the next batch
          of tags.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              response includes a token that you can use in the next request to fetch the next set
              of tags.
    ...
    def update_data_retention(
        ...
        * If the data retention period is increased, existing data is retained for the new retention
        period. For example, if the data retention period is increased from one hour to seven hours,
        all existing data is retained for seven hours.

        * If the data retention period is decreased, existing data is retained for the new retention
        period. For example, if the data retention period is decreased from seven hours to one hour,
        all existing data is retained for one hour, and any data older than one hour is deleted
        immediately.
        ...
        **Request Syntax**
        ...
        :param CurrentVersion: **[REQUIRED]**
          ...
          call either the ``DescribeStream`` or the ``ListStreams`` API.
        ...
        :param DataRetentionChangeInHours: **[REQUIRED]**
          ...
          The retention period, in hours. The value you specify replaces the current value. The
          maximum value for this parameter is 87600 (ten years).
    ...
    def update_stream(
        ...
        **Request Syntax**
        ...
        :param MediaType:
          ...
          The stream's media type. Use ``MediaType`` to specify the type of content that the stream
          contains to the consumers of the stream. For more information about media types, see
          `Media Types <http://www.iana.org/assignments/media-types/media-types.xhtml>`__ . If you
          choose to specify the ``MediaType`` , see `Naming Requirements
          <https://tools.ietf.org/html/rfc6838#section-4.2>`__ .
