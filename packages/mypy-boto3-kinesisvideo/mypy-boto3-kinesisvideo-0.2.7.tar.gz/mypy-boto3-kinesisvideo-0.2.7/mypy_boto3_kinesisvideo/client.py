"Main interface for kinesisvideo Client"
...
class Client(BaseClient):
    ...
    def create_stream(
        ...
        When you create a new stream, Kinesis Video Streams assigns it a version number. When you change the
        stream's metadata, Kinesis Video Streams updates the version.

         ``CreateStream`` is an asynchronous operation.

        For information about how the service works, see `How it Works
        <https://docs.aws.amazon.com/kinesisvideostreams/latest/dg/how-it-works.html>`__ .

        You must have permissions for the ``KinesisVideo:CreateStream`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/CreateStream>`_
        ...
        **Request Syntax**
        ...
        :param MediaType:
          ...
          stream. For more information about media types, see `Media Types
          <http://www.iana.org/assignments/media-types/media-types.xhtml>`__ . If you choose to specify the
          ``MediaType`` , see `Naming Requirements <https://tools.ietf.org/html/rfc6838#section-4.2>`__ for
          guidelines.
        ...
        :param KmsKeyId:
          ...
          The ID of the AWS Key Management Service (AWS KMS) key that you want Kinesis Video Streams to use
    ...
    def delete_stream(
        ...
        To ensure that you have the latest version of the stream before deleting it, you can specify the
        stream version. Kinesis Video Streams assigns a version to each stream. When you update a stream,
        Kinesis Video Streams assigns a new version number. To get the latest stream version, use the
        ``DescribeStream`` API.

        This operation requires permission for the ``KinesisVideo:DeleteStream`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/DeleteStream>`_
    ...
    def describe_stream(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/DescribeStream>`_
    ...
    def get_data_endpoint(
        ...
        .. note::
          ...
          The returned endpoint does not have the API name appended. The client needs to add the API name to
          the returned endpoint.

        In the request, specify the stream either by ``StreamName`` or ``StreamARN`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/GetDataEndpoint>`_
        ...
        **Request Syntax**
        ...
        :param StreamName:
          ...
          The name of the stream that you want to get the endpoint for. You must specify either this
          parameter or a ``StreamARN`` in the request.

        :type StreamARN: string
        :param StreamARN:

          The Amazon Resource Name (ARN) of the stream that you want to get the endpoint for. You must
          specify either this parameter or a ``StreamName`` in the request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DataEndpoint** *(string) --*
              ...
              The endpoint value. To read data from the stream or to write data to it, specify this endpoint
              in your application.
    ...
    def list_streams(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/ListStreams>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If you specify this parameter, when the result of a ``ListStreams`` operation is truncated, the
          call returns the ``NextToken`` in the response. To get another batch of streams, provide this
    ...
    def list_tags_for_stream(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/ListTagsForStream>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def tag_stream(
        self, Tags: List[str], StreamARN: str = None, StreamName: str = None
    ) -> Dict[str, Any]:
        """
        ...
        replaced with the value that you specify in the request. For more information, see `Using Cost
        Allocation Tags
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/TagStream>`_
    ...
    def untag_stream(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/UntagStream>`_
    ...
    def update_data_retention(
        ...
        whether you want to increase or decrease the data retention period, specify the ``Operation``
        parameter in the request body. In the request, you must specify either the ``StreamName`` or the
        ``StreamARN`` .
        ...
        * If the data retention period is increased, existing data is retained for the new retention period.
        For example, if the data retention period is increased from one hour to seven hours, all existing
        data is retained for seven hours.

        * If the data retention period is decreased, existing data is retained for the new retention period.
        For example, if the data retention period is decreased from seven hours to one hour, all existing
        data is retained for one hour, and any data older than one hour is deleted immediately.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/UpdateDataRetention>`_
        ...
        **Request Syntax**
        ...
        :param CurrentVersion: **[REQUIRED]**
          ...
          The version of the stream whose retention period you want to change. To get the version, call
        ...
        :param DataRetentionChangeInHours: **[REQUIRED]**
          ...
          The retention period, in hours. The value you specify replaces the current value. The maximum
          value for this parameter is 87600 (ten years).
    ...
    def update_stream(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisvideo-2017-09-30/UpdateStream>`_
        ...
        **Request Syntax**
        ...
        :param MediaType:
          ...
          The stream's media type. Use ``MediaType`` to specify the type of content that the stream contains
          to the consumers of the stream. For more information about media types, see `Media Types
          <http://www.iana.org/assignments/media-types/media-types.xhtml>`__ . If you choose to specify the
          ``MediaType`` , see `Naming Requirements <https://tools.ietf.org/html/rfc6838#section-4.2>`__ .

          To play video on the console, you must specify the correct video type. For example, if the video
          in the stream is H.264, specify ``video/h264`` as the ``MediaType`` .
