 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const A=new class{handleAttributeExpressions(t,e,s,o){const i=e[0];if("."===i){return new k(t,e.slice(1),s).parts}return"@"===i?[new T(t,e.slice(1),o.eventContext)]:"?"===i?[new S(t,e.slice(1),s)]:new w(t,e,s).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const M=(t,...e)=>new f(t,e,"html",A),V=133;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
const xt=new WeakMap,St=(t=>(...s)=>{const o=t(...s);return e.set(o,!0),o})(t=>e=>{if(!(e instanceof x))throw new Error("unsafeHTML can only be used in text bindings");const s=xt.get(e);if(void 0!==s&&_(t)&&t===s.value&&e.value===s.fragment)return;const o=document.createElement("template");o.innerHTML=t;const i=document.importNode(o.content,!0);e.setValue(i),xt.set(e,{value:t,fragment:i})});function kt(t,e,s,o){let i;i=void 0!==o?{type:"hacs/repository/data",action:s,repository:e,data:o}:{type:"hacs/repository",action:s,repository:e},t.connection.sendMessage(i)}let Pt=class extends lt{render(){return"0"===String(this.authors.length)?M``:M`
        ...
        `}};Tt=t([st("hacs-button-open-plugin")],Tt);let zt=class extends bt{render(){return M`
            <a href="https://github.com/${this.repository.full_name}" rel='noreferrer' target="_blank">
                <mwc-button>
                    ${this.hass.localize("component.hacs.repository.repository")}
                </mwc-button>
            </a>
        `}};zt=t([st("hacs-button-open-repository")],zt);let At=class extends bt{render(){if(!this.repository.installed)return M``;const t=this.hass.localize("component.hacs.repository.uninstall");return this.status.background_task?M`
                <mwc-button disabled>
                    ${t}
                </mwc-button>
            `:M`
        ...
        `}RepositoryUnInstall(){window.confirm(this.hass.localize("component.hacs.confirm.uninstall","item",this.repository.name))&&this.ExecuteAction()}ExecuteAction(){kt(this.hass,this.repository.id,"set_state","uninstalling"),kt(this.hass,this.repository.id,"uninstall")}};At=t([st("hacs-button-uninstall")],At);let Et=class extends bt{constructor(){super(...arguments),this.pathExists=!1}firstUpdated(){this.hass.connection.sendMessagePromise({type:"hacs/check_path",path:this.repository.local_path}).then(t=>{this.pathExists=t.exist},t=>{console.error("[hacs/check_path] Message failed!",t)})}render(){const t=this.hass.localize(`component.hacs.repository.${this.repository.main_action.toLowerCase()}`);return this.status.background_task?M`
                <mwc-button disabled>
                    ${t}
                </mwc-button>
            `:M`
...
- url: /community_plugin/${this.repository.full_name.split("/")[1]}/${this.repository.file_name}
  type: ${void 0!==this.repository.javascript_type?M`${this.repository.javascript_type}`:M`${this.hass.localize("component.hacs.repository.lovelace_no_js_type")}`}</pre>
        ...
        `]}};t([rt()],Ut.prototype,"hass",void 0),t([rt()],Ut.prototype,"repository",void 0),t([rt()],Ut.prototype,"status",void 0),t([rt()],Ut.prototype,"configuration",void 0),t([rt()],Ut.prototype,"lovelaceconfig",void 0),Ut=t([st("hacs-repository-banner-note")],Ut);let Dt=class extends lt{constructor(){super(...arguments),this.repository_view=!1}firstUpdated(){this.repo.updated_info||(kt(this.hass,this.repo.id,"set_state","other"),kt(this.hass,this.repo.id,"update"))}render(){if(void 0===this.repository)return M`
      <hacs-panel
        .hass=${this.hass}
        .configuration=${this.configuration}
        .repositories=${this.repositories}
    ...
    `]}};t([rt()],Ot.prototype,"hass",void 0),t([rt()],Ot.prototype,"repositories",void 0),t([rt()],Ot.prototype,"configuration",void 0),t([rt()],Ot.prototype,"status",void 0),Ot=t([st("hacs-panel-settings")],Ot);let qt=class extends lt{render(){return this.status.background_task?M`
        ...
        `]}};t([rt()],qt.prototype,"status",void 0),qt=t([st("hacs-progressbar")],qt);let jt=class extends lt{constructor(){super(...arguments),this.error=void 0}clearError(){this.error=void 0}firstUpdated(){this.hass.connection.subscribeEvents(t=>this.error=t.data,"hacs/error")}render(){if(void 0===this.error)return M``;var t=this.error.message,e="";return"add_repository"===this.error.action&&(e="Could not add this repository, make sure it is compliant with HACS."),M`
