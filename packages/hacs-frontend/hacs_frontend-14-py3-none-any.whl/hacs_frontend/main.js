...
- url: /community_plugin/${this.repository.full_name.split("/")[1]}/${this.repository.file_name}
  type: ${void 0!==this.repository.javascript_type?M`${this.repository.javascript_type}`:M`${this.hass.localize("component.hacs.repository.lovelace_no_js_type")}`}</pre>
        ...
        `]}};t([rt()],At.prototype,"hass",void 0),t([rt()],At.prototype,"configuration",void 0),t([rt()],At.prototype,"repository",void 0),At=t([st("hacs-lovelace-hint")],At);let zt=class extends lt{render(){return M`
    ...
    </app-header-layout>`}handlePageSelected(t){this.repository_view=!1;const e=t.detail.selected;this.panel=e,this.requestUpdate(),e!==this._page&&ut(0,`/${this._rootPath}/${e}`),function(t,e){const s=e,o=Math.random(),i=Date.now(),r=s.scrollTop,a=0-r;t._currentAnimationId=o,function e(){const n=Date.now()-i;var c;n>200?s.scrollTop=0:t._currentAnimationId===o&&(s.scrollTop=(c=n,-a*(c/=200)*(c-2)+r),requestAnimationFrame(e.bind(t)))}.call(t)}(this,this.shadowRoot.querySelector("app-header-layout").header.scrollTarget)}get _page(){return void 0===this.route.path.split("/")[1]?"installed":this.route.path.split("/")[1]}get _rootPath(){return void 0===this.route.prefix.split("/")[1]?"hacs":this.route.prefix.split("/")[1]}static get styles(){return[mt,pt`
    .loader {
      background-color: var(--primary-background-color);
      height: 100%;
      width: 100%;
