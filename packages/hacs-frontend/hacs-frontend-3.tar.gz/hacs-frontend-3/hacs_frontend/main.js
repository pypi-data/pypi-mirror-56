 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const v=` ${n} `;class f{constructor(t,e,s,o){this.strings=t,this.values=e,this.type=s,this.processor=o}getHTML(){const t=this.strings.length-1;let e="",s=!1;for(let o=0;o<t;o++){const t=this.strings[o],i=t.lastIndexOf("\x3c!--");s=(i>-1||s)&&-1===t.indexOf("--\x3e",i+1);const r=y.exec(t);e+=null===r?t+(s?v:c):t.substr(0,r.index)+r[1]+r[2]+h+r[3]+n}return e+=this.strings[t]}getTemplateElement(){const t=document.createElement("template");return t.innerHTML=this.getHTML(),t}}
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const z=new class{handleAttributeExpressions(t,e,s,o){const i=e[0];if("."===i){return new P(t,e.slice(1),s).parts}return"@"===i?[new T(t,e.slice(1),o.eventContext)]:"?"===i?[new S(t,e.slice(1),s)]:new w(t,e,s).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */function E(t){let e=N.get(t.type);void 0===e&&(e={stringsArray:new WeakMap,keyString:new Map},N.set(t.type,e));let s=e.stringsArray.get(t.strings);if(void 0!==s)return s;const o=t.strings.join(n);return void 0===(s=e.keyString.get(o))&&(s=new l(t,t.getTemplateElement()),e.keyString.set(o,s)),e.stringsArray.set(t.strings,s),s}const N=new Map,R=new WeakMap;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
(window.litHtmlVersions||(window.litHtmlVersions=[])).push("1.1.2");const M=(t,...e)=>new f(t,e,"html",z),V=133;
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`];function ft(t,e){if(void 0!==e){var s=!1,o=`/community_plugin/${t.full_name.split("/")[1]}/${t.file_name}`;return void 0!==e.resources&&e.resources.forEach(t=>{s||t.url===o&&(s=!0)}),s}return!0}class _t extends lt{static get styles(){return vt}}t([rt()],_t.prototype,"hass",void 0),t([rt()],_t.prototype,"repository",void 0);let bt=class extends _t{render(){return M`
            <mwc-button @click=${this.ExecuteAction}>
                ${this.hass.localize("component.hacs.store.clear_new")}
            </mwc-button>
        `}ExecuteAction(){var t={type:"hacs/settings",action:"clear_new",category:this.category};this.hass.connection.sendMessage(t)}};t([rt()],bt.prototype,"category",void 0),bt=t([st("hacs-button-clear-new")],bt);let wt=class extends lt{constructor(){super(...arguments),this.repository_view=!1,this.SearchTerm=""}render(){if("repository"===this.panel)return M`
    ...
    console.log("done")
          ...
          `}}StatusAndDescription(t){var e=t.status,s=t.status_description;return t.installed&&("plugin"!==t.category||ft(t,this.lovelaceconfig)?"integration"!==t.category||this.hass.config.components.includes(t.domain)||(e="pending-restart",s="Not loaded in Home Assistant"):(e="pending-restart",s="Not loaded in lovelace")),{status:e,description:s}}DoSearch(t){this.SearchTerm=t.composedPath()[0].value.toLowerCase(),localStorage.setItem("hacs-search",this.SearchTerm)}clearSearch(){this.SearchTerm="",localStorage.setItem("hacs-search",this.SearchTerm)}ShowRepository(t){var e;t.composedPath().forEach(t=>{t.RepoID&&(e=t.RepoID)}),this.panel="repository",this.repository=e,this.repository_view=!0,this.requestUpdate(),ut(0,`/${this._rootPath}/repository/${e}`)}get _rootPath(){return"hacs_dev"===window.location.pathname.split("/")[1]?"hacs_dev":"hacs"}static get styles(){return[vt,pt`
      hr {
        width: 95%
      }
      paper-item {
    ...
    `]}};t([rt()],wt.prototype,"hass",void 0),t([rt()],wt.prototype,"repositories",void 0),t([rt()],wt.prototype,"configuration",void 0),t([rt()],wt.prototype,"route",void 0),t([rt()],wt.prototype,"panel",void 0),t([rt()],wt.prototype,"repository_view",void 0),t([rt()],wt.prototype,"repository",void 0),t([rt()],wt.prototype,"SearchTerm",void 0),t([rt()],wt.prototype,"lovelaceconfig",void 0),wt=t([st("hacs-panel")],wt);
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const $t=new WeakMap,xt=(t=>(...s)=>{const o=t(...s);return e.set(o,!0),o})(t=>e=>{if(!(e instanceof x))throw new Error("unsafeHTML can only be used in text bindings");const s=$t.get(e);if(void 0!==s&&_(t)&&t===s.value&&e.value===s.fragment)return;const o=document.createElement("template");o.innerHTML=t;const i=document.importNode(o.content,!0);e.setValue(i),$t.set(e,{value:t,fragment:i})});function St(t,e,s,o){let i;i=void 0!==o?{type:"hacs/repository/data",action:s,repository:e,data:o}:{type:"hacs/repository",action:s,repository:e},t.connection.sendMessage(i)}let Pt=class extends lt{render(){return"0"===String(this.authors.length)?M``:M`
            <div class="autors">
        ...
        `]}};t([rt()],Pt.prototype,"hass",void 0),t([rt()],Pt.prototype,"authors",void 0),Pt=t([st("hacs-authors")],Pt);let kt=class extends lt{render(){return M`
        ...
        `]}RepositoryReload(){St(this.hass,this.repository.id,"set_state","other"),St(this.hass,this.repository.id,"update")}RepositoryBeta(){St(this.hass,this.repository.id,"set_state","other"),this.repository.beta?St(this.hass,this.repository.id,"hide_beta"):St(this.hass,this.repository.id,"show_beta")}RepositoryHide(){St(this.hass,this.repository.id,"set_state","other"),this.repository.hide?St(this.hass,this.repository.id,"unhide"):St(this.hass,this.repository.id,"hide")}};t([rt()],kt.prototype,"hass",void 0),t([rt()],kt.prototype,"repository",void 0),kt=t([st("hacs-repository-menu")],kt);let Ct=class extends _t{render(){if("plugin"!=this.repository.category)return M``;if(!this.repository.installed)return M``;const t=this.repository.local_path.split("/");return M`
        ...
        `}};Ct=t([st("hacs-button-open-plugin")],Ct);let Tt=class extends _t{render(){return M`
            <a href="https://github.com/${this.repository.full_name}" rel='noreferrer' target="_blank">
                <mwc-button>
                    ${this.hass.localize("component.hacs.repository.repository")}
                </mwc-button>
            </a>
        `}};Tt=t([st("hacs-button-open-repository")],Tt);let At=class extends _t{render(){return this.repository.installed?M`
        ...
        `:M``}RepositoryUnInstall(){window.confirm(this.hass.localize("component.hacs.confirm.uninstall","item",this.repository.name))&&this.ExecuteAction()}ExecuteAction(){St(this.hass,this.repository.id,"set_state","uninstalling"),St(this.hass,this.repository.id,"uninstall")}};At=t([st("hacs-button-uninstall")],At);let zt=class extends _t{constructor(){super(...arguments),this.pathExists=!1}firstUpdated(){this.hass.connection.sendMessagePromise({type:"hacs/check_path",path:this.repository.local_path}).then(t=>{this.pathExists=t.exist},t=>{console.error("[hacs/check_path] Message failed!",t)})}render(){return M`
            <mwc-button @click=${this.RepositoryInstall}>
                ${"installing"==this.repository.state?M`<paper-spinner active></paper-spinner>`:M`${this.hass.localize(`component.hacs.repository.${this.repository.main_action.toLowerCase()}`)}`}
            </mwc-button>
        `}RepositoryInstall(){this.repository.can_install?this.pathExists&&!this.repository.installed?window.confirm(this.hass.localize("component.hacs.confirm.exsist","item",this.repository.local_path)+"\n"+this.hass.localize("component.hacs.confirm.overwrite")+"\n"+this.hass.localize("component.hacs.confirm.continue"))&&this.ExecuteAction():this.ExecuteAction():window.alert(`This repository version requires Home Assistant version ${this.repository.homeassistant}`)}ExecuteAction(){St(this.hass,this.repository.id,"set_state","installing"),St(this.hass,this.repository.id,"install")}};t([rt()],zt.prototype,"pathExists",void 0),zt=t([st("hacs-button-main-action")],zt);let Et=class extends _t{render(){if(!this.repository.pending_upgrade)return M``;var t=`https://github.com/${this.repository.full_name}/releases`;return"commit"===this.repository.version_or_commit&&(t=`https://github.com/${this.repository.full_name}/compare/${this.repository.installed_version}...${this.repository.available_version}`),M`
        <a href="${t}" rel='noreferrer' target="_blank">
          <mwc-button>
          ${this.hass.localize("component.hacs.repository.changelog")}
          </mwc-button>
        </a>
        `}RepositoryInstall(){St(this.hass,this.repository.id,"set_state","installing"),St(this.hass,this.repository.id,"uninstall")}};Et=t([st("hacs-button-changelog")],Et);let Nt=class extends lt{render(){return M`
...
- url: /community_plugin/${this.repository.full_name.split("/")[1]}/${this.repository.file_name}
  type: ${void 0!==this.repository.javascript_type?M`${this.repository.javascript_type}`:M`${this.hass.localize("component.hacs.repository.lovelace_no_js_type")}`}</pre>
        ...
        `]}};t([rt()],Nt.prototype,"hass",void 0),t([rt()],Nt.prototype,"configuration",void 0),t([rt()],Nt.prototype,"repository",void 0),Nt=t([st("hacs-lovelace-hint")],Nt);let Rt=class extends lt{render(){return M`
        ...
        `]}};t([rt()],Rt.prototype,"hass",void 0),t([rt()],Rt.prototype,"configuration",void 0),t([rt()],Rt.prototype,"repository",void 0),Rt=t([st("hacs-repository-note")],Rt);let Mt=class extends _t{render(){return this.configuration.experimental&&this.repository.installed?null===this.repository.javascript_type?M``:M`
            <mwc-button @click=${this.RepositoryAddToLovelace}>
                Add to Lovelace
            </mwc-button>
        `:M``}RepositoryAddToLovelace(){window.confirm("Do you want to add this to your lovelace resources?")&&this.hass.connection.sendMessagePromise({type:"lovelace/config",force:!1}).then(t=>{var e=t;const s={type:this.repository.javascript_type,url:`/community_plugin/${this.repository.full_name.split("/")[1]}/${this.repository.file_name}`};e.resources?e.resources.push(s):e.resources=[s],this.hass.callWS({type:"lovelace/config/save",config:e})},t=>{console.error(t)})}};t([rt()],Mt.prototype,"lovelaceconfig",void 0),t([rt()],Mt.prototype,"configuration",void 0),Mt=t([st("hacs-button-add-to-lovelace")],Mt);let Vt=class extends lt{render(){if(!this.repository.installed)return M``;var t="",e="",s="";if("pending-restart"==this.repository.status)s="alert",e="Restart pending",t="\n            You need to restart Home Assistant.\n            ";else if("integration"==this.repository.category)this.hass.config.components.includes(this.repository.domain)||(s="warning",e="Not Loaded",t="\n                This integration is not loaded in Home Assistant.\n                ");else if("plugin"==this.repository.category){if(void 0!==this.lovelaceconfig)ft(this.repository,this.lovelaceconfig)||(s="warning",e="Not Loaded",t="\n                    This plugin is not added to your Lovelace resources.\n                    ")}return 0==t.length?M``:"plugin"!==this.repository.category?M`
        ...
        `]}};t([rt()],Vt.prototype,"hass",void 0),t([rt()],Vt.prototype,"repository",void 0),t([rt()],Vt.prototype,"configuration",void 0),t([rt()],Vt.prototype,"lovelaceconfig",void 0),Vt=t([st("hacs-repository-banner-note")],Vt);let Ut=class extends lt{constructor(){super(...arguments),this.repository_view=!1}firstUpdated(){this.repo.updated_info||(St(this.hass,this.repo.id,"set_state","other"),St(this.hass,this.repo.id,"update"))}render(){if(void 0===this.repository)return M`
      <hacs-panel
        .hass=${this.hass}
        .configuration=${this.configuration}
        .repositories=${this.repositories}
    ...
    <ha-card>
      ...
      ></hacs-repository-note>
          ...
          `}SetVersion(t){St(this.hass,this.repo.id,"set_state","other");var e=t.composedPath()[2].outerText;e&&St(this.hass,this.repo.id,"set_version",e)}GoBackToStore(){this.repository=void 0,this.repo.installed?this.panel="installed":this.panel=this.repo.category,ut(0,`/${this._rootPath}/${this.panel}`),this.requestUpdate()}get _rootPath(){return"hacs_dev"===window.location.pathname.split("/")[1]?"hacs_dev":"hacs"}static get styles(){return[vt,pt`
    ...
    `]}};t([rt()],Ut.prototype,"hass",void 0),t([rt()],Ut.prototype,"repositories",void 0),t([rt()],Ut.prototype,"configuration",void 0),t([rt()],Ut.prototype,"repository",void 0),t([rt()],Ut.prototype,"panel",void 0),t([rt()],Ut.prototype,"route",void 0),t([rt()],Ut.prototype,"repository_view",void 0),t([rt()],Ut.prototype,"repo",void 0),t([rt()],Ut.prototype,"lovelaceconfig",void 0),Ut=t([st("hacs-panel-repository")],Ut);let Dt=class extends lt{updated(){this.SaveSpinner=!1}Delete(t){if(window.confirm(this.hass.localize("component.hacs.confirm.delete","item",t.composedPath()[3].innerText))){var e=t.composedPath()[4].repoID;St(this.hass,e,"delete")}}Save(t){this.SaveSpinner=!0;var e=t.composedPath()[1].children[1].selectedItem.category,s=t.composedPath()[1].children[0].value;St(this.hass,s,"add",e)}render(){return this.custom=this.repositories.filter((function(t){return!!t.custom})),M`
        ...
        `]}};t([rt()],Dt.prototype,"hass",void 0),t([rt()],Dt.prototype,"repositories",void 0),t([rt()],Dt.prototype,"custom",void 0),t([rt()],Dt.prototype,"status",void 0),t([rt()],Dt.prototype,"configuration",void 0),t([rt()],Dt.prototype,"SaveSpinner",void 0),Dt=t([st("hacs-custom-repositories")],Dt);let Lt=class extends lt{UnHide(t){var e=t.composedPath()[4].repoID;St(this.hass,e,"unhide")}render(){return this._hidden=this.repositories.filter((function(t){return t.hide})),0===this._hidden.length?M``:M`
        ...
        `]}};t([rt()],Lt.prototype,"hass",void 0),t([rt()],Lt.prototype,"repositories",void 0),t([rt()],Lt.prototype,"_hidden",void 0),Lt=t([st("hacs-hidden-repositories")],Lt);let It=class extends lt{render(){return this.status.reloading_data,M`
    ...
    `]}};t([rt()],It.prototype,"hass",void 0),t([rt()],It.prototype,"repositories",void 0),t([rt()],It.prototype,"configuration",void 0),t([rt()],It.prototype,"status",void 0),It=t([st("hacs-panel-settings")],It);let Ot=class extends lt{constructor(){super(...arguments),this.error=void 0}clearError(){this.error=void 0}firstUpdated(){this.hass.connection.subscribeEvents(t=>this.error=t.data,"hacs/error")}render(){if(void 0===this.error)return M``;var t=this.error.message,e="";return"add_repository"===this.error.action&&(e="Could not add this repository, make sure it is compliant with HACS."),M`
