 ...
 * subject to an additional IP rights grant found at
 * http://polymer.github.io/PATENTS.txt
 */const E=new class{handleAttributeExpressions(t,e,s,o){const i=e[0];if("."===i){return new k(t,e.slice(1),s).parts}return"@"===i?[new A(t,e.slice(1),o.eventContext)]:"?"===i?[new S(t,e.slice(1),s)]:new w(t,e,s).parts}handleTextExpression(t){return new x(t)}};
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at
...
`];let ft=class extends lt{render(){return M`
        <a href="#">
            <ha-icon
                title="Help"
                class="float"
        ...
        `}openHelp(){var t=window.location.pathname.split("/")[2];console.log(t),"integration"===t&&(t="stores"),"plugin"===t&&(t="stores"),"appdaemon"===t&&(t="stores"),"python_script"===t&&(t="stores"),"theme"===t&&(t="stores"),window.open(`https://hacs.xyz/docs/navigation/${t}`,"Help","noreferrer")}static get styles(){return[vt,pt`
            .float{
                position: fixed;
                width: 60px;
                height:60px;
        ...
        `]}};function _t(t,e){if(void 0!==e){var s=!1,o=`/community_plugin/${t.full_name.split("/")[1]}/${t.file_name}`;return void 0!==e.resources&&e.resources.forEach(t=>{s||t.url===o&&(s=!0)}),s}return!0}function bt(t,e){var s=!1;return e.config.components.forEach(e=>{e.includes(t.domain)&&(s=!0)}),s}ft=t([st("hacs-help-button")],ft);class wt extends lt{static get styles(){return vt}}t([rt()],wt.prototype,"hass",void 0),t([rt()],wt.prototype,"repository",void 0),t([rt()],wt.prototype,"status",void 0);let $t=class extends wt{render(){return M`
            <mwc-button @click=${this.ExecuteAction}>
                ${this.hass.localize("component.hacs.store.clear_new")}
            </mwc-button>
        `}ExecuteAction(){var t={type:"hacs/settings",action:"clear_new",category:this.category};this.hass.connection.sendMessage(t)}};t([rt()],$t.prototype,"category",void 0),$t=t([st("hacs-button-clear-new")],$t);let xt=class extends lt{constructor(){super(...arguments),this.repository_view=!1,this.SearchTerm=""}render(){if("repository"===this.panel)return M`
    ...
    console.log("done")
          ...
          `}}StatusAndDescription(t){var e=t.status,s=t.status_description;return t.installed&&("plugin"!==t.category||_t(t,this.lovelaceconfig)?"integration"!==t.category||bt(t,this.hass)||(e="pending-restart",s="Not loaded in Home Assistant"):(e="pending-restart",s="Not loaded in lovelace")),{status:e,description:s}}DoSearch(t){this.SearchTerm=t.composedPath()[0].value.toLowerCase(),localStorage.setItem("hacs-search",this.SearchTerm)}clearSearch(){this.SearchTerm="",localStorage.setItem("hacs-search",this.SearchTerm)}ShowRepository(t){var e;t.composedPath().forEach(t=>{t.RepoID&&(e=t.RepoID)}),this.panel="repository",this.repository=e,this.repository_view=!0,this.requestUpdate(),ut(0,`/${this._rootPath}/repository/${e}`)}get _rootPath(){return"hacs_dev"===window.location.pathname.split("/")[1]?"hacs_dev":"hacs"}static get styles(){return[vt,pt`
      hr {
        width: 95%
      }
      paper-item {
 ...
 * http://polymer.github.io/PATENTS.txt
 */
const St=new WeakMap,kt=(t=>(...s)=>{const o=t(...s);return e.set(o,!0),o})(t=>e=>{if(!(e instanceof x))throw new Error("unsafeHTML can only be used in text bindings");const s=St.get(e);if(void 0!==s&&_(t)&&t===s.value&&e.value===s.fragment)return;const o=document.createElement("template");o.innerHTML=t;const i=document.importNode(o.content,!0);e.setValue(i),St.set(e,{value:t,fragment:i})});function Pt(t,e,s,o){let i;i=void 0!==o?{type:"hacs/repository/data",action:s,repository:e,data:o}:{type:"hacs/repository",action:s,repository:e},t.connection.sendMessage(i)}let Ct=class extends lt{render(){return"0"===String(this.authors.length)?M``:M`
            <div class="autors">
            ...
            `}static get styles(){return[vt,pt`
            .autors {

            }
        `]}};t([rt()],Ct.prototype,"hass",void 0),t([rt()],Ct.prototype,"authors",void 0),Ct=t([st("hacs-authors")],Ct);let At=class extends lt{render(){return M`
        ...
        `]}RepositoryReload(){Pt(this.hass,this.repository.id,"set_state","other"),Pt(this.hass,this.repository.id,"update")}RepositoryBeta(){Pt(this.hass,this.repository.id,"set_state","other"),this.repository.beta?Pt(this.hass,this.repository.id,"hide_beta"):Pt(this.hass,this.repository.id,"show_beta")}RepositoryHide(){Pt(this.hass,this.repository.id,"set_state","other"),this.repository.hide?Pt(this.hass,this.repository.id,"unhide"):Pt(this.hass,this.repository.id,"hide")}};t([rt()],At.prototype,"hass",void 0),t([rt()],At.prototype,"repository",void 0),At=t([st("hacs-repository-menu")],At);let Tt=class extends wt{render(){if("plugin"!=this.repository.category)return M``;if(!this.repository.installed)return M``;const t=this.repository.local_path.split("/");return M`
        ...
        `}};Tt=t([st("hacs-button-open-plugin")],Tt);let Et=class extends wt{render(){return M`
            <a href="https://github.com/${this.repository.full_name}" rel='noreferrer' target="_blank">
                <mwc-button>
                    ${this.hass.localize("component.hacs.repository.repository")}
                </mwc-button>
            </a>
        `}};Et=t([st("hacs-button-open-repository")],Et);let zt=class extends wt{render(){if(!this.repository.installed)return M``;const t=this.hass.localize("component.hacs.repository.uninstall");return this.status.background_task?M`
                <mwc-button disabled>
                    ${t}
                </mwc-button>
            `:M`
        ...
        `}RepositoryUnInstall(){window.confirm(this.hass.localize("component.hacs.confirm.uninstall","item",this.repository.name))&&this.ExecuteAction()}ExecuteAction(){Pt(this.hass,this.repository.id,"set_state","uninstalling"),Pt(this.hass,this.repository.id,"uninstall")}};zt=t([st("hacs-button-uninstall")],zt);let Nt=class extends wt{constructor(){super(...arguments),this.pathExists=!1}firstUpdated(){this.hass.connection.sendMessagePromise({type:"hacs/check_path",path:this.repository.local_path}).then(t=>{this.pathExists=t.exist},t=>{console.error("[hacs/check_path] Message failed!",t)})}render(){const t=this.hass.localize(`component.hacs.repository.${this.repository.main_action.toLowerCase()}`);return this.status.background_task?M`
                <mwc-button disabled>
                    ${t}
                </mwc-button>
            `:M`
        ...
        `}RepositoryInstall(){this.repository.can_install?this.pathExists&&!this.repository.installed?window.confirm(this.hass.localize("component.hacs.confirm.exsist","item",this.repository.local_path)+"\n"+this.hass.localize("component.hacs.confirm.overwrite")+"\n"+this.hass.localize("component.hacs.confirm.continue"))&&this.ExecuteAction():this.ExecuteAction():window.alert(`This repository version requires Home Assistant version ${this.repository.homeassistant}`)}ExecuteAction(){Pt(this.hass,this.repository.id,"set_state","installing"),Pt(this.hass,this.repository.id,"install")}};t([rt()],Nt.prototype,"pathExists",void 0),Nt=t([st("hacs-button-main-action")],Nt);let Rt=class extends wt{render(){if(!this.repository.pending_upgrade)return M``;var t=`https://github.com/${this.repository.full_name}/releases`;return"commit"===this.repository.version_or_commit&&(t=`https://github.com/${this.repository.full_name}/compare/${this.repository.installed_version}...${this.repository.available_version}`),M`
        <a href="${t}" rel='noreferrer' target="_blank">
          <mwc-button>
          ${this.hass.localize("component.hacs.repository.changelog")}
          </mwc-button>
        </a>
        `}RepositoryInstall(){Pt(this.hass,this.repository.id,"set_state","installing"),Pt(this.hass,this.repository.id,"uninstall")}};Rt=t([st("hacs-button-changelog")],Rt);let Mt=class extends lt{render(){return M`
...
- url: /community_plugin/${this.repository.full_name.split("/")[1]}/${this.repository.file_name}
  type: ${void 0!==this.repository.javascript_type?M`${this.repository.javascript_type}`:M`${this.hass.localize("component.hacs.repository.lovelace_no_js_type")}`}</pre>
            ...
            `}CopyToLovelaceExampleToClipboard(t){var e=t.composedPath()[4].children[0].children[1].innerText;document.addEventListener("copy",t=>{t.clipboardData.setData("text/plain",e),t.preventDefault(),document.removeEventListener("copy",null)}),document.execCommand("copy")}static get styles(){return[vt,pt`
            .lovelace-hint {
        ...
        `]}};t([rt()],Mt.prototype,"hass",void 0),t([rt()],Mt.prototype,"configuration",void 0),t([rt()],Mt.prototype,"repository",void 0),Mt=t([st("hacs-lovelace-hint")],Mt);let Vt=class extends lt{render(){return M`
        ...
        `]}};t([rt()],Vt.prototype,"hass",void 0),t([rt()],Vt.prototype,"configuration",void 0),t([rt()],Vt.prototype,"repository",void 0),Vt=t([st("hacs-repository-note")],Vt);let Ut=class extends wt{render(){return this.configuration.experimental&&this.repository.installed?null===this.repository.javascript_type?M``:M`
            <mwc-button @click=${this.RepositoryAddToLovelace}>
                Add to Lovelace
            </mwc-button>
        `:M``}RepositoryAddToLovelace(){window.confirm("Do you want to add this to your lovelace resources?")&&this.hass.connection.sendMessagePromise({type:"lovelace/config",force:!1}).then(t=>{var e=t;const s={type:this.repository.javascript_type,url:`/community_plugin/${this.repository.full_name.split("/")[1]}/${this.repository.file_name}`};e.resources?e.resources.push(s):e.resources=[s],this.hass.callWS({type:"lovelace/config/save",config:e})},t=>{console.error(t)})}};t([rt()],Ut.prototype,"lovelaceconfig",void 0),t([rt()],Ut.prototype,"configuration",void 0),Ut=t([st("hacs-button-add-to-lovelace")],Ut);let Dt=class extends lt{render(){if(!this.repository.installed)return M``;var t="",e="",s="";if("pending-restart"==this.repository.status)s="alert",e="Restart pending",t="\n            You need to restart Home Assistant.\n            ";else if("integration"==this.repository.category){bt(this.repository,this.hass)||(s="warning",e="Not Loaded",t="\n                This integration is not loaded in Home Assistant.\n                ")}else if("plugin"==this.repository.category){if(void 0!==this.lovelaceconfig)_t(this.repository,this.lovelaceconfig)||(s="warning",e="Not Loaded",t="\n                    This plugin is not added to your Lovelace resources.\n                    ")}return 0==t.length?M``:"plugin"!==this.repository.category?M`
        ...
        `]}};t([rt()],Dt.prototype,"hass",void 0),t([rt()],Dt.prototype,"repository",void 0),t([rt()],Dt.prototype,"configuration",void 0),t([rt()],Dt.prototype,"lovelaceconfig",void 0),Dt=t([st("hacs-repository-banner-note")],Dt);let Lt=class extends lt{constructor(){super(...arguments),this.repository_view=!1}firstUpdated(){this.repo.updated_info||(Pt(this.hass,this.repo.id,"set_state","other"),Pt(this.hass,this.repo.id,"update"))}render(){if(void 0===this.repository)return M`
      <hacs-panel
        .hass=${this.hass}
        .configuration=${this.configuration}
        .repositories=${this.repositories}
      ...
      `;var t=this.repository,e=this.repositories.filter((function(e){return e.id===t}));if(this.repo=e[0],this.repo.installed)var s=this.hass.localize("component.hacs.repository.installed");else{if("appdaemon"===this.repo.category)var o="appdaemon_apps";else o=`${this.repo.category}s`;s=this.hass.localize(`component.hacs.common.${o}`)}return M`
                    ...
                    label="${this.hass.localize("component.hacs.repository.available")}:
                     (${this.hass.localize("component.hacs.repository.newest")}: ${this.repo.releases[0]})">
                      <paper-listbox slot="dropdown-content" selected="-1">
                          ${this.repo.releases.map(t=>M`<paper-item @click="${this.SetVersion}">${t}</paper-item>`)}
    ...
    <ha-card class="additional">
      ...
      ></hacs-repository-note>
          ...
          `}SetVersion(t){Pt(this.hass,this.repo.id,"set_state","other");var e=t.composedPath()[2].outerText;e&&Pt(this.hass,this.repo.id,"set_version",e)}GoBackToStore(){this.repository=void 0,this.repo.installed?this.panel="installed":this.panel=this.repo.category,ut(0,`/${this._rootPath}/${this.panel}`),this.requestUpdate()}get _rootPath(){return"hacs_dev"===window.location.pathname.split("/")[1]?"hacs_dev":"hacs"}static get styles(){return[vt,pt`
    ...
    `]}};t([rt()],Lt.prototype,"hass",void 0),t([rt()],Lt.prototype,"repositories",void 0),t([rt()],Lt.prototype,"configuration",void 0),t([rt()],Lt.prototype,"repository",void 0),t([rt()],Lt.prototype,"panel",void 0),t([rt()],Lt.prototype,"route",void 0),t([rt()],Lt.prototype,"status",void 0),t([rt()],Lt.prototype,"repository_view",void 0),t([rt()],Lt.prototype,"repo",void 0),t([rt()],Lt.prototype,"lovelaceconfig",void 0),Lt=t([st("hacs-panel-repository")],Lt);let It=class extends lt{updated(){this.SaveSpinner=!1}Delete(t){if(window.confirm(this.hass.localize("component.hacs.confirm.delete","item",t.composedPath()[3].innerText))){var e=t.composedPath()[4].repoID;Pt(this.hass,e,"delete")}}Save(t){this.SaveSpinner=!0;var e=t.composedPath()[1].children[1].selectedItem.category,s=t.composedPath()[1].children[0].value;Pt(this.hass,s,"add",e)}render(){return this.custom=this.repositories.filter((function(t){return!!t.custom})),M`
        ...
        `]}};t([rt()],It.prototype,"hass",void 0),t([rt()],It.prototype,"repositories",void 0),t([rt()],It.prototype,"custom",void 0),t([rt()],It.prototype,"status",void 0),t([rt()],It.prototype,"configuration",void 0),t([rt()],It.prototype,"SaveSpinner",void 0),It=t([st("hacs-custom-repositories")],It);let Ot=class extends lt{UnHide(t){var e=t.composedPath()[4].repoID;Pt(this.hass,e,"unhide")}render(){return this._hidden=this.repositories.filter((function(t){return t.hide})),0===this._hidden.length?M``:M`
        ...
        `]}};t([rt()],Ot.prototype,"hass",void 0),t([rt()],Ot.prototype,"repositories",void 0),t([rt()],Ot.prototype,"_hidden",void 0),Ot=t([st("hacs-hidden-repositories")],Ot);let qt=class extends lt{render(){return this.status.reloading_data,M`
    ...
    >
          ...
          `}SetFeStyleGrid(){this.hass.connection.sendMessage({type:"hacs/settings",action:"set_fe_grid"})}SetFeStyleTable(){this.hass.connection.sendMessage({type:"hacs/settings",action:"set_fe_table"})}ReloadData(){this.hass.connection.sendMessage({type:"hacs/settings",action:"reload_data"})}UpgradeAll(){var t=[];if(this.repositories.forEach(e=>{e.pending_upgrade&&t.push(e)}),t.length>0){var e="This will upgrade all of these repositores, make sure that you have read the release notes for all of them before proceeding.";if(e+="\n",e+="\n",t.forEach(t=>{e+=`${t.name} ${t.installed_version} -> ${t.available_version}\n`}),!window.confirm(e))return;this.hass.connection.sendMessage({type:"hacs/settings",action:"upgrade_all"})}else window.alert("No upgrades pending")}static get styles(){return[vt,pt`
    ha-card {
      width: 90%;
      margin-left: 5%;
    }
    ...
    `]}};t([rt()],qt.prototype,"hass",void 0),t([rt()],qt.prototype,"repositories",void 0),t([rt()],qt.prototype,"configuration",void 0),t([rt()],qt.prototype,"status",void 0),qt=t([st("hacs-panel-settings")],qt);let Ht=class extends lt{render(){return this.status.background_task?M`
            <paper-progress indeterminate></paper-progress>
        `:M``}static get styles(){return[vt,pt`
            paper-progress {
                width: 100%;
                --paper-progress-active-color: var(--accent-color);
            }
        `]}};t([rt()],Ht.prototype,"status",void 0),Ht=t([st("hacs-progressbar")],Ht);let jt=class extends lt{constructor(){super(...arguments),this.error=void 0}clearError(){this.error=void 0}firstUpdated(){this.hass.connection.subscribeEvents(t=>this.error=t.data,"hacs/error")}render(){if(void 0===this.error)return M``;var t=this.error.message,e="";return"add_repository"===this.error.action&&(e="Could not add this repository, make sure it is compliant with HACS."),M`
        ...
        `]}};t([rt()],Ft.prototype,"hass",void 0),t([rt()],Ft.prototype,"critical",void 0),Ft=t([st("hacs-critical")],Ft);let Bt=class extends lt{constructor(){super(...arguments),this.repository_view=!1}getRepositories(){this.hass.connection.sendMessagePromise({type:"hacs/repositories"}).then(t=>{this.repositories=t,this.requestUpdate()},t=>{console.error("[hacs/repositories] Message failed!",t)})}getConfig(){this.hass.connection.sendMessagePromise({type:"hacs/config"}).then(t=>{this.configuration=t,this.requestUpdate()},t=>{console.error("[hacs/config] Message failed!",t)})}getCritical(){this.hass.connection.sendMessagePromise({type:"hacs/get_critical"}).then(t=>{this.critical=t,this.requestUpdate()},t=>{console.error("[hacs/get_critical] Message failed!",t)})}getStatus(){this.hass.connection.sendMessagePromise({type:"hacs/status"}).then(t=>{this.status=t,this.requestUpdate()},t=>{console.error("[hacs/status] Message failed!",t)})}getLovelaceConfig(){this.hass.connection.sendMessagePromise({type:"lovelace/config",force:!1}).then(t=>{this.lovelaceconfig=t},()=>{this.lovelaceconfig=void 0})}firstUpdated(){localStorage.setItem("hacs-search",""),this.panel=this._page,this.getRepositories(),this.getConfig(),this.getStatus(),this.getCritical(),this.getLovelaceConfig(),/repository\//i.test(this.panel)?(this.repository_view=!0,this.repository=this.panel.split("/")[1]):this.repository_view=!1,dt(),this.hass.connection.sendMessagePromise({type:"hacs/repository"}),this.hass.connection.sendMessagePromise({type:"hacs/config"}),this.hass.connection.sendMessagePromise({type:"hacs/status"}),this.hass.connection.subscribeEvents(()=>this.getRepositories(),"hacs/repository"),this.hass.connection.subscribeEvents(()=>this.getConfig(),"hacs/config"),this.hass.connection.subscribeEvents(()=>this.getStatus(),"hacs/status"),this.hass.connection.subscribeEvents(()=>window.location.reload(),"hacs/reload"),this.hass.connection.subscribeEvents(()=>this.getLovelaceConfig(),"lovelace_updated")}render(){if(""===this.panel&&(ut(0,`/${this._rootPath}/installed`),this.panel="installed"),void 0===this.repositories||void 0===this.configuration)return M`<paper-spinner active class="loader"></paper-spinner>`;/repository\//i.test(this.panel)?(this.repository_view=!0,this.repository=this.panel.split("/")[1],this.panel=this.panel.split("/")[0]):this.repository_view=!1;const t=this.panel;return M`
    ...
    `]}};t([rt()],Bt.prototype,"hass",void 0),t([rt()],Bt.prototype,"repositories",void 0),t([rt()],Bt.prototype,"configuration",void 0),t([rt()],Bt.prototype,"status",void 0),t([rt()],Bt.prototype,"route",void 0),t([rt()],Bt.prototype,"critical",void 0),t([rt()],Bt.prototype,"narrow",void 0),t([rt()],Bt.prototype,"panel",void 0),t([rt()],Bt.prototype,"repository",void 0),t([rt()],Bt.prototype,"repository_view",void 0),t([rt()],Bt.prototype,"lovelaceconfig",void 0),Bt=t([st("hacs-frontend")],Bt);
