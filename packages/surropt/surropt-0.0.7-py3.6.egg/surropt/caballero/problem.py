...
class CaballeroReport(Report):
    ...
    def built_iter_report(self, movement: str, iter_count: int, x: list,
                          f_pred: float, f_actual: float, g_actual: float,
                          header=False, field_size: int = 12):
        arr_str = super().built_iter_report(iter_count=iter_count, x=x,
    ...
    def print_iteration(self, movement: str, iter_count: int, x: list,
        ...
        if self.terminal:
            # terminal asked
            arr_str = self.built_iter_report(movement=movement,
