...
setup(
    name=wide_wild_west.__name__,
    version=wide_wild_west.__version__,
    author=wide_wild_west.__author__,
    author_email=wide_wild_west.__author_email__,
