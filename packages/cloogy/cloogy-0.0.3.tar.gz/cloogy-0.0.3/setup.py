...
"""
A setuptools based setup module for cloogy.
...
with open(path.join(here, 'cloogy', 'client.py'), encoding='utf-8') as f:
    lines = f.readlines()
    for l in lines:
...
setup(
    name='cloogy',
    version=__version__,
    description='A python API Client for Cloogy',
    long_description=long_description,
    long_description_content_type='text/markdown',
    url='https://github.com/energieid/cloogy',
    author='EnergieID.be',
