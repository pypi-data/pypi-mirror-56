...
from feersum_nlu.models import image_classifier_nn_l1
...
class TestImageClassifierNNL1Resnet(BaseTestCase):

    def test(self):
        print("Testing TestImageClassifierNNL1Resnet.test ...", flush=True)
        ...
        print("Creating ImageClassifierNearestNeighbourL1...", end='', flush=True)
        clsfr = image_classifier_nn_l1.ImageClassifierNearestNeighbourL1(vision_model)
        print("done.")
        # ===
        ...
        if clsfr is not None:
            ...
            print("Training ImageClassifierNearestNeighbourL1...", end='', flush=True)
            clsfr.train(training_list, testing_list)
            print("done.")
