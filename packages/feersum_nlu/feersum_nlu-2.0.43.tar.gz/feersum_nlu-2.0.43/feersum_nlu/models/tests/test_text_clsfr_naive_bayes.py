...
from feersum_nlu.models import text_classifier_naive_bayes
...
class TestTextClassifierNaiveBayes(BaseTestCase):

    def test(self):
        print("Testing TestTextClassifierNaiveBayes.test ...", flush=True)

        matcher = text_classifier_naive_bayes.TextClassifierNB({})
        # ===
