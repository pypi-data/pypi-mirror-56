...
from feersum_nlu.models import text_classifier_nn_l1
...
class TestTextClassifierNNVL1WordManifold(BaseTestCase):

    def test(self):
        print("Testing TestTextClassifierNNVL1WordManifold.test ...", flush=True)
        ...
        language_model = word_manifold.WordManifold(manifold_model_path)
        print("done.")

        matcher = text_classifier_nn_l1.TextClassifierNearestNeighbourL1({"eng": language_model})
        # ===
