...
from feersum_nlu.rest_api import intent_wrapper


@controller_util.controller_decorator
def intent_classifier_add_testing_samples(user, token_info,
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_add_testing_samples(iname=instance_name,
...
@controller_util.controller_decorator
def intent_classifier_update_testing_samples(user, token_info,
                                             instance_name, labelled_text_sample_list):
    """
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_update_testing_samples(iname=instance_name,
                                                           auth_token=auth_token,
                                                           caller_name=caller_name,
                                                           json_testing_data={"samples": sample_list})
...
@controller_util.controller_decorator
def intent_classifier_add_training_samples(user, token_info,
                                           instance_name, labelled_text_sample_list):
    """
    Add testing samples to the named model.
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_add_training_samples(iname=instance_name,
                                                         auth_token=auth_token,
                                                         caller_name=caller_name,
...
@controller_util.controller_decorator
def intent_classifier_update_training_samples(user, token_info,
                                              instance_name, labelled_text_sample_list):
    """
    Update testing samples to the named model.
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_update_training_samples(iname=instance_name,
                                                            auth_token=auth_token,
                                                            caller_name=caller_name,
                                                            json_training_data={"samples": sample_list})
...
@controller_util.controller_decorator
def intent_classifier_create(user, token_info,
                             create_details):
    """
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_create(iname=name,
                                                                      auth_token=auth_token,
                                                                      caller_name=caller_name,
                                                                      long_name=long_name,
                                                                      description=desc,
...
@controller_util.controller_decorator
def intent_classifier_del(user, token_info,
                          instance_name):
    """
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_del(instance_name,
                                                                   auth_token=auth_token,
                                                                   caller_name=caller_name,
                                                                   vaporise=False)
    return response_json, response_code
...
@controller_util.controller_decorator
def intent_classifier_vaporise(user, token_info,
                               instance_name):
    """
...
@controller_util.controller_decorator
def intent_classifier_del_testing_samples(user, token_info,
                                          instance_name):
    """
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_remove_testing_samples(iname=instance_name,
                                                           auth_token=auth_token,
                                                           caller_name=caller_name,
                                                           json_testing_data={"samples": sample_list})
...
@controller_util.controller_decorator
def intent_classifier_del_testing_samples_all(user, token_info,
                                              instance_name):
    """
...
@controller_util.controller_decorator
def intent_classifier_del_training_samples(user, token_info,
                                           instance_name):
    """
    Flask controller endpoint to delete testing samples from a text classifier.
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_remove_training_samples(iname=instance_name,
                                                            auth_token=auth_token,
                                                            caller_name=caller_name,
                                                            json_training_data={"samples": sample_list})
...
@controller_util.controller_decorator
def intent_classifier_del_training_samples_all(user, token_info,
                                               instance_name):
    """
...
@controller_util.controller_decorator
def intent_classifier_get_details(user, token_info,
                                  instance_name):
    """
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_get_details(instance_name,
                                                                           auth_token=auth_token,
                                                                           caller_name=caller_name)
    return response_json, response_code
...
@controller_util.controller_decorator
def intent_classifier_get_details_all(user, token_info):
    """
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_get_details_all(auth_token=auth_token,
                                                                               caller_name=caller_name)
    return response_json, response_code


@controller_util.controller_decorator
def intent_classifier_get_testing_samples(user, token_info,
                                          instance_name,
                                          index=None,
                                          len=None):
    """
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_get_testing_samples(iname=instance_name,
                                                        auth_token=auth_token,
                                                        index=index,
                                                        length=len,
                                                        caller_name=caller_name)
...
@controller_util.controller_decorator
def intent_classifier_get_training_samples(user, token_info,
                                           instance_name,
                                           index=None,
                                           len=None):
    """
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_get_training_samples(iname=instance_name,
                                                         auth_token=auth_token,
                                                         index=index,
                                                         length=len,
                                                         caller_name=caller_name)
...
@controller_util.controller_decorator
def intent_classifier_retrieve(user, token_info,
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_retrieve(instance_name,
                                                                        auth_token=auth_token,
                                                                        caller_name=caller_name,
                                                                        text=text, lang_code=lang_code)
    # response_json = List[Tuple[text, intent_id, intent_label, score, lang_code]]
    ...
    if 200 <= response_code <= 299:
        ...
        for result in result_tuple_list:
            # result is [text, intent_id, intent_label, score, text_lang]
...
@controller_util.controller_decorator
def intent_classifier_train(user, token_info,
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_train(instance_name,
                                          auth_token=auth_token,
                                          caller_name=caller_name,
...
@controller_util.controller_decorator
def intent_classifier_get_labels(user, token_info,
                                 instance_name):
    """
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_get_class_labels(instance_name,
                                                                                auth_token=auth_token,
                                                                                caller_name=caller_name)
    return response_json, response_code
...
@controller_util.controller_decorator
def intent_classifier_curate(user, token_info,
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_curate(instance_name,
                                           auth_token=auth_token,
                                           caller_name=caller_name,
...
@controller_util.controller_decorator
def intent_classifier_tsne_post(user, token_info,
                                instance_name,
                                tsne_settings):
    """
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_tsne_post(instance_name,
                                                                         auth_token=auth_token,
                                                                         caller_name=caller_name,
...
def intent_classifier_tsne_get(user, token_info,
                               instance_name):
    """
    Run TSNE dimensionality reduction and return the results.
    ...
    response_code, response_json = intent_wrapper.intent_clsfr_tsne_get(instance_name,
                                                                        auth_token=auth_token,
                                                                        caller_name=caller_name)
...
@controller_util.controller_decorator
def intent_classifier_set_params(user, token_info,
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_set_params(instance_name,
                                               auth_token=auth_token,
                                               caller_name=caller_name,
...
@controller_util.controller_decorator
def intent_classifier_get_params(user, token_info,
                                 instance_name):
    """
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_get_params(instance_name,
                                               auth_token=auth_token,
                                               caller_name=caller_name)
...
@controller_util.controller_decorator
def intent_classifier_online_training_samples(user, token_info,
                                              instance_name, labelled_text_sample_list):
    """
    ...
    response_code, response_json = \
        intent_wrapper.intent_clsfr_add_online_training_samples(iname=instance_name,
                                                                auth_token=auth_token,
                                                                caller_name=caller_name,
                                                                json_training_data={"samples": sample_list})
