...
from feersum_nlu.rest_api import text_classifier_wrapper


@controller_util.controller_decorator
def text_classifier_add_testing_samples(user, token_info,
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_add_testing_samples(iname=instance_name,
...
@controller_util.controller_decorator
def text_classifier_update_testing_samples(user, token_info,
                                           instance_name, labelled_text_sample_list):
    """
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_update_testing_samples(iname=instance_name,
                                                                  auth_token=auth_token,
                                                                  caller_name=caller_name,
                                                                  json_testing_data={"samples": sample_list})
...
@controller_util.controller_decorator
def text_classifier_add_training_samples(user, token_info,
                                         instance_name, labelled_text_sample_list):
    """
    Add testing samples to the named model.
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_add_training_samples(iname=instance_name,
                                                                auth_token=auth_token,
                                                                caller_name=caller_name,
...
@controller_util.controller_decorator
def text_classifier_update_training_samples(user, token_info,
                                            instance_name, labelled_text_sample_list):
    """
    Update testing samples to the named model.
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_update_training_samples(iname=instance_name,
                                                                   auth_token=auth_token,
                                                                   caller_name=caller_name,
                                                                   json_training_data={"samples": sample_list})
...
@controller_util.controller_decorator
def text_classifier_create(user, token_info,
                           create_details):
    """
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_create(iname=name,
                                                                             auth_token=auth_token,
                                                                             caller_name=caller_name,
                                                                             long_name=long_name,
                                                                             description=desc,
...
@controller_util.controller_decorator
def text_classifier_del(user, token_info,
                        instance_name):
    """
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_del(instance_name,
                                                                          auth_token=auth_token,
                                                                          caller_name=caller_name,
                                                                          vaporise=False)
    return response_json, response_code
...
@controller_util.controller_decorator
def text_classifier_vaporise(user, token_info,
                             instance_name):
    """
...
@controller_util.controller_decorator
def text_classifier_del_testing_samples(user, token_info,
                                        instance_name):
    """
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_remove_testing_samples(iname=instance_name,
                                                                  auth_token=auth_token,
                                                                  caller_name=caller_name,
                                                                  json_testing_data={"samples": sample_list})
...
@controller_util.controller_decorator
def text_classifier_del_testing_samples_all(user, token_info,
                                            instance_name):
    """
...
@controller_util.controller_decorator
def text_classifier_del_training_samples(user, token_info,
                                         instance_name):
    """
    Flask controller endpoint to delete testing samples from a text classifier.
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_remove_training_samples(iname=instance_name,
                                                                   auth_token=auth_token,
                                                                   caller_name=caller_name,
                                                                   json_training_data={"samples": sample_list})
...
@controller_util.controller_decorator
def text_classifier_del_training_samples_all(user, token_info,
                                             instance_name):
    """
...
@controller_util.controller_decorator
def text_classifier_get_details(user, token_info,
                                instance_name):
    """
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_get_details(instance_name,
                                                                                  auth_token=auth_token,
                                                                                  caller_name=caller_name)
    return response_json, response_code
...
@controller_util.controller_decorator
def text_classifier_get_details_all(user, token_info):
    """
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_get_details_all(auth_token=auth_token,
                                                                                      caller_name=caller_name)
    return response_json, response_code


@controller_util.controller_decorator
def text_classifier_get_testing_samples(user, token_info,
                                        instance_name,
                                        index=None,
                                        len=None):
    """
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_get_testing_samples(iname=instance_name,
                                                               auth_token=auth_token,
                                                               index=index,
                                                               length=len,
                                                               caller_name=caller_name)
...
@controller_util.controller_decorator
def text_classifier_get_training_samples(user, token_info,
                                         instance_name,
                                         index=None,
                                         len=None):
    """
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_get_training_samples(iname=instance_name,
                                                                auth_token=auth_token,
                                                                index=index,
                                                                length=len,
                                                                caller_name=caller_name)
...
@controller_util.controller_decorator
def text_classifier_retrieve(user, token_info,
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_retrieve(instance_name,
                                                                               auth_token=auth_token,
                                                                               caller_name=caller_name,
...
@controller_util.controller_decorator
def text_classifier_train(user, token_info,
    ...
    if train_details is not None:
        ...
        # 'nearest_neighbour_l1', 'nearest_neighbour_cosine', 'naive_bayes', 'svm', etc."

        language_model_list = train_details.get("language_model_list")
        # e.g. [{'lang_code':'eng', 'lang_model': 'wm_eng1'}, {}, ...]
        ...
        language_model_list = None
        immediate_mode = None
        callback_url = None

    language_model_dict = None  # type: Optional[Dict[str, str]]

    if language_model_list is not None:
        language_model_dict = {}

        for labelled_language_model in language_model_list:
            lang_model = labelled_language_model.get("lang_model")
            lang_code = labelled_language_model.get("lang_code")
            if lang_model is not None and lang_code is not None:
                language_model_dict[lang_code] = lang_model

    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_train(instance_name,
                                                 auth_token=auth_token,
                                                 caller_name=caller_name,
                                                 weak_match_threshold=weak_match_threshold,
                                                 immediate_mode=immediate_mode,
                                                 clsfr_algorithm=clsfr_algorithm,
                                                 requested_language_model_dict=language_model_dict,
...
@controller_util.controller_decorator
def text_classifier_get_labels(user, token_info,
                               instance_name):
    """
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_get_class_labels(instance_name,
                                                                                       auth_token=auth_token,
                                                                                       caller_name=caller_name)
    return response_json, response_code
...
@controller_util.controller_decorator
def text_classifier_curate(user, token_info,
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_curate(instance_name,
                                                  auth_token=auth_token,
                                                  caller_name=caller_name,
...
@controller_util.controller_decorator
def text_classifier_tsne_post(user, token_info,
                              instance_name,
                              tsne_settings):
    """
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_tsne_post(instance_name,
                                                                                auth_token=auth_token,
                                                                                caller_name=caller_name,
...
def text_classifier_tsne_get(user, token_info,
                             instance_name):
    """
    Run TSNE dimensionality reduction and return the results.
    ...
    response_code, response_json = text_classifier_wrapper.text_clsfr_tsne_get(instance_name,
                                                                               auth_token=auth_token,
                                                                               caller_name=caller_name)
...
@controller_util.controller_decorator
def text_classifier_set_params(user, token_info,
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_set_params(instance_name,
                                                      auth_token=auth_token,
                                                      caller_name=caller_name,
...
@controller_util.controller_decorator
def text_classifier_get_params(user, token_info,
                               instance_name):
    """
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_get_params(instance_name,
                                                      auth_token=auth_token,
                                                      caller_name=caller_name)
...
@controller_util.controller_decorator
def text_classifier_online_training_samples(user, token_info,
                                            instance_name, labelled_text_sample_list):
    """
    ...
    response_code, response_json = \
        text_classifier_wrapper.text_clsfr_add_online_training_samples(iname=instance_name,
                                                                       auth_token=auth_token,
                                                                       caller_name=caller_name,
                                                                       json_training_data={"samples": sample_list})
