...
class Client(BaseClient):
                ...
                'PhoneNumberErrors': [
                    {
                        ...
                        |'PreconditionFailed'|'ResourceLimitExceeded'
                        |'ServiceFailure'|'AccessDenied'|'ServiceUnavailable'
                        |'Throttled'|'Unauthorized'|'Unprocessable'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **PhoneNumberErrors** *(list) --*
              ...
              If the action fails for one or more of the phone numbers in the request, a list of the
              ...
              - *(dict) --*
                ...
                request, a list of the phone numbers is returned, along with error codes and error
                messages.
    ...
    def batch_create_attendee(
        ...
        <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in the *Amazon Chime
        Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/BatchCreateAttendee>`_
          ...
          - *(dict) --*
            ...
            - **Attendees** *(list) --*
              ...
              - *(dict) --*
                ...
                DeleteAttendee is called. After that, the attendee is unable to join the meeting.
    ...
    def batch_suspend_user(
        ...
        Users suspended from a ``Team`` account are dissasociated from the account, but they can
        continue to use Amazon Chime as free users. To remove the suspension from suspended ``Team``
        account users, invite them to the ``Team`` account again. You can use the  InviteUsers
        action to do so.
        ...
        users, use the  BatchUnsuspendUser action.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UserErrors** *(list) --*
              ...
              If the  BatchSuspendUser action fails for one or more of the user IDs in the request,
    ...
    def batch_unsuspend_user(
        ...
        using this action. For more information about different account types, see `Managing Your
    ...
    def batch_update_phone_number(
        ...
        for each ``UpdatePhoneNumberRequestItem`` . For example, you can update either the product
    ...
    def batch_update_user(
        ...
        specified Amazon Chime account. Currently, only ``LicenseType`` updates are supported for
        this action.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UserErrors** *(list) --*
              ...
              If the  BatchUpdateUser action fails for one or more of the user IDs in the request, a
          ...
          - *(dict) --*
            ...
            - **Account** *(dict) --*
              ...
              - **AccountType** *(string) --*
                ...
                see `Managing Your Amazon Chime Accounts
                <https://docs.aws.amazon.com/chime/latest/ag/manage-chime-account.html>`__ in the
    ...
    def create_attendee(
        ...
        the Amazon Chime SDK, see `Using the Amazon Chime SDK
        <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in the *Amazon Chime
        Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/CreateAttendee>`_
    ...
    def create_meeting(
        ...
        attendees. For more information about the Amazon Chime SDK, see `Using the Amazon Chime SDK
        <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in the *Amazon Chime
        Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/CreateMeeting>`_
    ...
    def create_voice_connector_group(
        ...
        associate up to three existing Amazon Chime Voice Connectors with the Amazon Chime Voice
    ...
    def delete_account(self, AccountId: str) -> Dict[str, Any]:
        """
        Deletes the specified Amazon Chime account. You must suspend all users before deleting a
        ``Team`` account. You can use the  BatchSuspendUser action to do so.

        For ``EnterpriseLWA`` and ``EnterpriseAD`` accounts, you must release the claimed domains
        for your Amazon Chime account before deletion. As soon as you release the domain, all users
        ...
        After 90 days, deleted accounts are permanently removed from your ``Disabled`` accounts
        list.
    ...
    def delete_attendee(self, MeetingId: str, AttendeeId: str) -> None:
        ...
        deleted. For more information about the Amazon Chime SDK, see `Using the Amazon Chime SDK
        <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in the *Amazon Chime
        Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/DeleteAttendee>`_
    ...
    def delete_meeting(self, MeetingId: str) -> None:
        """
        Deletes the specified Amazon Chime SDK meeting. When a meeting is deleted, its attendees are
        also deleted and clients can no longer join it. For more information about the Amazon Chime
        SDK, see `Using the Amazon Chime SDK
        <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in the *Amazon Chime
        Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/DeleteMeeting>`_
    ...
    def get_account_settings(self, AccountId: str) -> ClientGetAccountSettingsResponseTypeDef:
        ...
        and dial out settings. For more information about these settings, see `Use the Policies Page
        <https://docs.aws.amazon.com/chime/latest/ag/policies.html>`__ in the *Amazon Chime
    ...
    def get_attendee(self, MeetingId: str, AttendeeId: str) -> ClientGetAttendeeResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/GetAttendee>`_
    ...
    def get_bot(self, AccountId: str, BotId: str) -> ClientGetBotResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/GetBot>`_
    ...
    def get_meeting(self, MeetingId: str) -> ClientGetMeetingResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/GetMeeting>`_
          ...
          ::

            {
                'PhoneNumber': {
                    ...
                    |'ReleaseInProgress'|'DeleteInProgress'|'ReleaseFailed'
                    |'DeleteFailed',
                    'Capabilities': {
          ...
          - *(dict) --*
            ...
            - **Termination** *(dict) --*
              ...
              - **CpsLimit** *(integer) --*
                ...
                The limit on calls per second. Max value based on account service limit. Default
                value of 1.
                ...
                'Accounts': [
                    {
                        ...
                        'Name': 'string',
                        'AccountType':
                        'Team'|'EnterpriseDirectory'|'EnterpriseLWA'
                        |'EnterpriseOIDC',
                        'CreatedTimestamp': datetime(2015, 1, 1),
                        'DefaultLicense': 'Basic'|'Plus'|'Pro'|'ProTrial',
                        'SupportedLicenses': [
    ...
    def list_attendees(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/ListAttendees>`_
    ...
    def list_meetings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/chime-2018-05-01/ListMeetings>`_
                ...
                'PhoneNumbers': [
                    {
                        ...
                        'Associations': [
                            {
                                'Value': 'string',
                                'Name':
                                'AccountId'|'UserId'|'VoiceConnectorId'
                        ...
                        'CallingName': 'string',
                        'CallingNameStatus':
                        'Unassigned'|'UpdateInProgress'|'UpdateSucceeded'
                        |'UpdateFailed',
                        'CreatedTimestamp': datetime(2015, 1, 1),
                        'UpdatedTimestamp': datetime(2015, 1, 1),
                        'DeletionTimestamp': datetime(2015, 1, 1)
    ...
    def list_rooms(
        ...
        """
        Lists the room details for the specified Amazon Chime account. Optionally, filter the
        results by a member ID (user ID or bot ID) to see a list of rooms that the member belongs
        to.
    ...
    def put_voice_connector_streaming_configuration(
        ...
        configuration specifies whether media streaming is enabled for sending to Amazon Kinesis. It
        also sets the retention period, in hours, for the Amazon Kinesis data.
    ...
    def update_room_membership(
        ...
        """
        Updates room membership details, such as member role. The member role designates whether the
        member is a chat room administrator or a general chat room member. Member role can only be
        updated for user IDs.
    ...
    def update_voice_connector_group(
        ...
        """
        Updates details for the specified Amazon Chime Voice Connector group, such as the name and
