...
class Client(BaseClient):
    ...
    def batch_create_attendee(
        ...
        <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in the *Amazon Chime Developer
        Guide* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Errors** *(list) --*
              ...
              If the action fails for one or more of the attendees in the request, a list of the attendees
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Errors** *(list) --*
              ...
              If the action fails for one or more of the member IDs in the request, a list of the member IDs
              is returned, along with error codes and error messages.
    ...
    def batch_delete_phone_number(
        ...
        """
        Moves phone numbers into the **Deletion queue** . Phone numbers must be disassociated from any users
        or Amazon Chime Voice Connectors before they can be deleted.
    ...
    def batch_suspend_user(
        ...
        Users suspended from a ``Team`` account are dissasociated from the account, but they can continue to
        use Amazon Chime as free users. To remove the suspension from suspended ``Team`` account users,
        invite them to the ``Team`` account again. You can use the  InviteUsers action to do so.

        Users suspended from an ``EnterpriseLWA`` account are immediately signed out of Amazon Chime and can
        no longer sign in. To remove the suspension from suspended ``EnterpriseLWA`` account users, use the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UserErrors** *(list) --*
              ...
              If the  BatchUnsuspendUser action fails for one or more of the user IDs in the request, a list
              of the user IDs is returned, along with error codes and error messages.
    ...
    def create_voice_connector(
        ...
        Enabling  CreateVoiceConnectorRequest$RequireEncryption configures your Amazon Chime Voice Connector
        to use TLS transport for SIP signaling and Secure RTP (SRTP) for media. Inbound calls use TLS
    ...
    def delete_meeting(self, MeetingId: str) -> None:
        """
        Deletes the specified Amazon Chime SDK meeting. When a meeting is deleted, its attendees are also
        deleted and clients can no longer join it. For more information about the Amazon Chime SDK, see
        `Using the Amazon Chime SDK <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__ in
    ...
    def list_meetings(
        ...
        """
        Lists up to 100 active Amazon Chime SDK meetings. For more information about the Amazon Chime SDK,
        see `Using the Amazon Chime SDK <https://docs.aws.amazon.com/chime/latest/dg/meetings-sdk.html>`__
    ...
    def list_room_memberships(
        ...
        """
        Lists the membership details for the specified room, such as member IDs, member email addresses, and
        member names.
    ...
    def update_account(
        ...
        """
        Updates account details for the specified Amazon Chime account. Currently, only account name updates
        ...
        **Request Syntax**
        ...
        :param AccountSettings: **[REQUIRED]**
          ...
          - **EnableDialOut** *(boolean) --*
            ...
            Setting that allows meeting participants to choose the **Call me at a phone number** option. For
            more information, see `Join a Meeting without the Amazon Chime App
            <https://docs.aws.amazon.com/chime/latest/ug/chime-join-meeting.html>`__ .
    ...
    def update_phone_number(
        ...
        type or the calling name in one action.
    ...
    def update_room_membership(
        ...
        is a chat room administrator or a general chat room member. Member role can only be updated for user
        IDs.
