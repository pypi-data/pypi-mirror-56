...
class Client(BaseClient):
    ...
    def create_contact(
        ...
        **Request Syntax**
        ...
        :param PhoneNumber:
          ...
          The phone number of the contact in E.164 format. The phone number type defaults to WORK.
          You can specify PhoneNumber or PhoneNumbers. We recommend that you use PhoneNumbers, which
    ...
    def create_network_profile(
        ...
        **Request Syntax**
        ...
        :param TrustAnchors:
          ...
          The root certificates of your authentication server that is installed on your devices and
    ...
    def create_profile(
        ...
        MeetingRoomConfiguration: ClientCreateProfileMeetingRoomConfigurationTypeDef = None,
    ) -> ClientCreateProfileResponseTypeDef:
        """
        ...
        **Request Syntax**
          ...
          response = client.create_profile(
              ...
              MeetingRoomConfiguration={
                  ...
                  'EndOfMeetingReminder': {
                      ...
                      'ReminderType':
                      'ANNOUNCEMENT_TIME_CHECK'|'ANNOUNCEMENT_VARIABLE_TIME_LEFT'
                      |'CHIME'|'KNOCK',
                      'Enabled': True|False
                  },
                  'InstantBooking': {
        ...
        :param MeetingRoomConfiguration:
          ...
          - **RequireCheckIn** *(dict) --*
            ...
            reservation if it's not checked into to make the room available for others. Users can
    ...
    def create_skill_group(
        self, SkillGroupName: str, Description: str = None, ClientRequestToken: str = None
    ) -> ClientCreateSkillGroupResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_device_usage_data(self, DeviceArn: str, DeviceUsageType: str) -> Dict[str, Any]:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_address_book(self, AddressBookArn: str) -> ClientGetAddressBookResponseTypeDef:
        """
          ...
          - *(dict) --*
            ...
            - **Contact** *(dict) --*
              ...
              - **PhoneNumber** *(string) --*
                ...
                either specify PhoneNumber or PhoneNumbers. We recommend that you use PhoneNumbers,
                ...
                'Device': {
                    ...
                    'DeviceStatusInfo': {
                        'DeviceStatusDetails': [
                            {
                                'Feature':
                                'BLUETOOTH'|'VOLUME'|'NOTIFICATIONS'|'LISTS'
                                |'SKILLS'|'NETWORK_PROFILE'|'SETTINGS'
                                |'ALL',
                                'Code':
                                ...
                                |'AUTHENTICATION_FAILURE'|'DHCP_FAILURE'
                                |'INTERNET_UNAVAILABLE'|'DNS_FAILURE'
                                |'UNKNOWN_FAILURE'
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_gateway_group(self, GatewayGroupArn: str) -> ClientGetGatewayGroupResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_network_profile(self, NetworkProfileArn: str) -> ClientGetNetworkProfileResponseTypeDef:
        """
            ...
            - **Profile** *(dict) --*
              ...
              - **MeetingRoomConfiguration** *(dict) --*
                ...
                - **RequireCheckIn** *(dict) --*
                  ...
                  Settings for requiring a check in when a room is reserved. Alexa can cancel a room
                  reservation if it's not checked into. This makes the room available for others.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_skill_group(self, SkillGroupArn: str = None) -> ClientGetSkillGroupResponseTypeDef:
        """
    ...
    def list_device_events(
        self, DeviceArn: str, EventType: str = None, NextToken: str = None, MaxResults: int = None
    ) -> ClientListDeviceEventsResponseTypeDef:
        """
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          from this action. If this parameter is specified, the response only includes results
          beyond the token, up to the value specified by MaxResults. When the end of results is
    ...
    def list_gateways(
        ...
        gateway. An optional gateway group ARN can be provided to only retrieve gateway summaries of
    ...
    def put_conference_preference(
        self, ConferencePreference: ClientPutConferencePreferenceConferencePreferenceTypeDef
    ) -> Dict[str, Any]:
        """
    ...
    def put_skill_authorization(
        ...
        an assumed IAM role, the skill being linked must be a private skill. Also, the skill must be
        owned by the AWS account that assumed the IAM role.
        ...
        **Request Syntax**
        ...
        :param AuthorizationResult: **[REQUIRED]**
          ...
          The authorization result specific to OAUTH code grant output. "Code” must be populated in
          the AuthorizationResult map to establish the authorization.
    ...
    def register_avs_device(
        self, ClientId: str, UserCode: str, ProductId: str, DeviceSerialNumber: str, AmazonId: str
    ) -> ClientRegisterAvsDeviceResponseTypeDef:
        """
        ...
        **Request Syntax**
        ...
        :param UserCode: **[REQUIRED]**
          ...
          The code that is obtained after your AVS device has made a POST request to LWA as a part
          of the Device Authorization Request component of the OAuth code-based linking
          specification.
        ...
        :param DeviceSerialNumber: **[REQUIRED]**
          ...
          The key generated by the OEM that uniquely identifies a specified instance of your AVS
          device.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def resolve_room(self, UserId: str, SkillId: str) -> ClientResolveRoomResponseTypeDef:
        """
    ...
    def search_address_books(
        ...
        **Request Syntax**
        ...
        :param SortCriteria:
          ...
          The sort order to use in listing the specified set of address books. The supported sort
    ...
    def search_contacts(
        ...
        **Request Syntax**
        ...
        :param SortCriteria:
          ...
          The sort order to use in listing the specified set of contacts. The supported sort keys
          are DisplayName, FirstName, and LastName.
    ...
    def search_skill_groups(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          An optional token returned from a prior request. Use this token for pagination of results
          from this action. If this parameter is specified, the response includes only results
          beyond the token, up to the value specified by ``MaxResults`` . Required.
        ...
        :param Content: **[REQUIRED]**
          ...
          - **AudioList** *(list) --*
            ...
            - *(dict) --*
              ...
              information, see `FFmpeg <https://www.ffmpeg.org/>`__ . The following command converts
              the provided <input-file> to an MP3 file that is played in the announcement:
    ...
    def start_device_sync(
        ...
        * Settings - This internally syncs the room's profile (if the device is assigned to a room),
        contacts, address books, delegation access for account linking, and communications (if
        ...
        **Request Syntax**
        ::
          ...
          response = client.start_device_sync(
              ...
              DeviceArn='string',
              Features=[
                  'BLUETOOTH'|'VOLUME'|'NOTIFICATIONS'|'LISTS'|'SKILLS'|'NETWORK_PROFILE'|'SETTINGS'
                  |'ALL',
              ]
          )
        :type RoomArn: string
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def tag_resource(self, Arn: str, Tags: List[ClientTagResourceTagsTypeDef]) -> Dict[str, Any]:
        """
    ...
    def update_contact(
        ...
        **Request Syntax**
        ...
        :param PhoneNumber:
          ...
          The updated phone number of the contact. The phone number type defaults to WORK. You can
    ...
    def update_profile(
        ...
        MaxVolumeLimit: int = None,
        PSTNEnabled: bool = None,
        MeetingRoomConfiguration: ClientUpdateProfileMeetingRoomConfigurationTypeDef = None,
    ) -> Dict[str, Any]:
        """
