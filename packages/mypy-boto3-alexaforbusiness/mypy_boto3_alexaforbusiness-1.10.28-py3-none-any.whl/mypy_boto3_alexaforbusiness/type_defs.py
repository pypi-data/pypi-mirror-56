...
_ClientCreateBusinessReportScheduleContentRangeTypeDef = TypedDict(
    "_ClientCreateBusinessReportScheduleContentRangeTypeDef", {"Interval": str}, total=False
)
...
_ClientCreateConferenceProviderIPDialInTypeDef = TypedDict(
    "_ClientCreateConferenceProviderIPDialInTypeDef", {"Endpoint": str, "CommsProtocol": str}
)


class ClientCreateConferenceProviderIPDialInTypeDef(_ClientCreateConferenceProviderIPDialInTypeDef):
    """
...
_ClientCreateProfileMeetingRoomConfigurationEndOfMeetingReminderTypeDef = TypedDict(
    ...
    {"ReminderAtMinutes": List[int], "ReminderType": str, "Enabled": bool},
)
...
class ClientCreateProfileMeetingRoomConfigurationEndOfMeetingReminderTypeDef(
    ...
    """
    Type definition for `ClientCreateProfileMeetingRoomConfiguration` `EndOfMeetingReminder`

    Creates settings for the end of meeting reminder feature that are applied to a room profile. The
...
class ClientCreateProfileMeetingRoomConfigurationInstantBookingTypeDef(
    ...
    """
    Type definition for `ClientCreateProfileMeetingRoomConfiguration` `InstantBooking`

    Settings to automatically book a room for a configured duration if it's free when joining a
    meeting with Alexa.

    - **DurationInMinutes** *(integer) --* **[REQUIRED]**

      Duration between 15 and 240 minutes at increments of 15 that determines how long to book an
      available room when a meeting is started with Alexa.
...
class ClientCreateProfileMeetingRoomConfigurationRequireCheckInTypeDef(
    ...
    """
    Type definition for `ClientCreateProfileMeetingRoomConfiguration` `RequireCheckIn`

    Settings for requiring a check in when a room is reserved. Alexa can cancel a room reservation
    if it's not checked into to make the room available for others. Users can check in by joining
    the meeting with Alexa or an AVS device, or by saying “Alexa, check in.”

    - **ReleaseAfterMinutes** *(integer) --* **[REQUIRED]**

      Duration between 5 and 20 minutes to determine when to release the room if it's not checked
      into.
...
class ClientCreateProfileMeetingRoomConfigurationTypeDef(
    ...
    """
    Type definition for `ClientCreateProfile` `MeetingRoomConfiguration`
...
_ClientCreateRoomTagsTypeDef = TypedDict("_ClientCreateRoomTagsTypeDef", {"Key": str, "Value": str})
...
_ClientCreateUserTagsTypeDef = TypedDict("_ClientCreateUserTagsTypeDef", {"Key": str, "Value": str})
...
_ClientGetContactResponseContactPhoneNumbersTypeDef = TypedDict(
    "_ClientGetContactResponseContactPhoneNumbersTypeDef", {"Number": str, "Type": str}, total=False
)
...
class ClientGetNetworkProfileResponseNetworkProfileTypeDef(
    ...
    - **SecurityType** *(string) --*
      ...
      The security type of the Wi-Fi network. This can be WPA2_ENTERPRISE, WPA2_PSK, WPA_PSK, WEP,
      or OPEN.
    ...
    - **CertificateAuthorityArn** *(string) --*
      ...
      This is used to issue certificates to the devices.
...
class ClientGetProfileResponseProfileMeetingRoomConfigurationEndOfMeetingReminderTypeDef(
    ...
    """
    Type definition for `ClientGetProfileResponseProfileMeetingRoomConfiguration`
...
class ClientGetProfileResponseProfileMeetingRoomConfigurationInstantBookingTypeDef(
    ...
    """
    Type definition for `ClientGetProfileResponseProfileMeetingRoomConfiguration` `InstantBooking`

    Settings to automatically book the room if available for a configured duration when joining a
    meeting with Alexa.
...
class ClientGetProfileResponseProfileMeetingRoomConfigurationRequireCheckInTypeDef(
    ...
    """
    Type definition for `ClientGetProfileResponseProfileMeetingRoomConfiguration` `RequireCheckIn`

    Settings for requiring a check in when a room is reserved. Alexa can cancel a room reservation
    if it's not checked into. This makes the room available for others. Users can check in by
    joining the meeting with Alexa or an AVS device, or by saying “Alexa, check in.”
...
class ClientGetProfileResponseProfileMeetingRoomConfigurationTypeDef(
    ...
    """
    Type definition for `ClientGetProfileResponseProfile` `MeetingRoomConfiguration`
    ...
    - **EndOfMeetingReminder** *(dict) --*
      ...
      Settings for the end of meeting reminder feature that are applied to a room profile. The end
...
class ClientGetProfileResponseProfileTypeDef(_ClientGetProfileResponseProfileTypeDef):
    ...
    - **MeetingRoomConfiguration** *(dict) --*
      ...
      - **InstantBooking** *(dict) --*
        ...
        Settings to automatically book the room if available for a configured duration when joining
        a meeting with Alexa.
      ...
      - **RequireCheckIn** *(dict) --*
        ...
        check in by joining the meeting with Alexa or an AVS device, or by saying “Alexa, check in.”
...
class ClientListBusinessReportSchedulesResponseBusinessReportSchedulesContentRangeTypeDef(
    ...
    """
    Type definition for `ClientListBusinessReportSchedulesResponseBusinessReportSchedules`
    `ContentRange`
...
class ClientListBusinessReportSchedulesResponseBusinessReportSchedulesLastBusinessReportS3LocationTypeDef(
    ...
    """
    Type definition for
    `ClientListBusinessReportSchedulesResponseBusinessReportSchedulesLastBusinessReport`
    `S3Location`
...
class ClientListConferenceProvidersResponseConferenceProvidersTypeDef(
    ...
    An entity that provides a conferencing solution. Alexa for Business acts as the voice interface
    and mediator that connects users to their preferred conference provider. Examples of conference
    providers include Amazon Chime, Zoom, Cisco, and Polycom.
...
class ClientListSkillsStoreSkillsByCategoryResponseSkillsStoreSkillsSkillDetailsDeveloperInfoTypeDef(
    ...
    """
    Type definition for `ClientListSkillsStoreSkillsByCategoryResponseSkillsStoreSkillsSkillDetails`
    `DeveloperInfo`
...
class ClientListSkillsStoreSkillsByCategoryResponseSkillsStoreSkillsSkillDetailsTypeDef(
    ...
    """
    Type definition for `ClientListSkillsStoreSkillsByCategoryResponseSkillsStoreSkills`
    `SkillDetails`
...
class ClientListSmartHomeAppliancesResponseSmartHomeAppliancesTypeDef(
    ...
    A smart home appliance that can connect to a central system. Any domestic device can be a smart
    appliance.
...
class ClientSearchAddressBooksFiltersTypeDef(_ClientSearchAddressBooksFiltersTypeDef):
    ...
    A filter name and value pair that is used to return a more specific list of results. Filters can
    be used to match a set of resources by various criteria.
...
class ClientSearchAddressBooksSortCriteriaTypeDef(_ClientSearchAddressBooksSortCriteriaTypeDef):
    """
...
class ClientSearchContactsResponseContactsTypeDef(_ClientSearchContactsResponseContactsTypeDef):
    ...
    - **PhoneNumber** *(string) --*
      ...
      PhoneNumber or PhoneNumbers. We recommend that you use PhoneNumbers, which lets you specify
...
class ClientSearchNetworkProfilesFiltersTypeDef(_ClientSearchNetworkProfilesFiltersTypeDef):
    """
...
class ClientSearchNetworkProfilesResponseTypeDef(_ClientSearchNetworkProfilesResponseTypeDef):
    ...
    - **NextToken** *(string) --*
      ...
      this action. If this parameter is specified, the response includes only results beyond the
...
class ClientSearchSkillGroupsSortCriteriaTypeDef(_ClientSearchSkillGroupsSortCriteriaTypeDef):
    """
...
class ClientSendAnnouncementContentAudioListTypeDef(_ClientSendAnnouncementContentAudioListTypeDef):
    ...
    The audio message. There is a 1 MB limit on the audio file input and the only supported format
    is MP3. To convert your MP3 audio files to an Alexa-friendly,

    required codec version (MPEG version 2) and bit rate (48 kbps), you might use converter
    software. One option for this is a command-line tool, FFmpeg. For more information, see `FFmpeg
    <https://www.ffmpeg.org/>`__ . The following command converts the provided <input-file> to an
    MP3 file that is played in the announcement:
    ...
    - **Location** *(string) --* **[REQUIRED]**
      ...
      The location of the audio file. Currently, S3 URLs are supported. Only S3 locations comprised
      of safe characters are valid. For more information, see `Safe Characters
...
class ClientSendAnnouncementContentTextListTypeDef(_ClientSendAnnouncementContentTextListTypeDef):
    """
...
class ClientSendAnnouncementRoomFiltersTypeDef(_ClientSendAnnouncementRoomFiltersTypeDef):
    """
...
_ClientUpdateConferenceProviderIPDialInTypeDef = TypedDict(
    "_ClientUpdateConferenceProviderIPDialInTypeDef", {"Endpoint": str, "CommsProtocol": str}
)


class ClientUpdateConferenceProviderIPDialInTypeDef(_ClientUpdateConferenceProviderIPDialInTypeDef):
    """
...
class ClientUpdateProfileMeetingRoomConfigurationEndOfMeetingReminderTypeDef(
    ...
    """
    Type definition for `ClientUpdateProfileMeetingRoomConfiguration` `EndOfMeetingReminder`
...
class ClientUpdateProfileMeetingRoomConfigurationInstantBookingTypeDef(
    ...
    """
    Type definition for `ClientUpdateProfileMeetingRoomConfiguration` `InstantBooking`

    Settings to automatically book an available room available for a configured duration when
    joining a meeting with Alexa.
...
class ClientUpdateProfileMeetingRoomConfigurationRequireCheckInTypeDef(
    ...
    """
    Type definition for `ClientUpdateProfileMeetingRoomConfiguration` `RequireCheckIn`
...
class ClientUpdateProfileMeetingRoomConfigurationTypeDef(
    ...
    """
    Type definition for `ClientUpdateProfile` `MeetingRoomConfiguration`
...
class ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesContentRangeTypeDef(
    ...
    """
    Type definition for `ListBusinessReportSchedulesPaginateResponseBusinessReportSchedules`
    `ContentRange`
...
class ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesLastBusinessReportS3LocationTypeDef(
    ...
    """
    Type definition for
    `ListBusinessReportSchedulesPaginateResponseBusinessReportSchedulesLastBusinessReport`
    `S3Location`
...
class ListConferenceProvidersPaginateResponseConferenceProvidersMeetingSettingTypeDef(
    ...
    """
    Type definition for `ListConferenceProvidersPaginateResponseConferenceProviders`
    `MeetingSetting`
...
class ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsSkillDetailsDeveloperInfoTypeDef(
    ...
    """
    Type definition for
    `ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsSkillDetails` `DeveloperInfo`
...
class ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkillsSkillDetailsTypeDef(
    ...
    """
    Type definition for `ListSkillsStoreSkillsByCategoryPaginateResponseSkillsStoreSkills`
    `SkillDetails`
...
class SearchDevicesPaginateSortCriteriaTypeDef(_SearchDevicesPaginateSortCriteriaTypeDef):
    """
...
class SearchProfilesPaginateSortCriteriaTypeDef(_SearchProfilesPaginateSortCriteriaTypeDef):
    """
...
class SearchSkillGroupsPaginateSortCriteriaTypeDef(_SearchSkillGroupsPaginateSortCriteriaTypeDef):
    """
