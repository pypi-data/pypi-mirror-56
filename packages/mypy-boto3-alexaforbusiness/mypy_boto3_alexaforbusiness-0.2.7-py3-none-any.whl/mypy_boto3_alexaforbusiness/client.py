...
class Client(BaseClient):
    ...
    def associate_skill_group_with_room(
        ...
        """
        Associates a skill group with a given room. This enables all skills in the associated skill group on
                        ...
                        'DeviceStatusDetails': [
                            {
                                ...
                                |'AUTHENTICATION_FAILURE'|'DHCP_FAILURE'|'INTERNET_UNAVAILABLE'
                                |'DNS_FAILURE'|'UNKNOWN_FAILURE'|'CERTIFICATE_ISSUING_LIMIT_EXCEEDED'
    ...
    def search_profiles(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          The filters to use to list a specified set of room profiles. Supported filter keys are ProfileName
    ...
    def send_announcement(
        ...
        **Request Syntax**
        ...
        :param RoomFilters: **[REQUIRED]**
          ...
          The filters to use to send an announcement to a specified list of rooms. The supported filter keys
          are RoomName, ProfileName, RoomArn, and ProfileArn. To send to all rooms, specify an empty
          RoomFilters list.
    ...
    def send_invitation(self, UserArn: str = None) -> Dict[str, Any]:
        """
        Sends an enrollment invitation email with a URL to a user. The URL is valid for 30 days or until you
        call this operation again, whichever comes first.
