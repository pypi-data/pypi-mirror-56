...
@pytest.fixture
def device():
    device = MuranoClient(**{'murano_host': 'https://z4fwqr3fmr0200000.m2.exosite.io',
                             'murano_id': 'demo',
                             'murano_token': '22e155f4edfd17100f9e53b0fc112e4e74703a47',
                             'watchlist': ['data_in'],
                             'murano_port': 443,
                             'memory_queue': False
                             }
...
def queuing(device, mocker):
    ...
    queuing = Queuing('https://z4fwqr3fmr0200000.m2.exosite.io/',
                      'j1939', device)
    return queuing
...
def test_consume_table(mocker, device):
    ...
    queuing = Queuing(
        'https://z4fwqr3fmr0200000.m2.exosite.io/', 'j1939', device)
...
def test_product_id(queuing):
    assert queuing.product_id(
        'mqtt://z4fwqr3fmr0200000.m2.exosite.io/') == 'z4fwqr3fmr0200000'
    assert queuing.product_id(
        'https://z4fwqr3fmr0200000.m2.exosite.io/') == 'z4fwqr3fmr0200000'
...
def test_tell(mocker, protocol, device):
    ...
    queuing = Queuing(protocol+'://z4fwqr3fmr0200000.m2.exosite.io/',
                      'j1939', device)
    # test table is empty
