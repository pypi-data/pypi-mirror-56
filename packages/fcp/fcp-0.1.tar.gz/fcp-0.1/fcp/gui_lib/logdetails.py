...
class Ui_LogDetails(object):
    ...
    def retranslateUi(self, LogDetails):
        LogDetails.setWindowTitle(QtWidgets.QApplication.translate("LogDetails", "LogDetails", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("LogDetails", "Log", None, -1))
        self.nameLabel.setText(QtWidgets.QApplication.translate("LogDetails", "name", None, -1))
        self.idLabel.setText(QtWidgets.QApplication.translate("LogDetails", "id", None, -1))
        self.n_argsLabel.setText(QtWidgets.QApplication.translate("LogDetails", "n_args", None, -1))
        self.commentLabel.setText(QtWidgets.QApplication.translate("LogDetails", "comment", None, -1))
        self.stringLabel.setText(QtWidgets.QApplication.translate("LogDetails", "string", None, -1))
        self.logDeleteButton.setText(QtWidgets.QApplication.translate("LogDetails", "Delete", None, -1))
