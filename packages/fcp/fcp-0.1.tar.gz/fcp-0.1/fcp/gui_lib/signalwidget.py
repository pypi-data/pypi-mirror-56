...
class Ui_SignalWidget(object):
    ...
    def retranslateUi(self, SignalWidget):
        SignalWidget.setWindowTitle(QtWidgets.QApplication.translate("SignalWidget", "SignalWidget", None, -1))
        self.signalDetailsButton.setText(QtWidgets.QApplication.translate("SignalWidget", "Details", None, -1))
