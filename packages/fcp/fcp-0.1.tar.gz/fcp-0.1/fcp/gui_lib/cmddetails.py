...
class Ui_CmdDetails(object):
    ...
    def retranslateUi(self, CmdDetails):
        CmdDetails.setWindowTitle(QtWidgets.QApplication.translate("CmdDetails", "CmdDetails", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("CmdDetails", "Command", None, -1))
        self.nameLabel.setText(QtWidgets.QApplication.translate("CmdDetails", "name", None, -1))
        self.commentLabel.setText(QtWidgets.QApplication.translate("CmdDetails", "comment", None, -1))
        self.n_argsLabel.setText(QtWidgets.QApplication.translate("CmdDetails", "n_args", None, -1))
        self.idLabel.setText(QtWidgets.QApplication.translate("CmdDetails", "id", None, -1))
        self.addArgButton.setText(QtWidgets.QApplication.translate("CmdDetails", "Add Arg", None, -1))
        self.deleteCmdButton.setText(QtWidgets.QApplication.translate("CmdDetails", "Delete", None, -1))
