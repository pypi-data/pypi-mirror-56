...
class Ui_CfgDetails(object):
    ...
    def retranslateUi(self, CfgDetails):
        CfgDetails.setWindowTitle(QtWidgets.QApplication.translate("CfgDetails", "CfgDetails", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("CfgDetails", "Config", None, -1))
        self.nameLabel.setText(QtWidgets.QApplication.translate("CfgDetails", "name", None, -1))
        self.idLabel_2.setText(QtWidgets.QApplication.translate("CfgDetails", "id", None, -1))
        self.commentLabel.setText(QtWidgets.QApplication.translate("CfgDetails", "comment", None, -1))
        self.deleteCfgButton.setText(QtWidgets.QApplication.translate("CfgDetails", "Delete", None, -1))
