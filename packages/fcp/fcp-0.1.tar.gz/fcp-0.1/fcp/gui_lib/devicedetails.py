...
class Ui_DeviceDetails(object):
    ...
    def retranslateUi(self, DeviceDetails):
        DeviceDetails.setWindowTitle(QtWidgets.QApplication.translate("DeviceDetails", "DeviceDetails", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("DeviceDetails", "Device", None, -1))
        self.nameLabel.setText(QtWidgets.QApplication.translate("DeviceDetails", "name", None, -1))
        self.idLabel.setText(QtWidgets.QApplication.translate("DeviceDetails", "id", None, -1))
        self.cmdsButton.setText(QtWidgets.QApplication.translate("DeviceDetails", "Cmds", None, -1))
        self.cfgsButton.setText(QtWidgets.QApplication.translate("DeviceDetails", "Cfgs", None, -1))
        self.addButton.setText(QtWidgets.QApplication.translate("DeviceDetails", "Add", None, -1))
        self.deleteDeviceButton.setText(QtWidgets.QApplication.translate("DeviceDetails", "Delete", None, -1))
