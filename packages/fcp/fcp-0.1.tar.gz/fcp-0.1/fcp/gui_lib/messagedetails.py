...
class Ui_MessageDetails(object):
    ...
    def retranslateUi(self, MessageDetails):
        MessageDetails.setWindowTitle(QtWidgets.QApplication.translate("MessageDetails", "MessageDetails", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("MessageDetails", "Message", None, -1))
        self.nameLabel.setText(QtWidgets.QApplication.translate("MessageDetails", "name", None, -1))
        self.idLabel.setText(QtWidgets.QApplication.translate("MessageDetails", "id", None, -1))
        self.dlcLabel.setText(QtWidgets.QApplication.translate("MessageDetails", "dlc", None, -1))
        self.frequencyLabel.setText(QtWidgets.QApplication.translate("MessageDetails", "frequency", None, -1))
        self.addButton.setText(QtWidgets.QApplication.translate("MessageDetails", "Add", None, -1))
        self.deleteMessageButton.setText(QtWidgets.QApplication.translate("MessageDetails", "Delete", None, -1))
