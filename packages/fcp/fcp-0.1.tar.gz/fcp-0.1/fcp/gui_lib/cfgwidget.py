...
class Ui_CfgWidget(object):
    ...
    def retranslateUi(self, CfgWidget):
        CfgWidget.setWindowTitle(QtWidgets.QApplication.translate("CfgWidget", "CfgWidget", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("CfgWidget", "Configs", None, -1))
        self.addCfgButton.setText(QtWidgets.QApplication.translate("CfgWidget", "Add Cfg", None, -1))
