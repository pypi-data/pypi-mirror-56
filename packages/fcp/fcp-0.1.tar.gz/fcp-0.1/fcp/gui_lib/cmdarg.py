...
class Ui_CmdArg(object):
    ...
    def retranslateUi(self, CmdArg):
        CmdArg.setWindowTitle(QtWidgets.QApplication.translate("CmdArg", "CmdArg", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("CmdArg", "Argument", None, -1))
        self.idLabel.setText(QtWidgets.QApplication.translate("CmdArg", "id", None, -1))
        self.nameLabel.setText(QtWidgets.QApplication.translate("CmdArg", "name", None, -1))
        self.commentLabel.setText(QtWidgets.QApplication.translate("CmdArg", "comment", None, -1))
        self.deleteArgButton.setText(QtWidgets.QApplication.translate("CmdArg", "Delete", None, -1))
