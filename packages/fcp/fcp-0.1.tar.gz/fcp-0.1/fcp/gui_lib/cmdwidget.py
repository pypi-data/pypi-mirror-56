...
class Ui_CmdWidget(object):
    ...
    def retranslateUi(self, CmdWidget):
        CmdWidget.setWindowTitle(QtWidgets.QApplication.translate("CmdWidget", "CmdWidget", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("CmdWidget", "Commands", None, -1))
        self.addCmdButton.setText(QtWidgets.QApplication.translate("CmdWidget", "Add Cmd", None, -1))
