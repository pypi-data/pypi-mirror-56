...
class Ui_LogWidget(object):
    ...
    def retranslateUi(self, LogWidget):
        LogWidget.setWindowTitle(QtWidgets.QApplication.translate("LogWidget", "LogWidget", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("LogWidget", "Logs", None, -1))
        self.addLogButton.setText(QtWidgets.QApplication.translate("LogWidget", "Add Log", None, -1))
