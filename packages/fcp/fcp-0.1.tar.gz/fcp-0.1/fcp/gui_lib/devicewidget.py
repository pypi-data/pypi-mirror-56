...
class Ui_DeviceWidget(object):
    ...
    def retranslateUi(self, DeviceWidget):
        DeviceWidget.setWindowTitle(QtWidgets.QApplication.translate("DeviceWidget", "DeviceWidget", None, -1))
        self.deviceDetailsButton.setText(QtWidgets.QApplication.translate("DeviceWidget", "Details", None, -1))
