...
class Ui_MessageWidget(object):
    ...
    def retranslateUi(self, MessageWidget):
        MessageWidget.setWindowTitle(QtWidgets.QApplication.translate("MessageWidget", "MessageWidget", None, -1))
        self.messageDetailsButton.setText(QtWidgets.QApplication.translate("MessageWidget", "Details", None, -1))
