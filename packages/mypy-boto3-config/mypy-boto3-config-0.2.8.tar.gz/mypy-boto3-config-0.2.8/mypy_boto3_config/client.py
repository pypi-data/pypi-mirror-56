...
class Client(BaseClient):
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **unprocessedResourceKeys** *(list) --*
              ...
              unprocessed resource keys, the response contains an empty unprocessedResourceKeys
              list.
    ...
    def delete_config_rule(self, ConfigRuleName: str) -> None:
        ...
        AWS Config sets the state of a rule to ``DELETING`` until the deletion is complete. You
    ...
    def delete_conformance_pack(self, ConformancePackName: str) -> None:
        ...
        AWS Config sets the conformance pack to ``DELETE_IN_PROGRESS`` until the deletion is
    ...
    def delete_delivery_channel(self, DeliveryChannelName: str) -> None:
        ...
        using the  StopConfigurationRecorder action.
    ...
    def delete_organization_config_rule(self, OrganizationConfigRuleName: str) -> None:
        ...
        member accounts in that organization. Only a master account can delete an organization
        config rule.
    ...
    def delete_organization_conformance_pack(self, OrganizationConformancePackName: str) -> None:
        ...
        remediation actions from all member accounts in that organization. Only a master account can
    ...
    def delete_remediation_exceptions(
        ...
        **Request Syntax**
        ...
        :param ResourceKeys: **[REQUIRED]**
          ...
          An exception list of resource exception keys to be processed with the current request. AWS
          Config adds exception for each resource key. For example, AWS Config adds 3 exceptions for
          3 resource keys.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **FailedBatches** *(list) --*
              ...
              Returns a list of failed delete remediation exceptions batch objects. Each object in
    ...
    def delete_resource_config(self, ResourceType: str, ResourceId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/DeleteResourceConfig>`_
    ...
    def describe_aggregate_compliance_by_config_rules(
        ...
        **Request Syntax**
        ...
        :param Limit:
          ...
          The maximum number of evaluation results returned on each page. The default is maximum. If
    ...
    def describe_compliance_by_config_rule(
        ...
        * The rule's AWS Lambda function is failing to send evaluation results to AWS Config. Verify
        that the role you assigned to your configuration recorder includes the
        ``config:PutEvaluations`` permission. If the rule is a custom rule, verify that the AWS
        Lambda execution role includes the ``config:PutEvaluations`` permission.

        * The rule's AWS Lambda function has returned ``NOT_APPLICABLE`` for all evaluation results.
    ...
    def describe_compliance_by_resource(
        ...
        ``INSUFFICIENT_DATA`` . This result might indicate one of the following conditions about the
        rules that evaluate the resource:
    ...
    def describe_config_rule_evaluation_status(
        ...
        **Request Syntax**
        ...
        :param Limit:
          ...
          <http://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html#limits_config>`__ in
    ...
    def describe_configuration_aggregator_sources_status(
        ...
        about the last time AWS Config verified authorization between the source account and an
    ...
    def describe_configuration_recorder_status(
        ...
        **Request Syntax**
        ...
        :param ConfigurationRecorderNames:
          ...
          returns the current status of all the configuration recorders associated with the account.
            ...
            - **ConfigurationRecorders** *(list) --*
              ...
              - *(dict) --*
                ...
                - **name** *(string) --*
                  ...
                  "default" when creating the configuration recorder. You cannot change the assigned
                  name.
                ...
                - **recordingGroup** *(dict) --*
                  ...
                  - **resourceTypes** *(list) --*
                    ...
                    If you set this option to ``true`` , when AWS Config adds support for a new type
                    of resource, it will not record resources of that type unless you manually add
                    that type to your recording group.

                    For a list of valid ``resourceTypes`` values, see the **resourceType Value**
                    column in `Supported AWS Resource Types
    ...
    def describe_conformance_packs(
        ...
        **Request Syntax**
        ...
        :param ConformancePackNames:
          ...
          specify any names, AWS Config returns details for all your conformance packs.
          ...
          - *(dict) --*
            ...
            - **ConformancePackDetails** *(list) --*
              ...
              - *(dict) --*
                ...
                Config rules and remediation actions that can be easily deployed in an account and a
                region.
                ...
                - **DeliveryS3Bucket** *(string) --*
                  ...
                  should start with awsconfigconforms. For example: "Resource":
                ...
                - **ConformancePackInputParameters** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    of which you define. Keys can have a maximum character length of 128 characters,
                    and values can have a maximum length of 256 characters.
            ...
            - **DeliveryChannels** *(list) --*
              ...
              - *(dict) --*
                ...
                - **name** *(string) --*
                  ...
                  "default" when creating the delivery channel. To change the delivery channel name,
                  you must use the DeleteDeliveryChannel action to delete your current delivery
                  channel, and then you must use the PutDeliveryChannel command to create a delivery
                ...
                - **s3BucketName** *(string) --*
                  ...
                  <https://docs.aws.amazon.com/config/latest/developerguide/s3-bucket-policy.html>`__
                  in the AWS Config Developer Guide.
                ...
                - **snsTopicARN** *(string) --*
                  ...
                  grant access permissions to AWS Config. For more information, see `Permissions for
                  the Amazon SNS Topic
                  <https://docs.aws.amazon.com/config/latest/developerguide/sns-topic-policy.html>`__
                  in the AWS Config Developer Guide.
    ...
    def describe_organization_config_rule_statuses(
        ...
        **Request Syntax**
        ...
        :param OrganizationConfigRuleNames:
          ...
          specify any names, AWS Config returns details for all your organization AWS Confg rules.
                ...
                'OrganizationConfigRuleStatuses': [
                    {
                        ...
                        'CREATE_SUCCESSFUL'|'CREATE_IN_PROGRESS'|'CREATE_FAILED'
                        |'DELETE_SUCCESSFUL'|'DELETE_FAILED'|'DELETE_IN_PROGRESS'
                        |'UPDATE_SUCCESSFUL'|'UPDATE_IN_PROGRESS'|'UPDATE_FAILED',
                        'ErrorCode': 'string',
                        'ErrorMessage': 'string',
                        'LastUpdateTime': datetime(2015, 1, 1)
                    },
            ...
            - **OrganizationConfigRuleStatuses** *(list) --*
              ...
              - *(dict) --*
                ...
                - **OrganizationRuleStatus** *(string) --*
                  ...
                  when one or more member accounts join or leave an organization. Config rule status
                  is deleted when the master account deletes OrganizationConfigRule in all the
              ...
              - *(dict) --*
                ...
                - **OrganizationManagedRuleMetadata** *(dict) --*
                  ...
                  - **MaximumExecutionFrequency** *(string) --*
                    ...
                    using an AWS managed rule that is triggered at a periodic frequency.
                ...
                - **OrganizationCustomRuleMetadata** *(dict) --*
                  ...
                  - **OrganizationConfigRuleTriggerTypes** *(list) --*
                    ...
                    * ``OversizedConfigurationItemChangeNotification`` - Triggers an evaluation when
                    ...
                    this notification type when a resource changes and the notification exceeds the
    ...
    def describe_organization_conformance_pack_statuses(
        ...
        .. note::
          ...
          When you specify the limit and the next token, you receive a paginated response. Limit and
          next token are not applicable if you specify organization conformance pack names. They are
          only applicable, when you request all the organization conformance packs.
        ...
        **Request Syntax**
        ...
        :param OrganizationConformancePackNames:
          ...
          not specify any names, AWS Config returns details for all your organization conformance
          packs.
        ...
        :param Limit:
          ...
          The maximum number of OrganizationConformancePackStatuses returned on each page. If you do
          no specify a number, AWS Config uses the default. The default is 100.
            ...
            - **OrganizationConformancePackStatuses** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Status** *(string) --*
                  ...
                  account calls PutOrganizationConformancePack for the first time, conformance pack
                  ...
                  OrganizationConformancePack in all the member accounts and disables service access
    ...
    def describe_organization_conformance_packs(
        ...
        .. note::
          ...
          names. They are only applicable, when you request all the organization conformance packs.
            ...
            - **RemediationConfigurations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ExecutionControls** *(dict) --*
                  ...
                  - **SsmControls** *(dict) --*
                    ...
                    - **ErrorPercentage** *(integer) --*
                      ...
                      on non-compliant resources for that specific rule. You can specify a
                      percentage of errors, for example 10%. If you do not specifiy a percentage,
                      the default is 50%. For example, if you set the ErrorPercentage to 40% for 10
                ...
                - **MaximumAutomaticAttempts** *(integer) --*
                  ...
                  RetryAttemptsSeconds as 50 seconds, AWS Config throws an exception after the 5th
    ...
    def get_aggregate_discovered_resource_counts(
        ...
        the API returns the count of resources in account ID 12345678910 and region us-east-1. If
        the input contains ACCOUNT_ID as a GroupByKey, the API returns resource counts for all
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_aggregate_discovered_resource_counts(
              ...
              Filters={
                  ...
                  |'AWS::EC2::NatGateway'|'AWS::EC2::EgressOnlyInternetGateway'
                  |'AWS::EC2::VPCEndpoint'|'AWS::EC2::VPCEndpointService'
                  |'AWS::EC2::FlowLog'|'AWS::EC2::VPCPeeringConnection'|'AWS::IAM::Group'
                  |'AWS::IAM::Policy'|'AWS::IAM::Role'|'AWS::IAM::User'
                  |'AWS::ElasticLoadBalancingV2::LoadBalancer'|'AWS::ACM::Certificate'
                  |'AWS::RDS::DBInstance'|'AWS::RDS::DBParameterGroup'
                  |'AWS::RDS::DBOptionGroup'|'AWS::RDS::DBSubnetGroup'
        ...
        :param Limit:
          ...
          The maximum number of  GroupedResourceCount objects returned on each page. The default is
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **GroupByKey** *(string) --*
              ...
              The key passed into the request object. If ``GroupByKey`` is not provided, the result
              will be empty.
    ...
    def get_compliance_details_by_config_rule(
        ...
        """
        Returns the evaluation results for the specified AWS Config rule. The results indicate which
        AWS resources were evaluated by the rule, when each resource was last evaluated, and whether
          ...
          - *(dict) --*
            ...
            - **ConformancePackRuleEvaluationResults** *(list) --*
              ...
              - *(dict) --*
                ...
                resource type that was evaluated, the compliance of the conformance pack, related
    ...
    def get_discovered_resource_counts(
        ...
        resources that AWS Config is recording in this region for your AWS account.
        ...
        * You make a call to the ``GetDiscoveredResourceCounts`` action and specify that you want
        all resource types.
        ...
        * AWS Config returns the following:
        ...
        The response is paginated. By default, AWS Config lists 100  ResourceCount objects on each
        ...
        .. note::
          ...
          * You just enabled resource recording.
          ...
          It might take a few minutes for AWS Config to record and count your resources. Wait a few
        ...
        **Request Syntax**
        ...
        :param resourceTypes:
          ...
          The comma-separated list that specifies the resource types that you want AWS Config to
          return (for example, ``"AWS::EC2::Instance"`` , ``"AWS::IAM::User"`` ).

          If a value for ``resourceTypes`` is not specified, AWS Config returns all resource types
          that AWS Config is recording in the region for your account.

          .. note::

            If the configuration recorder is turned off, AWS Config returns an empty list of
          ...
          - *(dict) --*
            ...
            - **OrganizationConfigRuleDetailedStatus** *(list) --*
              ...
              - *(dict) --*
                ...
                includes the name of the rule, the status, error code and error message when the
                rule creation or deletion failed.
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          - **Status** *(string) --*
            ...
            pack status is created in the member account. When master account calls
            ``PutOrganizationConformancePack`` action for the second time, conformance pack status
            is updated in the member account. Conformance pack status is deleted when the master
          ...
          - *(dict) --*
            ...
            - **OrganizationConformancePackDetailedStatuses** *(list) --*
              ...
              - *(dict) --*
                ...
                This includes the name of the conformance pack, the status, error code and error
                message when the conformance pack creation or deletion failed.
                ...
                - **Status** *(string) --*
                  ...
                  Indicates deployment status for conformance pack in a member account. When master
                  account calls ``PutOrganizationConformancePack`` action for the first time,
                  ...
                  when the master account deletes ``OrganizationConformancePack`` and disables
    ...
    def get_resource_config_history(
        ...
        maximum of 7 years (2557 days), AWS Config returns the ``ConfigurationItems`` for the
        specified retention period.

        The response is paginated. By default, AWS Config returns a limit of 10 configuration items
        per page. You can customize this number with the ``limit`` parameter. The response includes
    ...
    def list_aggregate_discovered_resources(
        ...
        resource type ``AWS::EC2::Instance`` then the API returns all the EC2 instance identifiers
        of accountID 12345678910 and region us-east-1.
    ...
    def list_discovered_resources(
        ...
        resource name. The results consist of resources that AWS Config has discovered, including
        those that AWS Config is not currently recording. You can narrow the results to include only
        ...
        The response is paginated. By default, AWS Config lists 100 resource identifiers on each
        page. You can customize this number with the ``limit`` parameter. The response includes a
        ``nextToken`` string. To get the next page of results, run the request again and specify the
        string for the ``nextToken`` parameter.
          ...
          - *(dict) --*
            ...
            - **Tags** *(list) --*
              ...
              - *(dict) --*
                ...
                categorize and organize them. Each tag consists of a key and an optional value, both
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            which you define. Tag keys can have a maximum character length of 128 characters, and
    ...
    def put_config_rule(
        ...
        You can use this action for custom AWS Config rules and AWS managed Config rules. A custom
        AWS Config rule is a rule that you develop and maintain. An AWS managed Config rule is a
        customizable, predefined rule that AWS Config provides.
        ...
        ``PutConfigRule`` action to add the rule to AWS Config, you must specify the Amazon Resource
        Name (ARN) that AWS Lambda assigns to the function. Specify the ARN for the
        ...
        ``SourceIdentifier`` key. To reference AWS managed Config rule identifiers, see `About AWS
        Managed Config Rules
        <https://docs.aws.amazon.com/config/latest/developerguide/evaluate-config_use-managed-rules.html>`__
        .

        For any new rule that you add, specify the ``ConfigRuleName`` in the ``ConfigRule`` object.
        Do not specify the ``ConfigRuleArn`` or the ``ConfigRuleId`` . These values are generated by
        ...
        **Request Syntax**
        ...
        :param ConfigRule: **[REQUIRED]**
          ...
          - **Scope** *(dict) --*
            ...
            one or more resource types, a combination of one resource type and one resource ID, or a
    ...
    def put_configuration_aggregator(
        ...
        regions. The source account can be individual account(s) or an organization.

        .. note::

          AWS Config should be enabled in source accounts and regions you want to aggregate.

          If your source type is an organization, you must be signed in to the master account and
          all features must be enabled in your organization. AWS Config calls
    ...
    def put_configuration_recorder(
        ...
        existing recorder. To change the role, call the action on the existing configuration
    ...
    def put_conformance_pack(
        ...
        The service linked role is created only when the role does not exist in your account. AWS
        ...
        .. note::
          ...
          both. If you provide both AWS Config uses the ``TemplateS3Uri`` parameter and ignores the
        ...
        **Request Syntax**
        ...
        :param TemplateS3Uri:
          ...
          Location of file containing the template body (``s3://bucketname/prefix`` ). The uri must
          point to the conformance pack template (max size: 300 KB) that is located in an Amazon S3
        ...
        :param TemplateBody:
          ...
          A string containing full conformance pack template body. Structure containing the template
          body with a minimum length of 1 byte and a maximum length of 51,200 bytes.

          .. note::

            You can only use a YAML template with one resource type, that is, config rule and a
            remediation action.
    ...
    def put_delivery_channel(
        ...
        **Request Syntax**
        ...
        :param DeliveryChannel: **[REQUIRED]**
          ...
          The configuration delivery channel object that delivers the configuration information to
    ...
    def put_evaluations(
        ...
        **Request Syntax**
        ...
        :param Evaluations:
          ...
          The assessments that the AWS Lambda function performs. Each evaluation identifies an AWS
          resource and indicates whether it complies with the AWS Config rule that invokes the AWS
          Lambda function.
          ...
          - *(dict) --*
            ...
            - **ComplianceType** *(string) --* **[REQUIRED]**
              ...
              function for a custom AWS Config rule cannot pass an ``INSUFFICIENT_DATA`` value to
              AWS Config.
        ...
        :param ResultToken: **[REQUIRED]**
          ...
          An encrypted token that associates an evaluation with an AWS Config rule. Identifies the
        ...
        :param TestMode:
          ...
          your AWS Lambda function will deliver evaluation results to AWS Config. No updates occur
          to your existing evaluations, and evaluation results are not sent to AWS Config.
            ...
            - **FailedEvaluations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **OrderingTimestamp** *(datetime) --*
                  ...
                  The time of the event in AWS Config that triggered the evaluation. For event-based
                  evaluations, the time indicates when AWS Config created the configuration item
                  that triggered the evaluation. For periodic evaluations, the time indicates when
                  AWS Config triggered the evaluation at the frequency that you specified (for
    ...
    def put_organization_config_rule(
        ...
        your AWS resources comply with your desired configurations. Only a master account can create
        or update an organization config rule.

        This API enables organization service access through the ``EnableAWSServiceAccess`` action
        and creates a service linked role ``AWSServiceRoleForConfigMultiAccountSetup`` in the master
        ...
        If you are adding a new custom AWS Config rule, you must first create AWS Lambda function in
        the master account that the rule invokes to evaluate your resources. When you use the
        ``PutOrganizationConfigRule`` action to add the rule to AWS Config, you must specify the
        Amazon Resource Name (ARN) that AWS Lambda assigns to the function. If you are adding an AWS
        managed Config rule, specify the rule's identifier for the ``RuleIdentifier`` key.
    ...
    def put_organization_conformance_pack(
        ...
        ``AWSServiceRoleForConfigMultiAccountSetup`` in the master account of your organization. The
        service linked role is created only when the role does not exist in the master account. AWS
        Config verifies the existence of role with GetRole action.
        ...
        .. note::
          ...
          UPDATE_IN_PROGRESS until the confomance pack is created or updated. You cannot update a
        ...
        **Request Syntax**
        ...
        :param DeliveryS3Bucket: **[REQUIRED]**
          ...
          "arn:aws:s3:::your_bucket_name/*". For more information, see `Permissions for cross
          account bucket access
          <https://docs.aws.amazon.com/config/latest/developerguide/conformance-pack-organization-apis.html>`__
          .
    ...
    def put_remediation_configurations(
        ...
        selected target or action. The API creates the ``RemediationConfiguration`` object for the
        AWS Config rule. The AWS Config rule must already exist for you to add a remediation
    ...
    def put_remediation_exceptions(
        ...
        auto-remediation. This API adds a new exception or updates an exisiting exception for a
    ...
    def put_resource_config(
        ...
        custom resource type using existing AWS Config APIs.

        .. note::

          The custom resource type must be registered with AWS CloudFormation. This API accepts the
          configuration item registered with AWS CloudFormation.

          When you call this API, AWS Config only stores configuration state of the resource
          provided in the request. This API does not change or remediate the configuration of the
          resource.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/config-2014-11-12/PutResourceConfig>`_
    ...
    def put_retention_configuration(
        ...
        ``RetentionConfiguration`` object named **default** , calling the API modifies the default
        object.
    ...
    def select_resource_config(
        ...
        https://docs.aws.amazon.com/config/latest/developerguide/query-components.html`__ section in
        the AWS Config Developer Guide.
    ...
    def start_config_rules_evaluation(self, ConfigRuleNames: List[str] = None) -> Dict:
        ...
        you can call the API again. If you chose to have AWS Config stream to an Amazon SNS topic,
        you will receive a ``ConfigRuleEvaluationStarted`` notification when the evaluation starts.

        .. note::

          You don't need to call the ``StartConfigRulesEvaluation`` API to run an evaluation for a
          new rule. When you create a rule, AWS Config evaluates your resources against the rule
          automatically.
