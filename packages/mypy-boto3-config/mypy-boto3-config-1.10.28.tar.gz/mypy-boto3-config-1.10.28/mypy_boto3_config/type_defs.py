...
_RequiredClientBatchGetAggregateResourceConfigResourceIdentifiersTypeDef = TypedDict(
    ...
    {"SourceAccountId": str, "SourceRegion": str, "ResourceId": str, "ResourceType": str},
)
...
class ClientBatchGetAggregateResourceConfigResponseUnprocessedResourceIdentifiersTypeDef(
    ...
    """
    Type definition for `ClientBatchGetAggregateResourceConfigResponse`
...
class ClientBatchGetResourceConfigResponseunprocessedResourceKeysTypeDef(
    ...
    The details that identify a resource within AWS Config, including the resource type and resource
    ID.
...
_ClientBatchGetResourceConfigresourceKeysTypeDef = TypedDict(
    "_ClientBatchGetResourceConfigresourceKeysTypeDef", {"resourceType": str, "resourceId": str}
)
...
class ClientDeleteRemediationExceptionsResponseFailedBatchesTypeDef(
    ...
    - **FailureMessage** *(string) --*
      ...
      Returns a failure message for delete remediation exception. For example, AWS Config creates an
      exception due to an internal error.
...
class ClientDescribeAggregateComplianceByConfigRulesResponseAggregateComplianceByConfigRulesComplianceComplianceContributorCountTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeAggregateComplianceByConfigRulesResponseAggregateComplianceByConfigRulesCompliance`
    `ComplianceContributorCount`

    The number of AWS resources or AWS Config rules that cause a result of ``NON_COMPLIANT`` , up to
    a maximum number.

    - **CappedCount** *(integer) --*

      The number of AWS resources or AWS Config rules responsible for the current compliance of the
      item.
...
class ClientDescribeAggregateComplianceByConfigRulesResponseAggregateComplianceByConfigRulesComplianceTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeAggregateComplianceByConfigRulesResponseAggregateComplianceByConfigRules`
    `Compliance`
    ...
    - **ComplianceType** *(string) --*
      ...
      and ``INSUFFICIENT_DATA`` values. AWS Config does not support the ``NOT_APPLICABLE`` value for
      the ``Compliance`` data type.

    - **ComplianceContributorCount** *(dict) --*

      The number of AWS resources or AWS Config rules that cause a result of ``NON_COMPLIANT`` , up
      to a maximum number.
...
class ClientDescribeAggregateComplianceByConfigRulesResponseAggregateComplianceByConfigRulesTypeDef(
    ...
    """
    Type definition for `ClientDescribeAggregateComplianceByConfigRulesResponse`
    ...
    - **Compliance** *(dict) --*
      ...
      - **ComplianceType** *(string) --*
        ...
        For the ``Compliance`` data type, AWS Config supports only ``COMPLIANT`` , ``NON_COMPLIANT``
        , and ``INSUFFICIENT_DATA`` values. AWS Config does not support the ``NOT_APPLICABLE`` value
...
class ClientDescribeAggregationAuthorizationsResponseAggregationAuthorizationsTypeDef(
    ...
    """
    Type definition for `ClientDescribeAggregationAuthorizationsResponse`
...
class ClientDescribeComplianceByConfigRuleResponseComplianceByConfigRulesComplianceComplianceContributorCountTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeComplianceByConfigRuleResponseComplianceByConfigRulesCompliance`
    `ComplianceContributorCount`
...
class ClientDescribeComplianceByConfigRuleResponseComplianceByConfigRulesComplianceTypeDef(
    ...
    """
    Type definition for `ClientDescribeComplianceByConfigRuleResponseComplianceByConfigRules`
    `Compliance`
...
class ClientDescribeComplianceByConfigRuleResponseComplianceByConfigRulesTypeDef(
    ...
    that the rule evaluated comply with it. A rule is noncompliant if any of these resources do not
    comply.
...
class ClientDescribeComplianceByResourceResponseComplianceByResourcesComplianceComplianceContributorCountTypeDef(
    ...
    """
    Type definition for `ClientDescribeComplianceByResourceResponseComplianceByResourcesCompliance`
    `ComplianceContributorCount`
...
class ClientDescribeComplianceByResourceResponseComplianceByResourcesComplianceTypeDef(
    ...
    """
    Type definition for `ClientDescribeComplianceByResourceResponseComplianceByResources`
    `Compliance`
...
class ClientDescribeComplianceByResourceResponseComplianceByResourcesTypeDef(
    ...
    Indicates whether an AWS resource that is evaluated according to one or more AWS Config rules is
    compliant. A resource is compliant if it complies with all of the rules that evaluate it. A
    resource is noncompliant if it does not comply with one or more of these rules.
    ...
    - **Compliance** *(dict) --*
      ...
      Indicates whether the AWS resource complies with all of the AWS Config rules that evaluated
      it.
...
class ClientDescribeConfigRuleEvaluationStatusResponseConfigRulesEvaluationStatusTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigRuleEvaluationStatusResponse`
    `ConfigRulesEvaluationStatus`

    Status information for your AWS managed Config rules. The status includes information such as
    the last time the rule ran, the last time it failed, and the related error for the last failure.
    ...
    - **LastSuccessfulInvocationTime** *(datetime) --*
      ...
      The time that AWS Config last successfully invoked the AWS Config rule to evaluate your AWS
      resources.
...
class ClientDescribeConfigRulesResponseConfigRulesSourceSourceDetailsTypeDef(
    ...
    against a rule. It also provides the frequency with which you want AWS Config to run evaluations
    for the rule if the trigger type is periodic. You can specify the parameter values for
      ...
      - *(dict) --*
        ...
        - **MessageType** *(string) --*
          ...
          * ``OversizedConfigurationItemChangeNotification`` - Triggers an evaluation when AWS
          Config delivers an oversized configuration item. AWS Config may generate this notification
...
class ClientDescribeConfigRulesResponseConfigRulesTypeDef(
    ...
    assess whether your AWS resources comply with your desired configurations. This function can run
    when AWS Config detects a configuration change to an AWS resource and at a periodic frequency
    ...
    - **Source** *(dict) --*
      ...
      - **SourceDetails** *(list) --*
        ...
        - *(dict) --*
          ...
          Provides the source and the message types that trigger AWS Config to evaluate your AWS
          resources against a rule. It also provides the frequency with which you want AWS Config to
          run evaluations for the rule if the trigger type is periodic. You can specify the
    ...
    - **ConfigRuleState** *(string) --*
      ...
      It can also indicate the evaluation status for the AWS Config rule.
      ...
      ``DeleteEvaluationResults`` request to delete the current evaluation results for the AWS
      Config rule.
        ...
        *AWS Config Developer Guide* .
        ...
        - **Scope** *(dict) --*
          ...
          - **TagValue** *(string) --*
            ...
            for the rule. If you specify a value for ``TagValue`` , you must also specify a value
            for ``TagKey`` .
        ...
        - **Source** *(dict) --*
          ...
          - **SourceDetails** *(list) --*
            ...
            - *(dict) --*
              ...
              Provides the source and the message types that trigger AWS Config to evaluate your AWS
              resources against a rule. It also provides the frequency with which you want AWS
...
class ClientDescribeConfigurationAggregatorSourcesStatusResponseAggregatedSourceStatusListTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigurationAggregatorSourcesStatusResponse`
...
class ClientDescribeConfigurationAggregatorsResponseConfigurationAggregatorsAccountAggregationSourcesTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigurationAggregatorsResponseConfigurationAggregators`
...
class ClientDescribeConfigurationRecorderStatusResponseConfigurationRecordersStatusTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigurationRecorderStatusResponse`
...
_ClientDescribeConfigurationRecordersResponseConfigurationRecordersrecordingGroupTypeDef = TypedDict(
    ...
    {"allSupported": bool, "includeGlobalResourceTypes": bool, "resourceTypes": List[str]},
    total=False,
)
...
class ClientDescribeConfigurationRecordersResponseConfigurationRecordersrecordingGroupTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigurationRecordersResponseConfigurationRecorders`
    `recordingGroup`
...
class ClientDescribeConfigurationRecordersResponseConfigurationRecordersTypeDef(
    ...
    - **recordingGroup** *(dict) --*
      ...
      - **resourceTypes** *(list) --*
        ...
        resource, it will not record resources of that type unless you manually add that type to
...
class ClientDescribeConformancePackComplianceResponseConformancePackRuleComplianceListTypeDef(
    ...
    """
    Type definition for `ClientDescribeConformancePackComplianceResponse`
    `ConformancePackRuleComplianceList`

    Compliance information of one or more AWS Config rules within a conformance pack. You can filter
    using AWS Config rule names and compliance types.
...
class ClientDescribeConformancePacksResponseConformancePackDetailsConformancePackInputParametersTypeDef(
    ...
    """
    Type definition for `ClientDescribeConformancePacksResponseConformancePackDetails`
...
class ClientDescribeConformancePacksResponseConformancePackDetailsTypeDef(
    ...
    - **DeliveryS3Bucket** *(string) --*
      ...
      Conformance pack template that is used to create a pack. The delivery bucket name should start
      with awsconfigconforms. For example: "Resource": "arn:aws:s3:::your_bucket_name/*".
    ...
    - **ConformancePackDetails** *(list) --*
      ...
      - *(dict) --*
        ...
        - **DeliveryS3Bucket** *(string) --*
          ...
          Conformance pack template that is used to create a pack. The delivery bucket name should
          start with awsconfigconforms. For example: "Resource": "arn:aws:s3:::your_bucket_name/*".
...
class ClientDescribeDeliveryChannelStatusResponseDeliveryChannelsStatusconfigHistoryDeliveryInfoTypeDef(
    ...
    """
    Type definition for `ClientDescribeDeliveryChannelStatusResponseDeliveryChannelsStatus`
    `configHistoryDeliveryInfo`

    A list that contains the status of the delivery of the configuration history to the specified
    Amazon S3 bucket.
...
class ClientDescribeDeliveryChannelStatusResponseDeliveryChannelsStatusconfigStreamDeliveryInfoTypeDef(
    ...
    - **lastStatus** *(string) --*
       ...
       **Note** Providing an SNS topic on a `DeliveryChannel
       <https://docs.aws.amazon.com/config/latest/APIReference/API_DeliveryChannel.html>`__ for AWS
       Config is optional. If the SNS delivery is turned off, the last status will be
       **Not_Applicable** .
...
class ClientDescribeDeliveryChannelStatusResponseDeliveryChannelsStatusTypeDef(
    ...
    - **configStreamDeliveryInfo** *(dict) --*
      ...
      - **lastStatus** *(string) --*
         ...
         **Note** Providing an SNS topic on a `DeliveryChannel
         <https://docs.aws.amazon.com/config/latest/APIReference/API_DeliveryChannel.html>`__ for
         AWS Config is optional. If the SNS delivery is turned off, the last status will be
         **Not_Applicable** .
...
class ClientDescribeDeliveryChannelsResponseDeliveryChannelsconfigSnapshotDeliveryPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeDeliveryChannelsResponseDeliveryChannels`
    ...
    - **DeliveryChannels** *(list) --*
      ...
      - *(dict) --*
        ...
        - **s3BucketName** *(string) --*
          ...
          <https://docs.aws.amazon.com/config/latest/developerguide/s3-bucket-policy.html>`__ in the
          AWS Config Developer Guide.
        ...
        - **snsTopicARN** *(string) --*
          ...
          If you choose a topic from another account, the topic must have policies that grant access
          permissions to AWS Config. For more information, see `Permissions for the Amazon SNS Topic
          <https://docs.aws.amazon.com/config/latest/developerguide/sns-topic-policy.html>`__ in the
          AWS Config Developer Guide.
...
class ClientDescribeOrganizationConfigRuleStatusesResponseOrganizationConfigRuleStatusesTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrganizationConfigRuleStatusesResponse`
    ...
    - **OrganizationRuleStatus** *(string) --*
      ...
      PutOrganizationConfigRule action for the first time, config rule status is created in all the
      member accounts. When master account calls PutOrganizationConfigRule action for the second
      time, config rule status is updated in all the member accounts. Additionally, config rule
      status is updated when one or more member accounts join or leave an organization. Config rule
      status is deleted when the master account deletes OrganizationConfigRule in all the member
      accounts and disables service access for ``config-multiaccountsetup.amazonaws.com`` .

      AWS Config sets the state of the rule to:

      * ``CREATE_SUCCESSFUL`` when an organization config rule has been successfully created in all
      the member accounts.

      * ``CREATE_IN_PROGRESS`` when an organization config rule creation is in progress.

      * ``CREATE_FAILED`` when an organization config rule creation failed in one or more member
      accounts within that organization.

      * ``DELETE_FAILED`` when an organization config rule deletion failed in one or more member
      accounts within that organization.

      * ``DELETE_IN_PROGRESS`` when an organization config rule deletion is in progress.

      * ``DELETE_SUCCESSFUL`` when an organization config rule has been successfully deleted from
      all the member accounts.

      * ``UPDATE_SUCCESSFUL`` when an organization config rule has been successfully updated in all
      the member accounts.
    ...
    - **ErrorMessage** *(string) --*
      ...
      An error message indicating that organization config rule creation or deletion failed due to
      an error.
...
class ClientDescribeOrganizationConfigRulesResponseOrganizationConfigRulesOrganizationCustomRuleMetadataTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrganizationConfigRulesResponseOrganizationConfigRules`
...
class ClientDescribeOrganizationConfigRulesResponseOrganizationConfigRulesTypeDef(
    ...
    - **OrganizationManagedRuleMetadata** *(dict) --*
      ...
      - **MaximumExecutionFrequency** *(string) --*
        ...
        The maximum frequency with which AWS Config runs evaluations for a rule. You are using an
        AWS managed rule that is triggered at a periodic frequency.
...
class ClientDescribeOrganizationConformancePackStatusesResponseOrganizationConformancePackStatusesTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrganizationConformancePackStatusesResponse`
    ...
    - **Status** *(string) --*
      ...
      PutOrganizationConformancePack for the first time, conformance pack status is created in all
      the member accounts. When master account calls PutOrganizationConformancePack for the second
      time, conformance pack status is updated in all the member accounts. Additionally, conformance
      pack status is updated when one or more member accounts join or leave an organization.
      ...
      * ``CREATE_SUCCESSFUL`` when an organization conformance pack has been successfully created in
      all the member accounts.
      ...
      * ``DELETE_SUCCESSFUL`` when an organization conformance pack has been successfully deleted
      from all the member accounts.

      * ``UPDATE_SUCCESSFUL`` when an organization conformance pack has been successfully updated in
      all the member accounts.

      * ``UPDATE_IN_PROGRESS`` when an organization conformance pack update is in progress.

      * ``UPDATE_FAILED`` when an organization conformance pack update failed in one or more member
      accounts within that organization.

    - **ErrorCode** *(string) --*

      An error code that is returned when organization conformance pack creation or deletion has
      failed in a member account.

    - **ErrorMessage** *(string) --*

      An error message indicating that organization conformance pack creation or deletion failed due
      to an error.
    ...
    - **OrganizationConformancePackStatuses** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Status** *(string) --*
          ...
          Indicates deployment status of an organization conformance pack. When master account calls
          PutOrganizationConformancePack for the first time, conformance pack status is created in
          all the member accounts. When master account calls PutOrganizationConformancePack for the
          second time, conformance pack status is updated in all the member accounts. Additionally,
          conformance pack status is updated when one or more member accounts join or leave an
          organization. Conformance pack status is deleted when the master account deletes
        ...
        - **ErrorMessage** *(string) --*
          ...
          An error message indicating that organization conformance pack creation or deletion failed
          due to an error.
...
class ClientDescribeOrganizationConformancePacksResponseOrganizationConformancePacksConformancePackInputParametersTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeOrganizationConformancePacksResponseOrganizationConformancePacks`
    `ConformancePackInputParameters`
...
class ClientDescribeOrganizationConformancePacksResponseOrganizationConformancePacksTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrganizationConformancePacksResponse`
...
class ClientDescribePendingAggregationRequestsResponsePendingAggregationRequestsTypeDef(
    ...
    """
    Type definition for `ClientDescribePendingAggregationRequestsResponse`
...
class ClientDescribeRemediationConfigurationsResponseRemediationConfigurationsExecutionControlsSsmControlsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRemediationConfigurationsResponseRemediationConfigurationsExecutionControls`
    `SsmControls`
    ...
    - **ConcurrentExecutionRatePercentage** *(integer) --*
      ...
      resources for that specific rule. You can specify a percentage, such as 10%. The default value
      is 10.

    - **ErrorPercentage** *(integer) --*

      The percentage of errors that are allowed before SSM stops running automations on
      non-compliant resources for that specific rule. You can specify a percentage of errors, for
      example 10%. If you do not specifiy a percentage, the default is 50%. For example, if you set
      the ErrorPercentage to 40% for 10 non-compliant resources, then SSM stops running the
...
class ClientDescribeRemediationConfigurationsResponseRemediationConfigurationsExecutionControlsTypeDef(
    ...
    """
    Type definition for `ClientDescribeRemediationConfigurationsResponseRemediationConfigurations`
    `ExecutionControls`
    ...
    - **SsmControls** *(dict) --*
      ...
      - **ConcurrentExecutionRatePercentage** *(integer) --*
        ...
        non-compliant resources for that specific rule. You can specify a percentage, such as 10%.
      ...
      - **ErrorPercentage** *(integer) --*
        ...
        The percentage of errors that are allowed before SSM stops running automations on
        non-compliant resources for that specific rule. You can specify a percentage of errors, for
        example 10%. If you do not specifiy a percentage, the default is 50%. For example, if you
        set the ErrorPercentage to 40% for 10 non-compliant resources, then SSM stops running the
        automations when the fifth error is received.
    """
...
class ClientDescribeRemediationConfigurationsResponseRemediationConfigurationsParametersResourceValueTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRemediationConfigurationsResponseRemediationConfigurationsParameters`
    `ResourceValue`
...
class ClientDescribeRemediationConfigurationsResponseRemediationConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientDescribeRemediationConfigurationsResponse`
    ...
    - **RetryAttemptSeconds** *(integer) --*
      ...
      For example, if you specify RetryAttemptsSeconds as 50 seconds and MaximumAutomaticAttempts as
      5, AWS Config will run auto-remediations 5 times within 50 seconds before throwing an
      exception.
...
class ClientDescribeRemediationExecutionStatusResponseRemediationExecutionStatusesResourceKeyTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRemediationExecutionStatusResponseRemediationExecutionStatuses` `ResourceKey`
...
_ClientDescribeRemediationExecutionStatusResponseRemediationExecutionStatusesStepDetailsTypeDef = TypedDict(
    ...
    {"Name": str, "State": str, "ErrorMessage": str, "StartTime": datetime, "StopTime": datetime},
    total=False,
)
...
class ClientDescribeRemediationExecutionStatusResponseRemediationExecutionStatusesStepDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRemediationExecutionStatusResponseRemediationExecutionStatuses` `StepDetails`
...
class ClientDescribeRemediationExecutionStatusResponseRemediationExecutionStatusesTypeDef(
    ...
    """
    Type definition for `ClientDescribeRemediationExecutionStatusResponse`
...
class ClientGetAggregateComplianceDetailsByConfigRuleResponseAggregateEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `ClientGetAggregateComplianceDetailsByConfigRuleResponseAggregateEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`

    Identifies an AWS Config rule used to evaluate an AWS resource, and provides the type and ID of
...
class ClientGetAggregateComplianceDetailsByConfigRuleResponseAggregateEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for
    `ClientGetAggregateComplianceDetailsByConfigRuleResponseAggregateEvaluationResults`
...
class ClientGetAggregateComplianceDetailsByConfigRuleResponseAggregateEvaluationResultsTypeDef(
    ...
    """
    Type definition for `ClientGetAggregateComplianceDetailsByConfigRuleResponse`
    `AggregateEvaluationResults`

    The details of an AWS Config evaluation for an account ID and region in an aggregator. Provides
    the AWS resource that was evaluated, the compliance of the resource, related time stamps, and
...
class ClientGetAggregateConfigRuleComplianceSummaryResponseAggregateComplianceCountsComplianceSummaryCompliantResourceCountTypeDef(
    ...
    """
    Type definition for
    `ClientGetAggregateConfigRuleComplianceSummaryResponseAggregateComplianceCountsComplianceSummary`
...
class ClientGetAggregateConfigRuleComplianceSummaryResponseAggregateComplianceCountsComplianceSummaryNonCompliantResourceCountTypeDef(
    ...
    The number of AWS Config rules or AWS resources that are noncompliant, up to a maximum of 25 for
    rules and 100 for resources.
...
class ClientGetAggregateConfigRuleComplianceSummaryResponseAggregateComplianceCountsComplianceSummaryTypeDef(
    ...
    """
    Type definition for
    `ClientGetAggregateConfigRuleComplianceSummaryResponseAggregateComplianceCounts`
    `ComplianceSummary`
    ...
    - **NonCompliantResourceCount** *(dict) --*
      ...
      The number of AWS Config rules or AWS resources that are noncompliant, up to a maximum of 25
...
class ClientGetAggregateConfigRuleComplianceSummaryResponseAggregateComplianceCountsTypeDef(
    ...
    """
    Type definition for `ClientGetAggregateConfigRuleComplianceSummaryResponse`
...
_ClientGetAggregateResourceConfigResponseConfigurationItemrelationshipsTypeDef = TypedDict(
    ...
    {"resourceType": str, "resourceId": str, "resourceName": str, "relationshipName": str},
    total=False,
)
...
class ClientGetAggregateResourceConfigResponseConfigurationItemTypeDef(
    ...
    - **relatedEvents** *(list) --*
      ...
      An empty field indicates that the current configuration was not initiated by any event. As of
      Version 1.3, the relatedEvents field is empty. You can access the `LookupEvents API
      <https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_LookupEvents.html>`__ in
      the *AWS CloudTrail API Reference* to retrieve the events for the resource.
...
class ClientGetAggregateResourceConfigResponseTypeDef(
    ...
    - **ConfigurationItem** *(dict) --*
      ...
      - **relatedEvents** *(list) --*
        ...
        An empty field indicates that the current configuration was not initiated by any event. As
        of Version 1.3, the relatedEvents field is empty. You can access the `LookupEvents API
        <https://docs.aws.amazon.com/awscloudtrail/latest/APIReference/API_LookupEvents.html>`__ in
        the *AWS CloudTrail API Reference* to retrieve the events for the resource.
...
class ClientGetComplianceDetailsByConfigRuleResponseEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `ClientGetComplianceDetailsByConfigRuleResponseEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`
...
class ClientGetComplianceDetailsByConfigRuleResponseEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for `ClientGetComplianceDetailsByConfigRuleResponseEvaluationResults`
    `EvaluationResultIdentifier`
...
class ClientGetComplianceDetailsByConfigRuleResponseEvaluationResultsTypeDef(
    ...
    - **ResultToken** *(string) --*
      ...
      An encrypted token that associates an evaluation with an AWS Config rule. The token identifies
      the rule, the AWS resource being evaluated, and the event that triggered the evaluation.
    """
...
class ClientGetComplianceDetailsByResourceResponseEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `ClientGetComplianceDetailsByResourceResponseEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`
...
class ClientGetComplianceDetailsByResourceResponseEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for `ClientGetComplianceDetailsByResourceResponseEvaluationResults`
    `EvaluationResultIdentifier`
...
class ClientGetComplianceSummaryByConfigRuleResponseComplianceSummaryCompliantResourceCountTypeDef(
    ...
    """
    Type definition for `ClientGetComplianceSummaryByConfigRuleResponseComplianceSummary`
    `CompliantResourceCount`
...
class ClientGetComplianceSummaryByResourceTypeResponseComplianceSummariesByResourceTypeComplianceSummaryCompliantResourceCountTypeDef(
    ...
    """
    Type definition for
    `ClientGetComplianceSummaryByResourceTypeResponseComplianceSummariesByResourceTypeComplianceSummary`
    `CompliantResourceCount`
...
class ClientGetComplianceSummaryByResourceTypeResponseComplianceSummariesByResourceTypeComplianceSummaryTypeDef(
    ...
    """
    Type definition for
    `ClientGetComplianceSummaryByResourceTypeResponseComplianceSummariesByResourceType`
    `ComplianceSummary`
...
class ClientGetComplianceSummaryByResourceTypeResponseComplianceSummariesByResourceTypeTypeDef(
    ...
    """
    Type definition for `ClientGetComplianceSummaryByResourceTypeResponse`
    ...
    - **ComplianceSummary** *(dict) --*
      ...
      The number of AWS resources that are compliant or noncompliant, up to a maximum of 100 for
      each.
...
class ClientGetComplianceSummaryByResourceTypeResponseTypeDef(
    ...
    - **ComplianceSummariesByResourceType** *(list) --*
      ...
      more resource types were provided with the request, the numbers are returned for each resource
...
class ClientGetConformancePackComplianceDetailsFiltersTypeDef(
    ...
    - **ResourceIds** *(list) --*
      ...
      .. note::
        ...
        This is valid only when you provide resource type. If there is no resource type, you will
        see an error.
...
class ClientGetConformancePackComplianceDetailsResponseConformancePackRuleEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `ClientGetConformancePackComplianceDetailsResponseConformancePackRuleEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`
...
class ClientGetConformancePackComplianceDetailsResponseConformancePackRuleEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for
    `ClientGetConformancePackComplianceDetailsResponseConformancePackRuleEvaluationResults`
    `EvaluationResultIdentifier`
...
class ClientGetConformancePackComplianceDetailsResponseConformancePackRuleEvaluationResultsTypeDef(
    ...
    """
    Type definition for `ClientGetConformancePackComplianceDetailsResponse`
    `ConformancePackRuleEvaluationResults`

    The details of a conformance pack evaluation. Provides AWS Config rule and AWS resource type
    that was evaluated, the compliance of the conformance pack, related time stamps, and
    supplementary information.
...
class ClientGetConformancePackComplianceSummaryResponseConformancePackComplianceSummaryListTypeDef(
    ...
    """
    Type definition for `ClientGetConformancePackComplianceSummaryResponse`
...
class ClientGetDiscoveredResourceCountsResponseTypeDef(
    ...
    - **resourceCounts** *(list) --*
      ...
      The list of ``ResourceCount`` objects. Each object is listed in descending order by the number
      of resources.
...
class ClientGetOrganizationConfigRuleDetailedStatusResponseOrganizationConfigRuleDetailedStatusTypeDef(
    ...
    """
    Type definition for `ClientGetOrganizationConfigRuleDetailedStatusResponse`
    ...
    - **ErrorMessage** *(string) --*
      ...
      An error message indicating that config rule account creation or deletion has failed due to an
...
class ClientGetOrganizationConformancePackDetailedStatusFiltersTypeDef(
    ...
    - **Status** *(string) --*
      ...
      calls ``PutOrganizationConformancePack`` action for the first time, conformance pack status is
...
class ClientGetOrganizationConformancePackDetailedStatusResponseOrganizationConformancePackDetailedStatusesTypeDef(
    ...
    """
    Type definition for `ClientGetOrganizationConformancePackDetailedStatusResponse`
    ...
    - **ErrorMessage** *(string) --*
      ...
      An error message indicating that conformance pack account creation or deletion has failed due
      to an error in the member account.
...
_ClientListDiscoveredResourcesResponseresourceIdentifiersTypeDef = TypedDict(
    ...
    {"resourceType": str, "resourceId": str, "resourceName": str, "resourceDeletionTime": datetime},
    total=False,
)
...
_RequiredClientPutConfigRuleConfigRuleSourceTypeDef = TypedDict(
    "_RequiredClientPutConfigRuleConfigRuleSourceTypeDef", {"Owner": str, "SourceIdentifier": str}
)
...
class ClientPutConfigRuleConfigRuleTypeDef(
    _RequiredClientPutConfigRuleConfigRuleTypeDef, _OptionalClientPutConfigRuleConfigRuleTypeDef
):
    """
...
class ClientPutConfigurationAggregatorResponseConfigurationAggregatorAccountAggregationSourcesTypeDef(
    ...
    """
    Type definition for `ClientPutConfigurationAggregatorResponseConfigurationAggregator`
    `AccountAggregationSources`
...
class ClientPutRemediationConfigurationsRemediationConfigurationsExecutionControlsSsmControlsTypeDef(
    ...
    """
    Type definition for
    `ClientPutRemediationConfigurationsRemediationConfigurationsExecutionControls` `SsmControls`
...
class ClientPutRemediationConfigurationsRemediationConfigurationsExecutionControlsTypeDef(
    ...
    """
    Type definition for `ClientPutRemediationConfigurationsRemediationConfigurations`
    `ExecutionControls`
...
class ClientPutRemediationConfigurationsRemediationConfigurationsParametersResourceValueTypeDef(
    ...
    """
    Type definition for `ClientPutRemediationConfigurationsRemediationConfigurationsParameters`
    `ResourceValue`
...
class ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsExecutionControlsSsmControlsTypeDef(
    ...
    """
    Type definition for
    `ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsExecutionControls`
    `SsmControls`
...
class ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsExecutionControlsTypeDef(
    ...
    """
    Type definition for `ClientPutRemediationConfigurationsResponseFailedBatchesFailedItems`
    `ExecutionControls`
...
class ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsParametersResourceValueTypeDef(
    ...
    """
    Type definition for
    `ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsParameters` `ResourceValue`
...
class ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsParametersStaticValueTypeDef(
    ...
    """
    Type definition for
    `ClientPutRemediationConfigurationsResponseFailedBatchesFailedItemsParameters` `StaticValue`
        ...
        - **FailedItems** *(list) --*
          ...
          - *(dict) --*
            ...
            - **ExecutionControls** *(dict) --*
              ...
              - **SsmControls** *(dict) --*
                ...
                - **ConcurrentExecutionRatePercentage** *(integer) --*
                  ...
                  The maximum percentage of remediation actions allowed to run in parallel on the
                  non-compliant resources for that specific rule. You can specify a percentage, such
                ...
                - **ErrorPercentage** *(integer) --*
                  ...
                  For example, if you set the ErrorPercentage to 40% for 10 non-compliant resources,
                  then SSM stops running the automations when the fifth error is received.
            ...
            - **MaximumAutomaticAttempts** *(integer) --*
              ...
              For example, if you specify MaximumAutomaticAttempts as 5 with RetryAttemptsSeconds as
              50 seconds, AWS Config throws an exception after the 5th failed attempt within 50
              seconds.
...
_ClientStartRemediationExecutionResourceKeysTypeDef = TypedDict(
    "_ClientStartRemediationExecutionResourceKeysTypeDef", {"resourceType": str, "resourceId": str}
)
...
class DescribeAggregateComplianceByConfigRulesPaginateResponseAggregateComplianceByConfigRulesComplianceComplianceContributorCountTypeDef(
    ...
    """
    Type definition for
    `DescribeAggregateComplianceByConfigRulesPaginateResponseAggregateComplianceByConfigRulesCompliance`
    `ComplianceContributorCount`
...
class DescribeAggregateComplianceByConfigRulesPaginateResponseAggregateComplianceByConfigRulesComplianceTypeDef(
    ...
    """
    Type definition for
    `DescribeAggregateComplianceByConfigRulesPaginateResponseAggregateComplianceByConfigRules`
    `Compliance`
...
class DescribeAggregateComplianceByConfigRulesPaginateResponseAggregateComplianceByConfigRulesTypeDef(
    ...
    """
    Type definition for `DescribeAggregateComplianceByConfigRulesPaginateResponse`
    `AggregateComplianceByConfigRules`
...
class DescribeAggregationAuthorizationsPaginateResponseAggregationAuthorizationsTypeDef(
    ...
    """
    Type definition for `DescribeAggregationAuthorizationsPaginateResponse`
    `AggregationAuthorizations`
...
class DescribeComplianceByConfigRulePaginateResponseComplianceByConfigRulesComplianceComplianceContributorCountTypeDef(
    ...
    """
    Type definition for
    `DescribeComplianceByConfigRulePaginateResponseComplianceByConfigRulesCompliance`
    `ComplianceContributorCount`
...
class DescribeComplianceByConfigRulePaginateResponseComplianceByConfigRulesComplianceTypeDef(
    ...
    """
    Type definition for `DescribeComplianceByConfigRulePaginateResponseComplianceByConfigRules`
    `Compliance`
...
class DescribeComplianceByResourcePaginateResponseComplianceByResourcesComplianceComplianceContributorCountTypeDef(
    ...
    """
    Type definition for
    `DescribeComplianceByResourcePaginateResponseComplianceByResourcesCompliance`
    `ComplianceContributorCount`
...
class DescribeComplianceByResourcePaginateResponseComplianceByResourcesComplianceTypeDef(
    ...
    """
    Type definition for `DescribeComplianceByResourcePaginateResponseComplianceByResources`
    `Compliance`
...
class DescribeConfigRuleEvaluationStatusPaginateResponseConfigRulesEvaluationStatusTypeDef(
    ...
    """
    Type definition for `DescribeConfigRuleEvaluationStatusPaginateResponse`
    `ConfigRulesEvaluationStatus`
...
class DescribeConfigurationAggregatorSourcesStatusPaginateResponseAggregatedSourceStatusListTypeDef(
    ...
    """
    Type definition for `DescribeConfigurationAggregatorSourcesStatusPaginateResponse`
    `AggregatedSourceStatusList`
...
class DescribeConfigurationAggregatorsPaginateResponseConfigurationAggregatorsAccountAggregationSourcesTypeDef(
    ...
    """
    Type definition for `DescribeConfigurationAggregatorsPaginateResponseConfigurationAggregators`
    `AccountAggregationSources`
...
class DescribeConfigurationAggregatorsPaginateResponseConfigurationAggregatorsTypeDef(
    ...
    """
    Type definition for `DescribeConfigurationAggregatorsPaginateResponse`
...
class DescribePendingAggregationRequestsPaginateResponsePendingAggregationRequestsTypeDef(
    ...
    """
    Type definition for `DescribePendingAggregationRequestsPaginateResponse`
    `PendingAggregationRequests`
...
class DescribeRemediationExecutionStatusPaginateResponseRemediationExecutionStatusesResourceKeyTypeDef(
    ...
    """
    Type definition for
    `DescribeRemediationExecutionStatusPaginateResponseRemediationExecutionStatuses` `ResourceKey`
...
class DescribeRemediationExecutionStatusPaginateResponseRemediationExecutionStatusesStepDetailsTypeDef(
    ...
    """
    Type definition for
    `DescribeRemediationExecutionStatusPaginateResponseRemediationExecutionStatuses` `StepDetails`
...
class DescribeRemediationExecutionStatusPaginateResponseRemediationExecutionStatusesTypeDef(
    ...
    """
    Type definition for `DescribeRemediationExecutionStatusPaginateResponse`
    `RemediationExecutionStatuses`
...
class GetAggregateComplianceDetailsByConfigRulePaginateResponseAggregateEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `GetAggregateComplianceDetailsByConfigRulePaginateResponseAggregateEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`
...
class GetAggregateComplianceDetailsByConfigRulePaginateResponseAggregateEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for
    `GetAggregateComplianceDetailsByConfigRulePaginateResponseAggregateEvaluationResults`
    `EvaluationResultIdentifier`
...
class GetAggregateComplianceDetailsByConfigRulePaginateResponseAggregateEvaluationResultsTypeDef(
    ...
    """
    Type definition for `GetAggregateComplianceDetailsByConfigRulePaginateResponse`
    `AggregateEvaluationResults`
...
class GetComplianceDetailsByConfigRulePaginateResponseEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `GetComplianceDetailsByConfigRulePaginateResponseEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`
...
class GetComplianceDetailsByConfigRulePaginateResponseEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for `GetComplianceDetailsByConfigRulePaginateResponseEvaluationResults`
    `EvaluationResultIdentifier`
...
class GetComplianceDetailsByResourcePaginateResponseEvaluationResultsEvaluationResultIdentifierEvaluationResultQualifierTypeDef(
    ...
    """
    Type definition for
    `GetComplianceDetailsByResourcePaginateResponseEvaluationResultsEvaluationResultIdentifier`
    `EvaluationResultQualifier`
...
class GetComplianceDetailsByResourcePaginateResponseEvaluationResultsEvaluationResultIdentifierTypeDef(
    ...
    """
    Type definition for `GetComplianceDetailsByResourcePaginateResponseEvaluationResults`
    `EvaluationResultIdentifier`
