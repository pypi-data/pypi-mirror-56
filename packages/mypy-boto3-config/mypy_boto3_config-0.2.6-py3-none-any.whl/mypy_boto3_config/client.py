...
class Client(BaseClient):
            ...
            - **configurationItems** *(list) --*
              ...
              - *(dict) --*
                ...
                - **relatedEvents** *(list) --*
                  ...
                  As of Version 1.3, the relatedEvents field is empty. You can access the `LookupEvents API
    ...
    def put_conformance_pack(
        ...
        **Request Syntax**
        ...
        :param TemplateS3Uri:
          ...
          Location of file containing the template body (``s3://bucketname/prefix`` ). The uri must point
          to the conformance pack template (max size: 300 KB) that is located in an Amazon S3 bucket in the
    ...
    def put_organization_conformance_pack(
        ...
        service linked role is created only when the role does not exist in the master account. AWS Config
        verifies the existence of role with GetRole action.
        ...
        .. note::
          ...
          until the confomance pack is created or updated. You cannot update a conformance pack while it is
          in this state.
        ...
        **Request Syntax**
        ...
        :param DeliveryS3Bucket: **[REQUIRED]**
          ...
          "arn:aws:s3:::your_bucket_name/*". For more information, see `Permissions for cross account
          bucket access
    ...
    def put_resource_config(
        ...
        """
        Records the configuration state for the resource provided in the request. The configuration state
        of a resource is represented in AWS Config as Configuration Items. Once this API records the
        ...
        .. note::
          ...
          When you call this API, AWS Config only stores configuration state of the resource provided in
