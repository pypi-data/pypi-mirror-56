...
Mypy-friendly auto-generated type annotations for `boto3 config 1.10.28` service.
...
session_client = session.client("config")
...
```python
import boto3
from mypy_boto3.config import Client

from mypy_boto3.config.paginator import DescribeAggregateComplianceByConfigRulesPaginator
