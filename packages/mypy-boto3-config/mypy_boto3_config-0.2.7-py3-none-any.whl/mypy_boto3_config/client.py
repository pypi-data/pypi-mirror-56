...
class Client(BaseClient):
    ...
    def delete_configuration_recorder(self, ConfigurationRecorderName: str) -> None:
        ...
        able to access the previously recorded information by using the ``GetResourceConfigHistory`` action,
        but you will not be able to access this information in the AWS Config console until you create a new
    ...
    def delete_conformance_pack(self, ConformancePackName: str) -> None:
        """
        Deletes the specified conformance pack and all the AWS Config rules, remediation actions, and all
    ...
    def delete_organization_config_rule(self, OrganizationConfigRuleName: str) -> None:
        ...
        AWS Config sets the state of a rule to DELETE_IN_PROGRESS until the deletion is complete. You cannot
    ...
    def delete_resource_config(self, ResourceType: str, ResourceId: str) -> None:
        ...
        for this resource in your AWS Config History.
    ...
    def describe_config_rule_evaluation_status(
        ...
        **Request Syntax**
        ...
        :param ConfigRuleNames:
          ...
          specify any names, AWS Config returns status information for all AWS managed Config rules that you
          use.
    ...
    def describe_configuration_aggregators(
        ...
        specified, this action returns the details for all the configuration aggregators associated with the
        account.
    ...
    def describe_organization_config_rule_statuses(
        ...
        .. note::
          ...
          The status is not considered successful until organization config rule is successfully deployed in
          all the member accounts with an exception of excluded accounts.
    ...
    def describe_organization_conformance_packs(
        ...
        .. note::
          ...
          Limit and next token are not applicable if you specify organization conformance packs names. They
          are only applicable, when you request all the organization conformance packs.
        ...
        **Request Syntax**
        ...
        :param ComplianceType:
          ...
          .. note::
            ...
            For the ``GetAggregateComplianceDetailsByConfigRuleRequest`` data type, AWS Config supports only
            the ``COMPLIANT`` and ``NON_COMPLIANT`` . AWS Config does not support the ``NOT_APPLICABLE`` and
            ``INSUFFICIENT_DATA`` values.
    ...
    def get_aggregate_discovered_resource_counts(
        ...
        returns the count of resources in account ID 12345678910 and region us-east-1. If the input contains
        ACCOUNT_ID as a GroupByKey, the API returns resource counts for all source accounts that are present
        in your aggregator.
          ...
          ::

            {
                'ConfigurationItem': {
                    ...
                    |'AWS::LicenseManager::LicenseConfiguration'|'AWS::ApiGateway::DomainName'
                    |'AWS::ApiGateway::Method'|'AWS::ApiGateway::Stage'|'AWS::ApiGateway::RestApi'
                    |'AWS::ApiGatewayV2::DomainName'|'AWS::ApiGatewayV2::Stage'|'AWS::ApiGatewayV2::Api'
                    |'AWS::CodePipeline::Pipeline'|'AWS::ServiceCatalog::CloudFormationProvisionedProduct'
                    |'AWS::ServiceCatalog::CloudFormationProduct'|'AWS::ServiceCatalog::Portfolio',
                    'resourceId': 'string',
                    'resourceName': 'string',
                    'awsRegion': 'string',
    ...
    def get_compliance_details_by_resource(
        ...
        """
        Returns the evaluation results for the specified AWS resource. The results indicate which AWS Config
        rules were used to evaluate the resource, when each rule was last used, and whether the resource
    ...
    def get_conformance_pack_compliance_details(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          - **ResourceIds** *(list) --*
            ...
            .. note::
              ...
              This is valid only when you provide resource type. If there is no resource type, you will see
              an error.
        ...
        :param Limit:
          ...
          The maximum number of evaluation results returned on each page. If you do no specify a number, AWS
    ...
    def get_discovered_resource_counts(
        ...
        AWS Config is recording in this region for your AWS account.

         **Example**

        * AWS Config is recording three resource types in the US East (Ohio) Region for your account: 25 EC2
        instances, 20 IAM users, and 15 S3 buckets.
        ...
        * AWS Config returns the following:
        ...
        The response is paginated. By default, AWS Config lists 100  ResourceCount objects on each page. You
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          - **Status** *(string) --*
            ...
            ``PutOrganizationConformancePack`` action for the first time, conformance pack status is created
            in the member account. When master account calls ``PutOrganizationConformancePack`` action for
            the second time, conformance pack status is updated in the member account. Conformance pack
            status is deleted when the master account deletes ``OrganizationConformancePack`` and disables
    ...
    def list_aggregate_discovered_resources(
        ...
        For example, if the input consists of accountID 12345678910 and the region is us-east-1 for resource
        type ``AWS::EC2::Instance`` then the API returns all the EC2 instance identifiers of accountID
    ...
    def list_discovered_resources(
        ...
        """
        Accepts a resource type and returns a list of resource identifiers for the resources of that type. A
        resource identifier includes the resource type, ID, and (if available) the custom resource name. The
        results consist of resources that AWS Config has discovered, including those that AWS Config is not
        currently recording. You can narrow the results to include only resources that have specific
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          the supported resources are ``ConfigRule`` , ``ConfigurationAggregator`` and
    ...
    def put_config_rule(
        ...
        specify the ``ConfigRuleArn`` or the ``ConfigRuleId`` . These values are generated by AWS Config for
        new rules.

        If you are updating a rule that you added previously, you can specify the rule by ``ConfigRuleName``
        , ``ConfigRuleId`` , or ``ConfigRuleArn`` in the ``ConfigRule`` data type that you use in this
        request.
        ...
        **Request Syntax**
        ...
        :param ConfigRule: **[REQUIRED]**
          ...
          - **ConfigRuleState** *(string) --*
            ...
            AWS Config temporarily sets the state of a rule to ``DELETING`` after you use the
            ``DeleteConfigRule`` request to delete the rule. After AWS Config deletes the rule, the rule and
    ...
    def put_configuration_recorder(
        ...
        .. note::
          ...
          If ``ConfigurationRecorder`` does not have the **recordingGroup** parameter specified, the default
          is to record all supported resource types.
    ...
    def put_conformance_pack(
        ...
        can be easily deployed in an account and a region and across AWS Organization.
        ...
        **Request Syntax**
        ...
        :param TemplateBody:
          ...
          .. note::
            ...
            You can only use a YAML template with one resource type, that is, config rule and a remediation
            action.
    ...
    def put_delivery_channel(
        ...
        specify the changed values for the S3 bucket and the SNS topic. If you specify a different value for
        either the S3 bucket or the SNS topic, this action will keep the existing value for the parameter
        that is not changed.
        ...
        **Request Syntax**
        ...
        :param DeliveryChannel: **[REQUIRED]**
          ...
          The configuration delivery channel object that delivers the configuration information to an Amazon
          S3 bucket and to an Amazon SNS topic.
          ...
          - **s3BucketName** *(string) --*
            ...
            Bucket <https://docs.aws.amazon.com/config/latest/developerguide/s3-bucket-policy.html>`__ in
    ...
    def put_organization_config_rule(
        ...
        Resource Name (ARN) that AWS Lambda assigns to the function. If you are adding an AWS managed Config
        rule, specify the rule's identifier for the ``RuleIdentifier`` key.
    ...
    def put_organization_conformance_pack(
        ...
        This API enables organization service access for ``config-multiaccountsetup.amazonaws.com`` through
        the ``EnableAWSServiceAccess`` action and creates a service linked role
        ``AWSServiceRoleForConfigMultiAccountSetup`` in the master account of your organization. The service
        linked role is created only when the role does not exist in the master account. AWS Config verifies
        ...
        .. note::
          ...
          AWS Config sets the state of a conformance pack to CREATE_IN_PROGRESS and UPDATE_IN_PROGRESS until
          the confomance pack is created or updated. You cannot update a conformance pack while it is in
          this state.
        ...
        **Request Syntax**
        ...
        :param DeliveryS3Bucket: **[REQUIRED]**
          ...
          "arn:aws:s3:::your_bucket_name/*". For more information, see `Permissions for cross account bucket
          access
    ...
    def put_resource_config(
        ...
        a resource is represented in AWS Config as Configuration Items. Once this API records the
        configuration item, you can retrieve the list of configuration items for the custom resource type
        ...
        .. note::
          ...
          When you call this API, AWS Config only stores configuration state of the resource provided in the
          request. This API does not change or remediate the configuration of the resource.
        ...
        **Request Syntax**
        ...
        :param ResourceType: **[REQUIRED]**
          ...
          .. note::
            ...
            You cannot use the organization names “aws”, “amzn”, “amazon”, “alexa”, “custom” with custom
    ...
    def put_retention_configuration(
        ...
        that AWS Config stores your historical information. The API creates the ``RetentionConfiguration``
        object and names the object as **default** . When you have a ``RetentionConfiguration`` object named
    ...
    def select_resource_config(
        ...
        https://docs.aws.amazon.com/config/latest/developerguide/query-components.html`__ section in the AWS
        Config Developer Guide.
    ...
    def start_config_rules_evaluation(self, ConfigRuleNames: List[str] = None) -> Dict:
        """
        Runs an on-demand evaluation for the specified AWS Config rules against the last known configuration
        state of the resources. Use ``StartConfigRulesEvaluation`` when you want to test that a rule you
        updated is working as expected. ``StartConfigRulesEvaluation`` does not re-record the latest
        configuration state for your resources. It re-runs an evaluation against the last known state of
        your resources.

        You can specify up to 25 AWS Config rules per request.

        An existing ``StartConfigRulesEvaluation`` call for the specified rules must complete before you can
        call the API again. If you chose to have AWS Config stream to an Amazon SNS topic, you will receive
        a ``ConfigRuleEvaluationStarted`` notification when the evaluation starts.

        .. note::

          You don't need to call the ``StartConfigRulesEvaluation`` API to run an evaluation for a new rule.
          When you create a rule, AWS Config evaluates your resources against the rule automatically.
