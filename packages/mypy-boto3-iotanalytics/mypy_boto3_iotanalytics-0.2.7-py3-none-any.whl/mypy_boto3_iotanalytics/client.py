...
class Client(BaseClient):
    ...
    def create_dataset(
        ...
        (a SQL query) or a "containerAction" (executing a containerized application). This operation creates
        the skeleton of a data set. The data set can be populated manually by calling "CreateDatasetContent"
    ...
    def put_logging_options(
        ...
        change to take effect. Also, if you change the policy attached to the role you specified in the
    ...
    def update_pipeline(
        ...
        """
        Updates the settings of a pipeline. You must specify both a ``channel`` and a ``datastore`` activity
