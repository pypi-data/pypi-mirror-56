...
class Client(BaseClient):
    ...
    def create_channel(
        ...
        **Request Syntax**
        ...
        :param retentionPeriod:
          ...
          How long, in days, message data is kept for the channel. When "customerManagedS3" storage
    ...
    def create_dataset(
        ...
        This operation creates the skeleton of a data set. The data set can be populated manually by
        ...
        **Request Syntax**
          ...
          - *(dict) --*
            ...
            - **containerAction** *(dict) --*
              ...
              - **image** *(string) --* **[REQUIRED]**
                ...
                contains an application and needed support libraries and is used to generate data
                set contents.
              ...
              - **variables** *(list) --*
                ...
                containerized application (basically, parameters passed to the application). Each
        ...
        :param triggers:
          ...
          interval or when another data set's contents are created. The list of triggers can be
            ...
            - **destination** *(dict) --* **[REQUIRED]**
              ...
              - **s3DestinationConfiguration** *(dict) --*
                ...
                - **key** *(string) --* **[REQUIRED]**
                  ...
                  or "!{iotanalytics:versioned} to insert a unique hash identifying the data set,
                  for example:
        ...
        :param retentionPeriod:
          ...
          not specified or set to null, versions of data set contents are retained for at most 90
          days. The number of versions of data set contents retained is determined by the
        ...
        :param versioningConfiguration:
          ...
          null, only the latest version plus the latest succeeded version (if they are different)
    ...
    def create_pipeline(
        ...
        **Request Syntax**
        ...
        :param pipelineActivities: **[REQUIRED]**
          ...
          such as removing, renaming or adding message attributes; filtering messages based on
          attribute values; invoking your Lambda functions on messages for advanced processing; or
          performing mathematical transformations to normalize device data.

          The list can be 2-25 **PipelineActivity** objects and must contain both a ``channel`` and
          a ``datastore`` activity. Each entry in the list must contain only one activity, for
          example:
          ...
          - *(dict) --*
            ...
            - **dataset** *(dict) --*
                      ...
                      - *(dict) --*
                        ...
                        - **deltaTime** *(dict) --*
                          ...
                          - **offsetSeconds** *(integer) --*
                            ...
                            from processing during the next time frame as well, because its
                  ...
                  - **containerAction** *(dict) --*
                    ...
                    - **resourceConfiguration** *(dict) --*
                      ...
                      - **computeType** *(string) --*
                        ...
                        Possible values are: ACU_1 (vCPU=4, memory=
                            16GiB) or ACU_2 (vCPU=8,
                        memory=32GiB).
              ...
              - **versioningConfiguration** *(dict) --*
                ...
                to null, only the latest version plus the latest succeeded version (if they are
                different) are kept for the time period specified by the "retentionPeriod"
    ...
    def list_dataset_contents(
        ...
        **Request Syntax**
        ...
        :param scheduledOnOrAfter:
          ...
          after the given time. See the field ``triggers.schedule`` in the CreateDataset request.
          (timestamp)
        ...
        :param scheduledBefore:
          ...
          the given time. See the field ``triggers.schedule`` in the CreateDataset request.
          (timestamp)
    ...
    def put_logging_options(
        ...
        Note that if you update the value of any ``loggingOptions`` field, it takes up to one minute
        for the change to take effect. Also, if you change the policy attached to the role you
        specified in the roleArn field (for example, to correct an invalid policy) it takes up to 5
    ...
    def run_pipeline_activity(
        ...
        **Request Syntax**
        ...
        :param pipelineActivity: **[REQUIRED]**
          ...
          activity because these activities are used in a pipeline only to load the original message
          and to store the (possibly) transformed message. If a 'lambda' activity is specified, only
          short-running Lambda functions (those with a timeout of less than 30 seconds or less) can
          be used.
