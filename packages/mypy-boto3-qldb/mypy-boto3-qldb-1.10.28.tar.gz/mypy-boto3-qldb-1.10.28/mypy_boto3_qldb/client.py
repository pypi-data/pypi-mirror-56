...
class Client(BaseClient):
    ...
    def create_ledger(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          The name of the ledger that you want to create. The name must be unique among all of your
          ledgers in the current AWS Region.
        ...
        :param DeletionProtection:
          ...
          ledger using the QLDB API or the AWS Command Line Interface (AWS CLI). You can disable it
          by calling the ``UpdateLedger`` operation to set the flag to ``false`` . The QLDB console
          disables deletion protection for you when you use it to delete a ledger.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DeletionProtection** *(boolean) --*
              ...
              If deletion protection is enabled, you must first disable it before you can delete the
              ledger using the QLDB API or the AWS Command Line Interface (AWS CLI). You can disable
              it by calling the ``UpdateLedger`` operation to set the flag to ``false`` . The QLDB
    ...
    def delete_ledger(self, Name: str) -> None:
        ...
        If deletion protection is enabled, you must first disable it before you can delete the
        ledger using the QLDB API or the AWS Command Line Interface (AWS CLI). You can disable it by
        calling the ``UpdateLedger`` operation to set the flag to ``false`` . The QLDB console
        disables deletion protection for you when you use it to delete a ledger.
          ...
          - *(dict) --*
            ...
            - **ExportDescription** *(dict) --*
              ...
              - **ExportCreationTime** *(datetime) --*
                ...
                time format is the number of seconds elapsed since 12:00:00 AM January 1, 1970 UTC.)
              ...
              - **S3ExportConfiguration** *(dict) --*
                ...
                - **Bucket** *(string) --*
                  ...
                  <https://docs.aws.amazon.com/AmazonS3/latest/dev/BucketRestrictions.html>`__ in
                ...
                - **Prefix** *(string) --*
                  ...
                  <https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html>`__ in the
    ...
    def export_journal_to_s3(
        ...
        You can initiate up to two concurrent journal export requests for each ledger. Beyond this
        limit, journal export requests throw ``LimitExceededException`` .
    ...
    def get_block(
        ...
        """
        Returns a journal block object at a specified address in a ledger. Also returns a proof of
        the specified block for verification if ``DigestTipAddress`` is provided.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Proof** *(dict) --*
              ...
              contains the list of hash values required to recalculate the specified digest using a
    ...
    def get_revision(
        ...
        """
        Returns a revision data object for a specified document ID and block address. Also returns a
        proof of the specified revision for verification if ``DigestTipAddress`` is provided.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Proof** *(dict) --*
              ...
              contains the list of hash values that are required to recalculate the specified digest
              using a Merkle tree, starting with the specified document revision.
    ...
    def list_journal_s3_exports(
        ...
        """
        Returns an array of journal export job descriptions for all ledgers that are associated with
        the current AWS account and Region.

        This action returns a maximum of ``MaxResults`` items, and is paginated so that you can
        retrieve all the items by calling ``ListJournalS3Exports`` multiple times.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results to return in a single ``ListJournalS3Exports`` request. (The
          ...
          **Response Structure**
          ...
          - *(dict) --*
              ...
              - *(dict) --*
                ...
                - **S3ExportConfiguration** *(dict) --*
                  ...
                  - **Prefix** *(string) --*
                    ...
                    more information, see `Object Key and Metadata
                    <https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html>`__ in the
                    *Amazon S3 Developer Guide* .
            ...
            - **NextToken** *(string) --*
              ...
              * If ``NextToken`` is *not* empty, then there are more results available. To retrieve
              the next page of results, use the value of ``NextToken`` in a subsequent
    ...
    def list_ledgers(
        ...
        This action returns a maximum of 100 items and is paginated so that you can retrieve all the
        items by calling ``ListLedgers`` multiple times.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results to return in a single ``ListLedgers`` request. (The actual
        ...
        :param NextToken:
          ...
          A pagination token, indicating that you want to retrieve the next page of results. If you
          received a value for ``NextToken`` in the response from a previous ``ListLedgers`` call,
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        """
        Removes one or more tags from a specified Amazon QLDB resource. You can specify up to 50 tag
        keys to remove.
