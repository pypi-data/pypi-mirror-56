...
class Client(BaseClient):
          ...
          - *(dict) --*
            ...
            - **ExportDescription** *(dict) --*
              ...
              - **ExportCreationTime** *(datetime) --*
                ...
                The date and time, in epoch time format, when the export job was created. (Epoch time format
    ...
    def export_journal_to_s3(
        ...
        **Request Syntax**
        ...
        :param InclusiveStartTime: **[REQUIRED]**
          ...
          If you provide an ``InclusiveStartTime`` that is before the ledger's ``CreationDateTime`` , Amazon
          QLDB defaults it to the ledger's ``CreationDateTime`` .
    ...
    def get_block(
        ...
        **Request Syntax**
        ...
        :param BlockAddress: **[REQUIRED]**
          ...
          The location of the block that you want to request. An address is an Amazon Ion structure that has
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Proof** *(dict) --*
              ...
              The proof object in Amazon Ion format returned by a ``GetBlock`` request. A proof contains the
              list of hash values required to recalculate the specified digest using a Merkle tree, starting
    ...
    def get_digest(self, Name: str) -> ClientGetDigestResponseTypeDef:
        """
        Returns the digest of a ledger at the latest committed block in the journal. The response includes a
        256-bit hash value and a block address.
    ...
    def list_journal_s3_exports(
        ...
        This action returns a maximum of ``MaxResults`` items, and is paginated so that you can retrieve all
        the items by calling ``ListJournalS3Exports`` multiple times.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A pagination token, indicating that you want to retrieve the next page of results. If you received
          a value for ``NextToken`` in the response from a previous ``ListJournalS3Exports`` call, then you
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              * If ``NextToken`` is *not* empty, then there are more results available. To retrieve the next
              page of results, use the value of ``NextToken`` in a subsequent ``ListJournalS3Exports`` call.
    ...
    def list_journal_s3_exports_for_ledger(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A pagination token, indicating that you want to retrieve the next page of results. If you received
          a value for ``NextToken`` in the response from a previous ``ListJournalS3ExportsForLedger`` call,
    ...
    def list_ledgers(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A pagination token, indicating that you want to retrieve the next page of results. If you received
          a value for ``NextToken`` in the response from a previous ``ListLedgers`` call, then you should
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          The key-value pairs to add as tags to the specified QLDB resource. Tag keys are case sensitive. If
          you specify a key that already exists for the resource, your request fails and returns an error.
