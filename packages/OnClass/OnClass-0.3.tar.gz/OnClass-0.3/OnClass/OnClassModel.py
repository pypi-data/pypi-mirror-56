...
class OnClassModel:
	...
	def train(self, train_feature, train_label, label_emb, genes, model = 'BilinearNN', save_model = None, nhidden=[500], max_iter=20, minibatch_size=32, lr = 0.0001, l2=0.01, use_pretrain=None, pretrain_expression = None, log_transform=True, pretrain_expression = None):
	...
	def predict(self, test_X, test_genes, use_existing_model=None, label_networks=None, correct_batch = True, log_transform=True, normalize=True):
		if log_transform:
