...
class ClientCompareFacesResponseFaceMatchesFaceLandmarksTypeDef(
    ...
    - **X** *(float) --*
      ...
      The x-coordinate from the top left of the landmark expressed as the ratio of the width of the
      image. For example, if the image is 700 x 200 and the x-coordinate of the landmark is at 350
      pixels, this value is 0.5.

    - **Y** *(float) --*

      The y-coordinate from the top left of the landmark expressed as the ratio of the height of the
      image. For example, if the image is 700 x 200 and the y-coordinate of the landmark is at 100
      pixels, this value is 0.5.
    """
...
class ClientCompareFacesResponseFaceMatchesFaceTypeDef(
    ...
    Provides face metadata (bounding box and confidence that the bounding box actually contains a
    face).
    ...
    - **Landmarks** *(list) --*
      ...
      - *(dict) --*
        ...
        - **X** *(float) --*
          ...
          The x-coordinate from the top left of the landmark expressed as the ratio of the width of
          the image. For example, if the image is 700 x 200 and the x-coordinate of the landmark is
          at 350 pixels, this value is 0.5.

        - **Y** *(float) --*

          The y-coordinate from the top left of the landmark expressed as the ratio of the height of
          the image. For example, if the image is 700 x 200 and the y-coordinate of the landmark is
      ...
      - **Landmarks** *(list) --*
        ...
        - *(dict) --*
          ...
          - **Y** *(float) --*
            ...
            of the image. For example, if the image is 700 x 200 and the y-coordinate of the
            landmark is at 100 pixels, this value is 0.5.
...
class ClientDetectFacesResponseFaceDetailsAgeRangeTypeDef(
    ...
    The estimated age range, in years, for the face. Low represents the lowest estimated age and
    High represents the highest estimated age.
...
class ClientDetectFacesResponseFaceDetailsEmotionsTypeDef(
    ...
    face. It is not a determination of the person’s internal emotional state and should not be used
    in such a way. For example, a person pretending to have a sad face might not be sad emotionally.
...
class ClientDetectFacesResponseFaceDetailsTypeDef(_ClientDetectFacesResponseFaceDetailsTypeDef):
    ...
    The default attributes are ``BoundingBox`` , ``Confidence`` , ``Landmarks`` , ``Pose`` , and
    ``Quality`` .
      ...
      ``FaceAttributes`` input parameter for  StartFaceDetection . The following Amazon Rekognition
    ...
    * GetFaceSearch
    ...
    - **Emotions** *(list) --*
      ...
      - *(dict) --*
        ...
        person's face. It is not a determination of the person’s internal emotional state and should
        not be used in such a way. For example, a person pretending to have a sad face might not be
        sad emotionally.
    ...
    - **Confidence** *(float) --*
      ...
      Confidence level that the bounding box contains a face (and not a different object such as a
      tree). Default attribute.
    """
...
class ClientDetectLabelsResponseLabelsTypeDef(_ClientDetectLabelsResponseLabelsTypeDef):
    ...
    - **Instances** *(list) --*
      ...
      of the detected object. Bounding boxes are returned for common object labels such as people,
...
class ClientDetectModerationLabelsResponseModerationLabelsTypeDef(
    ...
    Provides information about a single type of unsafe content found in an image or video. Each type
    of moderated content has a label within a hierarchical taxonomy. For more information, see
...
class ClientDetectTextResponseTextDetectionsGeometryPolygonTypeDef(
    ...
    The X and Y coordinates of a point on an image. The X and Y values returned are ratios of the
    overall image size. For example, if the input image is 700x200 and the operation returns X=0.5
    and Y=0.25, then the point is at the (350,50) pixel coordinate on the image.

    An array of ``Point`` objects, ``Polygon`` , is returned by  DetectText . ``Polygon`` represents
    a fine-grained polygon around detected text. For more information, see Geometry in the Amazon
    Rekognition Developer Guide.
...
class ClientDetectTextResponseTextDetectionsGeometryTypeDef(
    ...
    - **Polygon** *(list) --*
      ...
      - *(dict) --*
        ...
        The X and Y coordinates of a point on an image. The X and Y values returned are ratios of
        the overall image size. For example, if the input image is 700x200 and the operation returns
        X=0.5 and Y=0.25, then the point is at the (350,50) pixel coordinate on the image.

        An array of ``Point`` objects, ``Polygon`` , is returned by  DetectText . ``Polygon``
        represents a fine-grained polygon around detected text. For more information, see Geometry
...
class ClientDetectTextResponseTextDetectionsTypeDef(_ClientDetectTextResponseTextDetectionsTypeDef):
    ...
    - **ParentId** *(integer) --*
      ...
      The Parent identifier for the detected text identified by the value of ``ID`` . If the type of
      detected text is ``LINE`` , the value of ``ParentId`` is ``Null`` .
    ...
    - **Geometry** *(dict) --*
      ...
      - **Polygon** *(list) --*
        ...
        - *(dict) --*
          ...
          The X and Y coordinates of a point on an image. The X and Y values returned are ratios of
          the overall image size. For example, if the input image is 700x200 and the operation
          returns X=0.5 and Y=
              0.25, then the point is at the (350,50) pixel coordinate on the image.
        ...
        - **Geometry** *(dict) --*
          ...
          - **Polygon** *(list) --*
            ...
            - *(dict) --*
              ...
              operation returns X=0.5 and Y=
                  0.25, then the point is at the (350,50) pixel coordinate
              on the image.
...
class ClientGetCelebrityRecognitionResponseCelebritiesCelebrityFaceBoundingBoxTypeDef(
    ...
    """
    Type definition for `ClientGetCelebrityRecognitionResponseCelebritiesCelebrityFace`
    `BoundingBox`
...
class ClientGetCelebrityRecognitionResponseVideoMetadataTypeDef(
    ...
    Information about a video that Amazon Rekognition Video analyzed. ``Videometadata`` is returned
...
class ClientGetFaceDetectionResponseFacesTypeDef(_ClientGetFaceDetectionResponseFacesTypeDef):
    ...
    Information about a face detected in a video analysis request and the time the face was detected
    in the video.
...
class ClientGetFaceSearchResponsePersonsFaceMatchesFaceTypeDef(
    ...
    Describes the face properties such as the bounding box, face ID, image ID of the source image,
...
_ClientGetFaceSearchResponsePersonsFaceMatchesTypeDef = TypedDict(
    ...
    {"Similarity": float, "Face": ClientGetFaceSearchResponsePersonsFaceMatchesFaceTypeDef},
    total=False,
)
...
class ClientGetFaceSearchResponsePersonsTypeDef(_ClientGetFaceSearchResponsePersonsTypeDef):
    ...
    - **Timestamp** *(integer) --*
      ...
      The time, in milliseconds from the beginning of the video, that the person was matched in the
      video.
...
_ClientIndexFacesResponseUnindexedFacesTypeDef = TypedDict(
    ...
    {"Reasons": List[str], "FaceDetail": ClientIndexFacesResponseUnindexedFacesFaceDetailTypeDef},
    total=False,
)
...
class ClientIndexFacesResponseUnindexedFacesTypeDef(_ClientIndexFacesResponseUnindexedFacesTypeDef):
    ...
    - **Reasons** *(list) --*
      ...
      * EXCEEDS_MAX_FACES - The number of faces detected is already higher than that specified by
      the ``MaxFaces`` input parameter for ``IndexFaces`` .
...
class ClientListStreamProcessorsResponseStreamProcessorsTypeDef(
    ...
    An object that recognizes faces in a streaming video. An Amazon Rekognition stream processor is
    created by a call to  CreateStreamProcessor . The request parameters for
...
_ClientSearchFacesByImageResponseFaceMatchesTypeDef = TypedDict(
    ...
    {"Similarity": float, "Face": ClientSearchFacesByImageResponseFaceMatchesFaceTypeDef},
    total=False,
)
...
_ClientStartContentModerationNotificationChannelTypeDef = TypedDict(
    "_ClientStartContentModerationNotificationChannelTypeDef", {"SNSTopicArn": str, "RoleArn": str}
)
...
_ClientStartFaceDetectionNotificationChannelTypeDef = TypedDict(
    "_ClientStartFaceDetectionNotificationChannelTypeDef", {"SNSTopicArn": str, "RoleArn": str}
)
...
_ClientStartFaceSearchNotificationChannelTypeDef = TypedDict(
    "_ClientStartFaceSearchNotificationChannelTypeDef", {"SNSTopicArn": str, "RoleArn": str}
)
...
_ClientStartLabelDetectionNotificationChannelTypeDef = TypedDict(
    "_ClientStartLabelDetectionNotificationChannelTypeDef", {"SNSTopicArn": str, "RoleArn": str}
)
...
_ClientStartPersonTrackingNotificationChannelTypeDef = TypedDict(
    "_ClientStartPersonTrackingNotificationChannelTypeDef", {"SNSTopicArn": str, "RoleArn": str}
)
