...
class QMacToolBar(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, identifier:str, parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
    ...
    def setAllowedItems(self, allowedItems:typing.List): ...
    def setItems(self, items:typing.List): ...
