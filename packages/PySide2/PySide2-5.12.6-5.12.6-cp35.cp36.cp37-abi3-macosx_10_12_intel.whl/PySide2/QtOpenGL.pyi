...
class QGLContext(Shiboken.Object):
    ...
    def chooseContext(self, shareContext:PySide2.QtOpenGL.QGLContext=...) -> bool: ...
    def colorIndex(self, c:PySide2.QtGui.QColor) -> int: ...
    def contextHandle(self) -> PySide2.QtGui.QOpenGLContext: ...
    def create(self, shareContext:PySide2.QtOpenGL.QGLContext=...) -> bool: ...
    @staticmethod
...
class QGLPixelBuffer(PySide2.QtGui.QPaintDevice):
    ...
    @typing.overload
    def __init__(self, size:PySide2.QtCore.QSize, format:PySide2.QtOpenGL.QGLFormat=..., shareWidget:PySide2.QtOpenGL.QGLWidget=...): ...
    @typing.overload
    def __init__(self, width:int, height:int, format:PySide2.QtOpenGL.QGLFormat=..., shareWidget:PySide2.QtOpenGL.QGLWidget=...): ...
    @typing.overload
    def bindTexture(self, fileName:str) -> int: ...
    @typing.overload
...
class QGLShader(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, type:PySide2.QtOpenGL.QGLShader.ShaderType, context:PySide2.QtOpenGL.QGLContext, parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
    def __init__(self, type:PySide2.QtOpenGL.QGLShader.ShaderType, parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
    ...
    @staticmethod
    def hasOpenGLShaders(type:PySide2.QtOpenGL.QGLShader.ShaderType, context:PySide2.QtOpenGL.QGLContext=...) -> bool: ...
...
class QGLShaderProgram(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, context:PySide2.QtOpenGL.QGLContext, parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
    ...
    @staticmethod
    def hasOpenGLShaderPrograms(context:PySide2.QtOpenGL.QGLContext=...) -> bool: ...
...
class QGLWidget(PySide2.QtWidgets.QWidget):
    ...
    @typing.overload
    def __init__(self, context:PySide2.QtOpenGL.QGLContext, parent:PySide2.QtWidgets.QWidget=..., shareWidget:PySide2.QtOpenGL.QGLWidget=..., f:PySide2.QtCore.Qt.WindowFlags=...): ...
    @typing.overload
    def __init__(self, format:PySide2.QtOpenGL.QGLFormat, parent:PySide2.QtWidgets.QWidget=..., shareWidget:PySide2.QtOpenGL.QGLWidget=..., f:PySide2.QtCore.Qt.WindowFlags=...): ...
    @typing.overload
    def __init__(self, parent:PySide2.QtWidgets.QWidget=..., shareWidget:PySide2.QtOpenGL.QGLWidget=..., f:PySide2.QtCore.Qt.WindowFlags=...): ...
