...
class QScxmlCompiler(Shiboken.Object):
    ...
    def errors(self) -> List[PySide2.QtScxml.QScxmlError]: ...
    ...
    class Loader(Shiboken.Object):
        ...
        def __init__(self): ...
        def load(self, name: str, baseDir: str, errors: List[str]) -> PySide2.QtCore.QByteArray: ...
...
class QScxmlDataModel(PySide2.QtCore.QObject):
    ...
    def evaluateToVariant(self, id: int, ok: bool) -> Any: ...
...
class QScxmlDynamicScxmlServiceFactory(PySide2.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, invokeInfo: PySide2.QtScxml.QScxmlExecutableContent.InvokeInfo, names: List[int], parameters: List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: PySide2.QtCore.QObject=...): ...
...
class QScxmlInvokableServiceFactory(PySide2.QtCore.QObject):
    ...
    def parameters(self) -> List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo]: ...
...
class QScxmlStateMachine(PySide2.QtCore.QObject):
    ...
    def invokedServices(self) -> List[PySide2.QtScxml.QScxmlInvokableService]: ...
    @typing.overload
    ...
    def loader(self) -> PySide2.QtScxml.QScxmlCompiler.Loader: ...
    def name(self) -> str: ...
    def parseErrors(self) -> List[PySide2.QtScxml.QScxmlError]: ...
    ...
    @typing.overload
    def submitEvent(self, eventName: str, data: Any): ...
...
class QScxmlStaticScxmlServiceFactory(PySide2.QtScxml.QScxmlInvokableServiceFactory):
    ...
    def __init__(self, metaObject: PySide2.QtCore.QMetaObject, invokeInfo: PySide2.QtScxml.QScxmlExecutableContent.InvokeInfo, nameList: List[int], parameters: List[PySide2.QtScxml.QScxmlExecutableContent.ParameterInfo], parent: PySide2.QtCore.QObject=...): ...
    def invoke(self, parentStateMachine: PySide2.QtScxml.QScxmlStateMachine) -> PySide2.QtScxml.QScxmlInvokableService: ...
