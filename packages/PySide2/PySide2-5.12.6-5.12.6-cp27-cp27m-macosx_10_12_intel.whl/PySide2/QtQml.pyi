...
class QJSEngine(PySide2.QtCore.QObject):
    ...
    def toScriptValue(self, arg__1: Any) -> PySide2.QtQml.QJSValue: ...
...
class QJSValue(Shiboken.Object):
    ...
    def __init__(self, value: int): ...
    def __copy__(self): ...
    def call(self, args: List[PySide2.QtQml.QJSValue]=...) -> PySide2.QtQml.QJSValue: ...
    def callAsConstructor(self, args: List[PySide2.QtQml.QJSValue]=...) -> PySide2.QtQml.QJSValue: ...
    def callWithInstance(self, instance: PySide2.QtQml.QJSValue, args: List[PySide2.QtQml.QJSValue]=...) -> PySide2.QtQml.QJSValue: ...
...
class QQmlContext(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def setContextProperty(self, arg__1: str, arg__2: Any): ...
...
class QQmlDebuggingEnabler(Shiboken.Object):
    ...
    @staticmethod
    def setServices(services: List[str]): ...
    @staticmethod
...
class QQmlEngine(PySide2.QtQml.QJSEngine):
    ...
    def importPlugin(self, filePath: str, uri: str, errors: List[PySide2.QtQml.QQmlError]) -> bool: ...
    ...
    def setImportPathList(self, paths: List[str]): ...
    ...
    def setPluginPathList(self, paths: List[str]): ...
...
class QQmlExpression(PySide2.QtCore.QObject):
    ...
    def evaluate(self, valueIsUndefined: bool=...) -> Any: ...
...
class QQmlFileSelector(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def setExtraSelectors(self, strings: List[str]): ...
    @typing.overload
    def setExtraSelectors(self, strings: List[str]): ...
...
class QQmlProperty(Shiboken.Object):
    ...
    @typing.overload
    @staticmethod
    def read(arg__1: PySide2.QtCore.QObject, arg__2: str) -> Any: ...
    @typing.overload
    @staticmethod
    def read(arg__1: PySide2.QtCore.QObject, arg__2: str, arg__3: PySide2.QtQml.QQmlContext) -> Any: ...
    @typing.overload
    @staticmethod
    def read(arg__1: PySide2.QtCore.QObject, arg__2: str, arg__3: PySide2.QtQml.QQmlEngine) -> Any: ...
    def reset(self) -> bool: ...
    def type(self) -> PySide2.QtQml.QQmlProperty.Type: ...
    @typing.overload
    @staticmethod
    def write(arg__1: PySide2.QtCore.QObject, arg__2: str, arg__3: Any) -> bool: ...
    @typing.overload
    @staticmethod
    def write(arg__1: PySide2.QtCore.QObject, arg__2: str, arg__3: Any, arg__4: PySide2.QtQml.QQmlContext) -> bool: ...
    @typing.overload
    @staticmethod
    def write(arg__1: PySide2.QtCore.QObject, arg__2: str, arg__3: Any, arg__4: PySide2.QtQml.QQmlEngine) -> bool: ...
    @typing.overload
    @staticmethod
    def write(arg__1: Any) -> bool: ...
