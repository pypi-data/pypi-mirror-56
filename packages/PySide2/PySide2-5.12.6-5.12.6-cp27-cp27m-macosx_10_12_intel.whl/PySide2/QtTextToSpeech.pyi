...
class QTextToSpeech(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def __init__(self, engine: str, parent: PySide2.QtCore.QObject=...): ...
    @typing.overload
    ...
    def availableVoices(self) -> List[PySide2.QtTextToSpeech.QVoice]: ...
...
class QTextToSpeechEngine(PySide2.QtCore.QObject):
    ...
    def availableVoices(self) -> List[PySide2.QtTextToSpeech.QVoice]: ...
    @staticmethod
    def createVoice(name: str, gender: PySide2.QtTextToSpeech.QVoice.Gender, age: PySide2.QtTextToSpeech.QVoice.Age, data: Any) -> PySide2.QtTextToSpeech.QVoice: ...
    def locale(self) -> PySide2.QtCore.QLocale: ...
    def pause(self): ...
    def pitch(self) -> float: ...
    def rate(self) -> float: ...
    ...
    def voice(self) -> PySide2.QtTextToSpeech.QVoice: ...
    @staticmethod
    def voiceData(voice: PySide2.QtTextToSpeech.QVoice) -> Any: ...
    def volume(self) -> float: ...
