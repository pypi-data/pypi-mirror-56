...
class Qt3DAnimation(Shiboken.Object):
    ...
    class QAnimationController(PySide2.QtCore.QObject):
        ...
        def animationGroupList(self) -> List[PySide2.Qt3DAnimation.Qt3DAnimation.QAnimationGroup]: ...
        ...
        def setAnimationGroups(self, animationGroups: List[PySide2.Qt3DAnimation.Qt3DAnimation.QAnimationGroup]): ...
    ...
    class QAnimationGroup(PySide2.QtCore.QObject):
        ...
        def animationList(self) -> List[PySide2.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation]: ...
        def duration(self) -> float: ...
        def name(self) -> str: ...
        def position(self) -> float: ...
        def removeAnimation(self, animation: PySide2.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation): ...
        def setAnimations(self, animations: List[PySide2.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation]): ...
    ...
    class QKeyframeAnimation(PySide2.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation):
        ...
        def setFramePositions(self, positions: List[float]): ...
        def setKeyframes(self, keyframes: List[PySide2.Qt3DCore.Qt3DCore.QTransform]): ...
    ...
    class QMorphTarget(PySide2.QtCore.QObject):
        ...
        @staticmethod
        def fromGeometry(geometry: PySide2.Qt3DRender.Qt3DRender.QGeometry, attributes: List[str]) -> PySide2.Qt3DAnimation.Qt3DAnimation.QMorphTarget: ...
        def removeAttribute(self, attribute: PySide2.Qt3DRender.Qt3DRender.QAttribute): ...
        def setAttributes(self, attributes: List[PySide2.Qt3DRender.Qt3DRender.QAttribute]): ...
    ...
    class QMorphingAnimation(PySide2.Qt3DAnimation.Qt3DAnimation.QAbstractAnimation):
        ...
        def morphTargetList(self) -> List[PySide2.Qt3DAnimation.Qt3DAnimation.QMorphTarget]: ...
        ...
        def setMorphTargets(self, targets: List[PySide2.Qt3DAnimation.Qt3DAnimation.QMorphTarget]): ...
        def setTarget(self, target: PySide2.Qt3DRender.Qt3DRender.QGeometryRenderer): ...
        def setTargetName(self, name: str): ...
        def setTargetPositions(self, targetPositions: List[float]): ...
        def setWeights(self, positionIndex: int, weights: List[float]): ...
