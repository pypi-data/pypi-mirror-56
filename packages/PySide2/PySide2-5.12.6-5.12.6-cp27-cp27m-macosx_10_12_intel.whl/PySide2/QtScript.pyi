...
class QScriptClass(Shiboken.Object):
    ...
    def extension(self, extension: PySide2.QtScript.QScriptClass.Extension, argument: Any=...) -> Any: ...
    def name(self) -> str: ...
...
class QScriptContext(Shiboken.Object):
    ...
    def scopeChain(self) -> List[PySide2.QtScript.QScriptValue]: ...
...
class QScriptEngine(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def newVariant(self, object: PySide2.QtScript.QScriptValue, value: Any) -> PySide2.QtScript.QScriptValue: ...
    @typing.overload
    def newVariant(self, value: Any) -> PySide2.QtScript.QScriptValue: ...
...
class QScriptEngineAgent(Shiboken.Object):
    ...
    def extension(self, extension: PySide2.QtScript.QScriptEngineAgent.Extension, argument: Any=...) -> Any: ...
...
class QScriptString(Shiboken.Object):
    ...
    def toArrayIndex(self, ok: bool=...) -> int: ...
    def toString(self) -> str: ...
...
class QScriptValue(Shiboken.Object):
    ...
    @typing.overload
    def call(self, thisObject: PySide2.QtScript.QScriptValue=..., args: List[PySide2.QtScript.QScriptValue]=...) -> PySide2.QtScript.QScriptValue: ...
    @typing.overload
    def construct(self, args: List[PySide2.QtScript.QScriptValue]=...) -> PySide2.QtScript.QScriptValue: ...
    @typing.overload
