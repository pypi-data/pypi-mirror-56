...
class QAbstractXmlNodeModel(Shiboken.Object):
    ...
    def __init__(self): ...
    def attributes(self, element: PySide2.QtXmlPatterns.QXmlNodeModelIndex) -> List[PySide2.QtXmlPatterns.QXmlNodeModelIndex]: ...
    ...
    def namespaceBindings(self, n: PySide2.QtXmlPatterns.QXmlNodeModelIndex) -> List[PySide2.QtXmlPatterns.QXmlName]: ...
    ...
    def nodesByIdref(self, NCName: PySide2.QtXmlPatterns.QXmlName) -> List[PySide2.QtXmlPatterns.QXmlNodeModelIndex]: ...
    ...
    def typedValue(self, n: PySide2.QtXmlPatterns.QXmlNodeModelIndex) -> Any: ...


class QAbstractXmlReceiver(Shiboken.Object):

    def __init__(self): ...
    def atomicValue(self, value: Any): ...
...
class QXmlItem(Shiboken.Object):
    ...
    def __init__(self): ...
    @typing.overload
    def __init__(self, atomicValue: Any): ...
    @typing.overload
