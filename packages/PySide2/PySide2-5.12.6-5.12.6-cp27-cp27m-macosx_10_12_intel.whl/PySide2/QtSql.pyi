...
class QSqlDatabase(Shiboken.Object):
    ...
    def tables(self, type: PySide2.QtSql.QSql.TableType=...) -> List[str]: ...
...
class QSqlDriver(PySide2.QtCore.QObject):
    ...
    def tables(self, tableType: PySide2.QtSql.QSql.TableType) -> List[str]: ...
...
class QSqlQuery(Shiboken.Object):
    ...
    def __copy__(self): ...
    def addBindValue(self, val: Any, type: PySide2.QtSql.QSql.ParamType=...): ...
    def at(self) -> int: ...
    @typing.overload
    def bindValue(self, placeholder: str, val: Any, type: PySide2.QtSql.QSql.ParamType=...): ...
    @typing.overload
    def bindValue(self, pos: int, val: Any, type: PySide2.QtSql.QSql.ParamType=...): ...
    @typing.overload
...
class QSqlQueryModel(PySide2.QtCore.QAbstractTableModel):
    ...
    def data(self, item: PySide2.QtCore.QModelIndex, role: int=...) -> Any: ...
...
class QSqlRecord(Shiboken.Object):
    ...
    @typing.overload
    def setValue(self, i: int, val: Any): ...
    @typing.overload
    def setValue(self, name: str, val: Any): ...
    @typing.overload
    def value(self, i: int) -> Any: ...
    @typing.overload
    def value(self, name: str) -> Any: ...
...
class QSqlRelationalTableModel(PySide2.QtSql.QSqlTableModel):
    ...
    def setData(self, item: PySide2.QtCore.QModelIndex, value: Any, role: int=...) -> bool: ...
...
class QSqlTableModel(PySide2.QtSql.QSqlQueryModel):
    ...
    def __init__(self, parent: PySide2.QtCore.QObject=..., db: PySide2.QtSql.QSqlDatabase=...): ...
    def clear(self): ...
    def data(self, idx: PySide2.QtCore.QModelIndex, role: int=...) -> Any: ...
