...
class QAbstractPrintDialog(PySide2.QtWidgets.QDialog):
    ...
    def setOptionTabs(self, tabs: List[PySide2.QtWidgets.QWidget]): ...
...
class QPrintEngine(Shiboken.Object):
    ...
    def property(self, key: PySide2.QtPrintSupport.QPrintEngine.PrintEnginePropertyKey) -> Any: ...
    def setProperty(self, key: PySide2.QtPrintSupport.QPrintEngine.PrintEnginePropertyKey, value: Any): ...
...
class QPrinterInfo(Shiboken.Object):
    ...
    @staticmethod
    def availablePrinters() -> List[PySide2.QtPrintSupport.QPrinterInfo]: ...
    ...
    def supportedDuplexModes(self) -> List[PySide2.QtPrintSupport.QPrinter.DuplexMode]: ...
    ...
    def supportedResolutions(self) -> List[int]: ...
    def supportedSizesWithNames(self) -> List[Tuple]: ...
