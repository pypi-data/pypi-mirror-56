...
class QHelpEngineCore(PySide2.QtCore.QObject):
    ...
    def __init__(self, collectionFile: str, parent: PySide2.QtCore.QObject=...): ...
    def addCustomFilter(self, filterName: str, attributes: List[str]) -> bool: ...
    ...
    def files(self, namespaceName: str, filterAttributes: List[str], extensionFilter: str=...) -> List[PySide2.QtCore.QUrl]: ...
...
class QHelpSearchEngine(PySide2.QtCore.QObject):
    ...
    def query(self) -> List[PySide2.QtHelp.QHelpSearchQuery]: ...
    ...
    @typing.overload
    def search(self, queryList: List[PySide2.QtHelp.QHelpSearchQuery]): ...
    @typing.overload
    def search(self, searchInput: str): ...
    def searchInput(self) -> str: ...
    def searchResultCount(self) -> int: ...
    def searchResults(self, start: int, end: int) -> List[PySide2.QtHelp.QHelpSearchResult]: ...
...
class QHelpSearchQuery(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, field: PySide2.QtHelp.QHelpSearchQuery.FieldName, wordList_: List[str]): ...
    def __copy__(self): ...
...
class QHelpSearchQueryWidget(PySide2.QtWidgets.QWidget):
    ...
    def setQuery(self, queryList: List[PySide2.QtHelp.QHelpSearchQuery]): ...
