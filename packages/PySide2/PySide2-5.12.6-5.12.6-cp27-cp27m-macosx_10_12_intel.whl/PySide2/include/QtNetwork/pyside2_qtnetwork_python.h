...
enum : int {
    ...
    SBK_QFLAGS_QABSTRACTSOCKET_BINDFLAG_IDX                  = 19,
    SBK_QABSTRACTSOCKET_PAUSEMODE_IDX                        = 4,
    SBK_QFLAGS_QABSTRACTSOCKET_PAUSEMODE_IDX                 = 20,
    ...
    SBK_QHOSTADDRESS_IDX                                     = 30,
    SBK_QHOSTADDRESS_SPECIALADDRESS_IDX                      = 32,
    SBK_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX                  = 31,
    SBK_QFLAGS_QHOSTADDRESS_CONVERSIONMODEFLAG_IDX           = 21,
    SBK_QHOSTINFO_IDX                                        = 33,
    SBK_QHOSTINFO_HOSTINFOERROR_IDX                          = 34,
    SBK_QHSTSPOLICY_IDX                                      = 35,
    SBK_QHSTSPOLICY_POLICYFLAG_IDX                           = 36,
    SBK_QFLAGS_QHSTSPOLICY_POLICYFLAG_IDX                    = 22,
    SBK_QHTTPMULTIPART_IDX                                   = 37,
    SBK_QHTTPMULTIPART_CONTENTTYPE_IDX                       = 38,
    SBK_QHTTPPART_IDX                                        = 39,
    SBK_QIPV6ADDRESS_IDX                                     = 40,
    SBK_QLOCALSERVER_IDX                                     = 41,
    SBK_QLOCALSERVER_SOCKETOPTION_IDX                        = 42,
    SBK_QFLAGS_QLOCALSERVER_SOCKETOPTION_IDX                 = 23,
    SBK_QLOCALSOCKET_IDX                                     = 43,
    SBK_QLOCALSOCKET_LOCALSOCKETERROR_IDX                    = 44,
    SBK_QLOCALSOCKET_LOCALSOCKETSTATE_IDX                    = 45,
    SBK_QNETWORKACCESSMANAGER_IDX                            = 46,
    SBK_QNETWORKACCESSMANAGER_OPERATION_IDX                  = 48,
    SBK_QNETWORKACCESSMANAGER_NETWORKACCESSIBILITY_IDX       = 47,
    SBK_QNETWORKADDRESSENTRY_IDX                             = 49,
    SBK_QNETWORKADDRESSENTRY_DNSELIGIBILITYSTATUS_IDX        = 50,
    SBK_QNETWORKCACHEMETADATA_IDX                            = 51,
    SBK_QNETWORKCONFIGURATION_IDX                            = 52,
    SBK_QNETWORKCONFIGURATION_TYPE_IDX                       = 56,
    SBK_QNETWORKCONFIGURATION_PURPOSE_IDX                    = 54,
    SBK_QNETWORKCONFIGURATION_STATEFLAG_IDX                  = 55,
    SBK_QFLAGS_QNETWORKCONFIGURATION_STATEFLAG_IDX           = 24,
    SBK_QNETWORKCONFIGURATION_BEARERTYPE_IDX                 = 53,
    SBK_QNETWORKCONFIGURATIONMANAGER_IDX                     = 57,
    SBK_QNETWORKCONFIGURATIONMANAGER_CAPABILITY_IDX          = 58,
    SBK_QFLAGS_QNETWORKCONFIGURATIONMANAGER_CAPABILITY_IDX   = 25,
    SBK_QNETWORKCOOKIE_IDX                                   = 59,
    SBK_QNETWORKCOOKIE_RAWFORM_IDX                           = 60,
    SBK_QNETWORKCOOKIEJAR_IDX                                = 61,
    SBK_QNETWORKDATAGRAM_IDX                                 = 62,
    SBK_QNETWORKDISKCACHE_IDX                                = 63,
    SBK_QNETWORKINTERFACE_IDX                                = 64,
    SBK_QNETWORKINTERFACE_INTERFACEFLAG_IDX                  = 65,
    SBK_QFLAGS_QNETWORKINTERFACE_INTERFACEFLAG_IDX           = 26,
    SBK_QNETWORKINTERFACE_INTERFACETYPE_IDX                  = 66,
    SBK_QNETWORKPROXY_IDX                                    = 67,
    SBK_QNETWORKPROXY_PROXYTYPE_IDX                          = 69,
    SBK_QNETWORKPROXY_CAPABILITY_IDX                         = 68,
    SBK_QFLAGS_QNETWORKPROXY_CAPABILITY_IDX                  = 27,
    SBK_QNETWORKPROXYFACTORY_IDX                             = 70,
    SBK_QNETWORKPROXYQUERY_IDX                               = 71,
    SBK_QNETWORKPROXYQUERY_QUERYTYPE_IDX                     = 72,
    SBK_QNETWORKREPLY_IDX                                    = 73,
    SBK_QNETWORKREPLY_NETWORKERROR_IDX                       = 74,
    SBK_QNETWORKREQUEST_IDX                                  = 75,
    SBK_QNETWORKREQUEST_KNOWNHEADERS_IDX                     = 78,
    SBK_QNETWORKREQUEST_ATTRIBUTE_IDX                        = 76,
    SBK_QNETWORKREQUEST_CACHELOADCONTROL_IDX                 = 77,
    SBK_QNETWORKREQUEST_LOADCONTROL_IDX                      = 79,
    SBK_QNETWORKREQUEST_PRIORITY_IDX                         = 80,
    SBK_QNETWORKREQUEST_REDIRECTPOLICY_IDX                   = 81,
    SBK_QNETWORKSESSION_IDX                                  = 82,
    SBK_QNETWORKSESSION_STATE_IDX                            = 84,
    SBK_QNETWORKSESSION_SESSIONERROR_IDX                     = 83,
    SBK_QNETWORKSESSION_USAGEPOLICY_IDX                      = 85,
    SBK_QFLAGS_QNETWORKSESSION_USAGEPOLICY_IDX               = 28,
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 86,
    SBK_QtNetworkQSSL_IDX                                    = 89,
    SBK_QSSL_KEYTYPE_IDX                                     = 93,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 91,
    SBK_QSSL_KEYALGORITHM_IDX                                = 92,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 90,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 95,
    SBK_QSSL_SSLOPTION_IDX                                   = 94,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 29,
    SBK_QSSLCERTIFICATE_IDX                                  = 96,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 97,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 98,
    SBK_QSSLCIPHER_IDX                                       = 99,
    SBK_QSSLCONFIGURATION_IDX                                = 100,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 101,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 102,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 103,
    SBK_QSSLERROR_IDX                                        = 104,
    SBK_QSSLERROR_SSLERROR_IDX                               = 105,
    SBK_QSSLKEY_IDX                                          = 106,
    SBK_QSSLPRESHAREDKEYAUTHENTICATOR_IDX                    = 107,
    SBK_QSSLSOCKET_IDX                                       = 108,
    SBK_QSSLSOCKET_SSLMODE_IDX                               = 110,
    SBK_QSSLSOCKET_PEERVERIFYMODE_IDX                        = 109,
    SBK_QTCPSERVER_IDX                                       = 111,
    SBK_QTCPSOCKET_IDX                                       = 112,
    SBK_QUDPSOCKET_IDX                                       = 113,
    SBK_QtNetwork_IDX_COUNT                                  = 114
};
...
enum : int {
    ...
    SBK_QTNETWORK_QPAIR_QHOSTADDRESS_INT_IDX                 = 8, // const QPair<QHostAddress,int > &
    SBK_QTNETWORK_QLIST_QHOSTADDRESS_IDX                     = 9, // QList<QHostAddress >
    SBK_QTNETWORK_QVECTOR_QHSTSPOLICY_IDX                    = 10, // const QVector<QHstsPolicy > &
    SBK_QTNETWORK_QLIST_QSSLERROR_IDX                        = 11, // const QList<QSslError > &
    SBK_QTNETWORK_QHASH_QNETWORKREQUEST_ATTRIBUTE_QVARIANT_IDX = 12, // QHash<QNetworkRequest::Attribute,QVariant >
    SBK_QTNETWORK_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX            = 13, // QPair<QByteArray,QByteArray >
    SBK_QTNETWORK_QLIST_QPAIR_QBYTEARRAY_QBYTEARRAY_IDX      = 14, // QList<QPair< QByteArray,QByteArray > >
    SBK_QTNETWORK_QLIST_QNETWORKCONFIGURATION_IDX            = 15, // QList<QNetworkConfiguration >
    SBK_QTNETWORK_QLIST_QNETWORKCOOKIE_IDX                   = 16, // QList<QNetworkCookie >
    SBK_QTNETWORK_QLIST_QNETWORKADDRESSENTRY_IDX             = 17, // QList<QNetworkAddressEntry >
    SBK_QTNETWORK_QLIST_QNETWORKINTERFACE_IDX                = 18, // QList<QNetworkInterface >
    SBK_QTNETWORK_QLIST_QNETWORKPROXY_IDX                    = 19, // QList<QNetworkProxy >
    SBK_QTNETWORK_QLIST_QSSLCERTIFICATEEXTENSION_IDX         = 20, // QList<QSslCertificateExtension >
    SBK_QTNETWORK_QLIST_QSSLCERTIFICATE_IDX                  = 21, // QList<QSslCertificate >
    SBK_QTNETWORK_QMULTIMAP_QSSL_ALTERNATIVENAMEENTRYTYPE_QSTRING_IDX = 22, // QMultiMap<QSsl::AlternativeNameEntryType,QString >
    SBK_QTNETWORK_QMAP_QBYTEARRAY_QVARIANT_IDX               = 23, // QMap<QByteArray,QVariant >
    SBK_QTNETWORK_QLIST_QSSLCIPHER_IDX                       = 24, // QList<QSslCipher >
    SBK_QTNETWORK_QLIST_QVARIANT_IDX                         = 25, // QList<QVariant >
    SBK_QTNETWORK_QLIST_QSTRING_IDX                          = 26, // QList<QString >
    SBK_QTNETWORK_QMAP_QSTRING_QVARIANT_IDX                  = 27, // QMap<QString,QVariant >
    SBK_QtNetwork_CONVERTERS_IDX_COUNT                       = 28
};
