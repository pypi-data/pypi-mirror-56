...
// Type indices
enum : int {
    SBK_QHELPCONTENTITEM_IDX                                 = 0,
    SBK_QHELPCONTENTMODEL_IDX                                = 1,
    SBK_QHELPCONTENTWIDGET_IDX                               = 2,
    SBK_QHELPENGINE_IDX                                      = 3,
    SBK_QHELPENGINECORE_IDX                                  = 4,
    SBK_QHELPINDEXMODEL_IDX                                  = 5,
    SBK_QHELPINDEXWIDGET_IDX                                 = 6,
    SBK_QHELPSEARCHENGINE_IDX                                = 7,
    SBK_QHELPSEARCHQUERY_IDX                                 = 8,
    SBK_QHELPSEARCHQUERY_FIELDNAME_IDX                       = 9,
    SBK_QHELPSEARCHQUERYWIDGET_IDX                           = 10,
    SBK_QHELPSEARCHRESULT_IDX                                = 11,
    SBK_QHELPSEARCHRESULTWIDGET_IDX                          = 12,
    SBK_QtHelp_IDX_COUNT                                     = 13
};
...
enum : int {
    ...
    SBK_QTHELP_QPAIR_QSTRING_QSTRING_IDX                     = 11, // QPair<QString,QString >
    SBK_QTHELP_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 12, // QList<QPair< QString,QString > >
    SBK_QTHELP_QLIST_QHELPSEARCHQUERY_IDX                    = 13, // QList<QHelpSearchQuery >
    SBK_QTHELP_QVECTOR_QHELPSEARCHRESULT_IDX                 = 14, // QVector<QHelpSearchResult >
