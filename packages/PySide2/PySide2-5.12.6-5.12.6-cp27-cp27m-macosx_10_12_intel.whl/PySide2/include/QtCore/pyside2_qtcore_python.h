...
enum : int {
    ...
    SBK_QFLAGS_QABSTRACTITEMMODEL_CHECKINDEXOPTION_IDX       = 87,
    ...
    SBK_QFLAGS_QBYTEARRAY_BASE64OPTION_IDX                   = 88,
    SBK_QBYTEARRAYMATCHER_IDX                                = 23,
    SBK_QCBORARRAY_IDX                                       = 24,
    SBK_QCBORERROR_IDX                                       = 25,
    SBK_QCBORERROR_CODE_IDX                                  = 26,
    SBK_QCBORMAP_IDX                                         = 28,
    SBK_QCBORPARSERERROR_IDX                                 = 29,
    SBK_QCBORSTREAMREADER_IDX                                = 31,
    SBK_QCBORSTREAMREADER_TYPE_IDX                           = 33,
    SBK_QCBORSTREAMREADER_STRINGRESULTCODE_IDX               = 32,
    SBK_QCBORSTREAMWRITER_IDX                                = 34,
    SBK_QCBORSTRINGRESULTBYTEARRAY_IDX                       = 35,
    SBK_QCBORSTREAMREADER_STRINGRESULT_QBYTEARRAY_IDX        = 35,
    SBK_QCBORSTRINGRESULTSTRING_IDX                          = 36,
    SBK_QCBORSTREAMREADER_STRINGRESULT_QSTRING_IDX           = 36,
    SBK_QCBORVALUE_IDX                                       = 37,
    SBK_QCBORVALUE_ENCODINGOPTION_IDX                        = 39,
    SBK_QFLAGS_QCBORVALUE_ENCODINGOPTION_IDX                 = 90,
    SBK_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX              = 38,
    SBK_QFLAGS_QCBORVALUE_DIAGNOSTICNOTATIONOPTION_IDX       = 89,
    SBK_QCBORVALUE_TYPE_IDX                                  = 40,
    SBK_QCHILDEVENT_IDX                                      = 41,
    SBK_QCOLLATOR_IDX                                        = 42,
    SBK_QCOLLATORSORTKEY_IDX                                 = 43,
    SBK_QCOMMANDLINEOPTION_IDX                               = 44,
    SBK_QCOMMANDLINEOPTION_FLAG_IDX                          = 45,
    SBK_QFLAGS_QCOMMANDLINEOPTION_FLAG_IDX                   = 91,
    SBK_QCOMMANDLINEPARSER_IDX                               = 46,
    SBK_QCOMMANDLINEPARSER_SINGLEDASHWORDOPTIONMODE_IDX      = 48,
    SBK_QCOMMANDLINEPARSER_OPTIONSAFTERPOSITIONALARGUMENTSMODE_IDX = 47,
    SBK_QCOREAPPLICATION_IDX                                 = 49,
    SBK_QCOREAPPLICATION_APPLICATIONFLAGS_IDX                = 402,
    SBK_QCRYPTOGRAPHICHASH_IDX                               = 50,
    SBK_QCRYPTOGRAPHICHASH_ALGORITHM_IDX                     = 51,
    SBK_QDATASTREAM_IDX                                      = 52,
    SBK_QDATASTREAM_VERSION_IDX                              = 56,
    SBK_QDATASTREAM_BYTEORDER_IDX                            = 53,
    SBK_QDATASTREAM_STATUS_IDX                               = 55,
    SBK_QDATASTREAM_FLOATINGPOINTPRECISION_IDX               = 54,
    SBK_QDATE_IDX                                            = 57,
    SBK_QDATE_MONTHNAMETYPE_IDX                              = 58,
    SBK_QDATETIME_IDX                                        = 59,
    SBK_QDIR_IDX                                             = 60,
    SBK_QDIR_FILTER_IDX                                      = 61,
    SBK_QFLAGS_QDIR_FILTER_IDX                               = 92,
    SBK_QDIR_SORTFLAG_IDX                                    = 62,
    SBK_QFLAGS_QDIR_SORTFLAG_IDX                             = 93,
    SBK_QDIRITERATOR_IDX                                     = 63,
    SBK_QDIRITERATOR_ITERATORFLAG_IDX                        = 64,
    SBK_QFLAGS_QDIRITERATOR_ITERATORFLAG_IDX                 = 94,
    SBK_QDYNAMICPROPERTYCHANGEEVENT_IDX                      = 65,
    SBK_QEASINGCURVE_IDX                                     = 66,
    SBK_QEASINGCURVE_TYPE_IDX                                = 67,
    SBK_QELAPSEDTIMER_IDX                                    = 68,
    SBK_QELAPSEDTIMER_CLOCKTYPE_IDX                          = 69,
    SBK_QEVENT_IDX                                           = 70,
    SBK_QEVENT_TYPE_IDX                                      = 71,
    SBK_QEVENTLOOP_IDX                                       = 72,
    SBK_QEVENTLOOP_PROCESSEVENTSFLAG_IDX                     = 73,
    SBK_QFLAGS_QEVENTLOOP_PROCESSEVENTSFLAG_IDX              = 95,
    SBK_QEVENTTRANSITION_IDX                                 = 74,
    SBK_QFACTORYINTERFACE_IDX                                = 75,
    SBK_QFILE_IDX                                            = 76,
    SBK_QFILEDEVICE_IDX                                      = 77,
    SBK_QFILEDEVICE_FILEERROR_IDX                            = 78,
    SBK_QFILEDEVICE_FILETIME_IDX                             = 80,
    SBK_QFILEDEVICE_PERMISSION_IDX                           = 82,
    SBK_QFLAGS_QFILEDEVICE_PERMISSION_IDX                    = 97,
    SBK_QFILEDEVICE_FILEHANDLEFLAG_IDX                       = 79,
    SBK_QFLAGS_QFILEDEVICE_FILEHANDLEFLAG_IDX                = 96,
    SBK_QFILEDEVICE_MEMORYMAPFLAGS_IDX                       = 81,
    SBK_QFILEINFO_IDX                                        = 83,
    SBK_QFILESELECTOR_IDX                                    = 84,
    SBK_QFILESYSTEMWATCHER_IDX                               = 85,
    SBK_QFINALSTATE_IDX                                      = 86,
    SBK_QGENERICARGUMENT_IDX                                 = 133,
    SBK_QGENERICRETURNARGUMENT_IDX                           = 134,
    SBK_QHISTORYSTATE_IDX                                    = 135,
    SBK_QHISTORYSTATE_HISTORYTYPE_IDX                        = 136,
    SBK_QIODEVICE_IDX                                        = 137,
    SBK_QIODEVICE_OPENMODEFLAG_IDX                           = 138,
    SBK_QFLAGS_QIODEVICE_OPENMODEFLAG_IDX                    = 98,
    SBK_QIDENTITYPROXYMODEL_IDX                              = 139,
    SBK_QITEMSELECTION_IDX                                   = 140,
    SBK_QLIST_QITEMSELECTIONRANGE_IDX                        = 140,
    SBK_QITEMSELECTIONMODEL_IDX                              = 141,
    SBK_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX                = 142,
    SBK_QFLAGS_QITEMSELECTIONMODEL_SELECTIONFLAG_IDX         = 99,
    SBK_QITEMSELECTIONRANGE_IDX                              = 143,
    SBK_QJSONARRAY_IDX                                       = 144,
    SBK_QJSONDOCUMENT_IDX                                    = 145,
    SBK_QJSONDOCUMENT_DATAVALIDATION_IDX                     = 146,
    SBK_QJSONDOCUMENT_JSONFORMAT_IDX                         = 147,
    SBK_QJSONPARSEERROR_IDX                                  = 148,
    SBK_QJSONPARSEERROR_PARSEERROR_IDX                       = 149,
    SBK_QJSONVALUE_IDX                                       = 150,
    SBK_QJSONVALUE_TYPE_IDX                                  = 151,
    SBK_QLIBRARYINFO_IDX                                     = 152,
    SBK_QLIBRARYINFO_LIBRARYLOCATION_IDX                     = 153,
    SBK_QLINE_IDX                                            = 154,
    SBK_QLINEF_IDX                                           = 155,
    SBK_QLINEF_INTERSECTTYPE_IDX                             = 156,
    SBK_QLOCALE_IDX                                          = 157,
    SBK_QLOCALE_LANGUAGE_IDX                                 = 162,
    SBK_QLOCALE_SCRIPT_IDX                                   = 405,
    SBK_QLOCALE_COUNTRY_IDX                                  = 158,
    SBK_QLOCALE_MEASUREMENTSYSTEM_IDX                        = 163,
    SBK_QLOCALE_FORMATTYPE_IDX                               = 161,
    SBK_QLOCALE_NUMBEROPTION_IDX                             = 164,
    SBK_QFLAGS_QLOCALE_NUMBEROPTION_IDX                      = 101,
    SBK_QLOCALE_FLOATINGPOINTPRECISIONOPTION_IDX             = 160,
    SBK_QLOCALE_CURRENCYSYMBOLFORMAT_IDX                     = 403,
    SBK_QLOCALE_DATASIZEFORMAT_IDX                           = 159,
    SBK_QFLAGS_QLOCALE_DATASIZEFORMAT_IDX                    = 100,
    SBK_QLOCALE_QUOTATIONSTYLE_IDX                           = 404,
    SBK_QLOCKFILE_IDX                                        = 165,
    SBK_QLOCKFILE_LOCKERROR_IDX                              = 166,
    SBK_QMARGINS_IDX                                         = 167,
    SBK_QMARGINSF_IDX                                        = 168,
    SBK_QMESSAGEAUTHENTICATIONCODE_IDX                       = 169,
    SBK_QMESSAGELOGCONTEXT_IDX                               = 170,
    SBK_QMETACLASSINFO_IDX                                   = 171,
    SBK_QMETAENUM_IDX                                        = 172,
    SBK_QMETAMETHOD_IDX                                      = 173,
    SBK_QMETAMETHOD_ACCESS_IDX                               = 174,
    SBK_QMETAMETHOD_METHODTYPE_IDX                           = 175,
    SBK_QMETAOBJECT_IDX                                      = 176,
    SBK_QMETAOBJECT_CALL_IDX                                 = 177,
    SBK_QMETAOBJECT_CONNECTION_IDX                           = 178,
    SBK_QMETAPROPERTY_IDX                                    = 179,
    SBK_QMIMEDATA_IDX                                        = 180,
    SBK_QMIMEDATABASE_IDX                                    = 181,
    SBK_QMIMEDATABASE_MATCHMODE_IDX                          = 182,
    SBK_QMIMETYPE_IDX                                        = 183,
    SBK_QMODELINDEX_IDX                                      = 184,
    SBK_QMUTEX_IDX                                           = 185,
    SBK_QMUTEX_RECURSIONMODE_IDX                             = 186,
    SBK_QMUTEXLOCKER_IDX                                     = 187,
    SBK_QOBJECT_IDX                                          = 188,
    SBK_QOPERATINGSYSTEMVERSION_IDX                          = 189,
    SBK_QOPERATINGSYSTEMVERSION_OSTYPE_IDX                   = 190,
    SBK_QPARALLELANIMATIONGROUP_IDX                          = 191,
    SBK_QPAUSEANIMATION_IDX                                  = 192,
    SBK_QPERSISTENTMODELINDEX_IDX                            = 193,
    SBK_QPLUGINLOADER_IDX                                    = 194,
    SBK_QPOINT_IDX                                           = 195,
    SBK_QPOINTF_IDX                                          = 196,
    SBK_QPROCESS_IDX                                         = 197,
    SBK_QPROCESS_PROCESSERROR_IDX                            = 202,
    SBK_QPROCESS_PROCESSSTATE_IDX                            = 203,
    SBK_QPROCESS_PROCESSCHANNEL_IDX                          = 200,
    SBK_QPROCESS_PROCESSCHANNELMODE_IDX                      = 201,
    SBK_QPROCESS_INPUTCHANNELMODE_IDX                        = 199,
    SBK_QPROCESS_EXITSTATUS_IDX                              = 198,
    SBK_QPROCESSENVIRONMENT_IDX                              = 204,
    SBK_QPROPERTYANIMATION_IDX                               = 205,
    SBK_QRANDOMGENERATOR_IDX                                 = 206,
    SBK_QRANDOMGENERATOR64_IDX                               = 207,
    SBK_QREADLOCKER_IDX                                      = 208,
    SBK_QREADWRITELOCK_IDX                                   = 209,
    SBK_QREADWRITELOCK_RECURSIONMODE_IDX                     = 210,
    SBK_QRECT_IDX                                            = 211,
    SBK_QRECTF_IDX                                           = 212,
    SBK_QREGEXP_IDX                                          = 213,
    SBK_QREGEXP_PATTERNSYNTAX_IDX                            = 215,
    SBK_QREGEXP_CARETMODE_IDX                                = 214,
    SBK_QREGULAREXPRESSION_IDX                               = 216,
    SBK_QREGULAREXPRESSION_PATTERNOPTION_IDX                 = 219,
    SBK_QFLAGS_QREGULAREXPRESSION_PATTERNOPTION_IDX          = 103,
    SBK_QREGULAREXPRESSION_MATCHTYPE_IDX                     = 218,
    SBK_QREGULAREXPRESSION_MATCHOPTION_IDX                   = 217,
    SBK_QFLAGS_QREGULAREXPRESSION_MATCHOPTION_IDX            = 102,
    SBK_QREGULAREXPRESSIONMATCH_IDX                          = 220,
    SBK_QREGULAREXPRESSIONMATCHITERATOR_IDX                  = 221,
    SBK_QRESOURCE_IDX                                        = 222,
    SBK_QRUNNABLE_IDX                                        = 223,
    SBK_QSAVEFILE_IDX                                        = 224,
    SBK_QSEMAPHORE_IDX                                       = 225,
    SBK_QSEMAPHORERELEASER_IDX                               = 226,
    SBK_QSEQUENTIALANIMATIONGROUP_IDX                        = 227,
    SBK_QSETTINGS_IDX                                        = 228,
    SBK_QSETTINGS_STATUS_IDX                                 = 231,
    SBK_QSETTINGS_FORMAT_IDX                                 = 229,
    SBK_QSETTINGS_SCOPE_IDX                                  = 230,
    SBK_QSIGNALBLOCKER_IDX                                   = 232,
    SBK_QSIGNALMAPPER_IDX                                    = 233,
    SBK_QSIGNALTRANSITION_IDX                                = 234,
    SBK_QSIZE_IDX                                            = 235,
    SBK_QSIZEF_IDX                                           = 236,
    SBK_QSOCKETNOTIFIER_IDX                                  = 237,
    SBK_QSOCKETNOTIFIER_TYPE_IDX                             = 238,
    SBK_QSORTFILTERPROXYMODEL_IDX                            = 239,
    SBK_QSTANDARDPATHS_IDX                                   = 240,
    SBK_QSTANDARDPATHS_STANDARDLOCATION_IDX                  = 242,
    SBK_QSTANDARDPATHS_LOCATEOPTION_IDX                      = 241,
    SBK_QFLAGS_QSTANDARDPATHS_LOCATEOPTION_IDX               = 104,
    SBK_QSTATE_IDX                                           = 243,
    SBK_QSTATE_CHILDMODE_IDX                                 = 244,
    SBK_QSTATE_RESTOREPOLICY_IDX                             = 245,
    SBK_QSTATEMACHINE_IDX                                    = 246,
    SBK_QSTATEMACHINE_EVENTPRIORITY_IDX                      = 248,
    SBK_QSTATEMACHINE_ERROR_IDX                              = 247,
    SBK_QSTATEMACHINE_SIGNALEVENT_IDX                        = 249,
    SBK_QSTATEMACHINE_WRAPPEDEVENT_IDX                       = 250,
    SBK_QSTORAGEINFO_IDX                                     = 251,
    SBK_QSTRINGLISTMODEL_IDX                                 = 252,
    SBK_QSYSINFO_IDX                                         = 253,
    SBK_QSYSINFO_SIZES_IDX                                   = 256,
    SBK_QSYSINFO_ENDIAN_IDX                                  = 254,
    SBK_QSYSINFO_MACVERSION_IDX                              = 255,
    SBK_QSYSTEMSEMAPHORE_IDX                                 = 257,
    SBK_QSYSTEMSEMAPHORE_ACCESSMODE_IDX                      = 258,
    SBK_QSYSTEMSEMAPHORE_SYSTEMSEMAPHOREERROR_IDX            = 259,
    SBK_QTEMPORARYDIR_IDX                                    = 260,
    SBK_QTEMPORARYFILE_IDX                                   = 261,
    SBK_QTEXTBOUNDARYFINDER_IDX                              = 262,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYTYPE_IDX                 = 264,
    SBK_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX               = 263,
    SBK_QFLAGS_QTEXTBOUNDARYFINDER_BOUNDARYREASON_IDX        = 105,
    SBK_QTEXTCODEC_IDX                                       = 265,
    SBK_QTEXTCODEC_CONVERSIONFLAG_IDX                        = 266,
    SBK_QFLAGS_QTEXTCODEC_CONVERSIONFLAG_IDX                 = 106,
    SBK_QTEXTCODEC_CONVERTERSTATE_IDX                        = 267,
    SBK_QTEXTDECODER_IDX                                     = 268,
    SBK_QTEXTENCODER_IDX                                     = 269,
    SBK_QTEXTSTREAM_IDX                                      = 270,
    SBK_QTEXTSTREAM_REALNUMBERNOTATION_IDX                   = 273,
    SBK_QTEXTSTREAM_FIELDALIGNMENT_IDX                       = 271,
    SBK_QTEXTSTREAM_STATUS_IDX                               = 274,
    SBK_QTEXTSTREAM_NUMBERFLAG_IDX                           = 272,
    SBK_QFLAGS_QTEXTSTREAM_NUMBERFLAG_IDX                    = 107,
    SBK_QTEXTSTREAMMANIPULATOR_IDX                           = 275,
    SBK_QTHREAD_IDX                                          = 276,
    SBK_QTHREAD_PRIORITY_IDX                                 = 277,
    SBK_QTHREADPOOL_IDX                                      = 278,
    SBK_QTIME_IDX                                            = 279,
    SBK_QTIMELINE_IDX                                        = 280,
    SBK_QTIMELINE_STATE_IDX                                  = 283,
    SBK_QTIMELINE_DIRECTION_IDX                              = 282,
    SBK_QTIMELINE_CURVESHAPE_IDX                             = 281,
    SBK_QTIMEZONE_IDX                                        = 284,
    SBK_QTIMEZONE_TIMETYPE_IDX                               = 287,
    SBK_QTIMEZONE_NAMETYPE_IDX                               = 285,
    SBK_QTIMEZONE_OFFSETDATA_IDX                             = 286,
    SBK_QTIMER_IDX                                           = 288,
    SBK_QTIMEREVENT_IDX                                      = 289,
    SBK_QTRANSLATOR_IDX                                      = 290,
    SBK_QURL_IDX                                             = 291,
    SBK_QURL_PARSINGMODE_IDX                                 = 293,
    SBK_QURL_URLFORMATTINGOPTION_IDX                         = 294,
    SBK_QURL_COMPONENTFORMATTINGOPTION_IDX                   = 292,
    SBK_QFLAGS_QURL_COMPONENTFORMATTINGOPTION_IDX            = 108,
    SBK_QURL_USERINPUTRESOLUTIONOPTION_IDX                   = 295,
    SBK_QFLAGS_QURL_USERINPUTRESOLUTIONOPTION_IDX            = 110,
    SBK_QURLQUERY_IDX                                        = 296,
    SBK_QUUID_IDX                                            = 297,
    SBK_QUUID_VARIANT_IDX                                    = 299,
    SBK_QUUID_VERSION_IDX                                    = 300,
    SBK_QUUID_STRINGFORMAT_IDX                               = 298,
    SBK_QVARIANTANIMATION_IDX                                = 301,
    SBK_QVERSIONNUMBER_IDX                                   = 302,
    SBK_QWAITCONDITION_IDX                                   = 303,
    SBK_QWRITELOCKER_IDX                                     = 304,
    SBK_QXMLSTREAMATTRIBUTE_IDX                              = 305,
    SBK_QXMLSTREAMATTRIBUTES_IDX                             = 306,
    SBK_QVECTOR_QXMLSTREAMATTRIBUTE_IDX                      = 306,
    SBK_QXMLSTREAMENTITYDECLARATION_IDX                      = 307,
    SBK_QXMLSTREAMENTITYRESOLVER_IDX                         = 308,
    SBK_QXMLSTREAMNAMESPACEDECLARATION_IDX                   = 309,
    SBK_QXMLSTREAMNOTATIONDECLARATION_IDX                    = 310,
    SBK_QXMLSTREAMREADER_IDX                                 = 311,
    SBK_QXMLSTREAMREADER_TOKENTYPE_IDX                       = 314,
    SBK_QXMLSTREAMREADER_READELEMENTTEXTBEHAVIOUR_IDX        = 313,
    SBK_QXMLSTREAMREADER_ERROR_IDX                           = 312,
    SBK_QXMLSTREAMWRITER_IDX                                 = 315,
    SBK_QtCoreQT_IDX                                         = 316,
    SBK_QT_GLOBALCOLOR_IDX                                   = 350,
    SBK_QT_KEYBOARDMODIFIER_IDX                              = 360,
    SBK_QFLAGS_QT_KEYBOARDMODIFIER_IDX                       = 122,
    SBK_QT_MODIFIER_IDX                                      = 364,
    SBK_QT_MOUSEBUTTON_IDX                                   = 365,
    SBK_QFLAGS_QT_MOUSEBUTTON_IDX                            = 124,
    SBK_QT_ORIENTATION_IDX                                   = 370,
    SBK_QFLAGS_QT_ORIENTATION_IDX                            = 126,
    SBK_QT_FOCUSPOLICY_IDX                                   = 345,
    SBK_QT_TABFOCUSBEHAVIOR_IDX                              = 381,
    SBK_QT_SORTORDER_IDX                                     = 380,
    SBK_QT_TILERULE_IDX                                      = 386,
    SBK_QT_ALIGNMENTFLAG_IDX                                 = 317,
    SBK_QFLAGS_QT_ALIGNMENTFLAG_IDX                          = 111,
    SBK_QT_TEXTFLAG_IDX                                      = 383,
    SBK_QT_TEXTELIDEMODE_IDX                                 = 382,
    SBK_QT_WHITESPACEMODE_IDX                                = 395,
    SBK_QT_HITTESTACCURACY_IDX                               = 351,
    SBK_QT_WINDOWTYPE_IDX                                    = 400,
    SBK_QFLAGS_QT_WINDOWTYPE_IDX                             = 132,
    SBK_QT_WINDOWSTATE_IDX                                   = 399,
    SBK_QFLAGS_QT_WINDOWSTATE_IDX                            = 131,
    SBK_QT_APPLICATIONSTATE_IDX                              = 320,
    SBK_QFLAGS_QT_APPLICATIONSTATE_IDX                       = 112,
    SBK_QT_SCREENORIENTATION_IDX                             = 374,
    SBK_QFLAGS_QT_SCREENORIENTATION_IDX                      = 127,
    SBK_QT_WIDGETATTRIBUTE_IDX                               = 396,
    SBK_QT_APPLICATIONATTRIBUTE_IDX                          = 319,
    SBK_QT_IMAGECONVERSIONFLAG_IDX                           = 352,
    SBK_QFLAGS_QT_IMAGECONVERSIONFLAG_IDX                    = 118,
    SBK_QT_BGMODE_IDX                                        = 324,
    SBK_QT_KEY_IDX                                           = 359,
    SBK_QT_ARROWTYPE_IDX                                     = 321,
    SBK_QT_PENSTYLE_IDX                                      = 373,
    SBK_QT_PENCAPSTYLE_IDX                                   = 371,
    SBK_QT_PENJOINSTYLE_IDX                                  = 372,
    SBK_QT_BRUSHSTYLE_IDX                                    = 325,
    SBK_QT_SIZEMODE_IDX                                      = 379,
    SBK_QT_UIEFFECT_IDX                                      = 394,
    SBK_QT_CURSORSHAPE_IDX                                   = 334,
    SBK_QT_TEXTFORMAT_IDX                                    = 384,
    SBK_QT_ASPECTRATIOMODE_IDX                               = 322,
    SBK_QT_DOCKWIDGETAREA_IDX                                = 337,
    SBK_QFLAGS_QT_DOCKWIDGETAREA_IDX                         = 113,
    SBK_QT_DOCKWIDGETAREASIZES_IDX                           = 338,
    SBK_QT_TOOLBARAREA_IDX                                   = 389,
    SBK_QFLAGS_QT_TOOLBARAREA_IDX                            = 129,
    SBK_QT_TOOLBARAREASIZES_IDX                              = 390,
    SBK_QT_DATEFORMAT_IDX                                    = 335,
    SBK_QT_TIMESPEC_IDX                                      = 387,
    SBK_QT_DAYOFWEEK_IDX                                     = 336,
    SBK_QT_SCROLLBARPOLICY_IDX                               = 375,
    SBK_QT_CASESENSITIVITY_IDX                               = 326,
    SBK_QT_CORNER_IDX                                        = 333,
    SBK_QT_EDGE_IDX                                          = 340,
    SBK_QFLAGS_QT_EDGE_IDX                                   = 115,
    SBK_QT_CONNECTIONTYPE_IDX                                = 330,
    SBK_QT_SHORTCUTCONTEXT_IDX                               = 377,
    SBK_QT_FILLRULE_IDX                                      = 343,
    SBK_QT_MASKMODE_IDX                                      = 362,
    SBK_QT_CLIPOPERATION_IDX                                 = 329,
    SBK_QT_ITEMSELECTIONMODE_IDX                             = 357,
    SBK_QT_ITEMSELECTIONOPERATION_IDX                        = 358,
    SBK_QT_TRANSFORMATIONMODE_IDX                            = 393,
    SBK_QT_AXIS_IDX                                          = 323,
    SBK_QT_FOCUSREASON_IDX                                   = 346,
    SBK_QT_CONTEXTMENUPOLICY_IDX                             = 331,
    SBK_QT_INPUTMETHODQUERY_IDX                              = 354,
    SBK_QFLAGS_QT_INPUTMETHODQUERY_IDX                       = 120,
    SBK_QT_INPUTMETHODHINT_IDX                               = 353,
    SBK_QFLAGS_QT_INPUTMETHODHINT_IDX                        = 119,
    SBK_QT_ENTERKEYTYPE_IDX                                  = 341,
    SBK_QT_TOOLBUTTONSTYLE_IDX                               = 391,
    SBK_QT_LAYOUTDIRECTION_IDX                               = 361,
    SBK_QT_ANCHORPOINT_IDX                                   = 318,
    SBK_QT_FINDCHILDOPTION_IDX                               = 344,
    SBK_QFLAGS_QT_FINDCHILDOPTION_IDX                        = 116,
    SBK_QT_DROPACTION_IDX                                    = 339,
    SBK_QFLAGS_QT_DROPACTION_IDX                             = 114,
    SBK_QT_CHECKSTATE_IDX                                    = 327,
    SBK_QT_ITEMDATAROLE_IDX                                  = 355,
    SBK_QT_ITEMFLAG_IDX                                      = 356,
    SBK_QFLAGS_QT_ITEMFLAG_IDX                               = 121,
    SBK_QT_MATCHFLAG_IDX                                     = 363,
    SBK_QFLAGS_QT_MATCHFLAG_IDX                              = 123,
    SBK_QT_WINDOWMODALITY_IDX                                = 398,
    SBK_QT_TEXTINTERACTIONFLAG_IDX                           = 385,
    SBK_QFLAGS_QT_TEXTINTERACTIONFLAG_IDX                    = 128,
    SBK_QT_EVENTPRIORITY_IDX                                 = 342,
    SBK_QT_SIZEHINT_IDX                                      = 378,
    SBK_QT_WINDOWFRAMESECTION_IDX                            = 397,
    SBK_QT_COORDINATESYSTEM_IDX                              = 332,
    SBK_QT_TOUCHPOINTSTATE_IDX                               = 392,
    SBK_QFLAGS_QT_TOUCHPOINTSTATE_IDX                        = 130,
    SBK_QT_GESTURESTATE_IDX                                  = 348,
    SBK_QT_GESTURETYPE_IDX                                   = 349,
    SBK_QT_GESTUREFLAG_IDX                                   = 347,
    SBK_QFLAGS_QT_GESTUREFLAG_IDX                            = 117,
    SBK_QT_NATIVEGESTURETYPE_IDX                             = 368,
    SBK_QT_NAVIGATIONMODE_IDX                                = 369,
    SBK_QT_CURSORMOVESTYLE_IDX                               = 406,
    SBK_QT_TIMERTYPE_IDX                                     = 388,
    SBK_QT_SCROLLPHASE_IDX                                   = 376,
    SBK_QT_MOUSEEVENTSOURCE_IDX                              = 367,
    SBK_QT_MOUSEEVENTFLAG_IDX                                = 366,
    SBK_QFLAGS_QT_MOUSEEVENTFLAG_IDX                         = 125,
    SBK_QT_CHECKSUMTYPE_IDX                                  = 328,
    SBK_QCBORKNOWNTAGS_IDX                                   = 27,
    SBK_QCBORSIMPLETYPE_IDX                                  = 30,
    SBK_QTMSGTYPE_IDX                                        = 401,
    SBK_QtCore_IDX_COUNT                                     = 407
};
...
enum : int {
    SBK_QCHAR_IDX                                            = 0,
    SBK_QJSONOBJECT_IDX                                      = 1,
    SBK_QMODELINDEXLIST_IDX                                  = 2,
    SBK_QSTRING_IDX                                          = 3,
    SBK_QSTRINGLIST_IDX                                      = 4,
    SBK_QSTRINGREF_IDX                                       = 5,
    SBK_QVARIANT_IDX                                         = 6,
    SBK_QVARIANT_TYPE_IDX                                    = 7,
    SBK_BOOL_IDX                                             = 8,
    SBK_QINTPTR_IDX                                          = 9,
    SBK_QPTRDIFF_IDX                                         = 10,
    SBK_QUINTPTR_IDX                                         = 11,
    SBK_QTCORE_QLIST_QOBJECTPTR_IDX                          = 12, // const QList<QObject* > &
    SBK_QTCORE_QLIST_QBYTEARRAY_IDX                          = 13, // QList<QByteArray >
    SBK_QTCORE_QLIST_QABSTRACTEVENTDISPATCHER_TIMERINFO_IDX  = 14, // QList<QAbstractEventDispatcher::TimerInfo >
    SBK_QTCORE_QVECTOR_INT_IDX                               = 15, // const QVector<int > &
    SBK_QTCORE_QHASH_INT_QBYTEARRAY_IDX                      = 16, // const QHash<int,QByteArray > &
    SBK_QTCORE_QMAP_INT_QVARIANT_IDX                         = 17, // QMap<int,QVariant >
    SBK_QTCORE_QLIST_QPERSISTENTMODELINDEX_IDX               = 18, // const QList<QPersistentModelIndex > &
    SBK_QTCORE_QLIST_QABSTRACTANIMATIONPTR_IDX               = 19, // QList<QAbstractAnimation* >
    SBK_QTCORE_QLIST_QABSTRACTSTATEPTR_IDX                   = 20, // const QList<QAbstractState* > &
    SBK_QTCORE_QLIST_QVARIANT_IDX                            = 21, // const QList<QVariant > &
    SBK_QTCORE_QHASH_QSTRING_QVARIANT_IDX                    = 22, // const QHash<QString,QVariant > &
    SBK_QTCORE_QMAP_QSTRING_QVARIANT_IDX                     = 23, // const QMap<QString,QVariant > &
    SBK_QTCORE_QVECTOR_QCBORVALUE_IDX                        = 24, // QVector<QCborValue >
    SBK_QTCORE_QLIST_QCOMMANDLINEOPTION_IDX                  = 25, // const QList<QCommandLineOption > &
    SBK_QTCORE_QLIST_QFILEINFO_IDX                           = 26, // QList<QFileInfo >
    SBK_QTCORE_QVECTOR_QPOINTF_IDX                           = 27, // QVector<QPointF >
    SBK_QTCORE_QLIST_QITEMSELECTIONRANGE_IDX                 = 28, // const QList<QItemSelectionRange > &
    SBK_QTCORE_QSET_QITEMSELECTIONRANGE_IDX                  = 29, // const QSet<QItemSelectionRange > &
    SBK_QTCORE_QVECTOR_QITEMSELECTIONRANGE_IDX               = 30, // const QVector<QItemSelectionRange > &
    SBK_QTCORE_QLIST_QLOCALE_COUNTRY_IDX                     = 31, // QList<QLocale::Country >
    SBK_QTCORE_QLIST_QLOCALE_IDX                             = 32, // QList<QLocale >
    SBK_QTCORE_QLIST_QT_DAYOFWEEK_IDX                        = 33, // QList<Qt::DayOfWeek >
    SBK_QTCORE_QLIST_QURL_IDX                                = 34, // const QList<QUrl > &
    SBK_QTCORE_QLIST_QMIMETYPE_IDX                           = 35, // QList<QMimeType >
    SBK_QTCORE_QPAIR_QREAL_QVARIANT_IDX                      = 36, // QPair<qreal,QVariant >
    SBK_QTCORE_QVECTOR_QPAIR_QREAL_QVARIANT_IDX              = 37, // QVector<QPair< qreal,QVariant > >
    SBK_QTCORE_QLIST_QABSTRACTTRANSITIONPTR_IDX              = 38, // QList<QAbstractTransition* >
    SBK_QTCORE_QSET_QABSTRACTSTATEPTR_IDX                    = 39, // QSet<QAbstractState* >
    SBK_QTCORE_QLIST_QSTORAGEINFO_IDX                        = 40, // QList<QStorageInfo >
    SBK_QTCORE_QLIST_INT_IDX                                 = 41, // QList<int >
    SBK_QTCORE_QVECTOR_QTIMEZONE_OFFSETDATA_IDX              = 42, // QVector<QTimeZone::OffsetData >
    SBK_QTCORE_QPAIR_QSTRING_QSTRING_IDX                     = 43, // QPair<QString,QString >
    SBK_QTCORE_QLIST_QPAIR_QSTRING_QSTRING_IDX               = 44, // QList<QPair< QString,QString > >
    SBK_QTCORE_QVECTOR_QXMLSTREAMATTRIBUTE_IDX               = 45, // QVector<QXmlStreamAttribute > &
    SBK_QTCORE_QLIST_QXMLSTREAMATTRIBUTE_IDX                 = 46, // const QList<QXmlStreamAttribute > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMNAMESPACEDECLARATION_IDX    = 47, // const QVector<QXmlStreamNamespaceDeclaration > &
    SBK_QTCORE_QVECTOR_QXMLSTREAMENTITYDECLARATION_IDX       = 48, // QVector<QXmlStreamEntityDeclaration >
    SBK_QTCORE_QVECTOR_QXMLSTREAMNOTATIONDECLARATION_IDX     = 49, // QVector<QXmlStreamNotationDeclaration >
    SBK_QTCORE_QLIST_QSTRING_IDX                             = 50, // QList<QString >
    SBK_QtCore_CONVERTERS_IDX_COUNT                          = 51
};
...
template<> inline PyTypeObject *SbkType< ::QSysInfo::MacVersion >() { return SbkPySide2_QtCoreTypes[SBK_QSYSINFO_MACVERSION_IDX]; }
