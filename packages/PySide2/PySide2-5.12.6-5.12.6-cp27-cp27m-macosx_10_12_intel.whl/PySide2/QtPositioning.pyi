...
class QGeoAreaMonitorSource(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def activeMonitors(self) -> List[PySide2.QtPositioning.QGeoAreaMonitorInfo]: ...
    @typing.overload
    def activeMonitors(self, lookupArea: PySide2.QtPositioning.QGeoShape) -> List[PySide2.QtPositioning.QGeoAreaMonitorInfo]: ...
    @staticmethod
...
class QGeoPath(PySide2.QtPositioning.QGeoShape):
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoShape): ...
    @typing.overload
    def __init__(self, path: List[PySide2.QtPositioning.QGeoCoordinate], width: float=...): ...
    def __copy__(self): ...
    ...
    def setVariantPath(self, path: List[Any]): ...
...
class QGeoPolygon(PySide2.QtPositioning.QGeoShape):
    ...
    def __init__(self, other: PySide2.QtPositioning.QGeoShape): ...
    @typing.overload
    def __init__(self, path: List[PySide2.QtPositioning.QGeoCoordinate]): ...
    def __copy__(self): ...
    def addCoordinate(self, coordinate: PySide2.QtPositioning.QGeoCoordinate): ...
    @typing.overload
    def addHole(self, holePath: List[PySide2.QtPositioning.QGeoCoordinate]): ...
    @typing.overload
    def addHole(self, holePath: Any): ...
    def containsCoordinate(self, coordinate: PySide2.QtPositioning.QGeoCoordinate) -> bool: ...
    def coordinateAt(self, index: int) -> PySide2.QtPositioning.QGeoCoordinate: ...
    def hole(self, index: int) -> List[Any]: ...
    def holePath(self, index: int) -> List[PySide2.QtPositioning.QGeoCoordinate]: ...
    def holesCount(self) -> int: ...
    def insertCoordinate(self, index: int, coordinate: PySide2.QtPositioning.QGeoCoordinate): ...
    def length(self, indexFrom: int=..., indexTo: int=...) -> float: ...
    def path(self) -> List[PySide2.QtPositioning.QGeoCoordinate]: ...
    def perimeter(self) -> List[Any]: ...
    @typing.overload
    def removeCoordinate(self, coordinate: PySide2.QtPositioning.QGeoCoordinate): ...
    @typing.overload
    def removeCoordinate(self, index: int): ...
    ...
    def replaceCoordinate(self, index: int, coordinate: PySide2.QtPositioning.QGeoCoordinate): ...
    def setPath(self, path: List[PySide2.QtPositioning.QGeoCoordinate]): ...
    def setPerimeter(self, path: List[Any]): ...
    def size(self) -> int: ...
    def toString(self) -> str: ...
    def translate(self, degreesLatitude: float, degreesLongitude: float): ...
...
class QGeoRectangle(PySide2.QtPositioning.QGeoShape):
    ...
    @typing.overload
    def __init__(self, coordinates: List[PySide2.QtPositioning.QGeoCoordinate]): ...
    @typing.overload
