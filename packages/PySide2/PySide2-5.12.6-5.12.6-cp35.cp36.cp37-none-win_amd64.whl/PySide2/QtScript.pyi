...
class QScriptValue(Shiboken.Object):
    ...
    @typing.overload
    def call(self, thisObject:PySide2.QtScript.QScriptValue=..., args:typing.List=...) -> PySide2.QtScript.QScriptValue: ...
    @typing.overload
    def construct(self, args:typing.List=...) -> PySide2.QtScript.QScriptValue: ...
    @typing.overload
