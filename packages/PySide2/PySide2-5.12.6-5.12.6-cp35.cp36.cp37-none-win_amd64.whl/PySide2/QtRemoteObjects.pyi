...
class QRemoteObjectAbstractPersistedStore(PySide2.QtCore.QObject):
    ...
    def saveProperties(self, repName:str, repSig:PySide2.QtCore.QByteArray, values:typing.List): ...
...
class QRemoteObjectHost(PySide2.QtRemoteObjects.QRemoteObjectHostBase):
    ...
    @typing.overload
    def __init__(self, address:PySide2.QtCore.QUrl, registryAddress:PySide2.QtCore.QUrl=..., allowedSchemas:PySide2.QtRemoteObjects.QRemoteObjectHostBase.AllowedSchemas=..., parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
    def __init__(self, parent:PySide2.QtCore.QObject=...): ...
...
class QRemoteObjectHostBase(PySide2.QtRemoteObjects.QRemoteObjectNode):
    ...
    @typing.overload
    def enableRemoting(self, model:PySide2.QtCore.QAbstractItemModel, name:str, roles:typing.List, selectionModel:PySide2.QtCore.QItemSelectionModel=...) -> bool: ...
    @typing.overload
...
class QRemoteObjectNode(PySide2.QtCore.QObject):
    ...
    def __init__(self, parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
    def __init__(self, registryAddress:PySide2.QtCore.QUrl, parent:PySide2.QtCore.QObject=...): ...
...
class QRemoteObjectPendingCallWatcher(PySide2.QtCore.QObject, PySide2.QtRemoteObjects.QRemoteObjectPendingCall):
    ...
    def __init__(self, call:PySide2.QtRemoteObjects.QRemoteObjectPendingCall, parent:PySide2.QtCore.QObject=...): ...
    def isFinished(self) -> bool: ...
    @typing.overload
...
class QRemoteObjectReplica(PySide2.QtCore.QObject):
    ...
    def persistProperties(self, repName:str, repSig:PySide2.QtCore.QByteArray, props:typing.List): ...
    ...
    def send(self, call:PySide2.QtCore.QMetaObject.Call, index:int, args:typing.List): ...
    def sendWithReply(self, call:PySide2.QtCore.QMetaObject.Call, index:int, args:typing.List) -> PySide2.QtRemoteObjects.QRemoteObjectPendingCall: ...
    def setChild(self, i:int, arg__2:typing.Any): ...
    def setNode(self, node:PySide2.QtRemoteObjects.QRemoteObjectNode): ...
    def setProperties(self, arg__1:typing.List): ...
