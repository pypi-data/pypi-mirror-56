...
class QGeoCodeReply(PySide2.QtCore.QObject):
    ...
    def setLocations(self, locations: List[PySide2.QtPositioning.QGeoLocation]): ...
...
class QGeoRoute(Shiboken.Object):
    ...
    def setPath(self, path: List[PySide2.QtPositioning.QGeoCoordinate]): ...
...
class QGeoRouteReply(PySide2.QtCore.QObject):
    ...
    def abort(self): ...
    def addRoutes(self, routes: List[PySide2.QtLocation.QGeoRoute]): ...
    def error(self) -> PySide2.QtLocation.QGeoRouteReply.Error: ...
    def errorString(self) -> str: ...
    def isFinished(self) -> bool: ...
    def request(self) -> PySide2.QtLocation.QGeoRouteRequest: ...
    def routes(self) -> List[PySide2.QtLocation.QGeoRoute]: ...
    def setError(self, error: PySide2.QtLocation.QGeoRouteReply.Error, errorString: str): ...
    def setFinished(self, finished: bool): ...
    def setRoutes(self, routes: List[PySide2.QtLocation.QGeoRoute]): ...
...
class QGeoRouteRequest(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, waypoints: List[PySide2.QtPositioning.QGeoCoordinate]=...): ...
    def excludeAreas(self) -> List[PySide2.QtPositioning.QGeoRectangle]: ...
    def extraParameters(self) -> Dict: ...
    def featureTypes(self) -> List[PySide2.QtLocation.QGeoRouteRequest.FeatureType]: ...
    ...
    def setExcludeAreas(self, areas: List[PySide2.QtPositioning.QGeoRectangle]): ...
    ...
    def setWaypoints(self, waypoints: List[PySide2.QtPositioning.QGeoCoordinate]): ...
    def setWaypointsMetadata(self, waypointMetadata: List[Dict]): ...
    ...
    def waypointsMetadata(self) -> List[Dict]: ...
...
class QPlace(Shiboken.Object):
    ...
    def categories(self) -> List[PySide2.QtLocation.QPlaceCategory]: ...
    def contactDetails(self, contactType: str) -> List[PySide2.QtLocation.QPlaceContactDetail]: ...
    ...
    def setCategories(self, categories: List[PySide2.QtLocation.QPlaceCategory]): ...
    def setCategory(self, category: PySide2.QtLocation.QPlaceCategory): ...
    def setContactDetails(self, contactType: str, details: List[PySide2.QtLocation.QPlaceContactDetail]): ...
...
class QPlaceContentRequest(Shiboken.Object):
    ...
    def limit(self) -> int: ...
    def placeId(self) -> str: ...
    def setContentContext(self, context: Any): ...
...
class QPlaceManager(PySide2.QtCore.QObject):
    ...
    def childCategories(self, parentId: str=...) -> List[PySide2.QtLocation.QPlaceCategory]: ...
    ...
    def setLocale(self, locale: PySide2.QtCore.QLocale): ...
    def setLocales(self, locale: List[PySide2.QtCore.QLocale]): ...
...
class QPlaceManagerEngine(PySide2.QtCore.QObject):
    ...
    def searchSuggestions(self, request: PySide2.QtLocation.QPlaceSearchRequest) -> PySide2.QtLocation.QPlaceSearchSuggestionReply: ...
    def setLocales(self, locales: List[PySide2.QtCore.QLocale]): ...


class QPlaceMatchReply(PySide2.QtLocation.QPlaceReply):

    def __init__(self, parent: PySide2.QtCore.QObject=...): ...
    def places(self) -> List[PySide2.QtLocation.QPlace]: ...
    def request(self) -> PySide2.QtLocation.QPlaceMatchRequest: ...
    def setPlaces(self, results: List[PySide2.QtLocation.QPlace]): ...
...
class QPlaceMatchRequest(Shiboken.Object):
    ...
    def places(self) -> List[PySide2.QtLocation.QPlace]: ...
    def setParameters(self, parameters: Dict): ...
    def setPlaces(self, places: List[PySide2.QtLocation.QPlace]): ...
    def setResults(self, results: List[PySide2.QtLocation.QPlaceSearchResult]): ...
...
class QPlaceSearchReply(PySide2.QtLocation.QPlaceReply):
    ...
    def results(self) -> List[PySide2.QtLocation.QPlaceSearchResult]: ...
...
class QPlaceSearchRequest(Shiboken.Object):
    ...
    def setSearchContext(self, context: Any): ...
