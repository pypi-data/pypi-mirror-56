...
class QSensor(PySide2.QtCore.QObject):
    ...
    def availableDataRates(self) -> List[Tuple]: ...
    ...
    def error(self) -> int: ...
    def filters(self) -> List[PySide2.QtSensors.QSensorFilter]: ...
    ...
    def outputRanges(self) -> List[PySide2.QtSensors.qoutputrange]: ...
    ...
    @staticmethod
    def sensorsForType(type: PySide2.QtCore.QByteArray) -> List[PySide2.QtCore.QByteArray]: ...
...
class QSensorGesturePluginInterface(Shiboken.Object):
    ...
    def __init__(self): ...
    def createRecognizers(self) -> List[PySide2.QtSensors.QSensorGestureRecognizer]: ...
    def name(self) -> str: ...
