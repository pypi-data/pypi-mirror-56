...
class QDtls(PySide2.QtCore.QObject):
    ...
    def ignoreVerificationErrors(self, errorsToIgnore: List[PySide2.QtNetwork.QSslError]): ...
    def isConnectionEncrypted(self) -> bool: ...
    def mtuHint(self) -> int: ...
    def peerAddress(self) -> PySide2.QtNetwork.QHostAddress: ...
    def peerPort(self) -> int: ...
    def peerVerificationErrors(self) -> List[PySide2.QtNetwork.QSslError]: ...
...
class QSslCertificate(Shiboken.Object):
    ...
    def handle(self) -> int: ...
    @staticmethod
    def importPkcs12(device: PySide2.QtCore.QIODevice, key: PySide2.QtNetwork.QSslKey, cert: PySide2.QtNetwork.QSslCertificate, caCertificates: List[PySide2.QtNetwork.QSslCertificate]=..., passPhrase: PySide2.QtCore.QByteArray=...) -> bool: ...
