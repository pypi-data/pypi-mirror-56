...
class QAbstractAudioDeviceInfo(PySide2.QtCore.QObject):
    ...
    def supportedByteOrders(self) -> List[PySide2.QtMultimedia.QAudioFormat.Endian]: ...
    ...
    def supportedSampleTypes(self) -> List[PySide2.QtMultimedia.QAudioFormat.SampleType]: ...
...
class QAbstractVideoSurface(PySide2.QtCore.QObject):
    ...
    def stop(self): ...
    def supportedPixelFormats(self, type: PySide2.QtMultimedia.QAbstractVideoBuffer.HandleType=...) -> List[PySide2.QtMultimedia.QVideoFrame.PixelFormat]: ...
...
class QAudioDecoder(PySide2.QtMultimedia.QMediaObject):
    ...
    @staticmethod
    def hasSupport(mimeType: str, codecs: List[str]=...) -> PySide2.QtMultimedia.QMultimedia.SupportEstimate: ...
...
class QAudioDeviceInfo(Shiboken.Object):
    ...
    def __copy__(self): ...
    @staticmethod
    def availableDevices(mode: PySide2.QtMultimedia.QAudio.Mode) -> List[PySide2.QtMultimedia.QAudioDeviceInfo]: ...
    @staticmethod
...
class QAudioEncoderSettings(Shiboken.Object):
    ...
    def encodingOption(self, option: str) -> Any: ...
    ...
    def setEncodingOption(self, option: str, value: Any): ...
...
class QAudioRoleControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def supportedAudioRoles(self) -> List[PySide2.QtMultimedia.QAudio.Role]: ...
...
class QCamera(PySide2.QtMultimedia.QMediaObject):
    ...
    def supportedViewfinderFrameRateRanges(self, settings: PySide2.QtMultimedia.QCameraViewfinderSettings=...) -> List[PySide2.QtMultimedia.QCamera.FrameRateRange]: ...
    def supportedViewfinderPixelFormats(self, settings: PySide2.QtMultimedia.QCameraViewfinderSettings=...) -> List[PySide2.QtMultimedia.QVideoFrame.PixelFormat]: ...
    def supportedViewfinderResolutions(self, settings: PySide2.QtMultimedia.QCameraViewfinderSettings=...) -> List[PySide2.QtCore.QSize]: ...
    def supportedViewfinderSettings(self, settings: PySide2.QtMultimedia.QCameraViewfinderSettings=...) -> List[PySide2.QtMultimedia.QCameraViewfinderSettings]: ...
    def unload(self): ...
    @typing.overload
    def unlock(self): ...
    @typing.overload
...
class QCameraCaptureBufferFormatControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def supportedBufferFormats(self) -> List[PySide2.QtMultimedia.QVideoFrame.PixelFormat]: ...
...
class QCameraExposureControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def __init__(self, parent: PySide2.QtCore.QObject=...): ...
    def actualValue(self, parameter: PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter) -> Any: ...
    def isParameterSupported(self, parameter: PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter) -> bool: ...
    def requestedValue(self, parameter: PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter) -> Any: ...
    def setValue(self, parameter: PySide2.QtMultimedia.QCameraExposureControl.ExposureParameter, value: Any) -> bool: ...
...
class QCameraImageProcessingControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def isParameterValueSupported(self, parameter: PySide2.QtMultimedia.QCameraImageProcessingControl.ProcessingParameter, value: Any) -> bool: ...
    def parameter(self, parameter: PySide2.QtMultimedia.QCameraImageProcessingControl.ProcessingParameter) -> Any: ...
    def setParameter(self, parameter: PySide2.QtMultimedia.QCameraImageProcessingControl.ProcessingParameter, value: Any): ...
...
class QCameraInfo(Shiboken.Object):
    ...
    def __copy__(self): ...
    @staticmethod
    def availableCameras(position: PySide2.QtMultimedia.QCamera.Position=...) -> List[PySide2.QtMultimedia.QCameraInfo]: ...
    @staticmethod
...
class QCameraViewfinderSettingsControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def setViewfinderParameter(self, parameter: PySide2.QtMultimedia.QCameraViewfinderSettingsControl.ViewfinderParameter, value: Any): ...
    def viewfinderParameter(self, parameter: PySide2.QtMultimedia.QCameraViewfinderSettingsControl.ViewfinderParameter) -> Any: ...
...
class QCameraViewfinderSettingsControl2(PySide2.QtMultimedia.QMediaControl):
    ...
    def __init__(self, parent: PySide2.QtCore.QObject=...): ...
    def setViewfinderSettings(self, settings: PySide2.QtMultimedia.QCameraViewfinderSettings): ...
    def supportedViewfinderSettings(self) -> List[PySide2.QtMultimedia.QCameraViewfinderSettings]: ...
    def viewfinderSettings(self) -> PySide2.QtMultimedia.QCameraViewfinderSettings: ...
...
class QMediaContent(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, resources: List[PySide2.QtMultimedia.QMediaResource]): ...
    def __copy__(self): ...
    ...
    def resources(self) -> List[PySide2.QtMultimedia.QMediaResource]: ...
...
class QMediaNetworkAccessControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def setConfigurations(self, configuration: List[PySide2.QtNetwork.QNetworkConfiguration]): ...
...
class QMediaPlayer(PySide2.QtMultimedia.QMediaObject):
    ...
    def errorString(self) -> str: ...
    @staticmethod
    def hasSupport(mimeType: str, codecs: List[str]=..., flags: PySide2.QtMultimedia.QMediaPlayer.Flags=...) -> PySide2.QtMultimedia.QMultimedia.SupportEstimate: ...
    ...
    def setNetworkConfigurations(self, configurations: List[PySide2.QtNetwork.QNetworkConfiguration]): ...
    ...
    def supportedCustomAudioRoles(self) -> List[str]: ...
    @staticmethod
    def supportedMimeTypes(flags: PySide2.QtMultimedia.QMediaPlayer.Flags=...) -> List[str]: ...
    def unbind(self, arg__1: PySide2.QtCore.QObject): ...
    def volume(self) -> int: ...
...
class QMediaPlaylist(PySide2.QtCore.QObject, PySide2.QtMultimedia.QMediaBindableInterface):
    ...
    @typing.overload
    def addMedia(self, items: List[PySide2.QtMultimedia.QMediaContent]) -> bool: ...
    def clear(self) -> bool: ...
    ...
    @typing.overload
    def insertMedia(self, index: int, items: List[PySide2.QtMultimedia.QMediaContent]) -> bool: ...
...
class QMediaServiceProviderHint(Shiboken.Object):
    ...
    @typing.overload
    def __init__(self, mimeType: str, codecs: List[str]): ...
    @typing.overload
...
class QMediaServiceSupportedDevicesInterface(Shiboken.Object):
    ...
    def devices(self, service: PySide2.QtCore.QByteArray) -> List[PySide2.QtCore.QByteArray]: ...


class QMediaServiceSupportedFormatsInterface(Shiboken.Object):

    def __init__(self): ...
    def hasSupport(self, mimeType: str, codecs: List[str]) -> PySide2.QtMultimedia.QMultimedia.SupportEstimate: ...
...
class QMediaStreamsControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def metaData(self, streamNumber: int, key: str) -> Any: ...
...
class QMediaTimeRange(Shiboken.Object):
    ...
    def intervals(self) -> List[PySide2.QtMultimedia.QMediaTimeInterval]: ...
...
class QRadioTuner(PySide2.QtMultimedia.QMediaObject):
    ...
    def frequencyRange(self, band: PySide2.QtMultimedia.QRadioTuner.Band) -> Tuple: ...
...
class QRadioTunerControl(PySide2.QtMultimedia.QMediaControl):
    ...
    def errorString(self) -> str: ...
    def frequency(self) -> int: ...
    def frequencyRange(self, b: PySide2.QtMultimedia.QRadioTuner.Band) -> Tuple: ...
