...
// Type indices
enum : int {
    SBK_QtConcurrentQTCONCURRENT_IDX                         = 1,
    SBK_QTCONCURRENT_THREADFUNCTIONRESULT_IDX                = 3,
    SBK_QTCONCURRENT_REDUCEOPTION_IDX                        = 2,
    SBK_QFLAGS_QTCONCURRENT_REDUCEOPTION_IDX                 = 0,
    SBK_QtConcurrent_IDX_COUNT                               = 4
};
...
// Converter indices
enum : int {
    SBK_QTCONCURRENT_QLIST_QVARIANT_IDX                      = 0, // QList<QVariant >
    SBK_QTCONCURRENT_QLIST_QSTRING_IDX                       = 1, // QList<QString >
