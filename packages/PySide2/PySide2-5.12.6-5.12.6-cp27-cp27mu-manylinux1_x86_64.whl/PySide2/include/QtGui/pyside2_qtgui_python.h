...
enum : int {
    ...
    SBK_QFLAGS_QACCESSIBLE_RELATIONFLAG_IDX                  = 53,
    ...
    SBK_QCONICALGRADIENT_IDX                                 = 38,
    SBK_QCONTEXTMENUEVENT_IDX                                = 39,
    SBK_QCONTEXTMENUEVENT_REASON_IDX                         = 40,
    SBK_QCURSOR_IDX                                          = 41,
    SBK_QDESKTOPSERVICES_IDX                                 = 42,
    SBK_QDOUBLEVALIDATOR_IDX                                 = 43,
    SBK_QDOUBLEVALIDATOR_NOTATION_IDX                        = 44,
    SBK_QDRAG_IDX                                            = 45,
    SBK_QDRAGENTEREVENT_IDX                                  = 46,
    SBK_QDRAGLEAVEEVENT_IDX                                  = 47,
    SBK_QDRAGMOVEEVENT_IDX                                   = 48,
    SBK_QDROPEVENT_IDX                                       = 49,
    SBK_QENTEREVENT_IDX                                      = 50,
    SBK_QEXPOSEEVENT_IDX                                     = 51,
    SBK_QFILEOPENEVENT_IDX                                   = 52,
    SBK_QFOCUSEVENT_IDX                                      = 74,
    SBK_QFONT_IDX                                            = 75,
    SBK_QFONT_STYLEHINT_IDX                                  = 80,
    SBK_QFONT_STYLESTRATEGY_IDX                              = 81,
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 369,
    SBK_QFONT_WEIGHT_IDX                                     = 82,
    SBK_QFONT_STYLE_IDX                                      = 79,
    SBK_QFONT_STRETCH_IDX                                    = 78,
    SBK_QFONT_CAPITALIZATION_IDX                             = 76,
    SBK_QFONT_SPACINGTYPE_IDX                                = 77,
    SBK_QFONTDATABASE_IDX                                    = 83,
    SBK_QFONTDATABASE_WRITINGSYSTEM_IDX                      = 85,
    SBK_QFONTDATABASE_SYSTEMFONT_IDX                         = 84,
    SBK_QFONTINFO_IDX                                        = 86,
    SBK_QFONTMETRICS_IDX                                     = 87,
    SBK_QFONTMETRICSF_IDX                                    = 88,
    SBK_QGRADIENT_IDX                                        = 89,
    SBK_QGRADIENT_TYPE_IDX                                   = 94,
    SBK_QGRADIENT_SPREAD_IDX                                 = 93,
    SBK_QGRADIENT_COORDINATEMODE_IDX                         = 90,
    SBK_QGRADIENT_INTERPOLATIONMODE_IDX                      = 91,
    SBK_QGRADIENT_PRESET_IDX                                 = 92,
    SBK_QGUIAPPLICATION_IDX                                  = 95,
    SBK_QHELPEVENT_IDX                                       = 96,
    SBK_QHIDEEVENT_IDX                                       = 97,
    SBK_QHOVEREVENT_IDX                                      = 98,
    SBK_QICON_IDX                                            = 99,
    SBK_QICON_MODE_IDX                                       = 100,
    SBK_QICON_STATE_IDX                                      = 101,
    SBK_QICONDRAGEVENT_IDX                                   = 102,
    SBK_QICONENGINE_IDX                                      = 103,
    SBK_QICONENGINE_ICONENGINEHOOK_IDX                       = 105,
    SBK_QICONENGINE_AVAILABLESIZESARGUMENT_IDX               = 104,
    SBK_QIMAGE_IDX                                           = 106,
    SBK_QIMAGE_INVERTMODE_IDX                                = 108,
    SBK_QIMAGE_FORMAT_IDX                                    = 107,
    SBK_QIMAGEIOHANDLER_IDX                                  = 109,
    SBK_QIMAGEIOHANDLER_IMAGEOPTION_IDX                      = 110,
    SBK_QIMAGEIOHANDLER_TRANSFORMATION_IDX                   = 111,
    SBK_QFLAGS_QIMAGEIOHANDLER_TRANSFORMATION_IDX            = 54,
    SBK_QIMAGEREADER_IDX                                     = 112,
    SBK_QIMAGEREADER_IMAGEREADERERROR_IDX                    = 113,
    SBK_QIMAGEWRITER_IDX                                     = 114,
    SBK_QIMAGEWRITER_IMAGEWRITERERROR_IDX                    = 115,
    SBK_QINPUTEVENT_IDX                                      = 116,
    SBK_QINPUTMETHOD_IDX                                     = 117,
    SBK_QINPUTMETHOD_ACTION_IDX                              = 118,
    SBK_QINPUTMETHODEVENT_IDX                                = 119,
    SBK_QINPUTMETHODEVENT_ATTRIBUTETYPE_IDX                  = 121,
    SBK_QINPUTMETHODEVENT_ATTRIBUTE_IDX                      = 120,
    SBK_QINPUTMETHODQUERYEVENT_IDX                           = 122,
    SBK_QINTVALIDATOR_IDX                                    = 123,
    SBK_QKEYEVENT_IDX                                        = 124,
    SBK_QKEYSEQUENCE_IDX                                     = 125,
    SBK_QKEYSEQUENCE_STANDARDKEY_IDX                         = 128,
    SBK_QKEYSEQUENCE_SEQUENCEFORMAT_IDX                      = 126,
    SBK_QKEYSEQUENCE_SEQUENCEMATCH_IDX                       = 127,
    SBK_QLINEARGRADIENT_IDX                                  = 129,
    SBK_QMATRIX_IDX                                          = 130,
    SBK_QMATRIX2X2_IDX                                       = 131,
    SBK_QGENERICMATRIX_2_2_FLOAT_IDX                         = 131,
    SBK_QMATRIX2X3_IDX                                       = 132,
    SBK_QGENERICMATRIX_2_3_FLOAT_IDX                         = 132,
    SBK_QMATRIX2X4_IDX                                       = 133,
    SBK_QGENERICMATRIX_2_4_FLOAT_IDX                         = 133,
    SBK_QMATRIX3X2_IDX                                       = 134,
    SBK_QGENERICMATRIX_3_2_FLOAT_IDX                         = 134,
    SBK_QMATRIX3X3_IDX                                       = 135,
    SBK_QGENERICMATRIX_3_3_FLOAT_IDX                         = 135,
    SBK_QMATRIX3X4_IDX                                       = 136,
    SBK_QGENERICMATRIX_3_4_FLOAT_IDX                         = 136,
    SBK_QMATRIX4X2_IDX                                       = 137,
    SBK_QGENERICMATRIX_4_2_FLOAT_IDX                         = 137,
    SBK_QMATRIX4X3_IDX                                       = 138,
    SBK_QGENERICMATRIX_4_3_FLOAT_IDX                         = 138,
    SBK_QMATRIX4X4_IDX                                       = 139,
    SBK_QMOUSEEVENT_IDX                                      = 140,
    SBK_QMOVEEVENT_IDX                                       = 141,
    SBK_QMOVIE_IDX                                           = 142,
    SBK_QMOVIE_MOVIESTATE_IDX                                = 144,
    SBK_QMOVIE_CACHEMODE_IDX                                 = 143,
    SBK_QNATIVEGESTUREEVENT_IDX                              = 145,
    SBK_QOFFSCREENSURFACE_IDX                                = 146,
    SBK_QOPENGLBUFFER_IDX                                    = 147,
    SBK_QOPENGLBUFFER_TYPE_IDX                               = 150,
    SBK_QOPENGLBUFFER_USAGEPATTERN_IDX                       = 151,
    SBK_QOPENGLBUFFER_ACCESS_IDX                             = 148,
    SBK_QOPENGLBUFFER_RANGEACCESSFLAG_IDX                    = 149,
    SBK_QFLAGS_QOPENGLBUFFER_RANGEACCESSFLAG_IDX             = 55,
    SBK_QOPENGLCONTEXT_IDX                                   = 152,
    SBK_QOPENGLCONTEXT_OPENGLMODULETYPE_IDX                  = 153,
    SBK_QOPENGLCONTEXTGROUP_IDX                              = 154,
    SBK_QOPENGLDEBUGLOGGER_IDX                               = 155,
    SBK_QOPENGLDEBUGLOGGER_LOGGINGMODE_IDX                   = 156,
    SBK_QOPENGLDEBUGMESSAGE_IDX                              = 157,
    SBK_QOPENGLDEBUGMESSAGE_SOURCE_IDX                       = 159,
    SBK_QFLAGS_QOPENGLDEBUGMESSAGE_SOURCE_IDX                = 57,
    SBK_QOPENGLDEBUGMESSAGE_TYPE_IDX                         = 160,
    SBK_QFLAGS_QOPENGLDEBUGMESSAGE_TYPE_IDX                  = 58,
    SBK_QOPENGLDEBUGMESSAGE_SEVERITY_IDX                     = 158,
    SBK_QFLAGS_QOPENGLDEBUGMESSAGE_SEVERITY_IDX              = 56,
    SBK_QOPENGLEXTRAFUNCTIONS_IDX                            = 161,
    SBK_QOPENGLFRAMEBUFFEROBJECT_IDX                         = 162,
    SBK_QOPENGLFRAMEBUFFEROBJECT_ATTACHMENT_IDX              = 163,
    SBK_QOPENGLFRAMEBUFFEROBJECT_FRAMEBUFFERRESTOREPOLICY_IDX = 164,
    SBK_QOPENGLFRAMEBUFFEROBJECTFORMAT_IDX                   = 165,
    SBK_QOPENGLFUNCTIONS_IDX                                 = 166,
    SBK_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX                   = 167,
    SBK_QFLAGS_QOPENGLFUNCTIONS_OPENGLFEATURE_IDX            = 59,
    SBK_QOPENGLPIXELTRANSFEROPTIONS_IDX                      = 168,
    SBK_QOPENGLSHADER_IDX                                    = 169,
    SBK_QOPENGLSHADER_SHADERTYPEBIT_IDX                      = 170,
    SBK_QFLAGS_QOPENGLSHADER_SHADERTYPEBIT_IDX               = 60,
    SBK_QOPENGLSHADERPROGRAM_IDX                             = 171,
    SBK_QOPENGLTEXTURE_IDX                                   = 172,
    SBK_QOPENGLTEXTURE_TARGET_IDX                            = 186,
    SBK_QOPENGLTEXTURE_BINDINGTARGET_IDX                     = 173,
    SBK_QOPENGLTEXTURE_MIPMAPGENERATION_IDX                  = 181,
    SBK_QOPENGLTEXTURE_TEXTUREUNITRESET_IDX                  = 189,
    SBK_QOPENGLTEXTURE_TEXTUREFORMAT_IDX                     = 187,
    SBK_QOPENGLTEXTURE_TEXTUREFORMATCLASS_IDX                = 188,
    SBK_QOPENGLTEXTURE_CUBEMAPFACE_IDX                       = 177,
    SBK_QOPENGLTEXTURE_PIXELFORMAT_IDX                       = 182,
    SBK_QOPENGLTEXTURE_PIXELTYPE_IDX                         = 183,
    SBK_QOPENGLTEXTURE_SWIZZLECOMPONENT_IDX                  = 184,
    SBK_QOPENGLTEXTURE_SWIZZLEVALUE_IDX                      = 185,
    SBK_QOPENGLTEXTURE_WRAPMODE_IDX                          = 190,
    SBK_QOPENGLTEXTURE_COORDINATEDIRECTION_IDX               = 176,
    SBK_QOPENGLTEXTURE_FEATURE_IDX                           = 179,
    SBK_QFLAGS_QOPENGLTEXTURE_FEATURE_IDX                    = 61,
    SBK_QOPENGLTEXTURE_DEPTHSTENCILMODE_IDX                  = 178,
    SBK_QOPENGLTEXTURE_COMPARISONFUNCTION_IDX                = 174,
    SBK_QOPENGLTEXTURE_COMPARISONMODE_IDX                    = 175,
    SBK_QOPENGLTEXTURE_FILTER_IDX                            = 180,
    SBK_QOPENGLTEXTUREBLITTER_IDX                            = 191,
    SBK_QOPENGLTEXTUREBLITTER_ORIGIN_IDX                     = 192,
    SBK_QOPENGLTIMEMONITOR_IDX                               = 193,
    SBK_QOPENGLTIMERQUERY_IDX                                = 194,
    SBK_QOPENGLVERSIONPROFILE_IDX                            = 195,
    SBK_QOPENGLVERTEXARRAYOBJECT_IDX                         = 196,
    SBK_QOPENGLVERTEXARRAYOBJECT_BINDER_IDX                  = 197,
    SBK_QOPENGLWINDOW_IDX                                    = 198,
    SBK_QOPENGLWINDOW_UPDATEBEHAVIOR_IDX                     = 199,
    SBK_QPAGELAYOUT_IDX                                      = 200,
    SBK_QPAGELAYOUT_UNIT_IDX                                 = 203,
    SBK_QPAGELAYOUT_ORIENTATION_IDX                          = 202,
    SBK_QPAGELAYOUT_MODE_IDX                                 = 201,
    SBK_QPAGESIZE_IDX                                        = 204,
    SBK_QPAGESIZE_PAGESIZEID_IDX                             = 205,
    SBK_QPAGESIZE_UNIT_IDX                                   = 207,
    SBK_QPAGESIZE_SIZEMATCHPOLICY_IDX                        = 206,
    SBK_QPAGEDPAINTDEVICE_IDX                                = 208,
    SBK_QPAGEDPAINTDEVICE_PAGESIZE_IDX                       = 210,
    SBK_QPAGEDPAINTDEVICE_PDFVERSION_IDX                     = 211,
    SBK_QPAGEDPAINTDEVICE_MARGINS_IDX                        = 209,
    SBK_QPAINTDEVICE_IDX                                     = 212,
    SBK_QPAINTDEVICE_PAINTDEVICEMETRIC_IDX                   = 213,
    SBK_QPAINTDEVICEWINDOW_IDX                               = 214,
    SBK_QPAINTENGINE_IDX                                     = 215,
    SBK_QPAINTENGINE_PAINTENGINEFEATURE_IDX                  = 217,
    SBK_QFLAGS_QPAINTENGINE_PAINTENGINEFEATURE_IDX           = 63,
    SBK_QPAINTENGINE_DIRTYFLAG_IDX                           = 216,
    SBK_QFLAGS_QPAINTENGINE_DIRTYFLAG_IDX                    = 62,
    SBK_QPAINTENGINE_POLYGONDRAWMODE_IDX                     = 218,
    SBK_QPAINTENGINE_TYPE_IDX                                = 219,
    SBK_QPAINTENGINESTATE_IDX                                = 220,
    SBK_QPAINTEVENT_IDX                                      = 221,
    SBK_QPAINTER_IDX                                         = 222,
    SBK_QPAINTER_RENDERHINT_IDX                              = 226,
    SBK_QFLAGS_QPAINTER_RENDERHINT_IDX                       = 65,
    SBK_QPAINTER_PIXMAPFRAGMENTHINT_IDX                      = 225,
    SBK_QFLAGS_QPAINTER_PIXMAPFRAGMENTHINT_IDX               = 64,
    SBK_QPAINTER_COMPOSITIONMODE_IDX                         = 223,
    SBK_QPAINTER_PIXMAPFRAGMENT_IDX                          = 224,
    SBK_QPAINTERPATH_IDX                                     = 227,
    SBK_QPAINTERPATH_ELEMENTTYPE_IDX                         = 229,
    SBK_QPAINTERPATH_ELEMENT_IDX                             = 228,
    SBK_QPAINTERPATHSTROKER_IDX                              = 230,
    SBK_QPALETTE_IDX                                         = 231,
    SBK_QPALETTE_COLORGROUP_IDX                              = 232,
    SBK_QPALETTE_COLORROLE_IDX                               = 233,
    SBK_QPDFWRITER_IDX                                       = 234,
    SBK_QPEN_IDX                                             = 235,
    SBK_QPICTURE_IDX                                         = 236,
    SBK_QPICTUREIO_IDX                                       = 237,
    SBK_QPIXELFORMAT_IDX                                     = 238,
    SBK_QPIXELFORMAT_COLORMODEL_IDX                          = 243,
    SBK_QPIXELFORMAT_ALPHAUSAGE_IDX                          = 241,
    SBK_QPIXELFORMAT_ALPHAPOSITION_IDX                       = 239,
    SBK_QPIXELFORMAT_ALPHAPREMULTIPLIED_IDX                  = 240,
    SBK_QPIXELFORMAT_TYPEINTERPRETATION_IDX                  = 244,
    SBK_QPIXELFORMAT_YUVLAYOUT_IDX                           = 245,
    SBK_QPIXELFORMAT_BYTEORDER_IDX                           = 242,
    SBK_QPIXMAP_IDX                                          = 246,
    SBK_QPIXMAPCACHE_IDX                                     = 247,
    SBK_QPIXMAPCACHE_KEY_IDX                                 = 248,
    SBK_QPOINTINGDEVICEUNIQUEID_IDX                          = 249,
    SBK_QPOLYGON_IDX                                         = 250,
    SBK_QVECTOR_QPOINT_IDX                                   = 250,
    SBK_QPOLYGONF_IDX                                        = 251,
    SBK_QVECTOR_QPOINTF_IDX                                  = 251,
    SBK_QPYTEXTOBJECT_IDX                                    = 252,
    SBK_QQUATERNION_IDX                                      = 253,
    SBK_QRADIALGRADIENT_IDX                                  = 254,
    SBK_QRASTERWINDOW_IDX                                    = 255,
    SBK_QRAWFONT_IDX                                         = 256,
    SBK_QRAWFONT_ANTIALIASINGTYPE_IDX                        = 257,
    SBK_QRAWFONT_LAYOUTFLAG_IDX                              = 258,
    SBK_QFLAGS_QRAWFONT_LAYOUTFLAG_IDX                       = 66,
    SBK_QREGEXPVALIDATOR_IDX                                 = 259,
    SBK_QREGION_IDX                                          = 260,
    SBK_QREGION_REGIONTYPE_IDX                               = 261,
    SBK_QRESIZEEVENT_IDX                                     = 262,
    SBK_QSCREEN_IDX                                          = 263,
    SBK_QSCROLLEVENT_IDX                                     = 264,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 265,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 266,
    SBK_QSESSIONMANAGER_IDX                                  = 267,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 268,
    SBK_QSHORTCUTEVENT_IDX                                   = 269,
    SBK_QSHOWEVENT_IDX                                       = 270,
    SBK_QSTANDARDITEM_IDX                                    = 271,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 272,
    SBK_QSTANDARDITEMMODEL_IDX                               = 273,
    SBK_QSTATICTEXT_IDX                                      = 274,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 275,
    SBK_QSTATUSTIPEVENT_IDX                                  = 276,
    SBK_QSTYLEHINTS_IDX                                      = 277,
    SBK_QSURFACE_IDX                                         = 278,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 279,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 280,
    SBK_QSURFACEFORMAT_IDX                                   = 281,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 283,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 67,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 286,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 285,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 284,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 282,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 287,
    SBK_QTABLETEVENT_IDX                                     = 288,
    SBK_QTABLETEVENT_TABLETDEVICE_IDX                        = 290,
    SBK_QTABLETEVENT_POINTERTYPE_IDX                         = 289,
    SBK_QTEXTBLOCK_IDX                                       = 291,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 292,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 293,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 370,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 294,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 295,
    SBK_QTEXTCHARFORMAT_IDX                                  = 296,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 299,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 298,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 297,
    SBK_QTEXTCURSOR_IDX                                      = 300,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 301,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 302,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 303,
    SBK_QTEXTDOCUMENT_IDX                                    = 304,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 306,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 305,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 68,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 307,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 308,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 309,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 310,
    SBK_QTEXTFORMAT_IDX                                      = 311,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 312,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 315,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 313,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 314,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 69,
    SBK_QTEXTFRAGMENT_IDX                                    = 316,
    SBK_QTEXTFRAME_IDX                                       = 317,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 318,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 319,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 321,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 320,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 322,
    SBK_QTEXTINLINEOBJECT_IDX                                = 323,
    SBK_QTEXTITEM_IDX                                        = 324,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 325,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 70,
    SBK_QTEXTLAYOUT_IDX                                      = 326,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 327,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 328,
    SBK_QTEXTLENGTH_IDX                                      = 329,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 330,
    SBK_QTEXTLINE_IDX                                        = 331,
    SBK_QTEXTLINE_EDGE_IDX                                   = 333,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 332,
    SBK_QTEXTLIST_IDX                                        = 334,
    SBK_QTEXTLISTFORMAT_IDX                                  = 335,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 336,
    SBK_QTEXTOBJECT_IDX                                      = 337,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 338,
    SBK_QTEXTOPTION_IDX                                      = 339,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 342,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 343,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 340,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 71,
    SBK_QTEXTOPTION_TAB_IDX                                  = 341,
    SBK_QTEXTTABLE_IDX                                       = 344,
    SBK_QTEXTTABLECELL_IDX                                   = 345,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 346,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 347,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 348,
    SBK_QTOUCHDEVICE_IDX                                     = 349,
    SBK_QTOUCHDEVICE_DEVICETYPE_IDX                          = 351,
    SBK_QTOUCHDEVICE_CAPABILITYFLAG_IDX                      = 350,
    SBK_QFLAGS_QTOUCHDEVICE_CAPABILITYFLAG_IDX               = 72,
    SBK_QTOUCHEVENT_IDX                                      = 352,
    SBK_QTOUCHEVENT_TOUCHPOINT_IDX                           = 353,
    SBK_QTOUCHEVENT_TOUCHPOINT_INFOFLAG_IDX                  = 354,
    SBK_QFLAGS_QTOUCHEVENT_TOUCHPOINT_INFOFLAG_IDX           = 73,
    SBK_QTRANSFORM_IDX                                       = 355,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 356,
    SBK_QVALIDATOR_IDX                                       = 357,
    SBK_QVALIDATOR_STATE_IDX                                 = 358,
    SBK_QVECTOR2D_IDX                                        = 359,
    SBK_QVECTOR3D_IDX                                        = 360,
    SBK_QVECTOR4D_IDX                                        = 361,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 362,
    SBK_QWHEELEVENT_IDX                                      = 363,
    SBK_QWINDOW_IDX                                          = 364,
    SBK_QWINDOW_VISIBILITY_IDX                               = 366,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 365,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 367,
    SBK_QtGuiQT_IDX                                          = 368,
    SBK_QtGui_IDX_COUNT                                      = 371
};
...
enum : int {
    ...
    SBK_QTGUI_QVECTOR_UNSIGNEDLONG_IDX                       = 26, // QVector<unsigned long >
