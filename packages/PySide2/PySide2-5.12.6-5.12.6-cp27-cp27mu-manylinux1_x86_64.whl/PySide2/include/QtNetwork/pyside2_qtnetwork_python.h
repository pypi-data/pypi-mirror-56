...
enum : int {
    ...
    SBK_QtNetworkQPASSWORDDIGESTOR_IDX                       = 88,
    SBK_QtNetworkQSSL_IDX                                    = 91,
    SBK_QSSL_KEYTYPE_IDX                                     = 95,
    SBK_QSSL_ENCODINGFORMAT_IDX                              = 93,
    SBK_QSSL_KEYALGORITHM_IDX                                = 94,
    SBK_QSSL_ALTERNATIVENAMEENTRYTYPE_IDX                    = 92,
    SBK_QSSL_SSLPROTOCOL_IDX                                 = 97,
    SBK_QSSL_SSLOPTION_IDX                                   = 96,
    SBK_QFLAGS_QSSL_SSLOPTION_IDX                            = 31,
    SBK_QSSLCERTIFICATE_IDX                                  = 98,
    SBK_QSSLCERTIFICATE_SUBJECTINFO_IDX                      = 99,
    SBK_QSSLCERTIFICATEEXTENSION_IDX                         = 100,
    SBK_QSSLCIPHER_IDX                                       = 101,
    SBK_QSSLCONFIGURATION_IDX                                = 102,
    SBK_QSSLCONFIGURATION_NEXTPROTOCOLNEGOTIATIONSTATUS_IDX  = 103,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_IDX                      = 104,
    SBK_QSSLDIFFIEHELLMANPARAMETERS_ERROR_IDX                = 105,
...
enum : int {
    ...
    SBK_QTNETWORK_QLIST_QVARIANT_IDX                         = 26, // QList<QVariant >
    SBK_QTNETWORK_QLIST_QSTRING_IDX                          = 27, // QList<QString >
    SBK_QTNETWORK_QMAP_QSTRING_QVARIANT_IDX                  = 28, // QMap<QString,QVariant >
    SBK_QtNetwork_CONVERTERS_IDX_COUNT                       = 29
};
