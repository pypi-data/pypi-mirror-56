...
enum : int {
    ...
    SBK_QT3DCORE_QBACKENDNODE_IDX                            = 9,
    SBK_QT3DCORE_QBACKENDNODE_MODE_IDX                       = 10,
    SBK_QT3DCORE_QCOMPONENT_IDX                              = 11,
    SBK_QT3DCORE_QCOMPONENTADDEDCHANGE_IDX                   = 12,
    SBK_QT3DCORE_QCOMPONENTREMOVEDCHANGE_IDX                 = 13,
    SBK_QT3DCORE_QDYNAMICPROPERTYUPDATEDCHANGE_IDX           = 14,
    SBK_QT3DCORE_QENTITY_IDX                                 = 15,
    SBK_QT3DCORE_QJOINT_IDX                                  = 16,
    SBK_QT3DCORE_QNODE_IDX                                   = 17,
    SBK_QT3DCORE_QNODE_PROPERTYTRACKINGMODE_IDX              = 18,
    SBK_QT3DCORE_QNODECOMMAND_IDX                            = 19,
    SBK_QT3DCORE_QNODECREATEDCHANGEBASE_IDX                  = 20,
    SBK_QT3DCORE_QNODEDESTROYEDCHANGE_IDX                    = 21,
    SBK_QT3DCORE_QNODEID_IDX                                 = 22,
    SBK_QT3DCORE_QNODEIDTYPEPAIR_IDX                         = 23,
    SBK_QT3DCORE_QPROPERTYNODEADDEDCHANGE_IDX                = 24,
    SBK_QT3DCORE_QPROPERTYNODEREMOVEDCHANGE_IDX              = 25,
    SBK_QT3DCORE_QPROPERTYUPDATEDCHANGE_IDX                  = 26,
    SBK_QT3DCORE_QPROPERTYUPDATEDCHANGEBASE_IDX              = 27,
    SBK_QT3DCORE_QPROPERTYVALUEADDEDCHANGE_IDX               = 28,
    SBK_QT3DCORE_QPROPERTYVALUEADDEDCHANGEBASE_IDX           = 29,
    SBK_QT3DCORE_QPROPERTYVALUEREMOVEDCHANGE_IDX             = 30,
    SBK_QT3DCORE_QPROPERTYVALUEREMOVEDCHANGEBASE_IDX         = 31,
    SBK_QT3DCORE_QSCENECHANGE_IDX                            = 32,
    SBK_QT3DCORE_QSCENECHANGE_DELIVERYFLAG_IDX               = 33,
    SBK_QFLAGS_QT3DCORE_QSCENECHANGE_DELIVERYFLAG_IDX        = 1,
    SBK_QT3DCORE_QSKELETON_IDX                               = 34,
    SBK_QT3DCORE_QSKELETONLOADER_IDX                         = 35,
    SBK_QT3DCORE_QSKELETONLOADER_STATUS_IDX                  = 36,
    SBK_QT3DCORE_QSTATICPROPERTYUPDATEDCHANGEBASE_IDX        = 37,
    SBK_QT3DCORE_QSTATICPROPERTYVALUEADDEDCHANGEBASE_IDX     = 38,
    SBK_QT3DCORE_QSTATICPROPERTYVALUEREMOVEDCHANGEBASE_IDX   = 39,
    SBK_QT3DCORE_QTRANSFORM_IDX                              = 40,
    SBK_Qt3DCore_IDX_COUNT                                   = 41
};
