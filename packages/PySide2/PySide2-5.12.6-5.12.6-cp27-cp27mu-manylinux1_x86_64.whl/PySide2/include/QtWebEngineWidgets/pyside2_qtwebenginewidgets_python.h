...
enum : int {
    ...
    SBK_QWEBENGINEPAGE_WEBACTION_IDX                         = 25,
    SBK_QWEBENGINEPAGE_FINDFLAG_IDX                          = 20,
    SBK_QFLAGS_QWEBENGINEPAGE_FINDFLAG_IDX                   = 2,
    SBK_QWEBENGINEPAGE_WEBWINDOWTYPE_IDX                     = 26,
    SBK_QWEBENGINEPAGE_PERMISSIONPOLICY_IDX                  = 23,
    SBK_QWEBENGINEPAGE_NAVIGATIONTYPE_IDX                    = 22,
    ...
    SBK_QWEBENGINEPAGE_RENDERPROCESSTERMINATIONSTATUS_IDX    = 24,
    SBK_QWEBENGINEPROFILE_IDX                                = 27,
    SBK_QWEBENGINEPROFILE_HTTPCACHETYPE_IDX                  = 28,
    SBK_QWEBENGINEPROFILE_PERSISTENTCOOKIESPOLICY_IDX        = 29,
    SBK_QWEBENGINESCRIPT_IDX                                 = 30,
    SBK_QWEBENGINESCRIPT_INJECTIONPOINT_IDX                  = 31,
    SBK_QWEBENGINESCRIPT_SCRIPTWORLDID_IDX                   = 32,
    SBK_QWEBENGINESCRIPTCOLLECTION_IDX                       = 33,
    SBK_QWEBENGINESETTINGS_IDX                               = 34,
    SBK_QWEBENGINESETTINGS_FONTFAMILY_IDX                    = 35,
    SBK_QWEBENGINESETTINGS_WEBATTRIBUTE_IDX                  = 38,
    SBK_QWEBENGINESETTINGS_FONTSIZE_IDX                      = 36,
    SBK_QWEBENGINESETTINGS_UNKNOWNURLSCHEMEPOLICY_IDX        = 37,
    SBK_QWEBENGINEVIEW_IDX                                   = 39,
    SBK_QtWebEngineWidgets_IDX_COUNT                         = 40
};
...
// Converter indices
enum : int {
    SBK_QTWEBENGINEWIDGETS_QLIST_QOBJECTPTR_IDX              = 0, // const QList<QObject* > &
    SBK_QTWEBENGINEWIDGETS_QLIST_QBYTEARRAY_IDX              = 1, // QList<QByteArray >
    SBK_QTWEBENGINEWIDGETS_QLIST_QWEBENGINEHISTORYITEM_IDX   = 2, // QList<QWebEngineHistoryItem >
    SBK_QTWEBENGINEWIDGETS_QLIST_QURL_IDX                    = 3, // const QList<QUrl > &
    SBK_QTWEBENGINEWIDGETS_QLIST_QWEBENGINESCRIPT_IDX        = 4, // QList<QWebEngineScript >
    SBK_QTWEBENGINEWIDGETS_QLIST_QACTIONPTR_IDX              = 5, // QList<QAction* >
    SBK_QTWEBENGINEWIDGETS_QLIST_QVARIANT_IDX                = 6, // QList<QVariant >
    SBK_QTWEBENGINEWIDGETS_QLIST_QSTRING_IDX                 = 7, // QList<QString >
    SBK_QTWEBENGINEWIDGETS_QMAP_QSTRING_QVARIANT_IDX         = 8, // QMap<QString,QVariant >
    SBK_QtWebEngineWidgets_CONVERTERS_IDX_COUNT              = 9
};
