...
class QWebEngineHistory(Shiboken.Object):
    ...
    def backItems(self, maxItems: int) -> List[PySide2.QtWebEngineWidgets.QWebEngineHistoryItem]: ...
    ...
    def forwardItems(self, maxItems: int) -> List[PySide2.QtWebEngineWidgets.QWebEngineHistoryItem]: ...
    ...
    def items(self) -> List[PySide2.QtWebEngineWidgets.QWebEngineHistoryItem]: ...
...
class QWebEnginePage(PySide2.QtCore.QObject):
    ...
    def chooseFiles(self, mode: PySide2.QtWebEngineWidgets.QWebEnginePage.FileSelectionMode, oldFiles: List[str], acceptedMimeTypes: List[str]) -> List[str]: ...
...
class QWebEngineProfile(PySide2.QtCore.QObject):
    ...
    def clearVisitedLinks(self, urls: List[PySide2.QtCore.QUrl]): ...
    ...
    def setSpellCheckLanguages(self, languages: List[str]): ...
    def settings(self) -> PySide2.QtWebEngineWidgets.QWebEngineSettings: ...
...
class QWebEngineScriptCollection(Shiboken.Object):
    ...
    def findScripts(self, name: str) -> List[PySide2.QtWebEngineWidgets.QWebEngineScript]: ...
    @typing.overload
    def insert(self, arg__1: PySide2.QtWebEngineWidgets.QWebEngineScript): ...
    @typing.overload
    def insert(self, list: List[PySide2.QtWebEngineWidgets.QWebEngineScript]): ...
    def isEmpty(self) -> bool: ...
    def remove(self, arg__1: PySide2.QtWebEngineWidgets.QWebEngineScript) -> bool: ...
    def size(self) -> int: ...
    def toList(self) -> List[PySide2.QtWebEngineWidgets.QWebEngineScript]: ...
