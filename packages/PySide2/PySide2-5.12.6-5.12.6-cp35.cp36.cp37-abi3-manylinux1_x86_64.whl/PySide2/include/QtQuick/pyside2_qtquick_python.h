...
// Type indices
enum : int {
    SBK_QQUICKASYNCIMAGEPROVIDER_IDX                         = 8,
    SBK_QQUICKFRAMEBUFFEROBJECT_IDX                          = 9,
    SBK_QQUICKFRAMEBUFFEROBJECT_RENDERER_IDX                 = 10,
    SBK_QQUICKIMAGEPROVIDER_IDX                              = 11,
    SBK_QQUICKIMAGERESPONSE_IDX                              = 12,
    SBK_QQUICKITEM_IDX                                       = 13,
    SBK_QQUICKITEM_FLAG_IDX                                  = 14,
    SBK_QFLAGS_QQUICKITEM_FLAG_IDX                           = 0,
    SBK_QQUICKITEM_ITEMCHANGE_IDX                            = 15,
    SBK_QQUICKITEM_TRANSFORMORIGIN_IDX                       = 16,
    SBK_QQUICKITEM_UPDATEPAINTNODEDATA_IDX                   = 17,
    SBK_QQUICKITEMGRABRESULT_IDX                             = 18,
    SBK_QQUICKPAINTEDITEM_IDX                                = 19,
    SBK_QQUICKPAINTEDITEM_RENDERTARGET_IDX                   = 21,
    SBK_QQUICKPAINTEDITEM_PERFORMANCEHINT_IDX                = 20,
    SBK_QFLAGS_QQUICKPAINTEDITEM_PERFORMANCEHINT_IDX         = 1,
    SBK_QQUICKRENDERCONTROL_IDX                              = 22,
    SBK_QQUICKTEXTDOCUMENT_IDX                               = 23,
    SBK_QQUICKTEXTUREFACTORY_IDX                             = 24,
    SBK_QQUICKTRANSFORM_IDX                                  = 25,
    SBK_QQUICKVIEW_IDX                                       = 26,
    SBK_QQUICKVIEW_RESIZEMODE_IDX                            = 27,
    SBK_QQUICKVIEW_STATUS_IDX                                = 28,
    SBK_QQUICKWINDOW_IDX                                     = 29,
    SBK_QQUICKWINDOW_CREATETEXTUREOPTION_IDX                 = 30,
    SBK_QFLAGS_QQUICKWINDOW_CREATETEXTUREOPTION_IDX          = 2,
    SBK_QQUICKWINDOW_RENDERSTAGE_IDX                         = 31,
    SBK_QQUICKWINDOW_SCENEGRAPHERROR_IDX                     = 32,
    SBK_QQUICKWINDOW_TEXTRENDERTYPE_IDX                      = 33,
    SBK_QSGABSTRACTRENDERER_IDX                              = 34,
    SBK_QSGABSTRACTRENDERER_CLEARMODEBIT_IDX                 = 35,
    SBK_QFLAGS_QSGABSTRACTRENDERER_CLEARMODEBIT_IDX          = 3,
    SBK_QSGBASICGEOMETRYNODE_IDX                             = 36,
    SBK_QSGCLIPNODE_IDX                                      = 37,
    SBK_QSGDYNAMICTEXTURE_IDX                                = 38,
    SBK_QSGENGINE_IDX                                        = 39,
    SBK_QSGENGINE_CREATETEXTUREOPTION_IDX                    = 40,
    SBK_QFLAGS_QSGENGINE_CREATETEXTUREOPTION_IDX             = 4,
    SBK_QSGGEOMETRY_IDX                                      = 41,
    SBK_QSGGEOMETRY_ATTRIBUTETYPE_IDX                        = 44,
    SBK_QSGGEOMETRY_DATAPATTERN_IDX                          = 46,
    SBK_QSGGEOMETRY_DRAWINGMODE_IDX                          = 47,
    SBK_QSGGEOMETRY_TYPE_IDX                                 = 50,
    SBK_QSGGEOMETRY_ATTRIBUTE_IDX                            = 42,
    SBK_QSGGEOMETRY_ATTRIBUTESET_IDX                         = 43,
    SBK_QSGGEOMETRY_COLOREDPOINT2D_IDX                       = 45,
    SBK_QSGGEOMETRY_POINT2D_IDX                              = 48,
    SBK_QSGGEOMETRY_TEXTUREDPOINT2D_IDX                      = 49,
    SBK_QSGGEOMETRYNODE_IDX                                  = 51,
    SBK_QSGMATERIALTYPE_IDX                                  = 52,
    SBK_QSGNODE_IDX                                          = 53,
    SBK_QSGNODE_NODETYPE_IDX                                 = 56,
    SBK_QSGNODE_FLAG_IDX                                     = 55,
    SBK_QFLAGS_QSGNODE_FLAG_IDX                              = 6,
    SBK_QSGNODE_DIRTYSTATEBIT_IDX                            = 54,
    SBK_QFLAGS_QSGNODE_DIRTYSTATEBIT_IDX                     = 5,
    SBK_QSGOPACITYNODE_IDX                                   = 57,
    SBK_QSGSIMPLERECTNODE_IDX                                = 58,
    SBK_QSGSIMPLETEXTURENODE_IDX                             = 59,
    SBK_QSGSIMPLETEXTURENODE_TEXTURECOORDINATESTRANSFORMFLAG_IDX = 60,
    SBK_QFLAGS_QSGSIMPLETEXTURENODE_TEXTURECOORDINATESTRANSFORMFLAG_IDX = 7,
    SBK_QSGTEXTURE_IDX                                       = 61,
    SBK_QSGTEXTURE_WRAPMODE_IDX                              = 64,
    SBK_QSGTEXTURE_FILTERING_IDX                             = 63,
    SBK_QSGTEXTURE_ANISOTROPYLEVEL_IDX                       = 62,
    SBK_QSGTEXTUREPROVIDER_IDX                               = 65,
    SBK_QSGTRANSFORMNODE_IDX                                 = 66,
    SBK_QSHAREDPOINTER_QQUICKITEMGRABRESULT_IDX              = 68, // QSharedPointer<QQuickItemGrabResult >
    SBK_QtQuick_IDX_COUNT                                    = 69
};
...
enum : int {
    ...
    SBK_QTQUICK_QLIST_QVARIANT_IDX                           = 5, // QList<QVariant >
    SBK_QTQUICK_QLIST_QSTRING_IDX                            = 6, // QList<QString >
    SBK_QTQUICK_QMAP_QSTRING_QVARIANT_IDX                    = 7, // QMap<QString,QVariant >
