...
class QtDataVisualization(Shiboken.Object):
    ...
    class Q3DTheme(PySide2.QtCore.QObject):
        ...
        def setBaseColors(self, colors:typing.List): ...
        def setBaseGradients(self, gradients:typing.List): ...
    ...
    class QAbstract3DAxis(PySide2.QtCore.QObject):
        ...
        def setLabels(self, labels:typing.List): ...
    ...
    class QBarDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QAbstractDataProxy):
        ...
        @typing.overload
        def addRows(self, rows:typing.List, labels:typing.List) -> int: ...
        ...
        @typing.overload
        def insertRows(self, rowIndex:int, rows:typing.List, labels:typing.List): ...
        @typing.overload
        ...
        @typing.overload
        def resetArray(self, newArray:typing.List, rowLabels:typing.List, columnLabels:typing.List): ...
        ...
        def setColumnLabels(self, labels:typing.List): ...
        @typing.overload
        ...
        def setRowLabels(self, labels:typing.List): ...
        @typing.overload
        def setRows(self, rowIndex:int, rows:typing.List): ...
        @typing.overload
        def setRows(self, rowIndex:int, rows:typing.List, labels:typing.List): ...
    ...
    class QCustom3DVolume(PySide2.QtDataVisualization.QtDataVisualization.QCustom3DItem):
        ...
        def __init__(self, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        def __init__(self, position:PySide2.QtGui.QVector3D, scaling:PySide2.QtGui.QVector3D, rotation:PySide2.QtGui.QQuaternion, textureWidth:int, textureHeight:int, textureDepth:int, textureData:typing.List, textureFormat:PySide2.QtGui.QImage.Format, colorTable:typing.List, parent:PySide2.QtCore.QObject=...): ...
        ...
        @typing.overload
        def setSubTextureData(self, axis:PySide2.QtCore.Qt.Axis, index:int, data:typing.Char): ...
        @typing.overload
    ...
    class QItemModelBarDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QBarDataProxy):
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, valueRole:str, rotationRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, valueRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        ...
        def remap(self, rowRole:str, columnRole:str, valueRole:str, rotationRole:str, rowCategories:typing.List, columnCategories:typing.List): ...
        ...
        def setColumnCategories(self, categories:typing.List): ...
        ...
        def setRowCategories(self, categories:typing.List): ...
    ...
    class QItemModelSurfaceDataProxy(PySide2.QtDataVisualization.QtDataVisualization.QSurfaceDataProxy):
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, xPosRole:str, yPosRole:str, zPosRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        ...
        @typing.overload
        def __init__(self, itemModel:PySide2.QtCore.QAbstractItemModel, rowRole:str, columnRole:str, yPosRole:str, rowCategories:typing.List, columnCategories:typing.List, parent:PySide2.QtCore.QObject=...): ...
        @typing.overload
        ...
        def remap(self, rowRole:str, columnRole:str, xPosRole:str, yPosRole:str, zPosRole:str, rowCategories:typing.List, columnCategories:typing.List): ...
        def rowCategories(self) -> typing.List: ...
        def rowCategoryIndex(self, category:str) -> int: ...
        def rowRole(self) -> str: ...
        def rowRolePattern(self) -> PySide2.QtCore.QRegExp: ...
