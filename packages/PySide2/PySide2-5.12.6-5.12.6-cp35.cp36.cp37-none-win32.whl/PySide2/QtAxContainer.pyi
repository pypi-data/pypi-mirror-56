...
class QAxBase(Shiboken.Object):
    ...
    @typing.overload
    def dynamicCall(self, name:str, v1:typing.Any=..., v2:typing.Any=..., v3:typing.Any=..., v4:typing.Any=..., v5:typing.Any=..., v6:typing.Any=..., v7:typing.Any=..., v8:typing.Any=...) -> typing.Any: ...
    @typing.overload
    def dynamicCall(self, name:str, vars:typing.List) -> typing.Any: ...
    @typing.overload
    def dynamicCall(self, name:str, vars:typing.List, flags:int) -> typing.Any: ...
    ...
    def propertyWritable(self, arg__1:str) -> bool: ...
    def qObject(self) -> PySide2.QtCore.QObject: ...
    @typing.overload
    def querySubObject(self, name:str, v1:typing.Any=..., v2:typing.Any=..., v3:typing.Any=..., v4:typing.Any=..., v5:typing.Any=..., v6:typing.Any=..., v7:typing.Any=..., v8:typing.Any=...) -> PySide2.QtAxContainer.QAxObject: ...
    @typing.overload
    def querySubObject(self, name:str, vars:typing.List) -> PySide2.QtAxContainer.QAxObject: ...
    def setControl(self, arg__1:str) -> bool: ...
    def setPropertyBag(self, arg__1:typing.Dict): ...
    def setPropertyWritable(self, arg__1:str, arg__2:bool): ...
...
class QAxObject(PySide2.QtCore.QObject, PySide2.QtAxContainer.QAxBase):
    ...
    @typing.overload
    def __init__(self, c:str, parent:PySide2.QtCore.QObject=...): ...
    @typing.overload
...
class QAxScript(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def call(self, function:str, arguments:typing.List) -> typing.Any: ...
    @typing.overload
...
class QAxWidget(PySide2.QtWidgets.QWidget, PySide2.QtAxContainer.QAxBase):
    ...
    @typing.overload
    def __init__(self, c:str, parent:PySide2.QtWidgets.QWidget=..., f:PySide2.QtCore.Qt.WindowFlags=...): ...
    @typing.overload
