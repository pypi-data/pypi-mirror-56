...
"""
    ...
    8.  Call AoDevice.get_scan_status() to get the scan status and display the status.
    9.  Call AoDevice.scan_stop() to stop the scan
    10. Call DaqDevice.disconnect() and DaqDevice.release() before exiting the process
"""
...
def main():
    ...
    try:
        ...
        create_output_data(num_channels, samples_per_channel, samples_per_cycle, amplitude, offset, out_buffer)
        ...
        sample_rate = ao_device.a_out_scan(low_channel, high_channel, voltage_range, samples_per_channel,
                                           sample_rate, scan_options, scan_flags, out_buffer)
