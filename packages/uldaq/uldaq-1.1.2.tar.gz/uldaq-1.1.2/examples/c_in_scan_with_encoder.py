...
"""
    ...
    3. Call daq_device.get_ctr_device() to get the ctr_device object for the CTR subsystem
    ...
    9. Call ctr_device.c_in_scan() to start a scan for the specified number of counters
    ...
    13. Call daq_device.disconnect() and daq_device.release() before exiting the process.
"""
...
def main():
    ...
    try:
        ...
        for encoder in range(low_encoder, high_encoder + 1):
            ctr_device.c_config_scan(encoder, encoder_type, encoder_mode, edge_detection, tick_size,
        ...
        try:
            while True:
                try:
                    ...
                    print('actual scan rate = ', '{:.6f}'.format(sample_rate), 'Hz\n')
