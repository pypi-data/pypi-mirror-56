...
"""
    ...
    3. Call daq_device.get_dio_device() to get the dio_device object for the DIO subsystem
    ...
    10. Call dio_device.get_scan_status() to check the status of the background operation
...
def main():
    ...
    try:
        ...
        dio_device.d_in_scan(low_port, hi_port, samples_per_channel, rate, scan_options, flags, data)
