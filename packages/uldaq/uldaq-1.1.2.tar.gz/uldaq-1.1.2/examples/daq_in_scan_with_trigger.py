...
"""
    ...
    10. Display the last 5 samples for the scanned channels for as long as scan is running
"""
...
def main():
    ...
    rate = 1000.0
    scan_options = ScanOption.DEFAULTIO | ScanOption.CONTINUOUS | ScanOption.EXTTRIGGER
    ...
    try:
        ...
        rate = daqi_device.daq_in_scan(channel_descriptors, samples_per_channel, rate, scan_options, flags, data)
        ...
        try:
            while True:
                try:
                    ...
                    # use the currentIndex to display the first sample of data for each channel in the buffer
...
def configure_trigger(daqi_device):
    ...
    # err = daqi_device.set_trigger(trigger_types[trigger_type_index], desc, 0.0, 0.0, 0)
