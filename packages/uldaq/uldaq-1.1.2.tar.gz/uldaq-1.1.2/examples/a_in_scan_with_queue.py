...
"""
    ...
    12. Call ai_device.get_scan_status() to check the status of the background operation
...
def main():
    ...
    try:
        ...
        rate = ai_device.a_in_scan(low_channel, high_channel, input_mode, ranges[range_index],
