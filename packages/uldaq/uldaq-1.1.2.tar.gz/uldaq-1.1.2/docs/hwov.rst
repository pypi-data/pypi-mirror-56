...
device to determine the subsystems supported, then use the :class:`DaqDeviceInfo` class methods
for each of the supported subsystems to determine capabilities.
