...
class TmrDevice:
    ...
    def pulse_out_start(self, timer_number, frequency, duty_cycle, pulse_count, initial_delay, idle_state, options):
        ...
        Args:
            ...
            initial_delay (float): The amount of time in seconds to wait before the
    ...
    def pulse_out_stop(self, timer_number):
        # type: (int) -> None
        """
        Stops the specified timer output on the device referenced by the :class:`TmrDevice` object.
