...
class AiInfo:
    ...
    def get_num_chans_by_mode(self, input_mode):
        ...
        Args:
            input_mode (AiInputMode): The analog input mode for which the number of channels is
                to be determined
    ...
    def get_num_chans_by_type(self, channel_type):
        ...
        Args:
            channel_type (AiChanType): The analog channel type for which the number of channels is
                to be determined.
    ...
    def get_max_burst_rate(self):
        # type: () -> float
        """
        Gets the maximum burst rate for the device referenced by the :class:`AiInfo` object
        in samples per second when using :class:`ScanOption.BURSTIO`.
    ...
    def get_ranges(self, input_mode):
        ...
        Args:
            input_mode (AiInputMode): The analog input mode for which the supported ranges are
                to be determined.
