...
class CtrInfo:
    ...
    def get_register_types(self):
        ...
        Returns:
            ...
            A list of :class:`CtrRegisterType` attributes (suitable for bit-wise operations)
            specifying supported register types.
    ...
    def get_fifo_size(self):
        # type: () -> int
        """
        Gets the FIFO size in bytes for the device referenced by the :class:`CtrInfo` object.
