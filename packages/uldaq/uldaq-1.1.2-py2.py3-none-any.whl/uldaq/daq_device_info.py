...
class DaqDeviceInfo:
    ...
    def _has_ai_device(self):
        ...
        """
        has_ai = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_AI_DEV, 0, byref(has_ai))
        if err != 0:
            raise ULException(err)
    ...
    def _has_ao_device(self):
        ...
        """
        has_ao = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_AO_DEV, 0, byref(has_ao))
        if err != 0:
            raise ULException(err)
    ...
    def _has_dio_device(self):
        ...
        """
        has_dio = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_DIO_DEV, 0, byref(has_dio))
        if err != 0:
            raise ULException(err)
    ...
    def _has_ctr_device(self):
        ...
        """
        has_ctr = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_CTR_DEV, 0, byref(has_ctr))
        if err != 0:
            raise ULException(err)
    ...
    def _has_tmr_device(self):
        ...
        """
        has_tmr = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_TMR_DEV, 0, byref(has_tmr))
        if err != 0:
            raise ULException(err)
    ...
    def _has_daqi_device(self):
        ...
        """
        has_daqi = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_DAQI_DEV, 0, byref(has_daqi))
        if err != 0:
            raise ULException(err)
    ...
    def _has_daqo_device(self):
        ...
        """
        has_daqo = c_longlong()
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.HAS_DAQO_DEV, 0, byref(has_daqo))
        if err != 0:
            raise ULException(err)
    ...
    def get_event_types(self):
        ...
        event_type_list = []
        err = lib.ulDevGetInfo(self.__handle, DevItemInfo.DAQ_EVENT_TYPES, 0, byref(event_type_mask))
        if err != 0:
            raise ULException(err)
