"Main interface for kinesis-video-media Client"
...
class Client(BaseClient):
    ...
    def get_media(
        ...
        fragment and related metadata in what is called a "chunk." For more information, see
        `PutMedia
        <https://docs.aws.amazon.com/kinesisvideostreams/latest/dg/API_dataplane_PutMedia.html>`__ .
        ...
        * Kinesis Video Streams sends media data at a rate of up to 25 megabytes per second (or 200
        megabits per second) during a ``GetMedia`` session.

        .. note::

          If an error is thrown after invoking a Kinesis Video Streams media API, in addition to the
          HTTP status code and the response body, it includes the following pieces of information:
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-video-media-2017-09-30/GetMedia>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_media(
              ...
              StartSelector={
                  'StartSelectorType':
                  'FRAGMENT_NUMBER'|'SERVER_TIMESTAMP'|'PRODUCER_TIMESTAMP'|'NOW'
                  |'EARLIEST'|'CONTINUATION_TOKEN',
        ...
        :param StartSelector: **[REQUIRED]**
          ...
          - **StartTimestamp** *(datetime) --*
            ...
            SERVER_TIMESTAMP as the ``startSelectorType`` . The ``GetMedia`` API then starts with
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Payload** (:class:`.StreamingBody`) --
              ...
              returns in the ``GetMedia`` call also include the following additional Matroska (MKV)
              tags:
