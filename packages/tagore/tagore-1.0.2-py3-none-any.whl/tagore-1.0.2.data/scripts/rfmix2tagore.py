...
@click.command()
@click.option('--chr1', '-1', 'chr1', default=None, type=click.File('r'), help="Chromosome 1 RFMix painting")
...
@click.option('--nat', 'nat', default="#D92414", help="Color for Native American / Asian blocks")
@click.option('--unk', 'unk', default="#808080 ", help="Color for Unknown regions")
@click.option('--out', '-o', 'output', default=None, type=click.File('w'), help="Output da Vinci bed")
