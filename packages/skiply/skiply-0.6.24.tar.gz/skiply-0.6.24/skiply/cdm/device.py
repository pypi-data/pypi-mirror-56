...
def get_devices_to_monitor(hours_start, hours_end, power_threshold, standard_monitoring):
    ...
    try:
        if standard_monitoring:
            ...
            if res_notin is None:
                print("get_devices_to_monitor(hours_start, hours_end, power_threshold, standard_monitoring) : Start request devices")
                ...
                print("get_devices_to_monitor(hours_start, hours_end, power_threshold, standard_monitoring) : Start request devices for all entities excluded {}".format(res_notin))
