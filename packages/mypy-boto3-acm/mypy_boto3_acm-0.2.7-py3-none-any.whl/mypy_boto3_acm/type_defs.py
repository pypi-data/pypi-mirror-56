...
class ClientDescribeCertificateResponseCertificateDomainValidationOptionsResourceRecordTypeDef(
    ...
    """
    Type definition for `ClientDescribeCertificateResponseCertificateDomainValidationOptions` `ResourceRecord`
...
class ClientDescribeCertificateResponseCertificateRenewalSummaryDomainValidationOptionsResourceRecordTypeDef(
    ...
    """
    Type definition for `ClientDescribeCertificateResponseCertificateRenewalSummaryDomainValidationOptions` `ResourceRecord`
...
class ClientDescribeCertificateResponseCertificateRenewalSummaryDomainValidationOptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeCertificateResponseCertificateRenewalSummary` `DomainValidationOptions`
...
class ClientImportCertificateTagsTypeDef(
    _RequiredClientImportCertificateTagsTypeDef,
    _OptionalClientImportCertificateTagsTypeDef,
):
    """
...
class ClientRequestCertificateTagsTypeDef(
    _RequiredClientRequestCertificateTagsTypeDef,
    _OptionalClientRequestCertificateTagsTypeDef,
):
    """
