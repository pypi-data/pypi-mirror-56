        ...
        **Request Syntax**
        ...
        :param CommitTransaction:
          ...
          - **CommitDigest** *(bytes) --* **[REQUIRED]**
            ...
            the commit digest must be passed. QLDB validates ``CommitDigest`` and rejects the commit
            with an error if the digest computed on the client does not match the digest computed by
            QLDB.
