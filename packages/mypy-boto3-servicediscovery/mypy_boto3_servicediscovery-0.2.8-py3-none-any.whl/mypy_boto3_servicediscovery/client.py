"Main interface for servicediscovery Client"
...
class Client(BaseClient):
    ...
    def create_http_namespace(
        ...
        be discovered using a ``DiscoverInstances`` request but can't be discovered using DNS.

        For the current limit on the number of namespaces that you can create using the same AWS
        account, see `AWS Cloud Map Limits
        <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__ in the *AWS Cloud
        Map Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/CreateHttpNamespace>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **OperationId** *(string) --*
              ...
              A value that you can use to determine whether the request completed successfully. To
              get the status of the operation, see  GetOperation .
    ...
    def create_private_dns_namespace(
        ...
        namespace ``example.com`` and name your service ``backend`` , the resulting DNS name for the
        service will be ``backend.example.com`` . For the current limit on the number of namespaces
        that you can create using the same AWS account, see `AWS Cloud Map Limits
        <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__ in the *AWS Cloud
        Map Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/CreatePrivateDnsNamespace>`_
    ...
    def create_public_dns_namespace(
        ...
        ``example.com`` and name your service ``backend`` , the resulting DNS name for the service
        will be ``backend.example.com`` . For the current limit on the number of namespaces that you
        can create using the same AWS account, see `AWS Cloud Map Limits
        <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__ in the *AWS Cloud
        Map Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/CreatePublicDnsNamespace>`_
        ...
        **Request Syntax**
        ...
        :param CreatorRequestId:
          ...
          A unique string that identifies the request and that allows failed
          ``CreatePublicDnsNamespace`` requests to be retried without the risk of executing the
          operation twice. ``CreatorRequestId`` can be any unique string, for example, a date/time
          stamp.
    ...
    def create_service(
        ...
        * Optionally, a health check
        ...
        uses the values in the configuration to create the specified entities.

        For the current limit on the number of instances that you can register using the same
        namespace and using the same service, see `AWS Cloud Map Limits
        <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__ in the *AWS Cloud
        Map Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/CreateService>`_
        ...
        **Request Syntax**
        ...
        :param HealthCheckConfig:
           ...
           *Public DNS namespaces only.* A complex type that contains settings for an optional Route
           53 health check. If you specify settings for a health check, AWS Cloud Map associates the
           health check with all the Route 53 DNS records that you specify in ``DnsConfig`` .
          ...
          - **ResourcePath** *(string) --*
            ...
            the endpoint is healthy, such as the file ``/docs/route53-health-check.html`` . Route 53
            ...
            - **Service** *(dict) --*
              ...
              - **DnsConfig** *(dict) --*
                ...
                - **RoutingPolicy** *(string) --*
                  ...
                  For example, suppose the service includes configurations for one A record and a
                  health check, and you use the service to register 10 instances. Route 53 responds
                  to DNS queries with IP addresses for up to eight healthy instances. If fewer than
                  eight instances are healthy, Route 53 responds to every DNS query with the IP
                  ...
                  Route 53 returns the applicable value from one randomly selected instance from
                  among the instances that you registered using the same service. Currently, all
                  records have the same weight, so you can't route more or less traffic to any
                  instances.

                  For example, suppose the service includes configurations for one A record and a
                  health check, and you use the service to register 10 instances. Route 53 responds
                  to DNS queries with the IP address for one randomly selected instance from among
                  the healthy instances. If no instances are healthy, Route 53 responds to DNS
                ...
                - **DnsRecords** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Type** *(string) --*
                      ...
                      * **A, AAAA, and SRV records:** You can specify settings for a maximum of one
                      A, one AAAA, and one SRV record. You can specify them in any combination.

                      * **CNAME records:** If you specify ``CNAME`` for ``Type`` , you can't define
                      any other records. This is a limitation of DNS: you can't create a CNAME
                      ...
                      * **All records:** You specify settings other than ``TTL`` and ``Type`` when
                      ...
                      * The value of ``service-hostname`` is a concatenation of the following
                      ...
                      service is ``backend`` , and the name of the namespace is ``example.com`` ,
                      the value of ``service-hostname`` is:
                    ...
                    - **TTL** *(integer) --*
                      ...
                      .. note::
                        ...
                        Alias records don't include a TTL because Route 53 uses the TTL for the AWS
                        resource that an alias record routes traffic to. If you include the
                        ``AWS_ALIAS_DNS_NAME`` attribute when you submit a  RegisterInstance
              ...
              - **HealthCheckConfig** *(dict) --*
                ...
                - **FailureThreshold** *(integer) --*
                  ...
                  vice versa. For more information, see `How Route 53 Determines Whether an Endpoint
                  Is Healthy
                  <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-determining-health-of-endpoints.html>`__
                  in the *Route 53 Developer Guide* .
              ...
              - **HealthCheckCustomConfig** *(dict) --*
                ...
                - **FailureThreshold** *(integer) --*
                  ...
                  status of a service instance. For example, suppose you specify a value of ``2``
                  for ``FailureTheshold`` , and then your application sends an
                  ``UpdateInstanceCustomHealthStatus`` request. Cloud Map waits for approximately 60
                  seconds (2 x 30) before changing the status of the service instance based on that
                  request.

                  Sending a second or subsequent ``UpdateInstanceCustomHealthStatus`` request with
                  the same value before ``FailureThreshold x 30`` seconds has passed doesn't
                  accelerate the change. Cloud Map still waits ``FailureThreshold x 30`` seconds
              ...
              - **CreatorRequestId** *(string) --*
                ...
                retried without the risk of executing the operation twice. ``CreatorRequestId`` can
    ...
    def delete_namespace(self, Id: str) -> ClientDeleteNamespaceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/DeleteNamespace>`_
    ...
    def delete_service(self, Id: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/DeleteService>`_
    ...
    def deregister_instance(
        ...
        """
        Deletes the Amazon Route 53 DNS records and health check, if any, that AWS Cloud Map created
        for the specified instance.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/DeregisterInstance>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **OperationId** *(string) --*
              ...
              A value that you can use to determine whether the request completed successfully. For
              more information, see  GetOperation .
    ...
    def discover_instances(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/DiscoverInstances>`_
          ...
          - *(dict) --*
            ...
            - **Instances** *(list) --*
              ...
              - *(dict) --*
                ...
                information about one instance that matches the values that you specified in the
                request.
    ...
    def get_instance(self, ServiceId: str, InstanceId: str) -> ClientGetInstanceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/GetInstance>`_
            ...
            - **Instance** *(dict) --*
              ...
              - **Attributes** *(dict) --*
                ...
                * If the service that is specified by ``ServiceId`` includes ``HealthCheckConfig``
                settings, AWS Cloud Map will create the health check, but it won't associate the
    ...
    def get_instances_health_status(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/GetInstancesHealthStatus>`_
        ...
        **Request Syntax**
        ...
        :param Instances:
          ...
          If you omit ``Instances`` , AWS Cloud Map returns the health status for all the instances
        ...
        :param NextToken:
          ...
          ``GetInstancesHealthStatus`` request to get the next group of results. Specify the value
    ...
    def get_namespace(self, Id: str) -> ClientGetNamespaceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/GetNamespace>`_
    ...
    def get_operation(self, OperationId: str) -> ClientGetOperationResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/GetOperation>`_
    ...
    def get_service(self, Id: str) -> ClientGetServiceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/GetService>`_
    ...
    def list_instances(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/ListInstances>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
              ...
              - *(dict) --*
                ...
                - **Attributes** *(dict) --*
                  ...
                  * ``AWS_ALIAS_DNS_NAME`` : For an alias record that routes traffic to an Elastic
                  Load Balancing load balancer, the DNS name that is associated with the load
                  balancer.
                  ...
                  * ``AWS_INSTANCE_PORT`` : For an SRV record, the value that Route 53 returns for
                  the port. In addition, if the service includes ``HealthCheckConfig`` , the port on
            ...
            - **NextToken** *(string) --*
              ...
              If more than ``MaxResults`` instances match the specified criteria, you can submit
              another ``ListInstances`` request to get the next group of results. Specify the value
              of ``NextToken`` from the previous response in the next request.
    ...
    def list_namespaces(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/ListNamespaces>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of namespaces that you want AWS Cloud Map to return in the response to
          a ``ListNamespaces`` request. If you don't specify a value for ``MaxResults`` , AWS Cloud
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            A complex type that identifies the namespaces that you want to list. You can choose to
            list public or private namespaces.
            ...
            - **Condition** *(string) --*
              ...
              * ``EQ`` : When you specify ``EQ`` for the condition, you can choose to list only
              public namespaces or private namespaces, but not both. ``EQ`` is the default condition
              and can be omitted.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Namespaces** *(list) --*
              ...
              An array that contains one ``NamespaceSummary`` object for each namespace that matches
    ...
    def list_operations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/ListOperations>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``ListOperations`` request. If you don't specify a value for ``MaxResults`` , AWS Cloud
          ...
          - *(dict) --*
            ...
            - **Condition** *(string) --*
              ...
              * ``EQ`` : When you specify ``EQ`` for the condition, you can specify only one value.
              ``EQ`` is supported for ``NAMESPACE_ID`` , ``SERVICE_ID`` , ``STATUS`` , and ``TYPE``
              . ``EQ`` is the default condition and can be omitted.

              * ``IN`` : When you specify ``IN`` for the condition, you can specify a list of one or
              more values. ``IN`` is supported for ``STATUS`` and ``TYPE`` . An operation must match
    ...
    def list_services(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/ListServices>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          .. note::
            ...
            the specified criteria but that subsequent groups of ``MaxResults`` services do contain
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Condition** *(string) --*
              ...
              * ``EQ`` : When you specify ``EQ`` , specify one namespace ID for ``Values`` . ``EQ``
              is the default condition and can be omitted.

              * ``IN`` : When you specify ``IN`` , specify a list of the IDs for the namespaces that
              you want ``ListServices`` to return a list of services for.
            ...
            - **Services** *(list) --*
              ...
              - *(dict) --*
                ...
                - **InstanceCount** *(integer) --*
                  ...
                  The number of instances that are currently associated with the service. Instances
                  that were previously associated with the service but that have been deleted are
                    ...
                    - *(dict) --*
                      ...
                      - **Type** *(string) --*
                        ...
                        * **CNAME records:** If you specify ``CNAME`` for ``Type`` , you can't
                        ...
                        CNAME record and any other type of record that has the same name as a CNAME
                        record.
                ...
                - **HealthCheckConfig** *(dict) --*
                   ...
                   *Public DNS namespaces only.* A complex type that contains settings for an
                   optional health check. If you specify settings for a health check, AWS Cloud Map
                  ...
                  Map creates a health check that uses the IPv4 address to check the health of the
                  ...
                  * Route 53 automatically sets ``EvaluateTargetHealth`` to true for alias records.
                  ...
                  referenced AWS resource. such as an ELB load balancer. For more information, see
                ...
                - **HealthCheckCustomConfig** *(dict) --*
                  ...
                  custom health check, which requires that you use a third-party health checker to
                  evaluate the health of your resources, is useful in the following circumstances:
                  ...
                  * You want to use a third-party health checker regardless of where your resources
                  are.
                  ...
                  of the resource, it just keeps a record of the status specified in the most recent
                  ``UpdateInstanceCustomHealthStatus`` request.

                  Here's how custom health checks work:

                  * You create a service and specify a value for ``FailureThreshold`` .  The failure
                  threshold indicates the number of 30-second intervals you want AWS Cloud Map to
                  wait between the time that your application sends an
                  UpdateInstanceCustomHealthStatus request and the time that AWS Cloud Map stops
                  ...
                  * If another ``UpdateInstanceCustomHealthStatus`` request doesn't arrive during
                  ...
                  - **FailureThreshold** *(integer) --*
                    ...
                    ``UpdateInstanceCustomHealthStatus`` request. Cloud Map waits for approximately
    ...
    def register_instance(
        ...
        * For each DNS record that you define in the service that is specified by ``ServiceId`` , a
        record is created or updated in the hosted zone that is associated with the corresponding
        namespace.
        ...
        * **If you didn't specify a health check configuration** : returns all the records
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/RegisterInstance>`_
        ...
        **Request Syntax**
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * For each attribute, the applicable value.
          ...
          If you want AWS Cloud Map to create an Amazon Route 53 alias record that routes traffic to
          an Elastic Load Balancing load balancer, specify the DNS name that is associated with the
          load balancer. For information about how to get the DNS name, see "DNSName" in the topic
          `AliasTarget
          <http://docs.aws.amazon.com/Route53/latest/APIReference/API_AliasTarget.html>`__ in the
          ...
          * If the service that is specified by ``ServiceId`` includes ``HealthCheckConfig``
          settings, AWS Cloud Map will create the Route 53 health check, but it won't associate the
          health check with the alias record.
          ...
          * If you specify a value for ``AWS_ALIAS_DNS_NAME`` , don't specify values for any of the
          ...
          This value is required if the service specified by ``ServiceId`` includes settings for an
          A record. If the service includes settings for an SRV record, you must specify a value for
          ...
          You can add up to 30 custom attributes. For each key-value pair, the maximum length of the
    ...
    def update_instance_custom_health_status(
        ...
        checks, which you define using ``HealthCheckCustomConfig`` when you create a service. You
        can't use it to change the status for Route 53 health checks, which you define using
        ``HealthCheckConfig`` .

        For more information, see  HealthCheckCustomConfig .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/UpdateInstanceCustomHealthStatus>`_
    ...
    def update_service(
        ...
        * Add, update, or delete ``HealthCheckConfig`` for a specified service
        ...
        (and, optionally, ``HealthCheckConfig`` ) that you want to appear in the updated service.
        Any current configurations that don't appear in an ``UpdateService`` request are deleted.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/servicediscovery-2017-03-14/UpdateService>`_
        ...
        **Request Syntax**
        ...
        :param Service: **[REQUIRED]**
            ...
            - **DnsRecords** *(list) --* **[REQUIRED]**
              ...
              - *(dict) --*
                ...
                - **Type** *(string) --* **[REQUIRED]**
                  ...
                  * **CNAME records:** If you specify ``CNAME`` for ``Type`` , you can't define any
                  other records. This is a limitation of DNS: you can't create a CNAME record and
                  ...
                  * The value of ``service-hostname`` is a concatenation of the following values:
                  ...
                  ``AWS_INSTANCE_IPV4`` , ``AWS_INSTANCE_IPV6`` , or both in the
                  ``RegisterInstance`` request, AWS Cloud Map automatically creates ``A`` and/or
                  ``AAAA`` records that have the same name as the value of ``service-hostname`` in
                ...
                - **TTL** *(integer) --* **[REQUIRED]**
                  ...
                  .. note::
                    ...
                    the ``TTL`` value is ignored. Always specify a TTL for the service; you can use
                    a service to register instances that create either alias or non-alias records.
          ...
          - **HealthCheckConfig** *(dict) --*
            ...
            creates a health check that uses the IPv4 address to check the health of the resource.
            ...
            you'll sometimes see several requests per second followed by a few seconds with no
            ...
            * If you include ``HealthCheckConfig`` and then use the service to register an instance
            ...
            - **ResourcePath** *(string) --*
              ...
              The path that you want Route 53 to request when performing health checks. The path can
              be any value for which your endpoint will return an HTTP status code of 2xx or 3xx
              when the endpoint is healthy, such as the file ``/docs/route53-health-check.html`` .
            ...
            - **FailureThreshold** *(integer) --*
              ...
              versa. For more information, see `How Route 53 Determines Whether an Endpoint Is
              Healthy
              <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/dns-failover-determining-health-of-endpoints.html>`__
              in the *Route 53 Developer Guide* .
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_namespaces` operation.
        """
