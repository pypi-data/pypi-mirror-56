...
class Client(BaseClient):
    ...
    def create_http_namespace(
        ...
        """
        Creates an HTTP namespace. Service instances that you register using an HTTP namespace can be
        ...
        see `AWS Cloud Map Limits <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__
        ...
        **Request Syntax**
        ...
        :param CreatorRequestId:
          ...
          requests to be retried without the risk of executing the operation twice. ``CreatorRequestId`` can
    ...
    def create_private_dns_namespace(
        ...
        ``backend.example.com`` . For the current limit on the number of namespaces that you can create
        using the same AWS account, see `AWS Cloud Map Limits
        <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__ in the *AWS Cloud Map
        Developer Guide* .
    ...
    def create_public_dns_namespace(
        ...
        """
        Creates a public namespace based on DNS, which will be visible on the internet. The namespace
        defines your service naming scheme. For example, if you name your namespace ``example.com`` and name
        your service ``backend`` , the resulting DNS name for the service will be ``backend.example.com`` .
        For the current limit on the number of namespaces that you can create using the same AWS account,
        see `AWS Cloud Map Limits <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__
        in the *AWS Cloud Map Developer Guide* .
    ...
    def create_service(
        ...
        * Optionally, a health check
        ...
        For the current limit on the number of instances that you can register using the same namespace and
        using the same service, see `AWS Cloud Map Limits
        <http://docs.aws.amazon.com/cloud-map/latest/dg/cloud-map-limits.html>`__ in the *AWS Cloud Map
        Developer Guide* .
        ...
        **Request Syntax**
        ...
        :param DnsConfig:
          ...
          A complex type that contains information about the Amazon Route 53 records that you want AWS Cloud
          ...
          - **DnsRecords** *(list) --* **[REQUIRED]**
            ...
            - *(dict) --*
              ...
              - **Type** *(string) --* **[REQUIRED]**
                ...
                * **All records:** You specify settings other than ``TTL`` and ``Type`` when you register an
                instance.
                ...
                * You can't specify both ``CNAME`` for ``Type`` and settings for ``HealthCheckConfig`` . If
                ...
                Route 53 returns the value for an SRV record. The value for an SRV record uses the following
                values:
                ...
                * The value of ``service-hostname`` is a concatenation of the following values:
                ...
                AWS Cloud Map automatically creates ``A`` and/or ``AAAA`` records that have the same name as
                the value of ``service-hostname`` in the SRV record. You can ignore these records.
        ...
        :param HealthCheckConfig:
          ...
          - **ResourcePath** *(string) --*
            ...
            DNS name for the service. If you don't specify a value for ``ResourcePath`` , the default value
            is ``/`` .
            ...
            - **Service** *(dict) --*
              ...
              - **HealthCheckConfig** *(dict) --*
                ...
                - **FailureThreshold** *(integer) --*
                  ...
                  The number of consecutive health checks that an endpoint must pass or fail for Route 53 to
                  change the current status of the endpoint from unhealthy to healthy or vice versa. For
              ...
              - **HealthCheckCustomConfig** *(dict) --*
                ...
                - **FailureThreshold** *(integer) --*
                  ...
                  ``UpdateInstanceCustomHealthStatus`` request. Cloud Map waits for approximately 60 seconds
                  (2 x 30) before changing the status of the service instance based on that request.
    ...
    def deregister_instance(
        ...
        """
        Deletes the Amazon Route 53 DNS records and health check, if any, that AWS Cloud Map created for the
        specified instance.
    ...
    def discover_instances(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``DiscoverInstances`` request. If you don't specify a value for ``MaxResults`` , Cloud Map returns
          up to 100 instances.
        ...
        :param QueryParameters:
          ...
          custom attribute that you specified when you registered the instance. Only instances that match
            ...
            - **Instance** *(dict) --*
              ...
              - **Attributes** *(dict) --*
                ...
                * If the service that is specified by ``ServiceId`` includes ``HealthCheckConfig`` settings,
                AWS Cloud Map will create the health check, but it won't associate the health check with the
                alias record.
    ...
    def get_instances_health_status(
        ...
        .. note::
          ...
          There is a brief delay between when you register an instance and when the health status for the
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``GetInstancesHealthStatus`` request. If you don't specify a value for ``MaxResults`` , AWS Cloud
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Status** *(dict) --*
              ...
              A complex type that contains the IDs and the health status of the instances that you specified
              in the ``GetInstancesHealthStatus`` request.
          ...
          ::

            {
                'Operation': {
                    'Id': 'string',
                    'Type':
                    'CREATE_NAMESPACE'|'DELETE_NAMESPACE'|'UPDATE_SERVICE'|'REGISTER_INSTANCE'
                    |'DEREGISTER_INSTANCE',
    ...
    def list_instances(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of instances that you want AWS Cloud Map to return in the response to a
          ``ListInstances`` request. If you don't specify a value for ``MaxResults`` , AWS Cloud Map returns
          up to 100 instances.
            ...
            - **Instances** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Attributes** *(dict) --*
                  ...
                  * ``AWS_INSTANCE_PORT`` : For an SRV record, the value that Route 53 returns for the port.
                  In addition, if the service includes ``HealthCheckConfig`` , the port on the endpoint that
    ...
    def list_namespaces(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the response contains ``NextToken`` , submit another ``ListNamespaces`` request to get the next
          group of results. Specify the value of ``NextToken`` from the previous response in the next
          request.
    ...
    def list_operations(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the response contains ``NextToken`` , submit another ``ListOperations`` request to get the next
          group of results. Specify the value of ``NextToken`` from the previous response in the next
          request.
          ...
          .. note::
            ...
            criteria. It's possible that no operations in the first ``MaxResults`` operations matched the
            specified criteria but that subsequent groups of ``MaxResults`` operations do contain operations
            that match the criteria.
        ...
        :param MaxResults:
          ...
          ``ListOperations`` request. If you don't specify a value for ``MaxResults`` , AWS Cloud Map
          ...
          - *(dict) --*
            ...
            - **Condition** *(string) --*
              ...
              * ``EQ`` : When you specify ``EQ`` for the condition, you can specify only one value. ``EQ``
              is supported for ``NAMESPACE_ID`` , ``SERVICE_ID`` , ``STATUS`` , and ``TYPE`` . ``EQ`` is the
    ...
    def list_services(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``ListServices`` request. If you don't specify a value for ``MaxResults`` , AWS Cloud Map returns
          up to 100 services.
            ...
            - **Services** *(list) --*
              ...
              - *(dict) --*
                ...
                - **InstanceCount** *(integer) --*
                  ...
                  were previously associated with the service but that have been deleted are not included in
                  the count.
                ...
                - **HealthCheckCustomConfig** *(dict) --*
                  ...
                  * You can't use a health check that is defined by ``HealthCheckConfig`` because the
                  resource isn't available over the internet. For example, you can use a custom health check
                  when the instance is in an Amazon VPC. (To check the health of resources in a VPC, the
    ...
    def register_instance(
        ...
        in a specified service. When you submit a ``RegisterInstance`` request, the following occurs:

        * For each DNS record that you define in the service that is specified by ``ServiceId`` , a record
        is created or updated in the hosted zone that is associated with the corresponding namespace.

        * If the service includes ``HealthCheckConfig`` , a health check is created based on the settings in
        ...
        **Request Syntax**
        ...
        :param InstanceId: **[REQUIRED]**
          ...
          * If you specify an existing ``InstanceId`` and ``ServiceId`` , AWS Cloud Map updates the existing
          DNS records, if any. If there's also an existing health check, AWS Cloud Map deletes the old
        ...
        :param CreatorRequestId:
          ...
          registering additional instances for the same namespace and service. ``CreatorRequestId`` can be
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * For each attribute, the applicable value.
          ...
          If you want AWS Cloud Map to create an Amazon Route 53 alias record that routes traffic to an
          Elastic Load Balancing load balancer, specify the DNS name that is associated with the load
          balancer. For information about how to get the DNS name, see "DNSName" in the topic `AliasTarget
          <http://docs.aws.amazon.com/Route53/latest/APIReference/API_AliasTarget.html>`__ in the *Route 53
          API Reference* .
          ...
          * If the service that is specified by ``ServiceId`` includes ``HealthCheckConfig`` settings, AWS
          Cloud Map will create the Route 53 health check, but it won't associate the health check with the
          alias record.
          ...
          * If you specify a value for ``AWS_ALIAS_DNS_NAME`` , don't specify values for any of the
          ...
          or ``UNHEALTHY`` . If you don't specify a value for ``AWS_INIT_HEALTH_STATUS`` , the initial
          status is ``HEALTHY`` .
    ...
    def update_instance_custom_health_status(
        ...
        which you define using ``HealthCheckCustomConfig`` when you create a service. You can't use it to
        change the status for Route 53 health checks, which you define using ``HealthCheckConfig`` .
    ...
    def update_service(
        ...
        * Add, update, or delete ``HealthCheckConfig`` for a specified service
        ...
        When you update the TTL setting for a service, AWS Cloud Map also updates the corresponding settings
        ...
        **Request Syntax**
        ...
        :param Service: **[REQUIRED]**
          ...
          - **HealthCheckConfig** *(dict) --*
            ...
            endpoint every 30 seconds. On average, your endpoint receives a health check request about every
            two seconds. However, health checkers don't coordinate with one another, so you'll sometimes see
