...
DOCUMENTATION = r'''
module: alteon_config_system_dns_client
short_description: Manage DNS Client in Radware Alteon
description:
  - Manage DNS Client in Radware Alteon.
version_added: null
author: 
...
options:
  ...
  parameters:
    description:
      - Parameters for DNS Client configuration.
    suboptions:
      primary_dns_ip4:
        description:
          - The DNS primary IP address.
...
- name: alteon configuration command
  alteon_config_system_dns_client:
    ...
    state: present
    parameters:
      primary_dns_ip4: 4.6.6.6
      secondary_dns_ip4: 4.6.6.7
...
class ModuleManager(AlteonConfigurationModule):
    def __init__(self, **kwargs):
        super(ModuleManager, self).__init__(SystemDNSClientConfigurator, **kwargs)


def main():
    spec = ArgumentSpec(SystemDNSClientConfigurator)
