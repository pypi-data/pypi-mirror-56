...
DOCUMENTATION = r'''
module: alteon_config_l3_bootp_relay
short_description: Manage BOOTP Relay in Radware Alteon
description:
...
options:
  ...
  parameters:
    description:
      - Parameters for BOOTP configuration.
    suboptions:
      state:
        description:
          - BOOTP state.
      ...
      primary_ip_address:
        description:
          - The IP address of the primary BOOTP server.
        required: false
        default: null
        type: str
      secondary_ip_address:
        description:
          - The IP address of the secondary BOOTP server.
        required: false
        default: null
        type: str
      preserve_source_port:
        description:
          - Source port preservation by alret agent.
        required: false
        default: null
        choices:
        - enabled
...
- name: alteon configuration command
  alteon_config_l3_bootp_relay:
    ...
    parameters:
      ...
      primary_ip_address: 4.5.6.7
      secondary_ip_address: 5.5.6.7                 
'''
...
result:
  ...
  returned: success
  type: str
  sample: deployed successfully
'''


class ModuleManager(AlteonConfigurationModule):
    def __init__(self, **kwargs):
        super(ModuleManager, self).__init__(BOOTPRelayConfigurator, **kwargs)


def main():
    spec = ArgumentSpec(BOOTPRelayConfigurator)
