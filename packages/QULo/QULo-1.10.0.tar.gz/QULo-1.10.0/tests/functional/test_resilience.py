...
# define some ways to try to make the program fail, and find ways to fix it
# see HPP, page 268-9 for ideas

#  The program should work properly even if the components do not start in the
# canonical order.
