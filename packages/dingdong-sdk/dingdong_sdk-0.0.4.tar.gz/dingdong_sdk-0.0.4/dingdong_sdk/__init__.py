...
class DingDong:
    ...
    def send_message(
        ...
        assert self.__stage in {'staging', 'prod'}, \
        ...
        dingdong_url = _dingdong_url[self.__stage] + '/staff/new'
        ...
        st = auth._generate_st(username=self.__username, password=self.__password)
