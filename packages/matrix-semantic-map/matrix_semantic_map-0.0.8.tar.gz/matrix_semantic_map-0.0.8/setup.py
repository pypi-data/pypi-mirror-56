...
with open(path.join(here, 'requirements.txt'), 'r') as rf:
    requirements = [x.rstrip() for x in rf.readlines() if x.rstrip()]



setup(name='matrix_semantic_map',  # Required
      version='v0.0.8',  # Required
      ...
      #data_files=[('json_schema', ['src/matrix_semantic_map/json_schema/expression_matrix_semantic_map.json'])],
