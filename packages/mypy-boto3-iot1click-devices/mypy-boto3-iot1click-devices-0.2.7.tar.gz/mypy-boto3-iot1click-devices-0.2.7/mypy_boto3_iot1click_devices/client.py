...
class Client(BaseClient):
    ...
    def claim_devices_by_claim_code(
        ...
        """
        Adds device(s) to your account (i.e., claim one or more devices) if and only if you received a claim
        code with the device(s).
          ...
          - *(dict) --*
            ...
            - **DeviceDescription** *(dict) --*
              ...
              - **Attributes** *(dict) --*
                ...
                An array of zero or more elements of DeviceAttribute objects providing user specified device
                attributes.
