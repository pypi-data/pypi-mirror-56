...
__all__ = ["Metadata", "Metric", "Other", "Parameter", "Tag"]
...
class Metric(QueryVariable):
    ...
    ```python
    >>> from comet_ml.papi import API, Metric
    >>> api = API()
...
class Parameter(QueryVariable):
    ...
    ```python
    >>> from comet_ml.papi import API, Parameter
    >>> api = API()
...
class Metadata(QueryVariable):
    ...
    ```python
    >>> from comet_ml.papi import API, Metadata
    >>> api = API()
...
class Other(QueryVariable):
    ...
    ```python
    >>> from comet_ml.papi import API, Other
    >>> api = API()
...
class Tag(QueryExpression):
    ...
    ```python
    >>> from comet_ml.papi import API, Tag
    >>> api = API()
