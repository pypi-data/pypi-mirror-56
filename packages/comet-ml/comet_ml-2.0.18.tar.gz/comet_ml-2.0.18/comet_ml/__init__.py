...
from .utils import Histogram, get_comet_version
...
class Experiment(BaseExperiment):
    ...
    def _setup_streamer(self):
        ...
        self.rest_api_client = get_rest_api_client("v1", comet_api_key=self.api_key)
    ...
    def send_notification(self, title, status=None, additional_data=None):
        ...
        try:
            ...
            self.connection.send_notification(
                title, status, name, self._get_experiment_url(), additional_data
            )
