...
CONFIG_MAP = {
    ...
    "comet.display_summary": {"type": bool, "default": True},
    # Logging
    ...
    "comet.override_feature.sdk_os_packages_http": {
        "type": bool
    },  # Leave feature toggle default to None
}
...
def get_display_summary(display_summary, config):
    if display_summary is None:
        return config["comet.display_summary"]
    else:
...
def save(directory="~/", save_all=False, **settings):
    ...
    * timeout_upload
    ...
    >>> comet_ml.config.save(api_key="...", rest_api_key="...")
