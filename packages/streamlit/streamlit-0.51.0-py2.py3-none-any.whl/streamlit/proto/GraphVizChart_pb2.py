...
_GRAPHVIZCHART = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='width', full_name='GraphVizChart.width', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='height', full_name='GraphVizChart.height', index=2,
...
GraphVizChart = _reflection.GeneratedProtocolMessageType('GraphVizChart', (_message.Message,), dict(
