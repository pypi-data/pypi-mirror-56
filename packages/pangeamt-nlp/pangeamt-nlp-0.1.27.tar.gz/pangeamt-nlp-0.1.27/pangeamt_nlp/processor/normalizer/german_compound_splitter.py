...
# import pangeamt_nlp.processor.normalizer.ngram_probs as _ngram_probs
# from pangeamt_nlp.processor.base.normalizer_base import  NormalizerBase
#
#
# class GermanCompoundSplitterNormalizer(NormalizerBase):
#
#     NAME = 'German compound splitter'
#     DESCRIPTION_TRAINING = '''
#         Applies the german compound splitter to the src or the tgt, checking
