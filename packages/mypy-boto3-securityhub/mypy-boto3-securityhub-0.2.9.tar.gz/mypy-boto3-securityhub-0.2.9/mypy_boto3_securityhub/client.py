...
class Client(BaseClient):
    ...
    def batch_enable_standards(
        ...
        """
        Enables the standards specified by the provided ``standardsArn`` . In this release, only CIS
        AWS Foundations standards are supported. For more information, see `Standards Supported in
        AWS Security Hub
        <https://docs.aws.amazon.com/securityhub/latest/userguide/securityhub-standards.html>`__ .
    ...
    def batch_import_findings(
        ...
        Hub. This action is requested by the integrated product to import its findings into Security
        Hub. The maximum allowed size for a finding is 240 Kb. An error is returned for any finding
        larger than 240 Kb.
              ...
              Findings=[
                  {
                      ...
                      'ThreatIntelIndicators': [
                          {
                              'Type':
                              'DOMAIN'|'EMAIL_ADDRESS'|'HASH_MD5'|'HASH_SHA1'
                              |'HASH_SHA256'|'HASH_SHA512'|'IPV4_ADDRESS'
                              |'IPV6_ADDRESS'|'MUTEX'|'PROCESS'|'URL',
                              'Value': 'string',
                              'Category':
                              'BACKDOOR'|'CARD_STEALER'|'COMMAND_AND_CONTROL'
        ...
        :param Findings: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Compliance** *(dict) --*
              ...
              run against a specific rule in a supported standard (for example, CIS AWS
    ...
    def create_insight(
        ...
        relate to a security issue that requires attention or remediation. Use the
        ``GroupByAttribute`` to group the related findings in the insight.
    ...
    def create_members(
        ...
        must use this action from an account that already has Security Hub enabled. You can use the
        EnableSecurityHub to enable Security Hub.

        After you use ``CreateMembers`` to create member account associations in Security Hub, you
        need to use the  InviteMembers action, which invites the accounts to enable Security Hub and
        become member accounts in Security Hub. If the invitation is accepted by the account owner,
        the account becomes a member account in Security Hub, and a permission policy is added that
        permits the master account to view the findings generated in the member account. When
        Security Hub is enabled in the invited account, findings start being sent to both the member
        and master accounts.
    ...
    def delete_action_target(self, ActionTargetArn: str) -> ClientDeleteActionTargetResponseTypeDef:
        """
        Deletes a custom action target from Security Hub. Deleting a custom action target doesn't
        affect any findings or insights that were already sent to Amazon CloudWatch Events using the
        custom action.
    ...
    def disable_import_findings_for_product(self, ProductSubscriptionArn: str) -> Dict[str, Any]:
        """
        Disables the integration of the specified product with Security Hub. Findings from that
        product are no longer sent to Security Hub after the integration is disabled.
    ...
    def disable_security_hub(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        """
        Disables Security Hub in your account only in the current Region. To disable Security Hub in
        ...
        configuration settings are deleted after 90 days and can't be recovered. Any standards that
        were enabled are disabled, and your master and member account associations are removed. If
        you want to save your existing findings, you must export them before you disable Security
        Hub.
    ...
    def enable_import_findings_for_product(
        ...
        findings to Security Hub. When you enable a product integration, a permission policy that
    ...
    def enable_security_hub(self, Tags: List[str] = None) -> Dict[str, Any]:
        ...
        request. When you enable Security Hub, you grant to Security Hub the permissions necessary
        to gather findings from AWS Config, Amazon GuardDuty, Amazon Inspector, and Amazon Macie. To
    ...
    def get_enabled_standards(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          Paginates results. On your first call to the ``GetEnabledStandards`` operation, set the
    ...
    def get_findings(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          Paginates results. On your first call to the ``GetFindings`` operation, set the value of
    ...
    def get_insights(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          Paginates results. On your first call to the ``GetInsights`` operation, set the value of
          this parameter to ``NULL`` . For subsequent calls to the operation, fill ``nextToken`` in
          the request with the value of ``nextToken`` from the previous response to continue listing
          data.
    ...
    def get_members(self, AccountIds: List[str]) -> ClientGetMembersResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param AccountIds: **[REQUIRED]**
          ...
          A list of account IDs for the Security Hub member accounts that you want to return the
          details for.
    ...
    def invite_members(self, AccountIds: List[str] = None) -> ClientInviteMembersResponseTypeDef:
        ...
        that the invitation is sent from. Before you can use this action to invite a member, you
        must first create the member account in Security Hub by using the  CreateMembers action.
        When the account owner accepts the invitation to become a member account and enables
        Security Hub, the master account can view the findings generated from member account.
    ...
    def list_enabled_products_for_import(
        ...
        """
        Lists all findings-generating solutions (products) whose findings you have subscribed to
        receive in Security Hub.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          set the value of this parameter to ``NULL`` . For subsequent calls to the operation, fill
          ``nextToken`` in the request with the value of ``NextToken`` from the previous response to
          continue listing data.
    ...
    def list_invitations(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          Paginates results. On your first call to the ``ListInvitations`` operation, set the value
          of this parameter to ``NULL`` . For subsequent calls to the operation, fill ``nextToken``
    ...
    def list_members(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          ``ListMembers`` operation. For subsequent calls to the operation, fill ``nextToken`` in
          the request with the value of ``nextToken`` from the previous response to continue listing
          data.
    ...
    def update_findings(
        ...
        filter attributes specify. Any member account that can view the finding also sees the update
        to the finding.
