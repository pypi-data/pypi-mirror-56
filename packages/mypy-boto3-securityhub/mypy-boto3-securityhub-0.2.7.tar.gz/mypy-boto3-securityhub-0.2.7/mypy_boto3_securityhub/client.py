...
class Client(BaseClient):
    ...
    def create_insight(
        ...
        security issue that requires attention or remediation. Use the ``GroupByAttribute`` to group the
        ...
        **Request Syntax**
        ...
        :param Filters: **[REQUIRED]**
          ...
          - **GeneratorId** *(list) --*
            ...
            The identifier for the solution-specific component (a discrete unit of logic) that generated a
            finding. In various security-findings providers' solutions, this generator can be called a rule,
            a check, a detector, a plug-in, etc.
          ...
          - **Confidence** *(list) --*
            ...
            A finding's confidence. Confidence is defined as the likelihood that a finding accurately
            identifies the behavior or issue that it was intended to identify. Confidence is scored on a
            0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100 percent
            confidence.
          ...
          - **ComplianceStatus** *(list) --*
            ...
            Exclusive to findings that are generated as the result of a check run against a specific rule in
            a supported standard (for example, CIS AWS Foundations). Contains compliance-related finding
            details.
    ...
    def delete_action_target(
        ...
        """
        Deletes a custom action target from Security Hub. Deleting a custom action target doesn't affect any
        findings or insights that were already sent to Amazon CloudWatch Events using the custom action.
    ...
    def enable_import_findings_for_product(
        ...
        Security Hub. When you enable a product integration, a permission policy that grants permission for
    ...
    def enable_security_hub(self, Tags: List[str] = None) -> Dict[str, Any]:
        ...
        findings from AWS Config, Amazon GuardDuty, Amazon Inspector, and Amazon Macie. To learn more, see
            ...
            - **Findings** *(list) --*
              ...
              - *(dict) --*
                ...
                - **GeneratorId** *(string) --*
                  ...
                  be called a rule, a check, a detector, a plug-in, etc.
                ...
                - **Confidence** *(integer) --*
                  ...
                  A finding's confidence. Confidence is defined as the likelihood that a finding accurately
                  identifies the behavior or issue that it was intended to identify. Confidence is scored on
                  a 0-100 basis using a ratio scale, where 0 means zero percent confidence and 100 means 100
                  percent confidence.
          ...
          - *(dict) --*
            ...
            - **InsightResults** *(dict) --*
              ...
              - **GroupByAttribute** *(string) --*
                ...
                The attribute that the findings are grouped by for the insight whose results are returned by
    ...
    def list_enabled_products_for_import(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          value of this parameter to ``NULL`` . For subsequent calls to the operation, fill ``nextToken`` in
