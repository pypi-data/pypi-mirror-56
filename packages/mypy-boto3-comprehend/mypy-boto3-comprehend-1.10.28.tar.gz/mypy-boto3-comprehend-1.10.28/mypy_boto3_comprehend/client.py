...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def detect_entities(self, Text: str, LanguageCode: str) -> ClientDetectEntitiesResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def detect_syntax(self, Text: str, LanguageCode: str) -> ClientDetectSyntaxResponseTypeDef:
        """
