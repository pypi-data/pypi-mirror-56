...
class ClientBatchDetectDominantLanguageResponseResultListLanguagesTypeDef(
    ...
    - **LanguageCode** *(string) --*
      ...
      The RFC 5646 language code for the dominant language. For more information about RFC 5646, see
...
class ClientBatchDetectDominantLanguageResponseTypeDef(
    ...
    - **ResultList** *(list) --*
      ...
      A list of objects containing the results of the operation. The results are sorted in ascending
      order by the ``Index`` field and match the order of the documents in the input list. If all of
    ...
    - **ErrorList** *(list) --*
      ...
      A list containing one object for each document that contained an error. The results are sorted
      in ascending order by the ``Index`` field and match the order of the documents in the input
      list. If there are no errors in the batch, the ``ErrorList`` is empty.
...
class ClientBatchDetectEntitiesResponseResultListEntitiesTypeDef(
    ...
    - **BeginOffset** *(integer) --*
      ...
      A character offset in the input text that shows where the entity begins (the first character
      is at position 0). The offset returns the position of each UTF-8 code point in the string. A
      *code point* is the abstract character from a particular graphical representation. For
      example, a multi-byte UTF-8 character maps to a single code point.

    - **EndOffset** *(integer) --*

      A character offset in the input text that shows where the entity ends. The offset returns the
      position of each UTF-8 code point in the string. A *code point* is the abstract character from
      a particular graphical representation. For example, a multi-byte UTF-8 character maps to a
      single code point.
    """
...
class ClientBatchDetectKeyPhrasesResponseResultListKeyPhrasesTypeDef(
    ...
    - **BeginOffset** *(integer) --*
      ...
      string. A *code point* is the abstract character from a particular graphical representation.
    ...
    - **EndOffset** *(integer) --*
      ...
      position of each UTF-8 code point in the string. A ``code point`` is the abstract character
      from a particular graphical representation. For example, a multi-byte UTF-8 character maps to
      a single code point.
    """
...
class ClientBatchDetectSyntaxResponseResultListSyntaxTokensPartOfSpeechTypeDef(
    ...
    Provides the part of speech label and the confidence level that Amazon Comprehend has that the
    part of speech was correctly identified. For more information, see  how-syntax .
...
_ClientClassifyDocumentResponseClassesTypeDef = TypedDict(
    "_ClientClassifyDocumentResponseClassesTypeDef", {"Name": str, "Score": float}, total=False
)


class ClientClassifyDocumentResponseClassesTypeDef(_ClientClassifyDocumentResponseClassesTypeDef):
    """
    Type definition for `ClientClassifyDocumentResponse` `Classes`
...
class ClientClassifyDocumentResponseTypeDef(_ClientClassifyDocumentResponseTypeDef):
    """
    Type definition for `ClientClassifyDocument` `Response`
...
class ClientCreateDocumentClassifierTagsTypeDef(
    ...
    A key-value pair that adds as a metadata to a resource used by Amazon Comprehend. For example, a
    tag with the key-value pair ‘Department’:’Sales’ might be added to a resource to indicate its
...
class ClientCreateEntityRecognizerVpcConfigTypeDef(_ClientCreateEntityRecognizerVpcConfigTypeDef):
    """
...
class ClientDescribeDocumentClassificationJobResponseDocumentClassificationJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDocumentClassificationJobResponseDocumentClassificationJobProperties`
    `InputDataConfig`
...
class ClientDescribeDocumentClassificationJobResponseDocumentClassificationJobPropertiesVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDocumentClassificationJobResponseDocumentClassificationJobProperties` `VpcConfig`

    Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you
    are using for your document classification job. For more information, see `Amazon VPC
    <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`__ .
...
class ClientDescribeDocumentClassificationJobResponseDocumentClassificationJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeDocumentClassificationJobResponse`
    ...
    - **InputDataConfig** *(dict) --*
      ...
      - **S3Uri** *(string) --*
        ...
        that you are calling. The URI can point to a single input file or it can provide the prefix
        for a collection of data files.
      ...
      - **InputFormat** *(string) --*
        ...
        * ``ONE_DOC_PER_FILE`` - Each file is considered a separate document. Use this option when
        you are processing large documents, such as newspaper articles or scientific papers.
    ...
    - **OutputDataConfig** *(dict) --*
      ...
      - **S3Uri** *(string) --*
        ...
        actual location of the output file.
    ...
    - **DocumentClassificationJobProperties** *(dict) --*
      ...
      - **VpcConfig** *(dict) --*
        ...
        - **SecurityGroupIds** *(list) --*
          ...
          your VPC function serve as a virtual firewall to control inbound and outbound traffic and
          provides security for the resources that you’ll be accessing on the VPC. This ID number is
          preceded by "sg-", for instance: "sg-03b388029b0a285ea". For more information, see
...
class ClientDescribeDocumentClassifierResponseDocumentClassifierPropertiesClassifierMetadataEvaluationMetricsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDocumentClassifierResponseDocumentClassifierPropertiesClassifierMetadata`
    `EvaluationMetrics`
    ...
    - **Accuracy** *(float) --*
      ...
      The fraction of the labels that were correct recognized. It is computed by dividing the number
      of labels in the test documents that were correctly recognized by the total number of labels
      in the test documents.

    - **Precision** *(float) --*

      A measure of the usefulness of the classifier results in the test data. High precision means
      that the classifier returned substantially more relevant results than irrelevant ones.

    - **Recall** *(float) --*

      A measure of how complete the classifier results are for the test data. High recall means that
    ...
    - **F1Score** *(float) --*
      ...
      ``Precision`` and ``Recall`` values. The ``F1Score`` is the harmonic average of the two
...
class ClientDescribeDocumentClassifierResponseDocumentClassifierPropertiesClassifierMetadataTypeDef(
    ...
    """
    Type definition for `ClientDescribeDocumentClassifierResponseDocumentClassifierProperties`
    `ClassifierMetadata`

    Information about the document classifier, including the number of documents used for training
    the classifier, the number of documents used for test the classifier, and an accuracy rating.
    ...
    - **NumberOfTrainedDocuments** *(integer) --*
      ...
      The number of documents in the input data that were used to train the classifier. Typically
    ...
    - **EvaluationMetrics** *(dict) --*
      ...
      - **F1Score** *(float) --*
        ...
        the ``Precision`` and ``Recall`` values. The ``F1Score`` is the harmonic average of the two
        scores. The highest score is 1, and the worst score is 0.
    """
...
class ClientDescribeDocumentClassifierResponseDocumentClassifierPropertiesTypeDef(
    ...
    - **Status** *(string) --*
      ...
      The status of the document classifier. If the status is ``TRAINED`` the classifier is ready to
      use. If the status is ``FAILED`` you can see additional information about why the classifier
    ...
    - **TrainingEndTime** *(datetime) --*
      ...
      training completes on documentation classifiers. You are billed for the time interval between
      this time and the value of TrainingStartTime.
    ...
    - **ClassifierMetadata** *(dict) --*
      ...
      - **EvaluationMetrics** *(dict) --*
        ...
        - **F1Score** *(float) --*
          ...
          A measure of how accurate the classifier results are for the test data. It is derived from
          the ``Precision`` and ``Recall`` values. The ``F1Score`` is the harmonic average of the
...
class ClientDescribeDocumentClassifierResponseTypeDef(
    ...
    - **DocumentClassifierProperties** *(dict) --*
      ...
      - **TrainingEndTime** *(datetime) --*
        ...
        The time that training of the document classifier was completed. Indicates the time when the
        training completes on documentation classifiers. You are billed for the time interval
      ...
      - **ClassifierMetadata** *(dict) --*
        ...
        - **EvaluationMetrics** *(dict) --*
          ...
          - **F1Score** *(float) --*
            ...
            from the ``Precision`` and ``Recall`` values. The ``F1Score`` is the harmonic average of
...
class ClientDescribeDominantLanguageDetectionJobResponseDominantLanguageDetectionJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDominantLanguageDetectionJobResponseDominantLanguageDetectionJobProperties`
    `InputDataConfig`

    The input data configuration that you supplied when you created the dominant language detection
    job.
...
class ClientDescribeDominantLanguageDetectionJobResponseDominantLanguageDetectionJobPropertiesVpcConfigTypeDef(
    ...
    Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you
    are using for your dominant language detection job. For more information, see `Amazon VPC
    <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`__ .
...
class ClientDescribeDominantLanguageDetectionJobResponseDominantLanguageDetectionJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeDominantLanguageDetectionJobResponse`
    ...
    - **VpcConfig** *(dict) --*
      ...
      Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources
      you are using for your dominant language detection job. For more information, see `Amazon VPC
      <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`__ .
...
class ClientDescribeEndpointResponseEndpointPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeEndpointResponse` `EndpointProperties`
...
class ClientDescribeEntitiesDetectionJobResponseEntitiesDetectionJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeEntitiesDetectionJobResponseEntitiesDetectionJobProperties`
    `InputDataConfig`
...
class ClientDescribeEntitiesDetectionJobResponseEntitiesDetectionJobPropertiesVpcConfigTypeDef(
    ...
    Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you
    are using for your entity detection job. For more information, see `Amazon VPC
    <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`__ .
...
class ClientDescribeEntitiesDetectionJobResponseEntitiesDetectionJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeEntitiesDetectionJobResponse`
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfigAnnotationsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfig` `Annotations`
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfigDocumentsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfig` `Documents`
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfigEntityListTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfig` `EntityList`
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfigEntityTypesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfig` `EntityTypes`
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeEntityRecognizerResponseEntityRecognizerProperties`
    `InputDataConfig`
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesRecognizerMetadataEntityTypesEvaluationMetricsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesRecognizerMetadataEntityTypes`
    `EvaluationMetrics`

    Detailed information about the accuracy of the entity recognizer for a specific item on the list
    of entity types.

    - **Precision** *(float) --*

      A measure of the usefulness of the recognizer results for a specific entity type in the test
      data. High precision means that the recognizer returned substantially more relevant results
      than irrelevant ones.

    - **Recall** *(float) --*

      A measure of how complete the recognizer results are for a specific entity type in the test
      data. High recall means that the recognizer returned most of the relevant results.
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesRecognizerMetadataEntityTypesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesRecognizerMetadata`
    `EntityTypes`
    ...
    - **EvaluationMetrics** *(dict) --*
      ...
      Detailed information about the accuracy of the entity recognizer for a specific item on the
      ...
      - **F1Score** *(float) --*
        ...
        A measure of how accurate the recognizer results are for for a specific entity type in the
        test data. It is derived from the ``Precision`` and ``Recall`` values. The ``F1Score`` is
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesRecognizerMetadataEvaluationMetricsTypeDef(
    ...
    - **Precision** *(float) --*
      ...
      A measure of the usefulness of the recognizer results in the test data. High precision means
      that the recognizer returned substantially more relevant results than irrelevant ones.

    - **Recall** *(float) --*

      A measure of how complete the recognizer results are for the test data. High recall means that
      the recognizer returned most of the relevant results.
      ...
      - *(dict) --*
        ...
        - **EvaluationMetrics** *(dict) --*
          ...
          - **F1Score** *(float) --*
            ...
            A measure of how accurate the recognizer results are for for a specific entity type in
            the test data. It is derived from the ``Precision`` and ``Recall`` values. The
            ``F1Score`` is the harmonic average of the two scores. The highest score is 1, and the
            worst score is 0.
...
class ClientDescribeEntityRecognizerResponseEntityRecognizerPropertiesTypeDef(
    ...
    - **LanguageCode** *(string) --*
      ...
      The language of the input documents. All documents must be in the same language. Only English
        ...
        - *(dict) --*
          ...
          - **EvaluationMetrics** *(dict) --*
            ...
            - **Recall** *(float) --*
              ...
              A measure of how complete the recognizer results are for a specific entity type in the
              test data. High recall means that the recognizer returned most of the relevant
              results.
...
class ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobProperties` `InputDataConfig`
...
class ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobPropertiesOutputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobProperties`
    `OutputDataConfig`
...
class ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobPropertiesVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobProperties` `VpcConfig`

    Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you
    are using for your key phrases detection job. For more information, see `Amazon VPC
    <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`__ .
...
class ClientDescribeKeyPhrasesDetectionJobResponseKeyPhrasesDetectionJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeKeyPhrasesDetectionJobResponse`
...
class ClientDescribeSentimentDetectionJobResponseSentimentDetectionJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeSentimentDetectionJobResponseSentimentDetectionJobProperties`
    `InputDataConfig`
...
class ClientDescribeSentimentDetectionJobResponseSentimentDetectionJobPropertiesVpcConfigTypeDef(
    ...
    Configuration parameters for a private Virtual Private Cloud (VPC) containing the resources you
    are using for your sentiment detection job. For more information, see `Amazon VPC
    <https://docs.aws.amazon.com/vpc/latest/userguide/what-is-amazon-vpc.html>`__ .
...
class ClientDescribeSentimentDetectionJobResponseSentimentDetectionJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeSentimentDetectionJobResponse`
...
class ClientDescribeTopicsDetectionJobResponseTopicsDetectionJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeTopicsDetectionJobResponseTopicsDetectionJobProperties`
    `InputDataConfig`
...
class ClientDescribeTopicsDetectionJobResponseTopicsDetectionJobPropertiesTypeDef(
    ...
    - **NumberOfTopics** *(integer) --*
      ...
      The number of topics to detect supplied when you created the topic detection job. The default
      is 10.
...
class ClientDetectDominantLanguageResponseTypeDef(_ClientDetectDominantLanguageResponseTypeDef):
    ...
    - **Languages** *(list) --*
      ...
      has in the accuracy of its inference. For more information about RFC 5646, see `Tags for
      Identifying Languages <https://tools.ietf.org/html/rfc5646>`__ on the *IETF Tools* web site.
...
_ClientDetectSentimentResponseTypeDef = TypedDict(
    ...
    {"Sentiment": str, "SentimentScore": ClientDetectSentimentResponseSentimentScoreTypeDef},
    total=False,
)
...
_ClientListDocumentClassificationJobsFilterTypeDef = TypedDict(
    ...
    {"JobName": str, "JobStatus": str, "SubmitTimeBefore": datetime, "SubmitTimeAfter": datetime},
    total=False,
)
...
class ClientListDocumentClassificationJobsFilterTypeDef(
    ...
    - **SubmitTimeAfter** *(datetime) --*
      ...
      Filters the list of jobs based on the time that the job was submitted for processing. Returns
      only jobs submitted before the specified time. Jobs are returned in descending order, newest
      to oldest.
    """
...
class ClientListDocumentClassificationJobsResponseDocumentClassificationJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListDocumentClassificationJobsResponseDocumentClassificationJobPropertiesList`
    `InputDataConfig`
...
class ClientListDocumentClassificationJobsResponseDocumentClassificationJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListDocumentClassificationJobsResponse`
...
class ClientListDocumentClassifiersResponseDocumentClassifierPropertiesListClassifierMetadataEvaluationMetricsTypeDef(
    ...
    """
    Type definition for
    `ClientListDocumentClassifiersResponseDocumentClassifierPropertiesListClassifierMetadata`
    `EvaluationMetrics`
...
class ClientListDocumentClassifiersResponseDocumentClassifierPropertiesListClassifierMetadataTypeDef(
    ...
    """
    Type definition for `ClientListDocumentClassifiersResponseDocumentClassifierPropertiesList`
    `ClassifierMetadata`
    ...
    - **DocumentClassifierPropertiesList** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Status** *(string) --*
          ...
          ready to use. If the status is ``FAILED`` you can see additional information about why the
          classifier wasn't trained in the ``Message`` field.
...
class ClientListDominantLanguageDetectionJobsResponseDominantLanguageDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListDominantLanguageDetectionJobsResponseDominantLanguageDetectionJobPropertiesList`
    `InputDataConfig`
...
class ClientListDominantLanguageDetectionJobsResponseDominantLanguageDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListDominantLanguageDetectionJobsResponse`
...
_ClientListEndpointsFilterTypeDef = TypedDict(
    ...
    {"ModelArn": str, "Status": str, "CreationTimeBefore": datetime, "CreationTimeAfter": datetime},
    total=False,
)
...
class ClientListEndpointsFilterTypeDef(_ClientListEndpointsFilterTypeDef):
    """
    Type definition for `ClientListEndpoints` `Filter`
...
class ClientListEndpointsResponseEndpointPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListEndpointsResponse` `EndpointPropertiesList`
...
class ClientListEntitiesDetectionJobsResponseEntitiesDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientListEntitiesDetectionJobsResponseEntitiesDetectionJobPropertiesList`
    `InputDataConfig`
...
class ClientListEntitiesDetectionJobsResponseEntitiesDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListEntitiesDetectionJobsResponse`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfigAnnotationsTypeDef(
    ...
    """
    Type definition for
    `ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfig` `Annotations`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfigDocumentsTypeDef(
    ...
    """
    Type definition for
    `ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfig` `Documents`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfigEntityListTypeDef(
    ...
    """
    Type definition for
    `ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfig` `EntityList`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfigEntityTypesTypeDef(
    ...
    """
    Type definition for
    `ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfig` `EntityTypes`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientListEntityRecognizersResponseEntityRecognizerPropertiesList`
    `InputDataConfig`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListRecognizerMetadataEntityTypesEvaluationMetricsTypeDef(
    ...
    """
    Type definition for
    `ClientListEntityRecognizersResponseEntityRecognizerPropertiesListRecognizerMetadataEntityTypes`
    `EvaluationMetrics`
...
class ClientListEntityRecognizersResponseEntityRecognizerPropertiesListRecognizerMetadataEntityTypesTypeDef(
    ...
    """
    Type definition for
    `ClientListEntityRecognizersResponseEntityRecognizerPropertiesListRecognizerMetadata`
    `EntityTypes`
            ...
            - *(dict) --*
              ...
              - **EvaluationMetrics** *(dict) --*
                ...
                - **F1Score** *(float) --*
                  ...
                  The ``F1Score`` is the harmonic average of the two scores. The highest score is 1,
...
class ClientListKeyPhrasesDetectionJobsResponseKeyPhrasesDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListKeyPhrasesDetectionJobsResponseKeyPhrasesDetectionJobPropertiesList`
    `InputDataConfig`
...
class ClientListKeyPhrasesDetectionJobsResponseKeyPhrasesDetectionJobPropertiesListVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListKeyPhrasesDetectionJobsResponseKeyPhrasesDetectionJobPropertiesList` `VpcConfig`
...
class ClientListKeyPhrasesDetectionJobsResponseKeyPhrasesDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListKeyPhrasesDetectionJobsResponse`
...
class ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesList` `InputDataConfig`
...
class ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesListOutputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesList` `OutputDataConfig`
...
class ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesListVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesList` `VpcConfig`
...
class ClientListSentimentDetectionJobsResponseSentimentDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListSentimentDetectionJobsResponse`
    ...
    - **Tags** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Key** *(string) --*
          ...
          For instance, if you want to show which resources are used by which departments, you might
          use “Department” as the key portion of the pair, with multiple possible values such as
          “sales,” “legal,” and “administration.”
...
class ClientListTopicsDetectionJobsFilterTypeDef(_ClientListTopicsDetectionJobsFilterTypeDef):
    ...
    - **SubmitTimeBefore** *(datetime) --*
      ...
      returns jobs submitted before the specified time. Jobs are returned in descending order,
      newest to oldest.
...
class ClientListTopicsDetectionJobsResponseTopicsDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientListTopicsDetectionJobsResponseTopicsDetectionJobPropertiesList`
    `InputDataConfig`
...
class ClientStartDocumentClassificationJobResponseTypeDef(
    ...
    - **JobStatus** *(string) --*
      ...
      * STOP_REQUESTED - Amazon Comprehend has received a stop request for the job and is processing
      the request.
...
_ClientStartEntitiesDetectionJobResponseTypeDef = TypedDict(
    "_ClientStartEntitiesDetectionJobResponseTypeDef", {"JobId": str, "JobStatus": str}, total=False
)
...
_ClientStartTopicsDetectionJobResponseTypeDef = TypedDict(
    "_ClientStartTopicsDetectionJobResponseTypeDef", {"JobId": str, "JobStatus": str}, total=False
)
...
class ClientStartTopicsDetectionJobVpcConfigTypeDef(_ClientStartTopicsDetectionJobVpcConfigTypeDef):
    """
...
_ClientStopEntitiesDetectionJobResponseTypeDef = TypedDict(
    "_ClientStopEntitiesDetectionJobResponseTypeDef", {"JobId": str, "JobStatus": str}, total=False
)
...
_ClientStopSentimentDetectionJobResponseTypeDef = TypedDict(
    "_ClientStopSentimentDetectionJobResponseTypeDef", {"JobId": str, "JobStatus": str}, total=False
)
...
class ListDocumentClassificationJobsPaginateResponseDocumentClassificationJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ListDocumentClassificationJobsPaginateResponseDocumentClassificationJobPropertiesList`
    `InputDataConfig`
...
class ListDocumentClassificationJobsPaginateResponseDocumentClassificationJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ListDocumentClassificationJobsPaginateResponse`
    `DocumentClassificationJobPropertiesList`
...
class ListDocumentClassifiersPaginateResponseDocumentClassifierPropertiesListClassifierMetadataEvaluationMetricsTypeDef(
    ...
    """
    Type definition for
    `ListDocumentClassifiersPaginateResponseDocumentClassifierPropertiesListClassifierMetadata`
    `EvaluationMetrics`
...
class ListDocumentClassifiersPaginateResponseDocumentClassifierPropertiesListClassifierMetadataTypeDef(
    ...
    """
    Type definition for `ListDocumentClassifiersPaginateResponseDocumentClassifierPropertiesList`
    `ClassifierMetadata`
...
class ListDominantLanguageDetectionJobsPaginateResponseDominantLanguageDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ListDominantLanguageDetectionJobsPaginateResponseDominantLanguageDetectionJobPropertiesList`
    `InputDataConfig`
...
class ListDominantLanguageDetectionJobsPaginateResponseDominantLanguageDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ListDominantLanguageDetectionJobsPaginateResponse`
    `DominantLanguageDetectionJobPropertiesList`
...
class ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesList` `InputDataConfig`
...
class ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesListOutputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesList` `OutputDataConfig`
...
class ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesListVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesList` `VpcConfig`
...
class ListEntitiesDetectionJobsPaginateResponseEntitiesDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ListEntitiesDetectionJobsPaginateResponse`
    `EntitiesDetectionJobPropertiesList`
...
class ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListInputDataConfigAnnotationsTypeDef(
    ...
    """
    Type definition for
    `ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListInputDataConfig`
    `Annotations`
...
class ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListInputDataConfigDocumentsTypeDef(
    ...
    """
    Type definition for
    `ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListInputDataConfig` `Documents`
...
class ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for `ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesList`
    `InputDataConfig`
...
class ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListRecognizerMetadataEntityTypesEvaluationMetricsTypeDef(
    ...
    """
    Type definition for
    `ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListRecognizerMetadataEntityTypes`
    `EvaluationMetrics`
...
class ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListRecognizerMetadataEntityTypesTypeDef(
    ...
    """
    Type definition for
    `ListEntityRecognizersPaginateResponseEntityRecognizerPropertiesListRecognizerMetadata`
    `EntityTypes`
...
class ListKeyPhrasesDetectionJobsPaginateResponseKeyPhrasesDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ListKeyPhrasesDetectionJobsPaginateResponseKeyPhrasesDetectionJobPropertiesList`
    `InputDataConfig`
...
class ListKeyPhrasesDetectionJobsPaginateResponseKeyPhrasesDetectionJobPropertiesListVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ListKeyPhrasesDetectionJobsPaginateResponseKeyPhrasesDetectionJobPropertiesList` `VpcConfig`
...
class ListKeyPhrasesDetectionJobsPaginateResponseKeyPhrasesDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ListKeyPhrasesDetectionJobsPaginateResponse`
    `KeyPhrasesDetectionJobPropertiesList`
...
class ListSentimentDetectionJobsPaginateResponseSentimentDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ListSentimentDetectionJobsPaginateResponseSentimentDetectionJobPropertiesList`
    `InputDataConfig`
...
class ListSentimentDetectionJobsPaginateResponseSentimentDetectionJobPropertiesListVpcConfigTypeDef(
    ...
    """
    Type definition for
    `ListSentimentDetectionJobsPaginateResponseSentimentDetectionJobPropertiesList` `VpcConfig`
...
class ListSentimentDetectionJobsPaginateResponseSentimentDetectionJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ListSentimentDetectionJobsPaginateResponse`
    `SentimentDetectionJobPropertiesList`
...
class ListTopicsDetectionJobsPaginateResponseTopicsDetectionJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for `ListTopicsDetectionJobsPaginateResponseTopicsDetectionJobPropertiesList`
    `InputDataConfig`
