...
class ICloud_Account (object):
    ...
    def __init__(self, name, username, password, cookie_dir=None,homie_settings=None, mqtt_settings=None):

        self.homie_settings = homie_settings
        self.mqtt_settings = mqtt_settings
        self.username = username
        self.password = password
        self.cookie_dir = cookie_dir or os.getcwd()
    ...
    def connect_icloud(self):
        try:
            self.api = PyiCloudService(self.username,self.password,cookie_directory=self.cookie_dir,verify=True)
