...
class ClientGetExecutionHistoryResponseeventsactivityScheduleFailedEventDetailsTypeDef(
    ...
    """
    Type definition for `ClientGetExecutionHistoryResponseevents`
...
class ClientGetExecutionHistoryResponseeventsactivityStartedEventDetailsTypeDef(
    ...
    - **workerName** *(string) --*
      ...
      The name of the worker that the task is assigned to. These names are provided by the workers
      when calling  GetActivityTask .
    """
...
class ClientGetExecutionHistoryResponseeventstaskSucceededEventDetailsTypeDef(
    ...
    - **output** *(string) --*
      ...
      The full JSON response from a resource when a task has succeeded. This response becomes the
...
class GetExecutionHistoryPaginateResponseeventsactivityScheduleFailedEventDetailsTypeDef(
    ...
    """
    Type definition for `GetExecutionHistoryPaginateResponseevents`
    `activityScheduleFailedEventDetails`
