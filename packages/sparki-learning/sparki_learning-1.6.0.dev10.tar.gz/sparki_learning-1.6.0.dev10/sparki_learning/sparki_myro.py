...
def senses():
    ...
    try:
        ...
        col2 = [
                   [ sg.Text('left edge') ],
                   [ sg.Text('   ', key='_LEDGE_VALUE_', size=(5,1)) ],
                   [ sg.Text('') ],
                   [ sg.Text('') ],
                   [ sg.Text('') ],
                   [ sg.Text('') ],
                   [ sg.Text('') ],
                   [ sg.Text('') ],
                   [ sg.Text('   ', key='_PING_VALUE_', size=(5,1)) ]
               ]

        # 3rd column: left, l line value, l light value, space, X, X mag, X accel, space, space
        col3 = [
                   [ sg.Text('left') ],
                   [ sg.Text('   ', key='_LLINE_VALUE_', size=(5,1)) ],
                   [ sg.Text('   ', key='_LLIGHT_VALUE_', size=(5,1)) ],
                   [ sg.Text('') ],
                   [ sg.Text('X') ],
        ...
        col4 = [
                   [ sg.Text('center') ],
                   [ sg.Text('   ', key='_CLINE_VALUE_', size=(5,1)) ],
                   [ sg.Text('   ', key='_CLIGHT_VALUE_', size=(5,1)) ],
                   [ sg.Text('') ],
                   [ sg.Text('Y') ],
        ...
        col5 = [
                   [ sg.Text('right') ],
                   [ sg.Text('   ', key='_RLINE_VALUE_', size=(5,1)) ],
                   [ sg.Text('   ', key='_RLIGHT_VALUE_', size=(5,1)) ],
                   [ sg.Text('') ],
                   [ sg.Text('Z') ],
        ...
        col6 = [
                   [ sg.Text('right edge') ],
                   [ sg.Text('   ', key='_REDGE_VALUE_', size=(5,1)) ],
                   [ sg.Text('') ],
                   [ sg.Text('') ],
                   [ sg.Text('compass') ],
