...
class Client(BaseClient):
    ...
    def decline_invitations(
        ...
        **Request Syntax**
        ...
        :param AccountIds: **[REQUIRED]**
          ...
          A list of account IDs of the AWS accounts that sent invitations to the current member account that
          you want to decline invitations from.
    ...
    def delete_invitations(
        ...
        **Request Syntax**
        ...
        :param AccountIds: **[REQUIRED]**
          ...
          A list of account IDs of the AWS accounts that sent invitations to the current member account that
          you want to delete invitations from.
    ...
    def list_publishing_destinations(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token to use for paginating results returned in the repsonse. Set the value of this parameter to
    ...
    def stop_monitoring_members(
        ...
        """
        Stops GuardDuty monitoring for the specified member accounnts. Use the ``StartMonitoringMembers`` to
