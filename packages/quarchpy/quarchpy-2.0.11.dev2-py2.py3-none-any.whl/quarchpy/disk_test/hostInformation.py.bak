...
class HostInformation:
    ...
    #             printText("Module ID : " + str(moduleSections[0]))
    #             printText("Module Desc : " + str(moduleSections[1]))
    #
    #             # is send across in format QuarchDTS::Key=Value
    #             driveTestCore.notifyChoiceOption(moduleSections[0], moduleSections[1])
    #         if not deviceList:
    #             # python logic!
    #             printText("ERROR - No PCIe devices found to display")
    #
    ...
    #
    #                 deviceStr = key
    #                 printText("I found your device!")
    #                 found = True
    #                 break
    #
    #         if not found:
    #             printText("couldn't find your device")
    #             return 0
    #
