...
class ClientCreateAliasResponseAliasTypeDef(_ClientCreateAliasResponseAliasTypeDef):
    ...
    - **CreationTime** *(datetime) --*
      ...
      Time stamp indicating when this data object was created. Format is a number expressed in Unix
      time as milliseconds (for example "1469498468.057").

    - **LastUpdatedTime** *(datetime) --*

      Time stamp indicating when this data object was last modified. Format is a number expressed in
...
class ClientCreateBuildResponseBuildTypeDef(_ClientCreateBuildResponseBuildTypeDef):
    ...
    - **Status** *(string) --*
      ...
      * **INITIALIZED** -- A new build has been defined, but no files have been uploaded. You cannot
      create fleets for builds that are in this status. When a build is successfully created, the
      build status is set to this value.
    ...
    - **OperatingSystem** *(string) --*
      ...
      Operating system that the game server binaries are built to run on. This value determines the
      type of fleet resources that you can use for this build.
...
class ClientCreateFleetEC2InboundPermissionsTypeDef(_ClientCreateFleetEC2InboundPermissionsTypeDef):
    """
...
class ClientCreateFleetResponseFleetAttributesResourceCreationLimitPolicyTypeDef(
    ...
    Fleet policy to limit the number of game sessions an individual player can create over a span of
    time.
...
class ClientCreateFleetResponseFleetAttributesTypeDef(
    ...
    - **InstanceType** *(string) --*
      ...
      EC2 instance type indicating the computing resources of each instance in the fleet, including
      CPU, memory, storage, and networking capacity. See `Amazon EC2 Instance Types
    ...
    - **LogPaths** *(list) --*
      ...
      . If no default log path for a fleet is specified, Amazon GameLift automatically uploads logs
      that are stored on each instance at ``C:\\game\\logs`` (for Windows) or ``/local/game/logs``
    ...
    - **OperatingSystem** *(string) --*
      ...
      Operating system of the fleet's computing resources. A fleet's operating system depends on the
      OS specified for the build that is deployed on this fleet.

    - **ResourceCreationLimitPolicy** *(dict) --*

      Fleet policy to limit the number of game sessions an individual player can create over a span
      of time.
    ...
    - **InstanceRoleArn** *(string) --*
      ...
      role or look up a role's ARN using the `IAM dashboard <https://console.aws.amazon.com/iam/>`__
      in the AWS Management Console. Learn more about using on-box credentials for your game servers
      at `Access external resources from a game server
...
class ClientCreateFleetRuntimeConfigurationServerProcessesTypeDef(
    ...
    - **LaunchPath** *(string) --* **[REQUIRED]**
      ...
      file that contains the ``Init()`` function. Game builds and Realtime scripts are installed on
...
class ClientCreateGameSessionGamePropertiesTypeDef(_ClientCreateGameSessionGamePropertiesTypeDef):
    """
...
class ClientCreateGameSessionQueueResponseGameSessionQueuePlayerLatencyPoliciesTypeDef(
    ...
    """
    Type definition for `ClientCreateGameSessionQueueResponseGameSessionQueue`
...
class ClientCreateGameSessionQueueResponseGameSessionQueueTypeDef(
    ...
    - **GameSessionQueueArn** *(string) --*
      ...
      Amazon Resource Name (`ARN
      <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html>`__ ) that is assigned to
      a game session queue and uniquely identifies it. Format is ``arn:aws:gamelift:<region>:<aws
      account>:gamesessionqueue/<queue name>`` .

    - **TimeoutInSeconds** *(integer) --*

      Maximum time, in seconds, that a new game session placement request remains in the queue. When
      a request exceeds this time, the game session placement changes to a ``TIMED_OUT`` status.

    - **PlayerLatencyPolicies** *(list) --*

      Collection of latency policies to apply when processing game sessions placement requests with
      player latency information. Multiple policies are evaluated in order of the maximum latency
      value, starting with the lowest latency values. With just one policy, it is enforced at the
      start of the game session placement for the duration period. With multiple policies, each
      policy is enforced consecutively for its duration period. For example, a queue might enforce a
      60-second policy followed by a 120-second policy, and then no policy for the remainder of the
      placement.
...
class ClientCreateGameSessionResponseGameSessionTypeDef(
    ...
    - **StatusReason** *(string) --*
      ...
      Provides additional information about game session status. ``INTERRUPTED`` indicates that the
      game session was hosted on a spot instance that was reclaimed, causing the active game session
      to be terminated.
    ...
    - **GameProperties** *(list) --*
      ...
      - *(dict) --*
        ...
        new game session, such as to specify a game mode, level, or map. Game properties are passed
        to the game server process when initiating a new game session; the server process uses the
        properties as appropriate. For more information, see the `Amazon GameLift Developer Guide
        <https://docs.aws.amazon.com/gamelift/latest/developerguide/gamelift-sdk-client-api.html#gamelift-sdk-client-api-create>`__
        .
    ...
    - **IpAddress** *(string) --*
      ...
      IP address of the game session. To connect to a Amazon GameLift game server, an app needs both
    ...
    - **GameSessionData** *(string) --*
      ...
      Set of custom game session properties, formatted as a single string value. This data is passed
...
_ClientCreateMatchmakingConfigurationGamePropertiesTypeDef = TypedDict(
    "_ClientCreateMatchmakingConfigurationGamePropertiesTypeDef", {"Key": str, "Value": str}
)
...
class ClientCreateMatchmakingConfigurationResponseConfigurationTypeDef(
    ...
    - **GameSessionQueueArns** *(list) --*
      ...
      <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-arn-format.html>`__ ) that is assigned to
      a game session queue and uniquely identifies it. Format is ``arn:aws:gamelift:<region>:<aws
      account>:gamesessionqueue/<queue name>`` . These queues are used when placing game sessions
      for matches that are created with this matchmaking configuration. Queues can be located in any
      region.
    ...
    - **AcceptanceRequired** *(boolean) --*
      ...
      Flag that determines whether a match that was created with this configuration must be accepted
    ...
    - **BackfillMode** *(string) --*
      ...
      AUTOMATIC indicates that GameLift creates  StartMatchBackfill requests whenever a game session
...
class ClientCreateMatchmakingRuleSetResponseRuleSetTypeDef(
    ...
    - **RuleSetBody** *(string) --*
      ...
      Collection of matchmaking rules, formatted as a JSON string. Comments are not allowed in JSON,
...
class ClientCreatePlayerSessionResponsePlayerSessionTypeDef(
    ...
    - **Status** *(string) --*
      ...
      * **TIMEDOUT** -- A player session request was received, but the player did not connect and/or
...
class ClientCreatePlayerSessionsResponsePlayerSessionsTypeDef(
    ...
    Properties describing a player session. Player session objects are created either by creating a
    player session for a specific game session, or as part of a game session placement. A player
    ...
    When a player disconnects, the player session status changes to ``COMPLETED`` . Once the session
    ends, the player session object is retained for 30 days and then removed.
...
class ClientCreateScriptResponseScriptStorageLocationTypeDef(
    ...
    Location in Amazon Simple Storage Service (Amazon S3) where build or script files are stored for
    access by Amazon GameLift. This location is specified in  CreateBuild ,  CreateScript , and
...
class ClientCreateScriptResponseScriptTypeDef(_ClientCreateScriptResponseScriptTypeDef):
    ...
    - **SizeOnDisk** *(integer) --*
      ...
      File size of the uploaded Realtime script, expressed in bytes. When files are uploaded from an
...
class ClientCreateVpcPeeringAuthorizationResponseVpcPeeringAuthorizationTypeDef(
    ...
    - **CreationTime** *(datetime) --*
      ...
      Time stamp indicating when this authorization was issued. Format is a number expressed in Unix
      time as milliseconds (for example "1469498468.057").
...
class ClientDescribeFleetAttributesResponseFleetAttributesCertificateConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeFleetAttributesResponseFleetAttributes`
...
class ClientDescribeFleetCapacityResponseFleetCapacityTypeDef(
    ...
    Information about the fleet's capacity. Fleet capacity is measured in EC2 instances. By default,
    new fleets have a capacity of one instance, but can be updated as needed. The maximum number of
    instances for a fleet is determined by the fleet's instance type.
...
class ClientDescribeFleetEventsResponseEventsTypeDef(
    ...
    """
    Type definition for `ClientDescribeFleetEventsResponse` `Events`
    ...
    - **EventCode** *(string) --*
      ...
      * FLEET_CREATED -- A fleet record was successfully created with a status of ``NEW`` . Event
      ...
      * FLEET_CREATION_EXTRACTING_BUILD – The game server build was successfully downloaded to an
      instance, and the build files are now being extracted from the uploaded build and saved to an
      instance. Failure at this stage prevents a fleet from moving to ``ACTIVE`` status. Logs for
      this stage display a list of the files that are extracted and saved on the instance. Access
      ...
      * FLEET_CREATION_RUNNING_INSTALLER – The game server build files were successfully extracted,
      ...
      Failure in this stage prevents a fleet from moving to ``ACTIVE`` status. Logs for this stage
      list the installation steps and whether or not the install completed successfully. Access the
      logs by using the URL in *PreSignedLogUrl* .

      * FLEET_CREATION_VALIDATING_RUNTIME_CONFIG -- The build process was successful, and the Amazon
      GameLift is now verifying that the game server launch paths, which are specified in the
      fleet's run-time configuration, exist. If any listed launch path exists, Amazon GameLift tries
      to launch a game server process and waits for the process to report ready. Failures in this
      stage prevent a fleet from moving to ``ACTIVE`` status. Logs for this stage list the launch
      paths in the run-time configuration and indicate whether each is found. Access the logs by
      using the URL in *PreSignedLogUrl* .

      * FLEET_STATE_VALIDATING -- Fleet status changed from ``DOWNLOADING`` to ``VALIDATING`` .

      * FLEET_VALIDATION_LAUNCH_PATH_NOT_FOUND -- Validation of the run-time configuration failed
      because the executable specified in a launch path does not exist on the instance.

      * FLEET_STATE_BUILDING -- Fleet status changed from ``VALIDATING`` to ``BUILDING`` .

      * FLEET_VALIDATION_EXECUTABLE_RUNTIME_FAILURE -- Validation of the run-time configuration
      failed because the executable specified in a launch path failed to run on the fleet instance.

      * FLEET_STATE_ACTIVATING -- Fleet status changed from ``BUILDING`` to ``ACTIVATING`` .

      * FLEET_ACTIVATION_FAILED - The fleet failed to successfully complete one of the steps in the
      fleet activation process. This event code indicates that the game build was successfully
      downloaded to a fleet instance, built, and validated, but was not able to start a server
      process. A possible reason for failure is that the game server is not reporting "process
      ...
      * FLEET_VPC_PEERING_SUCCEEDED -- A VPC peering connection has been established between the VPC
      for an Amazon GameLift fleet and a VPC in your AWS account.

      * FLEET_VPC_PEERING_FAILED -- A requested VPC peering connection has failed. Event details and
      status information (see  DescribeVpcPeeringConnections ) provide additional detail. A common
      reason for peering failure is that the two VPCs have overlapping CIDR blocks of IPv4
      addresses. To resolve this, change the CIDR block for the VPC in your AWS account. For more
      ...
      * FLEET_NEW_GAME_SESSION_PROTECTION_POLICY_UPDATED -- A change was made to the fleet's game
      session protection policy setting. Event messaging includes both the old and new policy
      setting.
    ...
    - **PreSignedLogUrl** *(string) --*
      ...
      Location of stored logs with additional detail that is related to the event. This is useful
      for debugging issues. The URL is valid for 15 minutes. You can also access fleet creation logs
...
class ClientDescribeFleetEventsResponseTypeDef(_ClientDescribeFleetEventsResponseTypeDef):
    """
    Type definition for `ClientDescribeFleetEvents` `Response`
...
class ClientDescribeFleetUtilizationResponseFleetUtilizationTypeDef(
    ...
    * Manage fleet actions:
    ...
    - **ActiveServerProcessCount** *(integer) --*
      ...
      Number of server processes in an ``ACTIVE`` status currently running across all instances in
      the fleet
    ...
    - **MaximumPlayerSessionCount** *(integer) --*
      ...
      Maximum players allowed across all game sessions currently being hosted on all instances in
      the fleet.
    """
...
class ClientDescribeGameSessionDetailsResponseGameSessionDetailsGameSessionGamePropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeGameSessionDetailsResponseGameSessionDetailsGameSession`
    `GameProperties`
...
class ClientDescribeGameSessionPlacementResponseGameSessionPlacementGamePropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeGameSessionPlacementResponseGameSessionPlacement`
    `GameProperties`
...
class ClientDescribeGameSessionPlacementResponseGameSessionPlacementPlacedPlayerSessionsTypeDef(
    ...
    request. This object contains only the player ID and player session ID. To retrieve full details
    on a player session, call  DescribePlayerSessions with the player session ID.
...
class ClientDescribeGameSessionPlacementResponseGameSessionPlacementTypeDef(
    ...
    - **GameSessionArn** *(string) --*
      ...
      Identifier for the game session created by this placement request. This value is set once the
      new game session is placed (placement status is ``FULFILLED`` ). This identifier is unique
      across all regions. You can use this value as a ``GameSessionId`` value as needed.
    ...
    - **StartTime** *(datetime) --*
      ...
      Time stamp indicating when this request was placed in the queue. Format is a number expressed
      in Unix time as milliseconds (for example "1469498468.057").
    ...
    - **IpAddress** *(string) --*
      ...
      IP address of the game session. To connect to a Amazon GameLift game server, an app needs both
      the IP address and port number. This value is set once the new game session is placed
      (placement status is ``FULFILLED`` ).
    ...
    - **PlacedPlayerSessions** *(list) --*
      ...
      the placement request) and the corresponding player session ID. Retrieve full player sessions
      by calling  DescribePlayerSessions with the player session ID.

      - *(dict) --*

        Information about a player session that was created as part of a  StartGameSessionPlacement
        request. This object contains only the player ID and player session ID. To retrieve full
        details on a player session, call  DescribePlayerSessions with the player session ID.
...
class ClientDescribeGameSessionQueuesResponseGameSessionQueuesPlayerLatencyPoliciesTypeDef(
    ...
    """
    Type definition for `ClientDescribeGameSessionQueuesResponseGameSessionQueues`
    `PlayerLatencyPolicies`
...
class ClientDescribeGameSessionsResponseGameSessionsTypeDef(
    ...
    Once the session ends, the game session object is retained for 30 days. This means you can reuse
    idempotency token values after this time. Game session logs are retained for 14 days.
...
class ClientDescribeInstancesResponseInstancesTypeDef(
    ...
    Properties that describe an instance of a virtual computing resource that hosts one or more game
    servers. A fleet may contain zero or more instances.
    ...
    - **Status** *(string) --*
      ...
      * **ACTIVE** -- The instance has been successfully created and at least one server process has
      successfully launched and reported back to Amazon GameLift that it is ready to host a game
      ...
      * **TERMINATING** -- The instance is in the process of shutting down. This may happen to
      reduce capacity during a scaling down event or to recycle resources in the event of a problem.
...
class ClientDescribeMatchmakingConfigurationsResponseConfigurationsGamePropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeMatchmakingConfigurationsResponseConfigurations`
    `GameProperties`
...
class ClientDescribeMatchmakingResponseTicketListGameSessionConnectionInfoMatchedPlayerSessionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeMatchmakingResponseTicketListGameSessionConnectionInfo`
...
class ClientDescribeMatchmakingResponseTicketListGameSessionConnectionInfoTypeDef(
    ...
    - **MatchedPlayerSessions** *(list) --*
      ...
      - *(dict) --*
        ...
        A successful match automatically creates new player sessions for every player ID in the
...
class ClientDescribeMatchmakingResponseTicketListPlayersPlayerAttributesTypeDef(
    ...
    - **SL** *(list) --*
      ...
      For a list of up to 10 strings. Maximum length for each string is 100 characters. Duplicate
      values are not recognized; all occurrences of the repeated value after the first of a repeated
      value are ignored.
...
class ClientDescribeMatchmakingResponseTicketListTypeDef(
    ...
    StartMatchmaking . Tickets can be retrieved by calling  DescribeMatchmaking with the ticket ID.
    ...
    - **Status** *(string) --*
      ...
      * **COMPLETED** -- Players have been matched and a game session is ready to host the players.
      A ticket in this state contains the necessary connection information for players.
      ...
      * **TIMED_OUT** -- The matchmaking request was not successful within the duration specified in
    ...
    - **StartTime** *(datetime) --*
      ...
      Time stamp indicating when this matchmaking request was received. Format is a number expressed
      in Unix time as milliseconds (for example "1469498468.057").
        ...
        - **PlayerAttributes** *(dict) --*
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              data map. Each ``AttributeValue`` object can use only one of the available properties.
    ...
    - **GameSessionConnectionInfo** *(dict) --*
      ...
      - **MatchedPlayerSessions** *(list) --*
        ...
        - *(dict) --*
          ...
          match. A successful match automatically creates new player sessions for every player ID in
...
class ClientDescribeMatchmakingRuleSetsResponseRuleSetsTypeDef(
    ...
    player matches. Rule sets are used in  MatchmakingConfiguration objects.

    A rule set may define the following elements for a match. For detailed information and examples
    showing how to construct a rule set, see `Build a FlexMatch Rule Set
    <https://docs.aws.amazon.com/gamelift/latest/developerguide/match-rulesets.html>`__ .

    * Teams -- Required. A rule set must define one or multiple teams for the match and set minimum
    and maximum team sizes. For example, a rule set might describe a 4x4 match that requires all
    eight slots to be filled.
    ...
    * Rules -- Optional. Rules define how to evaluate potential players for a match based on player
    attributes. A rule might specify minimum requirements for individual players, teams, or entire
    matches. For example, a rule might require each player to meet a certain skill level, each team
    to have at least one player in a certain role, or the match to have a minimum average skill
    level. or may describe an entire group--such as all teams must be evenly matched or have at
    least one player in a certain role.

    * Expansions -- Optional. Expansions allow you to relax the rules after a period of time when no
    acceptable matches are found. This feature lets you balance getting players into games in a
    reasonable amount of time instead of making them wait indefinitely for the best possible match.
    For example, you might use an expansion to increase the maximum skill variance between players
    after 30 seconds.
...
class ClientDescribeRuntimeConfigurationResponseRuntimeConfigurationServerProcessesTypeDef(
    ...
    """
    Type definition for `ClientDescribeRuntimeConfigurationResponseRuntimeConfiguration`
    `ServerProcesses`
...
class ClientDescribeRuntimeConfigurationResponseRuntimeConfigurationTypeDef(
    ...
    Instructions describing how server processes should be launched and maintained on each instance
    in the fleet.
...
class ClientDescribeScalingPoliciesResponseScalingPoliciesTypeDef(
    ...
    * Manage fleet actions:
    ...
    - **PolicyType** *(string) --*
      ...
      'PercentAvailableGameSessions' and specify a *TargetConfiguration* . For a rule-based policy
...
class ClientDescribeVpcPeeringAuthorizationsResponseVpcPeeringAuthorizationsTypeDef(
    ...
    fleet and another VPC on an account you have access to. This authorization must exist and be
    valid for the peering connection to be established. Authorizations are valid for 24 hours after
    they are issued.
...
class ClientDescribeVpcPeeringConnectionsResponseVpcPeeringConnectionsStatusTypeDef(
    ...
    Object that contains status information about the connection. Status indicates if a connection
...
class ClientDescribeVpcPeeringConnectionsResponseVpcPeeringConnectionsTypeDef(
    ...
    *  DeleteVpcPeeringConnection
    ...
    - **IpV4CidrBlock** *(string) --*
      ...
      CIDR block of IPv4 addresses assigned to the VPC peering connection for the GameLift VPC. The
      peered VPC also has an IPv4 CIDR block associated with it; these blocks cannot overlap or the
      peering connection cannot be created.
...
class ClientGetInstanceAccessResponseInstanceAccessCredentialsTypeDef(
    ...
    - **Secret** *(string) --*
      ...
      Desktop. For Linux instances, it is a private key (which must be saved as a ``.pem`` file) for
      use with SSH.
    """
...
class ClientRequestUploadCredentialsResponseUploadCredentialsTypeDef(
    ...
    AWS credentials required when uploading a game build to the storage location. These credentials
...
class ClientStartGameSessionPlacementResponseGameSessionPlacementGamePropertiesTypeDef(
    ...
    """
    Type definition for `ClientStartGameSessionPlacementResponseGameSessionPlacement`
    `GameProperties`
...
class ClientStartMatchBackfillResponseMatchmakingTicketGameSessionConnectionInfoMatchedPlayerSessionsTypeDef(
    ...
    """
    Type definition for `ClientStartMatchBackfillResponseMatchmakingTicketGameSessionConnectionInfo`
    `MatchedPlayerSessions`
...
class ClientStartMatchBackfillResponseMatchmakingTicketGameSessionConnectionInfoTypeDef(
    ...
    """
    Type definition for `ClientStartMatchBackfillResponseMatchmakingTicket`
...
class ClientStartMatchBackfillResponseMatchmakingTicketPlayersPlayerAttributesTypeDef(
    ...
    """
    Type definition for `ClientStartMatchBackfillResponseMatchmakingTicketPlayers`
    `PlayerAttributes`
...
class ClientStartMatchmakingResponseMatchmakingTicketGameSessionConnectionInfoMatchedPlayerSessionsTypeDef(
    ...
    """
    Type definition for `ClientStartMatchmakingResponseMatchmakingTicketGameSessionConnectionInfo`
    `MatchedPlayerSessions`
...
class ClientStartMatchmakingResponseMatchmakingTicketGameSessionConnectionInfoTypeDef(
    ...
    """
    Type definition for `ClientStartMatchmakingResponseMatchmakingTicket`
    `GameSessionConnectionInfo`
...
class ClientStopGameSessionPlacementResponseGameSessionPlacementGamePropertiesTypeDef(
    ...
    """
    Type definition for `ClientStopGameSessionPlacementResponseGameSessionPlacement`
    `GameProperties`
...
class ClientStopGameSessionPlacementResponseGameSessionPlacementTypeDef(
    ...
    Object that describes the canceled game session placement, with ``CANCELLED`` status and an end
    time stamp.
...
class ClientUpdateGameSessionQueueResponseGameSessionQueuePlayerLatencyPoliciesTypeDef(
    ...
    """
    Type definition for `ClientUpdateGameSessionQueueResponseGameSessionQueue`
    `PlayerLatencyPolicies`
...
_ClientUpdateMatchmakingConfigurationGamePropertiesTypeDef = TypedDict(
    "_ClientUpdateMatchmakingConfigurationGamePropertiesTypeDef", {"Key": str, "Value": str}
)
...
class ClientUpdateRuntimeConfigurationResponseRuntimeConfigurationServerProcessesTypeDef(
    ...
    """
    Type definition for `ClientUpdateRuntimeConfigurationResponseRuntimeConfiguration`
    `ServerProcesses`
...
class ClientUpdateRuntimeConfigurationResponseRuntimeConfigurationTypeDef(
    ...
    The run-time configuration currently in force. If the update was successful, this object matches
...
class DescribeFleetAttributesPaginateResponseFleetAttributesCertificateConfigurationTypeDef(
    ...
    """
    Type definition for `DescribeFleetAttributesPaginateResponseFleetAttributes`
    `CertificateConfiguration`
...
class DescribeFleetEventsPaginateResponseEventsTypeDef(
    ...
    """
    Type definition for `DescribeFleetEventsPaginateResponse` `Events`
...
class DescribeFleetEventsPaginateResponseTypeDef(_DescribeFleetEventsPaginateResponseTypeDef):
    """
    Type definition for `DescribeFleetEventsPaginate` `Response`
...
class DescribeGameSessionDetailsPaginateResponseGameSessionDetailsGameSessionGamePropertiesTypeDef(
    ...
    """
    Type definition for `DescribeGameSessionDetailsPaginateResponseGameSessionDetailsGameSession`
    `GameProperties`
...
class DescribeGameSessionQueuesPaginateResponseGameSessionQueuesPlayerLatencyPoliciesTypeDef(
    ...
    """
    Type definition for `DescribeGameSessionQueuesPaginateResponseGameSessionQueues`
    `PlayerLatencyPolicies`
...
class DescribeMatchmakingConfigurationsPaginateResponseConfigurationsGamePropertiesTypeDef(
    ...
    """
    Type definition for `DescribeMatchmakingConfigurationsPaginateResponseConfigurations`
    `GameProperties`
...
class DescribeScalingPoliciesPaginateResponseScalingPoliciesTargetConfigurationTypeDef(
    ...
    """
    Type definition for `DescribeScalingPoliciesPaginateResponseScalingPolicies`
    `TargetConfiguration`
