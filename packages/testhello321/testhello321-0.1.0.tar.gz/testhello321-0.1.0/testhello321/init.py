...
def init_jupyter(*, store_bundle_in_notebook=False):
    ...
    if store_bundle_in_notebook:
        print('Initialized testhello321 for Jupyter notebooks and stored bundle in notebook.')
    else:
        clear_output()
        print('Initialized testhello321 for Jupyter notebooks.')
...
def init_colab(*, store_bundle_in_notebook=False):
    if store_bundle_in_notebook:
        print('Initialized testhello321 for Colab notebooks and storing bundle in notebook.')
    else:
        print('Initialized testhello321 for Colab notebooks.')
