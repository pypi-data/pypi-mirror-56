...
The new code supports multiple corrections per band.""")
  ...
  def MakeButtons(self, frame, gbs):
    ...
    if conf.button_layout == 'Large screen':
      ...
      #   #wx.TOP | wx.BOTTOM, border=self.freqDisplay.border)
      #   #flag=wx.EXPAND | wx.TOP | wx.BOTTOM | wx.LEFT | wx.RIGHT, border=self.freqDisplay.border)
