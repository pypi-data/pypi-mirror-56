...
route53resolver = require("@aws-cdk/aws-route53resolver")
```
"""
import abc
import datetime
...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-route53resolver", "1.17.1", __name__, "aws-route53resolver@1.17.1.jsii.tgz")
