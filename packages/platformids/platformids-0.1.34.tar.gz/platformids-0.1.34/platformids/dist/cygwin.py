...
RTE_CYGWIN        = RTE_CYGWINNT + 0x00010000     #: Cygwin running within PWEMU on WindowsNT
RTE_CYGWIN1       = RTE_CYGWINNT + 0x00020000     #: Cygwin-2.* - contains the major version number
RTE_CYGWIN2       = RTE_CYGWINNT + 0x00040000     #: Cygwin-2.* - contains the major version number
RTE_CYGWIN3       = RTE_CYGWINNT + 0x00080000     #: Cygwin-3.* - contains the major version number
