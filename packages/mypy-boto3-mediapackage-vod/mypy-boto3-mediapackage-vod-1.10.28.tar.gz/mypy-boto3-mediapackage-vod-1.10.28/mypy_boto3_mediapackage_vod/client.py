...
class Client(BaseClient):
          ...
          **Response Structure**
          ...
          - *(dict) --* The new MediaPackage VOD Asset resource.
            ...
            - **EgressEndpoints** *(list) --* The list of egress endpoints available for the Asset.
              ...
              - *(dict) --* The endpoint URL used to access an Asset using one
              PackagingConfiguration.

                - **PackagingConfigurationId** *(string) --* The ID of the PackagingConfiguration
          ...
          - *(dict) --* A collection of MediaPackage VOD Asset resources.
            ...
            - **Assets** *(list) --* A list of MediaPackage VOD Asset resources.
              ...
              - *(dict) --* A MediaPackage VOD Asset resource.
                ...
                - **SourceRoleArn** *(string) --* The IAM role ARN used to access the source S3
                bucket.
    ...
    def list_packaging_configurations(
        ...
        **Request Syntax**
        ...
        :type PackagingGroupId: string
        :param PackagingGroupId: Returns MediaPackage VOD PackagingConfigurations associated with
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* A collection of MediaPackage VOD PackagingConfiguration resources.
            ...
            - **PackagingConfigurations** *(list) --* A list of MediaPackage VOD
            PackagingConfiguration resources.
              ...
              - *(dict) --* A MediaPackage VOD PackagingConfiguration resource.
                ...
                - **CmafPackage** *(dict) --* A CMAF packaging configuration.
                  ...
                  - **HlsManifests** *(list) --* A list of HLS manifest configurations.
                    ...
                    - *(dict) --* An HTTP Live Streaming (HLS) manifest configuration.
                      ...
                      - **ManifestName** *(string) --* An optional string to include in the name of
                      the manifest.
                      ...
                      - **StreamSelection** *(dict) --* A StreamSelection configuration.
                        ...
                        - **MaxVideoBitsPerSecond** *(integer) --* The maximum video bitrate (bps)
                        to include in output.

                        - **MinVideoBitsPerSecond** *(integer) --* The minimum video bitrate (bps)
                        to include in output.

                        - **StreamOrder** *(string) --* A directive that determines the order of
                ...
                - **MssPackage** *(dict) --* A Microsoft Smooth Streaming (MSS)
                PackagingConfiguration.
