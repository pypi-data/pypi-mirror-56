...
class JsbsimCatalog(Property, Enum):
    ...
    fcs_throttle_pos_norm = Property('fcs/throttle-pos-norm', 'throttle position, normalised', 0, 1, update=update_equal_throttle_pos)
    ...
    fcs_throttle_cmd_norm = Property('fcs/throttle-cmd-norm', 'throttle commanded position, normalised', 0., 0.9, update=update_equal_throttle_cmd)
    fcs_mixture_cmd_norm = Property('fcs/mixture-cmd-norm', 'engine mixture setting, normalised', 0., 1., update=update_equal_mixture_cmd)
    ...
    fcs_center_brake_cmd_norm = Property('fcs/center-brake-cmd-norm', 'normalised', 0., 1., update=update_equal_brake_cmd)
