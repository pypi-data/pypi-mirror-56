...
if platform.system()=='Linux':
    ...
    rdirs = ['@loader_path/../../../../lib', '@loader_path/../../../lib', '@loader_path/../../lib', '/usr/local/lib', '@loader_path']
    linkerdirs = ['-std=c++11', '-Wl,-rpath,'+'@loader_path/', '-Wl,-rpath,'+'@loader_path/../../../../lib', '-Wl,-rpath,'+'@loader_path/../../../lib', '-Wl,-rpath,'+'@loader_path/../../lib', '-Wl,-rpath,'+'/usr/local/lib']
else:
