...
confkcw['version']='2.1.7'							#项目版本
confkcw['description']='增加sqlite、mongodb和mysql动态切换'    #项目的简单描述
...
setup(
    ...
    url=confkcw['url'],
    packages =  b,
    install_requires = ['pymongo==3.9.0','six==1.12.0','requests==2.22.0','watchdog==0.9.0','Mako==1.1.0','paramiko==2.6.0','webssh==1.4.5'], #第三方包
    package_data = {
