...
class Dataset(object):
    ...
    A Dataset is a reference to data in a :class:`azureml.core.datastore.Datastore`.
    ...
    * :class:`azureml.data.FileDataset` references single or multiple files in datastores
    ...
    You can explore data in a Dataset with summary statistics and transform it using intelligent transforms.
    When you are ready to use the data for training, you can save the Dataset to your Azure Machine Learning
    workspace as a versioned Dataset.
    ...
    .. remarks::
        ...
        * ``Dataset.File.from_files()``
        ...
        You can also create a new TabularDataset or FileDataset working directly with their corresponding
        factory methods :class:`azureml.data.dataset_factory.TabularDatasetFactory` and
        ...
        https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/work-with-data/datasets-tutorial/train-with-datasets.ipynb
    ...
    def list(workspace):
        ...
        .. note::
            ...
            This property is deprecated. Use :meth:`azureml.core.Dataset.get_all` instead.
            For more information, see https://aka.ms/dataset-deprecation.
    ...
    @staticmethod
    @deprecated('"Dataset.from_pandas_dataframe"')
    @track(_get_logger, activity_type=_PUBLIC_API)
    ...
    def from_delimited_files(
        ...
        :type encoding: :class: azureml.data.dataset_type_definitions.FileEncoding, optional
        ...
        :type skip_mode: azureml.data.dataset_type_definitions.SkipLinesBehavior, optional
    ...
    def get_profile(self, arguments=None, generate_if_not_exist=True, workspace=None, compute_target=None):
        ...
        :param workspace: Workspace, required for transient(unregistered) Datasets.
        :type workspace: azureml.core.Workspace, optional
        :param compute_target: A compute target to execute the profile action, optional.
        :type compute_target: azureml.core.compute.ComputeTarget or str, optional
    ...
    def __getitem__(self, key):
        ...
        .. note::
            ...
            This method is deprecated. Create a TabularDataset by
