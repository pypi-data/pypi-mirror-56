...
class Client(BaseClient):
    ...
    def create_broker(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/CreateBroker>`_
        ...
        **Request Syntax**
        ...
        :param AutoMinorVersionUpgrade: Required. Enables automatic upgrades to new minor versions
        ...
        :param CreatorRequestId: The unique ID that the requester receives for the created broker.
        ...
        application doesn't require idempotency.This field is autopopulated if not provided.
        ...
        :param EncryptionOptions: Encryption options for the broker.
          ...
          - **KmsKeyId** *(string) --* The customer master key (CMK) to use for the AWS Key
          Management Service (KMS). This key is used to encrypt your data at rest. If not provided,
          Amazon MQ will use a default CMK to encrypt your data.

          - **UseAwsOwnedKey** *(boolean) --* **[REQUIRED]** Enables the use of an AWS owned CMK
        ...
        :param PubliclyAccessible: Required. Enables connections from applications outside of the
        VPC that hosts the broker's subnets.

        :type SecurityGroups: list
        :param SecurityGroups: The list of security groups (1 minimum, 5 maximum) that authorize
        connections to brokers.

          - *(string) --*

        :type SubnetIds: list
        :param SubnetIds: The list of groups (2 maximum) that define which subnets and IP ranges the
        broker can use from different Availability Zones. A SINGLE_INSTANCE deployment requires one
        subnet (for example, the default subnet). An ACTIVE_STANDBY_MULTI_AZ deployment requires two
        subnets.
        ...
        :type Users: list
        :param Users: Required. The list of ActiveMQ users (persons or applications) who can access
        ...
        underscores, and tildes (- . _ ~). This value must be 2-100 characters long.
          ...
          - *(dict) --* An ActiveMQ user associated with the broker.
            ...
            - **ConsoleAccess** *(boolean) --* Enables access to the the ActiveMQ Web Console for
            the ActiveMQ user.

            - **Groups** *(list) --* The list of groups (20 maximum) to which the ActiveMQ user
            belongs. This value can contain only alphanumeric characters, dashes, periods,
            underscores, and tildes (- . _ ~). This value must be 2-100 characters long.

              - *(string) --*

            - **Password** *(string) --* Required. The password of the ActiveMQ user. This value
            must be at least 12 characters long, must contain at least 4 unique characters, and must
            not contain commas.
    ...
    def create_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/CreateConfiguration>`_
        ...
        **Request Syntax**
        ...
        alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). This value must
    ...
    def create_tags(self, ResourceArn: str, Tags: List[str] = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/CreateTags>`_
    ...
    def create_user(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/CreateUser>`_
        ...
        **Request Syntax**
        ...
        :param Username: **[REQUIRED]** The username of the ActiveMQ user. This value can contain
        only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~). This value
    ...
    def delete_broker(self, BrokerId: str) -> ClientDeleteBrokerResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DeleteBroker>`_
        ...
        **Request Syntax**
        ...
        :type BrokerId: string
        :param BrokerId: **[REQUIRED]** The name of the broker. This value must be unique in your
    ...
    def delete_tags(self, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DeleteTags>`_
    ...
    def delete_user(self, BrokerId: str, Username: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DeleteUser>`_
    ...
    def describe_broker(self, BrokerId: str) -> ClientDescribeBrokerResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DescribeBroker>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **AutoMinorVersionUpgrade** *(boolean) --* Required. Enables automatic upgrades to new
            minor versions for brokers, as Apache releases the versions. The automatic upgrades
            ...
            - **Configurations** *(dict) --* The list of all revisions for the specified
            configuration.
            ...
            - **EncryptionOptions** *(dict) --* Encryption options for the broker.
              ...
              - **KmsKeyId** *(string) --* The customer master key (CMK) to use for the AWS Key
              Management Service (KMS). This key is used to encrypt your data at rest. If not
            ...
            - **EngineType** *(string) --* Required. The type of broker engine. Note: Currently,
            Amazon MQ supports only ACTIVEMQ.

            - **EngineVersion** *(string) --* The version of the broker engine. For a list of
            supported engine versions, see
            https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/broker-engine.html

            - **HostInstanceType** *(string) --* The broker's instance type.

            - **Logs** *(dict) --* The list of information about logs currently enabled and pending
            to be deployed for the specified broker.

              - **Audit** *(boolean) --* Enables audit logging. Every user management action made
              using JMX or the ActiveMQ Web Console is logged.

              - **AuditLogGroup** *(string) --* The location of the CloudWatch Logs log group where
              audit logs are sent.

              - **General** *(boolean) --* Enables general logging.

              - **GeneralLogGroup** *(string) --* The location of the CloudWatch Logs log group
              where general logs are sent.

              - **Pending** *(dict) --* The list of information about logs pending to be deployed
            ...
            - **MaintenanceWindowStartTime** *(dict) --* The parameters that determine the
            WeeklyStartTime.
            ...
            - **PendingHostInstanceType** *(string) --* The host instance type of the broker to
            upgrade to. For a list of supported instance types, see
            https://docs.aws.amazon.com/amazon-mq/latest/developer-guide//broker.html#broker-instance-types

            - **PubliclyAccessible** *(boolean) --* Required. Enables connections from applications
            ...
            - **SubnetIds** *(list) --* The list of groups (2 maximum) that define which subnets and
            IP ranges the broker can use from different Availability Zones. A SINGLE_INSTANCE
            ...
            - **Users** *(list) --* The list of all ActiveMQ usernames for the specified broker.
              ...
              - *(dict) --* Returns a list of all ActiveMQ users.
                ...
                - **Username** *(string) --* Required. The username of the ActiveMQ user. This value
    ...
    def describe_broker_engine_types(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DescribeBrokerEngineTypes>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults: The maximum number of engine types that Amazon MQ can return per page (20
        by default). This value must be an integer from 5 to 100.

        :type NextToken: string
        :param NextToken: The token that specifies the next page of results Amazon MQ should return.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **NextToken** *(string) --* The token that specifies the next page of results Amazon
    ...
    def describe_broker_instance_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DescribeBrokerInstanceOptions>`_
        ...
        **Request Syntax**
        ...
        :type MaxResults: integer
        :param MaxResults: The maximum number of instance options that Amazon MQ can return per page
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **MaxResults** *(integer) --* Required. The maximum number of instance options that
    ...
    def describe_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DescribeConfiguration>`_
        ...
        **Request Syntax**
        ...
        :param ConfigurationId: **[REQUIRED]** The unique ID that Amazon MQ generates for the
        configuration.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **EngineVersion** *(string) --* Required. The version of the broker engine. For a list
            of supported engine versions, see
            https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/broker-engine.html
    ...
    def describe_configuration_revision(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DescribeConfigurationRevision>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **ConfigurationId** *(string) --* Required. The unique ID that Amazon MQ generates for
            the configuration.
    ...
    def describe_user(self, BrokerId: str, Username: str) -> ClientDescribeUserResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/DescribeUser>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **BrokerId** *(string) --* Required. The unique ID that Amazon MQ generates for the
            broker.
            ...
            - **Pending** *(dict) --* The status of the changes pending for the ActiveMQ user.
              ...
              - **PendingChange** *(string) --* Required. The type of change pending for the
              ActiveMQ user.
    ...
    def list_brokers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/ListBrokers>`_
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **BrokerSummaries** *(list) --* A list of information about all brokers.
              ...
              - *(dict) --* The Amazon Resource Name (ARN) of the broker.
                ...
                - **BrokerName** *(string) --* The name of the broker. This value must be unique in
                your AWS account, 1-50 characters long, must contain only letters, numbers, dashes,
                and underscores, and must not contain whitespaces, brackets, wildcard characters, or
                special characters.
    ...
    def list_configuration_revisions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/ListConfigurationRevisions>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **MaxResults** *(integer) --* The maximum number of configuration revisions that can
    ...
    def list_configurations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/ListConfigurations>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **Configurations** *(list) --* The list of all revisions for the specified
            configuration.
              ...
              - *(dict) --* Returns information about all configurations.
                ...
                - **EngineVersion** *(string) --* Required. The version of the broker engine. For a
                ...
                - **Name** *(string) --* Required. The name of the configuration. This value can
            ...
            - **MaxResults** *(integer) --* The maximum number of configurations that Amazon MQ can
            return per page (20 by default). This value must be an integer from 5 to 100.
    ...
    def list_tags(self, ResourceArn: str) -> ClientListTagsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/ListTags>`_
    ...
    def list_users(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/ListUsers>`_
        ...
        **Request Syntax**
        ...
        :type MaxResults: integer
        :param MaxResults: The maximum number of ActiveMQ users that can be returned per page (20 by
        default). This value must be an integer from 5 to 100.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **MaxResults** *(integer) --* Required. The maximum number of ActiveMQ users that can
            be returned per page (20 by default). This value must be an integer from 5 to 100.

            - **NextToken** *(string) --* The token that specifies the next page of results Amazon
            MQ should return. To request the first page, leave nextToken empty.

            - **Users** *(list) --* Required. The list of all ActiveMQ usernames for the specified
            broker.
    ...
    def reboot_broker(self, BrokerId: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/RebootBroker>`_
    ...
    def update_broker(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/UpdateBroker>`_
        ...
        **Request Syntax**
        ...
        :type AutoMinorVersionUpgrade: boolean
        :param AutoMinorVersionUpgrade: Enables automatic upgrades to new minor versions for
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            - **AutoMinorVersionUpgrade** *(boolean) --* The new value of automatic upgrades to new
            minor version for brokers.
            ...
            - **EngineVersion** *(string) --* The version of the broker engine to upgrade to. For a
            list of supported engine versions, see
            https://docs.aws.amazon.com/amazon-mq/latest/developer-guide/broker-engine.html

            - **HostInstanceType** *(string) --* The host instance type of the broker to upgrade to.
            For a list of supported instance types, see
            https://docs.aws.amazon.com/amazon-mq/latest/developer-guide//broker.html#broker-instance-types

            - **Logs** *(dict) --* The list of information about logs to be enabled for the
            specified broker.
    ...
    def update_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/UpdateConfiguration>`_
                ...
                'Warnings': [
                    {
                        ...
                        'ElementName': 'string',
                        'Reason':
                        'DISALLOWED_ELEMENT_REMOVED'|'DISALLOWED_ATTRIBUTE_REMOVED'
          ...
          **Response Structure**
          ...
          - *(dict) --* HTTP Status Code 200: OK.
            ...
            elements or attributes that were sanitized.
              ...
              - *(dict) --* Returns information about the XML element or attribute that was
              sanitized in the configuration.

                - **AttributeName** *(string) --* The name of the XML attribute that has been
                sanitized.
    ...
    def update_user(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mq-2017-11-27/UpdateUser>`_
        ...
        **Request Syntax**
        ...
        :type Username: string
        :param Username: **[REQUIRED]** Required. The username of the ActiveMQ user. This value can
        contain only alphanumeric characters, dashes, periods, underscores, and tildes (- . _ ~).
        This value must be 2-100 characters long.
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_brokers` operation.
        """
