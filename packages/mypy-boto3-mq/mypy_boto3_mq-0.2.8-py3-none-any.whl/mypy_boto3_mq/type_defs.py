...
class ClientCreateBrokerUsersTypeDef(_ClientCreateBrokerUsersTypeDef):
    """
    Type definition for `ClientCreateBroker` `Users`
...
class ClientDescribeBrokerInstanceOptionsResponseBrokerInstanceOptionsAvailabilityZonesTypeDef(
    ...
    """
    Type definition for `ClientDescribeBrokerInstanceOptionsResponseBrokerInstanceOptions`
    `AvailabilityZones`
...
class ClientDescribeBrokerResponseBrokerInstancesTypeDef(
    ...
    - **IpAddress** *(string) --* The IP address of the Elastic Network Interface (ENI) attached to
    the broker.
    """
...
class ClientDescribeBrokerResponseEncryptionOptionsTypeDef(
    ...
    - **UseAwsOwnedKey** *(boolean) --* Enables the use of an AWS owned CMK using AWS Key Management
    Service (KMS).
    """
...
class ClientDescribeBrokerResponseLogsPendingTypeDef(
    ...
    """
    Type definition for `ClientDescribeBrokerResponseLogs` `Pending`
...
class ClientDescribeBrokerResponseLogsTypeDef(_ClientDescribeBrokerResponseLogsTypeDef):
    """
    Type definition for `ClientDescribeBrokerResponse` `Logs`

    - **Audit** *(boolean) --* Enables audit logging. Every user management action made using JMX or
    the ActiveMQ Web Console is logged.

    - **AuditLogGroup** *(string) --* The location of the CloudWatch Logs log group where audit logs
    are sent.

    - **General** *(boolean) --* Enables general logging.

    - **GeneralLogGroup** *(string) --* The location of the CloudWatch Logs log group where general
    logs are sent.
...
_ClientDescribeUserResponsePendingTypeDef = TypedDict(
    ...
    {"ConsoleAccess": bool, "Groups": List[str], "PendingChange": str},
    total=False,
)
...
_ClientListUsersResponseUsersTypeDef = TypedDict(
    "_ClientListUsersResponseUsersTypeDef", {"PendingChange": str, "Username": str}, total=False
)
...
class ClientUpdateBrokerResponseLogsTypeDef(_ClientUpdateBrokerResponseLogsTypeDef):
    """
    Type definition for `ClientUpdateBrokerResponse` `Logs`
...
_ClientUpdateConfigurationResponseWarningsTypeDef = TypedDict(
    ...
    {"AttributeName": str, "ElementName": str, "Reason": str},
    total=False,
)
...
class ClientUpdateConfigurationResponseWarningsTypeDef(
    ...
    """
    Type definition for `ClientUpdateConfigurationResponse` `Warnings`
    ...
    - **Reason** *(string) --* Required. The reason for which the XML elements or attributes were
    sanitized.
    """
