...
class ClientPublishMessageAttributesTypeDef(
    _RequiredClientPublishMessageAttributesTypeDef, _OptionalClientPublishMessageAttributesTypeDef
):
    """
    ...
    - **StringValue** *(string) --*
      ...
      Characters <https://en.wikipedia.org/wiki/ASCII#ASCII_printable_characters>`__ .
...
class TopicPublishMessageAttributesTypeDef(
    _RequiredTopicPublishMessageAttributesTypeDef, _OptionalTopicPublishMessageAttributesTypeDef
):
    """
