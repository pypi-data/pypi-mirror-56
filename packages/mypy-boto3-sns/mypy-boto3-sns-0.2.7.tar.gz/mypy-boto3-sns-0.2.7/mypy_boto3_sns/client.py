...
class Client(BaseClient):
    ...
    def create_platform_application(
        ...
        APNS and FCM, to which devices and mobile apps may register. You must specify PlatformPrincipal and
        PlatformCredential attributes when using the ``CreatePlatformApplication`` action. The
        PlatformPrincipal is received from the notification service. For APNS/APNS_SANDBOX,
        PlatformPrincipal is "SSL certificate". For FCM, PlatformPrincipal is not applicable. For ADM,
        PlatformPrincipal is "client id". The PlatformCredential is also received from the notification
        service. For WNS, PlatformPrincipal is "Package Security Identifier". For MPNS, PlatformPrincipal is
        "TLS certificate". For Baidu, PlatformPrincipal is "API key".

        For APNS/APNS_SANDBOX, PlatformCredential is "private key". For FCM, PlatformCredential is "API
        key". For ADM, PlatformCredential is "client secret". For WNS, PlatformCredential is "secret key".
        For MPNS, PlatformCredential is "private key". For Baidu, PlatformCredential is "secret key". The
        PlatformApplicationArn that is returned when using ``CreatePlatformApplication`` is then used as an
    ...
    def create_platform_endpoint(
        ...
        such as FCM and APNS. ``CreatePlatformEndpoint`` requires the PlatformApplicationArn that is
        returned from ``CreatePlatformApplication`` . The EndpointArn that is returned when using
        ``CreatePlatformEndpoint`` can then be used by the ``Publish`` action to send a message to a mobile
        app or by the ``Subscribe`` action for subscription to a topic. The ``CreatePlatformEndpoint``
        action is idempotent, so if the requester already owns an endpoint with the same device token and
        attributes, that endpoint's ARN is returned without creating a new endpoint. For more information,
        ...
        **Request Syntax**
        ...
        :param Token: **[REQUIRED]**
          ...
          using APNS as the notification service, you need the device token. Alternatively, when using FCM
    ...
    def create_topic(
        ...
        action is idempotent, so if the requester already owns a topic with the specified name, that topic's
        ...
        **Request Syntax**
        ...
        :param Attributes:
          ...
          * ``KmsMasterKeyId`` - The ID of an AWS-managed customer master key (CMK) for Amazon SNS or a
          ...
          <https://docs.aws.amazon.com/sns/latest/dg/sns-server-side-encryption.html#sse-key-terms>`__ . For
          more examples, see `KeyId
    ...
    def delete_endpoint(self, EndpointArn: str) -> None:
        ...
        When you delete an endpoint that is also subscribed to a topic, then you must also unsubscribe the
    ...
    def delete_platform_application(self, PlatformApplicationArn: str) -> None:
        ...
        APNS and FCM. For more information, see `Using Amazon SNS Mobile Push Notifications
        <https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html>`__ .
    ...
    def get_endpoint_attributes(
        ...
        such as FCM and APNS. For more information, see `Using Amazon SNS Mobile Push Notifications
        <https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html>`__ .
          ...
          - *(dict) --*
            ...
            - **Attributes** *(dict) --*
              ...
              * ``RedrivePolicy`` – When specified, sends undeliverable messages to the specified Amazon SQS
              ...
              the subscribed endpoint is unreachable) or server errors (for example, when the service that
              powers the subscribed endpoint becomes unavailable) are held in the dead-letter queue for
    ...
    def list_endpoints_by_platform_application(
        ...
        such as FCM and APNS. The results for ``ListEndpointsByPlatformApplication`` are paginated and
        return a limited list of endpoints, up to 100. If additional records are available after the first
        page results, then a NextToken string will be returned. To receive the next page, you call
        ``ListEndpointsByPlatformApplication`` again using the NextToken string received from the previous
        call. When there are no more records to return, NextToken will be null. For more information, see
    ...
    def list_platform_applications(
        ...
        and FCM. The results for ``ListPlatformApplications`` are paginated and return a limited list of
        applications, up to 100. If additional records are available after the first page results, then a
    ...
    def list_subscriptions_by_topic(
        ...
        ``NextToken`` parameter in a new ``ListSubscriptionsByTopic`` call to get further results.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              Token to pass along to the next ``ListSubscriptionsByTopic`` request. This element is returned
    ...
    def list_tags_for_resource(
        ...
        <https://docs.aws.amazon.com/sns/latest/dg/sns-tags.html>`__ in the *Amazon Simple Notification
    ...
    def list_topics(self, NextToken: str = None) -> ClientListTopicsResponseTypeDef:
        ...
        there are more topics, a ``NextToken`` is also returned. Use the ``NextToken`` parameter in a new
    ...
    def publish(
        ...
        """
        Sends a message to an Amazon SNS topic or sends a text message (SMS message) directly to a phone
        number.
        ...
        When a ``messageId`` is returned, the message has been saved and Amazon SNS will attempt to deliver
        it shortly.
        ...
        **Request Syntax**
        ...
        :param Message: **[REQUIRED]**
          ...
          transport protocol, set the value of the ``MessageStructure`` parameter to ``json`` and use a JSON
          ...
          * For SMS, each message can contain up to 140 characters. This character limit depends on the
          encoding schema. For example, an SMS message can contain 160 GSM characters, 140 ASCII characters,
          or 70 UCS-2 characters. If you publish a message that exceeds this size limit, Amazon SNS sends
          the message as multiple messages, each fitting within the size limit. Messages aren't truncated
        ...
        :param MessageStructure:
          ...
          For example, using one publish action, you can send a short message to your SMS subscribers and a
          longer message to your email subscribers. If you set ``MessageStructure`` to ``json`` , the value
          of the ``Message`` parameter must:
        ...
        :param MessageAttributes:
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              same restrictions on the content as the message body. For more information, see `Publish
        ...
        **Request Syntax**
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * ``Enabled`` – flag that enables/disables delivery to the endpoint. Amazon SNS will set this to
          false when a notification service indicates to Amazon SNS that the endpoint is invalid. Users can
    ...
    def set_platform_application_attributes(
        ...
        <https://docs.aws.amazon.com/sns/latest/dg/SNSMobilePush.html>`__ . For information on configuring
        attributes for message delivery status, see `Using Amazon SNS Application Attributes for Message
        Delivery Status <https://docs.aws.amazon.com/sns/latest/dg/sns-msg-status.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * ``PlatformCredential`` – The credential received from the notification service. For
          APNS/APNS_SANDBOX, PlatformCredential is private key. For FCM, PlatformCredential is "API key".
    ...
    def set_sms_attributes(self, attributes: Dict[str, str]) -> Dict:
        ...
        with the ``MessageAttributes.entry.N`` parameter. For more information, see `Sending an SMS Message
        <https://docs.aws.amazon.com/sns/latest/dg/sms_publish-to-phone.html>`__ in the *Amazon SNS
        Developer Guide* .
        ...
        **Request Syntax**
        ...
        :param attributes: **[REQUIRED]**
          ...
          The default settings for sending SMS messages from your account. You can set values for the
          following attribute names:

           ``MonthlySpendLimit`` – The maximum amount in USD that you are willing to spend each month to
          ...
          .. warning::
            ...
            interval, if you continue to send SMS messages, you will incur costs that exceed your limit.

          By default, the spend limit is set to the maximum allowed by Amazon SNS. If you want to raise the
          limit, submit an `SNS Limit Increase case
          <https://console.aws.amazon.com/support/home#/case/create?issueType=
              service-limit-increase&limitType=service-code-sns>`__ . For **New limit value** , enter your
              desired monthly spend limit. In the **Use Case Description** field, explain that you are
              requesting an SMS monthly spend limit increase.

           ``DeliveryStatusIAMRole`` – The ARN of the IAM role that allows Amazon SNS to write logs about
           SMS deliveries in CloudWatch Logs. For each SMS message that you send, Amazon SNS writes a log
           that includes the message price, the success or failure status, the reason for failure (if the
           ...
           Amazon SNS will write logs in CloudWatch Logs. The value can be an integer from 0 - 100. For
           example, to write logs only for failed deliveries, set this value to ``0`` . To write logs for
           10% of your successful deliveries, set it to ``10`` .

           ``DefaultSenderID`` – A string, such as your business brand, that is displayed as the sender on
           the receiving device. Support for sender IDs varies by country. The sender ID can be 1 - 11
           alphanumeric characters, and it must contain at least one letter.

           ``DefaultSMSType`` – The type of SMS message that you will send by default. You can assign the
           following values:
          ...
          * ``Transactional`` – Critical messages that support customer transactions, such as one-time
          ...
          the highest reliability.
           ...
           ``UsageReportS3Bucket`` – The name of the Amazon S3 bucket to receive daily SMS usage reports
           from Amazon SNS. Each day, Amazon SNS will deliver a usage report as a CSV file to the bucket.
           The report includes the following information for each SMS message that was successfully
          ...
          * Total number of parts
          ...
          To receive the report, the bucket must have a policy that allows the Amazon SNS service principle
          to perform the ``s3:PutObject`` and ``s3:GetBucketLocation`` actions.

          For an example bucket policy and usage report, see `Monitoring SMS Activity
          <https://docs.aws.amazon.com/sns/latest/dg/sms_stats.html>`__ in the *Amazon SNS Developer Guide*
          .
        ...
        **Request Syntax**
        ...
        :param AttributeName: **[REQUIRED]**
          ...
          * ``RawMessageDelivery`` – When set to ``true`` , enables raw message delivery to Amazon SQS or
          HTTP/S endpoints. This eliminates the need for the endpoints to process JSON formatting, which is
    ...
    def subscribe(
        ...
        """
        Prepares to subscribe an endpoint by sending the endpoint a confirmation message. To actually create
        a subscription, the endpoint owner must call the ``ConfirmSubscription`` action with the token from
        ...
        **Request Syntax**
        ...
        :param ReturnSubscriptionArn:
          ...
          * If you have the subscription ARN returned, the response includes the ARN in all cases, even if
          the subscription is not yet confirmed.

          * If you don't have the subscription ARN returned, in addition to the ARN for confirmed
          subscriptions, the response also includes the ``pending subscription`` ARN value for subscriptions
          that aren't yet confirmed. A subscription becomes confirmed when the subscriber calls the
    ...
    def tag_resource(
        ...
        <https://docs.aws.amazon.com/sns/latest/dg/sns-tags.html>`__ in the *Amazon SNS Developer Guide* .
    ...
    def unsubscribe(self, SubscriptionArn: str) -> None:
        ...
        the subscription or the topic's owner can unsubscribe, and an AWS signature is required. If the
        ``Unsubscribe`` call does not require authentication and the requester is not the subscription
        owner, a final cancellation message is delivered to the endpoint, so that the endpoint owner can
        easily resubscribe to the topic if the ``Unsubscribe`` request was unintended.
