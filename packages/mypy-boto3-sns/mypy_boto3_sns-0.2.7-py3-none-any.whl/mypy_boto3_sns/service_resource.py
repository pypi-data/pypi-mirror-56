"Main interface for sns ServiceResource"
...
class PlatformApplication(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        PlatformApplication resource. Note that the load and reload methods are the same method and can be
...
class PlatformEndpoint(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`SNS.Client.get_endpoint_attributes` to update the attributes of the PlatformEndpoint
    ...
    def publish(
        ...
        MessageAttributes: Dict[
            str, PlatformEndpointPublishMessageAttributesTypeDef
        ] = None,
    ) -> PlatformEndpointPublishResponseTypeDef:
        """
...
class Subscription(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`SNS.Client.get_subscription_attributes` to update the attributes of the Subscription
        resource. Note that the load and reload methods are the same method and can be used interchangeably.
...
class ServiceResourcePlatformApplicationsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all PlatformApplication resources in the collection filtered by kwargs passed
        to method.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.PlatformApplication]:
        """
        Creates an iterable of all PlatformApplication resources in the collection, but limits the number of
...
class PlatformApplicationEndpointsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all PlatformEndpoint resources in the collection filtered by kwargs passed to
        method.
