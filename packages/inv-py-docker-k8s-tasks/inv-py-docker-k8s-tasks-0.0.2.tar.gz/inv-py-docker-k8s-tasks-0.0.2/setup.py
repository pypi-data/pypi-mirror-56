...
setup(
    ...
    url='https://github.com/gnarvaja/inv-py-docker-k8s-tasks',  # Optional
    ...
    keywords='invoke Kubernetes k8s docker DevOps',  # Optional
    ...
    install_requires=['invoke', 'requests'],  # Optional
