...
class ClientCreateEndpointRedshiftSettingsTypeDef(
    ...
    - **DateFormat** *(string) --*
      ...
      string enclosed in quotes, or NULL. If this parameter is left unset (NULL), it defaults to a
      format of 'YYYY-MM-DD'. Using ``auto`` recognizes most strings, even some that aren't supported
    ...
    - **EncryptionMode** *(string) --*
      ...
      Access Management (IAM) role with a policy that allows ``"arn:aws:s3:::*"`` to use the following
    ...
    - **MaxFileSize** *(integer) --*
      ...
      The maximum size (in KB) of any .csv file used to transfer data to Amazon Redshift. This accepts
      a value from 1 through 1,048,576. It defaults to 32,768 KB (32 MB).
    ...
    - **TrimBlanks** *(boolean) --*
      ...
      parameter applies only to columns with a VARCHAR data type. Choose ``true`` to remove unneeded
...
class ClientCreateEndpointS3SettingsTypeDef(_ClientCreateEndpointS3SettingsTypeDef):
    ...
    - **ServerSideEncryptionKmsKeyId** *(string) --*
      ...
      that you use needs an attached policy that enables AWS Identity and Access Management (IAM) user
    ...
    - **DictPageSizeLimit** *(integer) --*
      ...
      this column is stored using an encoding type of ``PLAIN`` . This parameter defaults to 1024 *
      1024 bytes (1 MiB), the maximum size of a dictionary page before it reverts to ``PLAIN``
    ...
    - **CdcInsertsOnly** *(boolean) --*
      ...
      columnar storage (.parquet) output files. By default (the ``false`` setting), the first field in
      a .csv or .parquet record contains the letter I (INSERT), U (UPDATE), or D (DELETE). These
      ...
      without a first field to indicate the INSERT operation at the source. For more information about
      how these settings work together, see `Indicating Source DB Operations in Migrated S3 Data
      <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.Configuring.InsertOps>`__
      in the *AWS Database Migration Service User Guide.* .
...
class ClientCreateReplicationTaskResponseTypeDef(
    _ClientCreateReplicationTaskResponseTypeDef
):
    """
...
class ClientDeleteReplicationTaskResponseTypeDef(
    _ClientDeleteReplicationTaskResponseTypeDef
):
    """
...
class ClientDescribeReplicationTasksResponseReplicationTasksReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationTasksResponseReplicationTasks` `ReplicationTaskStats`
...
class ClientDescribeReplicationTasksResponseTypeDef(
    _ClientDescribeReplicationTasksResponseTypeDef
):
    """
...
class ClientModifyReplicationTaskResponseTypeDef(
    _ClientModifyReplicationTaskResponseTypeDef
):
    """
...
class ClientStartReplicationTaskAssessmentResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientStartReplicationTaskAssessmentResponseReplicationTask` `ReplicationTaskStats`
...
class ClientStartReplicationTaskResponseTypeDef(
    _ClientStartReplicationTaskResponseTypeDef
):
    """
...
class ClientStopReplicationTaskResponseTypeDef(
    _ClientStopReplicationTaskResponseTypeDef
):
    """
...
class DescribeReplicationTasksPaginateResponseReplicationTasksReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `DescribeReplicationTasksPaginateResponseReplicationTasks` `ReplicationTaskStats`
