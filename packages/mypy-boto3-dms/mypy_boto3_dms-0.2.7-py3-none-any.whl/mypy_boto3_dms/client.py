...
class Client(BaseClient):
    ...
    def apply_pending_maintenance_action(
        ...
        **Request Syntax**
        ...
        :param ReplicationInstanceArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the AWS DMS resource that the pending maintenance action applies
          to.
    ...
    def create_endpoint(
        ...
        **Request Syntax**
        ...
        :param ExtraConnectionAttributes:
          ...
          target endpoint, see `Working with AWS DMS Endpoints
    ...
    def create_event_subscription(
        ...
        AWS DMS source IDs (``SourceIds`` ) that triggers the events, and provide a list of event categories
        (``EventCategories`` ) for events you want to be notified of. If you specify both the ``SourceType``
        and ``SourceIds`` , such as ``SourceType = replication-instance`` and ``SourceIdentifier =
        my-replinstance`` , you will be notified of all the replication instance events for the specified
        source. If you specify a ``SourceType`` but don't specify a ``SourceIdentifier`` , you receive
        notice of the events for that source type for all your AWS DMS sources. If you don't specify either
        ``SourceType`` nor ``SourceIdentifier`` , you will be notified of events generated from all AWS DMS
        ...
        **Request Syntax**
        ...
        :param SourceType:
          ...
          events generated by a replication instance, you set this parameter to ``replication-instance`` .
    ...
    def create_replication_instance(
        ...
        create a replication instance. For information on the required roles, see `Creating the IAM Roles to
        Use With the AWS CLI and AWS DMS API
    ...
    def describe_account_attributes(
        ...
        allowed. The description for each resource quota, includes the quota name, current usage toward that
        quota, and the quota's maximum value. DMS uses the unique account identifier to name each artifact
        used by DMS in the given region.
    ...
    def describe_table_statistics(
        ...
        updated the table statistics record for a table. It does not indicate the time of the last update to
        the table.
    ...
    def modify_replication_instance(
        ...
        **Request Syntax**
        ...
        :param PreferredMaintenanceWindow:
          ...
          outage. Changing this parameter does not result in an outage, except in the following situation,
          and the change is asynchronously applied as soon as possible. If moving this window to the current
          time, there must be at least 30 minutes between the current time and end of the window to ensure
        ...
        :param AutoMinorVersionUpgrade:
          ...
          following case and the change is asynchronously applied as soon as possible. An outage will result
          if this parameter is set to ``true`` during the maintenance window, and a newer minor version is
    ...
    def modify_replication_task(
        ...
        <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Tasks.html>`__ in the *AWS Database Migration
        Service User Guide* .
