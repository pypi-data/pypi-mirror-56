...
class ReplicationInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`DatabaseMigrationService.Client.describe_replication_instances` every 60
        seconds until a successful state is reached. An error is returned after 60 failed checks.
...
class ReplicationInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`DatabaseMigrationService.Client.describe_replication_instances` every 15
        seconds until a successful state is reached. An error is returned after 60 failed checks.
...
class ReplicationTaskDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`DatabaseMigrationService.Client.describe_replication_tasks` every 15 seconds
...
class TestConnectionSucceedsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`DatabaseMigrationService.Client.describe_connections` every 5 seconds until
