...
class Client(BaseClient):
        ...
        :param Tags: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Value** *(string) --*
              ...
              Unicode characters in length and cannot be prefixed with "aws:" or "dms:". The string
          ...
          - *(dict) --*
            ...
            - **ResourcePendingMaintenanceActions** *(dict) --*
              ...
              - **ResourceIdentifier** *(string) --*
                ...
                <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Introduction.AWS.ARN.html>`__
    ...
    def create_endpoint(
        ...
        **Request Syntax**
        ...
        :param ExtraConnectionAttributes:
          ...
          for connecting your source or target endpoint, see `Working with AWS DMS Endpoints
          <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Endpoints.html>`__ in the *AWS
        ...
        :param DynamoDbSettings:
          ...
          about the available settings, see `Using Object Mapping to Migrate Data to DynamoDB
          <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.DynamoDB.html>`__ in the
        ...
        :param S3Settings:
          ...
          available settings, see `Extra Connection Attributes When Using Amazon S3 as a Target for
          AWS DMS
        ...
        :param MongoDbSettings:
          ...
          available settings, see the configuration properties section in `Using MongoDB as a Target
        ...
        :param ElasticsearchSettings:
          ...
          Settings in JSON format for the target Elasticsearch endpoint. For more information about
          the available settings, see `Extra Connection Attributes When Using Elasticsearch as a
          Target for AWS DMS
            ...
            - **Endpoint** *(dict) --*
              ...
              - **S3Settings** *(dict) --*
                ...
                - **EncryptionMode** *(string) --*
                  ...
                  (IAM) role with permission to allow ``"arn:aws:s3:::dms-*"`` to use the following
                  actions:
                ...
                - **ServerSideEncryptionKmsKeyId** *(string) --*
                  ...
                  ID. The key that you use needs an attached policy that enables AWS Identity and
                ...
                - **DictPageSizeLimit** *(integer) --*
                  ...
                  parameter defaults to 1024 * 1024 bytes (1 MiB), the maximum size of a dictionary
                  page before it reverts to ``PLAIN`` encoding. This size is used for .parquet file
                  format only.

                - **RowGroupLength** *(integer) --*

                  The number of rows in a row group. A smaller row group size provides faster reads.
                  But as the number of row groups grows, the slower writes become. This parameter
                  defaults to 10,000 rows. This number is used for .parquet file format only.
                ...
                - **EnableStatistics** *(boolean) --*
                  ...
                  to enable statistics, ``false`` to disable. Statistics include ``NULL`` ,
                  ``DISTINCT`` , ``MAX`` , and ``MIN`` values. This parameter defaults to ``true`` .
                ...
                - **IncludeOpForFullLoad** *(boolean) --*
                  ...
                  to ``true`` or ``y`` , the INSERT is recorded as an I annotation in the first
                  ...
                  .. note::
                    ...
                    This setting works together with the ``CdcInsertsOnly`` parameter for output to
                    .csv files only. For more information about how these settings work together,
                    see `Indicating Source DB Operations in Migrated S3 Data
                    <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.Configuring.InsertOps>`__
                    in the *AWS Database Migration Service User Guide.* .
                ...
                - **CdcInsertsOnly** *(boolean) --*
                  ...
                  row was inserted, updated, or deleted at the source database for a CDC load to the
                  target.
                  ...
                  ``IncludeOpForFullLoad`` is set to ``true`` , the first field of every CDC record
                  is set to I to indicate the INSERT operation at the source. If
                  ``IncludeOpForFullLoad`` is set to ``false`` , every CDC record is written without
                  a first field to indicate the INSERT operation at the source. For more information
                ...
                - **ParquetTimestampInMillisecond** *(boolean) --*
                  ...
                  that are .parquet formatted only if you plan to query or process the data with
                  Athena or AWS Glue.
                  ...
                  .. note::
                    ...
                    Setting ``ParquetTimestampInMillisecond`` has no effect on the string format of
              ...
              - **RedshiftSettings** *(dict) --*
                ...
                - **MaxFileSize** *(integer) --*
                  ...
                  Redshift. This accepts a value from 1 through 1,048,576. It defaults to 32,768 KB
                  (32 MB).
                ...
                - **TimeFormat** *(string) --*
                  ...
                  to 10. Using ``auto`` recognizes most strings, even some that aren't supported
    ...
    def create_event_subscription(
        ...
        list of AWS DMS source IDs (``SourceIds`` ) that triggers the events, and provide a list of
        event categories (``EventCategories`` ) for events you want to be notified of. If you
        specify both the ``SourceType`` and ``SourceIds`` , such as ``SourceType =
        replication-instance`` and ``SourceIdentifier = my-replinstance`` , you will be notified of
        all the replication instance events for the specified source. If you specify a
        ``SourceType`` but don't specify a ``SourceIdentifier`` , you receive notice of the events
        for that source type for all your AWS DMS sources. If you don't specify either
        ``SourceType`` nor ``SourceIdentifier`` , you will be notified of events generated from all
        ...
        **Request Syntax**
        ...
        :param SnsTopicArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the Amazon SNS topic created for event notification. The
        ...
        :param SourceType:
          ...
          ``replication-instance`` . If this value is not specified, all events are returned.
        ...
        :param EventCategories:
          ...
          information, see `Working with Events and Notifications
          <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html>`__ in the *AWS
          Database Migration Service User Guide.*
    ...
    def create_replication_instance(
        ...
        AWS DMS requires that your account have certain roles with appropriate permissions before
        you can create a replication instance. For information on the required roles, see `Creating
        the IAM Roles to Use With the AWS CLI and AWS DMS API
        <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Security.APIRole.html>`__ . For
        ...
        **Request Syntax**
        ...
        :param CdcStartPosition:
          ...
          .. note::
            ...
            this by setting the ``slotName`` extra connection attribute to the name of this logical
            replication slot. For more information, see `Extra Connection Attributes When Using
    ...
    def describe_account_attributes(
        ...
        """
        Lists all of the AWS DMS attributes for a customer account. These attributes include AWS DMS
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UniqueAccountIdentifier** *(string) --*
              ...
              this identifier has the following format: ``c99999999999`` . DMS uses this identifier
              to name artifacts. For example, DMS uses this identifier to name the default Amazon S3
              bucket for storing task assessment reports in a given AWS Region. The format of this
              S3 bucket name is the following: ``dms-*AccountNumber* -*UniqueAccountIdentifier* .``
              Here is an example name for this default S3 bucket: ``dms-111122223333-c44445555666``
              .

              .. note::

                AWS DMS supports the ``UniqueAccountIdentifier`` parameter in versions 3.1.4 and
                later.
    ...
    def describe_event_categories(
        ...
        Notifications <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html>`__ in the
        *AWS Database Migration Service User Guide.*
    ...
    def describe_event_subscriptions(
        ...
        includes ``SubscriptionName`` , ``SNSTopicARN`` , ``CustomerID`` , ``SourceType`` ,
    ...
    def describe_events(
        ...
        end time. For more information on AWS DMS events, see `Working with Events and Notifications
        <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Events.html>`__ in the *AWS Database
    ...
    def modify_endpoint(
        ...
        **Request Syntax**
        ...
        :param EngineName:
          ...
          mysql, oracle, postgres, mariadb, aurora, aurora-postgresql, redshift, s3, db2, azuredb,
        ...
        :param ServiceAccessRoleArn:
          ...
          The Amazon Resource Name (ARN) for the service access role you want to use to modify the
          endpoint.
        ...
        :param DmsTransferSettings:
          ...
          * compressionType - An optional parameter to use GZIP to compress the target files. Set to
    ...
    def modify_replication_instance(
        ...
        **Request Syntax**
        ...
        :param AllowMajorVersionUpgrade:
          ...
          Indicates that major version upgrades are allowed. Changing this parameter does not result
        ...
        :param AutoMinorVersionUpgrade:
          ...
          possible. An outage will result if this parameter is set to ``true`` during the
    ...
    def modify_replication_task(
        ...
        **Request Syntax**
        ...
        :param TableMappings:
          ...
          mappings. Precede the path with ``file://`` . When working with the DMS API, provide the
          JSON as the parameter value, for example: ``--table-mappings file://mappingfile.json``
    ...
    def reboot_replication_instance(
        ...
        **Request Syntax**
        ...
        :param ForceFailover:
          ...
          the instance isn't configured for Multi-AZ, then you can't specify ``true`` .)
    ...
    def remove_tags_from_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          An AWS DMS resource from which you want to remove tag(s). The value for this parameter is
