...
class ClientAddTagsToResourceTagsTypeDef(_ClientAddTagsToResourceTagsTypeDef):
    ...
    - **Key** *(string) --*
      ...
      characters in length and cannot be prefixed with "aws:" or "dms:". The string can only contain
...
class ClientApplyPendingMaintenanceActionResponseResourcePendingMaintenanceActionsPendingMaintenanceActionDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientApplyPendingMaintenanceActionResponseResourcePendingMaintenanceActions`
    ...
    - **AutoAppliedAfterDate** *(datetime) --*
      ...
      The date of the maintenance window when the action will be applied. The maintenance action
      will be applied to the resource during its first maintenance window after this date. If this
      date is specified, any ``next-maintenance`` opt-in requests are ignored.

    - **ForcedApplyDate** *(datetime) --*

      The date when the maintenance action will be automatically applied. The maintenance action
      will be applied to the resource on this date regardless of the maintenance window for the
    ...
    - **CurrentApplyDate** *(datetime) --*
      ...
      The effective date when the pending maintenance action will be applied to the resource. This
...
class ClientApplyPendingMaintenanceActionResponseResourcePendingMaintenanceActionsTypeDef(
    ...
    """
    Type definition for `ClientApplyPendingMaintenanceActionResponse`
    ...
    - **ResourceIdentifier** *(string) --*
      ...
      The Amazon Resource Name (ARN) of the DMS resource that the pending maintenance action applies
      to. For information about creating an ARN, see `Constructing an Amazon Resource Name (ARN) for
      AWS DMS <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Introduction.AWS.ARN.html>`__
    ...
    - **PendingMaintenanceActionDetails** *(list) --*
      ...
      - *(dict) --*
        ...
        - **AutoAppliedAfterDate** *(datetime) --*
          ...
          The date of the maintenance window when the action will be applied. The maintenance action
          will be applied to the resource during its first maintenance window after this date. If
        ...
        - **CurrentApplyDate** *(datetime) --*
          ...
          ``ForcedApplyDate`` . This value is blank if an opt-in request has not been received and
          nothing has been specified as ``AutoAppliedAfterDate`` or ``ForcedApplyDate`` .
      ...
      - **PendingMaintenanceActionDetails** *(list) --*
        ...
        - *(dict) --*
          ...
          - **ForcedApplyDate** *(datetime) --*
            ...
            for the resource. If this date is specified, any ``immediate`` opt-in requests are
            ignored.
...
class ClientCreateEndpointRedshiftSettingsTypeDef(_ClientCreateEndpointRedshiftSettingsTypeDef):
    ...
    - **EncryptionMode** *(string) --*
      ...
      part of the endpoint settings or the extra connections attributes for Amazon S3. You can
      choose either ``SSE_S3`` (the default) or ``SSE_KMS`` . To use ``SSE_S3`` , create an AWS
      Identity and Access Management (IAM) role with a policy that allows ``"arn:aws:s3:::*"`` to
      use the following actions: ``"s3:PutObject", "s3:ListBucket"``
    ...
    - **RemoveQuotes** *(boolean) --*
      ...
      data. All characters within the quotation marks, including delimiters, are retained. Choose
    ...
    - **TruncateColumns** *(boolean) --*
      ...
      that the data fits in the column. This parameter applies only to columns with a VARCHAR or
      CHAR data type, and rows with a size of 4 MB or less. Choose ``true`` to truncate data. The
      default is ``false`` .
...
class ClientCreateEndpointResponseEndpointS3SettingsTypeDef(
    ...
    - **BucketFolder** *(string) --*
      ...
      An optional parameter to set a folder name in the S3 bucket. If provided, tables are created
      in the path `` *bucketFolder* /*schema_name* /*table_name* /`` . If this parameter is not
    ...
    - **EncryptionMode** *(string) --*
      ...
      The type of server-side encryption that you want to use for your data. This encryption type is
      part of the endpoint settings or the extra connections attributes for Amazon S3. You can
      choose either ``SSE_S3`` (the default) or ``SSE_KMS`` . To use ``SSE_S3`` , you need an AWS
    ...
    - **DictPageSizeLimit** *(integer) --*
      ...
      1024 * 1024 bytes (1 MiB), the maximum size of a dictionary page before it reverts to
      ``PLAIN`` encoding. This size is used for .parquet file format only.
    ...
    - **ParquetTimestampInMillisecond** *(boolean) --*
      ...
      values. Set this parameter to ``true`` for S3 endpoint object files that are .parquet
...
class ClientCreateEndpointResponseEndpointTypeDef(_ClientCreateEndpointResponseEndpointTypeDef):
    ...
    - **EndpointIdentifier** *(string) --*
      ...
      ASCII letters, digits, and hyphens; and must not end with a hyphen or contain two consecutive
      hyphens.
    ...
    - **EngineName** *(string) --*
      ...
      postgres, mariadb, aurora, aurora-postgresql, redshift, s3, db2, azuredb, sybase, dynamodb,
    ...
    - **ExternalId** *(string) --*
      ...
      Value returned by a call to CreateEndpoint that can be used for cross-account validation. Use
      it on a subsequent call to CreateEndpoint to create the endpoint with a cross-account.
    ...
    - **S3Settings** *(dict) --*
      ...
      - **CompressionType** *(string) --*
        ...
        An optional parameter to use GZIP to compress the target files. Set to GZIP to compress the
        target files. Set to NONE (the default) or do not use to leave the files uncompressed.
        Applies to both .csv and .parquet file formats.

      - **EncryptionMode** *(string) --*

        The type of server-side encryption that you want to use for your data. This encryption type
        is part of the endpoint settings or the extra connections attributes for Amazon S3. You can
        choose either ``SSE_S3`` (the default) or ``SSE_KMS`` . To use ``SSE_S3`` , you need an AWS
      ...
      - **RowGroupLength** *(integer) --*
        ...
        the number of row groups grows, the slower writes become. This parameter defaults to 10,000
      ...
      - **IncludeOpForFullLoad** *(boolean) --*
        ...
        For full load, records can only be inserted. By default (the ``false`` setting), no
        information is recorded in these output files for a full load to indicate that the rows were
        inserted at the source database. If ``IncludeOpForFullLoad`` is set to ``true`` or ``y`` ,
        the INSERT is recorded as an I annotation in the first field of the .csv file. This allows
        the format of your target records from a full load to be consistent with the target records
        from a CDC load.

        .. note::

          This setting works together with the ``CdcInsertsOnly`` parameter for output to .csv files
          only. For more information about how these settings work together, see `Indicating Source
          DB Operations in Migrated S3 Data
          <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.Configuring.InsertOps>`__
          in the *AWS Database Migration Service User Guide.* .
      ...
      - **CdcInsertsOnly** *(boolean) --*
        ...
        recorded depends on the value of ``IncludeOpForFullLoad`` . If ``IncludeOpForFullLoad`` is
        set to ``true`` , the first field of every CDC record is set to I to indicate the INSERT
        operation at the source. If ``IncludeOpForFullLoad`` is set to ``false`` , every CDC record
        is written without a first field to indicate the INSERT operation at the source. For more
      ...
      - **ParquetTimestampInMillisecond** *(boolean) --*
        ...
        .parquet formatted only if you plan to query or process the data with Athena or AWS Glue.
    ...
    - **RedshiftSettings** *(dict) --*
      ...
      - **AcceptAnyDate** *(boolean) --*
        ...
        A value that indicates to allow any date format, including invalid formats such as 00/00/00
        00:00:00, to be loaded without generating an error. You can choose ``true`` or ``false``
        (the default).
      ...
      - **AfterConnectScript** *(string) --*
        ...
        Code to run after connecting. This parameter should contain the code itself, not the name of
        a file containing the code.

      - **BucketFolder** *(string) --*

        The location where the comma-separated value (.csv) files are stored before being uploaded
        to the S3 bucket.
      ...
      - **DateFormat** *(string) --*
        ...
        defaults to a format of 'YYYY-MM-DD'. Using ``auto`` recognizes most strings, even some that
      ...
      - **ServerSideEncryptionKmsKeyId** *(string) --*
        ...
        The AWS KMS key ID. If you are using ``SSE_KMS`` for the ``EncryptionMode`` , provide this
        key ID. The key that you use needs an attached policy that enables IAM user permissions and
      ...
      - **TimeFormat** *(string) --*
        ...
        Using ``auto`` recognizes most strings, even some that aren't supported when you use a time
        format string.
      ...
      - **TruncateColumns** *(boolean) --*
        ...
        so that the data fits in the column. This parameter applies only to columns with a VARCHAR
        or CHAR data type, and rows with a size of 4 MB or less. Choose ``true`` to truncate data.
    ...
    - **Endpoint** *(dict) --*
      ...
      - **S3Settings** *(dict) --*
        ...
        - **BucketFolder** *(string) --*
          ...
          created in the path `` *bucketFolder* /*schema_name* /*table_name* /`` . If this parameter
        ...
        - **DictPageSizeLimit** *(integer) --*
          ...
          The maximum size of an encoded dictionary page of a column. If the dictionary page exceeds
          this, this column is stored using an encoding type of ``PLAIN`` . This parameter defaults
          to 1024 * 1024 bytes (1 MiB), the maximum size of a dictionary page before it reverts to
          ``PLAIN`` encoding. This size is used for .parquet file format only.
        ...
        - **EnableStatistics** *(boolean) --*
          ...
          ``MAX`` , and ``MIN`` values. This parameter defaults to ``true`` . This value is used for
        ...
        - **IncludeOpForFullLoad** *(boolean) --*
          ...
          .. note::
            ...
            files only. For more information about how these settings work together, see `Indicating
        ...
        - **CdcInsertsOnly** *(boolean) --*
          ...
          record is written without a first field to indicate the INSERT operation at the source.
          For more information about how these settings work together, see `Indicating Source DB
          Operations in Migrated S3 Data
          <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.Configuring.InsertOps>`__
          in the *AWS Database Migration Service User Guide.* .
      ...
      - **RedshiftSettings** *(dict) --*
        ...
        - **EncryptionMode** *(string) --*
          ...
          The type of server-side encryption that you want to use for your data. This encryption
          type is part of the endpoint settings or the extra connections attributes for Amazon S3.
          You can choose either ``SSE_S3`` (the default) or ``SSE_KMS`` . To use ``SSE_S3`` , create
          an AWS Identity and Access Management (IAM) role with a policy that allows
        ...
        - **ServerSideEncryptionKmsKeyId** *(string) --*
          ...
          The AWS KMS key ID. If you are using ``SSE_KMS`` for the ``EncryptionMode`` , provide this
          key ID. The key that you use needs an attached policy that enables IAM user permissions
...
class ClientCreateEventSubscriptionResponseEventSubscriptionTypeDef(
    ...
    - **Status** *(string) --*
      ...
      The status "no-permission" indicates that AWS DMS no longer has permission to post to the SNS
...
class ClientCreateReplicationInstanceResponseReplicationInstancePendingModifiedValuesTypeDef(
    ...
    """
    Type definition for `ClientCreateReplicationInstanceResponseReplicationInstance`
...
class ClientCreateReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `ClientCreateReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnets`
...
class ClientCreateReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsTypeDef(
    ...
    """
    Type definition for
    `ClientCreateReplicationInstanceResponseReplicationInstanceReplicationSubnetGroup` `Subnets`
...
class ClientCreateReplicationSubnetGroupResponseReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientCreateReplicationSubnetGroupResponseReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientCreateReplicationTaskResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientCreateReplicationTaskResponseReplicationTask` `ReplicationTaskStats`
...
class ClientCreateReplicationTaskResponseReplicationTaskTypeDef(
    ...
    """
    Type definition for `ClientCreateReplicationTaskResponse` `ReplicationTask`
    ...
    - **RecoveryCheckpoint** *(string) --*
      ...
      Indicates the last checkpoint that occurred during a change data capture (CDC) operation. You
      can provide this value to the ``CdcStartPosition`` parameter to start a CDC operation that
...
class ClientCreateReplicationTaskResponseTypeDef(_ClientCreateReplicationTaskResponseTypeDef):
    """
    Type definition for `ClientCreateReplicationTask` `Response`
...
class ClientDeleteCertificateResponseCertificateTypeDef(
    ...
    - **CertificateIdentifier** *(string) --*
      ...
      contain only ASCII letters, digits, and hyphens; and must not end with a hyphen or contain two
      consecutive hyphens.
...
class ClientDeleteConnectionResponseConnectionTypeDef(
    ...
    - **EndpointIdentifier** *(string) --*
      ...
      The identifier of the endpoint. Identifiers must begin with a letter; must contain only ASCII
      letters, digits, and hyphens; and must not end with a hyphen or contain two consecutive
      hyphens.
...
class ClientDeleteReplicationInstanceResponseReplicationInstancePendingModifiedValuesTypeDef(
    ...
    """
    Type definition for `ClientDeleteReplicationInstanceResponseReplicationInstance`
    `PendingModifiedValues`
...
class ClientDeleteReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `ClientDeleteReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientDeleteReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsTypeDef(
    ...
    """
    Type definition for
    `ClientDeleteReplicationInstanceResponseReplicationInstanceReplicationSubnetGroup` `Subnets`
...
class ClientDeleteReplicationTaskResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientDeleteReplicationTaskResponseReplicationTask` `ReplicationTaskStats`
...
class ClientDeleteReplicationTaskResponseReplicationTaskTypeDef(
    ...
    """
    Type definition for `ClientDeleteReplicationTaskResponse` `ReplicationTask`
...
class ClientDeleteReplicationTaskResponseTypeDef(_ClientDeleteReplicationTaskResponseTypeDef):
    """
    Type definition for `ClientDeleteReplicationTask` `Response`
...
class ClientDescribeEndpointTypesFiltersTypeDef(_ClientDescribeEndpointTypesFiltersTypeDef):
    """
...
_ClientDescribeEndpointTypesResponseSupportedEndpointTypesTypeDef = TypedDict(
    ...
    {"EngineName": str, "SupportsCDC": bool, "EndpointType": str, "EngineDisplayName": str},
    total=False,
)
      ...
      - *(dict) --*
        ...
        - **S3Settings** *(dict) --*
          ...
          - **ServerSideEncryptionKmsKeyId** *(string) --*
            ...
            Here is a CLI example: ``aws dms create-endpoint --endpoint-identifier *value*
            --endpoint-type target --engine-name s3 --s3-settings ServiceAccessRoleArn=
                *value*
            ,BucketFolder=*value* ,BucketName=*value*
            ,EncryptionMode=SSE_KMS,ServerSideEncryptionKmsKeyId=*value* ``
          ...
          - **CdcInsertsOnly** *(boolean) --*
            ...
            A value that enables a change data capture (CDC) load to write only INSERT operations to
            .csv or columnar storage (.parquet) output files. By default (the ``false`` setting),
            the first field in a .csv or .parquet record contains the letter I (INSERT), U (UPDATE),
            or D (DELETE). These values indicate whether the row was inserted, updated, or deleted
            at the source database for a CDC load to the target.
            ...
            to I to indicate the INSERT operation at the source. If ``IncludeOpForFullLoad`` is set
            to ``false`` , every CDC record is written without a first field to indicate the INSERT
            operation at the source. For more information about how these settings work together,
            see `Indicating Source DB Operations in Migrated S3 Data
            <https://docs.aws.amazon.com/dms/latest/userguide/CHAP_Target.S3.html#CHAP_Target.S3.Configuring.InsertOps>`__
            in the *AWS Database Migration Service User Guide.* .
...
_ClientDescribeEventSubscriptionsFiltersTypeDef = TypedDict(
    "_ClientDescribeEventSubscriptionsFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribeOrderableReplicationInstancesResponseOrderableReplicationInstancesTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrderableReplicationInstancesResponse`
    ...
    - **ReleaseStatus** *(string) --*
      ...
      The value returned when the specified ``EngineVersion`` of the replication instance is in Beta
...
_ClientDescribePendingMaintenanceActionsFiltersTypeDef = TypedDict(
    "_ClientDescribePendingMaintenanceActionsFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribePendingMaintenanceActionsResponsePendingMaintenanceActionsPendingMaintenanceActionDetailsTypeDef(
    ...
    """
    Type definition for `ClientDescribePendingMaintenanceActionsResponsePendingMaintenanceActions`
    `PendingMaintenanceActionDetails`
...
class ClientDescribePendingMaintenanceActionsResponsePendingMaintenanceActionsTypeDef(
    ...
    """
    Type definition for `ClientDescribePendingMaintenanceActionsResponse`
...
class ClientDescribeReplicationInstanceTaskLogsResponseReplicationInstanceTaskLogsTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationInstanceTaskLogsResponse`
...
_ClientDescribeReplicationInstancesFiltersTypeDef = TypedDict(
    "_ClientDescribeReplicationInstancesFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribeReplicationInstancesResponseReplicationInstancesPendingModifiedValuesTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationInstancesResponseReplicationInstances`
    `PendingModifiedValues`
...
class ClientDescribeReplicationInstancesResponseReplicationInstancesReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeReplicationInstancesResponseReplicationInstancesReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientDescribeReplicationInstancesResponseReplicationInstancesReplicationSubnetGroupSubnetsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeReplicationInstancesResponseReplicationInstancesReplicationSubnetGroup` `Subnets`
...
_ClientDescribeReplicationSubnetGroupsFiltersTypeDef = TypedDict(
    "_ClientDescribeReplicationSubnetGroupsFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribeReplicationSubnetGroupsResponseReplicationSubnetGroupsSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeReplicationSubnetGroupsResponseReplicationSubnetGroupsSubnets`
    `SubnetAvailabilityZone`
...
class ClientDescribeReplicationSubnetGroupsResponseReplicationSubnetGroupsSubnetsTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationSubnetGroupsResponseReplicationSubnetGroups`
    `Subnets`
...
class ClientDescribeReplicationTaskAssessmentResultsResponseReplicationTaskAssessmentResultsTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationTaskAssessmentResultsResponse`
...
class ClientDescribeReplicationTasksFiltersTypeDef(_ClientDescribeReplicationTasksFiltersTypeDef):
    """
...
class ClientDescribeReplicationTasksResponseReplicationTasksReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationTasksResponseReplicationTasks`
...
class ClientDescribeReplicationTasksResponseReplicationTasksTypeDef(
    ...
    """
    Type definition for `ClientDescribeReplicationTasksResponse` `ReplicationTasks`
...
class ClientDescribeReplicationTasksResponseTypeDef(_ClientDescribeReplicationTasksResponseTypeDef):
    """
    Type definition for `ClientDescribeReplicationTasks` `Response`
...
class ClientDescribeTableStatisticsFiltersTypeDef(_ClientDescribeTableStatisticsFiltersTypeDef):
    """
...
class ClientDescribeTableStatisticsResponseTableStatisticsTypeDef(
    ...
    - **FullLoadCondtnlChkFailedRows** *(integer) --*
      ...
      The number of rows that failed conditional checks during the Full Load operation (valid only
      for DynamoDB as a target migrations).

    - **FullLoadErrorRows** *(integer) --*

      The number of rows that failed to load during the Full Load operation (valid only for DynamoDB
    ...
    - **ValidationState** *(string) --*
      ...
      * Table error—The table was not validated because it was in an error state and some data was
      not migrated.
...
class ClientModifyReplicationInstanceResponseReplicationInstancePendingModifiedValuesTypeDef(
    ...
    """
    Type definition for `ClientModifyReplicationInstanceResponseReplicationInstance`
    `PendingModifiedValues`
...
class ClientModifyReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `ClientModifyReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientModifyReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsTypeDef(
    ...
    """
    Type definition for
    `ClientModifyReplicationInstanceResponseReplicationInstanceReplicationSubnetGroup` `Subnets`
...
class ClientModifyReplicationSubnetGroupResponseReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientModifyReplicationSubnetGroupResponseReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientModifyReplicationTaskResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientModifyReplicationTaskResponseReplicationTask` `ReplicationTaskStats`
...
class ClientModifyReplicationTaskResponseReplicationTaskTypeDef(
    ...
    """
    Type definition for `ClientModifyReplicationTaskResponse` `ReplicationTask`
...
class ClientModifyReplicationTaskResponseTypeDef(_ClientModifyReplicationTaskResponseTypeDef):
    """
    Type definition for `ClientModifyReplicationTask` `Response`
...
class ClientRebootReplicationInstanceResponseReplicationInstancePendingModifiedValuesTypeDef(
    ...
    """
    Type definition for `ClientRebootReplicationInstanceResponseReplicationInstance`
    `PendingModifiedValues`
...
class ClientRebootReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `ClientRebootReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientRebootReplicationInstanceResponseReplicationInstanceReplicationSubnetGroupSubnetsTypeDef(
    ...
    """
    Type definition for
    `ClientRebootReplicationInstanceResponseReplicationInstanceReplicationSubnetGroup` `Subnets`
...
class ClientStartReplicationTaskAssessmentResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientStartReplicationTaskAssessmentResponseReplicationTask`
    `ReplicationTaskStats`
...
class ClientStartReplicationTaskAssessmentResponseReplicationTaskTypeDef(
    ...
    """
    Type definition for `ClientStartReplicationTaskAssessmentResponse` `ReplicationTask`
...
class ClientStartReplicationTaskAssessmentResponseTypeDef(
    ...
    """
    Type definition for `ClientStartReplicationTaskAssessment` `Response`
...
class ClientStartReplicationTaskResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientStartReplicationTaskResponseReplicationTask` `ReplicationTaskStats`
...
class ClientStartReplicationTaskResponseReplicationTaskTypeDef(
    ...
    """
    Type definition for `ClientStartReplicationTaskResponse` `ReplicationTask`
...
class ClientStartReplicationTaskResponseTypeDef(_ClientStartReplicationTaskResponseTypeDef):
    """
    Type definition for `ClientStartReplicationTask` `Response`
...
class ClientStopReplicationTaskResponseReplicationTaskReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `ClientStopReplicationTaskResponseReplicationTask` `ReplicationTaskStats`
...
class ClientStopReplicationTaskResponseReplicationTaskTypeDef(
    ...
    """
    Type definition for `ClientStopReplicationTaskResponse` `ReplicationTask`
...
class ClientStopReplicationTaskResponseTypeDef(_ClientStopReplicationTaskResponseTypeDef):
    """
    Type definition for `ClientStopReplicationTask` `Response`
...
class DescribeConnectionsPaginateFiltersTypeDef(_DescribeConnectionsPaginateFiltersTypeDef):
    """
...
class DescribeEndpointTypesPaginateFiltersTypeDef(_DescribeEndpointTypesPaginateFiltersTypeDef):
    """
...
_DescribeEventSubscriptionsPaginateFiltersTypeDef = TypedDict(
    "_DescribeEventSubscriptionsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeOrderableReplicationInstancesPaginateResponseOrderableReplicationInstancesTypeDef(
    ...
    """
    Type definition for `DescribeOrderableReplicationInstancesPaginateResponse`
    `OrderableReplicationInstances`
...
_DescribeReplicationInstancesPaginateFiltersTypeDef = TypedDict(
    "_DescribeReplicationInstancesPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeReplicationInstancesPaginateResponseReplicationInstancesPendingModifiedValuesTypeDef(
    ...
    """
    Type definition for `DescribeReplicationInstancesPaginateResponseReplicationInstances`
    `PendingModifiedValues`
...
class DescribeReplicationInstancesPaginateResponseReplicationInstancesReplicationSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `DescribeReplicationInstancesPaginateResponseReplicationInstancesReplicationSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class DescribeReplicationInstancesPaginateResponseReplicationInstancesReplicationSubnetGroupSubnetsTypeDef(
    ...
    """
    Type definition for
    `DescribeReplicationInstancesPaginateResponseReplicationInstancesReplicationSubnetGroup`
    `Subnets`
...
_DescribeReplicationSubnetGroupsPaginateFiltersTypeDef = TypedDict(
    "_DescribeReplicationSubnetGroupsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeReplicationSubnetGroupsPaginateResponseReplicationSubnetGroupsSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for
    `DescribeReplicationSubnetGroupsPaginateResponseReplicationSubnetGroupsSubnets`
    `SubnetAvailabilityZone`
...
class DescribeReplicationSubnetGroupsPaginateResponseReplicationSubnetGroupsSubnetsTypeDef(
    ...
    """
    Type definition for `DescribeReplicationSubnetGroupsPaginateResponseReplicationSubnetGroups`
    `Subnets`
...
class DescribeReplicationTaskAssessmentResultsPaginateResponseReplicationTaskAssessmentResultsTypeDef(
    ...
    """
    Type definition for `DescribeReplicationTaskAssessmentResultsPaginateResponse`
    `ReplicationTaskAssessmentResults`
...
_DescribeReplicationTasksPaginateFiltersTypeDef = TypedDict(
    "_DescribeReplicationTasksPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeReplicationTasksPaginateResponseReplicationTasksReplicationTaskStatsTypeDef(
    ...
    """
    Type definition for `DescribeReplicationTasksPaginateResponseReplicationTasks`
    `ReplicationTaskStats`
...
class DescribeReplicationTasksPaginateResponseReplicationTasksTypeDef(
    ...
    """
    Type definition for `DescribeReplicationTasksPaginateResponse` `ReplicationTasks`
...
class DescribeReplicationTasksPaginateResponseTypeDef(
    ...
    """
    Type definition for `DescribeReplicationTasksPaginate` `Response`
...
class DescribeTableStatisticsPaginateFiltersTypeDef(_DescribeTableStatisticsPaginateFiltersTypeDef):
    """
...
_ReplicationInstanceAvailableWaitFiltersTypeDef = TypedDict(
    "_ReplicationInstanceAvailableWaitFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ReplicationInstanceDeletedWaitFiltersTypeDef(_ReplicationInstanceDeletedWaitFiltersTypeDef):
    """
...
class ReplicationTaskDeletedWaitFiltersTypeDef(_ReplicationTaskDeletedWaitFiltersTypeDef):
    """
...
class ReplicationTaskRunningWaitFiltersTypeDef(_ReplicationTaskRunningWaitFiltersTypeDef):
    """
...
class ReplicationTaskStoppedWaitFiltersTypeDef(_ReplicationTaskStoppedWaitFiltersTypeDef):
    """
...
class TestConnectionSucceedsWaitFiltersTypeDef(_TestConnectionSucceedsWaitFiltersTypeDef):
    """
