...
class Client(BaseClient):
    ...
    def cancel_task_execution(self, TaskExecutionArn: str) -> Dict[str, Any]:
        ...
        of files that are transferred to the destination might be incomplete or inconsistent with the source
        files. However, if you start a new task execution on the same task and you allow the task execution
        to complete, file content on the destination is complete and consistent. This applies to other
        unexpected failures that interrupt a task execution. In all of these cases, AWS DataSync
    ...
    def create_agent(
        ...
        You can use an agent for more than one location. If a task uses multiple agents, all of them need to
        have status AVAILABLE for the task to run. If you use multiple agents for a source location, the
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            Represents a single entry in a list of AWS resource tags. ``TagListEntry`` returns an array that
            contains a list of tasks when the  ListTagsForResource operation is called.
        ...
        :param VpcEndpointId:
          ...
          see `Creating a VPC Endpoint Service Configuration
        ...
        :param SubnetArns:
          ...
          interfaces for each data transfer task. The agent that runs a task must be private. When you start
          a task that is associated with an agent created in a VPC, or one that has access to an IP address
          in a VPC, then the task is also private. In this case, DataSync creates four network interfaces
          for each task in your subnet. For a data transfer to work, the agent must be able to route to all
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AgentArn** *(string) --*
              ...
              The Amazon Resource Name (ARN) of the agent. Use the ``ListAgents`` operation to return a list
    ...
    def create_location_efs(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          empty string. This value helps you manage, filter, and search for your resources. We recommend
    ...
    def create_location_s3(
        ...
        (IAM) role that has the required permissions. You can set up the required permissions by creating an
        IAM policy that grants the required permissions and attaching the policy to the role. An example of
    ...
    def create_location_smb(
        ...
        **Request Syntax**
        ...
        :param Subdirectory: **[REQUIRED]**
          ...
          the user/password specified belongs to the user who can mount the share, and who has the
          appropriate permissions for all of the files and directories that you want DataSync to access, or
          use credentials of a member of the Backup Operators group to mount the share. Doing either enables
          the agent to access the data. For the agent to access directories, you must additionally enable
          all execute access.
    ...
    def create_task(
        ...
        When you create a task, it first enters the CREATING state. During CREATING AWS DataSync attempts to
        mount the on-premises Network File System (NFS) location. The task transitions to the AVAILABLE
        ...
        the UNAVAILABLE status. If the status of the task remains in the CREATING status for more than a few
        minutes, it means that your agent might be having trouble mounting the source NFS file system. Check
        the task's ErrorCode and ErrorDetail. Mount issues are often caused by either a misconfigured
        ...
        **Request Syntax**
        ...
        :param Options:
          ...
          occurs when you call ``StartTaskExecution`` . You can configure these options to preserve metadata
          such as user ID (UID) and group ID (GID), file permissions, data integrity verification, and so
          on.
          ...
          - **OverwriteMode** *(string) --*
            ...
            even if the destination file differs from the source file. If you modify files in the
          ...
          - **PreserveDevices** *(string) --*
            ...
            devices in the source file system, and recreate the files with that device name and metadata on
            the destination.
          ...
          - **BytesPerSecond** *(integer) --*
            ...
            A value that limits the bandwidth used by AWS DataSync. For example, if you want AWS DataSync to
            use a maximum of 1 MB, set this value to ``1048576`` (``=1024*1024`` ).
          ...
          - **TaskQueueing** *(string) --*
            ...
            more information see  queue-task-execution .

        :type Excludes: list
        :param Excludes:

          A list of filter rules that determines which files to exclude from a task. The list should contain
        ...
        :param Schedule:
          ...
          - **ScheduleExpression** *(string) --* **[REQUIRED]**
            ...
            A cron expression that specifies when AWS DataSync initiates a scheduled transfer from a source
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Status** *(string) --*
              ...
              available to use. The Running status is the normal running status for an agent. If the status
              is OFFLINE, the agent's VM is turned off or the agent is in an unhealthy state. When the issue
            ...
            - **PrivateLinkConfig** *(dict) --*
              ...
              - **VpcEndpointId** *(string) --*
                ...
                The ID of the VPC endpoint that is configured for an agent. An agent that is configured with
                a VPC endpoint will not be accessible over the public Internet.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CloudWatchLogGroupArn** *(string) --*
              ...
              The Amazon Resource Name (ARN) of the Amazon CloudWatch log group that was used to monitor and
            ...
            - **SourceNetworkInterfaceArns** *(list) --*
              ...
              The Amazon Resource Name (ARN) of the source ENIs (Elastic Network Interface) that was created
              for your subnet.
            ...
            - **Options** *(dict) --*
              ...
              metadata such as user ID (UID) and group (GID), file permissions, data integrity verification,
              and so on.
              ...
              - **TaskQueueing** *(string) --*
                ...
                For more information see  queue-task-execution .
            ...
            - **ErrorCode** *(string) --*
              ...
              Errors that AWS DataSync encountered during execution of the task. You can use this error code
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **FilesTransferred** *(integer) --*
              ...
              The actual number of files that was transferred over the network. This value is calculated and
              updated on an ongoing basis during the TRANSFERRING phase. It's updated periodically when each
              file is read from the source and sent over the network.
            ...
            - **Result** *(dict) --*
              ...
              - **TotalDuration** *(integer) --*
                ...
                The total time in milliseconds that AWS DataSync took to transfer the file from the source
            ...
            - **Locations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **LocationUri** *(string) --*
                  ...
                  convention. For NFS and Amazon EFS, it's the export path to mount the location. For Amazon
                  S3, it's the prefix path that you mount to and treat as the root of the location.
          ...
          - *(dict) --*
            ...
            - **Tasks** *(list) --*
              ...
              - *(dict) --*
                ...
                contains a list of tasks when the  ListTasks operation is called. A task includes the source
                and destination file systems to sync and the options to use for the tasks.
    ...
    def start_task_execution(
        ...
        **Request Syntax**
        ...
        :param OverrideOptions:
          ...
          A task has a set of default options associated with it. If you don't specify an option in
          StartTaskExecution , the default value is used. You can override the defaults options on each task
    ...
    def update_task(
        ...
        **Request Syntax**
        ...
        :param Schedule:
          ...
          Specifies a schedule used to periodically transfer files from a source to a destination location.
          You can configure your task to execute hourly, daily, weekly or on specific days of the week. You
          control when in the day or hour you want the task to execute. The time you specify is UTC time.
