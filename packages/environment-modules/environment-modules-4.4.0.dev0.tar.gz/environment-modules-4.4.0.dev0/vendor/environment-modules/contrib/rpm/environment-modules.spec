...
Source0:        http://downloads.sourceforge.net/modules/modules-4.4.0.tar.bz2
...
BuildRequires:  tclx-devel, libX11-devel
Requires:       tcl
Requires:       sed
Requires:       less
...
Provides:       environment-modules
%endif
Provides:       modules-tcl = %{version}-%{release}
...
%endif
%doc ChangeLog README doc/build/NEWS.txt doc/build/MIGRATING.txt doc/build/diff_v3_v4.txt doc/build/CONTRIBUTING.txt
