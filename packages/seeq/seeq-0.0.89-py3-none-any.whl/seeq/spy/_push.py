...
def push(data=None, *, metadata=None, workbook=_common.DEFAULT_WORKBOOK_PATH,
    ...
    datasource : str, optional
        The name of a datasource in which to contain all the pushed items. By
        default, all pushed items will be contained in a "Seeq Data Lab"
        datasource. Do not create new datasources unless you really want to
            ...
            try:
                flush_now, last_scalar_datasource = \
                    _process_push_row(asset_batch_input, cache, condition_batch_input, status, datasource_output,
                                      ...
                                      put_signals_input, roots, row, sync_token, tree_batch_input, workbook_id)
...
def _process_push_row(asset_batch_input, cache, condition_batch_input, status, datasource_output, flush_now, index,
                      ...
                      sync_token, tree_batch_input, workbook_id):
    d = row.to_dict()
