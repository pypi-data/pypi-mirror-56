...
class Client(BaseClient):
    ...
    def grant_permissions(
        ...
        **Request Syntax**
        ...
        :param Principal: **[REQUIRED]**
          ...
          IAM roles, and they are defined by their principal type and their ARN.
        ...
        :param Permissions: **[REQUIRED]**
          ...
          grant and revoke access to metadata in the Data Catalog and data organized in underlying data
    ...
    def register_resource(
        ...
        To add or update data, Lake Formation needs read/write access to the chosen Amazon S3 path. Choose a
        role that you know has permission to do this, or choose the AWSServiceRoleForLakeFormationDataAccess
        service-linked role. When you register the first Amazon S3 path, the service-linked role and a new
        inline policy are created on your behalf. Lake Formation adds the first path to the inline policy
        and attaches it to the service-linked role. When you register subsequent paths, Lake Formation adds
        the path to the existing policy.
