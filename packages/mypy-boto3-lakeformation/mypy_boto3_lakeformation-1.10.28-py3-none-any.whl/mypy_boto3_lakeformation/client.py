...
class Client(BaseClient):
    ...
    def batch_grant_permissions(
        ...
        **Request Syntax**
        ...
        :param Entries: **[REQUIRED]**
          ...
          A list of up to 20 entries for resource permissions to be granted by batch operation to
          the principal.
          ...
          - *(dict) --*
            ...
            - **Resource** *(dict) --*
              ...
              - **Database** *(dict) --*
                ...
                associated table definitions organized into a logical group. You can Grant and
                Revoke database permissions to a principal.
                ...
                - **RequestEntry** *(dict) --*
                  ...
                  - **Resource** *(dict) --*
                    ...
                    - **TableWithColumns** *(dict) --*
                      ...
                      The table with columns for the resource. A principal with permissions to this
                      resource can select metadata from the columns of a table in the Data Catalog
                      and the underlying data in Amazon S3.
    ...
    def batch_revoke_permissions(
        ...
        **Request Syntax**
        ...
        :param Entries: **[REQUIRED]**
          ...
          A list of up to 20 entries for resource permissions to be revoked by batch operation to
          the principal.
    ...
    def get_effective_permissions_for_path(
        ...
        """
        Returns the permissions for a specified table or database resource located at a path in
        Amazon S3.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Permissions** *(list) --*
              ...
              A list of the permissions for the specified table or database resource located at the
              path in Amazon S3.
    ...
    def grant_permissions(
        ...
        **Request Syntax**
        ...
        :param Principal: **[REQUIRED]**
          ...
          The principal to be granted the permissions on the resource. Supported principals are IAM
          users or IAM roles, and they are defined by their principal type and their ARN.
        ...
        :param Resource: **[REQUIRED]**
          ...
          The resource to which permissions are to be granted. Resources in AWS Lake Formation are
        ...
        :param PermissionsWithGrantOption:
          ...
          These permissions may only be a subset of the permissions granted in the ``Privileges`` .
    ...
    def register_resource(
        ...
        Lake Formation adds the first path to the inline policy and attaches it to the
