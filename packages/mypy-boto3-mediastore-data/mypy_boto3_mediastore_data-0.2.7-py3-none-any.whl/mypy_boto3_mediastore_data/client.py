    ...
    def get_object(
        ...
        **Request Syntax**
        ...
        :param Path: **[REQUIRED]**
          ...
          name inside and outside of AWS Elemental MediaStore, or it can have the same name. The file name
    ...
    def list_items(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          returns no more than the first 500 items. (The service also returns a ``NextToken`` value that you
