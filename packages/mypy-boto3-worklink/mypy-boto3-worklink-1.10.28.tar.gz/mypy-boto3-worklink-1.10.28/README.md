...
Mypy-friendly auto-generated type annotations for `boto3 worklink 1.10.28` service.
...
session_client = session.client("worklink")
...
```python
import boto3
from mypy_boto3.worklink import Client
