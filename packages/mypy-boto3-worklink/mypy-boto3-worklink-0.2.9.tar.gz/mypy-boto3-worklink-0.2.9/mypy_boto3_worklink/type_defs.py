...
_ClientListDevicesResponseDevicesTypeDef = TypedDict(
    "_ClientListDevicesResponseDevicesTypeDef", {"DeviceId": str, "DeviceStatus": str}, total=False
)
...
_ClientListDomainsResponseDomainsTypeDef = TypedDict(
    ...
    {"DomainName": str, "DisplayName": str, "CreatedTime": datetime, "DomainStatus": str},
    total=False,
)
...
class ClientListWebsiteAuthorizationProvidersResponseWebsiteAuthorizationProvidersTypeDef(
    ...
    """
    Type definition for `ClientListWebsiteAuthorizationProvidersResponse`
...
class ClientListWebsiteCertificateAuthoritiesResponseWebsiteCertificateAuthoritiesTypeDef(
    ...
    """
    Type definition for `ClientListWebsiteCertificateAuthoritiesResponse`
