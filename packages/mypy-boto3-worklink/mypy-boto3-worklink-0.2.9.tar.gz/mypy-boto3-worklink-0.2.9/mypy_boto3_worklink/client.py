...
class Client(BaseClient):
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def describe_device(self, FleetArn: str, DeviceId: str) -> ClientDescribeDeviceResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def describe_fleet_metadata(self, FleetArn: str) -> ClientDescribeFleetMetadataResponseTypeDef:
        """
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'CompanyCode': 'string',
                'FleetStatus':
                'CREATING'|'ACTIVE'|'DELETING'|'DELETED'|'FAILED_TO_CREATE'
                |'FAILED_TO_DELETE'
            }
          **Response Structure**
    ...
    def list_devices(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The pagination token used to retrieve the next page of results for this operation. If this
                ...
                'Domains': [
                    {
                        ...
                        'CreatedTime': datetime(2015, 1, 1),
                        'DomainStatus':
                        'PENDING_VALIDATION'|'ASSOCIATING'|'ACTIVE'|'INACTIVE'
    ...
    def update_identity_provider_configuration(
        self, FleetArn: str, IdentityProviderType: str, IdentityProviderSamlMetadata: str = None
    ) -> Dict[str, Any]:
        """
