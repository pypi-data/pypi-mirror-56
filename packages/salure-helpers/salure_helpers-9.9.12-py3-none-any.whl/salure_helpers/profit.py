...
class UpdateConnector:
    ...
    def new_employee_with_first_contract(self, data: dict, overload_fields={}):
        ...
        allowed_fields_person = ['initials']
        required_fields_person = ['employee_id', 'last_name', 'gender', 'first_name', 'place_of_birth', 'date_of_birth', 'country', 'email_work', 'email_home', 'ssn', 'country_of_birth']
