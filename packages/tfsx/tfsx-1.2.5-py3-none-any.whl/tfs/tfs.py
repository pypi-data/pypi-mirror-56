...
class TFS(object):
    ...
    def get_work_item(self, work_item_id):
        return self.work_item_tracking_client.get_work_item(work_item_id)
    ...
    def get_work_item_query_by_wiql_epic_user_story_product_backlog_item(self, area_path,iteration_path):
        wiql = Wiql(
        query="""
                select [System.Id],
                    [System.WorkItemType],
    ...
    def get_work_item_query_by_wiql_task(self, area_path, iteration_path):
        wiql = Wiql(
        #[System.TeamProject] = 
