...
class Client(BaseClient):
        ...
        **Request Syntax**
        ...
        :param EventDestination: An object that defines a single event destination.
          ...
          event destination that sends data to Amazon CloudWatch Logs.
            ...
            - **LogGroupArn** *(string) --* The name of the Amazon CloudWatch Log Group that you
            want to record events in.

          - **Enabled** *(boolean) --* Indicates whether or not the event destination is enabled. If
          the event destination is enabled, then Amazon Pinpoint sends response data to the
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* GetConfigurationSetEventDestinationsResponse
            ...
            - **EventDestinations** *(list) --* An array of EventDestination objects. Each
            EventDestination object includes ARNs and other information that define an event
            destination.

              - *(dict) --* An object that defines an event destination.

                - **CloudWatchLogsDestination** *(dict) --* An object that contains information
                about an event destination that sends data to Amazon CloudWatch Logs.

                  - **IamRoleArn** *(string) --* The Amazon Resource Name (ARN) of an Amazon
                  Identity and Access Management (IAM) role that is able to write event data to an
                  Amazon CloudWatch destination.

                  - **LogGroupArn** *(string) --* The name of the Amazon CloudWatch Log Group that
                  you want to record events in.

                - **Enabled** *(boolean) --* Indicates whether or not the event destination is
                enabled. If the event destination is enabled, then Amazon Pinpoint sends response
                data to the specified event destination.

                - **KinesisFirehoseDestination** *(dict) --* An object that contains information
                about an event destination that sends data to Amazon Kinesis Data Firehose.

                  - **DeliveryStreamArn** *(string) --* The Amazon Resource Name (ARN) of an IAM
                  role that can write data to an Amazon Kinesis Data Firehose stream.

                  - **IamRoleArn** *(string) --* The Amazon Resource Name (ARN) of the Amazon
                ...
                destination that sends data to Amazon SNS.
                  ...
                  - **TopicArn** *(string) --* The Amazon Resource Name (ARN) of the Amazon SNS
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* ListConfigurationSetsResponse
            ...
            - **ConfigurationSets** *(list) --* An object that contains a list of configuration sets
            for your account in the current region.

              - *(string) --*

            - **NextToken** *(string) --* A token returned from a previous call to
            ListConfigurationSets to indicate the position in the list of configuration sets.
        """
    ...
    def send_voice_message(
        ...
        **Request Syntax**
        ...
        :param CallerId: The phone number that appears on recipients' devices when they receive the
        message.

        :type ConfigurationSetName: string
        :param ConfigurationSetName: The name of the configuration set that you want to use to send
        the message.

        :type Content: dict
        :param Content: An object that contains a voice message and information about the recipient
        that you want to send it to.

          - **CallInstructionsMessage** *(dict) --* An object that defines a message that contains
          text formatted using Amazon Pinpoint Voice Instructions markup.

            - **Text** *(string) --* The language to use when delivering the message. For a complete
            list of supported languages, see the Amazon Polly Developer Guide.

          - **PlainTextMessage** *(dict) --* An object that defines a message that contains
          unformatted text.
            ...
            - **Text** *(string) --* The plain (not SSML-formatted) text to deliver to the
            recipient.

            - **VoiceId** *(string) --* The name of the voice that you want to use to deliver the
            message. For a complete list of supported voices, see the Amazon Polly Developer Guide.

          - **SSMLMessage** *(dict) --* An object that defines a message that contains
          SSML-formatted text.
        ...
        :param OriginationPhoneNumber: The phone number that Amazon Pinpoint should use to send the
