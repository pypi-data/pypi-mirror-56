...
class AmlWindowsCompute(AmlCompute):
    ...
    """Class for managing AmlWindowsCompute compute target objects."""
    ...
    def create(workspace, name, provisioning_configuration):
        """Provision an AmlWindowsCompute object.
        ...
        :type name: str
        :param provisioning_configuration: An AmlWindowsComputeTargetProvisioningConfiguration object that defines
        how to configure the windows cluster.
        :type provisioning_configuration: azureml.contrib.compute.AmlWindowsComputeTargetProvisioningConfiguration
    ...
    def provisioning_configuration(vm_size='', vm_priority="dedicated", vm_image=None, min_nodes=0,
        ...
        If not specified, will default to windows server 2016 image.
        :type vm_image: str
        ...
        :param remote_login_port_public_access: State of the public SSH port. Possible values are:
            ...
            Defaults to NotSpecified - Indicates that the public ssh port is closed on all nodes of the cluster if
            VNet is defined, else is open all public nodes. It can be default only during cluster creation time,
        ...
        :rtype: azureml.contrib.compute.AmlWindowsComputeTargetProvisioningConfiguration
        :raises: azureml.exceptions.ComputeTargetException
        """
    ...
    def deserialize(workspace, object_dict):
        """Convert a json object into a AmlWindowsCompute object.
        ...
        :type workspace: azureml.core.Workspace
        :param object_dict: A json object to convert to a AmlWindowsCompute object.
        :type object_dict: dict
        :return: The AmlWindowsCompute representation of the provided json object.
        :rtype: azureml.core.compute.amlcompute.AmlWindowsCompute
        :raises: azureml.exceptions.ComputeTargetException
        """
        ...
        if payload['properties']['properties']:
            if "osType" not in payload['properties']['properties']:
                ...
                raise ComputeTargetException('Invalid cluster payload. ["properties"]["properties"]["osType"] '
                                             'should be {} to create a AmlWindowsCompute cluster.'.foramt(_OS_TYPE))
...
class AmlWindowsComputeProvisioningConfiguration(AmlComputeProvisioningConfiguration):
    ...
    :param vm_priority: dedicated or lowpriority VMs. If not specified, will default to dedicated.
    :type vm_priority: str
    :param vm_image: VM Image to be used for the compute cluster. If not specified, will default to Windows  2016.
    :type vm_image: str
    :param min_nodes: Minimum number of nodes to use on the cluster. If not specified, will default to 0.
    :type min_nodes: int
    :param max_nodes: Maximum number of nodes to use on the cluster. Defaults to 4.
    ...
    def __init__(self, vm_size='', vm_priority="dedicated", vm_image=None, min_nodes=0,
        ...
        """Create a configuration object for provisioning a AmlWindowsCompute target.
...
class AmlWindowsComputeStatus(AmlComputeStatus):
    """Detailed status for a AmlWindowsCompute object.

    .. remarks::

        Initialize a AmlWindowsComputeStatus object
    ...
    def deserialize(object_dict):
        """Convert a json object into a AmlWindowsComputeStatus object.

        :param object_dict: A json object to convert to a AmlWindowsComputeStatus object.
        :type object_dict: dict
