...
class ClientAcceptResourceShareInvitationResponseresourceShareInvitationresourceShareAssociationsTypeDef(
    ...
    """
    Type definition for `ClientAcceptResourceShareInvitationResponseresourceShareInvitation`
    ...
    - **associatedEntity** *(string) --*
      ...
      principal associations, this is the ID of an AWS account or the ARN of an OU or organization
    ...
    - **external** *(boolean) --*
      ...
      Indicates whether the principal belongs to the same AWS organization as the AWS account that
...
class ClientAssociateResourceSharePermissionResponseTypeDef(
    ...
    """
    Type definition for `ClientAssociateResourceSharePermission` `Response`
...
class ClientCreateResourceShareResponseresourceShareTypeDef(
    ...
    - **featureSet** *(string) --*
      ...
      * ``CREATED_FROM_POLICY`` - Indicates that the resource share was created from an AWS Identity
      ...
      visible only to the AWS account that created it. They cannot be modified in AWS RAM.
    ...
    - **resourceShare** *(dict) --*
      ...
      - **featureSet** *(string) --*
        ...
        * ``CREATED_FROM_POLICY`` - Indicates that the resource share was created from an AWS
        Identity and Access Management (AWS IAM) policy attached to a resource. These resource
        shares are visible only to the AWS account that created it. They cannot be modified in AWS
        RAM.

        * ``PROMOTING_TO_STANDARD`` - The resource share is in the process of being promoted. For
        more information, see  PromoteResourceShareCreatedFromPolicy .

        * ``STANDARD`` - Indicates that the resource share was created in AWS RAM using the console
        or APIs. These resource shares are visible to all principals. They can be modified in AWS
        RAM.
...
class ClientDisassociateResourceSharePermissionResponseTypeDef(
    ...
    """
    Type definition for `ClientDisassociateResourceSharePermission` `Response`
...
class ClientGetPermissionResponsepermissionTypeDef(_ClientGetPermissionResponsepermissionTypeDef):
    """
    Type definition for `ClientGetPermissionResponse` `permission`
    ...
    - **permission** *(string) --*
      ...
      The permission's effect and actions in JSON format. The ``effect`` indicates whether the
      actions are allowed or denied. The ``actions`` list the API actions to which the principal is
...
class ClientGetPermissionResponseTypeDef(_ClientGetPermissionResponseTypeDef):
    """
    Type definition for `ClientGetPermission` `Response`
    ...
    - **permission** *(dict) --*
      ...
      - **permission** *(string) --*
        ...
        The permission's effect and actions in JSON format. The ``effect`` indicates whether the
        actions are allowed or denied. The ``actions`` list the API actions to which the principal
        is granted or denied access.
...
class ClientGetResourceShareInvitationsResponseresourceShareInvitationsresourceShareAssociationsTypeDef(
    ...
    """
    Type definition for `ClientGetResourceShareInvitationsResponseresourceShareInvitations`
    `resourceShareAssociations`
      ...
      - *(dict) --*
        ...
        - **featureSet** *(string) --*
          ...
          * ``STANDARD`` - Indicates that the resource share was created in AWS RAM using the
          console or APIs. These resource shares are visible to all principals. They can be modified
          in AWS RAM.
...
class ClientListResourceSharePermissionsResponsepermissionsTypeDef(
    ...
    """
    Type definition for `ClientListResourceSharePermissionsResponse` `permissions`
...
class ClientListResourceSharePermissionsResponseTypeDef(
    ...
    """
    Type definition for `ClientListResourceSharePermissions` `Response`
...
class ClientPromoteResourceShareCreatedFromPolicyResponseTypeDef(
    ...
    """
    Type definition for `ClientPromoteResourceShareCreatedFromPolicy` `Response`
...
class ClientRejectResourceShareInvitationResponseresourceShareInvitationresourceShareAssociationsTypeDef(
    ...
    """
    Type definition for `ClientRejectResourceShareInvitationResponseresourceShareInvitation`
    `resourceShareAssociations`
...
class GetResourceShareInvitationsPaginateResponseresourceShareInvitationsresourceShareAssociationsTypeDef(
    ...
    """
    Type definition for `GetResourceShareInvitationsPaginateResponseresourceShareInvitations`
    `resourceShareAssociations`
