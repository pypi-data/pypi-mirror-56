...
class GossipServiceStub(object):
  ...
  def __init__(self, channel):
    ...
    self.StreamDagTipBlockSummaries = channel.unary_stream(
        '/io.casperlabs.comm.gossiping.GossipService/StreamDagTipBlockSummaries',
        request_serializer=gossiping__pb2.StreamDagTipBlockSummariesRequest.SerializeToString,
        response_deserializer=consensus__pb2.BlockSummary.FromString,
        )
...
class GossipServiceServicer(object):
  ...
  def StreamDagTipBlockSummaries(self, request, context):
...
def add_GossipServiceServicer_to_server(servicer, server):
  rpc_method_handlers = {
      ...
      'StreamDagTipBlockSummaries': grpc.unary_stream_rpc_method_handler(
          servicer.StreamDagTipBlockSummaries,
          request_deserializer=gossiping__pb2.StreamDagTipBlockSummariesRequest.FromString,
          response_serializer=consensus__pb2.BlockSummary.SerializeToString,
      ),
