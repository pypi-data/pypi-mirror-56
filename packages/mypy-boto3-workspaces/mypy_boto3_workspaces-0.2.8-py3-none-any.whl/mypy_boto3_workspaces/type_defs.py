...
class ClientCreateWorkspacesResponseFailedRequestsWorkspaceRequestWorkspacePropertiesTypeDef(
    ...
    """
    Type definition for `ClientCreateWorkspacesResponseFailedRequestsWorkspaceRequest`
    `WorkspaceProperties`
...
class ClientDescribeClientPropertiesResponseClientPropertiesListClientPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeClientPropertiesResponseClientPropertiesList`
    `ClientProperties`
...
_ClientDescribeWorkspaceBundlesResponseBundlesComputeTypeTypeDef = TypedDict(
    "_ClientDescribeWorkspaceBundlesResponseBundlesComputeTypeTypeDef", {"Name": str}, total=False
)
...
class ClientDescribeWorkspaceDirectoriesResponseDirectoriesSelfservicePermissionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeWorkspaceDirectoriesResponseDirectories`
...
class ClientDescribeWorkspaceDirectoriesResponseDirectoriesWorkspaceCreationPropertiesTypeDef(
    ...
    - **EnableInternetAccess** *(boolean) --*
      ...
      Specifies whether to automatically assign a public IP address to WorkSpaces in this directory
      by default. If enabled, the public IP address allows outbound internet access from your
      WorkSpaces when you’re using an internet gateway in the Amazon VPC in which your WorkSpaces
      are located. If you're using a Network Address Translation (NAT) gateway for outbound internet
      access from your VPC, or if your WorkSpaces are in public subnets and you manually assign them
      Elastic IP addresses, you should disable this setting. This setting applies to new WorkSpaces
      that you launch or to existing WorkSpaces that you rebuild. For more information, see
...
class ClientDescribeWorkspaceDirectoriesResponseDirectoriesTypeDef(
    ...
    - **IamRoleId** *(string) --*
      ...
      The identifier of the IAM role. This is the role that allows Amazon WorkSpaces to make calls
      to other services, such as Amazon EC2, on your behalf.
    ...
    - **WorkspaceCreationProperties** *(dict) --*
      ...
      - **EnableInternetAccess** *(boolean) --*
        ...
        directory by default. If enabled, the public IP address allows outbound internet access from
        your WorkSpaces when you’re using an internet gateway in the Amazon VPC in which your
        WorkSpaces are located. If you're using a Network Address Translation (NAT) gateway for
        outbound internet access from your VPC, or if your WorkSpaces are in public subnets and you
        manually assign them Elastic IP addresses, you should disable this setting. This setting
        applies to new WorkSpaces that you launch or to existing WorkSpaces that you rebuild. For
        more information, see `Configure a VPC for Amazon WorkSpaces
        <https://docs.aws.amazon.com/workspaces/latest/adminguide/amazon-workspaces-vpc.html>`__ .
    ...
    - **WorkspaceAccessProperties** *(dict) --*
      ...
      - **DeviceTypeWindows** *(string) --*
        ...
        certificates, specify a value of ``TRUST`` . For more information, see `Restrict WorkSpaces
    ...
    - **Tenancy** *(string) --*
      ...
      Specifies whether the directory is dedicated or shared. To use Bring Your Own License (BYOL),
      this value must be set to ``DEDICATED`` . For more information, see `Bring Your Own Windows
      Desktop Images
      ...
      - *(dict) --*
        ...
        - **WorkspaceCreationProperties** *(dict) --*
          ...
          - **EnableInternetAccess** *(boolean) --*
            ...
            and you manually assign them Elastic IP addresses, you should disable this setting. This
            setting applies to new WorkSpaces that you launch or to existing WorkSpaces that you
            rebuild. For more information, see `Configure a VPC for Amazon WorkSpaces
            <https://docs.aws.amazon.com/workspaces/latest/adminguide/amazon-workspaces-vpc.html>`__
            .
...
_ClientDescribeWorkspaceImagesResponseImagesOperatingSystemTypeDef = TypedDict(
    "_ClientDescribeWorkspaceImagesResponseImagesOperatingSystemTypeDef", {"Type": str}, total=False
)
...
class ClientDescribeWorkspaceImagesResponseImagesTypeDef(
    ...
    - **RequiredTenancy** *(string) --*
      ...
      (BYOL) is enabled, this value is set to ``DEDICATED`` . For more information, see `Bring Your
      Own Windows Desktop Images
      <https://docs.aws.amazon.com/workspaces/latest/adminguide/byol-windows-images.html>`__ .
...
class ClientDescribeWorkspacesConnectionStatusResponseWorkspacesConnectionStatusTypeDef(
    ...
    """
    Type definition for `ClientDescribeWorkspacesConnectionStatusResponse`
    ...
    - **ConnectionState** *(string) --*
      ...
      The connection state of the WorkSpace. The connection state is unknown if the WorkSpace is
      stopped.
...
_ClientModifyClientPropertiesClientPropertiesTypeDef = TypedDict(
    "_ClientModifyClientPropertiesClientPropertiesTypeDef", {"ReconnectEnabled": str}, total=False
)
...
class ClientRebootWorkspacesResponseFailedRequestsTypeDef(
    ...
    RebuildWorkspaces ), restored ( RestoreWorkspace ), terminated ( TerminateWorkspaces ), started
...
_DescribeWorkspaceBundlesPaginateResponseBundlesComputeTypeTypeDef = TypedDict(
    "_DescribeWorkspaceBundlesPaginateResponseBundlesComputeTypeTypeDef", {"Name": str}, total=False
)
...
class DescribeWorkspaceDirectoriesPaginateResponseDirectoriesSelfservicePermissionsTypeDef(
    ...
    """
    Type definition for `DescribeWorkspaceDirectoriesPaginateResponseDirectories`
    `SelfservicePermissions`
...
class DescribeWorkspacesConnectionStatusPaginateResponseWorkspacesConnectionStatusTypeDef(
    ...
    """
    Type definition for `DescribeWorkspacesConnectionStatusPaginateResponse`
    `WorkspacesConnectionStatus`
