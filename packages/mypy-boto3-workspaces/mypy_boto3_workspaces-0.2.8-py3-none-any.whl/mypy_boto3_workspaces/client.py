...
class Client(BaseClient):
    ...
    def create_ip_group(
        ...
        rules to your IP access control group and then associate the group with your directory. You
    ...
    def describe_account_modifications(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If you received a ``NextToken`` from a previous call that was paginated, provide this
          token to receive the next set of results.
    ...
    def describe_workspace_bundles(
        ...
        **Request Syntax**
        ...
        :param Owner:
          ...
          Specify ``AMAZON`` to describe the bundles provided by AWS or null to describe the bundles
              ...
              - *(dict) --*
                ...
                - **WorkspaceCreationProperties** *(dict) --*
                  ...
                  - **EnableInternetAccess** *(boolean) --*
                    ...
                    Specifies whether to automatically assign a public IP address to WorkSpaces in
                    this directory by default. If enabled, the public IP address allows outbound
                ...
                - **WorkspaceAccessProperties** *(dict) --*
                  ...
                  - **DeviceTypeWindows** *(string) --*
                    ...
                    see `Restrict WorkSpaces Access to Trusted Devices
                ...
                - **Tenancy** *(string) --*
                  ...
                  License (BYOL), this value must be set to ``DEDICATED`` . For more information,
    ...
    def describe_workspaces(
        ...
        You can filter the results by using the bundle identifier, directory identifier, or owner,
        ...
        **Request Syntax**
        ...
        :param DirectoryId:
          ...
          directory user (see ``UserName`` ). You cannot combine this parameter with any other
          filter.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def modify_workspace_state(self, WorkspaceId: str, WorkspaceState: str) -> Dict[str, Any]:
        """
    ...
    def register_workspace_directory(
        ...
        **Request Syntax**
        ...
        :param Tenancy:
          ...
          License (BYOL) images, this value must be set to ``DEDICATED`` and your AWS account must
          be enabled for BYOL. If your account has not been enabled for BYOL, you will receive an
          InvalidParameterValuesException error. For more information about BYOL images, see `Bring
    ...
    def restore_workspace(self, WorkspaceId: str) -> Dict[str, Any]:
        ...
        You cannot restore a WorkSpace unless its state is ``AVAILABLE`` , ``ERROR`` , or
        ``UNHEALTHY`` .

        Restoring a WorkSpace is a potentially destructive action that can result in the loss of
        data. For more information, see `Restore a WorkSpace
