...
class Client(BaseClient):
    ...
    def assign_instance(self, InstanceId: str, LayerIds: List[str]) -> None:
        ...
        * You cannot use this action with instances that were created with AWS OpsWorks Stacks.
         ...
         **Required Permissions** : To use this action, an AWS Identity and Access Management (IAM)
    ...
    def assign_volume(self, VolumeId: str, InstanceId: str = None) -> None:
        """
        Assigns one of the stack's registered Amazon EBS volumes to a specified instance. The volume
        must first be registered with the stack by calling  RegisterVolume . After you register the
        volume, you must call  UpdateVolume to specify a mount point before calling ``AssignVolume``
    ...
    def attach_elastic_load_balancer(self, ElasticLoadBalancerName: str, LayerId: str) -> None:
        ...
        OpsWorks Stacks. For more information, see `Elastic Load Balancing
        ...
        .. note::
          ...
          Balancing console, API, or CLI. For more information, see `Elastic Load Balancing
          Developer Guide
    ...
    def clone_stack(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-cloning.html>`__ . By
        ...
        **Request Syntax**
        ...
        :param Region:
          ...
          The cloned stack AWS region, such as "ap-northeast-2". For more information about AWS
        ...
        :param VpcId:
          ...
          specified region. All instances are launched into this VPC, and you cannot change the ID
          later.
          ...
          * If your account does not support EC2 Classic, the default value is the default VPC for
          ...
          ``DefaultAvailabilityZone`` or the ``DefaultSubnetId`` parameter only, AWS OpsWorks Stacks
          infers the value of the other parameter. If you specify neither parameter, AWS OpsWorks
          Stacks sets these parameters to the first valid Availability Zone for the specified region
          ...
          * You must specify a value for ``DefaultSubnetId`` .
          ...
          For more information about how to use AWS OpsWorks Stacks with a VPC, see `Running a Stack
          in a VPC <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-vpc.html>`__
        ...
        :param ServiceRoleArn: **[REQUIRED]**
          ...
          The stack AWS Identity and Access Management (IAM) role, which allows AWS OpsWorks Stacks
          ...
          OpsWorks Stacks console, it creates the role for you. You can obtain an existing stack's
          IAM ARN programmatically by calling  DescribePermissions . For more information about IAM
        ...
        :param DefaultInstanceProfileArn:
          ...
          The Amazon Resource Name (ARN) of an IAM profile that is the default profile for all of
          the stack's EC2 instances. For more information about IAM ARNs, see `Using Identifiers
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html>`__ .
        ...
        :param DefaultOs:
          ...
          * A supported Linux operating system: An Amazon Linux version, such as ``Amazon Linux
        ...
        :param HostnameTheme:
          ...
          ``Layer_Dependent`` , which creates host names by appending integers to the layer's short
          ...
          * ``Wild_Cats``
          ...
          To obtain a generated host name, call ``GetHostNameSuggestion`` , which returns a host
          name based on the current theme.

        :type DefaultAvailabilityZone: string
        :param DefaultAvailabilityZone:

          The cloned stack's default Availability Zone, which must be in the specified region. For
          more information, see `Regions and Endpoints
          <https://docs.aws.amazon.com/general/latest/gr/rande.html>`__ . If you also specify a
          value for ``DefaultSubnetId`` , the subnet must be in the same zone. For more information,
          see the ``VpcId`` parameter description.

        :type DefaultSubnetId: string
        :param DefaultSubnetId:

          The stack's default VPC subnet ID. This parameter is required if you specify a value for
          the ``VpcId`` parameter. All instances are launched into this subnet unless you specify
          otherwise when you create the instance. If you also specify a value for
          ``DefaultAvailabilityZone`` , the subnet must be in that zone. For information on default
          values and when this parameter is required, see the ``VpcId`` parameter description.
        ...
        :param ConfigurationManager:
          ...
          configuration manager to specify the Chef version: 12, 11.10, or 11.4 for Linux stacks, or
          12.2 for Windows stacks. The default value for Linux stacks is currently 12.
        ...
        :param UseOpsworksSecurityGroups:
          ...
          layer, which are associated with layers by default. With ``UseOpsworksSecurityGroups`` you
          can instead provide your own custom security groups. ``UseOpsworksSecurityGroups`` has the
          following settings:

          * True - AWS OpsWorks Stacks automatically associates the appropriate built-in security
          group with each layer (default setting). You can associate additional security groups with
          ...
          * False - AWS OpsWorks Stacks does not associate built-in security groups with layers. You
          must create appropriate Amazon Elastic Compute Cloud (Amazon EC2) security groups and
          associate a security group with each layer that you create. However, you can still
        ...
        :param DefaultSshKeyName:
          ...
          name, AWS OpsWorks installs the public key on the instance and you can use the private key
          with an SSH client to log in to the instance. For more information, see `Using SSH to
          Communicate with an Instance
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-ssh.html>`__ and
          `Managing SSH Access
          <https://docs.aws.amazon.com/opsworks/latest/userguide/security-ssh-access.html>`__ . You
        ...
        :param AgentVersion:
          ...
          * Fixed version - Set this parameter to your preferred agent version. To update the agent
          ...
          Stacks then automatically installs that version on the stack's instances.
    ...
    def create_app(
        ...
        **Request Syntax**
        ...
        :param Type: **[REQUIRED]**
          ...
          to those instances that are members of the corresponding layer. If your app isn't one of
          the standard types, or you prefer to implement your own Deploy recipes, specify ``other``
          .
        ...
        :param Environment:
          ...
          the associated data structure - which includes the variables' names, values, and protected
          flag values - cannot exceed 20 KB. This limit should accommodate most if not all use
          cases. Exceeding it will cause an exception with the message, "Environment: is too large
          (maximum is 20KB)."
    ...
    def create_deployment(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-deploying.html>`__ and
        `Run Stack Commands
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-commands.html>`__ .
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_deployment(
              ...
              Command={
                  ...
                  |'execute_recipes'|'configure'|'setup'|'deploy'|'rollback'|'start'
                  |'stop'|'restart'|'undeploy',
                  'Args': {
                      'string': [
                          'string',
                      ]
        ...
        :param CustomJson:
          ...
          some corresponding default stack configuration JSON values. The string should be in the
          following format:
          ...
          For more information about custom JSON, see `Use Custom JSON to Modify the Stack
          Configuration Attributes
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-json.html>`__ and
    ...
    def create_instance(
        ...
        Layer <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-add.html>`__ .
        ...
        **Request Syntax**
        ...
        :param InstanceType: **[REQUIRED]**
          ...
          contains the currently supported types. For more information, see `Instance Families and
          Types <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ . The
          parameter values that you use to specify the various types are in the **API Name** column
        ...
        :param Os:
          ...
          * A custom AMI: ``Custom`` .
          ...
          ``Custom`` . For more information about supported operating systems, see `Operating
          Systems
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-os.html>`__ For
        ...
        :param AmiId:
          ...
          supported operating systems. For more information, see `Using Custom AMIs
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-custom-ami.html>`__
          .
        ...
        :param SubnetId:
          ...
          parameter to override the stack's default subnet ID value and direct AWS OpsWorks Stacks
        ...
        :param BlockDeviceMappings:
          ...
          An array of ``BlockDeviceMapping`` objects that specify the instance's block devices. For
        ...
        :param InstallUpdatesOnBoot:
          ...
          default value is ``true`` . To control when updates are installed, set this value to
        ...
        :param AgentVersion:
          ...
          * *version_number* - Use the specified agent version. This value overrides the stack's
          default setting. To update the agent version, edit the instance configuration and specify
          a new version. AWS OpsWorks Stacks then automatically installs that version on the
          instance.

          The default setting is ``INHERIT`` . To specify an agent version, you must use the
          complete version number, not the abbreviated number shown on the console. For a list of
          available agent version numbers, call  DescribeAgentVersions . AgentVersion cannot be set
          to Chef 12.2.

        :type Tenancy: string
        :param Tenancy:

          The instance's tenancy option. The default option is no tenancy, or if the instance is
          running in a VPC, inherit tenancy settings from the VPC. The following are valid values
          for this parameter: ``dedicated`` , ``default`` , or ``host`` . Because there are costs
          ...
          `Dedicated Hosts Overview <http://aws.amazon.com/ec2/dedicated-hosts/>`__ and `Amazon EC2
          Dedicated Hosts <http://aws.amazon.com/ec2/dedicated-hosts/>`__ . For more information
          about dedicated instances, see `Dedicated Instances
          <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/dedicated-instance.html>`__ and
          `Amazon EC2 Dedicated Instances
          <http://aws.amazon.com/ec2/purchasing-options/dedicated-instances/>`__ .
    ...
    def create_layer(
        ...
        .. note::
          ...
          You should use **CreateLayer** for noncustom layer types such as PHP App Server only if
          the stack does not have an existing layer of that type. A stack can have at most one
          instance of each noncustom layer; if you attempt to create a second instance,
          **CreateLayer** fails. A stack can have an arbitrary number of custom layers, so you can
          call **CreateLayer** as many times as you like for that layer type.
        ...
        **Request Syntax**
        ...
        :param Type: **[REQUIRED]**
          ...
          The layer type. A stack cannot have more than one built-in layer of the same type. It can
          have any number of custom layers. Built-in layers are not available in Chef 12 stacks.
        ...
        :param Shortname: **[REQUIRED]**
          ...
          For custom layers only, use this parameter to specify the layer's short name, which is
          used internally by AWS OpsWorks Stacks and by Chef recipes. The short name is also used as
          the name for the directory where your app files are installed. It can have a maximum of
          200 characters, which are limited to the alphanumeric characters, '-', '_', and '.'.

          The built-in layers' short names are defined by AWS OpsWorks Stacks. For more information,
          see the `Layer Reference
          <https://docs.aws.amazon.com/opsworks/latest/userguide/layers.html>`__ .
        ...
        :param CustomJson:
          ...
          A JSON-formatted string containing custom stack configuration and deployment attributes to
          be installed on the layer's instances. For more information, see `Using Custom JSON
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workingcookbook-json-override.html>`__
        ...
        **Request Syntax**
        ...
        :param Region: **[REQUIRED]**
          ...
          .. note::
            ...
            parameter is not set, but the AWS CLI ``--region`` parameter is, this also results in a
            stack with a *regional* endpoint. However, if the ``--region`` parameter is set to
            ``us-east-1`` , and the ``--stack-region`` parameter is set to one of the following,
            then the stack uses a legacy or *classic* region: ``us-west-1, us-west-2, sa-east-1,
            eu-central-1, eu-west-1, ap-northeast-1, ap-southeast-1, ap-southeast-2`` . In this
            case, the actual API endpoint of the stack is in ``us-east-1`` . Only the preceding
            regions are supported as classic regions in the ``us-east-1`` API endpoint. Because it
            is a best practice to choose the regional endpoint that is closest to where you manage
            AWS, we recommend that you use regional endpoints for new stacks. The AWS CLI common
            ``--region`` parameter always specifies a regional API endpoint; it cannot be used to
        ...
        :param ServiceRoleArn: **[REQUIRED]**
          ...
          Amazon Resource Name (ARN) for an existing IAM role. For more information about IAM ARNs,
        ...
        :param DefaultOs:
          ...
          The stack's default operating system, which is installed on every instance unless you
          specify a different operating system when you create the instance. You can specify one of
          the following.
        ...
        :param CustomJson:
          ...
          corresponding default stack configuration attribute values or to pass data to recipes. The
        ...
        :param UseOpsworksSecurityGroups:
          ...
          * False - AWS OpsWorks Stacks does not associate built-in security groups with layers. You
          ...
          that you create. However, you can still manually associate a built-in security group with
          a layer on creation; custom security groups are required only for those layers that need
          custom settings.
    ...
    def create_user_profile(
        ...
        **Request Syntax**
        ...
        :param SshUsername:
          ...
          The user's SSH user name. The allowable characters are [a-z], [A-Z], [0-9], '-', and '_'.
          If the specified name includes other punctuation marks, AWS OpsWorks Stacks removes them.
          For example, ``my.name`` will be changed to ``myname`` . If you do not specify an SSH user
    ...
    def delete_instance(
        ...
        stop an instance before you can delete it.
    ...
    def delete_stack(self, StackId: str) -> None:
        ...
        deregister registered instances. For more information, see `Shut Down a Stack
    ...
    def deregister_instance(self, InstanceId: str) -> None:
        """
        Deregister a registered Amazon EC2 or on-premises instance. This action removes the instance
        from the stack and returns it to your control. This action cannot be used with instances
    ...
    def deregister_volume(self, VolumeId: str) -> None:
        ...
        **Request Syntax**
        ...
        :param VolumeId: **[REQUIRED]**
          ...
          The AWS OpsWorks Stacks volume ID, which is the GUID that AWS OpsWorks Stacks assigned to
          the instance when you registered the volume with the stack, not the Amazon EC2 volume ID.
    ...
    def describe_agent_versions(
        ...
        configuration manager. ``DescribeAgentVersions`` returns a list of available agent versions
            ...
            - **Apps** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Environment** *(list) --*
                  ...
                  be associated with the app. After you deploy the app, these variables are defined
    ...
    def describe_commands(
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          The instance ID. If you include this parameter, ``DescribeCommands`` returns a description
          of the commands associated with the specified instance.

        :type CommandIds: list
        :param CommandIds:

          An array of command IDs. If you include this parameter, ``DescribeCommands`` returns a
          description of the specified commands. Otherwise, it returns a description of every
          command.
                ...
                'Deployments': [
                    {
                        ...
                        'Command': {
                            ...
                            |'configure'|'setup'|'deploy'|'rollback'|'start'
                            |'stop'|'restart'|'undeploy',
                            'Args': {
                                'string': [
                                    'string',
                ...
                - **Command** *(dict) --*
                  ...
                  - **Name** *(string) --*
                    ...
                    * ``execute_recipes`` : Execute one or more recipes. To specify the recipes, set
                    an ``Args`` parameter named ``recipes`` to the list of recipes to be executed.
                    ...
                    * ``rollback`` Roll the app back to the previous version. When you update an
                    app, AWS OpsWorks Stacks stores the previous version, up to a maximum of five
    ...
    def describe_ecs_clusters(
        ...
        ID, you can use the ``MaxResults`` and ``NextToken`` parameters to paginate the response.
        However, AWS OpsWorks Stacks currently supports only one cluster per layer, so the result
        set has a maximum of one element.

         **Required Permissions** : To use this action, an IAM user must have a Show, Deploy, or
         Manage permissions level for the stack or an attached policy that explicitly grants
         permission. For more information about user permissions, see `Managing User Permissions
         <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          of results, call ``DescribeEcsClusters`` again and assign that token to the request
        ...
        :param MaxResults:
          ...
          To receive a paginated response, use this parameter to specify the maximum number of
          results to be returned with a single call. If the number of available results exceeds this
          maximum, the response includes a ``NextToken`` value that you can assign to the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If a paginated request does not return all of the remaining results, this parameter is
              set to a token that you can assign to the request object's ``NextToken`` parameter to
              retrieve the next set of results. If the previous paginated request returned all of
              the remaining results, this parameter is set to ``null`` .
    ...
    def describe_elastic_load_balancers(
        ...
        **Request Syntax**
        ...
        :param LayerIds:
          ...
          A list of layer IDs. The action describes the Elastic Load Balancing instances for the
          specified layers.
            ...
            - **Instances** *(list) --*
              ...
              - *(dict) --*
                ...
                - **InstallUpdatesOnBoot** *(boolean) --*
                  ...
                  The default value is ``true`` . If this value is set to ``false`` , you must then
                ...
                'Layers': [
                    {
                        ...
                        'LayerId': 'string',
                        'Type':
                        'aws-flow-ruby'|'ecs-cluster'|'java-app'|'lb'|'web'
                        |'php-app'|'rails-app'|'nodejs-app'|'memcached'|'db-master'
                        |'monitoring-master'|'custom',
                        'Name': 'string',
                        'Shortname': 'string',
                        'Attributes': {
                            'string': 'string'
            ...
            - **Layers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Attributes** *(dict) --*
                  ...
                  For an ECS Cluster layer, AWS OpsWorks Stacks the ``EcsClusterArn`` attribute is
                    ...
                    - *(dict) --*
                      ...
                      - **File** *(string) --*
                        ...
                        Specifies log files that you want to push to CloudWatch Logs.
                         ...
                         ``File`` can point to a specific file or multiple files (by using wild card
                         characters such as ``/var/log/system.log*`` ). Only the latest file is
                         pushed to CloudWatch Logs, based on file modification time. We recommend
                         that you use wild card characters to specify a series of files of the same
                         type, such as ``access_log.2014-06-01-01`` , ``access_log.2014-06-01-02`` ,
                         and so on by using a pattern like ``access_log.*`` . Don't use a wildcard
                         to match multiple file types, such as ``access_log_80`` and
                         ``access_log_443`` . To specify multiple, different file types, add another
                ...
                - **VolumeConfigurations** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **VolumeType** *(string) --*
                      ...
                      * ``standard`` - Magnetic. Magnetic volumes must have a minimum size of 1 GiB
                      and a maximum size of 1024 GiB.

                      * ``io1`` - Provisioned IOPS (SSD). PIOPS volumes must have a minimum size of
                      4 GiB and a maximum size of 16384 GiB.
                      ...
                      * ``st1`` - Throughput Optimized hard disk drive (HDD). Throughput optimized
                      HDD volumes must have a minimum size of 500 GiB and a maximum size of 16384
                      GiB.

                      * ``sc1`` - Cold HDD. Cold HDD volumes must have a minimum size of 500 GiB and
                      a maximum size of 16384 GiB.
                ...
                - **AutoAssignPublicIps** *(boolean) --*
                  ...
                  address to the layer's instances. For more information, see `How to Edit a Layer
                  <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-basics-edit.html>`__
                  .
                ...
                - **DefaultRecipes** *(dict) --*
                  ...
                  recipes for any or all layers and events. AWS OpsWorks Stacks runs custom event
                  recipes after the standard recipes. ``LayerCustomRecipes`` specifies the custom
                  ...
                  ``.rb`` extension. For example: ``phpapp2::dbsetup`` specifies the ``dbsetup.rb``
              ...
              - *(dict) --*
                ...
                - **UpScaling** *(dict) --*
                  ...
                  - **IgnoreMetricsTime** *(integer) --*
                    ...
                    operation, which typically takes several minutes. ``IgnoreMetricsTime`` allows
                    you to direct AWS OpsWorks Stacks to suppress scaling events long enough to get
    ...
    def describe_permissions(
        ...
        **Request Syntax**
        ...
        :param IamUserArn:
          ...
          The user's IAM ARN. This can also be a federated user's ARN. For more information about
    ...
    def describe_raid_arrays(
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          The instance ID. If you use this parameter, ``DescribeRaidArrays`` returns descriptions of
            ...
            - **RdsDbInstances** *(list) --*
              ...
              - *(dict) --*
                ...
                - **MissingOnRds** *(boolean) --*
                  ...
                  value is set to ``true`` , you must deregister the instance, and then register it
                  again.
    ...
    def describe_service_errors(
        ...
        **Request Syntax**
        ...
        :param StackId:
          ...
          The stack ID. If you use this parameter, ``DescribeServiceErrors`` returns descriptions of
            ...
            - **Stacks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DefaultAvailabilityZone** *(string) --*
                  ...
                  Endpoints <https://docs.aws.amazon.com/general/latest/gr/rande.html>`__ .
    ...
    def describe_volumes(
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          The instance ID. If you use this parameter, ``DescribeVolumes`` returns descriptions of
        ...
        :param RaidArrayId:
          ...
          The RAID array ID. If you use this parameter, ``DescribeVolumes`` returns descriptions of
    ...
    def grant_access(
        ...
        **Request Syntax**
        ...
        :param ValidForInMinutes:
          ...
          of this period, the user will no longer be able to use the credentials to log in. If the
          user is logged in at the time, he or she automatically will be logged out.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Tags** *(dict) --*
              ...
              A set of key-value pairs that contain tag keys and tag values that are attached to a
              stack or layer.
            ...
            - **NextToken** *(string) --*
              ...
              If a paginated request does not return all of the remaining results, this parameter is
              set to a token that you can assign to the request object's ``NextToken`` parameter to
              get the next set of results. If the previous paginated request returned all of the
    ...
    def register_ecs_cluster(
        ...
        `Resource Management
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-ecscluster.html>`__ .
    ...
    def register_instance(
        ...
        .. note::
          ...
          and registering the instance with the stack. ``RegisterInstance`` handles only the second
          step. You should instead use the AWS CLI ``register`` command, which performs the entire
        ...
        CreateInstance API. For example, registered instances must be running a supported
    ...
    def register_volume(
        ...
        calling  DeregisterVolume . For more information, see `Resource Management
        <https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html>`__ .
    ...
    def set_load_based_auto_scaling(
        ...
        information, see `Managing Load with Time-based and Load-based Instances
        ...
        .. note::
          ...
          instances. Load-based auto scaling operates only on the instances from that set, so you
          must ensure that you have created enough instances to handle the maximum anticipated load.
        ...
        **Request Syntax**
        ...
        :param UpScaling:
          ...
          An ``AutoScalingThresholds`` object with the upscaling threshold configuration. If the
          load exceeds these thresholds for a specified amount of time, AWS OpsWorks Stacks starts a
        ...
        :param DownScaling:
          ...
          An ``AutoScalingThresholds`` object with the downscaling threshold configuration. If the
          load falls below these thresholds for a specified amount of time, AWS OpsWorks Stacks
    ...
    def set_permission(
        ...
        **Request Syntax**
        ...
        :param Level:
          ...
          The user's permission level, which must be set to one of the following strings. You cannot
          set your own permissions level.
          ...
          * ``iam_only``
          ...
          For more information about the permissions associated with these levels, see `Managing
          User Permissions
          <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .
    ...
    def stop_instance(self, InstanceId: str, Force: bool = None) -> None:
        ...
        **Request Syntax**
        ...
        :param Force:
          ...
          ``ebs`` , or EBS-backed, adding the ``Force`` parameter to the ``StopInstances`` API call
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> None:
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/tagging.html>`__ in the AWS OpsWorks
        User Guide.
    ...
    def update_elastic_ip(self, ElasticIp: str, Name: str = None) -> None:
        ...
        Management <https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Os:
          ...
          * A supported Windows operating system, such as ``Microsoft Windows Server 2012 R2 Base``
          ...
          The default option is the current Amazon Linux version. If you set this parameter to
          ``Custom`` , you must use the AmiId parameter to specify the custom AMI that you want to
          use. For more information about supported operating systems, see `Operating Systems
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-os.html>`__ . For
          more information about how to use custom AMIs with OpsWorks, see `Using Custom AMIs
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-custom-ami.html>`__
          .
        ...
        :param AmiId:
          ...
          The ID of the AMI that was used to create the instance. The value of this parameter must
          be the same AMI ID that the instance is already using. You cannot apply a new AMI to an
          instance by running UpdateInstance. UpdateInstance does not work on instances that are
          using custom AMIs.
        ...
        :param AgentVersion:
          ...
          * *version_number* - Use the specified agent version. This value overrides the stack's
          default setting. To update the agent version, you must edit the instance configuration and
          specify a new version. AWS OpsWorks Stacks then automatically installs that version on the
          instance.
    ...
    def update_layer(
        ...
        **Request Syntax**
        ...
        :param Shortname:
          ...
          For custom layers only, use this parameter to specify the layer's short name, which is
          used internally by AWS OpsWorks Stacks and by Chef. The short name is also used as the
          name for the directory where your app files are installed. It can have a maximum of 200
        ...
        :param InstallUpdatesOnBoot:
          ...
          default value is ``true`` . To control when updates are installed, set this value to
          ``false`` . You must then update your instances manually by using  CreateDeployment to run
          the ``update_dependencies`` stack command or manually running ``yum`` (Amazon Linux) or
          ``apt-get`` (Ubuntu) on the instances.
    ...
    def update_stack(
        ...
        **Request Syntax**
        ...
        :param CustomJson:
          ...
          A string that contains user-defined, custom JSON. It can be used to override the
          corresponding default stack configuration JSON values or to pass data to recipes. The
          string should be in the following format:
        ...
        :param DefaultSshKeyName:
          ...
          key-pair name, AWS OpsWorks Stacks installs the public key on the instance and you can use
          the private key with an SSH client to log in to the instance. For more information, see
        ...
        :param UseOpsworksSecurityGroups:
          ...
          AWS OpsWorks Stacks provides a standard set of built-in security groups, one for each
          layer, which are associated with layers by default. ``UseOpsworksSecurityGroups`` allows
          you to provide your own custom security groups instead of using the built-in groups.
          ...
          * False - AWS OpsWorks Stacks does not associate built-in security groups with layers. You
          must create appropriate EC2 security groups and associate a security group with each layer
          that you create. However, you can still manually associate a built-in security group with
          a layer on. Custom security groups are required only for those layers that need custom
          settings.
    ...
    @overload
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_waiter(self, waiter_name: Literal["app_exists"]) -> waiter_scope.AppExistsWaiter:
        """
