"Main interface for opsworks ServiceResource"
...
class Layer(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`OpsWorks.Client.describe_layers` to update the attributes of the Layer
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/None>`_
...
class Stack(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`OpsWorks.Client.describe_stacks` to update the attributes of the Stack
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class StackSummary(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        StackSummary resource. Note that the load and reload methods are the same method and can be
...
class ServiceResourceStacksCollection(ResourceCollection):
    ...
    def filter(self, StackIds: List[str] = None) -> List[service_resource_scope.Stack]:
        """
        Creates an iterable of all Stack resources in the collection filtered by kwargs passed to
        method.
...
class StackLayersCollection(ResourceCollection):
    ...
    def filter(self, LayerIds: List[str] = None) -> List[service_resource_scope.Layer]:
        """
        Creates an iterable of all Layer resources in the collection filtered by kwargs passed to
        method.
