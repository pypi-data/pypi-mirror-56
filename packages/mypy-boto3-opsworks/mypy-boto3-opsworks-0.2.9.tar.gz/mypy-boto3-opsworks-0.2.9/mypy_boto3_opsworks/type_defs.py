...
_ClientCloneStackCustomCookbooksSourceTypeDef = TypedDict(
    ...
    {"Type": str, "Url": str, "Username": str, "Password": str, "SshKey": str, "Revision": str},
    total=False,
)
...
class ClientCloneStackCustomCookbooksSourceTypeDef(_ClientCloneStackCustomCookbooksSourceTypeDef):
    ...
    - **Revision** *(string) --*
      ...
      application. One of the simplest approaches is to have branches or revisions in your
      repository that represent different versions that can potentially be deployed.
    """
...
class ClientCreateAppEnvironmentTypeDef(
    _RequiredClientCreateAppEnvironmentTypeDef, _OptionalClientCreateAppEnvironmentTypeDef
):
    """
...
_RequiredClientCreateAppSslConfigurationTypeDef = TypedDict(
    "_RequiredClientCreateAppSslConfigurationTypeDef", {"Certificate": str, "PrivateKey": str}
)
...
class ClientCreateDeploymentCommandTypeDef(
    ...
    - **Args** *(dict) --*
      ...
      The arguments of those commands that take arguments. It should be set to a JSON object with
...
class ClientCreateLayerCloudWatchLogsConfigurationLogStreamsTypeDef(
    ...
    - **LogGroupName** *(string) --*
      ...
      include a-z, A-Z, 0-9, '_' (underscore), '-' (hyphen), '/' (forward slash), and '.' (period).

    - **DatetimeFormat** *(string) --*

      Specifies how the time stamp is extracted from logs. For more information, see the `CloudWatch
    ...
    - **File** *(string) --*
      ...
      Specifies log files that you want to push to CloudWatch Logs.
       ...
       file modification time. We recommend that you use wild card characters to specify a series of
       files of the same type, such as ``access_log.2014-06-01-01`` , ``access_log.2014-06-01-02`` ,
       and so on by using a pattern like ``access_log.*`` . Don't use a wildcard to match multiple
       file types, such as ``access_log_80`` and ``access_log_443`` . To specify multiple, different
       file types, add another log stream entry to the configuration file, so that each log file
    ...
    - **FileFingerprintLines** *(string) --*
      ...
      is used to calculate the fingerprint. Fingerprint lines are not sent to CloudWatch Logs unless
    ...
    - **Encoding** *(string) --*
      ...
      ``utf_8`` . Encodings supported by Python ``codecs.decode()`` can be used here.
    ...
    - **LogStreams** *(list) --*
      ...
      - *(dict) --*
        ...
        - **LogGroupName** *(string) --*
          ...
          Specifies the destination log group. A log group is created automatically if it doesn't
          already exist. Log group names can be between 1 and 512 characters long. Allowed
          characters include a-z, A-Z, 0-9, '_' (underscore), '-' (hyphen), '/' (forward slash), and
          '.' (period).
        ...
        - **File** *(string) --*
          ...
          Specifies log files that you want to push to CloudWatch Logs.
           ...
           based on file modification time. We recommend that you use wild card characters to
        ...
        - **FileFingerprintLines** *(string) --*
          ...
          two dash-delimited numbers, such as '1', '2-5'. The default value is '1', meaning the
          first line is used to calculate the fingerprint. Fingerprint lines are not sent to
...
class ClientDescribeAppsResponseAppsTypeDef(_ClientDescribeAppsResponseAppsTypeDef):
    ...
    - **AppSource** *(dict) --*
      ...
      - **Revision** *(string) --*
        ...
        The application's version. AWS OpsWorks Stacks enables you to easily deploy new versions of
        an application. One of the simplest approaches is to have branches or revisions in your
        repository that represent different versions that can potentially be deployed.
    ...
    - **Environment** *(list) --*
      ...
      .. note::
        ...
        associated data structure - which includes the variable names, values, and protected flag
        values - cannot exceed 20 KB. This limit should accommodate most if not all use cases, but
        if you do exceed it, you will cause an exception (API) with an "Environment: is too large
        (maximum is 20 KB)" message.
      ...
      - *(dict) --*
        ...
        - **Key** *(string) --*
          ...
          must be specified. The name can contain upper- and lowercase letters, numbers, and
        ...
        - **Secure** *(boolean) --*
          ...
          (Optional) Whether the variable's value will be returned by the  DescribeApps action. To
          conceal an environment variable's value, set ``Secure`` to ``true`` . ``DescribeApps``
...
class ClientDescribeDeploymentsResponseDeploymentsTypeDef(
    ...
    - **Command** *(dict) --*
      ...
      - **Name** *(string) --*
        ...
        * ``rollback`` Roll the app back to the previous version. When you update an app, AWS
        OpsWorks Stacks stores the previous version, up to a maximum of five versions. You can use
        this command to roll an app back as many as four versions.
      ...
      - **Args** *(dict) --*
        ...
        * ``allow_reboot`` - Specifies whether to allow AWS OpsWorks Stacks to reboot the instances
        if necessary, after installing the updates. This argument can be set to either ``true`` or
        ``false`` . The default value is ``false`` .
    ...
    - **CustomJson** *(string) --*
      ...
      default stack configuration attribute values for stack or to pass data to recipes. The string
...
class ClientDescribeInstancesResponseInstancesBlockDeviceMappingsEbsTypeDef(
    ...
    """
    Type definition for `ClientDescribeInstancesResponseInstancesBlockDeviceMappings` `Ebs`
...
class ClientDescribeInstancesResponseInstancesBlockDeviceMappingsTypeDef(
    ...
    """
    Type definition for `ClientDescribeInstancesResponseInstances` `BlockDeviceMappings`
...
class ClientDescribeInstancesResponseInstancesReportedOsTypeDef(
    ...
    """
    Type definition for `ClientDescribeInstancesResponseInstances` `ReportedOs`
...
class ClientDescribeInstancesResponseInstancesTypeDef(
    ...
    - **InstallUpdatesOnBoot** *(boolean) --*
      ...
      value is ``true`` . If this value is set to ``false`` , you must then update your instances
...
class ClientDescribeLayersResponseLayersCloudWatchLogsConfigurationLogStreamsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayersCloudWatchLogsConfiguration` `LogStreams`
...
class ClientDescribeLayersResponseLayersCloudWatchLogsConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayers` `CloudWatchLogsConfiguration`
...
class ClientDescribeLayersResponseLayersCustomRecipesTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayers` `CustomRecipes`
...
class ClientDescribeLayersResponseLayersDefaultRecipesTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayers` `DefaultRecipes`
    ...
    **undeploy** , and **shutdown** . For each layer, AWS OpsWorks Stacks runs a set of standard
    recipes for each event. You can also provide custom recipes for any or all layers and events.
    AWS OpsWorks Stacks runs custom event recipes after the standard recipes. ``LayerCustomRecipes``
...
class ClientDescribeLayersResponseLayersLifecycleEventConfigurationShutdownTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayersLifecycleEventConfiguration` `Shutdown`
...
class ClientDescribeLayersResponseLayersLifecycleEventConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayers` `LifecycleEventConfiguration`
...
class ClientDescribeLayersResponseLayersVolumeConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLayersResponseLayers` `VolumeConfigurations`
...
class ClientDescribeLayersResponseLayersTypeDef(_ClientDescribeLayersResponseLayersTypeDef):
    """
    Type definition for `ClientDescribeLayersResponse` `Layers`
      ...
      - **LogStreams** *(list) --*
        ...
        - *(dict) --*
          ...
          - **LogGroupName** *(string) --*
            ...
            Specifies the destination log group. A log group is created automatically if it doesn't
            already exist. Log group names can be between 1 and 512 characters long. Allowed
            characters include a-z, A-Z, 0-9, '_' (underscore), '-' (hyphen), '/' (forward slash),
            and '.' (period).
          ...
          - **File** *(string) --*
            ...
            Specifies log files that you want to push to CloudWatch Logs.
             ...
             ``access_log_443`` . To specify multiple, different file types, add another log stream
             entry to the configuration file, so that each log file type is stored in a different
             log group.
          ...
          - **BatchSize** *(integer) --*
            ...
            Specifies the maximum size of log events in a batch, in bytes, up to 1048576 bytes. The
            default value is 32768 bytes. This size is calculated as the sum of all event messages
    ...
    - **DefaultRecipes** *(dict) --*
      ...
      ``LayerCustomRecipes`` specifies the custom recipes for a particular layer to be run in
      ...
      example: ``phpapp2::dbsetup`` specifies the ``dbsetup.rb`` recipe in the repository's
      ``phpapp2`` folder.
...
class ClientDescribeLayersResponseTypeDef(_ClientDescribeLayersResponseTypeDef):
    """
    Type definition for `ClientDescribeLayers` `Response`
...
class ClientDescribeLoadBasedAutoScalingResponseLoadBasedAutoScalingConfigurationsDownScalingTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeLoadBasedAutoScalingResponseLoadBasedAutoScalingConfigurations` `DownScaling`
    ...
    - **Alarms** *(list) --*
      ...
      Custom Cloudwatch auto scaling alarms, to be used as thresholds. This parameter takes a list
      of up to five alarm names, which are case sensitive and must be in the same region as the
      stack.
...
class ClientDescribeLoadBasedAutoScalingResponseLoadBasedAutoScalingConfigurationsUpScalingTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeLoadBasedAutoScalingResponseLoadBasedAutoScalingConfigurations` `UpScaling`
...
class ClientDescribeLoadBasedAutoScalingResponseLoadBasedAutoScalingConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBasedAutoScalingResponse`
    ...
    - **UpScaling** *(dict) --*
      ...
      - **IgnoreMetricsTime** *(integer) --*
        ...
        until they have been booted and configured. There is no point in raising additional scaling
        events during that operation, which typically takes several minutes. ``IgnoreMetricsTime``
        allows you to direct AWS OpsWorks Stacks to suppress scaling events long enough to get the
      ...
      - **Alarms** *(list) --*
        ...
        .. note::
          ...
          To use custom alarms, you must update your service role to allow
          ``cloudwatch:DescribeAlarms`` . You can either have AWS OpsWorks Stacks update the role
          for you when you first use this feature or you can edit the role manually. For more
          information, see `Allowing AWS OpsWorks Stacks to Act on Your Behalf
          <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-servicerole.html>`__
          .
...
class ClientDescribeOperatingSystemsResponseOperatingSystemsConfigurationManagersTypeDef(
    ...
    """
    Type definition for `ClientDescribeOperatingSystemsResponseOperatingSystems`
...
class ClientDescribeOperatingSystemsResponseOperatingSystemsTypeDef(
    ...
    - **ConfigurationManagers** *(list) --*
      ...
      - *(dict) --*
        ...
        A block that contains information about the configuration manager (Chef) and the versions of
        the configuration manager that are supported for an operating system.
...
class ClientDescribeStacksResponseStacksChefConfigurationTypeDef(
    ...
    A ``ChefConfiguration`` object that specifies whether to enable Berkshelf and the Berkshelf
    version. For more information, see `Create a New Stack
    <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-creating.html>`__ .
...
class ClientDescribeStacksResponseStacksTypeDef(_ClientDescribeStacksResponseStacksTypeDef):
    ...
    - **Region** *(string) --*
      ...
      The stack AWS region, such as "ap-northeast-2". For more information about AWS regions, see
    ...
    - **CustomJson** *(string) --*
      ...
      configuration attribute values or to pass data to recipes. The string should be in the
      following format:
    ...
    - **UseOpsworksSecurityGroups** *(boolean) --*
      ...
      Whether the stack automatically associates the AWS OpsWorks Stacks built-in security groups
    ...
    - **DefaultSshKeyName** *(string) --*
      ...
      A default Amazon EC2 key pair for the stack's instances. You can override this value when you
    ...
    - **DefaultRootDeviceType** *(string) --*
      ...
      but you can override it when you create an instance. For more information, see `Storage for
      the Root Device
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ComponentsAMIs.html#storage-for-the-root-device>`__
      .
    ...
    - **AgentVersion** *(string) --*
      ...
      The agent version. This parameter is set to ``LATEST`` for auto-update. or a version number
...
class ClientDescribeTimeBasedAutoScalingResponseTimeBasedAutoScalingConfigurationsAutoScalingScheduleTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeTimeBasedAutoScalingResponseTimeBasedAutoScalingConfigurations`
    `AutoScalingSchedule`
...
class ClientDescribeTimeBasedAutoScalingResponseTimeBasedAutoScalingConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientDescribeTimeBasedAutoScalingResponse`
...
class ClientGrantAccessResponseTemporaryCredentialTypeDef(
    ...
    - **ValidForInMinutes** *(integer) --*
      ...
      The length of time (in minutes) that the grant is valid. When the grant expires, at the end of
      this period, the user will no longer be able to use the credentials to log in. If they are
...
class ClientUpdateAppEnvironmentTypeDef(
    _RequiredClientUpdateAppEnvironmentTypeDef, _OptionalClientUpdateAppEnvironmentTypeDef
):
    """
...
_RequiredClientUpdateAppSslConfigurationTypeDef = TypedDict(
    "_RequiredClientUpdateAppSslConfigurationTypeDef", {"Certificate": str, "PrivateKey": str}
)
