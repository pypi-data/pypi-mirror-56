"Main interface for opsworks Client"
...
import mypy_boto3_opsworks.client as client_scope
...
class Client(BaseClient):
    ...
    def assign_instance(self, InstanceId: str, LayerIds: List[str]) -> None:
        ...
        * You cannot use this action with instances that were created with AWS OpsWorks Stacks.
         ...
         **Required Permissions** : To use this action, an AWS Identity and Access Management (IAM) user
         must have a Manage permissions level for the stack or an attached policy that explicitly grants
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/AssignInstance>`_
        ...
        **Request Syntax**
        ...
        :param LayerIds: **[REQUIRED]**
          ...
          The layer ID, which must correspond to a custom layer. You cannot assign a registered instance to
          a built-in layer.
    ...
    def assign_volume(self, VolumeId: str, InstanceId: str = None) -> None:
        ...
        first be registered with the stack by calling  RegisterVolume . After you register the volume, you
        must call  UpdateVolume to specify a mount point before calling ``AssignVolume`` . For more
        information, see `Resource Management
        <https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/AssignVolume>`_
    ...
    def associate_elastic_ip(self, ElasticIp: str, InstanceId: str = None) -> None:
        ...
        `Resource Management <https://docs.aws.amazon.com/opsworks/latest/userguide/resources.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/AssociateElasticIp>`_
    ...
    def attach_elastic_load_balancer(
        ...
        """
        Attaches an Elastic Load Balancing load balancer to a specified layer. AWS OpsWorks Stacks does not
        support Application Load Balancer. You can only use Classic Load Balancer with AWS OpsWorks Stacks.
        For more information, see `Elastic Load Balancing
        <https://docs.aws.amazon.com/opsworks/latest/userguide/layers-elb.html>`__ .

        .. note::

          You must create the Elastic Load Balancing instance separately, by using the Elastic Load
          Balancing console, API, or CLI. For more information, see `Elastic Load Balancing Developer Guide
          <https://docs.aws.amazon.com/ElasticLoadBalancing/latest/DeveloperGuide/Welcome.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/AttachElasticLoadBalancer>`_
    ...
    def clone_stack(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-cloning.html>`__ . By default,
         ...
         **Required Permissions** : To use this action, an IAM user must have an attached policy that
         ...
         Permissions <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__
         .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CloneStack>`_
        ...
        **Request Syntax**
        ...
        :param Region:
          ...
          `Regions and Endpoints <https://docs.aws.amazon.com/general/latest/gr/rande.html>`__ .

        :type VpcId: string
        :param VpcId:

          The ID of the VPC that the cloned stack is to be launched into. It must be in the specified
          ...
          * If your account does not support EC2 Classic, the default value is the default VPC for the
          ...
          the value of the other parameter. If you specify neither parameter, AWS OpsWorks Stacks sets these
          ...
          * You must specify a value for ``DefaultSubnetId`` .
          ...
          VPC <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-vpc.html>`__ . For more
          information about default VPC and EC2 Classic, see `Supported Platforms
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-supported-platforms.html>`__ .
        ...
        :param ServiceRoleArn: **[REQUIRED]**
          ...
          The stack AWS Identity and Access Management (IAM) role, which allows AWS OpsWorks Stacks to work
          with AWS resources on your behalf. You must set this parameter to the Amazon Resource Name (ARN)
          for an existing IAM role. If you create a stack by using the AWS OpsWorks Stacks console, it
          creates the role for you. You can obtain an existing stack's IAM ARN programmatically by calling
          ...
          .. note::
            ...
            You must set this parameter to a valid service role ARN or the action will fail; there is no
            default value. You can specify the source stack's service role ARN, if you prefer, but you must
            do so explicitly.
        ...
        :param DefaultOs:
          ...
          * A supported Linux operating system: An Amazon Linux version, such as ``Amazon Linux 2018.03`` ,
          ``Amazon Linux 2017.09`` , ``Amazon Linux 2017.03`` , ``Amazon Linux 2016.09`` , ``Amazon Linux
          ...
          * ``Microsoft Windows Server 2012 R2 Base`` , ``Microsoft Windows Server 2012 R2 with SQL Server
          Express`` , ``Microsoft Windows Server 2012 R2 with SQL Server Standard`` , or ``Microsoft Windows
          ...
          * A custom AMI: ``Custom`` . You specify the custom AMI you want to use when you create instances.
          ...
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-custom-ami.html>`__ .
          ...
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-os.html>`__ .

          .. note::

            You can specify a different Linux operating system for the cloned stack, but you cannot change
        ...
        :param HostnameTheme:
          ...
          generate host names for the stack's instances. By default, ``HostnameTheme`` is set to
        ...
        :param DefaultAvailabilityZone:
          ...
          <https://docs.aws.amazon.com/general/latest/gr/rande.html>`__ . If you also specify a value for
          ``DefaultSubnetId`` , the subnet must be in the same zone. For more information, see the ``VpcId``
        ...
        :param UseOpsworksSecurityGroups:
          ...
          are associated with layers by default. With ``UseOpsworksSecurityGroups`` you can instead provide
          ...
          * False - AWS OpsWorks Stacks does not associate built-in security groups with layers. You must
          create appropriate Amazon Elastic Compute Cloud (Amazon EC2) security groups and associate a
          security group with each layer that you create. However, you can still manually associate a
          built-in security group with a layer on creation; custom security groups are required only for
        ...
        :param CustomCookbooksSource:
          ...
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-creating.html>`__ or `Cookbooks
          and Recipes <https://docs.aws.amazon.com/opsworks/latest/userguide/workingcookbook.html>`__ .
        ...
        :param DefaultSshKeyName:
          ...
          Instance <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-ssh.html>`__ and
          `Managing SSH Access
          <https://docs.aws.amazon.com/opsworks/latest/userguide/security-ssh-access.html>`__ . You can
          override this setting by specifying a different key pair, or no key pair, when you `create an
          instance <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-add.html>`__ .
        ...
        :param DefaultRootDeviceType:
          ...
          but you can override it when you create an instance. For more information, see `Storage for the
          Root Device
    ...
    def create_app(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-creating.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CreateApp>`_
        ...
        **Request Syntax**
        ...
        :param Type: **[REQUIRED]**
          ...
          instances that are members of the corresponding layer. If your app isn't one of the standard
          types, or you prefer to implement your own Deploy recipes, specify ``other`` .
        ...
        :param Environment:
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --* **[REQUIRED]**
              ...
              be specified. The name can contain upper- and lowercase letters, numbers, and underscores (_),
    ...
    def create_deployment(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingapps-deploying.html>`__ and `Run Stack
        Commands <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-commands.html>`__ .

         **Required Permissions** : To use this action, an IAM user must have a Deploy or Manage permissions
         level for the stack, or an attached policy that explicitly grants permissions. For more information
         on user permissions, see `Managing User Permissions
         <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CreateDeployment>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_deployment(
              ...
              Command={
                  'Name':
                  'install_dependencies'|'update_dependencies'|'update_custom_cookbooks'|'execute_recipes'
                  |'configure'|'setup'|'deploy'|'rollback'|'start'|'stop'|'restart'|'undeploy',
                  'Args': {
                      'string': [
                          'string',
                      ]
        ...
        :param Command: **[REQUIRED]**
          ...
          - **Args** *(dict) --*
            ...
            * ``upgrade_os_to`` - Specifies the desired Amazon Linux version for instances whose OS you want
            to upgrade, such as ``Amazon Linux 2016.09`` . You must also set the ``allow_reboot`` argument
            to true.
        ...
        :param CustomJson:
          ...
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workingcookbook-json-override.html>`__ .
    ...
    def create_instance(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-add.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CreateInstance>`_
        ...
        **Request Syntax**
        ...
        :param InstanceType: **[REQUIRED]**
          ...
          currently supported types. For more information, see `Instance Families and Types
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ . The parameter
        ...
        :param Os:
          ...
          * A custom AMI: ``Custom`` .
          ...
          Systems <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-os.html>`__ .
          ...
          about supported operating systems, see `Operating Systems
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-os.html>`__ For more
          information about how to use custom AMIs with AWS OpsWorks Stacks, see `Using Custom AMIs
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-custom-ami.html>`__ .
        ...
        :param Architecture:
          ...
          The instance architecture. The default option is ``x86_64`` . Instance types do not necessarily
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ .
        ...
        :param BlockDeviceMappings:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/block-device-mapping-concepts.html>`__ . Note
        ...
        :param InstallUpdatesOnBoot:
          ...
          is ``true`` . To control when updates are installed, set this value to ``false`` . You must then
        ...
        :param Tenancy:
          ...
          The instance's tenancy option. The default option is no tenancy, or if the instance is running in
          a VPC, inherit tenancy settings from the VPC. The following are valid values for this parameter:
          ``dedicated`` , ``default`` , or ``host`` . Because there are costs associated with changes in
          tenancy options, we recommend that you research tenancy options before choosing them for your
          instances. For more information about dedicated hosts, see `Dedicated Hosts Overview
          <http://aws.amazon.com/ec2/dedicated-hosts/>`__ and `Amazon EC2 Dedicated Hosts
          <http://aws.amazon.com/ec2/dedicated-hosts/>`__ . For more information about dedicated instances,
          see `Dedicated Instances
          <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/dedicated-instance.html>`__ and `Amazon
          EC2 Dedicated Instances <http://aws.amazon.com/ec2/purchasing-options/dedicated-instances/>`__ .
    ...
    def create_layer(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-basics-create.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CreateLayer>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_layer(
              StackId='string',
              Type=
                  'aws-flow-ruby'|'ecs-cluster'|'java-app'|'lb'|'web'|'php-app'|'rails-app'|'nodejs-app'
                  |'memcached'|'db-master'|'monitoring-master'|'custom',
              Name='string',
              Shortname='string',
              Attributes={
                  'string': 'string'
                  ...
                  'LogStreams': [
                      {
                          ...
                          |'cp1026'|'cp1140'|'cp1250'|'cp1251'|'cp1252'|'cp1253'|'cp1254'|'cp1255'|'cp1256'
                          |'cp1257'|'cp1258'|'euc_jp'|'euc_jis_2004'|'euc_jisx0213'|'euc_kr'|'gb2312'|'gbk'
                          |'gb18030'|'hz'|'iso2022_jp'|'iso2022_jp_1'|'iso2022_jp_2'|'iso2022_jp_2004'
                          |'iso2022_jp_3'|'iso2022_jp_ext'|'iso2022_kr'|'latin_1'|'iso8859_2'|'iso8859_3'
                          |'iso8859_4'|'iso8859_5'|'iso8859_6'|'iso8859_7'|'iso8859_8'|'iso8859_9'
                          |'iso8859_10'|'iso8859_13'|'iso8859_14'|'iso8859_15'|'iso8859_16'|'johab'|'koi8_r'
                          |'koi8_u'|'mac_cyrillic'|'mac_greek'|'mac_iceland'|'mac_latin2'|'mac_roman'
                          |'mac_turkish'|'ptcp154'|'shift_jis'|'shift_jis_2004'|'shift_jisx0213'|'utf_32'
        ...
        :param Shortname: **[REQUIRED]**
          ...
          the directory where your app files are installed. It can have a maximum of 200 characters, which
          ...
          `Layer Reference <https://docs.aws.amazon.com/opsworks/latest/userguide/layers.html>`__ .
        ...
        :param CloudWatchLogsConfiguration:
          ...
          - **LogStreams** *(list) --*
            ...
            - *(dict) --*
              ...
              Describes the Amazon CloudWatch logs configuration for a layer. For detailed information about
              members of this data type, see the `CloudWatch Logs Agent Reference
              ...
              - **File** *(string) --*
                ...
                Specifies log files that you want to push to CloudWatch Logs.
                 ...
                 as ``/var/log/system.log*`` ). Only the latest file is pushed to CloudWatch Logs, based on
                 file modification time. We recommend that you use wild card characters to specify a series
              ...
              - **FileFingerprintLines** *(string) --*
                ...
                dash-delimited numbers, such as '1', '2-5'. The default value is '1', meaning the first line
                is used to calculate the fingerprint. Fingerprint lines are not sent to CloudWatch Logs
        ...
        :param CustomJson:
          ...
          installed on the layer's instances. For more information, see `Using Custom JSON
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workingcookbook-json-override.html>`__ .
        ...
        :param AutoAssignElasticIps:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html>`__ to the
          layer's instances. For more information, see `How to Edit a Layer
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-basics-edit.html>`__ .
    ...
    def create_stack(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-edit.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CreateStack>`_
        ...
        **Request Syntax**
        ...
        :param Region: **[REQUIRED]**
          ...
          The stack's AWS region, such as ``ap-south-1`` . For more information about Amazon regions, see
          `Regions and Endpoints <https://docs.aws.amazon.com/general/latest/gr/rande.html>`__ .

          .. note::

            In the AWS CLI, this API maps to the ``--stack-region`` parameter. If the ``--stack-region``
            parameter and the AWS CLI common parameter ``--region`` are set to the same value, the stack
            uses a *regional* endpoint. If the ``--stack-region`` parameter is not set, but the AWS CLI
            ``--region`` parameter is, this also results in a stack with a *regional* endpoint. However, if
            the ``--region`` parameter is set to ``us-east-1`` , and the ``--stack-region`` parameter is set
            to one of the following, then the stack uses a legacy or *classic* region: ``us-west-1,
            us-west-2, sa-east-1, eu-central-1, eu-west-1, ap-northeast-1, ap-southeast-1, ap-southeast-2``
            ...
            practice to choose the regional endpoint that is closest to where you manage AWS, we recommend
            that you use regional endpoints for new stacks. The AWS CLI common ``--region`` parameter always
            specifies a regional API endpoint; it cannot be used to specify a classic AWS OpsWorks Stacks
            region.
        ...
        :param ServiceRoleArn: **[REQUIRED]**
          ...
          The stack's AWS Identity and Access Management (IAM) role, which allows AWS OpsWorks Stacks to
        ...
        :param HostnameTheme:
          ...
          host names for the stack's instances. By default, ``HostnameTheme`` is set to ``Layer_Dependent``
        ...
        :param DefaultRootDeviceType:
          ...
          The default root device type. This value is the default for all instances in the stack, but you
    ...
    def create_user_profile(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/CreateUserProfile>`_
        ...
        **Request Syntax**
        ...
        :param SshUsername:
          ...
          ``my.name`` will be changed to ``myname`` . If you do not specify an SSH user name, AWS OpsWorks
        ...
        :param AllowSelfManagement:
          ...
          information, see `Setting an IAM User's Public SSH Key
    ...
    def delete_app(self, AppId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeleteApp>`_
    ...
    def delete_instance(
        ...
        """
        Deletes a specified instance, which terminates the associated Amazon EC2 instance. You must stop an
        instance before you can delete it.

        For more information, see `Deleting Instances
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-delete.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeleteInstance>`_
    ...
    def delete_layer(self, LayerId: str) -> None:
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-basics-delete.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeleteLayer>`_
    ...
    def delete_stack(self, StackId: str) -> None:
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingstacks-shutting.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeleteStack>`_
    ...
    def delete_user_profile(self, IamUserArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeleteUserProfile>`_
    ...
    def deregister_ecs_cluster(self, EcsClusterArn: str) -> None:
        ...
        Management
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-ecscluster.html#workinglayers-ecscluster-delete>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeregisterEcsCluster>`_
    ...
    def deregister_elastic_ip(self, ElasticIp: str) -> None:
        """
        Deregisters a specified Elastic IP address. The address can then be registered by another stack. For
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeregisterElasticIp>`_
    ...
    def deregister_instance(self, InstanceId: str) -> None:
        ...
        the stack and returns it to your control. This action cannot be used with instances that were
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeregisterInstance>`_
    ...
    def deregister_rds_db_instance(self, RdsDbInstanceArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeregisterRdsDbInstance>`_
    ...
    def deregister_volume(self, VolumeId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DeregisterVolume>`_
        ...
        **Request Syntax**
        ...
        :param VolumeId: **[REQUIRED]**
          ...
          The AWS OpsWorks Stacks volume ID, which is the GUID that AWS OpsWorks Stacks assigned to the
          instance when you registered the volume with the stack, not the Amazon EC2 volume ID.
    ...
    def describe_agent_versions(
        ...
        configuration manager. ``DescribeAgentVersions`` returns a list of available agent versions for the
        specified stack or configuration manager.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeAgentVersions>`_
              ...
              - *(dict) --*
                ...
                - **ConfigurationManager** *(dict) --*
                  ...
                  - **Version** *(string) --*
                    ...
                    The Chef version. This parameter must be set to 12, 11.10, or 11.4 for Linux stacks, and
                    to 12.2 for Windows stacks. The default value for Linux stacks is 11.4.
    ...
    def describe_apps(
         ...
         **Required Permissions** : To use this action, an IAM user must have a Show, Deploy, or Manage
         permissions level for the stack, or an attached policy that explicitly grants permissions. For more
              ...
              - *(dict) --*
                ...
                - **AppSource** *(dict) --*
                  ...
                  - **Revision** *(string) --*
                    ...
                    of an application. One of the simplest approaches is to have branches or revisions in
                    your repository that represent different versions that can potentially be deployed.
                ...
                - **Environment** *(list) --*
                  ...
                  .. note::
                    ...
                    the associated data structure - which includes the variable names, values, and protected
                    flag values - cannot exceed 20 KB. This limit should accommodate most if not all use
                    cases, but if you do exceed it, you will cause an exception (API) with an "Environment:
                  ...
                  - *(dict) --*
                    ...
                    - **Key** *(string) --*
                      ...
                      and must be specified. The name can contain upper- and lowercase letters, numbers, and
                      underscores (_), but it must start with a letter or underscore.

                    - **Value** *(string) --*

                      (Optional) The environment variable's value, which can be left empty. If you specify a
                      value, it can contain up to 256 characters, which must all be printable.
    ...
    def describe_commands(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeCommands>`_
        ...
        **Request Syntax**
        ...
        :param DeploymentId:
          ...
          The deployment ID. If you include this parameter, ``DescribeCommands`` returns a description of
                ...
                'Deployments': [
                    {
                        ...
                        'Command': {
                            'Name':
                            'install_dependencies'|'update_dependencies'|'update_custom_cookbooks'
                            |'execute_recipes'|'configure'|'setup'|'deploy'|'rollback'|'start'|'stop'
                            |'restart'|'undeploy',
                            'Args': {
                                'string': [
                                    'string',
                ...
                - **Command** *(dict) --*
                  ...
                  - **Name** *(string) --*
                    ...
                    * ``execute_recipes`` : Execute one or more recipes. To specify the recipes, set an
                    ...
                    to execute ``phpapp::appsetup`` , set ``Args`` to ``{"recipes":["phpapp::appsetup"]}`` .
                  ...
                  - **Args** *(dict) --*
                    ...
                    * ``allow_reboot`` - Specifies whether to allow AWS OpsWorks Stacks to reboot the
                    instances if necessary, after installing the updates. This argument can be set to either
    ...
    def describe_ecs_clusters(
        ...
        """
        Describes Amazon ECS clusters that are registered with a stack. If you specify only a stack ID, you
        can use the ``MaxResults`` and ``NextToken`` parameters to paginate the response. However, AWS
        OpsWorks Stacks currently supports only one cluster per layer, so the result set has a maximum of
        one element.

         **Required Permissions** : To use this action, an IAM user must have a Show, Deploy, or Manage
         permissions level for the stack or an attached policy that explicitly grants permission. For more
         information about user permissions, see `Managing User Permissions
         <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeEcsClusters>`_
        ...
        **Request Syntax**
        ...
        :param StackId:
          ...
          A stack ID. ``DescribeEcsClusters`` returns a description of the cluster that is registered with
          the stack.

        :type NextToken: string
        :param NextToken:

          If the previous paginated request did not return all of the remaining results, the response
          object's``NextToken`` parameter value is set to a token. To retrieve the next set of results, call
        ...
        :param MaxResults:
          ...
          includes a ``NextToken`` value that you can assign to the ``NextToken`` request parameter to get
    ...
    def describe_elastic_ips(
        ...
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeElasticIps>`_
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          The instance ID. If you include this parameter, ``DescribeElasticIps`` returns a description of
    ...
    def describe_elastic_load_balancers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeElasticLoadBalancers>`_
        ...
        **Request Syntax**
        ...
        :param LayerIds:
          ...
          A list of layer IDs. The action describes the Elastic Load Balancing instances for the specified
          layers.
    ...
    def describe_instances(
        ...
        **Request Syntax**
        ...
        :param InstanceIds:
          ...
          An array of instance IDs to be described. If you use this parameter, ``DescribeInstances`` returns
          a description of the specified instances. Otherwise, it returns a description of every instance.
            ...
            - **Instances** *(list) --*
              ...
              - *(dict) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Ebs** *(dict) --*
                      ...
                      - **VolumeType** *(string) --*
                        ...
                        ``Iops`` attribute. The maximum ratio of provisioned IOPS to requested volume size
                        (in GiB) is 50:1. AWS uses the default volume size (in GiB) specified in the AMI
                        attributes to set IOPS to 50 x (volume size).
                ...
                - **InstallUpdatesOnBoot** *(boolean) --*
                  ...
                  default value is ``true`` . If this value is set to ``false`` , you must then update your
                  instances manually by using  CreateDeployment to run the ``update_dependencies`` stack
                  command or by manually running ``yum`` (Amazon Linux) or ``apt-get`` (Ubuntu) on the
                  instances.
    ...
    def describe_layers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeLayers>`_
                ...
                'Layers': [
                    {
                        ...
                        'LayerId': 'string',
                        'Type':
                        'aws-flow-ruby'|'ecs-cluster'|'java-app'|'lb'|'web'|'php-app'|'rails-app'
                        |'nodejs-app'|'memcached'|'db-master'|'monitoring-master'|'custom',
                        'Name': 'string',
                        'Shortname': 'string',
                        'Attributes': {
                            'string': 'string'
            ...
            - **Layers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Attributes** *(dict) --*
                  ...
                  For an ECS Cluster layer, AWS OpsWorks Stacks the ``EcsClusterArn`` attribute is set to
                  the cluster's ARN.
                    ...
                    - *(dict) --*
                      ...
                      - **File** *(string) --*
                        ...
                        Specifies log files that you want to push to CloudWatch Logs.
                         ...
                         such as ``access_log_80`` and ``access_log_443`` . To specify multiple, different
                         file types, add another log stream entry to the configuration file, so that each
                         log file type is stored in a different log group.
                      ...
                      - **FileFingerprintLines** *(string) --*
                        ...
                        number, or two dash-delimited numbers, such as '1', '2-5'. The default value is '1',
                        meaning the first line is used to calculate the fingerprint. Fingerprint lines are
                      ...
                      - **InitialPosition** *(string) --*
                        ...
                        Specifies where to start to read data (start_of_file or end_of_file). The default is
                        start_of_file. This setting is only used if there is no state persisted for that log
                        stream.

                      - **Encoding** *(string) --*

                        Specifies the encoding of the log file so that the file can be read correctly. The
                        default is ``utf_8`` . Encodings supported by Python ``codecs.decode()`` can be used
                        here.
                      ...
                      - **BatchCount** *(integer) --*
                        ...
                        Specifies the max number of log events in a batch, up to 10000. The default value is
                        1000.
                ...
                - **VolumeConfigurations** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **VolumeType** *(string) --*
                      ...
                      * ``io1`` - Provisioned IOPS (SSD). PIOPS volumes must have a minimum size of 4 GiB
                      and a maximum size of 16384 GiB.

                      * ``gp2`` - General Purpose (SSD). General purpose volumes must have a minimum size of
                      1 GiB and a maximum size of 16384 GiB.
                ...
                - **AutoAssignElasticIps** *(boolean) --*
                  ...
                  Whether to automatically assign an `Elastic IP address
                  <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html>`__ to
                  the layer's instances. For more information, see `How to Edit a Layer
                  <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-basics-edit.html>`__
                  .

                - **AutoAssignPublicIps** *(boolean) --*

                  For stacks that are running in a VPC, whether to automatically assign a public IP address
                ...
                - **DefaultRecipes** *(dict) --*
                  ...
                  **deploy** , **undeploy** , and **shutdown** . For each layer, AWS OpsWorks Stacks runs a
                  set of standard recipes for each event. You can also provide custom recipes for any or all
                  layers and events. AWS OpsWorks Stacks runs custom event recipes after the standard
                  recipes. ``LayerCustomRecipes`` specifies the custom recipes for a particular layer to be
                  ...
                  colons and the recipe name, which is the recipe's file name without the ``.rb`` extension.
                  For example: ``phpapp2::dbsetup`` specifies the ``dbsetup.rb`` recipe in the repository's
                  ``phpapp2`` folder.
    ...
    def describe_load_based_auto_scaling(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeLoadBasedAutoScaling>`_
              ...
              - *(dict) --*
                ...
                - **UpScaling** *(dict) --*
                  ...
                  - **LoadThreshold** *(float) --*
                    ...
                    The load threshold. A value of -1 disables the threshold. For more information about how
                    load is computed, see `Load (computing)
    ...
    def describe_my_user_profile(
         ...
         **Required Permissions** : To use this action, an IAM user must have self-management enabled or an
         attached policy that explicitly grants permissions. For more information about user permissions,
         see `Managing User Permissions
         <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeMyUserProfile>`_
    ...
    def describe_operating_systems(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeOperatingSystems>`_
    ...
    def describe_permissions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribePermissions>`_
        ...
        **Request Syntax**
        ...
        :param IamUserArn:
          ...
          The user's IAM ARN. This can also be a federated user's ARN. For more information about IAM ARNs,
    ...
    def describe_raid_arrays(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeRaidArrays>`_
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          The instance ID. If you use this parameter, ``DescribeRaidArrays`` returns descriptions of the
    ...
    def describe_rds_db_instances(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeRdsDbInstances>`_
        ...
        **Request Syntax**
        ...
        :param StackId: **[REQUIRED]**
          ...
          The ID of the stack with which the instances are registered. The operation returns descriptions of
          all registered Amazon RDS instances.
    ...
    def describe_service_errors(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeServiceErrors>`_
        ...
        **Request Syntax**
        ...
        :param StackId:
          ...
          The stack ID. If you use this parameter, ``DescribeServiceErrors`` returns descriptions of the
          errors associated with the specified stack.

        :type InstanceId: string
        :param InstanceId:

          The instance ID. If you use this parameter, ``DescribeServiceErrors`` returns descriptions of the
    ...
    def describe_stack_provisioning_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeStackProvisioningParameters>`_
    ...
    def describe_stack_summary(
        ...
        """
        Describes the number of layers and apps in a specified stack, and the number of instances in each
        state, such as ``running_setup`` or ``online`` .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeStackSummary>`_
    ...
    def describe_stacks(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeStacks>`_
            ...
            - **Stacks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **CustomJson** *(string) --*
                  ...
                  stack configuration attribute values or to pass data to recipes. The string should be in
                  the following format:
    ...
    def describe_time_based_auto_scaling(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeTimeBasedAutoScaling>`_
    ...
    def describe_user_profiles(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeUserProfiles>`_
    ...
    def describe_volumes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DescribeVolumes>`_
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          The instance ID. If you use this parameter, ``DescribeVolumes`` returns descriptions of the
        ...
        :param RaidArrayId:
          ...
          The RAID array ID. If you use this parameter, ``DescribeVolumes`` returns descriptions of the
    ...
    def detach_elastic_load_balancer(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DetachElasticLoadBalancer>`_
    ...
    def disassociate_elastic_ip(self, ElasticIp: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/DisassociateElasticIp>`_
    ...
    def get_hostname_suggestion(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/GetHostnameSuggestion>`_
    ...
    def grant_access(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/GrantAccess>`_
        ...
        **Request Syntax**
        ...
        :param ValidForInMinutes:
          ...
          period, the user will no longer be able to use the credentials to log in. If the user is logged in
    ...
    def list_tags(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/ListTags>`_
    ...
    def reboot_instance(self, InstanceId: str) -> None:
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-starting.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/RebootInstance>`_
    ...
    def register_ecs_cluster(
        ...
        """
        Registers a specified Amazon ECS cluster with a stack. You can register only one cluster with a
        stack. A cluster can be registered with only one stack. For more information, see `Resource
        Management <https://docs.aws.amazon.com/opsworks/latest/userguide/workinglayers-ecscluster.html>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/RegisterEcsCluster>`_
    ...
    def register_elastic_ip(
        ...
        """
        Registers an Elastic IP address with a specified stack. An address can be registered with only one
        stack at a time. If the address is already registered, you must first deregister it by calling
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/RegisterElasticIp>`_
    ...
    def register_instance(
        ...
        .. note::
          ...
          We do not recommend using this action to register instances. The complete registration operation
          includes two tasks: installing the AWS OpsWorks Stacks agent on the instance, and registering the
          instance with the stack. ``RegisterInstance`` handles only the second step. You should instead use
          the AWS CLI ``register`` command, which performs the entire registration operation. For more
          information, see `Registering an Instance with an AWS OpsWorks Stacks Stack
          <https://docs.aws.amazon.com/opsworks/latest/userguide/registered-instances-register.html>`__ .

        Registered instances have the same requirements as instances that are created by using the
        CreateInstance API. For example, registered instances must be running a supported Linux-based
        operating system, and they must have a supported instance type. For more information about
        requirements for instances that you want to register, see `Preparing the Instance
        <https://docs.aws.amazon.com/opsworks/latest/userguide/registered-instances-register-registering-preparer.html>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/RegisterInstance>`_
        ...
        **Request Syntax**
        ...
        :param RsaPublicKey:
          ...
          The instances public RSA key. This key is used to encrypt communication between the instance and
          the service.
    ...
    def register_rds_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/RegisterRdsDbInstance>`_
    ...
    def register_volume(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/RegisterVolume>`_
    ...
    def set_load_based_auto_scaling(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-autoscaling.html>`__ .

        .. note::

          To use load-based auto scaling, you must create a set of load-based auto scaling instances.
          Load-based auto scaling operates only on the instances from that set, so you must ensure that you
          have created enough instances to handle the maximum anticipated load.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/SetLoadBasedAutoScaling>`_
        ...
        **Request Syntax**
        ...
        :param UpScaling:
          ...
          - **IgnoreMetricsTime** *(integer) --*
            ...
            ignore metrics and suppress additional scaling events. For example, AWS OpsWorks Stacks adds new
            instances following an upscaling event but the instances won't start reducing the load until
            they have been booted and configured. There is no point in raising additional scaling events
            during that operation, which typically takes several minutes. ``IgnoreMetricsTime`` allows you
            to direct AWS OpsWorks Stacks to suppress scaling events long enough to get the new instances
            online.
          ...
          - **LoadThreshold** *(float) --*
            ...
            computed, see `Load (computing) <http://en.wikipedia.org/wiki/Load_%28computing%29>`__ .
          ...
          - **Alarms** *(list) --*
            ...
            .. note::
              ...
              . You can either have AWS OpsWorks Stacks update the role for you when you first use this
              feature or you can edit the role manually. For more information, see `Allowing AWS OpsWorks
    ...
    def set_permission(
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workingsecurity.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/SetPermission>`_
        ...
        **Request Syntax**
        ...
        :param Level:
          ...
          The user's permission level, which must be set to one of the following strings. You cannot set
          your own permissions level.
          ...
          * ``iam_only``
          ...
          For more information about the permissions associated with these levels, see `Managing User
          Permissions
          <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .
    ...
    def set_time_based_auto_scaling(
        ...
        see `Managing Load with Time-based and Load-based Instances
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-autoscaling.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/SetTimeBasedAutoScaling>`_
    ...
    def start_instance(self, InstanceId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/StartInstance>`_
    ...
    def start_stack(self, StackId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/StartStack>`_
    ...
    def stop_instance(self, InstanceId: str, Force: bool = None) -> None:
        ...
        reinstalled when you restart the instance. You can stop an Amazon EBS-backed instance without losing
        data. For more information, see `Starting, Stopping, and Rebooting Instances
        <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-starting.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/StopInstance>`_
        ...
        **Request Syntax**
        ...
        :param Force:
          ...
          EBS-backed, adding the ``Force`` parameter to the ``StopInstances`` API call disassociates the AWS
          OpsWorks Stacks instance from EC2, and forces deletion of *only* the OpsWorks Stacks instance. You
          must also delete the formerly-associated instance in EC2 after troubleshooting and replacing the
    ...
    def stop_stack(self, StackId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/StopStack>`_
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> None:
        ...
        <https://docs.aws.amazon.com/opsworks/latest/userguide/tagging.html>`__ in the AWS OpsWorks User
        Guide.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/TagResource>`_
    ...
    def unassign_instance(self, InstanceId: str) -> None:
        """
        Unassigns a registered instance from all layers that are using the instance. The instance remains in
        the stack as an unassigned instance, and can be assigned to another layer as needed. You cannot use
        this action with instances that were created with AWS OpsWorks Stacks.

         **Required Permissions** : To use this action, an IAM user must have a Manage permissions level for
         the stack or an attached policy that explicitly grants permissions. For more information about user
         permissions, see `Managing User Permissions
         <https://docs.aws.amazon.com/opsworks/latest/userguide/opsworks-security-users.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UnassignInstance>`_
    ...
    def unassign_volume(self, VolumeId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UnassignVolume>`_
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UntagResource>`_
    ...
    def update_app(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateApp>`_
        ...
        **Request Syntax**
        ...
        :param Environment:
          ...
          associated data structure - which includes the variables' names, values, and protected flag values
          - cannot exceed 20 KB. This limit should accommodate most if not all use cases. Exceeding it will
          cause an exception with the message, "Environment: is too large (maximum is 20 KB)."
    ...
    def update_elastic_ip(self, ElasticIp: str, Name: str = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateElasticIp>`_
    ...
    def update_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateInstance>`_
        ...
        **Request Syntax**
        ...
        :param Os:
          ...
          * A supported Windows operating system, such as ``Microsoft Windows Server 2012 R2 Base`` ,
          ...
          The default option is the current Amazon Linux version. If you set this parameter to ``Custom`` ,
          you must use the AmiId parameter to specify the custom AMI that you want to use. For more
          ...
          .. note::
            ...
            You can specify a different Linux operating system for the updated stack, but you cannot change
            from Linux to Windows or Windows to Linux.

        :type AmiId: string
        :param AmiId:

          The ID of the AMI that was used to create the instance. The value of this parameter must be the
          same AMI ID that the instance is already using. You cannot apply a new AMI to an instance by
          running UpdateInstance. UpdateInstance does not work on instances that are using custom AMIs.
        ...
        :param Architecture:
          ...
          The instance architecture. Instance types do not necessarily support both architectures. For a
          list of the architectures that are supported by the different instance types, see `Instance
          Families and Types <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ .
    ...
    def update_layer(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateLayer>`_
        ...
        **Request Syntax**
        ...
        :param CustomInstanceProfileArn:
          ...
          The ARN of an IAM profile to be used for all of the layer's EC2 instances. For more information
    ...
    def update_my_user_profile(self, SshPublicKey: str = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateMyUserProfile>`_
    ...
    def update_rds_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateRdsDbInstance>`_
    ...
    def update_stack(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateStack>`_
        ...
        **Request Syntax**
        ...
        :param DefaultInstanceProfileArn:
          ...
          The ARN of an IAM profile that is the default profile for all of the stack's EC2 instances. For
          more information about IAM ARNs, see `Using Identifiers
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/Using_Identifiers.html>`__ .
        ...
        :param HostnameTheme:
          ...
          The stack's new host name theme, with spaces replaced by underscores. The theme is used to
          generate host names for the stack's instances. By default, ``HostnameTheme`` is set to
          ``Layer_Dependent`` , which creates host names by appending integers to the layer's short name.
          The other themes are:
        ...
        :param DefaultAvailabilityZone:
          ...
          The stack's default Availability Zone, which must be in the stack's region. For more information,
          see `Regions and Endpoints <https://docs.aws.amazon.com/general/latest/gr/rande.html>`__ . If you
        ...
        :param DefaultSshKeyName:
          ...
          A default Amazon EC2 key-pair name. The default value is ``none`` . If you specify a key-pair
          name, AWS OpsWorks Stacks installs the public key on the instance and you can use the private key
          with an SSH client to log in to the instance. For more information, see `Using SSH to Communicate
          with an Instance
          <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-ssh.html>`__ and `Managing
          SSH Access <https://docs.aws.amazon.com/opsworks/latest/userguide/security-ssh-access.html>`__ .
          You can override this setting by specifying a different key pair, or no key pair, when you `create
          an instance <https://docs.aws.amazon.com/opsworks/latest/userguide/workinginstances-add.html>`__ .

        :type DefaultRootDeviceType: string
        :param DefaultRootDeviceType:

          The default root device type. This value is used by default for all instances in the stack, but
          you can override it when you create an instance. For more information, see `Storage for the Root
          Device
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ComponentsAMIs.html#storage-for-the-root-device>`__
          .
        ...
        :param UseOpsworksSecurityGroups:
          ...
          AWS OpsWorks Stacks provides a standard set of built-in security groups, one for each layer, which
          are associated with layers by default. ``UseOpsworksSecurityGroups`` allows you to provide your
          own custom security groups instead of using the built-in groups. ``UseOpsworksSecurityGroups`` has
    ...
    def update_user_profile(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateUserProfile>`_
    ...
    def update_volume(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworks-2013-02-18/UpdateVolume>`_
