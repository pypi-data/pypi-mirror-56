...
class AsphodelNative:
    ...
    def find_tcp_devices(self):
        ...
        # first try
        self.lib.asphodel_tcp_find_devices(array_ptr, byref(count))
    ...
    def tcp_get_advertisement(self, device):
        ...
        return TCPAdvInfo(
            ...
            adv.serial_number.decode("UTF-8"), adv.board_rev,
            adv.board_type.decode("UTF-8"), adv.build_info.decode("UTF-8"),
            adv.build_date.decode("UTF-8"), adv.user_tag1.decode("UTF-8"),
            adv.user_tag2.decode("UTF-8"),
