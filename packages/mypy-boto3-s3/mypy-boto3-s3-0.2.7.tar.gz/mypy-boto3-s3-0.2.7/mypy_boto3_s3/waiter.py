...
class BucketExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`S3.Client.head_bucket` every 5 seconds until a successful state is reached. An error
...
class ObjectExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`S3.Client.head_object` every 5 seconds until a successful state is reached. An error
        is returned after 20 failed checks.
