...
class ServiceResource(Boto3ServiceResource):
    ...
    def BucketLifecycleConfiguration(
        ...
        :type bucket_name: string
        :param bucket_name: The BucketLifecycleConfiguration's bucket_name identifier. This **must**
        be set.
    ...
    def MultipartUploadPart(
        ...
        :param multipart_upload_id: The MultipartUploadPart's multipart_upload_id identifier. This
        **must** be set.
...
class Bucket(Boto3ServiceResource):
    ...
    def wait_until_exists(self, *args: Any, **kwargs: Any) -> None:
        """
        Waits until this Bucket is exists. This method calls :py:meth:`S3.Waiter.bucket_exists.wait`
        which polls. :py:meth:`S3.Client.head_bucket` every 5 seconds until a successful state is
    ...
    def wait_until_not_exists(self, *args: Any, **kwargs: Any) -> None:
        ...
        :py:meth:`S3.Waiter.bucket_not_exists.wait` which polls. :py:meth:`S3.Client.head_bucket`
        every 5 seconds until a successful state is reached. An error is returned after 20 failed
        checks.
...
class BucketAcl(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.get_bucket_acl` to update the attributes of the BucketAcl
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/s3-2006-03-01/None>`_
...
class BucketCors(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.get_bucket_cors` to update the attributes of the BucketCors
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class BucketLifecycle(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        BucketLifecycle resource. Note that the load and reload methods are the same method and can
...
class BucketLifecycleConfiguration(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.get_bucket_lifecycle_configuration` to update the attributes of
        the BucketLifecycleConfiguration resource. Note that the load and reload methods are the
...
class BucketNotification(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.get_bucket_notification_configuration` to update the attributes of
        the BucketNotification resource. Note that the load and reload methods are the same method
...
class BucketPolicy(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.get_bucket_policy` to update the attributes of the BucketPolicy
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class BucketRequestPayment(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        BucketRequestPayment resource. Note that the load and reload methods are the same method and
...
class BucketVersioning(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        BucketVersioning resource. Note that the load and reload methods are the same method and can
        be used interchangeably.
...
class Object(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.head_object` to update the attributes of the Object resource. Note
    ...
    def wait_until_exists(
        ...
        """
        Waits until this Object is exists. This method calls :py:meth:`S3.Waiter.object_exists.wait`
        which polls. :py:meth:`S3.Client.head_object` every 5 seconds until a successful state is
        reached. An error is returned after 20 failed checks.
    ...
    def wait_until_not_exists(
        ...
        :py:meth:`S3.Waiter.object_not_exists.wait` which polls. :py:meth:`S3.Client.head_object`
        every 5 seconds until a successful state is reached. An error is returned after 20 failed
        checks.
...
class ObjectAcl(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`S3.Client.get_object_acl` to update the attributes of the ObjectAcl
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.
...
class ObjectSummary(Boto3ServiceResource):
    ...
    def wait_until_exists(
        ...
        :py:meth:`S3.Waiter.object_exists.wait` which polls. :py:meth:`S3.Client.head_object` every
        5 seconds until a successful state is reached. An error is returned after 20 failed checks.
...
class ServiceResourceBucketsCollection(ResourceCollection):
    ...
    def filter(self, **kwargs: Any) -> List[service_resource_scope.Bucket]:
        """
        Creates an iterable of all Bucket resources in the collection filtered by kwargs passed to
        method.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.Bucket]:
        """
        Creates an iterable of all Bucket resources in the collection, but limits the number of
...
class BucketObjectVersionsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all ObjectVersion resources in the collection filtered by kwargs
        passed to method.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.ObjectVersion]:
        """
        Creates an iterable of all ObjectVersion resources in the collection, but limits the number
...
class BucketObjectsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all ObjectSummary resources in the collection filtered by kwargs
        passed to method.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.ObjectSummary]:
        """
        Creates an iterable of all ObjectSummary resources in the collection, but limits the number
        of items returned by each service call by the specified amount.
...
class MultipartUploadPartsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all MultipartUploadPart resources in the collection filtered by
    ...
    def limit(self, count: int) -> List[service_resource_scope.MultipartUploadPart]:
        """
        Creates an iterable up to a specified amount of MultipartUploadPart resources in the
        collection.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.MultipartUploadPart]:
        """
        Creates an iterable of all MultipartUploadPart resources in the collection, but limits the
        number of items returned by each service call by the specified amount.
