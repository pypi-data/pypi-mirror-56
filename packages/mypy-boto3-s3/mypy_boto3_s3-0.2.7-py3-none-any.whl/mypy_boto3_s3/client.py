...
class Client(BaseClient):
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ETag** *(string) --*
              ...
              data, it will contain one or more nonhexadecimal characters and/or will consist of less than
            ...
            - **SSEKMSKeyId** *(string) --*
              ...
              If present, specifies the ID of the AWS Key Management Service (KMS) customer master key (CMK)
    ...
    def copy_object(
        ...
        .. warning::
          ...
          more information about transfer acceleration, see `Transfer Acceleration
        ...
        S3 using the StorageClass parameter. For more information, see `Storage Classes
        ...
        the 200 OK response. This means that a ``200 OK`` response can contain either a success or an error.
        ...
        * Specify access permissions explicitly with the ``x-amz-grant-read`` , ``x-amz-grant-read-acp`` ,
        ...
        set of permissions that Amazon S3 supports in an ACL. For more information, see `Access Control List
        (ACL) Overview <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html>`__ .
        ...
        * If the source object is encrypted using server-side encryption with customer-provided encryption
        ...
        `Using ACLs <https://docs.aws.amazon.com/AmazonS3/latest/dev/S3_ACLs_UsingACLs.html>`__ . With this
        ...
        **Request Syntax**
        ...
        to copy a specific version.  You can also provide this value as a dictionary.  The dictionary format
        is recommended over the string format because it is more explicit.  The dictionary format is:
        {'Bucket': 'bucket', 'Key': 'key', 'VersionId': 'id'}.  Note that the VersionId key is optional and
        may be omitted.
        ...
        :param SSECustomerKey:
          ...
          is used to store the object and then it is discarded; Amazon does not store the encryption key.
        ...
        :param SSEKMSEncryptionContext:
          ...
          Specifies the AWS KMS Encryption Context to use for object encryption. The value of this header is
    ...
    def create_bucket(
        ...
        .. note::
          ...
          us-east-1 as region, even if the location constraint in the request specifies another region where
          the bucket is to be created. If you create a bucket in a region other than US East (N. Virginia)
          region, your application must be able to handle 307 redirect. For more information, see `Virtual
          Hosting of Buckets <https://docs.aws.amazon.com/AmazonS3/latest/dev/VirtualHosting.html>`__ .
        ...
        * Specify access permissions explicitly using the ``x-amz-grant-read`` , ``x-amz-grant-write`` ,
        ...
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/acl-overview.html>`__ . You specify each grantee as
        a type=value pair, where the type is one of the following:
        ...
        **Request Syntax**
        ...
        :param CreateBucketConfiguration:
          ...
          - **LocationConstraint** *(string) --*
            ...
            Specifies the region where the bucket will be created. If you don't specify a region, the bucket
            is created in US East (N. Virginia) Region (us-east-1).
    ...
    def create_multipart_upload(
        ...
        upload, send one or more requests to upload parts, and then complete the multipart upload process.
        ...
        KMS CMK, then you must have these permissions on the key policy. If your IAM user or role belongs to
        a different account than the key, then you must have the permissions on both the key policy and your
        IAM user or role.
    ...
    def delete_bucket_cors(self, Bucket: str) -> None:
        ...
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/cors.html>`__ in the *Amazon Simple Storage Service
        Developer Guide* .
    ...
    def delete_bucket_website(self, Bucket: str) -> None:
        ...
        them the ``S3:DeleteBucketWebsite`` permission.
    ...
    def delete_objects(
        ...
        object key names, and optionally, version IDs if you want to delete a specific version of the object
        from a versioning-enabled bucket. For each key, Amazon S3 performs a delete operation and returns
        the result of that delete, success, or failure, in the response. Note that, if the object specified
        ...
        verbose mode in which the response includes the result of deletion of each key in your request. In
        quiet mode the response includes only keys where the delete operation encountered an error. For a
        successful deletion, the operation does not return any information about the delete in the response
        body.
        ...
        fail, even if there are non versioned objects you are attempting to delete. If you provide an
                ...
                - **Code** *(string) --*
                  ...
                  *
                    ...
                    * *Description:* The bucket you tried to create already exists, and you own it. Amazon
                    S3 returns this error in all AWS Regions except in the North Virginia region. For legacy
                    compatibility, if you re-create an existing bucket that you already own in the North
                    Virginia region, Amazon S3 returns 200 OK and resets the bucket access control lists
                    (ACLs).
                  ...
                  *
                    ...
                    * *Description:* Indicates that the versioning configuration specified in the request is
                    invalid.
                  ...
                  *
                    ...
                    * *Description:* All access to this object has been disabled. Please contact AWS Support
    ...
    def delete_public_access_block(self, Bucket: str) -> None:
        ...
        you must have the s3:PutBucketPublicAccessBlock permission. For more information about permissions,
    ...
    def get_bucket_analytics_configuration(
        ...
        For information about Amazon S3 analytics feature, see `Amazon S3 Analytics – Storage Class Analysis
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/analytics-storage-class.html>`__ in the *Amazon
        Simple Storage Service Developer Guide* .
    ...
    def get_bucket_inventory_configuration(
        ...
        more information about permissions, see `Permissions Related to Bucket Subresource Operations
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html#using-with-s3-actions-related-to-bucket-subresources>`__
        and `Managing Access Permissions to Your Amazon S3 Resources
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-access-control.html>`__ .
    ...
    def get_bucket_lifecycle(
        ...
        *  DeleteBucketLifecycle
        ...
        .. danger::
            ...
            This operation is deprecated and may not function as expected. This operation should not be used
            going forward and is only kept for the purpose of backwards compatiblity.
    ...
    def get_bucket_lifecycle_configuration(
        ...
        .. note::
          ...
          select a subset of objects to which the rule applies. If you are still using previous version of
          the lifecycle configuration, it works. For the earlier API description, see  GetBucketLifecycle .
                ...
                - *(dict) --*
                  ...
                  - **Destination** *(dict) --*
                    ...
                    - **Account** *(string) --*
                      ...
                      S3 to change replica ownership to the AWS account that owns the destination bucket by
    ...
    def get_object(
        ...
        bucket named examplebucket, specify the resource as
        ...
        information, see `Amazon S3 Torrent
        ...
        * If you don’t have the ``s3:ListBucket`` permission, Amazon S3 will return an HTTP status code 403
        ...
        Amazon S3 accepts when you create an object. The response headers that you can override for the GET
        response are ``Content-Type`` , ``Content-Language`` , ``Expires`` , ``Cache-Control`` ,
    ...
    def get_object_lock_configuration(
        ...
        see `Locking Objects <https://docs.aws.amazon.com/AmazonS3/latest/dev/object-lock.html>`__ .
    ...
    def head_bucket(self, Bucket: str) -> None:
        ...
        operation returns a ``200 OK`` if the bucket exists and you have permission to access it. Otherwise,
        the operation might return responses such as ``404 Not Found`` and ``403 Forbidden`` .
    ...
    def head_object(
        ...
        If you encrypt an object by using server-side encryption with customer-provided encryption keys
        (SSE-C) when you store the object in Amazon S3, then when you retrieve the metadata from the object,
        ...
        **Request Syntax**
        ...
        :param PartNumber:
          ...
          Part number of the object being read. This is a positive integer between 1 and 10,000. Effectively
          performs a 'ranged' HEAD request for the part specified. Useful querying about the size of the
          ...
          - *(dict) --*
            ...
            - **ReplicationStatus** *(string) --*
              ...
              * If requesting object from the destination bucket — Amazon S3 will return the
              x-amz-replication-status header with value REPLICA if object in your request is a replica that
              Amazon S3 created.
            ...
            - **ObjectLockLegalHoldStatus** *(string) --*
              ...
              the requester has the ``s3:GetObjectLegalHold`` permission. This header is not returned if the
              specified version of this object has never had a legal hold applied. For more information
            ...
            - **InventoryConfigurationList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **IncludedObjectVersions** *(string) --*
                  ...
                  ``IsLatest`` , and ``DeleteMarker`` to the list. If set to ``Current`` , the list does not
    ...
    def list_multipart_uploads(
        ...
        further limit the number of uploads in a response by specifying the ``max-uploads`` parameter in the
        response. If additional multipart uploads satisfy the list criteria, the response will contain an
        ``IsTruncated`` element with the value true. To list the additional multipart uploads, use the
        ...
        **Request Syntax**
        ...
        :param KeyMarker:
          ...
          might also be included, provided those multipart uploads have upload IDs lexicographically greater
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Delimiter** *(string) --*
              ...
              The delimeter grouping the included keys. A delimiter is a character that you specify to group
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextMarker** *(string) --*
              ...
              Amazon S3 lists objects in alphabetical order Note: This element is returned only if you have
              delimiter request parameter specified. If response does not include the NextMaker and it is
              truncated, you can use the value of the last Key in the response as the marker in the
            ...
            - **Contents** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ETag** *(string) --*
                  ...
                  The entity tag is an MD5 hash of the object. ETag reflects only changes to the contents of
            ...
            - **Delimiter** *(string) --*
              ...
              rolled-up keys are not returned elsewhere in the response. Each rolled-up result counts as
            ...
            - **CommonPrefixes** *(list) --*
              ...
              the common prefix is notes/summer/. All of the keys that roll up into a common prefix count as
    ...
    def list_objects_v2(
        ...
        selection criteria to return a subset of the objects in a bucket. A ``200 OK`` response can contain
        valid or invalid XML. Make sure to design your application to parse the contents of the response and
        handle it appropriately.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **KeyCount** *(integer) --*
              ...
              equals to MaxKeys field. Say you ask for 50 keys, your result will include less than equals 50
              keys
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AbortDate** *(datetime) --*
              ...
              Using a Bucket Lifecycle Policy
              <https://docs.aws.amazon.com/AmazonS3/latest/dev/mpuoverview.html#mpu-abort-incomplete-mpu-lifecycle-config>`__
              .
            ...
            - **Initiator** *(dict) --*
              ...
              AWS account, this element provides the same information as the Owner element. If the initiator
              is an IAM User, then this element provides the user ARN and display name.
    ...
    def put_bucket_acl(
        ...
        see `Using ACLs <https://docs.aws.amazon.com/AmazonS3/latest/dev/S3_ACLs_UsingACLs.html>`__ . To set
              ...
              - **Destination** *(dict) --* **[REQUIRED]**
                ...
                - **S3BucketDestination** *(dict) --* **[REQUIRED]**
                  ...
                  - **BucketAccountId** *(string) --*
                    ...
                    The account ID that owns the destination bucket. If no account ID is provided, the owner
                    will not be validated prior to exporting data.
    ...
    def put_bucket_encryption(
        ...
        encryption with Amazon S3-managed keys SSE-S3 or AWS KMS customer master keys (CMKs) (SSE-KMS)
        bucket. For information about the Amazon S3 default encryption feature, see As a security
        ...
        **Request Syntax**
        ...
        :param Bucket: **[REQUIRED]**
          ...
          default encryption feature, see `Amazon S3 Default Bucket Encryption
          <https://docs.aws.amazon.com/AmazonS3/latest/dev/bucket-encryption.html>`__ in the *Amazon Simple
          Storage Service Developer Guide* .
            ...
            - *(dict) --*
              ...
              - **ApplyServerSideEncryptionByDefault** *(dict) --*
                ...
                - **KMSMasterKeyID** *(string) --*
                  ...
                  KMS master key ID to use for the default encryption. This parameter is allowed if and only
                  if ``SSEAlgorithm`` is set to ``aws:kms`` .
            ...
            - *(dict) --*
              ...
              - **NoncurrentVersionTransition** *(dict) --*
                ...
                - **NoncurrentDays** *(integer) --*
                  ...
                  Specifies the number of days an object is noncurrent before Amazon S3 can perform the
                  associated action. For information about the noncurrent days calculations, see `How Amazon
                  S3 Calculates When an Object Became Noncurrent
    ...
    def put_bucket_lifecycle_configuration(
        ...
        Your Amazon S3 Resources <https://docs.aws.amazon.com/AmazonS3/latest/dev/s3-access-control.html>`__
        .
        ...
        .. note::
          ...
          prefix, which is supported for backward compatibility. For the related API description, see
          PutBucketLifecycle .
        ...
        * Filter identifying a subset of objects to which the rule applies. The filter can be based on a key
        name prefix, object tags, or a combination of both.
        ...
        * One or more lifecycle transition and expiration actions that you want Amazon S3 to perform on the
        ...
        more noncurrent versions). Amazon S3 provides predefined actions that you can specify for current
        ...
        **Request Syntax**
        ...
        :param BucketLoggingStatus: **[REQUIRED]**
          ...
          - **LoggingEnabled** *(dict) --*
            ...
            a bucket. For more information, see `PUT Bucket logging
            <https://docs.aws.amazon.com/AmazonS3/latest/API/RESTBucketPUTlogging.html>`__ in the *Amazon
            Simple Storage Service API Reference* .
        ...
        **Request Syntax**
        ...
        :param NotificationConfiguration: **[REQUIRED]**
          ...
          - **QueueConfiguration** *(dict) --*
            ...
            to an Amazon Simple Queue Service (Amazon SQS) queue when Amazon S3 detects specified events.
    ...
    def put_bucket_notification_configuration(
        ...
        invoke the function from the Amazon S3 bucket. For more information, see `Configuring Notifications
        for Amazon S3 Events <https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html>`__ .
                  ...
                  - **FilterRules** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **Name** *(string) --*
                        ...
                        and suffixes are not supported. For more information, see `Configuring Event
                        Notifications
                        <https://docs.aws.amazon.com/AmazonS3/latest/dev/NotificationHowTo.html>`__ in the
                        *Amazon Simple Storage Service Developer Guide* .
    ...
    def put_bucket_policy(
        ...
        If you don't have ``PutBucketPolic`` y permissions, Amazon S3 returns a ``403 Access Denied`` error.
        If you have the correct permissions, but you're not using an identity that belongs to the bucket
        owner's account, Amazon S3 returns a ``405 Method Not Allowed`` error.
    ...
    def put_bucket_replication(
        ...
        `Replication <https://docs.aws.amazon.com/AmazonS3/latest/dev/replication.html>`__ in the *Amazon S3
        Developer Guide* .

        .. note::

          To perform this operation, the user or role performing the operation must have the `iam\\:PassRole
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles_use_passrole.html>`__ permission.
        ...
        choose additional subsets of objects to replicate, add a rule for each subset. All rules must
        specify the same destination bucket.

        To specify a subset of the objects in the source bucket to apply a replication rule to, add the
        Filter element as a child of the Rule element. You can filter objects based on an object key prefix,
        one or more object tags, or both. When you add the Filter element in the configuration, you must
        also add the following elements: ``DeleteMarkerReplication`` , ``Status`` , and ``Priority`` .
        ...
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html>`__ and `Managing Access
            ...
            - *(dict) --*
              ...
              - **SourceSelectionCriteria** *(dict) --*
                ...
                - **SseKmsEncryptedObjects** *(dict) --*
                  ...
                  AWS KMS. If you include ``SourceSelectionCriteria`` in the replication configuration, this
                  element is required.

                  - **Status** *(string) --* **[REQUIRED]**

                    Specifies whether Amazon S3 replicates objects created with server-side encryption using
                    a customer master key (CMK) stored in AWS Key Management Service.
              ...
              - **Destination** *(dict) --* **[REQUIRED]**
                ...
                - **ReplicationTime** *(dict) --*
                  ...
                  - **Time** *(dict) --* **[REQUIRED]**
                    ...
                    A container specifying the time by which replication should complete for all objects and
                ...
                - **Metrics** *(dict) --*
                  ...
                  A container specifying replication metrics-related information, including whether emitting
                  metrics and Amazon S3 events for replication are enabled. In addition, contains
              ...
              - **DeleteMarkerReplication** *(dict) --*
                ...
                Specifies whether Amazon S3 replicates the delete markers. If you specify a ``Filter`` , you
                must specify this element. However, in the latest version of replication configuration (when
                ``Filter`` is specified), Amazon S3 doesn't replicate delete markers. Therefore, the
    ...
    def put_bucket_tagging(
        ...
        * Error code: ``OperationAbortedError``
          ...
          * Description: A conflicting conditional operation is currently in progress against this resource.
          Please try again.
          ...
          - **RoutingRules** *(list) --*
            ...
            - *(dict) --*
              ...
              - **Condition** *(dict) --*
                ...
                For example, 1. If request is for pages in the ``/docs`` folder, redirect to the
                ...
                - **KeyPrefixEquals** *(string) --*
                  ...
                  for ``ExamplePage.html`` , the key prefix will be ``ExamplePage.html`` . To redirect
                  request for all pages with the prefix ``docs/`` , the key prefix will be ``/docs`` , which
                  identifies all objects in the docs/ folder. Required when the parent element ``Condition``
                  is specified and sibling ``HttpErrorCodeReturnedEquals`` is not specified. If both
    ...
    def put_object(
        ...
        .. note::
          ...
          To configure your application to send the request headers before sending the request body, use the
          ``100-continue`` HTTP status code. For PUT operations, this helps you avoid sending the message
          body if the message is rejected based on the headers (for example, because authentication fails or
          a redirect occurs). For more information on the ``100-continue`` HTTP status code, see Section
          8.2.3 of `http\\://www.ietf.org/rfc/rfc2616.txt <http://www.ietf.org/rfc/rfc2616.txt>`__ .

        You can optionally request server-side encryption. With server-side encryption, Amazon S3 encrypts
        your data as it writes it to disks in its data centers and decrypts the data when you access it. You
        have the option to provide your own encryption key or use AWS-managed encryption keys. For more
        ...
        * Use customer-provided encryption keys – If you want to manage your own encryption keys, provide
        ...
        object being stored. Amazon S3 returns this ID in the response using the ``x-amz-version-id
        ...
        **Request Syntax**
        ...
        :param ContentEncoding:
          ...
          information, see `http\\://www.w3.org/Protocols/rfc2616/rfc2616-sec14.html#sec14.11
        ...
        :param SSEKMSKeyId:
          ...
          If the x-amz-server-side-encryption is present and has the value of aws:kms, this header specifies
          the ID of the AWS Key Management Service (AWS KMS) customer master key (CMK) that was used for the
          object.

          If the value of x-amz-server-side-encryption is aws:kms, this header specifies the ID of the AWS
          KMS CMK that will be used for the object. If you specify x-amz-server-side-encryption:aws:kms, but
          do not provide x-amz-server-side-encryption-aws-kms-key-id, Amazon S3 uses the AWS managed CMK in
          AWS to protect the data.
    ...
    def put_object_acl(
        ...
        """
        uses the acl subresource to set the access control list (ACL) permissions for an object that already
    ...
    def put_public_access_block(
        ...
        """
        Creates or modifies the ``PublicAccessBlock`` configuration for an Amazon S3 bucket. In order to use
        this operation, you must have the ``s3:PutBucketPublicAccessBlock`` permission. For more information
        about Amazon S3 permissions, see `Specifying Permissions in a Policy
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/using-with-s3-actions.html>`__ .
        ...
        **Request Syntax**
        ...
        :param PublicAccessBlockConfiguration: **[REQUIRED]**
          ...
          - **RestrictPublicBuckets** *(boolean) --*
            ...
            element to ``TRUE`` restricts access to this bucket to only AWS services and authorized users
    ...
    def restore_object(
        ...
        * ``restore an archive`` - Restore an archived object
        ...
        values (CSV) files. You can run queries and custom analytics on your archived data without having to
        restore your data to a hotter Amazon S3 tier. For an overview about select requests, see `Querying
        Archived Objects <https://docs.aws.amazon.com/AmazonS3/latest/dev/querying-glacier-archives.html>`__
        in the *Amazon Simple Storage Service Developer Guide* .
        ...
        * Define an output location for the select query's output. This must be an Amazon S3 bucket in the
        ...
        storage class and encryption for the output objects stored in the bucket. For more information about
        ...
        * Amazon S3 accepts a select request even if the object has already been restored. A select request
        ...
        you must first initiate a restore request. This restores a temporary copy of the archived object. In
        a restore request, you specify the number of days that you want the restored copy to exist. After
        the specified period, Amazon S3 deletes the temporary copy but the object remains archived in the
        GLACIER or DEEP_ARCHIVE storage class that object was restored from.
        ...
        * **``Expedited`` ** - Expedited retrievals allow you to quickly access your data stored in the
        GLACIER storage class when occasional urgent requests for a subset of archives are required. For all
        but the largest archived objects (250 MB+), data accessed using Expedited retrievals are typically
        ...
        * **``Bulk`` ** - Bulk retrievals are Amazon Glacier’s lowest-cost retrieval option, enabling you to
        retrieve large amounts, even petabytes, of data inexpensively in a day. Bulk retrievals typically
        complete within 5-12 hours from the GLACIER storage class and typically complete within 48 hours
        from the DEEP_ARCHIVE storage class.

        For more information about archive retrieval options and provisioned capacity for ``Expedited`` data
        access, see `Restoring Archived Objects
        ...
        with a new period. Amazon S3 updates the restoration period relative to the current time and charges
        only for the request-there are no data transfer charges. You cannot update the restoration period
        when Amazon S3 is actively processing your current restore request for the object.

        If your bucket has a lifecycle configuration with a rule that includes an expiration action, the
        object expiration overrides the life span that you specify in a restore request. For example, if you
        restore an object copy for 10 days, but the object is scheduled to expire in 3 days, Amazon S3
            ...
            - **S3** *(dict) --*
              ...
              - **Encryption** *(dict) --*
                ...
                - **KMSKeyId** *(string) --*
                  ...
                  If the encryption type is aws:kms, this optional value specifies the AWS KMS key ID to use
                  for encryption of job results.
    ...
    def select_object_content(
        ...
        * *Server-side encryption* - Amazon S3 Select supports querying objects that are protected with
        ...
        `Protecting Data Using Server-Side Encryption
        <https://docs.aws.amazon.com/AmazonS3/latest/dev/serv-side-encryption.html>`__ in the *Amazon Simple
        Storage Service Developer Guide* .
        ...
        * GLACIER, DEEP_ARCHIVE and REDUCED_REDUNDANCY storage classes: You cannot specify the GLACIER,
        DEEP_ARCHIVE, or ``REDUCED_REDUNDANCY`` storage classes. For more information, about storage classes
        see `Storage Classes
        ...
        :param InputSerialization: **[REQUIRED]**
          ...
          - **CSV** *(dict) --*
            ...
            - **Comments** *(string) --*
              ...
              at the start of that row. You can specify any character to indicate a comment line.
    ...
    def upload_part(
        ...
        and also defines its position within the object being created. If you upload a new part using the
        same part number that was used with a previous part, the previously uploaded part is overwritten.
        Each part must be at least 5 MB in size, except the last part. There is no size limit on the last
        part of your multipart upload.

        To ensure that data is not corrupted when traversing the network, specify the ``Content-MD5`` header
        in the upload part request. Amazon S3 checks the part data against the provided MD5 value. If they
        do not match, Amazon S3 returns an error.
        ...
        For information on the permissions required to use the multipart upload API, go to `Multipart Upload
        ...
        to disks in its data centers and decrypts it for you when you access it. You have the option of
    ...
    def upload_part_copy(
        ...
        upload limits, go to `Quick Facts <https://docs.aws.amazon.com/AmazonS3/latest/dev/qfacts.html>`__
        in the *Amazon Simple Storage Service Developer Guide* .
        ...
        * For information about copying objects using a single atomic operation vs. the multipart upload, go
        to `Operations on Objects <https://docs.aws.amazon.com/AmazonS3/latest/dev/ObjectOperations.html>`__
        in the *Amazon Simple Storage Service Developer Guide* .

        * For information about using server-side encryption with customer-provided encryption keys with the
        UploadPartCopy operation, see  CopyObject and  UploadPart .
