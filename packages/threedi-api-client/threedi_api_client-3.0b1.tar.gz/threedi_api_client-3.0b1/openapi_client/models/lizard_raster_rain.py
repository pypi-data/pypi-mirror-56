...
class LizardRasterRain(object):
    ...
    def __init__(self, url=None, offset=None, duration=None, units=None, reference_uuid=None, start_datetime=None, simulation=None, multiplier=None, interval=None, origin_offset=None, store_path=None, id=None):  # noqa: E501
    ...
    def store_path(self, store_path):
        ...
        :type: str
        """
        if store_path is not None and len(store_path) < 1:
