...
@click.option('--no-wait', help='Flag to avoid waiting for the traffic switching to finish', type=bool, default=True)
@click.option('--timeout', '-t', help='Duration, in seconds, to wait for traffic switching to finish', default=600,
