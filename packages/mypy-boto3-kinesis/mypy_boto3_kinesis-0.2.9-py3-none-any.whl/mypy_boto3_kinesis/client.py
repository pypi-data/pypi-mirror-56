"Main interface for kinesis Client"
...
class Client(BaseClient):
    ...
    def add_tags_to_stream(self, StreamName: str, Tags: List[str]) -> None:
        ...
        If tags have already been assigned to the stream, ``AddTagsToStream`` overwrites any
        existing tags that correspond to the specified tag keys.

          AddTagsToStream has a limit of five transactions per second per account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/AddTagsToStream>`_
    ...
    def create_stream(self, StreamName: str, ShardCount: int) -> None:
        ...
        continuously emitted from different data sources or *producers* . Scale-out within a stream
        is explicitly supported by means of shards, which are uniquely identified groups of data
        records in a stream.

        You specify and control the number of shards that a stream is composed of. Each shard can
        support reads up to five transactions per second, up to a maximum data read total of 2 MB
        per second. Each shard can support writes up to 1,000 records per second, up to a maximum
        data write total of 1 MB per second. If the amount of data input increases or decreases, you
        can add or remove shards.

        The stream name identifies the stream. The name is scoped to the AWS account used by the
        application. It is also scoped by AWS Region. That is, two streams in two different accounts
        can have the same name, and two streams in the same account, but in two different Regions,
        can have the same name.

         ``CreateStream`` is an asynchronous operation. Upon receiving a ``CreateStream`` request,
         Kinesis Data Streams immediately returns and sets the stream status to ``CREATING`` . After
         the stream is created, Kinesis Data Streams sets the stream status to ``ACTIVE`` . You
        ...
        * Create more shards than are authorized for your account.
        ...
        For the default shard limit for an AWS account, see `Amazon Kinesis Data Streams Limits
        <http://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html>`__ in the
        *Amazon Kinesis Data Streams Developer Guide* . To increase this limit, `contact AWS Support
        <http://docs.aws.amazon.com/general/latest/gr/aws_service_limits.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/CreateStream>`_
        ...
        **Request Syntax**
        ...
        :param StreamName: **[REQUIRED]**
          ...
          A name to identify the stream. The stream name is scoped to the AWS account used by the
          application that creates the stream. It is also scoped by AWS Region. That is, two streams
          in two different AWS accounts can have the same name. Two streams in the same AWS account
    ...
    def decrease_stream_retention_period(self, StreamName: str, RetentionPeriodHours: int) -> None:
        ...
        hours and is decreased to 24 hours, any data already in the stream that is older than 24
        hours is inaccessible.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DecreaseStreamRetentionPeriod>`_
    ...
    def delete_stream(self, StreamName: str, EnforceConsumerDeletion: bool = None) -> None:
        ...
        request, the specified stream is in the ``DELETING`` state until Kinesis Data Streams
        completes the deletion.

         **Note:** Kinesis Data Streams might continue to accept data read and write operations,
         such as  PutRecord ,  PutRecords , and  GetRecords , on a stream in the ``DELETING`` state
        ...
        You can use the  DescribeStream operation to check the state of the stream, which is
        returned in ``StreamStatus`` .

          DeleteStream has a limit of five transactions per second per account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DeleteStream>`_
    ...
    def deregister_stream_consumer(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DeregisterStreamConsumer>`_
    ...
    def describe_limits(self, *args: Any, **kwargs: Any) -> ClientDescribeLimitsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DescribeLimits>`_
    ...
    def describe_stream(
        ...
        objects. For each shard object, there is the hash key and sequence number ranges that the
        shard spans, and the IDs of any earlier shards that played in a role in creating the shard.
        Every record ingested in the stream is identified by a sequence number, which is assigned
        ...
        <http://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-retrieve-shards.html>`__
                ...
                - *(dict) --*
                  ...
                  - **ShardLevelMetrics** *(list) --*
                    ...
                    * ``ALL``
                    ...
                    <http://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html>`__
                    in the *Amazon Kinesis Data Streams Developer Guide* .
    ...
    def describe_stream_consumer(
        ...
        describe, you can use the  ListStreamConsumers operation to get a list of the descriptions
        of all the consumers that are currently registered with a given data stream.

        This operation has a limit of 20 transactions per second per account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DescribeStreamConsumer>`_
    ...
    def describe_stream_summary(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DescribeStreamSummary>`_
    ...
    def disable_enhanced_monitoring(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/DisableEnhancedMonitoring>`_
        ...
        **Request Syntax**
        ...
        :param ShardLevelMetrics: **[REQUIRED]**
          ...
          * ``ALL``
          ...
          CloudWatch
          <http://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html>`__ in the
    ...
    def enable_enhanced_monitoring(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/EnableEnhancedMonitoring>`_
    ...
    def get_records(self, ShardIterator: str, Limit: int = None) -> ClientGetRecordsResponseTypeDef:
        ...
        (for more information, see `Amazon Kinesis Data Streams Limits
        <http://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html>`__ in the
        *Amazon Kinesis Data Streams Developer Guide* ). Your application should have one thread per
        ...
        GetRecords in a loop. Use  GetShardIterator to get the shard iterator to specify in the
        first  GetRecords call.  GetRecords returns a new shard iterator in ``NextShardIterator`` .
        Specify the shard iterator returned in ``NextShardIterator`` in subsequent calls to
        GetRecords . If the shard has been closed, the shard iterator can't return more data and
        GetRecords returns ``null`` in ``NextShardIterator`` . You can terminate the loop when the
        shard is closed, or when the shard iterator reaches the record with the sequence number or
        ...
        You can ensure that your calls don't exceed the maximum supported size or throughput by
        ...
        shard. The maximum size of data that  GetRecords can return is 10 MiB. If a call returns
        this amount of data, subsequent calls made within the next 5 seconds throw
        ``ProvisionedThroughputExceededException`` . If there is insufficient provisioned throughput
        on the stream, subsequent calls made within the next 1 second throw
        ``ProvisionedThroughputExceededException`` .  GetRecords doesn't return any data when it
        throws an exception. For this reason, we recommend that you wait 1 second between calls to
        ...
        metrics and other mechanisms (see `Monitoring
        <http://docs.aws.amazon.com/kinesis/latest/dev/monitoring.html>`__ in the *Amazon Kinesis
        Data Streams Developer Guide* ).

        Each Amazon Kinesis record includes a value, ``ApproximateArrivalTimestamp`` , that is set
        when a stream successfully receives and stores a record. This is commonly referred to as a
        server-side time stamp, whereas a client-side time stamp is set when a data producer creates
        or sends the record to a stream (a data producer is any data source putting data records
        into a stream, for example with  PutRecords ). The time stamp has millisecond precision.
        There are no guarantees about the time stamp accuracy, or that the time stamp is always
        increasing. For example, records in a shard or across a stream might have time stamps that
        are out of order.

        This operation has a limit of five transactions per second per account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/GetRecords>`_
        ...
        **Request Syntax**
        ...
        :param ShardIterator: **[REQUIRED]**
          ...
          A shard iterator specifies this position using the sequence number of a data record in the
          shard.

        :type Limit: integer
        :param Limit:

          The maximum number of records to return. Specify a value of up to 10,000. If you specify a
          value that is greater than 10,000,  GetRecords throws ``InvalidArgumentException`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Records** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Data** *(bytes) --*
                  ...
                  Streams, which does not inspect, interpret, or change the data in the blob in any
                  way. When the data blob (the payload before base64-encoding) is added to the
                  partition key size, the total size must not exceed the maximum record size (1 MB).
            ...
            - **NextShardIterator** *(string) --*
              ...
              If set to ``null`` , the shard has been closed and the requested iterator does not
            ...
            - **MillisBehindLatest** *(integer) --*
              ...
              record processing is caught up, and there are no new records to process at this
              moment.
    ...
    def get_shard_iterator(
        ...
        stream, and is assigned when a record is put into the stream. Each stream has one or more
        shards.

        You must specify the shard iterator type. For example, you can set the ``ShardIteratorType``
        parameter to read exactly from the position denoted by a specific sequence number by using
        the ``AT_SEQUENCE_NUMBER`` shard iterator type. Alternatively, the parameter can read right
        after the sequence number by using the ``AFTER_SEQUENCE_NUMBER`` shard iterator type, using
        sequence numbers returned by earlier calls to  PutRecord ,  PutRecords ,  GetRecords , or
        DescribeStream . In the request, you can specify the shard iterator type ``AT_TIMESTAMP`` to
        read records from an arbitrary point in time, ``TRIM_HORIZON`` to cause ``ShardIterator`` to
        point to the last untrimmed record in the shard in the system (the oldest data record in the
        shard), or ``LATEST`` so that you always read the most recent data in the shard.
        ...
        iterator is returned by every  GetRecords request in ``NextShardIterator`` , which you use
        in the ``ShardIterator`` parameter of the next  GetRecords request.

        If a  GetShardIterator request is made too often, you receive a
        ``ProvisionedThroughputExceededException`` . For more information about throughput limits,
        see  GetRecords , and `Streams Limits
        <http://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html>`__ in the
        *Amazon Kinesis Data Streams Developer Guide* .

        If the shard is closed,  GetShardIterator returns a valid iterator for the last sequence
        number of the shard. A shard can be closed as a result of using  SplitShard or  MergeShards
        .

          GetShardIterator has a limit of five transactions per second per account per open shard.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/GetShardIterator>`_
        ...
        **Request Syntax**
        ...
        :param StartingSequenceNumber:
          ...
          The sequence number of the data record in the shard from which to start reading. Used with
        ...
        :param Timestamp:
          ...
          type AT_TIMESTAMP. A time stamp is the Unix epoch date with precision in milliseconds. For
          example, ``2016-04-04T19:58:46.480-00:00`` or ``1459799926.480`` . If a record with this
    ...
    def increase_stream_retention_period(self, StreamName: str, RetentionPeriodHours: int) -> None:
        ...
        previous, expired data (older than the stream's previous retention period) accessible after
        the operation has been called. For example, if a stream's retention period is set to 24
        hours and is increased to 168 hours, any data that is older than 24 hours remains
        inaccessible to consumer applications.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/IncreaseStreamRetentionPeriod>`_
    ...
    def list_shards(
        ...
        limit of 100 transactions per second per data stream.

        .. warning::

          This API is a new operation that is used by the Amazon Kinesis Client Library (KCL). If
          you have a fine-grained IAM policy that only allows specific operations, you must update
          your policy to allow calls to this API. For more information, see `Controlling Access to
          Amazon Kinesis Data Streams Resources Using IAM
          <https://docs.aws.amazon.com/streams/latest/dev/controlling-access.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/ListShards>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          .. warning::
            ...
            specify an expired token in a call to ``ListShards`` , you get
        ...
        :param MaxResults:
          ...
          The maximum number of shards to return in a single call to ``ListShards`` . The minimum
          value you can specify for this parameter is 1, and the maximum is 1,000, which is also the
          default.
        ...
        :param StreamCreationTimestamp:
          ...
          example, if you create a data stream and then delete it, and you later create another data
          stream with the same name, you can use this input parameter to specify which of the two
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Shards** *(list) --*
              ...
              Each object also contains the starting and ending hash keys and the starting and
              ending sequence numbers for the shard.
            ...
            - **NextToken** *(string) --*
              ...
              is less than the number of shards in the data stream, the response includes a
              pagination token named ``NextToken`` . You can specify this ``NextToken`` value in a
              subsequent call to ``ListShards`` to list the next set of shards. For more information
              about the use of this pagination token when calling the ``ListShards`` operation, see
    ...
    def list_stream_consumers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/ListStreamConsumers>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          stream, the response includes a pagination token named ``NextToken`` . You can specify
          this ``NextToken`` value in a subsequent call to ``ListStreamConsumers`` to list the next
          ...
          You can optionally specify a value for the ``MaxResults`` parameter when you specify
          ``NextToken`` . If you specify a ``MaxResults`` value that is less than the number of
          consumers that the operation returns if you don't specify ``MaxResults`` , the response
          will contain a new ``NextToken`` value. You can use the new ``NextToken`` value in a
          subsequent call to the ``ListStreamConsumers`` operation to list the next set of
          consumers.

          .. warning::

            Tokens expire after 300 seconds. When you obtain a value for ``NextToken`` in the
            response to a call to ``ListStreamConsumers`` , you have 300 seconds to use that value.
            If you specify an expired token in a call to ``ListStreamConsumers`` , you get
            ``ExpiredNextTokenException`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Consumers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ConsumerARN** *(string) --*
                  ...
                  This is important to keep in mind if you have IAM policies that reference consumer
                  ARNs.
            ...
            - **NextToken** *(string) --*
              ...
              the default value for the ``MaxResults`` parameter, or if you explicitly specify a
              value for ``MaxResults`` that is less than the number of registered consumers, the
              ...
              set of registered consumers. For more information about the use of this pagination
              token when calling the ``ListStreamConsumers`` operation, see
    ...
    def list_streams(
        ...
        The number of streams may be too large to return from a single call to ``ListStreams`` . You
        can limit the number of returned streams using the ``Limit`` parameter. If you do not
        specify a value for the ``Limit`` parameter, Kinesis Data Streams uses the default limit,
        which is currently 10.

        You can detect if there are more streams available to list by using the ``HasMoreStreams``
        flag from the returned output. If there are more streams available, you can request more
        streams by using the name of the last stream returned by the ``ListStreams`` request in the
        ``ExclusiveStartStreamName`` parameter in a subsequent request to ``ListStreams`` . The
        group of stream names returned by the subsequent request is then added to the list. You can
        continue this process until all the stream names have been collected in the list.

          ListStreams has a limit of five transactions per second per account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/ListStreams>`_
    ...
    def list_tags_for_stream(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/ListTagsForStream>`_
        ...
        **Request Syntax**
        ...
        :param Limit:
          ...
          associated with the stream, ``HasMoreTags`` is set to ``true`` . To list additional tags,
    ...
    def merge_shards(self, StreamName: str, ShardToMerge: str, AdjacentShardToMerge: str) -> None:
        ...
        reduce the stream's capacity to ingest and transport data. Two shards are considered
        adjacent if the union of the hash key ranges for the two shards form a contiguous set with
        no gaps. For example, if you have two shards, one with a hash key range of 276...381 and the
        other with a hash key range of 382...454, then you could merge these two shards into a
        ...
        child shard receives data for all hash key values covered by the two parent shards.
         ...
         Two Shards
         <http://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-resharding-merge.html>`__
         in the *Amazon Kinesis Data Streams Developer Guide* .

        If the stream is in the ``ACTIVE`` state, you can call ``MergeShards`` . If a stream is in
        the ``CREATING`` , ``UPDATING`` , or ``DELETING`` state, ``MergeShards`` returns a
        ``ResourceInUseException`` . If the specified stream does not exist, ``MergeShards`` returns
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/MergeShards>`_
    ...
    def put_record(
        ...
        The partition key is used by Kinesis Data Streams to distribute data across shards. Kinesis
        Data Streams segregates the data records that belong to a stream into multiple shards, using
        the partition key associated with each data record to determine the shard to which a given
        data record belongs.

        Partition keys are Unicode strings, with a maximum length limit of 256 characters for each
        key. An MD5 hash function is used to map partition keys to 128-bit integer values and to map
        ...
        the ``ExplicitHashKey`` parameter. For more information, see `Adding Data to a Stream
        <http://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-add-data-to-stream>`__
        in the *Amazon Kinesis Data Streams Developer Guide* .
        ...
        Sequence numbers increase over time and are specific to a shard within a stream, not across
        all shards within a stream. To guarantee strictly increasing ordering, write serially to a
        shard and use the ``SequenceNumberForOrdering`` parameter. For more information, see `Adding
        Data to a Stream
        <http://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-add-data-to-stream>`__
        in the *Amazon Kinesis Data Streams Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/PutRecord>`_
        ...
        **Request Syntax**
        ...
        :param PartitionKey: **[REQUIRED]**
          ...
          Data Streams uses the partition key as input to a hash function that maps the partition
          key and associated data to a specific shard. Specifically, an MD5 hash function is used to
          map partition keys to 128-bit integer values and to map associated data records to shards.
          As a result of this hashing mechanism, all data records with the same partition key map to
        ...
        :param SequenceNumberForOrdering:
          ...
          same partition key. Usage: set the ``SequenceNumberForOrdering`` of record *n* to the
          sequence number of record *n-1* (as returned in the result when putting record *n-1* ). If
    ...
    def put_records(
        ...
        as large as 1 MB, up to a limit of 5 MB for the entire request, including partition keys.
        ...
        an array of request ``Records`` , with each record in the array requiring a partition key
        and data blob. The record size limit applies to the total size of the partition key and data
        blob.
        ...
        same shard within the stream. For more information, see `Adding Data to a Stream
        <http://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-add-data-to-stream>`__
        in the *Amazon Kinesis Data Streams Developer Guide* .
        ...
        to determine explicitly the shard where the record is stored. For more information, see
        `Adding Multiple Records with PutRecords
        <http://docs.aws.amazon.com/kinesis/latest/dev/developing-producers-with-sdk.html#kinesis-using-sdk-java-putrecords>`__
        in the *Amazon Kinesis Data Streams Developer Guide* .

        The ``PutRecords`` response includes an array of response ``Records`` . Each record in the
        response array directly correlates with a record in the request array using natural
        ordering, from the top to the bottom of the request and response. The response ``Records``
        ...
        ``SequenceNumber`` parameter is an identifier assigned to the put record, unique to all
        ...
        throttled. For more information about partially successful responses, see `Adding Multiple
        Records with PutRecords
        <http://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-add-data-to-stream.html#kinesis-using-sdk-java-putrecords>`__
        in the *Amazon Kinesis Data Streams Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/PutRecords>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Records** *(list) --*
              ...
              the request by natural ordering. A record that is successfully added to a stream
              ...
              - *(dict) --*
                ...
                - **ErrorMessage** *(string) --*
                  ...
                  account ID, stream name, and shard ID. An ``ErrorCode`` value of
            ...
            - **EncryptionType** *(string) --*
              ...
              * ``KMS`` : Use server-side encryption on the records using a customer-managed AWS KMS
              key.
    ...
    def register_stream_consumer(
        ...
        you register can read data from the stream at a rate of up to 2 MiB per second. This rate is
        unaffected by the total number of consumers that read from the same stream.

        You can register up to 5 consumers per stream. A given consumer can only be registered with
        one stream.

        This operation has a limit of five transactions per second per account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/RegisterStreamConsumer>`_
        ...
        **Request Syntax**
        ...
        :param StreamARN: **[REQUIRED]**
          ...
          info, see `Amazon Resource Names (ARNs) and AWS Service Namespaces
          <https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-kinesis-streams>`__
          .
    ...
    def remove_tags_from_stream(self, StreamName: str, TagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/RemoveTagsFromStream>`_
    ...
    def split_shard(self, StreamName: str, ShardToSplit: str, NewStartingHashKey: str) -> None:
        ...
        sending more than previously anticipated. You can also call ``SplitShard`` to increase
        stream capacity, so that more Kinesis Data Streams applications can simultaneously read data
        ...
        shard where the shard gets split in two. In many cases, the new hash key might be the
        average of the beginning and ending hash key, but it can be any hash key value in the range
        being mapped into the shard. For more information, see `Split a Shard
        <http://docs.aws.amazon.com/kinesis/latest/dev/kinesis-using-sdk-java-resharding-split.html>`__
        in the *Amazon Kinesis Data Streams Developer Guide* .
        ...
        ``SplitShard`` request.
         ...
         Kinesis Data Streams immediately returns a response and sets the stream status to
         ``UPDATING`` . After the operation is completed, Kinesis Data Streams sets the stream
         status to ``ACTIVE`` . Read and write operations continue to work while the stream is in
         the ``UPDATING`` state.
        ...
        ``ResourceNotFoundException`` . If you try to create more shards than are authorized for
        ...
        *Amazon Kinesis Data Streams Developer Guide* . To increase this limit, `contact AWS Support
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/SplitShard>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def start_stream_encryption(self, StreamName: str, EncryptionType: str, KeyId: str) -> None:
        """
        ...
        records written to the stream are encrypted. After you enable encryption, you can verify
        that encryption is applied by inspecting the API response from ``PutRecord`` or
        ``PutRecords`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/StartStreamEncryption>`_
        ...
        **Request Syntax**
        ...
        :param KeyId: **[REQUIRED]**
          ...
          globally unique identifier, a fully specified Amazon Resource Name (ARN) to either an
          alias or a key, or an alias name prefixed by "alias/".You can also use a master key owned
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def stop_stream_encryption(self, StreamName: str, EncryptionType: str, KeyId: str) -> None:
        """
        ...
        Streams returns immediately and sets the status of the stream to ``UPDATING`` . After the
        update is complete, Kinesis Data Streams sets the status of the stream back to ``ACTIVE`` .
        Stopping encryption normally takes a few seconds to complete, but it can take minutes. You
        can continue to read and write data to your stream while its status is ``UPDATING`` . Once
        the status of the stream is ``ACTIVE`` , records written to the stream are no longer
        encrypted by Kinesis Data Streams.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/StopStreamEncryption>`_
    ...
    def subscribe_to_shard(
        ...
        ConsumerARN: str,
        ShardId: str,
        StartingPosition: ClientSubscribeToShardStartingPositionTypeDef,
    ) -> Dict:
        """
        Call this operation from your consumer after you call  RegisterStreamConsumer to register
        the consumer with Kinesis Data Streams. If the call succeeds, your consumer starts receiving
        events of type  SubscribeToShardEvent for up to 5 minutes, after which time you need to call
        ``SubscribeToShard`` again to renew the subscription if you want to continue to receive
        records.

        You can make one call to ``SubscribeToShard`` per second per ``ConsumerARN`` . If your call
        succeeds, and then you call the operation again less than 5 seconds later, the second call
        generates a  ResourceInUseException . If you call the operation a second time more than 5
        seconds after the first call succeeds, the second call succeeds and the first connection
        gets shut down.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/SubscribeToShard>`_
          ...
          - *(dict) --*
            ...
            - **EventStream** (:class:`.EventStream`) --
              ...
              - **SubscribeToShardEvent** *(dict) --*
                ...
                After you call  SubscribeToShard , Kinesis Data Streams sends events of this type to
                your consumer.
                ...
                - **MillisBehindLatest** *(integer) --*
                  ...
                  that record processing is caught up, and there are no new records to process at
                  this moment.
              ...
              - **KMSInvalidStateException** *(dict) --*
                ...
                Master Key <http://docs.aws.amazon.com/kms/latest/developerguide/key-state.html>`__
              ...
              - **KMSThrottlingException** *(dict) --*
                ...
                <http://docs.aws.amazon.com/kms/latest/developerguide/limits.html#requests-per-second>`__
                in the *AWS Key Management Service Developer Guide* .
    ...
    def update_shard_count(
        ...
        Data Streams returns immediately and sets the status of the stream to ``UPDATING`` . After
        the update is complete, Kinesis Data Streams sets the status of the stream back to
        ``ACTIVE`` . Depending on the size of the stream, the scaling action could take a few
        minutes to complete. You can continue to read and write data to your stream while its status
        is ``UPDATING`` .

        To update the shard count, Kinesis Data Streams performs splits or merges on individual
        shards. This can cause short-lived shards to be created, in addition to the final shards. We
        recommend that you double or halve the shard count, as this results in the fewest number of
        splits or merges.
        ...
        * Scale up to more than the shard limit for your account
        ...
        <http://docs.aws.amazon.com/kinesis/latest/dev/service-sizes-and-limits.html>`__ in the
        *Amazon Kinesis Data Streams Developer Guide* . To request an increase in the call rate
        limit, the shard limit for this API, or your overall shard limit, use the `limits form
        <https://console.aws.amazon.com/support/v1#/case/create?issueType=
            service-limit-increase&limitType=service-code-kinesis>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesis-2013-12-02/UpdateShardCount>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_stream` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_shards` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_stream_consumers` operation.
        """
