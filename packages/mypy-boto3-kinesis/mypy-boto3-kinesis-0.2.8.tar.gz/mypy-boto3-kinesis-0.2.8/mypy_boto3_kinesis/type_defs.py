...
class ClientDescribeStreamConsumerResponseConsumerDescriptionTypeDef(
    ...
    - **ConsumerARN** *(string) --*
      ...
      When you register a consumer, Kinesis Data Streams generates an ARN for it. You need this ARN
      to be able to call  SubscribeToShard .
...
class ClientDescribeStreamResponseStreamDescriptionEnhancedMonitoringTypeDef(
    ...
    - **ShardLevelMetrics** *(list) --*
      ...
      * ``ALL``
      ...
      CloudWatch <http://docs.aws.amazon.com/kinesis/latest/dev/monitoring-with-cloudwatch.html>`__
...
class ClientDescribeStreamSummaryResponseStreamDescriptionSummaryEnhancedMonitoringTypeDef(
    ...
    """
    Type definition for `ClientDescribeStreamSummaryResponseStreamDescriptionSummary`
    `EnhancedMonitoring`
...
class ClientGetRecordsResponseRecordsTypeDef(_ClientGetRecordsResponseRecordsTypeDef):
    ...
    - **Data** *(bytes) --*
      ...
      which does not inspect, interpret, or change the data in the blob in any way. When the data
      blob (the payload before base64-encoding) is added to the partition key size, the total size
...
class ClientPutRecordsResponseRecordsTypeDef(_ClientPutRecordsResponseRecordsTypeDef):
    ...
    record that fails to be added to the stream includes ``ErrorCode`` and ``ErrorMessage`` in the
    result.
...
class DescribeStreamPaginateResponseStreamDescriptionShardsSequenceNumberRangeTypeDef(
    ...
    """
    Type definition for `DescribeStreamPaginateResponseStreamDescriptionShards`
    `SequenceNumberRange`
