...
p1.title(r'Rouse dynamics \n(NO hydrodynamic interaction)', size=1)
...
p0.xaxis(min=0.0, max=qmax, scale='n', label='q / nm\S-1')
...
p3.title(r'Zimm dynamics \n(incl hydrodynamic interaction)', size=1)
...
p2.xaxis(min=0.0, max=qmax, scale='n', label='q / nm\S-1')
p3.legend(x=29.3, y=1.0, charsize=0.5)
