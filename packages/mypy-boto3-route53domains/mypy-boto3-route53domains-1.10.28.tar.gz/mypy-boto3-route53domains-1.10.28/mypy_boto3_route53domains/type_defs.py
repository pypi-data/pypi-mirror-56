...
_ClientRegisterDomainRegistrantContactExtraParamsTypeDef = TypedDict(
    "_ClientRegisterDomainRegistrantContactExtraParamsTypeDef", {"Name": str, "Value": str}
)
...
_ClientTransferDomainRegistrantContactExtraParamsTypeDef = TypedDict(
    "_ClientTransferDomainRegistrantContactExtraParamsTypeDef", {"Name": str, "Value": str}
)
...
_ClientUpdateDomainContactAdminContactExtraParamsTypeDef = TypedDict(
    "_ClientUpdateDomainContactAdminContactExtraParamsTypeDef", {"Name": str, "Value": str}
)
...
_ClientUpdateDomainContactRegistrantContactExtraParamsTypeDef = TypedDict(
    "_ClientUpdateDomainContactRegistrantContactExtraParamsTypeDef", {"Name": str, "Value": str}
)
...
_ClientUpdateDomainContactTechContactExtraParamsTypeDef = TypedDict(
    "_ClientUpdateDomainContactTechContactExtraParamsTypeDef", {"Name": str, "Value": str}
)
...
_ClientViewBillingResponseBillingRecordsTypeDef = TypedDict(
    ...
    {"DomainName": str, "Operation": str, "InvoiceId": str, "BillDate": datetime, "Price": float},
    total=False,
)
...
class ClientViewBillingResponseBillingRecordsTypeDef(
    ...
    - **DomainName** *(string) --*
      ...
      characters other than a-z, 0-9, and - (hyphen), such as an internationalized domain name, then
      this value is in Punycode. For more information, see `DNS Domain Name Format
