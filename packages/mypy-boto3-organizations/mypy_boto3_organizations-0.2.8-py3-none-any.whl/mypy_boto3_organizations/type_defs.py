...
class ClientCreateOrganizationalUnitResponseOrganizationalUnitTypeDef(
    ...
    - **Id** *(string) --*
      ...
      contains the OU) followed by a second "-" dash and from 8 to 32 additional lower-case letters
      or digits.
...
class ClientListHandshakesForAccountResponseHandshakesTypeDef(
    ...
    originator) invites another account (the recipient) to join its organization, the two accounts
