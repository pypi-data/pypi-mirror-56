...
class Client(BaseClient):
    ...
    def accept_handshake(self, HandshakeId: str) -> ClientAcceptHandshakeResponseTypeDef:
        ...
        * **Invitation to join** or **Approve all features request** handshakes: only a principal
        from the member account.  The user who calls the API for an invitation to join must have the
        ``organizations:AcceptHandshake`` permission. If you enabled all features in the
        organization, the user must also have the ``iam:CreateServiceLinkedRole`` permission so that
        AWS Organizations can create the required service-linked role named
        ...
        * **Enable all features final confirmation** handshake: only a principal from the master
        account. For more information about invitations, see `Inviting an AWS Account to Join Your
        Organization
        <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_invites.html>`__
        in the *AWS Organizations User Guide.* For more information about requests to enable all
        features in the organization, see `Enabling All Features in Your Organization
                    ...
                    'Resources': [
                        {
                            'Value': 'string',
                            'Type':
                            'ACCOUNT'|'ORGANIZATION'|'ORGANIZATION_FEATURE_SET'
          ...
          - *(dict) --*
            ...
            - **Handshake** *(dict) --*
              ...
              - **State** *(string) --*
                ...
                * **REQUESTED** : This handshake was sent to multiple recipients (applicable to only
    ...
    def attach_policy(self, PolicyId: str, TargetId: str) -> None:
        ...
        * For more information about attaching SCPs, see `How SCPs Work
        <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_about-scps.html>`__
        in the *AWS Organizations User Guide.*

        * For information about attaching tag policies, see `How Policy Inheritance Works
        <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies-inheritance.html>`__
        in the *AWS Organizations User Guide.*
        ...
        **Request Syntax**
        ...
        :param PolicyId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the policy that you want to attach to the target. You can
          get the ID for the policy by calling the  ListPolicies operation.

          The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a policy ID string requires
          "p-" followed by from 8 to 128 lowercase letters or digits.

        :type TargetId: string
        :param TargetId: **[REQUIRED]**

          The unique identifier (ID) of the root, OU, or account that you want to attach the policy
          to. You can get the ID by calling the  ListRoots ,  ListOrganizationalUnitsForParent , or
          ...
          * **Organizational unit (OU)** - A string that begins with "ou-" followed by from 4 to 32
          lowercase letters or digits (the ID of the root that the OU is in). This string is
    ...
    def cancel_handshake(self, HandshakeId: str) -> ClientCancelHandshakeResponseTypeDef:
        ...
        recipient of the handshake can't cancel it, but can use  DeclineHandshake instead. After a
        handshake is canceled, the recipient can no longer respond to that handshake.
        ...
        **Request Syntax**
        ...
        :param HandshakeId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the handshake that you want to cancel. You can get the ID
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def create_account(
        self, Email: str, AccountName: str, RoleName: str = None, IamUserAccessToBilling: str = None
    ) -> ClientCreateAccountResponseTypeDef:
        """
        ...
        Because ``CreateAccount`` operates asynchronously, it can return a successful completion
        message even though account initialization might still be in progress. You might need to
        wait a few minutes before you can successfully access the account. To check the status of
        ...
        * Check the AWS CloudTrail log for the ``CreateAccountResult`` event. For information on
        using AWS CloudTrail with AWS Organizations, see `Monitoring the Activity in Your
        Organization
        <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_monitoring.html>`__ in the
        *AWS Organizations User Guide.*

        The user who calls the API to create an account must have the
        ``organizations:CreateAccount`` permission. If you enabled all features in the organization,
        ...
        ``OrganizationAccountAccessRole`` by default) that grants users in the master account
        administrator permissions in the new member account. Principals in the master account can
        ...
        Organization
        <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_create.html>`__
        in the *AWS Organizations User Guide.*

        .. warning::

          * When you create an account in an organization, the information required for the account
          to operate as a standalone account is *not* automatically collected. For example,
          information about the payment method and signing the end user license agreement (EULA) is
          not collected. If you must remove an account from your organization later, you can do so
          only after you provide the missing information. Follow the steps at `To leave an
          ...
          * If you get an exception that indicates that the operation failed because your
          ...
          persists, contact `AWS Support <https://console.aws.amazon.com/support/home#/>`__ .
          ...
          * Using ``CreateAccount`` to create multiple temporary accounts isn't recommended. You can
          ...
          <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_close.html>`__
          in the *AWS Organizations User Guide* .

        .. note::

          When you create a member account with this operation, you can choose whether to create the
          account with the **IAM User and Role Access to Billing Information** switch enabled. If
          ...
          billing information. For information about how to disable this switch for an account, see
          `Granting Access to Your Billing Information and Tools
          <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/grantaccess.html>`__ .
        ...
        **Request Syntax**
        ...
        :param RoleName:
          ...
          in the *AWS Organizations User Guide* . Also see steps 2 and 3 in `Tutorial\\: Delegate
          Access Across AWS Accounts Using IAM Roles
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/tutorial_cross-account-with-roles.html>`__
        ...
        :param IamUserAccessToBilling:
          ...
          If you don't specify this parameter, the value defaults to ``ALLOW`` . This value allows
          IAM users and roles with the required permissions to access billing information for the
          new account.
          ...
          ::

            {
                'CreateAccountStatus': {
                    ...
                    'FailureReason':
                    'ACCOUNT_LIMIT_EXCEEDED'|'EMAIL_ALREADY_EXISTS'|'INVALID_ADDRESS'
                    |'INVALID_EMAIL'|'CONCURRENT_ACCOUNT_MODIFICATION'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CreateAccountStatus** *(dict) --*
              ...
              status about the progress of the request at later times. You can also check the AWS
              CloudTrail log for the ``CreateAccountResult`` event. For more information, see
              `Monitoring the Activity in Your Organization
              <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_monitoring.html>`__ in
              ...
              - **Id** *(string) --*
                ...
                The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a create account request
                ID string requires "car-" followed by from 8 to 32 lower-case letters or digits.
              ...
              - **FailureReason** *(string) --*
                ...
                * GOVCLOUD_ACCOUNT_ALREADY_EXISTS: The account in the AWS GovCloud (US) Region could
                not be created because this Region already includes an account with that email
                address.
    ...
    def create_gov_cloud_account(
        ...
        * You're authorized to create accounts in the AWS GovCloud (US) Region. For more information
        on the AWS GovCloud (US) Region, see the ` *AWS GovCloud User Guide* .
        <http://docs.aws.amazon.com/govcloud-us/latest/UserGuide/welcome.html>`__

        * You already have an account in the AWS GovCloud (US) Region that is associated with your
        master account in the commercial Region.

        * You call this action from the master account of your organization in the commercial
        Region.

        * You have the ``organizations:CreateGovCloudAccount`` permission. AWS Organizations creates
        the required service-linked role named ``AWSServiceRoleForOrganizations`` . For more
        ...
        * Create an S3 bucket for AWS CloudTrail log storage. For more information, see `Verifying
        AWS CloudTrail Is Enabled
        <http://docs.aws.amazon.com/govcloud-us/latest/UserGuide/verifying-cloudtrail.html>`__ in
        ...
        <http://docs.aws.amazon.com/govcloud-us/latest/UserGuide/govcloud-organizations.html>`__ in
        the *AWS GovCloud User Guide.*

        Calling ``CreateGovCloudAccount`` is an asynchronous request that AWS performs in the
        background. Because ``CreateGovCloudAccount`` operates asynchronously, it can return a
        successful completion message even though account initialization might still be in progress.
        You might need to wait a few minutes before you can successfully access the account. To
        ...
        * Check the AWS CloudTrail log for the ``CreateAccountResult`` event. For information on
        using AWS CloudTrail with Organizations, see `Monitoring the Activity in Your Organization
        <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_monitoring.html>`__ in the
        *AWS Organizations User Guide.*

        When you call the ``CreateGovCloudAccount`` action, you create two accounts: a standalone
        account in the AWS GovCloud (US) Region and an associated account in the commercial Region
        ...
        A role is created in the new account in the commercial Region that allows the master account
        in the organization in the commercial Region to assume it. An AWS GovCloud (US) account is
        then created and associated with the commercial account that you just created. A role is
        created in the new AWS GovCloud (US) account. This role can be assumed by the AWS GovCloud
        (US) account that is associated with the master account of the commercial organization. For
        more information and to view a diagram that explains how account access works, see `AWS
        Organizations
        <http://docs.aws.amazon.com/govcloud-us/latest/UserGuide/govcloud-organizations.html>`__ in
        the *AWS GovCloud User Guide.*
        ...
        .. warning::
          ...
          * You can create an account in an organization using the AWS Organizations console, API,
          or CLI commands. When you do, the information required for the account to operate as a
          standalone account, such as a payment method, is *not* automatically collected. If you
          must remove an account from your organization later, you can do so only after you provide
          ...
          * Using ``CreateGovCloudAccount`` to create multiple temporary accounts isn't recommended.
          You can only close an account from the AWS Billing and Cost Management console, and you
          must be signed in as the root user. For information on the requirements and process for
        ...
        **Request Syntax**
        ...
        :param Email: **[REQUIRED]**
          ...
          Region. This email address must not already be associated with another AWS account. You
          must use a valid email address to complete account creation. You can't access the root
          user of the account or remove an account that was created with an invalid email address.
          Like all request parameters for ``CreateGovCloudAccount`` , the request for the email
          address for the AWS GovCloud (US) account originates from the commercial Region. It does
        ...
        :param RoleName:
          ...
          The name of an IAM role that AWS Organizations automatically preconfigures in the new
          member accounts in both the AWS GovCloud (US) Region and in the commercial Region. This
          role trusts the master account, allowing users in the master account to assume the role,
          as permitted by the master account administrator. The role has administrator permissions
          ...
          `Accessing and Administering the Member Accounts in Your Organization
          <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_access.html#orgs_manage_accounts_create-cross-account-role>`__
          in the *AWS Organizations User Guide* . See also steps 2 and 3 in `Tutorial\\: Delegate
          Access Across AWS Accounts Using IAM Roles
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/tutorial_cross-account-with-roles.html>`__
          in the *IAM User Guide.*
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CreateAccountStatus** *(dict) --*
              ...
              Contains the status about a  CreateAccount or  CreateGovCloudAccount request to create
              an AWS account or an AWS GovCloud (US) account in an organization.
    ...
    def create_organization(
        ...
        operation automatically becomes the `master account
        <https://docs.aws.amazon.com/IAM/latest/UserGuide/orgs_getting-started_concepts.html#account>`__
        ...
        created with all features enabled. In addition, service control policies are automatically
        enabled in the root. If you instead create the organization supporting only the consolidated
        billing features, no policy types are enabled by default, and you can't use organization
        policies.
        ...
        **Request Syntax**
        ...
        :param FeatureSet:
          ...
          * ``CONSOLIDATED_BILLING`` : All member accounts have their bills consolidated to and paid
          by the master account. For more information, see `Consolidated billing
          <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_getting-started_concepts.html#feature-set-cb-only>`__
          in the *AWS Organizations User Guide.*   The consolidated billing feature subset isn't
          available for organizations in the AWS GovCloud (US) Region.

          * ``ALL`` : In addition to all the features that consolidated billing feature set
          supports, the master account can also apply any policy type to any member account in the
          organization. For more information, see `All features
          ...
          - *(dict) --*
            ...
            - **Organization** *(dict) --*
              ...
              - **Id** *(string) --*
                ...
                The `regex pattern <http://wikipedia.org/wiki/regex>`__ for an organization ID
              ...
              - **AvailablePolicyTypes** *(list) --*
                ...
                organization has all features enabled, then service control policies (SCPs) are
                ...
                .. note::
                  ...
                  and  DisablePolicyType . Use  ListRoots to see the status of a policy type in that
                  root.
    ...
    def create_organizational_unit(
        ...
        <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_ous.html>`__ in the
        *AWS Organizations User Guide.*
          ...
          - *(dict) --*
            ...
            - **OrganizationalUnit** *(dict) --*
              ...
              - **Id** *(string) --*
                ...
                The `regex pattern <http://wikipedia.org/wiki/regex>`__ for an organizational unit
                ID string requires "ou-" followed by from 4 to 32 lower-case letters or digits (the
                ID of the root that contains the OU). This string is followed by a second "-" dash
              ...
              - **Name** *(string) --*
                ...
                The `regex pattern <http://wikipedia.org/wiki/regex>`__ that is used to validate
    ...
    def create_policy(
        ...
        **Request Syntax**
        ...
        :param Content: **[REQUIRED]**
          ...
          The policy content to add to the new policy. For example, you could create a `service
          control policy
          <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_scp.html>`__
          (SCP) that specifies the permissions that administrators in attached accounts can delegate
          to their users, groups, and roles. The string for this SCP must be JSON text. For more
          information about the SCP syntax, see `Service Control Policy Syntax
          <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_reference_scp-syntax.html>`__
          in the *AWS Organizations User Guide.*
            ...
            - **Policy** *(dict) --*
              ...
              - **PolicySummary** *(dict) --*
                ...
                - **Id** *(string) --*
                  ...
                  The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a policy ID string
    ...
    def decline_handshake(self, HandshakeId: str) -> ClientDeclineHandshakeResponseTypeDef:
        ...
        originator of the handshake can use  CancelHandshake instead. The originator can't
        ...
        **Request Syntax**
        ...
        :param HandshakeId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the handshake that you want to decline. You can get the ID
    ...
    def delete_organization(self, *args: Any, **kwargs: Any) -> None:
        ...
        master account. The organization must be empty of member accounts.
    ...
    def delete_organizational_unit(self, OrganizationalUnitId: str) -> None:
        ...
        **Request Syntax**
        ...
        :param OrganizationalUnitId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the organizational unit that you want to delete. You can get
          ...
          string requires "ou-" followed by from 4 to 32 lowercase letters or digits (the ID of the
    ...
    def delete_policy(self, PolicyId: str) -> None:
        ...
        **Request Syntax**
        ...
        :param PolicyId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the policy that you want to delete. You can get the ID from
    ...
    def describe_account(self, AccountId: str) -> ClientDescribeAccountResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param AccountId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the AWS account that you want information about. You can get
          the ID from the  ListAccounts or  ListAccountsForParent operations.
          ...
          - *(dict) --*
            ...
            - **Account** *(dict) --*
              ...
              - **Email** *(string) --*
                ...
                The `regex pattern <http://wikipedia.org/wiki/regex>`__ for this parameter is a
                string of characters that represents a standard internet email address.
    ...
    def describe_create_account_status(
        ...
        **Request Syntax**
        ...
        :param CreateAccountRequestId: **[REQUIRED]**
          ...
          Specifies the ``operationId`` that uniquely identifies the request. You can get the ID
          from the response to an earlier  CreateAccount request, or from the
    ...
    def describe_effective_policy(
        ...
        """
        Returns the contents of the effective tag policy for the account. The effective tag policy
        is the aggregation of any tag policies the account inherits, plus any policy directly that
        ...
        <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies-inheritance.html>`__
        in the *AWS Organizations User Guide* .

        This operation can be called from any account in the organization.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/organizations-2016-11-28/DescribeEffectivePolicy>`_
        ...
        **Request Syntax**
        ...
        :param TargetId:
          ...
          When you're signed in as the master account, specify the ID of the account that you want
          details about. Specifying an organization root or OU as the target is not supported.
    ...
    def describe_handshake(self, HandshakeId: str) -> ClientDescribeHandshakeResponseTypeDef:
        ...
        days after they change to that state. They're then deleted and no longer accessible.
        ...
        **Request Syntax**
        ...
        :param HandshakeId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the handshake that you want information about. You can get
          the ID from the original call to  InviteAccountToOrganization , or from a call to
    ...
    def describe_organizational_unit(
        ...
        **Request Syntax**
        ...
        :param OrganizationalUnitId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the organizational unit that you want details about. You can
    ...
    def describe_policy(self, PolicyId: str) -> ClientDescribePolicyResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param PolicyId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the policy that you want details about. You can get the ID
    ...
    def detach_policy(self, PolicyId: str, TargetId: str) -> None:
         ...
         **Note:** Every root, OU, and account must have at least one SCP attached. You can replace
         the default ``FullAWSAccess`` policy with one that limits the permissions that can be
         delegated. To do that, you must attach the replacement policy before you can remove the
         default one. This is the authorization strategy of using an `allow list
         <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_policies_about-scps.html#orgs_policies_whitelist>`__
         . You could instead attach a second SCP and leave the ``FullAWSAccess`` SCP still attached.
         You could then specify ``"Effect": "Deny"`` in the second SCP to override the ``"Effect":
         "Allow"`` in the ``FullAWSAccess`` policy (or any other attached SCP). If you take these
         steps, you're using the authorization strategy of a `deny list
        ...
        **Request Syntax**
        ...
        :param TargetId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the root, OU, or account that you want to detach the policy
          from. You can get the ID from the  ListRoots ,  ListOrganizationalUnitsForParent , or
          ListAccounts operations.
    ...
    def disable_aws_service_access(self, ServicePrincipal: str) -> None:
        ...
        service no longer can create a `service-linked role
        <http://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html>`__ in
        *new* accounts in your organization. This means the service can't perform operations on your
        behalf on any new accounts in your organization. The service can still perform operations in
        older accounts until the service completes its clean-up from AWS Organizations.

        .. warning::

          We recommend that you disable integration between AWS Organizations and the specified AWS
        ...
        longer perform operations in your organization's accounts. The only exception is when the
        operations are explicitly permitted by IAM policies that are attached to your roles.

        For more information about integrating other services with AWS Organizations, including the
        list of services that work with Organizations, see `Integrating AWS Organizations with Other
        AWS Services
        <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_integrate_services.html>`__
        in the *AWS Organizations User Guide.*
    ...
    def disable_policy_type(
        ...
        """
        Disables an organizational control policy type in a root and detaches all policies of that
        type from the organization root, OUs, and accounts. A policy of a certain type can be
        ...
        This is an asynchronous request that AWS performs in the background. If you disable a policy
        for a root, it still appears enabled for the organization if `all features
        <https://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_org_support-all-features.html>`__
        are enabled for the organization. AWS recommends that you first use  ListRoots to see the
        ...
        **Request Syntax**
        ...
        :param RootId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the root in which you want to disable a policy type. You can
          ...
          - *(dict) --*
            ...
            - **Root** *(dict) --*
              ...
              - **Id** *(string) --*
                ...
                The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a root ID string
              ...
              - **PolicyTypes** *(list) --*
                ...
                .. note::
                  ...
                  Even if a policy type is shown as available in the organization, you can
                  separately enable and disable them at the root level by using  EnablePolicyType
                  and  DisablePolicyType . Use  DescribeOrganization to see the availability of the
                  policy types in that organization.
    ...
    def enable_all_features(
        ...
        all features, you have access only to consolidated billing. You can't use any of the
        advanced account administration features that AWS Organizations supports. For more
        ...
        .. warning::
          ...
          This operation is required only for organizations that were created explicitly with only
          the consolidated billing features enabled. Calling this operation sends a handshake to
          ...
          the change. Accepting the handshake approves the change.
        ...
        by accepting the handshake that contains ``"Action": "ENABLE_ALL_FEATURES"`` . This
    ...
    def enable_aws_service_access(self, ServicePrincipal: str) -> None:
        ...
        specified service to create a `service-linked role
        <http://docs.aws.amazon.com/IAM/latest/UserGuide/using-service-linked-roles.html>`__ in all
        the accounts in your organization. This allows the service to perform operations on your
        behalf in your organization and its accounts.

        .. warning::

          We recommend that you enable integration between AWS Organizations and the specified AWS
          service by using the console or commands that are provided by the specified service. Doing
          so ensures that the service is aware that it can create the resources that are required
          for the integration. How the service creates those resources in the organization's
          accounts depends on that service. For more information, see the documentation for the
          other AWS service.

        For more information about enabling services to integrate with AWS Organizations, see
    ...
    def enable_policy_type(
        ...
        This is an asynchronous request that AWS performs in the background. AWS recommends that you
        first use  ListRoots to see the status of policy types for a specified root, and then use
        this operation.
        ...
        **Request Syntax**
        ...
        :param RootId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the root in which you want to enable a policy type. You can
          get the ID from the  ListRoots operation.
    ...
    def invite_account_to_organization(
        ...
        .. warning::
          ...
          * You can invite AWS accounts only from the same seller as the master account. For
          ...
          accounts to your organization. You can't combine accounts from AISPL and AWS or from any
          ...
          * You might receive an exception that indicates that you exceeded your account limits for
          ...
          hour, contact `AWS Support <https://console.aws.amazon.com/support/home#/>`__ .
        ...
        **Request Syntax**
        ...
        :param Target: **[REQUIRED]**
          ...
          If you specify ``"Type": "ACCOUNT"`` , you must provide the AWS account ID number as the
    ...
    def leave_organization(self, *args: Any, **kwargs: Any) -> None:
        ...
        master account, use  RemoveAccountFromOrganization instead.
        ...
        .. warning::
          ...
          * The master account in an organization with all features enabled can set service control
          ...
          restrictions can include preventing member accounts from successfully calling
          ``LeaveOrganization`` .
          ...
          * You can leave an organization as a member account only if the account is configured with
          ...
          an organization using the AWS Organizations console, API, or CLI, the information required
          of standalone accounts is *not* automatically collected. For each account that you want to
          make standalone, you must accept the end user license agreement (EULA). You must also
          choose a support plan, provide and verify the required contact information, and provide a
          current payment method. AWS uses the payment method to charge for any billable (not free
          tier) AWS activity that occurs while the account isn't attached to an organization. Follow
          the steps at `To leave an organization when all required account information has not yet
          been provided
          <http://docs.aws.amazon.com/organizations/latest/userguide/orgs_manage_accounts_remove.html#leave-without-all-info>`__
          in the *AWS Organizations User Guide.*
    ...
    def list_accounts(
        ...
        """
        Lists all the accounts in the organization. To request only the accounts in a specified root
        or organizational unit (OU), use the  ListAccountsForParent operation instead.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``NextToken`` request parameter in the next call to the operation to get the next part of
          the results. Note that Organizations might return fewer results than the maximum even when
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              subsequent call to the operation to get the next part of the output. You should repeat
              this until the ``NextToken`` response element comes back as ``null`` .
    ...
    def list_aws_service_access_for_organization(
        ...
        can perform operations on your organization and its accounts.

        For more information about integrating other services with AWS Organizations, including the
        list of services that currently work with Organizations, see `Integrating AWS Organizations
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def list_children(
        self, ParentId: str, ChildType: str, NextToken: str = None, MaxResults: int = None
    ) -> ClientListChildrenResponseTypeDef:
        """
            ...
            - **Children** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Id** *(string) --*
                  ...
                  The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a child ID string
                ...
                'CreateAccountStatuses': [
                    {
                        ...
                        'GovCloudAccountId': 'string',
                        'FailureReason':
                        'ACCOUNT_LIMIT_EXCEEDED'|'EMAIL_ALREADY_EXISTS'
            ...
            - **CreateAccountStatuses** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Id** *(string) --*
                  ...
                  the response of the initial  CreateAccount request to create the account.

                  The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a create account
    ...
    def list_handshakes_for_account(
        ...
        this API for only 30 days after changing to that state. After that, they're deleted and no
        longer accessible.
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          Filters the handshakes that you want included in the response. The default is all types.
          Use the ``ActionType`` element to limit the output to only a specified type, such as
          ``INVITE`` , ``ENABLE_ALL_FEATURES`` , or ``APPROVE_ALL_FEATURES`` . Alternatively, you
          can specify the ``ENABLE_ALL_FEATURES`` handshake, which generates a separate child
          handshake for each member account. When you do specify ``ParentHandshakeId`` to see only
                        ...
                        'Resources': [
                            {
                                ...
                                |'ORGANIZATION_FEATURE_SET'|'EMAIL'
                                |'MASTER_EMAIL'|'MASTER_NAME'|'NOTES'
                                |'PARENT_HANDSHAKE',
                                'Resources': {'... recursive ...'}
                            },
                        ]
          ...
          - *(dict) --*
            ...
            - **Handshakes** *(list) --*
              ...
              - *(dict) --*
                ...
                between two accounts (an *originator* and a *recipient* ). For example, assume that
                a master account (the originator) invites another account (the recipient) to join
                its organization. In that case, the two accounts exchange information as a series of
                handshake requests and responses.

                 **Note:** Handshakes that are CANCELED, ACCEPTED, or DECLINED show up in lists for
                 only 30 days after entering that state. After that, they are deleted.
                ...
                - **Parties** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Id** *(string) --*
                      ...
                      The `regex pattern <http://wikipedia.org/wiki/regex>`__ for handshake ID
                ...
                - **State** *(string) --*
                  ...
                  handshake through the process from its creation to its acceptance. The meaning of
                  each of the valid values is as follows:

                  * **REQUESTED** : This handshake was sent to multiple recipients (applicable to
                  only some handshake types) and not all recipients have responded yet. The request
                  stays in this state until all recipients respond.
                ...
                - **Action** *(string) --*
                  ...
                  * **APPROVE_ALL_FEATURES** : This type of handshake is sent from the Organizations
                  service when all member accounts have approved the ``ENABLE_ALL_FEATURES``
                  invitation. It is sent only to the master account and signals the master that it
                  can finalize the process to enable all features.
    ...
    def list_handshakes_for_organization(
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          types. Use the ``ActionType`` element to limit the output to only a specified type, such
          as ``INVITE`` , ``ENABLE-ALL-FEATURES`` , or ``APPROVE-ALL-FEATURES`` . Alternatively, you
          can specify the ``ENABLE-ALL-FEATURES`` handshake, which generates a separate child
          handshake for each member account. When you do, specify the ``ParentHandshakeId`` to see
          ...
          - *(dict) --*
            ...
            - **OrganizationalUnits** *(list) --*
              ...
              - *(dict) --*
                ...
                accounts within a root of an organization. Policies that are attached to an OU apply
                to all accounts contained in that OU and in any child OUs.
                ...
                - **Id** *(string) --*
                  ...
                  The `regex pattern <http://wikipedia.org/wiki/regex>`__ for an organizational unit
                  ID string requires "ou-" followed by from 4 to 32 lower-case letters or digits
    ...
    def list_parents(
        ...
        **Request Syntax**
        ...
        :param ChildId: **[REQUIRED]**
          ...
          * **Organizational unit (OU)** - A string that begins with "ou-" followed by from 4 to 32
          lowercase letters or digits (the ID of the root that contains the OU). This string is
          followed by a second "-" dash and from 8 to 32 additional lowercase letters or digits.
            ...
            - **Parents** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Id** *(string) --*
                  ...
                  The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a parent ID string
                  requires one of the following:

                  * Root: A string that begins with "r-" followed by from 4 to 32 lower-case letters
                  or digits.

                  * Organizational unit (OU): A string that begins with "ou-" followed by from 4 to
                  32 lower-case letters or digits (the ID of the root that the OU is in). This
                  string is followed by a second "-" dash and from 8 to 32 additional lower-case
                  letters or digits.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Policies** *(list) --*
              ...
              doesn't include the policy contents. To see the content for a policy, see
              DescribePolicy .
    ...
    def list_policies_for_target(
        ...
        **Request Syntax**
        ...
        :param TargetId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the root, organizational unit, or account whose policies you
          want to list.
          ...
          - *(dict) --*
            ...
            - **Roots** *(list) --*
              ...
              - *(dict) --*
                ...
                organized in a different way and to have different policy types enabled for use in
                that root.
                ...
                - **PolicyTypes** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Status** *(string) --*
                      ...
                      The status of the policy type as it relates to the associated root. You can
                      attach a policy of the specified type to a root or to an OU or account in that
                      root. To do so, the policy must be available in the organization and enabled
                      for that root.
            ...
            - **Targets** *(list) --*
              ...
              - *(dict) --*
                ...
                - **TargetId** *(string) --*
                  ...
                  The `regex pattern <http://wikipedia.org/wiki/regex>`__ for a target ID string
                  requires one of the following:
    ...
    def move_account(self, AccountId: str, SourceParentId: str, DestinationParentId: str) -> None:
        ...
        **Request Syntax**
        ...
        :param SourceParentId: **[REQUIRED]**
          ...
          The unique identifier (ID) of the root or organizational unit that you want to move the
          account from.
    ...
    def remove_account_from_organization(self, AccountId: str) -> None:
        ...
        .. warning::
          ...
          the information required to operate as a standalone account. When you create an account in
          an organization using the AWS Organizations console, API, or CLI, the information required
          of standalone accounts is *not* automatically collected. For an account that you want to
          make standalone, you must accept the end user license agreement (EULA). You must also
          choose a support plan, provide and verify the required contact information, and provide a
          current payment method. AWS uses the payment method to charge for any billable (not free
          ...
          account. Then follow the steps at `To leave an organization when all required account
    ...
    def tag_resource(self, ResourceId: str, Tags: List[ClientTagResourceTagsTypeDef]) -> None:
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          The tag to add to the specified resource. Specifying the tag key is required. You can set
    ...
    def update_organizational_unit(
        ...
        and accounts remain in place, and any attached policies of the OU remain attached.
