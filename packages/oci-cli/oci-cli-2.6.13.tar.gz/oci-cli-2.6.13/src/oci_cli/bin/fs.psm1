...
function GetOciCommandsToLongParams_fs() {
    $ociCommandsToLongParams = @{
        ...
        'fs mount-target create' = 'availability-domain compartment-id defined-tags display-name freeform-tags from-json help hostname-label ip-address max-wait-seconds subnet-id wait-for-state wait-interval-seconds'
        ...
        'fs mount-target update' = 'defined-tags display-name force freeform-tags from-json help if-match max-wait-seconds mount-target-id wait-for-state wait-interval-seconds'
