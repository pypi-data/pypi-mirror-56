...
function GetOciSubcommands_compute() {
    $ociSubcommands = @{
        ...
        'compute image-shape-compatibility-entry' = 'add remove'
...
function GetOciCommandsToLongParams_compute() {
    $ociCommandsToLongParams = @{
        ...
        'compute image-shape-compatibility-entry add' = 'from-json help image-id shape-name'
        ...
        'compute instance attach-vnic' = 'assign-public-ip defined-tags freeform-tags from-json help hostname-label instance-id nic-index nsg-ids private-ip skip-source-dest-check subnet-id vnic-display-name wait'
        ...
        'compute instance update' = 'agent-config defined-tags display-name extended-metadata force freeform-tags from-json help if-match instance-id max-wait-seconds metadata wait-for-state wait-interval-seconds'
        ...
        'compute volume-attachment attach' = 'device display-name from-json help instance-id is-read-only max-wait-seconds type volume-id wait-for-state wait-interval-seconds'
        'compute volume-attachment attach-iscsi-volume' = 'device display-name from-json help instance-id is-read-only max-wait-seconds use-chap volume-id wait-for-state wait-interval-seconds'
        'compute volume-attachment attach-paravirtualized-volume' = 'device display-name from-json help instance-id is-pv-encryption-in-transit-enabled is-read-only max-wait-seconds volume-id wait-for-state wait-interval-seconds'
