...
function GetOciCommandsToLongParams_os() {
    $ociCommandsToLongParams = @{
        ...
        'os object put' = 'bucket-name content-encoding content-language content-md5 content-type disable-parallel-uploads file force from-json help if-match metadata name namespace namespace-name no-multipart no-overwrite parallel-upload-count part-size verify-checksum'
