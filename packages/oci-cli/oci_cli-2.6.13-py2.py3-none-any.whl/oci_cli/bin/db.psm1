...
function GetOciSubcommands_db() {
    $ociSubcommands = @{
        'db' = 'autonomous-container-database autonomous-data-warehouse autonomous-data-warehouse-backup autonomous-database autonomous-database-backup autonomous-database-wallet autonomous-db-preview-version autonomous-exadata-infrastructure autonomous-exadata-infrastructure-shape backup backup-destination data-guard-association database exadata-infrastructure external-backup-job gi-version maintenance-run node patch patch-history system system-shape version vm-cluster vm-cluster-network'
        ...
        'db autonomous-database' = 'change-compartment create create-from-clone data-safe delete generate-wallet get list restore start stop update'
        ...
        'db exadata-infrastructure' = 'activate change-compartment create delete download-exadata-infrastructure-config-file generate-recommended-vm-cluster-network get list update'
...
function GetOciCommandsToLongParams_db() {
    $ociCommandsToLongParams = @{
        ...
        'db autonomous-database create' = 'admin-password autonomous-container-database-id compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database create-from-clone' = 'admin-password autonomous-container-database-id clone-type compartment-id cpu-core-count data-storage-size-in-tbs db-name db-workload defined-tags display-name freeform-tags from-json help is-auto-scaling-enabled is-dedicated is-free-tier is-preview-version-with-service-terms-accepted license-model max-wait-seconds source-id wait-for-state wait-interval-seconds whitelisted-ips'
        'db autonomous-database data-safe deregister' = 'autonomous-database-id from-json help'
        'db autonomous-database data-safe register' = 'autonomous-database-id from-json help'
        ...
        'db autonomous-database list' = 'all autonomous-container-database-id compartment-id db-workload display-name from-json help is-free-tier lifecycle-state limit page page-size sort-by sort-order'
        ...
        'db autonomous-database update' = 'admin-password autonomous-database-id cpu-core-count data-storage-size-in-tbs db-name defined-tags display-name force freeform-tags from-json help if-match is-auto-scaling-enabled is-free-tier license-model max-wait-seconds wait-for-state wait-interval-seconds whitelisted-ips'
        ...
        'db backup-destination create-nfs-details' = 'compartment-id defined-tags display-name freeform-tags from-json help local-mount-point-path max-wait-seconds wait-for-state wait-interval-seconds'
        ...
        'db backup-destination update' = 'backup-destination-id connection-string defined-tags force freeform-tags from-json help if-match local-mount-point-path max-wait-seconds vpc-users wait-for-state wait-interval-seconds'
        ...
        'db database create' = 'admin-password auto-backup-enabled auto-backup-window backup-destination character-set db-name db-system-id db-unique-name db-version db-workload from-json help max-wait-seconds ncharacter-set pdb-name recovery-window-in-days source vm-cluster-id wait-for-state wait-interval-seconds'
        'db database create-from-backup' = 'admin-password backup-id backup-tde-password db-name db-system-id db-unique-name from-json help max-wait-seconds wait-for-state wait-interval-seconds'
        'db database delete' = 'database-id force from-json help'
        'db database get' = 'database-id from-json help'
        'db database list' = 'compartment-id db-system-id display-name from-json help lifecycle-state limit sort-by sort-order vm-cluster-id'
        ...
        'db database update' = 'auto-backup-enabled auto-backup-window backup-destination database-id defined-tags force freeform-tags from-json help if-match max-wait-seconds recovery-window-in-days wait-for-state wait-interval-seconds'
        ...
        'db system update' = 'backup-network-nsg-ids cpu-core-count data-storage-size-in-gbs db-system-id defined-tags force freeform-tags from-json help if-match max-wait-seconds nsg-ids patch-action patch-id ssh-authorized-keys-file wait-for-state wait-interval-seconds'
        ...
        'db vm-cluster create' = 'compartment-id cpu-core-count defined-tags display-name exadata-infrastructure-id freeform-tags from-json gi-version help is-local-backup-enabled is-sparse-diskgroup-enabled license-model max-wait-seconds ssh-public-keys time-zone vm-cluster-network-id wait-for-state wait-interval-seconds'
        ...
        'db vm-cluster update' = 'cpu-core-count defined-tags force freeform-tags from-json help if-match license-model max-wait-seconds ssh-public-keys vm-cluster-id wait-for-state wait-interval-seconds'
