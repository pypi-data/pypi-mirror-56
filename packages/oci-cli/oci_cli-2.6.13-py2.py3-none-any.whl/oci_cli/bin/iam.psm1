...
function GetOciSubcommands_iam() {
    $ociSubcommands = @{
        ...
        'iam compartment' = 'create delete get list move update'
        ...
        'iam tag' = 'create delete get list list-cost-tracking reactivate retire update'
        'iam tag-default' = 'assemble-effective-tag-set create delete get list update'
        'iam tag-namespace' = 'change-compartment create delete get list reactivate retire update'
...
function GetOciCommandsToLongParams_iam() {
    $ociCommandsToLongParams = @{
        ...
        'iam authentication-policy update' = 'compartment-id force from-json help if-match password-policy'
        ...
        'iam tag update' = 'defined-tags description force freeform-tags from-json help if-match is-cost-tracking max-wait-seconds tag-name tag-namespace-id wait-for-state wait-interval-seconds'
