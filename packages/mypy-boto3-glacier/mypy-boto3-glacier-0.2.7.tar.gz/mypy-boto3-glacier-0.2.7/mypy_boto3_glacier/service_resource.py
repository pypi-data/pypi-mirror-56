"Main interface for glacier ServiceResource"
...
class Job(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`Glacier.Client.describe_job` to update the attributes of the Job resource. Note that
...
class Notification(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`Glacier.Client.get_vault_notifications` to update the attributes of the Notification
