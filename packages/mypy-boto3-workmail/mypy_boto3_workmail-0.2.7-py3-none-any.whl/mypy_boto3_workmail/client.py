"Main interface for workmail Client"
...
class Client(BaseClient):
    ...
    def delete_user(self, OrganizationId: str, UserId: str) -> Dict[str, Any]:
        ...
        Deleting a user is permanent and cannot be undone. WorkMail archives user mailboxes for 30 days
    ...
    def deregister_from_work_mail(
        ...
        """
        Mark a user, group, or resource as no longer used in Amazon WorkMail. This action disassociates the
    ...
    def put_mailbox_permissions(
        ...
        **Request Syntax**
        ...
        :param PermissionValues: **[REQUIRED]**
          ...
          The permissions granted to the grantee. SEND_AS allows the grantee to send email as the owner of
    ...
    def register_to_work_mail(
        ...
        """
        Registers an existing and disabled user, group, or resource for Amazon WorkMail use by associating a
        ...
        <https://aws.amazon.com//workmail/pricing>`__ . The equivalent console functionality for this
        operation is *Enable* .

        Users can either be created by calling the  CreateUser API operation or they can be synchronized
