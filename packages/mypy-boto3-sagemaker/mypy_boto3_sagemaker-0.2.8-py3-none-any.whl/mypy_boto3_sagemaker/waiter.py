...
class EndpointDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`SageMaker.Client.describe_endpoint` every 30 seconds until a successful
...
class NotebookInstanceDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`SageMaker.Client.describe_notebook_instance` every 30 seconds until a
...
class TrainingJobCompletedOrStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`SageMaker.Client.describe_training_job` every 120 seconds until a successful
        state is reached. An error is returned after 180 failed checks.
...
class TransformJobCompletedOrStoppedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`SageMaker.Client.describe_transform_job` every 60 seconds until a successful
        state is reached. An error is returned after 60 failed checks.
