...
class Client(BaseClient):
    ...
    def add_tags(
        ...
        """
        Adds or overwrites one or more tags for the specified Amazon SageMaker resource. You can add tags to
        ...
        .. note::
          ...
          training jobs that the hyperparameter tuning job launched before you called this API. To make sure
          that the tags associated with a hyperparameter tuning job are also added to all training jobs that
          the hyperparameter tuning job launches, add the tags when you first create the tuning job by
          specifying them in the ``Tags`` parameter of  CreateHyperParameterTuningJob
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          An array of ``Tag`` objects. Each tag is a key-value pair. Only the ``key`` parameter is required.
          If you don't specify a value, Amazon SageMaker sets the value to an empty string.
          ...
          response = client.create_algorithm(
              ...
              TrainingSpecification={
                  ...
                  'SupportedTrainingInstanceTypes': [
                      ...
                      |'ml.m5.24xlarge'|'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'|'ml.c4.8xlarge'
                      |'ml.p2.xlarge'|'ml.p2.8xlarge'|'ml.p2.16xlarge'|'ml.p3.2xlarge'|'ml.p3.8xlarge'
                      |'ml.p3.16xlarge'|'ml.p3dn.24xlarge'|'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'
              ...
              InferenceSpecification={
                  ...
                  'SupportedTransformInstanceTypes': [
                      ...
                      |'ml.p2.8xlarge'|'ml.p2.16xlarge'|'ml.p3.2xlarge'|'ml.p3.8xlarge'|'ml.p3.16xlarge'
                  ...
                  'SupportedRealtimeInferenceInstanceTypes': [
                      ...
                      |'ml.m4.2xlarge'|'ml.m4.4xlarge'|'ml.m4.10xlarge'|'ml.m4.16xlarge'|'ml.m5.large'
                      |'ml.m5.xlarge'|'ml.m5.2xlarge'|'ml.m5.4xlarge'|'ml.m5.12xlarge'|'ml.m5.24xlarge'
                      |'ml.m5d.large'|'ml.m5d.xlarge'|'ml.m5d.2xlarge'|'ml.m5d.4xlarge'|'ml.m5d.12xlarge'
                      |'ml.m5d.24xlarge'|'ml.c4.large'|'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'
                      |'ml.c4.8xlarge'|'ml.p2.xlarge'|'ml.p2.8xlarge'|'ml.p2.16xlarge'|'ml.p3.2xlarge'
                      |'ml.p3.8xlarge'|'ml.p3.16xlarge'|'ml.c5.large'|'ml.c5.xlarge'|'ml.c5.2xlarge'
                      |'ml.c5.4xlarge'|'ml.c5.9xlarge'|'ml.c5.18xlarge'|'ml.c5d.large'|'ml.c5d.xlarge'
                      |'ml.c5d.2xlarge'|'ml.c5d.4xlarge'|'ml.c5d.9xlarge'|'ml.c5d.18xlarge'|'ml.g4dn.xlarge'
                      |'ml.g4dn.2xlarge'|'ml.g4dn.4xlarge'|'ml.g4dn.8xlarge'|'ml.g4dn.12xlarge'
                      |'ml.g4dn.16xlarge'|'ml.r5.large'|'ml.r5.xlarge'|'ml.r5.2xlarge'|'ml.r5.4xlarge'
                      |'ml.r5.12xlarge'|'ml.r5.24xlarge'|'ml.r5d.large'|'ml.r5d.xlarge'|'ml.r5d.2xlarge'
                              ...
                              'InputDataConfig': [
                                  {
                                      ...
                                      'DataSource': {
                                          'S3DataSource': {
                                              'S3DataType':
                                              'ManifestFile'|'S3Prefix'|'AugmentedManifestFile',
                                              'S3Uri': 'string',
    ...
    def create_code_repository(
        ...
        GitConfig: ClientCreateCodeRepositoryGitConfigTypeDef,
    ) -> ClientCreateCodeRepositoryResponseTypeDef:
        """
        ...
        create. The Git repository is a resource in your Amazon SageMaker account, so it can be associated
        ...
        **Request Syntax**
        ...
        :param CodeRepositoryName: **[REQUIRED]**
          ...
          The name of the Git repository. The name must have 1 to 63 characters. Valid characters are a-z,
          A-Z, 0-9, and - (hyphen).
    ...
    def create_compilation_job(
        ...
        model artifacts as part of the model. You can also use the artifacts with AWS IoT Greengrass. In
        that case, deploy them as an ML resource.
        ...
        * ``The Amazon Resource Name (ARN) of the IAM role that Amazon SageMaker assumes to perform the
        model compilation job``

        You can also provide a ``Tag`` to track the model compilation job's resource use and costs. The
        response body contains the ``CompilationJobArn`` for the compiled job.
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_compilation_job(
              ...
              OutputConfig={
                  ...
                  'TargetDevice':
                  'lambda'|'ml_m4'|'ml_m5'|'ml_c4'|'ml_c5'|'ml_p2'|'ml_p3'|'jetson_tx1'|'jetson_tx2'
                  |'jetson_nano'|'rasp3b'|'deeplens'|'rk3399'|'rk3288'|'aisage'|'sbe_c'|'qcs605'|'qcs603'
              },
              StoppingCondition={
                  'MaxRuntimeInSeconds': 123,
                  'MaxWaitTimeInSeconds': 123
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          * Publish metrics to Amazon CloudWatch
          ...
          SageMaker, the caller of this API must have the ``iam:PassRole`` permission. For more information,
    ...
    def create_endpoint(
        ...
        """
        Creates an endpoint using the endpoint configuration specified in the request. Amazon SageMaker uses
        the endpoint to provision resources and deploy models. You create the endpoint configuration with
        ...
        creates the endpoint, it sets the status to ``InService`` . Amazon SageMaker can then process
        ...
        <IAM/latest/UserGuide/id_credentials_temp_enable-regions.html>`__ in the *AWS Identity and Access
    ...
    def create_endpoint_config(
        ...
        the configuration, you identify one or more models, created using the ``CreateModel`` API, to deploy
        and the resources that you want Amazon SageMaker to provision. Then you call the `CreateEndpoint
        ...
        In the request, you define one or more ``ProductionVariant`` s, each of which identifies a model.
        Each ``ProductionVariant`` parameter also describes the resources that you want Amazon SageMaker to
        provision. This includes the number and type of ML compute instances to deploy.

        If you are hosting multiple models, you also assign a ``VariantWeight`` to specify how much traffic
        you want to allocate to each model. For example, suppose that you want to host two models, A and B,
        and you assign traffic weight 2 for model A and 1 for model B. Amazon SageMaker distributes
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          .. note::
            ...
            specify in the ``ProductionVariants`` parameter use nitro-based instances with local storage, do
            not specify a value for the ``KmsKeyId`` parameter. If you specify a value for ``KmsKeyId`` when
    ...
    def create_hyper_parameter_tuning_job(
        ...
        result in a model that performs the best, as measured by an objective metric that you choose.
        ...
        **Request Syntax**
        ...
        :param HyperParameterTuningJobName: **[REQUIRED]**
          ...
          tuning job launches. The name must be unique within the same AWS account and AWS Region. The name
          must have { } to { } characters. Valid characters are a-z, A-Z, 0-9, and : + = @ _ % - (hyphen).
        ...
        :param Tags:
          ...
          An array of key-value pairs. You can use tags to categorize your AWS resources in different ways,
          for example, by purpose, owner, or environment. For more information, see `AWS Tagging Strategies
    ...
    def create_labeling_job(
        ...
        labeled data to train machine learning models.

        You can select your workforce from one of three providers:

        * A private workforce that you create. It can include employees, contractors, and outside experts.
        Use a private workforce when want the data to stay within your organization or when a specific set
        of skills is required.

        * One or more vendors that you select from the AWS Marketplace. Vendors provide expertise in
        specific areas.

        * The Amazon Mechanical Turk workforce. This is the largest workforce, but it should only be used
        for public data or data that has been stripped of any personally identifiable information.

        You can also use *automated data labeling* to reduce the number of data objects that need to be
        labeled by a human. Automated data labeling uses *active learning* to determine if a data object can
        be labeled by machine or if it needs to be sent to a human worker. For more information, see `Using
        Automated Data Labeling
        <https://docs.aws.amazon.com/sagemaker/latest/dg/sms-automated-labeling.html>`__ .

        The data objects to be labeled are contained in an Amazon S3 bucket. You create a *manifest file*
        that describes the location of each object. For more information, see `Using Input and Output Data
        <https://docs.aws.amazon.com/sagemaker/latest/dg/sms-data.html>`__ .

        The output can be used as the manifest file for another labeling job or as training data for your
        ...
        **Request Syntax**
        ...
        :param LabelAttributeName: **[REQUIRED]**
          ...
          The attribute name to use for the label in the output manifest file. This is the key for the
          key/value pair formed with the label that a worker assigns to the object. The name can't end with
          "-metadata". If you are running a semantic segmentation labeling job, the attribute name must end
          with "-ref". If you are running any other kind of labeling job, the attribute name must not end
          with "-ref".
    ...
    def create_model(
        ...
        container. For the primary container, you specify the docker image containing inference code,
        artifacts (from prior training), and custom environment map that the inference code uses when you
        ...
        To host your model, you create an endpoint configuration with the ``CreateEndpointConfig`` API, and
        ...
        Amazon SageMaker uses your model and your dataset to get inferences which are then saved to a
        ...
        artifacts and docker image for deployment on ML compute hosting instances or for batch transform
        jobs. In addition, you also use the IAM role to manage permissions the inference code needs. For
        example, if the inference code access any other AWS resources, you grant necessary permissions via
        this role.
        ...
        **Request Syntax**
        ...
        :param ExecutionRoleArn: **[REQUIRED]**
          ...
          SageMaker Roles <https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-roles.html>`__ .
    ...
    def create_model_package(
        ...
        create a model from an algorithm resource that you created or subscribed to in AWS Marketplace,
        ...
        **Request Syntax**
        ...
        :param ModelPackageName: **[REQUIRED]**
          ...
          The name of the model package. The name must have 1 to 63 characters. Valid characters are a-z,
          A-Z, 0-9, and - (hyphen).
    ...
    def create_notebook_instance(
        ...
        In a ``CreateNotebookInstance`` request, specify the type of ML compute instance that you want to
        run. Amazon SageMaker launches the instance, installs common libraries that you can use to explore
        ...
        * (Option) If you specified ``SubnetId`` , Amazon SageMaker creates a network interface in your own
        VPC, which is inferred from the subnet ID that you provide in the input. When creating this network
        interface, Amazon SageMaker attaches the security group that you specified in the request to the
        network interface that it creates in your VPC.

        * Launches an EC2 instance of the type specified in the request in the Amazon SageMaker VPC. If you
        specified ``SubnetId`` of your VPC, Amazon SageMaker specifies both network interfaces when
        launching this instance. This enables inbound traffic from your own VPC to the notebook instance,
        ...
        in Jupyter notebooks. For example, you can write code to explore a dataset that you can use for
        model training, train a model, host models by creating Amazon SageMaker endpoints, and validate
        hosted models.
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_notebook_instance(
              ...
              InstanceType=
                  'ml.t2.medium'|'ml.t2.large'|'ml.t2.xlarge'|'ml.t2.2xlarge'|'ml.t3.medium'|'ml.t3.large'
                  |'ml.t3.xlarge'|'ml.t3.2xlarge'|'ml.m4.xlarge'|'ml.m4.2xlarge'|'ml.m4.4xlarge'
                  |'ml.m4.10xlarge'|'ml.m4.16xlarge'|'ml.m5.xlarge'|'ml.m5.2xlarge'|'ml.m5.4xlarge'
                  |'ml.m5.12xlarge'|'ml.m5.24xlarge'|'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'
                  |'ml.c4.8xlarge'|'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'|'ml.c5.9xlarge'
                  |'ml.c5.18xlarge'|'ml.c5d.xlarge'|'ml.c5d.2xlarge'|'ml.c5d.4xlarge'|'ml.c5d.9xlarge'
                  |'ml.c5d.18xlarge'|'ml.p2.xlarge'|'ml.p2.8xlarge'|'ml.p2.16xlarge'|'ml.p3.2xlarge'
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          this role to perform tasks on your behalf. You must grant this role necessary permissions so
          ...
          `Amazon SageMaker Roles <https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-roles.html>`__
          .
        ...
        :param KmsKeyId:
          ...
          The Amazon Resource Name (ARN) of a AWS Key Management Service key that Amazon SageMaker uses to
          encrypt data on the storage volume attached to your notebook instance. The KMS key you provide
          must be enabled. For information, see `Enabling and Disabling Keys
          <https://docs.aws.amazon.com/kms/latest/developerguide/enabling-keys.html>`__ in the *AWS Key
          Management Service Developer Guide* .
        ...
        :param DirectInternetAccess:
          ...
          to ``Disabled`` this notebook instance will be able to access resources only in your VPC, and will
          not be able to connect to Amazon SageMaker training and endpoint services unless your configure a
        ...
        :param DefaultCodeRepository:
          ...
          repository. For more information, see `Associating Git Repositories with Amazon SageMaker Notebook
          Instances <https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-git-repo.html>`__ .

        :type AdditionalCodeRepositories: list
        :param AdditionalCodeRepositories:

          An array of up to three Git repositories to associate with the notebook instance. These can be
          either the names of Git repositories stored as resources in your account, or the URL of Git
          repositories in `AWS CodeCommit <codecommit/latest/userguide/welcome.html>`__ or in any other Git
          repository. These repositories are cloned at the same level as the default repository of your
          notebook instance. For more information, see `Associating Git Repositories with Amazon SageMaker
        ...
        :param RootAccess:
          ...
          Whether root access is enabled or disabled for users of the notebook instance. The default value
          is ``Enabled`` .
    ...
    def create_notebook_instance_lifecycle_config(
        ...
        **Request Syntax**
        ...
        :param OnCreate:
          ...
          A shell script that runs only once, when you create a notebook instance. The shell script must be
    ...
    def create_presigned_notebook_instance_url(
        ...
        that attempts to connect to the notebook instance.For example, you can restrict access to this API
        and to the URL that it returns to a list of IP addresses that you specify. Use the ``NotIpAddress``
        condition operator and the ``aws:SourceIP`` condition context key to specify the list of IP
        addresses that you want to have access to the notebook instance. For more information, see `Limit
        Access to a Notebook Instance by IP Address
        <https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-ip-filter.html>`__ .

        .. note::

          The URL that you get from a call to is valid only for 5 minutes. If you try to use the URL after
          the 5-minute limit expires, you are directed to the AWS console sign-in page.
    ...
    def create_training_job(
        ...
        If you choose to host your model using Amazon SageMaker hosting services, you can use the resulting
        model artifacts as part of the model. You can also use the artifacts in a machine learning service
        other than Amazon SageMaker, provided that you know how to use them for inferences.
        ...
        * ``HyperParameters`` - Specify these algorithm-specific parameters to enable the estimation of
        model parameters during training. Hyperparameters can be tuned to optimize this learning process.
        For a list of hyperparameters for each training algorithm provided by Amazon SageMaker, see
        `Algorithms <https://docs.aws.amazon.com/sagemaker/latest/dg/algos.html>`__ .

        * ``InputDataConfig`` - Describes the training dataset and the Amazon S3, EFS, or FSx location where
        it is stored.
        ...
        * ``EnableManagedSpotTraining`` - Optimize the cost of training machine learning models by up to 80%
        by using Amazon EC2 Spot instances. For more information, see `Managed Spot Training
        ...
        * ``StoppingCondition`` - To help cap training costs, use ``MaxRuntimeInSeconds`` to set a time
        limit for training. Use ``MaxWaitTimeInSeconds`` to specify how long you are willing to to wait for
        ...
        **Request Syntax**
        ...
        :param HyperParameters:
          ...
          key and value is limited to 256 characters, as specified by the ``Length Constraint`` .
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          bucket, download a Docker image that contains training code, write model artifacts to an S3
          bucket, write logs to Amazon CloudWatch Logs, and publish metrics to Amazon CloudWatch. You grant
        ...
        :param InputDataConfig:
          ...
          Algorithms can accept input data from one or more channels. For example, an algorithm might have
          two channels of input data, ``training_data`` and ``validation_data`` . The configuration for each
          channel provides the S3, EFS, or FSx location where the input data is stored. It also provides
          ...
          files from an S3 bucket to a local directory in the Docker container, or makes it available as
          input streams. For example, if you specify an EFS location, input data files will be made
        ...
        :param EnableNetworkIsolation:
          ...
          Isolates the training container. No inbound or outbound network calls can be made, except for
          calls between peers within a training cluster for distributed training. If you enable network
          isolation for training jobs that are configured to use a VPC, Amazon SageMaker downloads and
          uploads customer data and model artifacts through the specified VPC, but the training container
        ...
        :param EnableInterContainerTrafficEncryption:
          ...
          longer. How long it takes depends on the amount of communication between compute instances,
          especially if you use a deep learning algorithm in distributed training. For more information, see
        ...
        :param EnableManagedSpotTraining:
          ...
          To train models using managed spot training, choose ``True`` . Managed spot training provides a
          fully managed and scalable infrastructure for training machine learning models. this option is
          useful when training jobs can be interrupted and when there is flexibility when the training job
          is run.
    ...
    def create_transform_job(
        ...
        * ``TransformJobName`` - Identifies the transform job. The name must be unique within an AWS Region
        in an AWS account.
        ...
        * ``TransformInput`` - Describes the dataset to be transformed and the Amazon S3 location where it
        is stored.

        * ``TransformOutput`` - Identifies the Amazon S3 location where you want Amazon SageMaker to save
        ...
        **Request Syntax**
        ...
        :param ModelName: **[REQUIRED]**
          ...
          The name of the model that you want to use for the transform job. ``ModelName`` must be the name
        ...
        :param MaxConcurrentTransforms:
          ...
          execution-parameters to determine the optimal settings for your chosen algorithm. If the
          execution-parameters endpoint is not enabled, the default value is ``1`` . For more information on
          execution-parameters, see `How Containers Serve Requests
        ...
        :param MaxPayloadInMB:
          ...
          (without metadata). The value in ``MaxPayloadInMB`` must be greater than, or equal to, the size of
          a single record. To estimate the size of a record in MB, divide the size of your dataset by the
          number of records. To ensure that the records fit within the maximum payload size, we recommend
          ...
          encoding, set the value to ``0`` . This feature works only in supported algorithms. Currently,
          Amazon SageMaker built-in algorithms do not support HTTP chunked encoding.

        :type BatchStrategy: string
        :param BatchStrategy:

          Specifies the number of records to include in a mini-batch for an HTTP inference request. A
          *record*  is a single unit of input data that inference can be made on. For example, a single line
          in a CSV file is a record.

          To enable the batch strategy, you must set the ``SplitType`` property of the  DataProcessing
          object to ``Line`` , ``RecordIO`` , or ``TFRecord`` .
        ...
        :param Tags:
          ...
          (Optional) An array of key-value pairs. For more information, see `Using Cost Allocation Tags
          <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html#allocation-what>`__
          in the *AWS Billing and Cost Management User Guide* .
    ...
    def create_workteam(
        ...
        user pools. You must first create the user pools before you can create a work team.
    ...
    def delete_model(self, ModelName: str) -> None:
        ...
        SageMaker when you called the `CreateModel
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateModel.html>`__ API. It does not delete
        model artifacts, inference code, or the IAM role that you specified when creating the model.
    ...
    def delete_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        .. warning::
          ...
          When you delete a notebook instance, you lose all of your data. Amazon SageMaker removes the ML
          compute instance, and deletes the ML storage volume and the network interface associated with the
          notebook instance.
    ...
    def delete_tags(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        .. note::
          ...
          When you call this API to delete tags from a hyperparameter tuning job, the deleted tags are not
          removed from training jobs that the hyperparameter tuning job launched before you called this API.
...

            {
                ...
                'InferenceSpecification': {
                    ...
                    'SupportedRealtimeInferenceInstanceTypes': [
                        ...
                        |'ml.g4dn.12xlarge'|'ml.g4dn.16xlarge'|'ml.r5.large'|'ml.r5.xlarge'|'ml.r5.2xlarge'
                        |'ml.r5.4xlarge'|'ml.r5.12xlarge'|'ml.r5.24xlarge'|'ml.r5d.large'|'ml.r5d.xlarge'
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'EndpointStatus':
                'OutOfService'|'Creating'|'Updating'|'SystemUpdating'|'RollingBack'|'InService'|'Deleting'
                |'Failed',
                'FailureReason': 'string',
                'CreationTime': datetime(2015, 1, 1),
                'LastModifiedTime': datetime(2015, 1, 1)
    ...
    def describe_subscribed_workteam(
        ...
        with a vendor in the AWS Marketplace.
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                |'DownloadingTrainingImage'|'Training'|'Uploading'|'Stopping'|'Stopped'|'MaxRuntimeExceeded'
                ...
                'SecondaryStatusTransitions': [
                    {
                        ...
                        |'MaxRuntimeExceeded'|'Completed'|'Failed'|'Interrupted'|'MaxWaitTimeExceeded',
    ...
    def describe_workteam(
        ...
        """
        Gets information about a specific work team. You can see information such as the create date, the
    ...
    def list_algorithms(
        ...
        **Request Syntax**
        ...
        :param NameContains:
          ...
          A string in the algorithm name. This filter returns only algorithms whose name contains the
          specified string.
    ...
    def list_code_repositories(
        ...
        **Request Syntax**
        ...
        :param NameContains:
          ...
          A string in the Git repositories name. This filter returns only repositories whose name contains
    ...
    def list_compilation_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListCompilationJobs`` request was truncated, the response includes
          a ``NextToken`` . To retrieve the next set of model compilation jobs, use the token in the next
          request.
                ...
                'CompilationJobSummaries': [
                    {
                        ...
                        'lambda'|'ml_m4'|'ml_m5'|'ml_c4'|'ml_c5'|'ml_p2'|'ml_p3'|'jetson_tx1'|'jetson_tx2'
                        |'jetson_nano'|'rasp3b'|'deeplens'|'rk3399'|'rk3288'|'aisage'|'sbe_c'|'qcs605'
                        |'qcs603',
                        'LastModifiedTime': datetime(2015, 1, 1),
    ...
    def list_endpoint_configs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListEndpointConfig`` request was truncated, the response includes
        ...
        :param NameContains:
          ...
          A string in the endpoint configuration name. This filter returns only endpoint configurations
        ...
        :param CreationTimeAfter:
          ...
          A filter that returns only endpoint configurations with a creation time greater than or equal to
    ...
    def list_endpoints(
        ...
        **Request Syntax**
        ...
        :param CreationTimeAfter:
          ...
          A filter that returns only endpoints with a creation time greater than or equal to the specified
          time (timestamp).
    ...
    def list_labeling_jobs_for_workteam(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          includes a ``NextToken`` . To retrieve the next set of labeling jobs, use the token in the next
          request.
    ...
    def list_model_packages(
        ...
        **Request Syntax**
        ...
        :param NameContains:
          ...
          A string in the model package name. This filter returns only model packages whose name contains
          the specified string.
    ...
    def list_notebook_instance_lifecycle_configs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of a ``ListNotebookInstanceLifecycleConfigs`` request was truncated, the response
          includes a ``NextToken`` . To get the next set of lifecycle configurations, use the token in the
          next request.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          .. note::
            ...
            You might specify a filter or a sort order in your request. When response is truncated, you must
            use the same values for the filer and sort order in the next request.
        ...
        :param NotebookInstanceLifecycleConfigNameContains:
          ...
          instance. This filter returns only notebook instances associated with a lifecycle configuration
        ...
        :param DefaultCodeRepositoryContains:
          ...
          A string in the name or URL of a Git repository associated with this notebook instance. This
          filter returns only notebook instances associated with a git repository with a name that contains
          the specified string.
                ...
                'NotebookInstances': [
                    {
                        ...
                        |'ml.c5.9xlarge'|'ml.c5.18xlarge'|'ml.c5d.xlarge'|'ml.c5d.2xlarge'|'ml.c5d.4xlarge'
                        |'ml.c5d.9xlarge'|'ml.c5d.18xlarge'|'ml.p2.xlarge'|'ml.p2.8xlarge'|'ml.p2.16xlarge'
    ...
    def list_subscribed_workteams(
        ...
        """
        Gets a list of the work teams that you are subscribed to in the AWS Marketplace. The list may be
        ...
        **Request Syntax**
        ...
        :param NameContains:
          ...
          A string in the work team name. This filter returns only work teams whose name contains the
          specified string.
    ...
    def list_transform_jobs(
        ...
        **Request Syntax**
        ...
        :param NameContains:
          ...
          A string in the transform job name. This filter returns only transform jobs whose name contains
          the specified string.
    ...
    def list_workteams(
        ...
        """
        Gets a list of work teams that you have defined in a region. The list may be empty if no work team
    ...
    def search(
        ...
        """
        Finds Amazon SageMaker resources that match a search query. Matching resource objects are returned
        as a list of ``SearchResult`` objects in the response. You can sort the search results by any
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          ``SearchResponse`` includes a ``NextToken`` . The ``NextToken`` can be passed to the next
          ``SearchRequest`` to continue retrieving results for the specified ``SearchExpression`` and
          ``Sort`` parameters.
    ...
    def start_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        storage volume. After configuring the notebook instance, Amazon SageMaker sets the notebook instance
        status to ``InService`` . A notebook instance's status must be ``InService`` before you can connect
    ...
    def stop_compilation_job(self, CompilationJobName: str) -> None:
        ...
        CompilationJobSummary$CompilationJobStatus of the job to ``Stopping`` . After Amazon SageMaker stops
        the job, it sets the  CompilationJobSummary$CompilationJobStatus to ``Stopped`` .
    ...
    def stop_hyper_parameter_tuning_job(self, HyperParameterTuningJobName: str) -> None:
        ...
        (Amazon S3). All data that the training jobs write to Amazon CloudWatch Logs are still available in
        CloudWatch. After the tuning job moves to the ``Stopped`` state, it releases all reserved resources
        for the tuning job.
    ...
    def stop_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        the ML storage volume from it. Amazon SageMaker preserves the ML storage volume. Amazon SageMaker
    ...
    def stop_training_job(self, TrainingJobName: str) -> None:
        ...
        which delays job termination for 120 seconds. Algorithms might use this 120-second window to save
        the model artifacts, so the results of the training is not lost.
    ...
    def stop_transform_job(self, TransformJobName: str) -> None:
        ...
        stop a transform job before it is completed, Amazon SageMaker doesn't store the job's output in
        Amazon S3.
    ...
    def update_code_repository(
        self,
        CodeRepositoryName: str,
        GitConfig: ClientUpdateCodeRepositoryGitConfigTypeDef = None,
    ) -> ClientUpdateCodeRepositoryResponseTypeDef:
        """
    ...
    def update_endpoint(
        ...
        updating the endpoint, it sets the status to ``InService`` . To check the status of an endpoint, use
        the `DescribeEndpoint <https://docs.aws.amazon.com/sagemaker/latest/dg/API_DescribeEndpoint.html>`__
        API.
    ...
    def update_endpoint_weights_and_capacities(
        ...
        one variant associated with an existing endpoint. When it receives the request, Amazon SageMaker
    ...
    def update_notebook_instance(
        ...
        **Request Syntax**
        ...
        :param DisassociateLifecycleConfig:
          ...
          the notebook instance. This operation is idempotent. If you specify a lifecycle configuration that
          is not associated with the notebook instance when you call this method, it does not throw an
          error.
        ...
        :param VolumeSizeInGB:
          ...
          update a notebook instance, but you can't decrease the volume size. If you want to decrease the
          size of the ML storage volume in use, create a new notebook instance with the desired size.

        :type DefaultCodeRepository: string
        :param DefaultCodeRepository:

          The Git repository to associate with the notebook instance as its default code repository. This
          can be either the name of a Git repository stored as a resource in your account, or the URL of a
          Git repository in `AWS CodeCommit
          <https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html>`__ or in any other Git
          repository. When you open a notebook instance, it opens in the directory that contains this
          repository. For more information, see `Associating Git Repositories with Amazon SageMaker Notebook
          Instances <https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-git-repo.html>`__ .
        ...
        :param DisassociateAcceleratorTypes:
          ...
          operation is idempotent. If you specify an accelerator type that is not associated with the
        ...
        :param DisassociateAdditionalCodeRepositories:
          ...
          This operation is idempotent. If you specify a Git repository that is not associated with the
          notebook instance when you call this method, it does not throw an error.
    ...
    def update_notebook_instance_lifecycle_config(
        ...
        **Request Syntax**
        ...
        :param OnCreate:
          ...
          The shell script that runs only once, when you create a notebook instance. The shell script must
    ...
    def get_paginator(
        self,
        operation_name: Literal["list_training_jobs_for_hyper_parameter_tuning_job"],
    ...
    ) -> paginator_scope.SearchPaginator:
        """
