"Main interface for sagemaker Client"
...
import mypy_boto3_sagemaker.client as client_scope

# pylint: disable=import-self
import mypy_boto3_sagemaker.paginator as paginator_scope
...
# pylint: disable=import-self
import mypy_boto3_sagemaker.waiter as waiter_scope
...
class Client(BaseClient):
    ...
    def add_tags(
        ...
        tags to notebook instances, training jobs, hyperparameter tuning jobs, batch transform jobs,
        ...
        more information about tags, see For more information, see `AWS Tagging Strategies
        ...
        .. note::
          ...
          training jobs that the hyperparameter tuning job launches after you call this API, but not
          to training jobs that the hyperparameter tuning job launched before you called this API.
          To make sure that the tags associated with a hyperparameter tuning job are also added to
          all training jobs that the hyperparameter tuning job launches, add the tags when you first
          create the tuning job by specifying them in the ``Tags`` parameter of
          CreateHyperParameterTuningJob

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/AddTags>`_
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          required. If you don't specify a value, Amazon SageMaker sets the value to an empty
          string.
    ...
    def create_algorithm(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateAlgorithm>`_
        ...
        **Request Syntax**
          ...
          response = client.create_algorithm(
              ...
              TrainingSpecification={
                  ...
                  'SupportedTrainingInstanceTypes': [
                      ...
                      |'ml.p3dn.24xlarge'|'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'
              ...
              InferenceSpecification={
                  ...
                  'SupportedRealtimeInferenceInstanceTypes': [
                      'ml.t2.medium'|'ml.t2.large'|'ml.t2.xlarge'|'ml.t2.2xlarge'|'ml.m4.xlarge'
                      |'ml.m4.2xlarge'|'ml.m4.4xlarge'|'ml.m4.10xlarge'|'ml.m4.16xlarge'
                      |'ml.m5.large'|'ml.m5.xlarge'|'ml.m5.2xlarge'|'ml.m5.4xlarge'|'ml.m5.12xlarge'
                      |'ml.m5.24xlarge'|'ml.m5d.large'|'ml.m5d.xlarge'|'ml.m5d.2xlarge'
                      |'ml.m5d.4xlarge'|'ml.m5d.12xlarge'|'ml.m5d.24xlarge'|'ml.c4.large'
                      |'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'|'ml.c4.8xlarge'|'ml.p2.xlarge'
                      |'ml.p2.8xlarge'|'ml.p2.16xlarge'|'ml.p3.2xlarge'|'ml.p3.8xlarge'
                      |'ml.p3.16xlarge'|'ml.c5.large'|'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'
                      |'ml.c5.9xlarge'|'ml.c5.18xlarge'|'ml.c5d.large'|'ml.c5d.xlarge'
                      |'ml.c5d.2xlarge'|'ml.c5d.4xlarge'|'ml.c5d.9xlarge'|'ml.c5d.18xlarge'
                      |'ml.g4dn.xlarge'|'ml.g4dn.2xlarge'|'ml.g4dn.4xlarge'|'ml.g4dn.8xlarge'
                      |'ml.g4dn.12xlarge'|'ml.g4dn.16xlarge'|'ml.r5.large'|'ml.r5.xlarge'
                      |'ml.r5.2xlarge'|'ml.r5.4xlarge'|'ml.r5.12xlarge'|'ml.r5.24xlarge'
                      |'ml.r5d.large'|'ml.r5d.xlarge'|'ml.r5d.2xlarge'|'ml.r5d.4xlarge'
                      |'ml.r5d.12xlarge'|'ml.r5d.24xlarge',
                  ],
                  'SupportedContentTypes': [
                      'string',
                  ],
        ...
        :param TrainingSpecification: **[REQUIRED]**
          ...
          * The input channels that the algorithm supports for training data. For example, an
          ...
          - **MetricDefinitions** *(list) --*
            ...
            A list of ``MetricDefinition`` objects, which are used for parsing metrics generated by
            the algorithm.
          ...
          - **TrainingChannels** *(list) --* **[REQUIRED]**
            ...
            A list of ``ChannelSpecification`` objects, which specify the input sources to be used
            by the algorithm.
        ...
        :param InferenceSpecification:
          ...
          * The instance types that the algorithm supports for transform jobs and real-time
          ...
          - **Containers** *(list) --* **[REQUIRED]**
            ...
            - *(dict) --*
              ...
              - **Image** *(string) --* **[REQUIRED]**
                ...
                Amazon SageMaker, the inference code must meet Amazon SageMaker requirements. Amazon
        ...
        :param ValidationSpecification:
          ...
          Specifies configurations for one or more training jobs and that Amazon SageMaker runs to
          test the algorithm's training code and, optionally, one or more batch transform jobs that
          ...
          - **ValidationProfiles** *(list) --* **[REQUIRED]**
            ...
            job and batch transform job that Amazon SageMaker runs to validate your algorithm.
            ...
            - *(dict) --*
              ...
              - **TrainingJobDefinition** *(dict) --* **[REQUIRED]**
                ...
                - **TrainingInputMode** *(string) --* **[REQUIRED]**
                  ...
                  ``Pipe`` input mode, Amazon SageMaker streams data directly from S3 to the
                  container.
                ...
                - **InputDataConfig** *(list) --* **[REQUIRED]**
                  ...
                  - *(dict) --*
                    ...
                    - **DataSource** *(dict) --* **[REQUIRED]**
                      ...
                      - **S3DataSource** *(dict) --*
                        ...
                        - **S3DataType** *(string) --* **[REQUIRED]**
                          ...
                          Amazon SageMaker uses all objects that match the specified key name prefix
                          for model training.
                          ...
                          data you want to use for model training. ``AugmentedManifestFile`` can
                        ...
                        - **S3DataDistributionType** *(string) --*
                          ...
                          training job, each instance gets approximately 1/*n* of the number of S3
                          ...
                          training data to the ML storage volume (when ``TrainingInputMode`` is set
                    ...
                    - **RecordWrapperType** *(string) --*
                      ...
                      data is already in RecordIO format, you don't need to set this attribute. For
                    ...
                    - **InputMode** *(string) --*
                      ...
                      you don't set a value for ``InputMode`` , Amazon SageMaker uses the value set
                      ...
                      (Amazon S3) to the provisioned ML storage volume, and mount the directory to a
                      Docker volume, use ``File`` input mode. To stream data directly from Amazon S3
                      to the container, choose ``Pipe`` input mode.
                    ...
                    - **ShuffleConfig** *(dict) --*
                      ...
                      ``AugmentedManifestFile`` is shuffled. The shuffling order is determined using
                      the ``Seed`` value.

                      For Pipe input mode, shuffling is done at the start of every epoch. With large
                      datasets this ensures that the order of the training data is different for
                      each epoch, it helps reduce bias and possible overfitting. In a multi-node
                      ...
                      sent to a particular node on the first epoch might be sent to a different node
                      on the second epoch.
                ...
                - **OutputDataConfig** *(dict) --* **[REQUIRED]**
                  ...
                  - **KmsKeyId** *(string) --*
                    ...
                    * // Amazon Resource Name (ARN) of a KMS Key Alias
                    ...
                    <https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingKMSEncryption.html>`__ in
              ...
              - **TransformJobDefinition** *(dict) --*
                ...
                - **TransformInput** *(dict) --* **[REQUIRED]**
                    ...
                    - **S3DataSource** *(dict) --* **[REQUIRED]**
                      ...
                      - **S3Uri** *(string) --* **[REQUIRED]**
                        ...
                        * A manifest might look like this: ``s3://bucketname/example.manifest``
                        ...
                        set of ``S3Uris`` in this manifest constitutes the input data for the
                  ...
                  - **SplitType** *(string) --*
                    ...
                    processing multiple concurrent mini-batches. The default value for ``SplitType``
                    ...
                    of records in each request, up to the ``MaxPayloadInMB`` limit. If the value of
                    ``BatchStrategy`` is ``SingleRecord`` , Amazon SageMaker sends individual
                    ...
                    .. note::
                      ...
                      removed if the value of ``BatchStrategy`` is set to ``SingleRecord`` . Padding
                ...
                - **TransformOutput** *(dict) --* **[REQUIRED]**
                  ...
                  - **S3OutputPath** *(string) --* **[REQUIRED]**
                    ...
                    that contains multiple records, it creates an .``out`` file only if the
                    transform job succeeds on the entire file. When the input contains multiple S3
                    objects, the batch transform job processes the listed S3 objects and uploads
                    only the output for successfully processed objects. If any object fails in the
                  ...
                  - **KmsKeyId** *(string) --*
                    ...
                    * // Amazon Resource Name (ARN) of a KMS Key Alias
                    ...
                    The KMS key policy must grant permission to the IAM role that you specify in
                    your  CreateModel request. For more information, see `Using Key Policies in AWS
                    KMS <http://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html>`__
                    in the *AWS Key Management Service Developer Guide* .
                ...
                - **TransformResources** *(dict) --* **[REQUIRED]**
                  ...
                  - **VolumeKmsKeyId** *(string) --*
                    ...
                    run the batch transform job. The ``VolumeKmsKeyId`` can be any of the following
                    formats:
    ...
    def create_code_repository(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateCodeRepository>`_
        ...
        **Request Syntax**
        ...
        :param GitConfig: **[REQUIRED]**
          ...
          Specifies details about the repository, including the URL where the repository is located,
          the default branch, and credentials to use to access the repository.
    ...
    def create_compilation_job(
        ...
        resulting model artifacts as part of the model. You can also use the artifacts with AWS IoT
        ...
        * ``The Amazon Resource Name (ARN) of the IAM role that Amazon SageMaker assumes to perform
        ...
        To stop a model compilation job, use  StopCompilationJob . To get information about a
        particular model compilation job, use  DescribeCompilationJob . To get information about
        multiple model compilation jobs, use  ListCompilationJobs .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateCompilationJob>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_compilation_job(
              ...
              OutputConfig={
                  ...
                  'TargetDevice':
                  'lambda'|'ml_m4'|'ml_m5'|'ml_c4'|'ml_c5'|'ml_p2'|'ml_p3'|'jetson_tx1'
                  |'jetson_tx2'|'jetson_nano'|'rasp3b'|'deeplens'|'rk3399'|'rk3288'
        ...
        :param CompilationJobName: **[REQUIRED]**
          ...
          A name for the model compilation job. The name must be unique within the AWS Region and
        ...
        :param InputConfig: **[REQUIRED]**
          ...
          Provides information about the location of input model artifacts, the name and shape of
          ...
          - **DataInputConfig** *(string) --* **[REQUIRED]**
            ...
            JSON dictionary form. The data inputs are  InputConfig$Framework specific.

            * ``TensorFlow`` : You must specify the name and shape (NHWC format) of the expected
            ...
            * ``MXNET/ONNX`` : You must specify the name and shape (NCHW format) of the expected
            data inputs in order using a dictionary format for your trained model. The dictionary
            ...
            * ``PyTorch`` : You can either specify the name and shape (NCHW format) of expected data
            ...
            shape only using a list format. The dictionary formats required for the console and CLI
            are different. The list formats for the console and CLI are the same.
        ...
        :param StoppingCondition: **[REQUIRED]**
          ...
          Specifies a limit to how long a model compilation job can run. When the job reaches the
          time limit, Amazon SageMaker ends the compilation job. Use this API to cap model training
          costs.
    ...
    def create_endpoint(
        ...
        endpoint configuration with the `CreateEndpointConfig
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpointConfig.html>`__ API.
        ...
        After it creates the endpoint, it sets the status to ``InService`` . Amazon SageMaker can
        then process incoming requests for inferences. To check the status of an endpoint, use the
        `DescribeEndpoint
        ...
        Amazon SageMaker uses AWS Security Token Service to download model artifacts from the S3
        path you provided. AWS STS is activated in your IAM user account by default. If you
        previously deactivated AWS STS for a region, you need to reactivate AWS STS for that region.
        For more information, see `Activating and Deactivating AWS STS i an AWS Region
        <IAM/latest/UserGuide/id_credentials_temp_enable-regions.html>`__ in the *AWS Identity and
        Access Management User Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateEndpoint>`_
        ...
        **Request Syntax**
        ...
        :param EndpointConfigName: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpointConfig.html>`__ .
    ...
    def create_endpoint_config(
        ...
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpoint.html>`__ API.

        .. note::

          Use this API only if you want to use Amazon SageMaker hosting services to deploy models
          into production.

        In the request, you define one or more ``ProductionVariant`` s, each of which identifies a
        model. Each ``ProductionVariant`` parameter also describes the resources that you want
        Amazon SageMaker to provision. This includes the number and type of ML compute instances to
        deploy.
        ...
        models, A and B, and you assign traffic weight 2 for model A and 1 for model B. Amazon
        SageMaker distributes two-thirds of the traffic to Model A, and one-third to model B.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateEndpointConfig>`_
        ...
        **Request Syntax**
              ...
              ProductionVariants=[
                  {
                      ...
                      |'ml.m5d.large'|'ml.m5d.xlarge'|'ml.m5d.2xlarge'
                      |'ml.m5d.4xlarge'|'ml.m5d.12xlarge'|'ml.m5d.24xlarge'
                      |'ml.c4.large'|'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'
                      |'ml.c4.8xlarge'|'ml.p2.xlarge'|'ml.p2.8xlarge'|'ml.p2.16xlarge'
                      |'ml.p3.2xlarge'|'ml.p3.8xlarge'|'ml.p3.16xlarge'|'ml.c5.large'
                      |'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'|'ml.c5.9xlarge'
                      |'ml.c5.18xlarge'|'ml.c5d.large'|'ml.c5d.xlarge'
                      |'ml.c5d.2xlarge'|'ml.c5d.4xlarge'|'ml.c5d.9xlarge'
                      |'ml.c5d.18xlarge'|'ml.g4dn.xlarge'|'ml.g4dn.2xlarge'
                      |'ml.g4dn.4xlarge'|'ml.g4dn.8xlarge'|'ml.g4dn.12xlarge'
                      |'ml.g4dn.16xlarge'|'ml.r5.large'|'ml.r5.xlarge'|'ml.r5.2xlarge'
                      |'ml.r5.4xlarge'|'ml.r5.12xlarge'|'ml.r5.24xlarge'
                      |'ml.r5d.large'|'ml.r5d.xlarge'|'ml.r5d.2xlarge'
                      |'ml.r5d.4xlarge'|'ml.r5d.12xlarge'|'ml.r5d.24xlarge',
        ...
        :param EndpointConfigName: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateEndpoint.html>`__ request.
        ...
        :param ProductionVariants: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            Identifies a model that you want to host and the resources to deploy for hosting it. If
            you are deploying multiple models, tell Amazon SageMaker how to distribute traffic among
            ...
            - **InitialVariantWeight** *(float) --*
              ...
              ratio of the ``VariantWeight`` to the sum of all ``VariantWeight`` values across all
        ...
        :param KmsKeyId:
          ...
          uses to encrypt data on the storage volume attached to the ML compute instance that hosts
          the endpoint.
          ...
          .. note::
            ...
            request a ``KmsKeyId`` when using an instance type with local storage. If any of the
            models that you specify in the ``ProductionVariants`` parameter use nitro-based
            instances with local storage, do not specify a value for the ``KmsKeyId`` parameter. If
            you specify a value for ``KmsKeyId`` when using any nitro-based instances with local
    ...
    def create_hyper_parameter_tuning_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateHyperParameterTuningJob>`_
        ...
        **Request Syntax**
        ...
        :param HyperParameterTuningJobName: **[REQUIRED]**
          ...
          that this tuning job launches. The name must be unique within the same AWS account and AWS
          Region. The name must have { } to { } characters. Valid characters are a-z, A-Z, 0-9, and
        ...
        :param HyperParameterTuningJobConfig: **[REQUIRED]**
          ...
          The  HyperParameterTuningJobConfig object that describes the tuning job, including the
          search strategy, the objective metric used to evaluate training jobs, ranges of parameters
          to search, and resource limits for the tuning job. For more information, see
          ...
          - **HyperParameterTuningJobObjective** *(dict) --*
            ...
            The  HyperParameterTuningJobObjective object that specifies the objective metric for
            this tuning job.
          ...
          - **ParameterRanges** *(dict) --*
            ...
            The  ParameterRanges object that specifies the ranges of hyperparameters that this
            tuning job searches.
        ...
        :param TrainingJobDefinition:
          ...
          tuning job launches, including static hyperparameters, input data configuration, output
          data configuration, resource configuration, and stopping condition.
          ...
          - **AlgorithmSpecification** *(dict) --* **[REQUIRED]**
            ...
            The  HyperParameterAlgorithmSpecification object that specifies the resource algorithm
          ...
          - **VpcConfig** *(dict) --*
            ...
            hyperparameter tuning job launches to connect to. Control access to and from your
            training container by configuring the VPC. For more information, see `Protect Training
          ...
          - **ResourceConfig** *(dict) --* **[REQUIRED]**
            ...
            also use storage volumes for scratch space. If you want Amazon SageMaker to use the
            storage volume to store the training data, choose ``File`` as the ``TrainingInputMode``
          ...
          - **StoppingCondition** *(dict) --* **[REQUIRED]**
            ...
            When the job reaches the a limit, Amazon SageMaker ends the training job. Use this API
          ...
          - **EnableNetworkIsolation** *(boolean) --*
            ...
            network isolation is used for training jobs that are configured to use a VPC, Amazon
        ...
        :param WarmStartConfig:
          ...
          objective metric. If you specify ``IDENTICAL_DATA_AND_ALGORITHM`` as the ``WarmStartType``
          value for the warm start configuration, the training job that performs the best in the new
          tuning job is compared to the best training jobs from the parent tuning jobs. From these,
          the training job that performs the best as measured by the objective metric is returned as
          ...
          - **ParentHyperParameterTuningJobs** *(list) --* **[REQUIRED]**
            ...
            tuning job, see `Using a Previous Hyperparameter Tuning Job as a Starting Point
            <https://docs.aws.amazon.com/sagemaker/latest/dg/automatic-model-tuning-warm-start.html>`__
            .

            Hyperparameter tuning jobs created before October 1, 2018 cannot be used as parent jobs
            for warm start tuning jobs.
          ...
          - **WarmStartType** *(string) --* **[REQUIRED]**
            ...
            number of training jobs that the hyperparameter tuning job launches. You cannot use a
            new version of the training algorithm, unless the changes in the new version do not
            affect the algorithm itself. For example, changes that improve logging or adding support
            for a different data format are allowed. You can also change hyperparameters from
            tunable to static, and from static to tunable, but the total number of static plus
            tunable hyperparameters must remain the same as it is in all parent jobs. The objective
            ...
            different than those of its parent hyperparameter tuning jobs. The training image can
            also be a different version from the version used in the parent hyperparameter tuning
            job. You can also change hyperparameters from tunable to static, and from static to
            tunable, but the total number of static plus tunable hyperparameters must remain the
            same as it is in all parent jobs. The objective metric for the new tuning job must be
        ...
        :param Tags:
          ...
          <https://docs.aws.amazon.com/https:/aws.amazon.com/answers/account-management/aws-tagging-strategies/>`__
          .
    ...
    def create_labeling_job(
        ...
        * A private workforce that you create. It can include employees, contractors, and outside
        experts. Use a private workforce when want the data to stay within your organization or when
        a specific set of skills is required.

        * One or more vendors that you select from the AWS Marketplace. Vendors provide expertise in
        specific areas.

        * The Amazon Mechanical Turk workforce. This is the largest workforce, but it should only be
        used for public data or data that has been stripped of any personally identifiable
        information.
        ...
        <https://docs.aws.amazon.com/sagemaker/latest/dg/sms-automated-labeling.html>`__ .

        The data objects to be labeled are contained in an Amazon S3 bucket. You create a *manifest
        file* that describes the location of each object. For more information, see `Using Input and
        Output Data <https://docs.aws.amazon.com/sagemaker/latest/dg/sms-data.html>`__ .

        The output can be used as the manifest file for another labeling job or as training data for
        your machine learning models.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateLabelingJob>`_
        ...
        **Request Syntax**
        ...
        :param LabelAttributeName: **[REQUIRED]**
          ...
          The attribute name to use for the label in the output manifest file. This is the key for
          the key/value pair formed with the label that a worker assigns to the object. The name
          can't end with "-metadata". If you are running a semantic segmentation labeling job, the
          attribute name must end with "-ref". If you are running any other kind of labeling job,
          the attribute name must not end with "-ref".

        :type InputConfig: dict
        :param InputConfig: **[REQUIRED]**

          Input data for the labeling job, such as the Amazon S3 location of the data objects and
        ...
        :param OutputConfig: **[REQUIRED]**
          ...
          The location of the output data and the AWS Key Management Service key ID for the key used
          ...
          - **KmsKeyId** *(string) --*
            ...
            ID, Amazon SageMaker uses the default KMS key for Amazon S3 for your role's account.
            Amazon SageMaker uses server-side encryption with KMS-managed keys for
            ``LabelingJobOutputConfig`` . If you use a bucket policy with an ``s3:PutObject``
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          behalf during data labeling. You must grant this role the necessary permissions so that
          Amazon SageMaker can successfully complete data labeling.
        ...
        :param StoppingConditions:
          ...
          A set of conditions for stopping the labeling job. If any of the conditions are met, the
        ...
        :param HumanTaskConfig: **[REQUIRED]**
          ...
          - **UiConfig** *(dict) --* **[REQUIRED]**
            ...
            - **UiTemplateS3Uri** *(string) --* **[REQUIRED]**
              ...
              The Amazon S3 bucket location of the UI template. For more information about the
              contents of a UI template, see `Creating Your Custom Labeling Task Template
          ...
          - **MaxConcurrentTaskCount** *(integer) --*
            ...
            same time. Each object may have more than one worker at one time.
          ...
          - **AnnotationConsolidationConfig** *(dict) --* **[REQUIRED]**
            ...
            - **AnnotationConsolidationLambdaArn** *(string) --* **[REQUIRED]**
              ...
              * *Semantic segmentation* - Treats each pixel in an image as a multi-class
              classification and treats pixel annotations from workers as "votes" for the correct
              label.  ``arn:aws:lambda:us-east-1:432418664414:function:ACS-SemanticSegmentation``
    ...
    def create_model(
        ...
        primary container. For the primary container, you specify the docker image containing
        ...
        Use this API to create a model if you want to use Amazon SageMaker hosting services or run a
        batch transform job.

        To host your model, you create an endpoint configuration with the ``CreateEndpointConfig``
        API, and then create an endpoint with the ``CreateEndpoint`` API. Amazon SageMaker then
        deploys all of the containers that you defined for the model in the hosting environment.

        To run a batch transform using your model, you start a job with the ``CreateTransformJob``
        API. Amazon SageMaker uses your model and your dataset to get inferences which are then
        saved to a specified S3 location.
        ...
        model artifacts and docker image for deployment on ML compute hosting instances or for batch
        transform jobs. In addition, you also use the IAM role to manage permissions the inference
        code needs. For example, if the inference code access any other AWS resources, you grant
        necessary permissions via this role.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateModel>`_
        ...
        **Request Syntax**
        ...
        :param PrimaryContainer:
          ...
          - **ModelDataUrl** *(string) --*
            ...
            path is required for Amazon SageMaker built-in algorithms, but not if you use your own
            ...
            you need to reactivate AWS STS for that region. For more information, see `Activating
            and Deactivating AWS STS in an AWS Region
        ...
        :param Containers:
          ...
          - *(dict) --*
            ...
            - **ContainerHostname** *(string) --*
              ...
              For information, see `Use Logs and Metrics to Monitor an Inference Pipeline
              <https://docs.aws.amazon.com/sagemaker/latest/dg/inference-pipeline-logs-metrics.html>`__
              . If you don't specify a value for this parameter for a ``ContainerDefinition`` that
              is part of an inference pipeline, a unique name is automatically assigned based on the
              position of the ``ContainerDefinition`` in the pipeline. If you specify a value for
              the ``ContainerHostName`` for any ``ContainerDefinition`` that is part of an inference
              pipeline, you must specify a value for the ``ContainerHostName`` parameter of every
              ``ContainerDefinition`` in that pipeline.
            ...
            - **Image** *(string) --*
              ...
              The Amazon EC2 Container Registry (Amazon ECR) path where inference code is stored. If
              you are using your own custom algorithm instead of an algorithm provided by Amazon
              SageMaker, the inference code must meet Amazon SageMaker requirements. Amazon
              SageMaker supports both ``registry/repository[:tag]`` and
              ``registry/repository[@digest]`` image path formats. For more information, see `Using
              Your Own Algorithms with Amazon SageMaker
              <https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms.html>`__
            ...
            - **ModelDataUrl** *(string) --*
              ...
              If you provide a value for this parameter, Amazon SageMaker uses AWS Security Token
              Service to download model artifacts from the S3 path you provide. AWS STS is activated
              in your IAM user account by default. If you previously deactivated AWS STS for a
              region, you need to reactivate AWS STS for that region. For more information, see
            ...
            - **Environment** *(dict) --*
              ...
              The environment variables to set in the Docker container. Each key and value in the
              ``Environment`` string to string map can have length of up to 1024. We support up to
              16 entries in the map.
        ...
        :param VpcConfig:
          ...
          A `VpcConfig <https://docs.aws.amazon.com/sagemaker/latest/dg/API_VpcConfig.html>`__
          object that specifies the VPC that you want your model to connect to. Control access to
          and from your model container by configuring the VPC. ``VpcConfig`` is used in hosting
          services and in batch transform. For more information, see `Protect Endpoints by Using an
          Amazon Virtual Private Cloud
          <https://docs.aws.amazon.com/sagemaker/latest/dg/host-vpc.html>`__ and `Protect Data in
        ...
        :param EnableNetworkIsolation:
          ...
          Isolates the model container. No inbound or outbound network calls can be made to or from
          the model container.
    ...
    def create_model_package(
        ...
        ``InferenceSpecification`` . To create a model from an algorithm resource that you created
        or subscribed to in AWS Marketplace, provide a value for ``SourceAlgorithmSpecification`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateModelPackage>`_
        ...
        **Request Syntax**
        ...
        :param ModelPackageName: **[REQUIRED]**
          ...
          The name of the model package. The name must have 1 to 63 characters. Valid characters are
        ...
        :param ValidationSpecification:
          ...
          Specifies configurations for one or more transform jobs that Amazon SageMaker runs to test
          the model package.
    ...
    def create_notebook_instance(
        ...
        In a ``CreateNotebookInstance`` request, specify the type of ML compute instance that you
        want to run. Amazon SageMaker launches the instance, installs common libraries that you can
        use to explore datasets for model training, and attaches an ML storage volume to the
        notebook instance.
        ...
        * (Option) If you specified ``SubnetId`` , Amazon SageMaker creates a network interface in
        your own VPC, which is inferred from the subnet ID that you provide in the input. When
        creating this network interface, Amazon SageMaker attaches the security group that you
        specified in the request to the network interface that it creates in your VPC.

        * Launches an EC2 instance of the type specified in the request in the Amazon SageMaker VPC.
        If you specified ``SubnetId`` of your VPC, Amazon SageMaker specifies both network
        interfaces when launching this instance. This enables inbound traffic from your own VPC to
        ...
        After Amazon SageMaker creates the notebook instance, you can connect to the Jupyter server
        and work in Jupyter notebooks. For example, you can write code to explore a dataset that you
        can use for model training, train a model, host models by creating Amazon SageMaker
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateNotebookInstance>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_notebook_instance(
              ...
              InstanceType=
                  'ml.t2.medium'|'ml.t2.large'|'ml.t2.xlarge'|'ml.t2.2xlarge'|'ml.t3.medium'
                  |'ml.t3.large'|'ml.t3.xlarge'|'ml.t3.2xlarge'|'ml.m4.xlarge'|'ml.m4.2xlarge'
                  |'ml.m4.4xlarge'|'ml.m4.10xlarge'|'ml.m4.16xlarge'|'ml.m5.xlarge'|'ml.m5.2xlarge'
                  |'ml.m5.4xlarge'|'ml.m5.12xlarge'|'ml.m5.24xlarge'|'ml.c4.xlarge'|'ml.c4.2xlarge'
              ...
              VolumeSizeInGB=123,
              AcceleratorTypes=[
                  'ml.eia1.medium'|'ml.eia1.large'|'ml.eia1.xlarge'|'ml.eia2.medium'|'ml.eia2.large'
                  |'ml.eia2.xlarge',
              ],
        ...
        :param SecurityGroupIds:
          ...
          The VPC security group IDs, in the form sg-xxxxxxxx. The security groups must be for the
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          SageMaker service principal (sagemaker.amazonaws.com) permissionsto to assume this role.
        ...
        :param KmsKeyId:
          ...
          you provide must be enabled. For information, see `Enabling and Disabling Keys
          <https://docs.aws.amazon.com/kms/latest/developerguide/enabling-keys.html>`__ in the *AWS
          Key Management Service Developer Guide* .

        :type Tags: list
        :param Tags:

          A list of tags to associate with the notebook instance. You can add tags later by using
          the ``CreateTags`` API.
        ...
        :param LifecycleConfigName:
          ...
          information about lifestyle configurations, see `Step 2.1\\: (Optional) Customize a
          Notebook Instance
        ...
        :param DirectInternetAccess:
          ...
          Sets whether Amazon SageMaker provides internet access to the notebook instance. If you
          set this to ``Disabled`` this notebook instance will be able to access resources only in
        ...
        :param VolumeSizeInGB:
          ...
          The size, in GB, of the ML storage volume to attach to the notebook instance. The default
          value is 5 GB.
        ...
        :param AdditionalCodeRepositories:
          ...
          An array of up to three Git repositories to associate with the notebook instance. These
          can be either the names of Git repositories stored as resources in your account, or the
          URL of Git repositories in `AWS CodeCommit <codecommit/latest/userguide/welcome.html>`__
        ...
        :param RootAccess:
          ...
          .. note::
            ...
            Because of this, lifecycle configurations associated with a notebook instance always run
            with root access even if you disable root access for users.
    ...
    def create_notebook_instance_lifecycle_config(
        ...
        *lifecycle configuration* is a collection of shell scripts that run when you create or start
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateNotebookInstanceLifecycleConfig>`_
        ...
        **Request Syntax**
        ...
        :param OnCreate:
          ...
          A shell script that runs only once, when you create a notebook instance. The shell script
          ...
          - *(dict) --*
            ...
            for longer than 5 minutes, it fails and the notebook instance is not created or started.
    ...
    def create_presigned_notebook_instance_url(
        ...
        the Amazon SageMaker console, when you choose ``Open`` next to a notebook instance, Amazon
        ...
        restrict access to this API and to the URL that it returns to a list of IP addresses that
        you specify. Use the ``NotIpAddress`` condition operator and the ``aws:SourceIP`` condition
        context key to specify the list of IP addresses that you want to have access to the notebook
        instance. For more information, see `Limit Access to a Notebook Instance by IP Address
        <https://docs.aws.amazon.com/sagemaker/latest/dg/nbi-ip-filter.html>`__ .

        .. note::

          The URL that you get from a call to is valid only for 5 minutes. If you try to use the URL
          after the 5-minute limit expires, you are directed to the AWS console sign-in page.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreatePresignedNotebookInstanceUrl>`_
    ...
    def create_training_job(
        ...
        * ``HyperParameters`` - Specify these algorithm-specific parameters to enable the estimation
        of model parameters during training. Hyperparameters can be tuned to optimize this learning
        process. For a list of hyperparameters for each training algorithm provided by Amazon
        SageMaker, see `Algorithms <https://docs.aws.amazon.com/sagemaker/latest/dg/algos.html>`__ .

        * ``InputDataConfig`` - Describes the training dataset and the Amazon S3, EFS, or FSx
        location where it is stored.

        * ``OutputDataConfig`` - Identifies the Amazon S3 bucket where you want Amazon SageMaker to
        ...
        * ``EnableManagedSpotTraining`` - Optimize the cost of training machine learning models by
        up to 80% by using Amazon EC2 Spot instances. For more information, see `Managed Spot
        Training
        <https://docs.aws.amazon.com/sagemaker/latest/dg/model-managed-spot-training.html>`__ .

        * ``RoleARN`` - The Amazon Resource Number (ARN) that Amazon SageMaker assumes to perform
        ...
        * ``StoppingCondition`` - To help cap training costs, use ``MaxRuntimeInSeconds`` to set a
        time limit for training. Use ``MaxWaitTimeInSeconds`` to specify how long you are willing to
        to wait for a managed spot training job to complete.

        For more information about Amazon SageMaker, see `How It Works
        <https://docs.aws.amazon.com/sagemaker/latest/dg/how-it-works.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateTrainingJob>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_training_job(
              ...
              ResourceConfig={
                  ...
                  |'ml.c4.2xlarge'|'ml.c4.4xlarge'|'ml.c4.8xlarge'|'ml.p2.xlarge'
                  |'ml.p2.8xlarge'|'ml.p2.16xlarge'|'ml.p3.2xlarge'|'ml.p3.8xlarge'
                  |'ml.p3.16xlarge'|'ml.p3dn.24xlarge'|'ml.c5.xlarge'|'ml.c5.2xlarge'
        ...
        :param AlgorithmSpecification: **[REQUIRED]**
          ...
          algorithms provided by Amazon SageMaker, see `Algorithms
          ...
          - **AlgorithmName** *(string) --*
            ...
            algorithm resource that you created or subscribe to on AWS Marketplace. If you specify a
          ...
          - **TrainingInputMode** *(string) --* **[REQUIRED]**
            ...
            volume also stores the output model. The algorithm container use ML storage volume to
            ...
            your training duration is predictable if the input data objects size is approximately
            same. Amazon SageMaker does not split the files any further for model training. If the
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          During model training, Amazon SageMaker needs your permission to read input data from an
          S3 bucket, download a Docker image that contains training code, write model artifacts to
          an S3 bucket, write logs to Amazon CloudWatch Logs, and publish metrics to Amazon
        ...
        :param InputDataConfig:
          ...
          configuration for each channel provides the S3, EFS, or FSx location where the input data
          ...
          input data files from an S3 bucket to a local directory in the Docker container, or makes
          it available as input streams. For example, if you specify an EFS location, input data
          files will be made available as input streams. They do not need to be downloaded.
        ...
        :param ResourceConfig: **[REQUIRED]**
          ...
          also use ML storage volumes for scratch space. If you want Amazon SageMaker to use the ML
          storage volume to store the training data, choose ``File`` as the ``TrainingInputMode`` in
          the algorithm specification. For distributed training algorithms, specify an instance
          count greater than 1.
        ...
        :param VpcConfig:
          ...
          Control access to and from your training container by configuring the VPC. For more
        ...
        :param EnableNetworkIsolation:
          ...
          for calls between peers within a training cluster for distributed training. If you enable
          network isolation for training jobs that are configured to use a VPC, Amazon SageMaker
        ...
        :param EnableInterContainerTrafficEncryption:
          ...
          compute instances, especially if you use a deep learning algorithm in distributed
          training. For more information, see `Protect Communications Between ML Compute Instances
          in a Distributed Training Job
          <https://docs.aws.amazon.com/sagemaker/latest/dg/train-encrypt.html>`__ .
        ...
        :param EnableManagedSpotTraining:
          ...
          provides a fully managed and scalable infrastructure for training machine learning models.
          this option is useful when training jobs can be interrupted and when there is flexibility
          when the training job is run.

          The complete and intermediate results of jobs are stored in an Amazon S3 bucket, and can
          be used as a starting point to train models incrementally. Amazon SageMaker provides
          metrics and logs in CloudWatch. They can be used to see when managed spot training jobs
          are running, interrupted, resumed, or completed.

        :type CheckpointConfig: dict
    ...
    def create_transform_job(
        ...
        * ``TransformJobName`` - Identifies the transform job. The name must be unique within an AWS
        Region in an AWS account.

        * ``ModelName`` - Identifies the model to use. ``ModelName`` must be the name of an existing
        Amazon SageMaker model in the same AWS Region and AWS account. For information on creating a
        model, see  CreateModel .

        * ``TransformInput`` - Describes the dataset to be transformed and the Amazon S3 location
        where it is stored.

        * ``TransformOutput`` - Identifies the Amazon S3 location where you want Amazon SageMaker to
        save the results from the transform job.

        * ``TransformResources`` - Identifies the ML compute instances for the transform job.

        For more information about how batch transformation works, see `Batch Transform
        <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateTransformJob>`_
        ...
        **Request Syntax**
        ...
        :param TransformJobName: **[REQUIRED]**
          ...
          The name of the transform job. The name must be unique within an AWS Region in an AWS
          account.

        :type ModelName: string
        :param ModelName: **[REQUIRED]**

          The name of the model that you want to use for the transform job. ``ModelName`` must be
          the name of an existing Amazon SageMaker model within an AWS Region in an AWS account.
        ...
        :param MaxConcurrentTransforms:
          ...
          job. If ``MaxConcurrentTransforms`` is set to ``0`` or left unset, Amazon SageMaker checks
          the optional execution-parameters to determine the optimal settings for your chosen
          algorithm. If the execution-parameters endpoint is not enabled, the default value is ``1``
          . For more information on execution-parameters, see `How Containers Serve Requests
          <https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms-batch-code.html#your-algorithms-batch-code-how-containe-serves-requests>`__
        ...
        :param MaxPayloadInMB:
          ...
          record (without metadata). The value in ``MaxPayloadInMB`` must be greater than, or equal
          to, the size of a single record. To estimate the size of a record in MB, divide the size
          of your dataset by the number of records. To ensure that the records fit within the
          maximum payload size, we recommend using a slightly larger value. The default value is
          ``6`` MB.

          For cases where the payload might be arbitrarily large and is transmitted using HTTP
          chunked encoding, set the value to ``0`` . This feature works only in supported
        ...
        :param BatchStrategy:
          ...
          A *record*  is a single unit of input data that inference can be made on. For example, a
          single line in a CSV file is a record.
        ...
        :param DataProcessing:
          ...
          inference in a batch transform job. The output filter provided allows you to include input
          data relevant to interpreting the predictions in the output from the job. For more
          information, see `Associate Prediction Results with their Corresponding Input Records
          ...
          - **InputFilter** *(string) --*
            ...
            ``InputFilter`` parameter to exclude fields, such as an ID column, from the input. If
            you want Amazon SageMaker to pass the entire input dataset to the algorithm, accept the
            default value ``$`` .
          ...
          - **OutputFilter** *(string) --*
            ...
            A `JSONPath
            <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform-data-processing.html#data-processing-operators>`__
            expression used to select a portion of the joined dataset to save in the output file for
            a batch transform job. If you want Amazon SageMaker to store the entire input dataset in
            the output file, leave the default value, ``$`` . If you specify indexes that aren't
          ...
          - **JoinSource** *(string) --*
            ...
            input with the transformed data. If you want the batch transform job to join the
            original input data with the transformed data, set ``JoinSource`` to ``Input`` .
            ...
            and the input data is stored under the ``SageMakerInput`` key and the results are stored
            in ``SageMakerOutput`` .
    ...
    def create_workteam(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/CreateWorkteam>`_
        ...
        **Request Syntax**
        ...
        :param MemberDefinitions: **[REQUIRED]**
          ...
          A list of ``MemberDefinition`` objects that contains objects that identify the Amazon
          Cognito user pool that makes up the work team. For more information, see `Amazon Cognito
          User Pools
          <https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-identity-pools.html>`__
          .

          All of the ``CognitoMemberDefinition`` objects that make up the member definition must
          have the same ``ClientId`` and ``UserPool`` values.
        ...
        :param Tags:
          ...
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-resource-tags.html>`__
    ...
    def delete_algorithm(self, AlgorithmName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteAlgorithm>`_
    ...
    def delete_code_repository(self, CodeRepositoryName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteCodeRepository>`_
    ...
    def delete_endpoint(self, EndpointName: str) -> None:
        ...
        Amazon SageMaker retires any custom KMS key grants associated with the endpoint, meaning you
        don't need to use the `RevokeGrant
        <http://docs.aws.amazon.com/kms/latest/APIReference/API_RevokeGrant.html>`__ API call.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteEndpoint>`_
    ...
    def delete_endpoint_config(self, EndpointConfigName: str) -> None:
        ...
        specified configuration. It does not delete endpoints created using the configuration.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteEndpointConfig>`_
    ...
    def delete_model(self, ModelName: str) -> None:
        ...
        Amazon SageMaker when you called the `CreateModel
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateModel.html>`__ API. It does not
        delete model artifacts, inference code, or the IAM role that you specified when creating the
        model.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteModel>`_
    ...
    def delete_model_package(self, ModelPackageName: str) -> None:
        ...
        A model package is used to create Amazon SageMaker models or list on AWS Marketplace. Buyers
        can subscribe to model packages listed on AWS Marketplace to create models in Amazon
        SageMaker.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteModelPackage>`_
    ...
    def delete_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        you must call the ``StopNotebookInstance`` API.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteNotebookInstance>`_
    ...
    def delete_notebook_instance_lifecycle_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteNotebookInstanceLifecycleConfig>`_
    ...
    def delete_tags(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        .. note::
          ...
          When you call this API to delete tags from a hyperparameter tuning job, the deleted tags
          are not removed from training jobs that the hyperparameter tuning job launched before you
          called this API.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteTags>`_
    ...
    def delete_workteam(self, WorkteamName: str) -> ClientDeleteWorkteamResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DeleteWorkteam>`_
    ...
    def describe_algorithm(self, AlgorithmName: str) -> ClientDescribeAlgorithmResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeAlgorithm>`_
...

            {
                ...
                'InferenceSpecification': {
                    ...
                    'SupportedRealtimeInferenceInstanceTypes': [
                        ...
                        |'ml.m4.2xlarge'|'ml.m4.4xlarge'|'ml.m4.10xlarge'|'ml.m4.16xlarge'
                        |'ml.m5.large'|'ml.m5.xlarge'|'ml.m5.2xlarge'|'ml.m5.4xlarge'
                        |'ml.m5.12xlarge'|'ml.m5.24xlarge'|'ml.m5d.large'|'ml.m5d.xlarge'
                        |'ml.m5d.2xlarge'|'ml.m5d.4xlarge'|'ml.m5d.12xlarge'|'ml.m5d.24xlarge'
                        |'ml.c4.large'|'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'
                        |'ml.c4.8xlarge'|'ml.p2.xlarge'|'ml.p2.8xlarge'|'ml.p2.16xlarge'
                        |'ml.p3.2xlarge'|'ml.p3.8xlarge'|'ml.p3.16xlarge'|'ml.c5.large'
                        |'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'|'ml.c5.9xlarge'
                        |'ml.c5.18xlarge'|'ml.c5d.large'|'ml.c5d.xlarge'|'ml.c5d.2xlarge'
                        |'ml.c5d.4xlarge'|'ml.c5d.9xlarge'|'ml.c5d.18xlarge'|'ml.g4dn.xlarge'
                        |'ml.g4dn.2xlarge'|'ml.g4dn.4xlarge'|'ml.g4dn.8xlarge'|'ml.g4dn.12xlarge'
                        |'ml.g4dn.16xlarge'|'ml.r5.large'|'ml.r5.xlarge'|'ml.r5.2xlarge'
                        |'ml.r5.4xlarge'|'ml.r5.12xlarge'|'ml.r5.24xlarge'|'ml.r5d.large'
                        |'ml.r5d.xlarge'|'ml.r5d.2xlarge'|'ml.r5d.4xlarge'|'ml.r5d.12xlarge'
                        |'ml.r5d.24xlarge',
                    ],
                    'SupportedContentTypes': [
                        'string',
            ...
            - **TrainingSpecification** *(dict) --*
              ...
              - **MetricDefinitions** *(list) --*
                ...
                - *(dict) --*
                  ...
                  one metric that a hyperparameter tuning job uses as its objective metric to choose
              ...
              - **Containers** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **Image** *(string) --*
                    ...
                    If you are using your own custom algorithm instead of an algorithm provided by
                    Amazon SageMaker, the inference code must meet Amazon SageMaker requirements.
                    Amazon SageMaker supports both ``registry/repository[:tag]`` and
                    ``registry/repository[@digest]`` image path formats. For more information, see
                    `Using Your Own Algorithms with Amazon SageMaker
                    <https://docs.aws.amazon.com/sagemaker/latest/dg/your-algorithms.html>`__ .
                ...
                - *(dict) --*
                  ...
                  - **TrainingJobDefinition** *(dict) --*
                    ...
                    - **TrainingInputMode** *(string) --*
                      ...
                      the training data from S3 to the provisioned ML storage Volume, and mounts the
                    ...
                    - **InputDataConfig** *(list) --*
                      ...
                      - *(dict) --*
                          ...
                          - **S3DataSource** *(dict) --*
                            ...
                            - **S3Uri** *(string) --*
                              ...
                              * A manifest might look like this:
                              ...
                              ``"relative/path/to/custdata-1",``    ``"relative/path/custdata-2",``
                              ``...``    ``"relative/path/custdata-N"``    ``]``   The preceding
                        ...
                        - **ShuffleConfig** *(dict) --*
                          ...
                          use ``S3Prefix`` for ``S3DataType`` , this shuffles the results of the S3
                          key prefix matches. If you use ``ManifestFile`` , the order of the S3
                    ...
                    - **OutputDataConfig** *(dict) --*
                      ...
                      - **KmsKeyId** *(string) --*
                        ...
                        * // Amazon Resource Name (ARN) of a KMS Key Alias
                        ...
                        don't provide a KMS key ID, Amazon SageMaker uses the default KMS key for
                        Amazon S3 for your role's account. Amazon SageMaker uses server-side
                    ...
                    - **StoppingCondition** *(dict) --*
                      ...
                      - **MaxWaitTimeInSeconds** *(integer) --*
                        ...
                        must be equal to or greater than ``MaxRuntimeInSeconds`` .
                  ...
                  - **TransformJobDefinition** *(dict) --*
                    ...
                    - **BatchStrategy** *(string) --*
                      ...
                      mini-batch.
                       ...
                       ``MultiRecord`` means a mini-batch is set to contain as many records that can
                    ...
                    - **TransformInput** *(dict) --*
                      ...
                      - **DataSource** *(dict) --*
                        ...
                        - **S3DataSource** *(dict) --*
                          ...
                          - **S3Uri** *(string) --*
                            ...
                            * A manifest might look like this: ``s3://bucketname/example.manifest``
                            The manifest is an S3 object which is a JSON file with the following
                            format:   ``[ {"prefix": "s3://customer_bucket/some/prefix/"},``
                            ``"relative/path/to/custdata-1",``    ``"relative/path/custdata-2",``
                            ``...``    ``"relative/path/custdata-N"``    ``]``   The preceding JSON
                            matches the following ``s3Uris`` :
                            ``s3://customer_bucket/some/prefix/relative/path/to/custdata-1``
                            ``s3://customer_bucket/some/prefix/relative/path/custdata-2``    ``...``
                            ``s3://customer_bucket/some/prefix/relative/path/custdata-N``   The
                            complete set of ``S3Uris`` in this manifest constitutes the input data
                      ...
                      - **SplitType** *(string) --*
                        ...
                        value for ``SplitType`` is ``None`` , which indicates that input data files
                        are not split, and request payloads contain the entire contents of an input
                        ...
                        .. note::
                          ...
                          RecordIO <https://mxnet.apache.org/api/faq/recordio>`__ in the MXNet
                          documentation. For more information about ``TFRecord`` , see `Consuming
                          TFRecord data
                          <https://www.tensorflow.org/guide/datasets#consuming_tfrecord_data>`__ in
                    ...
                    - **TransformOutput** *(dict) --*
                      ...
                      - **S3OutputPath** *(string) --*
                        ...
                        object that contains multiple records, it creates an .``out`` file only if
                        the transform job succeeds on the entire file. When the input contains
                        multiple S3 objects, the batch transform job processes the listed S3 objects
                        and uploads only the output for successfully processed objects. If any
                        object fails in the transform job batch transform marks the job as failed to
                      ...
                      - **KmsKeyId** *(string) --*
                        ...
                        * // Amazon Resource Name (ARN) of a KMS Key Alias
                        ...
                        The KMS key policy must grant permission to the IAM role that you specify in
                        your  CreateModel request. For more information, see `Using Key Policies in
                        AWS KMS
    ...
    def describe_code_repository(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeCodeRepository>`_
    ...
    def describe_compilation_job(
        ...
        To create a model compilation job, use  CreateCompilationJob . To get information about
        multiple model compilation jobs, use  ListCompilationJobs .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeCompilationJob>`_
          ...
          ::

            {
                ...
                'OutputConfig': {
                    ...
                    |'jetson_tx1'|'jetson_tx2'|'jetson_nano'|'rasp3b'|'deeplens'
                    |'rk3399'|'rk3288'|'aisage'|'sbe_c'|'qcs605'|'qcs603'
                }
            }
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CompilationStartTime** *(datetime) --*
              ...
              DescribeCompilationJobResponse$CompilationEndTime field. In Amazon CloudWatch Logs,
            ...
            - **CompilationEndTime** *(datetime) --*
              ...
              uploading. For a failed job, this is when Amazon SageMaker detected that the job
              failed.
            ...
            - **InputConfig** *(dict) --*
              ...
              shape of the expected data inputs, and the framework in which the model was trained.
              ...
              - **DataInputConfig** *(string) --*
                ...
                a JSON dictionary form. The data inputs are  InputConfig$Framework specific.
                ...
                * ``MXNET/ONNX`` : You must specify the name and shape (NCHW format) of the expected
                data inputs in order using a dictionary format for your trained model. The
                ...
                * ``PyTorch`` : You can either specify the name and shape (NCHW format) of expected
                data inputs in order using a dictionary format for your trained model or you can
                specify the shape only using a list format. The dictionary formats required for the
                console and CLI are different. The list formats for the console and CLI are the
                same.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **EndpointStatus** *(string) --*
              ...
              * ``RollingBack`` : Endpoint fails to scale up or down or change its variant weight
              ...
              applies to an endpoint that has autoscaling enabled and is undergoing variant weight
              or capacity changes as part of an  UpdateEndpointWeightsAndCapacities call or when the
    ...
    def describe_endpoint_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeEndpointConfig>`_
                ...
                'ProductionVariants': [
                    {
                        ...
                        |'ml.m5.12xlarge'|'ml.m5.24xlarge'|'ml.m5d.large'
                        |'ml.m5d.xlarge'|'ml.m5d.2xlarge'|'ml.m5d.4xlarge'
                        |'ml.m5d.12xlarge'|'ml.m5d.24xlarge'|'ml.c4.large'
                        ...
                        |'ml.c5d.18xlarge'|'ml.g4dn.xlarge'|'ml.g4dn.2xlarge'
                        |'ml.g4dn.4xlarge'|'ml.g4dn.8xlarge'|'ml.g4dn.12xlarge'
                        |'ml.g4dn.16xlarge'|'ml.r5.large'|'ml.r5.xlarge'
                        |'ml.r5.2xlarge'|'ml.r5.4xlarge'|'ml.r5.12xlarge'
                        |'ml.r5.24xlarge'|'ml.r5d.large'|'ml.r5d.xlarge'
                        |'ml.r5d.2xlarge'|'ml.r5d.4xlarge'|'ml.r5d.12xlarge'
                        |'ml.r5d.24xlarge',
                        'InitialVariantWeight': ...,
                        'AcceleratorType':
                        'ml.eia1.medium'|'ml.eia1.large'|'ml.eia1.xlarge'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ProductionVariants** *(list) --*
              ...
              An array of ``ProductionVariant`` objects, one for each model that you want to host at
              this endpoint.

              - *(dict) --*

                Identifies a model that you want to host and the resources to deploy for hosting it.
                If you are deploying multiple models, tell Amazon SageMaker how to distribute
                ...
                - **InitialVariantWeight** *(float) --*
                  ...
                  by the ratio of the ``VariantWeight`` to the sum of all ``VariantWeight`` values
                ...
                - **AcceleratorType** *(string) --*
                  ...
                  see `Using Elastic Inference in Amazon SageMaker
                  <https://docs.aws.amazon.com/sagemaker/latest/dg/ei.html>`__ .
    ...
    def describe_hyper_parameter_tuning_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeHyperParameterTuningJob>`_
...

            {
                ...
                'TrainingJobDefinition': {
                    ...
                    'ResourceConfig': {
                        ...
                        |'ml.p3dn.24xlarge'|'ml.c5.xlarge'|'ml.c5.2xlarge'
                        |'ml.c5.4xlarge'|'ml.c5.9xlarge'|'ml.c5.18xlarge',
                        'InstanceCount': 123,
                        'VolumeSizeInGB': 123,
                        'VolumeKmsKeyId': 'string'
          ...
          - *(dict) --*
            ...
            - **HyperParameterTuningJobConfig** *(dict) --*
              ...
              - **Strategy** *(string) --*
                ...
                values to use for the training job it launches. To use the Bayesian search stategy,
                set this to ``Bayesian`` . To randomly search, set it to ``Random`` . For
              ...
              - **TrainingJobEarlyStoppingType** *(string) --*
                ...
                they are unlikely to perform better than previously completed training jobs. For
                more information, see `Stop Training Jobs Early
                <https://docs.aws.amazon.com/sagemaker/latest/dg/automatic-model-tuning-early-stopping.html>`__
                .

            - **TrainingJobDefinition** *(dict) --*

              The  HyperParameterTrainingJobDefinition object that specifies the definition of the
              ...
              - **AlgorithmSpecification** *(dict) --*
                ...
                - **TrainingInputMode** *(string) --*
                  ...
                  Amazon SageMaker downloads the training data from Amazon S3 to the storage volume
                  that is attached to the training instance and mounts the directory to the Docker
                ...
                - **MetricDefinitions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    ``stdout`` . Amazon SageMakerhyperparameter tuning captures all defined metrics.
                    You specify one metric that a hyperparameter tuning job uses as its objective
                  ...
                  - **DataSource** *(dict) --*
                    ...
                    - **S3DataSource** *(dict) --*
                      ...
                      - **S3Uri** *(string) --*
                        ...
                        * A manifest might look like this: ``s3://bucketname/example.manifest``
                        The manifest is an S3 object which is a JSON file with the following format:
                        The preceding JSON matches the following ``s3Uris`` :   ``[ {"prefix":
                        "s3://customer_bucket/some/prefix/"},``
                        ``"relative/path/to/custdata-1",``    ``"relative/path/custdata-2",``
                        ``...``    ``"relative/path/custdata-N"``    ``]``   The preceding JSON
                        matches the following ``s3Uris`` :
                        ...
                        ``s3://customer_bucket/some/prefix/relative/path/custdata-2``    ``...``
                        ``s3://customer_bucket/some/prefix/relative/path/custdata-N``   The complete
                        set of ``s3uris`` in this manifest is the input data for the channel for
                        this datasource. The object that each ``s3uris`` points to must be readable
              ...
              - **VpcConfig** *(dict) --*
                ...
                this hyperparameter tuning job launches to connect to. Control access to and from
                your training container by configuring the VPC. For more information, see `Protect
              ...
              - **OutputDataConfig** *(dict) --*
                ...
                - **KmsKeyId** *(string) --*
                  ...
                  * // Amazon Resource Name (ARN) of a KMS Key Alias
                  ...
                  keys for ``OutputDataConfig`` . If you use a bucket policy with an
                  ``s3:PutObject`` permission that only allows objects with server-side encryption,
                  set the condition key of ``s3:x-amz-server-side-encryption`` to ``"aws:kms"`` .
              ...
              - **ResourceConfig** *(dict) --*
                ...
                use the storage volume to store the training data, choose ``File`` as the
              ...
              - **StoppingCondition** *(dict) --*
                ...
                Specifies a limit to how long a model hyperparameter training job can run. It also
                specifies how long you are willing to wait for a managed spot training job to
                complete. When the job reaches the a limit, Amazon SageMaker ends the training job.
                ...
                - **MaxWaitTimeInSeconds** *(integer) --*
                  ...
                  The maximum length of time, in seconds, how long you are willing to wait for a
                  managed spot training job to complete. It is the amount of time spent waiting for
                  Spot capacity plus the amount of time the training job runs. It must be equal to
                  or greater than ``MaxRuntimeInSeconds`` .

              - **EnableNetworkIsolation** *(boolean) --*

                Isolates the training container. No inbound or outbound network calls can be made,
                except for calls between peers within a training cluster for distributed training.
                If network isolation is used for training jobs that are configured to use a VPC,
            ...
            - **BestTrainingJob** *(dict) --*
              ...
              A  TrainingJobSummary object that describes the training job that completed with the
              best current  HyperParameterTuningJobObjective .
              ...
              - **TrainingEndTime** *(datetime) --*
                ...
                for the time interval between the value of ``TrainingStartTime`` and this time. For
                successful jobs and stopped jobs, this is the time after model artifacts are
                uploaded. For failed jobs, this is the time when Amazon SageMaker detects a job
                failure.
              ...
              - **FinalHyperParameterTuningJobObjectiveMetric** *(dict) --*
                ...
                The  FinalHyperParameterTuningJobObjectiveMetric object that specifies the value of
                the objective metric of the tuning job that launched this training job.
              ...
              - **ObjectiveStatus** *(string) --*
                ...
                * Failed: The final objective metric for the training job was not evaluated, and was
                not used in the hyperparameter tuning process. This typically occurs when the
            ...
            - **OverallBestTrainingJob** *(dict) --*
              ...
              job with the best objective metric value of all training jobs launched by this tuning
              job and all parent jobs specified for the warm start tuning job.
            ...
            - **WarmStartConfig** *(dict) --*
              ...
              - **ParentHyperParameterTuningJobs** *(list) --*
                ...
                new hyperparameter tuning job. For more information about warm starting a
              ...
              - **WarmStartType** *(string) --*
                ...
                cannot use a new version of the training algorithm, unless the changes in the new
                version do not affect the algorithm itself. For example, changes that improve
                logging or adding support for a different data format are allowed. You can also
                change hyperparameters from tunable to static, and from static to tunable, but the
                total number of static plus tunable hyperparameters must remain the same as it is in
                all parent jobs. The objective metric for the new tuning job must be the same as for
                all parent jobs.

                  TRANSFER_LEARNING

                The new hyperparameter tuning job can include input data, hyperparameter ranges,
                maximum number of concurrent training jobs, and maximum number of training jobs that
                are different than those of its parent hyperparameter tuning jobs. The training
    ...
    def describe_labeling_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeLabelingJob>`_
          ...
          - *(dict) --*
            ...
            - **OutputConfig** *(dict) --*
              ...
              - **KmsKeyId** *(string) --*
                ...
                provide a KMS key ID, Amazon SageMaker uses the default KMS key for Amazon S3 for
                your role's account. Amazon SageMaker uses server-side encryption with KMS-managed
                keys for ``LabelingJobOutputConfig`` . If you use a bucket policy with an
                ``s3:PutObject`` permission that only allows objects with server-side encryption,
                ...
                *Amazon Simple Storage Service Developer Guide.*
                ...
                The KMS key policy must grant permission to the IAM role that you specify in your
                ``CreateLabelingJob`` request. For more information, see `Using Key Policies in AWS
                KMS <http://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html>`__ in
            ...
            - **LabelingJobAlgorithmsConfig** *(dict) --*
              ...
              - **InitialActiveLearningModelArn** *(string) --*
                ...
                Resource Nam (ARN) of the final model used for auto-labeling. You can use this model
                as the starting point for subsequent similar jobs by providing the ARN of the model
                here.
            ...
            - **HumanTaskConfig** *(dict) --*
              ...
              - **PreHumanTaskLambdaArn** *(string) --*
                ...
                For the built-in bounding box, image classification, semantic segmentation, and text
                classification task types, Amazon SageMaker Ground Truth provides the following
                Lambda functions:
              ...
              - **TaskAvailabilityLifetimeInSeconds** *(integer) --*
                ...
                The length of time that a task remains available for labeling by human workers. **If
                you choose the Amazon Mechanical Turk workforce, the maximum is 12 hours (43200)** .
              ...
              - **AnnotationConsolidationConfig** *(dict) --*
                ...
                - **AnnotationConsolidationLambdaArn** *(string) --*
                  ...
                  For the built-in bounding box, image classification, semantic segmentation, and
                  text classification task types, Amazon SageMaker Ground Truth provides the
                  ...
                  * *Image classification* - Uses a variant of the Expectation Maximization approach
                  ...
                  workers.  ``arn:aws:lambda:us-east-1:432418664414:function:ACS-ImageMultiClass``
                  ``arn:aws:lambda:us-east-2:266458841044:function:ACS-ImageMultiClass``
                  ``arn:aws:lambda:us-west-2:081040173940:function:ACS-ImageMultiClass``
                  ``arn:aws:lambda:eu-west-1:568282634449:function:ACS-ImageMultiClass``
                  ``arn:aws:lambda:ap-northeast-1:477331159723:function:ACS-ImageMultiClass``
    ...
    def describe_model(self, ModelName: str) -> ClientDescribeModelResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeModel>`_
          ...
          - *(dict) --*
            ...
            - **PrimaryContainer** *(dict) --*
              ...
              - **ContainerHostname** *(string) --*
                ...
                <https://docs.aws.amazon.com/sagemaker/latest/dg/inference-pipeline-logs-metrics.html>`__
                . If you don't specify a value for this parameter for a ``ContainerDefinition`` that
                is part of an inference pipeline, a unique name is automatically assigned based on
                the position of the ``ContainerDefinition`` in the pipeline. If you specify a value
                for the ``ContainerHostName`` for any ``ContainerDefinition`` that is part of an
              ...
              - **ModelDataUrl** *(string) --*
                ...
                S3 path is required for Amazon SageMaker built-in algorithms, but not if you use
                your own algorithms. For more information on built-in algorithms, see `Common
                Parameters
                <https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-algo-docker-registry-paths.html>`__
                .

                If you provide a value for this parameter, Amazon SageMaker uses AWS Security Token
                Service to download model artifacts from the S3 path you provide. AWS STS is
                activated in your IAM user account by default. If you previously deactivated AWS STS
                for a region, you need to reactivate AWS STS for that region. For more information,
                see `Activating and Deactivating AWS STS in an AWS Region
                <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_credentials_temp_enable-regions.html>`__
                in the *AWS Identity and Access Management User Guide* .
            ...
            - **Containers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ContainerHostname** *(string) --*
                  ...
                  is part of an inference pipeline, you must specify a value for the
                ...
                - **ModelDataUrl** *(string) --*
                  ...
                  suffix). The S3 path is required for Amazon SageMaker built-in algorithms, but not
                  if you use your own algorithms. For more information on built-in algorithms, see
                  `Common Parameters
                  <https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-algo-docker-registry-paths.html>`__
                  .

                  If you provide a value for this parameter, Amazon SageMaker uses AWS Security
                  Token Service to download model artifacts from the S3 path you provide. AWS STS is
                  activated in your IAM user account by default. If you previously deactivated AWS
                  STS for a region, you need to reactivate AWS STS for that region. For more
    ...
    def describe_model_package(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeModelPackage>`_
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'ml.t2.medium'|'ml.t2.large'|'ml.t2.xlarge'|'ml.t2.2xlarge'|'ml.t3.medium'
                |'ml.t3.large'|'ml.t3.xlarge'|'ml.t3.2xlarge'|'ml.m4.xlarge'|'ml.m4.2xlarge'
                |'ml.m4.4xlarge'|'ml.m4.10xlarge'|'ml.m4.16xlarge'|'ml.m5.xlarge'
                |'ml.m5.2xlarge'|'ml.m5.4xlarge'|'ml.m5.12xlarge'|'ml.m5.24xlarge'
                |'ml.c4.xlarge'|'ml.c4.2xlarge'|'ml.c4.4xlarge'|'ml.c4.8xlarge'
                |'ml.c5.xlarge'|'ml.c5.2xlarge'|'ml.c5.4xlarge'|'ml.c5.9xlarge'
                ...
                'VolumeSizeInGB': 123,
                'AcceleratorTypes': [
                    'ml.eia1.medium'|'ml.eia1.large'|'ml.eia1.xlarge'|'ml.eia2.medium'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DefaultCodeRepository** *(string) --*
              ...
              repository. This can be either the name of a Git repository stored as a resource in
              your account, or the URL of a Git repository in `AWS CodeCommit
              <https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html>`__ or in any
              other Git repository. When you open a notebook instance, it opens in the directory
              that contains this repository. For more information, see `Associating Git Repositories
            ...
            - **AdditionalCodeRepositories** *(list) --*
              ...
              the URL of Git repositories in `AWS CodeCommit
              <https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html>`__ or in any
    ...
    def describe_notebook_instance_lifecycle_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeNotebookInstanceLifecycleConfig>`_
          ...
          - *(dict) --*
            ...
            - **OnCreate** *(list) --*
              ...
              - *(dict) --*
                ...
                runs for longer than 5 minutes, it fails and the notebook instance is not created or
                started.
    ...
    def describe_subscribed_workteam(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeSubscribedWorkteam>`_
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'TrainingJobStatus': 'InProgress'|'Completed'|'Failed'|'Stopping'|'Stopped',
                'SecondaryStatus':
                'Starting'|'LaunchingMLInstances'|'PreparingTrainingStack'|'Downloading'
                |'DownloadingTrainingImage'|'Training'|'Uploading'|'Stopping'|'Stopped'
                |'MaxRuntimeExceeded'|'Completed'|'Failed'|'Interrupted'
                |'MaxWaitTimeExceeded',
                'FailureReason': 'string',
                'HyperParameters': {
                    'string': 'string'
                ...
                'SecondaryStatusTransitions': [
                    {
                        'Status':
                        'Starting'|'LaunchingMLInstances'|'PreparingTrainingStack'
          ...
          - *(dict) --*
            ...
            - **SecondaryStatusTransitions** *(list) --*
              ...
              - *(dict) --*
                ...
                be starting the training job or launching the ML instances. These transitional
                ...
                - **StatusMessage** *(string) --*
                  ...
                  Amazon SageMaker provides secondary statuses and status messages that apply to
                  each of them:
                  ...
                  * Training image download completed. Training in progress.
                  ...
                  and ``SecondaryStatus`` in  DescribeTrainingJob , and ``StatusMessage`` together.
            ...
            - **EnableNetworkIsolation** *(boolean) --*
              ...
              within a training cluster for distributed training, choose ``True`` . If you enable
              network isolation for training jobs that are configured to use a VPC, Amazon SageMaker
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TransformJobStatus** *(string) --*
              ...
              in the ``FailureReason`` field.

            - **FailureReason** *(string) --*

              If the transform job failed, ``FailureReason`` describes why it failed. A transform
              job creates a log file, which includes error messages, and stores it as an Amazon S3
              object. For more information, see `Log Amazon SageMaker Events with Amazon CloudWatch
            ...
            - **MaxConcurrentTransforms** *(integer) --*
              ...
              The maximum number of parallel requests on each instance node that can be launched in
            ...
            - **BatchStrategy** *(string) --*
              ...
              request. A *record*  is a single unit of input data that inference can be made on. For
              example, a single line in a CSV file is a record.
                ...
                - **S3DataSource** *(dict) --*
                  ...
                  - **S3Uri** *(string) --*
                    ...
                    * A manifest might look like this: ``s3://bucketname/example.manifest``   The
                    ...
                    ``s3://customer_bucket/some/prefix/relative/path/custdata-2``    ``...``
                    ``s3://customer_bucket/some/prefix/relative/path/custdata-N``   The complete set
                    of ``S3Uris`` in this manifest constitutes the input data for the channel for
                    this datasource. The object that each ``S3Uris`` points to must be readable by
                    the IAM role that Amazon SageMaker uses to perform tasks on your behalf.
            ...
            - **DataProcessing** *(dict) --*
              ...
              needed for inference in a batch transform job. The output filter provided allows you
              to include input data relevant to interpreting the predictions in the output from the
              job. For more information, see `Associate Prediction Results with their Corresponding
              Input Records
              <https://docs.aws.amazon.com/sagemaker/latest/dg/batch-transform-data-processing.html>`__
              .
              ...
              - **InputFilter** *(string) --*
                ...
                the ``InputFilter`` parameter to exclude fields, such as an ID column, from the
              ...
              - **JoinSource** *(string) --*
                ...
                are ``None`` and ``Input`` . The default value is ``None`` , which specifies not to
                join the input with the transformed data. If you want the batch transform job to
                join the original input data with the transformed data, set ``JoinSource`` to
                ``Input`` .
                ...
                For CSV files, Amazon SageMaker combines the transformed data with the input data at
                the end of the input data and stores it in the output file. The joined data has the
                joined input data followed by the transformed data and the output is a CSV file.
    ...
    def describe_workteam(self, WorkteamName: str) -> ClientDescribeWorkteamResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/DescribeWorkteam>`_
    ...
    def get_search_suggestions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/GetSearchSuggestions>`_
        ...
        **Request Syntax**
        ...
        :param Resource: **[REQUIRED]**
          ...
          The name of the Amazon SageMaker resource to Search for. The only valid ``Resource`` value
          is ``TrainingJob`` .
        ...
        :param SuggestionQuery:
          ...
          - **PropertyNameQuery** *(dict) --*
            ...
            A type of ``SuggestionQuery`` . Defines a property name hint. Only property names that
            match the specified hint are included in the response.

            - **PropertyNameHint** *(string) --* **[REQUIRED]**

              Text that is part of a property's name. The property names of hyperparameter, metric,
              and tag key names that begin with the specified text in the ``PropertyNameHint`` .
    ...
    def list_algorithms(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          includes a ``NextToken`` . To retrieve the next set of algorithms, use the token in the
          next request.
    ...
    def list_code_repositories(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          includes a ``NextToken`` . To get the next set of Git repositories, use the token in the
          next request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If the result of a ``ListCodeRepositoriesOutput`` request was truncated, the response
              includes a ``NextToken`` . To get the next set of Git repositories, use the token in
              the next request.
    ...
    def list_compilation_jobs(
        ...
        To create a model compilation job, use  CreateCompilationJob . To get information about a
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListCompilationJobs`` request was truncated, the response
          includes a ``NextToken`` . To retrieve the next set of model compilation jobs, use the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              retrieve the next set of model compilation jobs, use this token in the next request.
    ...
    def list_endpoint_configs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListEndpointConfig`` request was truncated, the response
          includes a ``NextToken`` . To retrieve the next set of endpoint configurations, use the
          token in the next request.
    ...
    def list_hyper_parameter_tuning_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          response includes a ``NextToken`` . To retrieve the next set of tuning jobs, use the token
          in the next request.
    ...
    def list_labeling_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListLabelingJobs`` request was truncated, the response
          includes a ``NextToken`` . To retrieve the next set of labeling jobs, use the token in the
          next request.
    ...
    def list_labeling_jobs_for_workteam(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListLabelingJobsForWorkteam`` request was truncated, the
          response includes a ``NextToken`` . To retrieve the next set of labeling jobs, use the
          token in the next request.
    ...
    def list_model_packages(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the response to a previous ``ListModelPackages`` request was truncated, the response
          includes a ``NextToken`` . To retrieve the next set of model packages, use the token in
          the next request.
    ...
    def list_models(
        ...
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_CreateModel.html>`__ API.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the response to a previous ``ListModels`` request was truncated, the response includes
          a ``NextToken`` . To retrieve the next set of models, use the token in the next request.
    ...
    def list_notebook_instance_lifecycle_configs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          response includes a ``NextToken`` . To get the next set of lifecycle configurations, use
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If the response is truncated, Amazon SageMaker returns this token. To get the next set
    ...
    def list_notebook_instances(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the previous call to the ``ListNotebookInstances`` is truncated, the response includes
          a ``NextToken`` . You can use this token in your subsequent ``ListNotebookInstances``
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If response is truncated, Amazon SageMaker includes a token in the response. You can
    ...
    def list_training_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListTrainingJobs`` request was truncated, the response
    ...
    def list_training_jobs_for_hyper_parameter_tuning_job(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          truncated, the response includes a ``NextToken`` . To retrieve the next set of training
    ...
    def list_transform_jobs(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the previous ``ListTransformJobs`` request was truncated, the response
          includes a ``NextToken`` . To retrieve the next set of transform jobs, use the token in
          the next request.
    ...
    def list_workteams(
        ...
        """
        Gets a list of work teams that you have defined in a region. The list may be empty if no
    ...
    def render_ui_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/RenderUiTemplate>`_
        ...
        **Request Syntax**
        ...
        :param Task: **[REQUIRED]**
          ...
          - **Input** *(string) --* **[REQUIRED]**
            ...
            available to the template under the substitution variable ``task.input`` . For example,
            if you define a variable ``task.input.text`` in your template, you can supply the
    ...
    def search(
        ...
        """
        Finds Amazon SageMaker resources that match a search query. Matching resource objects are
        returned as a list of ``SearchResult`` objects in the response. You can sort the search
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          next ``SearchRequest`` to continue retrieving results for the specified
          ``SearchExpression`` and ``Sort`` parameters.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If the result of the previous ``Search`` request was truncated, the response includes
    ...
    def start_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StartNotebookInstance>`_
    ...
    def stop_compilation_job(self, CompilationJobName: str) -> None:
        ...
        SageMaker stops the job, it sets the  CompilationJobSummary$CompilationJobStatus to
        ``Stopped`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopCompilationJob>`_
    ...
    def stop_hyper_parameter_tuning_job(self, HyperParameterTuningJobName: str) -> None:
        ...
        Service (Amazon S3). All data that the training jobs write to Amazon CloudWatch Logs are
        still available in CloudWatch. After the tuning job moves to the ``Stopped`` state, it
        releases all reserved resources for the tuning job.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopHyperParameterTuningJob>`_
    ...
    def stop_labeling_job(self, LabelingJobName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopLabelingJob>`_
    ...
    def stop_notebook_instance(self, NotebookInstanceName: str) -> None:
        ...
        disconnects the ML storage volume from it. Amazon SageMaker preserves the ML storage volume.
        Amazon SageMaker stops charging you for the ML compute instance when you call
        ``StopNotebookInstance`` .

        To access data on the ML storage volume for a notebook instance that has been terminated,
        call the ``StartNotebookInstance`` API. ``StartNotebookInstance`` launches another ML
        compute instance, configures it, and attaches the preserved ML storage volume so you can
        continue your work.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopNotebookInstance>`_
    ...
    def stop_training_job(self, TrainingJobName: str) -> None:
        ...
        When it receives a ``StopTrainingJob`` request, Amazon SageMaker changes the status of the
        job to ``Stopping`` . After Amazon SageMaker stops the job, it sets the status to
        ``Stopped`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopTrainingJob>`_
    ...
    def stop_transform_job(self, TransformJobName: str) -> None:
        ...
        When Amazon SageMaker receives a ``StopTransformJob`` request, the status of the job changes
        to ``Stopping`` . After Amazon SageMaker stops the job, the status is set to ``Stopped`` .
        When you stop a transform job before it is completed, Amazon SageMaker doesn't store the
        job's output in Amazon S3.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/StopTransformJob>`_
    ...
    def update_code_repository(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/UpdateCodeRepository>`_
        ...
        **Request Syntax**
        ...
        :param GitConfig:
          ...
          The configuration of the git repository, including the URL and the Amazon Resource Name
          (ARN) of the AWS Secrets Manager secret that contains the credentials used to access the
          repository. The secret must have a staging label of ``AWSCURRENT`` and must be in the
          following format:
    ...
    def update_endpoint(
        ...
        After updating the endpoint, it sets the status to ``InService`` . To check the status of an
        endpoint, use the `DescribeEndpoint
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_DescribeEndpoint.html>`__ API.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/UpdateEndpoint>`_
    ...
    def update_endpoint_weights_and_capacities(
        ...
        Amazon SageMaker sets the endpoint status to ``Updating`` . After updating the endpoint, it
        sets the status to ``InService`` . To check the status of an endpoint, use the
        `DescribeEndpoint
        <https://docs.aws.amazon.com/sagemaker/latest/dg/API_DescribeEndpoint.html>`__ API.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/UpdateEndpointWeightsAndCapacities>`_
    ...
    def update_notebook_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/UpdateNotebookInstance>`_
        ...
        **Request Syntax**
        ...
        :param RoleArn:
          ...
          The Amazon Resource Name (ARN) of the IAM role that Amazon SageMaker can assume to access
          the notebook instance. For more information, see `Amazon SageMaker Roles
          <https://docs.aws.amazon.com/sagemaker/latest/dg/sagemaker-roles.html>`__ .
        ...
        :param DisassociateLifecycleConfig:
          ...
          associated with the notebook instance. This operation is idempotent. If you specify a
          lifecycle configuration that is not associated with the notebook instance when you call
        ...
        :param VolumeSizeInGB:
          ...
          The size, in GB, of the ML storage volume to attach to the notebook instance. The default
          value is 5 GB. ML storage volumes are encrypted, so Amazon SageMaker can't determine the
          amount of available free space on the volume. Because of this, you can increase the volume
          size when you update a notebook instance, but you can't decrease the volume size. If you
          want to decrease the size of the ML storage volume in use, create a new notebook instance
        ...
        :param AdditionalCodeRepositories:
          ...
          An array of up to three Git repositories to associate with the notebook instance. These
          can be either the names of Git repositories stored as resources in your account, or the
          URL of Git repositories in `AWS CodeCommit
          <https://docs.aws.amazon.com/codecommit/latest/userguide/welcome.html>`__ or in any other
        ...
        :param DisassociateDefaultCodeRepository:
          ...
          operation is idempotent. If you specify a Git repository that is not associated with the
        ...
        :param RootAccess:
          ...
          .. note::
            ...
            If you set this to ``Disabled`` , users don't have root access on the notebook instance,
    ...
    def update_notebook_instance_lifecycle_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/UpdateNotebookInstanceLifecycleConfig>`_
    ...
    def update_workteam(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sagemaker-2017-07-24/UpdateWorkteam>`_
    ...
    ) -> paginator_scope.ListAlgorithmsPaginator:
        """
        Get Paginator for `list_algorithms` operation.
        """
    ...
    ) -> paginator_scope.ListCodeRepositoriesPaginator:
        """
        Get Paginator for `list_code_repositories` operation.
        """
    ...
    ) -> paginator_scope.ListCompilationJobsPaginator:
        """
        Get Paginator for `list_compilation_jobs` operation.
        """
    ...
    ) -> paginator_scope.ListEndpointConfigsPaginator:
        """
        Get Paginator for `list_endpoint_configs` operation.
        """
    ...
    ) -> paginator_scope.ListEndpointsPaginator:
        """
        Get Paginator for `list_endpoints` operation.
        """
    ...
    ) -> paginator_scope.ListHyperParameterTuningJobsPaginator:
        """
        Get Paginator for `list_hyper_parameter_tuning_jobs` operation.
        """
    ...
    ) -> paginator_scope.ListLabelingJobsPaginator:
        """
        Get Paginator for `list_labeling_jobs` operation.
        """
    ...
    ) -> paginator_scope.ListLabelingJobsForWorkteamPaginator:
        """
        Get Paginator for `list_labeling_jobs_for_workteam` operation.
        """
    ...
    ) -> paginator_scope.ListModelPackagesPaginator:
        """
        Get Paginator for `list_model_packages` operation.
        """
    ...
    ) -> paginator_scope.ListModelsPaginator:
        """
        Get Paginator for `list_models` operation.
        """
    ...
    ) -> paginator_scope.ListNotebookInstanceLifecycleConfigsPaginator:
        """
        Get Paginator for `list_notebook_instance_lifecycle_configs` operation.
        """
    ...
    ) -> paginator_scope.ListNotebookInstancesPaginator:
        """
        Get Paginator for `list_notebook_instances` operation.
        """
    ...
    ) -> paginator_scope.ListSubscribedWorkteamsPaginator:
        """
        Get Paginator for `list_subscribed_workteams` operation.
        """
    ...
    ) -> paginator_scope.ListTrainingJobsPaginator:
        """
        Get Paginator for `list_training_jobs` operation.
        """
    ...
    ) -> paginator_scope.ListTrainingJobsForHyperParameterTuningJobPaginator:
        """
        Get Paginator for `list_training_jobs_for_hyper_parameter_tuning_job` operation.
        """
    ...
    ) -> paginator_scope.ListTransformJobsPaginator:
        """
        Get Paginator for `list_transform_jobs` operation.
        """
    ...
    ) -> paginator_scope.ListWorkteamsPaginator:
        """
        Get Paginator for `list_workteams` operation.
        """

    @overload
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_paginator(self, operation_name: Literal["search"]) -> paginator_scope.SearchPaginator:
        """
        Get Paginator for `search` operation.
        """
    ...
    ) -> waiter_scope.EndpointInServiceWaiter:
        """
        Get Waiter `endpoint_in_service`.
        """
    ...
    ) -> waiter_scope.NotebookInstanceDeletedWaiter:
        """
        Get Waiter `notebook_instance_deleted`.
        """
    ...
    ) -> waiter_scope.NotebookInstanceInServiceWaiter:
        """
        Get Waiter `notebook_instance_in_service`.
        """
    ...
    ) -> waiter_scope.NotebookInstanceStoppedWaiter:
        """
        Get Waiter `notebook_instance_stopped`.
        """
    ...
    ) -> waiter_scope.TrainingJobCompletedOrStoppedWaiter:
        """
        Get Waiter `training_job_completed_or_stopped`.
        """
    ...
    ) -> waiter_scope.TransformJobCompletedOrStoppedWaiter:
        """
        Get Waiter `transform_job_completed_or_stopped`.
        """
