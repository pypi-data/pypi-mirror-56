...
class Client(BaseClient):
    ...
    def create_bot_version(
        ...
        version of this resource hasn't changed since you created the last version, Amazon Lex
        doesn't create a new version. It returns the last created version.

        .. note::

          You can update only the ``$LATEST`` version of the bot. You can't update the numbered
          versions that you create with the ``CreateBotVersion`` operation.
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          Identifies a specific revision of the ``$LATEST`` version of the bot. If you specify a
          checksum and the ``$LATEST`` version of the bot has a different checksum, a
          ...
          - *(dict) --*
            ...
            - **abortStatement** *(dict) --*
              ...
              - **responseCard** *(string) --*
                ...
                <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html>`__ API, Amazon
                Lex includes the response card in the response. It substitutes all of the session
            ...
            - **childDirected** *(boolean) --*
              ...
              website, program, or other application that is directed or targeted, in whole or in
              part, to children under age 13 and subject to COPPA. By specifying ``false`` in the
              ``childDirected`` field, you confirm that your use of Amazon Lex **is not** related to
              a website, program, or other application that is directed or targeted, in whole or in
              part, to children under age 13 and subject to COPPA. You may not specify a default
              value for the ``childDirected`` field that does not accurately reflect whether your
              use of Amazon Lex is related to a website, program, or other application that is
    ...
    def create_intent_version(
        ...
        .. note::
          ...
          versions that you create with the ``CreateIntentVersion`` operation.
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          Checksum of the ``$LATEST`` version of the intent that should be used to create the new
          version. If you specify a checksum and the ``$LATEST`` version of the intent has a
          different checksum, Amazon Lex returns a ``PreconditionFailedException`` exception and
          doesn't publish a new version. If you don't specify a checksum, Amazon Lex publishes the
          ``$LATEST`` version.
          ...
          - *(dict) --*
            ...
            - **slots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **priority** *(integer) --*
                  ...
                  If multiple slots share the same priority, the order in which Lex elicits values
                  is arbitrary.
            ...
            - **followUpPrompt** *(dict) --*
              ...
              - **rejectionStatement** *(dict) --*
                ...
                - **responseCard** *(string) --*
                  ...
                  At runtime, if the client is using the `PostText
                  <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html>`__ API,
                  Amazon Lex includes the response card in the response. It substitutes all of the
                  session attributes and slot values for placeholders in the response card.

            - **conclusionStatement** *(dict) --*

              After the Lambda function specified in the ``fulfillmentActivity`` field fulfills the
            ...
            - **dialogCodeHook** *(dict) --*
              ...
              - **messageVersion** *(string) --*
                ...
                Lambda function. For more information, see  using-lambda .
    ...
    def create_slot_type_version(
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          Checksum for the ``$LATEST`` version of the slot type that you want to publish. If you
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **enumerationValues** *(list) --*
              ...
              A list of ``EnumerationValue`` objects that defines the values that the slot type can
              take.
    ...
    def delete_bot(self, name: str) -> None:
        ...
        version of the bot, use the  DeleteBotVersion operation. The ``DeleteBot`` operation doesn't
        immediately remove the bot schema. Instead, it is marked for deletion and removed later.
        ...
        the bot. To remove the reference to the bot, delete the alias. If you get the same exception
        again, delete the referring alias until the ``DeleteBot`` operation is successful.
    ...
    def delete_bot_alias(self, name: str, botName: str) -> None:
        ...
        association. If you get the same exception again, delete the referring association until the
    ...
    def delete_bot_version(self, name: str, version: str) -> None:
        ...
        **Request Syntax**
        ...
        :param version: **[REQUIRED]**
          ...
          The version of the bot to delete. You cannot delete the ``$LATEST`` version of the bot. To
          delete the ``$LATEST`` version, use the  DeleteBot operation.
    ...
    def delete_intent(self, name: str) -> None:
        ...
        version of the intent, use the  DeleteIntentVersion operation.
        ...
        .. note::
          ...
          shows where the intent is referenced. To remove the reference to the intent, either update
          the bot or delete it. If you get the same exception when you attempt to delete the intent
          again, repeat until the intent has no references and the call to ``DeleteIntent`` is
          successful.
    ...
    def delete_intent_version(self, name: str, version: str) -> None:
        ...
        **Request Syntax**
        ...
        :param version: **[REQUIRED]**
          ...
          The version of the intent to delete. You cannot delete the ``$LATEST`` version of the
          intent. To delete the ``$LATEST`` version, use the  DeleteIntent operation.
    ...
    def delete_slot_type(self, name: str) -> None:
        ...
        specific version of the slot type, use the  DeleteSlotTypeVersion operation.
        ...
        .. note::
          ...
          when you attempt to delete the slot type again, repeat until the slot type has no
    ...
    def delete_slot_type_version(self, name: str, version: str) -> None:
        ...
        **Request Syntax**
        ...
        :param version: **[REQUIRED]**
          ...
          The version of the slot type to delete. You cannot delete the ``$LATEST`` version of the
          slot type. To delete the ``$LATEST`` version, use the  DeleteSlotType operation.
    ...
    def delete_utterances(self, botName: str, userId: str) -> None:
        ...
        days for use with the  GetUtterancesView operation, and then stored indefinitely for use in
        ...
        **Request Syntax**
        ...
        :param userId: **[REQUIRED]**
          ...
          The unique identifier for the user that made the utterances. This is the user ID that was
          sent in the `PostContent
          <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostContent.html>`__ or `PostText
          <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html>`__ operation request
    ...
    def get_bot_aliases(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          truncated, Amazon Lex returns a pagination token in the response. To fetch the next page
          of aliases, specify the pagination token in the next request.
        ...
        :param nameContains:
          ...
          Substring to match in bot alias names. An alias will be returned if any part of its name
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              truncated, Amazon Lex returns a pagination token in the response. To fetch the next
              page of aliases, specify the pagination token in the next request.
    ...
    def get_bot_channel_associations(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          call is truncated, Amazon Lex returns a pagination token in the response. To fetch the
          next page of associations, specify the pagination token in the next request.
        ...
        :param nameContains:
          ...
          "abcxyz." To return all bot channel associations, use a hyphen ("-") as the
    ...
    def get_bot_versions(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          call is truncated, Amazon Lex returns a pagination token in the response. To fetch the
          next page of versions, specify the pagination token in the next request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **bots** *(list) --*
              ...
              An array of ``BotMetadata`` objects, one for each numbered version of the bot plus one
    ...
    def get_bots(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          truncated, Amazon Lex returns a pagination token in the response. To fetch the next page
          of bots, specify the pagination token in the next request.
    ...
    def get_builtin_intents(
        ...
        **Request Syntax**
        ...
        :param signatureContains:
          ...
          Substring to match in built-in intent signatures. An intent will be returned if any part
          of its signature matches the substring. For example, "xyz" matches both "xyzabc" and
          "abcxyz." To find the signature for an intent, see `Standard Built-in Intents
          <https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/built-in-intent-ref/standard-intents>`__
          in the *Alexa Skills Kit* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              call is truncated, Amazon Lex returns a pagination token in the response. To fetch the
              next page of intents, specify the pagination token in the next request.
    ...
    def get_builtin_slot_types(
        ...
        **Request Syntax**
        ...
        :param signatureContains:
          ...
          Substring to match in built-in slot type signatures. A slot type will be returned if any
        ...
        :param nextToken:
          ...
          A pagination token that fetches the next page of slot types. If the response to this API
          call is truncated, Amazon Lex returns a pagination token in the response. To fetch the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **url** *(string) --*
              ...
              structure of the archive may change. Your code should not rely on the archive
              structure.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **importStatus** *(string) --*
              ...
              The status of the import job. If the status is ``FAILED`` , you can get the reason for
              the failure from the ``failureReason`` field.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **confirmationPrompt** *(dict) --*
              ...
              the user's request. For more information, see  PutIntent .
            ...
            - **followUpPrompt** *(dict) --*
              ...
              after the intent is fulfilled. For more information, see  PutIntent .
            ...
            - **dialogCodeHook** *(dict) --*
              ...
              input. For more information, see  PutIntent .
    ...
    def get_intent_versions(
        ...
        The ``GetIntentVersions`` operation returns an ``IntentMetadata`` object for each version of
        an intent. For example, if an intent has three numbered versions, the ``GetIntentVersions``
    ...
    def get_intents(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          A pagination token that fetches the next page of intents. If the response to this API call
          is truncated, Amazon Lex returns a pagination token in the response. To fetch the next
          page of intents, specify the pagination token in the next request.
    ...
    def get_slot_type(self, name: str, version: str) -> ClientGetSlotTypeResponseTypeDef:
        ...
        slot type name, you must specify the slot type version.
    ...
    def get_slot_type_versions(
        ...
        The ``GetSlotTypeVersions`` operation returns a ``SlotTypeMetadata`` object for each version
        of a slot type. For example, if a slot type has three numbered versions, the
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          the next page of versions, specify the pagination token in the next request.
    ...
    def get_slot_types(
        ...
        * If you specify the ``nameContains`` field, returns the ``$LATEST`` version of all slot
        types that contain the specified string.
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          A pagination token that fetches the next page of slot types. If the response to this API
          call is truncated, Amazon Lex returns a pagination token in the response. To fetch next
    ...
    def get_utterances_view(
        ...
        flowers" is not being recognized. You could add this utterance to the ``OrderFlowers``
        ...
        Utterance statistics are generated once a day. Data is available for the last 15 days. You
        can request information for up to 5 versions of your bot in each request. Amazon Lex returns
        ...
        **Request Syntax**
        ...
        :param botVersions: **[REQUIRED]**
          ...
          An array of bot versions for which utterance information should be returned. The limit is
          5 versions per request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **utterances** *(list) --*
              ...
              describing the utterances that were processed by your bot. The response contains a
              maximum of 100 ``UtteranceData`` objects for each version. Amazon Lex returns the most
    ...
    def put_bot(
        ...
        provide values for in the request, except for the ``idleTTLInSeconds`` and
        ``privacySettings`` fields, which are set to their default values. If you don't specify
        ...
        **Request Syntax**
        ...
        :param intents:
          ...
          An array of ``Intent`` objects. Each intent represents a command that a user can express.
          For example, a pizza ordering bot might support an OrderPizza intent. For more
        ...
        :param clarificationPrompt:
          ...
          prompt, use the ``maxAttempts`` field. If Amazon Lex still doesn't understand, it sends
          the message in the ``abortStatement`` field.
          ...
          * Follow-up prompt - When the user responds to a follow-up prompt but does not provide an
          intent. For example, in response to a follow-up prompt that says "Would you like anything
          else today?" the user says "Yes." Amazon Lex will return a 400 Bad Request exception
          because it does not have a clarification prompt to send to the user to get an intent.
        ...
        :param abortStatement:
          ...
          ``abortStatement`` to the user, and then aborts the conversation. To set the number of
          retries, use the ``valueElicitationPrompt`` field for the slot type.

          For example, in a pizza ordering bot, Amazon Lex might ask a user "What type of crust
          would you like?" If the user's response is not one of the expected responses (for example,
          "thin crust, "deep dish," etc.), Amazon Lex tries to elicit a correct response a few more
          times.
        ...
        :param voiceId:
          ...
          <https://docs.aws.amazon.com/polly/latest/dg/voicelist.html>`__ in the *Amazon Polly
          Developer Guide* .
        ...
        :param childDirected: **[REQUIRED]**
          ...
          For each Amazon Lex bot created with the Amazon Lex Model Building Service, you must
          specify whether your use of Amazon Lex is related to a website, program, or other
          application that is directed or targeted, in whole or in part, to children under age 13
          and subject to the Children's Online Privacy Protection Act (COPPA) by specifying ``true``
          ...
          website, program, or other application that is directed or targeted, in whole or in part,
          to children under age 13 and subject to COPPA. You may not specify a default value for the
          ``childDirected`` field that does not accurately reflect whether your use of Amazon Lex is
          related to a website, program, or other application that is directed or targeted, in whole
        ...
        :param detectSentiment:
          ...
          If you don't specify ``detectSentiment`` , the default is ``false`` .

        :type createVersion: boolean
        :param createVersion:

          When set to ``true`` a new numbered version of the bot is created. This is the same as
          calling the ``CreateBotVersion`` operation. If you don't specify ``createVersion`` , the
          default is ``false`` .
    ...
    def put_intent(
        ...
        * A follow-up prompt that asks the user for additional activity. For example, asking "Do you
        want to order a drink with your pizza?"
        ...
        **Request Syntax**
        ...
        :param slots:
          ...
          An array of intent slots. At runtime, Amazon Lex elicits required slot values from the
          user using prompts defined in the slots. For more information, see  how-it-works .
          ...
          - *(dict) --*
            ...
            - **priority** *(integer) --*
              ...
              if the intent has two slots with priorities 1 and 2, AWS Lex first elicits a value for
        ...
        :param followUpPrompt:
          ...
          example, after the ``OrderPizza`` intent is fulfilled, you might prompt the user to order
          a drink.

          The action that Amazon Lex takes depends on the user's response, as follows:

          * If the user says "Yes" it responds with the clarification prompt that is configured for
          the bot.

          * if the user says "Yes" and continues with an utterance that triggers an intent it starts
          a conversation for the intent.
        ...
        :param conclusionStatement:
          ...
          ``fulfillmentActivity`` . If you return the intent to the client application, you can't
        ...
        :param dialogCodeHook:
          ...
          retrieve John's information from a backend database and prepopulate some of the values.
          For example, if you find that John is gluten intolerant, you might set the corresponding
          intent slot, ``GlutenIntolerant`` , to true. You might find John's phone number and set
        ...
        :param fulfillmentActivity:
          ...
          Required. Describes how the intent is fulfilled. For example, after a user provides all of
          the information for a pizza order, ``fulfillmentActivity`` defines how the bot places an
        ...
        :param parentIntentSignature:
          ...
          for an intent, see `Standard Built-in Intents
          <https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/built-in-intent-ref/standard-intents>`__
          in the *Alexa Skills Kit* .
        ...
        :param createVersion:
          ...
          When set to ``true`` a new numbered version of the intent is created. This is the same as
          calling the ``CreateIntentVersion`` operation. If you do not specify ``createVersion`` ,
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **conclusionStatement** *(dict) --*
              ...
              After the Lambda function specified in the``fulfillmentActivity`` intent fulfills the
              intent, Amazon Lex conveys this statement to the user.
    ...
    def put_slot_type(
        ...
        **Request Syntax**
        ...
        :param name: **[REQUIRED]**
          ...
          ``AMAZON.DATE`` , you can't create a custom slot type called ``DATE`` .
        ...
        :param enumerationValues:
          ...
          A list of ``EnumerationValue`` objects that defines the values that the slot type can
          take. Each value can have a list of ``synonyms`` , which are additional values that help
        ...
        :param valueSelectionStrategy:
          ...
          * ``ORIGINAL_VALUE`` - Returns the value entered by the user, if the user value is similar
          to the slot value.
        ...
        :param createVersion:
          ...
          When set to ``true`` a new numbered version of the slot type is created. This is the same
          as calling the ``CreateSlotTypeVersion`` operation. If you do not specify
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **createVersion** *(boolean) --*
               ...
               field was not specified in the request, the ``createVersion`` field is set to false
               in the response.
        ...
        **Request Syntax**
        ...
        :param mergeStrategy: **[REQUIRED]**
          ...
          * FAIL_ON_CONFLICT - The import operation is stopped on the first conflict between a
          ...
          conflict is in the ``failureReason`` field of the response to the ``GetImport`` operation.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **importStatus** *(string) --*
              ...
              The status of the import job. If the status is ``FAILED`` , you can get the reason for
              the failure using the ``GetImport`` operation.
