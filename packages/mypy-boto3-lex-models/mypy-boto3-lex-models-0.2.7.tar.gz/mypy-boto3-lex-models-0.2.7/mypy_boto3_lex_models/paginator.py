"Main interface for lex-models Paginators"
...
class GetBotVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        name: str,
        PaginationConfig: GetBotVersionsPaginatePaginationConfigTypeDef = None,
    ) -> GetBotVersionsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetIntentVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        name: str,
        PaginationConfig: GetIntentVersionsPaginatePaginationConfigTypeDef = None,
    ) -> GetIntentVersionsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetSlotTypeVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        name: str,
        PaginationConfig: GetSlotTypeVersionsPaginatePaginationConfigTypeDef = None,
    ) -> GetSlotTypeVersionsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
