"Main interface for lex-models Client"
...
class Client(BaseClient):
    ...
    def create_bot_version(
        ...
        """
        Creates a new version of the bot based on the ``$LATEST`` version. If the ``$LATEST`` version of
        this resource hasn't changed since you created the last version, Amazon Lex doesn't create a new
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/CreateBotVersion>`_
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          Identifies a specific revision of the ``$LATEST`` version of the bot. If you specify a checksum
          and the ``$LATEST`` version of the bot has a different checksum, a ``PreconditionFailedException``
          ...
          - *(dict) --*
            ...
            - **clarificationPrompt** *(dict) --*
              ...
              - **responseCard** *(string) --*
                ...
                It substitutes session attributes and slot values for placeholders in the response card. For
            ...
            - **childDirected** *(boolean) --*
              ...
              that your use of Amazon Lex **is** related to a website, program, or other application that is
              directed or targeted, in whole or in part, to children under age 13 and subject to COPPA. By
              specifying ``false`` in the ``childDirected`` field, you confirm that your use of Amazon Lex
              **is not** related to a website, program, or other application that is directed or targeted,
              in whole or in part, to children under age 13 and subject to COPPA. You may not specify a
              default value for the ``childDirected`` field that does not accurately reflect whether your
              use of Amazon Lex is related to a website, program, or other application that is directed or
    ...
    def create_intent_version(
        ...
        ``$LATEST`` version of this intent hasn't changed since you last updated it, Amazon Lex doesn't
        ...
        When you create a version of an intent, Amazon Lex sets the version to 1. Subsequent versions
        increment by 1. For more information, see  versioning-intro .

        This operation requires permissions to perform the ``lex:CreateIntentVersion`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/CreateIntentVersion>`_
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          Amazon Lex returns a ``PreconditionFailedException`` exception and doesn't publish a new version.
          If you don't specify a checksum, Amazon Lex publishes the ``$LATEST`` version.
            ...
            - **slots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **sampleUtterances** *(list) --*
                  ...
                  a slot value, you can provide those utterances to improve accuracy. This is optional. In
                  most cases, Amazon Lex is capable of understanding user utterances.
    ...
    def create_slot_type_version(
        ...
        """
        Creates a new version of a slot type based on the ``$LATEST`` version of the specified slot type. If
        the ``$LATEST`` version of this resource has not changed since the last version that you created,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/CreateSlotTypeVersion>`_
    ...
    def delete_bot(self, name: str) -> None:
        ...
        the bot, use the  DeleteBotVersion operation. The ``DeleteBot`` operation doesn't immediately remove
        ...
        To remove the reference to the bot, delete the alias. If you get the same exception again, delete
        the referring alias until the ``DeleteBot`` operation is successful.

        This operation requires permissions for the ``lex:DeleteBot`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteBot>`_
    ...
    def delete_bot_alias(self, name: str, botName: str) -> None:
        ...
        You can't delete an alias that is used in the association between a bot and a messaging channel. If
        an alias is used in a channel association, the ``DeleteBot`` operation returns a
        ``ResourceInUseException`` exception that includes a reference to the channel association that
        refers to the bot. You can remove the reference to the alias by deleting the channel association. If
        you get the same exception again, delete the referring association until the ``DeleteBotAlias``
        operation is successful.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteBotAlias>`_
    ...
    def delete_bot_channel_association(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteBotChannelAssociation>`_
    ...
    def delete_bot_version(self, name: str, version: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteBotVersion>`_
    ...
    def delete_intent(self, name: str) -> None:
        ...
        You can delete a version of an intent only if it is not referenced. To delete an intent that is
        referred to in one or more bots (see  how-it-works ), you must remove those references first.

        .. note::

          If you get the ``ResourceInUseException`` exception, it provides an example reference that shows
          where the intent is referenced. To remove the reference to the intent, either update the bot or
          delete it. If you get the same exception when you attempt to delete the intent again, repeat until
          the intent has no references and the call to ``DeleteIntent`` is successful.

        This operation requires permission for the ``lex:DeleteIntent`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteIntent>`_
    ...
    def delete_intent_version(self, name: str, version: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteIntentVersion>`_
    ...
    def delete_slot_type(self, name: str) -> None:
        ...
        You can delete a version of a slot type only if it is not referenced. To delete a slot type that is
        referred to in one or more intents, you must remove those references first.

        .. note::

          If you get the ``ResourceInUseException`` exception, the exception provides an example reference
          that shows the intent where the slot type is referenced. To remove the reference to the slot type,
          either update the intent or delete it. If you get the same exception when you attempt to delete
          the slot type again, repeat until the slot type has no references and the ``DeleteSlotType`` call
          is successful.

        This operation requires permission for the ``lex:DeleteSlotType`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteSlotType>`_
    ...
    def delete_slot_type_version(self, name: str, version: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteSlotTypeVersion>`_
        ...
        **Request Syntax**
        ...
        :param version: **[REQUIRED]**
          ...
          The version of the slot type to delete. You cannot delete the ``$LATEST`` version of the slot
          type. To delete the ``$LATEST`` version, use the  DeleteSlotType operation.
    ...
    def delete_utterances(self, botName: str, userId: str) -> None:
        ...
        Amazon Lex stores the utterances that users send to your bot. Utterances are stored for 15 days for
        use with the  GetUtterancesView operation, and then stored indefinitely for use in improving the
        ability of your bot to respond to user input.

        Use the ``DeleteUtterances`` operation to manually delete stored utterances for a specific user.
        When you use the ``DeleteUtterances`` operation, utterances stored for improving your bot's ability
        to respond to user input are deleted immediately. Utterances stored for use with the
        ``GetUtterancesView`` operation are deleted after 15 days.

        This operation requires permissions for the ``lex:DeleteUtterances`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/DeleteUtterances>`_
        ...
        **Request Syntax**
        ...
        :param userId: **[REQUIRED]**
          ...
          the `PostContent <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostContent.html>`__ or
          `PostText <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html>`__ operation
    ...
    def get_bot(self, name: str, versionOrAlias: str) -> ClientGetBotResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBot>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **status** *(string) --*
              ...
              utterances specified in the bot's intents. When the bot is ready for full testing or to run,
              the status is ``READY`` .
    ...
    def get_bot_alias(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBotAlias>`_
    ...
    def get_bot_aliases(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBotAliases>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          A pagination token for fetching the next page of aliases. If the response to this call is
        ...
        :param nameContains:
          ...
          Substring to match in bot alias names. An alias will be returned if any part of its name matches
    ...
    def get_bot_channel_association(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBotChannelAssociation>`_
    ...
    def get_bot_channel_associations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBotChannelAssociations>`_
        ...
        **Request Syntax**
        ...
        :param nameContains:
          ...
          Substring to match in channel association names. An association will be returned if any part of
          its name matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz." To return
          all bot channel associations, use a hyphen ("-") as the ``nameContains`` parameter.
    ...
    def get_bot_versions(
        ...
        The ``GetBotVersions`` operation returns a ``BotMetadata`` object for each version of a bot. For
        example, if a bot has three numbered versions, the ``GetBotVersions`` operation returns four
        ``BotMetadata`` objects in the response, one for each numbered version and one for the ``$LATEST``
        version.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBotVersions>`_
    ...
    def get_bots(
        ...
        * If you provide the ``nameContains`` field, the response includes information for the ``$LATEST``
        ...
        * If you don't specify the ``nameContains`` field, the operation returns information about the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBots>`_
    ...
    def get_builtin_intent(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBuiltinIntent>`_
    ...
    def get_builtin_intents(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBuiltinIntents>`_
        ...
        **Request Syntax**
        ...
        :param signatureContains:
          ...
          signature matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz." To find
          the signature for an intent, see `Standard Built-in Intents
          <https://developer.amazon.com/public/solutions/alexa/alexa-skills-kit/docs/built-in-intent-ref/standard-intents>`__
          in the *Alexa Skills Kit* .
        ...
        :param nextToken:
          ...
          A pagination token that fetches the next page of intents. If this API call is truncated, Amazon
          Lex returns a pagination token in the response. To fetch the next page of intents, use the
          pagination token in the next request.
    ...
    def get_builtin_slot_types(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetBuiltinSlotTypes>`_
        ...
        **Request Syntax**
        ...
        :param signatureContains:
          ...
          Substring to match in built-in slot type signatures. A slot type will be returned if any part of
          its signature matches the substring. For example, "xyz" matches both "xyzabc" and "abcxyz."
    ...
    def get_export(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetExport>`_
    ...
    def get_import(self, importId: str) -> ClientGetImportResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetImport>`_
    ...
    def get_intent(self, name: str, version: str) -> ClientGetIntentResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetIntent>`_
    ...
    def get_intent_versions(
        ...
        returns four ``IntentMetadata`` objects in the response, one for each numbered version and one for
        the ``$LATEST`` version.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetIntentVersions>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              A pagination token for fetching the next page of intent versions. If the response to this call
    ...
    def get_intents(
        ...
        * If you don't specify the ``nameContains`` field, returns information about the ``$LATEST`` version
        of all intents.

        The operation requires permission for the ``lex:GetIntents`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetIntents>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              If the response is truncated, the response includes a pagination token that you can specify in
              your next request to fetch the next page of intents.
    ...
    def get_slot_type(
        ...
        name, you must specify the slot type version.

        This operation requires permissions for the ``lex:GetSlotType`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetSlotType>`_
    ...
    def get_slot_type_versions(
        ...
        The ``GetSlotTypeVersions`` operation returns a ``SlotTypeMetadata`` object for each version of a
        slot type. For example, if a slot type has three numbered versions, the ``GetSlotTypeVersions``
        operation returns four ``SlotTypeMetadata`` objects in the response, one for each numbered version
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetSlotTypeVersions>`_
    ...
    def get_slot_types(
        ...
        * If you specify the ``nameContains`` field, returns the ``$LATEST`` version of all slot types that
        contain the specified string.
        ...
        * If you don't specify the ``nameContains`` field, returns information about the ``$LATEST`` version
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetSlotTypes>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          A pagination token that fetches the next page of slot types. If the response to this API call is
          truncated, Amazon Lex returns a pagination token in the response. To fetch next page of slot
          types, specify the pagination token in the next request.
        ...
        :param nameContains:
          ...
          Substring to match in slot type names. A slot type will be returned if any part of its name
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **slotTypes** *(list) --*
              ...
              An array of objects, one for each slot type, that provides information such as the name of the
              slot type, the version, and a description.
    ...
    def get_utterances_view(
        ...
        For example, say that you have created a bot to order flowers. After your users have used your bot
        for a while, use the ``GetUtterancesView`` operation to see the requests that they have made and
        whether they have been successful. You might find that the utterance "I want flowers" is not being
        recognized. You could add this utterance to the ``OrderFlowers`` intent so that your bot recognizes
        that utterance.

        After you publish a new version of a bot, you can get information about the old version and the new
        so that you can compare the performance across the two versions.

        Utterance statistics are generated once a day. Data is available for the last 15 days. You can
        request information for up to 5 versions of your bot in each request. Amazon Lex returns the most
        frequent utterances received by the bot in the last 15 days. The response contains information about
        a maximum of 100 utterances for each version.

        If you set ``childDirected`` field to true when you created your bot, or if you opted out of
        participating in improving Amazon Lex, utterances are not available.

        This operation requires permissions for the ``lex:GetUtterancesView`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/GetUtterancesView>`_
        ...
        **Request Syntax**
        ...
        :param botVersions: **[REQUIRED]**
          ...
          An array of bot versions for which utterance information should be returned. The limit is 5
        ...
        :param statusType: **[REQUIRED]**
          ...
          To return utterances that were recognized and handled, use ``Detected`` . To return utterances
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **utterances** *(list) --*
              ...
              100 ``UtteranceData`` objects for each version. Amazon Lex returns the most frequent
    ...
    def put_bot(
        ...
        Lex returns the response ``FAILED`` . You can build the bot after you add one or more intents. For
        more information about Amazon Lex bots, see  how-it-works .

        If you specify the name of an existing bot, the fields in the request replace the existing values in
        the ``$LATEST`` version of the bot. Amazon Lex removes any fields that you don't provide values for
        in the request, except for the ``idleTTLInSeconds`` and ``privacySettings`` fields, which are set to
        their default values. If you don't specify values for required fields, Amazon Lex throws an
        exception.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/PutBot>`_
        ...
        **Request Syntax**
        ...
        :param clarificationPrompt:
          ...
          If you have defined a fallback intent, it will be invoked if the clarification prompt is repeated
          the number of times defined in the ``maxAttempts`` field. For more information, see
          ...
          * PutSession operation - When using the ``PutSession`` operation, you send an ``ElicitIntent``
          dialog type. Since Amazon Lex does not have a clarification prompt to get an intent from the user,
          it returns a 400 Bad Request exception.
        ...
        :param abortStatement:
          ...
          few times. After that, Amazon Lex sends the message defined in ``abortStatement`` to the user, and
          ...
          - **responseCard** *(string) --*
            ...
            At runtime, if the client is using the `PostText
            <http://docs.aws.amazon.com/lex/latest/dg/API_runtime_PostText.html>`__ API, Amazon Lex includes
            the response card in the response. It substitutes all of the session attributes and slot values
        ...
        :param idleSessionTTLInSeconds:
          ...
          A user interaction session remains active for the amount of time specified. If no conversation
        ...
        :param voiceId:
          ...
          `Voices in Amazon Polly <https://docs.aws.amazon.com/polly/latest/dg/voicelist.html>`__ in the
        ...
        :param processBehavior:
          ...
          If you set the ``processBehavior`` element to ``BUILD`` , Amazon Lex builds the bot so that it can
          be run. If you set the element to ``SAVE`` Amazon Lex saves the bot, but doesn't build it.
        ...
        :param childDirected: **[REQUIRED]**
          ...
          Online Privacy Protection Act (COPPA) by specifying ``true`` or ``false`` in the ``childDirected``
          field. By specifying ``true`` in the ``childDirected`` field, you confirm that your use of Amazon
          Lex **is** related to a website, program, or other application that is directed or targeted, in
          ...
          program, or other application that is directed or targeted, in whole or in part, to children under
          age 13 and subject to COPPA. You may not specify a default value for the ``childDirected`` field
          that does not accurately reflect whether your use of Amazon Lex is related to a website, program,
          or other application that is directed or targeted, in whole or in part, to children under age 13
          and subject to COPPA.

          If your use of Amazon Lex relates to a website, program, or other application that is directed in
          whole or in part, to children under age 13, you must obtain any required verifiable parental
          consent under COPPA. For information regarding the use of Amazon Lex in connection with websites,
          programs, or other applications that are directed or targeted, in whole or in part, to children
          under age 13, see the `Amazon Lex FAQ. <https://aws.amazon.com/lex/faqs#data-security>`__
    ...
    def put_bot_alias(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/PutBotAlias>`_
    ...
    def put_intent(
        ...
        * Information to be gathered. You specify slot types for the information that your bot will request
        from the user. You can specify standard slot types, such as a date or a time, or custom slot types
        ...
        * How the intent will be fulfilled. You can provide a Lambda function or configure the intent to
        ...
        the intent information is available, Amazon Lex invokes your Lambda function. If you configure your
        ...
        * A follow-up prompt that asks the user for additional activity. For example, asking "Do you want to
        ...
        don't provide in the request. If you don't specify the required fields, Amazon Lex throws an
        exception. When you update the ``$LATEST`` version of an intent, the ``status`` field of any bot
        that uses the ``$LATEST`` version of the intent is set to ``NOT_BUILT`` .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/PutIntent>`_
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          When you create a new intent, leave the ``checksum`` field blank. If you specify a checksum you
          get a ``BadRequestException`` exception.
        ...
        :param createVersion:
          ...
          When set to ``true`` a new numbered version of the intent is created. This is the same as calling
          the ``CreateIntentVersion`` operation. If you do not specify ``createVersion`` , the default is
          ``false`` .
    ...
    def put_slot_type(
        ...
        which are the values that a slot of this type can assume. For more information, see  how-it-works .

        If you specify the name of an existing slot type, the fields in the request replace the existing
        values in the ``$LATEST`` version of the slot type. Amazon Lex removes the fields that you don't
        provide in the request. If you don't specify required fields, Amazon Lex throws an exception. When
        you update the ``$LATEST`` version of a slot type, if a bot uses the ``$LATEST`` version of an
        intent that contains the slot type, the bot's ``status`` field is set to ``NOT_BUILT`` .

        This operation requires permissions for the ``lex:PutSlotType`` action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/PutSlotType>`_
        ...
        **Request Syntax**
        ...
        :param name: **[REQUIRED]**
          ...
          removed. For example, because there is a built-in slot type called ``AMAZON.DATE`` , you can't
          create a custom slot type called ``DATE`` .
        ...
        :param createVersion:
          ...
          When set to ``true`` a new numbered version of the slot type is created. This is the same as
          calling the ``CreateSlotTypeVersion`` operation. If you do not specify ``createVersion`` , the
          default is ``false`` .
    ...
    def start_import(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lex-models-2017-04-19/StartImport>`_
        ...
        **Request Syntax**
        ...
        :param mergeStrategy: **[REQUIRED]**
          ...
          * FAIL_ON_CONFLICT - The import operation is stopped on the first conflict between a resource in
          ...
          ``failureReason`` field of the response to the ``GetImport`` operation. OVERWRITE_LATEST - The
          import operation proceeds even if there is a conflict with an existing resource. The $LASTEST
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_bot_aliases` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_bot_channel_associations` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_bot_versions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_bots` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_builtin_intents` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_builtin_slot_types` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_intent_versions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_intents` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_slot_type_versions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_slot_types` operation.
        """
