...
class Client(BaseClient):
    ...
    def create_slot_type_version(
        ...
        If the ``$LATEST`` version of this resource has not changed since the last version that you
        created, Amazon Lex doesn't create a new version. It returns the last version that you created.
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          checksum and the ``$LATEST`` version of the slot type has a different checksum, Amazon Lex
          returns a ``PreconditionFailedException`` exception and doesn't publish the new version. If you
    ...
    def delete_bot(self, name: str) -> None:
        ...
        the bot, use the  DeleteBotVersion operation. The ``DeleteBot`` operation doesn't immediately
    ...
    def delete_bot_alias(self, name: str, botName: str) -> None:
        ...
        refers to the bot. You can remove the reference to the alias by deleting the channel association.
        If you get the same exception again, delete the referring association until the ``DeleteBotAlias``
    ...
    def delete_intent(self, name: str) -> None:
        ...
        .. note::
          ...
          delete it. If you get the same exception when you attempt to delete the intent again, repeat
          until the intent has no references and the call to ``DeleteIntent`` is successful.
    ...
    def delete_slot_type(self, name: str) -> None:
        ...
        .. note::
          ...
          that shows the intent where the slot type is referenced. To remove the reference to the slot
          type, either update the intent or delete it. If you get the same exception when you attempt to
    ...
    def get_bots(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Amazon Lex returns a pagination token in the response. To fetch the next page of bots, specify
    ...
    def get_intents(
        ...
        **Request Syntax**
        ...
        :param nameContains:
          ...
          Substring to match in intent names. An intent will be returned if any part of its name matches
          the substring. For example, "xyz" matches both "xyzabc" and "abcxyz."
    ...
    def get_slot_type(
        ...
        """
        Returns information about a specific version of a slot type. In addition to specifying the slot
        type name, you must specify the slot type version.
    ...
    def get_utterances_view(
        ...
        have made to your bot. You can use this list to tune the utterances that your bot responds to.
        ...
        frequent utterances received by the bot in the last 15 days. The response contains information
    ...
    def put_bot(
        ...
        If you specify the name of an existing bot, the fields in the request replace the existing values
        in the ``$LATEST`` version of the bot. Amazon Lex removes any fields that you don't provide values
        for in the request, except for the ``idleTTLInSeconds`` and ``privacySettings`` fields, which are
        set to their default values. If you don't specify values for required fields, Amazon Lex throws an
        exception.
        ...
        **Request Syntax**
        ...
        :param clarificationPrompt:
          ...
          * Follow-up prompt - When the user responds to a follow-up prompt but does not provide an intent.
          For example, in response to a follow-up prompt that says "Would you like anything else today?"
          the user says "Yes." Amazon Lex will return a 400 Bad Request exception because it does not have
        ...
        :param idleSessionTTLInSeconds:
          ...
          through placing an order. If the user doesn't complete the order within the specified time,
          Amazon Lex discards the slot information that it gathered, and the user must start over.
        ...
        :param childDirected: **[REQUIRED]**
          ...
          Online Privacy Protection Act (COPPA) by specifying ``true`` or ``false`` in the
          ``childDirected`` field. By specifying ``true`` in the ``childDirected`` field, you confirm that
          ...
          specifying ``false`` in the ``childDirected`` field, you confirm that your use of Amazon Lex **is
          not** related to a website, program, or other application that is directed or targeted, in whole
          or in part, to children under age 13 and subject to COPPA. You may not specify a default value
          for the ``childDirected`` field that does not accurately reflect whether your use of Amazon Lex
          is related to a website, program, or other application that is directed or targeted, in whole or
        ...
        :param createVersion:
          ...
          When set to ``true`` a new numbered version of the bot is created. This is the same as calling
          the ``CreateBotVersion`` operation. If you don't specify ``createVersion`` , the default is
          ``false`` .
    ...
    def put_bot_alias(
        ...
        To change the version of the bot that the alias points to, replace the alias. For more information
        ...
        **Request Syntax**
        ...
        :param checksum:
          ...
          recent revision of the ``$LATEST`` version. If you don't specify the ``checksum`` field, or if
          the checksum does not match the ``$LATEST`` version, you get a ``PreconditionFailedException``
          exception.
    ...
    def put_intent(
        ...
        * A follow-up prompt that asks the user for additional activity. For example, asking "Do you want
        to order a drink with your pizza?"

        If you specify an existing intent name to update the intent, Amazon Lex replaces the values in the
        ``$LATEST`` version of the intent with the values in the request. Amazon Lex removes fields that
        you don't provide in the request. If you don't specify the required fields, Amazon Lex throws an
        ...
        **Request Syntax**
        ...
        :param name: **[REQUIRED]**
          ...
          The name can't match a built-in intent name, or a built-in intent name with "AMAZON." removed.
          For example, because there is a built-in intent called ``AMAZON.HelpIntent`` , you can't create a
    ...
    def start_import(
        ...
        **Request Syntax**
        ...
        :param resourceType: **[REQUIRED]**
          ...
          Specifies the type of resource to export. Each resource also exports any resources that it
          depends on.
