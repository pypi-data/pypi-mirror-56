The _tau_ function is defined so that _tau(G, h)_ is the maximum size of a zero-H-free sumset. In other words, it's the largest size of a set _A_ such that _hA_ does not contain 0.
