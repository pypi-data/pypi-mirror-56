...
setuptools.setup(
    ...
    description="The Alpha Qt version of PySimpleGUI, this GUI SDK Launched in 2018 Actively developed and supported. Super-simple to create custom GUI's.  Now supports both tkinter, Qt, WxPython and Web (Remi)",
