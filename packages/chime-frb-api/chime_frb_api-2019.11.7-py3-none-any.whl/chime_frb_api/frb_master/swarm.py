...
class Swarm(API):
    ...
    def get_jobs(self) -> JSON:
        ...
        """
        return self.get(url="/v1/swarm/jobs")
    ...
    def get_job_status(self, job_name: str) -> JSON:
        ...
        """
        return self.get("/v1/swarm/job-status/{}".format(job_name))
    ...
    def spawn_job(
        ...
        return self.post(url="/v1/swarm/spawn-job", json=payload)
    ...
    def get_logs(self, job_name: str) -> JSON:
        ...
        -------
            dict
        """
        return self.get("/v1/swarm/logs/{}".format(job_name))
    ...
    def prune_jobs(self, job_name: str) -> JSON:
        ...
        """
        return self.get(url="/v1/swarm/prune-job/{}".format(job_name))
    ...
    def kill_job(self, job_name: str) -> JSON:
        ...
        -------
            dict: {job_name : boolean}
        """
        return self.get(url="/v1/swarm/kill-job/{}".format(job_name))
