...
class Mimic(API):
    ...
    ----------
    base_url : str
        Base URL at which the API is accessible.
    """
    ...
    def register_injection(self, **kwargs) -> JSON:
        ...
        """
        return self.post(url="/v1/mimic/injection", json=kwargs)
    ...
    def register_detection(self, **kwargs) -> JSON:
        ...
        -------
        """
        return self.post(url="/v1/mimic/detection", json=kwargs)
    ...
    def get_active_injections(self) -> JSON:
        ...
        """
        return self.get(url="/v1/mimic/active_injections")
    ...
    def get_simulated_event(self, uuid: str = None) -> JSON:
        ...
        """
        if uuid:
            return self.get(url="/v1/mimic/{}".format(uuid))
        else:
    ...
    def get_uuids(self) -> JSON:
        ...
        -------
            dict
        """
        return self.get(url="/v1/mimic/uuids")
