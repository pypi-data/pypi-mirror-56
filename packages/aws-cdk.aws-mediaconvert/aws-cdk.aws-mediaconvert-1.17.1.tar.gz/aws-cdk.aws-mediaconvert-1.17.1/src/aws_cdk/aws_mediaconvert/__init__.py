...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-mediaconvert", "1.17.1", __name__, "aws-mediaconvert@1.17.1.jsii.tgz")
@jsii.implements(aws_cdk.core.IInspectable)
class CfnJobTemplate(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediaconvert.CfnJobTemplate"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, settings_json: typing.Any, acceleration_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["AccelerationSettingsProperty"]]]=None, category: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, status_update_interval: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnJobTemplateProps(settings_json=settings_json, acceleration_settings=acceleration_settings, category=category, description=description, name=name, priority=priority, queue=queue, status_update_interval=status_update_interval, tags=tags)
    ...
    def settings_json(self, value: typing.Any):
        return jsii.set(self, "settingsJson", value)

    @property
    @jsii.member(jsii_name="accelerationSettings")
    def acceleration_settings(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["AccelerationSettingsProperty"]]]:
    ...
    def acceleration_settings(self, value: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["AccelerationSettingsProperty"]]]):
        return jsii.set(self, "accelerationSettings", value)
    ...
    @category.setter
    def category(self, value: typing.Optional[str]):
    ...
    @priority.setter
    def priority(self, value: typing.Optional[jsii.Number]):
    ...
    @queue.setter
    def queue(self, value: typing.Optional[str]):
        return jsii.set(self, "queue", value)
    ...
    def status_update_interval(self, value: typing.Optional[str]):
        return jsii.set(self, "statusUpdateInterval", value)

    @jsii.data_type(jsii_type="@aws-cdk/aws-mediaconvert.CfnJobTemplate.AccelerationSettingsProperty", jsii_struct_bases=[], name_mapping={'mode': 'mode'})
    class AccelerationSettingsProperty():
        ...
        def __repr__(self) -> str:
            return 'AccelerationSettingsProperty(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())



@jsii.data_type(jsii_type="@aws-cdk/aws-mediaconvert.CfnJobTemplateProps", jsii_struct_bases=[], name_mapping={'settings_json': 'settingsJson', 'acceleration_settings': 'accelerationSettings', 'category': 'category', 'description': 'description', 'name': 'name', 'priority': 'priority', 'queue': 'queue', 'status_update_interval': 'statusUpdateInterval', 'tags': 'tags'})
class CfnJobTemplateProps():
    def __init__(self, *, settings_json: typing.Any, acceleration_settings: typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnJobTemplate.AccelerationSettingsProperty"]]]=None, category: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, priority: typing.Optional[jsii.Number]=None, queue: typing.Optional[str]=None, status_update_interval: typing.Optional[str]=None, tags: typing.Any=None):
        ...
        if acceleration_settings is not None: self._values["acceleration_settings"] = acceleration_settings
        if category is not None: self._values["category"] = category
        if description is not None: self._values["description"] = description
        if name is not None: self._values["name"] = name
        if priority is not None: self._values["priority"] = priority
        if queue is not None: self._values["queue"] = queue
        if status_update_interval is not None: self._values["status_update_interval"] = status_update_interval
    ...
    @property
    def acceleration_settings(self) -> typing.Optional[typing.Union[typing.Optional[aws_cdk.core.IResolvable], typing.Optional["CfnJobTemplate.AccelerationSettingsProperty"]]]:
        """``AWS::MediaConvert::JobTemplate.AccelerationSettings``.
    ...
    def __repr__(self) -> str:
        return 'CfnJobTemplateProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnPreset(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediaconvert.CfnPreset"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, settings_json: typing.Any, category: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnPresetProps(settings_json=settings_json, category=category, description=description, name=name, tags=tags)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-mediaconvert.CfnPresetProps", jsii_struct_bases=[], name_mapping={'settings_json': 'settingsJson', 'category': 'category', 'description': 'description', 'name': 'name', 'tags': 'tags'})
class CfnPresetProps():
    def __init__(self, *, settings_json: typing.Any, category: typing.Optional[str]=None, description: typing.Optional[str]=None, name: typing.Optional[str]=None, tags: typing.Any=None):
    ...
    def __repr__(self) -> str:
        return 'CfnPresetProps(%s)' % ', '.join(k + '=' + repr(v) for k, v in self._values.items())


@jsii.implements(aws_cdk.core.IInspectable)
class CfnQueue(aws_cdk.core.CfnResource, metaclass=jsii.JSIIMeta, jsii_type="@aws-cdk/aws-mediaconvert.CfnQueue"):
    ...
    """
    def __init__(self, scope: aws_cdk.core.Construct, id: str, *, description: typing.Optional[str]=None, name: typing.Optional[str]=None, pricing_plan: typing.Optional[str]=None, status: typing.Optional[str]=None, tags: typing.Any=None) -> None:
        ...
        """
        props = CfnQueueProps(description=description, name=name, pricing_plan=pricing_plan, status=status, tags=tags)
    ...
    @pricing_plan.setter
    def pricing_plan(self, value: typing.Optional[str]):
        return jsii.set(self, "pricingPlan", value)
...
@jsii.data_type(jsii_type="@aws-cdk/aws-mediaconvert.CfnQueueProps", jsii_struct_bases=[], name_mapping={'description': 'description', 'name': 'name', 'pricing_plan': 'pricingPlan', 'status': 'status', 'tags': 'tags'})
class CfnQueueProps():
    def __init__(self, *, description: typing.Optional[str]=None, name: typing.Optional[str]=None, pricing_plan: typing.Optional[str]=None, status: typing.Optional[str]=None, tags: typing.Any=None):
        ...
        if description is not None: self._values["description"] = description
        if name is not None: self._values["name"] = name
        if pricing_plan is not None: self._values["pricing_plan"] = pricing_plan
...
__all__ = ["CfnJobTemplate", "CfnJobTemplateProps", "CfnPreset", "CfnPresetProps", "CfnQueue", "CfnQueueProps", "__jsii_assembly__"]
