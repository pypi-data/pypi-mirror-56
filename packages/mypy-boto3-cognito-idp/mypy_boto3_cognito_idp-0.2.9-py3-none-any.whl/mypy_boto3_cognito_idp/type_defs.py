...
class AdminListGroupsForUserPaginateResponseGroupsTypeDef(
    ...
    - **Precedence** *(integer) --*
      ...
      groups that a user can belong to in the user pool. If a user belongs to two or more groups, it
      is the group with the highest precedence whose role ARN will be used in the ``cognito:roles``
      and ``cognito:preferred_role`` claims in the user's tokens. Groups with higher ``Precedence``
      values take precedence over groups with lower ``Precedence`` values or with null
      ``Precedence`` values.
      ...
      If the two groups have different role ARNs, the ``cognito:preferred_role`` claim is not set in
      users' tokens.
...
_OptionalClientAdminInitiateAuthContextDataTypeDef = TypedDict(
    "_OptionalClientAdminInitiateAuthContextDataTypeDef", {"EncodedData": str}, total=False
)
...
class ClientAdminInitiateAuthResponseAuthenticationResultTypeDef(
    ...
    The result of the authentication response. This is only returned if the caller does not need to
...
class ClientAdminRespondToAuthChallengeResponseAuthenticationResultNewDeviceMetadataTypeDef(
    ...
    """
    Type definition for `ClientAdminRespondToAuthChallengeResponseAuthenticationResult`
    `NewDeviceMetadata`
...
_ClientCreateResourceServerScopesTypeDef = TypedDict(
    "_ClientCreateResourceServerScopesTypeDef", {"ScopeName": str, "ScopeDescription": str}
)
...
class ClientCreateUserPoolAccountRecoverySettingRecoveryMechanismsTypeDef(
    ...
    """
    Type definition for `ClientCreateUserPoolAccountRecoverySetting` `RecoveryMechanisms`
...
class ClientCreateUserPoolAccountRecoverySettingTypeDef(
    ...
    """
    Type definition for `ClientCreateUserPool` `AccountRecoverySetting`
...
class ClientCreateUserPoolClientResponseUserPoolClientTypeDef(
    ...
    - **PreventUserExistenceErrors** *(string) --*
      ...
      the user pool. When set to ``ENABLED`` and the user does not exist, authentication returns an
      error indicating either the username or password was incorrect, and account confirmation and
      password recovery return a response indicating a code was sent to a simulated destination.
      When set to ``LEGACY`` , those APIs will return a ``UserNotFoundException`` exception if the
...
class ClientCreateUserPoolEmailConfigurationTypeDef(_ClientCreateUserPoolEmailConfigurationTypeDef):
    ...
    - **From** *(string) --*
      ...
      For example, ``testuser@example.com`` or ``Test User <testuser@example.com>`` . This address
...
class ClientCreateUserPoolPoliciesTypeDef(_ClientCreateUserPoolPoliciesTypeDef):
    ...
    - **PasswordPolicy** *(dict) --*
      ...
      - **TemporaryPasswordValidityDays** *(integer) --*
        ...
        In the password policy you have set, refers to the number of days a temporary password is
        valid. If the user does not sign-in during this time, their password will need to be reset
        by an administrator.
...
class ClientCreateUserPoolResponseUserPoolAccountRecoverySettingRecoveryMechanismsTypeDef(
    ...
    """
    Type definition for `ClientCreateUserPoolResponseUserPoolAccountRecoverySetting`
    `RecoveryMechanisms`
...
class ClientCreateUserPoolResponseUserPoolAccountRecoverySettingTypeDef(
    ...
    """
    Type definition for `ClientCreateUserPoolResponseUserPool` `AccountRecoverySetting`
...
class ClientCreateUserPoolResponseUserPoolAdminCreateUserConfigInviteMessageTemplateTypeDef(
    ...
    """
    Type definition for `ClientCreateUserPoolResponseUserPoolAdminCreateUserConfig`
...
class ClientCreateUserPoolResponseUserPoolSchemaAttributesNumberAttributeConstraintsTypeDef(
    ...
    """
    Type definition for `ClientCreateUserPoolResponseUserPoolSchemaAttributes`
...
class ClientCreateUserPoolResponseUserPoolTypeDef(_ClientCreateUserPoolResponseUserPoolTypeDef):
    ...
    - **SchemaAttributes** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Mutable** *(boolean) --*
          ...
          this parameter to ``true`` . Amazon Cognito updates mapped attributes when users sign in
          to your application through an identity provider. If an attribute is immutable, Amazon
          Cognito throws an error when it attempts to update the attribute. For more information,
          see `Specifying Identity Provider Attribute Mappings for Your User Pool
          <https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-pools-specifying-attribute-mapping.html>`__
          .
    ...
    - **EmailConfiguration** *(dict) --*
      ...
      - **EmailSendingAccount** *(string) --*
        ...
        required delivery volume. To achieve a higher delivery volume, specify DEVELOPER to use your
        ...
        role contains the permissions that allow Amazon Cognito to access Amazon SES and send email
        messages with your address. For more information about the service-linked role that Amazon
        Cognito creates, see `Using Service-Linked Roles for Amazon Cognito
        <https://docs.aws.amazon.com/cognito/latest/developerguide/using-service-linked-roles.html>`__
        in the *Amazon Cognito Developer Guide* .
      ...
      - **ConfigurationSet** *(string) --*
        ...
        * Event publishing – Amazon SES can track the number of send, delivery, open, click, bounce,
        and complaint events for each email sent. Use event publishing to send information about
    ...
    - **UserPoolTags** *(dict) --*
      ...
      The tags that are assigned to the user pool. A tag is a label that you can apply to user pools
      to categorize and manage them in different ways, such as by purpose, owner, environment, or
      other criteria.
...
class ClientCreateUserPoolResponseTypeDef(_ClientCreateUserPoolResponseTypeDef):
    ...
    - **UserPool** *(dict) --*
      ...
      - **AccountRecoverySetting** *(dict) --*
        ...
        Use this setting to define which verified available method a user can use to recover their
        password when they call ``ForgotPassword`` . It allows you to define a preferred method when
        a user has more than one method available. With this setting, SMS does not qualify for a
        valid password recovery mechanism if the user also has SMS MFA enabled. In the absence of
        this setting, Cognito uses the legacy behavior to determine the recovery method where SMS is
        preferred over email.
...
class ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationActions`
    `HighAction`
...
class ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationActionsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfiguration`
    `Actions`
...
class ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmailTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration`
    `BlockEmail`
...
class ClientDescribeRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeRiskConfigurationResponseRiskConfiguration`
...
class ClientDescribeRiskConfigurationResponseRiskConfigurationCompromisedCredentialsRiskConfigurationActionsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeRiskConfigurationResponseRiskConfigurationCompromisedCredentialsRiskConfiguration`
    `Actions`
...
class ClientDescribeRiskConfigurationResponseRiskConfigurationTypeDef(
    ...
    - **RiskExceptionConfiguration** *(dict) --*
      ...
      - **BlockedIPRangeList** *(list) --*
        ...
        Overrides the risk decision to always block the pre-authentication requests. The IP range is
        in CIDR notation: a compact representation of an IP address and its associated routing
        prefix.
...
class ClientDescribeUserPoolClientResponseUserPoolClientAnalyticsConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserPoolClientResponseUserPoolClient`
...
class ClientDescribeUserPoolResponseUserPoolAccountRecoverySettingRecoveryMechanismsTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserPoolResponseUserPoolAccountRecoverySetting`
    `RecoveryMechanisms`
...
class ClientDescribeUserPoolResponseUserPoolAccountRecoverySettingTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserPoolResponseUserPool` `AccountRecoverySetting`
...
class ClientDescribeUserPoolResponseUserPoolAdminCreateUserConfigInviteMessageTemplateTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserPoolResponseUserPoolAdminCreateUserConfig`
    `InviteMessageTemplate`
...
class ClientDescribeUserPoolResponseUserPoolSchemaAttributesNumberAttributeConstraintsTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserPoolResponseUserPoolSchemaAttributes`
    `NumberAttributeConstraints`
...
class ClientRespondToAuthChallengeResponseAuthenticationResultNewDeviceMetadataTypeDef(
    ...
    """
    Type definition for `ClientRespondToAuthChallengeResponseAuthenticationResult`
    `NewDeviceMetadata`
...
class ClientSetRiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionTypeDef(
    ...
    """
    Type definition for `ClientSetRiskConfigurationAccountTakeoverRiskConfigurationActions`
    `HighAction`
...
class ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmailTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration` `BlockEmail`
...
class ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationMfaEmailTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration` `MfaEmail`
...
class ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationNoActionEmailTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration` `NoActionEmail`
...
class ClientSetRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationTypeDef(
    ...
    """
    Type definition for `ClientSetRiskConfigurationAccountTakeoverRiskConfiguration`
    `NotifyConfiguration`
...
class ClientSetRiskConfigurationCompromisedCredentialsRiskConfigurationActionsTypeDef(
    ...
    """
    Type definition for `ClientSetRiskConfigurationCompromisedCredentialsRiskConfiguration`
    `Actions`
...
class ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationActionsHighActionTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationActions`
    `HighAction`
...
class ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationActionsTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfiguration` `Actions`
...
class ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationBlockEmailTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfiguration`
    `BlockEmail`
...
class ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationNotifyConfigurationTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfiguration`
    `NotifyConfiguration`
...
class ClientSetRiskConfigurationResponseRiskConfigurationAccountTakeoverRiskConfigurationTypeDef(
    ...
    """
    Type definition for `ClientSetRiskConfigurationResponseRiskConfiguration`
    `AccountTakeoverRiskConfiguration`
...
class ClientSetRiskConfigurationResponseRiskConfigurationCompromisedCredentialsRiskConfigurationActionsTypeDef(
    ...
    """
    Type definition for
    `ClientSetRiskConfigurationResponseRiskConfigurationCompromisedCredentialsRiskConfiguration`
    `Actions`
...
_ClientUpdateResourceServerScopesTypeDef = TypedDict(
    "_ClientUpdateResourceServerScopesTypeDef", {"ScopeName": str, "ScopeDescription": str}
)
...
_ClientUpdateUserPoolAccountRecoverySettingRecoveryMechanismsTypeDef = TypedDict(
    "_ClientUpdateUserPoolAccountRecoverySettingRecoveryMechanismsTypeDef",
    {"Priority": int, "Name": str},
)
...
class ClientUpdateUserPoolAccountRecoverySettingRecoveryMechanismsTypeDef(
    ...
    """
    Type definition for `ClientUpdateUserPoolAccountRecoverySetting` `RecoveryMechanisms`
...
class ClientUpdateUserPoolAccountRecoverySettingTypeDef(
    ...
    """
    Type definition for `ClientUpdateUserPool` `AccountRecoverySetting`
...
_ClientVerifySoftwareTokenResponseTypeDef = TypedDict(
    "_ClientVerifySoftwareTokenResponseTypeDef", {"Status": str, "Session": str}, total=False
)
