"Main interface for cognito-idp Client"
...
class Client(BaseClient):
    ...
    def add_custom_attributes(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AddCustomAttributes>`_
        ...
        :param CustomAttributes: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Mutable** *(boolean) --*
              ...
              sign in to your application through an identity provider. If an attribute is
              immutable, Amazon Cognito throws an error when it attempts to update the attribute.
              For more information, see `Specifying Identity Provider Attribute Mappings for Your
              User Pool
    ...
    def admin_add_user_to_group(self, UserPoolId: str, Username: str, GroupName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminAddUserToGroup>`_
    ...
    def admin_confirm_sign_up(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminConfirmSignUp>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          invokes the AWS Lambda function that is specified for the *post confirmation* trigger.
          When Amazon Cognito invokes this function, it passes a JSON payload, which the function
          receives as input. In this payload, the ``clientMetadata`` attribute provides the data
          that you assigned to the ClientMetadata parameter in your AdminConfirmSignUp request. In
          ...
          <https://docs.aws.amazon.com/cognito/latest/developerguide/cognito-user-identity-pools-working-with-aws-lambda-triggers.html>`__
          ...
          .. note::
            ...
            * Amazon Cognito does not encrypt the the ClientMetadata value, so don't use it to
    ...
    def admin_create_user(
        ...
        DesiredDeliveryMediums: List[str] = None,
        ClientMetadata: Dict[str, str] = None,
    ) -> ClientAdminCreateUserResponseTypeDef:
        """
        Creates a new user in the specified user pool.

        If ``MessageAction`` is not set, the default is to send a welcome message via email or phone
        (SMS).

        .. note::

          This message is based on a template that you configured in your call to or . This template
        ...
        In either case, the user will be in the ``FORCE_CHANGE_PASSWORD`` state until they sign in
        and change their password.

        AdminCreateUser requires developer credentials.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminCreateUser>`_
        ...
        **Request Syntax**
        ...
        :param UserAttributes:
          ...
          than ``Username`` . However, any attributes that you specify as required (in or in the
          **Attributes** tab of the console) must be supplied either by you (in your call to
          ``AdminCreateUser`` ) or by the user (when he or she signs up in response to your welcome
          message).

          For custom attributes, you must prepend the ``custom:`` prefix to the attribute name.

          To send a message inviting the user to sign up, you must specify the user's email address
          or phone number. This can be done in your call to AdminCreateUser or in the **Users** tab
          ...
          also do this by calling .)

          * **email** : The email address of the user to whom the message that contains the code and
          username will be sent. Required if the ``email_verified`` attribute is set to ``True`` ,
          or if ``"EMAIL"`` is specified in the ``DesiredDeliveryMediums`` parameter.
        ...
        :param ValidationData:
          ...
          To configure custom validation, you must create a Pre Sign-up Lambda trigger for the user
        ...
        :param TemporaryPassword:
          ...
          user must enter the temporary password in the sign-in page along with a new password to be
          ...
          specified when you created the user pool. To reset the account after that time limit, you
          must call ``AdminCreateUser`` again, specifying ``"RESEND"`` for the ``MessageAction``
          parameter.
        ...
        :param ForceAliasCreation:
          ...
          the UserAttributes parameter already exists as an alias with a different user, the API
          call will migrate the alias from the previous user to the newly created user. The previous
        ...
        :param DesiredDeliveryMediums:
          ...
          if the phone number will be used. The default value is ``"SMS"`` . More than one value can
          be specified.
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the AdminCreateUser API action, Amazon Cognito invokes the function that is
          assigned to the *pre sign-up* trigger. When Amazon Cognito invokes this function, it
          passes a JSON payload, which the function receives as input. This payload contains a
          ``clientMetadata`` attribute, which provides the data that you assigned to the
          ClientMetadata parameter in your AdminCreateUser request. In your function code in AWS
    ...
    def admin_delete_user(self, UserPoolId: str, Username: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminDeleteUser>`_
    ...
    def admin_delete_user_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminDeleteUserAttributes>`_
    ...
    def admin_disable_provider_for_user(
        ...
        external IdP user, any link between that user and an existing user is removed. The next time
        the external user (no longer attached to the previously linked ``DestinationUser`` ) signs
        in, they must create a new user account. See .
        ...
        providers. The ``ProviderAttributeValue`` must always be the exact subject that was used
        ...
        been used to sign-in, the ``ProviderAttributeName`` and ``ProviderAttributeValue`` must be
        the same values that were used for the ``SourceUser`` when the identities were originally
        linked in the call. (If the linking was done with ``ProviderAttributeName`` set to
        ``Cognito_Subject`` , the same applies here). However, if the user has already signed in,
        the ``ProviderAttributeName`` must be ``Cognito_Subject`` and ``ProviderAttributeValue``
        must be the subject of the SAML assertion.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminDisableProviderForUser>`_
    ...
    def admin_disable_user(self, UserPoolId: str, Username: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminDisableUser>`_
    ...
    def admin_enable_user(self, UserPoolId: str, Username: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminEnableUser>`_
    ...
    def admin_forget_device(self, UserPoolId: str, Username: str, DeviceKey: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminForgetDevice>`_
    ...
    def admin_get_device(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminGetDevice>`_
    ...
    def admin_get_user(self, UserPoolId: str, Username: str) -> ClientAdminGetUserResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminGetUser>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UserStatus** *(string) --*
              ...
              * FORCE_CHANGE_PASSWORD - The user is confirmed and the user can sign in using a
              temporary password, but on first sign-in, the user must change his or her password to
              a new value before doing anything else.

            - **MFAOptions** *(list) --*

               *This response parameter is no longer supported.* It provides information only about
               SMS MFA configurations. It doesn't provide information about TOTP software token MFA
               configurations. To look up information about either type of MFA configuration, use
               the  AdminGetUserResponse$UserMFASettingList response instead.
    ...
    def admin_initiate_auth(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminInitiateAuth>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.admin_initiate_auth(
              ...
              ClientId='string',
              AuthFlow=
                  'USER_SRP_AUTH'|'REFRESH_TOKEN_AUTH'|'REFRESH_TOKEN'|'CUSTOM_AUTH'
                  |'ADMIN_NO_SRP_AUTH'|'USER_PASSWORD_AUTH'|'ADMIN_USER_PASSWORD_AUTH',
              AuthParameters={
                  'string': 'string'
              },
              ClientMetadata={
        ...
        :param AuthFlow: **[REQUIRED]**
          ...
          * ``ADMIN_USER_PASSWORD_AUTH`` : Admin-based user password authentication. This replaces
          the ``ADMIN_NO_SRP_AUTH`` authentication flow. In this flow, Cognito receives the password
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the AdminInitiateAuth API action, Amazon Cognito invokes the AWS Lambda functions
          that are specified for various triggers. The ClientMetadata value is passed as input to
          ...
          * User migration
          ...
          your AdminInitiateAuth request. In your function code in AWS Lambda, you can process the
        ...
        :returns:
          ...
          **Response Syntax**
          ...
          ::
            ...
            {
                'ChallengeName':
                'SMS_MFA'|'SOFTWARE_TOKEN_MFA'|'SELECT_MFA_TYPE'|'MFA_SETUP'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ChallengeName** *(string) --*
              ...
              to you in the ``AdminInitiateAuth`` response if you need to pass another challenge.

              * ``MFA_SETUP`` : If MFA is required, users who do not have at least one of the MFA
              methods set up are presented with an ``MFA_SETUP`` challenge. The user must set up at
              least one MFA type to continue to authenticate.

              * ``SELECT_MFA_TYPE`` : Selects the MFA type. Valid MFA options are ``SMS_MFA`` for
              text SMS MFA, and ``SOFTWARE_TOKEN_MFA`` for TOTP software token MFA.
              ...
              * ``DEVICE_SRP_AUTH`` : If device tracking was enabled on your user pool and the
              previous challenges were passed, this challenge is returned so that Amazon Cognito can
            ...
            - **ChallengeParameters** *(dict) --*
              ...
              The value of the ``USER_ID_FOR_SRP`` attribute will be the user's actual username, not
              an alias (such as email address or phone number), even if you specified an alias in
              your call to ``AdminInitiateAuth`` . This is because, in the
              ``AdminRespondToAuthChallenge`` API ``ChallengeResponses`` , the ``USERNAME``
            ...
            - **AuthenticationResult** *(dict) --*
              ...
              before it gets tokens, ``ChallengeName`` , ``ChallengeParameters`` , and ``Session``
              are returned.
    ...
    def admin_link_provider_for_user(
        ...
        external identity provider (``SourceUser`` ) based on a specified attribute name and value
        from the external identity provider. This allows you to create a link from the existing user
        account to an external federated user identity that has not yet been used to sign in, so
        that the federated user identity can be used to sign in as the existing user account.
        ...
        user signs in as the existing user account.

        .. warning::

          Because this API allows a user with an external federated identity to sign in as an
          existing user in the user pool, it is critical that it only be used with external identity
          providers and provider attributes that have been trusted by the application owner.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminLinkProviderForUser>`_
        ...
        **Request Syntax**
        ...
        :param DestinationUser: **[REQUIRED]**
          ...
          account. Can be a native (Username + Password) Cognito User Pools user or a federated user
          (for example, a SAML or Facebook user). If the user doesn't exist, an exception is thrown.
          This is the user that is returned when the new user (with the linked identity provider
          attribute) signs in.
        ...
        :param SourceUser: **[REQUIRED]**
          ...
          An external identity provider account for a user who does not currently exist yet in the
          user pool. This user must be a federated user (for example, a SAML or Facebook user), not
          another native user.

          If the ``SourceUser`` is a federated social identity provider user (Facebook, Google, or
          Login with Amazon), you must set the ``ProviderAttributeName`` to ``Cognito_Subject`` .
          For social identity providers, the ``ProviderName`` will be ``Facebook`` , ``Google`` , or
          ``LoginWithAmazon`` , and Cognito will automatically parse the Facebook, Google, and Login
          ...
          assertion. If you wish to link SAML users based on the subject of the SAML assertion, you
          should map the subject to a claim through the SAML identity provider and submit that claim
          name as the ``ProviderAttributeName`` . If you set ``ProviderAttributeName`` to
          ``Cognito_Subject`` , Cognito will automatically parse the default unique identifier found
    ...
    def admin_list_devices(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminListDevices>`_
    ...
    def admin_remove_user_from_group(self, UserPoolId: str, Username: str, GroupName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminRemoveUserFromGroup>`_
    ...
    def admin_reset_user_password(
        ...
        If a user tries to sign in after the API is called, the app will get a
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminResetUserPassword>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the AdminResetUserPassword API action, Amazon Cognito invokes the function that is
    ...
    def admin_respond_to_auth_challenge(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminRespondToAuthChallenge>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.admin_respond_to_auth_challenge(
              ...
              ClientId='string',
              ChallengeName=
                  'SMS_MFA'|'SOFTWARE_TOKEN_MFA'|'SELECT_MFA_TYPE'|'MFA_SETUP'|'PASSWORD_VERIFIER'
        ...
        :param ChallengeResponses:
          ...
          * ``SMS_MFA`` : ``SMS_MFA_CODE`` , ``USERNAME`` , ``SECRET_HASH`` (if app client is
        ...
        :param Session:
          ...
          If ``InitiateAuth`` or ``RespondToAuthChallenge`` API call determines that the caller
        ...
        :param ClientMetadata:
          ...
          *create auth challenge* , and *verify auth challenge response* . When Amazon Cognito
          ...
          you assigned to the ClientMetadata parameter in your AdminRespondToAuthChallenge request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Session** *(string) --*
              ...
              The session which should be passed both ways in challenge-response calls to the
              service. If the or API call determines that the caller needs to go through another
              challenge, they return a session with other challenge parameters. This session should
    ...
    def admin_set_user_mfa_preference(
        ...
        are enabled and if any are preferred. Only one factor can be set as preferred. The preferred
        MFA factor will be used to authenticate a user if multiple factors are enabled. If multiple
        options are enabled and no preference is set, a challenge to choose an MFA option will be
        returned during sign in.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminSetUserMFAPreference>`_
    ...
    def admin_set_user_password(
        ...
        InitiateAuth/AdminInitiateAuth response will contain the ``NEW_PASSWORD_REQUIRED``
        challenge. If the user does not sign in before it expires, the user will not be able to sign
        in and their password will need to be reset by an administrator.

        Once the user has set a new password, or the password is permanent, the user status will be
        set to ``Confirmed`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminSetUserPassword>`_
    ...
    def admin_set_user_settings(
         ...
         *This action is no longer supported.* You can use it to configure only SMS MFA. You can't
         use it to configure TOTP software token MFA. To configure either type of MFA, use the
         AdminSetUserMFAPreference action instead.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminSetUserSettings>`_
    ...
    def admin_update_auth_event_feedback(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminUpdateAuthEventFeedback>`_
    ...
    def admin_update_device_status(
        self, UserPoolId: str, Username: str, DeviceKey: str, DeviceRememberedStatus: str = None
    ) -> Dict:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminUpdateDeviceStatus>`_
    ...
    def admin_update_user_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminUpdateUserAttributes>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the AdminUpdateUserAttributes API action, Amazon Cognito invokes the function that
          is assigned to the *custom message* trigger. When Amazon Cognito invokes this function, it
          passes a JSON payload, which the function receives as input. This payload contains a
          ``clientMetadata`` attribute, which provides the data that you assigned to the
          ClientMetadata parameter in your AdminUpdateUserAttributes request. In your function code
          in AWS Lambda, you can process the ``clientMetadata`` value to enhance your workflow for
          your specific needs.
    ...
    def admin_user_global_sign_out(self, UserPoolId: str, Username: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AdminUserGlobalSignOut>`_
    ...
    def associate_software_token(
        ...
        """
        Returns a unique generated shared secret key code for the user account. The request takes an
        access token or a session string, but not both.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/AssociateSoftwareToken>`_
    ...
    def change_password(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ChangePassword>`_
    ...
    def confirm_device(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ConfirmDevice>`_
    ...
    def confirm_forgot_password(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ConfirmForgotPassword>`_
        ...
        **Request Syntax**
        ...
        :param ConfirmationCode: **[REQUIRED]**
          ...
          The confirmation code sent by a user's request to retrieve a forgotten password. For more
          information, see
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the ConfirmForgotPassword API action, Amazon Cognito invokes the function that is
    ...
    def confirm_sign_up(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ConfirmSignUp>`_
        ...
        **Request Syntax**
        ...
        :param ForceAliasCreation:
          ...
          default set to ``False`` . If this parameter is set to ``True`` and the phone number/email
          used for sign up confirmation already exists as an alias with a different user, the API
          call will migrate the alias from the previous user to the newly created user being
          confirmed. If set to ``False`` , the API will throw an **AliasExistsException** error.
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the ConfirmSignUp API action, Amazon Cognito invokes the function that is assigned
          to the *post confirmation* trigger. When Amazon Cognito invokes this function, it passes a
          JSON payload, which the function receives as input. This payload contains a
          ``clientMetadata`` attribute, which provides the data that you assigned to the
          ClientMetadata parameter in your ConfirmSignUp request. In your function code in AWS
          Lambda, you can process the ``clientMetadata`` value to enhance your workflow for your
          specific needs.
    ...
    def create_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateGroup>`_
        ...
        **Request Syntax**
        ...
        :param Precedence:
          ...
          the lowest precedence value whose role ARN will be used in the ``cognito:roles`` and
          ...
          - *(dict) --*
            ...
            - **Group** *(dict) --*
              ...
              - **Precedence** *(integer) --*
                ...
                be used in the ``cognito:roles`` and ``cognito:preferred_role`` claims in the user's
                tokens. Groups with higher ``Precedence`` values take precedence over groups with
    ...
    def create_identity_provider(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateIdentityProvider>`_
          ...
          ::

            {
                'IdentityProvider': {
                    ...
                    'ProviderName': 'string',
                    'ProviderType':
                    'SAML'|'Facebook'|'Google'|'LoginWithAmazon'|'SignInWithApple'
                    |'OIDC',
                    'ProviderDetails': {
                        'string': 'string'
                    },
    ...
    def create_resource_server(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateResourceServer>`_
    ...
    def create_user_import_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateUserImportJob>`_
          ...
          ::

            {
                'UserImportJob': {
                    ...
                    'Status':
                    'Created'|'Pending'|'InProgress'|'Stopping'|'Expired'|'Stopped'
                    |'Failed'|'Succeeded',
                    'CloudWatchLogsRoleArn': 'string',
                    'ImportedUsers': 123,
                    'SkippedUsers': 123,
    ...
    def create_user_pool(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateUserPool>`_
        ...
        **Request Syntax**
        ...
        :param Policies:
          ...
          - **PasswordPolicy** *(dict) --*
            ...
            - **TemporaryPasswordValidityDays** *(integer) --*
              ...
              is valid. If the user does not sign-in during this time, their password will need to
        ...
        :param EmailConfiguration:
          ...
          - **EmailSendingAccount** *(string) --*
            ...
            you use the default option, Amazon Cognito allows only a limited number of emails each
            day for your user pool. For typical production environments, the default email limit is
            below the required delivery volume. To achieve a higher delivery volume, specify
            DEVELOPER to use your Amazon SES email configuration.

            To look up the email delivery limit for the default option, see `Limits in Amazon
            Cognito <https://docs.aws.amazon.com/cognito/latest/developerguide/limits.html>`__ in
        ...
        :param Schema:
          ...
          An array of schema attributes for the new user pool. These attributes can be standard or
          custom attributes.
        ...
        :param UserPoolAddOns:
          ...
          Used to enable advanced security risk detection. Set the key ``AdvancedSecurityMode`` to
          the value "AUDIT".
        ...
        :param AccountRecoverySetting:
          ...
          password when they call ``ForgotPassword`` . It allows you to define a preferred method
          when a user has more than one method available. With this setting, SMS does not qualify
          for a valid password recovery mechanism if the user also has SMS MFA enabled. In the
          absence of this setting, Cognito uses the legacy behavior to determine the recovery method
          where SMS is preferred over email.

          .. note::

            Starting February 1, 2020, the value of ``AccountRecoverySetting`` will default to
            ``verified_email`` first and ``verified_phone_number`` as the second option for newly
            ...
            - **UserPool** *(dict) --*
                ...
                - **PasswordPolicy** *(dict) --*
                  ...
                  - **TemporaryPasswordValidityDays** *(integer) --*
                    ...
                    .. note::
                      ...
                      When you set ``TemporaryPasswordValidityDays`` for a user pool, you will no
                      longer be able to set the deprecated ``UnusedAccountValidityDays`` value for
                      that user pool.
              ...
              - **SchemaAttributes** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **Mutable** *(boolean) --*
                    ...
                    For any user pool attribute that's mapped to an identity provider attribute, you
                    must set this parameter to ``true`` . Amazon Cognito updates mapped attributes
              ...
              - **EmailConfiguration** *(dict) --*
                ...
                - **EmailSendingAccount** *(string) --*
                  ...
                  default email limit is below the required delivery volume. To achieve a higher
                  delivery volume, specify DEVELOPER to use your Amazon SES email configuration.

                  To look up the email delivery limit for the default option, see `Limits in Amazon
                  Cognito <https://docs.aws.amazon.com/cognito/latest/developerguide/limits.html>`__
                  in the *Amazon Cognito Developer Guide* .
                  ...
                  Amazon Cognito creates a *service-linked role* , which is a type of IAM role, in
                  your AWS account. This role contains the permissions that allow Amazon Cognito to
                  access Amazon SES and send email messages with your address. For more information
                  about the service-linked role that Amazon Cognito creates, see `Using
                ...
                - **From** *(string) --*
                  ...
                  <testuser@example.com>`` . This address will appear before the body of the email.
                ...
                - **ConfigurationSet** *(string) --*
                  ...
                  that configuration set are applied to the email. Configuration sets can be used to
              ...
              - **SmsConfiguration** *(dict) --*
                ...
                - **SnsCallerArn** *(string) --*
                  ...
                  caller. This is the ARN of the IAM role in your AWS account which Cognito will use
                  to send SMS messages.

                - **ExternalId** *(string) --*

                  The external ID is a value that we recommend you use to add security to your IAM
                  role which is used to call Amazon SNS to send SMS messages for your user pool. If
                  you provide an ``ExternalId`` , the Cognito User Pool will include it when
                  attempting to assume your IAM role, so that you can set your roles trust policy to
                  require the ``ExternalID`` . If you use the Cognito Management Console to create a
              ...
              - **UserPoolTags** *(dict) --*
                ...
                user pools to categorize and manage them in different ways, such as by purpose,
              ...
              - **CustomDomain** *(string) --*
                ...
                if you use a custom domain to host the sign-up and sign-in pages for your
                application. For example: ``auth.example.com`` .

                For more information about adding a custom domain to your user pool, see `Using Your
              ...
              - **AdminCreateUserConfig** *(dict) --*
                ...
                - **UnusedAccountValidityDays** *(integer) --*
                  ...
                  .. note::
                    ...
                    that value will be used and ``UnusedAccountValidityDays`` will be deprecated for
                    that user pool.
              ...
              - **AccountRecoverySetting** *(dict) --*
                ...
                preferred method when a user has more than one method available. With this setting,
    ...
    def create_user_pool_client(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateUserPoolClient>`_
        ...
        **Request Syntax**
        ...
        :param WriteAttributes:
          ...
          If your app client allows users to sign in through an identity provider, this array must
          include all attributes that are mapped to identity provider attributes. Amazon Cognito
        ...
        :param ExplicitAuthFlows:
          ...
          the ``ALLOW_`` prefix are deprecated in favor of new names with the ``ALLOW_`` prefix.
        ...
        :param SupportedIdentityProviders:
          ...
          A list of provider names for the identity providers that are supported on this client. The
          following are supported: ``COGNITO`` , ``Facebook`` , ``Google`` and ``LoginWithAmazon`` .
        ...
        :param AllowedOAuthScopes:
          ...
          ``"email"`` , ``"openid"`` , and ``"Cognito"`` . In addition to these values, custom
        ...
        :param PreventUserExistenceErrors:
          ...
          authentication, account confirmation, and password recovery when the user does not exist
          in the user pool. When set to ``ENABLED`` and the user does not exist, authentication
          returns an error indicating either the username or password was incorrect, and account
          confirmation and password recovery return a response indicating a code was sent to a
          simulated destination. When set to ``LEGACY`` , those APIs will return a
          ...
          - *(dict) --*
            ...
            - **UserPoolClient** *(dict) --*
              ...
              - **ExplicitAuthFlows** *(list) --*
                ...
                ``ALLOW_`` prefix. Note that values with ``ALLOW_`` prefix cannot be used along with
                values without ``ALLOW_`` prefix.

                Valid values include:

                * ``ALLOW_ADMIN_USER_PASSWORD_AUTH`` : Enable admin based user password
                authentication flow ``ADMIN_USER_PASSWORD_AUTH`` . This setting replaces the
                ``ADMIN_NO_SRP_AUTH`` setting. With this authentication flow, Cognito receives the
                password in the request instead of using the SRP (Secure Remote Password protocol)
                protocol to verify passwords.

                * ``ALLOW_CUSTOM_AUTH`` : Enable Lambda trigger based authentication.

                * ``ALLOW_USER_PASSWORD_AUTH`` : Enable user password-based authentication. In this
                flow, Cognito receives the password in the request instead of using the SRP protocol
                to verify passwords.
              ...
              - **AllowedOAuthFlows** *(list) --*
                ...
                Set to ``code`` to initiate a code grant flow, which provides an authorization code
                as the response. This code can be exchanged for access tokens with the token
                endpoint.
              ...
              - **PreventUserExistenceErrors** *(string) --*
                ...
                during authentication, account confirmation, and password recovery when the user
                does not exist in the user pool. When set to ``ENABLED`` and the user does not
                exist, authentication returns an error indicating either the username or password
                was incorrect, and account confirmation and password recovery return a response
                indicating a code was sent to a simulated destination. When set to ``LEGACY`` ,
                those APIs will return a ``UserNotFoundException`` exception if the user does not
    ...
    def create_user_pool_domain(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/CreateUserPoolDomain>`_
        ...
        **Request Syntax**
        ...
        :param CustomDomainConfig:
          ...
          For more information about the hosted domain and custom domains, see `Configuring a User
          Pool Domain
    ...
    def delete_group(self, GroupName: str, UserPoolId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteGroup>`_
    ...
    def delete_identity_provider(self, UserPoolId: str, ProviderName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteIdentityProvider>`_
    ...
    def delete_resource_server(self, UserPoolId: str, Identifier: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteResourceServer>`_
    ...
    def delete_user(self, AccessToken: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteUser>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_user_attributes(self, UserAttributeNames: List[str], AccessToken: str) -> Dict:
        """
        Deletes the attributes for a user.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteUserAttributes>`_
    ...
    def delete_user_pool(self, UserPoolId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteUserPool>`_
    ...
    def delete_user_pool_client(self, UserPoolId: str, ClientId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteUserPoolClient>`_
    ...
    def delete_user_pool_domain(self, Domain: str, UserPoolId: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DeleteUserPoolDomain>`_
    ...
    def describe_identity_provider(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeIdentityProvider>`_
    ...
    def describe_resource_server(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeResourceServer>`_
    ...
    def describe_risk_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeRiskConfiguration>`_
                    ...
                    'AccountTakeoverRiskConfiguration': {
                        ...
                        'Actions': {
                            'LowAction': {
                                'Notify': True|False,
                                'EventAction':
                                'BLOCK'|'MFA_IF_CONFIGURED'|'MFA_REQUIRED'
                                |'NO_ACTION'
                            },
                            'MediumAction': {
                                'Notify': True|False,
    ...
    def describe_user_import_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeUserImportJob>`_
    ...
    def describe_user_pool(self, UserPoolId: str) -> ClientDescribeUserPoolResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeUserPool>`_
    ...
    def describe_user_pool_client(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeUserPoolClient>`_
    ...
    def describe_user_pool_domain(self, Domain: str) -> ClientDescribeUserPoolDomainResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/DescribeUserPoolDomain>`_
    ...
    def forget_device(self, DeviceKey: str, AccessToken: str = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ForgetDevice>`_
    ...
    def forgot_password(
        ...
        username or user alias. If a verified phone number exists for the user, the confirmation
        code is sent to the phone number. Otherwise, if a verified email exists, the confirmation
        code is sent to the email. If neither a verified phone number nor a verified email exists,
        ``InvalidParameterException`` is thrown. To use the confirmation code for resetting the
        password, call .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ForgotPassword>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          assigned to the following triggers: *pre sign-up* , *custom message* , and *user
          migration* . When Amazon Cognito invokes any of these functions, it passes a JSON payload,
    ...
    def get_csv_header(self, UserPoolId: str) -> ClientGetCsvHeaderResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetCSVHeader>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents the response from the server to the request to get the header information for
            the .csv file for the user import job.
    ...
    def get_device(self, DeviceKey: str, AccessToken: str = None) -> ClientGetDeviceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetDevice>`_
    ...
    def get_group(self, GroupName: str, UserPoolId: str) -> ClientGetGroupResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetGroup>`_
    ...
    def get_identity_provider_by_identifier(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetIdentityProviderByIdentifier>`_
    ...
    def get_signing_certificate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetSigningCertificate>`_
    ...
    def get_ui_customization(
        ...
        level customization (app ``clientId`` will be ``ALL`` ), then that is returned. If nothing
        is present, then an empty shape is returned.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetUICustomization>`_
    ...
    def get_user(self, AccessToken: str) -> ClientGetUserResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetUser>`_
          ...
          - *(dict) --*
            ...
            - **MFAOptions** *(list) --*
               ...
               *This response parameter is no longer supported.* It provides information only about
               SMS MFA configurations. It doesn't provide information about TOTP software token MFA
               configurations. To look up information about either type of MFA configuration, use
               the use the  GetUserResponse$UserMFASettingList response instead.
    ...
    def get_user_attribute_verification_code(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetUserAttributeVerificationCode>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          function that is assigned to the *custom message* trigger. When Amazon Cognito invokes
          this function, it passes a JSON payload, which the function receives as input. This
          payload contains a ``clientMetadata`` attribute, which provides the data that you assigned
          to the ClientMetadata parameter in your GetUserAttributeVerificationCode request. In your
    ...
    def get_user_pool_mfa_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GetUserPoolMfaConfig>`_
          ...
          - *(dict) --*
            ...
            - **SmsMfaConfiguration** *(dict) --*
              ...
              - **SmsAuthenticationMessage** *(string) --*
                ...
                sign in. The message must contain the ‘{####}’ placeholder, which will be replaced
    ...
    def global_sign_out(self, AccessToken: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/GlobalSignOut>`_
    ...
    def initiate_auth(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/InitiateAuth>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the InitiateAuth API action, Amazon Cognito invokes the AWS Lambda functions that
          ...
          * User migration
          ...
          which the function receives as input. This payload contains a ``validationData``
          attribute, which provides the data that you assigned to the ClientMetadata parameter in
          your InitiateAuth request. In your function code in AWS Lambda, you can process the
          ``validationData`` value to enhance your workflow for your specific needs.

          When you use the InitiateAuth API action, Amazon Cognito also invokes the functions for
          the following triggers, but it does not provide the ClientMetadata value as input:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ChallengeParameters** *(dict) --*
              ...
              if you need to pass another challenge. The responses in this parameter should be used
    ...
    def list_devices(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ListDevices>`_
    ...
    def list_tags_for_resource(self, ResourceArn: str) -> ClientListTagsForResourceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ListTagsForResource>`_
    ...
    def list_user_import_jobs(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ListUserImportJobs>`_
                ...
                'UserImportJobs': [
                    {
                        ...
                        'CompletionDate': datetime(2015, 1, 1),
                        'Status':
                        'Created'|'Pending'|'InProgress'|'Stopping'|'Expired'
    ...
    def list_user_pool_clients(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results you want the request to return when listing the user pool
          clients.
    ...
    def resend_confirmation_code(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/ResendConfirmationCode>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the ResendConfirmationCode API action, Amazon Cognito invokes the function that is
          assigned to the *custom message* trigger. When Amazon Cognito invokes this function, it
          passes a JSON payload, which the function receives as input. This payload contains a
          ``clientMetadata`` attribute, which provides the data that you assigned to the
    ...
    def respond_to_auth_challenge(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/RespondToAuthChallenge>`_
        ...
        **Request Syntax**
        ...
        :param ChallengeResponses:
          ...
          .. note::
             ...
             ``SECRET_HASH`` (if app client is configured with client secret) applies to all inputs
             below (including ``SOFTWARE_TOKEN_MFA`` ).
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the RespondToAuthChallenge API action, Amazon Cognito invokes any functions that
          are assigned to the following triggers: *post authentication* , *pre token generation* ,
    ...
    def set_risk_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/SetRiskConfiguration>`_
        ...
        **Request Syntax**
        ...
        :param ClientId:
          ...
          ``userPoolId`` . When the client ID is null, the same risk configuration is applied to all
        ...
        :param AccountTakeoverRiskConfiguration:
          ...
          - **NotifyConfiguration** *(dict) --*
            ...
            - **SourceArn** *(string) --* **[REQUIRED]**
              ...
              authorization policy. It permits Amazon Cognito to send for the email address
    ...
    def set_ui_customization(
        ...
        customization set previously. If you specify UI customization settings for a particular
        client, it will no longer fall back to the ``ALL`` configuration.

        .. note::

          To use this API, your user pool must have a domain associated with it. Otherwise, there is
          no place to host the app's pages, and the service will throw an error.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/SetUICustomization>`_
    ...
    def set_user_mfa_preference(
        ...
        preferred MFA factor will be used to authenticate a user if multiple factors are enabled. If
        multiple options are enabled and no preference is set, a challenge to choose an MFA option
        will be returned during sign in.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/SetUserMFAPreference>`_
    ...
    def set_user_pool_mfa_config(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/SetUserPoolMfaConfig>`_
        ...
        :param SmsMfaConfiguration:
          ...
          - **SmsConfiguration** *(dict) --*
            ...
            - **ExternalId** *(string) --*
              ...
              The external ID is a value that we recommend you use to add security to your IAM role
              which is used to call Amazon SNS to send SMS messages for your user pool. If you
              provide an ``ExternalId`` , the Cognito User Pool will include it when attempting to
              ...
              MFA, Cognito will create a role with the required permissions and a trust policy that
    ...
    def set_user_settings(
         ...
         *This action is no longer supported.* You can use it to configure only SMS MFA. You can't
         use it to configure TOTP software token MFA. To configure either type of MFA, use the
         SetUserMFAPreference action instead.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/SetUserSettings>`_
    ...
    def sign_up(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/SignUp>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the SignUp API action, Amazon Cognito invokes any functions that are assigned to
          the following triggers: *pre sign-up* , *custom message* , and *post confirmation* . When
          Amazon Cognito invokes any of these functions, it passes a JSON payload, which the
          function receives as input. This payload contains a ``clientMetadata`` attribute, which
          provides the data that you assigned to the ClientMetadata parameter in your SignUp
    ...
    def start_user_import_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/StartUserImportJob>`_
    ...
    def stop_user_import_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/StopUserImportJob>`_
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> Dict[str, Any]:
        ...
        associated with your user pools. In an IAM policy, you can constrain permissions for user
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/TagResource>`_
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UntagResource>`_
    ...
    def update_auth_event_feedback(
        self, UserPoolId: str, Username: str, EventId: str, FeedbackToken: str, FeedbackValue: str
    ) -> Dict[str, Any]:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateAuthEventFeedback>`_
    ...
    def update_device_status(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateDeviceStatus>`_
    ...
    def update_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateGroup>`_
    ...
    def update_identity_provider(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateIdentityProvider>`_
    ...
    def update_resource_server(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateResourceServer>`_
    ...
    def update_user_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateUserAttributes>`_
        ...
        **Request Syntax**
        ...
        :param ClientMetadata:
          ...
          You create custom workflows by assigning AWS Lambda functions to user pool triggers. When
          you use the UpdateUserAttributes API action, Amazon Cognito invokes the function that is
          assigned to the *custom message* trigger. When Amazon Cognito invokes this function, it
          passes a JSON payload, which the function receives as input. This payload contains a
          ``clientMetadata`` attribute, which provides the data that you assigned to the
    ...
    def update_user_pool(
        ...
        current user pool settings with .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateUserPool>`_
    ...
    def update_user_pool_client(
        ...
        of the current user pool app client settings with .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateUserPoolClient>`_
    ...
    def update_user_pool_domain(
        ...
        Amazon Cognito. You cannot use it to change the domain for a user pool.
        ...
        this operation to change the certificate that you applied to your custom domain.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/UpdateUserPoolDomain>`_
        ...
        **Request Syntax**
        ...
        :param Domain: **[REQUIRED]**
          ...
          This string can include only lowercase letters, numbers, and hyphens. Do not use a hyphen
    ...
    def verify_software_token(
        ...
        status as "verified" if successful. The request takes an access token or a session string,
        but not both.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/VerifySoftwareToken>`_
    ...
    def verify_user_attribute(self, AccessToken: str, AttributeName: str, Code: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-idp-2016-04-18/VerifyUserAttribute>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `admin_list_groups_for_user` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `admin_list_user_auth_events` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_identity_providers` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_resource_servers` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_user_pool_clients` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_user_pools` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_users_in_group` operation.
        """
