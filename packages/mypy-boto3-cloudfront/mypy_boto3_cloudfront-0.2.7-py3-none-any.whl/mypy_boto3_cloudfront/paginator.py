"Main interface for cloudfront Paginators"
...
class ListCloudFrontOriginAccessIdentitiesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        :py:meth:`CloudFront.Client.list_cloud_front_origin_access_identities`.
          ...
          - *(dict) --*
            ...
            - **CloudFrontOriginAccessIdentityList** *(dict) --*
              ...
              - **NextMarker** *(string) --*
                ...
                for the ``Marker`` request parameter to continue listing your origin access identities where
                they left off.
...
class ListDistributionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`CloudFront.Client.list_distributions`.
          ...
          - *(dict) --*
            ...
            - **DistributionList** *(dict) --*
              ...
              - **NextMarker** *(string) --*
                ...
                If ``IsTruncated`` is ``true`` , this element is present and contains the value you can use
                for the ``Marker`` request parameter to continue listing your distributions where they left
                off.
              ...
              - **IsTruncated** *(boolean) --*
                ...
                truncated, you can make a follow-up pagination request using the ``Marker`` request
                ...
                - *(dict) --*
                  ...
                  - **AliasICPRecordals** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      known as a CNAME, that they've added to CloudFront. AliasICPRecordal provides the ICP
                      recordal status for CNAMEs associated with distributions. The status is returned in
                      ...
                      - **ICPRecordalStatus** *(string) --*
                        ...
                        ICPRecordalStatus is set to APPROVED for all CNAMEs (aliases) in regions outside of
                        China.
...
class ListInvalidationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`CloudFront.Client.list_invalidations`.
          ...
          - *(dict) --*
            ...
            - **InvalidationList** *(dict) --*
              ...
              - **NextMarker** *(string) --*
                ...
                use for the ``Marker`` request parameter to continue listing your invalidation batches where
                they left off.
...
class ListStreamingDistributionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`CloudFront.Client.list_streaming_distributions`.
              ...
              - **Items** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **TrustedSigners** *(dict) --*
                    ...
                    A complex type that specifies the AWS accounts, if any, that you want to allow to create
                    ...
                    and ``Items`` .If you don't want to require signed URLs in requests for objects that
