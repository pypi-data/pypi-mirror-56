...
class DistributionDeployedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`CloudFront.Client.get_distribution` every 60 seconds until a successful
        state is reached. An error is returned after 35 failed checks.
...
class InvalidationCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`CloudFront.Client.get_invalidation` every 20 seconds until a successful
...
class StreamingDistributionDeployedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`CloudFront.Client.get_streaming_distribution` every 60 seconds until a
