...
class Request(object):
    ...
    def charset(  # type: ignore
        self,
        parse_charset=re.compile(r';\s*charset=([\w\d\-]+)').search
    ) -> str:
        try:
    ...
    @property
    def query(self, environ_to_unicode=environ_to_unicode) -> MultiDict:  # type: ignore
        """
    ...
    def __getitem__(self, key, _marker=object()):
        """
    ...
    @property
    def path_info(self, environ_to_unicode=environ_to_unicode) -> str:  # type: ignore
        """
    ...
    @property
    def query_string(self,  # type: ignore
