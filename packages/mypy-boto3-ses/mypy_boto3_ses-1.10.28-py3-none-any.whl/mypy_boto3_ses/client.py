...
class Client(BaseClient):
    ...
    def create_configuration_set_event_destination(
        ...
        **Request Syntax**
        ...
        :param EventDestination: **[REQUIRED]**
          ...
          An object that describes the AWS service that email sending event information will be
          published to.
    ...
    def create_configuration_set_tracking_options(
        ...
        For information about using custom domains, see the `Amazon SES Developer Guide
    ...
    def create_custom_verification_email_template(
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html>`__
        in the *Amazon SES Developer Guide* .
        ...
        **Request Syntax**
        ...
        :param TemplateContent: **[REQUIRED]**
          ...
          information, see `Custom Verification Email Frequently Asked Questions
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def create_receipt_filter(self, Filter: ClientCreateReceiptFilterFilterTypeDef) -> Dict:
        """
        ...
        **Request Syntax**
        ...
        :param Filter: **[REQUIRED]**
          ...
          A data structure that describes the IP address filter to create, which consists of a name,
    ...
    def create_receipt_rule(
        ...
        **Request Syntax**
        ...
        :param After:
          ...
          The name of an existing rule after which the new rule will be placed. If this parameter is
          null, the new rule will be inserted at the beginning of the rule list.
                ...
                - **KmsKeyArn** *(string) --*
                  ...
                  * To use a custom master key you created in AWS KMS, provide the ARN of the master
                  ...
                  .. warning::
                    ...
                    encryption client is currently available with the `AWS SDK for Java
              ...
              - **LambdaAction** *(dict) --*
                ...
                - **InvocationType** *(string) --*
                  ...
                  .. warning::
                    ...
                    ``Event`` invocation in most cases. Use ``RequestResponse`` only when you want
                    to make a mail flow decision, such as whether to stop the receipt rule or the
                    receipt rule set.
    ...
    def delete_configuration_set_tracking_options(self, ConfigurationSetName: str) -> Dict:
        ...
        .. note::
          ...
          configuration set to capture open and click events using the standard, Amazon SES-operated
          domains.
    ...
    def delete_identity_policy(self, Identity: str, PolicyName: str) -> Dict:
        ...
        to use its identities. For information about using sending authorization, see the `Amazon
        SES Developer Guide
            ...
            - **Rules** *(list) --*
              ...
              - *(dict) --*
                ...
                - **TlsPolicy** *(string) --*
                  ...
                  a connection encrypted with Transport Layer Security (TLS). If this parameter is
                  set to ``Require`` , Amazon SES will bounce emails that are not received over TLS.
                    ...
                    - **S3Action** *(dict) --*
                      ...
                      - **KmsKeyArn** *(string) --*
                        ...
                        * To use the default master key, provide an ARN in the form of
                        ...
                        If you use the default master key, you don't need to perform any extra steps
                        ...
                        * To use a custom master key you created in AWS KMS, provide the ARN of the
                        ...
                        For more information about key policies, see the `AWS KMS Developer Guide
                        <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html>`__ .
                        ...
                        .. warning::
                          ...
                          SDK for Java <http://aws.amazon.com/sdk-for-java/>`__ and `AWS SDK for
                          Ruby <http://aws.amazon.com/sdk-for-ruby/>`__ only. For more information
                    ...
                    - **LambdaAction** *(dict) --*
                      ...
                      - **InvocationType** *(string) --*
                        ...
                        .. warning::
                          ...
                          only when you want to make a mail flow decision, such as whether to stop
                          the receipt rule or the receipt rule set.
    ...
    def describe_configuration_set(
        self, ConfigurationSetName: str, ConfigurationSetAttributeNames: List[str] = None
    ) -> ClientDescribeConfigurationSetResponseTypeDef:
        """
          ...
          - *(dict) --*
                  ...
                  - **DimensionConfigurations** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **DimensionValueSource** *(string) --*
                        ...
                        ``SendEmail`` /``SendRawEmail`` API, choose ``messageTag`` . If you want
                        Amazon SES to use your own email headers, choose ``emailHeader`` .
            ...
            - **ReputationOptions** *(dict) --*
              ...
              - **LastFreshStart** *(datetime) --*
                ...
                last reset. Resetting these metrics is known as a *fresh start* .

                When you disable email sending for a configuration set using
                UpdateConfigurationSetSendingEnabled and later re-enable it, the reputation metrics
                for the configuration set (but not for the entire Amazon SES account) are reset.
          ...
          - *(dict) --*
            ...
            - **Rule** *(dict) --*
              ...
              - **TlsPolicy** *(string) --*
                ...
                Specifies whether Amazon SES should require that incoming email is delivered over a
                connection encrypted with Transport Layer Security (TLS). If this parameter is set
                to ``Require`` , Amazon SES will bounce emails that are not received over TLS. The
                default is ``Optional`` .
                ...
                - *(dict) --*
                  ...
                  - **S3Action** *(dict) --*
                    ...
                    - **KmsKeyArn** *(string) --*
                      ...
                      * To use the default master key, provide an ARN in the form of
                      ...
                      if your AWS account ID is 123456789012 and you want to use the default master
                      key in the US West (Oregon) region, the ARN of the default master key would be
                      ``arn:aws:kms:us-west-2:123456789012:alias/aws/ses`` . If you use the default
                      master key, you don't need to perform any extra steps to give Amazon SES
                      permission to use the key.
                      ...
                      * To use a custom master key you created in AWS KMS, provide the ARN of the
                      ...
                      For more information about key policies, see the `AWS KMS Developer Guide
                      <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html>`__ . If
                      ...
                      .. warning::
                        ...
                        for Java <http://aws.amazon.com/sdk-for-java/>`__ and `AWS SDK for Ruby
                        <http://aws.amazon.com/sdk-for-ruby/>`__ only. For more information about
                  ...
                  - **LambdaAction** *(dict) --*
                    ...
                    - **InvocationType** *(string) --*
                      ...
                      AWS Lambda invocation types, see the `AWS Lambda Developer Guide
                      <https://docs.aws.amazon.com/lambda/latest/dg/API_Invoke.html>`__ .

                      .. warning::

                        There is a 30-second timeout on ``RequestResponse`` invocations. You should
                        use ``Event`` invocation in most cases. Use ``RequestResponse`` only when
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents a request to return the email sending status for your Amazon SES account in
            the current AWS Region.

            - **Enabled** *(boolean) --*

              Describes whether email sending is enabled or disabled for your Amazon SES account in
              the current AWS Region.
    ...
    def get_identity_dkim_attributes(
        ...
        * A set of DKIM tokens that represent the identity. If the identity is an email address, the
        ...
        * Whether Amazon SES has successfully verified the DKIM tokens published in the domain's
        ...
        Developer Guide
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim-dns-records.html>`__ .
        ...
        :returns:
...

            {
                'DkimAttributes': {
                    'string': {
                        ...
                        'Pending'|'Success'|'Failed'|'TemporaryFailure'
                        |'NotStarted',
                        'DkimTokens': [
                            'string',
                        ]
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            signing, and whether Amazon SES successfully verified that these tokens were published.
              ...
              - *(string) --*
                ...
                - *(dict) --*
                  ...
                  - **MailFromDomainStatus** *(string) --*
                    ...
                    required for custom MAIL FROM domain setup. If the state is ``Success`` , Amazon
                    SES uses the specified custom MAIL FROM domain when the verified identity sends
                    an email. All other states indicate that Amazon SES takes the action described
                    by ``BehaviorOnMXFailure`` .
                  ...
                  - **BehaviorOnMXFailure** *(string) --*
                    ...
                    subdomain of that) as the MAIL FROM domain. A value of ``RejectMessage``
                    indicates that if Amazon SES cannot read the required MX record, Amazon SES
                    returns a ``MailFromDomainNotVerified`` error and does not send the email.
            ...
            - **NotificationAttributes** *(dict) --*
              ...
              - *(string) --*
                ...
                - *(dict) --*
                  ...
                  bounce, complaint, and/or delivery notifications, and whether feedback forwarding
                  ...
                  - **HeadersInComplaintNotificationsEnabled** *(boolean) --*
                    ...
                    Describes whether Amazon SES includes the original email headers in Amazon SNS
                    notifications of type ``Complaint`` . A value of ``true`` specifies that Amazon
                  ...
                  - **HeadersInDeliveryNotificationsEnabled** *(boolean) --*
                    ...
                    Describes whether Amazon SES includes the original email headers in Amazon SNS
                    notifications of type ``Delivery`` . A value of ``true`` specifies that Amazon
    ...
    def get_identity_policies(
        ...
        **Request Syntax**
        ...
        :param PolicyNames: **[REQUIRED]**
          ...
          A list of the names of policies to be retrieved. You can retrieve a maximum of 20 policies
          at a time. If you do not know the names of the policies that are attached to the identity,
          you can use ``ListIdentityPolicies`` .
    ...
    def get_identity_verification_attributes(
        ...
        status changes to "Failed." In that case, if you still want to verify the email address, you
        ...
        that case, if you still want to verify the domain, you must restart the verification process
        from the beginning.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents your Amazon SES daily sending quota, maximum send rate, and the number of
            emails you have sent in the last 24 hours.
    ...
    def get_send_statistics(
        ...
        representing the last two weeks of sending activity. Each data point in the list contains
    ...
    def list_configuration_sets(
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>`__ in
        the *Amazon SES Developer Guide.*

        You can execute this operation no more than once per second. This operation will return up
        to 1,000 configuration sets each time it is run. If your Amazon SES account has more than
        1,000 configuration sets, this operation will also return a NextToken element. You can then
        execute the ``ListConfigurationSets`` operation again, passing the ``NextToken`` parameter
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            A list of configuration sets associated with your AWS account. Configuration sets enable
    ...
    def list_custom_verification_email_templates(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          least 1 and less than or equal to 50. If you do not specify a value, or if you specify a
          value less than 1 or greater than 50, the operation will return up to 50 results.
    ...
    def list_identities(
        ...
        account in the current AWS Region, regardless of verification status.
        ...
        **Request Syntax**
        ...
        :param IdentityType:
          ...
          The type of the identities to list. Possible values are "EmailAddress" and "Domain". If
          this parameter is omitted, then all identities will be listed.
    ...
    def list_identity_policies(self, Identity: str) -> ClientListIdentityPoliciesResponseTypeDef:
        ...
        email address or a domain). This API returns only a list. If you want the actual policy
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The identity that is associated with the policy for which the policies will be listed. You
    ...
    def list_receipt_rule_sets(
        ...
        there are additional receipt rule sets to be retrieved, you will receive a ``NextToken``
        that you can provide to the next call to ``ListReceiptRuleSets`` to retrieve the additional
        entries.
    ...
    def list_templates(
        ...
        **Request Syntax**
        ...
        :param MaxItems:
          ...
          equal to 10. If you do not specify a value, or if you specify a value less than 1 or
        ...
        **Request Syntax**
        ...
        :param DeliveryOptions:
          ...
          - **TlsPolicy** *(string) --*
            ...
            connection can be established. If the value is ``Optional`` , messages can be delivered
    ...
    def put_identity_policy(self, Identity: str, PolicyName: str, Policy: str) -> Dict:
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The identity that the policy will apply to. You can specify an identity by using its name
    ...
    def reorder_receipt_rule_set(self, RuleSetName: str, RuleNames: List[str]) -> Dict:
        ...
        .. note::
          ...
          All of the rules in the rule set must be represented in this request. That is, this API
          will return an error if the reorder request doesn't explicitly position all of the rules.
        ...
        **Request Syntax**
        ...
        :param RuleNames: **[REQUIRED]**
          ...
          A list of the specified receipt rule set's receipt rules in the order that you want to put
          them.
    ...
    def send_bounce(
        ...
        SES. You can only use this API on an email up to 24 hours after you receive it.
        ...
        **Request Syntax**
              ...
              BouncedRecipientInfoList=[
                  {
                      ...
                      'RecipientArn': 'string',
                      'BounceType':
                      'DoesNotExist'|'MessageTooLarge'|'ExceededQuota'
        ...
        :param Explanation:
          ...
          text will be auto-generated based on the bounced recipient information.
        ...
        :param MessageDsn:
          ...
          - **ReportingMta** *(string) --* **[REQUIRED]**
            ...
            The reporting MTA that attempted to deliver the message, formatted as specified in `RFC
            3464 <https://tools.ietf.org/html/rfc3464>`__ (``mta-name-type; mta-name`` ). The
        ...
        :param BouncedRecipientInfoList: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            Recipient-related information to include in the Delivery Status Notification (DSN) when
            ...
            - **RecipientDsnFields** *(dict) --*
              ...
              - **FinalRecipient** *(string) --*
                ...
                the ``Final-Recipient`` in the DSN. If not specified, ``FinalRecipient`` will be set
                ...
                .. note::
                  ...
                  described in `RFC 3798 <https://tools.ietf.org/html/rfc3798>`__ .
              ...
              - **Action** *(string) --* **[REQUIRED]**
                ...
                3464 <https://tools.ietf.org/html/rfc3464>`__ .

              - **RemoteMta** *(string) --*

                The MTA to which the remote MTA attempted to deliver the message, formatted as
                specified in `RFC 3464 <https://tools.ietf.org/html/rfc3464>`__ (``mta-name-type;
              ...
              - **DiagnosticCode** *(string) --*
                ...
                `RFC 3463 <https://tools.ietf.org/html/rfc3463>`__ for the correct formatting of
                this parameter.
        ...
        :param BounceSenderArn:
          ...
          is associated with the sending authorization policy that permits you to use the address in
          the "From" header of the bounce. For more information about sending authorization, see the
          `Amazon SES Developer Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html>`__ .
    ...
    def send_bulk_templated_email(
        ...
        In order to send email using the ``SendBulkTemplatedEmail`` operation, your call to the API
        ...
        * If your account is still in the Amazon SES sandbox, you may only send to verified
        ...
        Simulator. For more information, see `Verifying Email Addresses and Domains
        ...
        *UserName@[SubDomain.]Domain.TopLevelDomain* ), the entire message will be rejected, even if
        the message contains other recipients that are valid.

        * The message may not include more than 50 recipients, across the To:, CC: and BCC: fields.
        If you need to send an email message to a larger audience, you can divide your recipient
        list into groups of 50 or fewer, and then call the ``SendBulkTemplatedEmail`` operation
        several times to send the message to each group.

        * The number of destinations you can contact in a single call to the API may be limited by
        ...
        **Request Syntax**
        ...
        :param Source: **[REQUIRED]**
          ...
          SES. For information about verifying identities, see the `Amazon SES Developer Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-addresses-and-domains.html>`__
          .
          ...
          .. note::
            ...
            <https://tools.ietf.org/html/rfc6531>`__ . For this reason, the *local part* of a source
            email address (the part of the email address that precedes the @ sign) may only contain
            `7-bit ASCII characters <https://en.wikipedia.org/wiki/Email_address#Local-part>`__ . If
            the *domain part* of an address (the part after the @ sign) contains non-ASCII
            characters, they must be encoded using Punycode, as described in `RFC3492
            <https://tools.ietf.org/html/rfc3492.html>`__ . The sender name (also known as the
            *friendly name* ) may contain non-ASCII characters. These characters must be encoded
            using MIME encoded-word syntax, as described in `RFC 2047
            <https://tools.ietf.org/html/rfc2047>`__ . MIME encoded-word syntax uses the following
        ...
        :param SourceArn:
          ...
          This parameter is used only for sending authorization. It is the ARN of the identity that
          is associated with the sending authorization policy that permits you to send for the email
          address specified in the ``Source`` parameter.
        ...
        :param ReturnPath:
          ...
          forwarding is enabled. If the message cannot be delivered to the recipient, then an error
          message will be returned from the recipient's ISP; this message will then be forwarded to
          the email address specified by the ``ReturnPath`` parameter. The ``ReturnPath`` parameter
          is never overwritten. This email address must be either individually verified with Amazon
        ...
        :param Destinations: **[REQUIRED]**
          ...
          receive the same version of the email. You can specify up to 50 ``Destination`` objects
          ...
          - *(dict) --*
            ...
            - **Destination** *(dict) --* **[REQUIRED]**
              ...
              .. note::
                ...
                destination email address (the part of the email address that precedes the @ sign)
                may only contain `7-bit ASCII characters
                <https://en.wikipedia.org/wiki/Email_address#Local-part>`__ . If the *domain part*
            ...
            - **ReplacementTags** *(list) --*
              ...
              using ``SendBulkTemplatedEmail`` . Tags correspond to characteristics of the email
                ...
                'Status': [
                    {
                        ...
                        |'ConfigurationSetDoesNotExist'|'TemplateDoesNotExist'
                        |'AccountSuspended'|'AccountThrottled'
                        |'AccountDailyQuotaExceeded'|'InvalidSendingPoolName'
    ...
    def send_email(
        ...
        using the ``SendEmail`` operation, your message must meet the following requirements:

        * The message must be sent from a verified email address or domain. If you attempt to send
        email using a non-verified address or domain, the operation will result in an "Email address
        not verified" error.
        ...
        * The message must include at least one recipient email address. The recipient address can
        be a To: address, a CC: address, or a BCC: address. If a recipient email address is invalid
        ...
        * The message may not include more than 50 recipients, across the To:, CC: and BCC: fields.
        If you need to send an email message to a larger audience, you can divide your recipient
        list into groups of 50 or fewer, and then call the ``SendEmail`` operation several times to
        ...
        .. warning::
          ...
          quotas in Amazon SES, see `Managing Your Amazon SES Sending Limits
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/manage-sending-limits.html>`__ in
          the *Amazon SES Developer Guide.*
        ...
        **Request Syntax**
        ...
        :param Message: **[REQUIRED]**
          ...
          - **Body** *(dict) --* **[REQUIRED]**
            ...
            - **Html** *(dict) --*
              ...
              process HTML. You can include clickable links, formatted text, and much more in an
              HTML message.
        ...
        :param Tags:
          ...
          ``SendEmail`` . Tags correspond to characteristics of the email that you define, so that
    ...
    def send_raw_email(
        ...
        ``SendRawEmail`` operation, you can specify the headers of the message as well as its
        content. This flexibility is useful, for example, when you want to send a multipart MIME
        email (such a message that contains both a text and an HTML version). You can also use this
        ...
        * If your account is still in the `Amazon SES sandbox
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/request-production-access.html>`__ ,
        you can only send email to other verified addresses in your account, or to addresses that
        are associated with the `Amazon SES mailbox simulator
        ...
        * Each message can include up to 50 recipient addresses across the To:, CC:, or BCC: lines.
        If you need to send a single message to more than 50 recipients, you have to split the list
        of recipient addresses into groups of less than 50 recipients, and send separate messages to
        each group.

        * Amazon SES allows you to specify 8-bit Content-Transfer-Encoding for MIME message parts.
        However, if Amazon SES has to modify the contents of your message (for example, if you use
        open and click tracking), 8-bit content isn't preserved. For this reason, we highly
        ...
        * Although you can customize the message headers when using the ``SendRawEmail`` operation,
        Amazon SES will automatically apply its own ``Message-ID`` and ``Date`` headers; if you
        passed these headers when creating the message, they will be overwritten by the values that
        Amazon SES provides.
        ...
        * If you are using sending authorization to send on behalf of another user, ``SendRawEmail``
        ...
        ``FromArn`` , and/or ``ReturnPathArn`` to the API, or you can include the following
        ...
        If you only specify the ``SourceIdentityArn`` parameter, Amazon SES sets the From and
        ...
        Amazon SES
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html>`__ in the
        *Amazon SES Developer Guide.*

        * For every message that you send, the total number of recipients (including each recipient
        in the To:, CC: and BCC: fields) is counted against the maximum number of emails you can
        send in a 24-hour period (your *sending quota* ). For more information about sending quotas
        ...
        **Request Syntax**
        ...
        :param Source:
          ...
          If you specify the ``Source`` parameter and have feedback forwarding enabled, then bounces
          and complaints will be sent to this email address. This takes precedence over any
        ...
        :param RawMessage: **[REQUIRED]**
          ...
          * Attachments must be of a content type that Amazon SES supports. For a list on
          unsupported content types, see `Unsupported Attachment Types
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mime-types.html>`__ in the *Amazon
          SES Developer Guide* .
          ...
          * If any of the MIME parts in your message contain content that is outside of the 7-bit
          ...
          information, see `Sending Raw Email
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-raw.html>`__ in the
          *Amazon SES Developer Guide* .

          * Per `RFC 5321 <https://tools.ietf.org/html/rfc5321#section-4.5.3.1.6>`__ , the maximum
          ...
          - **Data** *(bytes) --* **[REQUIRED]**
            ...
            an AWS SDK, the SDK takes care of the base 64-encoding for you. In all cases, the client
            ...
            more information, see the documentation for ``SendRawEmail`` .
        ...
        :param ReturnPathArn:
          ...
          Instead of using this parameter, you can use the X-header ``X-SES-RETURN-PATH-ARN`` in the
          raw message of the email. If you use both the ``ReturnPathArn`` parameter and the
        ...
        :param Tags:
          ...
          A list of tags, in the form of name/value pairs, to apply to an email that you send using
          ``SendRawEmail`` . Tags correspond to characteristics of the email that you define, so
    ...
    def send_templated_email(
        ...
        In order to send email using the ``SendTemplatedEmail`` operation, your call to the API must
        ...
        * Calls to the ``SendTemplatedEmail`` operation may only include one ``Destination``
        parameter. A destination is a set of recipients who will receive the same version of the
        ...
        *UserName@[SubDomain.]Domain.TopLevelDomain* ), the entire message will be rejected, even if
        ...
        .. warning::
          ...
          parameters, Amazon SES accepts it and returns a Message ID. However, if Amazon SES can't
          render the email because the template contains errors, it doesn't send the email.
          Additionally, because it already accepted the message, Amazon SES doesn't return a message
          ...
          Personalized Email Using the Amazon SES API
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-personalized-email-api.html>`__
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          A list of tags, in the form of name/value pairs, to apply to an email that you send using
          ``SendTemplatedEmail`` . Tags correspond to characteristics of the email that you define,
    ...
    def set_identity_feedback_forwarding_enabled(
        ...
        **Request Syntax**
        ...
        :param ForwardingEnabled: **[REQUIRED]**
          ...
          specifies that Amazon SES will forward bounce and complaint notifications as email, in
          addition to any Amazon SNS topic publishing otherwise specified. ``false`` specifies that
          Amazon SES will publish bounce and complaint notifications only through Amazon SNS. This
    ...
    def set_identity_headers_in_notifications_enabled(
        ...
        **Request Syntax**
        ...
        :param Enabled: **[REQUIRED]**
          ...
          the specified notification type. A value of ``true`` specifies that Amazon SES will
          include headers in notifications, and a value of ``false`` specifies that Amazon SES will
    ...
    def set_identity_mail_from_domain(
        ...
        .. warning::
          ...
          MAIL FROM domain's DNS settings. If you want your emails to pass Sender Policy Framework
          (SPF) checks, you must also add or update an SPF record. For more information, see the
          `Amazon SES Developer Guide
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The verified identity for which you want to enable or disable the specified custom MAIL
          FROM domain.
        ...
        :param MailFromDomain:
          ...
          domain must 1) be a subdomain of the verified identity, 2) not be used in a "From" address
          if the MAIL FROM domain is the destination of email feedback forwarding (for more
          information, see the `Amazon SES Developer Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mail-from.html>`__ ), and 3) not be
          used to receive emails. A value of ``null`` disables the custom MAIL FROM setting for the
          identity.
        ...
        :param BehaviorOnMXFailure:
          ...
          record when you send an email. If you choose ``UseDefaultValue`` , Amazon SES will use
          amazonses.com (or a subdomain of that) as the MAIL FROM domain. If you choose
          ``RejectMessage`` , Amazon SES will return a ``MailFromDomainNotVerified`` error and not
          send the email.
    ...
    def update_account_sending_enabled(self, Enabled: bool = None) -> None:
        ...
        reputation metrics (such as your bounce or complaint rates) reach certain thresholds.
    ...
    def update_configuration_set_event_destination(
        ...
        about using configuration sets, see `Monitoring Your Amazon SES Sending Activity
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>`__ in
        the *Amazon SES Developer Guide.*
    ...
    def update_configuration_set_reputation_metrics_enabled(
        ...
        rates. These metrics are published to Amazon CloudWatch. By using CloudWatch, you can create
    ...
    def update_configuration_set_sending_enabled(
        ...
        given AWS Region. You can use this operation in conjunction with Amazon CloudWatch alarms to
    ...
    def verify_domain_dkim(self, Domain: str) -> ClientVerifyDomainDkimResponseTypeDef:
        ...
        .. warning::
          ...
          When you execute the ``VerifyDomainDkim`` operation, the domain that you specify is added
          to the list of identities that are associated with your account. This is true even if you
          ...
          you either successfully `verify it
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-domains.html>`__ or you
          successfully `set up DKIM for it
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html>`__ .

        You use the tokens that are generated by this operation to create CNAME records. When Amazon
        SES detects that you've added these records to the DNS configuration for a domain, you can
        start sending email from that domain. You can start sending email even if you haven't added
        the TXT record provided by the VerifyDomainIdentity operation to the DNS configuration for
        your domain. All email that you send from the domain is authenticated using DKIM.
        ...
        * **Value** : *token* .dkim.amazonses.com
        ...
        execute this operation. Replace *example.com* with your domain. Repeat this process for each
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **VerificationToken** *(string) --*
              ...
              changes to "Success". If Amazon SES is unable to detect the record within 72 hours,
              the domain's verification status changes to "Failed." In that case, if you still want
