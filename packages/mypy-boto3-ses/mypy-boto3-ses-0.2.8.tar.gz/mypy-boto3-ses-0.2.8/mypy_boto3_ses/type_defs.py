...
class ClientCreateConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationsTypeDef(
    ...
    """
    Type definition for
    `ClientCreateConfigurationSetEventDestinationEventDestinationCloudWatchDestination`
    ...
    - **DimensionValueSource** *(string) --* **[REQUIRED]**
      ...
      The place where Amazon SES finds the value of a dimension to publish to Amazon CloudWatch. If
      you want Amazon SES to use the message tags that you specify using an ``X-SES-MESSAGE-TAGS``
      header or a parameter to the ``SendEmail`` /``SendRawEmail`` API, choose ``messageTag`` . If
...
class ClientCreateConfigurationSetEventDestinationEventDestinationTypeDef(
    ...
    - **SNSDestination** *(dict) --*
      ...
      - **TopicARN** *(string) --* **[REQUIRED]**
        ...
        of an Amazon SNS topic ARN is ``arn:aws:sns:us-west-2:123456789012:MyTopic`` . For more
        information about Amazon SNS topics, see the `Amazon SNS Developer Guide
        <https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html>`__ .
    """
...
class ClientCreateReceiptRuleRuleActionsBounceActionTypeDef(
    ...
    - **TopicArn** *(string) --*
      ...
      taken. An example of an Amazon SNS topic ARN is ``arn:aws:sns:us-west-2:123456789012:MyTopic``
...
_RequiredClientCreateReceiptRuleRuleActionsLambdaActionTypeDef = TypedDict(
    "_RequiredClientCreateReceiptRuleRuleActionsLambdaActionTypeDef", {"FunctionArn": str}
)
...
class ClientCreateReceiptRuleRuleActionsLambdaActionTypeDef(
    ...
    - **InvocationType** *(string) --*
      ...
      ``Event`` means that the function will be invoked asynchronously. The default value is
      ``Event`` . For information about AWS Lambda invocation types, see the `AWS Lambda Developer
      Guide <https://docs.aws.amazon.com/lambda/latest/dg/API_Invoke.html>`__ .

      .. warning::

        There is a 30-second timeout on ``RequestResponse`` invocations. You should use ``Event``
        invocation in most cases. Use ``RequestResponse`` only when you want to make a mail flow
...
class ClientCreateReceiptRuleRuleActionsS3ActionTypeDef(
    ...
    - **TopicArn** *(string) --*
      ...
      An example of an Amazon SNS topic ARN is ``arn:aws:sns:us-west-2:123456789012:MyTopic`` . For
    ...
    - **KmsKeyArn** *(string) --*
      ...
      to the Amazon S3 bucket. You can use the default master key or a custom master key you created
      in AWS KMS as follows:
      ...
      * To use a custom master key you created in AWS KMS, provide the ARN of the master key and
      ...
      .. warning::
        ...
        keys for decryption. This encryption client is currently available with the `AWS SDK for
        Java <http://aws.amazon.com/sdk-for-java/>`__ and `AWS SDK for Ruby
...
_OptionalClientCreateReceiptRuleRuleActionsSNSActionTypeDef = TypedDict(
    "_OptionalClientCreateReceiptRuleRuleActionsSNSActionTypeDef", {"Encoding": str}, total=False
)
...
class ClientCreateReceiptRuleRuleActionsSNSActionTypeDef(
    ...
    - **TopicArn** *(string) --* **[REQUIRED]**
      ...
      topic ARN is ``arn:aws:sns:us-west-2:123456789012:MyTopic`` . For more information about
...
_OptionalClientCreateReceiptRuleRuleActionsStopActionTypeDef = TypedDict(
    "_OptionalClientCreateReceiptRuleRuleActionsStopActionTypeDef", {"TopicArn": str}, total=False
)
...
_RequiredClientCreateReceiptRuleRuleActionsWorkmailActionTypeDef = TypedDict(
    "_RequiredClientCreateReceiptRuleRuleActionsWorkmailActionTypeDef", {"OrganizationArn": str}
)
...
class ClientCreateReceiptRuleRuleActionsWorkmailActionTypeDef(
    ...
    - **TopicArn** *(string) --*
      ...
      called. An example of an Amazon SNS topic ARN is
      ``arn:aws:sns:us-west-2:123456789012:MyTopic`` . For more information about Amazon SNS topics,
      see the `Amazon SNS Developer Guide
      <https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html>`__ .

    - **OrganizationArn** *(string) --* **[REQUIRED]**

      The ARN of the Amazon WorkMail organization. An example of an Amazon WorkMail organization ARN
      is ``arn:aws:workmail:us-west-2:123456789012:organization/m-68755160c4cb4e29a2b2f8fb58f359d7``
      . For information about Amazon WorkMail organizations, see the `Amazon WorkMail Administrator
      Guide <https://docs.aws.amazon.com/workmail/latest/adminguide/organizations_overview.html>`__
      .
    """
...
class ClientCreateReceiptRuleRuleActionsTypeDef(_ClientCreateReceiptRuleRuleActionsTypeDef):
    ...
    - **S3Action** *(dict) --*
      ...
      - **KmsKeyArn** *(string) --*
        ...
        The customer master key that Amazon SES should use to encrypt your emails before saving them
        to the Amazon S3 bucket. You can use the default master key or a custom master key you
    ...
    - **LambdaAction** *(dict) --*
      ...
      - **InvocationType** *(string) --*
        ...
        The invocation type of the AWS Lambda function. An invocation type of ``RequestResponse``
        means that the execution of the function will immediately result in a response, and a value
        of ``Event`` means that the function will be invoked asynchronously. The default value is
        ``Event`` . For information about AWS Lambda invocation types, see the `AWS Lambda Developer
        Guide <https://docs.aws.amazon.com/lambda/latest/dg/API_Invoke.html>`__ .
    ...
    - **SNSAction** *(dict) --*
      ...
      - **TopicArn** *(string) --* **[REQUIRED]**
        ...
        SNS topic ARN is ``arn:aws:sns:us-west-2:123456789012:MyTopic`` . For more information about
        Amazon SNS topics, see the `Amazon SNS Developer Guide
        <https://docs.aws.amazon.com/sns/latest/dg/CreateTopic.html>`__ .
      ...
      - **Encoding** *(string) --*
        ...
        use, but may not preserve all special characters when a message was encoded with a different
        encoding format. Base64 preserves all special characters. The default value is UTF-8.
    """
      ...
      - *(dict) --*
        ...
        - **S3Action** *(dict) --*
          ...
          - **KmsKeyArn** *(string) --*
            ...
            * To use the default master key, provide an ARN in the form of
            ...
            key, you don't need to perform any extra steps to give Amazon SES permission to use the
            key.
            ...
            * To use a custom master key you created in AWS KMS, provide the ARN of the master key
            ...
            to use it. For more information about giving permissions, see the `Amazon SES Developer
            Guide
            <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-permissions.html>`__
            .
        ...
        - **LambdaAction** *(dict) --*
          ...
          - **InvocationType** *(string) --*
            ...
            ``RequestResponse`` means that the execution of the function will immediately result in
            a response, and a value of ``Event`` means that the function will be invoked
            ...
            .. warning::
              ...
              a mail flow decision, such as whether to stop the receipt rule or the receipt rule
              set.
...
_ClientDescribeConfigurationSetResponseDeliveryOptionsTypeDef = TypedDict(
    "_ClientDescribeConfigurationSetResponseDeliveryOptionsTypeDef", {"TlsPolicy": str}, total=False
)
...
class ClientDescribeConfigurationSetResponseEventDestinationsCloudWatchDestinationDimensionConfigurationsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeConfigurationSetResponseEventDestinationsCloudWatchDestination`
    `DimensionConfigurations`
...
class ClientDescribeConfigurationSetResponseEventDestinationsCloudWatchDestinationTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigurationSetResponseEventDestinations`
    `CloudWatchDestination`
...
class ClientDescribeConfigurationSetResponseEventDestinationsTypeDef(
    ...
    Contains information about the event destination that the specified email sending events will be
    published to.
...
class ClientDescribeConfigurationSetResponseReputationOptionsTypeDef(
    ...
    - **SendingEnabled** *(boolean) --*
      ...
      is ``true`` , then Amazon SES will send emails that use the configuration set. If the value is
      ``false`` , Amazon SES will not send emails that use the configuration set. The default value
      is ``true`` . You can change this setting using  UpdateConfigurationSetSendingEnabled .
...
class ClientGetIdentityDkimAttributesResponseDkimAttributesTypeDef(
    ...
    - **DkimVerificationStatus** *(string) --*
      ...
      Describes whether Amazon SES has successfully verified the DKIM DNS records (tokens) published
      in the domain name's DNS. (This only applies to domain identities, not email address
      identities.)
...
class ClientGetIdentityMailFromDomainAttributesResponseMailFromDomainAttributesTypeDef(
    ...
    """
    Type definition for `ClientGetIdentityMailFromDomainAttributesResponse`
    ...
    - **MailFromDomainStatus** *(string) --*
      ...
      custom MAIL FROM domain setup. If the state is ``Success`` , Amazon SES uses the specified
    ...
    - **BehaviorOnMXFailure** *(string) --*
      ...
      required MX record, it uses amazonses.com (or a subdomain of that) as the MAIL FROM domain. A
      value of ``RejectMessage`` indicates that if Amazon SES cannot read the required MX record,
...
class ClientGetIdentityNotificationAttributesResponseNotificationAttributesTypeDef(
    ...
    - **ForwardingEnabled** *(boolean) --*
      ...
      ``true`` indicates that Amazon SES will forward bounce and complaint notifications as email,
      while ``false`` indicates that bounce and complaint notifications will be published only to
      the specified bounce and complaint Amazon SNS topics.

    - **HeadersInBounceNotificationsEnabled** *(boolean) --*

      Describes whether Amazon SES includes the original email headers in Amazon SNS notifications
      of type ``Bounce`` . A value of ``true`` specifies that Amazon SES will include headers in
      bounce notifications, and a value of ``false`` specifies that Amazon SES will not include
      headers in bounce notifications.

    - **HeadersInComplaintNotificationsEnabled** *(boolean) --*

      Describes whether Amazon SES includes the original email headers in Amazon SNS notifications
      of type ``Complaint`` . A value of ``true`` specifies that Amazon SES will include headers in
      complaint notifications, and a value of ``false`` specifies that Amazon SES will not include
      headers in complaint notifications.

    - **HeadersInDeliveryNotificationsEnabled** *(boolean) --*

      Describes whether Amazon SES includes the original email headers in Amazon SNS notifications
      of type ``Delivery`` . A value of ``true`` specifies that Amazon SES will include headers in
      delivery notifications, and a value of ``false`` specifies that Amazon SES will not include
...
class ClientListConfigurationSetsResponseConfigurationSetsTypeDef(
    ...
    Configuration Sets
    <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/using-configuration-sets.html>`__ in the
    `Amazon SES Developer Guide <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/>`__ .
...
class ClientListCustomVerificationEmailTemplatesResponseCustomVerificationEmailTemplatesTypeDef(
    ...
    """
    Type definition for `ClientListCustomVerificationEmailTemplatesResponse`
...
class ClientSendBounceBouncedRecipientInfoListRecipientDsnFieldsExtensionFieldsTypeDef(
    ...
    """
    Type definition for `ClientSendBounceBouncedRecipientInfoListRecipientDsnFields`
    `ExtensionFields`
...
class ClientSendBounceBouncedRecipientInfoListRecipientDsnFieldsTypeDef(
    ...
    - **FinalRecipient** *(string) --*
      ...
      .. note::
        ...
        Do not prepend the ``FinalRecipient`` email address with ``rfc 822;`` , as described in `RFC
        3798 <https://tools.ietf.org/html/rfc3798>`__ .
...
class ClientSendBulkTemplatedEmailDestinationsDestinationTypeDef(
    ...
    .. note::
      ...
      <https://tools.ietf.org/html/rfc6531>`__ . For this reason, the *local part* of a destination
      email address (the part of the email address that precedes the @ sign) may only contain `7-bit
      ASCII characters <https://en.wikipedia.org/wiki/Email_address#Local-part>`__ . If the *domain
      part* of an address (the part after the @ sign) contains non-ASCII characters, they must be
      encoded using Punycode, as described in `RFC3492 <https://tools.ietf.org/html/rfc3492.html>`__
      .
...
_ClientSendBulkTemplatedEmailDestinationsReplacementTagsTypeDef = TypedDict(
    "_ClientSendBulkTemplatedEmailDestinationsReplacementTagsTypeDef", {"Name": str, "Value": str}
)
...
class ClientSendBulkTemplatedEmailResponseStatusTypeDef(
    ...
    - **Status** *(string) --*
      ...
      * ``TransientFailure`` : Amazon SES was unable to process your request because of a temporary
      issue.
...
class ClientSendEmailMessageBodyHtmlTypeDef(
    _RequiredClientSendEmailMessageBodyHtmlTypeDef, _OptionalClientSendEmailMessageBodyHtmlTypeDef
):
    """
...
class ClientSendEmailMessageBodyTextTypeDef(
    _RequiredClientSendEmailMessageBodyTextTypeDef, _OptionalClientSendEmailMessageBodyTextTypeDef
):
    """
...
_ClientSendEmailMessageTypeDef = TypedDict(
    ...
    {"Subject": ClientSendEmailMessageSubjectTypeDef, "Body": ClientSendEmailMessageBodyTypeDef},
)
...
_ClientSendEmailTagsTypeDef = TypedDict("_ClientSendEmailTagsTypeDef", {"Name": str, "Value": str})
...
class ClientUpdateConfigurationSetEventDestinationEventDestinationCloudWatchDestinationDimensionConfigurationsTypeDef(
    ...
    """
    Type definition for
    `ClientUpdateConfigurationSetEventDestinationEventDestinationCloudWatchDestination`
    `DimensionConfigurations`
...
_RequiredClientUpdateReceiptRuleRuleActionsLambdaActionTypeDef = TypedDict(
    "_RequiredClientUpdateReceiptRuleRuleActionsLambdaActionTypeDef", {"FunctionArn": str}
)
...
_OptionalClientUpdateReceiptRuleRuleActionsSNSActionTypeDef = TypedDict(
    "_OptionalClientUpdateReceiptRuleRuleActionsSNSActionTypeDef", {"Encoding": str}, total=False
)
...
_OptionalClientUpdateReceiptRuleRuleActionsStopActionTypeDef = TypedDict(
    "_OptionalClientUpdateReceiptRuleRuleActionsStopActionTypeDef", {"TopicArn": str}, total=False
)
...
_RequiredClientUpdateReceiptRuleRuleActionsWorkmailActionTypeDef = TypedDict(
    "_RequiredClientUpdateReceiptRuleRuleActionsWorkmailActionTypeDef", {"OrganizationArn": str}
)
...
class ListCustomVerificationEmailTemplatesPaginateResponseCustomVerificationEmailTemplatesTypeDef(
    ...
    """
    Type definition for `ListCustomVerificationEmailTemplatesPaginateResponse`
    `CustomVerificationEmailTemplates`
