...
class Client(BaseClient):
    ...
    def clone_receipt_rule_set(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CloneReceiptRuleSet>`_
    ...
    def create_configuration_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateConfigurationSet>`_
    ...
    def create_configuration_set_event_destination(
        ...
        .. note::
          ...
          The destination can be CloudWatch, Amazon Kinesis Firehose, or Amazon Simple Notification Service
          (Amazon SNS).

        An event destination is the AWS service to which Amazon SES publishes the email sending events
        associated with a configuration set. For information about using configuration sets, see the `Amazon
        SES Developer Guide
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateConfigurationSetEventDestination>`_
        ...
        **Request Syntax**
        ...
        :param EventDestination: **[REQUIRED]**
          ...
          - **CloudWatchDestination** *(dict) --*
            ...
            An object that contains the names, default values, and sources of the dimensions associated with
            an Amazon CloudWatch event destination.
            ...
            - **DimensionConfigurations** *(list) --* **[REQUIRED]**
              ...
              - *(dict) --*
                ...
                - **DimensionValueSource** *(string) --* **[REQUIRED]**
                  ...
                  If you want Amazon SES to use the message tags that you specify using an
    ...
    def create_configuration_set_tracking_options(
        ...
        By default, images and links used for tracking open and click events are hosted on domains operated
        by Amazon SES. You can configure a subdomain of your own to handle these events. For information
        about using custom domains, see the `Amazon SES Developer Guide
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/configure-custom-open-click-domains.html>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateConfigurationSetTrackingOptions>`_
    ...
    def create_custom_verification_email_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateCustomVerificationEmailTemplate>`_
        ...
        **Request Syntax**
        ...
        :param TemplateContent: **[REQUIRED]**
          ...
          Verification Email Frequently Asked Questions
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html#custom-verification-emails-faq>`__
          in the *Amazon SES Developer Guide* .
    ...
    def create_receipt_filter(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateReceiptFilter>`_
    ...
    def create_receipt_rule(
        self,
        RuleSetName: str,
        Rule: ClientCreateReceiptRuleRuleTypeDef,
        After: str = None,
    ) -> Dict:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateReceiptRule>`_
        ...
        **Request Syntax**
        ...
        :param After:
          ...
          The name of an existing rule after which the new rule will be placed. If this parameter is null,
          the new rule will be inserted at the beginning of the rule list.
              ...
              - **S3Action** *(dict) --*
                ...
                - **KmsKeyArn** *(string) --*
                  ...
                  * To use the default master key, provide an ARN in the form of
                  ...
                  account ID is 123456789012 and you want to use the default master key in the US West
                  ...
                  * To use a custom master key you created in AWS KMS, provide the ARN of the master key and
                  ensure that you add a statement to your key's policy to give Amazon SES permission to use
                  it. For more information about giving permissions, see the `Amazon SES Developer Guide
                  ...
                  .. warning::
                    ...
                    the `AWS SDK for Java <http://aws.amazon.com/sdk-for-java/>`__ and `AWS SDK for Ruby
                    <http://aws.amazon.com/sdk-for-ruby/>`__ only. For more information about client-side
    ...
    def create_receipt_rule_set(self, RuleSetName: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateReceiptRuleSet>`_
    ...
    def create_template(
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-personalized-email-api.html>`__ .

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/CreateTemplate>`_
    ...
    def delete_configuration_set(self, ConfigurationSetName: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteConfigurationSet>`_
    ...
    def delete_configuration_set_event_destination(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteConfigurationSetEventDestination>`_
    ...
    def delete_configuration_set_tracking_options(
        ...
        .. note::
          ...
          Deleting this kind of association will result in emails sent using the specified configuration set
          to capture open and click events using the standard, Amazon SES-operated domains.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteConfigurationSetTrackingOptions>`_
    ...
    def delete_custom_verification_email_template(self, TemplateName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteCustomVerificationEmailTemplate>`_
    ...
    def delete_identity(self, Identity: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteIdentity>`_
    ...
    def delete_identity_policy(self, Identity: str, PolicyName: str) -> Dict:
        ...
        domain). This API returns successfully even if a policy with the specified name does not exist.

        .. note::

          This API is for the identity owner only. If you have not verified the identity, this API will
          return an error.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteIdentityPolicy>`_
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The identity that is associated with the policy that you want to delete. You can specify the
    ...
    def delete_receipt_filter(self, FilterName: str) -> Dict:
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-ip-filters.html>`__
        .

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteReceiptFilter>`_
    ...
    def delete_receipt_rule(self, RuleSetName: str, RuleName: str) -> Dict:
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rules.html>`__
        .

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteReceiptRule>`_
    ...
    def delete_receipt_rule_set(self, RuleSetName: str) -> Dict:
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-managing-receipt-rule-sets.html>`__
        .

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteReceiptRuleSet>`_
    ...
    def delete_template(self, TemplateName: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteTemplate>`_
    ...
    def delete_verified_email_address(self, EmailAddress: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DeleteVerifiedEmailAddress>`_
    ...
    def describe_active_receipt_rule_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DescribeActiveReceiptRuleSet>`_
    ...
    def describe_configuration_set(
        self,
        ConfigurationSetName: str,
        ConfigurationSetAttributeNames: List[str] = None,
    ) -> ClientDescribeConfigurationSetResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DescribeConfigurationSet>`_
            ...
            - **EventDestinations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Enabled** *(boolean) --*
                  ...
                  destination; set to ``false`` to prevent publishing to this destination. The default value
                  is ``false`` .
                  ...
                  - **DimensionConfigurations** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **DimensionValueSource** *(string) --*
                        ...
                        ``X-SES-MESSAGE-TAGS`` header or a parameter to the ``SendEmail`` /``SendRawEmail``
    ...
    def describe_receipt_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DescribeReceiptRule>`_
                  ...
                  - **S3Action** *(dict) --*
                    ...
                    - **KmsKeyArn** *(string) --*
                      ...
                      * To use the default master key, provide an ARN in the form of
                      ...
                      AWS account ID is 123456789012 and you want to use the default master key in the US
                      ...
                      * To use a custom master key you created in AWS KMS, provide the ARN of the master key
                      ...
                      to use it. For more information about giving permissions, see the `Amazon SES
                      Developer Guide
                      <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/receiving-email-permissions.html>`__
                      .
                      ...
                      .. warning::
                        ...
                        available with the `AWS SDK for Java <http://aws.amazon.com/sdk-for-java/>`__ and
                        `AWS SDK for Ruby <http://aws.amazon.com/sdk-for-ruby/>`__ only. For more
                        information about client-side encryption using AWS KMS master keys, see the `Amazon
                        S3 Developer Guide
                        <https://docs.aws.amazon.com/AmazonS3/latest/dev/UsingClientSideEncryption.html>`__
                        .
    ...
    def describe_receipt_rule_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/DescribeReceiptRuleSet>`_
    ...
    def get_account_sending_enabled(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetAccountSendingEnabled>`_
    ...
    def get_custom_verification_email_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetCustomVerificationEmailTemplate>`_
    ...
    def get_identity_dkim_attributes(
        ...
        SES has successfully verified that these tokens have been published.
        ...
        * Whether Amazon SES has successfully verified the DKIM tokens published in the domain's DNS. This
        information is only returned for domain name identities, not for email addresses.

        This operation is throttled at one request per second and can only get DKIM attributes for up to 100
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetIdentityDkimAttributes>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            this response also contains the DKIM tokens that are required for Easy DKIM signing, and whether
            Amazon SES successfully verified that these tokens were published.
              ...
              - *(string) --*
                ...
                - *(dict) --*
                  ...
                  - **DkimTokens** *(list) --*
                    ...
                    need to create DNS CNAME records that point to DKIM public keys that are hosted by
                    Amazon SES. Amazon Web Services eventually detects that you've updated your DNS records.
                    This detection process might take up to 72 hours. After successful detection, Amazon SES
                    is able to DKIM-sign email originating from that domain. (This only applies to domain
    ...
    def get_identity_mail_from_domain_attributes(
        ...
        This operation is throttled at one request per second and can only get custom MAIL FROM attributes
        for up to 100 identities at a time.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetIdentityMailFromDomainAttributes>`_
    ...
    def get_identity_notification_attributes(
        ...
        This operation is throttled at one request per second and can only get notification attributes for
        up to 100 identities at a time.

        For more information about using notifications with Amazon SES, see the `Amazon SES Developer Guide
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/notifications.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetIdentityNotificationAttributes>`_
    ...
    def get_identity_policies(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetIdentityPolicies>`_
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The identity for which the policies will be retrieved. You can specify an identity by using its
    ...
    def get_identity_verification_attributes(
        ...
        (for domain identities) the verification token for each identity.
        ...
        clicks the link within 24 hours, the verification status of the email address changes to "Success".
        If the link is not clicked within 24 hours, the verification status changes to "Failed." In that
        case, if you still want to verify the email address, you must restart the verification process from
        the beginning.

        For domain identities, the domain's verification status is "Pending" as Amazon SES searches for the
        required TXT record in the DNS settings of the domain. When Amazon SES detects the record, the
        domain's verification status changes to "Success". If Amazon SES is unable to detect the record
        within 72 hours, the domain's verification status changes to "Failed." In that case, if you still
        want to verify the domain, you must restart the verification process from the beginning.

        This operation is throttled at one request per second and can only get verification attributes for
        up to 100 identities at a time.
    ...
    def get_send_quota(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetSendQuota>`_
          ...
          - *(dict) --*
            ...
            - **MaxSendRate** *(float) --*
              ...
              .. note::
                ...
                The rate at which Amazon SES accepts the user's messages might be less than the maximum send
                rate.
    ...
    def get_send_statistics(
        ...
        representing the last two weeks of sending activity. Each data point in the list contains statistics
        for a 15-minute period of time.

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetSendStatistics>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Represents a list of data points. This list contains aggregated data from the previous two weeks
            of your sending activity with Amazon SES.
    ...
    def get_template(self, TemplateName: str) -> ClientGetTemplateResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/GetTemplate>`_
    ...
    def list_configuration_sets(
        ...
        """
        Provides a list of the configuration sets associated with your Amazon SES account in the current AWS
        Region. For information about using configuration sets, see `Monitoring Your Amazon SES Sending
        Activity <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>`__ in
        the *Amazon SES Developer Guide.*

        You can execute this operation no more than once per second. This operation will return up to 1,000
        configuration sets each time it is run. If your Amazon SES account has more than 1,000 configuration
        sets, this operation will also return a NextToken element. You can then execute the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListConfigurationSets>`_
    ...
    def list_custom_verification_email_templates(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListCustomVerificationEmailTemplates>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          or greater than 50, the operation will return up to 50 results.
    ...
    def list_identities(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListIdentities>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            A list of all identities that you have attempted to verify under your AWS account, regardless of
            verification status.
    ...
    def list_identity_policies(
        ...
        address or a domain). This API returns only a list. If you want the actual policy content, you can
        use ``GetIdentityPolicies`` .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListIdentityPolicies>`_
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The identity that is associated with the policy for which the policies will be listed. You can
          specify an identity by using its name or by using its Amazon Resource Name (ARN). Examples:
          ``user@example.com`` , ``example.com`` ,
          ``arn:aws:ses:us-east-1:123456789012:identity/example.com`` .
    ...
    def list_receipt_filters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListReceiptFilters>`_
    ...
    def list_receipt_rule_sets(
        ...
        """
        Lists the receipt rule sets that exist under your AWS account in the current AWS Region. If there
        are additional receipt rule sets to be retrieved, you will receive a ``NextToken`` that you can
        provide to the next call to ``ListReceiptRuleSets`` to retrieve the additional entries.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListReceiptRuleSets>`_
    ...
    def list_templates(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListTemplates>`_
        ...
        **Request Syntax**
        ...
        :param MaxItems:
          ...
          10. If you do not specify a value, or if you specify a value less than 1 or greater than 10, the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              token to a subsequent call to ``ListTemplates`` to retrieve the next 50 email templates.
    ...
    def list_verified_email_addresses(
        ...
        """
        Deprecated. Use the ``ListIdentities`` operation to list the email addresses and domains associated
        with your account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ListVerifiedEmailAddresses>`_
    ...
    def put_configuration_set_delivery_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/PutConfigurationSetDeliveryOptions>`_
    ...
    def put_identity_policy(self, Identity: str, PolicyName: str, Policy: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/PutIdentityPolicy>`_
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The identity that the policy will apply to. You can specify an identity by using its name or by
        ...
        :param PolicyName: **[REQUIRED]**
          ...
          The policy name cannot exceed 64 characters and can only include alphanumeric characters, dashes,
          and underscores.
        ...
        :param Policy: **[REQUIRED]**
          ...
          Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization-policies.html>`__ .
    ...
    def reorder_receipt_rule_set(self, RuleSetName: str, RuleNames: List[str]) -> Dict:
        ...
        .. note::
          ...
          All of the rules in the rule set must be represented in this request. That is, this API will
          return an error if the reorder request doesn't explicitly position all of the rules.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/ReorderReceiptRuleSet>`_
    ...
    def send_bounce(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SendBounce>`_
        ...
        **Request Syntax**
              ...
              BouncedRecipientInfoList=[
                  {
                      ...
                      'RecipientArn': 'string',
                      'BounceType':
                      'DoesNotExist'|'MessageTooLarge'|'ExceededQuota'|'ContentRejected'|'Undefined'
                      |'TemporaryFailure',
                      'RecipientDsnFields': {
        ...
        :param Explanation:
          ...
          Human-readable text for the bounce message to explain the failure. If not specified, the text will
          be auto-generated based on the bounced recipient information.
          ...
          - *(dict) --*
            ...
            - **RecipientDsnFields** *(dict) --*
              ...
              - **FinalRecipient** *(string) --*
                ...
                ``Recipient`` specified in the ``BouncedRecipientInfo`` structure. Either ``FinalRecipient``
                or the recipient in ``BouncedRecipientInfo`` must be a recipient of the original bounced
                message.
    ...
    def send_bulk_templated_email(
        ...
        In order to send email using the ``SendBulkTemplatedEmail`` operation, your call to the API must
        ...
        * If your account is still in the Amazon SES sandbox, you may only send to verified addresses or
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-addresses-and-domains.html>`__ in the
        *Amazon SES Developer Guide.*
        ...
        * Each ``Destination`` parameter must include at least one recipient email address. The recipient
        ...
        invalid (that is, it is not in the format *UserName@[SubDomain.]Domain.TopLevelDomain* ), the entire
        message will be rejected, even if the message contains other recipients that are valid.
        ...
        * The message may not include more than 50 recipients, across the To:, CC: and BCC: fields. If you
        ...
        of 50 or fewer, and then call the ``SendBulkTemplatedEmail`` operation several times to send the
        message to each group.

        * The number of destinations you can contact in a single call to the API may be limited by your
        account's maximum sending rate.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SendBulkTemplatedEmail>`_
        ...
        **Request Syntax**
        ...
        :param Source: **[REQUIRED]**
          ...
          verified with Amazon SES, or from a domain that has been verified with Amazon SES. For information
          about verifying identities, see the `Amazon SES Developer Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-addresses-and-domains.html>`__ .

          If you are sending on behalf of another user and have been permitted to do so by a sending
          authorization policy, then you must also specify the ``SourceArn`` parameter. For more information
          ...
          .. note::
            ...
            <https://tools.ietf.org/html/rfc6531>`__ . For this reason, the *local part* of a source email
            address (the part of the email address that precedes the @ sign) may only contain `7-bit ASCII
            characters <https://en.wikipedia.org/wiki/Email_address#Local-part>`__ . If the *domain part* of
            an address (the part after the @ sign) contains non-ASCII characters, they must be encoded using
            Punycode, as described in `RFC3492 <https://tools.ietf.org/html/rfc3492.html>`__ . The sender
            name (also known as the *friendly name* ) may contain non-ASCII characters. These characters
            must be encoded using MIME encoded-word syntax, as described in `RFC 2047
            <https://tools.ietf.org/html/rfc2047>`__ . MIME encoded-word syntax uses the following form:
        ...
        :param SourceArn:
          ...
          authorizes you to send from ``user@example.com`` , then you would specify the ``SourceArn`` to be
        ...
        :param ReturnPath:
          ...
          enabled. If the message cannot be delivered to the recipient, then an error message will be
          returned from the recipient's ISP; this message will then be forwarded to the email address
          specified by the ``ReturnPath`` parameter. The ``ReturnPath`` parameter is never overwritten. This
        ...
        :param ReturnPathArn:
          ...
          For example, if the owner of ``example.com`` (which has ARN
          ``arn:aws:ses:us-east-1:123456789012:identity/example.com`` ) attaches a policy to it that
          authorizes you to use ``feedback@example.com`` , then you would specify the ``ReturnPathArn`` to
          be ``arn:aws:ses:us-east-1:123456789012:identity/example.com`` , and the ``ReturnPath`` to be
        ...
        :param Destinations: **[REQUIRED]**
          ...
          One or more ``Destination`` objects. All of the recipients in a ``Destination`` will receive the
          ...
          ::

            {
                'Status': [
                    {
                        'Status':
                        'Success'|'MessageRejected'|'MailFromDomainNotVerified'
                        ...
                        |'AccountSendingPaused'|'ConfigurationSetSendingPaused'|'InvalidParameterValue'
    ...
    def send_custom_verification_email(
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/custom-verification-emails.html>`__ in the
        *Amazon SES Developer Guide* .

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SendCustomVerificationEmail>`_
    ...
    def send_email(
        ...
        * The message must be sent from a verified email address or domain. If you attempt to send email
        using a non-verified address or domain, the operation will result in an "Email address not verified"
        error.
        ...
        * The message must include at least one recipient email address. The recipient address can be a To:
        address, a CC: address, or a BCC: address. If a recipient email address is invalid (that is, it is
        not in the format *UserName@[SubDomain.]Domain.TopLevelDomain* ), the entire message will be
        rejected, even if the message contains other recipients that are valid.

        * The message may not include more than 50 recipients, across the To:, CC: and BCC: fields. If you
        need to send an email message to a larger audience, you can divide your recipient list into groups
        of 50 or fewer, and then call the ``SendEmail`` operation several times to send the message to each
        group.

        .. warning::

          For every message that you send, the total number of recipients (including each recipient in the
          To:, CC: and BCC: fields) is counted against the maximum number of emails you can send in a
          24-hour period (your *sending quota* ). For more information about sending quotas in Amazon SES,
          see `Managing Your Amazon SES Sending Limits
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/manage-sending-limits.html>`__ in the
          *Amazon SES Developer Guide.*

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SendEmail>`_
    ...
    def send_raw_email(
        ...
        flexibility is useful, for example, when you want to send a multipart MIME email (such a message
        that contains both a text and an HTML version). You can also use this operation to send messages
        that include attachments.

        The ``SendRawEmail`` operation has the following requirements:

        * You can only send email from `verified email addresses or domains
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-addresses-and-domains.html>`__ . If
        ...
        * If your account is still in the `Amazon SES sandbox
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/request-production-access.html>`__ , you can
        only send email to other verified addresses in your account, or to addresses that are associated
        with the `Amazon SES mailbox simulator
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mailbox-simulator.html>`__ .
        ...
        * If you send a single message to more than one recipient address, and one of the recipient
        addresses isn't in a valid format (that is, it's not in the format
        ...
        * Amazon SES allows you to specify 8-bit Content-Transfer-Encoding for MIME message parts. However,
        if Amazon SES has to modify the contents of your message (for example, if you use open and click
        tracking), 8-bit content isn't preserved. For this reason, we highly recommend that you encode all
        content that isn't 7-bit ASCII. For more information, see `MIME Encoding
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-email-raw.html#send-email-mime-encoding>`__
        in the *Amazon SES Developer Guide* .

        Additionally, keep the following considerations in mind when using the ``SendRawEmail`` operation:

        * Although you can customize the message headers when using the ``SendRawEmail`` operation, Amazon
        SES will automatically apply its own ``Message-ID`` and ``Date`` headers; if you passed these
        headers when creating the message, they will be overwritten by the values that Amazon SES provides.

        * If you are using sending authorization to send on behalf of another user, ``SendRawEmail`` enables
        you to specify the cross-account identity for the email's Source, From, and Return-Path parameters
        ...
        .. warning::
          ...
          Don't include these X-headers in the DKIM signature. Amazon SES removes these before it sends the
          email.
        ...
        SES <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization.html>`__ in the
        *Amazon SES Developer Guide.*

        * For every message that you send, the total number of recipients (including each recipient in the
        To:, CC: and BCC: fields) is counted against the maximum number of emails you can send in a 24-hour
        period (your *sending quota* ). For more information about sending quotas in Amazon SES, see
        `Managing Your Amazon SES Sending Limits
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/manage-sending-limits.html>`__ in the *Amazon
        SES Developer Guide.*

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SendRawEmail>`_
        ...
        **Request Syntax**
        ...
        :param Source:
          ...
          complaints will be sent to this email address. This takes precedence over any Return-Path header
        ...
        :param RawMessage: **[REQUIRED]**
          ...
          * Per `RFC 5321 <https://tools.ietf.org/html/rfc5321#section-4.5.3.1.6>`__ , the maximum length of
          ...
          - **Data** *(bytes) --* **[REQUIRED]**
            ...
            message format complies with Internet email standards regarding email header fields, MIME types,
            and MIME encoding.
        ...
        :param FromArn:
          ...
          Instead of using this parameter, you can use the X-header ``X-SES-FROM-ARN`` in the raw message of
          the email. If you use both the ``FromArn`` parameter and the corresponding X-header, Amazon SES
          ...
          .. note::
            ...
            <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/sending-authorization-delegate-sender-tasks-email.html>`__
            .
        ...
        :param SourceArn:
          ...
          Instead of using this parameter, you can use the X-header ``X-SES-SOURCE-ARN`` in the raw message
          of the email. If you use both the ``SourceArn`` parameter and the corresponding X-header, Amazon
          SES uses the value of the ``SourceArn`` parameter.
    ...
    def send_templated_email(
        ...
        In order to send email using the ``SendTemplatedEmail`` operation, your call to the API must meet
        ...
        * Calls to the ``SendTemplatedEmail`` operation may only include one ``Destination`` parameter. A
        destination is a set of recipients who will receive the same version of the email. The
        ``Destination`` parameter can include up to 50 recipients, across the To:, CC: and BCC: fields.
        ...
        * The ``Destination`` parameter must include at least one recipient email address. The recipient
        ...
        .. warning::
          ...
          because the template contains errors, it doesn't send the email. Additionally, because it already
          accepted the message, Amazon SES doesn't return a message stating that it was unable to send the
          email.

          For these reasons, we highly recommend that you set up Amazon SES to send you notifications when
          Rendering Failure events occur. For more information, see `Sending Personalized Email Using the
          Amazon SES API
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/send-personalized-email-api.html>`__ in the
          *Amazon Simple Email Service Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SendTemplatedEmail>`_
    ...
    def set_active_receipt_rule_set(self, RuleSetName: str = None) -> Dict:
        ...
        .. note::
          ...
          To disable your email-receiving through Amazon SES completely, you can call this API with
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetActiveReceiptRuleSet>`_
    ...
    def set_identity_dkim_enabled(self, Identity: str, DkimEnabled: bool) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetIdentityDkimEnabled>`_
    ...
    def set_identity_feedback_forwarding_enabled(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetIdentityFeedbackForwardingEnabled>`_
        ...
        **Request Syntax**
        ...
        :param ForwardingEnabled: **[REQUIRED]**
          ...
          specifies that Amazon SES will forward bounce and complaint notifications as email, in addition to
          any Amazon SNS topic publishing otherwise specified. ``false`` specifies that Amazon SES will
    ...
    def set_identity_headers_in_notifications_enabled(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetIdentityHeadersInNotificationsEnabled>`_
        ...
        **Request Syntax**
        ...
        :param Enabled: **[REQUIRED]**
          ...
          specified notification type. A value of ``true`` specifies that Amazon SES will include headers in
    ...
    def set_identity_mail_from_domain(
        ...
        .. warning::
          ...
          To send emails using the specified MAIL FROM domain, you must add an MX record to your MAIL FROM
          domain's DNS settings. If you want your emails to pass Sender Policy Framework (SPF) checks, you
          must also add or update an SPF record. For more information, see the `Amazon SES Developer Guide
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mail-from-set.html>`__ .

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetIdentityMailFromDomain>`_
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          The verified identity for which you want to enable or disable the specified custom MAIL FROM
          domain.
        ...
        :param MailFromDomain:
          ...
          domain is the destination of email feedback forwarding (for more information, see the `Amazon SES
          Developer Guide <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/mail-from.html>`__ ), and
          3) not be used to receive emails. A value of ``null`` disables the custom MAIL FROM setting for
          the identity.

        :type BehaviorOnMXFailure: string
        :param BehaviorOnMXFailure:

          The action that you want Amazon SES to take if it cannot successfully read the required MX record
          when you send an email. If you choose ``UseDefaultValue`` , Amazon SES will use amazonses.com (or
          a subdomain of that) as the MAIL FROM domain. If you choose ``RejectMessage`` , Amazon SES will
          return a ``MailFromDomainNotVerified`` error and not send the email.

          The action specified in ``BehaviorOnMXFailure`` is taken when the custom MAIL FROM domain setup is
          in the ``Pending`` , ``Failed`` , and ``TemporaryFailure`` states.
    ...
    def set_identity_notification_topic(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetIdentityNotificationTopic>`_
        ...
        **Request Syntax**
        ...
        :param Identity: **[REQUIRED]**
          ...
          following examples are all valid identities: ``sender@example.com`` , ``example.com`` ,
          ``arn:aws:ses:us-east-1:123456789012:identity/example.com`` .
        ...
        :param SnsTopic:
          ...
          The Amazon Resource Name (ARN) of the Amazon SNS topic. If the parameter is omitted from the
          request or a null value is passed, ``SnsTopic`` is cleared and publishing is disabled.
    ...
    def set_receipt_rule_position(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/SetReceiptRulePosition>`_
    ...
    def test_render_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/TestRenderTemplate>`_
    ...
    def update_account_sending_enabled(self, Enabled: bool = None) -> None:
        ...
        You can use this operation in conjunction with Amazon CloudWatch alarms to temporarily pause email
        sending across your Amazon SES account in a given AWS Region when reputation metrics (such as your
        bounce or complaint rates) reach certain thresholds.

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateAccountSendingEnabled>`_
    ...
    def update_configuration_set_event_destination(
        ...
        <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/monitor-sending-activity.html>`__ in the
        *Amazon SES Developer Guide.*
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateConfigurationSetEventDestination>`_
    ...
    def update_configuration_set_reputation_metrics_enabled(
        ...
        These metrics are published to Amazon CloudWatch. By using CloudWatch, you can create alarms when
        bounce or complaint rates exceed certain thresholds.

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateConfigurationSetReputationMetricsEnabled>`_
        ...
        **Request Syntax**
        ...
        :param Enabled: **[REQUIRED]**
          ...
          Describes whether or not Amazon SES will publish reputation metrics for the configuration set,
          such as bounce and complaint rates, to Amazon CloudWatch.
    ...
    def update_configuration_set_sending_enabled(
        ...
        AWS Region. You can use this operation in conjunction with Amazon CloudWatch alarms to temporarily
        pause email sending for a configuration set when the reputation metrics for that configuration set
        (such as your bounce on complaint rate) exceed certain thresholds.

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateConfigurationSetSendingEnabled>`_
    ...
    def update_configuration_set_tracking_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateConfigurationSetTrackingOptions>`_
    ...
    def update_custom_verification_email_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateCustomVerificationEmailTemplate>`_
    ...
    def update_receipt_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateReceiptRule>`_
    ...
    def update_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/UpdateTemplate>`_
    ...
    def verify_domain_dkim(self, Domain: str) -> ClientVerifyDomainDkimResponseTypeDef:
        ...
        .. warning::
          ...
          When you execute the ``VerifyDomainDkim`` operation, the domain that you specify is added to the
          list of identities that are associated with your account. This is true even if you haven't already
          associated the domain with your account by using the ``VerifyDomainIdentity`` operation. However,
          you can't send email from the domain until you either successfully `verify it
          <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/verify-domains.html>`__ or you successfully
          `set up DKIM for it <https://docs.aws.amazon.com/ses/latest/DeveloperGuide/easy-dkim.html>`__ .

        You use the tokens that are generated by this operation to create CNAME records. When Amazon SES
        detects that you've added these records to the DNS configuration for a domain, you can start sending
        email from that domain. You can start sending email even if you haven't added the TXT record
        provided by the VerifyDomainIdentity operation to the DNS configuration for your domain. All email
        that you send from the domain is authenticated using DKIM.
        ...
        * **Value** : *token* .dkim.amazonses.com
        ...
        In the preceding example, replace *token* with one of the tokens that are generated when you execute
        this operation. Replace *example.com* with your domain. Repeat this process for each token that's
        generated by this operation.

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/VerifyDomainDkim>`_
    ...
    def verify_domain_identity(
        ...
        *Amazon SES Developer Guide.*
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/VerifyDomainIdentity>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **VerificationToken** *(string) --*
              ...
              Amazon SES detects the record, the domain's verification status changes to "Success". If
    ...
    def verify_email_address(self, EmailAddress: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/VerifyEmailAddress>`_
    ...
    def verify_email_identity(self, EmailAddress: str) -> Dict:
        """
        Adds an email address to the list of identities for your Amazon SES account in the current AWS
        region and attempts to verify it. As a result of executing this operation, a verification email is
        sent to the specified address.

        You can execute this operation no more than once per second.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/email-2010-12-01/VerifyEmailIdentity>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_configuration_sets` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_custom_verification_email_templates` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_identities` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_receipt_rule_sets` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_templates` operation.
        """
