...
class Client(BaseClient):
    ...
    def create_api_key(
        ...
        Create an  ApiKey resource.
         ...
         `AWS CLI <https://docs.aws.amazon.com/cli/latest/reference/apigateway/create-api-key.html>`__
        ...
        **Request Syntax**
        ...
        :param identitySource:
          ...
          * For the ``REQUEST`` authorizer, this is required when authorization caching is enabled. The
          ...
          parameters. For example, if an ``Auth`` header, a ``Name`` query string parameter are defined as
          ...
          parameters are present, not null and non-empty. Only when this is true does the authorizer invoke
          the authorizer Lambda function, otherwise, it returns a 401 Unauthorized response without calling
          the Lambda function. The valid value is a string of comma-separated mapping expressions of the
    ...
    def create_base_path_mapping(
        ...
        **Request Syntax**
        ...
        :param stage:
          ...
          The name of the API's stage that you want to use for this mapping. Specify '(none)' if you do not
          want callers to explicitly specify the stage name after any base path name.
        ...
        **Request Syntax**
        ...
        :param location: **[REQUIRED]**
          ...
          - **statusCode** *(string) --*
            ...
            , ``RESPONSE_HEADER`` , and ``RESPONSE_BODY`` . The default value is ``*`` for any status code.
            When an applicable child entity inherits the content of an entity of the same type with more
            general specifications of the other ``location`` attributes, the child entity's ``statusCode``
        ...
        :param properties: **[REQUIRED]**
          ...
          [Required] The new documentation content map of the targeted API entity. Enclosed key-value pairs
          are API-specific, but only OpenAPI-compliant key-value pairs can be exported and, hence,
          published.
    ...
    def create_domain_name(
        ...
        **Request Syntax**
        ...
        :param certificateName:
          ...
          The user-friendly name of the certificate that will be used by edge-optimized endpoint for this
          domain name.

        :type certificateBody: string
        :param certificateBody:

          [Deprecated] The body of the server certificate that will be used by edge-optimized endpoint for
        ...
        :param certificateChain:
          ...
          include the root certificate, your certificate chain must start with intermediate certificates and
          end with the root certificate. Use the intermediate certificates that were provided by your
    ...
    def create_model(
        ...
        **Request Syntax**
        ...
        :param schema:
          ...
          <https://tools.ietf.org/html/draft-zyp-json-schema-04>`__ model.
          ...
          - *(dict) --*
            ...
            - **resourceMethods** *(dict) --*
              ...
              /restapis/{restapi_id}/resources/{resource_id}?embed=methods`` request.
               ...
               SignedHeaders=content-type;host;x-amz-date, Signature={sig4_hash}``  Response ``{ "_links": {
               "curies": [ { "href":
    ...
    def create_rest_api(
        ...
        **Request Syntax**
        ...
        :type policy: string
        :param policy: A stringified JSON policy document that applies to this RestApi regardless of the
    ...
    def create_stage(
        ...
        **Request Syntax**
        ...
        :param stageName: **[REQUIRED]**
          ...
          [Required] The name for the  Stage resource. Stage names can only contain alphanumeric characters,
    ...
    def create_vpc_link(
        ...
        **Request Syntax**
        ...
        :param targetArns: **[REQUIRED]**
          ...
          [Required] The ARNs of network load balancers of the VPC targeted by the VPC link. The network
        ...
        ::
          ...
          response = client.delete_gateway_response(
              ...
              responseType=
                  ...
                  |'ACCESS_DENIED'|'AUTHORIZER_FAILURE'|'AUTHORIZER_CONFIGURATION_ERROR'|'INVALID_SIGNATURE'
                  |'EXPIRED_TOKEN'|'MISSING_AUTHENTICATION_TOKEN'|'INTEGRATION_FAILURE'
                  |'INTEGRATION_TIMEOUT'|'API_CONFIGURATION_ERROR'|'UNSUPPORTED_MEDIA_TYPE'
                  |'BAD_REQUEST_PARAMETERS'|'BAD_REQUEST_BODY'|'REQUEST_TOO_LARGE'|'THROTTLED'
                  |'QUOTA_EXCEEDED'
          )
        :type restApiId: string
        :param restApiId: **[REQUIRED]**
    ...
    def get_authorizer(
        ...
        Describe an existing  Authorizer resource.
         ...
         `AWS CLI <https://docs.aws.amazon.com/cli/latest/reference/apigateway/get-authorizer.html>`__
    ...
    def get_base_path_mapping(
        ...
        **Request Syntax**
        ...
        :param basePath: **[REQUIRED]**
          ...
          [Required] The base path name that callers of the API must provide as part of the URL after the
          domain name. This value must be unique for all of the mappings across a single API. Specify
          '(none)' if you do not want callers to specify any base path name after the domain name.
    ...
    def get_deployment(
        ...
        **Request Syntax**
        ...
        :param embed:
          ...
          single-valued list containing only the ``"apisummary"`` string. For example, ``GET
    ...
    def get_export(
        ...
        **Request Syntax**
        ...
        :param parameters:
          ...
          requested ``exportType`` . For ``exportType``  ``oas30`` and ``swagger`` , any combination of the
        ...
        :param accepts:
          ...
          and ``application/yaml`` are supported for ``exportType`` of``oas30`` and ``swagger`` . This
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'DEFAULT_4XX'|'DEFAULT_5XX'|'RESOURCE_NOT_FOUND'|'UNAUTHORIZED'|'INVALID_API_KEY'
                |'ACCESS_DENIED'|'AUTHORIZER_FAILURE'|'AUTHORIZER_CONFIGURATION_ERROR'|'INVALID_SIGNATURE'
                |'EXPIRED_TOKEN'|'MISSING_AUTHENTICATION_TOKEN'|'INTEGRATION_FAILURE'|'INTEGRATION_TIMEOUT'
    ...
    def get_gateway_responses(
        ...
        **Request Syntax**
        ...
        :param limit:
          ...
          The maximum number of returned results per page. The default value is 25 and the maximum value is
          500. The  GatewayResponses collection does not support pagination and the limit does not apply
          here.
            ...
            - **methodIntegration** *(dict) --*
              ...
              - **uri** *(string) --*
                ...
                * For ``AWS`` or ``AWS_PROXY`` integrations, the URI is of the form
                ...
                for an AWS service action-based API, using an ``Action={name}&{p1}={v1}&p2={v2}...`` query
                      ...
                      - **methodIntegration** *(dict) --*
                        ...
                        - **uri** *(string) --*
                          ...
                          * For ``AWS`` or ``AWS_PROXY`` integrations, the URI is of the form
                          ...
                          |action/{service_api}`` . Here, ``{Region}`` is the API Gateway region (e.g.,
                          ``us-east-1`` ); ``{service}`` is the name of the integrated AWS service (e.g.,
                          ``s3`` ); and ``{subdomain}`` is a designated subdomain supported by certain AWS
                          service for fast host-name lookup. ``action`` can be used for an AWS service
                          action-based API, using an ``Action={name}&{p1}={v1}&p2={v2}...`` query string.
                          The ensuing ``{service_api}`` refers to a supported action ``{name}`` plus any
                          required input parameters. Alternatively, ``path`` can be used for an AWS service
                          path-based API. The ensuing ``service_api`` refers to the path to an AWS service
                          resource, including the region of the integrated AWS service, if applicable. For
    ...
    def get_sdk(
        ...
        **Request Syntax**
        ...
        :param sdkType: **[REQUIRED]**
          ...
          [Required] The language for the generated SDK. Currently ``java`` , ``javascript`` , ``android`` ,
        ...
        :param parameters:
          ...
          For ``sdkType`` of ``objectivec`` or ``swift`` , a parameter named ``classPrefix`` is required.
          For ``sdkType`` of ``android`` , parameters named ``groupId`` , ``artifactId`` ,
          ``artifactVersion`` , and ``invokerPackage`` are required. For ``sdkType`` of ``java`` ,
          parameters named ``serviceName`` and ``javaPackageName`` are required.
    ...
    def import_api_keys(
        ...
        **Request Syntax**
        ...
        :param body: **[REQUIRED]**
          ...
          Format <https://docs.aws.amazon.com/apigateway/latest/developerguide/api-key-file-format.html>`__
          .
    ...
    def import_rest_api(
        ...
        **Request Syntax**
        ...
        :param body: **[REQUIRED]**
          ...
          [Required] The POST request body containing external API definitions. Currently, only OpenAPI
          definition JSON/YAML files are supported. The maximum size of the API definition file is 2MB.
        ...
        **Request Syntax**
        ...
        :param uri:
          ...
          * For ``HTTP`` or ``HTTP_PROXY`` integrations, the URI must be a fully formed, encoded HTTP(S) URL
          ...
          <https://en.wikipedia.org/wiki/Uniform_Resource_Identifier>`__ , for either standard integration,
          where ``connectionType`` is not ``VPC_LINK`` , or private integration, where ``connectionType`` is
          ...
          * For ``AWS`` or ``AWS_PROXY`` integrations, the URI is of the form
          ...
          refers to the path to an AWS service resource, including the region of the integrated AWS service,
          if applicable. For example, for integration with the S3 API of ```GetObject
          <https://docs.aws.amazon.com/AmazonS3/latest/API/RESTObjectGET.html>`__`` , the ``uri`` can be
          either ``arn:aws:apigateway:us-west-2:s3:action/GetObject&Bucket={bucket}&Key={key}`` or
          ``arn:aws:apigateway:us-west-2:s3:path/{bucket}/{key}``
        ...
        :param connectionId:
          ...
          The (```id`` <https://docs.aws.amazon.com/apigateway/api-reference/resource/vpc-link/#id>`__ ) of
          the  VpcLink used for the integration when ``connectionType=VPC_LINK`` and undefined, otherwise.
        ...
        :param passthroughBehavior:
          ...
          Integration resource. There are three valid values: ``WHEN_NO_MATCH`` , ``WHEN_NO_TEMPLATES`` ,
          and ``NEVER`` .
    ...
    def put_integration_response(
        ...
        **Request Syntax**
        ...
        :param responseParameters:
          ...
          ``integration.response.body.{JSON-expression}`` , where ``name`` must be a valid and unique
          response header name and ``JSON-expression`` a valid JSON expression without the ``$`` prefix.
    ...
    def put_method(
        ...
        **Request Syntax**
        ...
        :param authorizationType: **[REQUIRED]**
          ...
          [Required] The method's authorization type. Valid values are ``NONE`` for open access, ``AWS_IAM``
        ...
        :param requestParameters:
          ...
          ``method.request.{location}.{name}`` , where ``location`` is ``querystring`` , ``path`` , or
          ``header`` and ``name`` is a valid and unique parameter name. The value associated with the key is
          a Boolean flag indicating whether the parameter is required (``true`` ) or optional (``false`` ).
          The method request parameter names defined here are available in  Integration to be mapped to
        ...
        :param requestModels:
          ...
          Specifies the  Model resources used for the request's content type. Request models are represented
    ...
    def put_method_response(
        ...
        **Request Syntax**
        ...
        :param responseParameters:
          ...
          flag indicating whether the method response parameter is required or not. The method response
          header names must match the pattern of ``method.response.header.{name}`` , where ``name`` is a
    ...
    def tag_resource(self, resourceArn: str, tags: Dict[str, str]) -> None:
        ...
        **Request Syntax**
        ...
        :param tags: **[REQUIRED]**
          ...
          [Required] The key-value map of strings. The valid character set is [a-zA-Z+-=._:/]. The tag key
    ...
    def test_invoke_authorizer(
        ...
        **Request Syntax**
        ...
        :param headers:
          ...
          [Required] A key-value map of headers to simulate an incoming invocation request. This is where
        ...
        :param multiValueHeaders:
          ...
          [Optional] The headers as a map from string to list of values to simulate an incoming invocation
          request. This is where the incoming authorization token, or identity source, may be specified.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_account(
        self, patchOperations: List[Dict] = None
    ) -> ClientUpdateAccountResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_api_key(
        self, apiKey: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateApiKeyResponseTypeDef:
        """
    ...
    def update_authorizer(
        self, restApiId: str, authorizerId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateAuthorizerResponseTypeDef:
        """
    ...
    def update_base_path_mapping(
        self, domainName: str, basePath: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateBasePathMappingResponseTypeDef:
        """
    ...
    def update_client_certificate(
        self, clientCertificateId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateClientCertificateResponseTypeDef:
        """
    ...
    def update_deployment(
        self, restApiId: str, deploymentId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateDeploymentResponseTypeDef:
        """
    ...
    def update_documentation_part(
        ...
        patchOperations: List[Dict] = None,
    ) -> ClientUpdateDocumentationPartResponseTypeDef:
        """
        See also: `AWS API Documentation
    ...
    def update_domain_name(
        self, domainName: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateDomainNameResponseTypeDef:
        """
    ...
    def update_gateway_response(
        self, restApiId: str, responseType: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateGatewayResponseResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_model(
        self, restApiId: str, modelName: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateModelResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_resource(
        self, restApiId: str, resourceId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateResourceResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_rest_api(
        self, restApiId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateRestApiResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_stage(
        self, restApiId: str, stageName: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateStageResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_usage(
        self, usagePlanId: str, keyId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateUsageResponseTypeDef:
        """
        ...
        **Request Syntax**
        ...
        :param keyId: **[REQUIRED]**
          ...
          [Required] The identifier of the API key associated with the usage plan in which a temporary
    ...
    def update_usage_plan(
        self, usagePlanId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateUsagePlanResponseTypeDef:
        """
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_vpc_link(
        self, vpcLinkId: str, patchOperations: List[Dict] = None
    ) -> ClientUpdateVpcLinkResponseTypeDef:
        """
