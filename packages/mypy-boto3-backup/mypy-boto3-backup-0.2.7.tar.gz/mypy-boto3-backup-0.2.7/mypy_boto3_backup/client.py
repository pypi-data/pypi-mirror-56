"Main interface for backup Client"
...
class Client(BaseClient):
    ...
    def create_backup_plan(
        ...
        If you call ``CreateBackupPlan`` with a plan that already exists, the existing ``backupPlanId`` is
        returned.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/CreateBackupPlan>`_
        ...
        **Request Syntax**
        ...
        :param BackupPlanTags:
          ...
          To help organize your resources, you can assign your own metadata to the resources that you
          create. Each tag is a key-value pair. The specified tags are assigned to all backups created with
          this plan.
    ...
    def create_backup_selection(
        ...
        """
        Creates a JSON document that specifies a set of resources to assign to a backup plan. Resources can
        be included by specifying patterns for a ``ListOfTags`` and selected ``Resources`` .
        ...
        * ``ConditionKey:"importance"``    ``ConditionValue:"critical"``    ``ConditionType:"StringEquals"``
        ...
        tagged as ``"department=finance"`` , ``"importance=critical"`` , in addition to an EBS volume with
        the specified volume Id.

        Resources and conditions are additive in that all resources that match the pattern are selected.
        This shouldn't be confused with a logical AND, where all conditions must match. The matching
        patterns are logically 'put together using the OR operator. In other words, all patterns that match
        are selected for backup.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/CreateBackupSelection>`_
        ...
        **Request Syntax**
        ...
        :param BackupSelection: **[REQUIRED]**
          ...
          It includes an array of resources, an optional array of patterns to exclude resources, an optional
          role to provide access to the AWS service the resource belongs to, and an optional array of tags
    ...
    def create_backup_vault(
        ...
        """
        Creates a logical container where backups are stored. A ``CreateBackupVault`` request includes a
        name, optionally one or more resource tags, an encryption key, and a request ID.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/CreateBackupVault>`_
        ...
        **Request Syntax**
        ...
        :param BackupVaultTags:
          ...
          Metadata that you can assign to help organize the resources that you create. Each tag is a
          key-value pair.
    ...
    def delete_backup_plan(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteBackupPlan>`_
    ...
    def delete_backup_selection(self, BackupPlanId: str, SelectionId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteBackupSelection>`_
    ...
    def delete_backup_vault(self, BackupVaultName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteBackupVault>`_
        ...
        **Request Syntax**
        ...
        :param BackupVaultName: **[REQUIRED]**
          ...
          The name of a logical container where backups are stored. Backup vaults are identified by names
          that are unique to the account used to create them and theAWS Region where they are created. They
          consist of lowercase letters, numbers, and hyphens.
    ...
    def delete_backup_vault_access_policy(self, BackupVaultName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteBackupVaultAccessPolicy>`_
    ...
    def delete_backup_vault_notifications(self, BackupVaultName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteBackupVaultNotifications>`_
    ...
    def delete_recovery_point(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DeleteRecoveryPoint>`_
    ...
    def describe_backup_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeBackupJob>`_
    ...
    def describe_backup_vault(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeBackupVault>`_
    ...
    def describe_protected_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeProtectedResource>`_
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends
    ...
    def describe_recovery_point(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeRecoveryPoint>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CompletionDate** *(datetime) --*
              ...
              Coordinated Universal Time (UTC). The value of ``CompletionDate`` is accurate to milliseconds.
              For example, the value 1516925490.087 represents Friday, January 26, 2018 12:11:30.087 AM.
            ...
            - **Lifecycle** *(dict) --*
              ...
              “transition to cold after days” setting. The “transition to cold after days” setting cannot be
              changed after a backup has been transitioned to cold.
    ...
    def describe_restore_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/DescribeRestoreJob>`_
    ...
    def export_backup_plan_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ExportBackupPlanTemplate>`_
    ...
    def get_backup_plan(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetBackupPlan>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **LastExecutionDate** *(datetime) --*
              ...
              accurate to milliseconds. For example, the value 1516925490.087 represents Friday, January 26,
    ...
    def get_backup_plan_from_json(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetBackupPlanFromJSON>`_
    ...
    def get_backup_plan_from_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetBackupPlanFromTemplate>`_
    ...
    def get_backup_selection(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetBackupSelection>`_
    ...
    def get_backup_vault_access_policy(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetBackupVaultAccessPolicy>`_
    ...
    def get_backup_vault_notifications(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetBackupVaultNotifications>`_
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'SNSTopicArn': 'string',
                'BackupVaultEvents': [
                    'BACKUP_JOB_STARTED'|'BACKUP_JOB_COMPLETED'|'RESTORE_JOB_STARTED'
    ...
    def get_recovery_point_restore_metadata(
        ...
        """
        Returns two sets of metadata key-value pairs. The first set lists the metadata that the recovery
        point was created with. The second set lists the metadata key-value pairs that are required to
        restore the recovery point.

        These sets can be the same, or the restore metadata set can contain different values if the target
        service to be restored has changed since the recovery point was created and now requires additional
        or different information in order to be restored.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetRecoveryPointRestoreMetadata>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **RestoreMetadata** *(dict) --*
              ...
              A set of metadata key-value pairs that lists the metadata key-value pairs that are required to
              restore the recovery point.
    ...
    def get_supported_resource_types(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/GetSupportedResourceTypes>`_
    ...
    def list_backup_jobs(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListBackupJobs>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          return ``maxResults`` number of items, ``NextToken`` allows you to return more items in your list
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              The next item following a partial list of returned items. For example, if a request is made to
              return ``maxResults`` number of items, ``NextToken`` allows you to return more items in your
    ...
    def list_backup_plan_templates(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListBackupPlanTemplates>`_
    ...
    def list_backup_plan_versions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListBackupPlanVersions>`_
    ...
    def list_backup_plans(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListBackupPlans>`_
    ...
    def list_backup_selections(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListBackupSelections>`_
    ...
    def list_backup_vaults(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListBackupVaults>`_
    ...
    def list_protected_resources(
        ...
        """
        Returns an array of resources successfully backed up by AWS Backup, including the time the resource
        was saved, an Amazon Resource Name (ARN) of the resource, and a resource type.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListProtectedResources>`_
    ...
    def list_recovery_points_by_backup_vault(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListRecoveryPointsByBackupVault>`_
            ...
            - **RecoveryPoints** *(list) --*
              ...
              - *(dict) --*
                ...
                - **IsEncrypted** *(boolean) --*
                  ...
                  A Boolean value that is returned as ``TRUE`` if the specified recovery point is encrypted,
                  or ``FALSE`` if the recovery point is not encrypted.
    ...
    def list_recovery_points_by_resource(
        ...
        """
        Returns detailed information about recovery points of the type specified by a resource Amazon
        Resource Name (ARN).

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListRecoveryPointsByResource>`_
    ...
    def list_restore_jobs(
        ...
        """
        Returns a list of jobs that AWS Backup initiated to restore a saved resource, including metadata
        about the recovery process.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListRestoreJobs>`_
    ...
    def list_tags(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/ListTags>`_
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          An Amazon Resource Name (ARN) that uniquely identifies a resource. The format of the ARN depends
          on the type of resource. Valid targets for ``ListTags`` are recovery points, backup plans, and
          backup vaults.
    ...
    def put_backup_vault_access_policy(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/PutBackupVaultAccessPolicy>`_
    ...
    def put_backup_vault_notifications(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/PutBackupVaultNotifications>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.put_backup_vault_notifications(
              ...
              SNSTopicArn='string',
              BackupVaultEvents=[
                  'BACKUP_JOB_STARTED'|'BACKUP_JOB_COMPLETED'|'RESTORE_JOB_STARTED'|'RESTORE_JOB_COMPLETED'
    ...
    def start_backup_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/StartBackupJob>`_
        ...
        **Request Syntax**
        ...
        :param IdempotencyToken:
          ...
          Idempotency tokens time out after one hour. Therefore, if you call ``StartBackupJob`` multiple
          times with the same idempotency token within one hour, AWS Backup recognizes that you are
          requesting only one backup job and initiates only one. If you change the idempotency token for
          each call, AWS Backup recognizes that you are requesting to start multiple backups.
    ...
    def start_restore_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/StartRestoreJob>`_
        ...
        **Request Syntax**
        ...
        :param IamRoleArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the IAM role that AWS Backup uses to create the target recovery
        ...
        :param IdempotencyToken:
          ...
          Idempotency tokens time out after one hour. Therefore, if you call ``StartRestoreJob`` multiple
          times with the same idempotency token within one hour, AWS Backup recognizes that you are
          requesting only one restore job and initiates only one. If you change the idempotency token for
          each call, AWS Backup recognizes that you are requesting to start multiple restores.
    ...
    def stop_backup_job(self, BackupJobId: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/StopBackupJob>`_
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/TagResource>`_
    ...
    def update_backup_plan(
        ...
        """
        Replaces the body of a saved backup plan identified by its ``backupPlanId`` with the input document
        in JSON format. The new version is uniquely identified by a ``VersionId`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/UpdateBackupPlan>`_
    ...
    def update_recovery_point_lifecycle(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/backup-2018-11-15/UpdateRecoveryPointLifecycle>`_
