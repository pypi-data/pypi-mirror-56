...
_ClientCreateBudgetBudgetCalculatedSpendActualSpendTypeDef = TypedDict(
    "_ClientCreateBudgetBudgetCalculatedSpendActualSpendTypeDef", {"Amount": str, "Unit": str}
)
...
_ClientCreateBudgetBudgetCalculatedSpendForecastedSpendTypeDef = TypedDict(
    "_ClientCreateBudgetBudgetCalculatedSpendForecastedSpendTypeDef", {"Amount": str, "Unit": str}
)
...
class ClientCreateBudgetBudgetTimePeriodTypeDef(_ClientCreateBudgetBudgetTimePeriodTypeDef):
    ...
    start date must come before the end date. The end date must come before ``06/15/87 00:00 UTC`` .
...
class ClientCreateBudgetBudgetTypeDef(
    ...
    - **TimePeriod** *(dict) --*
      ...
      - **Start** *(datetime) --*
        ...
        set a start date, AWS set your start date to ``01/24/18 00:00 UTC`` . If you chose
        ``MONTHLY`` , AWS set your start date to ``01/01/18 00:00 UTC`` . The defaults are the same
...
_ClientCreateNotificationSubscribersTypeDef = TypedDict(
    "_ClientCreateNotificationSubscribersTypeDef", {"SubscriptionType": str, "Address": str}
)


class ClientCreateNotificationSubscribersTypeDef(_ClientCreateNotificationSubscribersTypeDef):
    """
...
_ClientCreateSubscriberSubscriberTypeDef = TypedDict(
    "_ClientCreateSubscriberSubscriberTypeDef", {"SubscriptionType": str, "Address": str}
)
...
_ClientDeleteSubscriberSubscriberTypeDef = TypedDict(
    "_ClientDeleteSubscriberSubscriberTypeDef", {"SubscriptionType": str, "Address": str}
)
...
class ClientDescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistoryBudgetedAndActualAmountsListActualAmountTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistoryBudgetedAndActualAmountsList`
    `ActualAmount`
...
class ClientDescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistoryBudgetedAndActualAmountsListTypeDef(
    ...
    """
    Type definition for `ClientDescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistory`
...
class ClientDescribeBudgetPerformanceHistoryResponseBudgetPerformanceHistoryTypeDef(
    ...
    - **BudgetedAndActualAmountsList** *(list) --*
      ...
      A list of amounts of cost or usage that you created budgets for, compared to your actual costs
      or usage.

      - *(dict) --*

        The amount of cost or usage that you created the budget for, compared to your actual costs
        or usage.
    ...
    - **Budget** *(dict) --*
      ...
      - **BudgetLimit** *(dict) --*
        ...
        Savings Plans coverage that you want to track with your budget.
         ...
         ``BudgetLimit`` is required for cost or usage budgets, but optional for RI or Savings Plans
         utilization or coverage budgets. RI and Savings Plans utilization or coverage budgets
         default to ``100`` , which is the only valid value for RI or Savings Plans utilization or
         coverage budgets. You can't use ``BudgetLimit`` with ``PlannedBudgetLimits`` for
      ...
      - **PlannedBudgetLimits** *(dict) --*
        ...
        provides the same experience as a fixed budget.
         ...
         also contain ``BudgetLimit`` representing the current month or quarter limit present in
         ``PlannedBudgetLimits`` . This only applies to budgets created with ``PlannedBudgetLimits``
         . Budgets created without ``PlannedBudgetLimits`` will only contain ``BudgetLimit`` , and
      ...
      - **TimePeriod** *(dict) --*
        ...
        your budget on January 24, 2018, chose ``DAILY`` , and didn't set a start date, AWS set your
        start date to ``01/24/18 00:00 UTC`` . If you chose ``MONTHLY`` , AWS set your start date to
        ``01/01/18 00:00 UTC`` . If you didn't specify an end date, AWS set your end date to
        ``06/15/87 00:00 UTC`` . The defaults are the same for the AWS Billing and Cost Management
        console and the API.
...
_ClientUpdateBudgetNewBudgetCalculatedSpendActualSpendTypeDef = TypedDict(
    "_ClientUpdateBudgetNewBudgetCalculatedSpendActualSpendTypeDef", {"Amount": str, "Unit": str}
)
...
_ClientUpdateBudgetNewBudgetPlannedBudgetLimitsTypeDef = TypedDict(
    "_ClientUpdateBudgetNewBudgetPlannedBudgetLimitsTypeDef", {"Amount": str, "Unit": str}
)
...
_ClientUpdateSubscriberNewSubscriberTypeDef = TypedDict(
    "_ClientUpdateSubscriberNewSubscriberTypeDef", {"SubscriptionType": str, "Address": str}
)


class ClientUpdateSubscriberNewSubscriberTypeDef(_ClientUpdateSubscriberNewSubscriberTypeDef):
    """
...
_ClientUpdateSubscriberOldSubscriberTypeDef = TypedDict(
    "_ClientUpdateSubscriberOldSubscriberTypeDef", {"SubscriptionType": str, "Address": str}
)


class ClientUpdateSubscriberOldSubscriberTypeDef(_ClientUpdateSubscriberOldSubscriberTypeDef):
    """
