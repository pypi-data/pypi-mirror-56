...
class Client(BaseClient):
        ...
        **Request Syntax**
        ...
        :param Budget: **[REQUIRED]**
          ...
          - **PlannedBudgetLimits** *(dict) --*
            ...
            start from the current month and include the next 11 months. The ``key`` is the start of
            the month, ``UTC`` in epoch seconds.
        ...
        :param NotificationsWithSubscribers:
          ...
          - *(dict) --*
            ...
            A notification with subscribers. A notification can have one SNS subscriber and up to 10
            ...
            - **Notification** *(dict) --* **[REQUIRED]**
              ...
              - **ThresholdType** *(string) --*
                ...
                forecasted to go over a certain percentage of your forecasted spend. For example, if
                you have a budget for 200 dollars and you have a ``PERCENTAGE`` threshold of 80%,
        ...
        **Request Syntax**
        ...
        :param Notification: **[REQUIRED]**
          ...
          - **ThresholdType** *(string) --*
            ...
            The type of threshold for a notification. For ``ABSOLUTE_VALUE`` thresholds, AWS
            notifies you when you go over or are forecasted to go over your total cost threshold.
            For ``PERCENTAGE`` thresholds, AWS notifies you when you go over or are forecasted to go
            over a certain percentage of your forecasted spend. For example, if you have a budget
            for 200 dollars and you have a ``PERCENTAGE`` threshold of 80%, AWS notifies you when
            ...
            - **Budget** *(dict) --*
              ...
              - **BudgetLimit** *(dict) --*
                ...
                utilization, or Savings Plans coverage that you want to track with your budget.
                 ...
                 coverage budgets default to ``100`` , which is the only valid value for RI or
              ...
              - **PlannedBudgetLimits** *(dict) --*
                ...
                budget continues to use the last limit as the ``BudgetLimit`` . At that point, the
                planned budget provides the same experience as a fixed budget.
                 ...
                 month or quarter limit present in ``PlannedBudgetLimits`` . This only applies to
                 budgets created with ``PlannedBudgetLimits`` . Budgets created without
                 ``PlannedBudgetLimits`` will only contain ``BudgetLimit`` , and no
                 ``PlannedBudgetLimits`` .
              ...
              - **TimeUnit** *(string) --*
                ...
                is available only for ``RI_UTILIZATION`` , ``RI_COVERAGE`` ,
                ``Savings_Plans_Utilization`` , and ``Savings_Plans_Coverage`` budgets.

              - **TimePeriod** *(dict) --*

                The period of time that is covered by a budget. The period has a start date and an
                end date. The start date must come before the end date. The end date must come
                before ``06/15/87 00:00 UTC`` .

                If you create your budget and don't specify a start date, AWS defaults to the start
                of your chosen time period (DAILY, MONTHLY, QUARTERLY, or ANNUALLY). For example, if
                you created your budget on January 24, 2018, chose ``DAILY`` , and didn't set a
                start date, AWS set your start date to ``01/24/18 00:00 UTC`` . If you chose
                ``MONTHLY`` , AWS set your start date to ``01/01/18 00:00 UTC`` . If you didn't
                specify an end date, AWS set your end date to ``06/15/87 00:00 UTC`` . The defaults
                are the same for the AWS Billing and Cost Management console and the API.
                ...
                - **Start** *(datetime) --*
                  ...
                  QUARTERLY, or ANNUALLY). For example, if you created your budget on January 24,
        ...
        **Request Syntax**
        ...
        :param TimePeriod:
          ...
          - **Start** *(datetime) --*
            ...
            , and didn't set a start date, AWS set your start date to ``01/24/18 00:00 UTC`` . If
            you chose ``MONTHLY`` , AWS set your start date to ``01/01/18 00:00 UTC`` . The defaults
            are the same for the AWS Billing and Cost Management console and the API.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **BudgetPerformanceHistory** *(dict) --*
              ...
              For ``DAILY`` budgets, the history saves the state of the budget for the last 60 days.
              For ``MONTHLY`` budgets, the history saves the state of the budget for the current
              month plus the last 12 months. For ``QUARTERLY`` budgets, the history saves the state
              of the budget for the last four quarters.
                ...
                - *(dict) --*
                  ...
                  - **TimePeriod** *(dict) --*
                    ...
                    - **Start** *(datetime) --*
                      ...
                      January 24, 2018, chose ``DAILY`` , and didn't set a start date, AWS set your
                      start date to ``01/24/18 00:00 UTC`` . If you chose ``MONTHLY`` , AWS set your
                      start date to ``01/01/18 00:00 UTC`` . The defaults are the same for the AWS
    ...
    def describe_budgets(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          An optional integer that represents how many entries a paginated response contains. The
          maximum is 100.
            ...
            - **Budgets** *(list) --*
              ...
              - *(dict) --*
                ...
                - **PlannedBudgetLimits** *(dict) --*
                  ...
                  must start from the current month and include the next 11 months. The ``key`` is
                  the start of the month, ``UTC`` in epoch seconds.

                  For quarterly budgets, provide 4 quarters of ``PlannedBudgetLimits`` value entries
                  in standard calendar quarter increments. This must start from the current quarter
                  and include the next 3 quarters. The ``key`` is the start of the quarter, ``UTC``
                  in epoch seconds.
                  ...
                  planned budget provides the same experience as a fixed budget.
                   ...
                   applies to budgets created with ``PlannedBudgetLimits`` . Budgets created without
                   ``PlannedBudgetLimits`` will only contain ``BudgetLimit`` , and no
                   ``PlannedBudgetLimits`` .
                ...
                - **TimeUnit** *(string) --*
                  ...
                  ``DAILY`` is available only for ``RI_UTILIZATION`` , ``RI_COVERAGE`` ,
                  ``Savings_Plans_Utilization`` , and ``Savings_Plans_Coverage`` budgets.
                ...
                - **TimePeriod** *(dict) --*
                  ...
                  If you create your budget and don't specify a start date, AWS defaults to the
                  ...
                  didn't set a start date, AWS set your start date to ``01/24/18 00:00 UTC`` . If
                  you chose ``MONTHLY`` , AWS set your start date to ``01/01/18 00:00 UTC`` . If you
                  didn't specify an end date, AWS set your end date to ``06/15/87 00:00 UTC`` . The
              ...
              - *(dict) --*
                ...
                * A notification ``threshold`` of ``80``
                ...
                - **ThresholdType** *(string) --*
                  ...
                  notifies you when you go over or are forecasted to go over your total cost
                  threshold. For ``PERCENTAGE`` thresholds, AWS notifies you when you go over or are
                  forecasted to go over a certain percentage of your forecasted spend. For example,
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_budget(self, AccountId: str, NewBudget: ClientUpdateBudgetNewBudgetTypeDef) -> Dict:
        """
        Updates a budget. You can change every part of a budget except for the ``budgetName`` and
        the ``calculatedSpend`` . When you modify a budget, the ``calculatedSpend`` drops to zero
