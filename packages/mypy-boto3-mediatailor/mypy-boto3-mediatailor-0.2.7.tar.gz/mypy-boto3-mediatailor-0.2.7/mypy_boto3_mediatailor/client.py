"Main interface for mediatailor Client"
...
class Client(BaseClient):
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AdDecisionServerUrl** *(string) --*
              ...
              The URL for the ad decision server (ADS). This includes the specification of static parameters
              and placeholders for dynamic parameters. AWS Elemental MediaTailor substitutes player-specific
              and session-specific parameters as needed when calling the ADS. Alternately, for testing, you
            ...
            - **CdnConfiguration** *(dict) --*
              ...
              - **AdSegmentUrlPrefix** *(string) --*
                ...
                MediaTailor uses Amazon CloudFront with default cache settings as its CDN for ad segments.
                To set up an alternate CDN, create a rule in your CDN for the following origin:
            ...
            - **DashConfiguration** *(dict) --*
              ...
              - **MpdLocation** *(string) --*
                ...
                by players that don't support sticky redirects. Disable this if you have CDN routing rules
                set up for accessing MediaTailor manifests, and you are either using client-side reporting
                or your players support sticky HTTP redirects. Valid values are DISABLED and EMT_DEFAULT.
                The EMT_DEFAULT setting enables the inclusion of the tag and is the default value.
              ...
              - **OriginManifestType** *(string) --*
                ...
                single-period manifests, set this to SINGLE_PERIOD. The default setting is MULTI_PERIOD. For
            ...
            - **SlateAdUrl** *(string) --*
              ...
              The URL for a high-quality video asset to transcode and use to fill in time that's not used by
              ads. AWS Elemental MediaTailor shows the slate to fill in gaps in media content. Configuring
              the slate is optional for non-VPAID playback configurations. For VPAID, the slate is required
    ...
    def list_playback_configurations(
        ...
        """
        Returns a list of the playback configurations defined in AWS Elemental MediaTailor. You can specify
        a maximum number of configurations to return at a time. The default maximum is 50. Results are
        returned in pagefuls. If MediaTailor has more configurations than the specified maximum, it provides
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              Pagination token returned by the GET list request when results exceed the maximum allowed. Use
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) for the playback configuration. You can get this from the response
          to any playback configuration request.
        ...
        **Request Syntax**
        ...
        :param CdnConfiguration:
          ...
          - **ContentSegmentUrlPrefix** *(string) --*
            ...
            A content delivery network (CDN) to cache content segments, so that content requests don’t
            always have to go to the origin server. First, create a rule in your CDN for the content segment
            origin server. Then specify the rule's name in this ContentSegmentUrlPrefix. When AWS Elemental
        ...
        :param SlateAdUrl:
          ...
          MediaTailor provides it in the slots that are designated for dynamic ad content. The slate must be
          a high-quality asset that contains both audio and video.
        ...
        :param VideoContentSourceUrl:
          ...
          The URL prefix for the master playlist for the stream, minus the asset ID. The maximum length is
          512 characters.
