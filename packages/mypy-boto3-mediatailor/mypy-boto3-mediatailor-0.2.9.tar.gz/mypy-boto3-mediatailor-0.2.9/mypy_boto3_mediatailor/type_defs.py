...
class ClientGetPlaybackConfigurationResponseCdnConfigurationTypeDef(
    ...
    - **ContentSegmentUrlPrefix** *(string) --*
      ...
      Elemental MediaTailor serves a manifest, it reports your CDN as the source for content
      segments.
    """
...
class ClientGetPlaybackConfigurationResponseLivePreRollConfigurationTypeDef(
    ...
    """
    Type definition for `ClientGetPlaybackConfigurationResponse` `LivePreRollConfiguration`
    ...
    - **MaxDurationSeconds** *(integer) --* The maximum allowed duration for the pre-roll ad avail.
...
class ClientGetPlaybackConfigurationResponseTypeDef(_ClientGetPlaybackConfigurationResponseTypeDef):
    ...
    - **LivePreRollConfiguration** *(dict) --*
      ...
      avail. AWS Elemental MediaTailor won't play pre-roll ads to exceed this duration, regardless
...
class ClientPutPlaybackConfigurationLivePreRollConfigurationTypeDef(
    ...
    """
    Type definition for `ClientPutPlaybackConfiguration` `LivePreRollConfiguration`
...
class ClientPutPlaybackConfigurationResponseLivePreRollConfigurationTypeDef(
    ...
    """
    Type definition for `ClientPutPlaybackConfigurationResponse` `LivePreRollConfiguration`
