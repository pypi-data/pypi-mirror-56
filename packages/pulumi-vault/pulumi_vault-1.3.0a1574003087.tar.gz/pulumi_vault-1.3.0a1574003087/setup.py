...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.3.0-alpha.1574003087+ga1b41a9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.3.0-alpha.1574003087+ga1b41a9`
                """)
            else:
                raise
