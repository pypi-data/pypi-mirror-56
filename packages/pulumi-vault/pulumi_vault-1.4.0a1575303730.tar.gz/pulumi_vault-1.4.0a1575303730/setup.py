...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'vault', 'v1.4.0-alpha.1575303730+gda21ab4'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource vault v1.4.0-alpha.1575303730+gda21ab4`
                """)
            else:
                raise
