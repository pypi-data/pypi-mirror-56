...
# pip install twine wheel sphinx sphinx-pypi-upload reconnmark
# python setup.py sdist bdist_wheel build_sphinx upload_sphinx
...
setup(
    ...
    platform='any',
    description='Decoripy helps you making better decorators.',
