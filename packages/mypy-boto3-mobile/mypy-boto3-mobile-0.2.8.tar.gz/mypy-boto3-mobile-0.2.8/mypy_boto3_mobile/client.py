    ...
    def create_project(
        ...
        **Request Syntax**
        ...
        :param contents:
          ...
          project. This may be the contents of the file downloaded from the URL provided in an
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Result structure which contains link to download custom-generated SDK and tool packages
            used to integrate mobile web or app clients with backed AWS resources.

            - **downloadUrl** *(string) --*

              URL which contains the custom-generated SDK and tool packages used to integrate the
              client mobile app or web app with the AWS resources created by the AWS Mobile Hub
              project.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **shareUrl** *(string) --*
              ...
              Mobile Hub with the same configuration as the specified project. This URL pertains to
              a snapshot in time of the project configuration that is created when this API is
    ...
    def list_bundles(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Pagination token. Set to null to start listing bundles from start. If non-null pagination
    ...
    def list_projects(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Pagination token. Set to null to start listing projects from start. If non-null pagination
          token is returned in a result, then pass its value in here in another request to list more
          projects.
    ...
    def update_project(
        ...
        **Request Syntax**
        ...
        :param contents:
          ...
          ZIP or YAML file which contains project configuration to be updated. This should be the
