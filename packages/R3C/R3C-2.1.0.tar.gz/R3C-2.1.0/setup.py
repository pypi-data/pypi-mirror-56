...
setup(
    ...
    description='R3C: The Blockchain of confidential data & things.',
    long_description=(
        "R3C integrates deep addresses, high throughput, inter DLT connectivity, and advanced verifiable smart contracts/protocols."
        ),
    url='https://github.com/BigchainDB/bigchaindb/',
    author='RIDDLE&CODE GmbH',
    author_email='support@riddleancode.com',
