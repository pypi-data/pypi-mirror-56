    ...
    try:
        ...
        try:
            ...
            if r.status_code == 200:
                ...
                if master_mac[option - 1] != 'Not Provided' and master_mac[option - 1] != host_mac.upper() and master[0].lower() != 'n':
                    ...
                    if master_mac[option - 1] == 'Not Provided' and master[0].lower() == 'n':
                        print("\n\r\n\r\n\r ********* Please first run espapp on master computer ********** "
                              "\n\r\n\r\n\r")
                        return 0
                    if master_mac[option - 1] != 'Not Provided':
                        print("* Mac address of master computer for router '{0}': {1}".format(ssid_list['SSID'][option - 1][0], master_mac[option - 1]))
