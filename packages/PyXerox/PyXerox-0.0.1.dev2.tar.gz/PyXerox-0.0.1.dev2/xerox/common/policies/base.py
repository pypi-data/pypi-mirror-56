...
# ``xerox.conf [oslo_policy] enforce_scope = False``, which the default.
...
# traditionally reserved for system administrators. Once xerox defaults
# ``xerox.conf [oslo_policy] enforce_scope=True``, the ``system_scope:all``
