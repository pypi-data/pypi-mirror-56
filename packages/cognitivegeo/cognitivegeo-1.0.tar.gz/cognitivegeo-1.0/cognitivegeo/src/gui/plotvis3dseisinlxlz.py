...
class plotvis3dseisinlxlz(object):
    ...
    def clickBtnPlotSlice(self):
        ...
        if len(_attriblist) < 1:
            print("PlotVis3DSeisInlXlZ: No property selected for plot")
        ...
        if _min is False or _max is False:
            print("PlotVis3DSeisInlXlZ: Non-float range specified for plot")
            QtWidgets.QMessageBox.critical(self.msgbox,
                                           '3D Window: Seismic',
        ...
        if _zsls is False or _zscale <= 0.0:
            print("PlotVis3DSeisInlXlZ: z-scale > 0.0 required")
            QtWidgets.QMessageBox.critical(self.msgbox,
                                           '3D Window: Seismic',
