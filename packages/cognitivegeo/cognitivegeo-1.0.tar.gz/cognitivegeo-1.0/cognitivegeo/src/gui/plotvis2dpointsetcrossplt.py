...
class plotvis2dpointsetcrossplt(object):
    ...
    def clickBtnPlot(self):
        ...
        if _npoint < 1:
            print("PlotVis2DPointSetCrossplt: No pointset selected")
        ...
        if _xmin is False or _xmax is False or _ymin is False or _ymax is False:
            print("PlotVis2DPointSetCrossplt: Non-float range specified for plot")
            QtWidgets.QMessageBox.critical(self.msgbox,
                                           '2D Window: PointSet Cross-plot',
        ...
        for _item in self.twgpoint.selectedItems():
            ...
            if _xfeature not in self.pointdata[_name].keys():
                print("PlotVis2DPointSetCrossplt: X-feature not found in " + _name)
                QtWidgets.QMessageBox.critical(self.msgbox,
                                               '2-D Cross-plot',
                                               'X-feature not found in ' + _name)
                return
            if _yfeature not in self.pointdata[_name].keys():
                print("PlotVis2DPointSetCrossplt: Y-feature not found in " + _name)
                QtWidgets.QMessageBox.critical(self.msgbox,
                                               '2-D Cross-plot',
