...
class about(object):
    ...
    def setupGUI(self, About):
        ...
        self.lblqr.setGeometry(QtCore.QRect(360, 140, 50, 50))
        #
    ...
    def retranslateGUI(self, About):
        ...
        self.lbllink.setText(_translate("About", '<a href="https://geopyteam.wixsite.com/cognitivegeo">Cognitive Geo</a>'))
