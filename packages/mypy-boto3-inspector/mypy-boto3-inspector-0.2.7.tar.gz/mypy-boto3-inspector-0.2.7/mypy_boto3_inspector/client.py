...
class Client(BaseClient):
          ...
          ::

            {
                'failedItems': {
                    'string': {
                        'failureCode':
                        'INVALID_ARN'|'DUPLICATE_ARN'|'ITEM_DOES_NOT_EXIST'|'ACCESS_DENIED'|'LIMIT_EXCEEDED'
                        |'INTERNAL_ERROR',
    ...
    def create_assessment_target(
        ...
        account and region are included in the assessment target. If the `service-linked role
    ...
    def create_assessment_template(
        ...
        **Request Syntax**
        ...
        :param userAttributesForFindings:
          ...
          run that uses this assessment template. An attribute is a key and value pair (an  Attribute
                ...
                'assessmentRuns': [
                    {
                        ...
                        |'START_EVALUATING_RULES_PENDING'|'EVALUATING_RULES'|'FAILED'|'ERROR'|'COMPLETED'
                        ...
                        'notifications': [
                            {
                                ...
                                'event':
                                'ASSESSMENT_RUN_STARTED'|'ASSESSMENT_RUN_COMPLETED'
                                |'ASSESSMENT_RUN_STATE_CHANGED'|'FINDING_REPORTED'|'OTHER',
                                'message': 'string',
                                'error': True|False,
                                'snsTopicArn': 'string',
            ...
            - **assessmentRuns** *(list) --*
              ...
              - *(dict) --*
                ...
                - **dataCollected** *(boolean) --*
                  ...
                  A Boolean value (true or false) that specifies whether the process of collecting data from
    ...
    def get_assessment_report(
        ...
        **Request Syntax**
        ...
        :param reportType: **[REQUIRED]**
          ...
          Reports <https://docs.aws.amazon.com/inspector/latest/userguide/inspector_reports.html>`__ .
    ...
    def get_exclusions_preview(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          your first call to the GetExclusionsPreviewRequest action. Subsequent calls to the action fill
    ...
    def list_assessment_run_agents(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListAssessmentRunAgents** action. Subsequent calls to the action fill
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              When a response is generated, if there is more data to be listed, this parameter is present in
        ...
        **Request Syntax**
        ...
        :param filter:
          ...
          - **namePattern** *(string) --*
            ...
            specified for this data type property must match the value of the **assessmentRunName** property
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListAssessmentRuns** action. Subsequent calls to the action fill
          **nextToken** in the request with the value of **NextToken** from the previous response to
          continue listing data.
    ...
    def list_assessment_targets(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListAssessmentTargets** action. Subsequent calls to the action fill
          **nextToken** in the request with the value of **NextToken** from the previous response to
          continue listing data.
        ...
        **Request Syntax**
        ...
        :param filter:
          ...
          - **durationRange** *(dict) --*
            ...
            match any value between the specified minimum and maximum values of the **durationInSeconds**
            property of the  AssessmentTemplate data type.
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListAssessmentTemplates** action. Subsequent calls to the action fill
          **nextToken** in the request with the value of **NextToken** from the previous response to
          continue listing data.
    ...
    def list_event_subscriptions(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListEventSubscriptions** action. Subsequent calls to the action fill
          **nextToken** in the request with the value of **NextToken** from the previous response to
          continue listing data.
    ...
    def list_exclusions(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the ListExclusionsRequest action. Subsequent calls to the action fill nextToken
    ...
    def list_findings(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListFindings** action. Subsequent calls to the action fill **nextToken**
    ...
    def list_rules_packages(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **ListRulesPackages** action. Subsequent calls to the action fill
          **nextToken** in the request with the value of **NextToken** from the previous response to
          continue listing data.
    ...
    def preview_agents(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to null on
          your first call to the **PreviewAgents** action. Subsequent calls to the action fill **nextToken**
          in the request with the value of **NextToken** from the previous response to continue listing
          data.
            ...
            - **agentPreviews** *(list) --*
              ...
              - *(dict) --*
                ...
                - **kernelVersion** *(string) --*
                  ...
                  The kernel version of the operating system running on the EC2 instance on which the Amazon
    ...
    def stop_assessment_run(
        ...
        **Request Syntax**
        ...
        :param stopAction:
          ...
          (the default value), stops the AWS agent from collecting data and begins the results evaluation
          and the findings generation process. SKIP_EVALUATION cancels the assessment run immediately, after
          which no findings are generated.
    ...
    def update_assessment_target(
        ...
        If resourceGroupArn is not specified, all EC2 instances in the current AWS account and region are
        included in the assessment target.
