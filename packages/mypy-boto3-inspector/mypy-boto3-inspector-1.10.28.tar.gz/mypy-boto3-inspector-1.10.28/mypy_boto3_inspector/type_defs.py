...
class ClientDescribeAssessmentRunsResponseassessmentRunsuserAttributesForFindingsTypeDef(
    ...
    """
    Type definition for `ClientDescribeAssessmentRunsResponseassessmentRuns`
...
class ClientDescribeAssessmentTemplatesResponseassessmentTemplatesuserAttributesForFindingsTypeDef(
    ...
    """
    Type definition for `ClientDescribeAssessmentTemplatesResponseassessmentTemplates`
    `userAttributesForFindings`
...
class ClientDescribeAssessmentTemplatesResponseassessmentTemplatesTypeDef(
    ...
    - **userAttributesForFindings** *(list) --*
      ...
      The user-defined attributes that are assigned to every generated finding from the assessment
      run that uses this assessment template.
    ...
    - **lastAssessmentRunArn** *(string) --*
      ...
      assessment template. This value exists only when the value of assessmentRunCount is greaterpa
      than zero.

    - **assessmentRunCount** *(integer) --*

      The number of existing assessment runs associated with this assessment template. This value
...
class ClientDescribeFindingsResponsefindingsassetAttributesnetworkInterfacesprivateIpAddressesTypeDef(
    ...
    """
    Type definition for `ClientDescribeFindingsResponsefindingsassetAttributesnetworkInterfaces`
    `privateIpAddresses`
...
class ClientDescribeFindingsResponsefindingsassetAttributesnetworkInterfacesTypeDef(
    ...
    - **privateIpAddresses** *(list) --*
      ...
      - *(dict) --*
        ...
        data type is used as a response element in the  DescribeFindings action.
    ...
    - **securityGroups** *(list) --*
      ...
      - *(dict) --*
        ...
        Contains information about a security group associated with a network interface. This data
        type is used as one of the elements of the  NetworkInterface data type.
...
class ClientDescribeFindingsResponsefindingsassetAttributesTypeDef(
    ...
    - **networkInterfaces** *(list) --*
      ...
      - *(dict) --*
        ...
        Contains information about the network interfaces interacting with an EC2 instance. This
        data type is used as one of the elements of the  AssetAttributes data type.
        ...
        - **privateIpAddresses** *(list) --*
          ...
          - *(dict) --*
            ...
            This data type is used as a response element in the  DescribeFindings action.
        ...
        - **securityGroups** *(list) --*
          ...
          - *(dict) --*
            ...
            data type is used as one of the elements of the  NetworkInterface data type.
...
class ClientDescribeResourceGroupsResponseresourceGroupsTypeDef(
    ...
    queried, identify the AWS resources that make up the assessment target. This data type is used
    as the response element in the  DescribeResourceGroups action.
...
_ClientGetAssessmentReportResponseTypeDef = TypedDict(
    "_ClientGetAssessmentReportResponseTypeDef", {"status": str, "url": str}, total=False
)
...
class ClientListAssessmentRunAgentsResponseassessmentRunAgentstelemetryMetadataTypeDef(
    ...
    """
    Type definition for `ClientListAssessmentRunAgentsResponseassessmentRunAgents`
    `telemetryMetadata`
...
class ClientListAssessmentRunAgentsfilterTypeDef(_ClientListAssessmentRunAgentsfilterTypeDef):
    """
...
class ClientListAssessmentRunsfilterTypeDef(_ClientListAssessmentRunsfilterTypeDef):
    ...
    - **states** *(list) --*
      ...
      For a record to match a filter, one of the values specified for this data type property must
      be the exact match of the value of the **assessmentRunState** property of the  AssessmentRun
      data type.
    ...
    - **rulesPackageArns** *(list) --*
      ...
      For a record to match a filter, the value that is specified for this data type property must
      be contained in the list of values of the **rulesPackages** property of the  AssessmentRun
      data type.
...
_OptionalClientListFindingsfilteruserAttributesTypeDef = TypedDict(
    "_OptionalClientListFindingsfilteruserAttributesTypeDef", {"value": str}, total=False
)
...
class ClientListFindingsfilterTypeDef(_ClientListFindingsfilterTypeDef):
    ...
    - **autoScalingGroups** *(list) --*
      ...
      For a record to match a filter, one of the values that is specified for this data type
      property must be the exact match of the value of the **autoScalingGroup** property of the
      Finding data type.
    ...
    - **ruleNames** *(list) --*
      ...
      For a record to match a filter, one of the values that is specified for this data type
      property must be the exact match of the value of the **ruleName** property of the  Finding
      data type.
    ...
    - **severities** *(list) --*
      ...
      For a record to match a filter, one of the values that is specified for this data type
      property must be the exact match of the value of the **severity** property of the  Finding
      data type.
    ...
    - **userAttributes** *(list) --*
      ...
      For a record to match a filter, the value that is specified for this data type property must
      be contained in the list of values of the **userAttributes** property of the  Finding data
      type.
...
class ListAssessmentRunAgentsPaginateResponseassessmentRunAgentstelemetryMetadataTypeDef(
    ...
    """
    Type definition for `ListAssessmentRunAgentsPaginateResponseassessmentRunAgents`
    `telemetryMetadata`
...
class ListAssessmentRunAgentsPaginatefilterTypeDef(_ListAssessmentRunAgentsPaginatefilterTypeDef):
    """
...
_OptionalListFindingsPaginatefilteruserAttributesTypeDef = TypedDict(
    "_OptionalListFindingsPaginatefilteruserAttributesTypeDef", {"value": str}, total=False
)
