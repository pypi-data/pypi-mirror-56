"Main interface for inspector Client"
...
class Client(BaseClient):
    ...
    def add_attributes_to_findings(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/AddAttributesToFindings>`_
          ...
          ::

            {
                'failedItems': {
                    'string': {
                        'failureCode':
                        'INVALID_ARN'|'DUPLICATE_ARN'|'ITEM_DOES_NOT_EXIST'
                        |'ACCESS_DENIED'|'LIMIT_EXCEEDED'|'INTERNAL_ERROR',
    ...
    def create_assessment_target(
        ...
        <https://docs.aws.amazon.com/inspector/latest/userguide/inspector_slr.html>`__ isn’t already
        registered, this action also creates and registers a service-linked role to grant Amazon
        Inspector access to AWS Services needed to perform security assessments. You can create up
        to 50 assessment targets per AWS account. You can run up to 500 concurrent agents per AWS
        account. For more information, see `Amazon Inspector Assessment Targets
        <https://docs.aws.amazon.com/inspector/latest/userguide/inspector_applications.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/CreateAssessmentTarget>`_
    ...
    def create_assessment_template(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/CreateAssessmentTemplate>`_
        ...
        **Request Syntax**
        ...
        :param assessmentTemplateName: **[REQUIRED]**
          ...
          The user-defined name that identifies the assessment template that you want to create. You
          can create several assessment templates for an assessment target. The names of the
    ...
    def create_exclusions_preview(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/CreateExclusionsPreview>`_
    ...
    def create_resource_group(
        ...
        more information, see  CreateAssessmentTarget .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/CreateResourceGroup>`_
    ...
    def delete_assessment_run(self, assessmentRunArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DeleteAssessmentRun>`_
    ...
    def delete_assessment_target(self, assessmentTargetArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DeleteAssessmentTarget>`_
    ...
    def delete_assessment_template(self, assessmentTemplateArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DeleteAssessmentTemplate>`_
    ...
    def describe_assessment_runs(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeAssessmentRuns>`_
                        ...
                        'notifications': [
                            {
                                ...
                                |'FINDING_REPORTED'|'OTHER',
                                'message': 'string',
                                'error': True|False,
                                'snsTopicArn': 'string',
                                'snsPublishStatusCode':
                                'SUCCESS'|'TOPIC_DOES_NOT_EXIST'
    ...
    def describe_assessment_targets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeAssessmentTargets>`_
    ...
    def describe_assessment_templates(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeAssessmentTemplates>`_
    ...
    def describe_cross_account_access_role(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeCrossAccountAccessRole>`_
    ...
    def describe_exclusions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeExclusions>`_
    ...
    def describe_findings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeFindings>`_
        ...
        **Request Syntax**
        ...
        :param locale:
          ...
          The locale into which you want to translate a finding description, recommendation, and the
          short description that identifies the finding.
    ...
    def describe_resource_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeResourceGroups>`_
    ...
    def describe_rules_packages(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/DescribeRulesPackages>`_
    ...
    def get_assessment_report(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/GetAssessmentReport>`_
        ...
        **Request Syntax**
        ...
        :param reportType: **[REQUIRED]**
          ...
          Specifies the type of the assessment report that you want to generate. There are two types
          of assessment reports: a finding report and a full report. For more information, see
          `Assessment Reports
          <https://docs.aws.amazon.com/inspector/latest/userguide/inspector_reports.html>`__ .
    ...
    def get_exclusions_preview(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/GetExclusionsPreview>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          null on your first call to the GetExclusionsPreviewRequest action. Subsequent calls to the
    ...
    def get_telemetry_metadata(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/GetTelemetryMetadata>`_
    ...
    def list_assessment_run_agents(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListAssessmentRunAgents>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListAssessmentRunAgents** action. Subsequent calls to the
          action fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              in a subsequent pagination request. If there is no more data to be listed, this
    ...
    def list_assessment_runs(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListAssessmentRuns>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.list_assessment_runs(
              ...
              filter={
                  'namePattern': 'string',
                  'states': [
                      'CREATED'|'START_DATA_COLLECTION_PENDING'|'START_DATA_COLLECTION_IN_PROGRESS'
                      |'COLLECTING_DATA'|'STOP_DATA_COLLECTION_PENDING'|'DATA_COLLECTED'
                      |'START_EVALUATING_RULES_PENDING'|'EVALUATING_RULES'|'FAILED'|'ERROR'
        ...
        :param filter:
          ...
          - **namePattern** *(string) --*
            ...
            is specified for this data type property must match the value of the
          ...
          - **states** *(list) --*
            ...
            must be the exact match of the value of the **assessmentRunState** property of the
          ...
          - **rulesPackageArns** *(list) --*
            ...
            For a record to match a filter, the value that is specified for this data type property
            must be contained in the list of values of the **rulesPackages** property of the
            AssessmentRun data type.
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListAssessmentRuns** action. Subsequent calls to the
          action fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
    ...
    def list_assessment_targets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListAssessmentTargets>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListAssessmentTargets** action. Subsequent calls to the
          action fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
    ...
    def list_assessment_templates(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListAssessmentTemplates>`_
        ...
        **Request Syntax**
        ...
        :param filter:
          ...
          - **rulesPackageArns** *(list) --*
            ...
            property must be contained in the list of values of the **rulesPackageArns** property of
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListAssessmentTemplates** action. Subsequent calls to the
          action fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
    ...
    def list_event_subscriptions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListEventSubscriptions>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListEventSubscriptions** action. Subsequent calls to the
          action fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
    ...
    def list_exclusions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListExclusions>`_
    ...
    def list_findings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListFindings>`_
        ...
        **Request Syntax**
        ...
        :param filter:
          ...
          - **agentIds** *(list) --*
            ...
            property must be the exact match of the value of the **agentId** property of the
            Finding data type.
          ...
          - **autoScalingGroups** *(list) --*
            ...
            For a record to match a filter, one of the values that is specified for this data type
            property must be the exact match of the value of the **autoScalingGroup** property of
          ...
          - **ruleNames** *(list) --*
            ...
            For a record to match a filter, one of the values that is specified for this data type
            property must be the exact match of the value of the **ruleName** property of the
            Finding data type.
          ...
          - **severities** *(list) --*
            ...
            For a record to match a filter, one of the values that is specified for this data type
            property must be the exact match of the value of the **severity** property of the
            Finding data type.
          ...
          - **rulesPackageArns** *(list) --*
            ...
            For a record to match a filter, one of the values that is specified for this data type
            property must be the exact match of the value of the **rulesPackageArn** property of the
            Finding data type.
          ...
          - **attributes** *(list) --*
            ...
            property must be contained in the list of values of the **attributes** property of the
            Finding data type.
          ...
          - **userAttributes** *(list) --*
            ...
            For a record to match a filter, the value that is specified for this data type property
            must be contained in the list of values of the **userAttributes** property of the
            Finding data type.
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListFindings** action. Subsequent calls to the action
    ...
    def list_rules_packages(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListRulesPackages>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **ListRulesPackages** action. Subsequent calls to the
          action fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
    ...
    def list_tags_for_resource(self, resourceArn: str) -> ClientListTagsForResourceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/ListTagsForResource>`_
    ...
    def preview_agents(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/PreviewAgents>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          You can use this parameter when paginating results. Set the value of this parameter to
          null on your first call to the **PreviewAgents** action. Subsequent calls to the action
          fill **nextToken** in the request with the value of **NextToken** from the previous
          response to continue listing data.
    ...
    def register_cross_account_access_role(self, roleArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/RegisterCrossAccountAccessRole>`_
    ...
    def remove_attributes_from_findings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/RemoveAttributesFromFindings>`_
    ...
    def set_tags_for_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/SetTagsForResource>`_
    ...
    def start_assessment_run(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/StartAssessmentRun>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def stop_assessment_run(self, assessmentRunArn: str, stopAction: str = None) -> None:
        """
        Stops the assessment run that is specified by the ARN of the assessment run.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/StopAssessmentRun>`_
    ...
    def subscribe_to_event(self, resourceArn: str, event: str, topicArn: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/SubscribeToEvent>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.subscribe_to_event(
              resourceArn='string',
              event=
                  'ASSESSMENT_RUN_STARTED'|'ASSESSMENT_RUN_COMPLETED'|'ASSESSMENT_RUN_STATE_CHANGED'
                  |'FINDING_REPORTED'|'OTHER',
              topicArn='string'
          )
        :type resourceArn: string
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def unsubscribe_from_event(self, resourceArn: str, event: str, topicArn: str) -> None:
        """
        Disables the process of sending Amazon Simple Notification Service (SNS) notifications about
        a specified event to a specified SNS topic.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/UnsubscribeFromEvent>`_
    ...
    def update_assessment_target(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/inspector-2016-02-16/UpdateAssessmentTarget>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_assessment_run_agents` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_assessment_runs` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_assessment_targets` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_assessment_templates` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_event_subscriptions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_exclusions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_rules_packages` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `preview_agents` operation.
        """
