...
class Client(BaseClient):
    ...
    def attach_policy(self, policyName: str, target: str) -> None:
        ...
        **Request Syntax**
        ...
        :param target: **[REQUIRED]**
          ...
          The `identity
          <https://docs.aws.amazon.com/iot/latest/developerguide/iot-security-identity.html>`__ to which the
          policy is attached.
    ...
    def cancel_certificate_transfer(self, certificateId: str) -> None:
         ...
         **Note** Only the transfer source account can use this operation to cancel a transfer. (Transfer
         ...
         certificate to the source account in the INACTIVE state. After the destination account has accepted
    ...
    def cancel_job(
        ...
        **Request Syntax**
        ...
        :param force:
          ...
          unable to update the job execution status. Use caution and ensure that each device executing a job
    ...
    def confirm_topic_rule_destination(self, confirmationToken: str) -> Dict[str, Any]:
        ...
        you pass back when calling ``ConfirmTopicRuleDestination`` to confirm that you own or have access to
        the endpoint.
    ...
    def create_certificate_from_csr(
        ...
        into that directory, and then specifying that directory on the command line. The following commands
    ...
    def create_dynamic_thing_group(
        ...
        **Request Syntax**
        ...
        :param queryString: **[REQUIRED]**
          ...
          See `Query Syntax <https://docs.aws.amazon.com/iot/latest/developerguide/query-syntax.html>`__ for
        ...
        **Request Syntax**
        ...
        :param actionParams: **[REQUIRED]**
          ...
          - **addThingsToThingGroupParams** *(dict) --*
            ...
            Parameters to define a mitigation action that moves devices associated with a certificate to one
            or more specified thing groups, typically for quarantine.
            ...
            - *(dict) --*
              ...
              - **dynamoDB** *(dict) --*
                ...
                - **operation** *(string) --*
                  ...
                  be ``${operation}`` , but the substitution must result in one of the following: ``INSERT``
                  , ``UPDATE`` , or ``DELETE`` .
          ...
          - **errorAction** *(dict) --*
            ...
            - **http** *(dict) --*
              ...
              - **confirmationUrl** *(string) --*
                ...
                confirmationUrl, you must create and enable topic rule destinations that match each possible
                value of the substituion template before traffic is allowed to your endpoint URL.
    ...
    def delete_job(self, jobId: str, force: bool = None) -> None:
        ...
        **Request Syntax**
        ...
        :param jobId: **[REQUIRED]**
          ...
          this is not recommended, and you must ensure that your devices are not using the jobId to refer to
          the deleted job.
        ...
        :param force:
          ...
          .. note::
            ...
            unable to access job information or update the job execution status. Use caution and ensure that
            ...
            - **job** *(dict) --*
              ...
              - **jobProcessDetails** *(dict) --*
                ...
                - **processingTargets** *(list) --*
                  ...
                  The target devices to which the job execution is being rolled out. This value will be null
                  after the job execution has finished rolling out to all the target devices.
              ...
              - **timeoutConfig** *(dict) --*
                ...
                - **inProgressTimeoutInMinutes** *(integer) --*
                  ...
                  in progress timer can't be updated and will apply to all job executions for the job.
                  Whenever a job execution remains in the IN_PROGRESS status for longer than this interval,
          ...
          - *(dict) --*
            ...
            - **execution** *(dict) --*
              ...
              - **forceCanceled** *(boolean) --*
                ...
                Will be ``true`` if the job execution was canceled with the optional ``force`` parameter set
                to ``true`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **frequency** *(string) --*
              ...
              How often the scheduled audit takes place. One of "DAILY", "WEEKLY", "BIWEEKLY", or "MONTHLY".
                ...
                - **criteria** *(dict) --*
                  ...
                  - **statisticalThreshold** *(dict) --*
                    ...
                    - **statistic** *(string) --*
                      ...
                      is determined. Metrics are collected over the specified period (``durationSeconds`` )
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **thingTypeProperties** *(dict) --*
              ...
              The ThingTypeProperties contains information about the thing type including description, and a
            ...
            - **thingTypeMetadata** *(dict) --*
              ...
              date and time, a value indicating whether the thing type is deprecated, and a date and time
          ...
          - *(dict) --*
            ...
            - **otaUpdateInfo** *(dict) --*
              ...
              - **targetSelection** *(string) --*
                ...
                continuous, the OTA update may also be run on a thing when a change is detected in a target.
                For example, an OTA update will run on a thing when the thing is added to a target group,
                even after the OTA update was completed by all things originally in the group.
                ...
                - *(dict) --*
                  ...
                  - **http** *(dict) --*
                    ...
                    - **url** *(string) --*
                      ...
                      a ``confirmationUrl`` . If this is a new destination, a new ``TopicRuleDestination``
                    ...
                    - **confirmationUrl** *(string) --*
                      ...
                      IoT uses the endpoint URL as the confirmation URL. If you use substitution templates
              ...
              - *(dict) --*
                ...
                - **jobExecutionSummary** *(dict) --*
                  ...
                  - **executionNumber** *(integer) --*
                    ...
                    A string (consisting of the digits "0" through "9") which identifies this particular job
                    execution on this particular device. It can be used later in commands which return or
    ...
    def list_security_profiles(
        ...
        """
        Lists the Device Defender security profiles you have created. You can use filters to list only those
        security profiles associated with a thing group or only those associated with your account.
    ...
    def register_ca_certificate(
        ...
        authorities sign your device certificates. If you have more than one CA certificate registered, make
        sure you pass the CA certificate when you register your device certificates with the
    ...
    def register_certificate(
        ...
        same subject field, you must specify the CA certificate that was used to sign the device certificate
        being registered.
    ...
    def register_thing(
        ...
        **Request Syntax**
        ...
        :param templateBody: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/iot/latest/developerguide/programmatic-provisioning.html>`__ for more
          information.
    ...
    def set_default_policy_version(self, policyName: str, policyVersionId: str) -> None:
        ...
        is attached to, use the ListPrincipalPolicy API.
    ...
    def transfer_certificate(
        ...
        API to deactivate it.

        The certificate must not have any policies attached to it. You can use the DetachPrincipalPolicy API
        to detach them.
    ...
    def update_mitigation_action(
        ...
        **Request Syntax**
        ...
        :param actionName: **[REQUIRED]**
          ...
          ``UpdateMitigationAction`` . Instead, you must delete and re-create the mitigation action with the
          new name.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **additionalMetricsToRetain** *(list) --*
              ...
              A list of metrics whose data is retained (stored). By default, data is retained for any metric
              used in the security profile's ``behaviors`` , but it is also retained for any metric
              specified here.
    ...
    def update_thing(
        ...
        **Request Syntax**
        ...
        :param expectedVersion:
          ...
          The expected version of the thing record in the registry. If the version of the record in the
          registry does not match the expected version specified in the request, the ``UpdateThing`` request
          is rejected with a ``VersionConflictException`` .
    ...
    def update_topic_rule_destination(self, arn: str, status: str) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param status: **[REQUIRED]**
          ...
          by calling ``UpdateTopicRuleDestination`` . Calling ``UpdateTopicRuleDestination`` causes a new
