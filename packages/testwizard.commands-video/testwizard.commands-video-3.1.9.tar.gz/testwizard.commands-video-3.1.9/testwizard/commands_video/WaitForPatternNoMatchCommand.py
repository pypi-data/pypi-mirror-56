...
class WaitForPatternNoMatchCommand(CommandBase):
    def __init__(self, session, testObjectName):
        CommandBase.__init__(self, session, testObjectName, "WaitForPatternNoMatch")
    ...
    def execute(self, filename, minSimilarity, timeout, mode, x, y, width, height):
        ...
        return WaitForPatternResult(response.read(), "WaitForPatternNoMatch was successful", "WaitForPatternNoMatch failed")