...
class WaitForSampleNoMatchCommand(CommandBase):
    def __init__(self, session, testObjectName):
        CommandBase.__init__(self, session, testObjectName, "WaitForSampleNoMatch")
    ...
    def execute(self, x, y, width, height, minSimilarity, timeout, tolerance, distanceMethod = None, maxDistance = None):
        ...
        return WaitForSampleResult(response.read(), "WaitForSampleNoMatch was successful", "WaitForSampleNoMatch failed")