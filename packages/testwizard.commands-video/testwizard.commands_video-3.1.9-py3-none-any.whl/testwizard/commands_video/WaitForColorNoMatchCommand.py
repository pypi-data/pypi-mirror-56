...
class WaitForColorNoMatchCommand(CommandBase):
    def __init__(self, session, testObjectName):
        CommandBase.__init__(self, session, testObjectName, "WaitForColorNoMatch")
    ...
    def execute(self, x, y, width, height, refColor, tolerance, minSimilarity, timeout):
        ...
        return WaitForColorResult(response.read(), "WaitForColorNoMatch was successful", "WaitForColorNoMatch failed")