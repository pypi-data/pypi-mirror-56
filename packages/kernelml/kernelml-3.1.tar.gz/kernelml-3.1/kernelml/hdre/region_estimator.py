...
class HighDensityRegions():
    ...
    def optimize(self,X,y=None,cost=None, bins_per_dimension=21, number_of_random_simulations=500, number_of_realizations=10, smoothing_parameter=2.0, agg_func='count'):
