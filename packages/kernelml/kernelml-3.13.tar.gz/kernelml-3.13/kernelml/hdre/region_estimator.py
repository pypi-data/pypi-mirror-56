...
class HighDensityRegions():
    ...
    def optimize(self,X,y=None,cost=None, bins_per_dimension=41, number_of_random_simulations=1000, number_of_realizations=10, smoothing_parameter=3.0, agg_func='count'):
