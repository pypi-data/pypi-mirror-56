...
class Client(BaseClient):
    ...
    def create_identity_pool(
        ...
        **Request Syntax**
        ...
        :param IdentityPoolTags:
          ...
          Tags to assign to the identity pool. A tag is a label that you can apply to identity pools
          to categorize and manage them in different ways, such as by purpose, owner, environment,
          or other criteria.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AllowClassicFlow** *(boolean) --*
              ...
              Enables or disables the Basic (Classic) authentication flow. For more information, see
              `Identity Pools (Federated Identities) Authentication Flow
              <https://docs.aws.amazon.com/cognito/latest/developerguide/authentication-flow.html>`__
            ...
            - **CognitoIdentityProviders** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ServerSideTokenCheck** *(boolean) --*
                  ...
                  been globally signed out or deleted before the identity pool provides an OIDC
    ...
    def get_credentials_for_identity(
        ...
        **Request Syntax**
        ...
        :param Logins:
          ...
          providers such as FaceBook. For examples of ``Logins`` maps, see the code examples in the
        ...
        :param CustomRoleArn:
          ...
          The Amazon Resource Name (ARN) of the role to be assumed when multiple roles were received
          in the token from the identity provider. For example, a SAML-based identity provider. This
          parameter is optional for identity providers that do not support role customization.
              ...
              - *(string) --*
                ...
                - *(dict) --*
                  ...
                  - **Type** *(string) --*
                    ...
                    map groups to roles. Rules will attempt to match claims from the token to map to
                    a role.
                  ...
                  - **AmbiguousRoleResolution** *(string) --*
                    ...
                    the ``Rules`` type, or there is no ``cognito:preferred_role`` claim and there
    ...
    def get_open_id_token_for_developer_identity(
        ...
        existing identity. When you want to create a new identity, the ``IdentityId`` should be
        null. When you want to associate a new login with an existing authenticated/unauthenticated
        ...
        **Request Syntax**
        ...
        :param TokenDuration:
          ...
          The expiration time of the token, in seconds. You can specify a custom expiration time for
          the token so that you can cache it. If you don't provide an expiration time, the token is
          valid for 15 minutes. You can exchange the token with Amazon STS for temporary AWS
    ...
    def lookup_developer_identity(
        ...
        ``DeveloperUserIdentifier`` values associated with an ``IdentityId`` for an existing
        ...
        returned as a part of the response. If you supply both, ``DeveloperUserIdentifier`` will be
        matched against ``IdentityID`` . If the values are verified against the database, the
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A pagination token. The first call you make will have ``NextToken`` set to null. After
          that the service will return ``NextToken`` values as needed. For example, let's say you
          make a request with ``MaxResults`` set to 10, and there are 20 matches in the database.
          The service will return a pagination token as a part of the response. This token can be
          used to call the API again and get results starting from the 11th match.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              A pagination token. The first call you make will have ``NextToken`` set to null. After
              that the service will return ``NextToken`` values as needed. For example, let's say
              you make a request with ``MaxResults`` set to 10, and there are 20 matches in the
    ...
    def merge_developer_identities(
        ...
        ``DestinationUserIdentifier`` . Only developer-authenticated users can be merged. If the
        users to be merged are associated with the same public provider, but as two different users,
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              - **Type** *(string) --* **[REQUIRED]**
                ...
                The role mapping type. Token will use ``cognito:roles`` and
                ``cognito:preferred_role`` claims from the Cognito identity provider token to map
                groups to roles. Rules will attempt to match claims from the token to map to a role.
              ...
              - **AmbiguousRoleResolution** *(string) --*
                ...
                ``Rules`` type, or there is no ``cognito:preferred_role`` claim and there are
    ...
    def tag_resource(self, ResourceArn: str, Tags: List[str]) -> Dict[str, Any]:
        """
        Assigns a set of tags to an Amazon Cognito identity pool. A tag is a label that you can use
        to categorize and manage identity pools in different ways, such as by purpose, owner,
        ...
        testing and another for production, you might assign an ``Environment`` tag key to both
        identity pools. The value of this key might be ``Test`` for one identity pool and
    ...
    def unlink_developer_identity(
        ...
        """
        Unlinks a ``DeveloperUserIdentifier`` from an existing identity. Unlinked developer users
        will be considered new identities next time they are seen. If, for a given Cognito identity,
        you remove all federated identities as well as the developer user identifier, the Cognito
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        """
        Removes the specified tags from an Amazon Cognito identity pool. You can use this action up
