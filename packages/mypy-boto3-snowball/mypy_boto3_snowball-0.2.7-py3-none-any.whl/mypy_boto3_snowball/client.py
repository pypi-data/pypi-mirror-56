"Main interface for snowball Client"
...
class Client(BaseClient):
    ...
    def create_address(
        ...
        """
        Creates an address for a Snowball to be shipped to. In most regions, addresses are validated at the
        time of creation. The address you provide must be located within the serviceable area of your
        region. If the address is invalid or unsupported, then an exception is thrown.
    ...
    def create_cluster(
        ...
        **Request Syntax**
        ...
        :param Resources: **[REQUIRED]**
          ...
          - **Ec2AmiResources** *(list) --*
            ...
            - *(dict) --*
              ...
              Amazon EC2 AMI ID and the Snowball Edge AMI ID. Each AMI has these two IDs to simplify
        ...
        :param KmsKeyARN:
          ...
          created by using the `CreateKey
          <https://docs.aws.amazon.com/kms/latest/APIReference/API_CreateKey.html>`__ API action in AWS Key
        ...
        :param RoleARN: **[REQUIRED]**
          ...
          using the `CreateRole <https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateRole.html>`__
          API action in AWS Identity and Access Management (IAM).

        :type SnowballType: string
        :param SnowballType:

          The type of AWS Snowball device to use for this cluster. Currently, the only supported device type
        ...
        :param ShippingOption: **[REQUIRED]**
          ...
          * In the European Union (EU), you have access to express shipping. Typically, Snowball Edges
          shipped express are delivered in about a day. In addition, most countries in the EU have access to
    ...
    def create_job(
        ...
        account must have the right trust policies and permissions in place to create a job for Snowball. If
        you're creating a job for a node in a cluster, you only need to provide the ``clusterId`` value; the
        ...
        **Request Syntax**
        ...
        :param KmsKeyARN:
          ...
          The ``KmsKeyARN`` that you want to associate with this job. ``KmsKeyARN`` s are created using the
          `CreateKey <https://docs.aws.amazon.com/kms/latest/APIReference/API_CreateKey.html>`__ AWS Key
        ...
        :param RoleARN:
          ...
          `CreateRole <https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateRole.html>`__ AWS
        ...
        :param SnowballCapacityPreference:
          ...
          Snowball you'd like for this job. In all other regions, Snowballs come with 80 TB in storage
          capacity.

        :type ShippingOption: string
        :param ShippingOption:

          The shipping speed for this job. This speed doesn't dictate how soon you'll get the Snowball,
          rather it represents how quickly the Snowball moves to its destination while in transit. Regional
          shipping speeds are as follows:

          * In Australia, you have access to express shipping. Typically, Snowballs shipped express are
          delivered in about a day.
        ...
        :param ClusterId:
          ...
          The ID of a cluster. If you're creating a job for a node in a cluster, you need to provide only
          this ``clusterId`` value. The other job attributes are inherited from the cluster.
    ...
    def describe_address(self, AddressId: str) -> ClientDescribeAddressResponseTypeDef:
        """
        Takes an ``AddressId`` and returns specific details about that address in the form of an ``Address``
        object.
                ...
                'ClusterMetadata': {
                    ...
                    'Notification': {
                        ...
                        'JobStatesToNotify': [
                            ...
                            |'WithCustomer'|'InTransitToAWS'|'WithAWSSortingFacility'|'WithAWS'|'InProgress'
          ...
          - *(dict) --*
            ...
            - **ClusterMetadata** *(dict) --*
              ...
              - **Resources** *(dict) --*
                ...
                - **S3Resources** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    optional ``KeyRange`` value. The length of the range is defined at job creation, and has
                ...
                - **Ec2AmiResources** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    including the Amazon EC2 AMI ID and the Snowball Edge AMI ID. Each AMI has these two IDs
                    to simplify identifying the AMI in both the AWS Cloud and on the device.
              ...
              - **ShippingOption** *(string) --*
                ...
                The shipping speed for each node in this cluster. This speed doesn't dictate how soon you'll
                get each Snowball Edge device, rather it represents how quickly each device moves to its
              ...
              - **Notification** *(dict) --*
                ...
                - **SnsTopicARN** *(string) --*
                  ...
                  <https://docs.aws.amazon.com/sns/latest/api/API_Subscribe.html>`__ AWS Simple Notification
          ...
          ::

            {
                'JobMetadata': {
                    ...
                    'JobState':
                    'New'|'PreparingAppliance'|'PreparingShipment'|'InTransitToCustomer'|'WithCustomer'
                    |'InTransitToAWS'|'WithAWSSortingFacility'|'WithAWS'|'InProgress'|'Complete'|'Cancelled'
                    |'Listing'|'Pending',
                    'JobType': 'IMPORT'|'EXPORT'|'LOCAL_USE',
                    'SnowballType': 'STANDARD'|'EDGE'|'EDGE_C'|'EDGE_CG',
                    'CreationDate': datetime(2015, 1, 1),
            ...
            - **JobMetadata** *(dict) --*
              ...
              - **ShippingDetails** *(dict) --*
                ...
                - **OutboundShipment** *(dict) --*
                  ...
                  The ``Status`` and ``TrackingNumber`` values for a Snowball being delivered to the address
              ...
              - **SnowballCapacityPreference** *(string) --*
                ...
                The Snowball capacity preference for this job, specified at job creation. In US regions, you
                can choose between 50 TB and 80 TB Snowballs. All other regions use 80 TB capacity
                Snowballs.
              ...
              - **DataTransferProgress** *(dict) --*
                ...
                - **TotalBytes** *(integer) --*
                  ...
                  The total bytes of data for a transfer between a Snowball and Amazon S3. This value is set
                  to 0 (zero) until all the keys that will be transferred have been listed.

                - **TotalObjects** *(integer) --*

                  The total number of objects for a transfer between a Snowball and Amazon S3. This value is
            ...
            - **SubJobMetadata** *(list) --*
              ...
              - *(dict) --*
                ...
                - **JobLogInfo** *(dict) --*
                  ...
                  report typically becomes available while the Snowball for your job part is being delivered
                  to you.
    ...
    def get_job_manifest(self, JobId: str) -> ClientGetJobManifestResponseTypeDef:
        ...
        ``JobId`` value. You can access the manifest file for up to 60 minutes after this request has been
        made. To access the manifest file after 60 minutes have passed, you'll have to make another call to
        the ``GetJobManifest`` action.

        The manifest is an encrypted file that you can download after your job enters the ``WithCustomer``
        status. The manifest is decrypted by using the ``UnlockCode`` code value, when you pass both values
        to the Snowball through the Snowball client when the client is started for the first time.
        ...
        The credentials of a given job, including its manifest file and unlock code, expire 90 days after
        the job is created.
    ...
    def get_job_unlock_code(self, JobId: str) -> ClientGetJobUnlockCodeResponseTypeDef:
        ...
        be accessed for up to 90 days after the associated job has been created.

        The ``UnlockCode`` value is a 29-character code with 25 alphanumeric characters and 4 hyphens. This
        code is used to decrypt the manifest file when it is passed along with the manifest to the Snowball
    ...
    def get_snowball_usage(
        ...
        Snowballs your account has in use.

        The default service limit for the number of Snowballs that you can have at one time is 1. If you
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UpdatesURI** *(string) --*
              ...
              The software update will be available for 2 days after this request is made. To access an
    ...
    def list_cluster_jobs(
        ...
        is for a job in the specified cluster and contains a job's state, a job's ID, and other information.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              HTTP requests are stateless. If you use the automatically generated ``NextToken`` value in
              your next ``ClusterListEntry`` call, your list of returned clusters will start from this point
              in the array.
    ...
    def list_compatible_images(
        ...
        """
        This action returns a list of the different Amazon EC2 Amazon Machine Images (AMIs) that are owned
        by your AWS account that would be supported for use on a Snowball Edge device. Currently, supported
        AMIs are based on the CentOS 7 (x86_64) - with Updates HVM, Ubuntu Server 14.04 LTS (HVM), and
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          images, you can specify a value for ``NextToken`` as the starting point for your list of returned
          images.
    ...
    def list_jobs(
        ...
        """
        Returns an array of ``JobListEntry`` objects of the specified length. Each ``JobListEntry`` object
        contains a job's state, a job's ID, and a value that indicates whether the job is a job part, in the
        case of export jobs. Calling this API action in one of the US regions will return jobs from the list
        of all jobs associated with this account in all US regions.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              your next ``ListJobs`` call, your returned ``JobListEntry`` objects will start from this point
              in the array.
    ...
    def update_cluster(
        ...
        **Request Syntax**
        ...
        :param RoleARN:
          ...
          role ARN, use the `CreateRole
          <https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateRole.html>`__ API action in AWS
    ...
    def update_job(
        ...
        a job. Once the job changes to a different job state, usually within 60 minutes of the job being
        ...
        **Request Syntax**
        ...
        :param RoleARN:
          ...
          ARN, use the `CreateRole
          <https://docs.aws.amazon.com/IAM/latest/APIReference/API_CreateRole.html>`__ AWS Identity and
