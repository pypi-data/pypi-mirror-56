...
class ClientCreateClusterResourcesS3ResourcesKeyRangeTypeDef(
    ...
    - **BeginMarker** *(string) --*
      ...
      The key that starts an optional key range for an export job. Ranges are inclusive and UTF-8
      binary sorted.
...
_OptionalClientCreateJobResourcesEc2AmiResourcesTypeDef = TypedDict(
    "_OptionalClientCreateJobResourcesEc2AmiResourcesTypeDef", {"SnowballAmiId": str}, total=False
)
...
class ClientDescribeAddressResponseAddressTypeDef(_ClientDescribeAddressResponseAddressTypeDef):
    ...
    The address that you want the Snowball or Snowballs associated with a specific job to be shipped
    to.
...
class ClientDescribeAddressesResponseAddressesTypeDef(
    ...
    within the serviceable area of your region. Although no individual elements of the ``Address``
...
class ClientDescribeClusterResponseClusterMetadataResourcesLambdaResourcesEventTriggersTypeDef(
    ...
    """
    Type definition for `ClientDescribeClusterResponseClusterMetadataResourcesLambdaResources`
    `EventTriggers`
...
class ClientDescribeClusterResponseClusterMetadataResourcesS3ResourcesKeyRangeTypeDef(
    ...
    """
    Type definition for `ClientDescribeClusterResponseClusterMetadataResourcesS3Resources`
    `KeyRange`
...
class ClientDescribeClusterResponseClusterMetadataTypeDef(
    ...
    - **KmsKeyARN** *(string) --*
      ...
      <https://docs.aws.amazon.com/kms/latest/APIReference/API_CreateKey.html>`__ API action in AWS
    ...
    - **SnowballType** *(string) --*
      ...
      The type of AWS Snowball device to use for this cluster. Currently, the only supported device
    ...
    - **Resources** *(dict) --*
      ...
      - **S3Resources** *(list) --*
        ...
        - *(dict) --*
          ...
          Each ``S3Resource`` object represents an Amazon S3 bucket that your transferred data will
          be exported from or imported into. For export jobs, this object can have an optional
          ``KeyRange`` value. The length of the range is defined at job creation, and has either an
          inclusive ``BeginMarker`` , an inclusive ``EndMarker`` , or both. Ranges are UTF-8 binary
          sorted.
...
class ClientDescribeJobResponseJobMetadataDataTransferProgressTypeDef(
    ...
    A value that defines the real-time status of a Snowball's data transfer while the device is at
    AWS. This data is only available while a job has a ``JobState`` value of ``InProgress`` , for
    ...
    - **TotalBytes** *(integer) --*
      ...
      The total bytes of data for a transfer between a Snowball and Amazon S3. This value is set to
      0 (zero) until all the keys that will be transferred have been listed.

    - **TotalObjects** *(integer) --*

      The total number of objects for a transfer between a Snowball and Amazon S3. This value is set
...
class ClientDescribeJobResponseJobMetadataResourcesLambdaResourcesEventTriggersTypeDef(
    ...
    """
    Type definition for `ClientDescribeJobResponseJobMetadataResourcesLambdaResources`
    `EventTriggers`
...
class ClientDescribeJobResponseJobMetadataShippingDetailsTypeDef(
    ...
    - **ShippingOption** *(string) --*
      ...
      Snowball from the job's creation date. This speed represents how quickly it moves to its
      destination while in transit. Regional shipping speeds are as follows:
...
class ClientDescribeJobResponseJobMetadataTypeDef(_ClientDescribeJobResponseJobMetadataTypeDef):
    ...
    - **SnowballCapacityPreference** *(string) --*
      ...
      can choose between 50 TB and 80 TB Snowballs. All other regions use 80 TB capacity Snowballs.
...
class ClientDescribeJobResponseSubJobMetadataResourcesLambdaResourcesEventTriggersTypeDef(
    ...
    """
    Type definition for `ClientDescribeJobResponseSubJobMetadataResourcesLambdaResources`
    `EventTriggers`
...
class ClientListClusterJobsResponseJobListEntriesTypeDef(
    ...
    - **IsMaster** *(boolean) --*
      ...
      request to create an export job. Master jobs aren't associated with any Snowballs. Instead,
      each master job will have at least one job part, and each job part is associated with a
      Snowball. It might take some time before the job parts associated with a particular master job
...
_ClientListClustersResponseClusterListEntriesTypeDef = TypedDict(
    ...
    {"ClusterId": str, "ClusterState": str, "CreationDate": datetime, "Description": str},
    total=False,
)
...
class ClientListCompatibleImagesResponseCompatibleImagesTypeDef(
    ...
    A JSON-formatted object that describes a compatible Amazon Machine Image (AMI), including the ID
    and name for a Snowball Edge AMI. This AMI is compatible with the device's physical hardware
...
_OptionalClientUpdateJobResourcesEc2AmiResourcesTypeDef = TypedDict(
    "_OptionalClientUpdateJobResourcesEc2AmiResourcesTypeDef", {"SnowballAmiId": str}, total=False
)
