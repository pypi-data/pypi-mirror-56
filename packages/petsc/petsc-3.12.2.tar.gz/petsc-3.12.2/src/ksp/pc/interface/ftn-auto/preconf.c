...
PETSC_EXTERN void PETSC_STDCALL  pcgetfailedreason_(PC pc,PCFailedReason *reason, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  pccomputeoperator_(PC pc,MatType *mattype,Mat *mat, int *__ierr){
...
PETSC_EXTERN void PETSC_STDCALL  pcgetinterpolations_(PC pc,PetscInt *num_levels,Mat *interpolations[], int *__ierr){
*__ierr = PCGetInterpolations(
	(PC)PetscToPointer((pc) ),num_levels,interpolations);
}
PETSC_EXTERN void PETSC_STDCALL  pcgetcoarseoperators_(PC pc,PetscInt *num_levels,Mat *coarseOperators[], int *__ierr){
