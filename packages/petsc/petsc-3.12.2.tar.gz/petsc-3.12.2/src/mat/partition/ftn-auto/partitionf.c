...
PETSC_EXTERN void PETSC_STDCALL  matpartitioningimprove_(MatPartitioning matp,IS *partitioning, int *__ierr){
*__ierr = MatPartitioningImprove(
	(MatPartitioning)PetscToPointer((matp) ),partitioning);
}
PETSC_EXTERN void PETSC_STDCALL  matpartitioningviewimbalance_(MatPartitioning matp,IS partitioning, int *__ierr){
