...
class Respuesta(DOC):
    ...
    def DTEs(self, vals):
        ...
        if type(vals) is list:
            for v in vals:
                if not v['Encabezado'].get('Emisor') and v['Encabezado']['Receptor']['RUTRecep'] != self._dte_emisor.RUTEmisor:
                    v['Encabezado']['Emisor'] = {
    ...
    def resultado(self, r):
        ...
        res['RUTEmisor'] = r.Emisor.RUTEmisor
    ...
    def recibo(self, r):
        ...
        receipt['RUTEmisor'] = r.Emisor.RUTEmisor
