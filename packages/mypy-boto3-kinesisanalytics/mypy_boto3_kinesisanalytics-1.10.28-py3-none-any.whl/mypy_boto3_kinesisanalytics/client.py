...
class Client(BaseClient):
    ...
    def add_application_input(
        ...
        in a new version of the application. You can use the `DescribeApplication
        ...
        **Request Syntax**
        ...
        :param Input: **[REQUIRED]**
          ...
          The `Input <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_Input.html>`__ to
          add.
          ...
          - **KinesisFirehoseInput** *(dict) --*
            ...
            - **RoleARN** *(string) --* **[REQUIRED]**
              ...
              ARN of the IAM role that Amazon Kinesis Analytics can assume to access the stream on
              your behalf. You need to make sure that the role has the necessary permissions to
              access the stream.
    ...
    def add_application_input_processing_configuration(
        ...
        application's SQL code executes. Currently, the only input processor available is `AWS
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          get a list of the input IDs for an application using the `DescribeApplication
          <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__
          operation.
    ...
    def add_application_output(
        ...
        outputs for your application. Each output configuration maps an in-application stream and an
        ...
        see `Understanding Application Output (Destination)
        ...
        :param Output: **[REQUIRED]**
          ...
          - **LambdaOutput** *(dict) --*
            ...
            - **RoleARN** *(string) --* **[REQUIRED]**
              ...
              ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the
              destination function on your behalf. You need to grant the necessary permissions to
              this role.
    ...
    def add_application_reference_data_source(
        ...
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ . For
        the limits on data sources you can add to your application, see `Limits
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/limits.html>`__ .
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          Version of the application for which you are adding the reference data source. You can use
          the `DescribeApplication
          <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__
          operation to get the current application version. If the version specified is not the
          current version, the ``ConcurrentModificationException`` is returned.
        ...
        :param ReferenceDataSource: **[REQUIRED]**
          ...
          that is created. You must also provide an IAM role with the necessary permissions that
          ...
          - **S3ReferenceDataSource** *(dict) --*
            ...
            changes, you call the ``UpdateApplication`` operation to trigger reloading of data into
            your application.
            ...
            - **ReferenceRoleARN** *(string) --* **[REQUIRED]**
              ...
              must have permission for the ``s3:GetObject`` action on the object and trust policy
    ...
    def create_application(
        ...
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works.html>`__ .

        In the input configuration, you map the streaming source to an in-application stream, which
        you can think of as a constantly updating table. In the mapping, you must provide a schema
        for the in-application stream and map each data column in the in-application stream to a
        data element in the streaming source.

        Your application code is one or more SQL statements that read input data, transform it, and
        generate output. Your application code can create one or more SQL artifacts like SQL streams
        or pumps.
        ...
        To read data from your source stream or write data to destination streams, Amazon Kinesis
        Analytics needs your permissions. You grant these permissions by creating IAM roles. This
        operation requires permissions to perform the ``kinesisanalytics:CreateApplication`` action.

        For introductory exercises to create an Amazon Kinesis Analytics application, see `Getting
        ...
        **Request Syntax**
        ...
        :param Inputs:
          ...
          To create the in-application stream, you need to specify a schema to transform your data
          into a schematized version used in SQL. In the schema, you provide the necessary mapping
          of the data elements in the streaming source to record columns in the in-app stream.
        ...
        :param Outputs:
          ...
          In the configuration, you specify the in-application stream name, the destination stream
          or Lambda function Amazon Resource Name (ARN), and the format to use when writing data.
          You must also provide an IAM role that Amazon Kinesis Analytics can assume to write to the
          destination stream or Lambda function on your behalf.

          In the output configuration, you also provide the output stream or Lambda function ARN.
          For stream destinations, you provide the format of data in the stream (for example, JSON,
          CSV). You also must provide an IAM role that Amazon Kinesis Analytics can assume to write
          ...
          - *(dict) --*
            ...
            - **KinesisStreamsOutput** *(dict) --*
              ...
              - **RoleARN** *(string) --* **[REQUIRED]**
                ...
                ARN of the IAM role that Amazon Kinesis Analytics can assume to write to the
                destination stream on your behalf. You need to grant the necessary permissions to
                this role.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ApplicationSummary** *(dict) --*
              ...
              response with a summary of the application it created, including the application
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        **Request Syntax**
        ...
        :param CloudWatchLoggingOptionId: **[REQUIRED]**
          ...
          the ``CloudWatchLoggingOptionId`` by using the `DescribeApplication
          <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__
          operation.
    ...
    def delete_application_reference_data_source(
        ...
        **Request Syntax**
        ...
        :param ReferenceId: **[REQUIRED]**
          ...
          using the `AddApplicationReferenceDataSource
          <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_AddApplicationReferenceDataSource.html>`__
    ...
    def describe_application(
        ...
        `ListApplications
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_ListApplications.html>`__
        operation.

        This operation requires permissions to perform the ``kinesisanalytics:DescribeApplication``
        action. You can use ``DescribeApplication`` to get the current application versionId, which
                  ...
                  - **InputProcessingConfigurationDescription** *(dict) --*
                    ...
                    - **InputLambdaProcessorDescription** *(dict) --*
                      ...
                      - **ResourceARN** *(string) --*
                        ...
                        The ARN of the `AWS Lambda <https://docs.aws.amazon.com/lambda/>`__ function
    ...
    def discover_input_schema(
        ...
        For conceptual information, see `Configuring Application Input
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/how-it-works-input.html>`__ . Note
        that when you create an application using the Amazon Kinesis Analytics console, the console
    ...
    def list_applications(
        ...
        status. If the response returns the ``HasMoreApplications`` value as true, you can send
        another request by adding the ``ExclusiveStartApplicationName`` in the request body, and set
            ...
            - **ApplicationSummaries** *(list) --*
              ...
              - *(dict) --*
                ...
                .. note::
                  ...
                  Analytics API V2 Documentation </kinesisanalytics/latest/apiv2/Welcome.html>`__ .
    ...
    def start_application(
        ...
        After you start the application, you can stop the application from processing the input by
        calling the `StopApplication
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_StopApplication.html>`__
        operation.
    ...
    def stop_application(self, ApplicationName: str) -> Dict[str, Any]:
        ...
        in the running state. You can use the `DescribeApplication
        <https://docs.aws.amazon.com/kinesisanalytics/latest/dev/API_DescribeApplication.html>`__
        operation to find the application state. After the application is stopped, Amazon Kinesis
        Analytics stops reading data from the input, the application stops processing data, and
        ...
        :param ApplicationUpdate: **[REQUIRED]**
          ...
          - **InputUpdates** *(list) --*
            ...
            - *(dict) --*
              ...
              Describes updates to a specific input configuration (identified by the ``InputId`` of
              an application).
