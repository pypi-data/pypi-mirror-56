...
class Client(BaseClient):
    ...
    def create_harvest_job(
        ...
        **Request Syntax**
        ...
        :param S3Destination: **[REQUIRED]** Configuration parameters for where in an S3 bucket to place the
        harvested content
    ...
    def create_origin_endpoint(
        ...
        **Request Syntax**
        ...
        :param CmafPackage: A Common Media Application Format (CMAF) packaging configuration.
          ...
          - **SegmentDurationSeconds** *(integer) --* Duration (in seconds) of each segment. Actual segments
          will be rounded to the nearest multiple of the source segment duration.
        ...
        :param DashPackage: A Dynamic Adaptive Streaming over HTTP (DASH) packaging configuration.
          ...
          - **AdTriggers** *(list) --* A list of SCTE-35 message types that are treated as ad markers in the
          output. If empty, no ad markers are output. Specify multiple items to create ad markers for all of
          the included message types.
          ...
          types specified in AdTriggers will be treated as ads. Note that Splice Insert messages do not have
          ...
          - **Profile** *(string) --* The Dynamic Adaptive Streaming over HTTP (DASH) profile type. When set
          ...
          - **SuggestedPresentationDelaySeconds** *(integer) --* Duration (in seconds) to delay live content
          before presentation.
        ...
        :param HlsPackage: An HTTP Live Streaming (HLS) packaging configuration.
          ...
          manifest to contain a copy of the SCTE-35 ad markers (comments) taken directly from the input HTTP
          Live Streaming (HLS) manifest. "SCTE35_ENHANCED" generates ad markers and blackout tags based on
          ...
          - **IncludeIframeOnlyStream** *(boolean) --* When enabled, an I-Frame only stream will be included
          in the output.
          ...
          ID3Timed Metadata messages will be generated every 5 seconds using the ingest time of the content.
          If the interval is not specified, or set to 0, then no EXT-X-PROGRAM-DATE-TIME tags will be
          inserted into manifests and no ID3Timed Metadata messages will be generated. Note that
        ...
        to DENY, the OriginEndpoint may not be requested. This can be helpful for Live to VOD harvesting, or
        for temporarily disabling origination
    ...
    def update_origin_endpoint(
        ...
        **Request Syntax**
        ...
        :type TimeDelaySeconds: integer
        :param TimeDelaySeconds: Amount of delay (in seconds) to enforce on the playback of live content. If
        not specified, there will be no time delay in effect for the OriginEndpoint.
