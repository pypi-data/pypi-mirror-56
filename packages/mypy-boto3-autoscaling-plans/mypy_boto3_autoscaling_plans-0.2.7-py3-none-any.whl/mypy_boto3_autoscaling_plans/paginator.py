"Main interface for autoscaling-plans Paginators"
...
class DescribeScalingPlanResourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        :py:meth:`AutoScalingPlans.Client.describe_scaling_plan_resources`.
...
class DescribeScalingPlansPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`AutoScalingPlans.Client.describe_scaling_plans`.
