"Main interface for autoscaling-plans Client"
...
class Client(BaseClient):
    ...
    def create_scaling_plan(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/autoscaling-plans-2018-01-06/CreateScalingPlan>`_
              ...
              ScalingInstructions=[
                  {
                      ...
                      'ResourceId': 'string',
                      'ScalableDimension':
                      'autoscaling:autoScalingGroup:DesiredCapacity'|'ecs:service:DesiredCount'
                      |'ec2:spot-fleet-request:TargetCapacity'|'rds:cluster:ReadReplicaCount'
        ...
        :param ScalingInstructions: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **TargetTrackingConfigurations** *(list) --* **[REQUIRED]**
              ...
              - *(dict) --*
                ...
                - **DisableScaleIn** *(boolean) --*
                  ...
                  is ``true`` , scale in is disabled and the target tracking scaling policy doesn't remove
            ...
            - **ScheduledActionBufferTime** *(integer) --*
              ...
              9:55 AM. The intention is to give resources time to be provisioned. For example, it can take a
              few minutes to launch an EC2 instance. The actual amount of time required depends on several
              factors, such as the size of the instance and whether there are startup scripts to complete.
            ...
            - **PredictiveScalingMaxCapacityBehavior** *(string) --*
              ...
              maximum capacity specified for the resource. The default value is
            ...
            - **ScalingPolicyUpdateBehavior** *(string) --*
              ...
              Condition: The number of existing policies to be replaced must be less than or equal to 50. If
              there are more than 50 policies to be replaced, AWS Auto Scaling keeps all existing policies
    ...
    def delete_scaling_plan(
        ...
        Deleting a scaling plan deletes the underlying  ScalingInstruction for all of the scalable resources
        that are covered by the plan.

        If the plan has launched resources or has scaling activities in progress, you must delete those
        resources separately.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/autoscaling-plans-2018-01-06/DeleteScalingPlan>`_
    ...
    def describe_scaling_plan_resources(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/autoscaling-plans-2018-01-06/DescribeScalingPlanResources>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of scalable resources to return. The value must be between 1 and 50. The
          default value is 50.
                        ...
                        'ScalingPolicies': [
                            {
                                ...
                                'TargetTrackingConfiguration': {
                                    'PredefinedScalingMetricSpecification': {
                                        ...
                                        |'ECSServiceAverageMemoryUtilization'|'ALBRequestCountPerTarget'
            ...
            - **ScalingPlanResources** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ScalingStatusCode** *(string) --*
                  ...
                  * ``Inactive`` - The scaling configuration is not active because the scaling plan is being
                  created or the scaling configuration could not be applied. Check the status message for
                  more information.
    ...
    def describe_scaling_plans(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/autoscaling-plans-2018-01-06/DescribeScalingPlans>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of scalable resources to return. This value can be between 1 and 50. The
          default value is 50.
                ...
                'ScalingPlans': [
                    {
                        ...
                        'StatusCode':
                        'Active'|'ActiveWithProblems'|'CreationInProgress'|'CreationFailed'
                        |'DeletionInProgress'|'DeletionFailed'|'UpdateInProgress'|'UpdateFailed',
                ...
                - **ScalingInstructions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **PredefinedLoadMetricSpecification** *(dict) --*
                      ...
                      The predefined load metric to use for predictive scaling. This parameter or a
                      **CustomizedLoadMetricSpecification** is required when configuring predictive scaling,
                      and cannot be used otherwise.
                    ...
                    - **CustomizedLoadMetricSpecification** *(dict) --*
                      ...
                      The customized load metric to use for predictive scaling. This parameter or a
                      **PredefinedLoadMetricSpecification** is required when configuring predictive scaling,
                      and cannot be used otherwise.
                    ...
                    - **ScheduledActionBufferTime** *(integer) --*
                      ...
                      action will be 9:55 AM. The intention is to give resources time to be provisioned. For
                      example, it can take a few minutes to launch an EC2 instance. The actual amount of
                      time required depends on several factors, such as the size of the instance and whether
    ...
    def get_scaling_plan_resource_forecast_data(
        ...
        Capacity forecasts are represented as predicted values, or data points, that are calculated using
        historical data points from a specified CloudWatch load metric. Data points are available for up to
        56 days.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/autoscaling-plans-2018-01-06/GetScalingPlanResourceForecastData>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_scaling_plan_resource_forecast_data(
              ...
              ScalableDimension=
                  ...
                  |'dynamodb:index:ReadCapacityUnits'|'dynamodb:index:WriteCapacityUnits',
              ForecastDataType=
                  'CapacityForecast'|'LoadForecast'|'ScheduledActionMinCapacity'
        ...
        :param ForecastDataType: **[REQUIRED]**
          ...
          * ``ScheduledActionMinCapacity`` : The minimum capacity for each scheduled scaling action. This
          data is calculated as the larger of two values: the capacity forecast or the minimum capacity in
        ...
        :param StartTime: **[REQUIRED]**
          ...
          The inclusive start time of the time range for the forecast data to get. The date and time can be
          at most 56 days before the current date and time.
        ...
        :param EndTime: **[REQUIRED]**
          ...
          availability of forecast data has limits. AWS Auto Scaling only issues forecasts for periods of
          two days in advance.
    ...
    def update_scaling_plan(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/autoscaling-plans-2018-01-06/UpdateScalingPlan>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_scaling_plan_resources` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_scaling_plans` operation.
        """
