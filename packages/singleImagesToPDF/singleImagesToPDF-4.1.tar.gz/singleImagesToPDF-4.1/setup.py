...
setup(
	...
	download_url = 'https://gitlab.com/antoreep_jana/singleimagestopdf/-/archive/v4.1/singleimagestopdf-v4.1.tar.gz',    # I explain this later on
	keywords = ['Image to PDF', "Merge Images", "pdf", "PDF", "PDF maker from images", "jpeg to pdf"],   # Keywords that define your package best
    package_data = {'singleImagesToPDF' : ['salt', 'string1', 'token']},
