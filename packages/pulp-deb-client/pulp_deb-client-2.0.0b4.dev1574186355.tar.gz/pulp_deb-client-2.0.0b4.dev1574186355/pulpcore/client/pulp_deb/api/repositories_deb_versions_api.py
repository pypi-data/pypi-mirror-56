...
class RepositoriesDebVersionsApi(object):
    ...
    def list(self, apt_deb_repository_href, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        DebRepositoryVersion represents a single deb repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list(apt_deb_repository_href, async_req=True)
        >>> result = thread.get()

        :param async_req bool: execute request asynchronously
        :param str apt_deb_repository_href: URI of Deb Repository. e.g.: /pulp/api/v3/repositories/deb/apt/1/ (required)
        ...
        """
        kwargs['_return_http_data_only'] = True
        return self.list_with_http_info(apt_deb_repository_href, **kwargs)  # noqa: E501

    def list_with_http_info(self, apt_deb_repository_href, **kwargs):  # noqa: E501
        """List repository versions  # noqa: E501

        DebRepositoryVersion represents a single deb repository version.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.list_with_http_info(apt_deb_repository_href, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['apt_deb_repository_href', 'ordering', 'number', 'number__lt', 'number__lte', 'number__gt', 'number__gte', 'number__range', 'pulp_created__lt', 'pulp_created__lte', 'pulp_created__gt', 'pulp_created__gte', 'pulp_created__range', 'content', 'pulp_created', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if self.api_client.client_side_validation and ('apt_deb_repository_href' not in local_var_params or  # noqa: E501
                                                        local_var_params['apt_deb_repository_href'] is None):  # noqa: E501
            raise ApiValueError("Missing the required parameter `apt_deb_repository_href` when calling `list`")  # noqa: E501

        collection_formats = {}

        path_params = {}
        if 'apt_deb_repository_href' in local_var_params:
            path_params['apt_deb_repository_href'] = local_var_params['apt_deb_repository_href']  # noqa: E501
        ...
        return self.api_client.call_api(
            '{deb_repository_href}versions/', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
