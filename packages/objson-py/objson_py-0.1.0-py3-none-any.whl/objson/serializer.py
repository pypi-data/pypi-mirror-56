...
def loadd(d, obj_cls, initargs=None):
    """
    ...
    initargs : dict, default None
        Arguments to pass to the constructor of `obj_cls`
...
def loads(s, obj_cls=None, initargs=None, **kwargs):
    """
    ...
    if obj_cls is None:
        ...
        if initargs is None:
            ...
            return loadd(d, obj_cls, initargs)
...
class Serializable:
    ...
    def from_dict_list(cls, dict_list):
        """
        Create list of this objects from list of dictionaries
        ...
        Returns
        -------
        list_of_this_obj : list
            List of this objects
        """
        return [cls.from_dict(v) for v in dict_list]
