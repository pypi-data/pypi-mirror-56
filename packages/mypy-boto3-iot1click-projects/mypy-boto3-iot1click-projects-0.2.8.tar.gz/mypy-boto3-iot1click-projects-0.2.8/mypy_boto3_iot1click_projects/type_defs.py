...
class ClientCreateProjectplacementTemplatedeviceTemplatesTypeDef(
    ...
    - **callbackOverrides** *(dict) --*
      ...
      An optional Lambda function to invoke instead of the default Lambda function provided by the
      placement template.
...
class ClientDescribePlacementResponseplacementTypeDef(
    ...
    - **updatedDate** *(datetime) --*
      ...
      The date when the placement was last updated, in UNIX epoch time format. If the placement was
...
class ClientDescribeProjectResponseprojectTypeDef(_ClientDescribeProjectResponseprojectTypeDef):
    ...
    - **updatedDate** *(datetime) --*
      ...
      The date when the project was last updated, in UNIX epoch time format. If the project was not
      updated, then ``createdDate`` and ``updatedDate`` are the same.
