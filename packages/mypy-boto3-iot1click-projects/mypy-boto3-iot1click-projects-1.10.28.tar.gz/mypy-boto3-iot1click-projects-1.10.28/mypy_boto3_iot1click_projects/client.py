...
class Client(BaseClient):
    ...
    def associate_device_with_placement(
        ...
        **Request Syntax**
        ...
        :param deviceId: **[REQUIRED]**
          ...
          Note that a mandatory 4 character prefix is required for all ``deviceId`` values.
    ...
    def create_project(
        ...
        **Request Syntax**
        ...
        :param placementTemplate:
          ...
          the project has been created. However, you can update ``callbackOverrides`` for the device
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def describe_project(self, projectName: str) -> ClientDescribeProjectResponseTypeDef:
        """
    ...
    def update_project(
        ...
        **Request Syntax**
        ...
        :param placementTemplate:
          ...
          device template names to the project. However, for a given ``placementTemplate`` , you can
          update the associated ``callbackOverrides`` for the device definition using this API.
