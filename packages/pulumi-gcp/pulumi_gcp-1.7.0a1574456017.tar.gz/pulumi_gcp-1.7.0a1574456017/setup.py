...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.7.0-alpha.1574456017+gc5cb6e90'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.7.0-alpha.1574456017+gc5cb6e90`
                """)
            else:
                raise
