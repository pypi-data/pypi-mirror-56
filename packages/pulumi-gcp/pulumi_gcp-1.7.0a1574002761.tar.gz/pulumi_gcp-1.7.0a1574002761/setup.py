...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.7.0-alpha.1574002761+g40da1a25'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.7.0-alpha.1574002761+g40da1a25`
                """)
            else:
                raise
