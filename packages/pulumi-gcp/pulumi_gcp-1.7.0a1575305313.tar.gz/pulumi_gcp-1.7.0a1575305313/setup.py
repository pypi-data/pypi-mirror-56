...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'gcp', 'v1.7.0-alpha.1575305313+g66193ad9'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource gcp v1.7.0-alpha.1575305313+g66193ad9`
                """)
            else:
                raise
