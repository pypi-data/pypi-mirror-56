...
def table_value_line(*, width, style='thin', column_widths, column_vals, outer_borders=True, inner_borders=True, align='left'):
...
#     print(table_value_line(width=75, column_widths=[15, 8], column_vals=['TITLE', 'ID', 'DESCRIPTION'], align='left', inner_borders=False))
#     print(table_value_line(width=75, column_widths=[15, 8], column_vals=['value title', '00001', 'This is a large description of something.'], align='left', inner_borders=False))
#     print(table_value_line(width=75, column_widths=[15, 8], column_vals=['value title', '00001', 'This is a large description of something.'], align='left', inner_borders=False))
