...
from rqdatac.share.errors import ErrorFromBackend
from rqdatac.decorators import retry
from rqdatac.connection import Connection, connection_error, timeout_error
...
class ConnectionPool:
    ...
    def _get_connection(self):
        ...
        try:
            ...
            if not isinstance(e, ErrorFromBackend):
                # some error happened, the connection is in an unknown state
                conn.close()
        else:
            with self._lock:
