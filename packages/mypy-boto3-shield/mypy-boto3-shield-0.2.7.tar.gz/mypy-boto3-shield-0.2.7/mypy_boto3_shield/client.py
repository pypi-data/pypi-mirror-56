"Main interface for shield Client"
...
class Client(BaseClient):
    ...
    def associate_drt_log_bucket(self, LogBucket: str) -> Dict[str, Any]:
        """
        Authorizes the DDoS Response team (DRT) to access the specified Amazon S3 bucket containing your AWS
        WAF logs. You can associate up to 10 Amazon S3 buckets with your subscription.

        To use the services of the DRT and make an ``AssociateDRTLogBucket`` request, you must be subscribed
        to the `Business Support plan <https://aws.amazon.com/premiumsupport/business-support/>`__ or the
        `Enterprise Support plan <https://aws.amazon.com/premiumsupport/enterprise-support/>`__ .
    ...
    def associate_drt_role(self, RoleArn: str) -> Dict[str, Any]:
        ...
        assist with DDoS attack mitigation during potential attacks. This enables the DRT to inspect your
        AWS WAF configuration and create or update AWS WAF rules and web ACLs.

        You can associate only one ``RoleArn`` with your subscription. If you submit an ``AssociateDRTRole``
        request for an account that already has an associated role, the new ``RoleArn`` will replace the
        existing ``RoleArn`` .
        ...
        managed policy to the role you will specify in the request. For more information see `Attaching and
        Detaching IAM Policies <
        https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies_manage-attach-detach.html>`__ . The
        role must also trust the service principal ``drt.shield.amazonaws.com`` . For more information, see
        ...
        authorize the DRT to inspect your AWS WAF and Shield configuration and create and update AWS WAF
        rules and web ACLs on your behalf. The DRT takes these actions only if explicitly authorized by you.
        ...
        To use the services of the DRT and make an ``AssociateDRTRole`` request, you must be subscribed to
        the `Business Support plan <https://aws.amazon.com/premiumsupport/business-support/>`__ or the
        `Enterprise Support plan <https://aws.amazon.com/premiumsupport/enterprise-support/>`__ .
    ...
    def create_protection(
        ...
        distribution, Elastic Load Balancing load balancer, AWS Global Accelerator accelerator, Elastic IP
        Address, or an Amazon Route 53 hosted zone.

        You can add protection to only a single resource with each CreateProtection request. If you want to
        add protection to multiple resources at once, use the `AWS WAF console
        <https://console.aws.amazon.com/waf/>`__ . For more information see `Getting Started with AWS Shield
        Advanced <https://docs.aws.amazon.com/waf/latest/developerguide/getting-started-ddos.html>`__ and
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          * For an Elastic Load Balancer (Classic Load Balancer): ``arn:aws:elasticloadbalancing:*region*
          :*account-id* :loadbalancer/*load-balancer-name* ``
    ...
    def create_subscription(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        As part of this request you can specify ``EmergencySettings`` that automaticaly grant the DDoS
        response team (DRT) needed permissions to assist you during a suspected DDoS attack. For more
        information see `Authorize the DDoS Response Team to Create Rules and Web ACLs on Your Behalf
        <https://docs.aws.amazon.com/waf/latest/developerguide/authorize-DRT.html>`__ .
        ...
        When you initally create a subscription, your subscription is set to be automatically renewed at the
        end of the existing subscription period. You can change this by submitting an ``UpdateSubscription``
        request.
                    ...
                    'AttackProperties': [
                        {
                            ...
                            'DESTINATION_URL'|'REFERRER'|'SOURCE_ASN'|'SOURCE_COUNTRY'|'SOURCE_IP_ADDRESS'
                            |'SOURCE_USER_AGENT'|'WORDPRESS_PINGBACK_REFLECTOR'|'WORDPRESS_PINGBACK_SOURCE',
                            'TopContributors': [
                                {
                                    'Name': 'string',
                                    'Value': 123
    ...
    def describe_drt_access(
        ...
        """
        Returns the current role and list of Amazon S3 log buckets used by the DDoS Response team (DRT) to
        access your AWS account while assisting with attack mitigation.
    ...
    def disassociate_drt_log_bucket(self, LogBucket: str) -> Dict[str, Any]:
        ...
        To make a ``DisassociateDRTLogBucket`` request, you must be subscribed to the `Business Support plan
        <https://aws.amazon.com/premiumsupport/business-support/>`__ or the `Enterprise Support plan
        <https://aws.amazon.com/premiumsupport/enterprise-support/>`__ . However, if you are not subscribed
        to one of these support plans, but had been previously and had granted the DRT access to your
    ...
    def disassociate_drt_role(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        To make a ``DisassociateDRTRole`` request, you must be subscribed to the `Business Support plan
        <https://aws.amazon.com/premiumsupport/business-support/>`__ or the `Enterprise Support plan
        <https://aws.amazon.com/premiumsupport/enterprise-support/>`__ . However, if you are not subscribed
        to one of these support plans, but had been previously and had granted the DRT access to your
    ...
    def list_attacks(
        ...
        **Request Syntax**
        ...
        :param StartTime:
          ...
          above indicates a ``number`` type because the default used by WAF is Unix time in seconds. However
          any valid `timestamp format
        ...
        :param NextToken:
          ...
          The ``ListAttacksRequest.NextMarker`` value from a previous call to ``ListAttacksRequest`` . Pass
        ...
        :param MaxResults:
          ...
          This is a maximum value; it is possible that AWS WAF will return the results in smaller batches.
          That is, the number of  AttackSummary objects returned could be less than ``MaxResults`` , even if
    ...
    def list_protections(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The ``ListProtectionsRequest.NextToken`` value from a previous call to ``ListProtections`` . Pass
          null if this is the first call.
        ...
        :param MaxResults:
          ...
          This is a maximum value; it is possible that AWS WAF will return the results in smaller batches.
          That is, the number of  Protection objects returned could be less than ``MaxResults`` , even if
          there are still more  Protection objects yet to return. If there are more  Protection objects to
    ...
    def update_emergency_contact_settings(
        ...
        """
        Updates the details of the list of email addresses that the DRT can use to contact you during a
        suspected attack.
    ...
    def update_subscription(self, AutoRenew: str = None) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param AutoRenew:
          ...
          the subscription will be automatically renewed at the end of the existing subscription period. You
          can change this by submitting an ``UpdateSubscription`` request. If the ``UpdateSubscription``
          request does not included a value for ``AutoRenew`` , the existing value for ``AutoRenew`` remains
          unchanged.
