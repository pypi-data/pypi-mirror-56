...
class DataProcessor(BaseEstimator, TransformerMixin):
    ...
    def process_data(self, df_data):
        ...
        predict_cols = ['agenda', 'bike_sharing_distance_km', 'bike_sharing_time_min', 'bus_distance_km', 'bus_time_min',
                       ...
                       'train_distance_km', 'train_time_min', 'tram_distance_km',
                       'tram_time_min', 'direct_car_distance_km', 'direct_car_time_min', 'direct_moto_distance_km',
                       'direct_moto_time_min', 'eco_car_distance_km', 'eco_car_time_min', 'eco_moto_distance_km', 'eco_moto_time_min',
                       'ecoplus_car_distance_km','ecoplus_car_time_min', 'ecoplus_moto_distance_km', 'ecoplus_moto_time_min',
                       'transfers','walking_distance_km', 'walking_time_min', 'pt_origin_gym', 'pt_origin_point_of_interest',
                       ...
                       'day_of_week_type_work', 'traffic_fluid', 'traffic_medium', 'traffic_heavy', 'weather_clear', 'weather_rain',
