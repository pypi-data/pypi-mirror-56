...
_ClientBatchAssociateUserStackResponseerrorsUserStackAssociationTypeDef = TypedDict(
    ...
    {"StackName": str, "UserName": str, "AuthenticationType": str, "SendEmailNotification": bool},
    total=False,
)
...
class ClientBatchAssociateUserStackResponseerrorsTypeDef(
    ...
    Describes the error that is returned when a user can’t be associated with or disassociated from
    a stack.
...
class ClientCreateDirectoryConfigResponseDirectoryConfigServiceAccountCredentialsTypeDef(
    ...
    """
    Type definition for `ClientCreateDirectoryConfigResponseDirectoryConfig`
...
class ClientCreateFleetResponseFleetTypeDef(_ClientCreateFleetResponseFleetTypeDef):
    ...
    - **FleetType** *(string) --*
      ...
      Provides users with instant-on access to their apps. You are charged for all running instances
      in your fleet, even if no users are streaming apps.
    ...
    - **DisconnectTimeoutInSeconds** *(integer) --*
      ...
      The amount of time that a streaming session remains active after users disconnect. If they try
      to reconnect to the streaming session after a disconnection or network interruption within
    ...
    - **IdleDisconnectTimeoutInSeconds** *(integer) --*
      ...
      notified before they are disconnected due to inactivity. If users try to reconnect to the
      streaming session before the time interval specified in ``DisconnectTimeoutInSeconds``
      ...
      continue to be idle after the time interval in ``IdleDisconnectTimeoutInSeconds`` elapses,
      ...
      .. note::
        ...
        value is rounded to the nearest minute. For example, if you specify a value of 70, users are
    ...
    - **IamRoleArn** *(string) --*
      ...
      retrieves the temporary credentials and creates the **AppStream_Machine_Role** credential
    ...
    - **Fleet** *(dict) --*
      ...
      - **IdleDisconnectTimeoutInSeconds** *(integer) --*
        ...
        .. note::
          ...
          are disconnected after 1 minute of inactivity. If you specify a value that is at the
          midpoint between two different minutes, the value is rounded up. For example, if you
          specify a value of 90, users are disconnected after 2 minutes of inactivity.
...
class ClientCreateImageBuilderResponseImageBuilderNetworkAccessConfigurationTypeDef(
    ...
    - **EniPrivateIpAddress** *(string) --*
      ...
      The private IP address of the elastic network interface that is attached to instances in your
      VPC.
...
class ClientCreateImageBuilderResponseImageBuilderTypeDef(
    ...
    - **IamRoleArn** *(string) --*
      ...
      builder calls the AWS Security Token Service (STS) ``AssumeRole`` API operation and passes the
    ...
    - **AccessEndpoints** *(list) --*
      ...
      The list of virtual private cloud (VPC) interface endpoint objects. Administrators can connect
      to the image builder only through the specified endpoints.
...
class ClientCreateStackResponseStackApplicationSettingsTypeDef(
    ...
    - **S3BucketName** *(string) --*
      ...
      application settings are enabled for the first time for an account in an AWS Region, an S3
      bucket is created. The bucket is unique to the AWS account and the Region.
    """
...
class ClientCreateUsageReportSubscriptionResponseTypeDef(
    ...
    - **S3BucketName** *(string) --*
      ...
      uses the same bucket to store your usage reports. If you haven't already enabled on-instance
...
class ClientDeleteImageResponseImageTypeDef(_ClientDeleteImageResponseImageTypeDef):
    ...
    - **PublicBaseImageReleasedDate** *(datetime) --*
      ...
      The release date of the public base image. For private images, this date is the release date
...
class ClientDescribeDirectoryConfigsResponseDirectoryConfigsServiceAccountCredentialsTypeDef(
    ...
    """
    Type definition for `ClientDescribeDirectoryConfigsResponseDirectoryConfigs`
    `ServiceAccountCredentials`
...
class ClientDescribeDirectoryConfigsResponseTypeDef(_ClientDescribeDirectoryConfigsResponseTypeDef):
    ...
    - **DirectoryConfigs** *(list) --*
      ...
      Information about the directory configurations. Note that although the response syntax in this
      topic includes the account password, this password is not returned in the actual response.
...
class ClientDescribeImageBuildersResponseImageBuildersNetworkAccessConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeImageBuildersResponseImageBuilders`
...
class ClientDescribeImagePermissionsResponseSharedImagePermissionsListimagePermissionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeImagePermissionsResponseSharedImagePermissionsList`
    `imagePermissions`
...
class ClientDescribeSessionsResponseSessionsTypeDef(_ClientDescribeSessionsResponseSessionsTypeDef):
    ...
    - **MaxExpirationTime** *(datetime) --*
      ...
      chooses to end his or her session, the streaming instance is terminated and the streaming
      session ends.

    - **AuthenticationType** *(string) --*

      The authentication method. The user is authenticated using a streaming URL (``API`` ) or SAML
      2.0 federation (``SAML`` ).
...
class ClientDescribeUsageReportSubscriptionsResponseUsageReportSubscriptionsSubscriptionErrorsTypeDef(
    ...
    """
    Type definition for `ClientDescribeUsageReportSubscriptionsResponseUsageReportSubscriptions`
    `SubscriptionErrors`
...
class ClientUpdateDirectoryConfigResponseDirectoryConfigServiceAccountCredentialsTypeDef(
    ...
    """
    Type definition for `ClientUpdateDirectoryConfigResponseDirectoryConfig`
    `ServiceAccountCredentials`
...
class DescribeDirectoryConfigsPaginateResponseDirectoryConfigsServiceAccountCredentialsTypeDef(
    ...
    """
    Type definition for `DescribeDirectoryConfigsPaginateResponseDirectoryConfigs`
    `ServiceAccountCredentials`
...
class DescribeImageBuildersPaginateResponseImageBuildersNetworkAccessConfigurationTypeDef(
    ...
    """
    Type definition for `DescribeImageBuildersPaginateResponseImageBuilders`
    `NetworkAccessConfiguration`
