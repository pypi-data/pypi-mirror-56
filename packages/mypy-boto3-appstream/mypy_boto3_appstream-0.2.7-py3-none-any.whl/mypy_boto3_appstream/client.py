...
class Client(BaseClient):
                    ...
                    'FleetErrors': [
                        {
                            ...
                            |'IAM_SERVICE_ROLE_MISSING_ENI_DELETE_ACTION'|'NETWORK_INTERFACE_LIMIT_EXCEEDED'
                            |'INTERNAL_SERVICE_ERROR'|'IAM_SERVICE_ROLE_IS_MISSING'
    ...
    def create_stack(
        ...
        **Request Syntax**
        ...
        :param ApplicationSettings:
          ...
          that users make to applications and Windows settings are automatically saved after each session
          and applied to the next session.
    ...
    def describe_directory_configs(
        ...
        """
        Retrieves a list that describes one or more specified Directory Config objects for AppStream 2.0, if
        the names for these objects are provided. Otherwise, all Directory Config objects in the account are
        described. These objects include the configuration information required to join fleets and image
    ...
    def update_fleet(
        ...
        fleet is in the ``RUNNING`` state, you can update the ``DisplayName`` , ``ComputeCapacity`` ,
