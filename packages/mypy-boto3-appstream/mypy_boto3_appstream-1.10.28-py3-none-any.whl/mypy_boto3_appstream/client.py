...
class Client(BaseClient):
    ...
    def copy_image(
        ...
        **Request Syntax**
        ...
        :param DestinationRegion: **[REQUIRED]**
          ...
          The destination region to which the image will be copied. This parameter is required, even
          if you are copying an image within the same region.
    ...
    def create_fleet(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          <https://docs.aws.amazon.com/appstream2/latest/developerguide/tagging-basic.html>`__ in
                    ...
                    'FleetErrors': [
                        {
                            ...
                            |'MACHINE_ROLE_IS_MISSING'|'STS_DISABLED_IN_REGION'
                            |'SUBNET_HAS_INSUFFICIENT_IP_ADDRESSES'
                            |'IAM_SERVICE_ROLE_MISSING_DESCRIBE_SUBNET_ACTION'
                            |'SUBNET_NOT_FOUND'|'IMAGE_NOT_FOUND'
                            |'INVALID_SUBNET_CONFIGURATION'
                            |'SECURITY_GROUPS_NOT_FOUND'|'IGW_NOT_ATTACHED'
                            |'IAM_SERVICE_ROLE_MISSING_DESCRIBE_SECURITY_GROUPS_ACTION'|'DOMAIN_JOIN_ERROR_FILE_NOT_FOUND'|'DOMAIN_JOIN_ERROR_ACCESS_DENIED'|'DOMAIN_JOIN_ERROR_LOGON_FAILURE'|'DOMAIN_JOIN_ERROR_INVALID_PARAMETER'|'DOMAIN_JOIN_ERROR_MORE_DATA'|'DOMAIN_JOIN_ERROR_NO_SUCH_DOMAIN'|'DOMAIN_JOIN_ERROR_NOT_SUPPORTED'|'DOMAIN_JOIN_NERR_INVALID_WORKGROUP_NAME'|'DOMAIN_JOIN_NERR_WORKSTATION_NOT_STARTED'|'DOMAIN_JOIN_ERROR_DS_MACHINE_ACCOUNT_QUOTA_EXCEEDED'|'DOMAIN_JOIN_NERR_PASSWORD_EXPIRED'
          ...
          - *(dict) --*
            ...
            - **Fleet** *(dict) --*
              ...
              - **DisconnectTimeoutInSeconds** *(integer) --*
                ...
                session. Otherwise, they are connected to a new session with a new streaming
                instance.
              ...
              - **VpcConfig** *(dict) --*
                ...
                - **SubnetIds** *(list) --*
                  ...
                  fleet instance or image builder instance. Fleet instances use one or more subnets.
              ...
              - **IdleDisconnectTimeoutInSeconds** *(integer) --*
                ...
                try to reconnect to the streaming session before the time interval specified in
              ...
              - **IamRoleArn** *(string) --*
                ...
                passes the ARN of the role to use. The operation creates a new session with
                temporary credentials. AppStream 2.0 retrieves the temporary credentials and creates
                ...
                and Scripts Running on AppStream 2.0 Streaming Instances
                <https://docs.aws.amazon.com/appstream2/latest/developerguide/using-iam-roles-to-grant-permissions-to-applications-scripts-streaming-instances.html>`__
                in the *Amazon AppStream 2.0 Administration Guide* .
          ...
          ::

            {
                'ImageBuilder': {
                    ...
                    'IamRoleArn': 'string',
                    'State':
                    'PENDING'|'UPDATING_AGENT'|'RUNNING'|'STOPPING'|'STOPPED'
          ...
          - *(dict) --*
            ...
            - **ImageBuilder** *(dict) --*
              ...
              - **IamRoleArn** *(string) --*
                ...
                image builder calls the AWS Security Token Service (STS) ``AssumeRole`` API
              ...
              - **AccessEndpoints** *(list) --*
                ...
                - *(dict) --*
                  ...
                  stack can connect to AppStream 2.0 only through that endpoint. When you specify an
                  interface endpoint for an image builder, administrators can connect to the image
                  builder only through that endpoint.
    ...
    def create_stack(
        ...
        **Request Syntax**
              ...
              UserSettings=[
                  {
                      ...
                      |'CLIPBOARD_COPY_TO_LOCAL_DEVICE'|'FILE_UPLOAD'|'FILE_DOWNLOAD'
        ...
        :param ApplicationSettings:
          ...
          changes that users make to applications and Windows settings are automatically saved after
          each session and applied to the next session.
          ...
          - **SettingsGroup** *(string) --*
            ...
            stored. You can allow the same persistent application settings to be used across
          ...
          - *(dict) --*
            ...
            - **Stack** *(dict) --*
              ...
              - **EmbedHostDomains** *(list) --*
                ...
                must approve the domains that you want to host embedded AppStream 2.0 streaming
                sessions.

                - *(string) --* Specifies a valid domain that can embed AppStream. Valid examples
                include: ["testorigin.tt--com", "testingorigin.com.us", "test.com.us"] Invalid
                examples include: ["test,com", ".com", "h*llo.com". ""]
    ...
    def create_user(
        ...
        **Request Syntax**
        ...
        :param MessageAction:
          ...
          in the user pool. If you specify SUPPRESS, no email is sent. If you specify RESEND, do not
          specify the first name or last name of the user. If the value is null, the email is sent.
            ...
            - **Fleets** *(list) --*
              ...
              - *(dict) --*
                ...
                - **FleetType** *(string) --*
                  ...
                  Provide users with access to applications after they connect, which takes one to
                  two minutes. You are charged for instance streaming when users are connected and a
                ...
                - **MaxUserDurationInSeconds** *(integer) --*
                  ...
                  The maximum amount of time that a streaming session can remain active, in seconds.
                  If users are still connected to a streaming instance five minutes before this
                  limit is reached, they are prompted to save any open documents before being
                  disconnected. After this time elapses, the instance is terminated and replaced by
                  a new instance.
                ...
                - **IdleDisconnectTimeoutInSeconds** *(integer) --*
                  ...
                  The amount of time that users can be idle (inactive) before they are disconnected
                  from their streaming session and the ``DisconnectTimeoutInSeconds`` time interval
                  begins. Users are notified before they are disconnected due to inactivity. If
                  users try to reconnect to the streaming session before the time interval specified
                  in ``DisconnectTimeoutInSeconds`` elapses, they are connected to their previous
                  session. Users are considered idle when they stop providing keyboard or mouse
                  input during their streaming session. File uploads and downloads, audio in, audio
                  out, and pixels changing do not qualify as user activity. If users continue to be
                  idle after the time interval in ``IdleDisconnectTimeoutInSeconds`` elapses, they
                  are disconnected.
                ...
                - **IamRoleArn** *(string) --*
                  ...
                  The ARN of the IAM role that is applied to the fleet. To assume a role, the fleet
                  instance calls the AWS Security Token Service (STS) ``AssumeRole`` API operation
                  and passes the ARN of the role to use. The operation creates a new session with
                  temporary credentials. AppStream 2.0 retrieves the temporary credentials and
                  creates the **AppStream_Machine_Role** credential profile on the instance.
            ...
            - **Sessions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **MaxExpirationTime** *(datetime) --*
                  ...
                  ``MaxUserDurationinSeconds`` value, which determines the maximum length of time
                  that a streaming session can run. A streaming session might end earlier than the
                  time specified in ``SessionMaxExpirationTime`` , when the
                  ``DisconnectTimeOutInSeconds`` elapses or the user chooses to end his or her
                  session. If the ``DisconnectTimeOutInSeconds`` elapses, or the user chooses to end
                  his or her session, the streaming instance is terminated and the streaming session
                  ends.
    ...
    def update_fleet(
        ...
        If the fleet is in the ``STOPPED`` state, you can update any attribute except the fleet
        name. If the fleet is in the ``RUNNING`` state, you can update the ``DisplayName`` ,
        ``ComputeCapacity`` , ``ImageARN`` , ``ImageName`` , ``IdleDisconnectTimeoutInSeconds`` ,
        and ``DisconnectTimeoutInSeconds`` attributes. If the fleet is in the ``STARTING`` or
        ...
        **Request Syntax**
        ::
          ...
          response = client.update_stack(
              ...
              FeedbackURL='string',
              AttributesToDelete=[
                  'STORAGE_CONNECTORS'|'STORAGE_CONNECTOR_HOMEFOLDERS'
                  |'STORAGE_CONNECTOR_GOOGLE_DRIVE'|'STORAGE_CONNECTOR_ONE_DRIVE'|'REDIRECT_URL'
                  |'FEEDBACK_URL'|'THEME_NAME'|'USER_SETTINGS'|'EMBED_HOST_DOMAINS'|'IAM_ROLE_ARN'
                  |'ACCESS_ENDPOINTS',
              ],
              UserSettings=[
                  {
