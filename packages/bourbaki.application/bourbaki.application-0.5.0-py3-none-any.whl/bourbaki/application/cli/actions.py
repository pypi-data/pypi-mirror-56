...
def print_package_info(info, keys=None, exclude_keys=('package',)):
    if keys is None:
        ...
        raise ValueError("misunderstood keys arg; pass None, a string, or a collection of strings")
    import yaml
...
class InfoAction(Action):
    ...
    def __init__(self,
                 ...
                 help=None):
        if help is None:
            help = "show {} for parent package {} and exit".format(self._info_type, repr(package))
