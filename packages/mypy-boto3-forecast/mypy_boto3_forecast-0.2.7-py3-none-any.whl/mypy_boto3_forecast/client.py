...
class Client(BaseClient):
    ...
    def create_dataset(
        ...
        **Request Syntax**
        ...
        :param Domain: **[REQUIRED]**
          ...
          the value specified for the ``Domain`` parameter of the  CreateDatasetGroup operation must match.

          The ``Domain`` and ``DatasetType`` that you choose determine the fields that must be present in
          the training data that you import to the dataset. For example, if you choose the ``RETAIL`` domain
          and ``TARGET_TIME_SERIES`` as the ``DatasetType`` , Amazon Forecast requires ``item_id`` ,
    ...
    def create_dataset_group(
        ...
        dataset group when you create the dataset group, or later by using the  UpdateDatasetGroup
        operation.
        ...
        .. note::
          ...
          The ``Status`` of a dataset group must be ``ACTIVE`` before you can create use the dataset group
          to create a predictor. To get the status, use the  DescribeDatasetGroup operation.
        ...
        **Request Syntax**
        ...
        :param Domain: **[REQUIRED]**
          ...
          The domain associated with the dataset group. When you add a dataset to a dataset group, this
    ...
    def create_dataset_import_job(
        ...
        You must specify a  DataSource object that includes an AWS Identity and Access Management (IAM) role
        that Amazon Forecast can assume to access the data. For more information, see
        aws-forecast-iam-roles .

        The training data must be in CSV format. The delimiter must be a comma (,).

        You can specify the path to a specific CSV file, the S3 bucket, or to a folder in the S3 bucket. For
        the latter two cases, Amazon Forecast imports all files up to the limit of 10,000 files.
        ...
        **Request Syntax**
        ...
        :param DataSource: **[REQUIRED]**
          ...
          that Amazon Forecast can assume to access the data. The training data must be stored in an Amazon
          S3 bucket.
    ...
    def create_forecast(
        ...
        CreatePredictor request, multiplied by the ``DataFrequency`` value, which you specify in the
        ...
        .. note::
          ...
          The forecasts generated by Amazon Forecast are in the same time zone as the dataset that was used
        ...
        .. note::
          ...
          The ``Status`` of the forecast must be ``ACTIVE`` before you can query or export the forecast. Use
          the  DescribeForecast operation to get the status.
        ...
        **Request Syntax**
        ...
        :param ForecastTypes:
          ...
          The quantiles at which probabilistic forecasts are generated. You can specify up to 5 quantiles
          per forecast. Accepted values include ``0.01 to 0.99`` (increments of .01 only) and ``mean`` . The
          mean forecast is different from the median (0.50) when the distribution is not symmetric (e.g.
          Beta, Negative Binomial). The default value is ``["0.1", "0.5", "0.9"]`` .
    ...
    def create_forecast_export_job(
        ...
        You must specify a  DataDestination object that includes an AWS Identity and Access Management (IAM)
        role that Amazon Forecast can assume to access the Amazon S3 bucket. For more information, see
        aws-forecast-iam-roles .
        ...
        .. note::
          ...
          The ``Status`` of the forecast export job must be ``ACTIVE`` before you can access the forecast in
          your Amazon S3 bucket. To get the status, use the  DescribeForecastExportJob operation.
    ...
    def create_predictor(
        ...
        in the specified dataset group. The result is called a predictor. You then generate a forecast using
        the  CreateForecast operation.

        After training a model, the ``CreatePredictor`` operation also evaluates it. To see the evaluation
        metrics, use the  GetAccuracyMetrics operation. Always review the evaluation metrics before deciding
        to use the predictor to generate a forecast.

        Optionally, you can specify a featurization configuration to fill and aggregate the data fields in
        the ``TARGET_TIME_SERIES`` dataset to improve model training. For more information, see
        FeaturizationConfig .

        For RELATED_TIME_SERIES datasets, ``CreatePredictor`` verifies that the ``DataFrequency`` specified
        when the dataset was created matches the ``ForecastFrequency`` . TARGET_TIME_SERIES datasets don't
        have this restriction. Amazon Forecast also verifies the delimiter and timestamp format. For more
        ...
        as the mean of the weighted p10, p50, and p90 quantile losses. For more information, see
        EvaluationResult .
        ...
        **Request Syntax**
        ...
        :param PerformAutoML:
          ...
          Set ``PerformAutoML`` to ``true`` to have Amazon Forecast perform AutoML. This is a good option if
          you aren't sure which algorithm is suitable for your training data. In this case, ``PerformHPO``
          must be false.
        ...
        :param PerformHPO:
          ...
          hyperparameters participate in tuning, and the valid range for each tunable hyperparameter. In
        ...
        :param EvaluationParameters:
          ...
          - **BackTestWindowOffset** *(integer) --*
            ...
            start date. This value must be greater than or equal to the forecast horizon and less than half
          ...
          - **Featurizations** *(list) --*
            ...
            - *(dict) --*
              ...
              - **AttributeName** *(string) --* **[REQUIRED]**
                ...
                the ``RETAIL`` domain, the target is ``demand`` , and for the ``CUSTOM`` domain, the target
                is ``target_value`` .
    ...
    def delete_dataset_group(self, DatasetGroupArn: str) -> None:
        ...
        groups that have a status of ``ACTIVE`` , ``CREATE_FAILED`` , or ``UPDATE_FAILED`` . To get the
    ...
    def delete_dataset_import_job(self, DatasetImportJobArn: str) -> None:
        """
        Deletes a dataset import job created using the  CreateDatasetImportJob operation. You can delete
        only dataset import jobs that have a status of ``ACTIVE`` or ``CREATE_FAILED`` . To get the status,
    ...
    def delete_forecast(self, ForecastArn: str) -> None:
        ...
        have a status of ``ACTIVE`` or ``CREATE_FAILED`` . To get the status, use the  DescribeForecast
        operation.
    ...
    def delete_predictor(self, PredictorArn: str) -> None:
        """
        Deletes a predictor created using the  CreatePredictor operation. You can delete only predictor that
        have a status of ``ACTIVE`` or ``CREATE_FAILED`` . To get the status, use the  DescribePredictor
        operation.
    ...
    def describe_predictor(
        ...
        In addition to listing the properties provided in the ``CreatePredictor`` request, this operation
        lists the following properties:
    ...
    def get_accuracy_metrics(
        ...
        generate a forecast. For more information, see  metrics .

        This operation generates metrics for each backtest window that was evaluated. The number of backtest
        windows (``NumberOfBacktestWindows`` ) is specified using the  EvaluationParameters object, which is
        optionally included in the ``CreatePredictor`` request. If ``NumberOfBacktestWindows`` isn't
        specified, the number defaults to one.

        The parameters of the ``filling`` method determine which items contribute to the metrics. If you
        want all items to contribute, specify ``zero`` . If you want only those items that have complete
        data in the range being evaluated to contribute, specify ``nan`` . For more information, see
        FeaturizationMethod .
    ...
    def list_dataset_import_jobs(
        ...
        DescribeDatasetImportJob operation. You can filter the list by providing an array of  Filter
        objects.
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          is either ``IS`` or ``IS_NOT`` , which specifies whether to include or exclude the datasets that
          match the statement from the list, respectively. The match statement consists of a key and a
          value.
          ...
          * ``Value`` - The value to match.
          ...
          For example, to list all dataset import jobs whose status is ACTIVE, you specify the following
          filter:
    ...
    def list_datasets(
        ...
        of its properties, including its Amazon Resource Name (ARN), is returned. To retrieve the complete
        set of properties, use the ARN with the  DescribeDataset operation.
    ...
    def list_forecast_export_jobs(
        ...
        each forecast export job, this operation returns a summary of its properties, including its Amazon
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          An array of filters. For each filter, you provide a condition and a match statement. The condition
          is either ``IS`` or ``IS_NOT`` , which specifies whether to include or exclude the forecast export
          jobs that match the statement from the list, respectively. The match statement consists of a key
          and a value.

           **Filter properties**

          * ``Condition`` - The condition to apply. Valid values are ``IS`` and ``IS_NOT`` . To include the
          forecast export jobs that match the statement, specify ``IS`` . To exclude matching forecast
    ...
    def list_forecasts(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          An array of filters. For each filter, you provide a condition and a match statement. The condition
          is either ``IS`` or ``IS_NOT`` , which specifies whether to include or exclude the forecasts that
          match the statement from the list, respectively. The match statement consists of a key and a
          value.
    ...
    def list_predictors(
        ...
        operation returns a summary of its properties, including its Amazon Resource Name (ARN). You can
        retrieve the complete set of properties by using the ARN with the  DescribePredictor operation. You
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          An array of filters. For each filter, you provide a condition and a match statement. The condition
          is either ``IS`` or ``IS_NOT`` , which specifies whether to include or exclude the predictors that
          match the statement from the list, respectively. The match statement consists of a key and a
          value.
          ...
          * ``Condition`` - The condition to apply. Valid values are ``IS`` and ``IS_NOT`` . To include the
          predictors that match the statement, specify ``IS`` . To exclude matching predictors, specify
          ``IS_NOT`` .
