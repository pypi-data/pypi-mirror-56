...
class BrickletRotaryEncoderV2(Device):
    ...
    FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION = 2
    FUNCTION_GET_COUNT_CALLBACK_CONFIGURATION = 3
    FUNCTION_IS_PRESSED = 5
    ...
    def __init__(self, uid, ipcon):
        ...
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_GET_COUNT] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_SET_COUNT_CALLBACK_CONFIGURATION] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_GET_COUNT_CALLBACK_CONFIGURATION] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_IS_PRESSED] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_GET_SPITFP_ERROR_COUNT] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_SET_BOOTLOADER_MODE] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_GET_BOOTLOADER_MODE] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_SET_WRITE_FIRMWARE_POINTER] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_FALSE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_WRITE_FIRMWARE] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_SET_STATUS_LED_CONFIG] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_FALSE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_GET_STATUS_LED_CONFIG] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_GET_CHIP_TEMPERATURE] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_ALWAYS_TRUE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_RESET] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_FALSE
        self.response_expected[BrickletRotaryEncoderV2.FUNCTION_WRITE_UID] = BrickletRotaryEncoderV2.RESPONSE_EXPECTED_FALSE
...
RotaryEncoderV2 = BrickletRotaryEncoderV2 # for backward compatibility
