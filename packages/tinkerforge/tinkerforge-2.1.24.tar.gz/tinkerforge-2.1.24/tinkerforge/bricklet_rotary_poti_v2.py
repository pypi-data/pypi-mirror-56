...
class BrickletRotaryPotiV2(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.callback_formats[BrickletRotaryPotiV2.CALLBACK_POSITION] = 'h'
    ...
    def get_position(self):
        ...
        """
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_POSITION, (), '', 'h')
    ...
    def set_position_callback_configuration(self, period, value_has_to_change, option, min, max):
        ...
        self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_SET_POSITION_CALLBACK_CONFIGURATION, (period, value_has_to_change, option, min, max), 'I ! c h h', '')
    ...
    def get_position_callback_configuration(self):
        ...
        """
        return GetPositionCallbackConfiguration(*self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_POSITION_CALLBACK_CONFIGURATION, (), '', 'I ! c h h'))
    ...
    def get_spitfp_error_count(self):
        ...
        * overflow errors.
        ...
        """
        return GetSPITFPErrorCount(*self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_SPITFP_ERROR_COUNT, (), '', 'I I I I'))
    ...
    def set_bootloader_mode(self, mode):
        ...
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_SET_BOOTLOADER_MODE, (mode,), 'B', 'B')

    def get_bootloader_mode(self):
        """
        Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
        """
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_BOOTLOADER_MODE, (), '', 'B')
    ...
    def set_write_firmware_pointer(self, pointer):
        ...
        self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_SET_WRITE_FIRMWARE_POINTER, (pointer,), 'I', '')
    ...
    def write_firmware(self, data):
        ...
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_WRITE_FIRMWARE, (data,), '64B', 'B')
    ...
    def set_status_led_config(self, config):
        ...
        self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_SET_STATUS_LED_CONFIG, (config,), 'B', '')

    def get_status_led_config(self):
        """
        Returns the configuration as set by :func:`Set Status LED Config`
        """
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_STATUS_LED_CONFIG, (), '', 'B')
    ...
    def get_chip_temperature(self):
        ...
        temperature changes.
        """
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_CHIP_TEMPERATURE, (), '', 'h')
    ...
    def reset(self):
        ...
        undefined behavior!
        """
        self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_RESET, (), '', '')
    ...
    def write_uid(self, uid):
        ...
        self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_WRITE_UID, (uid,), 'I', '')
    ...
    def read_uid(self):
        ...
        """
        return self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_READ_UID, (), '', 'I')
    ...
    def get_identity(self):
        ...
        """
        return GetIdentity(*self.ipcon.send_request(self, BrickletRotaryPotiV2.FUNCTION_GET_IDENTITY, (), '', '8s 8s c 3B 3B H'))
