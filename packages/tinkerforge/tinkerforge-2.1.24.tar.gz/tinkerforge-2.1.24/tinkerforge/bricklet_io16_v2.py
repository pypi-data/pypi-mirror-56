...
class BrickletIO16V2(Device):
    ...
    def __init__(self, uid, ipcon):
        ...
        self.callback_formats[BrickletIO16V2.CALLBACK_INPUT_VALUE] = 'B ! !'
        self.callback_formats[BrickletIO16V2.CALLBACK_ALL_INPUT_VALUE] = '16! 16!'
        self.callback_formats[BrickletIO16V2.CALLBACK_MONOFLOP_DONE] = 'B !'
    ...
    def set_value(self, value):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_VALUE, (value,), '16!', '')
    ...
    def get_value(self):
        ...
        """
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_VALUE, (), '', '16!')
    ...
    def set_selected_value(self, channel, value):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_SELECTED_VALUE, (channel, value), 'B !', '')
    ...
    def get_configuration(self, channel):
        ...
        return GetConfiguration(*self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_CONFIGURATION, (channel,), 'B', 'c !'))
    ...
    def set_input_value_callback_configuration(self, channel, period, value_has_to_change):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_INPUT_VALUE_CALLBACK_CONFIGURATION, (channel, period, value_has_to_change), 'B I !', '')
    ...
    def get_input_value_callback_configuration(self, channel):
        ...
        return GetInputValueCallbackConfiguration(*self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_INPUT_VALUE_CALLBACK_CONFIGURATION, (channel,), 'B', 'I !'))
    ...
    def set_all_input_value_callback_configuration(self, period, value_has_to_change):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_ALL_INPUT_VALUE_CALLBACK_CONFIGURATION, (period, value_has_to_change), 'I !', '')
    ...
    def set_monoflop(self, channel, value, time):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_MONOFLOP, (channel, value, time), 'B ! I', '')
    ...
    def get_monoflop(self, channel):
        ...
        return GetMonoflop(*self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_MONOFLOP, (channel,), 'B', '! I I'))
    ...
    def get_edge_count(self, channel, reset_counter):
        ...
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_EDGE_COUNT, (channel, reset_counter), 'B !', 'I')
    ...
    def set_edge_count_configuration(self, channel, edge_type, debounce):
        ...
        * 2 = both
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_EDGE_COUNT_CONFIGURATION, (channel, edge_type, debounce), 'B B B', '')
    ...
    def get_edge_count_configuration(self, channel):
        ...
        return GetEdgeCountConfiguration(*self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_EDGE_COUNT_CONFIGURATION, (channel,), 'B', 'B B'))
    ...
    def get_spitfp_error_count(self):
        ...
        * overflow errors.
        ...
        """
        return GetSPITFPErrorCount(*self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_SPITFP_ERROR_COUNT, (), '', 'I I I I'))
    ...
    def set_bootloader_mode(self, mode):
        ...
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_BOOTLOADER_MODE, (mode,), 'B', 'B')

    def get_bootloader_mode(self):
        """
        Returns the current bootloader mode, see :func:`Set Bootloader Mode`.
        """
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_BOOTLOADER_MODE, (), '', 'B')
    ...
    def set_write_firmware_pointer(self, pointer):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_WRITE_FIRMWARE_POINTER, (pointer,), 'I', '')
    ...
    def write_firmware(self, data):
        ...
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_WRITE_FIRMWARE, (data,), '64B', 'B')
    ...
    def set_status_led_config(self, config):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_SET_STATUS_LED_CONFIG, (config,), 'B', '')

    def get_status_led_config(self):
        """
        Returns the configuration as set by :func:`Set Status LED Config`
        """
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_STATUS_LED_CONFIG, (), '', 'B')
    ...
    def get_chip_temperature(self):
        ...
        temperature changes.
        """
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_CHIP_TEMPERATURE, (), '', 'h')
    ...
    def reset(self):
        ...
        undefined behavior!
        """
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_RESET, (), '', '')
    ...
    def write_uid(self, uid):
        ...
        self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_WRITE_UID, (uid,), 'I', '')
    ...
    def read_uid(self):
        ...
        """
        return self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_READ_UID, (), '', 'I')
    ...
    def get_identity(self):
        ...
        """
        return GetIdentity(*self.ipcon.send_request(self, BrickletIO16V2.FUNCTION_GET_IDENTITY, (), '', '8s 8s c 3B 3B H'))
