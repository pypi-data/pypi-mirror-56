...
class BaseService(object):
    ...
    def add_to_queue_map(self, queue_name: str, func: Callable, auto_ack: bool, prefetch: int, service):
        """
        ...
        :return:
        """
        queue = Queue(queue_name, func, auto_ack=auto_ack, prefetch=prefetch, service=service)
    ...
    def register(
        ...
        def _register(func: Callable):
            ...
            :return:
            """
            self.add_to_queue_map(queue_name, func, auto_ack, prefetch, service)
            return func
    ...
    def get_context(
        ...
        :return: context实例
        """
        context = Context(queue, self.logger, self.connection, channel, method_frame, header_frame, body, service)
