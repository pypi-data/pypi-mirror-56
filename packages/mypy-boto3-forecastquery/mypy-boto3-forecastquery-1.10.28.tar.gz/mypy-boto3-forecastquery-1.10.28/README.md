...
Mypy-friendly auto-generated type annotations for `boto3 forecastquery 1.10.28` service.
...
session_client = session.client("forecastquery")
...
```python
import boto3
from mypy_boto3.forecastquery import Client
