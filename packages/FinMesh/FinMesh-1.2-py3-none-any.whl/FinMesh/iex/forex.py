...
# Latest Rates
FOREX_LATEST_URL = prepend_iex_url(endpoint='fx') + 'latest?'
...
# Currency Conversion
FOREX_CONVERSION_URL = prepend_iex_url(endpoint='fx') + 'convert?'
...
# Historical Data
FOREX_HISTORICAL_URL = prepend_iex_url(endpoint='fx') + 'historical?'
