...
setup(
    ...
    description='Classes for implementing execution chains.',
    long_description=long_description,

    # The project's main homepage (@@ add github url once public)
    url='https://git.getme.co.uk/manhattan/manhattan_chains',
    ...
    packages=find_packages('manhattan_chains'),
    package_dir={'': 'manhattan_chains'},
    ...
    extras_require={
        'flask': ['Flask>=0.11.1'],
        'develop': ['Flask>=0.11.1', 'pytest', 'tox'],
        'test': ['Flask>=0.11.1', 'pytest', 'tox']
    },
