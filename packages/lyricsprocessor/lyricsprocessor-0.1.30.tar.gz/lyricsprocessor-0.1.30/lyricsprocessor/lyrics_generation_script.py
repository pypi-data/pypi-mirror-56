...
def main(api_key, artist_search_term, dropna=True, check_lyrics_state=True, save_raw_df_path='', save_processed_df_path='', save_processed_hdf_key='default', save_txt_path='lyrics.txt'):
