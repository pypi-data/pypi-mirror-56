...
def main(api_key, artist_search_term, dropna, check_lyrics_state, save_raw_df_path, save_processed_df_path, save_txt_path):
	df = fetch_lyrics.main(api_key, artist_search_term, save_path=save_raw_df_path)
	df = process_lyrics.main(api_key, df, dropna, check_lyrics_state, save_path=save_processed_df_path)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_raw_df_path', default='./df_raw.hdf', type=bool,
                        help='where to save the raw df file with everything')
    parser.add_argument('--save_processed_df_path', default='./df.hdf', type=bool,
    ...
    main(args.api_key, args.artist_search_term, args.dropna, args.check_lyrics_state, args.save_raw_df_path, args.save_processed_df_path, args.save_txt_path)