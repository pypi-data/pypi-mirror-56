...
_libnuml.LIBNUML_DOTTED_VERSION_swigconstant(_libnuml)
LIBNUML_DOTTED_VERSION = _libnuml.LIBNUML_DOTTED_VERSION

_libnuml.LIBNUML_VERSION_swigconstant(_libnuml)
LIBNUML_VERSION = _libnuml.LIBNUML_VERSION

_libnuml.LIBNUML_VERSION_STRING_swigconstant(_libnuml)
...
_libnuml.NUML_UNKNOWN_swigconstant(_libnuml)
NUML_UNKNOWN = _libnuml.NUML_UNKNOWN

_libnuml.NUML_DOCUMENT_swigconstant(_libnuml)
NUML_DOCUMENT = _libnuml.NUML_DOCUMENT

_libnuml.NUML_ONTOLOGYTERMS_swigconstant(_libnuml)
NUML_ONTOLOGYTERMS = _libnuml.NUML_ONTOLOGYTERMS

_libnuml.NUML_ONTOLOGYTERM_swigconstant(_libnuml)
NUML_ONTOLOGYTERM = _libnuml.NUML_ONTOLOGYTERM

_libnuml.NUML_RESULTCOMPONENT_swigconstant(_libnuml)
NUML_RESULTCOMPONENT = _libnuml.NUML_RESULTCOMPONENT

_libnuml.NUML_RESULTCOMPONENTS_swigconstant(_libnuml)
NUML_RESULTCOMPONENTS = _libnuml.NUML_RESULTCOMPONENTS

_libnuml.NUML_DIMENSION_swigconstant(_libnuml)
NUML_DIMENSION = _libnuml.NUML_DIMENSION

_libnuml.NUML_DIMENSIONDESCRIPTION_swigconstant(_libnuml)
NUML_DIMENSIONDESCRIPTION = _libnuml.NUML_DIMENSIONDESCRIPTION

_libnuml.NUML_COMPOSITEVALUE_swigconstant(_libnuml)
NUML_COMPOSITEVALUE = _libnuml.NUML_COMPOSITEVALUE

_libnuml.NUML_COMPOSITEVALUES_swigconstant(_libnuml)
NUML_COMPOSITEVALUES = _libnuml.NUML_COMPOSITEVALUES

_libnuml.NUML_TUPLE_swigconstant(_libnuml)
NUML_TUPLE = _libnuml.NUML_TUPLE

_libnuml.NUML_TUPLES_swigconstant(_libnuml)
NUML_TUPLES = _libnuml.NUML_TUPLES

_libnuml.NUML_ATOMICVALUE_swigconstant(_libnuml)
NUML_ATOMICVALUE = _libnuml.NUML_ATOMICVALUE

_libnuml.NUML_ATOMICVALUES_swigconstant(_libnuml)
NUML_ATOMICVALUES = _libnuml.NUML_ATOMICVALUES

_libnuml.NUML_COMPOSITEDESCRIPTION_swigconstant(_libnuml)
NUML_COMPOSITEDESCRIPTION = _libnuml.NUML_COMPOSITEDESCRIPTION

_libnuml.NUML_TUPLEDESCRIPTION_swigconstant(_libnuml)
NUML_TUPLEDESCRIPTION = _libnuml.NUML_TUPLEDESCRIPTION

_libnuml.NUML_ATOMICDESCRIPTION_swigconstant(_libnuml)
NUML_ATOMICDESCRIPTION = _libnuml.NUML_ATOMICDESCRIPTION

_libnuml.NUML_NUMLLIST_swigconstant(_libnuml)
...
class List(_object):
    ...
    __swig_getmethods__["deleteListAndChildrenWith"] = lambda x: deleteListAndChildrenWith
...
_libnuml.MODEL_QUALIFIER_swigconstant(_libnuml)
MODEL_QUALIFIER = _libnuml.MODEL_QUALIFIER

_libnuml.BIOLOGICAL_QUALIFIER_swigconstant(_libnuml)
BIOLOGICAL_QUALIFIER = _libnuml.BIOLOGICAL_QUALIFIER

_libnuml.UNKNOWN_QUALIFIER_swigconstant(_libnuml)
UNKNOWN_QUALIFIER = _libnuml.UNKNOWN_QUALIFIER

_libnuml.BQM_IS_swigconstant(_libnuml)
BQM_IS = _libnuml.BQM_IS

_libnuml.BQM_IS_DESCRIBED_BY_swigconstant(_libnuml)
BQM_IS_DESCRIBED_BY = _libnuml.BQM_IS_DESCRIBED_BY

_libnuml.BQM_IS_DERIVED_FROM_swigconstant(_libnuml)
BQM_IS_DERIVED_FROM = _libnuml.BQM_IS_DERIVED_FROM

_libnuml.BQM_IS_INSTANCE_OF_swigconstant(_libnuml)
BQM_IS_INSTANCE_OF = _libnuml.BQM_IS_INSTANCE_OF

_libnuml.BQM_HAS_INSTANCE_swigconstant(_libnuml)
BQM_HAS_INSTANCE = _libnuml.BQM_HAS_INSTANCE

_libnuml.BQM_UNKNOWN_swigconstant(_libnuml)
BQM_UNKNOWN = _libnuml.BQM_UNKNOWN

_libnuml.BQB_IS_swigconstant(_libnuml)
BQB_IS = _libnuml.BQB_IS

_libnuml.BQB_HAS_PART_swigconstant(_libnuml)
BQB_HAS_PART = _libnuml.BQB_HAS_PART

_libnuml.BQB_IS_PART_OF_swigconstant(_libnuml)
BQB_IS_PART_OF = _libnuml.BQB_IS_PART_OF

_libnuml.BQB_IS_VERSION_OF_swigconstant(_libnuml)
BQB_IS_VERSION_OF = _libnuml.BQB_IS_VERSION_OF

_libnuml.BQB_HAS_VERSION_swigconstant(_libnuml)
BQB_HAS_VERSION = _libnuml.BQB_HAS_VERSION

_libnuml.BQB_IS_HOMOLOG_TO_swigconstant(_libnuml)
BQB_IS_HOMOLOG_TO = _libnuml.BQB_IS_HOMOLOG_TO

_libnuml.BQB_IS_DESCRIBED_BY_swigconstant(_libnuml)
BQB_IS_DESCRIBED_BY = _libnuml.BQB_IS_DESCRIBED_BY

_libnuml.BQB_IS_ENCODED_BY_swigconstant(_libnuml)
BQB_IS_ENCODED_BY = _libnuml.BQB_IS_ENCODED_BY

_libnuml.BQB_ENCODES_swigconstant(_libnuml)
BQB_ENCODES = _libnuml.BQB_ENCODES

_libnuml.BQB_OCCURS_IN_swigconstant(_libnuml)
BQB_OCCURS_IN = _libnuml.BQB_OCCURS_IN

_libnuml.BQB_HAS_PROPERTY_swigconstant(_libnuml)
BQB_HAS_PROPERTY = _libnuml.BQB_HAS_PROPERTY

_libnuml.BQB_IS_PROPERTY_OF_swigconstant(_libnuml)
BQB_IS_PROPERTY_OF = _libnuml.BQB_IS_PROPERTY_OF

_libnuml.BQB_HAS_TAXON_swigconstant(_libnuml)
BQB_HAS_TAXON = _libnuml.BQB_HAS_TAXON

_libnuml.BQB_UNKNOWN_swigconstant(_libnuml)
...
_libnuml.IdCheckON_swigconstant(_libnuml)
IdCheckON = _libnuml.IdCheckON

_libnuml.IdCheckOFF_swigconstant(_libnuml)
IdCheckOFF = _libnuml.IdCheckOFF

_libnuml.NUMLCheckON_swigconstant(_libnuml)
NUMLCheckON = _libnuml.NUMLCheckON

_libnuml.NUMLCheckOFF_swigconstant(_libnuml)
NUMLCheckOFF = _libnuml.NUMLCheckOFF

_libnuml.SBOCheckON_swigconstant(_libnuml)
SBOCheckON = _libnuml.SBOCheckON

_libnuml.SBOCheckOFF_swigconstant(_libnuml)
SBOCheckOFF = _libnuml.SBOCheckOFF

_libnuml.MathCheckON_swigconstant(_libnuml)
MathCheckON = _libnuml.MathCheckON

_libnuml.MathCheckOFF_swigconstant(_libnuml)
MathCheckOFF = _libnuml.MathCheckOFF

_libnuml.UnitsCheckON_swigconstant(_libnuml)
UnitsCheckON = _libnuml.UnitsCheckON

_libnuml.UnitsCheckOFF_swigconstant(_libnuml)
UnitsCheckOFF = _libnuml.UnitsCheckOFF

_libnuml.OverdeterCheckON_swigconstant(_libnuml)
OverdeterCheckON = _libnuml.OverdeterCheckON

_libnuml.OverdeterCheckOFF_swigconstant(_libnuml)
OverdeterCheckOFF = _libnuml.OverdeterCheckOFF

_libnuml.PracticeCheckON_swigconstant(_libnuml)
PracticeCheckON = _libnuml.PracticeCheckON

_libnuml.PracticeCheckOFF_swigconstant(_libnuml)
PracticeCheckOFF = _libnuml.PracticeCheckOFF

_libnuml.AllChecksON_swigconstant(_libnuml)
...
_libnuml.XMLUnknownError_swigconstant(_libnuml)
XMLUnknownError = _libnuml.XMLUnknownError

_libnuml.XMLOutOfMemory_swigconstant(_libnuml)
XMLOutOfMemory = _libnuml.XMLOutOfMemory

_libnuml.XMLFileUnreadable_swigconstant(_libnuml)
XMLFileUnreadable = _libnuml.XMLFileUnreadable

_libnuml.XMLFileUnwritable_swigconstant(_libnuml)
XMLFileUnwritable = _libnuml.XMLFileUnwritable

_libnuml.XMLFileOperationError_swigconstant(_libnuml)
XMLFileOperationError = _libnuml.XMLFileOperationError

_libnuml.XMLNetworkAccessError_swigconstant(_libnuml)
XMLNetworkAccessError = _libnuml.XMLNetworkAccessError

_libnuml.InternalXMLParserError_swigconstant(_libnuml)
InternalXMLParserError = _libnuml.InternalXMLParserError

_libnuml.UnrecognizedXMLParserCode_swigconstant(_libnuml)
UnrecognizedXMLParserCode = _libnuml.UnrecognizedXMLParserCode

_libnuml.XMLTranscoderError_swigconstant(_libnuml)
XMLTranscoderError = _libnuml.XMLTranscoderError

_libnuml.MissingXMLDecl_swigconstant(_libnuml)
MissingXMLDecl = _libnuml.MissingXMLDecl

_libnuml.MissingXMLEncoding_swigconstant(_libnuml)
MissingXMLEncoding = _libnuml.MissingXMLEncoding

_libnuml.BadXMLDecl_swigconstant(_libnuml)
BadXMLDecl = _libnuml.BadXMLDecl

_libnuml.BadXMLDOCTYPE_swigconstant(_libnuml)
BadXMLDOCTYPE = _libnuml.BadXMLDOCTYPE

_libnuml.InvalidCharInXML_swigconstant(_libnuml)
InvalidCharInXML = _libnuml.InvalidCharInXML

_libnuml.BadlyFormedXML_swigconstant(_libnuml)
BadlyFormedXML = _libnuml.BadlyFormedXML

_libnuml.UnclosedXMLToken_swigconstant(_libnuml)
UnclosedXMLToken = _libnuml.UnclosedXMLToken

_libnuml.InvalidXMLConstruct_swigconstant(_libnuml)
InvalidXMLConstruct = _libnuml.InvalidXMLConstruct

_libnuml.XMLTagMismatch_swigconstant(_libnuml)
XMLTagMismatch = _libnuml.XMLTagMismatch

_libnuml.DuplicateXMLAttribute_swigconstant(_libnuml)
DuplicateXMLAttribute = _libnuml.DuplicateXMLAttribute

_libnuml.UndefinedXMLEntity_swigconstant(_libnuml)
UndefinedXMLEntity = _libnuml.UndefinedXMLEntity

_libnuml.BadProcessingInstruction_swigconstant(_libnuml)
BadProcessingInstruction = _libnuml.BadProcessingInstruction

_libnuml.BadXMLPrefix_swigconstant(_libnuml)
BadXMLPrefix = _libnuml.BadXMLPrefix

_libnuml.BadXMLPrefixValue_swigconstant(_libnuml)
BadXMLPrefixValue = _libnuml.BadXMLPrefixValue

_libnuml.MissingXMLRequiredAttribute_swigconstant(_libnuml)
MissingXMLRequiredAttribute = _libnuml.MissingXMLRequiredAttribute

_libnuml.XMLAttributeTypeMismatch_swigconstant(_libnuml)
XMLAttributeTypeMismatch = _libnuml.XMLAttributeTypeMismatch

_libnuml.XMLBadUTF8Content_swigconstant(_libnuml)
XMLBadUTF8Content = _libnuml.XMLBadUTF8Content

_libnuml.MissingXMLAttributeValue_swigconstant(_libnuml)
MissingXMLAttributeValue = _libnuml.MissingXMLAttributeValue

_libnuml.BadXMLAttributeValue_swigconstant(_libnuml)
BadXMLAttributeValue = _libnuml.BadXMLAttributeValue

_libnuml.BadXMLAttribute_swigconstant(_libnuml)
BadXMLAttribute = _libnuml.BadXMLAttribute

_libnuml.UnrecognizedXMLElement_swigconstant(_libnuml)
UnrecognizedXMLElement = _libnuml.UnrecognizedXMLElement

_libnuml.BadXMLComment_swigconstant(_libnuml)
BadXMLComment = _libnuml.BadXMLComment

_libnuml.BadXMLDeclLocation_swigconstant(_libnuml)
BadXMLDeclLocation = _libnuml.BadXMLDeclLocation

_libnuml.XMLUnexpectedEOF_swigconstant(_libnuml)
XMLUnexpectedEOF = _libnuml.XMLUnexpectedEOF

_libnuml.BadXMLIDValue_swigconstant(_libnuml)
BadXMLIDValue = _libnuml.BadXMLIDValue

_libnuml.BadXMLIDRef_swigconstant(_libnuml)
BadXMLIDRef = _libnuml.BadXMLIDRef

_libnuml.UninterpretableXMLContent_swigconstant(_libnuml)
UninterpretableXMLContent = _libnuml.UninterpretableXMLContent

_libnuml.BadXMLDocumentStructure_swigconstant(_libnuml)
BadXMLDocumentStructure = _libnuml.BadXMLDocumentStructure

_libnuml.InvalidAfterXMLContent_swigconstant(_libnuml)
InvalidAfterXMLContent = _libnuml.InvalidAfterXMLContent

_libnuml.XMLExpectedQuotedString_swigconstant(_libnuml)
XMLExpectedQuotedString = _libnuml.XMLExpectedQuotedString

_libnuml.XMLEmptyValueNotPermitted_swigconstant(_libnuml)
XMLEmptyValueNotPermitted = _libnuml.XMLEmptyValueNotPermitted

_libnuml.XMLBadNumber_swigconstant(_libnuml)
XMLBadNumber = _libnuml.XMLBadNumber

_libnuml.XMLBadColon_swigconstant(_libnuml)
XMLBadColon = _libnuml.XMLBadColon

_libnuml.MissingXMLElements_swigconstant(_libnuml)
MissingXMLElements = _libnuml.MissingXMLElements

_libnuml.XMLContentEmpty_swigconstant(_libnuml)
XMLContentEmpty = _libnuml.XMLContentEmpty

_libnuml.XMLErrorCodesUpperBound_swigconstant(_libnuml)
XMLErrorCodesUpperBound = _libnuml.XMLErrorCodesUpperBound

_libnuml.LIBSBML_CAT_INTERNAL_swigconstant(_libnuml)
LIBSBML_CAT_INTERNAL = _libnuml.LIBSBML_CAT_INTERNAL

_libnuml.LIBSBML_CAT_SYSTEM_swigconstant(_libnuml)
LIBSBML_CAT_SYSTEM = _libnuml.LIBSBML_CAT_SYSTEM

_libnuml.LIBSBML_CAT_XML_swigconstant(_libnuml)
LIBSBML_CAT_XML = _libnuml.LIBSBML_CAT_XML

_libnuml.LIBSBML_SEV_INFO_swigconstant(_libnuml)
LIBSBML_SEV_INFO = _libnuml.LIBSBML_SEV_INFO

_libnuml.LIBSBML_SEV_WARNING_swigconstant(_libnuml)
LIBSBML_SEV_WARNING = _libnuml.LIBSBML_SEV_WARNING

_libnuml.LIBSBML_SEV_ERROR_swigconstant(_libnuml)
LIBSBML_SEV_ERROR = _libnuml.LIBSBML_SEV_ERROR

_libnuml.LIBSBML_SEV_FATAL_swigconstant(_libnuml)
LIBSBML_SEV_FATAL = _libnuml.LIBSBML_SEV_FATAL

_libnuml.LIBSBML_OVERRIDE_DISABLED_swigconstant(_libnuml)
LIBSBML_OVERRIDE_DISABLED = _libnuml.LIBSBML_OVERRIDE_DISABLED

_libnuml.LIBSBML_OVERRIDE_DONT_LOG_swigconstant(_libnuml)
LIBSBML_OVERRIDE_DONT_LOG = _libnuml.LIBSBML_OVERRIDE_DONT_LOG

_libnuml.LIBSBML_OVERRIDE_WARNING_swigconstant(_libnuml)
LIBSBML_OVERRIDE_WARNING = _libnuml.LIBSBML_OVERRIDE_WARNING

_libnuml.LIBSBML_OVERRIDE_ERROR_swigconstant(_libnuml)
