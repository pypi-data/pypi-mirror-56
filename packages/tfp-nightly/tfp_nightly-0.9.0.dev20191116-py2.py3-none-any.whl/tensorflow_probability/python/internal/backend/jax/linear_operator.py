...
from tensorflow_probability.python.internal.backend.jax import ops as module
...
from tensorflow_probability.python.internal.backend.jax import linear_operator_algebra
