...
from tensorflow_probability.python.experimental.substrates.jax import math as tfp_math
from tensorflow_probability.python.experimental.substrates.jax.bijectors import kumaraswamy as kumaraswamy_bijector
