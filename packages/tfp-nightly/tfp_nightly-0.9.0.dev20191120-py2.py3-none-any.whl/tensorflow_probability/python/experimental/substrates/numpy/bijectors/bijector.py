...
class Bijector(tf.Module):
  ...
  **WARNING** Handing of non-injective transforms is subject to change.
  ...
  def __call__(self, value, name=None, **kwargs):
    ...
    from tensorflow_probability.python.experimental.substrates.numpy.bijectors import chain  # pylint: disable=g-import-not-at-top
    from tensorflow_probability.python.experimental.substrates.numpy.distributions import distribution  # pylint: disable=g-import-not-at-top
    from tensorflow_probability.python.experimental.substrates.numpy.distributions import transformed_distribution  # pylint: disable=g-import-not-at-top
