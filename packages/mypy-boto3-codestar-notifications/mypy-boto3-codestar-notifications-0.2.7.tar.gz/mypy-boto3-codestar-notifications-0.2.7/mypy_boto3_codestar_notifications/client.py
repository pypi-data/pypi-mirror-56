    ...
    def create_notification_rule(
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          cannot be repeated with a changed parameter. If a request with the same parameters is received and
    ...
    def delete_target(
        ...
        **Request Syntax**
        ...
        :param ForceUnsubscribeAll:
          ...
          A Boolean value that can be used to delete all associations with this SNS topic. The default value
    ...
    def list_targets(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          type, target address, and target status.
          ...
          - *(dict) --*
            ...
            - **Value** *(string) --* **[REQUIRED]**
              ...
              specify *SNS* for the Target type, you could specify an Amazon Resource Name (ARN) for a topic
              as the value.
