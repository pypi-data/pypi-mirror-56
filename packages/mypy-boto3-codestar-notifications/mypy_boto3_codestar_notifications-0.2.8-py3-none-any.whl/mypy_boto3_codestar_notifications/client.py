...
class Client(BaseClient):
    ...
    def create_notification_rule(
        ...
        **Request Syntax**
        ...
        :param DetailType: **[REQUIRED]**
          ...
          The level of detail to include in the notifications for this resource. BASIC will include
          only the contents of the event as it would appear in AWS CloudWatch. FULL will include any
        ...
        :param ClientRequestToken:
          ...
          request cannot be repeated with a changed parameter. If a request with the same parameters
          is received and a token is included, the request returns information about the initial
    ...
    def delete_target(self, TargetAddress: str, ForceUnsubscribeAll: bool = None) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param ForceUnsubscribeAll:
          ...
          A Boolean value that can be used to delete all associations with this SNS topic. The
          default value is FALSE. If set to TRUE, all associations between that target and every
          notification rule in your AWS account are deleted.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DetailType** *(string) --*
              ...
              include only the contents of the event as it would appear in AWS CloudWatch. FULL will
              include any supplemental information provided by AWS CodeStar Notifications and/or the
            ...
            - **Status** *(string) --*
              ...
              The status of the notification rule. Valid statuses are on (sending notifications) or
              off (not sending notifications).
    ...
    def list_event_types(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          A non-negative integer used to limit the number of returned results. The default number is
          50. The maximum number of results that can be returned is 100.
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            Information about a filter to apply to the list of returned notification rules. You can
            ...
            - **Value** *(string) --* **[REQUIRED]**
              ...
              For example, if you specify filtering by *RESOURCE* in Name, you might specify the ARN
              of a pipeline in AWS CodePipeline for the value.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NotificationRules** *(list) --*
              ...
              The list of notification rules for the AWS account, by Amazon Resource Name (ARN) and
              ID.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def tag_resource(self, Arn: str, Tags: List[str]) -> ClientTagResourceResponseTypeDef:
        """
    ...
    def unsubscribe(self, Arn: str, TargetAddress: str) -> ClientUnsubscribeResponseTypeDef:
        ...
        subscribers to that topic stop receiving notifications when the events described in the rule
        are triggered.
