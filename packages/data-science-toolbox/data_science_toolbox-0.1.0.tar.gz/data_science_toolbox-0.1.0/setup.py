...
package_data = \
{'': ['*'],
 'data_science_toolbox': ['gists/*',
                          'gists/io/*',
                          'gists/io/.ipynb_checkpoints/*',
                          'gists/ml/*'],
 'data_science_toolbox.assertions': ['dictionary/*'],
 'data_science_toolbox.etl': ['.ipynb_checkpoints/*',
                              'custom_transformers/*',
                              'custom_transformers/.ipynb_checkpoints/*',
                              'custom_transformers/DF/*',
                              'custom_transformers/DF/.ipynb_checkpoints/*'],
 'data_science_toolbox.io': ['.ipynb_checkpoints/*'],
 'data_science_toolbox.ml': ['.ipynb_checkpoints/*',
                             'feature_engineering/*',
                             'feature_engineering/.ipynb_checkpoints/*',
                             'feature_list/*',
                             'feature_list/.ipynb_checkpoints/*',
                             'scoring/*',
