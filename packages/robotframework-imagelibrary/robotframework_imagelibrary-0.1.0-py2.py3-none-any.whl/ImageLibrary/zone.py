...
class Zone(object):
    ...
    def get_number_from_zone(self, cache=False, zone=None, lang=None, resize_percent=0, resize=0, contrast=0,
        ...
        if background is not None:
            img = ImageProcessor(self.error_handler, self.screenshot_folder).get_image_to_recognize_with_background(
                zone, cache, resize_percent, contrast, background, brightness, invert)
        else:
            img = ImageProcessor(self.error_handler, self.screenshot_folder).get_image_to_recognize(zone, cache,
                                                                                                    resize_percent,
                                                                                                    contrast, invert,
                                                                                                    brightness,
                                                                                                    change_mode,
        ...
        img.save(os.path.join(self.screenshot_folder, 'ImageLibrary_Zone_Image.png'))
    ...
    @utils.add_error_info
    def get_float_number_from_zone(self, cache=False, zone=None, lang=None, resize_percent=0, resize=0, contrast=0,
                                   invert=False, brightness=0, change_mode=True, tessdata_dir=None):
    ...
    @utils.add_error_info
    def get_number_with_text_from_zone(self, cache=False, zone=None, lang=None, resize_percent=0, resize=0, contrast=0,
                                       background=None, invert=False, brightness=0, change_mode=True, tessdata_dir=None):
        ...
        if background is not None:
            img = ImageProcessor(self.error_handler, self.screenshot_folder).get_image_to_recognize_with_background(
                zone, cache, resize_percent, contrast, invert, brightness, change_mode)
        else:
            img = ImageProcessor(self.error_handler, self.screenshot_folder).get_image_to_recognize(zone, cache,
                                                                                                    resize_percent,
                                                                                                    contrast, invert,
    ...
    @utils.add_error_info
    def get_text_from_zone(self, zone=None, lang=None, resize_percent=0, contrast=0, cache=False, invert=False,
                           brightness=0, change_mode=True, tessdata_dir=None):
