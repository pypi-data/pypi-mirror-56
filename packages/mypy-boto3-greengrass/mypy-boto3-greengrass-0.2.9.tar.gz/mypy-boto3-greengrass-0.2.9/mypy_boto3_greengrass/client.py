...
class Client(BaseClient):
    ...
    def associate_role_to_group(
        ...
        **Request Syntax**
        ...
        :type RoleArn: string
        :param RoleArn: **[REQUIRED]** The ARN of the role you wish to associate with this group.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **AssociatedAt** *(string) --* The time, in milliseconds since the epoch, when the
            role ARN was associated with the group.
        """
    ...
    def associate_service_role_to_account(
        ...
        **Request Syntax**
        ...
        :type RoleArn: string
        :param RoleArn: **[REQUIRED]** The ARN of the service role you wish to associate with your
        account.
    ...
    def create_connector_definition(
        ...
        **Request Syntax**
        ...
        :param InitialVersion: Information about the initial version of the connector definition.
          ...
          - **Connectors** *(list) --* A list of references to connectors in this version, with
          their corresponding configuration settings.
            ...
            cloud services.
              ...
              - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the connector.
              This value must be unique within the connector definition version. Max length is 128
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Id** *(string) --* The ID of the parent definition that the version is associated
            with.
        ...
        :param InitialVersion: Information about the initial version of the core definition.
          ...
          - **Cores** *(list) --* A list of cores in the core definition version.
            ...
            - *(dict) --* Information about a core.
              ...
              - **CertificateArn** *(string) --* **[REQUIRED]** The ARN of the certificate
              associated with the core.

              - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the core. This
              value must be unique within the core definition version. Max length is 128 characters
              with pattern ''[a-zA-Z0-9:_-]+''.

              - **SyncShadow** *(boolean) --* If true, the core's local shadow is automatically
        ...
        **Request Syntax**
        ...
        :param Cores: A list of cores in the core definition version.
          ...
          - *(dict) --* Information about a core.
            ...
            - **CertificateArn** *(string) --* **[REQUIRED]** The ARN of the certificate associated
            with the core.
    ...
    def create_deployment(
        ...
        **Request Syntax**
        ...
        :param DeploymentType: **[REQUIRED]** The type of deployment. When used for
        ''CreateDeployment'', only ''NewDeployment'' and ''Redeployment'' are valid.
        ...
        :param InitialVersion: Information about the initial version of the device definition.
          ...
          - **Devices** *(list) --* A list of devices in the definition version.
            ...
            - *(dict) --* Information about a device.
              ...
              - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the device.
              This value must be unique within the device definition version. Max length is 128
              characters with pattern ''[a-zA-Z0-9:_-]+''.

              - **SyncShadow** *(boolean) --* If true, the device's local shadow will be
        ...
        **Request Syntax**
        ...
        :param InitialVersion: Information about the initial version of the function definition.
          ...
          these settings.
            ...
            - **Execution** *(dict) --* Configuration information that specifies how a Lambda
            function runs.
              ...
              running the Lambda function. You can specify one or both values to override the
              default values. We recommend that you avoid running as root unless absolutely
              necessary to minimize the risk of unintended changes or malicious attacks. To run as
              root, you must set ''IsolationMode'' to ''NoContainer'' and update config.json in
          ...
          - **Functions** *(list) --* A list of Lambda functions in this function definition
          version.
            ...
            - *(dict) --* Information about a Lambda function.
              ...
              - **FunctionConfiguration** *(dict) --* The configuration of the Lambda function.
                ...
                - **Environment** *(dict) --* The environment configuration of the function.
                  ...
                  - **Execution** *(dict) --* Configuration related to executing the Lambda function
                    ...
                    - **IsolationMode** *(string) --* Specifies whether the Lambda function runs in
                    a Greengrass container (default) or without containerization. Unless your
                    scenario requires that you run without containerization, we recommend that you
                    run in a Greengrass container. Omit this value to run the Lambda function with
                    ...
                    attacks. To run as root, you must set ''IsolationMode'' to ''NoContainer'' and
                    update config.json in ''greengrass-root/config'' to set
                    ''allowFunctionsToRunAsRoot'' to ''yes''.

                      - **Gid** *(integer) --* The group ID whose permissions are used to run a
                      Lambda function.

                      - **Uid** *(integer) --* The user ID whose permissions are used to run a
                      Lambda function.

                  - **ResourceAccessPolicies** *(list) --* A list of the resources, with their
                  permissions, to which the Lambda function will be granted access. A Lambda
                  function can have at most 10 resources. ResourceAccessPolicies apply only when you
                  run the Lambda function in a Greengrass container.
                    ...
                    - *(dict) --* A policy used by the function to access a resource.
                      ...
                      - **ResourceId** *(string) --* **[REQUIRED]** The ID of the resource. (This ID
                      is assigned to the resource when you create the resource definiton.)
                ...
                This setting is not applicable and should be cleared when you run the Lambda
                function without containerization.

                - **Pinned** *(boolean) --* True if the function is pinned. Pinned means the
              ...
              - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the function.
              This value must be unique within the function definition version. Max length is 128
              characters with pattern ''[a-zA-Z0-9:_-]+''.
    ...
    def create_group(
        ...
        **Request Syntax**
        ...
        :param InitialVersion: Information about the initial version of the group.
          ...
          - **ConnectorDefinitionVersionArn** *(string) --* The ARN of the connector definition
          version for this group.

          - **CoreDefinitionVersionArn** *(string) --* The ARN of the core definition version for
          this group.

          - **DeviceDefinitionVersionArn** *(string) --* The ARN of the device definition version
          for this group.

          - **FunctionDefinitionVersionArn** *(string) --* The ARN of the function definition
          version for this group.

          - **LoggerDefinitionVersionArn** *(string) --* The ARN of the logger definition version
          for this group.

          - **ResourceDefinitionVersionArn** *(string) --* The ARN of the resource definition
          version for this group.

          - **SubscriptionDefinitionVersionArn** *(string) --* The ARN of the subscription
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the new active CA ARN.
            ...
            - **GroupCertificateAuthorityArn** *(string) --* The ARN of the group certificate
            authority.
        """
    ...
    def create_group_version(
        ...
        **Request Syntax**
        ...
        :param ConnectorDefinitionVersionArn: The ARN of the connector definition version for this
        group.
        ...
        :param FunctionDefinitionVersionArn: The ARN of the function definition version for this
        group.
        ...
        :param ResourceDefinitionVersionArn: The ARN of the resource definition version for this
        group.

        :type SubscriptionDefinitionVersionArn: string
        :param SubscriptionDefinitionVersionArn: The ARN of the subscription definition version for
        this group.
        ...
        :param InitialVersion: Information about the initial version of the logger definition.
          ...
          - **Loggers** *(list) --* A list of loggers.
            ...
            - *(dict) --* Information about a logger
              ...
              - **Component** *(string) --* **[REQUIRED]** The component that will be subject to
              logging.

              - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the logger.
              This value must be unique within the logger definition version. Max length is 128
              characters with pattern ''[a-zA-Z0-9:_-]+''.
        ...
        :param InitialVersion: Information about the initial version of the resource definition.
          ...
          - **Resources** *(list) --* A list of resources.
            ...
            - *(dict) --* Information about a resource.
              ...
              - **Id** *(string) --* **[REQUIRED]** The resource ID, used to refer to a resource in
              the Lambda function configuration. Max length is 128 characters with pattern
              ''[a-zA-Z0-9:_-]+''. This must be unique within a Greengrass group.

              - **Name** *(string) --* **[REQUIRED]** The descriptive resource name, which is
              displayed on the AWS IoT Greengrass console. Max length 128 characters with pattern
              ''[a-zA-Z0-9:_-]+''. This must be unique within a Greengrass group.

              - **ResourceDataContainer** *(dict) --* **[REQUIRED]** A container of data for all
              resource types.

                - **LocalDeviceResourceData** *(dict) --* Attributes that define the local device
                resource.

                  - **GroupOwnerSetting** *(dict) --* Group/owner related settings for local
                  resources.
                    ...
                    - **GroupOwner** *(string) --* The name of the Linux OS group whose privileges
                ...
                resource.
                  ...
                  - **SourcePath** *(string) --* The local absolute path of the volume resource on
                  the host. The source path for a volume resource type cannot start with ''/sys''.

                - **S3MachineLearningModelResourceData** *(dict) --* Attributes that define an
                Amazon S3 machine learning resource.

                  - **DestinationPath** *(string) --* The absolute local path of the resource inside
                  the Lambda environment.

                  - **OwnerSetting** *(dict) --* The owner setting for downloaded machine learning
                  resources.

                    - **GroupOwner** *(string) --* **[REQUIRED]** The group owner of the resource.
                    This is the name of an existing Linux OS group on the system or a GID. The
                    group's permissions are added to the Lambda process.

                    - **GroupPermission** *(string) --* **[REQUIRED]** The permissions that the
                    group owner has to the resource. Valid values are ''rw'' (read/write) or ''ro''
                    (read-only).

                  - **S3Uri** *(string) --* The URI of the source model in an S3 bucket. The model
                  package must be in tar.gz or .zip format.

                - **SageMakerMachineLearningModelResourceData** *(dict) --* Attributes that define
                an Amazon SageMaker machine learning resource.
                  ...
                  - **SageMakerJobArn** *(string) --* The ARN of the Amazon SageMaker training job
                ...
                resource, which references a secret from AWS Secrets Manager.
                  ...
                  whose values you want to make available on the core, in addition to
                  ''AWSCURRENT''.
            ...
            resource types.
              ...
              S3 machine learning resource.
                ...
                resources.
                  ...
                  - **GroupOwner** *(string) --* **[REQUIRED]** The group owner of the resource.
                  This is the name of an existing Linux OS group on the system or a GID. The group's
                  permissions are added to the Lambda process.

                  - **GroupPermission** *(string) --* **[REQUIRED]** The permissions that the group
                  owner has to the resource. Valid values are ''rw'' (read/write) or ''ro''
                  (read-only).
    ...
    def create_software_update_job(
        ...
        **Request Syntax**
        ...
        :param S3UrlSignerRole: **[REQUIRED]** The IAM Role that Greengrass will use to create
        pre-signed URLs pointing towards the update artifact.

        :type SoftwareToUpdate: string
        :param SoftwareToUpdate: **[REQUIRED]** The piece of software on the Greengrass core that
        will be updated.

        :type UpdateAgentLogLevel: string
        :param UpdateAgentLogLevel: The minimum level of log statements that should be logged by the
        OTA Agent during an update.

        :type UpdateTargets: list
        :param UpdateTargets: **[REQUIRED]** The ARNs of the targets (IoT things or IoT thing
        groups) that this update will be applied to.
        ...
        :param UpdateTargetsOperatingSystem: **[REQUIRED]** The operating system of the cores which
        are the targets of an update.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **PlatformSoftwareVersion** *(string) --* The software version installed on the device
            or devices after the update.
        """
        ...
        :param InitialVersion: Information about the initial version of the subscription definition.
          ...
          - **Subscriptions** *(list) --* A list of subscriptions.
            ...
            - *(dict) --* Information about a subscription.
              ...
              - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the
              subscription. This value must be unique within the subscription definition version.
              Max length is 128 characters with pattern ''[a-zA-Z0-9:_-]+''.

              - **Source** *(string) --* **[REQUIRED]** The source of the subscription. Can be a
              thing ARN, a Lambda function ARN, a connector ARN, 'cloud' (which represents the AWS
              IoT cloud), or 'GGShadowService'.

              - **Subject** *(string) --* **[REQUIRED]** The MQTT topic used to route the message.

              - **Target** *(string) --* **[REQUIRED]** Where the message is sent to. Can be a thing
        ...
        **Request Syntax**
        ...
        :param Subscriptions: A list of subscriptions.
          ...
          - *(dict) --* Information about a subscription.
            ...
            - **Id** *(string) --* **[REQUIRED]** A descriptive or arbitrary ID for the
            subscription. This value must be unique within the subscription definition version. Max
            length is 128 characters with pattern ''[a-zA-Z0-9:_-]+''.

            - **Source** *(string) --* **[REQUIRED]** The source of the subscription. Can be a thing
            ARN, a Lambda function ARN, a connector ARN, 'cloud' (which represents the AWS IoT
            cloud), or 'GGShadowService'.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **DisassociatedAt** *(string) --* The time, in milliseconds since the epoch, when the
            role was disassociated from the group.
        """
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **DisassociatedAt** *(string) --* The time when the service role was disassociated
            from the account.
        """
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the status of the bulk deployment.
            ...
            - **BulkDeploymentMetrics** *(dict) --* Relevant metrics on input records processed
            during bulk deployment.

              - **InvalidInputRecords** *(integer) --* The total number of records that returned a
              non-retryable error. For example, this can occur if a group record from the input file
              uses an invalid format or specifies a nonexistent group version, or if the execution
              role doesn't grant permission to deploy a group or group version.

              - **RecordsProcessed** *(integer) --* The total number of group records from the input
              file that have been processed so far, or attempted.

              - **RetryAttempts** *(integer) --* The total number of deployment attempts that
              returned a retryable error. For example, a retry is triggered if the attempt to deploy
              a group returns a throttling error. ''StartBulkDeployment'' retries a group deployment
              up to five times.
          ...
          - *(dict) --* success
            ...
            - **ConnectivityInfo** *(list) --* Connectivity info list.
              ...
              - *(dict) --* Information about a Greengrass core's connectivity.
                ...
                - **HostAddress** *(string) --* The endpoint for the Greengrass core. Can be an IP
                address or DNS.
    ...
    def get_connector_definition_version(
        ...
        **Request Syntax**
        ...
        :param ConnectorDefinitionVersionId: **[REQUIRED]** The ID of the connector definition
        version. This value maps to the ''Version'' property of the corresponding
        ''VersionInformation'' object, which is returned by ''ListConnectorDefinitionVersions''
        requests. If the version is the last one that was associated with a connector definition,
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the connector definition version was created.
            ...
            - **Definition** *(dict) --* Information about the connector definition version.
              ...
              their corresponding configuration settings.
                ...
                - *(dict) --* Information about a connector. Connectors run on the Greengrass core
                and contain built-in integration with local infrastructure, device protocols, AWS,
                and other cloud services.

                  - **ConnectorArn** *(string) --* The ARN of the connector.

                  - **Id** *(string) --* A descriptive or arbitrary ID for the connector. This value
                  must be unique within the connector definition version. Max length is 128
                  characters with pattern [a-zA-Z0-9:_-]+.

                  - **Parameters** *(dict) --* The parameters or configuration that the connector
                  uses.
            ...
            - **NextToken** *(string) --* The token for the next set of results, or ''null'' if
    ...
    def get_core_definition_version(
        ...
        **Request Syntax**
        ...
        :param CoreDefinitionVersionId: **[REQUIRED]** The ID of the core definition version. This
        value maps to the ''Version'' property of the corresponding ''VersionInformation'' object,
        which is returned by ''ListCoreDefinitionVersions'' requests. If the version is the last one
        that was associated with a core definition, the value also maps to the ''LatestVersion''
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the core definition version was created.
            ...
            - **Definition** *(dict) --* Information about the core definition version.
              ...
              - **Cores** *(list) --* A list of cores in the core definition version.
                ...
                - *(dict) --* Information about a core.
                  ...
                  - **CertificateArn** *(string) --* The ARN of the certificate associated with the
                  core.

                  - **Id** *(string) --* A descriptive or arbitrary ID for the core. This value must
                  be unique within the core definition version. Max length is 128 characters with
                  pattern ''[a-zA-Z0-9:_-]+''.
        ...
        **Request Syntax**
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the status of the deployment for the
          group.
            ...
            - **UpdatedAt** *(string) --* The time, in milliseconds since the epoch, when the
            deployment status was updated.
        """
    ...
    def get_device_definition_version(
        ...
        **Request Syntax**
        ...
        This value maps to the ''Version'' property of the corresponding ''VersionInformation''
        object, which is returned by ''ListDeviceDefinitionVersions'' requests. If the version is
        the last one that was associated with a device definition, the value also maps to the
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the device definition version was created.
            ...
            - **Definition** *(dict) --* Information about the device definition version.
              ...
              - **Devices** *(list) --* A list of devices in the definition version.
                ...
                - *(dict) --* Information about a device.
                  ...
                  - **Id** *(string) --* A descriptive or arbitrary ID for the device. This value
                  must be unique within the device definition version. Max length is 128 characters
                  with pattern ''[a-zA-Z0-9:_-]+''.
    ...
    def get_function_definition_version(
        ...
        **Request Syntax**
        ...
        :param FunctionDefinitionVersionId: **[REQUIRED]** The ID of the function definition
        version. This value maps to the ''Version'' property of the corresponding
        ''VersionInformation'' object, which is returned by ''ListFunctionDefinitionVersions''
        requests. If the version is the last one that was associated with a function definition, the
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the function definition version was created.

            - **Definition** *(dict) --* Information on the definition.

              - **DefaultConfig** *(dict) --* The default configuration that applies to all Lambda
              functions in this function definition version. Individual Lambda functions can
              ...
              version.
                ...
                - *(dict) --* Information about a Lambda function.
                  ...
                  - **FunctionConfiguration** *(dict) --* The configuration of the Lambda function.
                    ...
                    - **EncodingType** *(string) --* The expected encoding type of the input payload
                    for the function. The default is ''json''.

                    - **Environment** *(dict) --* The environment configuration of the function.

                      - **AccessSysfs** *(boolean) --* If true, the Lambda function is allowed to
                      access the host's /sys folder. Use this when the Lambda function needs to read
                      device information from /sys. This setting applies only when you run the
                      Lambda function in a Greengrass container.

                      - **Execution** *(dict) --* Configuration related to executing the Lambda
                      function

                        - **IsolationMode** *(string) --* Specifies whether the Lambda function runs
                        in a Greengrass container (default) or without containerization. Unless your
                        scenario requires that you run without containerization, we recommend that
                        you run in a Greengrass container. Omit this value to run the Lambda
                        function with the default containerization for the group.

                        - **RunAs** *(dict) --* Specifies the user and group whose permissions are
                        used when running the Lambda function. You can specify one or both values to
                        override the default values. We recommend that you avoid running as root
                      ...
                      - **ResourceAccessPolicies** *(list) --* A list of the resources, with their
                      permissions, to which the Lambda function will be granted access. A Lambda
                      function can have at most 10 resources. ResourceAccessPolicies apply only when
                      you run the Lambda function in a Greengrass container.

                        - *(dict) --* A policy used by the function to access a resource.

                          - **Permission** *(string) --* The permissions that the Lambda function
                          has to the resource. Can be one of ''rw'' (read/write) or ''ro''
                          (read-only).

                          - **ResourceId** *(string) --* The ID of the resource. (This ID is
                    ...
                    - **MemorySize** *(integer) --* The memory size, in KB, which the function
                    requires. This setting is not applicable and should be cleared when you run the
                    Lambda function without containerization.

                    - **Pinned** *(boolean) --* True if the function is pinned. Pinned means the
                    function is long-lived and starts when the core starts.

                    - **Timeout** *(integer) --* The allowed function execution time, after which
                    Lambda should terminate the function. This timeout still applies to pinned
                    Lambda functions for each request.

                  - **Id** *(string) --* A descriptive or arbitrary ID for the function. This value
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the PKI Configuration.
            ...
            - **GroupCertificateAuthorityArn** *(string) --* The ARN of the certificate authority
            for the group.

            - **GroupCertificateAuthorityId** *(string) --* The ID of the certificate authority for
            the group.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the PKI Configuration.
            ...
            - **CertificateAuthorityExpiryInMilliseconds** *(string) --* The amount of time
            remaining before the certificate authority expires, in milliseconds.

            - **CertificateExpiryInMilliseconds** *(string) --* The amount of time remaining before
            the certificate expires, in milliseconds.
    ...
    def get_group_version(
        ...
        **Request Syntax**
        ...
        ''Version'' property of the corresponding ''VersionInformation'' object, which is returned
        by ''ListGroupVersions'' requests. If the version is the last one that was associated with a
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **Definition** *(dict) --* Information about the group version definition.
              ...
              - **CoreDefinitionVersionArn** *(string) --* The ARN of the core definition version
              for this group.

              - **DeviceDefinitionVersionArn** *(string) --* The ARN of the device definition
              version for this group.

              - **FunctionDefinitionVersionArn** *(string) --* The ARN of the function definition
              version for this group.

              - **LoggerDefinitionVersionArn** *(string) --* The ARN of the logger definition
              version for this group.
    ...
    def get_logger_definition_version(
        ...
        **Request Syntax**
        ...
        This value maps to the ''Version'' property of the corresponding ''VersionInformation''
        object, which is returned by ''ListLoggerDefinitionVersions'' requests. If the version is
        the last one that was associated with a logger definition, the value also maps to the
        ''LatestVersion'' property of the corresponding ''DefinitionInformation'' object.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the logger definition version was created.
            ...
            - **Definition** *(dict) --* Information about the logger definition version.
              ...
              - **Loggers** *(list) --* A list of loggers.
                ...
                - *(dict) --* Information about a logger
                  ...
                  - **Id** *(string) --* A descriptive or arbitrary ID for the logger. This value
                  must be unique within the logger definition version. Max length is 128 characters
                  with pattern ''[a-zA-Z0-9:_-]+''.

                  - **Level** *(string) --* The level of the logs.

                  - **Space** *(integer) --* The amount of file space, in KB, to use if the local
    ...
    def get_resource_definition_version(
        ...
        **Request Syntax**
        ...
        version. This value maps to the ''Version'' property of the corresponding
        ''VersionInformation'' object, which is returned by ''ListResourceDefinitionVersions''
        requests. If the version is the last one that was associated with a resource definition, the
        value also maps to the ''LatestVersion'' property of the corresponding
        ''DefinitionInformation'' object.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* success
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the resource definition version was created.
            ...
            - **Definition** *(dict) --* Information about the definition.
              ...
              - **Resources** *(list) --* A list of resources.
                ...
                - *(dict) --* Information about a resource.
                  ...
                  function configuration. Max length is 128 characters with pattern
                  ''[a-zA-Z0-9:_-]+''. This must be unique within a Greengrass group.

                  - **Name** *(string) --* The descriptive resource name, which is displayed on the
                  AWS IoT Greengrass console. Max length 128 characters with pattern
                  ''[a-zA-Z0-9:_-]+''. This must be unique within a Greengrass group.

                  - **ResourceDataContainer** *(dict) --* A container of data for all resource
                  types.

                    - **LocalDeviceResourceData** *(dict) --* Attributes that define the local
                    device resource.

                      - **GroupOwnerSetting** *(dict) --* Group/owner related settings for local
                      resources.

                        - **AutoAddGroupOwner** *(boolean) --* If true, AWS IoT Greengrass
                        automatically adds the specified Linux OS group owner of the resource to the
                        Lambda process privileges. Thus the Lambda process will have the file access
                        permissions of the added Linux group.

                        - **GroupOwner** *(string) --* The name of the Linux OS group whose
                        privileges will be added to the Lambda process. This field is optional.

                      - **SourcePath** *(string) --* The local absolute path of the device resource.
                      The source path for a device resource can refer only to a character device or
                      block device under ''/dev''.

                    - **LocalVolumeResourceData** *(dict) --* Attributes that define the local
                    volume resource.

                      - **DestinationPath** *(string) --* The absolute local path of the resource
                      ...
                      - **SourcePath** *(string) --* The local absolute path of the volume resource
                      on the host. The source path for a volume resource type cannot start with
                      ''/sys''.
                    ...
                    Amazon S3 machine learning resource.
                      ...
                      - **OwnerSetting** *(dict) --* The owner setting for downloaded machine
                      learning resources.

                        - **GroupOwner** *(string) --* The group owner of the resource. This is the
                        name of an existing Linux OS group on the system or a GID. The group's
                        permissions are added to the Lambda process.

                        - **GroupPermission** *(string) --* The permissions that the group owner has
                        to the resource. Valid values are ''rw'' (read/write) or ''ro'' (read-only).

                      - **S3Uri** *(string) --* The URI of the source model in an S3 bucket. The
                      model package must be in tar.gz or .zip format.

                    - **SageMakerMachineLearningModelResourceData** *(dict) --* Attributes that
                    define an Amazon SageMaker machine learning resource.
                      ...
                      - **SageMakerJobArn** *(string) --* The ARN of the Amazon SageMaker training
                      job that represents the source model.

                    - **SecretsManagerSecretResourceData** *(dict) --* Attributes that define a
                    secret resource, which references a secret from AWS Secrets Manager.

                      - **ARN** *(string) --* The ARN of the Secrets Manager secret to make
                      available on the core. The value of the secret's latest version (represented
                      by the ''AWSCURRENT'' staging label) is included by default.

                      - **AdditionalStagingLabelsToDownload** *(list) --* Optional. The staging
                      labels whose values you want to make available on the core, in addition to
                      ''AWSCURRENT''.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch, when
            the subscription definition version was created.
            ...
            - **Definition** *(dict) --* Information about the subscription definition version.
              ...
              - **Subscriptions** *(list) --* A list of subscriptions.
                ...
                - *(dict) --* Information about a subscription.
                  ...
                  - **Id** *(string) --* A descriptive or arbitrary ID for the subscription. This
                  value must be unique within the subscription definition version. Max length is 128
                  characters with pattern ''[a-zA-Z0-9:_-]+''.

                  - **Source** *(string) --* The source of the subscription. Can be a thing ARN, a
                  Lambda function ARN, a connector ARN, 'cloud' (which represents the AWS IoT
                  cloud), or 'GGShadowService'.

                  - **Subject** *(string) --* The MQTT topic used to route the message.

                  - **Target** *(string) --* Where the message is sent to. Can be a thing ARN, a
                  Lambda function ARN, a connector ARN, 'cloud' (which represents the AWS IoT
                  cloud), or 'GGShadowService'.
        ...
        **Request Syntax**
        ...
        :returns:
                ...
                'Deployments': [
                    {
                        ...
                        'DeploymentStatus': 'string',
                        'DeploymentType':
                        'NewDeployment'|'Redeployment'|'ResetDeployment'
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the list of deployments for the given
          group.

            - **Deployments** *(list) --* A list of the individual group deployments in the bulk
            deployment operation.

              - *(dict) --* Information about an individual group deployment in a bulk deployment
              operation.

                - **CreatedAt** *(string) --* The time, in ISO format, when the deployment was
                created.
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the list of bulk deployments.
            ...
            - **BulkDeployments** *(list) --* A list of bulk deployments.
              ...
              - *(dict) --* Information about a bulk deployment. You cannot start a new bulk
          ...
          - *(dict) --*
            ...
            - **Versions** *(list) --* Information about a version.
              ...
              - *(dict) --* Information about a version.
                ...
                - **CreationTimestamp** *(string) --* The time, in milliseconds since the epoch,
                when the version was created.

                - **Id** *(string) --* The ID of the parent definition that the version is
                associated with.
          ...
          - *(dict) --*
            ...
            - **Definitions** *(list) --* Information about a definition.
              ...
              - *(dict) --* Information about a definition.
                ...
                - **LastUpdatedTimestamp** *(string) --* The time, in milliseconds since the epoch,
                when the definition was last updated.

                - **LatestVersion** *(string) --* The ID of the latest version associated with the
                definition.

                - **LatestVersionArn** *(string) --* The ARN of the latest version associated with
                the definition.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response body contains the PKI Configuration.
            ...
            - **GroupCertificateAuthorities** *(list) --* A list of certificate authorities
            associated with the group.

              - *(dict) --* Information about a certificate authority for a group.

                - **GroupCertificateAuthorityArn** *(string) --* The ARN of the certificate
                authority for the group.

                - **GroupCertificateAuthorityId** *(string) --* The ID of the certificate authority
                for the group.
        ...
        **Request Syntax**
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Success. The response contains the list of versions and metadata for the
          given group.
    ...
    def start_bulk_deployment(
        ...
        **Request Syntax**
        ...
        :param ExecutionRoleArn: **[REQUIRED]** The ARN of the execution role to associate with the
        bulk deployment operation. This IAM role must allow the ''greengrass:CreateDeployment''
        action for all group versions that are listed in the input file. This IAM role must have
        access to the S3 bucket containing the input file.

        :type InputFileUri: string
        :param InputFileUri: **[REQUIRED]** The URI of the input file contained in the S3 bucket.
        The execution role must have ''getObject'' permissions on this bucket to access the input
        file. The input file is a JSON-serialized, line delimited file with UTF-8 encoding that
        provides a list of group and version IDs and the deployment type. This file must be less
        than 100 MB. Currently, AWS IoT Greengrass supports only ''NewDeployment'' deployment types.
