...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.5.0-alpha.1574783005+gab6dcd76'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.5.0-alpha.1574783005+gab6dcd76`
                """)
            else:
                raise
