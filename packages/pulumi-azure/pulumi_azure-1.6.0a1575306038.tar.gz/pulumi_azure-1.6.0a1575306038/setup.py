...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.6.0-alpha.1575306038+g3c1e219a'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.6.0-alpha.1575306038+g3c1e219a`
                """)
            else:
                raise
