...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.5.0-alpha.1574002739+ge57e3a81'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.5.0-alpha.1574002739+ge57e3a81`
                """)
            else:
                raise
