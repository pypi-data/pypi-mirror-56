...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.5.0-alpha.1574176764+gf6ce37d8'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.5.0-alpha.1574176764+gf6ce37d8`
                """)
            else:
                raise
