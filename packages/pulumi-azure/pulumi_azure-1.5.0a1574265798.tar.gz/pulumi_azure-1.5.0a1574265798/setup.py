...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'azure', 'v1.5.0-alpha.1574265798+g9b037bff'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource azure v1.5.0-alpha.1574265798+g9b037bff`
                """)
            else:
                raise
