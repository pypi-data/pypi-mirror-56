...
class PinchCoordinatesCommand(CommandBase):
    def __init__(self, session, testObjectName):
        CommandBase.__init__(self, session, testObjectName, "Mobile.PinchCoordinates")
    ...
    def execute(self, x, y, length):
        ...
        return SimpleResult(response.read(), "PinchCoordinates was successful", "PinchCoordinates failed")