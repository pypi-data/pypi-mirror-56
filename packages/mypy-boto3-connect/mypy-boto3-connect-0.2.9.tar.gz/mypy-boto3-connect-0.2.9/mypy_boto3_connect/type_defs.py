...
class ClientDescribeUserHierarchyGroupResponseHierarchyGroupHierarchyPathLevelFiveTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserHierarchyGroupResponseHierarchyGroupHierarchyPath`
    `LevelFive`
...
class ClientDescribeUserHierarchyStructureResponseHierarchyStructureLevelThreeTypeDef(
    ...
    """
    Type definition for `ClientDescribeUserHierarchyStructureResponseHierarchyStructure`
    `LevelThree`
...
_ClientGetCurrentMetricDataCurrentMetricsTypeDef = TypedDict(
    "_ClientGetCurrentMetricDataCurrentMetricsTypeDef", {"Name": str, "Unit": str}, total=False
)
...
_ClientGetMetricDataFiltersTypeDef = TypedDict(
    "_ClientGetMetricDataFiltersTypeDef", {"Queues": List[str], "Channels": List[str]}, total=False
)
...
_ClientGetMetricDataResponseMetricResultsDimensionsTypeDef = TypedDict(
    ...
    {"Queue": ClientGetMetricDataResponseMetricResultsDimensionsQueueTypeDef, "Channel": str},
    total=False,
)
...
_ClientStartChatContactInitialMessageTypeDef = TypedDict(
    "_ClientStartChatContactInitialMessageTypeDef", {"ContentType": str, "Content": str}
)


class ClientStartChatContactInitialMessageTypeDef(_ClientStartChatContactInitialMessageTypeDef):
    """
    Type definition for `ClientStartChatContact` `InitialMessage`
...
class ClientStartChatContactParticipantDetailsTypeDef(
    ...
    """
    Type definition for `ClientStartChatContact` `ParticipantDetails`
...
class ClientStartChatContactResponseTypeDef(_ClientStartChatContactResponseTypeDef):
    """
    Type definition for `ClientStartChatContact` `Response`
...
_GetMetricDataPaginateResponseMetricResultsDimensionsTypeDef = TypedDict(
    ...
    {"Queue": GetMetricDataPaginateResponseMetricResultsDimensionsQueueTypeDef, "Channel": str},
    total=False,
)
