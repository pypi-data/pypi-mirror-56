...
class Client(BaseClient):
    ...
    def start_chat_contact(
        ...
        """
        Initiates a contact flow to start a new chat for the customer. Response of this API provides a
        token required to obtain credentials from the `CreateParticipantConnection
