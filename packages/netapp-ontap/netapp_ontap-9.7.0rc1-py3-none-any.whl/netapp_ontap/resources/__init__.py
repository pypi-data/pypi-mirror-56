...
/api/storage/volumes/{volume[uuid]}/files/{file_info[path]}/metadata| <a title="netapp_ontap.resources.file_info_metadata.FileInfoMetadata" href="../resources/file_info_metadata.html"><code>FileInfoMetadata</code></a>
...
from netapp_ontap.resources.file_info_metadata import FileInfoMetadata
