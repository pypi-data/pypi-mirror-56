"Main interface for codepipeline Client"
...
class Client(BaseClient):
    ...
    def acknowledge_job(
        ...
        **Request Syntax**
        ...
        :param nonce: **[REQUIRED]**
          ...
          A system-generated random number that AWS CodePipeline uses to ensure that the job is being worked
          on by only one job worker. Get this number from the response of the  PollForJobs request that
          returned this job.
    ...
    def acknowledge_third_party_job(
        ...
        **Request Syntax**
        ...
        :param nonce: **[REQUIRED]**
          ...
          A system-generated random number that AWS CodePipeline uses to ensure that the job is being worked
          on by only one job worker. Get this number from the response to a  GetThirdPartyJobDetails
          request.
    ...
    def create_custom_action_type(
        ...
        """
        Creates a new custom action that can be used in all pipelines associated with the AWS account. Only
        ...
        **Request Syntax**
        ...
        :param settings:
          ...
          - **entityUrlTemplate** *(string) --*
            ...
            the external system, such as the configuration page for an AWS CodeDeploy deployment group. This
          ...
          - **executionUrlTemplate** *(string) --*
            ...
            page for the external system, such as the console page for AWS CodeDeploy. This link is shown on
            the pipeline view page in the AWS CodePipeline console and provides a link to the execution
    ...
    def create_pipeline(
        ...
        .. note::
          ...
          In the pipeline structure, you must include either ``artifactStore`` or ``artifactStores`` in your
          pipeline, but you cannot use both. If you create a cross-region action in your pipeline, you must
          use ``artifactStores`` .
        ...
        **Request Syntax**
        ...
        :param pipeline: **[REQUIRED]**
          ...
          - **version** *(integer) --*
            ...
            The version number of the pipeline. A new pipeline always has a version number of 1. This number
    ...
    def delete_custom_action_type(
        ...
        .. warning::
          ...
          To re-create a custom action after it has been deleted you must use a string in the version field
          that has never been used before. This string can be an incremented version number, for example. To
          restore a deleted custom action, use a JSON file that is identical to the deleted action,
    ...
    def delete_webhook(self, name: str) -> Dict[str, Any]:
        ...
        starting a pipeline every time an external event occurs. The API returns successfully when trying to
        delete a webhook that is already deleted. If a deleted webhook is re-created by calling PutWebhook
    ...
    def get_job_details(self, jobId: str) -> ClientGetJobDetailsResponseTypeDef:
        ...
        .. warning::
          ...
          When this API is called, AWS CodePipeline returns temporary credentials for the Amazon S3 bucket
          used to store artifacts for the pipeline, if the action requires access to that Amazon S3 bucket
    ...
    def list_pipeline_executions(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          The token that was returned from the previous ``ListPipelineExecutions`` call, which can be used
    ...
    def list_pipelines(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          An identifier that was returned from the previous list pipelines call. It can be used to return
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          page of the list. The ListTagsforResource call lists all available tags in one call and does not
          use pagination.
    ...
    def put_approval_result(
        ...
        """
        Provides the response to a manual approval request to AWS CodePipeline. Valid responses include
    ...
    def put_job_success_result(
        ...
        **Request Syntax**
        ...
        :param continuationToken:
          ...
          provides to identify a custom action in progress. Future jobs use this token to identify the
          running instance of the action. It can be reused to return more information about the progress of
          the custom action. When the action is complete, no continuation token should be supplied.
        ...
        :param outputVariables:
          ...
          Key-value pairs produced as output by a job worker that can be made available to a downstream
          action configuration. ``outputVariables`` can be included only when there is no continuation token
          on the request.
    ...
    def put_webhook(
        ...
        used to automatically configure supported third parties to call the generated webhook URL.
        ...
        **Request Syntax**
        ...
        :param webhook: **[REQUIRED]**
          ...
          name, and the action name. Give the webhook a unique name that helps you identify it. You might
          name the webhook after the pipeline and action it targets so that you can easily recognize what
          it's used for later.
          ...
          - **authentication** *(string) --* **[REQUIRED]**
            ...
            * For information about the authentication scheme implemented by GITHUB_HMAC, see `Securing your
            webhooks <https://developer.github.com/webhooks/securing/>`__ on the GitHub Developer website.
    ...
    def retry_stage_execution(
        ...
        """
        Resumes the pipeline execution by retrying the last failed actions in a stage. You can retry a stage
        immediately if any of the actions in the stage fail. When you retry, all actions that are still in
        progress continue working, and failed actions are triggered again.
