...
# Register SwigPyIterator in _ngl:
_ngl.SwigPyIterator_swigregister(SwigPyIterator)

class nglGraph(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr

    def __init__(self, Xin, rows, cols, graph, maxN, beta, edgeIndices, connect=False):
        _ngl.nglGraph_swiginit(self, _ngl.new_nglGraph(Xin, rows, cols, graph, maxN, beta, edgeIndices, connect))
...
# Register nglGraph in _ngl:
_ngl.nglGraph_swigregister(nglGraph)
...
class vectorDouble(object):
    ...
    def __init__(self, *args):
        _ngl.vectorDouble_swiginit(self, _ngl.new_vectorDouble(*args))
...
# Register vectorDouble in _ngl:
_ngl.vectorDouble_swigregister(vectorDouble)
...
class vectorInt(object):
    ...
    def __init__(self, *args):
        _ngl.vectorInt_swiginit(self, _ngl.new_vectorInt(*args))
...
# Register vectorInt in _ngl:
_ngl.vectorInt_swigregister(vectorInt)
...
class setInt(object):
    ...
    def __init__(self, *args):
        _ngl.setInt_swiginit(self, _ngl.new_setInt(*args))
...
# Register setInt in _ngl:
_ngl.setInt_swigregister(setInt)

class mapIntSet(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    ...
    def __init__(self, *args):
        _ngl.mapIntSet_swiginit(self, _ngl.new_mapIntSet(*args))
...
# Register mapIntSet in _ngl:
_ngl.mapIntSet_swigregister(mapIntSet)
