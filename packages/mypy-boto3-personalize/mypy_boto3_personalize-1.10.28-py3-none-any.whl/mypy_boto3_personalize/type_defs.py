...
class ClientCreateSolutionsolutionConfighpoConfigalgorithmHyperParameterRangescategoricalHyperParameterRangesTypeDef(
    ...
    """
    Type definition for `ClientCreateSolutionsolutionConfighpoConfigalgorithmHyperParameterRanges`
...
class ClientCreateSolutionsolutionConfighpoConfigalgorithmHyperParameterRangesTypeDef(
    ...
    """
    Type definition for `ClientCreateSolutionsolutionConfighpoConfig`
...
class ClientDescribeAlgorithmResponsealgorithmdefaultHyperParameterRangescategoricalHyperParameterRangesTypeDef(
    ...
    """
    Type definition for `ClientDescribeAlgorithmResponsealgorithmdefaultHyperParameterRanges`
    `categoricalHyperParameterRanges`
...
class ClientDescribeBatchInferenceJobResponsebatchInferenceJobjobInputs3DataSourceTypeDef(
    ...
    """
    Type definition for `ClientDescribeBatchInferenceJobResponsebatchInferenceJobjobInput`
    `s3DataSource`
...
class ClientDescribeBatchInferenceJobResponsebatchInferenceJobjobOutputs3DataDestinationTypeDef(
    ...
    """
    Type definition for `ClientDescribeBatchInferenceJobResponsebatchInferenceJobjobOutput`
    `s3DataDestination`
...
class ClientDescribeDatasetImportJobResponsedatasetImportJobTypeDef(
    ...
    * CREATE FAILED
    ...
    - **roleArn** *(string) --*
      ...
      The ARN of the AWS Identity and Access Management (IAM) role that has permissions to read from
...
class ClientDescribeSolutionResponsesolutionsolutionConfighpoConfigalgorithmHyperParameterRangescategoricalHyperParameterRangesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeSolutionResponsesolutionsolutionConfighpoConfigalgorithmHyperParameterRanges`
    `categoricalHyperParameterRanges`
...
class ClientDescribeSolutionResponsesolutionsolutionConfighpoConfigalgorithmHyperParameterRangesTypeDef(
    ...
    """
    Type definition for `ClientDescribeSolutionResponsesolutionsolutionConfighpoConfig`
    `algorithmHyperParameterRanges`
...
class ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfigautoMLConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfig`
    `autoMLConfig`
...
class ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfighpoConfigalgorithmHyperParameterRangescategoricalHyperParameterRangesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfighpoConfigalgorithmHyperParameterRanges`
    `categoricalHyperParameterRanges`
...
class ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfighpoConfigalgorithmHyperParameterRangesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfighpoConfig`
    `algorithmHyperParameterRanges`
...
class ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfighpoConfighpoObjectiveTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeSolutionVersionResponsesolutionVersionsolutionConfighpoConfig` `hpoObjective`
...
class ClientDescribeSolutionVersionResponsesolutionVersionTypeDef(
    ...
    - **trainingHours** *(float) --*
      ...
      The time used to train the model. You are billed for the time it takes to train a model. This
      field is visible only after Amazon Personalize successfully trains a model.
