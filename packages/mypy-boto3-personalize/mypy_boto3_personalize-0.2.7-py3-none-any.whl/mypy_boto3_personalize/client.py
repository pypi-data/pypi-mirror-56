...
class Client(BaseClient):
        ...
        **Request Syntax**
        ...
        :param jobInput: **[REQUIRED]**
          ...
          - **s3DataSource** *(dict) --* **[REQUIRED]**
            ...
            The URI of the Amazon S3 location that contains your input data. The Amazon S3 bucket must be in
    ...
    def create_dataset_group(
        ...
        * DELETE PENDING
        ...
        specify a KMS key, you must also include an AWS Identity and Access Management (IAM) role that has
    ...
    def create_dataset_import_job(
        ...
        * CREATE PENDING > CREATE IN_PROGRESS > ACTIVE -or- CREATE FAILED
        ...
        .. note::
          ...
          Importing takes time. You must wait until the status shows as ACTIVE before training a model using
          the dataset.
    ...
    def create_event_tracker(
        ...
        When Amazon Personalize creates an event tracker, it also creates an *event-interactions* dataset in
        the dataset group associated with the event tracker. The event-interactions dataset stores the event
        data from the ``PutEvents`` call. The contents of this dataset are not available to the user.
          ...
          - **hpoConfig** *(dict) --*
            ...
            - **hpoResourceConfig** *(dict) --*
              ...
              - **maxParallelTrainingJobs** *(string) --*
                ...
                The maximum number of parallel training jobs when you create a solution version. The maximum
                value for ``maxParallelTrainingJobs`` is ``10`` .
    ...
    def create_solution_version(
        ...
        """
        Trains or retrains an active solution. A solution is created using the  CreateSolution operation and
        must be in the ACTIVE state before calling ``CreateSolutionVersion`` . A new version of the solution
        ...
        * CREATE PENDING > CREATE IN_PROGRESS > ACTIVE -or- CREATE FAILED
        ...
        If the status shows as CREATE FAILED, the response includes a ``failureReason`` key, which describes
        why the job failed.
    ...
    def delete_dataset(self, datasetArn: str) -> None:
        ...
        ``SolutionVersion`` is in the CREATE PENDING or IN PROGRESS state. For more information on datasets,
        see  CreateDataset .
          ...
          - *(dict) --*
            ...
            - **batchInferenceJob** *(dict) --*
              ...
              - **numResults** *(integer) --*
                ...
                The number of recommendations generated by the batch inference job. This number includes the
                error messages generated for failed input records.
              ...
              - **jobInput** *(dict) --*
                ...
                - **s3DataSource** *(dict) --*
                  ...
                  The URI of the Amazon S3 location that contains your input data. The Amazon S3 bucket must
          ...
          - *(dict) --*
            ...
            - **solution** *(dict) --*
              ...
              - **performAutoML** *(boolean) --*
                ...
                from the list specified in the solution configuration (``recipeArn`` must not be specified).
          ...
          - *(dict) --*
            ...
            - **solutionVersion** *(dict) --*
              ...
              - **trainingMode** *(string) --*
                ...
                the last solution version. Choose ``UPDATE`` when you want to start recommending items added
                to the dataset without retraining the model.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              The token to use to retreive the next page of results. The value is ``null`` when there are no
    ...
    def list_campaigns(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          A token returned from the previous call to ``ListCampaigns`` for getting the next set of campaigns
          (if they exist).
    ...
    def list_solutions(
        ...
        """
        Returns a list of solutions that use the given dataset group. When a dataset group is not specified,
        all the solutions associated with the account are listed. The response provides the properties for
        each solution, including the Amazon Resource Name (ARN). For more information on solutions, see
        CreateSolution .
    ...
    def update_campaign(
        ...
        To update a campaign, the campaign status must be ACTIVE or CREATE FAILED. Check the campaign status
        using the  DescribeCampaign API.
