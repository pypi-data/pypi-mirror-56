...
class Client(BaseClient):
    ...
    def add_permission(
        ...
        <https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#P>`__ . This allows sharing
        access to the queue.
        ...
        these permissions, see `Allow Developers to Write Messages to a Shared Queue
        <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-writing-an-sqs-policy.html#write-messages-to-shared-queue>`__
        in the *Amazon Simple Queue Service Developer Guide* .

        .. note::

          * ``AddPermission`` generates a policy for you. You can use ``  SetQueueAttributes `` to
          upload your policy. For more information, see `Using Custom Policies with the Amazon SQS
          Access Policy Language
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-creating-custom-policies.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .

          * An Amazon SQS policy can have a maximum of 7 actions.

          * To remove the ability to change queue permissions, you must deny permission to the
          ``AddPermission`` , ``RemovePermission`` , and ``SetQueueAttributes`` actions in your IAM
          policy.
        ...
        .. note::
          ...
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-customer-managed-policy-examples.html#grant-cross-account-permissions-to-role-and-user-name>`__
          in the *Amazon Simple Queue Service Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/AddPermission>`_
        ...
        **Request Syntax**
        ...
        :param AWSAccountIds: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#P>`__ who is given
          permission. The principal must have an AWS account, but does not need to be signed up for
          Amazon SQS. For information about locating the AWS account identification, see `Your AWS
          Identifiers
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-making-api-requests.html#sqs-api-request-authentication>`__
          in the *Amazon Simple Queue Service Developer Guide* .
        ...
        :param Actions: **[REQUIRED]**
          ...
          For more information about these actions, see `Overview of Managing Access Permissions to
          Your Amazon Simple Queue Service Resource
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-overview-of-managing-access.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          actions: ``SendMessageBatch`` , ``DeleteMessageBatch`` , and
    ...
    def change_message_visibility(
        ...
        hours. For more information, see `Visibility Timeout
        <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html>`__
        in the *Amazon Simple Queue Service Developer Guide* .

        For example, you have a message with a visibility timeout of 5 minutes. After 3 minutes, you
        call ``ChangeMessageVisibility`` with a timeout of 10 minutes. You can continue to call
        ``ChangeMessageVisibility`` to extend the visibility timeout to the maximum allowed time. If
        you try to extend the visibility timeout beyond the maximum, your request is rejected.
        ...
        * Deleted from the queue.
        ...
        A message is considered to be *stored* after it is sent to a queue by a producer, but not
        yet received from the queue by a consumer (that is, between states 1 and 2). There is no
        limit to the number of stored messages. A message is considered to be *in flight* after it
        is received from a queue by a consumer, but not yet deleted from the queue (that is, between
        states 2 and 3). There is a limit to the number of inflight messages.

        Limits that apply to inflight messages are unrelated to the *unlimited* number of stored
        messages.

        For most standard queues (depending on queue traffic and message backlog), there can be a
        maximum of approximately 120,000 inflight messages (received from a queue by a consumer, but
        not yet deleted from the queue). If you reach this limit, Amazon SQS returns the
        ``OverLimit`` error message. To avoid reaching the limit, you should delete messages from
        the queue after they're processed. You can also increase the number of queues you use to
        process your messages. To request a limit increase, `file a support request
        <https://console.aws.amazon.com/support/home#/case/create?issueType=
            service-limit-increase&limitType=service-code-sqs>`__
        .

        For FIFO queues, there can be a maximum of 20,000 inflight messages (received from a queue
        ...
        .. warning::
          ...
          left, Amazon SQS returns an error. Amazon SQS doesn't automatically recalculate and
          increase the timeout to the maximum remaining time.

          Unlike with a queue, when you change the visibility timeout for a specific message the
          timeout value is applied immediately but isn't saved in memory for that message. If you
          don't delete a message after it is received, the visibility timeout for the message
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ChangeMessageVisibility>`_
    ...
    def change_message_visibility_batch(
        ...
        individually in the response. You can send up to 10 ``  ChangeMessageVisibility `` requests
        with each ``ChangeMessageVisibilityBatch`` action.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ChangeMessageVisibilityBatch>`_
    ...
    def create_queue(
        ...
        * If you don't specify the ``FifoQueue`` attribute, Amazon SQS creates a standard queue.
        ...
        .. note::
           ...
           application or delete your existing standard queue and recreate it as a FIFO queue. For
           more information, see `Moving From a Standard Queue to a FIFO Queue
           <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-moving>`__
           in the *Amazon Simple Queue Service Developer Guide* .
        ...
        * If you delete a queue, you must wait at least 60 seconds before creating a queue with the
        ...
        <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/limits-queues.html>`__
        ...
        * If the queue name, attribute names, or attribute values don't match an existing queue,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/CreateQueue>`_
        ...
        **Request Syntax**
        ...
        :param Attributes:
          ...
          that the ``CreateQueue`` action uses:
          ...
          * ``Policy`` - The queue's policy. A valid AWS policy. For more information about policy
          ...
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/PoliciesOverview.html>`__ in the *Amazon
          IAM User Guide* .
          ...
          * ``RedrivePolicy`` - The string that includes the parameters for the dead-letter queue
          functionality of the source queue. For more information about the redrive policy and
          dead-letter queues, see `Using Amazon SQS Dead-Letter Queues
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-dead-letter-queues.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
            ...
            * ``maxReceiveCount`` - The number of times a message is delivered to the source queue
            before being moved to the dead-letter queue. When the ``ReceiveCount`` for a message
          ...
          * ``VisibilityTimeout`` - The visibility timeout for the queue, in seconds. Valid values:
          An integer from 0 to 43,200 (12 hours). Default: 30. For more information about the
          visibility timeout, see `Visibility Timeout
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .

          The following attributes apply only to `server-side-encryption
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html>`__
          :

          * ``KmsMasterKeyId`` - The ID of an AWS-managed customer master key (CMK) for Amazon SQS
          or a custom CMK. For more information, see `Key Terms
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-sse-key-terms>`__
          . While the alias of the AWS-managed CMK for Amazon SQS is always ``alias/aws/sqs`` , the
          alias of a custom CMK can, for example, be ``alias/*MyAlias* `` . For more examples, see
          `KeyId
          <https://docs.aws.amazon.com/kms/latest/APIReference/API_DescribeKey.html#API_DescribeKey_RequestParameters>`__
          in the *AWS Key Management Service API Reference* .

          * ``KmsDataKeyReusePeriodSeconds`` - The length of time, in seconds, for which Amazon SQS
          can reuse a `data key
          <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#data-keys>`__ to
          encrypt or decrypt messages before calling AWS KMS again. An integer representing seconds,
          between 60 seconds (1 minute) and 86,400 seconds (24 hours). Default: 300 (5 minutes). A
          shorter time period provides better security but results in more calls to KMS which might
          incur charges after Free Tier. For more information, see `How Does the Data Key Reuse
          Period Work?
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-how-does-the-data-key-reuse-period-work>`__
          .

          The following attributes apply only to `FIFO (first-in-first-out) queues
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html>`__
          :

          * ``FifoQueue`` - Designates a queue as FIFO. Valid values: ``true`` , ``false`` . If you
          don't specify the ``FifoQueue`` attribute, Amazon SQS creates a standard queue. You can
          provide this attribute only during queue creation. You can't change it for an existing
          queue. When you set this attribute, you must also provide the ``MessageGroupId`` for your
          messages explicitly. For more information, see `FIFO Queue Logic
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-understanding-logic>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * ``ContentBasedDeduplication`` - Enables content-based deduplication. Valid values:
          ...
          in the *Amazon Simple Queue Service Developer Guide* .
            ...
            * When ``ContentBasedDeduplication`` is in effect, messages with identical content sent
            within the deduplication interval are treated as duplicates and only one copy of the
            ...
            * If you send one message with ``ContentBasedDeduplication`` enabled and then another
            ...
            first ``MessageDeduplicationId`` , the two messages are treated as duplicates and only
        ...
        :param tags:
          ...
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-queue-tags.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * A new tag with a key identical to that of an existing tag overwrites the existing tag.
          ...
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-limits.html#limits-queues>`__
          in the *Amazon Simple Queue Service Developer Guide* .
    ...
    def delete_message(self, QueueUrl: str, ReceiptHandle: str) -> None:
        ...
        the ``ReceiptHandle`` of the message (*not* the ``MessageId`` which you receive when you
        send the message). Amazon SQS can delete a message from a queue even if a visibility timeout
        setting causes the message to be locked by another consumer. Amazon SQS automatically
        ...
        .. note::
          ...
          the message might not be deleted).
          ...
          unavailable when you send the request to delete the message. The copy remains on the
          server and might be returned to you during a subsequent receive request. You should ensure
          that your application is idempotent, so that receiving a message more than once does not
          cause issues.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/DeleteMessage>`_
    ...
    def delete_message_batch(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/DeleteMessageBatch>`_
    ...
    def delete_queue(self, QueueUrl: str) -> None:
        ...
        .. warning::
          ...
          Be careful with the ``DeleteQueue`` action: When you delete a queue, any messages in the
          queue are no longer available.

        When you delete a queue, the deletion process takes up to 60 seconds. Requests you send
        involving that queue during the 60 seconds might succeed. For example, a ``  SendMessage ``
        request might succeed, but after 60 seconds the queue and the message you sent no longer
        exist.

        When you delete a queue, you must wait at least 60 seconds before creating a queue with the
        same name.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/DeleteQueue>`_
    ...
    def get_queue_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/GetQueueAttributes>`_
        ...
        **Request Syntax**
        ...
        :param AttributeNames:
          ...
          * ``ApproximateNumberOfMessagesDelayed`` - Returns the approximate number of messages in
          the queue that are delayed and not available for reading immediately. This can happen when
          the queue is configured as a delay queue or when a message has been sent with a delay
          parameter.

          * ``ApproximateNumberOfMessagesNotVisible`` - Returns the approximate number of messages
          that are in flight. Messages are considered to be *in flight* if they have been sent to a
          client but have not yet been deleted or have not yet reached the end of their visibility
          window.

          * ``CreatedTimestamp`` - Returns the time when the queue was created in seconds (`epoch
          time <http://en.wikipedia.org/wiki/Unix_time>`__ ).

          * ``DelaySeconds`` - Returns the default delay on the queue in seconds.

          * ``LastModifiedTimestamp`` - Returns the time when the queue was last changed in seconds
          (`epoch time <http://en.wikipedia.org/wiki/Unix_time>`__ ).

          * ``MaximumMessageSize`` - Returns the limit of how many bytes a message can contain
          before Amazon SQS rejects it.

          * ``MessageRetentionPeriod`` - Returns the length of time, in seconds, for which Amazon
          ...
          * ``ReceiveMessageWaitTimeSeconds`` - Returns the length of time, in seconds, for which
          the ``ReceiveMessage`` action waits for a message to arrive.

          * ``RedrivePolicy`` - Returns the string that includes the parameters for dead-letter
          queue functionality of the source queue. For more information about the redrive policy and
          dead-letter queues, see `Using Amazon SQS Dead-Letter Queues
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-dead-letter-queues.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * ``KmsDataKeyReusePeriodSeconds`` - Returns the length of time, in seconds, for which
          Amazon SQS can reuse a data key to encrypt or decrypt messages before calling AWS KMS
          again. For more information, see `How Does the Data Key Reuse Period Work?
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-how-does-the-data-key-reuse-period-work>`__
          .
          ...
          * ``FifoQueue`` - Returns whether the queue is FIFO. For more information, see `FIFO Queue
          Logic
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-understanding-logic>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * ``ContentBasedDeduplication`` - Returns whether content-based deduplication is enabled
          for the queue. For more information, see `Exactly-Once Processing
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-exactly-once-processing>`__
          in the *Amazon Simple Queue Service Developer Guide* .
    ...
    def get_queue_url(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/GetQueueUrl>`_
    ...
    def list_dead_letter_source_queues(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ListDeadLetterSourceQueues>`_
    ...
    def list_queue_tags(self, QueueUrl: str) -> ClientListQueueTagsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ListQueueTags>`_
    ...
    def list_queues(self, QueueNamePrefix: str = None) -> ClientListQueuesResponseTypeDef:
        ...
        If you specify a value for the optional ``QueueNamePrefix`` parameter, only queues with a
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ListQueues>`_
    ...
    def purge_queue(self, QueueUrl: str) -> None:
        ...
        Messages sent to the queue *after* you call ``PurgeQueue`` might be deleted while the queue
        is being purged.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/PurgeQueue>`_
    ...
    def receive_message(
        ...
        ``WaitTimeSeconds`` parameter enables long-poll support. For more information, see `Amazon
        SQS Long Polling
        <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-long-polling.html>`__
        in the *Amazon Simple Queue Service Developer Guide* .

        Short poll is the default behavior where a weighted random set of machines is sampled on a
        ``ReceiveMessage`` call. Thus, only the messages on the sampled machines are returned. If
        ...
        * An MD5 digest of the message attributes.
        ...
        You can provide the ``VisibilityTimeout`` parameter in your request. The parameter is
        applied to the messages that Amazon SQS returns in the response. If you don't include the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/ReceiveMessage>`_
        ...
        **Request Syntax**
        ...
        :param AttributeNames:
          ...
          * ``ApproximateFirstReceiveTimestamp`` - Returns the time the message was first received
          from the queue (`epoch time <http://en.wikipedia.org/wiki/Unix_time>`__ in milliseconds).

          * ``ApproximateReceiveCount`` - Returns the number of times a message has been received
          from the queue but not deleted.
          ...
          * ``SentTimestamp`` - Returns the time the message was sent to the queue (`epoch time
          <http://en.wikipedia.org/wiki/Unix_time>`__ in milliseconds).
          ...
          * ``MessageGroupId`` - Returns the value provided by the producer that calls the ``
          SendMessage `` action. Messages with the same ``MessageGroupId`` are returned in sequence.
        ...
        :param ReceiveRequestAttemptId:
          ...
          you can retry the same action with an identical ``ReceiveRequestAttemptId`` to retrieve
          ...
          * You can retry the ``ReceiveMessage`` action with the same ``ReceiveRequestAttemptId`` if
          ...
          * During a visibility timeout, subsequent calls with the same ``ReceiveRequestAttemptId``
          ...
          interval, it resets the visibility timeout. For more information, see `Visibility Timeout
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          .. warning::
             ...
             the same queue can receive the same messages and therefore process duplicates. Also, if
             a consumer whose message processing time is longer than the visibility timeout tries to
             delete the processed messages, the action fails with an error. To mitigate this effect,
             ensure that your application observes a safe threshold before the visibility timeout
          ...
          * If a caller of ``ReceiveMessage`` can't track the ``ReceiveRequestAttemptId`` , no
          ...
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/using-receiverequestattemptid-request-parameter.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
            ...
            - **Messages** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ReceiptHandle** *(string) --*
                  ...
                  handle is returned every time you receive a message. When deleting a message, you
                  provide the last received receipt handle to delete the message.
                ...
                - **Attributes** *(dict) --*
                  ...
                  * ``SequenceNumber``
                   ...
                   ``ApproximateFirstReceiveTimestamp`` and ``SentTimestamp`` are each returned as
                   an integer representing the `epoch time
                   <http://en.wikipedia.org/wiki/Unix_time>`__ in milliseconds.
                ...
                - **MD5OfMessageAttributes** *(string) --*
                  ...
                  see `RFC1321 <https://www.ietf.org/rfc/rfc1321.txt>`__ .
                  ...
                  - *(string) --*
                    ...
                    - *(dict) --*
                      ...
                      body. For more information, see ``  SendMessage .``
                       ...
                       null. All parts of the message attribute, including ``Name`` , ``Type`` , and
                      ...
                      - **StringValue** *(string) --*
                        ...
                        see `ASCII Printable Characters
    ...
    def remove_permission(self, QueueUrl: str, Label: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/RemovePermission>`_
    ...
    def send_message(
        ...
        .. warning::
          ...
          Any characters not included in this list will be rejected. For more information, see the
          `W3C specification for characters <http://www.w3.org/TR/REC-xml/#charsets>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/SendMessage>`_
        ...
        **Request Syntax**
        ...
        :param DelaySeconds:
          ...
          The length of time, in seconds, for which to delay a specific message. Valid values: 0 to
        ...
        :type MessageSystemAttributes: dict
        :param MessageSystemAttributes:
          ...
          .. warning::
            ...
            * Currently, the only supported message system attribute is ``AWSTraceHeader`` . Its
            type must be ``String`` and its value must be a correctly formatted AWS X-Ray trace
            string.

            * The size of a message system attribute doesn't count towards the total size of a
            message.
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              ``Value`` attribute has the same restrictions on the content as the message body. For
        ...
        :param MessageDeduplicationId:
          ...
          5-minute deduplication interval. For more information, see `Exactly-Once Processing
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-exactly-once-processing>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * If you send one message with ``ContentBasedDeduplication`` enabled and then another
          message with a ``MessageDeduplicationId`` that is the same as the one generated for the
          first ``MessageDeduplicationId`` , the two messages are treated as duplicates and only one
        ...
        :param MessageGroupId:
          ...
          for multiple users). In this scenario, multiple consumers can process the queue, but the
    ...
    def send_message_batch(
        ...
        The result of sending each message is reported individually in the response. Because the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/SendMessageBatch>`_
        ...
        :param Entries: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **DelaySeconds** *(integer) --*
              ...
              0 to 900. Maximum: 15 minutes. Messages with a positive ``DelaySeconds`` value become
            ...
            - **MessageDeduplicationId** *(string) --*
              ...
              accepted successfully but aren't delivered. For more information, see `Exactly-Once
              Processing
              <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-exactly-once-processing>`__
              in the *Amazon Simple Queue Service Developer Guide* .
              ...
              * When ``ContentBasedDeduplication`` is in effect, messages with identical content
              sent within the deduplication interval are treated as duplicates and only one copy of
              the message is delivered.

              * If you send one message with ``ContentBasedDeduplication`` enabled and then another
              message with a ``MessageDeduplicationId`` that is the same as the one generated for
              the first ``MessageDeduplicationId`` , the two messages are treated as duplicates and
              only one copy of the message is delivered.

              .. note::

                The ``MessageDeduplicationId`` is available to the consumer of the message (this can
                be useful for troubleshooting delivery issues).

                If a message is sent successfully but the acknowledgement is lost and the message is
                resent with the same ``MessageDeduplicationId`` after the deduplication interval,
            ...
            - **MessageGroupId** *(string) --*
              ...
              * ``ReceiveMessage`` might return messages with multiple ``MessageGroupId`` values.
              For each ``MessageGroupId`` , the messages are sorted by time sent. The caller can't
            ...
            - **Successful** *(list) --*
              ...
              - *(dict) --*
                ...
                - **MD5OfMessageSystemAttributes** *(string) --*
                  ...
                  SQS URL-decodes the message before creating the MD5 digest. For information about
                  MD5, see `RFC1321 <https://www.ietf.org/rfc/rfc1321.txt>`__ .
    ...
    def set_queue_attributes(self, QueueUrl: str, Attributes: Dict[str, str]) -> None:
        ...
        Amazon SQS system. Changes made to the ``MessageRetentionPeriod`` attribute can take up to
        15 minutes.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/SetQueueAttributes>`_
        ...
        **Request Syntax**
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * ``MaximumMessageSize`` - The limit of how many bytes a message can contain before Amazon
          SQS rejects it. Valid values: An integer from 1,024 bytes (1 KiB) up to 262,144 bytes (256
          KiB). Default: 262,144 (256 KiB).

          * ``MessageRetentionPeriod`` - The length of time, in seconds, for which Amazon SQS
          retains a message. Valid values: An integer representing seconds, from 60 (1 minute) to
    ...
    def tag_queue(self, QueueUrl: str, Tags: List[str]) -> None:
        ...
        * A new tag with a key identical to that of an existing tag overwrites the existing tag.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/TagQueue>`_
    ...
    def untag_queue(self, QueueUrl: str, TagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/UntagQueue>`_
