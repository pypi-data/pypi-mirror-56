...
_RequiredClientChangeMessageVisibilityBatchEntriesTypeDef = TypedDict(
    "_RequiredClientChangeMessageVisibilityBatchEntriesTypeDef", {"Id": str, "ReceiptHandle": str}
)
...
class ClientReceiveMessageResponseMessagesMessageAttributesTypeDef(
    ...
    SendMessage .``
     ...
     the message attribute, including ``Name`` , ``Type`` , and ``Value`` , are part of the message
     size restriction (256 KB or 262,144 bytes).
...
class ClientReceiveMessageResponseMessagesTypeDef(_ClientReceiveMessageResponseMessagesTypeDef):
    ...
    - **Attributes** *(dict) --*
      ...
      * ``SequenceNumber``
       ...
       representing the `epoch time <http://en.wikipedia.org/wiki/Unix_time>`__ in milliseconds.
...
_RequiredClientSendMessageBatchEntriesMessageSystemAttributesTypeDef = TypedDict(
    "_RequiredClientSendMessageBatchEntriesMessageSystemAttributesTypeDef", {"DataType": str}
)
...
class ClientSendMessageBatchResponseSuccessfulTypeDef(
    ...
    - **SequenceNumber** *(string) --*
      ...
      The length of ``SequenceNumber`` is 128 bits. As ``SequenceNumber`` continues to increase for
...
_RequiredQueueChangeMessageVisibilityBatchEntriesTypeDef = TypedDict(
    "_RequiredQueueChangeMessageVisibilityBatchEntriesTypeDef", {"Id": str, "ReceiptHandle": str}
)
