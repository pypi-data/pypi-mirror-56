...
class Client(BaseClient):
    ...
    def add_permission(
        ...
        <https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#P>`__ . This allows sharing access to
        the queue.
        ...
        .. note::
          ...
          * ``AddPermission`` generates a policy for you. You can use ``  SetQueueAttributes `` to upload
          your policy. For more information, see `Using Custom Policies with the Amazon SQS Access Policy
          Language
        ...
        **Request Syntax**
        ...
        :param AWSAccountIds: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/general/latest/gr/glos-chap.html#P>`__ who is given permission. The
          principal must have an AWS account, but does not need to be signed up for Amazon SQS. For
          information about locating the AWS account identification, see `Your AWS Identifiers
    ...
    def change_message_visibility(
        ...
        ``ChangeMessageVisibility`` to extend the visibility timeout to the maximum allowed time. If you try
        to extend the visibility timeout beyond the maximum, your request is rejected.
        ...
        * Deleted from the queue.
        ...
        number of stored messages. A message is considered to be *in flight* after it is received from a
        queue by a consumer, but not yet deleted from the queue (that is, between states 2 and 3). There is
        a limit to the number of inflight messages.
        ...
        approximately 120,000 inflight messages (received from a queue by a consumer, but not yet deleted
        from the queue). If you reach this limit, Amazon SQS returns the ``OverLimit`` error message. To
        avoid reaching the limit, you should delete messages from the queue after they're processed. You can
        also increase the number of queues you use to process your messages. To request a limit increase,
        ...
        consumer, but not yet deleted from the queue). If you reach this limit, Amazon SQS returns no error
        messages.

        .. warning::

          If you attempt to set the ``VisibilityTimeout`` to a value greater than the maximum time left,
          Amazon SQS returns an error. Amazon SQS doesn't automatically recalculate and increase the timeout
        ...
        **Request Syntax**
        ...
        :param VisibilityTimeout: **[REQUIRED]**
          ...
          The new value for the message's visibility timeout (in seconds). Values values: ``0`` to ``43200``
          . Maximum: 12 hours.
    ...
    def change_message_visibility_batch(
        self,
        QueueUrl: str,
        Entries: List[ClientChangeMessageVisibilityBatchEntriesTypeDef],
    ) -> ClientChangeMessageVisibilityBatchResponseTypeDef:
        """
        ...
        .. warning::
          ...
          Because the batch request can result in a combination of successful and unsuccessful actions, you
        ...
        :param Entries: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            .. warning::
              ...
              ``ChangeMessageVisibilityBatchRequestEntry.n`` , where ``n`` is an integer value starting with
              ``1`` . For example, a parameter list for this action might look like this:
    ...
    def create_queue(
        ...
        * If you don't specify the ``FifoQueue`` attribute, Amazon SQS creates a standard queue.
        ...
        .. note::
           ...
           From a Standard Queue to a FIFO Queue
        ...
        * If you provide the name of an existing queue along with the exact names and values of all the
        queue's attributes, ``CreateQueue`` returns the queue URL for the existing queue.
        ...
        **Request Syntax**
        ...
        :param Attributes:
          ...
          * ``MessageRetentionPeriod`` - The length of time, in seconds, for which Amazon SQS retains a
          message. Valid values: An integer from 60 seconds (1 minute) to 1,209,600 seconds (14 days).
          ...
          * ``Policy`` - The queue's policy. A valid AWS policy. For more information about policy
          ...
          <https://docs.aws.amazon.com/IAM/latest/UserGuide/PoliciesOverview.html>`__ in the *Amazon IAM
          User Guide* .
          ...
          * ``VisibilityTimeout`` - The visibility timeout for the queue, in seconds. Valid values: An
          integer from 0 to 43,200 (12 hours). Default: 30. For more information about the visibility
          ...
          * ``KmsMasterKeyId`` - The ID of an AWS-managed customer master key (CMK) for Amazon SQS or a
          ...
          . While the alias of the AWS-managed CMK for Amazon SQS is always ``alias/aws/sqs`` , the alias of
          a custom CMK can, for example, be ``alias/*MyAlias* `` . For more examples, see `KeyId
          ...
          * ``KmsDataKeyReusePeriodSeconds`` - The length of time, in seconds, for which Amazon SQS can
          reuse a `data key
          <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#data-keys>`__ to encrypt or
          decrypt messages before calling AWS KMS again. An integer representing seconds, between 60 seconds
          (1 minute) and 86,400 seconds (24 hours). Default: 300 (5 minutes). A shorter time period provides
          better security but results in more calls to KMS which might incur charges after Free Tier. For
          ...
          * ``FifoQueue`` - Designates a queue as FIFO. Valid values: ``true`` , ``false`` . If you don't
          specify the ``FifoQueue`` attribute, Amazon SQS creates a standard queue. You can provide this
          attribute only during queue creation. You can't change it for an existing queue. When you set this
          ...
          * ``ContentBasedDeduplication`` - Enables content-based deduplication. Valid values: ``true`` ,
          ``false`` . For more information, see `Exactly-Once Processing
    ...
    def delete_message(self, QueueUrl: str, ReceiptHandle: str) -> None:
        ...
        message). Amazon SQS can delete a message from a queue even if a visibility timeout setting causes
        the message to be locked by another consumer. Amazon SQS automatically deletes messages left in a
        ...
        .. note::
          ...
          receive a message more than once, the ``ReceiptHandle`` is different each time you receive a
          message. When you use the ``DeleteMessage`` action, you must provide the most recently received
          ``ReceiptHandle`` for the message (otherwise, the request succeeds, but the message might not be
          deleted).
    ...
    def delete_queue(self, QueueUrl: str) -> None:
        ...
        that queue during the 60 seconds might succeed. For example, a ``  SendMessage `` request might
        succeed, but after 60 seconds the queue and the message you sent no longer exist.
    ...
    def get_queue_attributes(
        ...
        **Request Syntax**
        ...
        :param AttributeNames:
          ...
          * ``ApproximateNumberOfMessagesDelayed`` - Returns the approximate number of messages in the queue
          that are delayed and not available for reading immediately. This can happen when the queue is
          configured as a delay queue or when a message has been sent with a delay parameter.

          * ``ApproximateNumberOfMessagesNotVisible`` - Returns the approximate number of messages that are
          in flight. Messages are considered to be *in flight* if they have been sent to a client but have
          ...
          * ``CreatedTimestamp`` - Returns the time when the queue was created in seconds (`epoch time
          <http://en.wikipedia.org/wiki/Unix_time>`__ ).

          * ``DelaySeconds`` - Returns the default delay on the queue in seconds.

          * ``LastModifiedTimestamp`` - Returns the time when the queue was last changed in seconds (`epoch
          ...
          * ``MessageRetentionPeriod`` - Returns the length of time, in seconds, for which Amazon SQS
          retains a message.
          ...
          * ``RedrivePolicy`` - Returns the string that includes the parameters for dead-letter queue
          functionality of the source queue. For more information about the redrive policy and dead-letter
          queues, see `Using Amazon SQS Dead-Letter Queues
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-dead-letter-queues.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * ``VisibilityTimeout`` - Returns the visibility timeout for the queue. For more information about
          the visibility timeout, see `Visibility Timeout
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * ``KmsMasterKeyId`` - Returns the ID of an AWS-managed customer master key (CMK) for Amazon SQS
          or a custom CMK. For more information, see `Key Terms
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-server-side-encryption.html#sqs-sse-key-terms>`__
          .

          * ``KmsDataKeyReusePeriodSeconds`` - Returns the length of time, in seconds, for which Amazon SQS
          can reuse a data key to encrypt or decrypt messages before calling AWS KMS again. For more
          ...
          * ``FifoQueue`` - Returns whether the queue is FIFO. For more information, see `FIFO Queue Logic
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-understanding-logic>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * ``ContentBasedDeduplication`` - Returns whether content-based deduplication is enabled for the
          queue. For more information, see `Exactly-Once Processing
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-exactly-once-processing>`__
          in the *Amazon Simple Queue Service Developer Guide* .
    ...
    def get_queue_url(
        ...
        to specify the account ID of the queue's owner. The queue's owner must grant you permission to
        access the queue. For more information about shared queue access, see ``  AddPermission `` or see
    ...
    def list_queues(
        ...
        """
        Returns a list of your queues. The maximum number of queues that can be returned is 1,000. If you
        specify a value for the optional ``QueueNamePrefix`` parameter, only queues with a name that begins
    ...
    def purge_queue(self, QueueUrl: str) -> None:
        ...
        Messages sent to the queue *before* you call ``PurgeQueue`` might be received but are deleted within
        the next minute.

        Messages sent to the queue *after* you call ``PurgeQueue`` might be deleted while the queue is being
        purged.
    ...
    def receive_message(
        ...
        ``ReceiveMessage`` call. Thus, only the messages on the sampled machines are returned. If the number
        of messages in the queue is small (fewer than 1,000), you most likely get fewer messages than you
        requested per ``ReceiveMessage`` call. If the number of messages in the queue is extremely small,
        you might not receive any messages in a particular ``ReceiveMessage`` response. If this happens,
        repeat the request.
        ...
        * An MD5 digest of the message attributes.
        ...
        messages that Amazon SQS returns in the response. If you don't include the parameter, the overall
        visibility timeout for the queue is used for the returned messages. For more information, see
        `Visibility Timeout
        <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/sqs-visibility-timeout.html>`__
        in the *Amazon Simple Queue Service Developer Guide* .

        A message that isn't deleted or a message whose visibility isn't extended before the visibility
        timeout expires counts as a failed receive. Depending on the configuration of the queue, the message
        ...
        **Request Syntax**
        ...
        :param AttributeNames:
          ...
          * ``ApproximateFirstReceiveTimestamp`` - Returns the time the message was first received from the
          queue (`epoch time <http://en.wikipedia.org/wiki/Unix_time>`__ in milliseconds).

          * ``ApproximateReceiveCount`` - Returns the number of times a message has been received from the
        ...
        :param ReceiveRequestAttemptId:
          ...
          ``ReceiveMessage`` action, and instead of a response you receive a generic error, you can retry
          the same action with an identical ``ReceiveRequestAttemptId`` to retrieve the same set of
          ...
          * You can retry the ``ReceiveMessage`` action with the same ``ReceiveRequestAttemptId`` if none of
          the messages have been modified (deleted or had their visibility changes).
          ...
          * During a visibility timeout, subsequent calls with the same ``ReceiveRequestAttemptId`` return
          ...
          .. warning::
             ...
             timeout expires and messages become visible, another worker consuming from the same queue can
             receive the same messages and therefore process duplicates. Also, if a consumer whose message
             processing time is longer than the visibility timeout tries to delete the processed messages,
          ...
          * If a caller of ``ReceiveMessage`` can't track the ``ReceiveRequestAttemptId`` , no retries work
          until the original visibility timeout expires. As a result, delays might occur but the messages in
    ...
    def send_message(
        ...
        MessageSystemAttributes: Dict[
            str, ClientSendMessageMessageSystemAttributesTypeDef
        ] = None,
        ...
        .. warning::
          ...
          Any characters not included in this list will be rejected. For more information, see the `W3C
          specification for characters <http://www.w3.org/TR/REC-xml/#charsets>`__ .
        ...
        **Request Syntax**
        ...
        :param DelaySeconds:
          ...
          processing after the delay period is finished. If you don't specify a value, the default value for
          the queue applies.
        ...
        :param MessageSystemAttributes:
          ...
          .. warning::
            ...
            * Currently, the only supported message system attribute is ``AWSTraceHeader`` . Its type must
            be ``String`` and its value must be a correctly formatted AWS X-Ray trace string.
        ...
        :param MessageDeduplicationId:
          ...
          deduplication interval. For more information, see `Exactly-Once Processing
          <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-exactly-once-processing>`__
          in the *Amazon Simple Queue Service Developer Guide* .
          ...
          * If you send one message with ``ContentBasedDeduplication`` enabled and then another message with
          ...
          The length of ``MessageDeduplicationId`` is 128 characters. ``MessageDeduplicationId`` can contain
        ...
        :param MessageGroupId:
          ...
          the same message group are processed in a FIFO manner (however, messages in different message
          groups might be processed out of order). To interleave multiple ordered streams within a single
          queue, use ``MessageGroupId`` values (for example, session data for multiple users). In this
          scenario, multiple consumers can process the queue, but the session data of each user is processed
          in a FIFO fashion.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **MD5OfMessageSystemAttributes** *(string) --*
              ...
              attribute to verify that Amazon SQS received the message correctly. Amazon SQS URL-decodes the
        ...
        :param Entries: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **DelaySeconds** *(integer) --*
              ...
              900. Maximum: 15 minutes. Messages with a positive ``DelaySeconds`` value become available for
            ...
            - **MessageDeduplicationId** *(string) --*
              ...
              delivered. For more information, see `Exactly-Once Processing
              <https://docs.aws.amazon.com/AWSSimpleQueueService/latest/SQSDeveloperGuide/FIFO-queues.html#FIFO-queues-exactly-once-processing>`__
              in the *Amazon Simple Queue Service Developer Guide* .
            ...
            - **Successful** *(list) --*
              ...
              - *(dict) --*
                ...
                - **MD5OfMessageSystemAttributes** *(string) --*
                  ...
                  the message before creating the MD5 digest. For information about MD5, see `RFC1321
                  <https://www.ietf.org/rfc/rfc1321.txt>`__ .
    ...
    def set_queue_attributes(self, QueueUrl: str, Attributes: Dict[str, str]) -> None:
        ...
        take up to 60 seconds for most of the attributes to propagate throughout the Amazon SQS system.
        ...
        **Request Syntax**
        ...
        :param Attributes: **[REQUIRED]**
          ...
          * ``MaximumMessageSize`` - The limit of how many bytes a message can contain before Amazon SQS
          rejects it. Valid values: An integer from 1,024 bytes (1 KiB) up to 262,144 bytes (256 KiB).
