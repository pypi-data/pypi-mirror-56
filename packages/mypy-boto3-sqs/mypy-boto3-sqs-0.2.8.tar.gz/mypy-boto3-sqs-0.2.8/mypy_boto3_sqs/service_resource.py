"Main interface for sqs ServiceResource"
...
class Queue(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`SQS.Client.get_queue_attributes` to update the attributes of the Queue
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sqs-2012-11-05/None>`_
...
class ServiceResourceQueuesCollection(ResourceCollection):
    ...
    def filter(self, QueueNamePrefix: str = None) -> List[service_resource_scope.Queue]:
        """
        Creates an iterable of all Queue resources in the collection filtered by kwargs passed to
        method.
