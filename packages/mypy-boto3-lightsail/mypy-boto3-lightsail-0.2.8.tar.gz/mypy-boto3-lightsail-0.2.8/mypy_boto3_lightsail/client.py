...
class Client(BaseClient):
                ...
                'operations': [
                    {
                        ...
                        'resourceName': 'string',
                        'resourceType':
                        'Instance'|'StaticIp'|'KeyPair'|'InstanceSnapshot'|'Domain'
                        |'PeeredVpc'|'LoadBalancer'|'LoadBalancerTlsCertificate'
                        ...
                        'location': {
                            ...
                            |'ca-central-1'|'ap-south-1'|'ap-southeast-1'
                            |'ap-southeast-2'|'ap-northeast-1'|'ap-northeast-2'
                        },
                        'isTerminal': True|False,
                        'operationDetails': 'string',
                        'operationType':
                        'DeleteKnownHostKeys'|'DeleteInstance'|'CreateInstance'
                        ...
                        |'DeleteDomain'|'CreateInstanceSnapshot'
                        ...
                        |'CreateRelationalDatabase'|'UpdateRelationalDatabase'
                        ...
                        |'StopRelationalDatabase'|'EnableAddOn'|'DisableAddOn',
    ...
    def attach_disk(
        ...
        the resource identified by ``disk name`` . For more information, see the `Lightsail Dev
        Guide
    ...
    def attach_load_balancer_tls_certificate(
        ...
        can also use this API to rotate the certificates on your account. Use the ``attach load
        balancer tls certificate`` operation with the non-attached certificate, and it will replace
        the existing one and become the attached certificate.
    ...
    def close_instance_public_ports(
        ...
        The ``close instance public ports`` operation supports tag-based access control via resource
          ...
          ::

            {
                'operation': {
                    ...
                    'resourceType':
                    'Instance'|'StaticIp'|'KeyPair'|'InstanceSnapshot'|'Domain'
                    |'PeeredVpc'|'LoadBalancer'|'LoadBalancerTlsCertificate'|'Disk'
                    ...
                    |'AttachStaticIp'|'DetachStaticIp'|'UpdateDomainEntry'
                    |'DeleteDomainEntry'|'CreateDomain'|'DeleteDomain'
                    |'CreateInstanceSnapshot'|'DeleteInstanceSnapshot'
                    ...
                    |'CreateLoadBalancerTlsCertificate'
                    |'DeleteLoadBalancerTlsCertificate'
                    |'AttachLoadBalancerTlsCertificate'|'CreateDisk'|'DeleteDisk'
                    |'AttachDisk'|'DetachDisk'|'CreateDiskSnapshot'|'DeleteDiskSnapshot'
                    ...
                    |'RebootRelationalDatabase'|'StopRelationalDatabase'|'EnableAddOn'
                    |'DisableAddOn',
                    'status': 'NotStarted'|'Started'|'Failed'|'Completed'|'Succeeded',
                    'statusChangedAt': datetime(2015, 1, 1),
                    'errorCode': 'string',
    ...
    def copy_snapshot(
        ...
        instance or disk snapshot as a manual snapshot. This operation can also be used to copy a
        manual or automatic snapshot of an instance or a disk from one AWS Region to another in
        Amazon Lightsail.
        ...
        resource name`` , ``target snapshot name`` , and either the ``restore date`` or the ``use
        latest restorable auto snapshot`` parameters.
        ...
        **Request Syntax**
        ...
        :param useLatestRestorableAutoSnapshot:
          ...
          This parameter cannot be defined together with the ``restore date`` parameter. The ``use
          latest restorable auto snapshot`` and ``restore date`` parameters are mutually exclusive.
        ...
        **Request Syntax**
        ...
        :param instances: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            using the ``create cloud formation stack`` operation.
    ...
    def create_disk(
        ...
        **Request Syntax**
        ...
        :param availabilityZone: **[REQUIRED]**
          ...
          The Availability Zone where you want to create the disk (e.g., ``us-east-2a`` ). Use the
        ...
        :param addOns:
          ...
          - *(dict) --*
            ...
            .. note::
              ...
              the `Lightsail pricing page <https://aws.amazon.com/lightsail/pricing/>`__ .
    ...
    def create_disk_from_snapshot(
        ...
        tags and resource tags applied to the resource identified by ``disk snapshot name`` . For
        more information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        **Request Syntax**
        ...
        :param availabilityZone: **[REQUIRED]**
          ...
          The Availability Zone where you want to create the disk (e.g., ``us-east-2a`` ). Choose
          the same Availability Zone as the Lightsail instance where you want to create the disk.
    ...
    def create_disk_snapshot(
        ...
        exclude any data that has been cached by any applications or the operating system. If you
        can pause any file systems on the disk long enough to take a snapshot, your snapshot should
        be complete. Nevertheless, if you cannot pause all file writes to the disk, you should
        ...
        To create a snapshot of a system volume, just define the ``instance name`` parameter when
        issuing the snapshot command, and a snapshot of the defined instance's system volume will be
        ...
        **Request Syntax**
        ...
        :param instanceName:
          ...
          The unique name of the source instance (e.g., ``Amazon_Linux-512MB-Virginia-1`` ). When
        ...
        **Request Syntax**
        ...
        :param domainName: **[REQUIRED]**
          ...
          .. note::
            ...
            using Amazon Route 53 or another domain name registrar. If you have already registered
    ...
    def create_instances(
        ...
        **Request Syntax**
        ...
        :param availabilityZone: **[REQUIRED]**
          ...
          `get regions
          <http://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetRegions.html>`__
        ...
        :param userData:
          ...
          .. note::
            ...
            FreeBSD uses ``pkg`` . For a complete list, see the `Dev Guide
    ...
    def create_instances_from_snapshot(
        ...
        **Request Syntax**
        ...
        :param sourceInstanceName:
          ...
          This parameter cannot be defined together with the ``instance snapshot name`` parameter.
    ...
    def create_load_balancer(
        ...
        **Request Syntax**
        ...
        :param certificateAlternativeNames:
          ...
          (e.g., ``www.example.com`` , ``example.com`` , ``m.example.com`` , ``blog.example.com`` ).
        ...
        **Request Syntax**
        ...
        :param masterUsername: **[REQUIRED]**
          ...
          * Cannot be a reserved word for the database engine you choose. For more information about
          reserved words in MySQL 5.6 or 5.7, see the Keywords and Reserved Words articles for
          `MySQL 5.6 <https://dev.mysql.com/doc/refman/5.6/en/keywords.html>`__ or `MySQL 5.7
        ...
        :param preferredBackupWindow:
          ...
          region, see the `Working With Backups
    ...
    def delete_auto_snapshot(
        ...
        **Request Syntax**
        ...
        :param date: **[REQUIRED]**
          ...
          Use the ``get auto snapshots`` operation to get the available automatic snapshots for a
          resource.
    ...
    def delete_domain(self, domainName: str) -> ClientDeleteDomainResponseTypeDef:
        ...
        to the resource identified by ``domain name`` . For more information, see the `Lightsail Dev
        Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **operation** *(dict) --*
              ...
              An array of key-value pairs containing information about the results of your delete
              domain request.
    ...
    def delete_instance(
        ...
        The ``delete instance`` operation supports tag-based access control via resource tags
        applied to the resource identified by ``instance name`` . For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
    ...
    def delete_instance_snapshot(
        ...
        tags applied to the resource identified by ``instance snapshot name`` . For more
        information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
    ...
    def delete_key_pair(self, keyPairName: str) -> ClientDeleteKeyPairResponseTypeDef:
        ...
        The ``delete key pair`` operation supports tag-based access control via resource tags
        applied to the resource identified by ``key pair name`` . For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
    ...
    def delete_known_host_keys(self, instanceName: str) -> ClientDeleteKnownHostKeysResponseTypeDef:
        ...
        .. warning::
          ...
          Perform this operation only if you were expecting the host key or certificate mismatch or
          if you are familiar with the new host key or certificate on the instance. For more
          information, see `Troubleshooting connection issues when using the Amazon Lightsail
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **operations** *(list) --*
              ...
              An array of key-value pairs containing information about the results of your detach
              static IP request.
    ...
    def export_snapshot(self, sourceSnapshotName: str) -> ClientExportSnapshotResponseTypeDef:
        ...
        The ``export snapshot`` operation supports tag-based access control via resource tags
        applied to the resource identified by ``source snapshot name`` . For more information, see
        the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextPageToken** *(string) --*
              ...
              A token used for advancing to the next page of results from your get active names
              request.
    ...
    def get_blueprints(
        ...
        app or development stack. The software each instance is running depends on the blueprint
        image you choose.
            ...
            - **bundles** *(list) --*
              ...
              - *(dict) --*
                ...
                - **supportedPlatforms** *(list) --*
                  ...
                  bundle supports. You can only launch a ``WINDOWS`` bundle on a blueprint that
                  supports the ``WINDOWS`` platform. ``LINUX_UNIX`` blueprints require a
                  ``LINUX_UNIX`` bundle.
    ...
    def get_cloud_formation_stack_records(
        ...
        **Request Syntax**
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results for your ``get cloud formation
          stack records`` request.
          ...
          - *(dict) --*
            ...
            - **cloudFormationStackRecords** *(list) --*
              ...
              - *(dict) --*
                ...
                stack used to create a new Amazon Elastic Compute Cloud instance from an exported
    ...
    def get_disk_snapshots(self, pageToken: str = None) -> ClientGetDiskSnapshotsResponseTypeDef:
        ...
        If you are describing a long list of disk snapshots, you can paginate the output to make the
        list more manageable. You can use the pageToken and nextPageToken values to retrieve the
    ...
    def get_disks(self, pageToken: str = None) -> ClientGetDisksResponseTypeDef:
        ...
        If you are describing a long list of disks, you can paginate the output to make the list
        more manageable. You can use the pageToken and nextPageToken values to retrieve the next
        items in the list.
              ...
              - *(dict) --*
                ...
                - **attachmentState** *(string) --*
                  ...
                  .. note::
                    ...
                    In releases prior to November 14, 2017, this parameter returned ``attached`` for
                    system disks in the API response. It is now deprecated, but still included in
                ...
                - **gbInUse** *(integer) --*
                  ...
                  .. note::
                    ...
                    API response. It is now deprecated.
              ...
              - **domainEntries** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **target** *(string) --*
                    ...
                    For Lightsail load balancers, the value looks like
                    ``ab1234c56789c6b86aba6fb203d443bc-123456789.us-east-2.elb.amazonaws.com`` . Be
                    sure to also set ``isAlias`` to ``true`` when setting up an A record for a load
                    balancer.
    ...
    def get_export_snapshot_records(
        ...
        **Request Syntax**
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results for your ``get export snapshot
          records`` request.
                        ...
                        'disks': [
                            {
                                ...
                                'resourceType':
                                'Instance'|'StaticIp'|'KeyPair'
                                |'InstanceSnapshot'|'Domain'|'PeeredVpc'
                                |'LoadBalancer'|'LoadBalancerTlsCertificate'
                                |'Disk'|'DiskSnapshot'|'RelationalDatabase'
                  ...
                  - *(dict) --*
                    ...
                    - **protocol** *(string) --*
                      ...
                      * ``tcp`` - Transmission Control Protocol (TCP) provides reliable, ordered,
                      and error-checked delivery of streamed data between applications running on
                      hosts communicating by an IP network. If you have an application that doesn't
                      require reliable data stream service, use UDP instead.

                      * ``all`` - All transport layer protocol types. For more general information,
                      see `Transport layer <https://en.wikipedia.org/wiki/Transport_layer>`__ on
                      Wikipedia.
                      ...
                      * ``udp`` - With User Datagram Protocol (UDP), computer applications can send
                      ...
                      paths. Applications that don't require reliable data stream service can use
                      UDP, which provides a connectionless datagram service that emphasizes reduced
                      latency over reliability. If you do require reliable data stream service, use
                      TCP instead.
          ...
          - *(dict) --*
            ...
            - **accessDetails** *(dict) --*
              ...
              - **password** *(string) --*
                ...
                empty string if the password for your new instance is not ready yet. When you create
              ...
              - **passwordData** *(dict) --*
                ...
                your password. This is only needed if ``password`` is empty and the instance is not
                new (and therefore the password is not ready yet). When you create an instance, it
                ...
                - **keyPairName** *(string) --*
                  ...
                  your password using the ``ciphertext`` . Lightsail creates the ciphertext by
                    ...
                    'fromAttachedDisks': [
                        {
                            ...
                            'location': {
                                ...
                                'us-east-1'|'us-east-2'|'us-west-1'
                                |'us-west-2'|'eu-west-1'|'eu-west-2'
                                |'eu-west-3'|'eu-central-1'|'ca-central-1'
                                |'ap-south-1'|'ap-southeast-1'
                                |'ap-southeast-2'|'ap-northeast-1'
                                |'ap-northeast-2'
                            },
                            'resourceType':
                            'Instance'|'StaticIp'|'KeyPair'|'InstanceSnapshot'
                            |'Domain'|'PeeredVpc'|'LoadBalancer'
                            |'LoadBalancerTlsCertificate'|'Disk'|'DiskSnapshot'
                            ...
                            'disks': [
                                {
                                    ...
                                    'resourceType':
                                    'Instance'|'StaticIp'|'KeyPair'
                                    |'InstanceSnapshot'|'Domain'
                                    |'PeeredVpc'|'LoadBalancer'
                                    |'LoadBalancerTlsCertificate'|'Disk'
                                    |'DiskSnapshot'|'RelationalDatabase'
                                    |'RelationalDatabaseSnapshot'
                                    |'ExportSnapshotRecord'
                                    |'CloudFormationStackRecord',
                                    'tags': [
                      ...
                      - **tags** *(list) --*
                        ...
                        - *(dict) --*
                          ...
                          - **key** *(string) --*
                            ...
                            in UTF-8, or the following characters: + - =
                                 . _ : / @
                  ...
                  - **ports** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **protocol** *(string) --*
                        ...
                        * ``tcp`` - Transmission Control Protocol (TCP) provides reliable, ordered,
                        and error-checked delivery of streamed data between applications running on
                        hosts communicating by an IP network. If you have an application that
                        ...
                        * ``all`` - All transport layer protocol types. For more general
                        ...
                        <https://en.wikipedia.org/wiki/Transport_layer>`__ on Wikipedia.
                    ...
                    'instanceHealthSummary': [
                        {
                            ...
                            |'Instance.NotRegistered'|'Instance.NotInUse'
              ...
              - **instanceHealthSummary** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **instanceHealthReason** *(string) --*
                    ...
                    * **``Lb.InitialHealthChecking`` ** - The Lightsail load balancer is still
                    sending the target instance the minimum number of health checks required to
                    ...
                    * **``Instance.NotInUse`` ** - The target group is not used by any load
                    balancer, or the target instance is in an Availability Zone that is not enabled
                    for its load balancer.

                    * **``Instance.IpUnusable`` ** - The target IP address is reserved for use by a
                    Lightsail load balancer.

                    * **``Instance.InvalidState`` ** - The target is in the stopped or terminated
                    state.

                    If ** ``instanceHealth`` ** is ``draining`` , the ** ``instanceHealthReason`` **
                    value can be one of the following:

                    * **``Instance.DeregistrationInProgress`` ** - The target instance is in the
    ...
    def get_load_balancer_metric_data(
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_load_balancer_metric_data(
              ...
              metricName=
                  ...
                  |'HTTPCode_Instance_5XX_Count'|'InstanceResponseTime'|'RejectedConnectionCount'
                  |'RequestCount',
              period=123,
              startTime=datetime(2015, 1, 1),
              endTime=datetime(2015, 1, 1),
        ...
        :param metricName: **[REQUIRED]**
          ...
          along with the most useful ``statistics`` to include in your request.
          ...
          * **``HTTPCode_LB_4XX_Count`` ** - The number of HTTP 4XX client error codes that
          originate from the load balancer. Client errors are generated when requests are malformed
          or incomplete. These requests have not been received by the target instance. This count
          does not include any response codes generated by the target instances.  ``Statistics`` :
          The most useful statistic is ``Sum`` . Note that ``Minimum`` , ``Maximum`` , and
          ``Average`` all return ``1`` .

          * **``HTTPCode_LB_5XX_Count`` ** - The number of HTTP 5XX server error codes that
          originate from the load balancer. This count does not include any response codes generated
          by the target instances.  ``Statistics`` : The most useful statistic is ``Sum`` . Note
          that ``Minimum`` , ``Maximum`` , and ``Average`` all return ``1`` . Note that ``Minimum``
          , ``Maximum`` , and ``Average`` all return ``1`` .

          * **``HTTPCode_Instance_2XX_Count`` ** - The number of HTTP response codes generated by
          the target instances. This does not include any response codes generated by the load
          balancer.  ``Statistics`` : The most useful statistic is ``Sum`` . Note that ``Minimum`` ,
          ``Maximum`` , and ``Average`` all return ``1`` .

          * **``HTTPCode_Instance_3XX_Count`` ** - The number of HTTP response codes generated by
          the target instances. This does not include any response codes generated by the load
          balancer.   ``Statistics`` : The most useful statistic is ``Sum`` . Note that ``Minimum``
          , ``Maximum`` , and ``Average`` all return ``1`` .

          * **``HTTPCode_Instance_4XX_Count`` ** - The number of HTTP response codes generated by
          the target instances. This does not include any response codes generated by the load
          balancer.  ``Statistics`` : The most useful statistic is ``Sum`` . Note that ``Minimum`` ,
          ``Maximum`` , and ``Average`` all return ``1`` .

          * **``HTTPCode_Instance_5XX_Count`` ** - The number of HTTP response codes generated by
          the target instances. This does not include any response codes generated by the load
          balancer.  ``Statistics`` : The most useful statistic is ``Sum`` . Note that ``Minimum`` ,
          ``Maximum`` , and ``Average`` all return ``1`` .

          * **``InstanceResponseTime`` ** - The time elapsed, in seconds, after the request leaves
          the load balancer until a response from the target instance is received.  ``Statistics`` :
        ...
        :param statistics: **[REQUIRED]**
          ...
          * **``Average`` ** - The value of Sum / SampleCount during the specified period. By
          comparing this statistic with the Minimum and Maximum, you can determine the full scope of
          a metric and how close the average use is to the Minimum and Maximum. This comparison
          ...
          * **``Minimum`` ** - The lowest value observed during the specified period. You can use
          this value to determine low volumes of activity for your application.

          * **``Maximum`` ** - The highest value observed during the specified period. You can use
          ...
          - *(dict) --*
            ...
            - **metricName** *(string) --*
              ...
              * **``ClientTLSNegotiationErrorCount`` ** - The number of TLS connections initiated by
              the client that did not establish a session with the load balancer. Possible causes
              include a mismatch of ciphers or protocols.  ``Statistics`` : The most useful
              statistic is ``Sum`` .

              * **``HealthyHostCount`` ** - The number of target instances that are considered
              healthy.  ``Statistics`` : The most useful statistic are ``Average`` , ``Minimum`` ,
              and ``Maximum`` .
              ...
              * **``HTTPCode_LB_4XX_Count`` ** - The number of HTTP 4XX client error codes that
              originate from the load balancer. Client errors are generated when requests are
              malformed or incomplete. These requests have not been received by the target instance.
              This count does not include any response codes generated by the target instances.
              ``Statistics`` : The most useful statistic is ``Sum`` . Note that ``Minimum`` ,
              ``Maximum`` , and ``Average`` all return ``1`` .

              * **``HTTPCode_LB_5XX_Count`` ** - The number of HTTP 5XX server error codes that
              originate from the load balancer. This count does not include any response codes
              generated by the target instances.  ``Statistics`` : The most useful statistic is
              ``Sum`` . Note that ``Minimum`` , ``Maximum`` , and ``Average`` all return ``1`` .
              ...
              * **``RequestCount`` ** - The number of requests processed over IPv4. This count
              ...
              balancer.  ``Statistics`` : The most useful statistic is ``Sum`` . Note that
              ``Minimum`` , ``Maximum`` , and ``Average`` all return ``1`` .
                ...
                'tlsCertificates': [
                    {
                        ...
                        |'DOMAIN_NOT_ALLOWED'|'INVALID_PUBLIC_DOMAIN'|'OTHER',
                        ...
                        'renewalSummary': {
                            'renewalStatus':
                            'PENDING_AUTO_RENEWAL'|'PENDING_VALIDATION'
                            |'SUCCESS'|'FAILED',
            ...
            - **tlsCertificates** *(list) --*
              ...
              - *(dict) --*
                ...
                - **renewalSummary** *(dict) --*
                  ...
                  An object containing information about the status of Lightsail's managed renewal
                  for the certificate.

                  - **renewalStatus** *(string) --*

                    The status of Lightsail's managed renewal of the certificate. Valid values are
                    listed below.
                ...
                - **subjectAlternativeNames** *(list) --*
                  ...
                  the domain names that are bound to the public key that is contained in the
                  certificate. The subject alternative names include the canonical domain name
                  (CNAME) of the certificate and additional domain names that can be used to connect
                  to the website, such as ``example.com`` , ``www.example.com`` , or
                  ``m.example.com`` .
    ...
    def get_load_balancers(self, pageToken: str = None) -> ClientGetLoadBalancersResponseTypeDef:
        ...
        If you are describing a long list of load balancers, you can paginate the output to make the
        list more manageable. You can use the pageToken and nextPageToken values to retrieve the
        next items in the list.
                        ...
                        'instanceHealthSummary': [
                            {
                                'instanceName': 'string',
                                'instanceHealth':
                                'initial'|'healthy'|'unhealthy'|'unused'
                ...
                - **instanceHealthSummary** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **instanceHealthReason** *(string) --*
                      ...
                      * **``Lb.RegistrationInProgress`` ** - The target instance is in the process
                      ...
                      * **``Instance.FailedHealthChecks`` ** - The health checks failed because the
                      connection to the target instance timed out, the target instance response was
                      malformed, or the target instance failed the health check for an unknown
                      reason.

                      * **``Lb.InternalError`` ** - The health checks failed due to an internal
                      error.
                      ...
                      * **``Instance.IpUnusable`` ** - The target IP address is reserved for use by
    ...
    def get_operations(self, pageToken: str = None) -> ClientGetOperationsResponseTypeDef:
        ...
        making each subsequent call to ``GetOperations`` use the maximum (last) ``statusChangedAt``
          ...
          - *(dict) --*
            ...
            - **nextPageCount** *(string) --*
              ...
              .. note::
                ...
                is now deprecated, and the API returns the ``next page token`` parameter instead.
          ...
          - *(dict) --*
            ...
            - **relationalDatabase** *(dict) --*
              ...
              - **relationalDatabaseBlueprintId** *(string) --*
                ...
                The blueprint ID for the database. A blueprint describes the major engine version of
                a database.
    ...
    def get_relational_database_events(
        ...
        **Request Syntax**
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results from for get relational database
          events request.
    ...
    def get_relational_database_log_events(
        ...
        **Request Syntax**
        ...
        :param startTime:
          ...
          * Specified in the Unix time format. For example, if you wish to use a start time of
          October 1, 2018, at 8 PM UTC, then you input ``1538424000`` as the start time.
        ...
        :param endTime:
          ...
          * Specified in the Unix time format. For example, if you wish to use an end time of
          October 1, 2018, at 8 PM UTC, then you input ``1538424000`` as the end time.
    ...
    def get_relational_database_master_user_password(
        ...
        **Request Syntax**
        ...
        :param passwordVersion:
          ...
          rotate to ``CURRENT`` . After the ``PENDING`` password rotates to ``CURRENT`` , the
    ...
    def get_relational_database_parameters(
        ...
        about each parameter. This information includes whether changes require a reboot, whether
        the parameter is modifiable, the allowed values, and the data types.
          ...
          - *(dict) --*
            ...
            - **relationalDatabaseSnapshot** *(dict) --*
              ...
              - **supportCode** *(string) --*
                ...
                support when you have questions about a database snapshot in Lightsail. This code
                enables our support team to look up your Lightsail information more easily.
            ...
            - **relationalDatabases** *(list) --*
              ...
              - *(dict) --*
                ...
                - **supportCode** *(string) --*
                  ...
                  The support code for the database. Include this code in your email to support when
                  you have questions about a database in Lightsail. This code enables our support
                  team to look up your Lightsail information more easily.
    ...
    def open_instance_public_ports(
        ...
        The ``open instance public ports`` operation supports tag-based access control via resource
        tags applied to the resource identified by ``instance name`` . For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
    ...
    def put_instance_public_ports(
        ...
        """
        Sets the specified open ports for an Amazon Lightsail instance, and closes all ports for
        every protocol not included in the current request.

        The ``put instance public ports`` operation supports tag-based access control via resource
        tags applied to the resource identified by ``instance name`` . For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
    ...
    def reboot_instance(self, instanceName: str) -> ClientRebootInstanceResponseTypeDef:
        ...
        The ``reboot instance`` operation supports tag-based access control via resource tags
        applied to the resource identified by ``instance name`` . For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
    ...
    def start_instance(self, instanceName: str) -> ClientStartInstanceResponseTypeDef:
        ...
        .. note::
          ...
          static IP address and attach it to the instance. For more information, see the `Lightsail
          Dev Guide
        ...
        to the resource identified by ``instance name`` . For more information, see the `Lightsail
        Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        **Request Syntax**
        ...
        :param force:
          ...
          .. warning::
            ...
            any other state, your instance should stop normally without adding this parameter to
            your API request.
    ...
    def tag_resource(
        ...
        unique per resource. For more information about tags, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-tags>`__ .

        The ``tag resource`` operation supports tag-based access control via request tags and
        resource tags applied to the resource identified by ``resource name`` . For more
        information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        **Request Syntax**
        ::
          ...
          response = client.update_load_balancer_attribute(
              loadBalancerName='string',
              attributeName=
                  'HealthCheckPath'|'SessionStickinessEnabled'
    ...
    def update_relational_database_parameters(
        ...
        preferred maintenance window. However, there are two ways in which paramater updates are
        applied: ``dynamic`` or ``pending-reboot`` . Parameters marked with a ``dynamic`` apply type
        are applied immediately. Parameters marked with a ``pending-reboot`` apply type are applied
        only after the database is rebooted using the ``reboot relational database`` operation.

        The ``update relational database parameters`` operation supports tag-based access control
