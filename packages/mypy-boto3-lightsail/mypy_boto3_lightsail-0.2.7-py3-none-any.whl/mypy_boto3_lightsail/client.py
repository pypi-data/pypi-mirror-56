"Main interface for lightsail Client"
...
class Client(BaseClient):
    ...
    def allocate_static_ip(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/AllocateStaticIp>`_
                ...
                'operations': [
                    {
                        ...
                        'resourceName': 'string',
                        'resourceType':
                        'Instance'|'StaticIp'|'KeyPair'|'InstanceSnapshot'|'Domain'|'PeeredVpc'
                        |'LoadBalancer'|'LoadBalancerTlsCertificate'|'Disk'|'DiskSnapshot'
                        |'RelationalDatabase'|'RelationalDatabaseSnapshot'|'ExportSnapshotRecord'
                        ...
                        'location': {
                            ...
                            |'eu-west-3'|'eu-central-1'|'ca-central-1'|'ap-south-1'|'ap-southeast-1'
                            |'ap-southeast-2'|'ap-northeast-1'|'ap-northeast-2'
                        },
                        'isTerminal': True|False,
                        'operationDetails': 'string',
                        'operationType':
                        'DeleteKnownHostKeys'|'DeleteInstance'|'CreateInstance'|'StopInstance'
                        |'StartInstance'|'RebootInstance'|'OpenInstancePublicPorts'|'PutInstancePublicPorts'
                        |'CloseInstancePublicPorts'|'AllocateStaticIp'|'ReleaseStaticIp'|'AttachStaticIp'
                        |'DetachStaticIp'|'UpdateDomainEntry'|'DeleteDomainEntry'|'CreateDomain'
                        |'DeleteDomain'|'CreateInstanceSnapshot'|'DeleteInstanceSnapshot'
                        |'CreateInstancesFromSnapshot'|'CreateLoadBalancer'|'DeleteLoadBalancer'
                        |'AttachInstancesToLoadBalancer'|'DetachInstancesFromLoadBalancer'
                        |'UpdateLoadBalancerAttribute'|'CreateLoadBalancerTlsCertificate'
                        |'DeleteLoadBalancerTlsCertificate'|'AttachLoadBalancerTlsCertificate'|'CreateDisk'
                        |'DeleteDisk'|'AttachDisk'|'DetachDisk'|'CreateDiskSnapshot'|'DeleteDiskSnapshot'
                        |'CreateDiskFromSnapshot'|'CreateRelationalDatabase'|'UpdateRelationalDatabase'
                        ...
                        |'UpdateRelationalDatabaseParameters'|'StartRelationalDatabase'
                        |'RebootRelationalDatabase'|'StopRelationalDatabase'|'EnableAddOn'|'DisableAddOn',
    ...
    def attach_disk(
        ...
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/AttachDisk>`_
    ...
    def attach_instances_to_load_balancer(
        ...
        The ``attach instances to load balancer`` operation supports tag-based access control via resource
        tags applied to the resource identified by ``load balancer name`` . For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/AttachInstancesToLoadBalancer>`_
        ...
        **Request Syntax**
        ...
        :param instanceNames: **[REQUIRED]**
          ...
          There are no additional limits on the number of instances you can attach to your load balancer,
          aside from the limit of Lightsail instances you can create in your account (20).
    ...
    def attach_load_balancer_tls_certificate(
        ...
        more secure version of Secure Socket Layer (SSL).

        Once you create and validate your certificate, you can attach it to your load balancer. You can also
        use this API to rotate the certificates on your account. Use the ``attach load balancer tls
        certificate`` operation with the non-attached certificate, and it will replace the existing one and
        become the attached certificate.

        The ``attach load balancer tls certificate`` operation supports tag-based access control via
        resource tags applied to the resource identified by ``load balancer name`` . For more information,
        see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/AttachLoadBalancerTlsCertificate>`_
    ...
    def attach_static_ip(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/AttachStaticIp>`_
    ...
    def close_instance_public_ports(
        ...
        applied to the resource identified by ``instance name`` . For more information, see the `Lightsail
        Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CloseInstancePublicPorts>`_
          ...
          ::

            {
                'operation': {
                    ...
                    |'LoadBalancerTlsCertificate'|'Disk'|'DiskSnapshot'|'RelationalDatabase'
                    |'RelationalDatabaseSnapshot'|'ExportSnapshotRecord'|'CloudFormationStackRecord',
                    'createdAt': datetime(2015, 1, 1),
                    'location': {
                        'availabilityZone': 'string',
                        'regionName':
                        'us-east-1'|'us-east-2'|'us-west-1'|'us-west-2'|'eu-west-1'|'eu-west-2'|'eu-west-3'
                        |'eu-central-1'|'ca-central-1'|'ap-south-1'|'ap-southeast-1'|'ap-southeast-2'
                        |'ap-northeast-1'|'ap-northeast-2'
                    },
                    'isTerminal': True|False,
                    'operationDetails': 'string',
                    'operationType':
                    'DeleteKnownHostKeys'|'DeleteInstance'|'CreateInstance'|'StopInstance'|'StartInstance'
                    |'RebootInstance'|'OpenInstancePublicPorts'|'PutInstancePublicPorts'
                    |'CloseInstancePublicPorts'|'AllocateStaticIp'|'ReleaseStaticIp'|'AttachStaticIp'
                    |'DetachStaticIp'|'UpdateDomainEntry'|'DeleteDomainEntry'|'CreateDomain'|'DeleteDomain'
                    ...
                    |'AttachLoadBalancerTlsCertificate'|'CreateDisk'|'DeleteDisk'|'AttachDisk'|'DetachDisk'
                    |'CreateDiskSnapshot'|'DeleteDiskSnapshot'|'CreateDiskFromSnapshot'
                    |'CreateRelationalDatabase'|'UpdateRelationalDatabase'|'DeleteRelationalDatabase'
                    ...
                    |'StartRelationalDatabase'|'RebootRelationalDatabase'|'StopRelationalDatabase'
    ...
    def copy_snapshot(
        ...
        """
        Copies a manual instance or disk snapshot as another manual snapshot, or copies an automatic
        instance or disk snapshot as a manual snapshot. This operation can also be used to copy a manual or
        automatic snapshot of an instance or a disk from one AWS Region to another in Amazon Lightsail.
        ...
        When copying an *automatic snapshot* , be sure to define the ``source region`` , ``source resource
        name`` , ``target snapshot name`` , and either the ``restore date`` or the ``use latest restorable
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CopySnapshot>`_
        ...
        **Request Syntax**
        ...
        :param sourceResourceName:
          ...
          .. note::
            ...
            <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__
            .
        ...
        :param restoreDate:
          ...
          Use the ``get auto snapshots`` operation to identify the dates of the available automatic
          snapshots.
        ...
        :param useLatestRestorableAutoSnapshot:
          ...
          restorable auto snapshot`` and ``restore date`` parameters are mutually exclusive.
    ...
    def create_cloud_formation_stack(
        ...
        track the AWS CloudFormation stack created. Use the ``get cloud formation stack records`` operation
        to get a list of the CloudFormation stacks created.

        .. warning::

          Wait until after your new Amazon EC2 instance is created before running the ``create cloud
          formation stack`` operation again with the same export snapshot record.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateCloudFormationStack>`_
        ...
        **Request Syntax**
        ...
        :param instances: **[REQUIRED]**
          ...
          one instance entry at a time in this array. You will get an invalid parameter error if you pass
          ...
          - *(dict) --*
            ...
            - **userData** *(string) --*
              ...
              .. note::
                ...
                varies. Amazon Linux and CentOS use ``yum`` , Debian and Ubuntu use ``apt-get`` , and
                FreeBSD uses ``pkg`` .
    ...
    def create_disk(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateDisk>`_
    ...
    def create_disk_from_snapshot(
        ...
        be attached to an Amazon Lightsail instance in the same Availability Zone (e.g., ``us-east-2a`` ).

        The ``create disk from snapshot`` operation supports tag-based access control via request tags and
        resource tags applied to the resource identified by ``disk snapshot name`` . For more information,
        see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateDiskFromSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param diskSnapshotName:
          ...
          This parameter cannot be defined together with the ``source disk name`` parameter. The ``disk
          snapshot name`` and ``source disk name`` parameters are mutually exclusive.
        ...
        :param sourceDiskName:
          ...
          This parameter cannot be defined together with the ``disk snapshot name`` parameter. The ``source
          disk name`` and ``disk snapshot name`` parameters are mutually exclusive.
    ...
    def create_disk_snapshot(
        ...
        disks, and to save data before shutting down a Lightsail instance.

        You can take a snapshot of an attached disk that is in use; however, snapshots only capture data
        that has been written to your disk at the time the snapshot command is issued. This may exclude any
        data that has been cached by any applications or the operating system. If you can pause any file
        systems on the disk long enough to take a snapshot, your snapshot should be complete. Nevertheless,
        if you cannot pause all file writes to the disk, you should unmount the disk from within the
        Lightsail instance, issue the create disk snapshot command, and then remount the disk to ensure a
        consistent and complete snapshot. You may remount and use your disk while the snapshot status is
        pending.

        You can also use this operation to create a snapshot of an instance's system volume. You might want
        to do this, for example, to recover data from the system volume of a botched instance or to create a
        backup of the system volume like you would for a block storage disk. To create a snapshot of a
        system volume, just define the ``instance name`` parameter when issuing the snapshot command, and a
        snapshot of the defined instance's system volume will be created. After the snapshot is available,
        you can create a block storage disk from the snapshot and attach it to a running instance to access
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateDiskSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param instanceName:
          ...
          The unique name of the source instance (e.g., ``Amazon_Linux-512MB-Virginia-1`` ). When this is
    ...
    def create_domain(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateDomain>`_
        ...
        **Request Syntax**
        ...
        :param domainName: **[REQUIRED]**
          ...
          .. note::
            ...
            You cannot register a new domain name using Lightsail. You must register a domain name using
            Amazon Route 53 or another domain name registrar. If you have already registered your domain,
            you can enter its name in this parameter to manage the DNS records for that domain.
    ...
    def create_domain_entry(
        ...
        """
        Creates one of the following entry records associated with the domain: Address (A), canonical name
        (CNAME), mail exchanger (MX), name server (NS), start of authority (SOA), service locator (SRV), or
        text (TXT).

        The ``create domain entry`` operation supports tag-based access control via resource tags applied to
        the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateDomainEntry>`_
        ...
        **Request Syntax**
        ...
        :param domainEntry: **[REQUIRED]**
          ...
          - **isAlias** *(boolean) --*
            ...
            balancer. You can include an alias (A type) record in your request, which points to a load
            balancer DNS name and routes traffic to your load balancer

          - **type** *(string) --*

            The type of domain entry, such as address (A), canonical name (CNAME), mail exchanger (MX), name
          ...
          - **options** *(dict) --*
            ...
            .. note::
              ...
              In releases prior to November 29, 2017, this parameter was not included in the API response.
    ...
    def create_instance_snapshot(
        ...
        create a new instance that is based on that snapshot.

        The ``create instance snapshot`` operation supports tag-based access control via request tags. For
        more information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateInstanceSnapshot>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **operations** *(list) --*
              ...
              An array of key-value pairs containing information about the results of your create instances
              snapshot request.
    ...
    def create_instances(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateInstances>`_
        ...
        **Request Syntax**
        ...
        :param availabilityZone: **[REQUIRED]**
          ...
          <http://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetRegions.html>`__ operation.
        ...
        :param userData:
          ...
          A launch script you can create that configures a server with additional user data. For example,
          you might want to run ``apt-get -y update`` .

          .. note::

            Depending on the machine image you choose, the command to get software on your instance varies.
            Amazon Linux and CentOS use ``yum`` , Debian and Ubuntu use ``apt-get`` , and FreeBSD uses
            ``pkg`` . For a complete list, see the `Dev Guide
            <https://lightsail.aws.amazon.com/ls/docs/getting-started/article/compare-options-choose-lightsail-instance-image>`__
            .
    ...
    def create_instances_from_snapshot(
        ...
        The ``create instances from snapshot`` operation supports tag-based access control via request tags
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateInstancesFromSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param availabilityZone: **[REQUIRED]**
          ...
          ``us-east-2a`` (case sensitive). You can get a list of Availability Zones by using the `get
          regions <http://docs.aws.amazon.com/lightsail/2016-11-28/api-reference/API_GetRegions.html>`__
    ...
    def create_key_pair(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateKeyPair>`_
          ...
          - *(dict) --*
            ...
            - **keyPair** *(dict) --*
              ...
              - **tags** *(list) --*
                ...
                Lightsail, see the `Lightsail Dev Guide
                <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-tags>`__ .
            ...
            - **operation** *(dict) --*
              ...
              An array of key-value pairs containing information about the results of your create key pair
              request.
    ...
    def create_load_balancer(
        ...
        application, see `Configure your Lightsail instances for load balancing
        <https://lightsail.aws.amazon.com/ls/docs/how-to/article/configure-lightsail-instances-for-load-balancing>`__
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateLoadBalancer>`_
    ...
    def create_load_balancer_tls_certificate(
        ...
        The ``create load balancer tls certificate`` operation supports tag-based access control via
        resource tags applied to the resource identified by ``load balancer name`` . For more information,
        see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateLoadBalancerTlsCertificate>`_
        ...
        **Request Syntax**
        ...
        :param certificateName: **[REQUIRED]**
          ...
          You can have up to 10 certificates in your account at one time. Each Lightsail load balancer can
          have up to 2 certificates associated with it at one time. There is also an overall limit to the
          number of certificates that can be issue in a 365-day period. For more information, see `Limits
          <http://docs.aws.amazon.com/acm/latest/userguide/acm-limits.html>`__ .
        ...
        :param certificateAlternativeNames:
          ...
          addition to the 1 primary domain). We do not support wildcards (e.g., ``*.example.com`` ).
    ...
    def create_relational_database(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateRelationalDatabase>`_
        ...
        **Request Syntax**
        ...
        :param availabilityZone:
          ...
          You can get a list of Availability Zones by using the ``get regions`` operation. Be sure to add
        ...
        :param masterUsername: **[REQUIRED]**
          ...
          * Cannot be a reserved word for the database engine you choose. For more information about
          reserved words in MySQL 5.6 or 5.7, see the Keywords and Reserved Words articles for `MySQL 5.6
          <https://dev.mysql.com/doc/refman/5.6/en/keywords.html>`__ or `MySQL 5.7
          <https://dev.mysql.com/doc/refman/5.7/en/keywords.html>`__ respectively.
        ...
        :param preferredBackupWindow:
          ...
          Region. For more information about the preferred backup window time blocks for each region, see
    ...
    def create_relational_database_from_snapshot(
        ...
        The ``create relational database from snapshot`` operation supports tag-based access control via
        request tags and resource tags applied to the resource identified by relationalDatabaseSnapshotName.
        For more information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateRelationalDatabaseFromSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param restoreTime:
          ...
          * Specified in the Unix time format. For example, if you wish to use a restore time of October 1,
          2018, at 8 PM UTC, then you input ``1538424000`` as the restore time.
    ...
    def create_relational_database_snapshot(
        ...
        copies of a database, and to save data before deleting a database.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/CreateRelationalDatabaseSnapshot>`_
    ...
    def delete_auto_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteAutoSnapshot>`_
    ...
    def delete_disk(
        ...
        """
        Deletes the specified block storage disk. The disk must be in the ``available`` state (not attached
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteDisk>`_
    ...
    def delete_disk_snapshot(
        ...
        When you make periodic snapshots of a disk, the snapshots are incremental, and only the blocks on
        ...
        snapshots have been deleted, all active snapshots will have access to all the information needed to
        restore the disk.

        The ``delete disk snapshot`` operation supports tag-based access control via resource tags applied
        to the resource identified by ``disk snapshot name`` . For more information, see the `Lightsail Dev
        Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteDiskSnapshot>`_
    ...
    def delete_domain(self, domainName: str) -> ClientDeleteDomainResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteDomain>`_
    ...
    def delete_domain_entry(
        ...
        The ``delete domain entry`` operation supports tag-based access control via resource tags applied to
        the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteDomainEntry>`_
    ...
    def delete_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteInstance>`_
    ...
    def delete_instance_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteInstanceSnapshot>`_
    ...
    def delete_key_pair(self, keyPairName: str) -> ClientDeleteKeyPairResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteKeyPair>`_
    ...
    def delete_known_host_keys(
        ...
        clients to connect to the instance after a host key mismatch.

        .. warning::

          Perform this operation only if you were expecting the host key or certificate mismatch or if you
          are familiar with the new host key or certificate on the instance. For more information, see
          `Troubleshooting connection issues when using the Amazon Lightsail browser-based SSH or RDP client
          <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-troubleshooting-browser-based-ssh-rdp-client-connection>`__
          .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteKnownHostKeys>`_
    ...
    def delete_load_balancer(
        ...
        The ``delete load balancer`` operation supports tag-based access control via resource tags applied
        to the resource identified by ``load balancer name`` . For more information, see the `Lightsail Dev
        Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteLoadBalancer>`_
    ...
    def delete_load_balancer_tls_certificate(
        ...
        The ``delete load balancer tls certificate`` operation supports tag-based access control via
        resource tags applied to the resource identified by ``load balancer name`` . For more information,
        see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteLoadBalancerTlsCertificate>`_
        ...
        **Request Syntax**
        ...
        :param force:
          ...
          There can be two certificates associated with a Lightsail load balancer: the primary and the
          backup. The ``force`` parameter is required when the primary SSL/TLS certificate is in use by an
    ...
    def delete_relational_database(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteRelationalDatabase>`_
        ...
        **Request Syntax**
        ...
        :param skipFinalSnapshot:
          ...
          ``true`` is specified, no database snapshot is created. If ``false`` is specified, a database
          snapshot is created before your database is deleted.

          You must specify the ``final relational database snapshot name`` parameter if the ``skip final
          snapshot`` parameter is ``false`` .
    ...
    def delete_relational_database_snapshot(
        ...
        tags applied to the resource identified by relationalDatabaseName. For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DeleteRelationalDatabaseSnapshot>`_
    ...
    def detach_disk(self, diskName: str) -> ClientDetachDiskResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DetachDisk>`_
    ...
    def detach_instances_from_load_balancer(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DetachInstancesFromLoadBalancer>`_
    ...
    def detach_static_ip(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DetachStaticIp>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **operations** *(list) --*
              ...
              An array of key-value pairs containing information about the results of your detach static IP
              request.
    ...
    def disable_add_on(
        ...
        """
        Disables an add-on for an Amazon Lightsail resource. For more information, see the `Lightsail Dev
        Guide
        <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DisableAddOn>`_
    ...
    def download_default_key_pair(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/DownloadDefaultKeyPair>`_
    ...
    def enable_add_on(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/EnableAddOn>`_
    ...
    def export_snapshot(
        ...
        Exported instance snapshots appear in Amazon EC2 as Amazon Machine Images (AMIs), and the instance
        system disk appears as an Amazon Elastic Block Store (Amazon EBS) volume. Exported disk snapshots
        appear in Amazon EC2 as Amazon EBS volumes. Snapshots are exported to the same Amazon Web Services
        ...
        .. note::
          ...
          Use the ``get instance snapshots`` or ``get disk snapshots`` operations to get a list of snapshots
          that you can export to Amazon EC2.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/ExportSnapshot>`_
    ...
    def get_active_names(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetActiveNames>`_
    ...
    def get_auto_snapshots(
        ...
        """
        Returns the available automatic snapshots for the specified resource name. For more information, see
        the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en_us/articles/amazon-lightsail-configuring-automatic-snapshots>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetAutoSnapshots>`_
    ...
    def get_blueprints(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetBlueprints>`_
            ...
            - **blueprints** *(list) --*
              ...
              - *(dict) --*
                ...
                - **isActive** *(boolean) --*
                  ...
                  to support customers with existing instances but are not necessarily available for launch
                  of new instances. Blueprints are marked inactive when they become outdated due to
    ...
    def get_bundles(
        ...
        """
        Returns the list of bundles that are available for purchase. A bundle describes the specs for your
        virtual private server (or *instance* ).

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetBundles>`_
              ...
              - *(dict) --*
                ...
                *instance* ).
                ...
                - **power** *(integer) --*
                  ...
                  A numeric value that represents the power of the bundle (e.g., ``500`` ). You can use the
                  bundle's power value in conjunction with a blueprint's minimum power value to determine
                  whether the blueprint will run on the bundle. For example, you need a bundle with a power
                  value of 500 or more to create an instance that uses a blueprint with a minimum power
                  value of 500.
    ...
    def get_cloud_formation_stack_records(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetCloudFormationStackRecords>`_
        ...
        **Request Syntax**
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results for your ``get cloud formation stack
          records`` request.
            ...
            - **cloudFormationStackRecords** *(list) --*
              ...
              - *(dict) --*
                ...
                - **destinationInfo** *(dict) --*
                  ...
                  A list of objects describing the destination service, which is AWS CloudFormation, and the
                  Amazon Resource Name (ARN) of the AWS CloudFormation stack.
    ...
    def get_disk(self, diskName: str) -> ClientGetDiskResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetDisk>`_
    ...
    def get_disk_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetDiskSnapshot>`_
    ...
    def get_disk_snapshots(
        ...
        If you are describing a long list of disk snapshots, you can paginate the output to make the list
        more manageable. You can use the pageToken and nextPageToken values to retrieve the next items in
        the list.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetDiskSnapshots>`_
            ...
            - **diskSnapshots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **supportCode** *(string) --*
                  ...
                  The support code. Include this code in your email to support when you have questions about
                  an instance or another resource in Lightsail. This code enables our support team to look
                ...
                - **tags** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **key** *(string) --*
                      ...
                      Constraints: Tag keys accept a maximum of 128 letters, numbers, spaces in UTF-8, or
                      the following characters: + - = . _ : / @
    ...
    def get_disks(self, pageToken: str = None) -> ClientGetDisksResponseTypeDef:
        ...
        If you are describing a long list of disks, you can paginate the output to make the list more
        manageable. You can use the pageToken and nextPageToken values to retrieve the next items in the
        list.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetDisks>`_
    ...
    def get_domain(self, domainName: str) -> ClientGetDomainResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetDomain>`_
              ...
              - **domainEntries** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **target** *(string) --*
                    ...
                    For Lightsail load balancers, the value looks like
                    ``ab1234c56789c6b86aba6fb203d443bc-123456789.us-east-2.elb.amazonaws.com`` . Be sure to
                    also set ``isAlias`` to ``true`` when setting up an A record for a load balancer.

                  - **isAlias** *(boolean) --*

                    When ``true`` , specifies whether the domain entry is an alias used by the Lightsail
                    load balancer. You can include an alias (A type) record in your request, which points to
                    a load balancer DNS name and routes traffic to your load balancer
    ...
    def get_domains(self, pageToken: str = None) -> ClientGetDomainsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetDomains>`_
                ...
                - **domainEntries** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **isAlias** *(boolean) --*
                      ...
                      When ``true`` , specifies whether the domain entry is an alias used by the Lightsail
                      load balancer. You can include an alias (A type) record in your request, which points
                      to a load balancer DNS name and routes traffic to your load balancer
    ...
    def get_export_snapshot_records(
        ...
        An export snapshot record can be used to create a new Amazon EC2 instance and its related resources
        with the ``create cloud formation stack`` operation.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetExportSnapshotRecords>`_
        ...
        **Request Syntax**
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results for your ``get export snapshot records``
          request.
    ...
    def get_instance(self, instanceName: str) -> ClientGetInstanceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstance>`_
                ...
                - **disks** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **supportCode** *(string) --*
                      ...
                      about an instance or another resource in Lightsail. This code enables our support team
                    ...
                    - **tags** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        - **key** *(string) --*
                          ...
                          Constraints: Tag keys accept a maximum of 128 letters, numbers, spaces in UTF-8,
                        ...
                        - **value** *(string) --*
                          ...
                          Constraints: Tag values accept a maximum of 256 letters, numbers, spaces in UTF-8,
                          or the following characters: + - = . _ : / @
                    ...
                    - **attachmentState** *(string) --*
                      ...
                      .. note::
                        ...
                        system disks in the API response. It is now deprecated, but still included in the
                  ...
                  - *(dict) --*
                    ...
                    - **protocol** *(string) --*
                      ...
                      * ``all`` - All transport layer protocol types. For more general information, see
                      `Transport layer <https://en.wikipedia.org/wiki/Transport_layer>`__ on Wikipedia.
    ...
    def get_instance_access_details(
        ...
        *instance* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstanceAccessDetails>`_
          ...
          - *(dict) --*
            ...
            - **accessDetails** *(dict) --*
              ...
              - **password** *(string) --*
                ...
                string if the password for your new instance is not ready yet. When you create an instance,
              ...
              - **passwordData** *(dict) --*
                ...
                therefore the password is not ready yet). When you create an instance, it can take up to 15
              ...
              - **privateKey** *(string) --*
                ...
                For SSH access, the temporary private key. For OpenSSH clients (e.g., command line SSH), you
    ...
    def get_instance_metric_data(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstanceMetricData>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_instance_metric_data(
              instanceName='string',
              metricName=
                  'CPUUtilization'|'NetworkIn'|'NetworkOut'|'StatusCheckFailed'|'StatusCheckFailed_Instance'
    ...
    def get_instance_port_states(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstancePortStates>`_
              ...
              - *(dict) --*
                ...
                - **protocol** *(string) --*
                  ...
                  * ``udp`` - With User Datagram Protocol (UDP), computer applications can send messages (or
                  datagrams) to other hosts on an Internet Protocol (IP) network. Prior communications are
                  not required to set up transmission channels or data paths. Applications that don't
                  require reliable data stream service can use UDP, which provides a connectionless datagram
                  service that emphasizes reduced latency over reliability. If you do require reliable data
    ...
    def get_instance_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstanceSnapshot>`_
          ...
          - *(dict) --*
            ...
            - **instanceSnapshot** *(dict) --*
              ...
              - **fromBlueprintId** *(string) --*
                ...
                The blueprint ID from which you created the snapshot (e.g., ``os_debian_8_3`` ). A blueprint
                is a virtual private server (or *instance* ) image used to create instances quickly.
    ...
    def get_instance_snapshots(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstanceSnapshots>`_
            ...
            - **instanceSnapshots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **fromBlueprintId** *(string) --*
                  ...
                  blueprint is a virtual private server (or *instance* ) image used to create instances
                  quickly.
    ...
    def get_instance_state(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstanceState>`_
    ...
    def get_instances(self, pageToken: str = None) -> ClientGetInstancesResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetInstances>`_
                            ...
                            'disks': [
                                {
                                    ...
                                    'location': {
                                        ...
                                        |'eu-west-2'|'eu-west-3'|'eu-central-1'|'ca-central-1'|'ap-south-1'
                                        |'ap-southeast-1'|'ap-southeast-2'|'ap-northeast-1'|'ap-northeast-2'
                                    },
                                    'resourceType':
                                    'Instance'|'StaticIp'|'KeyPair'|'InstanceSnapshot'|'Domain'|'PeeredVpc'
                                    |'LoadBalancer'|'LoadBalancerTlsCertificate'|'Disk'|'DiskSnapshot'
                                    |'RelationalDatabase'|'RelationalDatabaseSnapshot'
                                    |'ExportSnapshotRecord'|'CloudFormationStackRecord',
                                    'tags': [
                                        {
                                            'key': 'string',
                                            'value': 'string'
                  ...
                  - **disks** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **tags** *(list) --*
                        ...
                        in Lightsail, see the `Lightsail Dev Guide
                        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-tags>`__ .
    ...
    def get_key_pair(self, keyPairName: str) -> ClientGetKeyPairResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetKeyPair>`_
    ...
    def get_key_pairs(self, pageToken: str = None) -> ClientGetKeyPairsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetKeyPairs>`_
    ...
    def get_load_balancer(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetLoadBalancer>`_
                    ...
                    'instanceHealthSummary': [
                        {
                            ...
                            'Lb.RegistrationInProgress'|'Lb.InitialHealthChecking'|'Lb.InternalError'
          ...
          - *(dict) --*
            ...
            - **loadBalancer** *(dict) --*
              ...
              - **instancePort** *(integer) --*
                ...
                The port where the load balancer will direct traffic to your Lightsail instances. For HTTP
                traffic, it's port 80. For HTTPS traffic, it's port 443.
              ...
              - **instanceHealthSummary** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **instanceHealthReason** *(string) --*
                    ...
                    If ** ``instanceHealth`` ** is ``initial`` , the ** ``instanceHealthReason`` ** value
                    ...
                    * **``Lb.InitialHealthChecking`` ** - The Lightsail load balancer is still sending the
                    target instance the minimum number of health checks required to determine its health
                    status.

                    If ** ``instanceHealth`` ** is ``unhealthy`` , the ** ``instanceHealthReason`` ** value
                    can be one of the following:
                    ...
                    * **``Instance.FailedHealthChecks`` ** - The health checks failed because the connection
                    to the target instance timed out, the target instance response was malformed, or the
                    ...
                    * **``Lb.InternalError`` ** - The health checks failed due to an internal error.
                    ...
                    If ** ``instanceHealth`` ** is ``unused`` , the ** ``instanceHealthReason`` ** value can
                    be one of the following:

                    * **``Instance.NotRegistered`` ** - The target instance is not registered with the
                    target group.

                    * **``Instance.NotInUse`` ** - The target group is not used by any load balancer, or the
                    ...
                    * **``Instance.InvalidState`` ** - The target is in the stopped or terminated state.
                    ...
                    If ** ``instanceHealth`` ** is ``draining`` , the ** ``instanceHealthReason`` ** value
                    can be one of the following:
              ...
              - **configurationOptions** *(dict) --*
                ...
                A string to string map of the configuration options for your load balancer. Valid values are
                listed below.
    ...
    def get_load_balancer_metric_data(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetLoadBalancerMetricData>`_
        ...
        **Request Syntax**
        ...
        :param metricName: **[REQUIRED]**
          ...
          The metric about which you want to return information. Valid values are listed below, along with
          the most useful ``statistics`` to include in your request.

          * **``ClientTLSNegotiationErrorCount`` ** - The number of TLS connections initiated by the client
          that did not establish a session with the load balancer. Possible causes include a mismatch of
          ciphers or protocols.  ``Statistics`` : The most useful statistic is ``Sum`` .
          ...
          * **``HTTPCode_LB_4XX_Count`` ** - The number of HTTP 4XX client error codes that originate from
          the load balancer. Client errors are generated when requests are malformed or incomplete. These
          requests have not been received by the target instance. This count does not include any response
          ...
          * **``HTTPCode_LB_5XX_Count`` ** - The number of HTTP 5XX server error codes that originate from
          the load balancer. This count does not include any response codes generated by the target
          instances.  ``Statistics`` : The most useful statistic is ``Sum`` . Note that ``Minimum`` ,
          ``Maximum`` , and ``Average`` all return ``1`` . Note that ``Minimum`` , ``Maximum`` , and
          ...
          * **``InstanceResponseTime`` ** - The time elapsed, in seconds, after the request leaves the load
          balancer until a response from the target instance is received.  ``Statistics`` : The most useful
          statistic is ``Average`` .

          * **``RejectedConnectionCount`` ** - The number of connections that were rejected because the load
          balancer had reached its maximum number of connections.  ``Statistics`` : The most useful
          statistic is ``Sum`` .

          * **``RequestCount`` ** - The number of requests processed over IPv4. This count includes only the
          requests with a response generated by a target instance of the load balancer.  ``Statistics`` :
          The most useful statistic is ``Sum`` . Note that ``Minimum`` , ``Maximum`` , and ``Average`` all
          return ``1`` .
        ...
        :param statistics: **[REQUIRED]**
          ...
          * **``Average`` ** - The value of Sum / SampleCount during the specified period. By comparing this
          statistic with the Minimum and Maximum, you can determine the full scope of a metric and how close
          the average use is to the Minimum and Maximum. This comparison helps you to know when to increase
          or decrease your resources as needed.
          ...
          * **``Minimum`` ** - The lowest value observed during the specified period. You can use this value
          ...
          - *(dict) --*
            ...
            - **metricName** *(string) --*
              ...
              * **``HTTPCode_LB_4XX_Count`` ** - The number of HTTP 4XX client error codes that originate
              from the load balancer. Client errors are generated when requests are malformed or incomplete.
              These requests have not been received by the target instance. This count does not include any
              response codes generated by the target instances.  ``Statistics`` : The most useful statistic
              ...
              * **``RejectedConnectionCount`` ** - The number of connections that were rejected because the
              load balancer had reached its maximum number of connections.  ``Statistics`` : The most useful
              statistic is ``Sum`` .
    ...
    def get_load_balancer_tls_certificates(
        ...
        You can have a maximum of 2 certificates associated with a Lightsail load balancer. One is active
        and the other is inactive.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetLoadBalancerTlsCertificates>`_
                ...
                'tlsCertificates': [
                    {
                        ...
                        'isAttached': True|False,
                        'status':
                        'PENDING_VALIDATION'|'ISSUED'|'INACTIVE'|'EXPIRED'|'VALIDATION_TIMED_OUT'|'REVOKED'
                        |'FAILED'|'UNKNOWN',
                        'domainName': 'string',
                        ...
                        'revocationReason':
                        'UNSPECIFIED'|'KEY_COMPROMISE'|'CA_COMPROMISE'|'AFFILIATION_CHANGED'|'SUPERCEDED'
            ...
            - **tlsCertificates** *(list) --*
              ...
              - *(dict) --*
                ...
                - **renewalSummary** *(dict) --*
                  ...
                  An object containing information about the status of Lightsail's managed renewal for the
                  certificate.
                ...
                - **subjectAlternativeNames** *(list) --*
                  ...
                  One or more domains or subdomains included in the certificate. This list contains the
                  ...
                  ``example.com`` , ``www.example.com`` , or ``m.example.com`` .
    ...
    def get_load_balancers(
        ...
        If you are describing a long list of load balancers, you can paginate the output to make the list
        more manageable. You can use the pageToken and nextPageToken values to retrieve the next items in
        the list.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetLoadBalancers>`_
    ...
    def get_operation(self, operationId: str) -> ClientGetOperationResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetOperation>`_
    ...
    def get_operations(
        ...
        Results are returned from oldest to newest, up to a maximum of 200. Results can be paged by making
        each subsequent call to ``GetOperations`` use the maximum (last) ``statusChangedAt`` value from the
        previous request.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetOperations>`_
    ...
    def get_operations_for_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetOperationsForResource>`_
        ...
        **Request Syntax**
        ...
        :param pageToken:
          ...
          A token used for advancing to the next page of results from your get operations for resource
          request.
    ...
    def get_regions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRegions>`_
        ...
        **Request Syntax**
        ...
        :param includeAvailabilityZones:
          ...
          Availability Zones are indicated with a letter: e.g., ``us-east-2a`` .
        ...
        :param includeRelationalDatabaseAvailabilityZones:
          ...
          regions request. Availability Zones are indicated with a letter (e.g., ``us-east-2a`` ).
            ...
            - **regions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **description** *(string) --*
                  ...
                  The description of the AWS Region (e.g., ``This region is recommended to serve users in
    ...
    def get_relational_database(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabase>`_
    ...
    def get_relational_database_blueprints(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseBlueprints>`_
          ...
          - *(dict) --*
            ...
            - **blueprints** *(list) --*
              ...
              - *(dict) --*
                ...
                Describes a database image, or blueprint. A blueprint describes the major engine version of
                a database.
    ...
    def get_relational_database_bundles(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseBundles>`_
    ...
    def get_relational_database_events(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseEvents>`_
        ...
        **Request Syntax**
        ...
        :param durationInMinutes:
          ...
          from the past 2 hours, enter 120.
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results from for get relational database events
          request.
    ...
    def get_relational_database_log_events(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseLogEvents>`_
        ...
        **Request Syntax**
        ...
        :param startTime:
          ...
          * Specified in the Unix time format. For example, if you wish to use a start time of October 1,
          2018, at 8 PM UTC, then you input ``1538424000`` as the start time.
        ...
        :param endTime:
          ...
          * Specified in the Unix time format. For example, if you wish to use an end time of October 1,
          2018, at 8 PM UTC, then you input ``1538424000`` as the end time.

        :type startFromHead: boolean
        :param startFromHead:

          Parameter to specify if the log should start from head or tail. If ``true`` is specified, the log
          event starts from the head of the log. If ``false`` is specified, the log event starts from the
          tail of the log.
        ...
        :param pageToken:
          ...
          A token used for advancing to a specific page of results for your ``get relational database log
          events`` request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextBackwardToken** *(string) --*
              ...
              A token used for advancing to the previous page of results from your get relational database
              log events request.

            - **nextForwardToken** *(string) --*

              A token used for advancing to the next page of results from your get relational database log
              events request.
    ...
    def get_relational_database_log_streams(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseLogStreams>`_
    ...
    def get_relational_database_master_user_password(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseMasterUserPassword>`_
        ...
        **Request Syntax**
        ...
        :param passwordVersion:
          ...
          Specifying ``PENDING`` returns the newest version of the password that will rotate to ``CURRENT``
          . After the ``PENDING`` password rotates to ``CURRENT`` , the ``PENDING`` password is no longer
          available.
    ...
    def get_relational_database_metric_data(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseMetricData>`_
    ...
    def get_relational_database_parameters(
        ...
        specific database in Amazon Lightsail.

        In addition to the parameter names and values, this operation returns other information about each
        parameter. This information includes whether changes require a reboot, whether the parameter is
        modifiable, the allowed values, and the data types.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseParameters>`_
    ...
    def get_relational_database_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseSnapshot>`_
          ...
          - *(dict) --*
            ...
            - **relationalDatabaseSnapshot** *(dict) --*
              ...
              - **supportCode** *(string) --*
                ...
                The support code for the database snapshot. Include this code in your email to support when
                you have questions about a database snapshot in Lightsail. This code enables our support
                team to look up your Lightsail information more easily.
    ...
    def get_relational_database_snapshots(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabaseSnapshots>`_
    ...
    def get_relational_databases(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetRelationalDatabases>`_
    ...
    def get_static_ip(self, staticIpName: str) -> ClientGetStaticIpResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetStaticIp>`_
    ...
    def get_static_ips(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/GetStaticIps>`_
    ...
    def import_key_pair(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/ImportKeyPair>`_
    ...
    def is_vpc_peered(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/IsVpcPeered>`_
    ...
    def open_instance_public_ports(
        ...
        The ``open instance public ports`` operation supports tag-based access control via resource tags
        applied to the resource identified by ``instance name`` . For more information, see the `Lightsail
        Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/OpenInstancePublicPorts>`_
    ...
    def peer_vpc(self, *args: Any, **kwargs: Any) -> ClientPeerVpcResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/PeerVpc>`_
    ...
    def put_instance_public_ports(
        ...
        """
        Sets the specified open ports for an Amazon Lightsail instance, and closes all ports for every
        protocol not included in the current request.

        The ``put instance public ports`` operation supports tag-based access control via resource tags
        applied to the resource identified by ``instance name`` . For more information, see the `Lightsail
        Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/PutInstancePublicPorts>`_
    ...
    def reboot_instance(self, instanceName: str) -> ClientRebootInstanceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/RebootInstance>`_
    ...
    def reboot_relational_database(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/RebootRelationalDatabase>`_
    ...
    def release_static_ip(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/ReleaseStaticIp>`_
    ...
    def start_instance(self, instanceName: str) -> ClientStartInstanceResponseTypeDef:
        ...
        .. note::
          ...
          When you start a stopped instance, Lightsail assigns a new public IP address to the instance. To
          use the same IP address after stopping and starting an instance, create a static IP address and
          attach it to the instance. For more information, see the `Lightsail Dev Guide
          <https://lightsail.aws.amazon.com/ls/docs/en/articles/lightsail-create-static-ip>`__ .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/StartInstance>`_
    ...
    def start_relational_database(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/StartRelationalDatabase>`_
    ...
    def stop_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/StopInstance>`_
        ...
        **Request Syntax**
        ...
        :param force:
          ...
          .. warning::
            ...
            other state, your instance should stop normally without adding this parameter to your API
            request.
    ...
    def stop_relational_database(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/StopRelationalDatabase>`_
    ...
    def tag_resource(
        self,
        resourceName: str,
        tags: List[ClientTagResourcetagsTypeDef],
        ...
        For more information about tags, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-tags>`__ .

        The ``tag resource`` operation supports tag-based access control via request tags and resource tags
        applied to the resource identified by ``resource name`` . For more information, see the `Lightsail
        Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/TagResource>`_
    ...
    def unpeer_vpc(self, *args: Any, **kwargs: Any) -> ClientUnpeerVpcResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/UnpeerVpc>`_
    ...
    def untag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/UntagResource>`_
    ...
    def update_domain_entry(
        ...
        The ``update domain entry`` operation supports tag-based access control via resource tags applied to
        the resource identified by ``domain name`` . For more information, see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/UpdateDomainEntry>`_
    ...
    def update_load_balancer_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/UpdateLoadBalancerAttribute>`_
    ...
    def update_relational_database(
        ...
        The ``update relational database`` operation supports tag-based access control via resource tags
        applied to the resource identified by relationalDatabaseName. For more information, see the
        `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/UpdateRelationalDatabase>`_
        ...
        **Request Syntax**
        ...
        :param disableBackupRetention:
          ...
          Disabling backup retention deletes all automated database backups. Before disabling this, you may
          want to create a snapshot of your database using the ``create relational database snapshot``
          operation.
        ...
        :param publiclyAccessible:
          ...
          Specifies the accessibility options for your database. A value of ``true`` specifies a database
    ...
    def update_relational_database_parameters(
        ...
        Parameter updates don't cause outages; therefore, their application is not subject to the preferred
        maintenance window. However, there are two ways in which paramater updates are applied: ``dynamic``
        or ``pending-reboot`` . Parameters marked with a ``dynamic`` apply type are applied immediately.
        Parameters marked with a ``pending-reboot`` apply type are applied only after the database is
        ...
        resource tags applied to the resource identified by relationalDatabaseName. For more information,
        see the `Lightsail Dev Guide
        <https://lightsail.aws.amazon.com/ls/docs/en/articles/amazon-lightsail-controlling-access-using-tags>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/lightsail-2016-11-28/UpdateRelationalDatabaseParameters>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_active_names` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_blueprints` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_bundles` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_cloud_formation_stack_records` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_disk_snapshots` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_disks` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_domains` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_export_snapshot_records` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_instance_snapshots` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_instances` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_key_pairs` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_load_balancers` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_operations` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_relational_database_blueprints` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_relational_database_bundles` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_relational_database_events` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_relational_database_parameters` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_relational_database_snapshots` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_relational_databases` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_static_ips` operation.
        """
