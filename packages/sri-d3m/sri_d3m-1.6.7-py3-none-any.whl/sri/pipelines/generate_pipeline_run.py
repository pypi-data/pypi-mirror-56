...
class GeneratePipelineRun(object):
    ...
    def __init__(self, **args):
        self._add_attrs(args, 'pipeline_name', 'problem_name', 'dataset_home', 'docker_image', 'output_home')
    ...
    def generate_command(self):
        ...
        pipeline_run = "%s/%s%s" % ("/output", self.pipeline_name, "_pipeline_run.yml")
        ...
        command = "python3 -m d3m runtime -v /volumes fit-score -p %s -r %s -i %s -t %s -a %s -O %s" % \
