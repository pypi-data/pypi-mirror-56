...
def build_docker_image(execution_context, image_name, path, include=None, dockerfile=None, parent_images=[]):
    ...
    source_archive = source_utils.create_source_archive(execution_context, source_path=path, include=include)
