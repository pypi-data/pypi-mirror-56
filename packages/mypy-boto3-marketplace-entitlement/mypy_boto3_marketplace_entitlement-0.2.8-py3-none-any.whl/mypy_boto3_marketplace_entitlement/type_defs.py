...
class ClientGetEntitlementsResponseEntitlementsValueTypeDef(
    ...
    - **DoubleValue** *(float) --*
      ...
      The DoubleValue field will be populated with a double value when the entitlement is a double
    ...
    - **StringValue** *(string) --*
      ...
      The StringValue field will be populated with a string value when the entitlement is a string
      type. Otherwise, the field will not be set.
    """
...
class ClientGetEntitlementsResponseEntitlementsTypeDef(
    ...
    - **Value** *(dict) --*
      ...
      The EntitlementValue represents the amount of capacity that the customer is entitled to for
      the product.
    ...
    - **ExpirationDate** *(datetime) --*
      ...
      The expiration date represents the minimum date through which this entitlement is expected to
      remain valid. For contractual products listed on AWS Marketplace, the expiration date is the
      date at which the customer will renew or cancel their contract. Customers who are opting to
      renew their contract will still have entitlements with an expiration date.
    """
...
class ClientGetEntitlementsResponseTypeDef(_ClientGetEntitlementsResponseTypeDef):
    ...
    - **Entitlements** *(list) --*
      ...
      The set of entitlements found through the GetEntitlements operation. If the result contains an
      ...
      - *(dict) --*
        ...
        - **ExpirationDate** *(datetime) --*
          ...
          The expiration date represents the minimum date through which this entitlement is expected
          to remain valid. For contractual products listed on AWS Marketplace, the expiration date
          is the date at which the customer will renew or cancel their contract. Customers who are
          opting to renew their contract will still have entitlements with an expiration date.
