"Main interface for marketplace-entitlement Paginators"
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          are described as keys mapped to a lists of values. Filtered requests are *unioned* for each value
          in the value list, and then *intersected* for each filter key.
