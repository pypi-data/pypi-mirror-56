    ...
    def get_entitlements(
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          Filters are described as keys mapped to a lists of values. Filtered requests are *unioned*
          for each value in the value list, and then *intersected* for each filter key.
            ...
            - **Entitlements** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ExpirationDate** *(datetime) --*
                  ...
                  expiration date is the date at which the customer will renew or cancel their
