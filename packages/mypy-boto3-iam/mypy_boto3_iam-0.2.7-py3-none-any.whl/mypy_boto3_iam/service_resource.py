"Main interface for iam ServiceResource"
...
class AccountPasswordPolicy(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        AccountPasswordPolicy resource. Note that the load and reload methods are the same method and can be
...
class CurrentUser(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`IAM.Client.get_user` to update the attributes of the CurrentUser resource. Note that
...
class Group(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        load and reload methods are the same method and can be used interchangeably.
...
class LoginProfile(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`IAM.Client.get_login_profile` to update the attributes of the LoginProfile resource.
        Note that the load and reload methods are the same method and can be used interchangeably.
...
class SamlProvider(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`IAM.Client.get_saml_provider` to update the attributes of the SamlProvider resource.
        Note that the load and reload methods are the same method and can be used interchangeably.
...
class ServerCertificate(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`IAM.Client.get_server_certificate` to update the attributes of the ServerCertificate
        resource. Note that the load and reload methods are the same method and can be used interchangeably.
...
class ServiceResourceRolesCollection(ResourceCollection):
    ...
    def page_size(self, count: int) -> List[service_resource_scope.Role]:
        """
        Creates an iterable of all Role resources in the collection, but limits the number of items returned
...
class ServiceResourceServerCertificatesCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all ServerCertificate resources in the collection filtered by kwargs passed
        to method.
...
class ServiceResourceUsersCollection(ResourceCollection):
    ...
    def page_size(self, count: int) -> List[service_resource_scope.User]:
        """
        Creates an iterable of all User resources in the collection, but limits the number of items returned
        by each service call by the specified amount.
...
class ServiceResourceVirtualMfaDevicesCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all VirtualMfaDevice resources in the collection filtered by kwargs passed to
        method.
...
class PolicyVersionsCollection(ResourceCollection):
    ...
    def filter(
        ...
        """
        Creates an iterable of all PolicyVersion resources in the collection filtered by kwargs passed to
        method.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.PolicyVersion]:
        """
        Creates an iterable of all PolicyVersion resources in the collection, but limits the number of items
        returned by each service call by the specified amount.
