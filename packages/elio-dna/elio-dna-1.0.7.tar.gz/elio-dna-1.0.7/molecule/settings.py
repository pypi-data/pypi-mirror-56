...
SITE_DNA = {
    "page": {
        "A Grand Idea": {"engage": {"Cosmos": {"field": ["name"]}}},
        "Universal": {
            "template": "molecule/universal.html",
            "engage": ["Universe"],
            "page": {
                "Galaxies": {
                    "engage": {"Cosmos": {"field": []}},
                    "list": {
                        "Galaxy": {
                            "field": ["name"],
                            "paginate": 3,
                            "template": "molecule/_galaxy_listed.html",
                        }
                    },
                    "page": {
                        "MilkyWay": {
                            "list": ["SolarSystem", "Sun"],
                            "page": {
                                "Sol": {
                                    "list": {
                                        "Moon": {
        ...
        "Orbitals": {
            "engage": {
                "Moon": {"field": ["name", "moonShine"], "many": ["sunny"]}
            },
            "list": {
                "Moon": {"field": ["name", "moonShine"], "many": ["sunny"]},
                "Satellite": {"field": []},
...
DNA_BASE_MODEL_NAME = "Cosmos"
DNA_ENUMERATION_MODEL_NAME = "Gravitation"
DNA_DEPTH = 1
SCHEMA_VERSION = "3.9"
SCHEMA_PATH = "molecule/tests/mocks/space.jsonld"
