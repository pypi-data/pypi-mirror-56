...
class BaseWeightQuantizer:
    ...
    def __init__(self, bitwidth):
        ...
        :param bitwidth: the quantizer bitwidth defining the number of quantized values
    ...
    def quantize(self, w):
        ...
        :param w: the weights Tensor to quantize
        :type w: tensorflow.Tensor
        :return: a tensorflow.Tensor of quantized weights
        """
        return w
    ...
    def scale_factor(self, w):
        ...
        :param w: the weights Tensor to quantize
        :type w: tensorflow.Tensor
        :return: a tensorflow.Tensor containing a single scalar value
        """
...
class WeightQuantizer(BaseWeightQuantizer):
    ...
    def __init__(self, threshold=3, bitwidth=4):
        ...
        :param threshold: the standard deviation multiplier used to exclude outliers
...
class WeightFloat(BaseWeightQuantizer):
    """
    This quantizer actually does not perform any quantization, and it might be used
    for training
    """
