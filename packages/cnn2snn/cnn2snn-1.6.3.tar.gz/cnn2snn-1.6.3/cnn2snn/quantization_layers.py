...
class QuantizedConv2D(layers.Conv2D):
    ...
    def __init__(self,
        ...
        :type strides: integer, or tuple of integers
        :param padding: one of 'valid' or 'same'
        :type padding: str
        :param use_bias: whether the layer uses a bias vector
        :type use_bias: boolean
        :param kernel_initializer: initializer for the weights matrix
        :type kernel_initializer: str, or a tf.keras.initializer
        :param bias_initializer: initializer for the bias vector
        :type bias_initializer: str, or a tf.keras.initializer
        :param kernel_regularizer: regularization applied to the weights
        :type kernel_regularizer: str, or a tf.keras.regularizer
        :param bias_regularizer: regularization applied to the bias
        :type bias_regularizer: str, or a tf.keras.regularizer
        :param kernel_constraint: constraint applied to the weights
        :type kernel_constraint: str, or a tf.keras.constraint
        :param bias_constraint: constraint applied to the bias
        :type bias_constraint: str, or a tf.keras.constraint
...
class QuantizedDepthwiseConv2D(layers.DepthwiseConv2D):
    ...
    def __init__(self,
        ...
        :param use_bias: whether the layer uses a bias vector
        :type use_bias: boolean
        :param depthwise_initializer: initializer for the weights matrix
        :type depthwise_initializer: str, or a tf.keras.initializer
        :param bias_initializer: initializer for the bias vector
        :type bias_initializer: str, or a tf.keras.initializer
        :param depthwise_regularizer: regularization applied to the weights
        :type depthwise_regularizer: str, or a tf.keras.regularizer
        :param bias_regularizer: regularization applied to the bias
        :type bias_regularizer: str, or a tf.keras.regularizer
        :param depthwise_constraint: constraint applied to the weights
        :type depthwise_constraint: str, or a tf.keras.constraint
        :param bias_constraint: constraint applied to the bias
        :type bias_constraint: str, or a tf.keras.constraint
        :param quantizer: the quantizer to apply during the forward pass
        :type quantizer: cnn2snn.WeightQuantizer
...
class QuantizedSeparableConv2D(layers.SeparableConv2D):
    ...
    def __init__(self,
        ...
        :param use_bias: whether the layer uses a bias vector
        :type use_bias: boolean
        :param depthwise_initializer: initializer for the depthwise kernel
        :type depthwise_initializer: str, or a tf.keras.initializer
        :param pointwise_initializer: initializer for the pointwise kernel
        :type pointwise_initializer: str, or a tf.keras.initializer
        :param bias_initializer: initializer for the bias vector
        :type bias_initializer: str, or a tf.keras.initializer
        :param depthwise_regularizer: regularization applied to the depthwise kernel
        :type depthwise_regularizer: str, or a tf.keras.regularizer
        :param pointwise_regularizer: regularization applied to the pointwise kernel
        :type pointwise_regularizer: str, or a tf.keras.regularizer
        :param bias_regularizer: regularization applied to the bias
        :type bias_regularizer: str, or a tf.keras.regularizer
        ...
        :type pointwise_constraint: str, or a tf.keras.constraint
        :param bias_constraint: constraint applied to the bias
        :type bias_constraint: str, or a tf.keras.constraint
        :param quantizer: the quantizer to apply during the forward pass
        :type quantizer: cnn2snn.WeightQuantizer
