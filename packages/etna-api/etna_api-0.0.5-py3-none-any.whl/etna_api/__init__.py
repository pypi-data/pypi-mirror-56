...
class EtnaSession:
    ...
    def get_activity_marks(self, module_id: int, activity_id: int) -> List:
        ...
        return self._perform_request(
            method="GET",
            url=f"/{module_id}/activities/{activity_id}/marks_list",
        )
    ...
    def download_file(self, module_id: int, activity_id: int, path: str) -> bytes:
        """
    ...
    def delete_file(self, module_id: int, activity_id: int, path: str):
        """
    ...
    def get_checklist(self, module_id: int, activity_id: int):
        """
    ...
    def add_checklist(self, module_id: int, activity_id: int, data: dict):
        """
