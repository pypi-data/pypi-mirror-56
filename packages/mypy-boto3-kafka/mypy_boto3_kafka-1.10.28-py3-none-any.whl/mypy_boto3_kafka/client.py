    ...
    def create_configuration(
        ...
        **Request Syntax**
        ...
        :param ServerProperties: **[REQUIRED]**
          ...
          Contents of the server.propertiesfile. When using the API, you must ensure that the
          contents of the file are base64 encoded. When using the AWS Management Console, the SDK,
          or the AWS CLI, the contents of server.propertiescan be in plaintext.
            ...
            - **ClusterInfo** *(dict) --*
              ...
              - **BrokerNodeGroupInfo** *(dict) --*
                ...
                - **BrokerAZDistribution** *(string) --*
                  ...
                  The distribution of broker nodes across Availability Zones. This is an optional
                  parameter. If you don't specify it, Amazon MSK gives it the value DEFAULT. You can
                  also explicitly set this parameter to the value DEFAULT. No other values are
                  currently allowed.
                ...
                - **InstanceType** *(string) --*
                  ...
                  types are allowed: kafka.m5.large, kafka.m5.xlarge, kafka.m5.2xlarge,
                ...
                - **SecurityGroups** *(list) --*
                  ...
                  don't specify a security group, Amazon MSK uses the default security group
              ...
              - **EnhancedMonitoring** *(string) --*
                ...
                metrics associated with each of these three levels of monitoring, see `Monitoring
    ...
    def describe_configuration(self, Arn: str) -> ClientDescribeConfigurationResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param Arn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that uniquely identifies an MSK configuration and all of
          its revisions.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ServerProperties** *(bytes) --*
              ...
              SDK, or the AWS CLI, the contents of server.propertiescan be in plaintext.
    ...
    def list_cluster_operations(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results to return in the response. If there are more results, the
        ...
        :param NextToken:
          ...
          returns NextToken in the response. To get the next batch, provide this token in your next
          request.
    ...
    def list_clusters(
        ...
        **Request Syntax**
        ...
        :param ClusterNameFilter:
          ...
          Specify a prefix of the name of the clusters that you want to list. The service lists all
          the clusters whose names start with this prefix.
    ...
    def update_broker_count(
        ...
        **Request Syntax**
        ...
        :param CurrentVersion: **[REQUIRED]**
          ...
          The version of cluster to update from. A successful operation will then generate a new
          version.
