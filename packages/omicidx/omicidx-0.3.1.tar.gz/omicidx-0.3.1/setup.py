...
package_data = \
{'': ['*'], 'omicidx': ['processing/sra_queue.py']}
...
['Click',
 ...
 'google-bigquery>=0.14.0,<0.15.0',
 'google-cloud-bigquery>=1.18,<2.0',
 'google-cloud-pubsub>=0.45.0,<0.46.0',
 'google-cloud-storage>=1.18,<2.0',
 'psycopg2>=2.8,<3.0',
 'pydantic',
 'requests>=2.22,<3.0',
 'sd_cloud_utils',
