...
#line 36 "cif2_grammar.y"

    #include <cif_compiler.h>

#line 144 "cif2_grammar.tab.c"
...
union YYSTYPE
{
#line 40 "cif2_grammar.y"

    char *s;
    typed_value *typed_value;

#line 192 "cif2_grammar.tab.c"
...
{
       0,    76,    76,    77,    78,    79,    80,    81,    85,   100,
     124,   125,   129,   146,   145,   165,   166,   170,   171,   175,
     180,   220,   221,   226,   227,   231,   232,   236,   244,   293,
     299,   310,   309,   338,   349,   363,   371,   383,   382,   392,
     397,   398,   399,   400,   401,   405,   406,   413,   414,   418,
     422,   429,   433,   440,   493,   497,   504,   508,   515,   519,
     526,   543
};
#endif
...
#line 1368 "cif2_grammar.tab.c"
    break;

  case 9:
#line 101 "cif2_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc, "WARNING", "stray CIF values at the "
...
#line 1388 "cif2_grammar.tab.c"
    break;

  case 12:
#line 130 "cif2_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
...
#line 1408 "cif2_grammar.tab.c"
    break;

  case 13:
#line 146 "cif2_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc,
...
#line 1428 "cif2_grammar.tab.c"
    break;

  case 19:
#line 176 "cif2_grammar.y"
    {
            cif_start_datablock( cif_compiler_cif( cif_cc ), (yyvsp[0].s), px );
            freex( (yyvsp[0].s) );
        }
#line 1437 "cif2_grammar.tab.c"
    break;

  case 20:
#line 181 "cif2_grammar.y"
    {
...
#line 1478 "cif2_grammar.tab.c"
    break;

  case 27:
#line 237 "cif2_grammar.y"
    {
...
#line 1490 "cif2_grammar.tab.c"
    break;

  case 28:
#line 245 "cif2_grammar.y"
    {
                assert_datablock_exists( cif_cc, px );
                CIFLIST *list = value_list( typed_value_value( (yyvsp[0].typed_value) ) );
...
#line 1540 "cif2_grammar.tab.c"
    break;

  case 29:
#line 294 "cif2_grammar.y"
    {
...
#line 1550 "cif2_grammar.tab.c"
    break;

  case 30:
#line 300 "cif2_grammar.y"
    {
...
#line 1561 "cif2_grammar.tab.c"
    break;

  case 31:
#line 310 "cif2_grammar.y"
    {
           assert_datablock_exists( cif_cc, px );
...
#line 1572 "cif2_grammar.tab.c"
    break;

  case 32:
#line 317 "cif2_grammar.y"
    {
...
#line 1595 "cif2_grammar.tab.c"
    break;

  case 33:
#line 339 "cif2_grammar.y"
    {
...
#line 1610 "cif2_grammar.tab.c"
    break;

  case 34:
#line 350 "cif2_grammar.y"
    {
            ssize_t tag_nr = cif_tag_index( cif_compiler_cif( cif_cc ), (yyvsp[0].s) );
            if( tag_nr != -1 ) {
                yyerror_token( cif_cc, cxprintf( "tag %s appears more than once", (yyvsp[0].s) ),
...
#line 1625 "cif2_grammar.tab.c"
    break;

  case 35:
#line 364 "cif2_grammar.y"
    {
...
#line 1637 "cif2_grammar.tab.c"
    break;

  case 36:
#line 372 "cif2_grammar.y"
    {
            cif_compiler_increase_loop_values( cif_cc );
            cif_push_loop_cifvalue( cif_compiler_cif( cif_cc ),
                                    typed_value_value( (yyvsp[0].typed_value) ), px );
...
#line 1828 "cif2_grammar.tab.c"
    break;

  case 61:
#line 544 "cif2_grammar.y"
    {
...
#line 1846 "cif2_grammar.tab.c"
    break;


#line 1850 "cif2_grammar.tab.c"
