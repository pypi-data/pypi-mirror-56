...
{
       0,    66,    66,    67,    68,    69,    70,    71,    75,    90,
     114,   115,   119,   136,   135,   155,   156,   160,   161,   165,
     170,   207,   208,   213,   214,   218,   219,   223,   231,   272,
     273,   307,   306,   335,   346,   360,   368,   380,   379,   392,
     393,   394,   398,   402,   406,   413,   466,   468
};
#endif
...
#line 1330 "cif_grammar.tab.c"
    break;

  case 9:
#line 91 "cif_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc, "WARNING", "stray CIF values at the "
...
#line 1350 "cif_grammar.tab.c"
    break;

  case 12:
#line 120 "cif_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
...
#line 1370 "cif_grammar.tab.c"
    break;

  case 13:
#line 136 "cif_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
                isset_fix_data_header( cif_cc ) ) {
                    print_message( cif_cc, 
...
#line 1390 "cif_grammar.tab.c"
    break;

  case 19:
#line 166 "cif_grammar.y"
    {
            cif_start_datablock( cif_compiler_cif( cif_cc ), (yyvsp[0].s), px );
            freex( (yyvsp[0].s) );
        }
#line 1399 "cif_grammar.tab.c"
    break;

  case 20:
#line 171 "cif_grammar.y"
    {
            if( isset_fix_errors( cif_cc ) ||
...
#line 1437 "cif_grammar.tab.c"
    break;

  case 27:
#line 224 "cif_grammar.y"
    {
...
#line 1449 "cif_grammar.tab.c"
    break;

  case 28:
#line 232 "cif_grammar.y"
    {
                assert_datablock_exists( cif_cc, px );
                if( isset_fix_errors( cif_cc ) ||
                    isset_fix_string_quotes( cif_cc ) ) {
...
#line 1491 "cif_grammar.tab.c"
    break;

  case 30:
#line 274 "cif_grammar.y"
    {
...
#line 1525 "cif_grammar.tab.c"
    break;

  case 31:
#line 307 "cif_grammar.y"
    {
           assert_datablock_exists( cif_cc, px );
...
#line 1536 "cif_grammar.tab.c"
    break;

  case 32:
#line 314 "cif_grammar.y"
    {
...
#line 1559 "cif_grammar.tab.c"
    break;

  case 33:
#line 336 "cif_grammar.y"
    {
...
#line 1574 "cif_grammar.tab.c"
    break;

  case 34:
#line 347 "cif_grammar.y"
    {
            ssize_t tag_nr = cif_tag_index( cif_compiler_cif( cif_cc ), (yyvsp[0].s) );
            if( tag_nr != -1 ) {
                yyerror_token( cif_cc, cxprintf( "tag %s appears more than once", (yyvsp[0].s) ),
...
#line 1589 "cif_grammar.tab.c"
    break;

  case 35:
#line 361 "cif_grammar.y"
    {
...
#line 1601 "cif_grammar.tab.c"
    break;

  case 36:
#line 369 "cif_grammar.y"
    {
            cif_compiler_increase_loop_values( cif_cc );
            cif_push_loop_cifvalue( cif_compiler_cif( cif_cc ),
                                    typed_value_value( (yyvsp[0].typed_value) ), px );
