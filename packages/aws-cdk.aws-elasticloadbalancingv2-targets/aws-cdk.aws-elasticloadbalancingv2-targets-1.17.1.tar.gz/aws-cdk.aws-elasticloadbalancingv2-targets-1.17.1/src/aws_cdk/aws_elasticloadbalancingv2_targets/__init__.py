...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-elasticloadbalancingv2-targets", "1.17.1", __name__, "aws-elasticloadbalancingv2-targets@1.17.1.jsii.tgz")
