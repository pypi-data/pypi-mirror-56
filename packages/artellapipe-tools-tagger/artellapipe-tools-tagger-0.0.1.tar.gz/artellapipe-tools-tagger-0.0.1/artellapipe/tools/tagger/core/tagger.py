...
class ArtellaTagger(tool.Tool, object):
    ...
    def __init__(self, project, config):
        ...
        super(ArtellaTagger, self).__init__(project=project, config=config)
    ...
    def ui(self):
        ...
        self._error_pixmap = resource.ResourceManager().pixmap('error', category='icons').scaled(QSize(24, 24))
        self._warning_pixmap = resource.ResourceManager().pixmap('warning', category='icons').scaled(QSize(24, 24))
        self._ok_pixmap = resource.ResourceManager().pixmap('ok', category='icons').scaled(QSize(24, 24))
        ...
        select_tag_data_btn.setIcon(resource.ResourceManager().icon('tag'))
        remove_tag_data_btn = QPushButton('Remove Tag Data')
        remove_tag_data_btn.setMinimumWidth(125)
        remove_tag_data_btn.setIcon(resource.ResourceManager().icon('tag_remove'))
