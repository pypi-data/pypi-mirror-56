...
setup(
  ...
  description = 'predict whether a domain is genuine or DGA.',   # Give a short description about your library
  ...
  download_url = 'https://github.com/sudo-rushil/dgaintel/archive/v0.4.tar.gz',    # I explain this later on
