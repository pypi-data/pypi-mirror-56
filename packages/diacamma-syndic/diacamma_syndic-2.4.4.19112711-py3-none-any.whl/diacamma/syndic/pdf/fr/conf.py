...
# -*- coding: utf-8 -*-
#
# Diacamma Asso documentation build configuration file, created by
...
def create_link(rootpath, packagename):
    target_path = os.path.join(os.path.abspath('.'), packagename)
...
for packname in ('syndic', 'condominium'):
...
project = 'Diacamma Syndic'
copyright = '2019, sd-libre'
author = 'sd-libre'
...
htmlhelp_basename = 'DiacammaSyndic'
...
latex_documents = [
    (master_doc, 'DiacammaSyndic.tex', 'Diacamma Syndic', 'sd-libre', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "../../DiacammaSyndic.jpg"
...
man_pages = [
    (master_doc, 'DiacammaSyndic', 'Diacamma Syndic',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DiacammaSyndic', 'Diacamma Syndic',
     author, 'DiacammaSyndic', 'Manuel de Diacamma Syndic', 'Miscellaneous'),
]
