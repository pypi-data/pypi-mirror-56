...
_OptionalClientCreateJobManifestLocationTypeDef = TypedDict(
    "_OptionalClientCreateJobManifestLocationTypeDef", {"ObjectVersionId": str}, total=False
)


class ClientCreateJobManifestLocationTypeDef(
    _RequiredClientCreateJobManifestLocationTypeDef, _OptionalClientCreateJobManifestLocationTypeDef
):
    """
...
class ClientCreateJobOperationS3PutObjectAclAccessControlPolicyAccessControlListGrantsGranteeTypeDef(
    ...
    """
    Type definition for
    `ClientCreateJobOperationS3PutObjectAclAccessControlPolicyAccessControlListGrants` `Grantee`
...
class ClientCreateJobOperationS3PutObjectAclAccessControlPolicyAccessControlListGrantsTypeDef(
    ...
    """
    Type definition for `ClientCreateJobOperationS3PutObjectAclAccessControlPolicyAccessControlList`
    `Grants`
...
class ClientCreateJobOperationS3PutObjectAclAccessControlPolicyAccessControlListTypeDef(
    ...
    """
    Type definition for `ClientCreateJobOperationS3PutObjectAclAccessControlPolicy`
    `AccessControlList`
...
_ClientCreateJobOperationS3PutObjectCopyNewObjectTaggingTypeDef = TypedDict(
    "_ClientCreateJobOperationS3PutObjectCopyNewObjectTaggingTypeDef", {"Key": str, "Value": str}
)
...
_ClientCreateJobOperationS3PutObjectTaggingTagSetTypeDef = TypedDict(
    "_ClientCreateJobOperationS3PutObjectTaggingTagSetTypeDef", {"Key": str, "Value": str}
)
...
class ClientDescribeJobResponseJobOperationS3PutObjectAclAccessControlPolicyAccessControlListGrantsGranteeTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeJobResponseJobOperationS3PutObjectAclAccessControlPolicyAccessControlListGrants`
    `Grantee`
...
class ClientDescribeJobResponseJobOperationS3PutObjectAclAccessControlPolicyAccessControlListGrantsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeJobResponseJobOperationS3PutObjectAclAccessControlPolicyAccessControlList`
    `Grants`
...
class ClientDescribeJobResponseJobOperationS3PutObjectAclAccessControlPolicyAccessControlListTypeDef(
    ...
    """
    Type definition for `ClientDescribeJobResponseJobOperationS3PutObjectAclAccessControlPolicy`
    `AccessControlList`
...
class ClientDescribeJobResponseJobOperationS3PutObjectCopyAccessControlGrantsGranteeTypeDef(
    ...
    """
    Type definition for `ClientDescribeJobResponseJobOperationS3PutObjectCopyAccessControlGrants`
    `Grantee`
...
class ClientDescribeJobResponseJobProgressSummaryTypeDef(
    ...
    Describes the total number of tasks that the specified job has executed, the number of tasks
...
class ClientDescribeJobResponseJobTypeDef(_ClientDescribeJobResponseJobTypeDef):
    ...
    - **Report** *(dict) --*
      ...
      - **Prefix** *(string) --*
        ...
        be stored. Amazon S3 will store the job-completion report at
    ...
    - **SuspendedCause** *(string) --*
      ...
      through the Amazon S3 console. When you create the job, it enters the ``Suspended`` state to
      await confirmation before running. After you confirm the job, it automatically exits the
      ``Suspended`` state.
    """
...
class ClientListJobsResponseJobsTypeDef(_ClientListJobsResponseJobsTypeDef):
    ...
    Contains the configuration and status information for a single job retrieved as part of a job
    list.
