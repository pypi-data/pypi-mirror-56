...
class Client(BaseClient):
    ...
    def delete_public_access_block(self, AccountId: str) -> None:
        ...
        **Request Syntax**
        ...
        :param AccountId: **[REQUIRED]**
          ...
          The account ID for the AWS account whose block public access configuration you want to
          delete.
    ...
    def update_job_status(
        self, AccountId: str, JobId: str, RequestedJobStatus: str, StatusUpdateReason: str = None
    ) -> ClientUpdateJobStatusResponseTypeDef:
        """
