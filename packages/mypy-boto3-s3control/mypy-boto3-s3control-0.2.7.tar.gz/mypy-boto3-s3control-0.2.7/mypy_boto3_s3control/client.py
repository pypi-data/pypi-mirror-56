"Main interface for s3control Client"
          ...
          response = client.create_job(
              ...
              Operation={
                  ...
                  'S3PutObjectCopy': {
                      ...
                      'StorageClass':
                      'STANDARD'|'STANDARD_IA'|'ONEZONE_IA'|'GLACIER'|'INTELLIGENT_TIERING'|'DEEP_ARCHIVE',
                ...
                'Job': {
                    ...
                    'Operation': {
                        ...
                        'S3PutObjectCopy': {
                            ...
                            'RequesterPays': True|False,
                            'StorageClass':
                            'STANDARD'|'STANDARD_IA'|'ONEZONE_IA'|'GLACIER'|'INTELLIGENT_TIERING'
                            |'DEEP_ARCHIVE',
                            'UnModifiedSinceConstraint': datetime(2015, 1, 1),
                            'SSEAwsKmsKeyId': 'string',
                            'TargetKeyPrefix': 'string',
    ...
    def list_jobs(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          more jobs than this number, the response will include a pagination token in the ``NextToken``
                ...
                'Jobs': [
                    {
                        ...
                        'Description': 'string',
                        'Operation':
                        'LambdaInvoke'|'S3PutObjectCopy'|'S3PutObjectAcl'|'S3PutObjectTagging'
                        |'S3InitiateRestoreObject',
                        'Priority': 123,
                        'Status':
                        'Active'|'Cancelled'|'Cancelling'|'Complete'|'Completing'|'Failed'|'Failing'|'New'
          ...
          **Response Syntax**
          ...
          ::

            {
                'JobId': 'string',
                'Status':
                'Active'|'Cancelled'|'Cancelling'|'Complete'|'Completing'|'Failed'|'Failing'|'New'|'Paused'
                |'Pausing'|'Preparing'|'Ready'|'Suspended',
                'StatusUpdateReason': 'string'
            }
          **Response Structure**
