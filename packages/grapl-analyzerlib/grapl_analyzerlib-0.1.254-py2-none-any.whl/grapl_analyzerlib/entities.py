...
class FileView(Viewable):
    ...
    def get_file_size(self) -> Optional[int]:
        ...
        if not self_file.file_size is not None:
            return None
...
class ProcessQuery(Queryable):
    ...
    def with_edge_filter(self, edge: str, edge_filter: EdgeFilter) -> "PQ":
        self.edge_filters[edge] = edge_filter
        return self

    def with_reverse_edge_filter(self, edge: str, edge_filter: EdgeFilter) -> "PQ":
        self.reverse_edge_filters[edge] = edge_filter
        return self
    ...
    def with_user_id(
        ...
        self._user_id.extend(_int_cmps("user_id", eq, gt, lt))
        return self
    ...
    def with_auid(
        ...
        self._auid.extend(_int_cmps("auid", eq, gt, lt))
        return self
    ...
    def with_parent(self, process: "PQ") -> "PQ":
        process = deepcopy(process)  # type: PQ
    ...
    def get_forward_edges(self) -> List[Tuple[str, Any]]:
        ...
        edges.extend([t for t in self.edge_filters.items() if t[1]])
    ...
    def get_reverse_edges(self) -> List[Tuple[str, Any, str]]:
        ...
        edges.extend([t for t in self.reverse_edge_filters.items() if t[1]])
...
class ProcessView(Viewable):
    ...
    def get_user_id(self) -> Optional[int]:
        ...
        if not self_process:
            return None
        if self_process.user_id is not None:
    ...
    def get_auid(self) -> Optional[int]:
        ...
        if self_process.auid is not None:
    ...
    def get_process_id(self) -> Optional[int]:
        ...
        if self_process.process_id is not None:
