...
Mypy-friendly auto-generated type annotations for `boto3 waf 1.10.28` service.
...
session_client = session.client("waf")
...
```python
import boto3
from mypy_boto3.waf import Client

from mypy_boto3.waf.paginator import GetRateBasedRuleManagedKeysPaginator
