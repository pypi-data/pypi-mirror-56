...
class Client(BaseClient):
    ...
    def create_byte_match_set(
        ...
        request that you want AWS WAF to inspect, such as the values of the ``User-Agent`` header or
        the query string. For example, you can create a ``ByteMatchSet`` that matches any requests
        with ``User-Agent`` headers that contain the string ``BadBot`` . You can then configure AWS
        ...
        * Submit an  UpdateByteMatchSet request to specify the part of the request that you want AWS
        WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to
        watch for.

        For more information about how to use the AWS WAF API to allow or block HTTP requests, see
        the `AWS WAF Developer Guide <https://docs.aws.amazon.com/waf/latest/developerguide/>`__ .
                    ...
                    'ByteMatchTuples': [
                        {
                            'FieldToMatch': {
                                ...
                                |'BODY'|'SINGLE_QUERY_ARG'|'ALL_QUERY_ARGS',
                                'Data': 'string'
                            },
            ...
            - **ByteMatchSet** *(dict) --*
              ...
              - **ByteMatchTuples** *(list) --*
                ...
                - *(dict) --*
                  ...
                  want AWS WAF to search for in web requests, the location in requests that you want
                  AWS WAF to search, and other settings.
                  ...
                  - **FieldToMatch** *(dict) --*
                    ...
                    - **Type** *(string) --*
                      ...
                      * ``METHOD`` : The HTTP method, which indicated the type of operation that the
                      ...
                      following methods: ``DELETE`` , ``GET`` , ``HEAD`` , ``OPTIONS`` , ``PATCH`` ,
                      ``POST`` , and ``PUT`` .
                      ...
                      * ``BODY`` : The part of a request that contains any additional data that you
                      want to send to your web server as the HTTP request body, such as data from a
                      form. The request body immediately follows the request headers. Note that only
                      the first ``8192`` bytes of the request body are forwarded to AWS WAF for
                      ...
                      * ``ALL_QUERY_ARGS`` : Similar to ``SINGLE_QUERY_ARG`` , but rather than
                      inspecting a single parameter, AWS WAF will inspect all parameters within the
                  ...
                  - **TargetString** *(bytes) --*
                    ...
                    * ``BODY`` : The part of a request that contains any additional data that you
                    ...
                    create a size constraint set. For more information, see  CreateSizeConstraintSet
                    .
                    ...
                    * ``ALL_QUERY_ARGS`` : Similar to ``SINGLE_QUERY_ARG`` , but instead of
                    ...
                    and include the resulting value, ``QmFkQm90`` , in the value of ``TargetString``
                    .
                  ...
                  - **TextTransformation** *(string) --*
                    ...
                    AWS WAF performs the transformation on ``TargetString`` before inspecting a
                    request for a match.
    ...
    def create_geo_match_set(
        ...
        you can create an ``GeoMatchSet`` that contains those countries and then configure AWS WAF
        ...
        * Submit an ``UpdateGeoMatchSetSet`` request to specify the countries that you want AWS WAF
        to watch for.
          ...
          - *(dict) --*
            ...
            - **GeoMatchSet** *(dict) --*
              ...
              - **GeoMatchConstraints** *(list) --*
                ...
                An array of  GeoMatchConstraint objects, which contain the country that you want AWS
                WAF to search for.
    ...
    def create_ip_set(self, Name: str, ChangeToken: str) -> ClientCreateIpSetResponseTypeDef:
        ...
        of IP addresses and you want to block the requests, you can create an ``IPSet`` that
        ...
        * Submit an ``UpdateIPSet`` request to specify the IP addresses that you want AWS WAF to
        watch for.
          ...
          - *(dict) --*
            ...
            - **IPSet** *(dict) --*
              ...
              - **IPSetDescriptors** *(list) --*
                ...
                notation) that web requests originate from. If the ``WebACL`` is associated with a
                CloudFront distribution and the viewer did not use an HTTP proxy or a load balancer
    ...
    def create_rate_based_rule(
        ...
        the maximum number of requests that AWS WAF allows from a specified IP address in a
        ...
        count or block if these requests exceed the ``RateLimit`` .

        If you add more than one predicate to a ``RateBasedRule`` , a request not only must exceed
        the ``RateLimit`` , but it also must match all the specifications to be counted or blocked.
        ...
        * A ``ByteMatchSet`` that matches ``BadBot`` in the ``User-Agent`` header
        ...
        requests that meet the conditions in the rule. For a request to be blocked, it must come
        from the IP address 192.0.2.44 *and* the ``User-Agent`` header in the request must contain
        the value ``BadBot`` . Further, requests that match these two conditions must be received at
        ...
        * Submit an ``UpdateRateBasedRule`` request to specify the predicates that you want to
        include in the rule.
                    ...
                    'MatchPredicates': [
                        {
                            'Negated': True|False,
                            'Type':
                            'IPMatch'|'ByteMatch'|'SqlInjectionMatch'|'GeoMatch'
          ...
          - *(dict) --*
            ...
            - **Rule** *(dict) --*
              ...
              - **RateKey** *(string) --*
                ...
                source and thus subject to rate monitoring. The only valid value for ``RateKey`` is
                ``IP`` . ``IP`` indicates that requests arriving from the same IP address are
    ...
    def create_regex_match_set(
        ...
        request that you want AWS WAF to inspect, such as the values of the ``User-Agent`` header or
        the query string. For example, you can create a ``RegexMatchSet`` that contains a
        ``RegexMatchTuple`` that looks for any requests with ``User-Agent`` headers that match a
        ``RegexPatternSet`` with pattern ``B[a@]dB[o0]t`` . You can then configure AWS WAF to reject
        those requests.
        ...
        * Submit an  UpdateRegexMatchSet request to specify the part of the request that you want
    ...
    def create_rule(
        ...
        other predicates that identify the requests that you want to block. If you add more than one
        predicate to a ``Rule`` , a request must match all of the specifications to be allowed or
        blocked. For example, suppose that you add the following to a ``Rule`` :
          ...
          - *(dict) --*
            ...
            - **Rule** *(dict) --*
              ...
              - **MetricName** *(string) --*
                ...
                minimum length one. It can't contain whitespace or metric names reserved for AWS
    ...
    def create_size_constraint_set(
        ...
        * Submit an  UpdateSizeConstraintSet request to specify the part of the request that you
        want AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS
        WAF to watch for.
          ...
          - *(dict) --*
            ...
            - **SizeConstraintSet** *(dict) --*
              ...
              - **SizeConstraintSetId** *(string) --*
                ...
                ``SizeConstraintSet`` into a ``Rule`` or delete one from a ``Rule`` (see  UpdateRule
              ...
              - **SizeConstraints** *(list) --*
                ...
                - *(dict) --*
                  ...
                  ``Size`` , ``ComparisonOperator`` , and ``FieldToMatch`` to build an expression in
                  the form of "``Size``  ``ComparisonOperator`` size in bytes of ``FieldToMatch`` ".
                  ...
                  - **TextTransformation** *(string) --*
                    ...
                    Text transformations eliminate some of the unusual formatting that attackers use
                    in web requests in an effort to bypass AWS WAF. If you specify a transformation,
                    AWS WAF performs the transformation on ``FieldToMatch`` before inspecting a
                    request for a match.
                  ...
                  - **Size** *(integer) --*
                    ...
                    of "``Size``  ``ComparisonOperator`` size in bytes of ``FieldToMatch`` ". If
    ...
    def create_sql_injection_match_set(
        ...
        * Submit an  UpdateSqlInjectionMatchSet request to specify the parts of web requests in
          ...
          - *(dict) --*
            ...
            - **SqlInjectionMatchSet** *(dict) --*
              ...
              - **SqlInjectionMatchSetId** *(string) --*
                ...
                UpdateSqlInjectionMatchSet ), insert a ``SqlInjectionMatchSet`` into a ``Rule`` or
                delete one from a ``Rule`` (see  UpdateRule ), and delete a ``SqlInjectionMatchSet``
              ...
              - **SqlInjectionMatchTuples** *(list) --*
                ...
                - *(dict) --*
                  ...
                  of malicious SQL code and, if you want AWS WAF to inspect a header, the name of
                  the header.
    ...
    def create_web_acl(
        ...
        requests that you want to allow, block, or count. AWS WAF evaluates ``Rules`` in order based
        on the value of ``Priority`` for each ``Rule`` .

        You also specify a default action, either ``ALLOW`` or ``BLOCK`` . If a web request doesn't
        match any of the ``Rules`` in a ``WebACL`` , AWS WAF responds to the request with the
        default action.

        To create and configure a ``WebACL`` , perform the following steps:

        * Create and update the ``ByteMatchSet`` objects and other predicates that you want to
        include in ``Rules`` . For more information, see  CreateByteMatchSet ,  UpdateByteMatchSet ,
              ...
              - **Rules** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **Action** *(dict) --*
                    ...
                    the conditions in the ``Rule`` . Valid values for ``Action`` include the
                    following:
                    ...
                    * ``COUNT`` : AWS WAF increments a counter of requests that match the conditions
                    ...
                    rules in the web ACL.
                     ...
                     ``ActivatedRule
                     |OverrideAction`` applies only when updating or adding a
                  ...
                  - **OverrideAction** *(dict) --*
                    ...
                    block action specified by individual rules contained within the group. Instead
                    of blocking matching requests, those requests will be counted. You can view a
                    record of counted requests using  GetSampledRequests .
                  ...
                  - **Type** *(string) --*
                    ...
                    default is REGULAR. Although this field is optional, be aware that if you try to
                    add a RATE_BASED rule to a web ACL without setting the type, the  UpdateWebACL
                  ...
                  - **ExcludedRules** *(list) --*
                    ...
                    that match an ``ExcludedRule`` are counted but not blocked. The ``RuleGroup``
                    owner will receive COUNT metrics for each ``ExcludedRule`` .

                    If you want to exclude rules from a rule group that is already associated with a
                    web ACL, perform the following steps:
                    ...
                    * Submit an  UpdateWebACL request that has two actions:
                      ...
                      * The first action deletes the existing rule group from the web ACL. That is,
                      in the  UpdateWebACL request, the first ``Updates:Action`` should be
                      ...
                      * The second action inserts the same rule group back in, but specifying the
                      ...
                      removed, and ``ExcludedRules`` should contain the rules that you want to
                      exclude.
    ...
    def create_xss_match_set(
        ...
        * Submit an  UpdateXssMatchSet request to specify the parts of web requests in which you
        want to allow, block, or count cross-site scripting attacks.
          ...
          - *(dict) --*
            ...
            - **XssMatchSet** *(dict) --*
              ...
              - **XssMatchSetId** *(string) --*
                ...
                ``XssMatchSet`` (see  UpdateXssMatchSet ), insert an ``XssMatchSet`` into a ``Rule``
                or delete one from a ``Rule`` (see  UpdateRule ), and delete an ``XssMatchSet`` from
                AWS WAF (see  DeleteXssMatchSet ).
    ...
    def delete_geo_match_set(
        ...
        """
        Permanently deletes a  GeoMatchSet . You can't delete a ``GeoMatchSet`` if it's still used
        in any ``Rules`` or if it still includes any countries.
    ...
    def delete_ip_set(self, IPSetId: str, ChangeToken: str) -> ClientDeleteIpSetResponseTypeDef:
        ...
        * Update the ``IPSet`` to remove IP address ranges, if any. For more information, see
        UpdateIPSet .
    ...
    def delete_regex_match_set(
        ...
        used in any ``Rules`` or if it still includes any ``RegexMatchTuples`` objects (any
        filters).
    ...
    def delete_regex_pattern_set(
        ...
        """
        Permanently deletes a  RegexPatternSet . You can't delete a ``RegexPatternSet`` if it's
        still used in any ``RegexMatchSet`` or if the ``RegexPatternSet`` is not empty.
    ...
    def delete_rule_group(
        ...
        """
        Permanently deletes a  RuleGroup . You can't delete a ``RuleGroup`` if it's still used in
        any ``WebACL`` objects or if it still includes any rules.
    ...
    def delete_sql_injection_match_set(
        ...
        it's still used in any ``Rules`` or if it still contains any  SqlInjectionMatchTuple
        objects.
    ...
    def get_ip_set(self, IPSetId: str) -> ClientGetIpSetResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-2015-08-24/GetIPSet>`_
...

            {
                'LoggingConfiguration': {
                    ...
                    'RedactedFields': [
                        {
                            'Type':
                            'URI'|'QUERY_STRING'|'HEADER'|'METHOD'|'BODY'
          ...
          - *(dict) --*
            ...
            - **LoggingConfiguration** *(dict) --*
              ...
              - **RedactedFields** *(list) --*
                ...
                redact the cookie field, the cookie field in the firehose will be ``xxx`` .
    ...
    def get_rule(self, RuleId: str) -> ClientGetRuleResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-2015-08-24/GetRule>`_
        ...
        **Request Syntax**
        ...
        :param TimeWindow: **[REQUIRED]**
          ...
          - **StartTime** *(datetime) --* **[REQUIRED]**
            ...
            following format: ``"2016-09-27T14:50Z"`` . You can specify any time range in the
            previous three hours.

          - **EndTime** *(datetime) --* **[REQUIRED]**

            The end of the time range from which you want ``GetSampledRequests`` to return a sample
            of the requests that your AWS resource received. Specify the date and time in the
            following format: ``"2016-09-27T14:50Z"`` . You can specify any time range in the
            previous three hours.
        ...
        :param MaxItems: **[REQUIRED]**
          ...
          The number of requests that you want AWS WAF to return from among the first 5,000 requests
          that your AWS resource received during the time range. If your resource received fewer
          requests than the value of ``MaxItems`` , ``GetSampledRequests`` returns information about
          all of them.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **SampledRequests** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Request** *(dict) --*
                  ...
                  - **Headers** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      ``HTTPHeader`` contains the names and values of all of the headers that appear
                      in one of the web requests that were returned by ``GetSampledRequests`` .
                ...
                - **RuleWithinRuleGroup** *(string) --*
                  ...
                  ``RuleGroup`` rather than the ID of an individual rule. ``RuleWithinRuleGroup`` is
                  the rule within the specified ``RuleGroup`` that matched the request listed in the
                  response.

            - **PopulationSize** *(integer) --*

              The total number of requests from which ``GetSampledRequests`` got a sample of
              ``MaxItems`` requests. If ``PopulationSize`` is less than ``MaxItems`` , the sample
              includes every request that your AWS resource received during the specified time
              range.
            ...
            - **TimeWindow** *(dict) --*
              ...
              requests during the time range that you specified in the request,
              ...
              - **StartTime** *(datetime) --*
                ...
                in the following format: ``"2016-09-27T14:50Z"`` . You can specify any time range in
                the previous three hours.

              - **EndTime** *(datetime) --*

                The end of the time range from which you want ``GetSampledRequests`` to return a
                sample of the requests that your AWS resource received. Specify the date and time in
                the following format: ``"2016-09-27T14:50Z"`` . You can specify any time range in
                the previous three hours.
            ...
            - **ActivatedRules** *(list) --*
              ...
              - *(dict) --*
                  ...
                  * ``COUNT`` : AWS WAF increments a counter of requests that match the conditions
                  ...
                  - **Type** *(string) --*
                    ...
                    * ``COUNT`` : AWS WAF increments a counter of the requests that match all of the
                    ...
                    on the remaining rules in the web ACL. You can't specify ``COUNT`` for the
                ...
                - **OverrideAction** *(dict) --*
                  ...
                  ``OverrideAction`` to ``None`` , the ``RuleGroup`` will block a request if any
                  individual rule in the ``RuleGroup`` matches the request and is configured to
                  block that request. However if you first want to test the ``RuleGroup`` , set the
                  ``OverrideAction`` to ``Count`` . The ``RuleGroup`` will then override any block
                  action specified by individual rules contained within the group. Instead of
                  blocking matching requests, those requests will be counted. You can view a record
                  of counted requests using  GetSampledRequests .
                ...
                - **Type** *(string) --*
                  ...
                  is REGULAR. Although this field is optional, be aware that if you try to add a
                  RATE_BASED rule to a web ACL without setting the type, the  UpdateWebACL request
                  will fail because the request tries to add a REGULAR rule with the specified ID,
                ...
                - **ExcludedRules** *(list) --*
                  ...
                  unexpectedly (false positives). One troubleshooting technique is to identify the
                  specific rule within the rule group that is blocking the legitimate traffic and
                  then disable (exclude) that particular rule. You can exclude rules from both your
                  own rule groups and AWS Marketplace rule groups that have been associated with a
                  web ACL.
                  ...
                  * Submit an  UpdateWebACL request that has two actions:
                    ...
                    * The first action deletes the existing rule group from the web ACL. That is, in
                    the  UpdateWebACL request, the first ``Updates:Action`` should be ``DELETE`` and
                    ``Updates:ActivatedRule:RuleId`` should be the rule group that contains the
    ...
    def list_geo_match_sets(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list
          another group of ``GeoMatchSet`` objects. For the second and subsequent
    ...
    def list_ip_sets(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          group of ``IPSets`` . For the second and subsequent ``ListIPSets`` requests, specify the
          value of ``NextMarker`` from the previous response to get information about another batch
          of ``IPSets`` .
    ...
    def list_logging_configurations(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          you to list another group of ``LoggingConfigurations`` . For the second and subsequent
        ...
        :param Limit:
          ...
          ``Limit`` , the response includes a ``NextMarker`` value that you can use to get another
          batch of ``LoggingConfigurations`` .
    ...
    def list_rate_based_rules(
        ...
        **Request Syntax**
        ...
        :param Limit:
          ...
          have more ``Rules`` than the number that you specify for ``Limit`` , the response includes
          a ``NextMarker`` value that you can use to get another batch of ``Rules`` .
    ...
    def list_regex_pattern_sets(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          subsequent ``ListRegexPatternSets`` requests, specify the value of ``NextMarker`` from the
          previous response to get information about another batch of ``RegexPatternSet`` objects.
    ...
    def list_rule_groups(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list
          another group of ``RuleGroups`` . For the second and subsequent ``ListRuleGroups``
          requests, specify the value of ``NextMarker`` from the previous response to get
        ...
        :param Limit:
          ...
          If you have more ``RuleGroups`` than the number that you specify for ``Limit`` , the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextMarker** *(string) --*
              ...
              If you have more ``RuleGroups`` than the number that you specified for ``Limit`` in
              the request, the response includes a ``NextMarker`` value. To list more ``RuleGroups``
    ...
    def list_rules(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``Rules`` than the value of
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list
          another group of ``Rules`` . For the second and subsequent ``ListRules`` requests, specify
            ...
            - **SizeConstraintSets** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SizeConstraintSetId** *(string) --*
                  ...
                  update a ``SizeConstraintSet`` (see  UpdateSizeConstraintSet ), insert a
    ...
    def list_sql_injection_match_sets(
        ...
        **Request Syntax**
        ...
        :param Limit:
          ...
          Specifies the number of  SqlInjectionMatchSet objects that you want AWS WAF to return for
          this request. If you have more ``SqlInjectionMatchSet`` objects than the number you
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextMarker** *(string) --*
              ...
              ``Limit`` in the request, the response includes a ``NextMarker`` value. To list more
              ``SqlInjectionMatchSet`` objects, submit another ``ListSqlInjectionMatchSets``
    ...
    def list_subscribed_rule_groups(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          response that allows you to list another group of subscribed rule groups. For the second
          and subsequent ``ListSubscribedRuleGroupsRequest`` requests, specify the value of
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextMarker** *(string) --*
              ...
              another ``ListSubscribedRuleGroups`` request, and specify the ``NextMarker`` value
    ...
    def list_web_acls(
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          that you specify for ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response
          that allows you to list another group of ``WebACL`` objects. For the second and subsequent
          ``ListWebACLs`` requests, specify the value of ``NextMarker`` from the previous response
    ...
    def put_logging_configuration(
        ...
        * Create an Amazon Kinesis Data Firehose.  Create the data firehose with a PUT source and in
        the region that you are operating. However, if you are capturing logs for Amazon CloudFront,
        ...
        * Associate that firehose to your web ACL using a ``PutLoggingConfiguration`` request.
        ...
        will create a service linked role with the necessary permissions to write logs to the Amazon
        Kinesis Data Firehose. For more information, see `Logging Web ACL Traffic Information
        <https://docs.aws.amazon.com/waf/latest/developerguide/logging.html>`__ in the *AWS WAF
        Developer Guide* .
            ...
            - *(dict) --*
              ...
              - **Type** *(string) --* **[REQUIRED]**
                ...
                * ``ALL_QUERY_ARGS`` : Similar to ``SINGLE_QUERY_ARG`` , but rather than inspecting
                a single parameter, AWS WAF will inspect all parameters within the query for the
                value or regex pattern that you specify in ``TargetString`` .

              - **Data** *(string) --*

                When the value of ``Type`` is ``HEADER`` , enter the name of the header that you
                want AWS WAF to search, for example, ``User-Agent`` or ``Referer`` . The name of the
    ...
    def put_permission_policy(self, ResourceArn: str, Policy: str) -> Dict[str, Any]:
        """
        Attaches a IAM policy to the specified resource. The only supported use for this action is
        ...
        * The ``Action`` in the policy must be ``waf:UpdateWebACL`` , ``waf-regional:UpdateWebACL``
        , ``waf:GetRuleGroup`` and ``waf-regional:GetRuleGroup`` . Any extra or wildcard actions in
        the policy will be rejected.

        * The policy cannot include a ``Resource`` parameter.

        * The ARN in the request must be a valid WAF RuleGroup ARN and the RuleGroup must exist in
        the same region.
    ...
    def update_byte_match_set(
        ...
        * The bytes (typically a string that corresponds with ASCII characters) that you want AWS
        ...
        API and the AWS CLI or SDKs, see ``TargetString`` in the  ByteMatchTuple data type.
        ...
        * Submit an ``UpdateByteMatchSet`` request to specify the part of the request that you want
        AWS WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF
        to watch for.
            ...
            - **ByteMatchTuple** *(dict) --* **[REQUIRED]**
              ...
              - **FieldToMatch** *(dict) --* **[REQUIRED]**
                ...
                - **Type** *(string) --* **[REQUIRED]**
                  ...
                  * ``BODY`` : The part of a request that contains any additional data that you want
                  to send to your web server as the HTTP request body, such as data from a form. The
                  request body immediately follows the request headers. Note that only the first
                  ``8192`` bytes of the request body are forwarded to AWS WAF for inspection. To
                  allow or block requests based on the length of the body, you can create a size
              ...
              - **TargetString** *(bytes) --* **[REQUIRED]**
                ...
                * ``METHOD`` : The HTTP method, which indicates the type of operation specified in
                the request. CloudFront supports the following methods: ``DELETE`` , ``GET`` ,
                ``HEAD`` , ``OPTIONS`` , ``PATCH`` , ``POST`` , and ``PUT`` .
                ...
                * ``ALL_QUERY_ARGS`` : Similar to ``SINGLE_QUERY_ARG`` , but instead of inspecting a
                single parameter, AWS WAF inspects all parameters within the query string for the
                value or regex pattern that you specify in ``TargetString`` .
                ...
                For example, suppose the value of ``Type`` is ``HEADER`` and the value of ``Data``
                is ``User-Agent`` . If you want to search the ``User-Agent`` header for the value
              ...
              - **TextTransformation** *(string) --* **[REQUIRED]**
                ...
                WAF performs the transformation on ``TargetString`` before inspecting a request for
                a match.
    ...
    def update_geo_match_set(
        ...
        * Submit an ``UpdateGeoMatchSet`` request to specify the country that you want AWS WAF to
        watch for.
    ...
    def update_ip_set(
        ...
        * The IP address in CIDR notation, for example, ``192.0.2.0/24`` (for the range of IP
        addresses from ``192.0.2.0`` to ``192.0.2.255`` ) or ``192.0.2.44/32`` (for the individual
        ...
        * 1111::111/128
        ...
        You use an ``IPSet`` to specify which web requests you want to allow or block based on the
        IP addresses that the requests originated from. For example, if you're receiving a lot of
        ...
        * Submit an ``UpdateIPSet`` request to specify the IP addresses that you want AWS WAF to
        ...
        When you update an ``IPSet`` , you specify the IP addresses that you want to add and/or the
        IP addresses that you want to delete. If you want to change an IP address, you delete the
        existing IP address and add the new one.
          ...
          - *(dict) --*
            ...
            - **IPSetDescriptor** *(dict) --* **[REQUIRED]**
              ...
              - **Value** *(string) --* **[REQUIRED]**
                ...
                * To configure AWS WAF to allow, block, or count requests that originated from the
    ...
    def update_rate_based_rule(
        ...
        * A ``ByteMatchSet`` that matches ``BadBot`` in the ``User-Agent`` header
        ...
        address 192.0.2.44 *and* the ``User-Agent`` header in the request must contain the value
        ``BadBot`` . Further, requests that match these two conditions much be received at a rate of
        more than 15,000 every five minutes. If the rate drops below this limit, AWS WAF no longer
        blocks the requests.
        ...
        **Request Syntax**
        ...
        :param RateLimit: **[REQUIRED]**
          ...
          ``RateLimit`` and the other predicates specified in the rule are also met, AWS WAF
    ...
    def update_regex_match_set(
        ...
        * Whether to perform any conversions on the request, such as converting it to lowercase,
        ...
        ``User-Agent`` headers that contain the string ``B[a@]dB[o0]t`` . You can then configure AWS
        WAF to reject those requests.
        ...
        **Request Syntax**
        ...
        :param Updates: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            In an  UpdateRegexMatchSet request, ``RegexMatchSetUpdate`` specifies whether to insert
            or delete a  RegexMatchTuple and includes the settings for the ``RegexMatchTuple`` .
            ...
            - **RegexMatchTuple** *(dict) --* **[REQUIRED]**
              ...
              for. If you specify ``DELETE`` for the value of ``Action`` , the ``RegexMatchTuple``
              values must exactly match the values in the ``RegexMatchTuple`` that you want to
              delete from the ``RegexMatchSet`` .
              ...
              - **TextTransformation** *(string) --* **[REQUIRED]**
                ...
                Text transformations eliminate some of the unusual formatting that attackers use in
                web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS
                WAF performs the transformation on ``RegexPatternSet`` before inspecting a request
                for a match.
              ...
              - **RegexPatternSetId** *(string) --* **[REQUIRED]**
                ...
                to get information about a ``RegexPatternSet`` (see  GetRegexPatternSet ), update a
                ``RegexPatternSet`` (see  UpdateRegexPatternSet ), insert a ``RegexPatternSet`` into
    ...
    def update_regex_pattern_set(
        ...
        * Submit an ``UpdateRegexPatternSet`` request to specify the regular expression pattern that
        ...
        **Request Syntax**
        ...
        :param Updates: **[REQUIRED]**
          ...
          An array of ``RegexPatternSetUpdate`` objects that you want to insert into or delete from
          a  RegexPatternSet .

          - *(dict) --*

            In an  UpdateRegexPatternSet request, ``RegexPatternSetUpdate`` specifies whether to
            insert or delete a ``RegexPatternString`` and includes the settings for the
            ``RegexPatternString`` .
    ...
    def update_rule_group(
        ...
        * Create and update a ``WebACL`` that contains the ``RuleGroup`` . See  CreateWebACL .
        ...
        If you want to replace one ``Rule`` with another, you delete the existing one and add the
        new one.
        ...
        **Request Syntax**
        ...
        :param Updates: **[REQUIRED]**
          ...
          You can only insert ``REGULAR`` rules into a rule group.
           ...
           ``ActivatedRule
           |OverrideAction`` applies only when updating or adding a ``RuleGroup`` to
          ...
          - *(dict) --*
            ...
            - **Action** *(string) --* **[REQUIRED]**
              ...
              remove an ``ActivatedRule`` from a ``RuleGroup`` .

            - **ActivatedRule** *(dict) --* **[REQUIRED]**

              The ``ActivatedRule`` object specifies a ``Rule`` that you want to insert or delete,
              the priority of the ``Rule`` in the ``WebACL`` , and the action that you want AWS WAF
              ...
              - **RuleId** *(string) --* **[REQUIRED]**
                ...
                The ``RuleId`` for a ``Rule`` . You use ``RuleId`` to get more information about a
                ``Rule`` (see  GetRule ), update a ``Rule`` (see  UpdateRule ), insert a ``Rule``
                into a ``WebACL`` or delete a one from a ``WebACL`` (see  UpdateWebACL ), or delete
                a ``Rule`` from AWS WAF (see  DeleteRule ).
              ...
              - **Action** *(dict) --*
                ...
                * ``COUNT`` : AWS WAF increments a counter of requests that match the conditions in
                the rule and then continues to inspect the web request based on the remaining rules
                in the web ACL.

                 ``ActivatedRule|OverrideAction`` applies only when updating or adding a
                 ``RuleGroup`` to a ``WebACL`` . In this case, you do not use
                 ``ActivatedRule|Action`` . For all other update requests, ``ActivatedRule
                 |Action``
              ...
              - **OverrideAction** *(dict) --*
                ...
                ``OverrideAction`` to ``Count`` . The ``RuleGroup`` will then override any block
                action specified by individual rules contained within the group. Instead of blocking
                matching requests, those requests will be counted. You can view a record of counted
              ...
              - **ExcludedRules** *(list) --*
                ...
                disable (exclude) that particular rule. You can exclude rules from both your own
                rule groups and AWS Marketplace rule groups that have been associated with a web
                ACL.
                ...
                * Submit an  UpdateWebACL request that has two actions:
                  ...
                  * The second action inserts the same rule group back in, but specifying the rules
                  to exclude. That is, the second ``Updates:Action`` should be ``INSERT`` ,
                  ``Updates:ActivatedRule:RuleId`` should be the rule group that you just removed,
                  and ``ExcludedRules`` should contain the rules that you want to exclude.
    ...
    def update_size_constraint_set(
        ...
        * Whether to perform any transformations on the request, such as converting it to lowercase,
        before checking its length. Note that transformations of the request body are not supported
        because the AWS resource forwards only the first ``8192`` bytes of your request to AWS WAF.
        You can only specify a single type of TextTransformation.
        ...
        * The length, in bytes, that you want AWS WAF to watch for in selected part of the request.
        ...
        which the length of the ``User-Agent`` header is greater than 100 bytes. You can then
        ...
        **Request Syntax**
        ...
        :param Updates: **[REQUIRED]**
          ...
          An array of ``SizeConstraintSetUpdate`` objects that you want to insert into or delete
          from a  SizeConstraintSet . For more information, see the applicable data types:
          ...
          - *(dict) --*
            ...
            - **SizeConstraint** *(dict) --* **[REQUIRED]**
              ...
              - **TextTransformation** *(string) --* **[REQUIRED]**
                ...
                Text transformations eliminate some of the unusual formatting that attackers use in
                web requests in an effort to bypass AWS WAF. If you specify a transformation, AWS
                WAF performs the transformation on ``FieldToMatch`` before inspecting a request for
                a match.

                You can only specify a single type of TextTransformation.

                Note that if you choose ``BODY`` for the value of ``Type`` , you must choose
                ``NONE`` for ``TextTransformation`` because CloudFront forwards only the first 8192
              ...
              - **ComparisonOperator** *(string) --* **[REQUIRED]**
                ...
                with the provided ``Size`` and ``FieldToMatch`` to build an expression in the form
    ...
    def update_sql_injection_match_set(
        ...
        * Submit an ``UpdateSqlInjectionMatchSet`` request to specify the parts of web requests that
        ...
        :param Updates: **[REQUIRED]**
          ...
          *  FieldToMatch : Contains ``Data`` and ``Type``
          ...
          - *(dict) --*
            ...
            SQL code and indicates whether you want to add the specification to a
            ...
            - **SqlInjectionMatchTuple** *(dict) --* **[REQUIRED]**
              ...
              malicious SQL code and, if you want AWS WAF to inspect a header, the name of the
              header.
    ...
    def update_web_acl(
        ...
        * The order in which you want AWS WAF to evaluate the ``Rules`` in a ``WebACL`` . If you add
        more than one ``Rule`` to a ``WebACL`` , AWS WAF evaluates each request against the
        ``Rules`` in order based on the value of ``Priority`` . (The ``Rule`` that has the lowest
        value for ``Priority`` is evaluated first.) When a web request matches all the predicates
        (such as ``ByteMatchSets`` and ``IPSets`` ) in a ``Rule`` , AWS WAF immediately takes the
        corresponding action, allow or block, and doesn't evaluate the request against the remaining
        ...
        * Submit an ``UpdateWebACL`` request to specify the ``Rules`` that you want to include in
        the ``WebACL`` , to specify the default action, and to associate the ``WebACL`` with a
        CloudFront distribution.  The ``ActivatedRule`` can be a rule group. If you specify a rule
        group as your ``ActivatedRule`` , you can exclude specific rules from that rule group. If
        you already have a rule group associated with a web ACL and want to submit an
        ``UpdateWebACL`` request to exclude certain rules from that rule group, you must first
        remove the rule group from the web ACL, the re-insert it again, specifying the excluded
        ...
        when first creating the rule, the  UpdateWebACL request will fail because the request tries
        to add a REGULAR rule (the default rule type) with the specified ID, which does not exist.
          ...
          *  WafAction : Contains ``Type``
          ...
          - *(dict) --*
            ...
            - **ActivatedRule** *(dict) --* **[REQUIRED]**
              ...
              action that you want AWS WAF to take when a web request matches the ``Rule``
              (``ALLOW`` , ``BLOCK`` , or ``COUNT`` ).
    ...
    def update_xss_match_set(
        ...
        * ``TextTransformation`` : Which text transformation, if any, to perform on the web request
        before inspecting the request for cross-site scripting attacks. You can only specify a
        single type of TextTransformation.
        ...
        * Submit an ``UpdateXssMatchSet`` request to specify the parts of web requests that you want
        ...
        :param Updates: **[REQUIRED]**
          ...
          *  FieldToMatch : Contains ``Data`` and ``Type``
          ...
          - *(dict) --*
            ...
            attacks and indicates whether you want to add the specification to an  XssMatchSet or
            ...
            - **XssMatchTuple** *(dict) --* **[REQUIRED]**
              ...
              scripting attacks and, if you want AWS WAF to inspect a header, the name of the
              header.
