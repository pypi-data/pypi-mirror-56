...
class ClientCreateByteMatchSetResponseByteMatchSetByteMatchTuplesFieldToMatchTypeDef(
    ...
    - **Type** *(string) --*
      ...
      * ``BODY`` : The part of a request that contains any additional data that you want to send to
      ...
      request body are forwarded to AWS WAF for inspection. To allow or block requests based on the
      length of the body, you can create a size constraint set. For more information, see
...
class ClientCreateByteMatchSetResponseByteMatchSetByteMatchTuplesTypeDef(
    ...
    - **TextTransformation** *(string) --*
      ...
      requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the
      transformation on ``TargetString`` before inspecting a request for a match.
    ...
    - **PositionalConstraint** *(string) --*
      ...
      Within the portion of a web request that you want to search (for example, in the query string,
      if any), specify where you want AWS WAF to search. Valid values include the following:
      ...
      - *(dict) --*
        ...
        - **TargetString** *(bytes) --*
          ...
          * ``ALL_QUERY_ARGS`` : Similar to ``SINGLE_QUERY_ARG`` , but instead of inspecting a
          single parameter, AWS WAF inspects all parameters within the query string for the value or
          regex pattern that you specify in ``TargetString`` .
...
class ClientCreateIpSetResponseIPSetTypeDef(_ClientCreateIpSetResponseIPSetTypeDef):
    ...
    - **IPSetId** *(string) --*
      ...
      or delete one from a ``Rule`` (see  UpdateRule ), and delete an ``IPSet`` from AWS WAF (see
      DeleteIPSet ).
...
class ClientCreateRateBasedRuleResponseRuleMatchPredicatesTypeDef(
    ...
    - **Negated** *(boolean) --*
      ...
      the IP address ``192.0.2.44`` , AWS WAF will allow or block requests based on that IP address.

      Set ``Negated`` to ``True`` if you want AWS WAF to allow or block a request based on the
      negation of the settings in the  ByteMatchSet ,  IPSet ,  SqlInjectionMatchSet ,  XssMatchSet
...
class ClientCreateRateBasedRuleResponseRuleTypeDef(_ClientCreateRateBasedRuleResponseRuleTypeDef):
    ...
    - **MetricName** *(string) --*
      ...
      A friendly name or description for the metrics for a ``RateBasedRule`` . The name can contain
      only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one.
    ...
    - **MatchPredicates** *(list) --*
      ...
      - *(dict) --*
        ...
        Specifies the  ByteMatchSet ,  IPSet ,  SqlInjectionMatchSet ,  XssMatchSet ,  RegexMatchSet
        ,  GeoMatchSet , and  SizeConstraintSet objects that you want to add to a ``Rule`` and, for
        each object, indicates whether you want to negate the settings, for example, requests that
...
class ClientCreateRegexMatchSetResponseRegexMatchSetRegexMatchTuplesFieldToMatchTypeDef(
    ...
    """
    Type definition for `ClientCreateRegexMatchSetResponseRegexMatchSetRegexMatchTuples`
    `FieldToMatch`
...
class ClientCreateRegexMatchSetResponseRegexMatchSetRegexMatchTuplesTypeDef(
    ...
    The regular expression pattern that you want AWS WAF to search for in web requests, the location
    in requests that you want AWS WAF to search, and other settings. Each ``RegexMatchTuple`` object
    contains:

    * The part of a web request that you want AWS WAF to inspect, such as a query string or the
    value of the ``User-Agent`` header.

    * The identifier of the pattern (a regular expression) that you want AWS WAF to look for. For
    ...
    * Whether to perform any conversions on the request, such as converting it to lowercase, before
    ...
    - **TextTransformation** *(string) --*
      ...
      Text transformations eliminate some of the unusual formatting that attackers use in web
      requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the
      transformation on ``RegexPatternSet`` before inspecting a request for a match.

      You can only specify a single type of TextTransformation.

       **CMD_LINE**

      When you're concerned that attackers are injecting an operating system commandline command and
      using unusual formatting to disguise some or all of the command, use this option to perform
...
class ClientCreateRegexPatternSetResponseRegexPatternSetTypeDef(
    ...
    - **RegexPatternSetId** *(string) --*
      ...
      about a ``RegexPatternSet`` , update a ``RegexPatternSet`` , remove a ``RegexPatternSet`` from
      a ``RegexMatchSet`` , and delete a ``RegexPatternSet`` from AWS WAF.
...
class ClientCreateSizeConstraintSetResponseSizeConstraintSetSizeConstraintsFieldToMatchTypeDef(
    ...
    """
    Type definition for `ClientCreateSizeConstraintSetResponseSizeConstraintSetSizeConstraints`
    `FieldToMatch`
...
class ClientCreateSizeConstraintSetResponseSizeConstraintSetSizeConstraintsTypeDef(
    ...
    - **TextTransformation** *(string) --*
      ...
      Text transformations eliminate some of the unusual formatting that attackers use in web
      requests in an effort to bypass AWS WAF. If you specify a transformation, AWS WAF performs the
      transformation on ``FieldToMatch`` before inspecting a request for a match.
    ...
    - **ComparisonOperator** *(string) --*
      ...
      provided ``Size`` and ``FieldToMatch`` to build an expression in the form of "``Size``
      ``ComparisonOperator`` size in bytes of ``FieldToMatch`` ". If that expression is true, the
      ``SizeConstraint`` is considered to match.
...
class ClientCreateSizeConstraintSetResponseSizeConstraintSetTypeDef(
    ...
    - **SizeConstraints** *(list) --*
      ...
      - *(dict) --*
        ...
        "``Size``  ``ComparisonOperator`` size in bytes of ``FieldToMatch`` ". If that expression is
...
class ClientCreateSqlInjectionMatchSetResponseSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatchTypeDef(
    ...
    """
    Type definition for
    `ClientCreateSqlInjectionMatchSetResponseSqlInjectionMatchSetSqlInjectionMatchTuples`
    `FieldToMatch`
...
class ClientCreateSqlInjectionMatchSetResponseSqlInjectionMatchSetSqlInjectionMatchTuplesTypeDef(
    ...
    """
    Type definition for `ClientCreateSqlInjectionMatchSetResponseSqlInjectionMatchSet`
...
class ClientCreateSqlInjectionMatchSetResponseSqlInjectionMatchSetTypeDef(
    ...
    - **SqlInjectionMatchSetId** *(string) --*
      ...
      ``SqlInjectionMatchSet`` (see  UpdateSqlInjectionMatchSet ), insert a ``SqlInjectionMatchSet``
...
class ClientCreateWebAclResponseWebACLRulesActionTypeDef(
    ...
    Specifies the action that CloudFront or AWS WAF takes when a web request matches the conditions
    in the ``Rule`` . Valid values for ``Action`` include the following:
...
class ClientCreateWebAclResponseWebACLRulesExcludedRulesTypeDef(
    ...
    The rule to exclude from a rule group. This is applicable only when the ``ActivatedRule`` refers
    to a ``RuleGroup`` . The rule must belong to the ``RuleGroup`` that is specified by the
    ``ActivatedRule`` .
...
_ClientCreateWebAclResponseWebACLRulesOverrideActionTypeDef = TypedDict(
    "_ClientCreateWebAclResponseWebACLRulesOverrideActionTypeDef", {"Type": str}, total=False
)
...
class ClientCreateWebAclResponseWebACLRulesOverrideActionTypeDef(
    ...
    to ``None`` , the ``RuleGroup`` will block a request if any individual rule in the ``RuleGroup``
    matches the request and is configured to block that request. However if you first want to test
    the ``RuleGroup`` , set the ``OverrideAction`` to ``Count`` . The ``RuleGroup`` will then
    override any block action specified by individual rules contained within the group. Instead of
    blocking matching requests, those requests will be counted. You can view a record of counted
...
class ClientCreateWebAclResponseWebACLRulesTypeDef(_ClientCreateWebAclResponseWebACLRulesTypeDef):
      ...
      * ``COUNT`` : AWS WAF increments a counter of requests that match the conditions in the rule
      ...
      - **Type** *(string) --*
        ...
        * ``COUNT`` : AWS WAF increments a counter of the requests that match all of the conditions
        in the rule. AWS WAF then continues to inspect the web request based on the remaining rules
        in the web ACL. You can't specify ``COUNT`` for the default action for a ``WebACL`` .
    ...
    - **OverrideAction** *(dict) --*
      ...
      ``RuleGroup`` matches the request and is configured to block that request. However if you
      first want to test the ``RuleGroup`` , set the ``OverrideAction`` to ``Count`` . The
      ``RuleGroup`` will then override any block action specified by individual rules contained
      within the group. Instead of blocking matching requests, those requests will be counted. You
    ...
    - **Type** *(string) --*
      ...
      this field is optional, be aware that if you try to add a RATE_BASED rule to a web ACL without
      setting the type, the  UpdateWebACL request will fail because the request tries to add a
    ...
    - **ExcludedRules** *(list) --*
      ...
      rule group that is blocking the legitimate traffic and then disable (exclude) that particular
      rule. You can exclude rules from both your own rule groups and AWS Marketplace rule groups
          ...
          - **Action** *(dict) --*
            ...
            * ``COUNT`` : AWS WAF increments a counter of requests that match the conditions in the
            ...
            web ACL.
             ...
             ``ActivatedRule
             |OverrideAction`` applies only when updating or adding a ``RuleGroup``
...
_ClientGetChangeTokenStatusResponseTypeDef = TypedDict(
    "_ClientGetChangeTokenStatusResponseTypeDef", {"ChangeTokenStatus": str}, total=False
)
...
class ClientGetGeoMatchSetResponseGeoMatchSetTypeDef(
    ...
    includes the ``Type`` , which for a ``GeoMatchContraint`` is always ``Country`` , as well as the
    ``Value`` , which is the identifier for a specific country.
...
_ClientGetIpSetResponseIPSetIPSetDescriptorsTypeDef = TypedDict(
    "_ClientGetIpSetResponseIPSetIPSetDescriptorsTypeDef", {"Type": str, "Value": str}, total=False
)
...
class ClientGetRegexPatternSetResponseRegexPatternSetTypeDef(
    ...
    including the identifier of the pattern set and the regular expression patterns you want AWS WAF
    to search for.
...
class ClientGetSampledRequestsResponseSampledRequestsRequestTypeDef(
    ...
    - **Country** *(string) --*
      ...
      The two-letter country code for the country that the request originated from. For a current
      list of country codes, see the Wikipedia entry `ISO 3166-1 alpha-2
    ...
    - **Headers** *(list) --*
      ...
      A complex type that contains two values for each header in the sampled web request: the name
      of the header and the value of the header.

      - *(dict) --*

        The response from a  GetSampledRequests request includes an ``HTTPHeader`` complex type that
        appears as ``Headers`` in the response syntax. ``HTTPHeader`` contains the names and values
        of all of the headers that appear in one of the web requests that were returned by
        ``GetSampledRequests`` .
...
class ClientGetSampledRequestsResponseSampledRequestsTypeDef(
    ...
    The response from a  GetSampledRequests request includes a ``SampledHTTPRequests`` complex type
    that appears as ``SampledRequests`` in the response syntax. ``SampledHTTPRequests`` contains one
    ...
    - **Request** *(dict) --*
      ...
      - **Headers** *(list) --*
        ...
        - *(dict) --*
          ...
          The response from a  GetSampledRequests request includes an ``HTTPHeader`` complex type
          that appears as ``Headers`` in the response syntax. ``HTTPHeader`` contains the names and
          values of all of the headers that appear in one of the web requests that were returned by
          ``GetSampledRequests`` .
    ...
    - **Weight** *(integer) --*
      ...
      A value that indicates how one result in the response relates proportionally to other results
      in the response. A result that has a weight of ``2`` represents roughly twice as many
...
_ClientGetSampledRequestsTimeWindowTypeDef = TypedDict(
    "_ClientGetSampledRequestsTimeWindowTypeDef", {"StartTime": datetime, "EndTime": datetime}
)


class ClientGetSampledRequestsTimeWindowTypeDef(_ClientGetSampledRequestsTimeWindowTypeDef):
    """
...
class ClientGetSizeConstraintSetResponseSizeConstraintSetSizeConstraintsFieldToMatchTypeDef(
    ...
    """
    Type definition for `ClientGetSizeConstraintSetResponseSizeConstraintSetSizeConstraints`
    `FieldToMatch`
...
class ClientGetSqlInjectionMatchSetResponseSqlInjectionMatchSetSqlInjectionMatchTuplesFieldToMatchTypeDef(
    ...
    """
    Type definition for
    `ClientGetSqlInjectionMatchSetResponseSqlInjectionMatchSetSqlInjectionMatchTuples`
    `FieldToMatch`
...
class ClientGetSqlInjectionMatchSetResponseSqlInjectionMatchSetSqlInjectionMatchTuplesTypeDef(
    ...
    """
    Type definition for `ClientGetSqlInjectionMatchSetResponseSqlInjectionMatchSet`
    `SqlInjectionMatchTuples`
...
_ClientGetWebAclResponseWebACLRulesOverrideActionTypeDef = TypedDict(
    "_ClientGetWebAclResponseWebACLRulesOverrideActionTypeDef", {"Type": str}, total=False
)
...
class ClientListLoggingConfigurationsResponseLoggingConfigurationsRedactedFieldsTypeDef(
    ...
    """
    Type definition for `ClientListLoggingConfigurationsResponseLoggingConfigurations`
    `RedactedFields`
...
class ClientListRateBasedRulesResponseRulesTypeDef(_ClientListRateBasedRulesResponseRulesTypeDef):
    ...
    - **RuleId** *(string) --*
      ...
      A unique identifier for a ``Rule`` . You use ``RuleId`` to get more information about a
      ``Rule`` (see  GetRule ), update a ``Rule`` (see  UpdateRule ), insert a ``Rule`` into a
      ``WebACL`` or delete one from a ``WebACL`` (see  UpdateWebACL ), or delete a ``Rule`` from AWS
      WAF (see  DeleteRule ).
...
class ClientListRegexPatternSetsResponseRegexPatternSetsTypeDef(
    ...
    Returned by  ListRegexPatternSets . Each ``RegexPatternSetSummary`` object includes the ``Name``
    and ``RegexPatternSetId`` for one  RegexPatternSet .
...
_RequiredClientPutLoggingConfigurationLoggingConfigurationRedactedFieldsTypeDef = TypedDict(
    "_RequiredClientPutLoggingConfigurationLoggingConfigurationRedactedFieldsTypeDef", {"Type": str}
)
...
_RequiredClientUpdateByteMatchSetUpdatesByteMatchTupleFieldToMatchTypeDef = TypedDict(
    "_RequiredClientUpdateByteMatchSetUpdatesByteMatchTupleFieldToMatchTypeDef", {"Type": str}
)
...
class ClientUpdateByteMatchSetUpdatesByteMatchTupleTypeDef(
    ...
    Information about the part of a web request that you want AWS WAF to inspect and the value that
    you want AWS WAF to search for. If you specify ``DELETE`` for the value of ``Action`` , the
...
_ClientUpdateByteMatchSetUpdatesTypeDef = TypedDict(
    ...
    {"Action": str, "ByteMatchTuple": ClientUpdateByteMatchSetUpdatesByteMatchTupleTypeDef},
)
...
_ClientUpdateGeoMatchSetUpdatesGeoMatchConstraintTypeDef = TypedDict(
    "_ClientUpdateGeoMatchSetUpdatesGeoMatchConstraintTypeDef", {"Type": str, "Value": str}
)
...
_ClientUpdateGeoMatchSetUpdatesTypeDef = TypedDict(
    ...
    {"Action": str, "GeoMatchConstraint": ClientUpdateGeoMatchSetUpdatesGeoMatchConstraintTypeDef},
)
...
_RequiredClientUpdateRegexMatchSetUpdatesRegexMatchTupleFieldToMatchTypeDef = TypedDict(
    "_RequiredClientUpdateRegexMatchSetUpdatesRegexMatchTupleFieldToMatchTypeDef", {"Type": str}
)
...
class ClientUpdateRegexMatchSetUpdatesRegexMatchTupleTypeDef(
    ...
    Information about the part of a web request that you want AWS WAF to inspect and the identifier
    of the regular expression (regex) pattern that you want AWS WAF to search for. If you specify
    ``DELETE`` for the value of ``Action`` , the ``RegexMatchTuple`` values must exactly match the
    values in the ``RegexMatchTuple`` that you want to delete from the ``RegexMatchSet`` .
...
_ClientUpdateRegexMatchSetUpdatesTypeDef = TypedDict(
    ...
    {"Action": str, "RegexMatchTuple": ClientUpdateRegexMatchSetUpdatesRegexMatchTupleTypeDef},
)
...
_ClientUpdateRegexPatternSetUpdatesTypeDef = TypedDict(
    "_ClientUpdateRegexPatternSetUpdatesTypeDef", {"Action": str, "RegexPatternString": str}
)


class ClientUpdateRegexPatternSetUpdatesTypeDef(_ClientUpdateRegexPatternSetUpdatesTypeDef):
    """
...
_RequiredClientUpdateRuleGroupUpdatesActivatedRuleTypeDef = TypedDict(
    "_RequiredClientUpdateRuleGroupUpdatesActivatedRuleTypeDef", {"Priority": int, "RuleId": str}
)
      ...
      - **Action** *(dict) --*
        ...
        * ``COUNT`` : AWS WAF increments a counter of requests that match the conditions in the rule
        and then continues to inspect the web request based on the remaining rules in the web ACL.
         ...
         ``ActivatedRule
         |OverrideAction`` applies only when updating or adding a ``RuleGroup`` to a
         ``WebACL`` . In this case, you do not use ``ActivatedRule
         |Action`` . For all other update
...
_ClientUpdateRuleUpdatesPredicateTypeDef = TypedDict(
    "_ClientUpdateRuleUpdatesPredicateTypeDef", {"Negated": bool, "Type": str, "DataId": str}
)
...
_RequiredClientUpdateSizeConstraintSetUpdatesSizeConstraintFieldToMatchTypeDef = TypedDict(
    "_RequiredClientUpdateSizeConstraintSetUpdatesSizeConstraintFieldToMatchTypeDef", {"Type": str}
)
...
_ClientUpdateSizeConstraintSetUpdatesTypeDef = TypedDict(
    ...
    {"Action": str, "SizeConstraint": ClientUpdateSizeConstraintSetUpdatesSizeConstraintTypeDef},
)


class ClientUpdateSizeConstraintSetUpdatesTypeDef(_ClientUpdateSizeConstraintSetUpdatesTypeDef):
    """
...
class ClientUpdateSqlInjectionMatchSetUpdatesSqlInjectionMatchTupleFieldToMatchTypeDef(
    ...
    """
    Type definition for `ClientUpdateSqlInjectionMatchSetUpdatesSqlInjectionMatchTuple`
    `FieldToMatch`
...
_RequiredClientUpdateWebAclUpdatesActivatedRuleTypeDef = TypedDict(
    "_RequiredClientUpdateWebAclUpdatesActivatedRuleTypeDef", {"Priority": int, "RuleId": str}
)
...
_RequiredClientUpdateXssMatchSetUpdatesXssMatchTupleFieldToMatchTypeDef = TypedDict(
    "_RequiredClientUpdateXssMatchSetUpdatesXssMatchTupleFieldToMatchTypeDef", {"Type": str}
)
...
_ClientUpdateXssMatchSetUpdatesTypeDef = TypedDict(
    ...
    {"Action": str, "XssMatchTuple": ClientUpdateXssMatchSetUpdatesXssMatchTupleTypeDef},
)
...
class ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesExcludedRulesTypeDef(
    ...
    """
    Type definition for `ListActivatedRulesInRuleGroupPaginateResponseActivatedRules`
    `ExcludedRules`
...
_ListActivatedRulesInRuleGroupPaginateResponseTypeDef = TypedDict(
    ...
    {
        "ActivatedRules": List[ListActivatedRulesInRuleGroupPaginateResponseActivatedRulesTypeDef],
        "NextToken": str,
    },
    total=False,
)
...
class ListByteMatchSetsPaginateResponseTypeDef(_ListByteMatchSetsPaginateResponseTypeDef):
    """
...
_ListGeoMatchSetsPaginateResponseTypeDef = TypedDict(
    ...
    {"GeoMatchSets": List[ListGeoMatchSetsPaginateResponseGeoMatchSetsTypeDef], "NextToken": str},
    total=False,
)
...
_ListIPSetsPaginateResponseIPSetsTypeDef = TypedDict(
    "_ListIPSetsPaginateResponseIPSetsTypeDef", {"IPSetId": str, "Name": str}, total=False
)
...
class ListLoggingConfigurationsPaginateResponseLoggingConfigurationsRedactedFieldsTypeDef(
    ...
    """
    Type definition for `ListLoggingConfigurationsPaginateResponseLoggingConfigurations`
    `RedactedFields`
...
_ListRateBasedRulesPaginateResponseRulesTypeDef = TypedDict(
    "_ListRateBasedRulesPaginateResponseRulesTypeDef", {"RuleId": str, "Name": str}, total=False
)
...
class ListRateBasedRulesPaginateResponseTypeDef(_ListRateBasedRulesPaginateResponseTypeDef):
    """
...
class ListRegexMatchSetsPaginateResponseTypeDef(_ListRegexMatchSetsPaginateResponseTypeDef):
    """
...
_ListRegexPatternSetsPaginateResponseTypeDef = TypedDict(
    ...
    {
        "RegexPatternSets": List[ListRegexPatternSetsPaginateResponseRegexPatternSetsTypeDef],
        "NextToken": str,
    },
    total=False,
)
...
class ListRegexPatternSetsPaginateResponseTypeDef(_ListRegexPatternSetsPaginateResponseTypeDef):
    """
...
class ListRuleGroupsPaginatePaginationConfigTypeDef(_ListRuleGroupsPaginatePaginationConfigTypeDef):
    """
...
_ListRuleGroupsPaginateResponseTypeDef = TypedDict(
    ...
    {"RuleGroups": List[ListRuleGroupsPaginateResponseRuleGroupsTypeDef], "NextToken": str},
    total=False,
)
...
_ListSizeConstraintSetsPaginateResponseTypeDef = TypedDict(
    ...
    {
        "SizeConstraintSets": List[ListSizeConstraintSetsPaginateResponseSizeConstraintSetsTypeDef],
        "NextToken": str,
    },
    total=False,
)
...
class ListSizeConstraintSetsPaginateResponseTypeDef(_ListSizeConstraintSetsPaginateResponseTypeDef):
    """
...
class ListWebACLsPaginatePaginationConfigTypeDef(_ListWebACLsPaginatePaginationConfigTypeDef):
    """
...
_ListWebACLsPaginateResponseWebACLsTypeDef = TypedDict(
    "_ListWebACLsPaginateResponseWebACLsTypeDef", {"WebACLId": str, "Name": str}, total=False
)


class ListWebACLsPaginateResponseWebACLsTypeDef(_ListWebACLsPaginateResponseWebACLsTypeDef):
    """
...
_ListXssMatchSetsPaginateResponseTypeDef = TypedDict(
    ...
    {"XssMatchSets": List[ListXssMatchSetsPaginateResponseXssMatchSetsTypeDef], "NextToken": str},
    total=False,
)
