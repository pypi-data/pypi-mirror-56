...
Data.prototype.load = function() {
  get(config.data.dir + '/' + config.data.file, function(json) {
    ...
    this.layout = this.layout ? this.layout : Object.keys(this.layouts)[0];
    ...
    get(this.layouts[this.layout].positions, function(json) {
      this.addCells(json)
    }.bind(this))
  }.bind(this))
}
...
Layout.prototype.transition = function(layoutKey) {
  ...
  console.log(' * transition - rafactor')
  return;
...
World.prototype.plot = function() {
  // find the draw call of each cell
  var drawCallToCells = {};
  for (var i=0; i<data.cells.length; i++) {
