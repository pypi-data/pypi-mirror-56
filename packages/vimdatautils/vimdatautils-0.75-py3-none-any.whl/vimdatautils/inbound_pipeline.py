...
class InboundPipeline(ABC):
    ...
    def __init__(self, config_obj, postgres_connection_string):
    ...
    def execute(self):
        ...
        try:
            ...
            self.pre_load_logic()
            self.load_data(self.config.local_dir, self.config.tables_to_load, self.config.scripts_location, self.sync_date)
        ...
        for table_config in tables_config:
            ...
            if os.path.isfile(full_path_file):
                if table_config.ddl_script:
                    ...
                    self.table_stats[table_config] = {'row_count': row_count, 'file_name': table_config.file_name}
