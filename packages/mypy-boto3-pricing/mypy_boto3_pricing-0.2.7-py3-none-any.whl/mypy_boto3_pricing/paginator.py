"Main interface for pricing Paginators"
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param ServiceCode:
          ...
          use the ``ServiceCode`` to filter the results in a ``GetProducts`` call. To retrieve a list of all
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Field** *(string) --* **[REQUIRED]**
              ...
              The product metadata field that you want to filter on. You can filter by just the service code
              to see all products for a specific service, filter by just the attribute name to see a
            ...
            - **Value** *(string) --* **[REQUIRED]**
              ...
              attribute name, this is the attribute value that you want the returned products to match, such
              as a ``Provisioned IOPS`` volume.
