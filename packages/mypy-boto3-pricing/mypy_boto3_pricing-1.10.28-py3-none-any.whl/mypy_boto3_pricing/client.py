...
class Client(BaseClient):
    ...
    def describe_services(
        ...
        available for EC2 are ``volumeType`` , ``maxIopsVolume`` , ``operation`` , ``locationType``
        ...
        **Request Syntax**
        ...
        :param ServiceCode:
          ...
          You can use the ``ServiceCode`` to filter the results in a ``GetProducts`` call. To
    ...
    def get_attribute_values(
        ...
        """
        Returns a list of attribute values. Attibutes are similar to the details in a Price List API
        offer file. For a list of available attributes, see `Offer File Definitions
        <http://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/reading-an-offer.html#pps-defs>`__
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Field** *(string) --* **[REQUIRED]**
              ...
              name to see a specific attribute for multiple services, or use both a service code and
              an attribute name to retrieve only products that match both fields.
            ...
            - **Value** *(string) --* **[REQUIRED]**
              ...
              by service code this is the actual service code, such as ``AmazonEC2`` . If you are
