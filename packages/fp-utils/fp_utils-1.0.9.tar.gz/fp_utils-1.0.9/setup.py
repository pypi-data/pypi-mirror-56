...
setup(
    name = 'fp_utils',
    packages = ['fp_utils', 'fp_utils.big_query', 'fp_utils.mongo', 'fp_utils.google'],
    version = '1.0.9',  # 
    ...
    download_url = 'https://github.com/fifth-partners/fp-utils/archive/1.0.9.tar.gz',
