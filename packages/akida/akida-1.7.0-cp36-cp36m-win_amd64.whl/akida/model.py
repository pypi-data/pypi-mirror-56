...
class Model(ModelBase):
    ...
    def forward(self, input, do_learning, input_labels=None):
        ...
        Args:
            input (:obj:`Sparse`,`numpy.ndarray`): a Sparse object of shape
                ...
                shape (n, h, w, c) containing the n images.
                (grayscale (c=1) or RGB (c=3))
            do_learning (bool): a flag indicating if the model can learn
    ...
    def summary(self):
        ...
        This method prints a summary of the model with details of every layer
        (type, shape, learning type, ...).
