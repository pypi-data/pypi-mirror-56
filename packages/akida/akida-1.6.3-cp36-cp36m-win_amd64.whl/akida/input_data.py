...
class InputData(Layer):
    ...
    This is the general purpose input layer. It takes events in a simple
    address-event data format; that is, each event is characterized by a trio of
    values giving x, y and feature values. The InputData layer can simply pass
    them to the rest of the model for processing or group the generated events
    into packets (packetizing option).
    ...
    def __init__(self, name, input_width, input_height, input_features,
                 packet_size=0, accumulate=False,
        ...
        :param input_features: size of the third input dimension
        :param packet_size: optional, size of a packet
        :param accumulate: optional, defines if the layer maintains its
        ...
        fill_input_data_params(params, input_width=input_width,
