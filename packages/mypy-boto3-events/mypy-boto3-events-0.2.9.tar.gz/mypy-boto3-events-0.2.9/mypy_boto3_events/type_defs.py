...
class ClientListEventSourcesResponseEventSourcesTypeDef(
    ...
    that matches this event source, that AWS account can receive events from the partner's
...
_ClientListPartnerEventSourceAccountsResponsePartnerEventSourceAccountsTypeDef = TypedDict(
    ...
    {"Account": str, "CreationTime": datetime, "ExpirationTime": datetime, "State": str},
    total=False,
)
...
class ClientListTargetsByRuleResponseTargetsBatchParametersRetryStrategyTypeDef(
    ...
    The retry strategy to use for failed jobs if the target is an AWS Batch job. The retry strategy
    is the number of times to retry the failed job execution. Valid values are 1–10. When you
    specify a retry strategy here, it overrides the retry strategy defined in the job definition.
...
class ClientListTargetsByRuleResponseTargetsBatchParametersTypeDef(
    ...
    <https://docs.aws.amazon.com/batch/latest/userguide/jobs.html>`__ in the *AWS Batch User Guide*
    .
...
class ClientListTargetsByRuleResponseTargetsEcsParametersNetworkConfigurationawsvpcConfigurationTypeDef(
    ...
    """
    Type definition for `ClientListTargetsByRuleResponseTargetsEcsParametersNetworkConfiguration`
    `awsvpcConfiguration`
    ...
    - **SecurityGroups** *(list) --*
      ...
      the same VPC. You can specify as many as five security groups. If you don't specify a security
...
class ClientListTargetsByRuleResponseTargetsEcsParametersNetworkConfigurationTypeDef(
    ...
    Use this structure if the ECS task uses the ``awsvpc`` network mode. This structure specifies
    the VPC subnets and security groups associated with the task and whether a public IP address is
    to be used. This structure is required if ``LaunchType`` is ``FARGATE`` because the ``awsvpc``
    ...
    - **awsvpcConfiguration** *(dict) --*
      ...
      - **SecurityGroups** *(list) --*
        ...
        Specifies the security groups associated with the task. These security groups must all be in
        the same VPC. You can specify as many as five security groups. If you don't specify a
...
class ClientListTargetsByRuleResponseTargetsEcsParametersTypeDef(
    ...
    *Amazon EC2 Container Service Developer Guide* .
    ...
    - **LaunchType** *(string) --*
      ...
      must match one of the launch type (compatibilities) of the target task. The ``FARGATE`` value
      is supported only in the Regions where AWS Fargate with Amazon ECS is supported. For more
      information, see `AWS Fargate on Amazon ECS
    ...
    - **NetworkConfiguration** *(dict) --*
      ...
      Use this structure if the ECS task uses the ``awsvpc`` network mode. This structure specifies
      the VPC subnets and security groups associated with the task and whether a public IP address
      ...
      - **awsvpcConfiguration** *(dict) --*
        ...
        - **SecurityGroups** *(list) --*
          ...
          in the same VPC. You can specify as many as five security groups. If you don't specify a
          security group, the default security group for the VPC is used.
    ...
    - **PlatformVersion** *(string) --*
      ...
      <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/platform_versions.html>`__ in the
      *Amazon Elastic Container Service Developer Guide* .
...
class ClientListTargetsByRuleResponseTargetsInputTransformerTypeDef(
    ...
    - **InputTemplate** *(string) --*
      ...
      from ``InputPathsMap`` to customize the data sent to the target. Enclose each
...
class ClientListTargetsByRuleResponseTargetsKinesisParametersTypeDef(
    ...
    Kinesis data stream. If you don't include this parameter, the default is to use the ``eventId``
...
class ClientListTargetsByRuleResponseTargetsRunCommandParametersRunCommandTargetsTypeDef(
    ...
    """
    Type definition for `ClientListTargetsByRuleResponseTargetsRunCommandParameters`
    `RunCommandTargets`

    Information about the EC2 instances that are to be sent the command, specified as key-value
    pairs. Each ``RunCommandTarget`` block can include only one key, but this key can specify
    multiple values.
...
_ClientPutRuleTagsTypeDef = TypedDict("_ClientPutRuleTagsTypeDef", {"Key": str, "Value": str})
...
_RequiredClientPutTargetsTargetsBatchParametersTypeDef = TypedDict(
    "_RequiredClientPutTargetsTargetsBatchParametersTypeDef", {"JobDefinition": str, "JobName": str}
)
...
class ClientPutTargetsTargetsEcsParametersNetworkConfigurationawsvpcConfigurationTypeDef(
    ...
    """
    Type definition for `ClientPutTargetsTargetsEcsParametersNetworkConfiguration`
    `awsvpcConfiguration`
...
class ListTargetsByRulePaginateResponseTargetsEcsParametersNetworkConfigurationawsvpcConfigurationTypeDef(
    ...
    """
    Type definition for `ListTargetsByRulePaginateResponseTargetsEcsParametersNetworkConfiguration`
    `awsvpcConfiguration`
...
class ListTargetsByRulePaginateResponseTargetsEcsParametersNetworkConfigurationTypeDef(
    ...
    """
    Type definition for `ListTargetsByRulePaginateResponseTargetsEcsParameters`
...
class ListTargetsByRulePaginateResponseTargetsRunCommandParametersRunCommandTargetsTypeDef(
    ...
    """
    Type definition for `ListTargetsByRulePaginateResponseTargetsRunCommandParameters`
    `RunCommandTargets`
