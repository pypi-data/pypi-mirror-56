...
trained_model_metainfo_list = (
    ...
    ('resnext50_32x4d', 'ResNeXt-50 (32x4d)', '1611.05431', 224, 0.875, 200, 'pytorch, from [dmlc/gluon-cv]'),
    ('resnext101_32x4d', 'ResNeXt-101 (32x4d)', '1611.05431', 224, 0.875, 200, 'pytorch, from [dmlc/gluon-cv]'),
    ('resnext101_64x4d', 'ResNeXt-101 (64x4d)', '1611.05431', 224, 0.875, 200, 'pytorch, from [dmlc/gluon-cv]'),
    ...
    ('seresnext50_32x4d', 'SE-ResNeXt-50 (32x4d)', '1709.01507', 224, 0.875, 200, 'pytorch, from [dmlc/gluon-cv]'),
    ('seresnext101_32x4d', 'SE-ResNeXt-101 (32x4d)', '1709.01507', 224, 0.875, 200, 'pytorch, from [dmlc/gluon-cv]'),
    ('seresnext101_64x4d', 'SE-ResNeXt-101 (64x4d)', '1709.01507', 224, 0.875, 200, 'pytorch, from [dmlc/gluon-cv]'),
    ...
    ('mnasnet_b1', 'MnasNet-B1', '1807.11626', 224, 0.875, 200, 'pytorch, from [rwightman/pyt...models]'),
    ('mnasnet_a1', 'MnasNet-A1', '1807.11626', 224, 0.875, 200, 'pytorch, from [rwightman/pyt...models]'),
