    ...
    def generate_data_set(
        ...
        **Request Syntax**
        ::
          ...
          response = client.generate_data_set(
              dataSetType=
                  ...
                  |'disbursed_amount_by_product_with_uncollected_funds'|'disbursed_amount_by_instance_hours'
                  |'disbursed_amount_by_customer_geo'|'disbursed_amount_by_age_of_uncollected_funds'
        ...
        :param dataSetType: **[REQUIRED]**
          ...
          * daily_business_canceled_product_subscribers From 2015-01-26 to present: Available daily by 24:00
          UTC.
          ...
          * disbursed_amount_by_age_of_uncollected_funds From 2015-01-26 to present: Available every 30 days
          by 24:00 UTC.

          * disbursed_amount_by_age_of_disbursed_funds From 2015-01-26 to present: Available every 30 days
          by 24:00 UTC.

          * disbursed_amount_by_age_of_past_due_funds From 2018-04-07 to present: Available every 30 days by
          24:00 UTC.
        ...
        sets, provide a date with day-level granularity for the desired day. For weekly data sets, provide a
        date with day-level granularity within the desired week (the day value will be ignored). For monthly
        data sets, provide a date with month-level granularity for the desired month (the day value will be
        ignored).
        ...
        Amazon SNS notification message and the data set metadata file. These key-value pairs can be used to
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Container for the result of the GenerateDataSet operation.
            ...
            GenerateDataSet operation. This identifier can be used to correlate a request with notifications
            from the SNS topic.
        """
