...
class Dashboard:
    ...
    def map(self):
        ...
        """
        results = []
        for d in YuleakClient.get_request('map/{0}'.format(self.id)):
    ...
    def graph(self):
        ...
        """
        results = {}
        data = YuleakClient.get_request('graph/{0}'.format(self.id))
        if len(data) == 0:
            return []
        # Nodes
    ...
    def timeline(self):
        ...
        """
        results = []
        for d in YuleakClient.get_request('timeline/{0}'.format(self.id)):
    ...
    def details(self):
        ...
        """
        results = []
        for d in YuleakClient.get_request('details/{0}'.format(self.id)):
    ...
    def resources(self):
        ...
        """
        results = []
        for d in YuleakClient.get_request('resources/{0}'.format(self.id)):
    ...
    def filters(self):
        ...
        """
        results = []
        for d in YuleakClient.get_request('filters/{0}'.format(self.id)):
    ...
    def add_filter(self, category, value, type_='required'):
        ...
        """
        return YuleakClient.post_request('filters/{0}'.format(self.id),
    ...
    def search(self, search):
        ...
        """
        return YuleakClient.post_request('search', data={'value': search, 'dashboard': self.id})
    ...
    def delete(self):
        ...
        """
        return YuleakClient.delete_request('delete/{0}'.format(self.id))
