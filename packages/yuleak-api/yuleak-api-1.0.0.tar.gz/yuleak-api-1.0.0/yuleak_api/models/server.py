...
class Server:
    ...
    def add_bookmark(self):
        ...
        if YuleakClient.post_request('bookmark/{0}/{1}'.format(self.dashboard.id, self.id)):
            self.bookmark = True
    ...
    def del_bookmark(self):
        ...
        if YuleakClient.delete_request('bookmark/{0}/{1}'.format(self.dashboard.id, self.id)):
            self.bookmark = False
            return True
        else:
            return False
