...
class Resource:
    ...
    def renew(self):
        ...
        """
        return YuleakClient.post_request('renew/{0}'.format(self.dashboard.id), data={'value': self.value})
    ...
    def delete(self):
        ...
        Returns:
            (bool) True if the search has been launched
        """
        return YuleakClient.delete_request('resources/{0}'.format(self.dashboard.id), params={'value': self.value})
