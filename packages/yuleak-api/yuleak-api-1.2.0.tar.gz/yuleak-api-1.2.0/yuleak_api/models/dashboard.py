...
class Dashboard:
    ...
    def search(self, search):
        ...
        """
        return YuleakClient.post_request('dashboard/{0}/search', data={'value': search})
    ...
    def list_new_servers(self):
        ...
        Returns:
            list of ip (string)
        """
        return YuleakClient.post_request('dashboard/{0}/searchall')
    ...
    def delete(self):
        ...
        """
        return YuleakClient.delete_request('dashboard/{0}/delete'.format(self.id))
