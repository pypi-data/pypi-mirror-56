...
class YesWeHack(YwhApiObject):
    ...
    def __init__(self, verify=False, headers={}, totp_code=None, **kwargs):
        logging.basicConfig()
...
class Log(YwhApiObject):
    ...
    def __init__(self, ywh_api, lazy=False, **kwargs):
        ...
        kwargs["old_cvss"] = CVSS(**kwargs["old_cvss"])
        kwargs["new_cvss"] = CVSS(**kwargs["new_cvss"])
...
class Report(YwhApiObject):
    ...
    _attrs = [
        ...
        Attr(name="duplicate_of", type_=str),
        ...
        Attr(name="priority", type_=dict, default={}),
    ...
    def post_comment(self, comment, private=False):
        self.ywh_api.post_comment(self.id, comment, private)
