...
class Client(BaseClient):
    ...
    def authorize_cluster_security_group_ingress(
        ...
        the application accessing your cluster is running on the Internet or an Amazon EC2 instance,
        you can authorize inbound access to either a Classless Interdomain Routing (CIDR)/Internet
        Protocol (IP) range or to an Amazon EC2 security group. You can add as many as 20 ingress
        ...
        *EC2SecurityGroupOwnerId* . The Amazon EC2 security group and Amazon Redshift cluster must
        ...
        If you authorize access to a CIDR/IP address range, specify *CIDRIP* . For an overview of
        CIDR blocks, see the Wikipedia article on `Classless Inter-Domain Routing
        ...
        about managing security groups, go to `Working with Security Groups
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-security-groups.html>`__ in
    ...
    def authorize_snapshot_access(
        ...
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-snapshots.html>`__ in the
        ...
        **Request Syntax**
        ...
        :param SnapshotClusterIdentifier:
          ...
          The identifier of the cluster the snapshot was created from. This parameter is required if
          your IAM user has a policy containing a snapshot resource element that specifies anything
          ...
          - *(dict) --*
            ...
            - **Snapshot** *(dict) --*
              ...
              - **ElapsedTimeInSeconds** *(integer) --*
                ...
                The amount of time an in-progress snapshot backup has been running, or the amount of
                time it took a completed backup to finish.
              ...
              - **EnhancedVpcRouting** *(boolean) --*
                ...
                enabled. To create a cluster that uses enhanced VPC routing, the cluster must be in
                a VPC. For more information, see `Enhanced VPC Routing
                <https://docs.aws.amazon.com/redshift/latest/mgmt/enhanced-vpc-routing.html>`__ in
                the Amazon Redshift Cluster Management Guide.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ProgressInMegaBytes** *(integer) --*
              ...
              complete, this value shows the total amount of data, in megabytes, on the cluster,
              which may be more or less than TotalResizeDataInMegaBytes (the estimated total amount
            ...
            - **EstimatedTimeToCompletionInSeconds** *(integer) --*
              ...
              remaining to be processed. Once the resize operation is complete, this value will be
              0.
    ...
    def copy_cluster_snapshot(
        ...
        Also, when the retention period of the snapshot expires, Amazon Redshift automatically
        deletes it. If you want to keep an automated snapshot for a longer period, you can make a
        manual copy of the snapshot. Manual snapshots are retained until you delete them.
    ...
    def create_cluster(
        ...
        when creating the cluster. For more information about managing clusters, go to `Amazon
        Redshift Clusters
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html>`__ in the
        *Amazon Redshift Cluster Management Guide* .
        ...
        **Request Syntax**
        ...
        :param DBName:
          ...
          SQL client and use SQL commands to create a database. For more information, go to `Create
          a Database <https://docs.aws.amazon.com/redshift/latest/dg/t_creating_database.html>`__ in
          ...
          * Cannot be a word that is reserved by the service. A list of reserved words can be found
          in `Reserved Words <https://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html>`__
        ...
        :param NodeType: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html#how-many-nodes>`__
        ...
        :param MasterUsername: **[REQUIRED]**
          ...
          * Cannot be a reserved word. A list of reserved words can be found in `Reserved Words
          <https://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html>`__ in the Amazon
        ...
        :param AvailabilityZone:
          ...
          For example, if you have several EC2 instances running in a specific Availability Zone,
          then you might want the cluster to be provisioned in the same zone in order to decrease
          network latency.
        ...
        :param PreferredMaintenanceWindow:
          ...
          region, see `Maintenance Windows
        ...
        :param ElasticIp:
          ...
          Internet gateway. For more information about provisioning clusters in EC2-VPC, go to
        ...
        :param IamRoles:
          ...
          to access other AWS services. You must supply the IAM roles in their Amazon Resource Name
          (ARN) format. You can supply up to 10 IAM roles in a single request.
    ...
    def create_cluster_parameter_group(
        ...
        with a parameter group when you create the cluster. You can also associate an existing
        cluster with a parameter group after the cluster is created by using  ModifyCluster .
        ...
        **Request Syntax**
        ...
        :param ParameterGroupFamily: **[REQUIRED]**
          ...
          parameter groups that are owned by your AWS account, including the default parameter
    ...
    def create_cluster_snapshot(
        ...
        **Request Syntax**
        ...
        :param SnapshotIdentifier: **[REQUIRED]**
          ...
          unique for all snapshots within the AWS account.
    ...
    def create_cluster_subnet_group(
        ...
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-cluster-subnet-groups.html>`__
        in the *Amazon Redshift Cluster Management Guide* .
    ...
    def create_event_subscription(
        ...
        the Amazon SNS console, or the Amazon SNS API. To obtain an ARN with Amazon SNS, you must
        create a topic in Amazon SNS and subscribe to the topic. The ARN is displayed in the SNS
        console.
        ...
        will only send notifications for those ERROR events in the Availability and Backup
        ...
        receive notice of the events for the objects of that type in your AWS account. If you do not
        specify either the SourceType nor the SourceIdentifier, you will be notified of events
        generated from all Amazon Redshift sources belonging to your AWS account. You must specify a
            ...
            - **EventSubscription** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                * The status "no-permission" indicates that Amazon Redshift no longer has permission
                to post to the Amazon SNS topic. The status "topic-not-exist" indicates that the
    ...
    def create_hsm_client_certificate(
        ...
        The command returns a public key, which you must store in the HSM. In addition to creating
        the HSM certificate, you must create an Amazon Redshift HSM configuration that provides a
        cluster the information needed to store and use encryption keys in the HSM. For more
        information, go to `Hardware Security Modules
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-HSM.html>`__ in the Amazon
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **HsmClientCertificate** *(dict) --*
              ...
              secure Hardware Storage Module (HSM), and used by the Amazon Redshift cluster to
              encrypt data files.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **HsmConfiguration** *(dict) --*
              ...
              Amazon Redshift clusters the information they require to connect to an HSM where they
              can store database encryption keys.
    ...
    def create_scheduled_action(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/CreateScheduledAction>`_
        ...
        **Request Syntax**
        ...
        :param StartTime:
          ...
          The start time in UTC of the scheduled action. Before this time, the scheduled action does
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IamRole** *(string) --*
              ...
              assume permissions on your behalf. For more information about the IAM role to use with
              the Amazon Redshift scheduler, see `Using Identity-Based Policies for Amazon Redshift
    ...
    def create_snapshot_copy_grant(
        ...
        (CMK) from AWS Key Management Service (AWS KMS) to encrypt copied snapshots in a destination
        region.
        ...
        **Request Syntax**
        ...
        :param SnapshotCopyGrantName: **[REQUIRED]**
          ...
          The name of the snapshot copy grant. This name must be unique in the region for the AWS
          account.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **SnapshotCopyGrant** *(dict) --*
              ...
              Database Encryption
              <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-db-encryption.html>`__
              in the *Amazon Redshift Cluster Management Guide* .
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Describes a snapshot schedule. You can set a regular interval for creating snapshots of
            a cluster. You can also schedule snapshots for specific dates.
    ...
    def create_tags(self, ResourceName: str, Tags: List[ClientCreateTagsTagsTypeDef]) -> None:
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          Separate multiple tags with a space. For example, ``--tags "Key"="owner","Value"="admin"
    ...
    def delete_cluster(
        ...
        indicates that the request was received correctly. Use  DescribeClusters to monitor the
        status of the deletion. The delete operation cannot be canceled or reverted once submitted.
        ...
        *FinalClusterSnapshotIdentifier* . You can later restore this snapshot to resume using the
        cluster. If a final cluster snapshot is requested, the status of the cluster will be
        "final-snapshot" while the snapshot is being taken, then it's "deleting" once Amazon
    ...
    def delete_cluster_snapshot(
        ...
        """
        Deletes the specified manual snapshot. The snapshot must be in the ``available`` state, with
        no other users authorized to access the snapshot.
        ...
        snapshot explicitly to avoid getting charged. If other accounts are authorized to access the
        snapshot, you must revoke all of the authorizations before you can delete the snapshot.
    ...
    def delete_scheduled_action(self, ScheduledActionName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/DeleteScheduledAction>`_
    ...
    def delete_tags(self, ResourceName: str, TagKeys: List[str]) -> None:
        """
        Deletes a tag or tags from a resource. You must provide the ARN of the resource from which
    ...
    def describe_cluster_db_revisions(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          specified in ``MaxRecords`` , Amazon Redshift returns a value in the ``marker`` field of
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Marker** *(string) --*
              ...
              empty, all revisions have already been returned.
    ...
    def describe_cluster_parameter_groups(
        ...
        parameter groups that match any combination of the specified keys and values. For example,
        if you have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag
        values, all parameter groups that have any combination of those values are returned.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Marker** *(string) --*
              ...
              subsequent request. If a value is returned in a response, you can retrieve the next
    ...
    def describe_cluster_parameters(
        ...
        You can specify *source* filter to retrieve parameters of only specific type. For example,
    ...
    def describe_cluster_security_groups(
        ...
        you have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag
        values, all security groups that have any combination of those values are returned.
        ...
        **Request Syntax**
        ...
        :param ClusterSecurityGroupName:
          ...
          The name of a cluster security group for which you are requesting details. You can specify
          either the **Marker** parameter or a **ClusterSecurityGroupName** parameter, but not both.
        ...
        :param TagKeys:
          ...
          are associated with the specified key or keys. For example, suppose that you have security
          groups that are tagged with keys called ``owner`` and ``environment`` . If you specify
          both of these tag keys in the request, Amazon Redshift returns a response with the
          security groups that have either or both of these tag keys associated with them.
    ...
    def describe_cluster_snapshots(
        ...
        inactive AWS customer accounts.

        If you specify both tag keys and tag values in the same request, Amazon Redshift returns all
        snapshots that match any combination of the specified keys and values. For example, if you
        have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag values,
        all snapshots that have any combination of those values are returned. Only snapshots that
        you own are returned in the response; shared snapshots are not returned with the tag key and
        tag value request parameters.
            ...
            - **Snapshots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **OwnerAccount** *(string) --*
                  ...
                  snapshot. For automatic snapshots, the owner of the cluster. The owner can perform
    ...
    def describe_cluster_subnet_groups(
        ...
        If you specify both tag keys and tag values in the same request, Amazon Redshift returns all
        subnet groups that match any combination of the specified keys and values. For example, if
        you have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag
        values, all subnet groups that have any combination of those values are returned.
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          associated with the specified key or keys. For example, suppose that you have subnet
          groups that are tagged with keys called ``owner`` and ``environment`` . If you specify
        ...
        :param TagValues:
          ...
          A tag value or values for which you want to return all matching cluster subnet groups that
          are associated with the specified tag value or values. For example, suppose that you have
          subnet groups that are tagged with values called ``admin`` and ``test`` . If you specify
    ...
    def describe_cluster_tracks(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          An optional parameter that specifies the starting point to return a set of response
          records. When the results of a ``DescribeClusterTracks`` request exceed the value
          specified in ``MaxRecords`` , Amazon Redshift returns a value in the ``Marker`` field of
          the response. You can retrieve the next set of response records by providing the returned
          marker value in the ``Marker`` parameter and retrying the request.
          ...
          - *(dict) --*
            ...
            - **MaintenanceTracks** *(list) --*
              ...
              - *(dict) --*
                ...
                during a maintenance window. If the value for ``MaintenanceTrack`` is ``current`` ,
                the cluster is updated to the most recently certified maintenance release. If the
                value is ``trailing`` , the cluster is updated to the previously certified
                maintenance release.
    ...
    def describe_cluster_versions(
        ...
        versions. For more information about managing clusters, go to `Amazon Redshift Clusters
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html>`__ in the
        *Amazon Redshift Cluster Management Guide* .
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          An optional parameter that specifies the starting point to return a set of response
          records. When the results of a  DescribeClusterVersions request exceed the value specified
    ...
    def describe_clusters(
        ...
        *Amazon Redshift Cluster Management Guide* .
        ...
        If you specify both tag keys and tag values in the same request, Amazon Redshift returns all
        clusters that match any combination of the specified keys and values. For example, if you
        have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag values,
            ...
            - **Clusters** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DBName** *(string) --*
                  ...
                  This same name is returned for the life of the cluster. If an initial database was
                  not specified, a database named ``dev`` dev was created by default.
                ...
                - **VpcSecurityGroups** *(list) --*
                  ...
                  A list of Amazon Virtual Private Cloud (Amazon VPC) security groups that are
                  associated with the cluster. This parameter is returned only if the cluster is in
                  a VPC.
                ...
                - **PendingModifiedValues** *(dict) --*
                  ...
                  - **EnhancedVpcRouting** *(boolean) --*
                    ...
                    enabled. To create a cluster that uses enhanced VPC routing, the cluster must be
                    in a VPC. For more information, see `Enhanced VPC Routing
                    <https://docs.aws.amazon.com/redshift/latest/mgmt/enhanced-vpc-routing.html>`__
                    in the Amazon Redshift Cluster Management Guide.
    ...
    def describe_default_cluster_parameters(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          An optional parameter that specifies the starting point to return a set of response
          records. When the results of a  DescribeDefaultClusterParameters request exceed the value
          specified in ``MaxRecords`` , AWS returns a value in the ``Marker`` field of the response.
          You can retrieve the next set of response records by providing the returned marker value
          in the ``Marker`` parameter and retrying the request.
          ...
          - *(dict) --*
            ...
            - **DefaultClusterParameters** *(dict) --*
              ...
              - **Marker** *(string) --*
                ...
                A value that indicates the starting point for the next set of response records in a
                subsequent request. If a value is returned in a response, you can retrieve the next
                set of records by providing this returned marker value in the ``Marker`` parameter
                and retrying the command. If the ``Marker`` field is empty, all response records
    ...
    def describe_event_subscriptions(
        ...
        If you specify both tag keys and tag values in the same request, Amazon Redshift returns all
        event notification subscriptions that match any combination of the specified keys and
        values. For example, if you have ``owner`` and ``environment`` for tag keys, and ``admin``
        and ``test`` for tag values, all subscriptions that have any combination of those values are
        returned.
        ...
        **Request Syntax**
        ...
        :param TagValues:
          ...
          ``test`` . If you specify both of these tag values in the request, Amazon Redshift returns
          a response with the subscriptions that have either or both of these tag values associated
          with them.
              ...
              - *(dict) --*
                ...
                - **Status** *(string) --*
                  ...
                  * The status "no-permission" indicates that Amazon Redshift no longer has
                  permission to post to the Amazon SNS topic. The status "topic-not-exist" indicates
    ...
    def describe_events(
        ...
        group can be obtained by providing the name as a parameter. By default, the past hour of
        events are returned.
        ...
        **Request Syntax**
        ...
        :param SourceIdentifier:
          ...
          The identifier of the event source for which events will be returned. If this parameter is
                ...
                'Events': [
                    {
                        'SourceIdentifier': 'string',
                        'SourceType':
                        'cluster'|'cluster-parameter-group'|'cluster-security-group'
                        |'cluster-snapshot'|'scheduled-action',
                        'Message': 'string',
                        'EventCategories': [
                            'string',
                        ],
    ...
    def describe_hsm_client_certificates(
        ...
        for tag values, all HSM client certificates that have any combination of those values are
        returned.
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          client certificates that are tagged with keys called ``owner`` and ``environment`` . If
        ...
        :param TagValues:
          ...
          that are associated with the specified tag value or values. For example, suppose that you
          have HSM client certificates that are tagged with values called ``admin`` and ``test`` .
    ...
    def describe_hsm_configurations(
        ...
        configuration ID is specified, returns information about all the HSM configurations owned by
        your AWS customer account.

        If you specify both tag keys and tag values in the same request, Amazon Redshift returns all
        HSM connections that match any combination of the specified keys and values. For example, if
        you have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag
        values, all HSM connections that have any combination of those values are returned.
        ...
        **Request Syntax**
        ...
        :param TagKeys:
          ...
          configurations that are tagged with keys called ``owner`` and ``environment`` . If you
          specify both of these tag keys in the request, Amazon Redshift returns a response with the
          HSM configurations that have either or both of these tag keys associated with them.
        ...
        :param TagValues:
          ...
          are associated with the specified tag value or values. For example, suppose that you have
          HSM configurations that are tagged with values called ``admin`` and ``test`` . If you
          specify both of these tag values in the request, Amazon Redshift returns a response with
          the HSM configurations that have either or both of these tag values associated with them.
          ...
          - *(dict) --*
            ...
            - **HsmConfigurations** *(list) --*
              ...
              - *(dict) --*
                ...
                Returns information about an HSM configuration, which is an object that describes to
                Amazon Redshift clusters the information they require to connect to an HSM where
    ...
    def describe_node_configuration_options(
        ...
        **Request Syntax**
        ...
        :param ActionType: **[REQUIRED]**
          ...
          The action type to evaluate for possible node configurations. Specify "restore-cluster" to
          get configuration combinations based on an existing snapshot. Specify
          "recommend-node-config" to get configuration recommendations based on an existing cluster
          or snapshot.
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              EstimatedDiskUtilizationPercent, then values can range from 0 to 100. For example,
              filter NumberOfNodes (name) GT (operator) 3 (values).
        ...
        :param Marker:
          ...
          An optional parameter that specifies the starting point to return a set of response
          records. When the results of a  DescribeNodeConfigurationOptions request exceed the value
          specified in ``MaxRecords`` , AWS returns a value in the ``Marker`` field of the response.
          You can retrieve the next set of response records by providing the returned marker value
          in the ``Marker`` parameter and retrying the request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **OrderableClusterOptions** *(list) --*
              ...
              An ``OrderableClusterOption`` structure containing information about orderable options
              for the cluster.
    ...
    def describe_reserved_node_offerings(
        ...
        <https://docs.aws.amazon.com/redshift/latest/mgmt/purchase-reserved-node-instance.html>`__
        in the *Amazon Redshift Cluster Management Guide* .
    ...
    def describe_resize(self, ClusterIdentifier: str) -> ClientDescribeResizeResponseTypeDef:
        ...
        operation has ever been initiated for the specified cluster, a ``HTTP 404`` error is
        returned. If a resize operation was initiated and completed, the status of the resize
        remains as ``SUCCEEDED`` until the next resize.

        A resize operation can be requested using  ModifyCluster and specifying a different number
    ...
    def describe_scheduled_actions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/DescribeScheduledActions>`_
          ...
          - *(dict) --*
            ...
            - **ScheduledActions** *(list) --*
              ...
              - *(dict) --*
                ...
                can be scheduled, see  ScheduledActionType .
                ...
                - **Schedule** *(string) --*
                  ...
                  Format of cron expressions is "``cron(Minutes Hours Day-of-month Month Day-of-week
                  Year)`` ". For example, "``cron(0, 10, *, *, MON, *)`` ". For more information,
                ...
                - **IamRole** *(string) --*
                  ...
                  permission to run the Amazon Redshift API operation in the scheduled action. This
                  IAM role must allow the Amazon Redshift scheduler (Principal
    ...
    def describe_snapshot_copy_grants(
        ...
        **Request Syntax**
        ...
        :param TagValues:
          ...
          resources tagged with values called ``admin`` and ``test`` . If you specify both of these
          tag values in the request, Amazon Redshift returns a response with all resources that have
    ...
    def describe_snapshot_schedules(
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          records by providing this returned marker value in the ``marker`` parameter and retrying
          the command. If the ``marker`` field is empty, all response records have been retrieved
          for the request.
    ...
    def describe_table_restore_status(
        ...
        ``TableRestoreRequestId`` parameter, then ``DescribeTableRestoreStatus`` returns the status
        of all table restore requests ordered by the date and time of the request in ascending
        order. Otherwise ``DescribeTableRestoreStatus`` returns the status of the table specified by
    ...
    def describe_tags(
        ...
        or you can return all tags for a given type of resource, such as clusters, snapshots, and so
        on.
        ...
        * The ``MaxRecords`` parameter can be a range from 10 to 50 results to return in a request.
        ...
        If you specify both tag keys and tag values in the same request, Amazon Redshift returns all
        resources that match any combination of the specified keys and values. For example, if you
        have ``owner`` and ``environment`` for tag keys, and ``admin`` and ``test`` for tag values,
    ...
    def disable_snapshot_copy(
        ...
        If your cluster and its snapshots are encrypted using a customer master key (CMK) from AWS
        KMS, use  DeleteSnapshotCopyGrant to delete the grant that grants Amazon Redshift permission
        to the CMK in the destination region.
    ...
    def enable_snapshot_copy(
        ...
        **Request Syntax**
        ...
        :param DestinationRegion: **[REQUIRED]**
          ...
          Constraints: Must be the name of a valid AWS Region. For more information, see `Regions
          and Endpoints
          <https://docs.aws.amazon.com/general/latest/gr/rande.html#redshift_region>`__ in the
        ...
        :param SnapshotCopyGrantName:
          ...
          The name of the snapshot copy grant to use when snapshots of an AWS KMS-encrypted cluster
    ...
    def get_cluster_credentials(
        ...
        ``IAM:`` if ``AutoCreate`` is ``False`` or ``IAMA:`` if ``AutoCreate`` is ``True`` . You can
        optionally specify one or more database user groups that the user will join at log on. By
        default, the temporary credentials expire in 900 seconds. You can optionally specify a
        duration between 900 seconds (15 minutes) and 3600 seconds (60 minutes). For more
        information, see `Using IAM Authentication to Generate Database User Credentials
        <https://docs.aws.amazon.com/redshift/latest/mgmt/generating-user-credentials.html>`__ in
        the Amazon Redshift Cluster Management Guide.
        ...
        For more information about permissions, see `Resource Policies for GetClusterCredentials
        ...
        **Request Syntax**
        ...
        :param DbUser: **[REQUIRED]**
          ...
          The name of a database user. If a user name matching ``DbUser`` exists in the database,
          the temporary user credentials have the same permissions as the existing user. If
          ``DbUser`` doesn't exist in the database and ``Autocreate`` is ``True`` , a new user is
          created using the value for ``DbUser`` with PUBLIC permissions. If a database user
          matching the value for ``DbUser`` doesn't exist and ``Autocreate`` is ``False`` , then the
          command succeeds but the connection attempt will fail because the user doesn't exist in
          the database.

          For more information, see `CREATE USER
          <https://docs.aws.amazon.com/redshift/latest/dg/r_CREATE_USER.html>`__ in the Amazon
          Redshift Database Developer Guide.
          ...
          * Cannot be a reserved word. A list of reserved words can be found in `Reserved Words
          <http://docs.aws.amazon.com/redshift/latest/dg/r_pg_keywords.html>`__ in the Amazon
          Redshift Database Developer Guide.
        ...
        :param AutoCreate:
          ...
          Create a database user with the name specified for the user named in ``DbUser`` if one
          does not exist.

        :type DbGroups: list
        :param DbGroups:

          A list of the names of existing database groups that the user named in ``DbUser`` will
          join for the current session, in addition to any group memberships for an existing user.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DbUser** *(string) --*
              ...
              user is added to PUBLIC. If the ``DbGroups`` parameter is specifed, ``DbUser`` is
              added to the listed groups for any sessions created using these credentials.

            - **DbPassword** *(string) --*

              A temporary password that authorizes the user name returned by ``DbUser`` to log on to
              the database ``DbName`` .
    ...
    def modify_cluster(
        ...
        """
        Modifies the settings for a cluster. For example, you can add another security or parameter
        group, update the preferred maintenance window, or change the master user password.
        Resetting a cluster password or modifying the security groups associated with a cluster do
        not need a reboot. However, modifying a parameter group requires a reboot for parameters to
        take effect. For more information about managing clusters, go to `Amazon Redshift Clusters
        <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-clusters.html>`__ in the
        *Amazon Redshift Cluster Management Guide* .

        You can also change node type and the number of nodes to scale up or down the cluster. When
        resizing a cluster, you must specify both the number of nodes and the node type even if one
        of the parameters does not change.
        ...
        **Request Syntax**
        ...
        :param NodeType:
          ...
          for the cluster to read-only. After Amazon Redshift provisions a new cluster according to
          your resize requirements, there will be a temporary outage while the old cluster is
          deleted and your connection is switched to the new cluster. When the new connection is
          complete, the original access permissions for the cluster are restored. You can use
        ...
        :param MasterUserPassword:
          ...
          The new password for the cluster master user. This change is asynchronously applied as
        ...
        :param PreferredMaintenanceWindow:
          ...
          The weekly time range (in UTC) during which system maintenance can occur, if necessary. If
          system maintenance is necessary during the window, it may result in an outage.
        ...
        :param ClusterVersion:
          ...
          parameter group family. For more information about parameters and parameter groups, go to
          `Amazon Redshift Parameter Groups
          <https://docs.aws.amazon.com/redshift/latest/mgmt/working-with-parameter-groups.html>`__
          in the *Amazon Redshift Cluster Management Guide* .
        ...
        :param AllowVersionUpgrade:
          ...
          If ``true`` , major version upgrades will be applied automatically to the cluster during
        ...
        :param MaintenanceTrackName:
          ...
          cluster until the next maintenance window. When the maintenance track changes, the cluster
          is switched to the latest cluster release available for the maintenance track. At this
          point, the maintenance track name is applied.

        :type Encrypted: boolean
        :param Encrypted:

          Indicates whether the cluster is encrypted. If the cluster is encrypted and you provide a
          value for the ``KmsKeyId`` parameter, we will encrypt the cluster with the provided
          ``KmsKeyId`` . If you don't provide a ``KmsKeyId`` , we will encrypt with the default key.
          In the China region we will use legacy encryption if you specify that the cluster is
          encrypted.
    ...
    def modify_cluster_iam_roles(
        ...
        **Request Syntax**
        ...
        :param AddIamRoles:
          ...
          Resource Name (ARN) format. You can associate up to 10 IAM roles with a single cluster in
          a single request.
    ...
    def modify_cluster_maintenance(
        ...
        **Request Syntax**
        ...
        :param DeferMaintenanceEndTime:
          ...
          A timestamp indicating end time for the deferred maintenance window. If you specify an end
          time, you can't specify a duration.
    ...
    def modify_cluster_parameter_group(
        ...
        **Request Syntax**
        ...
        :param Parameters: **[REQUIRED]**
          ...
          For the workload management (WLM) configuration, you must supply all the name-value pairs
          in the wlm_json_configuration parameter.
          ...
          - *(dict) --*
            ...
            - **ApplyType** *(string) --*
              ...
              for the configuration changes to be applied. For more information about parameters and
    ...
    def modify_scheduled_action(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/redshift-2012-12-01/ModifyScheduledAction>`_
    ...
    def modify_snapshot_copy_retention_period(
        ...
        """
        Modifies the number of days to retain snapshots in the destination AWS Region after they are
        copied from the source AWS Region. By default, this operation only changes the retention
        period of copied automated snapshots. The retention periods for both new and existing copied
        automated snapshots are updated with the new retention period. You can set the manual option
        to change only the retention periods of copied manual snapshots. If you set this option,
        ...
        **Request Syntax**
        ...
        :param ClusterIdentifier: **[REQUIRED]**
          ...
          The unique identifier of the cluster for which you want to change the retention period for
          either automated or manual snapshots that are copied to a destination AWS Region.
    ...
    def reboot_cluster(self, ClusterIdentifier: str) -> ClientRebootClusterResponseTypeDef:
        ...
        outage to the cluster, during which the cluster status is set to ``rebooting`` . A cluster
        event is created when the reboot is completed. Any pending cluster modifications (see
    ...
    def reset_cluster_parameter_group(
        ...
        sets the source values of the parameters to "engine-default". To reset the entire parameter
        group specify the *ResetAllParameters* parameter. For parameter changes to take effect you
    ...
    def restore_from_cluster_snapshot(
        ...
        type of the same size during restore.
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          The AWS Key Management Service (KMS) key ID of the encryption key that you want to use to
          encrypt data in the cluster that you restore from a shared snapshot.
        ...
        :param NodeType:
          ...
          restore into that same instance type and size. In other words, you can only restore a
          dc1.large instance type into another dc1.large instance type or dc2.large instance type.
          You can't restore dc1.8xlarge to dc2.8xlarge. First restore to a dc1.8xlareg cluster, then
          resize to a dc2.8large cluster. For more information about node types, see `About Clusters
          and Nodes
        ...
        :param MaintenanceTrackName:
          ...
          snapshot inherits the ``MaintenanceTrack`` value from the cluster. The snapshot might be
          on a different track than the cluster that was the source for the snapshot. For example,
          suppose that you take a snapshot of a cluster that is on the current track and then change
          the cluster to be on the trailing track. In this case, the snapshot and the source cluster
    ...
    def restore_table_from_cluster_snapshot(
        ...
        You cannot use ``RestoreTableFromClusterSnapshot`` to restore a table with the same name as
        an existing table in an Amazon Redshift cluster. That is, you cannot overwrite an existing
        ...
        ``RestoreTableFromClusterSnapshot`` . When you have renamed your original table, then you
        can pass the original name of the table as the ``NewTableName`` parameter value in the call
        to ``RestoreTableFromClusterSnapshot`` . This way, you can replace the original table with
        the table created from the snapshot.
    ...
    def revoke_cluster_security_group_ingress(
        ...
        **Request Syntax**
        ...
        :param CIDRIP:
          ...
          Routing (CIDR) block of IP addresses. If ``CIDRIP`` is specified, ``EC2SecurityGroupName``
        ...
        :param EC2SecurityGroupOwnerId:
          ...
          ``EC2SecurityGroupOwnerId`` is specified, ``EC2SecurityGroupName`` must also be provided.
          and ``CIDRIP`` cannot be provided.
