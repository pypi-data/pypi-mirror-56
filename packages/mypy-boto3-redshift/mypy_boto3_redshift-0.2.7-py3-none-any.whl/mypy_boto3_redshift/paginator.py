"Main interface for redshift Paginators"
...
class DescribeClusterDbRevisionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        :py:meth:`Redshift.Client.describe_cluster_db_revisions`.
...
class DescribeClusterTracksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`Redshift.Client.describe_cluster_tracks`.
...
class DescribeNodeConfigurationOptionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`Redshift.Client.describe_node_configuration_options`.
...
class DescribeSnapshotSchedulesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`Redshift.Client.describe_snapshot_schedules`.
...
class GetReservedNodeExchangeOfferingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`Redshift.Client.get_reserved_node_exchange_offerings`.
