...
class RtnTrade(Base):
    ...
    volume = Column('volume', DOUBLE)
    turnover = Column('turnover', DOUBLE)
    commission = Column('commission', DOUBLE)
...
class ExchPos(Base):
    ...
    yd_position = Column(DOUBLE)
    position_cost = Column(DOUBLE)
    frozen = Column(DOUBLE)
    yd_frozen = Column(DOUBLE)
    available = Column(DOUBLE)
    borrowed = Column(DOUBLE)
    interest = Column(DOUBLE)
    liquidation_price = Column(DOUBLE)
    equity = Column(DOUBLE)
    risk_rate = Column(DOUBLE)
    update_time = Column(DateTime)
    pnl = Column(DOUBLE)
    realized_pnl = Column(DOUBLE)
...
class FeeInfo(Base):
    ...
    min_fee = Column(DOUBLE)
    buy_fee_rate = Column(DOUBLE)
    sell_fee_rate = Column(DOUBLE)
    contract_multiplier = Column(Integer)
    open_fee_rate = Column(DOUBLE)
    close_fee_rate = Column(DOUBLE)
    close_today_fee_rate = Column(DOUBLE)
    close_yesterday_fee_rate = Column(DOUBLE)
...
class PnlInfo(Base):
    ...
    unrealized_pnl = Column(DOUBLE)
    realized_pnl = Column(DOUBLE)
    total_pnl = Column(DOUBLE)
    paid_fees = Column(DOUBLE)
    total_long_cost = Column(DOUBLE)
    ystd_long_cost = Column(DOUBLE)
    total_short_cost = Column(DOUBLE)
    ystd_short_cost = Column(DOUBLE)
    last_price = Column(DOUBLE)
    pre_settlement_price = Column(DOUBLE)
    pre_close_price = Column(DOUBLE)
