...
class Fist:
    ...
    def set_pull(self):
        ...
        self.pull_sock.setsockopt(zmq.SNDHWM, 0)
        self.pull_sock.setsockopt(zmq.RCVHWM, 0)
    ...
    def reg_sub(self, other_fist_name):
        ...
        sub_sock.setsockopt(zmq.SNDHWM, 0)
    ...
    def reg_sub_master(self):
        ...
        self.sub_master_sock.setsockopt(zmq.SNDHWM, 0)
        self.sub_master_sock.setsockopt(zmq.RCVHWM, 0)
    ...
    def reg_req_master(self):
        ...
        self.req_master_sock.setsockopt(zmq.SNDHWM, 0)
        self.req_master_sock.setsockopt(zmq.RCVHWM, 0)
