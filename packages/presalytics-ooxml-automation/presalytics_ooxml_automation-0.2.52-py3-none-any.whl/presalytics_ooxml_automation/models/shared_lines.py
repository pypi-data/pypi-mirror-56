...
class SharedLines(object):
    ...
    openapi_types = {
        ...
        't_lto_br_border': 'object',
        'b_lto_tr_border_id': 'str',
        'b_lto_tr_border': 'object',
        'line_map_id': 'str',
        'line_map': 'object',
        'id': 'str',
