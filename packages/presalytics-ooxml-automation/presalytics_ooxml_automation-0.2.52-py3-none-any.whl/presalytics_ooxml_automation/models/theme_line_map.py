...
class ThemeLineMap(object):
    ...
    def __init__(self, theme_id=None, theme=None, intensity_id=None, line=None, id=None, date_created=None, user_created=None, date_modified=None, user_modified=None, local_vars_configuration=None):  # noqa: E501
