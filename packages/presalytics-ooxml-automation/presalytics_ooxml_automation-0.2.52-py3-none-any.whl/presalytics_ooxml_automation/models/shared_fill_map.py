...
class SharedFillMap(object):
    ...
    openapi_types = {
        ...
        'effect_attribute': 'object',
        'table_cell_id': 'str',
        'table_cell': 'object',
        'theme_background_fill_id': 'str',
        'theme_background_fill': 'object',
        'theme_fill_id': 'str',
        'theme_fill': 'object',
        'id': 'str',
    ...
    def __init__(self, fill_type_id=None, solid_fill=None, gradient_fill=None, image_fill=None, shape=None, shape_id=None, connector=None, connector_id=None, effect_attribute_id=None, effect_attribute=None, table_cell_id=None, table_cell=None, theme_background_fill_id=None, theme_background_fill=None, theme_fill_id=None, theme_fill=None, id=None, date_created=None, user_created=None, date_modified=None, user_modified=None, local_vars_configuration=None):  # noqa: E501
