...
class ChartAxes(object):
    ...
    def __init__(self, charts_id=None, chart=None, title_text_container=None, ooxml_id=None, axis_data_type_id=None, id=None, date_created=None, user_created=None, date_modified=None, user_modified=None, local_vars_configuration=None):  # noqa: E501
