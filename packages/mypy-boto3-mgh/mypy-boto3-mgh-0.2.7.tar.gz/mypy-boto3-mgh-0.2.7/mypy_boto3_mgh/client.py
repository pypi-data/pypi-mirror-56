...
class Client(BaseClient):
    ...
    def associate_created_artifact(
        ...
        migration task performed by a migration tool. This API has the following traits:

        * Migration tools can call the ``AssociateCreatedArtifact`` operation to indicate which AWS artifact
        is associated with a migration task.

        * The created artifact name must be provided in ARN (Amazon Resource Name) format which will contain
    ...
    def delete_progress_update_stream(
        ...
        resource used for access control. This API has the following traits:
        ...
        * ``CreateProgressUpdateStream`` , ``ImportMigrationTask`` , ``NotifyMigrationTaskState`` , and all
        Associate[*] APIs related to the tasks belonging to the stream will throw "InvalidInputException" if
        ...
        * Once the stream and all of its resources are deleted, ``CreateProgressUpdateStream`` for a stream
        of the same name will succeed, and that stream will be an entirely new logical resource (without any
    ...
    def disassociate_created_artifact(
        ...
        * A migration user can call the ``DisassociateCreatedArtifacts`` operation to disassociate a created
        AWS Artifact from a migration task.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If there are more created artifacts than the max result, return the next token to be passed to
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If there are more discovered resources than the max result, return the next token to be passed
    ...
    def notify_migration_task_state(
        ...
        **Request Syntax**
        ...
        :param NextUpdateSeconds: **[REQUIRED]**
          ...
          Migration Hub does not receive an update within the specified interval, then the migration task
