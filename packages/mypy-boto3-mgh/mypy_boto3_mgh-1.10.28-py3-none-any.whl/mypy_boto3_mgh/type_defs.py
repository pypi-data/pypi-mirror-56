...
class ClientDescribeMigrationTaskResponseMigrationTaskTypeDef(
    ...
    - **Task** *(dict) --*
      ...
      - **StatusDetail** *(string) --*
        ...
        provide clarifying information about the status that is unique to that tool or that explains
        an error state.
    ...
    - **ResourceAttributeList** *(list) --*
      ...
      Information about the resource that is being migrated. This data will be used to map the task
      to a resource in the Application Discovery Service repository.
...
class ClientListMigrationTasksResponseMigrationTaskSummaryListTypeDef(
    ...
    - **ProgressUpdateStream** *(string) --*
      ...
      An AWS resource used for access control. It should uniquely identify the migration tool as it
      is used for all updates made by the tool.
...
_ClientPutResourceAttributesResourceAttributeListTypeDef = TypedDict(
    "_ClientPutResourceAttributesResourceAttributeListTypeDef", {"Type": str, "Value": str}
)
...
class ListProgressUpdateStreamsPaginateResponseProgressUpdateStreamSummaryListTypeDef(
    ...
    """
    Type definition for `ListProgressUpdateStreamsPaginateResponse`
