...
class Client(BaseClient):
    ...
    def associate_created_artifact(
        ...
        """
        Associates a created artifact of an AWS cloud resource, the target receiving the migration, with
        the migration task performed by a migration tool. This API has the following traits:

        * Migration tools can call the ``AssociateCreatedArtifact`` operation to indicate which AWS
        artifact is associated with a migration task.
        ...
        * Examples of the AWS resource behind the created artifact are, AMI's, EC2 instance, or DMS
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/AssociateCreatedArtifact>`_
        ...
        **Request Syntax**
        ...
        :param DryRun:
          ...
          Optional boolean flag to indicate whether any effect should take place. Used to test if the
    ...
    def associate_discovered_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/AssociateDiscoveredResource>`_
    ...
    def create_progress_update_stream(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/CreateProgressUpdateStream>`_
    ...
    def delete_progress_update_stream(
        ...
        """
        Deletes a progress update stream, including all of its tasks, which was previously created as an
        AWS resource used for access control. This API has the following traits:

        * The only parameter needed for ``DeleteProgressUpdateStream`` is the stream name (same as a
        ``CreateProgressUpdateStream`` call).

        * The call will return, and a background process will asynchronously delete the stream and all of
        its resources (tasks, associated resources, resource attributes, created artifacts).
        ...
        * ``CreateProgressUpdateStream`` , ``ImportMigrationTask`` , ``NotifyMigrationTaskState`` , and all
        Associate[*] APIs related to the tasks belonging to the stream will throw "InvalidInputException"
        if the stream of the same name is in the process of being deleted.

        * Once the stream and all of its resources are deleted, ``CreateProgressUpdateStream`` for a stream
        of the same name will succeed, and that stream will be an entirely new logical resource (without
        any resources associated with the old stream).

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/DeleteProgressUpdateStream>`_
    ...
    def describe_application_state(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/DescribeApplicationState>`_
    ...
    def describe_migration_task(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/DescribeMigrationTask>`_
...

            {
                'MigrationTask': {
                    ...
                    'ResourceAttributeList': [
                        {
                            'Type':
                            'IPV4_ADDRESS'|'IPV6_ADDRESS'|'MAC_ADDRESS'|'FQDN'|'VM_MANAGER_ID'
    ...
    def disassociate_created_artifact(
        ...
        tool that was previously associated. This API has the following traits:

        * A migration user can call the ``DisassociateCreatedArtifacts`` operation to disassociate a
        created AWS Artifact from a migration task.
        ...
        * Examples of the AWS resource behind the created artifact are, AMI's, EC2 instance, or RDS
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/DisassociateCreatedArtifact>`_
        ...
        **Request Syntax**
        ...
        :param MigrationTaskName: **[REQUIRED]**
          ...
          Unique identifier that references the migration task to be disassociated with the artifact. *Do
    ...
    def disassociate_discovered_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/DisassociateDiscoveredResource>`_
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/DisassociateDiscoveredResource>`_
    ...
    def import_migration_task(
        ...
        """
        Registers a new migration task which represents a server, database, etc., being migrated to AWS by
        a migration tool.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/ImportMigrationTask>`_
    ...
    def list_created_artifacts(
        ...
        """
        Lists the created artifacts attached to a given migration task in an update stream. This API has
    ...
    def list_migration_tasks(
        ...
        this call. This API has the following traits:
    ...
    def notify_application_state(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/NotifyApplicationState>`_
    ...
    def notify_migration_task_state(
        ...
        * Migration tools will call the ``NotifyMigrationTaskState`` API to share the latest progress and
        status.

        * ``MigrationTaskName`` is used for addressing updates to the correct target.

        * ``ProgressUpdateStream`` is used for access control and to provide a namespace for each migration
        tool.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/NotifyMigrationTaskState>`_
        ...
        **Request Syntax**
        ...
        :param NextUpdateSeconds: **[REQUIRED]**
          ...
          If Migration Hub does not receive an update within the specified interval, then the migration
    ...
    def put_resource_attributes(
        ...
        """
        ..
        _https://docs.aws.amazon.com/migrationhub/latest/ug/API_PutResourceAttributes.html#migrationhub-PutResourceAttributes-request-ResourceAttributeList:
        ...
        .. warning::
          ...
          * Keep in mind that subsequent calls to PutResourceAttributes will override previously stored
          attributes. For example, if it is first called with a MAC address, but later, it is desired to
          *add* an IP address, it will then be required to call it with *both* the IP and MAC addresses to
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/AWSMigrationHub-2017-05-31/PutResourceAttributes>`_
        ...
        **Request Syntax**
        ...
        :param ResourceAttributeList: **[REQUIRED]**
          ...
          Information about the resource that is being migrated. This data will be used to map the task to
          a resource in the Application Discovery Service repository.
          ...
          .. note::
            ...
            VM_MANAGED_OBJECT_REFERENCE | VM_NAME | VM_PATH | BIOS_ID | MOTHERBOARD_SERIAL_NUMBER`` where
            the identifying value can be a string up to 256 characters.
          ...
          .. warning::
            ...
            * If any "VM" related value is set for a ``ResourceAttribute`` object, it is required that
            ...
            fields will be discarded and "VM" fields will not be used for matching the migration task to a
            server in Application Discovery Service repository. See the `Example
            <https://docs.aws.amazon.com/migrationhub/latest/ug/API_PutResourceAttributes.html#API_PutResourceAttributes_Examples>`__
            section below for a use case of specifying "VM" related values.

            * If a server you are trying to match has multiple IP or MAC addresses, you should provide as
            many as you know in separate type/value pairs passed to the ``ResourceAttributeList`` parameter
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_created_artifacts` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_migration_tasks` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_progress_update_streams` operation.
        """
