...
class ClientCreateCostCategoryDefinitionResponseTypeDef(
    ...
    """
    Type definition for `ClientCreateCostCategoryDefinition` `Response`
...
class ClientCreateCostCategoryDefinitionRulesRuleCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientCreateCostCategoryDefinitionRulesRule` `CostCategories`

     * **Cost Category is in preview release for AWS Billing and Cost Management and is subject to
     change. Your use of Cost Categories is subject to the Beta Service Participation terms of the
     `AWS Service Terms <https://aws.amazon.com/service-terms/>`__ (Section 1.10).** *
...
class ClientCreateCostCategoryDefinitionRulesRuleDimensionsTypeDef(
    ...
    """
    Type definition for `ClientCreateCostCategoryDefinitionRulesRule` `Dimensions`
    ...
    - **Values** *(list) --*
      ...
      ``Amazon Elasticsearch Service`` , ``Amazon ElastiCache`` , ``Amazon Redshift`` , and ``Amazon
...
class ClientCreateCostCategoryDefinitionRulesRuleTagsTypeDef(
    ...
    """
    Type definition for `ClientCreateCostCategoryDefinitionRulesRule` `Tags`
...
class ClientCreateCostCategoryDefinitionRulesRuleTypeDef(
    ...
    """
    Type definition for `ClientCreateCostCategoryDefinitionRules` `Rule`
...
class ClientCreateCostCategoryDefinitionRulesTypeDef(
    ...
    """
    Type definition for `ClientCreateCostCategoryDefinition` `Rules`
    ...
    - **Rule** *(dict) --* **[REQUIRED]**
      ...
      - **Or** *(list) --*
        ...
        - *(dict) --*
          ...
          * Simple dimension values - You can set the dimension name and values for the filters that
          you plan to use. For example, you can filter for ``REGION==us-east-1 OR
          REGION==
              us-west-1`` . The ``Expression`` for that looks like this:  ``{ "Dimensions": {
          "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }``   The list of dimension
          values are OR'd together to retrieve cost or usage data. You can create ``Expression`` and
          ``DimensionValues`` objects using either ``with*`` methods or ``set*`` methods in multiple
          lines.

          * Compound dimension values with logical operations - You can use multiple ``Expression``
          types and the logical operators ``AND/OR/NOT`` to create a list of one or more
          ``Expression`` objects. This allows you to filter on more advanced options. For example,
          you can filter on ``((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type ==
               Type1))
          AND (USAGE_TYPE !=
          ...
          .. note::
            ...
            supported. OR is not supported between different dimensions, or dimensions and tags. NOT
            operators aren't supported. Dimensions are also limited to ``LINKED_ACCOUNT`` ,
...
class ClientDeleteCostCategoryDefinitionResponseTypeDef(
    ...
    """
    Type definition for `ClientDeleteCostCategoryDefinition` `Response`
    ...
    - **EffectiveEnd** *(string) --*
      ...
      The effective end date of the Cost Category as a result of deleting it. No costs after this
      date will be categorized by the deleted Cost Category.
    """
...
class ClientDescribeCostCategoryDefinitionResponseCostCategoryRulesRuleCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientDescribeCostCategoryDefinitionResponseCostCategoryRulesRule`
    `CostCategories`
...
class ClientDescribeCostCategoryDefinitionResponseCostCategoryRulesRuleTagsTypeDef(
    ...
    """
    Type definition for `ClientDescribeCostCategoryDefinitionResponseCostCategoryRulesRule` `Tags`
...
class ClientDescribeCostCategoryDefinitionResponseCostCategoryRulesRuleTypeDef(
    ...
    """
    Type definition for `ClientDescribeCostCategoryDefinitionResponseCostCategoryRules` `Rule`
...
class ClientDescribeCostCategoryDefinitionResponseCostCategoryRulesTypeDef(
    ...
    """
    Type definition for `ClientDescribeCostCategoryDefinitionResponseCostCategory` `Rules`
...
class ClientDescribeCostCategoryDefinitionResponseCostCategoryTypeDef(
    ...
    """
    Type definition for `ClientDescribeCostCategoryDefinitionResponse` `CostCategory`
      ...
      - *(dict) --*
        ...
        - **Rule** *(dict) --*
          ...
          - **Or** *(list) --*
            ...
            - *(dict) --*
              ...
              * Simple dimension values - You can set the dimension name and values for the filters
              ...
              dimension values are OR'd together to retrieve cost or usage data. You can create
              ``Expression`` and ``DimensionValues`` objects using either ``with*`` methods or
              ``set*`` methods in multiple lines.

              * Compound dimension values with logical operations - You can use multiple
              ``Expression`` types and the logical operators ``AND/OR/NOT`` to create a list of one
              or more ``Expression`` objects. This allows you to filter on more advanced options.
              For example, you can filter on ``((REGION == us-east-1 OR REGION ==
                   us-west-1) OR
              (TAG.Type == Type1)) AND (USAGE_TYPE !=
                   DataTransfer)`` . The ``Expression`` for that
              looks like this:  ``{ "And": [ {"Or": [ {"Dimensions": { "Key": "REGION", "Values": [
          ...
          - **CostCategories** *(dict) --*
             ...
             * **Cost Category is in preview release for AWS Billing and Cost Management and is
             subject to change. Your use of Cost Categories is subject to the Beta Service
             Participation terms of the `AWS Service Terms
...
class ClientDescribeCostCategoryDefinitionResponseTypeDef(
    ...
    """
    Type definition for `ClientDescribeCostCategoryDefinition` `Response`
            ...
            - **Or** *(list) --*
              ...
              - *(dict) --*
                ...
                * Simple dimension values - You can set the dimension name and values for the
                filters that you plan to use. For example, you can filter for ``REGION==
                    us-east-1 OR
                REGION==us-west-1`` . The ``Expression`` for that looks like this:  ``{
                "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }``   The
                list of dimension values are OR'd together to retrieve cost or usage data. You can
                create ``Expression`` and ``DimensionValues`` objects using either ``with*`` methods
                or ``set*`` methods in multiple lines.

                * Compound dimension values with logical operations - You can use multiple
                ``Expression`` types and the logical operators ``AND/OR/NOT`` to create a list of
                one or more ``Expression`` objects. This allows you to filter on more advanced
                options. For example, you can filter on ``((REGION ==
                     us-east-1 OR REGION ==
                us-west-1) OR (TAG.Type == Type1)) AND (USAGE_TYPE !=
                     DataTransfer)`` . The
                ``Expression`` for that looks like this:  ``{ "And": [ {"Or": [ {"Dimensions": {
                ...
                .. note::
                  ...
                  For ``GetRightsizingRecommendation`` action, a combination of OR and NOT is not
                  supported. OR is not supported between different dimensions, or dimensions and
...
class ClientGetCostAndUsageFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetCostAndUsageFilter` `CostCategories`
...
_ClientGetCostAndUsageFilterDimensionsTypeDef = TypedDict(
    "_ClientGetCostAndUsageFilterDimensionsTypeDef", {"Key": str, "Values": List[str]}, total=False
)
...
_ClientGetCostAndUsageResponseGroupDefinitionsTypeDef = TypedDict(
    "_ClientGetCostAndUsageResponseGroupDefinitionsTypeDef", {"Type": str, "Key": str}, total=False
)
      ...
      - *(dict) --*
        ...
        - **TimePeriod** *(dict) --*
          ...
          - **Start** *(string) --*
            ...
            is inclusive. For example, if ``start`` is ``2017-01-01`` , AWS retrieves cost and usage
...
class ClientGetCostAndUsageWithResourcesFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetCostAndUsageWithResourcesFilter` `CostCategories`
...
_ClientGetCostAndUsageWithResourcesGroupByTypeDef = TypedDict(
    "_ClientGetCostAndUsageWithResourcesGroupByTypeDef", {"Type": str, "Key": str}, total=False
)
...
class ClientGetCostForecastFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetCostForecastFilter` `CostCategories`
...
_ClientGetCostForecastFilterDimensionsTypeDef = TypedDict(
    "_ClientGetCostForecastFilterDimensionsTypeDef", {"Key": str, "Values": List[str]}, total=False
)
...
class ClientGetDimensionValuesTimePeriodTypeDef(_ClientGetDimensionValuesTimePeriodTypeDef):
    """
...
class ClientGetReservationCoverageFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetReservationCoverageFilter` `CostCategories`
...
class ClientGetReservationCoverageFilterTypeDef(_ClientGetReservationCoverageFilterTypeDef):
    ...
    * TENANCY
     ...
     nest only one level deep. If there are multiple values for a dimension, they are OR'd together.
...
_ClientGetReservationCoverageGroupByTypeDef = TypedDict(
    "_ClientGetReservationCoverageGroupByTypeDef", {"Type": str, "Key": str}, total=False
)
...
class ClientGetReservationCoverageResponseCoveragesByTimeGroupsCoverageCoverageCostTypeDef(
    ...
    """
    Type definition for `ClientGetReservationCoverageResponseCoveragesByTimeGroupsCoverage`
    `CoverageCost`
...
class ClientGetReservationCoverageResponseCoveragesByTimeTotalCoverageNormalizedUnitsTypeDef(
    ...
    """
    Type definition for `ClientGetReservationCoverageResponseCoveragesByTimeTotal`
    `CoverageNormalizedUnits`
...
class ClientGetReservationCoverageTimePeriodTypeDef(_ClientGetReservationCoverageTimePeriodTypeDef):
    """
...
class ClientGetReservationPurchaseRecommendationResponseRecommendationsRecommendationDetailsInstanceDetailsEC2InstanceDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetReservationPurchaseRecommendationResponseRecommendationsRecommendationDetailsInstanceDetails`
    `EC2InstanceDetails`
...
class ClientGetReservationPurchaseRecommendationResponseRecommendationsRecommendationDetailsInstanceDetailsRDSInstanceDetailsTypeDef(
    ...
    - **DeploymentOption** *(string) --*
      ...
      Whether the recommendation is for a reservation in a single Availability Zone or a reservation
...
class ClientGetReservationPurchaseRecommendationResponseRecommendationsRecommendationDetailsInstanceDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetReservationPurchaseRecommendationResponseRecommendationsRecommendationDetails`
    `InstanceDetails`
...
class ClientGetReservationPurchaseRecommendationResponseRecommendationsRecommendationDetailsTypeDef(
    ...
    """
    Type definition for `ClientGetReservationPurchaseRecommendationResponseRecommendations`
    ...
    - **EstimatedMonthlySavingsPercentage** *(string) --*
      ...
      How much AWS estimates that this specific recommendation could save you in a month, as a
    ...
    - **EstimatedReservationCostForLookbackPeriod** *(string) --*
      ...
      How much AWS estimates that you would have spent for all usage during the specified historical
...
class ClientGetReservationPurchaseRecommendationResponseRecommendationsServiceSpecificationEC2SpecificationTypeDef(
    ...
    """
    Type definition for
    `ClientGetReservationPurchaseRecommendationResponseRecommendationsServiceSpecification`
    `EC2Specification`
        ...
        - **RecommendationDetails** *(list) --*
          ...
          - *(dict) --*
            ...
            - **EstimatedMonthlySavingsPercentage** *(string) --*
              ...
              How much AWS estimates that this specific recommendation could save you in a month, as
...
class ClientGetReservationPurchaseRecommendationServiceSpecificationEC2SpecificationTypeDef(
    ...
    """
    Type definition for `ClientGetReservationPurchaseRecommendationServiceSpecification`
    `EC2Specification`
...
class ClientGetReservationUtilizationFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetReservationUtilizationFilter` `CostCategories`
...
_ClientGetReservationUtilizationGroupByTypeDef = TypedDict(
    "_ClientGetReservationUtilizationGroupByTypeDef", {"Type": str, "Key": str}, total=False
)
...
class ClientGetReservationUtilizationResponseUtilizationsByTimeGroupsUtilizationTypeDef(
    ...
    """
    Type definition for `ClientGetReservationUtilizationResponseUtilizationsByTimeGroups`
    `Utilization`
...
class ClientGetRightsizingRecommendationFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetRightsizingRecommendationFilter` `CostCategories`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceResourceDetailsEC2ResourceDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceResourceDetails`
    `EC2ResourceDetails`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceResourceDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstance`
    `ResourceDetails`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceResourceUtilizationEC2ResourceUtilizationTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceResourceUtilization`
    ...
    - **MaxStorageUtilizationPercentage** *(string) --*
      ...
      Maximum observed or expected storage utilization of the instance (does not measure EBS
      storage).
    """
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceTagsTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstance` `Tags`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsCurrentInstanceTypeDef(
    ...
    """
    Type definition for `ClientGetRightsizingRecommendationResponseRightsizingRecommendations`
    `CurrentInstance`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstancesExpectedResourceUtilizationEC2ResourceUtilizationTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstancesExpectedResourceUtilization`
    `EC2ResourceUtilization`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstancesExpectedResourceUtilizationTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstances`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstancesResourceDetailsEC2ResourceDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstancesResourceDetails`
    `EC2ResourceDetails`
...
class ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetailTargetInstancesTypeDef(
    ...
    """
    Type definition for
    `ClientGetRightsizingRecommendationResponseRightsizingRecommendationsModifyRecommendationDetail`
    `TargetInstances`
...
class ClientGetSavingsPlansCoverageFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetSavingsPlansCoverageFilter` `CostCategories`
...
_ClientGetSavingsPlansCoverageGroupByTypeDef = TypedDict(
    "_ClientGetSavingsPlansCoverageGroupByTypeDef", {"Type": str, "Key": str}, total=False
)
...
class ClientGetSavingsPlansCoverageResponseSavingsPlansCoveragesCoverageTypeDef(
    ...
    - **CoveragePercentage** *(string) --*
      ...
      The percentage of your existing Savings Planscovered usage, divided by all of your eligible
...
class ClientGetSavingsPlansPurchaseRecommendationResponseSavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationDetailsSavingsPlansDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetSavingsPlansPurchaseRecommendationResponseSavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationDetails`
    `SavingsPlansDetails`
...
class ClientGetSavingsPlansPurchaseRecommendationResponseSavingsPlansPurchaseRecommendationSavingsPlansPurchaseRecommendationDetailsTypeDef(
    ...
    """
    Type definition for
    `ClientGetSavingsPlansPurchaseRecommendationResponseSavingsPlansPurchaseRecommendation`
    ...
    - **EstimatedOnDemandCost** *(string) --*
      ...
      The remaining On-Demand cost estimated to not be covered by the recommended Savings Plans,
      over the length of the lookback period.

    - **EstimatedOnDemandCostWithCurrentCommitment** *(string) --*

      The estimated On-Demand costs you would expect with no additional commitment, based on your
      usage of the selected time period and the Savings Plans you own.

    - **EstimatedSavingsAmount** *(string) --*

      The estimated savings amount based on the recommended Savings Plans over the length of the
      lookback period.

    - **EstimatedSavingsPercentage** *(string) --*

      The estimated savings percentage relative to the total cost of applicable On-Demand usage over
      the lookback period.

    - **HourlyCommitmentToPurchase** *(string) --*

      The recommended hourly commitment level for the Savings Plans type, and configuration based on
    ...
    - **CurrentMaximumHourlyOnDemandSpend** *(string) --*
      ...
      The highest value of hourly On-Demand spend over the lookback period of the applicable usage
      type.

    - **CurrentAverageHourlyOnDemandSpend** *(string) --*

      The average value of hourly On-Demand spend over the lookback period of the applicable usage
      type.
    """
...
class ClientGetSavingsPlansPurchaseRecommendationResponseSavingsPlansPurchaseRecommendationTypeDef(
    ...
    """
    Type definition for `ClientGetSavingsPlansPurchaseRecommendationResponse`
    ...
    - **SavingsPlansPurchaseRecommendationDetails** *(list) --*
      ...
      - *(dict) --*
        ...
        - **EstimatedROI** *(string) --*
          ...
          The estimated return on investment based on the recommended Savings Plans purchased. This
    ...
    - **SavingsPlansPurchaseRecommendationSummary** *(dict) --*
      ...
      - **EstimatedTotalCost** *(string) --*
        ...
        The estimated total cost of the usage after purchasing the recommended Savings Plans. This
        is a sum of the cost of Savings Plans during this term, and the remaining On-Demand usage.
...
class ClientGetSavingsPlansUtilizationDetailsFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetSavingsPlansUtilizationDetailsFilter` `CostCategories`
...
class ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetailsAmortizedCommitmentTypeDef(
    ...
    """
    Type definition for
    `ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetails`
    `AmortizedCommitment`
    ...
    - **AmortizedUpfrontCommitment** *(string) --*
      ...
      or ``PartialUpfront`` Savings Plans.
...
class ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetailsSavingsTypeDef(
    ...
    """
    Type definition for
    `ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetails` `Savings`

    The amount saved by using existing Savings Plans. Savings returns both net savings from savings
    plans as well as the ``onDemandCostEquivalent`` of the Savings Plans when considering the
    utilization rate.

    - **NetSavings** *(string) --*

      The savings amount that you are accumulating for the usage that is covered by a Savings Plans,
...
class ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetailsUtilizationTypeDef(
    ...
    """
    Type definition for
    `ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetails` `Utilization`
    ...
    - **UnusedCommitment** *(string) --*
      ...
      The amount of your Savings Plans commitment that was not consumed from Savings Plans eligible
      usage in a specific period.
...
class ClientGetSavingsPlansUtilizationDetailsResponseSavingsPlansUtilizationDetailsTypeDef(
    ...
    """
    Type definition for `ClientGetSavingsPlansUtilizationDetailsResponse`
    ...
    - **Savings** *(dict) --*
      ...
      savings plans as well as the ``onDemandCostEquivalent`` of the Savings Plans when considering
...
_ClientGetSavingsPlansUtilizationDetailsTimePeriodTypeDef = TypedDict(
    "_ClientGetSavingsPlansUtilizationDetailsTimePeriodTypeDef", {"Start": str, "End": str}
)
...
class ClientGetSavingsPlansUtilizationFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetSavingsPlansUtilizationFilter` `CostCategories`
...
class ClientGetSavingsPlansUtilizationResponseSavingsPlansUtilizationsByTimeAmortizedCommitmentTypeDef(
    ...
    """
    Type definition for `ClientGetSavingsPlansUtilizationResponseSavingsPlansUtilizationsByTime`
    `AmortizedCommitment`
...
class ClientGetUsageForecastFilterCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientGetUsageForecastFilter` `CostCategories`
...
_ClientGetUsageForecastFilterDimensionsTypeDef = TypedDict(
    "_ClientGetUsageForecastFilterDimensionsTypeDef", {"Key": str, "Values": List[str]}, total=False
)
...
class ClientListCostCategoryDefinitionsResponseCostCategoryReferencesTypeDef(
    ...
    """
    Type definition for `ClientListCostCategoryDefinitionsResponse` `CostCategoryReferences`
...
class ClientListCostCategoryDefinitionsResponseTypeDef(
    ...
    """
    Type definition for `ClientListCostCategoryDefinitions` `Response`
...
class ClientUpdateCostCategoryDefinitionResponseTypeDef(
    ...
    """
    Type definition for `ClientUpdateCostCategoryDefinition` `Response`
...
class ClientUpdateCostCategoryDefinitionRulesRuleCostCategoriesTypeDef(
    ...
    """
    Type definition for `ClientUpdateCostCategoryDefinitionRulesRule` `CostCategories`
...
class ClientUpdateCostCategoryDefinitionRulesRuleDimensionsTypeDef(
    ...
    """
    Type definition for `ClientUpdateCostCategoryDefinitionRulesRule` `Dimensions`
...
class ClientUpdateCostCategoryDefinitionRulesRuleTagsTypeDef(
    ...
    """
    Type definition for `ClientUpdateCostCategoryDefinitionRulesRule` `Tags`
...
class ClientUpdateCostCategoryDefinitionRulesRuleTypeDef(
    ...
    """
    Type definition for `ClientUpdateCostCategoryDefinitionRules` `Rule`
...
class ClientUpdateCostCategoryDefinitionRulesTypeDef(
    ...
    """
    Type definition for `ClientUpdateCostCategoryDefinition` `Rules`
