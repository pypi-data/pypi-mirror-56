...
class Client(BaseClient):
    ...
    def create_cost_category_definition(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/CreateCostCategoryDefinition>`_
              ...
              Rules=[
                  {
                      ...
                      'Rule': {
                          ...
                          'Dimensions': {
                              'Key':
                              'AZ'|'INSTANCE_TYPE'|'LINKED_ACCOUNT'
                              |'OPERATION'|'PURCHASE_TYPE'|'REGION'|'SERVICE'
                              |'USAGE_TYPE'|'USAGE_TYPE_GROUP'|'RECORD_TYPE'
                              |'OPERATING_SYSTEM'|'TENANCY'|'SCOPE'|'PLATFORM'
                              |'SUBSCRIPTION_ID'|'LEGAL_ENTITY_NAME'
                              |'DEPLOYMENT_OPTION'|'DATABASE_ENGINE'
                              |'CACHE_ENGINE'|'INSTANCE_TYPE_FAMILY'
                              |'BILLING_ENTITY'|'RESERVATION_ID'|'RESOURCE_ID'
                              |'RIGHTSIZING_TYPE'|'SAVINGS_PLANS_TYPE'
                ...
                - *(dict) --*
                  ...
                  * Simple dimension values - You can set the dimension name and values for the
                  filters that you plan to use. For example, you can filter for ``REGION==
                      us-east-1
                  OR REGION==
                      us-west-1`` . The ``Expression`` for that looks like this:  ``{
                  "Dimensions": { "Key": "REGION", "Values": [ "us-east-1", “us-west-1” ] } }``
                  The list of dimension values are OR'd together to retrieve cost or usage data. You
                  can create ``Expression`` and ``DimensionValues`` objects using either ``with*``
    ...
    def delete_cost_category_definition(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/DeleteCostCategoryDefinition>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **EffectiveEnd** *(string) --*
              ...
              this date will be categorized by the deleted Cost Category.
    ...
    def describe_cost_category_definition(
        ...
        You have the option to use ``EffectiveOn`` to return a Cost Category that is active on a
        specific date. If there is no ``EffectiveOn`` specified, you’ll see a Cost Category that is
        effective on the current date. If Cost Category is still effective, ``EffectiveEnd`` is
        omitted in the response.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/DescribeCostCategoryDefinition>`_
                    ...
                    'Rules': [
                        {
                            ...
                            'Rule': {
                                ...
                                'Dimensions': {
                                    'Key':
                                    'AZ'|'INSTANCE_TYPE'
                                    |'LINKED_ACCOUNT'|'OPERATION'
                                    |'PURCHASE_TYPE'|'REGION'|'SERVICE'
                                    |'USAGE_TYPE'|'USAGE_TYPE_GROUP'
                                    |'RECORD_TYPE'|'OPERATING_SYSTEM'
                                    |'TENANCY'|'SCOPE'|'PLATFORM'
                                    |'SUBSCRIPTION_ID'
                                    |'LEGAL_ENTITY_NAME'
                                    |'DEPLOYMENT_OPTION'
                                    |'DATABASE_ENGINE'|'CACHE_ENGINE'
                                    |'INSTANCE_TYPE_FAMILY'
                                    |'BILLING_ENTITY'|'RESERVATION_ID'
                                    |'RESOURCE_ID'|'RIGHTSIZING_TYPE'
                                    |'SAVINGS_PLANS_TYPE'
                                    |'SAVINGS_PLAN_ARN'
                                    |'PAYMENT_OPTION',
                                    'Values': [
              ...
              - **Rules** *(list) --*
                ...
                - *(dict) --*
                  ...
                  .. warning::
                     ...
                     * **Cost Category is in preview release for AWS Billing and Cost Management and
                     is subject to change. Your use of Cost Categories is subject to the Beta
                     Service Participation terms of the `AWS Service Terms
                     <https://aws.amazon.com/service-terms/>`__ (Section 1.10).** *
                  ...
                  - **Rule** *(dict) --*
                    ...
                    Root level ``OR`` is not supported. We recommend you create a separate rule
                    instead.
                    ...
                    - **Or** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        * Simple dimension values - You can set the dimension name and values for
                        ...
                        ``REGION==us-east-1 OR REGION==
                            us-west-1`` . The ``Expression`` for that
                        looks like this:  ``{ "Dimensions": { "Key": "REGION", "Values": [
                        "us-east-1", “us-west-1” ] } }``   The list of dimension values are OR'd
                        together to retrieve cost or usage data. You can create ``Expression`` and
                        ``DimensionValues`` objects using either ``with*`` methods or ``set*``
                        methods in multiple lines.

                        * Compound dimension values with logical operations - You can use multiple
                        ``Expression`` types and the logical operators ``AND/OR/NOT`` to create a
                        list of one or more ``Expression`` objects. This allows you to filter on
                        more advanced options. For example, you can filter on ``((REGION ==
                        us-east-1 OR REGION == us-west-1) OR (TAG.Type ==
                             Type1)) AND (USAGE_TYPE !=
                        ...
                        .. note::
                          ...
                          For ``GetRightsizingRecommendation`` action, a combination of OR and NOT
    ...
    def get_cost_and_usage(
        ...
        usage-related metric, such as ``BlendedCosts`` or ``UsageQuantity`` , that you want the
        request to return. You can also filter and group your data by various dimensions, such as
        ``SERVICE`` or ``AZ`` , in a specific time range. For a complete list of valid dimensions,
        see the `GetDimensionValues
        ...
        **Request Syntax**
        ...
        :param TimePeriod: **[REQUIRED]**
          ...
          Sets the start and end dates for retrieving AWS costs. The start date is inclusive, but
        ...
        :param Filter:
          ...
          service. You can nest ``Expression`` objects to define any combination of dimension
        ...
        :param Metrics:
          ...
          .. note::
            ...
            and data transfer are measured in different units (for example, hours vs. GB). To get
        ...
        :param GroupBy:
          ...
          You can group AWS costs using up to two different groups, either dimensions, tag keys, or
          both.
              ...
              - *(dict) --*
                ...
                - **TimePeriod** *(dict) --*
                  ...
                  - **End** *(string) --*
                    ...
                    is exclusive. For example, if ``end`` is ``2017-05-01`` , AWS retrieves cost and
    ...
    def get_cost_and_usage_with_resources(
        ...
        and usage-related metric, such as ``BlendedCosts`` or ``UsageQuantity`` , that you want the
        request to return. You can also filter and group your data by various dimensions, such as
        ``SERVICE`` or ``AZ`` , in a specific time range. For a complete list of valid dimensions,
        see the `GetDimensionValues
        <http://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_GetDimensionValues.html>`__
        operation. Master accounts in an organization in AWS Organizations have access to all member
        accounts. This API is currently available for the Amazon Elastic Compute Cloud – Compute
        service only.

        .. note::

          This is an opt-in only feature. You can enable this feature from the Cost Explorer
          Settings page. For information on how to access the Settings page, see `Controlling Access
          for Cost Explorer
          <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/ce-access.html>`__ in the
    ...
    def get_cost_forecast(
        ...
        **Request Syntax**
        ...
        :param Metric: **[REQUIRED]**
          ...
          blended and unblended rates, see `Why does the "blended" annotation appear on some line
          items in my bill?
          <https://aws.amazon.com/premiumsupport/knowledge-center/blended-rates-intro/>`__ .
        ...
        :param Granularity: **[REQUIRED]**
          ...
          How granular you want the forecast to be. You can get 3 months of ``DAILY`` forecasts or
          12 months of ``MONTHLY`` forecasts.
        ...
        :param Filter:
          ...
          The filters that you want to use to filter your forecast. Cost Explorer API supports all
          of the Cost Explorer filters.
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_dimension_values(
              ...
              Dimension=
                  'AZ'|'INSTANCE_TYPE'|'LINKED_ACCOUNT'|'OPERATION'|'PURCHASE_TYPE'|'REGION'
                  ...
                  |'BILLING_ENTITY'|'RESERVATION_ID'|'RESOURCE_ID'|'RIGHTSIZING_TYPE'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DimensionValues** *(list) --*
              ...
              * LINKED_ACCOUNT - The description in the attribute map that includes the full name of
              ...
              * USAGE_TYPE - The type of usage. An example is DataTransfer-In-Bytes. The response
              for the ``GetDimensionValues`` operation includes a unit attribute. Examples include
              GB and Hrs.
    ...
    def get_reservation_coverage(
        ...
        or Amazon Redshift usage is covered by a reservation. An organization's master account can
        see the coverage of the associated member accounts. For any time period, you can filter data
        ...
        **Request Syntax**
        ...
        :param TimePeriod: **[REQUIRED]**
          ...
          ``start`` is ``2017-01-01`` and ``end`` is ``2017-05-01`` , then the cost and usage data
        ...
        :param Filter:
          ...
          * TENANCY
           ...
           <http://docs.aws.amazon.com/aws-cost-management/latest/APIReference/API_Expression.html>`__
           object as the other operations, but only ``AND`` is supported among each dimension. You
           can nest only one level deep. If there are multiple values for a dimension, they are OR'd
           together.
    ...
    def get_reservation_purchase_recommendation(
        ...
        you reduce your costs. Reservations provide a discounted hourly rate (up to 75%) compared to
        On-Demand pricing.
        ...
        After AWS has these categories, it simulates every combination of reservations in each
        category of usage to identify the best number of each type of RI to purchase to maximize
        your estimated savings.

        For example, AWS automatically aggregates your Amazon EC2 Linux, shared tenancy, and c4
        family usage in the US West (Oregon) Region and recommends that you buy size-flexible
        regional reservations to apply to the c4 family usage. AWS recommends the smallest size
        instance in an instance family. This makes it easier to purchase a size-flexible RI. AWS
        also shows the equal number of normalized units so that you can purchase any instance size
        that you want. For this example, your RI recommendation would be for ``c4.large`` because
        ...
        **Request Syntax**
        ...
        :param AccountScope:
          ...
          The account scope that you want recommendations for. ``PAYER`` means that AWS includes the
                ...
                'Recommendations': [
                    {
                        ...
                        |'LIGHT_UTILIZATION'|'MEDIUM_UTILIZATION'
                        |'HEAVY_UTILIZATION',
                        'ServiceSpecification': {
                            'EC2Specification': {
                                'OfferingClass': 'STANDARD'|'CONVERTIBLE'
    ...
    def get_reservation_utilization(
        ...
        have access to member accounts. You can filter data by dimensions in a time period. You can
        use ``GetDimensionValues`` to determine the possible dimension values. Currently, you can
        group only by ``SUBSCRIPTION_ID`` .
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          * Simple dimension values - You can set the dimension name and values for the filters that
          ...
          REGION==us-west-1`` . The ``Expression`` for that looks like this:  ``{ "Dimensions": {
          ...
          * Compound dimension values with logical operations - You can use multiple ``Expression``
          ...
          you can filter on ``((REGION == us-east-1 OR REGION == us-west-1) OR (TAG.Type ==
               Type1))
          AND (USAGE_TYPE != DataTransfer)`` . The ``Expression`` for that looks like this:  ``{
          ...
          - *(dict) --*
            ...
            - **Summary** *(dict) --*
              ...
              - **SavingsPercentage** *(string) --*
                ...
                Savings percentage based on the recommended modifications, relative to the total On
                Demand costs associated with these instances.
    ...
    def get_savings_plans_coverage(
        ...
        your cost is covered by a Savings Plan. An organization’s master account can see the
        coverage of the associated member accounts. For any time period, you can filter data for
        ...
        **Request Syntax**
        ...
        :param TimePeriod: **[REQUIRED]**
          ...
          The time period that you want the usage and costs for. The ``Start`` date must be within
          13 months. The ``End`` date must be after the ``Start`` date, and before the current date.
              ...
              - *(dict) --*
                ...
                - **Coverage** *(dict) --*
                  ...
                  - **CoveragePercentage** *(string) --*
                    ...
                    The percentage of your existing Savings Planscovered usage, divided by all of
    ...
    def get_savings_plans_utilization(
        ...
        monthly granularity. Master accounts in an organization have access to member accounts. You
        can use ``GetDimensionValues`` in ``SAVINGS_PLANS`` to determine the possible dimension
        values.
            ...
            - **SavingsPlansUtilizationsByTime** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Savings** *(dict) --*
                  ...
                  from Savings Plans as well as the ``onDemandCostEquivalent`` of the Savings Plans
    ...
    def get_savings_plans_utilization_details(
        ...
        retrieve data by dates in a single response similar to ``GetSavingsPlanUtilization`` , but
        you have the option to make multiple calls to ``GetSavingsPlanUtilizationDetails`` by
        providing individual dates. You can use ``GetDimensionValues`` in ``SAVINGS_PLANS`` to
          ...
          - *(dict) --*
            ...
            - **SavingsPlansUtilizationDetails** *(list) --*
              ...
              - *(dict) --*
                ...
                account. Master accounts in an organization have access to member accounts. You can
            ...
            - **TimePeriod** *(dict) --*
              ...
              - **Start** *(string) --*
                ...
                date is inclusive. For example, if ``start`` is ``2017-01-01`` , AWS retrieves cost
    ...
    def get_tags(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/GetTags>`_
    ...
    def list_cost_category_definitions(
        ...
        have the option to use ``EffectiveOn`` to return a list of Cost Categories that were active
        on a specific date. If there is no ``EffectiveOn`` specified, you’ll see Cost Categories
        that are effective on the current date. If Cost Category is still effective,
        ``EffectiveEnd`` is omitted in the response.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/ListCostCategoryDefinitions>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CostCategoryReferences** *(list) --*
              ...
              A reference to a Cost Category containing enough information to identify the Cost
              Category.
              ...
              - *(dict) --*
                ...
                .. warning::
                   ...
                   * **Cost Category is in preview release for AWS Billing and Cost Management and
                   is subject to change. Your use of Cost Categories is subject to the Beta Service
                   Participation terms of the `AWS Service Terms
                   <https://aws.amazon.com/service-terms/>`__ (Section 1.10).** *
    ...
    def update_cost_category_definition(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ce-2017-10-25/UpdateCostCategoryDefinition>`_
