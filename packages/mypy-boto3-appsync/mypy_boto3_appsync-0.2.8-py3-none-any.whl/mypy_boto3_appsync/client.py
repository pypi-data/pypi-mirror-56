...
class Client(BaseClient):
    ...
    def create_api_cache(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/CreateApiCache>`_
          ...
          ::

            {
                'apiCache': {
                    ...
                    'atRestEncryptionEnabled': True|False,
                    'type':
                    'T2_SMALL'|'T2_MEDIUM'|'R4_LARGE'|'R4_XLARGE'|'R4_2XLARGE'
                    |'R4_4XLARGE'|'R4_8XLARGE',
            ...
            - **dataSource** *(dict) --*
              ...
              - **httpConfig** *(dict) --*
                ...
                - **endpoint** *(string) --*
                  ...
                  specified, AWS AppSync uses the default port 80 for the HTTP endpoint and port 443
                  for HTTPS endpoints.
                ...
                - *(dict) --*
                  ...
                  - **openIDConnectConfig** *(dict) --*
                    ...
                    - **clientId** *(string) --*
                      ...
                      with the OpenID identity provider. You can specify a regular expression so the
    ...
    def create_resolver(
        ...
        A resolver converts incoming requests into a format that a data source can understand and
        converts the data source's responses into GraphQL.
            ...
            - **resolver** *(dict) --*
              ...
              - **kind** *(string) --*
                ...
                * **PIPELINE** : A PIPELINE resolver type. A PIPELINE resolver enables you to
                execute a series of ``Function`` in a serial manner. You can use a pipeline resolver
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_api_cache(self, apiId: str) -> Dict:
        """
        Deletes an ``ApiCache`` object.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/DeleteApiCache>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def flush_api_cache(self, apiId: str) -> Dict:
        """
        Flushes an ``ApiCache`` object.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/FlushApiCache>`_
    ...
    def get_api_cache(self, apiId: str) -> ClientGetApiCacheResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/GetApiCache>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_type(self, apiId: str, typeName: str, format: str) -> ClientGetTypeResponseTypeDef:
        """
    ...
    def update_api_cache(
        self, apiId: str, ttl: int, apiCachingBehavior: str, type: str
    ) -> ClientUpdateApiCacheResponseTypeDef:
        """
        Updates the cache for the GraphQL API.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/appsync-2017-07-25/UpdateApiCache>`_
