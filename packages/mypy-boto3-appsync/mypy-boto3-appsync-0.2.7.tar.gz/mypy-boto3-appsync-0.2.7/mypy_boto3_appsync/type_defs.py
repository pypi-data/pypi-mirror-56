...
class ClientCreateApiCacheResponseapiCacheTypeDef(
    _ClientCreateApiCacheResponseapiCacheTypeDef
):
    """
...
class ClientCreateDataSourcehttpConfigTypeDef(_ClientCreateDataSourcehttpConfigTypeDef):
    ...
    - **endpoint** *(string) --*
      ...
      the URL scheme must be HTTP or HTTPS. If the port is not specified, AWS AppSync uses the default
      port 80 for the HTTP endpoint and port 443 for HTTPS endpoints.
...
class ClientCreateResolverResponseresolversyncConfiglambdaConflictHandlerConfigTypeDef(
    ...
    """
    Type definition for `ClientCreateResolverResponseresolversyncConfig` `lambdaConflictHandlerConfig`
...
_ClientCreateResolvercachingConfigTypeDef = TypedDict(
    "_ClientCreateResolvercachingConfigTypeDef",
    {"ttl": int, "cachingKeys": List[str]},
    total=False,
)


class ClientCreateResolvercachingConfigTypeDef(
    _ClientCreateResolvercachingConfigTypeDef
):
    """
...
class ClientGetApiCacheResponseapiCacheTypeDef(
    _ClientGetApiCacheResponseapiCacheTypeDef
):
    """
...
class ClientListResolversByFunctionResponseresolverssyncConfiglambdaConflictHandlerConfigTypeDef(
    ...
    """
    Type definition for `ClientListResolversByFunctionResponseresolverssyncConfig` `lambdaConflictHandlerConfig`
...
class ClientListResolversResponseresolverssyncConfiglambdaConflictHandlerConfigTypeDef(
    ...
    """
    Type definition for `ClientListResolversResponseresolverssyncConfig` `lambdaConflictHandlerConfig`
...
class ClientUpdateApiCacheResponseapiCacheTypeDef(
    _ClientUpdateApiCacheResponseapiCacheTypeDef
):
    """
...
class ClientUpdateResolverResponseresolversyncConfiglambdaConflictHandlerConfigTypeDef(
    ...
    """
    Type definition for `ClientUpdateResolverResponseresolversyncConfig` `lambdaConflictHandlerConfig`
...
_ClientUpdateResolvercachingConfigTypeDef = TypedDict(
    "_ClientUpdateResolvercachingConfigTypeDef",
    {"ttl": int, "cachingKeys": List[str]},
    total=False,
)


class ClientUpdateResolvercachingConfigTypeDef(
    _ClientUpdateResolvercachingConfigTypeDef
):
    """
...
class ListResolversByFunctionPaginateResponseresolverssyncConfiglambdaConflictHandlerConfigTypeDef(
    ...
    """
    Type definition for `ListResolversByFunctionPaginateResponseresolverssyncConfig` `lambdaConflictHandlerConfig`
...
class ListResolversPaginateResponseresolverssyncConfiglambdaConflictHandlerConfigTypeDef(
    ...
    """
    Type definition for `ListResolversPaginateResponseresolverssyncConfig` `lambdaConflictHandlerConfig`
