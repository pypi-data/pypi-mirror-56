"Main interface for appsync Paginators"
...
class ListApiKeysPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        apiId: str,
        PaginationConfig: ListApiKeysPaginatePaginationConfigTypeDef = None,
    ) -> ListApiKeysPaginateResponseTypeDef:
        """
...
class ListDataSourcesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        apiId: str,
        PaginationConfig: ListDataSourcesPaginatePaginationConfigTypeDef = None,
    ) -> ListDataSourcesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
