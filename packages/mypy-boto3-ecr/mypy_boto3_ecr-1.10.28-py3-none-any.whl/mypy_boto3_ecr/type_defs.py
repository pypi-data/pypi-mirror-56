...
class ClientDescribeImageScanFindingsResponseimageScanFindingsfindingsattributesTypeDef(
    ...
    """
    Type definition for `ClientDescribeImageScanFindingsResponseimageScanFindingsfindings`
    `attributes`
...
class ClientDescribeImagesResponseimageDetailsTypeDef(
    ...
    - **imagePushedAt** *(datetime) --*
      ...
      The date and time, expressed in standard JavaScript date format, at which the current image
...
class ClientDescribeRepositoriesResponserepositoriesimageScanningConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeRepositoriesResponserepositories`
...
class ClientGetAuthorizationTokenResponseauthorizationDataTypeDef(
    ...
    - **proxyEndpoint** *(string) --*
      ...
      The registry URL to use for this authorization token in a ``docker login`` command. The Amazon
      ECR registry URL format is ``https://aws_account_id.dkr.ecr.region.amazonaws.com`` . For
...
_ClientStartLifecyclePolicyPreviewResponseTypeDef = TypedDict(
    ...
    {"registryId": str, "repositoryName": str, "lifecyclePolicyText": str, "status": str},
    total=False,
)
...
class DescribeImageScanFindingsPaginateResponseimageScanFindingsfindingsattributesTypeDef(
    ...
    """
    Type definition for `DescribeImageScanFindingsPaginateResponseimageScanFindingsfindings`
    `attributes`
...
class DescribeRepositoriesPaginateResponserepositoriesimageScanningConfigurationTypeDef(
    ...
    """
    Type definition for `DescribeRepositoriesPaginateResponserepositories`
    `imageScanningConfiguration`
