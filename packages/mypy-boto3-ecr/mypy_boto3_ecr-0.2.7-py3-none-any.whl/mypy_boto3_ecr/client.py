...
class Client(BaseClient):
    ...
    def batch_check_layer_availability(
        ...
        **Request Syntax**
        ...
        :param registryId:
          ...
          The AWS account ID associated with the registry that contains the image layers to check. If you do
    ...
    def create_repository(
        ...
        <https://docs.aws.amazon.com/AmazonECR/latest/userguide/Repositories.html>`__ in the *Amazon Elastic
        ...
        **Request Syntax**
        ...
        :param imageScanningConfiguration:
          ...
          - **scanOnPush** *(boolean) --*
            ...
            set to ``true`` , images will be scanned after being pushed. If this parameter is not specified,
    ...
    def describe_image_scan_findings(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          initial request can be seen by sending another ``DescribeImageScanFindings`` request with the
          returned ``nextToken`` value. This value can be between 1 and 1000. If this parameter is not used,
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              The ``nextToken`` value to include in a future ``DescribeImageScanFindings`` request. When the
              results of a ``DescribeImageScanFindings`` request exceed ``maxResults`` , this value can be
    ...
    def describe_images(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          value can be between 1 and 1000. If this parameter is not used, then ``DescribeImages`` returns up
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              a ``DescribeImages`` request exceed ``maxResults`` , this value can be used to retrieve the
    ...
    def describe_repositories(
        ...
        **Request Syntax**
        ...
        :param registryId:
          ...
          The AWS account ID associated with the registry that contains the repositories to be described. If
          you do not specify a registry, the default registry is assumed.
        ...
        :param nextToken:
          ...
          ``maxResults`` was used and the results exceeded the value of that parameter. Pagination continues
          from the end of the previous results that returned the ``nextToken`` value. This value is ``null``
          when there are no more results to return. This option cannot be used when you specify repositories
        ...
        :param maxResults:
          ...
          When this parameter is used, ``DescribeRepositories`` only returns ``maxResults`` results in a
    ...
    def get_lifecycle_policy_preview(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          results of the initial request can be seen by sending another ``GetLifecyclePolicyPreviewRequest``
          request with the returned ``nextToken`` value. This value can be between 1 and 1000. If this
          parameter is not used, then ``GetLifecyclePolicyPreviewRequest`` returns up to 100 results and a
          ``nextToken`` value, if applicable. This option cannot be used when you specify images with
          ``imageIds`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              The ``nextToken`` value to include in a future ``GetLifecyclePolicyPreview`` request. When the
              results of a ``GetLifecyclePolicyPreview`` request exceed ``maxResults`` , this value can be
    ...
    def list_images(
        ...
        to ``TAGGED`` or ``UNTAGGED`` . For example, you can filter your results to return only ``UNTAGGED``
        images and then pipe that result to a  BatchDeleteImage operation to delete them. Or, you can filter
        your results to return only ``TAGGED`` images to list all of the tags in your repository.
    ...
    def put_image_tag_mutability(
        ...
        immutability, all image tags within the repository will be prevented them from being overwritten.
        For more information, see `Image Tag Mutability
        <https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-tag-mutability.html>`__ in the *Amazon
    ...
    def put_lifecycle_policy(
        ...
        Policy Template <https://docs.aws.amazon.com/AmazonECR/latest/userguide/LifecyclePolicies.html>`__ .
    ...
    def start_image_scan(
        ...
        image. This limit includes if an image was scanned on initial push. For more information, see `Image
        Scanning <https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-scanning.html>`__ in the
        *Amazon Elastic Container Registry User Guide* .
