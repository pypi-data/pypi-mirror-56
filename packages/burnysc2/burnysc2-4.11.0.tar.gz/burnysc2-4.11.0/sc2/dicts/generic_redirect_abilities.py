...
GENERIC_REDIRECT_ABILITIES: Dict[AbilityId, AbilityId] = {
    ...
    AbilityId.BATTLECRUISERSTOPEVALUATOR_STOP: AbilityId.STOP,
    AbilityId.BEACON_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.CANCEL_MORPHLURKERDEN: AbilityId.CANCEL,
    ...
    AbilityId.CANCEL_MOTHERSHIPSTASIS: AbilityId.CANCEL,
    AbilityId.CANCEL_NEURALPARASITE: AbilityId.CANCEL,
    AbilityId.CANCEL_NUKE: AbilityId.CANCEL,
    AbilityId.CANCEL_PROTOSSBUILDINGQUEUE: AbilityId.CANCEL_LAST,
    ...
    AbilityId.CANCEL_TEMPESTDISRUPTIONBLAST: AbilityId.CANCEL,
    AbilityId.CANCEL_VOIDRAYPRISMATICALIGNMENT: AbilityId.CANCEL,
    AbilityId.CORRUPTIONBOMB_CANCEL: AbilityId.CANCEL,
    AbilityId.CORRUPTION_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.DIGESTERTRANSPORT_LOADDIGESTER: AbilityId.LOAD,
    AbilityId.EFFECT_BLINK_STALKER: AbilityId.EFFECT_BLINK,
    AbilityId.EFFECT_MASSRECALL_MOTHERSHIP: AbilityId.EFFECT_MASSRECALL,
    ...
    AbilityId.EYESTALK_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.LEECHRESOURCES_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.LURKERASPECTMPFROMHYDRALISKBURROWED_CANCEL: AbilityId.CANCEL,
    AbilityId.LURKERASPECTMP_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.MOTHERSHIPCOREENERGIZE_CANCEL: AbilityId.CANCEL,
    AbilityId.MOVE_BATTLECRUISER: AbilityId.MOVE,
    AbilityId.MOVE_MOVE: AbilityId.MOVE,
    AbilityId.ORACLENORMALMODE_CANCEL: AbilityId.CANCEL,
    AbilityId.ORACLEREVELATIONMODE_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.PROTOSSBUILDINGQUEUE_CANCELSLOT: AbilityId.CANCEL_SLOT,
    AbilityId.PROTOSSBUILD_CANCEL: AbilityId.HALT,
    AbilityId.QUE5LONGBLEND_CANCEL: AbilityId.CANCEL_LAST,
    AbilityId.QUE5LONGBLEND_CANCELSLOT: AbilityId.CANCEL_SLOT,
    AbilityId.QUE8_CANCEL: AbilityId.CANCEL_LAST,
    AbilityId.QUE8_CANCELSLOT: AbilityId.CANCEL_SLOT,
    ...
    AbilityId.RAVENBUILD_CANCEL: AbilityId.HALT,
    ...
    AbilityId.SELFREPAIR_CANCEL: AbilityId.CANCEL,
    AbilityId.SIPHON_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId.TIMESTOP_CANCEL: AbilityId.CANCEL,
    ...
    AbilityId._250MMSTRIKECANNONS_CANCEL: AbilityId.CANCEL,
}
