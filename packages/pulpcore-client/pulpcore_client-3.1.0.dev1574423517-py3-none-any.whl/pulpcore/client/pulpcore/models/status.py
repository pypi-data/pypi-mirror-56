...
class Status(object):
    ...
    def __init__(self, versions=None, online_workers=None, missing_workers=None, online_content_apps=None, database_connection=None, redis_connection=None, storage=None, local_vars_configuration=None):  # noqa: E501
        ...
        self.missing_workers = missing_workers
    ...
    def missing_workers(self):
        """Gets the missing_workers of this Status.  # noqa: E501

        List of missing workers known to the application. A missing worker is a worker that was online, but has now stopped heartbeating and has potentially died  # noqa: E501

        :return: The missing_workers of this Status.  # noqa: E501
        :rtype: list[Worker]
        """
        return self._missing_workers

    @missing_workers.setter
    def missing_workers(self, missing_workers):
        """Sets the missing_workers of this Status.

        List of missing workers known to the application. A missing worker is a worker that was online, but has now stopped heartbeating and has potentially died  # noqa: E501

        :param missing_workers: The missing_workers of this Status.  # noqa: E501
        :type: list[Worker]
        """
        if self.local_vars_configuration.client_side_validation and missing_workers is None:  # noqa: E501
            raise ValueError("Invalid value for `missing_workers`, must not be `None`")  # noqa: E501

        self._missing_workers = missing_workers

    @property
    def online_content_apps(self):
        """Gets the online_content_apps of this Status.  # noqa: E501

        List of online content apps known to the application. An online worker is actively heartbeating  # noqa: E501
