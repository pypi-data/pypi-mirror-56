...
class Client(BaseClient):
    ...
    def disassociate_web_acl(self, ResourceArn: str) -> Dict[str, Any]:
        """
        Removes a web ACL from the specified resource, either an application load balancer or Amazon
        API Gateway stage.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ResourceArns** *(list) --*
              ...
              specified web ACL. An array with zero elements is returned if there are no resources
