...
Mypy-friendly auto-generated type annotations for `boto3 waf-regional 1.10.28` service.
...
session_client = session.client("waf-regional")
...
```python
import boto3
from mypy_boto3.waf_regional import Client
