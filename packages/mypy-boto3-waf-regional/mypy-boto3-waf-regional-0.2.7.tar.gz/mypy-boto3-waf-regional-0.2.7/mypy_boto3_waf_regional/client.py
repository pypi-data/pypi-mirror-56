"Main interface for waf-regional Client"
...
class Client(BaseClient):
    ...
    def associate_web_acl(self, WebACLId: str, ResourceArn: str) -> Dict[str, Any]:
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/AssociateWebACL>`_
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The ARN (Amazon Resource Name) of the resource to be protected, either an application load
          ...
          * For an Amazon API Gateway stage: ``arn:aws:apigateway:*region* ::/restapis/*api-id*
          /stages/*stage-name* ``
    ...
    def create_byte_match_set(
        ...
        that you want AWS WAF to inspect, such as the values of the ``User-Agent`` header or the query
        string. For example, you can create a ``ByteMatchSet`` that matches any requests with ``User-Agent``
        headers that contain the string ``BadBot`` . You can then configure AWS WAF to reject those
        requests.
        ...
        * Use ``GetChangeToken`` to get the change token that you provide in the ``ChangeToken`` parameter
        of an ``UpdateByteMatchSet`` request.
        ...
        * Submit an  UpdateByteMatchSet request to specify the part of the request that you want AWS WAF to
        ...
        WAF Developer Guide <https://docs.aws.amazon.com/waf/latest/developerguide/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateByteMatchSet>`_
                    ...
                    'ByteMatchTuples': [
                        {
                            'FieldToMatch': {
                                'Type':
                                'URI'|'QUERY_STRING'|'HEADER'|'METHOD'|'BODY'|'SINGLE_QUERY_ARG'
                                |'ALL_QUERY_ARGS',
                                'Data': 'string'
                            },
              ...
              - **ByteMatchTuples** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **TargetString** *(bytes) --*
                    ...
                    in the part of web requests that you specified in ``FieldToMatch`` . The maximum length
                  ...
                  - **PositionalConstraint** *(string) --*
                    ...
                    ``TargetString`` must contain only alphanumeric characters or underscore (A-Z, a-z, 0-9,
                    or _). In addition, ``TargetString`` must be a word, which means one of the following:
    ...
    def create_geo_match_set(
        ...
        ``GeoMatchSet`` that contains those countries and then configure AWS WAF to block the requests.
        ...
        * Submit an ``UpdateGeoMatchSetSet`` request to specify the countries that you want AWS WAF to watch
        for.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateGeoMatchSet>`_
    ...
    def create_ip_set(
        ...
        """
        Creates an  IPSet , which you use to specify which web requests that you want to allow or block
        based on the IP addresses that the requests originate from. For example, if you're receiving a lot
        of requests from one or more individual IP addresses or one or more ranges of IP addresses and you
        want to block the requests, you can create an ``IPSet`` that contains those IP addresses and then
        ...
        * Submit an ``UpdateIPSet`` request to specify the IP addresses that you want AWS WAF to watch for.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateIPSet>`_
          ...
          - *(dict) --*
            ...
            - **IPSet** *(dict) --*
              ...
              - **IPSetDescriptors** *(list) --*
                ...
                and the viewer did not use an HTTP proxy or a load balancer to send the request, this is the
    ...
    def create_rate_based_rule(
        ...
        maximum number of requests that AWS WAF allows from a specified IP address in a five-minute period.
        The ``RateBasedRule`` also contains the ``IPSet`` objects, ``ByteMatchSet`` objects, and other
        ...
        * A ``ByteMatchSet`` that matches ``BadBot`` in the ``User-Agent`` header
        ...
        meet the conditions in the rule. For a request to be blocked, it must come from the IP address
        192.0.2.44 *and* the ``User-Agent`` header in the request must contain the value ``BadBot`` .
        Further, requests that match these two conditions must be received at a rate of more than 15,000
        requests every five minutes. If both conditions are met and the rate is exceeded, AWS WAF blocks the
        requests. If the rate drops below 15,000 for a five-minute period, AWS WAF no longer blocks the
        requests.

        As a second example, suppose you want to limit requests to a particular page on your site. To do
        ...
        * Create and update a ``WebACL`` that contains the ``RateBasedRule`` . For more information, see
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateRateBasedRule>`_
        ...
        **Request Syntax**
        ...
        :param MetricName: **[REQUIRED]**
          ...
          A friendly name or description for the metrics for this ``RateBasedRule`` . The name can contain
          only alphanumeric characters (A-Z, a-z, 0-9), with maximum length 128 and minimum length one. It
        ...
        :param RateKey: **[REQUIRED]**
          ...
          thus subject to rate monitoring. The only valid value for ``RateKey`` is ``IP`` . ``IP`` indicates
          that requests that arrive from the same IP address are subject to the ``RateLimit`` that is
        ...
        :param RateLimit: **[REQUIRED]**
          ...
          ``RateKey`` , allowed in a five-minute period. If the number of requests exceeds the ``RateLimit``
        ...
        :param ChangeToken: **[REQUIRED]**
          ...
          The ``ChangeToken`` that you used to submit the ``CreateRateBasedRule`` request. You can also use
                    ...
                    'MatchPredicates': [
                        {
                            'Negated': True|False,
                            'Type':
                            'IPMatch'|'ByteMatch'|'SqlInjectionMatch'|'GeoMatch'|'SizeConstraint'|'XssMatch'
                            |'RegexMatch',
                            'DataId': 'string'
                        },
                    ],
          ...
          - *(dict) --*
            ...
            - **Rule** *(dict) --*
              ...
              - **RateKey** *(string) --*
                ...
                and thus subject to rate monitoring. The only valid value for ``RateKey`` is ``IP`` . ``IP``
    ...
    def create_regex_match_set(
        ...
        that you want AWS WAF to inspect, such as the values of the ``User-Agent`` header or the query
        string. For example, you can create a ``RegexMatchSet`` that contains a ``RegexMatchTuple`` that
        looks for any requests with ``User-Agent`` headers that match a ``RegexPatternSet`` with pattern
        ...
        * Use ``GetChangeToken`` to get the change token that you provide in the ``ChangeToken`` parameter
        of an ``UpdateRegexMatchSet`` request.

        * Submit an  UpdateRegexMatchSet request to specify the part of the request that you want AWS WAF to
        inspect (for example, the header or the URI) and the value, using a ``RegexPatternSet`` , that you
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateRegexMatchSet>`_
    ...
    def create_regex_pattern_set(
        ...
        expression (regex) pattern that you want AWS WAF to search for, such as ``B[a@]dB[o0]t`` . You can
        ...
        * Use ``GetChangeToken`` to get the change token that you provide in the ``ChangeToken`` parameter
        of an ``UpdateRegexPatternSet`` request.
        ...
        * Submit an  UpdateRegexPatternSet request to specify the string that you want AWS WAF to watch for.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateRegexPatternSet>`_
    ...
    def create_rule(
        ...
        predicates that identify the requests that you want to block. If you add more than one predicate to
        a ``Rule`` , a request must match all of the specifications to be allowed or blocked. For example,
        ...
        * A ``ByteMatchSet`` that matches ``BadBot`` in the ``User-Agent`` header
        ...
        You then add the ``Rule`` to a ``WebACL`` and specify that you want to blocks requests that satisfy
        the ``Rule`` . For a request to be blocked, it must come from the IP address 192.0.2.44 *and* the
        ...
        * Create and update a ``WebACL`` that contains the ``Rule`` . For more information, see
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateRule>`_
    ...
    def create_rule_group(
        ...
        """
        Creates a ``RuleGroup`` . A rule group is a collection of predefined rules that you add to a web
        ACL. You use  UpdateRuleGroup to add rules to the rule group.
        ...
        * Ten rules per rule group.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateRuleGroup>`_
    ...
    def create_size_constraint_set(
        ...
        header or the length of the query string. For example, you can create a ``SizeConstraintSet`` that
        matches any requests that have a query string that is longer than 100 bytes. You can then configure
        ...
        * Use ``GetChangeToken`` to get the change token that you provide in the ``ChangeToken`` parameter
        of an ``UpdateSizeConstraintSet`` request.

        * Submit an  UpdateSizeConstraintSet request to specify the part of the request that you want AWS
        WAF to inspect (for example, the header or the URI) and the value that you want AWS WAF to watch
        for.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateSizeConstraintSet>`_
    ...
    def create_sql_injection_match_set(
        ...
        * Use ``GetChangeToken`` to get the change token that you provide in the ``ChangeToken`` parameter
        of an  UpdateSqlInjectionMatchSet request.

        * Submit an  UpdateSqlInjectionMatchSet request to specify the parts of web requests in which you
        want to allow, block, or count malicious SQL code.

        For more information about how to use the AWS WAF API to allow or block HTTP requests, see the `AWS
        WAF Developer Guide <https://docs.aws.amazon.com/waf/latest/developerguide/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateSqlInjectionMatchSet>`_
    ...
    def create_web_acl(
        ...
        """
        Creates a ``WebACL`` , which contains the ``Rules`` that identify the CloudFront web requests that
        you want to allow, block, or count. AWS WAF evaluates ``Rules`` in order based on the value of
        ...
        * Create and update the ``ByteMatchSet`` objects and other predicates that you want to include in
        ``Rules`` . For more information, see  CreateByteMatchSet ,  UpdateByteMatchSet ,  CreateIPSet ,
        UpdateIPSet ,  CreateSqlInjectionMatchSet , and  UpdateSqlInjectionMatchSet .

        * Create and update the ``Rules`` that you want to include in the ``WebACL`` . For more information,
        see  CreateRule and  UpdateRule .
        ...
        * Submit an  UpdateWebACL request to specify the ``Rules`` that you want to include in the
        ...
        <https://docs.aws.amazon.com/waf/latest/developerguide/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateWebACL>`_
    ...
    def create_xss_match_set(
        ...
        * Use ``GetChangeToken`` to get the change token that you provide in the ``ChangeToken`` parameter
        of an  UpdateXssMatchSet request.
        ...
        * Submit an  UpdateXssMatchSet request to specify the parts of web requests in which you want to
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/CreateXssMatchSet>`_
    ...
    def delete_byte_match_set(
        ...
        * Submit a ``DeleteByteMatchSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteByteMatchSet>`_
    ...
    def delete_geo_match_set(
        ...
        * Submit a ``DeleteGeoMatchSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteGeoMatchSet>`_
        ...
        **Request Syntax**
        ...
        :param GeoMatchSetId: **[REQUIRED]**
          ...
          The ``GeoMatchSetID`` of the  GeoMatchSet that you want to delete. ``GeoMatchSetId`` is returned
          by  CreateGeoMatchSet and by  ListGeoMatchSets .
    ...
    def delete_ip_set(
        ...
        * Submit a ``DeleteIPSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteIPSet>`_
        ...
        **Request Syntax**
        ...
        :param IPSetId: **[REQUIRED]**
          ...
          The ``IPSetId`` of the  IPSet that you want to delete. ``IPSetId`` is returned by  CreateIPSet and
          by  ListIPSets .
    ...
    def delete_logging_configuration(self, ResourceArn: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteLoggingConfiguration>`_
    ...
    def delete_permission_policy(self, ResourceArn: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeletePermissionPolicy>`_
    ...
    def delete_rate_based_rule(
        ...
        * Submit a ``DeleteRateBasedRule`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteRateBasedRule>`_
    ...
    def delete_regex_match_set(
        ...
        * Submit a ``DeleteRegexMatchSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteRegexMatchSet>`_
    ...
    def delete_regex_pattern_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteRegexPatternSet>`_
    ...
    def delete_rule(
        ...
        * Submit a ``DeleteRule`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteRule>`_
    ...
    def delete_rule_group(
        ...
        * Submit a ``DeleteRuleGroup`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteRuleGroup>`_
        ...
        **Request Syntax**
        ...
        :param RuleGroupId: **[REQUIRED]**
          ...
          The ``RuleGroupId`` of the  RuleGroup that you want to delete. ``RuleGroupId`` is returned by
    ...
    def delete_size_constraint_set(
        ...
        * Submit a ``DeleteSizeConstraintSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteSizeConstraintSet>`_
    ...
    def delete_sql_injection_match_set(
        ...
        * Submit a ``DeleteSqlInjectionMatchSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteSqlInjectionMatchSet>`_
    ...
    def delete_web_acl(
        ...
        * Submit a ``DeleteWebACL`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteWebACL>`_
    ...
    def delete_xss_match_set(
        ...
        * Submit a ``DeleteXssMatchSet`` request.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DeleteXssMatchSet>`_
        ...
        **Request Syntax**
        ...
        :param XssMatchSetId: **[REQUIRED]**
          ...
          The ``XssMatchSetId`` of the  XssMatchSet that you want to delete. ``XssMatchSetId`` is returned
          by  CreateXssMatchSet and by  ListXssMatchSets .
    ...
    def disassociate_web_acl(self, ResourceArn: str) -> Dict[str, Any]:
        """
        Removes a web ACL from the specified resource, either an application load balancer or Amazon API
        Gateway stage.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/DisassociateWebACL>`_
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The ARN (Amazon Resource Name) of the resource from which the web ACL is being removed, either an
    ...
    def get_byte_match_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetByteMatchSet>`_
        ...
        **Request Syntax**
        ...
        :param ByteMatchSetId: **[REQUIRED]**
          ...
          The ``ByteMatchSetId`` of the  ByteMatchSet that you want to get. ``ByteMatchSetId`` is returned
          by  CreateByteMatchSet and by  ListByteMatchSets .
    ...
    def get_change_token(
        ...
        change token in the create, update, or delete request. Change tokens ensure that your application
        doesn't submit conflicting requests to AWS WAF.

        Each create, update, or delete request must use a unique change token. If your application submits a
        ``GetChangeToken`` request and then submits a second ``GetChangeToken`` request before submitting a
        create, update, or delete request, the second ``GetChangeToken`` request returns the same value as
        the first ``GetChangeToken`` request.

        When you use a change token in a create, update, or delete request, the status of the change token
        changes to ``PENDING`` , which indicates that AWS WAF is propagating the change to all AWS WAF
        servers. Use ``GetChangeTokenStatus`` to determine the status of your change token.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetChangeToken>`_
    ...
    def get_change_token_status(
        ...
        * ``INSYNC`` : Propagation is complete.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetChangeTokenStatus>`_
        ...
        **Request Syntax**
        ...
        :param ChangeToken: **[REQUIRED]**
          ...
          The change token for which you want to get the status. This change token was previously returned
          in the ``GetChangeToken`` response.
    ...
    def get_geo_match_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetGeoMatchSet>`_
    ...
    def get_ip_set(self, IPSetId: str) -> ClientGetIpSetResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetIPSet>`_
    ...
    def get_logging_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetLoggingConfiguration>`_
    ...
    def get_permission_policy(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetPermissionPolicy>`_
    ...
    def get_rate_based_rule(self, RuleId: str) -> ClientGetRateBasedRuleResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetRateBasedRule>`_
    ...
    def get_rate_based_rule_managed_keys(
        ...
        the ``RuleId`` . The maximum number of managed keys that will be blocked is 10,000. If more than
        10,000 addresses exceed the rate limit, the 10,000 addresses with the highest rates will be blocked.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetRateBasedRuleManagedKeys>`_
    ...
    def get_regex_match_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetRegexMatchSet>`_
    ...
    def get_regex_pattern_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetRegexPatternSet>`_
    ...
    def get_rule(self, RuleId: str) -> ClientGetRuleResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetRule>`_
    ...
    def get_rule_group(self, RuleGroupId: str) -> ClientGetRuleGroupResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetRuleGroup>`_
    ...
    def get_sampled_requests(
        ...
        """
        Gets detailed information about a specified number of requests--a sample--that AWS WAF randomly
        selects from among the first 5,000 requests that your AWS resource received during a time range that
        you choose. You can specify a sample size of up to 500 requests, and you can specify any time range
        in the previous three hours.

         ``GetSampledRequests`` returns a time range, which is usually the time range that you specified.
         However, if your resource (such as a CloudFront distribution) received 5,000 requests before the
         specified time range elapsed, ``GetSampledRequests`` returns an updated time range. This new time
         range indicates the actual period during which AWS WAF selected the requests in the sample.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetSampledRequests>`_
        ...
        **Request Syntax**
        ...
        :param WebAclId: **[REQUIRED]**
          ...
          The ``WebACLId`` of the ``WebACL`` for which you want ``GetSampledRequests`` to return a sample of
          requests.
        ...
        :param TimeWindow: **[REQUIRED]**
          ...
          - **StartTime** *(datetime) --* **[REQUIRED]**
            ...
            The beginning of the time range from which you want ``GetSampledRequests`` to return a sample of
        ...
        :param MaxItems: **[REQUIRED]**
          ...
          The number of requests that you want AWS WAF to return from among the first 5,000 requests that
          your AWS resource received during the time range. If your resource received fewer requests than
          the value of ``MaxItems`` , ``GetSampledRequests`` returns information about all of them.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **SampledRequests** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Timestamp** *(datetime) --*
                  ...
                  The time at which AWS WAF received the request from your AWS resource, in Unix time format
                  (in seconds).
            ...
            - **TimeWindow** *(dict) --*
              ...
              request. However, if your AWS resource received more than 5,000 requests during the time range
              that you specified in the request, ``GetSampledRequests`` returns the time range for the first
              5,000 requests.
    ...
    def get_size_constraint_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetSizeConstraintSet>`_
    ...
    def get_sql_injection_match_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetSqlInjectionMatchSet>`_
    ...
    def get_web_acl(self, WebACLId: str) -> ClientGetWebAclResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetWebACL>`_
    ...
    def get_web_acl_for_resource(
        ...
        """
        Returns the web ACL for the specified resource, either an application load balancer or Amazon API
        Gateway stage.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetWebACLForResource>`_
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The ARN (Amazon Resource Name) of the resource for which to get the web ACL, either an application
    ...
    def get_xss_match_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/GetXssMatchSet>`_
    ...
    def list_activated_rules_in_rule_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListActivatedRulesInRuleGroup>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          group of ``ActivatedRules`` . For the second and subsequent ``ListActivatedRulesInRuleGroup``
        ...
        :param Limit:
          ...
          Specifies the number of ``ActivatedRules`` that you want AWS WAF to return for this request. If
          you have more ``ActivatedRules`` than the number that you specify for ``Limit`` , the response
          includes a ``NextMarker`` value that you can use to get another batch of ``ActivatedRules`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextMarker** *(string) --*
              ...
              submit another ``ListActivatedRulesInRuleGroup`` request, and specify the ``NextMarker`` value
            ...
            - **ActivatedRules** *(list) --*
              ...
              - *(dict) --*
                ...
                you want AWS WAF to take when a web request matches the ``Rule`` (``ALLOW`` , ``BLOCK`` , or
                ``COUNT`` ).
    ...
    def list_byte_match_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListByteMatchSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another
          group of ``ByteMatchSets`` . For the second and subsequent ``ListByteMatchSets`` requests, specify
        ...
        :param Limit:
          ...
          If you have more ``ByteMatchSets`` objects than the number you specify for ``Limit`` , the
          response includes a ``NextMarker`` value that you can use to get another batch of ``ByteMatchSet``
          objects.
    ...
    def list_geo_match_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListGeoMatchSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another
          group of ``GeoMatchSet`` objects. For the second and subsequent ``ListGeoMatchSets`` requests,
        ...
        :param Limit:
          ...
          If you have more ``GeoMatchSet`` objects than the number you specify for ``Limit`` , the response
          includes a ``NextMarker`` value that you can use to get another batch of ``GeoMatchSet`` objects.
    ...
    def list_ip_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListIPSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``IPSets`` . For the second and subsequent ``ListIPSets`` requests, specify the value of
          ``NextMarker`` from the previous response to get information about another batch of ``IPSets`` .

        :type Limit: integer
        :param Limit:

          Specifies the number of ``IPSet`` objects that you want AWS WAF to return for this request. If you
          have more ``IPSet`` objects than the number you specify for ``Limit`` , the response includes a
    ...
    def list_logging_configurations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListLoggingConfigurations>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``LoggingConfigurations`` than the value of
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another
          group of ``LoggingConfigurations`` . For the second and subsequent ``ListLoggingConfigurations``
          requests, specify the value of ``NextMarker`` from the previous response to get information about
        ...
        :param Limit:
          ...
          request. If you have more ``LoggingConfigurations`` than the number that you specify for ``Limit``
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextMarker** *(string) --*
              ...
              If you have more ``LoggingConfigurations`` than the number that you specified for ``Limit`` in
    ...
    def list_rate_based_rules(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListRateBasedRules>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``Rules`` than the value of ``Limit`` , AWS
          WAF returns a ``NextMarker`` value in the response that allows you to list another group of
          ``Rules`` . For the second and subsequent ``ListRateBasedRules`` requests, specify the value of
          ``NextMarker`` from the previous response to get information about another batch of ``Rules`` .

        :type Limit: integer
        :param Limit:

          Specifies the number of ``Rules`` that you want AWS WAF to return for this request. If you have
          more ``Rules`` than the number that you specify for ``Limit`` , the response includes a
    ...
    def list_regex_match_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListRegexMatchSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``RegexMatchSet`` objects than the value of
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another
          group of ``ByteMatchSets`` . For the second and subsequent ``ListRegexMatchSets`` requests,
          specify the value of ``NextMarker`` from the previous response to get information about another
        ...
        :param Limit:
          ...
          request. If you have more ``RegexMatchSet`` objects than the number you specify for ``Limit`` ,
          the response includes a ``NextMarker`` value that you can use to get another batch of
    ...
    def list_regex_pattern_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListRegexPatternSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``RegexPatternSet`` objects than the value
          of ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list
          another group of ``RegexPatternSet`` objects. For the second and subsequent
        ...
        :param Limit:
          ...
          Specifies the number of ``RegexPatternSet`` objects that you want AWS WAF to return for this
          request. If you have more ``RegexPatternSet`` objects than the number you specify for ``Limit`` ,
          the response includes a ``NextMarker`` value that you can use to get another batch of
    ...
    def list_resources_for_web_acl(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListResourcesForWebACL>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ResourceArns** *(list) --*
              ...
              ACL. An array with zero elements is returned if there are no resources associated with the web
              ACL.
    ...
    def list_rule_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListRuleGroups>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another group of
          ``RuleGroups`` . For the second and subsequent ``ListRuleGroups`` requests, specify the value of
          ``NextMarker`` from the previous response to get information about another batch of ``RuleGroups``
          .

        :type Limit: integer
        :param Limit:

          Specifies the number of ``RuleGroups`` that you want AWS WAF to return for this request. If you
          have more ``RuleGroups`` than the number that you specify for ``Limit`` , the response includes a
    ...
    def list_rules(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListRules>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``Rules`` than the value of ``Limit`` , AWS
          WAF returns a ``NextMarker`` value in the response that allows you to list another group of
          ``Rules`` . For the second and subsequent ``ListRules`` requests, specify the value of
          ``NextMarker`` from the previous response to get information about another batch of ``Rules`` .
    ...
    def list_size_constraint_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListSizeConstraintSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another
          group of ``SizeConstraintSets`` . For the second and subsequent ``ListSizeConstraintSets``
          requests, specify the value of ``NextMarker`` from the previous response to get information about
        ...
        :param Limit:
          ...
          Specifies the number of ``SizeConstraintSet`` objects that you want AWS WAF to return for this
          request. If you have more ``SizeConstraintSets`` objects than the number you specify for ``Limit``
          , the response includes a ``NextMarker`` value that you can use to get another batch of
    ...
    def list_sql_injection_match_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListSqlInjectionMatchSets>`_
    ...
    def list_subscribed_rule_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListSubscribedRuleGroups>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``ByteMatchSets`` subscribed rule groups
        ...
        :param Limit:
          ...
          If you have more objects than the number you specify for ``Limit`` , the response includes a
    ...
    def list_tags_for_resource(
        ...
        """
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListTagsForResource>`_
    ...
    def list_web_acls(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListWebACLs>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          If you specify a value for ``Limit`` and you have more ``WebACL`` objects than the number that you
          specify for ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to
          list another group of ``WebACL`` objects. For the second and subsequent ``ListWebACLs`` requests,
          specify the value of ``NextMarker`` from the previous response to get information about another
        ...
        :param Limit:
          ...
          Specifies the number of ``WebACL`` objects that you want AWS WAF to return for this request. If
          you have more ``WebACL`` objects than the number that you specify for ``Limit`` , the response
          includes a ``NextMarker`` value that you can use to get another batch of ``WebACL`` objects.
    ...
    def list_xss_match_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/ListXssMatchSets>`_
        ...
        **Request Syntax**
        ...
        :param NextMarker:
          ...
          ``Limit`` , AWS WAF returns a ``NextMarker`` value in the response that allows you to list another
          group of ``XssMatchSets`` . For the second and subsequent ``ListXssMatchSets`` requests, specify
          the value of ``NextMarker`` from the previous response to get information about another batch of
          ``XssMatchSets`` .
        ...
        :param Limit:
          ...
          Specifies the number of  XssMatchSet objects that you want AWS WAF to return for this request. If
          you have more ``XssMatchSet`` objects than the number you specify for ``Limit`` , the response
    ...
    def put_logging_configuration(
        ...
        * Create an Amazon Kinesis Data Firehose.  Create the data firehose with a PUT source and in the
        region that you are operating. However, if you are capturing logs for Amazon CloudFront, always
        ...
        * Associate that firehose to your web ACL using a ``PutLoggingConfiguration`` request.
        ...
        create a service linked role with the necessary permissions to write logs to the Amazon Kinesis Data
        Firehose. For more information, see `Logging Web ACL Traffic Information
        <https://docs.aws.amazon.com/waf/latest/developerguide/logging.html>`__ in the *AWS WAF Developer
        Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/PutLoggingConfiguration>`_
          ...
          - **RedactedFields** *(list) --*
            ...
            - *(dict) --*
              ...
              - **Type** *(string) --* **[REQUIRED]**
                ...
                The part of the web request that you want AWS WAF to search for a specified string. Parts of
                a request that you can search include the following:
                ...
                * ``ALL_QUERY_ARGS`` : Similar to ``SINGLE_QUERY_ARG`` , but rather than inspecting a single
                parameter, AWS WAF will inspect all parameters within the query for the value or regex
    ...
    def put_permission_policy(self, ResourceArn: str, Policy: str) -> Dict[str, Any]:
        ...
        * The ``Action`` in the policy must be ``waf:UpdateWebACL`` , ``waf-regional:UpdateWebACL`` ,
        ``waf:GetRuleGroup`` and ``waf-regional:GetRuleGroup`` . Any extra or wildcard actions in the policy
        will be rejected.
        ...
        * Your policy must be composed using IAM Policy version 2012-10-17.
        ...
        <https://docs.aws.amazon.com/IAM/latest/UserGuide/access_policies.html>`__ .

        An example of a valid policy parameter is shown in the Examples section below.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/PutPermissionPolicy>`_
    ...
    def tag_resource(
        ...
        """
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/TagResource>`_
    ...
    def untag_resource(self, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        """
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UntagResource>`_
    ...
    def update_byte_match_set(
        ...
        * The bytes (typically a string that corresponds with ASCII characters) that you want AWS WAF to
        look for. For more information, including how you specify the values for the AWS WAF API and the AWS
        ...
        * Submit an ``UpdateByteMatchSet`` request to specify the part of the request that you want AWS WAF
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateByteMatchSet>`_
          ...
          *  FieldToMatch : Contains ``Data`` and ``Type``
          ...
          - *(dict) --*
            ...
            - **ByteMatchTuple** *(dict) --* **[REQUIRED]**
              ...
              the ``ByteMatchTuple`` values must exactly match the values in the ``ByteMatchTuple`` that you
              ...
              - **PositionalConstraint** *(string) --* **[REQUIRED]**
                ...
                * ``TargetString`` is in the middle of the specified part of the web request and is preceded
                and followed by characters other than alphanumeric characters or underscore (_), for
                example, ``-BadBot;`` .
    ...
    def update_geo_match_set(
        ...
        * The ``Value`` , which is a two character code for the country to add to the ``GeoMatchConstraint``
        ...
        * Submit an ``UpdateGeoMatchSet`` request to specify the country that you want AWS WAF to watch for.
        ...
        When you update an ``GeoMatchSet`` , you specify the country that you want to add and/or the country
        that you want to delete. If you want to change a country, you delete the existing country and add
        the new one.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateGeoMatchSet>`_
        ...
        **Request Syntax**
        ...
        :param GeoMatchSetId: **[REQUIRED]**
          ...
          The ``GeoMatchSetId`` of the  GeoMatchSet that you want to update. ``GeoMatchSetId`` is returned
          by  CreateGeoMatchSet and by  ListGeoMatchSets .
    ...
    def update_ip_set(
        ...
        IPSetId: str,
        ChangeToken: str,
        Updates: List[ClientUpdateIpSetUpdatesTypeDef],
    ) -> ClientUpdateIpSetResponseTypeDef:
        """
        Inserts or deletes  IPSetDescriptor objects in an ``IPSet`` . For each ``IPSetDescriptor`` object,
        ...
        * The IP address in CIDR notation, for example, ``192.0.2.0/24`` (for the range of IP addresses from
        ...
        AWS WAF supports IPv4 address ranges: /8 and any range between /16 through /32. AWS WAF supports
        IPv6 address ranges: /24, /32, /48, /56, /64, and /128. For more information about CIDR notation,
        see the Wikipedia entry `Classless Inter-Domain Routing
        <https://en.wikipedia.org/wiki/Classless_Inter-Domain_Routing>`__ .
        ...
        * 1111::111/128
        ...
        addresses that the requests originated from. For example, if you're receiving a lot of requests from
        one or a small number of IP addresses and you want to block the requests, you can create an
        ``IPSet`` that specifies those IP addresses, and then configure AWS WAF to block the requests.
        ...
        * Submit an ``UpdateIPSet`` request to specify the IP addresses that you want AWS WAF to watch for.
        ...
        addresses that you want to delete. If you want to change an IP address, you delete the existing IP
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateIPSet>`_
        ...
        **Request Syntax**
        ...
        :param IPSetId: **[REQUIRED]**
          ...
          The ``IPSetId`` of the  IPSet that you want to update. ``IPSetId`` is returned by  CreateIPSet and
          by  ListIPSets .
    ...
    def update_rate_based_rule(
        ...
        specifies the web requests that you want to block or count. The ``RateLimit`` specifies the number
        of requests every five minutes that triggers the rule.

        If you add more than one predicate to a ``RateBasedRule`` , a request must match all the predicates
        and exceed the ``RateLimit`` to be counted or blocked. For example, suppose you add the following to
        a ``RateBasedRule`` :
        ...
        * A ``ByteMatchSet`` that matches ``BadBot`` in the ``User-Agent`` header
        ...
        You then add the ``RateBasedRule`` to a ``WebACL`` and specify that you want to block requests that
        satisfy the rule. For a request to be blocked, it must come from the IP address 192.0.2.44 *and* the
        ``User-Agent`` header in the request must contain the value ``BadBot`` . Further, requests that
        match these two conditions much be received at a rate of more than 15,000 every five minutes. If the
        ...
        * A ``TargetString`` of ``login``
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateRateBasedRule>`_
          ...
          - *(dict) --*
            ...
            - **Predicate** *(dict) --* **[REQUIRED]**
              ...
              - **Negated** *(boolean) --* **[REQUIRED]**
                ...
                includes the IP address ``192.0.2.44`` , AWS WAF will allow or block requests based on that
                IP address.
    ...
    def update_regex_match_set(
        ...
        * The part of a web request that you want AWS WAF to inspectupdate, such as a query string or the
        value of the ``User-Agent`` header.
        ...
        * Submit an ``UpdateRegexMatchSet`` request to specify the part of the request that you want AWS WAF
        to inspect (for example, the header or the URI) and the identifier of the ``RegexPatternSet`` that
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateRegexMatchSet>`_
    ...
    def update_regex_pattern_set(
        ...
        * The regular expression pattern that you want to insert or delete. For more information, see
        ...
        For example, you can create a ``RegexPatternString`` such as ``B[a@]dB[o0]t`` . AWS WAF will match
        this ``RegexPatternString`` to:
        ...
        * Submit an ``UpdateRegexPatternSet`` request to specify the regular expression pattern that you
        want AWS WAF to watch for.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateRegexPatternSet>`_
    ...
    def update_rule(
        ...
        RuleId: str,
        ChangeToken: str,
        Updates: List[ClientUpdateRuleUpdatesTypeDef],
    ) -> ClientUpdateRuleResponseTypeDef:
        """
        Inserts or deletes  Predicate objects in a ``Rule`` . Each ``Predicate`` object identifies a
        predicate, such as a  ByteMatchSet or an  IPSet , that specifies the web requests that you want to
        allow, block, or count. If you add more than one predicate to a ``Rule`` , a request must match all
        of the specifications to be allowed, blocked, or counted. For example, suppose that you add the
        following to a ``Rule`` :
        ...
        * An ``IPSet`` that matches the IP address ``192.0.2.44``
        ...
        You then add the ``Rule`` to a ``WebACL`` and specify that you want to block requests that satisfy
        the ``Rule`` . For a request to be blocked, the ``User-Agent`` header in the request must contain
        ...
        * Create and update a ``WebACL`` that contains the ``Rule`` . See  CreateWebACL .
        ...
        If you want to replace one ``ByteMatchSet`` or ``IPSet`` with another, you delete the existing one
        and add the new one.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateRule>`_
    ...
    def update_rule_group(
        self,
        RuleGroupId: str,
        Updates: List[ClientUpdateRuleGroupUpdatesTypeDef],
        ChangeToken: str,
    ) -> ClientUpdateRuleGroupResponseTypeDef:
        """
        ...
        * Create and update a ``WebACL`` that contains the ``RuleGroup`` . See  CreateWebACL .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateRuleGroup>`_
        ...
        **Request Syntax**
        ...
        :param RuleGroupId: **[REQUIRED]**
          ...
          The ``RuleGroupId`` of the  RuleGroup that you want to update. ``RuleGroupId`` is returned by
          CreateRuleGroup and by  ListRuleGroups .
          ...
          - *(dict) --*
            ...
            - **ActivatedRule** *(dict) --* **[REQUIRED]**
              ...
              - **Priority** *(integer) --* **[REQUIRED]**
                ...
                a unique integer. If you add multiple ``Rules`` to a ``WebACL`` , the values don't need to
                be consecutive.
              ...
              - **OverrideAction** *(dict) --*
                ...
                However if you first want to test the ``RuleGroup`` , set the ``OverrideAction`` to
                ``Count`` . The ``RuleGroup`` will then override any block action specified by individual
                rules contained within the group. Instead of blocking matching requests, those requests will
                be counted. You can view a record of counted requests using  GetSampledRequests .
              ...
              - **ExcludedRules** *(list) --*
                ...
                (false positives). One troubleshooting technique is to identify the specific rule within the
                rule group that is blocking the legitimate traffic and then disable (exclude) that
                particular rule. You can exclude rules from both your own rule groups and AWS Marketplace
                ...
                * Submit an  UpdateWebACL request that has two actions:
                  ...
                  * The first action deletes the existing rule group from the web ACL. That is, in the
                  UpdateWebACL request, the first ``Updates:Action`` should be ``DELETE`` and
                  ``Updates:ActivatedRule:RuleId`` should be the rule group that contains the rules that you
                  want to exclude.
                ...
                - *(dict) --*
                  ...
                  refers to a ``RuleGroup`` . The rule must belong to the ``RuleGroup`` that is specified by
                  the ``ActivatedRule`` .
    ...
    def update_size_constraint_set(
        ...
        * The part of a web request that you want AWS WAF to evaluate, such as the length of a query string
        or the length of the ``User-Agent`` header.

        * Whether to perform any transformations on the request, such as converting it to lowercase, before
        checking its length. Note that transformations of the request body are not supported because the AWS
        resource forwards only the first ``8192`` bytes of your request to AWS WAF. You can only specify a
        single type of TextTransformation.

        * A ``ComparisonOperator`` used for evaluating the selected part of the request against the
        specified ``Size`` , such as equals, greater than, less than, and so on.

        * The length, in bytes, that you want AWS WAF to watch for in selected part of the request. The
        length is computed after applying the transformation.

        For example, you can add a ``SizeConstraintSetUpdate`` object that matches web requests in which the
        length of the ``User-Agent`` header is greater than 100 bytes. You can then configure AWS WAF to
        ...
        * Submit an ``UpdateSizeConstraintSet`` request to specify the part of the request that you want AWS
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateSizeConstraintSet>`_
    ...
    def update_sql_injection_match_set(
        ...
        * ``FieldToMatch`` : The part of web requests that you want AWS WAF to inspect and, if you want AWS
        ...
        * ``TextTransformation`` : Which text transformation, if any, to perform on the web request before
        inspecting the request for snippets of malicious SQL code. You can only specify a single type of
        TextTransformation.

        You use ``SqlInjectionMatchSet`` objects to specify which CloudFront requests that you want to
        allow, block, or count. For example, if you're receiving requests that contain snippets of SQL code
        in the query string and you want to block the requests, you can create a ``SqlInjectionMatchSet``
        ...
        * Submit an ``UpdateSqlInjectionMatchSet`` request to specify the parts of web requests that you
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateSqlInjectionMatchSet>`_
    ...
    def update_web_acl(
        ...
        that you want to allow, block, or count. When you update a ``WebACL`` , you specify the following
        values:
        ...
        * For each ``Rule`` , whether you want AWS WAF to allow requests, block requests, or count requests
        that match the conditions in the ``Rule`` .
        ...
        * The order in which you want AWS WAF to evaluate the ``Rules`` in a ``WebACL`` . If you add more
        ...
        evaluated first.) When a web request matches all the predicates (such as ``ByteMatchSets`` and
        ...
        * Submit an ``UpdateWebACL`` request to specify the ``Rules`` that you want to include in the
        ``WebACL`` , to specify the default action, and to associate the ``WebACL`` with a CloudFront
        distribution.  The ``ActivatedRule`` can be a rule group. If you specify a rule group as your
        ``ActivatedRule`` , you can exclude specific rules from that rule group. If you already have a rule
        group associated with a web ACL and want to submit an ``UpdateWebACL`` request to exclude certain
        rules from that rule group, you must first remove the rule group from the web ACL, the re-insert it
        again, specifying the excluded rules. For details, see  ActivatedRule$ExcludedRules .

        Be aware that if you try to add a RATE_BASED rule to a web ACL without setting the rule type when
        first creating the rule, the  UpdateWebACL request will fail because the request tries to add a
        REGULAR rule (the default rule type) with the specified ID, which does not exist.

        For more information about how to use the AWS WAF API to allow or block HTTP requests, see the `AWS
        WAF Developer Guide <https://docs.aws.amazon.com/waf/latest/developerguide/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateWebACL>`_
        ...
        **Request Syntax**
        ...
        :param Updates:
          ...
          *  ActivatedRule : Contains ``Action`` , ``OverrideAction`` , ``Priority`` , ``RuleId`` , and
          ``Type`` . ``ActivatedRule|OverrideAction`` applies only when updating or adding a ``RuleGroup``
          to a ``WebACL`` . In this case, you do not use ``ActivatedRule|Action`` . For all other update
          requests, ``ActivatedRule|Action`` is used instead of ``ActivatedRule|OverrideAction`` .
          ...
          *  WafAction : Contains ``Type``
          ...
          - *(dict) --*
            ...
            - **ActivatedRule** *(dict) --* **[REQUIRED]**
              ...
              insert or delete, the priority of the ``Rule`` in the ``WebACL`` , and the action that you
    ...
    def update_xss_match_set(
        ...
        * ``TextTransformation`` : Which text transformation, if any, to perform on the web request before
        ...
        You use ``XssMatchSet`` objects to specify which CloudFront requests that you want to allow, block,
        or count. For example, if you're receiving requests that contain cross-site scripting attacks in the
        request body and you want to block the requests, you can create an ``XssMatchSet`` with the
        ...
        * Submit an ``UpdateXssMatchSet`` request to specify the parts of web requests that you want AWS WAF
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/waf-regional-2016-11-28/UpdateXssMatchSet>`_
