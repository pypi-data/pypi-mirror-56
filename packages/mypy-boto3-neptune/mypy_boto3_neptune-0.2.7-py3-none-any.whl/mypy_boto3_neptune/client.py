"Main interface for neptune Client"
...
class Client(BaseClient):
    ...
    def add_role_to_db_cluster(self, DBClusterIdentifier: str, RoleArn: str) -> None:
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/AddRoleToDBCluster>`_
        ...
        **Request Syntax**
        ...
        :param RoleArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the IAM role to associate with the Neptune DB cluster, for
    ...
    def add_source_identifier_to_subscription(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/AddSourceIdentifierToSubscription>`_
    ...
    def add_tags_to_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/AddTagsToResource>`_
        ...
        **Request Syntax**
        ...
        :param ResourceName: **[REQUIRED]**
          ...
          The Amazon Neptune resource that the tags are added to. This value is an Amazon Resource Name
          (ARN). For information about creating an ARN, see `Constructing an Amazon Resource Name (ARN)
          <https://docs.aws.amazon.com/neptune/latest/UserGuide/tagging.ARN.html#tagging.ARN.Constructing>`__
          .
    ...
    def apply_pending_maintenance_action(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ApplyPendingMaintenanceAction>`_
        ...
        **Request Syntax**
        ...
        :param OptInType: **[REQUIRED]**
          ...
          A value that specifies the type of opt-in request, or undoes an opt-in request. An opt-in request
          of type ``immediate`` can't be undone.
              ...
              - **PendingMaintenanceActionDetails** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **AutoAppliedAfterDate** *(datetime) --*
                    ...
                    applied to the resource during its first maintenance window after this date. If this
                  ...
                  - **CurrentApplyDate** *(datetime) --*
                    ...
                    API, the ``AutoAppliedAfterDate`` , and the ``ForcedApplyDate`` . This value is blank if
                    an opt-in request has not been received and nothing has been specified as
    ...
    def copy_db_cluster_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CopyDBClusterParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param SourceDBClusterParameterGroupIdentifier: **[REQUIRED]**
          ...
          * If the source DB cluster parameter group is in the same AWS Region as the copy, specify a valid
          DB parameter group identifier, for example ``my-db-cluster-param-group`` , or a valid ARN.
    ...
    def copy_db_cluster_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CopyDBClusterSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          The AWS AWS KMS key ID for an encrypted DB cluster snapshot. The KMS key ID is the Amazon Resource
          ...
          If you copy an encrypted DB cluster snapshot that is shared from another AWS account, then you
          ...
          - *(dict) --*
            ...
            - **DBClusterSnapshot** *(dict) --*
              ...
              - **SourceDBClusterSnapshotArn** *(string) --*
                ...
                Name (ARN) for the source DB cluster snapshot, otherwise, a null value.
    ...
    def copy_db_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CopyDBParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param SourceDBParameterGroupIdentifier: **[REQUIRED]**
          ...
          The identifier or ARN for the source DB parameter group. For information about creating an ARN,
    ...
    def create_db_cluster(
        ...
        You can use the ``ReplicationSourceIdentifier`` parameter to create the DB cluster as a Read Replica
        of another DB cluster or Amazon Neptune DB instance.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateDBCluster>`_
        ...
        **Request Syntax**
        ...
        :param OptionGroupName:
          ...
          Permanent options can't be removed from an option group. The option group can't be removed from a
        ...
        :param PreferredBackupWindow:
          ...
          <https://docs.aws.amazon.com/AmazonRDS/latest/UserGuide/AdjustingTheMaintenanceWindow.html>`__ in
        ...
        :param KmsKeyId:
          ...
          creating a DB cluster with the same AWS account that owns the KMS encryption key used to encrypt
          the new DB cluster, then you can use the KMS key alias instead of the ARN for the KMS encryption
          key.

          If an encryption key is not specified in ``KmsKeyId`` :

          * If ``ReplicationSourceIdentifier`` identifies an encrypted source, then Amazon Neptune will use
          the encryption key used to encrypt the source. Otherwise, Amazon Neptune will use your default
          encryption key.
    ...
    def create_db_cluster_parameter_group(
        ...
        A DB cluster parameter group is initially created with the default parameters for the database
        engine used by instances in the DB cluster. To provide custom values for any of the parameters, you
        must modify the group after creating it using  ModifyDBClusterParameterGroup . Once you've created a
        DB cluster parameter group, you need to associate it with your DB cluster using  ModifyDBCluster .
        When you associate a new DB cluster parameter group with a running DB cluster, you need to reboot
        ...
        .. warning::
          ...
          your first DB cluster that uses that DB cluster parameter group as the default parameter group.
          This allows Amazon Neptune to fully complete the create action before the DB cluster parameter
          ...
          *Parameter Groups* option of the `Amazon Neptune console <https://console.aws.amazon.com/rds/>`__
          or the  DescribeDBClusterParameters command to verify that your DB cluster parameter group has
          been created or modified.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateDBClusterParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param DBParameterGroupFamily: **[REQUIRED]**
          ...
          The DB cluster parameter group family name. A DB cluster parameter group can be associated with
    ...
    def create_db_cluster_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateDBClusterSnapshot>`_
    ...
    def create_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateDBInstance>`_
        ...
        **Request Syntax**
        ...
        :param VpcSecurityGroupIds:
          ...
          Not applicable. The associated list of EC2 VPC security groups is managed by the DB cluster. For
        ...
        :param OptionGroupName:
          ...
          an option group, and that option group can't be removed from a DB instance once it is associated
          with a DB instance
        ...
        :param KmsKeyId:
          ...
          The KMS key identifier is the Amazon Resource Name (ARN) for the KMS encryption key. If you are
          creating a DB instance with the same AWS account that owns the KMS encryption key used to encrypt
          the new DB instance, then you can use the KMS key alias instead of the ARN for the KM encryption
          key.
          ...
          parameter, then Amazon Neptune will use your default encryption key. AWS KMS creates the default
          encryption key for your AWS account. Your AWS account has a different default encryption key for
          each AWS Region.
        ...
        :param PerformanceInsightsKMSKeyId:
          ...
          The AWS KMS key identifier for encryption of Performance Insights data. The KMS key ID is the
          Amazon Resource Name (ARN), KMS key identifier, or the KMS key alias for the KMS encryption key.
          ...
          - *(dict) --*
            ...
            - **DBInstance** *(dict) --*
              ...
              - **DbiResourceId** *(string) --*
                ...
                The AWS Region-unique, immutable identifier for the DB instance. This identifier is found in
                AWS CloudTrail log entries whenever the AWS KMS key for the DB instance is accessed.
              ...
              - **PromotionTier** *(integer) --*
                ...
                A value that specifies the order in which a Read Replica is promoted to the primary instance
                after a failure of the existing primary instance.
    ...
    def create_db_parameter_group(
        ...
        after creating it using *ModifyDBParameterGroup* . Once you've created a DB parameter group, you
        need to associate it with your DB instance using *ModifyDBInstance* . When you associate a new DB
        parameter group with a running DB instance, you need to reboot the DB instance without failover for
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateDBParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param DBParameterGroupFamily: **[REQUIRED]**
          ...
          DB parameter group family, and can be applied only to a DB instance running a database engine and
    ...
    def create_db_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateDBSubnetGroup>`_
    ...
    def create_event_subscription(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/CreateEventSubscription>`_
        ...
        **Request Syntax**
        ...
        :param EventCategories:
          ...
          the categories for a given SourceType by using the **DescribeEventCategories** action.
    ...
    def delete_db_cluster(
        ...
        cluster snapshots of the specified DB cluster are not deleted.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBCluster>`_
    ...
    def delete_db_cluster_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBClusterParameterGroup>`_
    ...
    def delete_db_cluster_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBClusterSnapshot>`_
    ...
    def delete_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBInstance>`_
        ...
        **Request Syntax**
        ...
        :param SkipFinalSnapshot:
          ...
          is specified, no DBSnapshot is created. If ``false`` is specified, a DB snapshot is created before
    ...
    def delete_db_parameter_group(self, DBParameterGroupName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBParameterGroup>`_
    ...
    def delete_db_subnet_group(self, DBSubnetGroupName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteDBSubnetGroup>`_
    ...
    def delete_event_subscription(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DeleteEventSubscription>`_
    ...
    def describe_db_cluster_parameter_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBClusterParameterGroups>`_
    ...
    def describe_db_cluster_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBClusterParameters>`_
    ...
    def describe_db_cluster_snapshot_attributes(
        ...
        ``restore`` attribute and a list of IDs for the AWS accounts that are authorized to copy or restore
        the manual DB cluster snapshot. If ``all`` is included in the list of values for the ``restore``
        attribute, then the manual DB cluster snapshot is public and can be copied or restored by all AWS
        accounts.

        To add or remove access for an AWS account to copy or restore a manual DB cluster snapshot, or to
        make the manual DB cluster snapshot public or private, use the  ModifyDBClusterSnapshotAttribute API
        action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBClusterSnapshotAttributes>`_
    ...
    def describe_db_cluster_snapshots(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBClusterSnapshots>`_
        ...
        **Request Syntax**
        ...
        :param SnapshotType:
          ...
          * ``public`` - Return all DB cluster snapshots that have been marked as public.
          ...
          ``IncludeShared`` parameter to ``true`` . You can include public DB cluster snapshots with these
        ...
        :param IncludeShared:
          ...
          True to include shared manual DB cluster snapshots from other AWS accounts that this AWS account
        ...
        :param IncludePublic:
          ...
          AWS account, and otherwise false. The default is ``false`` . The default is false.
    ...
    def describe_db_clusters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBClusters>`_
    ...
    def describe_db_engine_versions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBEngineVersions>`_
    ...
    def describe_db_parameter_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBParameterGroups>`_
    ...
    def describe_db_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBParameters>`_
    ...
    def describe_db_subnet_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeDBSubnetGroups>`_
    ...
    def describe_engine_default_cluster_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeEngineDefaultClusterParameters>`_
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          request. If this parameter is specified, the response includes only records beyond the marker, up
    ...
    def describe_engine_default_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeEngineDefaultParameters>`_
    ...
    def describe_event_categories(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeEventCategories>`_
    ...
    def describe_event_subscriptions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeEventSubscriptions>`_
    ...
    def describe_events(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeEvents>`_
        ...
        **Request Syntax**
        ...
        :param SourceIdentifier:
          ...
          The identifier of the event source for which events are returned. If not specified, then all
    ...
    def describe_orderable_db_instance_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeOrderableDBInstanceOptions>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **OrderableDBInstanceOptions** *(list) --*
              ...
              An  OrderableDBInstanceOption structure containing information about orderable options for the
              DB instance.
    ...
    def describe_pending_maintenance_actions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribePendingMaintenanceActions>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``db-instance-id`` - Accepts DB instance identifiers and DB instance ARNs. The results list will
        ...
        :param Marker:
          ...
          If this parameter is specified, the response includes only records beyond the marker, up to a
    ...
    def describe_valid_db_instance_modifications(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/DescribeValidDBInstanceModifications>`_
    ...
    def failover_db_cluster(
        ...
        Amazon Neptune will automatically fail over to a Read Replica, if one exists, when the primary
        instance fails. You can force a failover when you want to simulate a failure of a primary instance
        for testing. Because each instance in a DB cluster has its own endpoint address, you will need to
        clean up and re-establish any existing connections that use those endpoint addresses when the
        failover is complete.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/FailoverDBCluster>`_
    ...
    def list_tags_for_resource(
        self,
        ResourceName: str,
        Filters: List[ClientListTagsForResourceFiltersTypeDef] = None,
    ) -> ClientListTagsForResourceResponseTypeDef:
        """
        Lists all tags on an Amazon Neptune resource.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ListTagsForResource>`_
        ...
        **Request Syntax**
        ...
        :param ResourceName: **[REQUIRED]**
          ...
          The Amazon Neptune resource with tags to be listed. This value is an Amazon Resource Name (ARN).
    ...
    def modify_db_cluster(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBCluster>`_
        ...
        **Request Syntax**
        ...
        :param NewDBClusterIdentifier:
          ...
          The new DB cluster identifier for the DB cluster when renaming a DB cluster. This value is stored
        ...
        :param ApplyImmediately:
          ...
          ``MasterUserPassword`` values. If you set the ``ApplyImmediately`` parameter value to false, then
          changes to the ``NewDBClusterIdentifier`` and ``MasterUserPassword`` values are applied during the
        ...
        :param OptionGroupName:
          ...
          is applied during the next maintenance window unless the ``ApplyImmediately`` parameter is set to
          ``true`` for this request. If the parameter change results in an option group that enables OEM,
          this change can cause a brief (sub-second) period during which new connections are rejected but
    ...
    def modify_db_cluster_parameter_group(
        ...
        list of the following: ``ParameterName`` , ``ParameterValue`` , and ``ApplyMethod`` . A maximum of
        ...
        .. warning::
          ...
          After you create a DB cluster parameter group, you should wait at least 5 minutes before creating
          your first DB cluster that uses that DB cluster parameter group as the default parameter group.
          This allows Amazon Neptune to fully complete the create action before the parameter group is used
          ...
          database defined by the ``character_set_database`` parameter. You can use the *Parameter Groups*
          option of the Amazon Neptune console or the  DescribeDBClusterParameters command to verify that
          your DB cluster parameter group has been created or modified.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBClusterParameterGroup>`_
    ...
    def modify_db_cluster_snapshot_attribute(
        ...
        manual DB cluster snapshot public, which means that it can be copied or restored by all AWS
        accounts. Do not add the ``all`` value for any manual DB cluster snapshots that contain private
        information that you don't want available to all AWS accounts. If a manual DB cluster snapshot is
        encrypted, it can be shared, but only by specifying a list of authorized AWS account IDs for the
        ``ValuesToAdd`` parameter. You can't use ``all`` as a value for that parameter in this case.

        To view which AWS accounts have access to copy or restore a manual DB cluster snapshot, or whether a
        manual DB cluster snapshot public or private, use the  DescribeDBClusterSnapshotAttributes API
        action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBClusterSnapshotAttribute>`_
        ...
        **Request Syntax**
        ...
        :param ValuesToAdd:
          ...
          include one or more AWS account IDs, or ``all`` to make the manual DB cluster snapshot restorable
          by any AWS account. Do not add the ``all`` value for any manual DB cluster snapshots that contain
        ...
        :param ValuesToRemove:
          ...
          To remove authorization for other AWS accounts to copy or restore a manual DB cluster snapshot,
          set this list to include one or more AWS account identifiers, or ``all`` to remove authorization
          for any AWS account to copy or restore the DB cluster snapshot. If you specify ``all`` , an AWS
    ...
    def modify_db_instance(
        ...
        make to your DB instance, call  DescribeValidDBInstanceModifications before you call
        ModifyDBInstance .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBInstance>`_
        ...
        **Request Syntax**
        ...
        :param DBInstanceClass:
          ...
          If you modify the DB instance class, an outage occurs during the change. The change is applied
        ...
        :param DBSubnetGroupName:
          ...
          The new DB subnet group for the DB instance. You can use this parameter to move your DB instance
          to a different VPC.

          Changing the subnet group causes an outage during the change. The change is applied during the
          next maintenance window, unless you specify ``true`` for the ``ApplyImmediately`` parameter.
        ...
        :param DBParameterGroupName:
          ...
          The name of the DB parameter group to apply to the DB instance. Changing this setting doesn't
          result in an outage. The parameter group name itself is changed immediately, but the actual
          parameter changes are not applied until you reboot the instance without failover. The db instance
          will NOT be rebooted automatically and the parameter changes will NOT be applied during the next
          maintenance window.

          Default: Uses existing setting

          Constraints: The DB parameter group must be in the same DB parameter group family as this DB
          instance.
        ...
        :param PreferredMaintenanceWindow:
          ...
          outage. Changing this parameter doesn't result in an outage, except in the following situation,
          and the change is asynchronously applied as soon as possible. If there are pending actions that
          cause a reboot, and the maintenance window is changed to include the current time, then changing
          this parameter will cause a reboot of the DB instance. If moving this window to the current time,
        ...
        :param MultiAZ:
          ...
          Specifies if the DB instance is a Multi-AZ deployment. Changing this parameter doesn't result in
          an outage and the change is applied during the next maintenance window unless the
          ``ApplyImmediately`` parameter is set to ``true`` for this request.

        :type EngineVersion: string
        :param EngineVersion:

          The version number of the database engine to upgrade to. Changing this parameter results in an
          ...
          parameter group in the DB parameter group family for the new engine version must be specified. The
          new DB parameter group can be the default for that DB parameter group family.
        ...
        :param AutoMinorVersionUpgrade:
          ...
          maintenance window. Changing this parameter doesn't result in an outage except in the following
          case and the change is asynchronously applied as soon as possible. An outage will result if this
          parameter is set to ``true`` during the maintenance window, and a newer minor version is
          available, and Neptune has enabled auto patching for that engine version.
        ...
        :param OptionGroupName:
          ...
          parameter doesn't result in an outage except in the following case and the change is applied
          during the next maintenance window unless the ``ApplyImmediately`` parameter is set to ``true``
          for this request. If the parameter change results in an option group that enables OEM, this change
          can cause a brief (sub-second) period during which new connections are rejected but existing
        ...
        :param NewDBInstanceIdentifier:
          ...
          The new DB instance identifier for the DB instance when renaming a DB instance. When you change
          the DB instance identifier, an instance reboot will occur immediately if you set ``Apply
          Immediately`` to true, or will occur during the next maintenance window if ``Apply Immediately``
        ...
        :param PromotionTier:
          ...
          A value that specifies the order in which a Read Replica is promoted to the primary instance after
        ...
        :param EnableIAMDatabaseAuthentication:
          ...
          Not applicable. Mapping AWS IAM accounts to database accounts is managed by the DB cluster. For
          more information, see  ModifyDBCluster .
    ...
    def modify_db_parameter_group(
        ...
        the following: ``ParameterName`` , ``ParameterValue`` , and ``ApplyMethod`` . A maximum of 20
        parameters can be modified in a single request.

        .. note::

          Changes to dynamic parameters are applied immediately. Changes to static parameters require a
          reboot without failover to the DB instance associated with the parameter group before the change
          can take effect.
        ...
        .. warning::
          ...
          first DB instance that uses that DB parameter group as the default parameter group. This allows
          Amazon Neptune to fully complete the modify action before the parameter group is used as the
          default for a new DB instance. This is especially important for parameters that are critical when
          creating the default database for a DB instance, such as the character set for the default
          database defined by the ``character_set_database`` parameter. You can use the *Parameter Groups*
          option of the Amazon Neptune console or the *DescribeDBParameters* command to verify that your DB
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param Parameters: **[REQUIRED]**
          ...
          .. note::
            ...
            value for both dynamic and static parameters, and changes are applied when you reboot the DB
    ...
    def modify_db_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyDBSubnetGroup>`_
    ...
    def modify_event_subscription(
        ...
        **DescribeEventCategories** action.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ModifyEventSubscription>`_
    ...
    def promote_read_replica_db_cluster(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/PromoteReadReplicaDBCluster>`_
    ...
    def reboot_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RebootDBInstance>`_
    ...
    def remove_role_from_db_cluster(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RemoveRoleFromDBCluster>`_
    ...
    def remove_source_identifier_from_subscription(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RemoveSourceIdentifierFromSubscription>`_
    ...
    def remove_tags_from_resource(self, ResourceName: str, TagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RemoveTagsFromResource>`_
    ...
    def reset_db_cluster_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ResetDBClusterParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param ResetAllParameters:
          ...
          default values, and ``false`` otherwise. You can't use this parameter if there is a list of
    ...
    def reset_db_parameter_group(
        ...
        ``ResetAllParameters`` parameters. When resetting the entire group, dynamic parameters are updated
        immediately and static parameters are set to ``pending-reboot`` to take effect on the next DB
        instance restart or ``RebootDBInstance`` request.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/ResetDBParameterGroup>`_
    ...
    def restore_db_cluster_from_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RestoreDBClusterFromSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param AvailabilityZones:
          ...
          Provides the list of EC2 Availability Zones that instances in the restored DB cluster can be
          created in.
        ...
        :param KmsKeyId:
          ...
          The KMS key identifier is the Amazon Resource Name (ARN) for the KMS encryption key. If you are
          restoring a DB cluster with the same AWS account that owns the KMS encryption key used to encrypt
          the new DB cluster, then you can use the KMS key alias instead of the ARN for the KMS encryption
          key.
    ...
    def restore_db_cluster_to_point_in_time(
        ...
        ``LatestRestorableTime`` for up to ``BackupRetentionPeriod`` days. The target DB cluster is created
        from the source DB cluster with the same configuration as the original DB cluster, except that the
        new DB cluster is created with the default DB security group.

        .. note::

          This action only restores the DB cluster, not the DB instances for that DB cluster. You must
          invoke the  CreateDBInstance action to create DB instances for the restored DB cluster, specifying
          the identifier of the restored DB cluster in ``DBClusterIdentifier`` . You can create DB instances
          only after the ``RestoreDBClusterToPointInTime`` action has completed and the DB cluster is
          available.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/neptune-2014-10-31/RestoreDBClusterToPointInTime>`_
        ...
        **Request Syntax**
        ...
        :param UseLatestRestorableTime:
          ...
          A value that is set to ``true`` to restore the DB cluster to the latest restorable backup time,
          and ``false`` otherwise.
        ...
        :param KmsKeyId:
          ...
          The AWS KMS key identifier to use when restoring an encrypted DB cluster from an encrypted DB
          cluster.
          ...
          different than the KMS key used to encrypt the source DB cluster. The new DB cluster is encrypted
          with the KMS key identified by the ``KmsKeyId`` parameter.

          If you do not specify a value for the ``KmsKeyId`` parameter, then the following will occur:

          * If the DB cluster is encrypted, then the restored DB cluster is encrypted using the KMS key that
          was used to encrypt the source DB cluster.

          * If the DB cluster is not encrypted, then the restored DB cluster is not encrypted.

          If ``DBClusterIdentifier`` refers to a DB cluster that is not encrypted, then the restore request
          is rejected.
