...
class ClientAddSourceIdentifierToSubscriptionResponseEventSubscriptionTypeDef(
    ...
    - **Status** *(string) --*
      ...
      The status "no-permission" indicates that Neptune no longer has permission to post to the SNS
...
class ClientApplyPendingMaintenanceActionResponseResourcePendingMaintenanceActionsPendingMaintenanceActionDetailsTypeDef(
    ...
    - **CurrentApplyDate** *(datetime) --*
      ...
      The effective date when the pending maintenance action is applied to the resource. This date
      takes into account opt-in requests received from the  ApplyPendingMaintenanceAction API, the
...
class ClientCopyDbParameterGroupResponseDBParameterGroupTypeDef(
    ...
    - **DBParameterGroupFamily** *(string) --*
      ...
      Provides the name of the DB parameter group family that this DB parameter group is compatible
      with.
...
class ClientCreateDbClusterResponseDBClusterAssociatedRolesTypeDef(
    ...
    - **Status** *(string) --*
      ...
      * ``ACTIVE`` - the IAM role ARN is associated with the DB cluster and can be used to access
      other AWS services on your behalf.

      * ``PENDING`` - the IAM role ARN is being associated with the DB cluster.

      * ``INVALID`` - the IAM role ARN is associated with the DB cluster, but the DB cluster is
...
class ClientCreateDbClusterResponseDBClusterTypeDef(_ClientCreateDbClusterResponseDBClusterTypeDef):
    ...
    - **DatabaseName** *(string) --*
      ...
      Contains the name of the initial database of this DB cluster that was provided at create time,
      if one was specified when the DB cluster was created. This same name is returned for the life
      of the DB cluster.
    ...
    - **AssociatedRoles** *(list) --*
      ...
      the DB cluster. IAM roles that are associated with a DB cluster grant permission for the DB
...
class ClientCreateDbInstanceResponseDBInstanceDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientCreateDbInstanceResponseDBInstanceDBSubnetGroupSubnets`
...
class ClientCreateDbInstanceResponseDBInstancePendingModifiedValuesPendingCloudwatchLogsExportsTypeDef(
    ...
    """
    Type definition for `ClientCreateDbInstanceResponseDBInstancePendingModifiedValues`
    ...
    - **LogTypesToEnable** *(list) --*
      ...
      Log types that are in the process of being deactivated. After they are deactivated, these log
      types aren't exported to CloudWatch Logs.

      - *(string) --*

    - **LogTypesToDisable** *(list) --*

      Log types that are in the process of being enabled. After they are enabled, these log types
      are exported to CloudWatch Logs.
...
class ClientCreateDbInstanceResponseDBInstancePendingModifiedValuesTypeDef(
    ...
    - **DBInstanceClass** *(string) --*
      ...
      Contains the new ``DBInstanceClass`` for the DB instance that will be applied or is currently
      being applied.
...
class ClientCreateDbInstanceResponseDBInstanceStatusInfosTypeDef(
    ...
    - **Normal** *(boolean) --*
      ...
      Boolean value that is true if the instance is operating normally, or false if the instance is
      in an error state.
...
class ClientCreateDbSubnetGroupResponseDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientCreateDbSubnetGroupResponseDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientDeleteDbInstanceResponseDBInstanceDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientDeleteDbInstanceResponseDBInstanceDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientDeleteDbInstanceResponseDBInstancePendingModifiedValuesPendingCloudwatchLogsExportsTypeDef(
    ...
    """
    Type definition for `ClientDeleteDbInstanceResponseDBInstancePendingModifiedValues`
    `PendingCloudwatchLogsExports`
...
_ClientDescribeDbClusterParameterGroupsFiltersTypeDef = TypedDict(
    "_ClientDescribeDbClusterParameterGroupsFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
_ClientDescribeDbClusterParametersFiltersTypeDef = TypedDict(
    "_ClientDescribeDbClusterParametersFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribeDbClusterSnapshotAttributesResponseDBClusterSnapshotAttributesResultDBClusterSnapshotAttributesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDbClusterSnapshotAttributesResponseDBClusterSnapshotAttributesResult`
    `DBClusterSnapshotAttributes`

    Contains the name and values of a manual DB cluster snapshot attribute.

    Manual DB cluster snapshot attributes are used to authorize other AWS accounts to restore a
    manual DB cluster snapshot. For more information, see the  ModifyDBClusterSnapshotAttribute API
    action.
    ...
    - **AttributeName** *(string) --*
      ...
      The attribute named ``restore`` refers to the list of AWS accounts that have permission to
    ...
    - **AttributeValues** *(list) --*
      ...
      of the AWS accounts that are authorized to copy or restore the manual DB cluster snapshot. If
      a value of ``all`` is in the list, then the manual DB cluster snapshot is public and available
...
class ClientDescribeDbClusterSnapshotAttributesResponseDBClusterSnapshotAttributesResultTypeDef(
    ...
    """
    Type definition for `ClientDescribeDbClusterSnapshotAttributesResponse`
    ...
    - **DBClusterSnapshotAttributes** *(list) --*
      ...
      - *(dict) --*
        ...
        - **AttributeValues** *(list) --*
          ...
          IDs of the AWS accounts that are authorized to copy or restore the manual DB cluster
...
_ClientDescribeDbClusterSnapshotsFiltersTypeDef = TypedDict(
    "_ClientDescribeDbClusterSnapshotsFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribeDbClustersResponseDBClustersDBClusterOptionGroupMembershipsTypeDef(
    ...
    """
    Type definition for `ClientDescribeDbClustersResponseDBClusters`
...
class ClientDescribeDbEngineVersionsResponseDBEngineVersionsDefaultCharacterSetTypeDef(
    ...
    """
    Type definition for `ClientDescribeDbEngineVersionsResponseDBEngineVersions`
    `DefaultCharacterSet`
...
class ClientDescribeDbEngineVersionsResponseDBEngineVersionsValidUpgradeTargetTypeDef(
    ...
    - **AutoUpgrade** *(boolean) --*
      ...
      A value that indicates whether the target version is applied to any source DB instances that
...
class ClientDescribeDbEngineVersionsResponseDBEngineVersionsTypeDef(
    ...
    - **SupportedCharacterSets** *(list) --*
      ...
      A list of the character sets supported by this engine for the ``CharacterSetName`` parameter
    ...
    - **SupportsLogExportsToCloudwatchLogs** *(boolean) --*
      ...
      A value that indicates whether the engine version supports exporting the log types specified
...
class ClientDescribeDbInstancesResponseDBInstancesDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientDescribeDbInstancesResponseDBInstancesDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientDescribeDbInstancesResponseDBInstancesPendingModifiedValuesPendingCloudwatchLogsExportsTypeDef(
    ...
    """
    Type definition for `ClientDescribeDbInstancesResponseDBInstancesPendingModifiedValues`
    `PendingCloudwatchLogsExports`
...
class ClientDescribeDbSubnetGroupsResponseDBSubnetGroupsSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientDescribeDbSubnetGroupsResponseDBSubnetGroupsSubnets`
    `SubnetAvailabilityZone`
...
class ClientDescribeEngineDefaultClusterParametersResponseEngineDefaultsParametersTypeDef(
    ...
    """
    Type definition for `ClientDescribeEngineDefaultClusterParametersResponseEngineDefaults`
    `Parameters`
...
class ClientDescribeEngineDefaultClusterParametersResponseEngineDefaultsTypeDef(
    ...
    - **Marker** *(string) --*
      ...
      An optional pagination token provided by a previous EngineDefaults request. If this parameter
      is specified, the response includes only records beyond the marker, up to the value specified
      by ``MaxRecords`` .
...
_ClientDescribeEngineDefaultParametersFiltersTypeDef = TypedDict(
    "_ClientDescribeEngineDefaultParametersFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
_ClientDescribeOrderableDbInstanceOptionsFiltersTypeDef = TypedDict(
    "_ClientDescribeOrderableDbInstanceOptionsFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class ClientDescribeOrderableDbInstanceOptionsResponseOrderableDBInstanceOptionsAvailabilityZonesTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrderableDbInstanceOptionsResponseOrderableDBInstanceOptions`
    `AvailabilityZones`
...
class ClientDescribeOrderableDbInstanceOptionsResponseOrderableDBInstanceOptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeOrderableDbInstanceOptionsResponse`
...
class ClientDescribeValidDbInstanceModificationsResponseValidDBInstanceModificationsMessageStorageIopsToStorageRatioTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeValidDbInstanceModificationsResponseValidDBInstanceModificationsMessageStorage`
    `IopsToStorageRatio`
...
class ClientDescribeValidDbInstanceModificationsResponseValidDBInstanceModificationsMessageStorageProvisionedIopsTypeDef(
    ...
    - **Step** *(integer) --*
      ...
      The step value for the range. For example, if you have a range of 5,000 to 10,000, with a step
      value of 1,000, the valid values start at 5,000 and step up by 1,000. Even though 7,500 is
      within the range, it isn't a valid value for the range. The valid values are 5,000, 6,000,
      7,000, 8,000...
    """
...
class ClientDescribeValidDbInstanceModificationsResponseValidDBInstanceModificationsMessageStorageTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeValidDbInstanceModificationsResponseValidDBInstanceModificationsMessage`
    `Storage`
...
class ClientDescribeValidDbInstanceModificationsResponseValidDBInstanceModificationsMessageTypeDef(
    ...
    """
    Type definition for `ClientDescribeValidDbInstanceModificationsResponse`
    `ValidDBInstanceModificationsMessage`

    Information about valid modifications that you can make to your DB instance. Contains the result
    of a successful call to the  DescribeValidDBInstanceModifications action. You can use this
        ...
        - **StorageSize** *(list) --*
          ...
          - *(dict) --*
            ...
            - **Step** *(integer) --*
              ...
              with a step value of 1,000, the valid values start at 5,000 and step up by 1,000. Even
              though 7,500 is within the range, it isn't a valid value for the range. The valid
...
class ClientModifyDbClusterSnapshotAttributeResponseDBClusterSnapshotAttributesResultDBClusterSnapshotAttributesTypeDef(
    ...
    """
    Type definition for
    `ClientModifyDbClusterSnapshotAttributeResponseDBClusterSnapshotAttributesResult`
    `DBClusterSnapshotAttributes`
...
class ClientModifyDbClusterSnapshotAttributeResponseDBClusterSnapshotAttributesResultTypeDef(
    ...
    """
    Type definition for `ClientModifyDbClusterSnapshotAttributeResponse`
    `DBClusterSnapshotAttributesResult`
...
class ClientModifyDbInstanceResponseDBInstanceDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientModifyDbInstanceResponseDBInstanceDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientModifyDbInstanceResponseDBInstancePendingModifiedValuesPendingCloudwatchLogsExportsTypeDef(
    ...
    """
    Type definition for `ClientModifyDbInstanceResponseDBInstancePendingModifiedValues`
    `PendingCloudwatchLogsExports`
...
class ClientModifyDbSubnetGroupResponseDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientModifyDbSubnetGroupResponseDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientPromoteReadReplicaDbClusterResponseDBClusterDBClusterOptionGroupMembershipsTypeDef(
    ...
    """
    Type definition for `ClientPromoteReadReplicaDbClusterResponseDBCluster`
    `DBClusterOptionGroupMemberships`
...
class ClientRebootDbInstanceResponseDBInstanceDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `ClientRebootDbInstanceResponseDBInstanceDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class ClientRebootDbInstanceResponseDBInstancePendingModifiedValuesPendingCloudwatchLogsExportsTypeDef(
    ...
    """
    Type definition for `ClientRebootDbInstanceResponseDBInstancePendingModifiedValues`
    `PendingCloudwatchLogsExports`
...
class ClientRestoreDbClusterFromSnapshotResponseDBClusterDBClusterOptionGroupMembershipsTypeDef(
    ...
    """
    Type definition for `ClientRestoreDbClusterFromSnapshotResponseDBCluster`
    `DBClusterOptionGroupMemberships`
...
class ClientRestoreDbClusterToPointInTimeResponseDBClusterDBClusterOptionGroupMembershipsTypeDef(
    ...
    """
    Type definition for `ClientRestoreDbClusterToPointInTimeResponseDBCluster`
    `DBClusterOptionGroupMemberships`
...
_DescribeDBClusterParameterGroupsPaginateFiltersTypeDef = TypedDict(
    "_DescribeDBClusterParameterGroupsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeDBClusterParameterGroupsPaginateResponseDBClusterParameterGroupsTypeDef(
    ...
    """
    Type definition for `DescribeDBClusterParameterGroupsPaginateResponse`
...
_DescribeDBClusterParametersPaginateFiltersTypeDef = TypedDict(
    "_DescribeDBClusterParametersPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
_DescribeDBClusterSnapshotsPaginateFiltersTypeDef = TypedDict(
    "_DescribeDBClusterSnapshotsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeDBClustersPaginateResponseDBClustersDBClusterOptionGroupMembershipsTypeDef(
    ...
    """
    Type definition for `DescribeDBClustersPaginateResponseDBClusters`
    `DBClusterOptionGroupMemberships`
...
_DescribeDBEngineVersionsPaginateFiltersTypeDef = TypedDict(
    "_DescribeDBEngineVersionsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeDBEngineVersionsPaginateResponseDBEngineVersionsDefaultCharacterSetTypeDef(
    ...
    """
    Type definition for `DescribeDBEngineVersionsPaginateResponseDBEngineVersions`
    `DefaultCharacterSet`
...
class DescribeDBInstancesPaginateResponseDBInstancesDBSubnetGroupSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `DescribeDBInstancesPaginateResponseDBInstancesDBSubnetGroupSubnets`
    `SubnetAvailabilityZone`
...
class DescribeDBInstancesPaginateResponseDBInstancesPendingModifiedValuesPendingCloudwatchLogsExportsTypeDef(
    ...
    """
    Type definition for `DescribeDBInstancesPaginateResponseDBInstancesPendingModifiedValues`
    `PendingCloudwatchLogsExports`
...
_DescribeDBParameterGroupsPaginateFiltersTypeDef = TypedDict(
    "_DescribeDBParameterGroupsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeDBSubnetGroupsPaginateResponseDBSubnetGroupsSubnetsSubnetAvailabilityZoneTypeDef(
    ...
    """
    Type definition for `DescribeDBSubnetGroupsPaginateResponseDBSubnetGroupsSubnets`
    `SubnetAvailabilityZone`
...
_DescribeEngineDefaultParametersPaginateFiltersTypeDef = TypedDict(
    "_DescribeEngineDefaultParametersPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
_DescribeOrderableDBInstanceOptionsPaginateFiltersTypeDef = TypedDict(
    "_DescribeOrderableDBInstanceOptionsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribeOrderableDBInstanceOptionsPaginateResponseOrderableDBInstanceOptionsAvailabilityZonesTypeDef(
    ...
    """
    Type definition for
    `DescribeOrderableDBInstanceOptionsPaginateResponseOrderableDBInstanceOptions`
    `AvailabilityZones`
...
class DescribeOrderableDBInstanceOptionsPaginateResponseOrderableDBInstanceOptionsTypeDef(
    ...
    """
    Type definition for `DescribeOrderableDBInstanceOptionsPaginateResponse`
    `OrderableDBInstanceOptions`
...
_DescribePendingMaintenanceActionsPaginateFiltersTypeDef = TypedDict(
    "_DescribePendingMaintenanceActionsPaginateFiltersTypeDef", {"Name": str, "Values": List[str]}
)
...
class DescribePendingMaintenanceActionsPaginateResponsePendingMaintenanceActionsPendingMaintenanceActionDetailsTypeDef(
    ...
    """
    Type definition for `DescribePendingMaintenanceActionsPaginateResponsePendingMaintenanceActions`
    `PendingMaintenanceActionDetails`
...
class DescribePendingMaintenanceActionsPaginateResponsePendingMaintenanceActionsTypeDef(
    ...
    """
    Type definition for `DescribePendingMaintenanceActionsPaginateResponse`
    `PendingMaintenanceActions`
