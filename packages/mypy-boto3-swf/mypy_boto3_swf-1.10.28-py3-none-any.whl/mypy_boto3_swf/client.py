...
import mypy_boto3_swf.client as client_scope

# pylint: disable=import-self
import mypy_boto3_swf.paginator as paginator_scope
...
class Client(BaseClient):
    ...
    def count_closed_workflow_executions(
        ...
        *Amazon SWF Developer Guide* .
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/CountClosedWorkflowExecutions>`_
    ...
    def count_open_workflow_executions(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/CountOpenWorkflowExecutions>`_
    ...
    def count_pending_activity_tasks(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/CountPendingActivityTasks>`_
    ...
    def count_pending_decision_tasks(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/CountPendingDecisionTasks>`_
    ...
    def deprecate_activity_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DeprecateActivityType>`_
    ...
    def deprecate_domain(self, name: str) -> None:
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DeprecateDomain>`_
    ...
    def deprecate_workflow_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DeprecateWorkflowType>`_
    ...
    def describe_activity_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DescribeActivityType>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **typeInfo** *(dict) --*
              ...
              * ``DEPRECATED`` – The type was deprecated using  DeprecateActivityType , but is still
              in use. You should keep workers supporting this type running. You cannot create new
              tasks of this type.
            ...
            - **configuration** *(dict) --*
              ...
              - **defaultTaskList** *(dict) --*
                ...
                ``ScheduleActivityTask``   Decision . You can override the default registered task
              ...
              - **defaultTaskScheduleToStartTimeout** *(string) --*
                ...
                The default maximum duration, specified when registering the activity type, that a
                task of an activity type can wait before being assigned to a worker. You can
              ...
              - **defaultTaskScheduleToCloseTimeout** *(string) --*
                ...
                tasks of this activity type. You can override this default when scheduling a task
                through the ``ScheduleActivityTask``   Decision .
    ...
    def describe_domain(self, name: str) -> ClientDescribeDomainResponseTypeDef:
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DescribeDomain>`_
    ...
    def describe_workflow_execution(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DescribeWorkflowExecution>`_
          ...
          - *(dict) --*
            ...
            - **executionConfiguration** *(dict) --*
              ...
              - **childPolicy** *(string) --*
                ...
                terminated, by calling the  TerminateWorkflowExecution action explicitly or due to
                an expired timeout.
                ...
                * ``REQUEST_CANCEL`` – A request to cancel is attempted for each child execution by
                ...
                the decider to take appropriate actions when it receives an execution history with
                this event.
            ...
            - **latestExecutionContext** *(string) --*
              ...
              task using  RespondDecisionTaskCompleted .
    ...
    def describe_workflow_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/DescribeWorkflowType>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **typeInfo** *(dict) --*
              ...
              * ``DEPRECATED`` – The type was deprecated using  DeprecateWorkflowType , but is still
              in use. You should keep workers supporting this type running. You cannot create new
            ...
            - **configuration** *(dict) --*
              ...
              - **defaultTaskStartToCloseTimeout** *(string) --*
                ...
                decision task for executions of this workflow type might take before returning
                completion or failure. If the task doesn'tdo close in the specified time then the
                task is automatically timed out and rescheduled. If the decider eventually reports a
                completion or failure, it is ignored. This default can be overridden when starting a
              ...
              - **defaultLambdaRole** *(string) --*
                ...
                .. note::
                  ...
                  don't specify an IAM role when starting this workflow type, the default Lambda
                  role is attached to the execution. For more information, see
                  `https\\://docs.aws.amazon.com/amazonswf/latest/developerguide/lambda-task.html
                  <https://docs.aws.amazon.com/amazonswf/latest/developerguide/lambda-task.html>`__
                  in the *Amazon SWF Developer Guide* .
    ...
    def get_workflow_execution_history(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/GetWorkflowExecutionHistory>`_
        ...
        **Request Syntax**
        ...
        :param nextPageToken:
          ...
          ``NextPageToken`` is a unique pagination token for each page. Make the call again using
          the returned token to retrieve the next page. Keep all other arguments unchanged. Each
          pagination token expires after 60 seconds. Using an expired pagination token will return a
        ...
        :returns:
                ...
                'events': [
                    {
                        ...
                        'continueAsNewWorkflowExecutionFailedEventAttributes': {
                            ...
                            |'DEFAULT_EXECUTION_START_TO_CLOSE_TIMEOUT_UNDEFINED'|'DEFAULT_TASK_START_TO_CLOSE_TIMEOUT_UNDEFINED'|'DEFAULT_TASK_LIST_UNDEFINED'|'DEFAULT_CHILD_POLICY_UNDEFINED'|'CONTINUE_AS_NEW_WORKFLOW_EXECUTION_RATE_EXCEEDED'
                        ...
                        'workflowExecutionTerminatedEventAttributes': {
                            ...
                            'childPolicy': 'TERMINATE'|'REQUEST_CANCEL'|'ABANDON',
                            'cause':
                            'CHILD_POLICY_APPLIED'|'EVENT_LIMIT_EXCEEDED'
                            |'OPERATOR_INITIATED'
                        },
                        ...
                        'startChildWorkflowExecutionFailedEventAttributes': {
                            ...
                            |'DEFAULT_EXECUTION_START_TO_CLOSE_TIMEOUT_UNDEFINED'|'DEFAULT_TASK_LIST_UNDEFINED'|'DEFAULT_TASK_START_TO_CLOSE_TIMEOUT_UNDEFINED'|'DEFAULT_CHILD_POLICY_UNDEFINED'
                            |'OPERATION_NOT_PERMITTED',
                            'workflowId': 'string',
                            'initiatedEventId': 123,
                            'decisionTaskCompletedEventId': 123,
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Paginated representation of a workflow history for a workflow execution. This is the up
            to date, complete and authoritative record of the events related to all tasks and events
            in the life of the workflow execution.
            ...
            - **events** *(list) --*
              ...
              - *(dict) --*
                ...
                * ``CancelTimerFailed`` – Failed to process CancelTimer decision. This happens when
                the decision isn't configured properly, for example no timer exists with the
                specified timer Id.
                ...
                * ``WorkflowExecutionTimedOut`` – The workflow execution was closed because a time
                ...
                - **workflowExecutionStartedEventAttributes** *(dict) --*
                  ...
                  - **continuedExecutionRunId** *(string) --*
                    ...
                    the previous workflow execution that was closed and continued as this execution.
                ...
                - **completeWorkflowExecutionFailedEventAttributes** *(dict) --*
                  ...
                  - **cause** *(string) --*
                    ...
                    .. note::
                      ...
                      <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html>`__
                      in the *Amazon SWF Developer Guide* .
                ...
                - **workflowExecutionCancelRequestedEventAttributes** *(dict) --*
                  ...
                  - **externalInitiatedEventId** *(integer) --*
                    ...
                    cancel this workflow execution.The source event with this ID can be found in the
                ...
                - **decisionTaskScheduledEventAttributes** *(dict) --*
                  ...
                  - **startToCloseTimeout** *(string) --*
                    ...
                    it doesn't completed within this duration.
                ...
                - **activityTaskCanceledEventAttributes** *(dict) --*
                  ...
                  - **latestCancelRequestedEventId** *(integer) --*
                    ...
                    recorded for this activity task. This information can be useful for diagnosing
                    problems by tracing back the chain of events leading up to this event.
                ...
                - **activityTaskCancelRequestedEventAttributes** *(dict) --*
                  ...
                  - **decisionTaskCompletedEventId** *(integer) --*
                    ...
                    The ID of the ``DecisionTaskCompleted`` event corresponding to the decision task
                    that resulted in the ``RequestCancelActivityTask`` decision for this
                ...
                - **signalExternalWorkflowExecutionInitiatedEventAttributes** *(dict) --*
                  ...
                  - **decisionTaskCompletedEventId** *(integer) --*
                    ...
                    signal. This information can be useful for diagnosing problems by tracing back
                    the chain of events leading up to this event.
                ...
                - **startChildWorkflowExecutionFailedEventAttributes** *(dict) --*
                  ...
                  - **cause** *(string) --*
                    ...
                    .. note::
                      ...
                      because it lacks sufficient permissions. For details and example IAM policies,
                  ...
                  - **initiatedEventId** *(integer) --*
                    ...
                    ``StartChildWorkflowExecution``   Decision to start the workflow execution. You
                    can use this information to diagnose problems by tracing back the chain of
                    events leading up to this event.
                ...
                - **scheduleLambdaFunctionFailedEventAttributes** *(dict) --*
                  ...
                  - **decisionTaskCompletedEventId** *(integer) --*
                    ...
                    The ID of the ``LambdaFunctionCompleted`` event corresponding to the decision
                    that resulted in scheduling this Lambda task. To help diagnose issues, use this
                ...
                - **startLambdaFunctionFailedEventAttributes** *(dict) --*
                  ...
                  - **cause** *(string) --*
                    ...
                    .. note::
                      ...
                      If ``cause`` is set to ``OPERATION_NOT_PERMITTED`` , the decision failed
                      because the IAM role attached to the execution lacked sufficient permissions.
                      For details and example IAM policies, see `Lambda Tasks
                      <https://docs.aws.amazon.com/amazonswf/latest/developerguide/lambda-task.html>`__
                      in the *Amazon SWF Developer Guide* .
    ...
    def list_activity_types(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/ListActivityTypes>`_
    ...
    def list_closed_workflow_executions(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/ListClosedWorkflowExecutions>`_
        ...
        **Request Syntax**
        ...
        :param closeStatusFilter:
          ...
          If specified, only workflow executions that match this *close status* are listed. For
          example, if TERMINATED is specified, then only TERMINATED workflow executions are listed.
    ...
    def list_domains(
        ...
        * Use a ``Resource`` element with the domain name to limit the action to only specified
        domains. The element must be set to ``arn:aws:swf::AccountID:domain/*`` , where *AccountID*
        is the account ID, with no dashes.
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/ListDomains>`_
    ...
    def list_open_workflow_executions(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/ListOpenWorkflowExecutions>`_
    ...
    def list_tags_for_resource(self, resourceArn: str) -> ClientListTagsForResourceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/ListTagsForResource>`_
    ...
    def list_workflow_types(
        ...
        into multiple pages that can be retrieved by making the call repeatedly.
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/ListWorkflowTypes>`_
    ...
    def poll_for_activity_task(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/PollForActivityTask>`_
        ...
        **Request Syntax**
        ...
        :param identity:
          ...
          Identity of the worker making the request, recorded in the ``ActivityTaskStarted`` event
          in the workflow history. This enables diagnostic tracing when problems arise. The form of
    ...
    def poll_for_decision_task(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/PollForDecisionTask>`_
        ...
        **Request Syntax**
        ...
        :param nextPageToken:
          ...
          .. note::
            ...
            again (with the ``nextPageToken`` ) to retrieve the next page of history records.
            Calling  PollForDecisionTask with a ``nextPageToken`` doesn't return a new decision
            task.
    ...
    def record_activity_task_heartbeat(
        ...
        progress, for example percent complete, using the ``details`` parameter. This action can
        also be used by the worker as a mechanism to check if cancellation is being requested for
        the activity task. If a cancellation is being attempted for the specified task, then the
        ...
        the task times out, the workflow execution history contains a ``ActivityTaskTimedOut`` event
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RecordActivityTaskHeartbeat>`_
        ...
        **Request Syntax**
        ...
        :param taskToken: **[REQUIRED]**
          ...
          .. warning::
             ...
             the task is passed to another process, its ``taskToken`` must also be passed. This
    ...
    def register_activity_type(
        ...
        .. warning::
          ...
          cannot change any configuration settings of the type after its registration, and it must
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RegisterActivityType>`_
        ...
        **Request Syntax**
        ...
        :param defaultTaskHeartbeatTimeout:
          ...
          If set, specifies the default maximum time before which a worker processing a task of this
          type must report progress by calling  RecordActivityTaskHeartbeat . If the timeout is
          exceeded, the activity task is automatically timed out. This default can be overridden
        ...
        :param defaultTaskList:
          ...
          This default task list is used if a task list isn't provided when a task is scheduled
          through the ``ScheduleActivityTask``   Decision .
    ...
    def register_domain(
        ...
        * You cannot use an IAM policy to control domain access for this action. The name of the
        domain being registered is available as the resource of this action.
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RegisterDomain>`_
        ...
        **Request Syntax**
        ...
        :param workflowExecutionRetentionPeriodInDays: **[REQUIRED]**
          ...
          Amazon SWF service limits, see: `Amazon SWF Service Limits
          <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dg-limits.html>`__ in the
          *Amazon SWF Developer Guide* .
    ...
    def register_workflow_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RegisterWorkflowType>`_
        ...
        **Request Syntax**
        ...
        :param defaultLambdaRole:
          ...
          .. note::
            ...
            specify an IAM role when you start this workflow type, the default Lambda role is
    ...
    def request_cancel_workflow_execution(
        ...
        cancellation of the workflow execution as a whole. It is up to the decider to take
        appropriate actions when it receives an execution history with this event.

        .. note::

          If the runId isn't specified, the ``WorkflowExecutionCancelRequested`` event is recorded
          in the history of the current open workflow execution with the specified workflowId in the
          domain.
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RequestCancelWorkflowExecution>`_
    ...
    def respond_activity_task_canceled(self, taskToken: str, details: str = None) -> None:
        ...
        <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dg-basic.html#swf-dev-timeout-types>`__
        .
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RespondActivityTaskCanceled>`_
    ...
    def respond_activity_task_completed(self, taskToken: str, result: str = None) -> None:
        ...
        .. warning::
          ...
          instead. If the worker finds that the task is canceled through the ``canceled`` flag
          returned by  RecordActivityTaskHeartbeat , it should cancel the task, clean up and then
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RespondActivityTaskCompleted>`_
    ...
    def respond_activity_task_failed(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RespondActivityTaskFailed>`_
    ...
    def respond_decision_task_completed(
        ...
        permissions for the list of decisions in the ``decisions`` parameter. Each of the decisions
        has one or more parameters, much like a regular API call. To allow for policies to be as
        readable as possible, you can express permissions on decisions as if they were actual API
        calls, including applying conditions to some parameters. For more information, see `Using
        IAM to Manage Access to Amazon SWF Workflows
        <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html>`__ in the
        *Amazon SWF Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/RespondDecisionTaskCompleted>`_
              ...
              decisions=[
                  {
                      ...
                      |'RecordMarker'|'StartTimer'|'CancelTimer'
        ...
        :param decisions:
          ...
          - *(dict) --*
            ...
            * ``ContinueAsNewWorkflowExecution`` – Closes the workflow execution and starts a new
            workflow execution of the same type using the same workflow ID and a unique run Id. A
            ...
            * ``RecordMarker`` – Records a ``MarkerRecorded`` event in the history. Markers can be
            used for adding custom information in the history for instance to let deciders know that
            they don't need to look at the history beyond the marker event.

            * ``RequestCancelActivityTask`` – Attempts to cancel a previously scheduled activity
            task. If the activity task was scheduled but has not been assigned to a worker, then it
            is canceled. If the activity task was already assigned to a worker, then the worker is
            ...
            * ``StartChildWorkflowExecution`` – Requests that a child workflow execution be started
            and records a ``StartChildWorkflowExecutionInitiated`` event in the history. The child
            ...
            * ``StartTimer`` – Starts a timer for this workflow execution and records a
            ``TimerStarted`` event in the history. This timer fires after the specified delay and
            record a ``TimerFired`` event.

             **Access Control**

            If you grant permission to use ``RespondDecisionTaskCompleted`` , you can use IAM
            policies to express permissions for the list of decisions returned by this action as if
            they were members of the API. Treating decisions as a pseudo API maintains a uniform
            conceptual model and helps keep policies readable. For details and example IAM policies,
            see `Using IAM to Manage Access to Amazon SWF Workflows
            <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html>`__ in the
            *Amazon SWF Developer Guide* .
            ...
            * The decision lacks sufficient permissions.
            ...
            event attribute's ``cause`` parameter indicates the cause. If ``cause`` is set to
            ...
            * ``ScheduleActivityTaskFailed`` – A ``ScheduleActivityTask`` decision failed. This
            could happen if the activity type specified in the decision isn't registered, is in a
            deprecated state, or the decision isn't properly configured.

            * ``RequestCancelActivityTaskFailed`` – A ``RequestCancelActivityTask`` decision failed.
            This could happen if there is no open activity task with the specified activityId.
            ...
            * ``SignalExternalWorkflowExecutionFailed`` – A ``SignalExternalWorkflowExecution``
            decision failed. This could happen if the ``workflowID`` specified in the decision was
            incorrect.
            ...
            * ``CompleteWorkflowExecutionFailed`` – A ``CompleteWorkflowExecution`` decision failed.
            This could happen if there is an unhandled decision task pending in the workflow
            execution.
            ...
            * ``ContinueAsNewWorkflowExecutionFailed`` – A ``ContinueAsNewWorkflowExecution``
            ...
            workflow execution or the ContinueAsNewWorkflowExecution decision was not configured
            correctly.
            ...
            * ``FailWorkflowExecutionFailed`` – A ``FailWorkflowExecution`` decision failed. This
            ...
            The preceding error events might occur due to an error in the decider logic, which might
            put the workflow execution in an unstable state The cause field in the event structure
            for the error event indicates the cause of the error.
            ...
            .. note::
              ...
              workflow closing decision is specified and a signal or activity event had been added
              to the history while the decision task was being performed by the decider. Unlike the
              above situations which are logic issues, this fault is always possible because of race
              conditions in a distributed system. The right action here is to call
              RespondDecisionTaskCompleted without any decisions. This would result in another
              decision task with these new events included in the history. The decider should handle
            ...
            * `` StartChildWorkflowExecutionDecisionAttributes ``
            ...
            - **scheduleActivityTaskDecisionAttributes** *(dict) --*
              ...
              - **scheduleToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  default for the activity type or through this field. If neither this field is set
                  nor a default schedule-to-close timeout was specified at registration time then a
                  fault is returned.

              - **taskList** *(dict) --*

                If set, specifies the name of the task list in which to schedule the activity task.
                If not specified, the ``defaultTaskList`` registered with the activity type is used.
              ...
              - **taskPriority** *(string) --*
                ...
                worker. This overrides the defaultTaskPriority specified when registering the
                activity type using  RegisterActivityType . Valid values are integers that range
              ...
              - **scheduleToStartTimeout** *(string) --*
                ...
                If set, specifies the maximum duration the activity task can wait to be assigned to
                a worker. This overrides the default schedule-to-start timeout specified when
                ...
                .. note::
                  ...
                  default for the activity type or through this field. If neither this field is set
                  nor a default schedule-to-start timeout was specified at registration time then a
                  fault is returned.
              ...
              - **startToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  default for the activity type or through this field. If neither this field is set
                  nor a default start-to-close timeout was specified at registration time then a
                  fault is returned.

              - **heartbeatTimeout** *(string) --*

                If set, specifies the maximum time before which a worker processing a task of this
                type must report progress by calling  RecordActivityTaskHeartbeat . If the timeout
                is exceeded, the activity task is automatically timed out. If the worker
                subsequently attempts to record a heartbeat or returns a result, it is ignored. This
                overrides the default heartbeat timeout specified when registering the activity type
            ...
            - **continueAsNewWorkflowExecutionDecisionAttributes** *(dict) --*
              ...
              Provides the details of the ``ContinueAsNewWorkflowExecution`` decision. It isn't set
              ...
              - **executionStartToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  either as a default for the workflow type or through this field. If neither this
                  field is set nor a default execution start-to-close timeout was specified at
              ...
              - **childPolicy** *(string) --*
                ...
                * ``ABANDON`` – No action is taken. The child executions continue to run.
                ...
                .. note::
                  ...
                  nor a default child policy was specified at registration time then a fault is
                  returned.
            ...
            - **recordMarkerDecisionAttributes** *(dict) --*
              ...
              Provides the details of the ``RecordMarker`` decision. It isn't set for other decision
              types.
            ...
            - **cancelTimerDecisionAttributes** *(dict) --*
              ...
              Provides the details of the ``CancelTimer`` decision. It isn't set for other decision
              types.
            ...
            - **signalExternalWorkflowExecutionDecisionAttributes** *(dict) --*
              ...
              Provides the details of the ``SignalExternalWorkflowExecution`` decision. It isn't set
              for other decision types.
            ...
            - **startChildWorkflowExecutionDecisionAttributes** *(dict) --*
              ...
              - **executionStartToCloseTimeout** *(string) --*
                ...
                .. note::
                  ...
                  An execution start-to-close timeout for this workflow execution must be specified
                  either as a default for the workflow type or through this parameter. If neither
                  this parameter is set nor a default execution start-to-close timeout was specified
              ...
              - **childPolicy** *(string) --*
                ...
                policy overrides the default child policy specified when registering the workflow
    ...
    def signal_workflow_execution(
        ...
        a decision task for the workflow execution identified by the given domain, workflowId and
        runId. The event is recorded with the specified user defined signalName and input (if
        provided).

        .. note::

          If a runId isn't specified, then the ``WorkflowExecutionSignaled`` event is recorded in
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/SignalWorkflowExecution>`_
    ...
    def start_workflow_execution(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/StartWorkflowExecution>`_
        ...
        **Request Syntax**
        ...
        :param workflowId: **[REQUIRED]**
          ...
          identifier if a workflow execution is logically a *restart* of a previous execution. You
          cannot have two open workflow executions with the same ``workflowId`` at the same time
        ...
        :param taskPriority:
          ...
          that was assigned when the workflow type was registered. If not set, then the default task
          priority for the workflow type is used. Valid values are integers that range from Java's
        ...
        :param taskStartToCloseTimeout:
          ...
          .. note::
            ...
            default for the workflow type or through this parameter. If neither this parameter is
        ...
        :param lambdaRole:
          ...
          .. note::
            ...
            Executions of this workflow type need IAM roles to invoke Lambda functions. If you don't
            attach an IAM role, any attempt to schedule a Lambda task fails. This results in a
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **runId** *(string) --*
              ...
              The ``runId`` of a workflow execution. This ID is generated by the service and can be
              used to uniquely identify the workflow execution within a domain.
    ...
    def tag_resource(self, resourceArn: str, tags: List[ClientTagResourcetagsTypeDef]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/TagResource>`_
    ...
    def terminate_workflow_execution(
        ...
        workflow type or specified when starting this execution, is applied to any open child
        ...
        .. note::
          ...
          You should consider using  RequestCancelWorkflowExecution action instead because it allows
          the workflow to gracefully close while  TerminateWorkflowExecution doesn't.
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/TerminateWorkflowExecution>`_
    ...
    def undeprecate_activity_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UndeprecateActivityType>`_

        **Request Syntax**
        ::

          response = client.undeprecate_activity_type(
              domain='string',
              activityType={
                  'name': 'string',
                  'version': 'string'
    ...
    def undeprecate_domain(self, name: str) -> None:
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UndeprecateDomain>`_

        **Request Syntax**
        ::

          response = client.undeprecate_domain(
              name='string'
          )
        :type name: string
        :param name: **[REQUIRED]**
    ...
    def undeprecate_workflow_type(
        ...
        *Amazon SWF Developer Guide* .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UndeprecateWorkflowType>`_

        **Request Syntax**
        ::

          response = client.undeprecate_workflow_type(
              domain='string',
              workflowType={
                  'name': 'string',
                  'version': 'string'
    ...
    def untag_resource(self, resourceArn: str, tagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/swf-2012-01-25/UntagResource>`_
    ...
    ) -> paginator_scope.GetWorkflowExecutionHistoryPaginator:
        """
        Get Paginator for `get_workflow_execution_history` operation.
        """
    ...
    ) -> paginator_scope.ListActivityTypesPaginator:
        """
        Get Paginator for `list_activity_types` operation.
        """
    ...
    ) -> paginator_scope.ListClosedWorkflowExecutionsPaginator:
        """
        Get Paginator for `list_closed_workflow_executions` operation.
        """
    ...
    ) -> paginator_scope.ListOpenWorkflowExecutionsPaginator:
        """
        Get Paginator for `list_open_workflow_executions` operation.
        """
    ...
    ) -> paginator_scope.ListWorkflowTypesPaginator:
        """
        Get Paginator for `list_workflow_types` operation.
        """
    ...
    ) -> paginator_scope.PollForDecisionTaskPaginator:
        """
        Get Paginator for `poll_for_decision_task` operation.
        """
