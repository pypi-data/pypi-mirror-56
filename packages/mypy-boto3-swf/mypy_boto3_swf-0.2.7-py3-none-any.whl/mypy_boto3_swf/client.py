...
class Client(BaseClient):
    ...
    def count_closed_workflow_executions(
        ...
        * Constrain the following parameters by using a ``Condition`` element with the appropriate keys.
        ...
        parameter is set to ``OPERATION_NOT_PERMITTED`` . For details and example IAM policies, see `Using
        IAM to Manage Access to Amazon SWF Workflows
        <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dev-iam.html>`__ in the *Amazon SWF
        Developer Guide* .
    ...
    def count_pending_activity_tasks(
        ...
        ever scheduled in then ``0`` is returned.
    ...
    def deprecate_domain(self, name: str) -> None:
        ...
        domain. Executions that were started before the domain was deprecated continues to run.
    ...
    def deprecate_workflow_type(
        ...
        continues to run. A deprecated workflow type may still be used when calling visibility actions.
    ...
    def describe_activity_type(
        ...
        when the type was registered and other general information about the type.
    ...
    def get_workflow_execution_history(
        ...
        **Request Syntax**
        ...
        :param nextPageToken:
          ...
          If ``NextPageToken`` is returned there are more results available. The value of ``NextPageToken``
          is a unique pagination token for each page. Make the call again using the returned token to
          retrieve the next page. Keep all other arguments unchanged. Each pagination token expires after 60
          seconds. Using an expired pagination token will return a ``400`` error: "``Specified token has
                ...
                'events': [
                    {
                        ...
                        |'WorkflowExecutionFailed'|'FailWorkflowExecutionFailed'|'WorkflowExecutionTimedOut'
                        ...
                        |'WorkflowExecutionTerminated'|'DecisionTaskScheduled'|'DecisionTaskStarted'
                        |'DecisionTaskCompleted'|'DecisionTaskTimedOut'|'ActivityTaskScheduled'
                        |'ScheduleActivityTaskFailed'|'ActivityTaskStarted'|'ActivityTaskCompleted'
                        |'ActivityTaskFailed'|'ActivityTaskTimedOut'|'ActivityTaskCanceled'
                        |'ActivityTaskCancelRequested'|'RequestCancelActivityTaskFailed'
                        |'WorkflowExecutionSignaled'|'MarkerRecorded'|'RecordMarkerFailed'|'TimerStarted'
                        |'StartTimerFailed'|'TimerFired'|'TimerCanceled'|'CancelTimerFailed'
                        ...
                        |'LambdaFunctionStarted'|'LambdaFunctionCompleted'|'LambdaFunctionFailed'
                        ...
                        'continueAsNewWorkflowExecutionFailedEventAttributes': {
                            ...
                            |'DEFAULT_TASK_START_TO_CLOSE_TIMEOUT_UNDEFINED'|'DEFAULT_TASK_LIST_UNDEFINED'
                            |'DEFAULT_CHILD_POLICY_UNDEFINED'
                            |'CONTINUE_AS_NEW_WORKFLOW_EXECUTION_RATE_EXCEEDED'|'OPERATION_NOT_PERMITTED',
                            'decisionTaskCompletedEventId': 123
                        },
                        ...
                        'scheduleActivityTaskFailedEventAttributes': {
                            ...
                            |'ACTIVITY_CREATION_RATE_EXCEEDED'|'DEFAULT_SCHEDULE_TO_CLOSE_TIMEOUT_UNDEFINED'
                        ...
                        'scheduleLambdaFunctionFailedEventAttributes': {
                            ...
                            'name': 'string',
                            'cause':
                            'ID_ALREADY_IN_USE'|'OPEN_LAMBDA_FUNCTIONS_LIMIT_EXCEEDED'
    ...
    def list_activity_types(
        ...
        **Request Syntax**
        ...
        :param reverseOrder:
          ...
          When set to ``true`` , returns the results in reverse order. By default, the results are returned
          in ascending alphabetical order by ``name`` of the activity types.
    ...
    def list_closed_workflow_executions(
        ...
        **Request Syntax**
        ...
        :param startTimeFilter:
          ...
          start times are within the range specified by this filter. Also, if this parameter is specified,
          the returned results are ordered by their start times.
        ...
        :param closeTimeFilter:
          ...
          If specified, the workflow executions are included in the returned results based on whether their
          close times are within the range specified by this filter. Also, if this parameter is specified,
          the returned results are ordered by their close times.
    ...
    def list_domains(
        ...
        **Request Syntax**
        ...
        :param reverseOrder:
          ...
          When set to ``true`` , returns the results in reverse order. By default, the results are returned
          in ascending alphabetical order by ``name`` of the domains.
    ...
    def list_workflow_types(
        ...
        **Request Syntax**
        ...
        :param reverseOrder:
          ...
          When set to ``true`` , returns the results in reverse order. By default the results are returned
          in ascending alphabetical order of the ``name`` of the workflow types.
    ...
    def poll_for_activity_task(
        self,
        domain: str,
        taskList: ClientPollForActivityTasktaskListTypeDef,
        identity: str = None,
    ) -> ClientPollForActivityTaskResponseTypeDef:
        """
        Used by workers to get an  ActivityTask from the specified activity ``taskList`` . This initiates a
        long poll, where the service holds the HTTP connection open and responds as soon as a task becomes
        ...
        .. warning::
          ...
          Workers should set their client side socket timeout to at least 70 seconds (10 seconds higher than
          the maximum time service may hold the poll request).
        ...
        **Request Syntax**
        ...
        :param identity:
          ...
          Identity of the worker making the request, recorded in the ``ActivityTaskStarted`` event in the
          workflow history. This enables diagnostic tracing when problems arise. The form of this identity
          is user defined.
    ...
    def poll_for_decision_task(
        ...
        may be returned for any open workflow execution that is using the specified task list. The task
        includes a paginated view of the history of the workflow execution. The decider should use the
        workflow type and the history to determine how to properly handle the task.

        This action initiates a long poll, where the service holds the HTTP connection open and responds as
        soon a task becomes available. If no decision task is available in the specified task list before
        the timeout of 60 seconds expires, an empty result is returned. An empty result, in this context,
        ...
        .. warning::
          ...
          Because the number of workflow history events for a single workflow execution might be very large,
          the result returned might be split up across a number of pages. To retrieve subsequent pages, make
          additional calls to ``PollForDecisionTask`` using the ``nextPageToken`` returned by the initial
          call. Note that you do *not* call ``GetWorkflowExecutionHistory`` with this ``nextPageToken`` .
        ...
        **Request Syntax**
        ...
        :param identity:
          ...
          the workflow history. This enables diagnostic tracing when problems arise. The form of this
        ...
        :param nextPageToken:
          ...
          .. note::
            ...
            to get the next page. You must call  PollForDecisionTask again (with the ``nextPageToken`` ) to
    ...
    def record_activity_task_heartbeat(
        ...
        used by the worker as a mechanism to check if cancellation is being requested for the activity task.
        ...
        This action resets the ``taskHeartbeatTimeout`` clock. The ``taskHeartbeatTimeout`` is specified in
        RegisterActivityType .

        This action doesn't in itself create an event in the workflow execution history. However, if the
        task times out, the workflow execution history contains a ``ActivityTaskTimedOut`` event that
        ...
        .. warning::
          ...
          worker can cancel the activity, it should respond with  RespondActivityTaskCanceled . Otherwise,
          it should ignore the cancellation request.
    ...
    def register_activity_type(
        ...
        .. warning::
          ...
          change any configuration settings of the type after its registration, and it must be registered as
          a new version.
        ...
        **Request Syntax**
        ...
        :param version: **[REQUIRED]**
          ...
          .. note::
            ...
            The activity type consists of the name and version, the combination of which must be unique
            within the domain.
        ...
        :param defaultTaskHeartbeatTimeout:
          ...
          If set, specifies the default maximum time before which a worker processing a task of this type
          must report progress by calling  RecordActivityTaskHeartbeat . If the timeout is exceeded, the
          activity task is automatically timed out. This default can be overridden when scheduling an
          activity task using the ``ScheduleActivityTask``   Decision . If the activity worker subsequently
          attempts to record a heartbeat or returns a result, the activity worker receives an
          ``UnknownResource`` fault. In this case, Amazon SWF no longer considers the activity task to be
        ...
        :param defaultTaskPriority:
          ...
          The default task priority to assign to the activity type. If not assigned, then ``0`` is used.
          Valid values are integers that range from Java's ``Integer.MIN_VALUE`` (-2147483648) to
          ``Integer.MAX_VALUE`` (2147483647). Higher numbers indicate higher priority.

          For more information about setting task priority, see `Setting Task Priority
          <https://docs.aws.amazon.com/amazonswf/latest/developerguide/programming-priority.html>`__ in the
          *in the *Amazon SWF Developer Guide* .* .
        ...
        :param defaultTaskScheduleToCloseTimeout:
          ...
          If set, specifies the default maximum duration for a task of this activity type. This default can
          be overridden when scheduling an activity task using the ``ScheduleActivityTask``   Decision .
    ...
    def register_domain(
        ...
        * You cannot use an IAM policy to control domain access for this action. The name of the domain
        being registered is available as the resource of this action.
        ...
        **Request Syntax**
        ...
        :param workflowExecutionRetentionPeriodInDays: **[REQUIRED]**
          ...
          retained. As soon as the workflow execution completes, the execution record and its history are
          deleted.

          The maximum workflow execution retention period is 90 days. For more information about Amazon SWF
          service limits, see: `Amazon SWF Service Limits
          <https://docs.aws.amazon.com/amazonswf/latest/developerguide/swf-dg-limits.html>`__ in the *Amazon
          SWF Developer Guide* .
    ...
    def register_workflow_type(
        ...
        .. warning::
          ...
          configuration settings of a workflow type once it is registered and it must be registered as a new
          version.
        ...
        **Request Syntax**
        ...
        :param version: **[REQUIRED]**
          ...
          .. note::
            ...
            The workflow type consists of the name and version, the combination of which must be unique
            within the domain. To get a list of all currently registered workflow types, use the
        ...
        :param defaultExecutionStartToCloseTimeout:
          ...
          The duration is specified in seconds; an integer greater than or equal to 0. Unlike some of the
        ...
        :param defaultTaskList:
          ...
          execution through the  StartWorkflowExecution Action or ``StartChildWorkflowExecution``   Decision
          .
        ...
        :param defaultTaskPriority:
          ...
          The default task priority to assign to the workflow type. If not assigned, then ``0`` is used.
          Valid values are integers that range from Java's ``Integer.MIN_VALUE`` (-2147483648) to
          ``Integer.MAX_VALUE`` (2147483647). Higher numbers indicate higher priority.
        ...
        :param defaultChildPolicy:
          ...
          execution of this type is terminated, by calling the  TerminateWorkflowExecution action explicitly
          or due to an expired timeout. This default can be overridden when starting a workflow execution
          using the  StartWorkflowExecution action or the ``StartChildWorkflowExecution``   Decision .
        ...
        :param defaultLambdaRole:
          ...
          .. note::
            ...
            Executions of this workflow type need IAM roles to invoke Lambda functions. If you don't specify
            an IAM role when you start this workflow type, the default Lambda role is attached to the
            execution. For more information, see
            `https\\://docs.aws.amazon.com/amazonswf/latest/developerguide/lambda-task.html
            <https://docs.aws.amazon.com/amazonswf/latest/developerguide/lambda-task.html>`__ in the *Amazon
            SWF Developer Guide* .
    ...
    def respond_activity_task_canceled(
        ...
        A task is considered open from the time that it is scheduled until it is closed. Therefore a task is
        reported as open while a worker is processing it. A task is closed after it has been specified in a
        call to  RespondActivityTaskCompleted , RespondActivityTaskCanceled,  RespondActivityTaskFailed , or
    ...
    def respond_activity_task_completed(
        ...
        successfully with a ``result`` (if provided). The ``result`` appears in the
        ``ActivityTaskCompleted`` event in the workflow history.

        .. warning::

          If the requested task doesn't complete successfully, use  RespondActivityTaskFailed instead. If
    ...
    def respond_decision_task_completed(
        ...
        permissions for the list of decisions in the ``decisions`` parameter. Each of the decisions has one
        or more parameters, much like a regular API call. To allow for policies to be as readable as
        possible, you can express permissions on decisions as if they were actual API calls, including
        applying conditions to some parameters. For more information, see `Using IAM to Manage Access to
        ...
        **Request Syntax**
        ...
        :param decisions:
          ...
          See the docs for the  Decision structure for details.
    ...
    def signal_workflow_execution(
        ...
        decision task for the workflow execution identified by the given domain, workflowId and runId. The
        event is recorded with the specified user defined signalName and input (if provided).
    ...
    def start_workflow_execution(
        ...
        **Request Syntax**
        ...
        :param workflowId: **[REQUIRED]**
          ...
          The user defined identifier associated with the workflow execution. You can use this to associate
          a custom identifier with the workflow execution. You may specify the same identifier if a workflow
          execution is logically a *restart* of a previous execution. You cannot have two open workflow
          executions with the same ``workflowId`` at the same time within the same domain.
        ...
        :param taskList:
          ...
          the ``defaultTaskList`` specified when registering the workflow type.
        ...
        :param executionStartToCloseTimeout:
          ...
          The duration is specified in seconds; an integer greater than or equal to ``0`` . Exceeding this
          limit causes the workflow execution to time out. Unlike some of the other timeout parameters in
          Amazon SWF, you cannot specify a value of "NONE" for this timeout; there is a one-year max limit
          on the time that a workflow execution can run.

          .. note::

            An execution start-to-close timeout must be specified either through this parameter or as a
        ...
        :param taskStartToCloseTimeout:
          ...
          .. note::
            ...
            A task start-to-close timeout for this workflow execution must be specified either as a default
            for the workflow type or through this parameter. If neither this parameter is set nor a default
            task start-to-close timeout was specified at registration time then a fault is returned.

        :type childPolicy: string
        :param childPolicy:

          If set, specifies the policy to use for the child workflow executions of this workflow execution
          if it is terminated, by calling the  TerminateWorkflowExecution action explicitly or due to an
          ...
          * ``ABANDON`` – No action is taken. The child executions continue to run.
          ...
          .. note::
            ...
            A child policy for this workflow execution must be specified either as a default for the
            workflow type or through this parameter. If neither this parameter is set nor a default child
            policy was specified at registration time then a fault is returned.
    ...
    def terminate_workflow_execution(
        ...
        .. note::
          ...
          If a runId isn't specified, then the ``WorkflowExecutionTerminated`` event is recorded in the
          history of the current open workflow with the matching workflowId in the domain.

        .. note::

          You should consider using  RequestCancelWorkflowExecution action instead because it allows the
          workflow to gracefully close while  TerminateWorkflowExecution doesn't.
    ...
    def undeprecate_activity_type(
        ...
        you can create new tasks of that activity type.
    ...
    def undeprecate_domain(self, name: str) -> None:
        ...
        create new workflow executions or register new types.
