...
# source: tensorflow_serving_client/protos/tensor_shape.proto
...
_TENSORSHAPEPROTO_DIM = _descriptor.Descriptor(
  name='Dim',
  full_name='tensorflow.serving.TensorShapeProto.Dim',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='size', full_name='tensorflow.serving.TensorShapeProto.Dim.size', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='name', full_name='tensorflow.serving.TensorShapeProto.Dim.name', index=1,
...
_TENSORSHAPEPROTO = _descriptor.Descriptor(
  ...
  full_name='tensorflow.serving.TensorShapeProto',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='dim', full_name='tensorflow.serving.TensorShapeProto.dim', index=0,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='unknown_rank', full_name='tensorflow.serving.TensorShapeProto.unknown_rank', index=1,
...
TensorShapeProto = _reflection.GeneratedProtocolMessageType('TensorShapeProto', (_message.Message,), {
  ...
  'Dim' : _reflection.GeneratedProtocolMessageType('Dim', (_message.Message,), {
    ...
    '__module__' : 'tensorflow_serving_client.protos.tensor_shape_pb2'
    # @@protoc_insertion_point(class_scope:tensorflow.serving.TensorShapeProto.Dim)
    })
  ,
  'DESCRIPTOR' : _TENSORSHAPEPROTO,
  '__module__' : 'tensorflow_serving_client.protos.tensor_shape_pb2'
  # @@protoc_insertion_point(class_scope:tensorflow.serving.TensorShapeProto)
  })
