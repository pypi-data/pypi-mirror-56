...
# source: tensorflow_serving_client/protos/prediction_service.proto
...
DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow_serving_client/protos/prediction_service.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n9tensorflow_serving_client/protos/prediction_service.proto\x12\x12tensorflow.serving\x1a.tensorflow_serving_client/protos/predict.proto2g\n\x11PredictionService\x12R\n\x07Predict\x12\".tensorflow.serving.PredictRequest\x1a#.tensorflow.serving.PredictResponseB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[tensorflow__serving__client_dot_protos_dot_predict__pb2.DESCRIPTOR,])
...
_PREDICTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    input_type=tensorflow__serving__client_dot_protos_dot_predict__pb2._PREDICTREQUEST,
    output_type=tensorflow__serving__client_dot_protos_dot_predict__pb2._PREDICTRESPONSE,
    serialized_options=None,
  ),
])
