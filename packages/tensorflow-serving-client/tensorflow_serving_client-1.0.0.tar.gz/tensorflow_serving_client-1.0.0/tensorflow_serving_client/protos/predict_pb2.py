...
# source: tensorflow_serving_client/protos/predict.proto
...
from tensorflow_serving_client.protos import tensor_pb2 as tensorflow__serving__client_dot_protos_dot_tensor__pb2
from tensorflow_serving_client.protos import model_pb2 as tensorflow__serving__client_dot_protos_dot_model__pb2


DESCRIPTOR = _descriptor.FileDescriptor(
  name='tensorflow_serving_client/protos/predict.proto',
  package='tensorflow.serving',
  syntax='proto3',
  serialized_options=_b('\370\001\001'),
  serialized_pb=_b('\n.tensorflow_serving_client/protos/predict.proto\x12\x12tensorflow.serving\x1a-tensorflow_serving_client/protos/tensor.proto\x1a,tensorflow_serving_client/protos/model.proto\"\xea\x01\n\x0ePredictRequest\x12\x31\n\nmodel_spec\x18\x01 \x01(\x0b\x32\x1d.tensorflow.serving.ModelSpec\x12>\n\x06inputs\x18\x02 \x03(\x0b\x32..tensorflow.serving.PredictRequest.InputsEntry\x12\x15\n\routput_filter\x18\x03 \x03(\t\x1aN\n\x0bInputsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12.\n\x05value\x18\x02 \x01(\x0b\x32\x1f.tensorflow.serving.TensorProto:\x02\x38\x01\"\xd8\x01\n\x0fPredictResponse\x12\x31\n\nmodel_spec\x18\x02 \x01(\x0b\x32\x1d.tensorflow.serving.ModelSpec\x12\x41\n\x07outputs\x18\x01 \x03(\x0b\x32\x30.tensorflow.serving.PredictResponse.OutputsEntry\x1aO\n\x0cOutputsEntry\x12\x0b\n\x03key\x18\x01 \x01(\t\x12.\n\x05value\x18\x02 \x01(\x0b\x32\x1f.tensorflow.serving.TensorProto:\x02\x38\x01\x42\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[tensorflow__serving__client_dot_protos_dot_tensor__pb2.DESCRIPTOR,tensorflow__serving__client_dot_protos_dot_model__pb2.DESCRIPTOR,])
...
_PREDICTREQUEST_INPUTSENTRY.fields_by_name['value'].message_type = tensorflow__serving__client_dot_protos_dot_tensor__pb2._TENSORPROTO
_PREDICTREQUEST_INPUTSENTRY.containing_type = _PREDICTREQUEST
_PREDICTREQUEST.fields_by_name['model_spec'].message_type = tensorflow__serving__client_dot_protos_dot_model__pb2._MODELSPEC
_PREDICTREQUEST.fields_by_name['inputs'].message_type = _PREDICTREQUEST_INPUTSENTRY
_PREDICTRESPONSE_OUTPUTSENTRY.fields_by_name['value'].message_type = tensorflow__serving__client_dot_protos_dot_tensor__pb2._TENSORPROTO
_PREDICTRESPONSE_OUTPUTSENTRY.containing_type = _PREDICTRESPONSE
_PREDICTRESPONSE.fields_by_name['model_spec'].message_type = tensorflow__serving__client_dot_protos_dot_model__pb2._MODELSPEC
...
PredictRequest = _reflection.GeneratedProtocolMessageType('PredictRequest', (_message.Message,), {
  ...
  'InputsEntry' : _reflection.GeneratedProtocolMessageType('InputsEntry', (_message.Message,), {
    ...
    '__module__' : 'tensorflow_serving_client.protos.predict_pb2'
