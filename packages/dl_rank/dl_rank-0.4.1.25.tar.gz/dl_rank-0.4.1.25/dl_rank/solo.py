...
class EstimatorManager(object):
    ...
    def train_and_eval(self, parse_fn):
        ...
        train_input_fn = self.input_fn("train",self.parser.data_file_filter,self.run_conf['train_distribute'], 'tfrecord')
        eval_input_fn = self.input_fn("evaluation",self.parser.data_file_filter,self.run_conf['train_distribute'], 'csv')
