...
class EstimatorManager(object):
    ...
    def input_fn(self):
        ...
        def wrapper(parse_fn, batch_size, data_source, TOTAL_WORKERS=1, WORKER_INDEX=1, epochs=1, num_parallel_calls=1,
            ...
            dataset = dataset.prefetch(200 * batch_size)
...
def run(mode, conf, useSpark, retrain=False, date='', tw=1, wi=1, ps=1, logpath='', hdfspath='', use_TFoS=False, num_executor=0, **kwargs):
    assert ps > 0
