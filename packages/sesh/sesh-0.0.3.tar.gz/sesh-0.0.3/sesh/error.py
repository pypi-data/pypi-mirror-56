...
The error module provides custom Sesh Error Classes, as well as an ExitCode
class that supplies exit code values used when exiting the Sesh program.
Errror messages are available in the Sesh log file, which is located at
~/.local/log/sesh.log by default.
