...
from sesh.api import archive, show, six_degrees_of
...
parser = argparse.ArgumentParser(
    prog='sesh',
    description='Use sesh to manage iSesh',
...
parser.add_argument(
    ...
    help=(f'limit the number of operations performed by the command '
          ...
          f'\n \nExample:'
          f'\n\t\t`sesh --limit 5 archive playlist Movies`'
...
parser_show.add_argument(
    ...
    metavar='target',
    help=('The type of iSesh object to show.'
