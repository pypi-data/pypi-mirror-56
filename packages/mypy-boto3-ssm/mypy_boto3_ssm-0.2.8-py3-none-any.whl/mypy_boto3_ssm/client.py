...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        self, ResourceType: str, ResourceId: str, Tags: List[ClientAddTagsToResourceTagsTypeDef]
    ) -> Dict[str, Any]:
        """
        ...
        your account's managed instances that helps you track each instance's owner and stack level.
        ...
        search and filter the resources based on the tags you add. Tags don't have any semantic
        meaning to Amazon EC2 and are interpreted strictly as a string of characters.

        For more information about tags, see `Tagging Your Amazon EC2 Resources
        <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html>`__ in the *Amazon EC2
        User Guide* .
        ...
        **Request Syntax**
        ::
          ...
          response = client.add_tags_to_resource(
              ResourceType=
                  'Document'|'ManagedInstance'|'MaintenanceWindow'|'Parameter'|'PatchBaseline'
                  |'OpsItem',
              ResourceId='string',
              Tags=[
                  {
        ...
        :param ResourceType: **[REQUIRED]**
          ...
          .. note::
            ...
            The ManagedInstance type for this API action is for on-premises managed instances. You
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Whether or not the command was successfully canceled. There is no guarantee that a
    ...
    def create_activation(
        ...
        these resources using Run Command. An on-premises server or virtual machine that has been
        registered with EC2 is called a managed instance. For more information about activations,
        ...
        :param Tags:
          ...
          * ``Key=Environment,Value=Production``
          ...
          .. warning::
            ...
            activation ID and code. When you specify the activation ID and code, tags assigned to
            the activation are automatically applied to the on-premises servers or VMs.
        ...
        **Request Syntax**
        ...
        :param InstanceId:
          ...
          .. note::
             ...
             ``InstanceId`` has been deprecated. To specify an instance ID for an association, use
             the ``Targets`` parameter. If you use the parameter ``InstanceId`` , you cannot use the
          ...
          - *(dict) --*
            ...
            * (Maintenance window targets only)
            ``Key=resource-groups:Name,Values=
                ProductionResourceGroup``   This example demonstrates
            ...
            - **AssociationDescription** *(dict) --*
              ...
              - **Targets** *(list) --*
                ...
                - *(dict) --*
                  ...
                  * (Maintenance window targets only)
                  ``Key=resource-groups:ResourceTypeFilters,Values=*resource-type-1*
                  ,*resource-type-2* ``
                  ...
                  *
                  ``Key=InstanceIds,Values=
                      i-02573cafcfEXAMPLE,i-0471e04240EXAMPLE,i-07782c72faEXAMPLE``
                  ...
                  * (Maintenance window targets only)
                  ``Key=resource-groups:Name,Values=
                      ProductionResourceGroup``   This example
                  ...
                  * (State Manager association targets only) ``Key=InstanceIds,Values=
                      *``   This
                  example demonstrates how to target all managed instances in the AWS Region where
                  the association was created.

                  For information about how to send commands that target instances using
                  ``Key,Value`` parameters, see `Using Targets and Rate Controls to Send Commands to
                  a Fleet
                  <https://docs.aws.amazon.com/systems-manager/latest/userguide/send-commands-multiple.html#send-commands-targeting>`__
                  in the *AWS Systems Manager User Guide* .
              ...
              - **MaxErrors** *(string) --*
                ...
                is received. If you specify 0, then the system stops sending requests after the
                first error is returned. If you run an association on 50 instances and set MaxError
                ...
                ensure that there won't be more than max-errors failed executions, set
              ...
              - **MaxConcurrency** *(string) --*
                ...
                If a new instance starts and attempts to run an association while Systems Manager is
                running MaxConcurrency associations, the association is allowed to run. During the
                next association interval, the new instance will process its association within the
        ...
        :param Entries: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **MaxConcurrency** *(string) --*
              ...
              The default value is 100%, which means all targets run the association at the same
              time.
            ...
            - **Successful** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Targets** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    * (State Manager association targets only) ``Key=InstanceIds,Values=
                    ...
                    For information about how to send commands that target instances using
                    ``Key,Value`` parameters, see `Using Targets and Rate Controls to Send Commands
                    to a Fleet
                    <https://docs.aws.amazon.com/systems-manager/latest/userguide/send-commands-multiple.html#send-commands-targeting>`__
                    in the *AWS Systems Manager User Guide* .
                ...
                - **MaxErrors** *(string) --*
                  ...
                  The number of errors that are allowed before the system stops sending requests to
                  run the association on additional targets. You can specify either an absolute
                  ...
                  fourth error is received. If you specify 0, then the system stops sending requests
                  after the first error is returned. If you run an association on 50 instances and
                  set MaxError to 10%, then the system stops sending the request when the sixth
                  error is received.
                ...
                - **MaxConcurrency** *(string) --*
                  ...
                  The maximum number of targets allowed to run the association at the same time. You
                  can specify a number, for example 10, or a percentage of the target set, for
                  ...
                  the next association interval, the new instance will process its association
              ...
              - *(dict) --*
                ...
                - **Entry** *(dict) --*
                  ...
                  - **Name** *(string) --*
                    ...
                    For AWS-predefined documents and SSM documents you created in your account, you
                    only need to specify the document name. For example, ``AWS-ApplyPatchBaseline``
                    or ``My-Document`` .
                  ...
                  - **Targets** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      * (State Manager association targets only) ``Key=
                          InstanceIds,Values=*``   This
                      ...
                      - **Values** *(list) --*
                        ...
                        on instances that include Amazon EC2 tags of ``ServerRole,WebServer`` .
                  ...
                  - **MaxErrors** *(string) --*
                    ...
                    Executions that are already running an association when MaxErrors is reached are
                    allowed to complete, but some of these executions may fail as well. If you need
                    to ensure that there won't be more than max-errors failed executions, set
                    MaxConcurrency to 1 so that executions proceed one at a time.
                  ...
                  - **MaxConcurrency** *(string) --*
                    ...
                    run. During the next association interval, the new instance will process its
    ...
    def create_document(
        ...
        After you create a document, you can use CreateAssociation to associate it with one or more
        running instances.
        ...
        **Request Syntax**
        ...
        :param Attachments:
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              document. The format is the URL of the location of a document attachment, such as the
              URL of an Amazon S3 bucket.
        ...
        :param VersionName:
          ...
          document. For example, "Release 12, Update 6". This value is unique across all versions of
          a document, and cannot be changed.
        ...
        :param DocumentFormat:
          ...
          Specify the document format for the request. The document format can be either JSON or
        ...
        :param TargetType:
          ...
          list of valid resource types, see `AWS Resource Types Reference
        ...
        :param Tags:
          ...
          run. In this case, you could specify the following key name/value pairs:
          ...
          - *(dict) --*
            ...
            - **DocumentDescription** *(dict) --*
              ...
              - **StatusInformation** *(string) --*
                ...
                example, a ``Failed`` status might be explained by the ``StatusInformation``
                message, "The specified S3 bucket does not exist. Verify that the URL of the S3
                bucket is correct."
              ...
              - **TargetType** *(string) --*
                ...
                example, /AWS::EC2::Instance. For a list of valid resource types, see `AWS Resource
                Types Reference
                <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html>`__
                in the *AWS CloudFormation User Guide* .
              ...
              - **Tags** *(list) --*
                ...
                - *(dict) --*
                  ...
                  Metadata that you assign to your AWS resources. Tags enable you to categorize your
                  resources in different ways, for example, by purpose, owner, or environment. In
                  Systems Manager, you can apply tags to documents, managed instances, maintenance
    ...
    def create_maintenance_window(
        ...
        .. note::
          ...
          . For example, if the maintenance window starts at 3 PM, the duration is three hours, and
          the value you specify for ``Cutoff`` is one hour, no maintenance window tasks can start
          after 5 PM.
        ...
        **Request Syntax**
        ...
        :param StartDate:
          ...
          to become active. StartDate allows you to delay activation of the maintenance window until
        ...
        :param ScheduleTimezone:
          ...
          or "Asia/Seoul". For more information, see the `Time Zone Database
        ...
        :param Tags:
          ...
          targets, and the environment it will run in. In this case, you could specify the following
    ...
    def create_ops_item(
        ...
        to create a new OpsItem. For more information, see `Getting Started with OpsCenter
        <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html>`__
        in the *AWS Systems Manager User Guide* .
        ...
        <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter.html>`__ in the *AWS
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          using an inline IAM policy that specifies tags. For more information, see `Getting Started
          with OpsCenter
    ...
    def create_patch_baseline(
        ...
        .. note::
          ...
          For information about valid key and value pairs in ``PatchFilters`` for each supported
        ...
        **Request Syntax**
          ...
          - **PatchRules** *(list) --* **[REQUIRED]**
            ...
            - *(dict) --*
              ...
              - **ComplianceLevel** *(string) --*
                ...
                compliance severity levels include the following: Unspecified, Critical, High,
              ...
              - **ApproveAfterDays** *(integer) --* **[REQUIRED]**
                ...
                patch is marked as approved in the patch baseline. For example, a value of ``7``
        ...
        :param ApprovedPatches:
          ...
          see `Package Name Formats for Approved and Rejected Patch Lists
        ...
        :param ApprovedPatchesComplianceLevel:
          ...
          reported as missing, this is the severity of the compliance violation. The default value
          is UNSPECIFIED.
        ...
        :param ApprovedPatchesEnableNonSecurity:
          ...
          be applied to the instances. The default value is 'false'. Applies to Linux instances
          only.
        ...
        :param RejectedPatchesAction:
          ...
          * **ALLOW_AS_DEPENDENCY** : A package in the Rejected patches list is installed only if it
          is a dependency of another package. It is considered compliant with the patch baseline,
          and its status is reported as *InstalledOther* . This is the default action if no option
          is specified.

          * **BLOCK** : Packages in the RejectedPatches list, and packages that include them as
          dependencies, are not installed under any circumstances. If a package was installed before
        ...
        :param Sources:
          ...
          - *(dict) --*
            ...
            - **Products** *(list) --* **[REQUIRED]**
              ...
              lists of supported product values, see  PatchFilter .
        ...
        :param Tags:
          ...
          operating system family it applies to. In this case, you could specify the following key
          name/value pairs:
    ...
    def create_resource_data_sync(
        ...
        information, see `Configuring Resource Data Sync for Inventory
        <http://docs.aws.amazon.com/systems-manager/latest/userguide/sysman-inventory-datasync.html>`__
        in the *AWS Systems Manager User Guide* .

        You can configure Systems Manager Explorer to use the ``SyncToDestination`` type to
        synchronize operational work items (OpsItems) and operational data (OpsData) from multiple
        AWS Regions to a single Amazon S3 bucket. You can also configure Explorer to use the
        ``SyncFromSource`` type. This type synchronizes OpsItems and OpsData from multiple AWS
        accounts and Regions by using AWS Organizations. For more information, see `Setting Up
        ...
        successful initial sync is completed, the system continuously syncs data. To check the
        status of a sync, use the  ListResourceDataSync .
        ...
        **Request Syntax**
        ...
        :param SyncType:
          ...
          Specify ``SyncToDestination`` to create a resource data sync that synchronizes data from
          multiple AWS Regions to an Amazon S3 bucket. Specify ``SyncFromSource`` to synchronize
          data from multiple AWS accounts and Regions, as listed in AWS Organizations.
    ...
    def delete_association(
        ...
        the instance. To change the configuration state of an instance after you disassociate a
    ...
    def delete_document(
        ...
        all instances that are associated with the document.
        ...
        **Request Syntax**
        ...
        :param Force:
          ...
          Some SSM document types require that you specify a ``Force`` flag before you can delete
          the document. For example, you must specify a ``Force`` flag to delete a document of type
    ...
    def delete_inventory(
        ...
        **Request Syntax**
        ...
        :param SchemaDeleteOption:
          ...
          the ``PutInventory`` action for a version greater than the disabled version.
        ...
        :param DryRun:
          ...
          data type. This option is useful when you only want to understand what will be deleted.
          Once you validate that the data to be deleted is what you intend to delete, you can run
          the same command without specifying the ``DryRun`` option.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DeletionId** *(string) --*
              ...
              Every ``DeleteInventory`` action is assigned a unique ID. This option returns a unique
              ID. You can use this ID to query the status of a delete operation. This option is
              useful for ensuring that a delete operation has completed before you begin other
              actions.
    ...
    def describe_association(
        ...
        association by using the ``Targets`` parameter, then you must retrieve the association by
        using the association ID. If you created the association by specifying an instance ID and a
        ...
        **Request Syntax**
        ...
        :param AssociationVersion:
          ...
          for an instance, use  ListAssociations . To get a list of versions for a specific
        ...
        ::
          ...
          response = client.describe_automation_executions(
              Filters=[
                  {
                      'Key':
                      'DocumentNamePrefix'|'ExecutionStatus'|'ExecutionId'
                      |'ParentExecutionId'|'CurrentAction'|'StartTimeBefore'
                      |'StartTimeAfter'|'AutomationType',
                      'Values': [
                          'string',
                      ]
                  },
                ...
                'AutomationExecutionMetadataList': [
                    {
                        ...
                        'Pending'|'InProgress'|'Waiting'|'Success'|'TimedOut'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AutomationExecutionMetadataList** *(list) --*
              ...
              The list of details about each automation execution which has occurred which matches
              the filter specification, if any.
              ...
              - *(dict) --*
                ...
                - **AutomationType** *(string) --*
                  ...
                  accounts. For more information, see `Executing Automations in Multiple AWS Regions
                  and Accounts
        ...
        ::
          ...
          response = client.describe_automation_step_executions(
              ...
              Filters=[
                  {
                      'Key':
                      'StartTimeBefore'|'StartTimeAfter'|'StepExecutionStatus'
                      |'StepExecutionId'|'StepName'|'Action',
                      'Values': [
                          'string',
                      ]
                  },
            ...
            - **StepExecutions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ValidNextSteps** *(list) --*
                  ...
                  step and allow automation to run the next step. With conditional branching, we add
                  step:stepName to support the automation to go to another specific step.
    ...
    def describe_document(
        ...
        **Request Syntax**
        ...
        :param VersionName:
          ...
          example, "Release 12, Update 6". This value is unique across all versions of a document,
          ...
          - *(dict) --*
            ...
            - **AccountSharingInfoList** *(list) --*
              ...
              - *(dict) --*
                ...
                Information includes the AWS account ID where the current document is shared and the
          ...
          - *(dict) --*
            ...
            - **EffectivePatches** *(list) --*
              ...
              - *(dict) --*
                ...
                state of the patch in a particular patch baseline. The approval state includes
                ...
                - **Patch** *(dict) --*
                  ...
                  classification and a URL for where more information can be obtained about the
                  patch.
    ...
    def describe_instance_information(
        ...
        """
        Describes one or more of your instances. You can use this to get information about instances
        like the operating system platform, the SSM Agent version (Linux), status etc. If you
        specify one or more instance IDs, it returns information for those instances. If you do not
        specify instance IDs, it returns information for all your instances. If you specify an
        ...
        .. note::
          ...
          role assigned to on-premises instances. This call does not return the IAM role for Amazon
          EC2 instances.
        ...
        **Request Syntax**
              ...
              InstanceInformationFilterList=[
                  {
                      ...
                      |'ActivationIds'|'IamRole'|'ResourceType'|'AssociationStatus',
                      'valueSet': [
                          'string',
                      ]
                  },
        ...
        :param InstanceInformationFilterList:
          ...
          InstanceInformationFilter action. The ``InstanceInformationFilter`` action enables you to
          return instance information by using tags that are specified as a key-value mapping.

          If you do use this method, then you can't use the ``InstanceInformationFilter`` action.
          Using this method and the ``InstanceInformationFilter`` action causes an exception error.
        ...
        :param Filters:
          ...
          filter on Amazon EC2 tag. Specify tags by using a key-value mapping.
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --* **[REQUIRED]**
              ...
              |"IamRole"|"ResourceType"|"AssociationStatus"|"Tag
              Key"
            ...
            - **InstanceInformationList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **IsLatestVersion** *(boolean) --*
                  ...
                  Instance. This field does not indicate whether or not the latest version is
                  installed on Windows managed instances, because some older versions of Windows
                  Server use the EC2Config service to process SSM requests.
                ...
                - **IamRole** *(string) --*
                  ...
                  Systems Manager managed instances. This call does not return the IAM role for
          ...
          - *(dict) --*
            ...
            - **InstancePatchStates** *(list) --*
              ...
              - *(dict) --*
                ...
                patches along with metadata about the operation when this information was gathered
                for the instance.
                ...
                - **InstallOverrideList** *(string) --*
                  ...
                  This patch installation list, which you maintain in an Amazon S3 bucket in YAML
                ...
                - **RebootOption** *(string) --*
                  ...
                  * **NoReboot** : Patch Manager attempts to install missing packages without trying
                  ...
                  ``InstalledPendingReboot`` . These patches might not be in effect until a reboot
                  is performed.
    ...
    def describe_instance_patches(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          combination. Valid values for Key are ``Classification`` | ``KBId`` | ``Severity`` |
          ``State`` .
                ...
                'Patches': [
                    {
                        ...
                        'Severity': 'string',
                        'State':
                        'INSTALLED'|'INSTALLED_OTHER'|'INSTALLED_PENDING_REBOOT'
                        |'INSTALLED_REJECTED'|'MISSING'|'NOT_APPLICABLE'|'FAILED',
          ...
          - *(dict) --*
            ...
            - **WindowExecutionTaskInvocationIdentities** *(list) --*
              ...
              - *(dict) --*
                ...
                Describes the information about a task invocation for a particular target as part of
                a task execution performed as part of a maintenance window execution.
                ...
                - **OwnerInformation** *(string) --*
                  ...
                  maintenance window. This was also included in any CloudWatch events raised during
                  the task invocation.
            ...
            - **ScheduledWindowExecutions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ExecutionTime** *(string) --*
                  ...
                  The time, in ISO-8601 Extended format, that the maintenance window is scheduled to
                  be run.
            ...
            - **Tasks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Targets** *(list) --*
                  ...
                  Key=instanceids,Values=
                      <instanceid1>,<instanceid2>. Tags are specified using
                  Key=<tag name>,Values=<tag value>.
        ...
        ::
          ...
          response = client.describe_ops_items(
              OpsItemFilters=[
                  {
                      'Key':
                      'Status'|'CreatedBy'|'Source'|'Priority'|'Title'|'OpsItemId'
                      |'CreatedTime'|'LastModifiedTime'|'OperationalData'
                      |'OperationalDataKey'|'OperationalDataValue'|'ResourceId'
                      |'AutomationId'|'Category'|'Severity',
                      'Values': [
                          'string',
                      ],
    ...
    def describe_parameters(
        ...
        .. note::
          ...
          reaches an internal limit while processing the results, it stops the operation and returns
        ...
        :param ParameterFilters:
          ...
          - *(dict) --*
            ...
            .. warning::
              ...
              <http://docs.aws.amazon.com/systems-manager/latest/userguide/parameter-search.html>`__
              in the *AWS Systems Manager User Guide* .
            ...
            - **Option** *(string) --*
              ...
              ``BeginsWith`` . (Exception: For filters using the key ``Label`` , the only valid
              option is ``Equals`` .)
                ...
                - **Policies** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **PolicyStatus** *(string) --*
                      ...
                      policy has not been enforced or applied yet), Finished (the policy was
            ...
            - **BaselineIdentities** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DefaultBaseline** *(boolean) --*
                  ...
                  multiple default patch baselines. For example, you can create a default patch
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **InstancesWithInstalledRejectedPatches** *(integer) --*
              ...
              list. Patches with a status of *INSTALLED_REJECTED* were typically installed before
          ...
          ::

            {
                'AutomationExecution': {
                    ...
                    'ExecutionEndTime': datetime(2015, 1, 1),
                    'AutomationExecutionStatus':
                    'Pending'|'InProgress'|'Waiting'|'Success'|'TimedOut'|'Cancelling'
                    |'Cancelled'|'Failed',
                    'StepExecutions': [
                        {
                            'StepName': 'string',
                            ...
                            'ExecutionEndTime': datetime(2015, 1, 1),
                            'StepStatus':
                            'Pending'|'InProgress'|'Waiting'|'Success'
          ...
          - *(dict) --*
            ...
            - **AutomationExecution** *(dict) --*
              ...
              - **StepExecutionsTruncated** *(boolean) --*
                ...
                Automation step executions. If true, use the DescribeAutomationStepExecutions API
                action to get the full list of step executions.
    ...
    def get_command_invocation(
        ...
        **Request Syntax**
        ...
        :param InstanceId: **[REQUIRED]**
          ...
          (Required) The ID of the managed instance targeted by the command. A managed instance can
          be an Amazon EC2 instance or an instance in your hybrid environment that is configured for
          Systems Manager.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **InstanceId** *(string) --*
              ...
              The ID of the managed instance targeted by the command. A managed instance can be an
              Amazon EC2 instance or an instance in your hybrid environment that is configured for
              Systems Manager.
            ...
            - **ExecutionStartDateTime** *(string) --*
              ...
              AWS CLI command uses the ``InvokedBefore`` filter.
            ...
            - **ExecutionEndDateTime** *(string) --*
              ...
              sample AWS CLI command uses the ``InvokedAfter`` filter.
            ...
            - **StatusDetails** *(string) --*
              ...
              * Failed: The command wasn't run successfully on the instance. For a plugin, this
              ...
              * Undeliverable: The command can't be delivered to the instance. The instance might
              ...
              the parent command's MaxErrors limit and don't contribute to whether the parent
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **VersionName** *(string) --*
              ...
              Update 6". This value is unique across all versions of a document, and cannot be
              changed.
    ...
    def get_inventory(
        ...
        **Request Syntax**
        ...
        :param Aggregators:
          ...
          type, you can see a count of how many Windows and Linux instances exist in your
          inventoried fleet.
                ...
                - **Filters** *(list) --* **[REQUIRED]**
                  ...
                  - *(dict) --*
                    ...
                    - **Values** *(list) --* **[REQUIRED]**
                      ...
                      specified as values Key=
                          AWS:InstanceInformation.InstanceId,Values=
            ...
            - **Entities** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Id** *(string) --*
                  ...
                  result will be the managed instance ID. For EC2 instance inventory, the result
            ...
            - **Schemas** *(list) --*
              ...
              - *(dict) --*
                ...
                - **TypeName** *(string) --*
                  ...
                  Custom inventory type names will start with Custom. Default inventory item types
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TaskArn** *(string) --*
              ...
              value is the function name/ARN. For STEP_FUNCTIONS tasks, the value is the state
              machine ARN.
            ...
            - **TaskInvocationParameters** *(dict) --*
              ...
              - **RunCommand** *(dict) --*
                ...
                - **NotificationConfig** *(dict) --*
                  ...
                  - **NotificationEvents** *(list) --*
                    ...
                    Failed. To learn more about these events, see `Configuring Amazon SNS
                    Notifications for AWS Systems Manager
              ...
              - **Lambda** *(dict) --*
                ...
                - **ClientContext** *(string) --*
                  ...
                  can then process the client information in your Lambda function as you choose
                  through the context variable.

                - **Qualifier** *(string) --*

                  (Optional) Specify a Lambda function version or alias name. If you specify a
                  function version, the action uses the qualified function ARN to invoke a specific
                  Lambda function. If you specify an alias name, the action uses the alias ARN to
          ...
          - *(dict) --*
            ...
            - **OpsItem** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                more information, see `Editing OpsItem Details
              ...
              - **OperationalData** *(dict) --*
                ...
                OpsItem Overview page (as provided by the  DescribeOpsItems API action) can view and
                search on the specified data. Operational data that is not searchable is only
                viewable by users who have access to the OpsItem (as provided by the  GetOpsItem API
                action).
                ...
                Automation runbook with the OpsItem. To view AWS CLI example commands that use these
                keys, see `Creating OpsItems Manually
                <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-creating-OpsItems.html#OpsCenter-manually-create-OpsItems>`__
                in the *AWS Systems Manager User Guide* .
        ...
        **Request Syntax**
                      ...
                      'Filters': [
                          {
                              ...
                              'Type':
                              'Equal'|'NotEqual'|'BeginWith'|'LessThan'
                              |'GreaterThan'|'Exists'
                          },
                      ],
                      'Aggregators': {'... recursive ...'}
        ...
        :param Aggregators:
          ...
          - *(dict) --*
            ...
            One or more aggregators for viewing counts of OpsItems using different dimensions such
            as ``Source`` , ``CreatedTime`` , or ``Source and CreatedTime`` , to name a few.
    ...
    def get_parameters_by_path(
        ...
        **Request Syntax**
        ...
        :param Path: **[REQUIRED]**
          ...
          The hierarchy for the parameter. Hierarchies start with a forward slash (/) and end with
          the parameter name. A parameter name hierarchy can have a maximum of 15 levels. Here is an
        ...
        :param Recursive:
          ...
          .. warning::
            ...
            ``/a/b`` , they can still call the GetParametersByPath API action recursively for ``/a``
            and view ``/a/b`` .
...

            {
                ...
                'GlobalFilters': {
                    'PatchFilters': [
                        {
                            'Key':
                            'PATCH_SET'|'PRODUCT'|'PRODUCT_FAMILY'
              ...
              - **PatchRules** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **ApproveAfterDays** *(integer) --*
                    ...
                    the patch is marked as approved in the patch baseline. For example, a value of
                    ``7`` means that patches are approved seven days after they are released.
    ...
    def get_service_setting(self, SettingId: str) -> ClientGetServiceSettingResponseTypeDef:
        """
         ``ServiceSetting`` is an account-level setting for an AWS service. This setting defines how
         a user interacts with or uses a service or a feature of a service. For example, if an AWS
        ...
        Services map a ``SettingId`` object to a setting value. AWS services teams define the
        default value for a ``SettingId`` . You can't create a new ``SettingId`` , but you can
        overwrite the default value if you have the ``ssm:UpdateServiceSetting`` permission for the
        setting. Use the  UpdateServiceSetting API action to change the default setting. Or use the
          ...
          - *(dict) --*
            ...
            - **ServiceSetting** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                * PendingUpdate: The current setting uses a default or custom value, but a setting
                change request is pending approval.
    ...
    def label_parameter_version(
        ...
        * You can't delete a parameter label. If you no longer want to use a parameter label, then
        you must move it to a different version of a parameter.
        ...
        ::
          ...
          response = client.list_associations(
              AssociationFilterList=[
                  {
                      'key':
                      'InstanceId'|'Name'|'AssociationId'|'AssociationStatusName'
                      |'LastExecutedBefore'|'LastExecutedAfter'|'AssociationName',
                      'value': 'string'
                  },
              ],
              MaxResults=123,
    ...
    def list_command_invocations(
        ...
        **Request Syntax**
        ::
          ...
          response = client.list_command_invocations(
              ...
              Filters=[
                  {
                      'key':
                      'InvokedAfter'|'InvokedBefore'|'Status'|'ExecutionStage'
                      |'DocumentName',
                      'value': 'string'
                  },
              ],
        ...
        :param Filters:
          ...
          Note that the ``DocumentName`` filter is not supported for ListCommandInvocations.
          ...
          - *(dict) --*
            ...
            - **value** *(string) --* **[REQUIRED]**
              ...
              * **Status** : Specify a valid command status to see a list of all command executions
              ...
              * **DocumentName** : Specify name of the SSM document for which you want to see
              command execution results. For example, specify ``AWS-RunPatchBaseline`` to see
              command executions that used this SSM document to perform security patching operations
              on instances.
                ...
                'CommandInvocations': [
                    {
                        ...
                        'Status':
                        'Pending'|'InProgress'|'Delayed'|'Success'|'Cancelled'
                        ...
                        'CommandPlugins': [
                            {
                                'Name': 'string',
                                'Status':
                                'Pending'|'InProgress'|'Success'|'TimedOut'
                                |'Cancelled'|'Failed',
                                'StatusDetails': 'string',
                                'ResponseCode': 123,
          ...
          - *(dict) --*
            ...
            - **CommandInvocations** *(list) --*
              ...
              - *(dict) --*
                ...
                if a user runs SendCommand against three instances, then a command invocation is
                created for each requested instance ID. A command invocation returns status and
                ...
                - **StatusDetails** *(string) --*
                  ...
                  * Undeliverable: The command can't be delivered to the instance. The instance
                  ...
                  against the parent command's MaxErrors limit and don't contribute to whether the
                ...
                - **StandardOutputUrl** *(string) --*
                  ...
                  defined for the parent command. For an invocation, StandardOutputUrl is populated
                ...
                'Commands': [
                    {
                        ...
                        'RequestedDateTime': datetime(2015, 1, 1),
                        'Status':
                        'Pending'|'InProgress'|'Success'|'Cancelled'|'Failed'
                        |'TimedOut'|'Cancelling',
                        'StatusDetails': 'string',
                        'OutputS3Region': 'string',
                        'OutputS3BucketName': 'string',
            ...
            - **Commands** *(list) --*
              ...
              - *(dict) --*
                ...
                - **StatusDetails** *(string) --*
                  ...
                  * Execution Timed Out: The value of MaxErrors or more command invocations shows a
                  status of Execution Timed Out. This is a terminal state.
                  ...
                  * Incomplete: The command was attempted on all instances and one or more
                  invocations does not have a value of Success but not enough invocations failed for
                  the status to be Failed. This is a terminal state.

                  * Canceled: The command was terminated before it was completed. This is a terminal
                  state.

                  * Rate Exceeded: The number of instances targeted by the command exceeded the
                  account limit for pending invocations. The system has canceled the command before
                  running it on any instance. This is a terminal state.
                ...
                - **MaxConcurrency** *(string) --*
                  ...
                  instances, such as 10%. The default value is 50. For more information about how to
                  use MaxConcurrency, see `Running Commands Using Systems Manager Run Command
                  <http://docs.aws.amazon.com/systems-manager/latest/userguide/run-command.html>`__
                  in the *AWS Systems Manager User Guide* .
          ...
          - *(dict) --*
            ...
            - **ComplianceItems** *(list) --*
              ...
              - *(dict) --*
                ...
                patch resource type, ``Items`` includes information about the PatchSeverity,
                Classification, etc.
            ...
            - **DocumentVersions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **VersionName** *(string) --*
                  ...
                  12, Update 6". This value is unique across all versions of a document, and cannot
                  be changed.
            ...
            - **DocumentIdentifiers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **TargetType** *(string) --*
                  ...
                  The target type which defines the kinds of resources the document can run on. For
                  example, /AWS::EC2::Instance. For a list of valid resource types, see `AWS
    ...
    def list_resource_data_sync(
        ...
        ``ListResourceDataSync`` . You can limit the number of sync configurations returned by using
        the ``MaxResults`` parameter. To determine whether there are more sync configurations to
        list, check the value of ``NextToken`` in the output. If there are more sync configurations
        to list, you can request them by specifying the ``NextToken`` returned in the call to the
        ...
        **Request Syntax**
        ...
        :param SyncType:
          ...
          buckets. Specify ``SyncFromSource`` to view resource data syncs from AWS Organizations or
            ...
            - **ResourceDataSyncItems** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SyncType** *(string) --*
                  ...
                  The type of resource data sync. If ``SyncType`` is ``SyncToDestination`` , then
                  the resource data sync synchronizes data to an Amazon S3 bucket. If the
                  ``SyncType`` is ``SyncFromSource`` then the resource data sync synchronizes data
                ...
                - **SyncSource** *(dict) --*
                  ...
                  - **State** *(string) --*
                    ...
                    states:
                     ...
                     the resource data sync configuration.
    ...
    def modify_document_permission(
        ...
        **Request Syntax**
        ...
        :param AccountIdsToAdd:
          ...
          The AWS user accounts that should have access to the document. The account IDs can either
          be a group of account IDs or *All* .
        ...
        :param AccountIdsToRemove:
          ...
          account can either be a group of account IDs or *All* . This action has a higher priority
          than *AccountIdsToAdd* . If you specify an account ID to add and the same ID to remove,
    ...
    def put_compliance_items(
        ...
        **Request Syntax**
        ...
        :param Items: **[REQUIRED]**
          ...
          compliance type, ``Items`` includes information about the PatchSeverity, Classification,
          etc.
    ...
    def put_parameter(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          qualified name includes the complete hierarchy of the parameter path and name. For
          ...
          * Parameter hierarchies are limited to a maximum depth of fifteen levels.
          ...
          .. note::
            ...
            parameter name is 1011 characters, including the full length of the parameter ARN. For
            example, the following fully qualified parameter name is 65 characters, not 20
            characters:
        ...
        :param Type: **[REQUIRED]**
          ...
          .. note::
             ...
             ``SecureString`` is not currently supported for AWS CloudFormation templates or in the
             China Regions.
        ...
        :param KeyId:
          ...
          Management Service (AWS KMS) key automatically assigned to your AWS account or a custom
        ...
        :param Tier:
          ...
          policies. You can create a maximum of 10,000 standard parameters for each Region in an AWS
          ...
          Region in an AWS account. Advanced parameters incur a charge. For more information, see
          ...
          parameter according to that request. However, if you do not specify a tier in a request,
          Parameter Store assigns the tier based on the current Parameter Store default tier
          configuration.

          The default tier when you begin using Parameter Store is the standard-parameter tier. If
          you use the advanced-parameter tier, you can specify one of the following as the default:

          * **Advanced** : With this option, Parameter Store evaluates all requests as advanced
          parameters.

          * **Intelligent-Tiering** : With this option, Parameter Store evaluates each request to
          determine if the parameter is standard or advanced.  If the request doesn't include any
          options that require an advanced parameter, the parameter is created in the
          standard-parameter tier. If one or more options requiring an advanced parameter are
          included in the request, Parameter Store create a parameter in the advanced-parameter
          ...
          * More than 10,000 parameters already exist in your AWS account in the current Region.
          ...
          Parameter Tier
          <http://docs.aws.amazon.com/systems-manager/latest/userguide/ps-default-tier.html>`__ in
        ...
        :param Policies:
          ...
          updating the policy. Updating the *parameter* does not affect the expiration date and
          ...
          modified for a specified period of time. This policy type is useful when, for example, a
          secret needs to be changed within a period of time, but it has not been changed.

          All existing policies are preserved until you send new policies or an empty policy. For
          more information about parameter policies, see `Working with Parameter Policies
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Version** *(integer) --*
              ...
              documents). By default, if you don't specify a specific version, the system returns
    ...
    def register_target_with_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param Targets: **[REQUIRED]**
          ...
          one, see `Examples\\: Register Targets with a Maintenance Window
    ...
    def register_task_with_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param ServiceRoleArn:
          ...
          service-linked role. If no service-linked role for Systems Manager exists in your account,
          it is created when you run ``RegisterTaskWithMaintenanceWindow`` .

          For more information, see the following topics in the in the *AWS Systems Manager User
          Guide* :
        ...
        :param TaskParameters:
          ...
          .. note::
             ...
             runs, instead use the ``Parameters`` option in the ``TaskInvocationParameters``
        ...
        :param TaskInvocationParameters:
          ...
          - **RunCommand** *(dict) --*
            ...
            - **NotificationConfig** *(dict) --*
              ...
              - **NotificationEvents** *(list) --*
                ...
                learn more about these events, see `Configuring Amazon SNS Notifications for AWS
                Systems Manager
                <http://docs.aws.amazon.com/systems-manager/latest/userguide/monitoring-sns-notifications.html>`__
                in the *AWS Systems Manager User Guide* .
          ...
          - **Lambda** *(dict) --*
            ...
            - **Qualifier** *(string) --*
              ...
              version, the action uses the qualified function ARN to invoke a specific Lambda
              function. If you specify an alias name, the action uses the alias ARN to invoke the
        ...
        :param LoggingInfo:
          ...
          A structure containing information about an Amazon S3 bucket to write instance-level logs
          to.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **StreamUrl** *(string) --*
              ...
              commands and receive output from the instance. Format: ``wss://ssmmessages.**region**
               ...
               **region** represents the Region identifier for an AWS Region supported by AWS
               ...
               supported **region** values, see the **Region** column in the `AWS Systems Manager
               table of regions and endpoints
               <http://docs.aws.amazon.com/general/latest/gr/rande.html#ssm_region>`__ in the *AWS
               General Reference* .
    ...
    def send_automation_signal(
        self, AutomationExecutionId: str, SignalType: str, Payload: Dict[str, List[str]] = None
    ) -> Dict[str, Any]:
        """
    ...
    def send_command(
        ...
        **Request Syntax**
        ...
        :param InstanceIds:
          ...
          The instance IDs where the command should run. You can specify a maximum of 50 IDs. If you
          prefer not to list individual instance IDs, you can instead send commands to a fleet of
          instances using the Targets parameter, which accepts EC2 tags. For more information about
          how to use targets, see `Sending Commands to a Fleet
          <http://docs.aws.amazon.com/systems-manager/latest/userguide/send-commands-multiple.html>`__
          in the *AWS Systems Manager User Guide* .
        ...
        :param Targets:
          ...
          combination that you specify. Targets is required if you don't provide one or more
          instance IDs in the call. For more information about how to use targets, see `Sending
          Commands to a Fleet
          <http://docs.aws.amazon.com/systems-manager/latest/userguide/send-commands-multiple.html>`__
          in the *AWS Systems Manager User Guide* .
        ...
        :param DocumentVersion:
          ...
          specific version number. If you run commands by using the AWS CLI, then you must escape
          the first two options by using a backslash. If you specify a version number, then you
        ...
        :param MaxConcurrency:
          ...
          time. You can specify a number such as 10 or a percentage such as 10%. The default value
          is 50. For more information about how to use MaxConcurrency, see `Using Concurrency
          Controls
        ...
        :param MaxErrors:
          ...
          additional targets. You can specify a number like 10 or a percentage like 10%. The default
          value is 0. For more information about how to use MaxErrors, see `Using Error Controls
          ...
          ::

            {
                'Command': {
                    ...
                    'RequestedDateTime': datetime(2015, 1, 1),
                    'Status':
                    'Pending'|'InProgress'|'Success'|'Cancelled'|'Failed'|'TimedOut'
                    |'Cancelling',
                    'StatusDetails': 'string',
                    'OutputS3Region': 'string',
                    'OutputS3BucketName': 'string',
            ...
            - **Command** *(dict) --*
              ...
              - **StatusDetails** *(string) --*
                ...
                * Incomplete: The command was attempted on all instances and one or more invocations
                does not have a value of Success but not enough invocations failed for the status to
              ...
              - **MaxConcurrency** *(string) --*
                ...
                instances, such as 10%. The default value is 50. For more information about how to
                use MaxConcurrency, see `Running Commands Using Systems Manager Run Command
                <http://docs.aws.amazon.com/systems-manager/latest/userguide/run-command.html>`__ in
                the *AWS Systems Manager User Guide* .
              ...
              - **MaxErrors** *(string) --*
                ...
                use MaxErrors, see `Running Commands Using Systems Manager Run Command
                <http://docs.aws.amazon.com/systems-manager/latest/userguide/run-command.html>`__ in
                the *AWS Systems Manager User Guide* .
              ...
              - **NotificationConfig** *(dict) --*
                ...
                - **NotificationArn** *(string) --*
                  ...
                  An Amazon Resource Name (ARN) for an Amazon Simple Notification Service (Amazon
                  SNS) topic. Run Command pushes notifications about command status changes to this
                  topic.
    ...
    def start_automation_execution(
        ...
        **Request Syntax**
        ...
        :param MaxErrors:
          ...
          then the system stops running the automation on additional targets when the sixth error is
          received.
        ...
        :param TargetLocations:
          ...
          Automation. Use this action to start an Automation in multiple Regions and multiple
    ...
    def start_session(
        ...
        Returns a URL and token that can be used to open a WebSocket connection for sending input
        and receiving outputs.

        .. note::

          AWS CLI usage: ``start-session`` is an interactive command that requires the Session
          Manager plugin to be installed on the client machine making the call. For information, see
        ...
        **Request Syntax**
        ...
        :param DocumentName:
          ...
          For example, ``SSM-SessionManagerRunShell`` . If no document name is provided, a shell to
    ...
    def terminate_session(self, SessionId: str) -> ClientTerminateSessionResponseTypeDef:
        ...
        and SSM Agent on the instance. A terminated session cannot be resumed.
    ...
    def update_association(
        ...
        with permission to call the  DescribeAssociation API action. If you don't have permission to
        call DescribeAssociation, then you receive the following error: ``An error occurred
        (AccessDeniedException) when calling the UpdateAssociation operation: User: <user_arn> is
        not authorized to perform: ssm:DescribeAssociation on resource: <resource_arn>``
    ...
    def update_maintenance_window_task(
        ...
        * MaxErrors
        ...
        Replace to true, then all fields required by the  RegisterTaskWithMaintenanceWindow action
    ...
    def update_ops_item(
        ...
        (IAM) to update an OpsItem. For more information, see `Getting Started with OpsCenter
        <http://docs.aws.amazon.com/systems-manager/latest/userguide/OpsCenter-getting-started.html>`__
        in the *AWS Systems Manager User Guide* .
    ...
    def update_resource_data_sync(
        ...
        (Ohio) Region and you choose the Include only the current account option, you can't edit
        that sync later and choose the Include all accounts from my AWS Organizations configuration
        option. Instead, you must delete the first resource data sync, and create a new one.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ssm-2014-11-06/UpdateResourceDataSync>`_
    ...
    def update_service_setting(self, SettingId: str, SettingValue: str) -> Dict:
        ...
        default value for a ``SettingId`` . You can't create a new ``SettingId`` , but you can
        overwrite the default value if you have the ``ssm:UpdateServiceSetting`` permission for the
        setting. Use the  GetServiceSetting API action to view the current value. Or, use the
        ResetServiceSetting to change the value back to the original value defined by the AWS
        service team.
