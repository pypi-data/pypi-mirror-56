...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        you track each instance's owner and stack level. For example: Key=Owner and Value=DbAdmin, SysAdmin,
        or Dev. Or Key=Stack and Value=Production, Pre-Production, or Test.

        Each resource can have a maximum of 50 tags.

        We recommend that you devise a set of tag keys that meets your needs for each resource type. Using a
        consistent set of tag keys makes it easier for you to manage your resources. You can search and
        ...
        **Request Syntax**
        ...
        :param ResourceId: **[REQUIRED]**
          ...
          .. note::
            ...
            The ManagedInstance type for this API action is only for on-premises managed instances. You must
            specify the name of the managed instance in the following format: mi-ID_number. For example,
            mi-1a2b3c4d5e6f.
    ...
    def cancel_maintenance_window_execution(
        ...
        that have not already starting running. (Tasks already in progress will continue to completion.)
    ...
    def create_activation(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          intend to activate. In this case, you could specify the following key name/value pairs:
          ...
          * ``Key=Environment,Value=Production``
          ...
          managed instance ID. This means they are listed in the AWS Systems Manager console with an ID that
          is prefixed with "mi-". For information about how to add tags to your managed instances, see
    ...
    def create_association(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          You can specify AWS-predefined documents, documents you created, or a document that is shared with
        ...
        :param Targets:
          ...
          - *(dict) --*
            ...
            * (Maintenance window targets only)
            ``Key=resource-groups:ResourceTypeFilters,Values=*AWS::EC2::INSTANCE* ,*AWS::EC2::VPC* ``   This
            example demonstrates how to target only Amazon EC2 instances and VPCs in your maintenance
            window.
            ...
            * (State Manager association targets only) ``Key=InstanceIds,Values=*``   This example
            ...
            For information about how to send commands that target instances using ``Key,Value`` parameters,
        ...
        :param MaxErrors:
          ...
          example 10, or a percentage of the target set, for example 10%. If you specify 3, for example, the
          system stops sending requests when the fourth error is received. If you specify 0, then the system
          stops sending requests after the first error is returned. If you run an association on 50
          ...
          more than max-errors failed executions, set MaxConcurrency to 1 so that executions proceed one at
          a time.
        ...
        :param Entries: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **MaxErrors** *(string) --*
              ...
              the system stops sending requests when the fourth error is received. If you specify 0, then
              the system stops sending requests after the first error is returned. If you run an association
              on 50 instances and set MaxError to 10%, then the system stops sending the request when the
            ...
            - **MaxConcurrency** *(string) --*
              ...
              The maximum number of targets allowed to run the association at the same time. You can specify
              a number, for example 10, or a percentage of the target set, for example 10%. The default
              ...
              - *(dict) --*
                ...
                - **Entry** *(dict) --*
                  ...
                  - **MaxErrors** *(string) --*
                    ...
                    received. If you specify 0, then the system stops sending requests after the first error
                    is returned. If you run an association on 50 instances and set MaxError to 10%, then the
        ...
        :param Attachments:
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              format is the URL of the location of a document attachment, such as the URL of an Amazon S3
              bucket.
    ...
    def create_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param ScheduleTimezone:
          ...
          For more information, see the `Time Zone Database <https://www.iana.org/time-zones>`__ on the IANA
          website.
    ...
    def create_ops_item(
        ...
        **Request Syntax**
        ...
        :param RelatedOpsItems:
          ...
          related OpsItems can include OpsItems with similar error messages, impacted resources, or statuses
          ...
          response = client.create_patch_baseline(
              ...
              GlobalFilters={
                  'PatchFilters': [
                      {
                          'Key':
                          'PATCH_SET'|'PRODUCT'|'PRODUCT_FAMILY'|'CLASSIFICATION'|'MSRC_SEVERITY'|'PATCH_ID'
    ...
    def create_resource_data_sync(
        ...
        """
        A resource data sync helps you view data from multiple sources in a single location. Systems Manager
        offers two types of resource data sync: ``SyncToDestination`` and ``SyncFromSource`` .
        ...
        Organizations. For more information, see `Setting Up Explorer to Display Data from Multiple Accounts
        and Regions
        <http://docs.aws.amazon.com/systems-manager/latest/userguide/Explorer-resource-data-sync.html>`__ in
        the *AWS Systems Manager User Guide* .
    ...
    def delete_inventory(
        ...
        **Request Syntax**
        ...
        :param SchemaDeleteOption:
          ...
          version, and any earlier versions. To enable this schema again, you must call the ``PutInventory``
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DeletionId** *(string) --*
              ...
              Every ``DeleteInventory`` action is assigned a unique ID. This option returns a unique ID. You
              can use this ID to query the status of a delete operation. This option is useful for ensuring
              that a delete operation has completed before you begin other actions.
            ...
            - **DeletionSummary** *(dict) --*
              ...
              A summary of the delete operation. For more information about this summary, see `Understanding
    ...
    def delete_resource_data_sync(
        ...
        managed instances are no longer synced to or from the target. Deleting a sync configuration does not
        delete data.
    ...
    def describe_association(
        ...
        using the ``Targets`` parameter, then you must retrieve the association by using the association ID.
        If you created the association by specifying an instance ID and a Systems Manager document, then you
        retrieve the association by specifying the document name and the instance ID.
            ...
            - **AutomationExecutionMetadataList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **AutomationType** *(string) --*
                  ...
                  CrossAccount is an Automation that runs in multiple AWS Regions and accounts. For more
                  information, see `Executing Automations in Multiple AWS Regions and Accounts
            ...
            - **StepExecutions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ValidNextSteps** *(list) --*
                  ...
                  automation to run the next step. With conditional branching, we add step:stepName to
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AccountIds** *(list) --*
              ...
              The account IDs that have permission to use this document. The ID can be either an AWS account
              or *All* .
    ...
    def describe_instance_information(
        ...
        the operating system platform, the SSM Agent version (Linux), status etc. If you specify one or more
        instance IDs, it returns information for those instances. If you do not specify instance IDs, it
        returns information for all your instances. If you specify an instance ID that is not valid or an
        ...
        **Request Syntax**
        ...
        :param InstanceInformationFilterList:
          ...
          If you do use this method, then you can't use the ``InstanceInformationFilter`` action. Using this
          method and the ``InstanceInformationFilter`` action causes an exception error.
          ...
          - *(dict) --*
            ...
            method. The ``InstanceInformationFilterList`` method is a legacy method and does not support
            tags.
            ...
            - **InstanceInformationList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **IsLatestVersion** *(boolean) --*
                  ...
                  Windows managed instances, because some older versions of Windows Server use the EC2Config
            ...
            - **InstancePatchStates** *(list) --*
              ...
              - *(dict) --*
                ...
                - **LastNoRebootInstallOperationTime** *(datetime) --*
                  ...
                  The time of the last attempt to patch the instance with ``NoReboot`` specified as the
                  reboot option.
                ...
                - **RebootOption** *(string) --*
                  ...
                  .. note::
                    ...
                    Reboot options apply to ``Install`` operations only. Reboots are not attempted for Patch
                    Manager ``Scan`` operations.

                  * **RebootIfNeeded** : Patch Manager tries to reboot the instance if it installed any
                  patches, or if any patches are detected with a status of ``InstalledPendingReboot`` .

                  * **NoReboot** : Patch Manager attempts to install missing packages without trying to
                  reboot the system. Patches installed with this option are assigned a status of
                ...
                'Patches': [
                    {
                        ...
                        'Severity': 'string',
                        'State':
                        'INSTALLED'|'INSTALLED_OTHER'|'INSTALLED_PENDING_REBOOT'|'INSTALLED_REJECTED'
                        |'MISSING'|'NOT_APPLICABLE'|'FAILED',
    ...
    def describe_maintenance_window_execution_task_invocations(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          STATUS with the corresponding values PENDING, IN_PROGRESS, SUCCESS, FAILED, TIMED_OUT, CANCELLING,
          and CANCELLED.
            ...
            - **Tasks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **TaskArn** *(string) --*
                  ...
                  types, ``TaskArn`` is the Systems Manager document name or ARN. For LAMBDA tasks, it's the
        ...
        :param ParameterFilters:
          ...
          - *(dict) --*
            ...
            .. warning::
              ...
              GetParametersByPath API actions. However, not all of the pattern values listed for ``Key`` can
              be used with both actions.
            ...
            - **BaselineIdentities** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DefaultBaseline** *(boolean) --*
                  ...
                  Whether this is the default baseline. Note that Systems Manager supports creating multiple
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **InstancesWithInstalledPendingRebootPatches** *(integer) --*
              ...
              The number of instances with patches installed that have not been rebooted after the patch
          ...
          - *(dict) --*
            ...
            - **AutomationExecution** *(dict) --*
              ...
              - **StepExecutionsTruncated** *(boolean) --*
                ...
                executions. If true, use the DescribeAutomationStepExecutions API action to get the full
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **PluginName** *(string) --*
              ...
              The name of the plugin for which you want detailed results. For example, aws:RunShellScript is
              a plugin.
            ...
            - **StatusDetails** *(string) --*
              ...
              control parameters. StatusDetails can show different results than Status. For more information
              ...
              * Undeliverable: The command can't be delivered to the instance. The instance might not exist
              or might not be responding. Undeliverable invocations don't count against the parent command's
    ...
    def get_connection_status(
        ...
        """
        Retrieves the Session Manager connection status for an instance to determine whether it is connected
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **VersionName** *(string) --*
              ...
              The version of the artifact associated with the document. For example, "Release 12, Update 6".
            ...
            - **Groups** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Filters** *(list) --* **[REQUIRED]**
                  ...
                  of resources that match the criteria. The ``notMatchingCount`` field displays the number
                  of resources that don't match the criteria.
            ...
            - **OpsItem** *(dict) --*
              ...
              - **RelatedOpsItems** *(list) --*
                ...
                - *(dict) --*
                  ...
                  An OpsItems that shares something in common with the current OpsItem. For example, related
                  OpsItems can include OpsItems with similar error messages, impacted resources, or statuses
                  for the impacted resource.
              ...
              - **OperationalData** *(dict) --*
                ...
                or other relevant data. You enter operational data as key-value pairs. The key has a maximum
                ...
                You can choose to make the data searchable by other users in the account or you can restrict
                search access. Searchable data means that all users with access to the OpsItem Overview page
                (as provided by the  DescribeOpsItems API action) can view and search on the specified data.
                Operational data that is not searchable is only viewable by users who have access to the
                OpsItem (as provided by the  GetOpsItem API action).
                  ...
                  - **PatchFilterGroup** *(dict) --*
                    ...
                    - **PatchFilters** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        matching criterion for the patch property indicated by the key. For example, if the
                        filter key is PRODUCT and the filter values are ["Office 2013", "Office 2016"], then
                        the filter accepts all patches where product name is either "Office 2013" or "Office
                        2016". The filter values can be exact values for the patch property given as a key,
    ...
    def get_service_setting(
        ...
        for a ``SettingId`` . You can't create a new ``SettingId`` , but you can overwrite the default value
    ...
    def label_parameter_version(
        ...
        number by one. A label can help you remember the purpose of a parameter when there are multiple
        versions.
            ...
            - **CommandInvocations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **StandardOutputUrl** *(string) --*
                  ...
                  the parent command. For an invocation, StandardOutputUrl is populated if there is just one
                  ...
                  - *(dict) --*
                    ...
                    - **StatusDetails** *(string) --*
                      ...
                      * Undeliverable: The command can't be delivered to the instance. The instance might
                      ...
                      against the parent command's MaxErrors limit, and they don't contribute to whether the
            ...
            - **ComplianceItems** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Title** *(string) --*
                  ...
                  the title could be the title of the KB article for the patch; for example: Security Update
            ...
            - **DocumentVersions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **StatusInformation** *(string) --*
                  ...
                  a ``Failed`` status might be explained by the ``StatusInformation`` message, "The
                  specified S3 bucket does not exist. Verify that the URL of the S3 bucket is correct."
    ...
    def list_resource_data_sync(
        ...
        **Request Syntax**
        ...
        :param SyncType:
          ...
          view resource data syncs that synchronize data to an Amazon S3 buckets. Specify ``SyncFromSource``
          ...
          - *(dict) --*
            ...
            - **TagList** *(list) --*
              ...
              - *(dict) --*
                ...
                in different ways, for example, by purpose, owner, or environment. In Systems Manager, you
                can apply tags to documents, managed instances, maintenance windows, Parameter Store
    ...
    def modify_document_permission(
        ...
        specify the AWS user account IDs for those people who can use the document. If you share a document
        ...
        :param Items: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **ContentHash** *(string) --*
              ...
              update inventory information. The PutInventory API does not update the inventory item type
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          * Parameter hierarchies are limited to a maximum depth of fifteen levels.
          ...
          .. note::
            ...
            that are not part of the name. The maximum length for the fully qualified parameter name is 1011
            characters, including the full length of the parameter ARN. For example, the following fully
            qualified parameter name is 65 characters, not 20 characters:
        ...
        :param KeyId:
          ...
          * To use your default AWS KMS key, choose the ``SecureString`` data type, and do *not* specify the
          ``Key ID`` when you create the parameter. The system automatically populates ``Key ID`` with your
          default KMS key.
        ...
        :param Tier:
          ...
          * **Intelligent-Tiering** : With this option, Parameter Store evaluates each request to determine
          if the parameter is standard or advanced.  If the request doesn't include any options that require
          an advanced parameter, the parameter is created in the standard-parameter tier. If one or more
          options requiring an advanced parameter are included in the request, Parameter Store create a
          parameter in the advanced-parameter tier. This approach helps control your parameter-related costs
          by always creating standard parameters unless an advanced parameter is necessary.
        ...
        :param Policies:
          ...
          Updating the *parameter* does not affect the expiration date and time. When the expiration time is
          ...
          NoChangeNotification: This policy triggers a CloudWatch event if a parameter has not been modified
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Version** *(integer) --*
              ...
              documents). By default, if you don't specify a specific version, the system returns the latest
    ...
    def register_task_with_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param ServiceRoleArn:
          ...
          task. If you do not specify a service role ARN, Systems Manager uses your account's service-linked
          role. If no service-linked role for Systems Manager exists in your account, it is created when you
        ...
        :param TaskInvocationParameters:
          ...
          - **RunCommand** *(dict) --*
            ...
            - **NotificationConfig** *(dict) --*
              ...
              - **NotificationType** *(string) --*
                ...
                sent to multiple instances, receive notification on a per-instance basis when the status of
                a command changes.
          ...
          - **Lambda** *(dict) --*
            ...
            - **Qualifier** *(string) --*
              ...
              (Optional) Specify a Lambda function version or alias name. If you specify a function version,
              the action uses the qualified function ARN to invoke a specific Lambda function. If you
    ...
    def reset_service_setting(
        ...
        Services map a ``SettingId`` object to a setting value. AWS services teams define the default value
        for a ``SettingId`` . You can't create a new ``SettingId`` , but you can overwrite the default value
        if you have the ``ssm:UpdateServiceSetting`` permission for the setting. Use the  GetServiceSetting
        API action to view the current value. Use the  UpdateServiceSetting API action to change the default
        setting.
          ...
          - *(dict) --*
            ...
            - **StreamUrl** *(string) --*
               ...
               **region** values, see the **Region** column in the `AWS Systems Manager table of regions and
               endpoints <http://docs.aws.amazon.com/general/latest/gr/rande.html#ssm_region>`__ in the *AWS
               General Reference* .
    ...
    def send_command(
        ...
        **Request Syntax**
        ...
        :param MaxConcurrency:
          ...
          information about how to use MaxConcurrency, see `Using Concurrency Controls
        ...
        :param CloudWatchOutputConfig:
          ...
          - **CloudWatchLogGroupName** *(string) --*
            ...
            The name of the CloudWatch log group where you want to send command output. If you don't specify
            a group name, Systems Manager automatically creates a log group for you. The log group uses the
    ...
    def start_automation_execution(
        ...
        **Request Syntax**
        ...
        :param TargetMaps:
          ...
          A key-value mapping of document parameters to target resources. Both Targets and TargetMaps cannot
        ...
        :param MaxConcurrency:
          ...
          as 10, or a percentage, such as 10%. The default value is 10.

        :type MaxErrors: string
        :param MaxErrors:

          The number of errors that are allowed before the system stops running the automation on additional
          targets. You can specify either an absolute number of errors, for example 10, or a percentage of
          the target set, for example 10%. If you specify 3, for example, the system stops running the
          automation when the fourth error is received. If you specify 0, then the system stops running the
          automation on additional targets after the first error result is returned. If you run an
          automation on 50 resources and set max-errors to 10%, then the system stops running the automation
          ...
          complete, but some of these executions may fail as well. If you need to ensure that there won't be
          more than max-errors failed executions, set max-concurrency to 1 so the executions proceed one at
          a time.
    ...
    def start_session(
        ...
        """
        Initiates a connection to a target (for example, an instance) for a Session Manager session. Returns
        a URL and token that can be used to open a WebSocket connection for sending input and receiving
        outputs.
        ...
        **Request Syntax**
        ...
        :param DocumentName:
          ...
          example, ``SSM-SessionManagerRunShell`` . If no document name is provided, a shell to the instance
    ...
    def terminate_session(
        ...
        Agent on the instance. A terminated session cannot be resumed.
    ...
    def update_maintenance_window(
        ...
        **Request Syntax**
        ...
        :param Replace:
          ...
          If True, then all fields that are required by the CreateMaintenanceWindow action are also required
    ...
    def update_patch_baseline(
        ...
        **Request Syntax**
        ...
        :param Replace:
          ...
          If True, then all fields that are required by the CreatePatchBaseline action are also required for
    ...
    def update_resource_data_sync(
        ...
        choose the Include all accounts from my AWS Organizations configuration option. Instead, you must
        ...
        **Request Syntax**
        ...
        :param SyncType: **[REQUIRED]**
          ...
          sync synchronizes data to an Amazon S3 bucket. If the ``SyncType`` is ``SyncFromSource`` then the
    ...
    def update_service_setting(self, SettingId: str, SettingValue: str) -> Dict:
        ...
        for a ``SettingId`` . You can't create a new ``SettingId`` , but you can overwrite the default value
        if you have the ``ssm:UpdateServiceSetting`` permission for the setting. Use the  GetServiceSetting
        API action to view the current value. Or, use the  ResetServiceSetting to change the value back to
