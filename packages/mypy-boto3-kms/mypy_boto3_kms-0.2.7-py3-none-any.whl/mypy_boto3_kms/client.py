...
class Client(BaseClient):
    ...
    def cancel_key_deletion(self, KeyId: str) -> ClientCancelKeyDeletionResponseTypeDef:
        ...
        Keys <https://docs.aws.amazon.com/kms/latest/developerguide/deleting-keys.html>`__ in the *AWS Key
        ...
        <https://docs.aws.amazon.com/kms/latest/developerguide/key-state.html>`__ in the *AWS Key Management
    ...
    def connect_custom_key_store(self, CustomKeyStoreId: str) -> Dict[str, Any]:
        ...
        Custom Key Store <https://docs.aws.amazon.com/kms/latest/developerguide/fix-keystore.html>`__ in the
    ...
    def create_alias(self, AliasName: str, TargetKeyId: str) -> None:
        ...
        alias name cannot begin with ``alias/aws/`` . The ``alias/aws/`` prefix is reserved for `AWS managed
        CMKs <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#aws-managed-cmk>`__ .
        ...
        **Request Syntax**
        ...
        :param TargetKeyId: **[REQUIRED]**
          ...
          of the CMK. You cannot specify another alias. For help finding the key ID and ARN, see `Finding
          the Key ID and ARN
    ...
    def create_custom_key_store(
        ...
        <https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html>`__ feature in
        AWS KMS, which combines the convenience and extensive integration of AWS KMS with the isolation and
        ...
        When the operation completes successfully, it returns the ID of the new custom key store. Before you
        can use your new custom key store, you need to use the  ConnectCustomKeyStore operation to connect
        the new key store to its AWS CloudHSM cluster. Even if you are not going to use your custom key
        store immediately, you might want to connect it to verify that all settings are correct and then
        ...
        :param Constraints:
          ...
          *AWS Key Management Service Developer Guide* * .
          ...
          - **EncryptionContextSubset** *(dict) --*
            ...
            in the request includes the key-value pairs specified in this constraint, although it can
        ...
        **Request Syntax**
        ...
        :param Policy:
          ...
          * Each statement in the key policy must contain one or more principals. The principals in the key
          ...
          <https://docs.aws.amazon.com/kms/latest/developerguide/key-policies.html#key-policy-default>`__ in
          the *AWS Key Management Service Developer Guide* .
        ...
        :param CustomKeyStoreId:
          ...
          cluster that is associated with the custom key store must have at least two active HSMs, each in a
        ...
        :param BypassPolicyLockoutSafetyCheck:
          ...
          .. warning::
            ...
            Setting this value to true increases the risk that the CMK becomes unmanageable. Do not set this
          ...
          - *(dict) --*
            ...
            - **KeyMetadata** *(dict) --*
              ...
              - **KeyManager** *(string) --*
                ...
                For more information about the difference, see `Customer Master Keys
    ...
    def decrypt(
        ...
        *  Encrypt
        ...
        other accounts if the key policy for the cross-account CMK permits it. If you must use an IAM policy
        for ``Decrypt`` permissions, limit the user to particular CMKs or particular trusted accounts.
    ...
    def delete_imported_key_material(self, KeyId: str) -> None:
        ...
        After you delete key material, you can use  ImportKeyMaterial to reimport the same key material into
        the CMK.
    ...
    def describe_custom_key_stores(
        ...
        Custom key stores have a ``DISCONNECTED`` connection state if the key store has never been connected
        or you use the  DisconnectCustomKeyStore operation to disconnect it. If your custom key store state
        is ``CONNECTED`` but you are having trouble using it, make sure that its associated AWS CloudHSM
            ...
            - **CustomKeyStores** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ConnectionState** *(string) --*
                  ...
                  are having trouble using the custom key store, make sure that its associated AWS CloudHSM
                ...
                - **ConnectionErrorCode** *(string) --*
                  ...
                  * ``INTERNAL_ERROR`` - AWS KMS could not complete the request due to an internal error.
                  Retry the request. For ``ConnectCustomKeyStore`` requests, disconnect the custom key store
                  ...
                  * ``NETWORK_ERRORS`` - Network errors are preventing AWS KMS from connecting to the custom
                  key store.
    ...
    def describe_key(
        ...
        <https://docs.aws.amazon.com/kms/latest/developerguide/concepts.html#master_keys>`__ and returns its
        ...
        **Request Syntax**
        ...
        :param KeyId: **[REQUIRED]**
          ...
          If you specify a predefined AWS alias (an AWS alias with no key ID), KMS associates the alias with
          an `AWS managed CMK
          ...
          an alias name, prefix it with ``"alias/"`` . To specify a CMK in a different AWS account, you must
    ...
    def disconnect_custom_key_store(self, CustomKeyStoreId: str) -> Dict[str, Any]:
        ...
        associated AWS CloudHSM cluster. While a custom key store is disconnected, you can manage the custom
        key store and its customer master keys (CMKs), but you cannot create or use CMKs in the custom key
    ...
    def generate_data_key(
        ...
        """
        Generates a unique data key. This operation returns a plaintext copy of the data key and a copy that
        is encrypted under a customer master key (CMK) that you specify. You can use the plaintext key to
        ...
        keys), we recommend that you use ``KeySpec`` . To perform this operation on a CMK in a different AWS
        ...
        * Use the plaintext data key to decrypt data locally, then erase the plaintext data key from memory.
        ...
        same encryption context (a case-sensitive exact match) in your request to  Decrypt the data key.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Plaintext** *(bytes) --*
              ...
              Otherwise, it is not encoded. Use this data key to encrypt your data outside of KMS. Then,
    ...
    def generate_data_key_without_plaintext(
        ...
        containers. That component first decrypts the data key, uses the plaintext data key to encrypt data,
        puts the encrypted data into the container, and then destroys the plaintext data key. In this
    ...
    def generate_random(
        ...
        Cryptographic Details <https://d0.awsstatic.com/whitepapers/KMS-Cryptographic-Details.pdf>`__
        whitepaper.
    ...
    def get_key_rotation_status(
        ...
        * Pending deletion: While a CMK is pending deletion, its key rotation status is ``false`` and AWS
        KMS does not rotate the backing key. If you cancel the deletion, the original key rotation status is
        restored.
    ...
    def get_parameters_for_import(
        ...
        hours. When they expire, they cannot be used for a subsequent  ImportKeyMaterial request. To get new
        ...
        **Request Syntax**
        ...
        :param WrappingAlgorithm: **[REQUIRED]**
          ...
          . For more information, see `Encrypt the Key Material
    ...
    def import_key_material(
        ...
        material. You cannot perform this operation on a CMK in a different AWS account. For more
        information about creating CMKs with no key material and then importing key material, see `Importing
        Key Material <https://docs.aws.amazon.com/kms/latest/developerguide/importing-keys.html>`__ in the
        *AWS Key Management Service Developer Guide* .
        ...
        * Whether the key material expires and if so, when. If you set an expiration date, you can change it
        only by reimporting the same key material and specifying a new expiration date. If the key material
        expires, AWS KMS deletes the key material and the CMK becomes unusable. To use the CMK again, you
    ...
    def list_aliases(
        ...
        managed CMKs, and aliases that AWS created and associated with AWS managed CMKs in your account. You
        can recognize AWS aliases because their names have the format ``aws/<service-name>`` , such as
        ``aws/dynamodb`` .

        The response might also include aliases that have no ``TargetKeyId`` field. These are predefined
        aliases that AWS has created but has not yet associated with a CMK. Aliases that AWS creates in your
        account, including predefined aliases, do not count against your `AWS KMS aliases limit
    ...
    def re_encrypt(
        ...
        of the data on the client side. The data is first decrypted and then reencrypted. You can also use
        this operation to change the encryption context of a ciphertext.
    ...
    def retire_grant(
        ...
        * The ``GranteePrincipal`` , if ``RetireGrant`` is an operation specified in the grant
        ...
        You must identify the grant to retire by its grant token or by a combination of the grant ID and the
        Amazon Resource Name (ARN) of the customer master key (CMK). A grant token is a unique
    ...
    def schedule_key_deletion(
        ...
        <https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html>`__ , when the
        waiting period expires, ``ScheduleKeyDeletion`` deletes the CMK from AWS KMS. Then AWS KMS makes a
        best effort to delete the key material from the associated AWS CloudHSM cluster. However, you might
    ...
    def update_custom_key_store(
        ...
        custom key store you want to edit. Use the remaining parameters to change the properties of the
        custom key store.
        ...
        **Request Syntax**
        ...
        :param KeyStorePassword:
          ...
          This parameter tells AWS KMS the current password of the ``kmsuser`` crypto user (CU). It does not
        ...
        :param CloudHsmClusterId:
          ...
          replacement cluster must `fulfill the requirements
