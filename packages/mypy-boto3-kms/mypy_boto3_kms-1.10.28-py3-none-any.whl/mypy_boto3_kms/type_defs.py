...
class ClientCreateGrantConstraintsTypeDef(_ClientCreateGrantConstraintsTypeDef):
    ...
    * *AWS Key Management Service Developer Guide* * .
    ...
    - **EncryptionContextEquals** *(dict) --*
      ...
      operation request. The grant allows the operation only when the encryption context in the
...
class ClientCreateKeyResponseKeyMetadataTypeDef(_ClientCreateKeyResponseKeyMetadataTypeDef):
    ...
    - **Arn** *(string) --*
      ...
      The Amazon Resource Name (ARN) of the CMK. For examples, see `AWS Key Management Service (AWS
      KMS)
    ...
    - **Origin** *(string) --*
      ...
      material. When this value is ``EXTERNAL`` , the key material was imported from your existing
      key management infrastructure or the CMK lacks key material. When this value is
      ``AWS_CLOUDHSM`` , the key material was created in the AWS CloudHSM cluster associated with a
      custom key store.

    - **CustomKeyStoreId** *(string) --*

      A unique identifier for the `custom key store
      <https://docs.aws.amazon.com/kms/latest/developerguide/custom-key-store-overview.html>`__ that
    ...
    - **EncryptionAlgorithms** *(list) --*
      ...
      A list of encryption algorithms that the CMK supports. You cannot use the CMK with other
...
_ClientDecryptResponseTypeDef = TypedDict(
    ...
    {"KeyId": str, "Plaintext": bytes, "EncryptionAlgorithm": str},
    total=False,
)
...
class ClientDescribeCustomKeyStoresResponseCustomKeyStoresTypeDef(
    ...
    - **ConnectionState** *(string) --*
      ...
      having trouble using the custom key store, make sure that its associated AWS CloudHSM cluster
    ...
    - **ConnectionErrorCode** *(string) --*
      ...
      * ``INSUFFICIENT_CLOUDHSM_HSMS`` - The associated AWS CloudHSM cluster does not contain any
      active HSMs. To connect a custom key store to its AWS CloudHSM cluster, the cluster must
      ...
      * ``USER_LOCKED_OUT`` - The ``kmsuser`` CU account is locked out of the associated AWS
      CloudHSM cluster due to too many failed password attempts. Before you can connect your custom
      key store to its AWS CloudHSM cluster, you must change the ``kmsuser`` account password and
...
_ClientEncryptResponseTypeDef = TypedDict(
    ...
    {"CiphertextBlob": bytes, "KeyId": str, "EncryptionAlgorithm": str},
    total=False,
)
...
class ClientGenerateDataKeyPairResponseTypeDef(_ClientGenerateDataKeyPairResponseTypeDef):
    """
    Type definition for `ClientGenerateDataKeyPair` `Response`
...
_ClientGenerateDataKeyPairWithoutPlaintextResponseTypeDef = TypedDict(
    ...
    {"PrivateKeyCiphertextBlob": bytes, "PublicKey": bytes, "KeyId": str, "KeyPairSpec": str},
    total=False,
)
...
class ClientGenerateDataKeyPairWithoutPlaintextResponseTypeDef(
    ...
    """
    Type definition for `ClientGenerateDataKeyPairWithoutPlaintext` `Response`
    ...
    - **KeyId** *(string) --*
      ...
      Specifies the CMK that encrypted the private key in the data key pair. You must specify a
      ...
      using an alias name, prefix it with ``"alias/"`` .
...
class ClientGenerateDataKeyResponseTypeDef(_ClientGenerateDataKeyResponseTypeDef):
    ...
    - **Plaintext** *(bytes) --*
      ...
      Otherwise, it is not Base64-encoded. Use this data key to encrypt your data outside of KMS.
...
class ClientGetPublicKeyResponseTypeDef(_ClientGetPublicKeyResponseTypeDef):
    ...
    - **PublicKey** *(bytes) --*
      ...
      <https://www.itu.int/ITU-T/studygroups/com17/languages/X.690-0207.pdf>`__ (DER)-encoded
      object. To decode it, use an ASN.1 parsing tool, such as `OpenSSL asn1parse
      <https://www.openssl.org/docs/man1.0.2/man1/asn1parse.html>`__ .
...
_ClientReEncryptResponseTypeDef = TypedDict(
    "_ClientReEncryptResponseTypeDef",
    {
        ...
        "SourceKeyId": str,
        "KeyId": str,
        "SourceEncryptionAlgorithm": str,
        "DestinationEncryptionAlgorithm": str,
    },
    total=False,
)
...
_ClientSignResponseTypeDef = TypedDict(
    ...
    {"KeyId": str, "Signature": bytes, "SigningAlgorithm": str},
    total=False,
)
...
class ClientSignResponseTypeDef(_ClientSignResponseTypeDef):
    """
    Type definition for `ClientSign` `Response`
...
_ClientVerifyResponseTypeDef = TypedDict(
    ...
    {"KeyId": str, "SignatureValid": bool, "SigningAlgorithm": str},
    total=False,
)
...
class ClientVerifyResponseTypeDef(_ClientVerifyResponseTypeDef):
    """
    Type definition for `ClientVerify` `Response`
