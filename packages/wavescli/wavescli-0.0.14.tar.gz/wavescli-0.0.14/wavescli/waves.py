...
def send_update_execution(
        ...
        task_parent_id, status=None, inputs=None, args=None, results=None, last_error=None):
    """
    Envia para fila default
    """
    print("--> send_update_execution")
    params = (
        identifier,
        task_id,
        task_name,
...
def task_updated(sender=None, headers=None, body=None, **kwargs):
    ...
    if task_name == 'awebrunner.update_execution':
        print("--> skip before_task_publish")
        return True

    print("--> before_task_publish: {}".format(sender))
    ...
    print("    --> args_data: {}".format(args_data))
    print("    --> kwargs_data: {}".format(kwargs_data))
...
def task_started(task_id, task, args, **kwargs):
    ...
    print("--> task_prerun: {} --> {}".format(identifier, task_id))
