"Main interface for quicksight Client"
...
class Client(BaseClient):
    ...
    def create_dashboard(
        ...
        A dashboard is an entity in QuickSight which identifies Quicksight reports, created from analyses.
        QuickSight dashboards are sharable. With the right permissions, you can create scheduled email
        reports from them. The ``CreateDashboard`` , ``DescribeDashboard`` and ``ListDashboardsByUser`` APIs
        act on the dashboard entity. If you have the correct permissions, you can create a dashboard from a
        ...
        **Request Syntax**
        ...
        :param SourceEntity: **[REQUIRED]**
          ...
          Source entity from which the dashboard is created. The souce entity accepts the ARN of the source
          template or analysis and also references the replacement datasets for the placeholders set when
          creating the template. The replacement datasets need to follow the same schema as the datasets for
        ...
        :param DashboardPublishOptions:
          ...
          * AvailabilityStatus for ExportToCSVOption - This can be either ``ENABLED`` or ``DISABLED`` . The
          visual option to export data to CSV is disabled when this is set to ``DISABLED`` . Enabled by
          default.

          * VisibilityState for SheetControlsOption - This can be either ``COLLAPSED`` or ``EXPANDED`` . The
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'DashboardId': 'string',
                'CreationStatus':
                'CREATION_IN_PROGRESS'|'CREATION_SUCCESSFUL'|'CREATION_FAILED'|'UPDATE_IN_PROGRESS'
                                  ...
                                  'Tags': [
                                      {
                                          ...
                                          'COUNTRY'|'STATE'|'COUNTY'|'CITY'|'POSTCODE'|'LONGITUDE'
                                          |'LATITUDE'
                                      },
                                  ]
                              }
        ...
        :param PhysicalTableMap: **[REQUIRED]**
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              source. This is a variant type structure. No more than one of the attributes can be non-null
            ...
            - *(dict) --*
              ...
              - **DataTransforms** *(list) --*
                ...
                - *(dict) --*
                  ...
                  A data transformation on a logical table. This is a variant type structure. No more than
                  ...
                  - **CreateColumnsOperation** *(dict) --*
                    ...
                    An operation that creates calculated columns. Columns created in one such operation form
                    a lexical closure.
                    ...
                    - **Columns** *(list) --* **[REQUIRED]**
                      ...
                      - *(dict) --*
                        ...
                        - **ColumnId** *(string) --* **[REQUIRED]**
                          ...
                          A unique ID to identify a calculated column. During dataset update, if the column
                          ID of a calculated column matches that of an existing calculated column,
    ...
    def create_data_source(
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_data_source(
              ...
              Type=
                  ...
                  |'AWS_IOT_ANALYTICS'|'GITHUB'|'JIRA'|'MARIADB'|'MYSQL'|'POSTGRESQL'|'PRESTO'|'REDSHIFT'
                  |'S3'|'SALESFORCE'|'SERVICENOW'|'SNOWFLAKE'|'SPARK'|'SQLSERVER'|'TERADATA'|'TWITTER',
        ...
        :param Type: **[REQUIRED]**
          ...
          AURORA, AURORA_POSTGRESQL, MARIADB, MYSQL, POSTGRESQL, PRESTO, REDSHIFT, S3, SNOWFLAKE, SPARK,
          SQLSERVER, TERADATA`` . Use ``ListDataSources`` to return a list of all data sources.
    ...
    def create_iam_policy_assignment(
        ...
        """
        Creates an assignment with one specified IAM policy ARN and will assigned to specified groups or
        users of QuickSight. Users and groups need to be in the same namespace.
        ...
        CLI syntax:
         ...
         --identities="user=user5,engineer123,group=QS-Admin" --namespace=default --region=us-west-2``
        ...
        **Request Syntax**
        ...
        :param PolicyArn:
          ...
          An IAM policy ARN that you want to apply to the QuickSight users and groups specified in this
          assignment.
    ...
    def create_ingestion(
        ...
        access-control. For an example, see `How do I create an IAM policy to control access to Amazon EC2
        resources using tags?
        <https://aws.example.com/premiumsupport/knowledge-center/iam-ec2-resource-tags/>`__ . Tags will be
    ...
    def create_template(
        ...
        """
        Creates a template from an existing QuickSight analysis or template. The resulting template can be
        used to create a dashboard.

        A template is an entity in QuickSight which encapsulates the metadata required to create an analysis
        that can be used to create dashboard. It adds a layer of abstraction by use placeholders to replace
        the dataset associated with the analysis. You can use templates to create dashboards by replacing
        dataset placeholders with datasets which follow the same schema that was used to create the source
        ...
        CLI syntax to create a template from another template in the same AWS account:
         ...
         ``aws quicksight create-template --aws-account-id 111122223333 --template-id reports_test_template
         --data-set-references
         DataSetPlaceholder=reports,DataSetArn=
             arn:aws:quicksight:us-west-2:111122223333:dataset/0dfc789c-81f6-4f4f-b9ac-7db2453eefc8
             DataSetPlaceholder=Elblogs,DataSetArn=
                 arn:aws:quicksight:us-west-2:111122223333:dataset/f60da323-af68-45db-9016-08e0d1d7ded5
                 --source-entity
                 SourceAnalysis='{Arn=
                     arn:aws:quicksight:us-west-2:111122223333:analysis/7fb74527-c36d-4be8-8139-ac1be4c97365}'``

        To create template from another account’s template, you need to grant cross account resource
        permission for DescribeTemplate the account that contains the template.
        ...
        **Request Syntax**
        ...
        :param Permissions:
          ...
          A list of resource permissions to be set on the template. The shorthand syntax should look similar
          to this: ``Shorthand Syntax: Principal=string,Actions=string,string ...``
        ...
        :param SourceEntity: **[REQUIRED]**
          ...
          The ARN of the source entity from which this template is being created. Templates can be currently
          created from an analysis or another template. If the ARN is for an analysis, you must include its
          dataset references.
        ...
        :param VersionDescription:
          ...
          A description of the current template version being created. This API created the first version of
    ...
    def create_template_alias(
        ...
        **Request Syntax**
        ...
        :param AliasName: **[REQUIRED]**
          ...
          The name you want to give the template's alias. Alias names can't begin with a ``$`` , which is
          reserved by QuickSight. Alias names that start with ‘$’ sign are QuickSight reserved naming and
          can't be deleted.
    ...
    def delete_dashboard(
        ...
        **Request Syntax**
        ...
        :param VersionNumber:
          ...
          The version number of the dashboard. If version number property is provided, only the specified
    ...
    def delete_data_source(
        ...
        """
        Deletes the data source permanently. This action breaks all the datasets that reference the deleted
        data source.
    ...
    def delete_template(
        ...
        * ``aws quicksight delete-template --aws-account-id 111122223333 —-template-id
        ...
        If version number which is an optional field is not passed the template (including all the versions)
        is deleted by the API, if version number is provided, the specific template version is deleted by
        the API.

        Users can explicitly describe the latest version of the template by passing ``$LATEST`` to the
        ``alias-name`` parameter. ``$LATEST`` is an internally supported alias, which points to the latest
    ...
    def delete_template_alias(
        ...
        **Request Syntax**
        ...
        :param AliasName: **[REQUIRED]**
          ...
          deleted. Alias names that start with ``$`` are reserved by QuickSight and can't be deleted.”
    ...
    def delete_user(
        ...
        """
        Deletes the Amazon QuickSight user that is associated with the identity of the AWS Identity and
        Access Management (IAM) user or role that's making the call. The IAM user isn't deleted as a result
        of this call.
    ...
    def delete_user_by_principal_id(
         ...
         **CLI Sample:**
         ...
         ``aws quicksight delete-user-by-principal-id --aws-account-id=111122223333 --namespace=default
    ...
    def describe_dashboard_permissions(
        ...
        CLI syntax:
         ...
         ``aws quicksight describe-dashboard-permissions --aws-account-id 735340738645 —dashboard-id
         reports_test_bob_report``
          ...
          ::

            {
                'DataSource': {
                    ...
                    'ErrorInfo': {
                        'Type':
                        'TIMEOUT'|'ENGINE_VERSION_NOT_SUPPORTED'|'UNKNOWN_HOST'|'GENERIC_SQL_FAILURE'
                        |'CONFLICT'|'UNKNOWN',
                        'Message': 'string'
                    }
                },
...

            {
                'Ingestion': {
                    ...
                    'ErrorInfo': {
                        ...
                        |'DATA_SET_DELETED'|'DATA_SET_NOT_SPICE'|'S3_UPLOADED_FILE_DELETED'
                        |'S3_MANIFEST_ERROR'|'DATA_TOLERANCE_EXCEPTION'|'SPICE_TABLE_NOT_FOUND'
                        |'DATA_SET_SIZE_LIMIT_EXCEEDED'|'ROW_SIZE_LIMIT_EXCEEDED'
                        |'ACCOUNT_CAPACITY_LIMIT_EXCEEDED'|'CUSTOMER_ERROR'|'DATA_SOURCE_NOT_FOUND'
                        |'IAM_ROLE_NOT_AVAILABLE'|'CONNECTION_FAILURE'|'SQL_TABLE_NOT_FOUND'
                        |'PERMISSION_DENIED'|'SSL_CERTIFICATE_VALIDATION_FAILURE'|'OAUTH_TOKEN_FAILURE'
                        ...
                        |'SOURCE_RESOURCE_LIMIT_EXCEEDED'|'SQL_INVALID_PARAMETER_VALUE'|'QUERY_TIMEOUT'
                        |'SQL_NUMERIC_OVERFLOW'|'UNRESOLVABLE_HOST'|'UNROUTABLE_HOST'|'SQL_EXCEPTION'
                        |'S3_FILE_INACCESSIBLE'|'IOT_FILE_NOT_FOUND'|'IOT_DATA_SET_FILE_EMPTY'
                        |'INVALID_DATA_SOURCE_CONFIG'|'DATA_SOURCE_AUTH_FAILED'
                        |'DATA_SOURCE_CONNECTION_FAILED'|'FAILURE_TO_PROCESS_JSON_FILE'
    ...
    def describe_template(
        ...
        **Request Syntax**
        ...
        :param AliasName:
          ...
          described. Refer to ``CreateTemplateAlias`` to create a template alias. ``$PUBLISHED`` is not
    ...
    def describe_template_permissions(
        ...
        CLI syntax:
         ...
         ``aws quicksight describe-template-permissions —aws-account-id 735340738645 —template-id
         reports_test_template``
    ...
    def describe_user(
        ...
        The response is a user object that contains the user's Amazon Resource Name (ARN), AWS Identity and
    ...
    def get_dashboard_embed_url(
        ...
        """
        Generates a server-side embeddable URL and authorization code. Before this can work properly, first
        you need to configure the dashboards and user permissions. For more information, see `Embedding
        Amazon QuickSight Dashboards
        <https://docs.aws.example.com/en_us/quicksight/latest/user/embedding.html>`__ .
        ...
        assume-role-with-saml.
         ...
         "arn:aws:iam::111122223333:role/embedding_quicksight_dashboard_role" --role-session-name
         embeddingsession``

        If the user does not exist in QuickSight, register the user:

         ``aws quicksight register-user --aws-account-id 111122223333 --namespace default --identity-type
         IAM --iam-arn "arn:aws:iam::111122223333:role/embedding_quicksight_dashboard_role" --user-role
         READER --session-name "embeddingsession" --email user123@example.com --region us-east-1``
        ...
        **Request Syntax**
        ...
        :param ResetDisabled:
          ...
          Remove the reset button on embedded dashboard. The default is FALSE, which allows the reset
          button.

        :type UserArn: string
        :param UserArn:

          The Amazon QuickSight user's ARN, for use with ``QUICKSIGHT`` identity type. You can use this for
          any Amazon QuickSight users in your account (readers, authors, or admins) authenticated as one of
          the following:
    ...
    def list_dashboards(
        ...
        CLI syntax:
         ...
         ``aws quicksight list-dashboards --aws-account-id 111122223333 --max-results 5 —next-token
         'next-10'``
    ...
    def list_iam_policy_assignments(
        ...
        CLI syntax:
         ...
         ``aws quicksight list-iam-policy-assignments --aws-account-id=111122223333 --max-result=5
    ...
    def list_iam_policy_assignments_for_user(
        ...
        """
        Lists all the assignments and the ARNs for the associated IAM policies assigned to the specified
        user and the group or groups that the user belongs to.
    ...
    def list_tags_for_resource(
        ...
        * ``aws quicksight list-tags-for-resource --resource-arn
        arn:aws:quicksight:us-east-1:111111111111:dataset/dataset1 --region us-east-1``
    ...
    def list_template_versions(
        ...
        aws quicksight list-template-versions --aws-account-id 111122223333 --aws-account-id 196359894473
    ...
    def list_templates(
        ...
        CLI syntax:
         ...
         ``aws quicksight list-templates --aws-account-id 111122223333 --max-results 1 —next-token
         AYADeJuxwOypAndSoOn``
    ...
    def list_users(
        ...
        The response is a list of user objects, containing each user's Amazon Resource Name (ARN), AWS
        Identity and Access Management (IAM) role, and email address.
    ...
    def register_user(
        ...
        Creates an Amazon QuickSight user, whose identity is associated with the AWS Identity and Access
        Management (IAM) identity or role specified in the request.
        ...
        **Request Syntax**
        ...
        :param IdentityType: **[REQUIRED]**
          ...
          Amazon QuickSight supports several ways of managing the identity of users. This parameter accepts
          two values:
        ...
        :param SessionName:
          ...
          You don't need to provide the session name for other scenarios, for example when you are
    ...
    def tag_resource(
        ...
        Assigns one or more tags (key-value pairs) to the specified QuickSight resource. Tags can help you
        ...
        TagResource action with a resource that already has tags. If you specify a new tag key for the
        ...
        You can associate as many as 50 tags with a resource. QuickSight supports tagging on data-set,
        data-source, dashboard, template.

        Tagging for QuickSight works in a similar was to tagging for other AWS services, except for the
        following:

        * You can't use tags to track AWS costs for QuickSight, because QuickSight costs are based on users
        ...
        * ``aws quicksight tag-resource --resource-arn
        arn:aws:quicksight:us-east-1:111111111111:dataset/dataset1 --tags Key=K1,Value=V1 Key=K2,Value=V2
        --region us-east-1``
    ...
    def untag_resource(
        ...
        * ``aws quicksight untag-resource --resource-arn
        arn:aws:quicksight:us-east-1:111111111111:dataset/dataset1 --tag-keys K1 K2 --region us-east-1``
    ...
    def update_dashboard(
        ...
        CLI syntax:
         ...
         ``aws quicksight update-dashboard --aws-account-id 111122223333 --dashboard-id 123123123
         --dashboard-name "test-update102" --source-entity
         SourceTemplate={Arn=arn:aws:quicksight:us-west-2:111122223333:template/sales-report-template2}
         --data-set-references
         DataSetPlaceholder=SalesDataSet,DataSetArn=
             arn:aws:quicksight:us-west-2:111122223333:dataset/0e251aef-9ebf-46e1-b852-eb4fa33c1d3a``
        ...
        **Request Syntax**
        ...
        :param SourceEntity: **[REQUIRED]**
          ...
          Arn of the template and also references to replacement datasets for the placeholders set when
          creating the template. The replacement datasets need to follow the same schema as the datasets for
          which placeholders were created when creating the template.
    ...
    def update_dashboard_permissions(
        ...
        To obtain the principal name of a QuickSight user or group, you can use describe-group or
        describe-user. For example:

         ``aws quicksight describe-user --aws-account-id 111122223333 --namespace default --user-name user2
         --region us-east-1 { "User": { "Arn":
         "arn:aws:quicksight:us-east-1:111122223333:user/default/user2", "Active": true, "Email":
         "user2@example.com", "Role": "ADMIN", "UserName": "user2", "PrincipalId":
         "federated/iam/abcd2abcdabcdeabc5ab5" }, "RequestId": "8f74bb31-6291-448a-a71c-a765a44bae31",
         "Status": 200 }``
    ...
    def update_dashboard_published_version(
        ...
        CLI syntax:
         ...
         ``aws quicksight update-dashboard-published-version --aws-account-id 111122223333 --dashboard-id
         dashboard-w1 ---version-number 2``
    ...
    def update_data_set_permissions(
        ...
        CLI syntax:
         ...
         ``--grant-permissions=
             '[{"Principal":"arn:aws:quicksight:us-east-1:111122223333:user/default/user1","Actions":["quicksight:DescribeDataSet","quicksight:DescribeDataSetPermissions","quicksight:PassDataSet","quicksight:ListIngestions","quicksight:DescribeIngestion"]}]'
             \\``

         ``--revoke-permissions=
             '[{"Principal":"arn:aws:quicksight:us-east-1:111122223333:user/default/user2","Actions":["quicksight:UpdateDataSet","quicksight:DeleteDataSet","quicksight:UpdateDataSetPermissions","quicksight:CreateIngestion","quicksight:CancelIngestion"]}]'``
    ...
    def update_data_source(
        ...
        CLI syntax:
         ...
         ``--data-source-parameters=
             '{"PostgreSqlParameters":{"Host":"my-db-host.example.com","Port":1234,"Database":"my-db"}}'
             \\``
    ...
    def update_data_source_permissions(
        ...
        CLI syntax:
         ...
         ``--grant-permissions=
             '[{"Principal":"arn:aws:quicksight:us-east-1:111122223333:user/default/user1","Actions":["quicksight:DescribeDataSource","quicksight:DescribeDataSourcePermissions","quicksight:PassDataSource"]}]'
             \\``

         ``--revoke-permissions=
             '[{"Principal":"arn:aws:quicksight:us-east-1:111122223333:user/default/user2","Actions":["quicksight:UpdateDataSource","quicksight:DeleteDataSource","quicksight:UpdateDataSourcePermissions"]}]'``
    ...
    def update_group(
         ...
         **CLI Sample:**
         ...
         ``aws quicksight update-group --aws-account-id=111122223333 --namespace=default --group-name=Sales
         --description="Sales BI Dashboards"``
    ...
    def update_iam_policy_assignment(
        ...
        """
        Updates an existing assignment. This operation updates only the optional parameter or parameters
        that are specified in the request.

        CLI syntax:

         aws quicksight update-iam-policy-assignment --aws-account-id=111122223333
         --assignment-name=FullAccessAssignment --assignment-status=DRAFT
        ...
        **Request Syntax**
        ...
        :param PolicyArn:
          ...
          An IAM policy ARN that will be applied to specified QuickSight users and groups in this
          assignment.
    ...
    def update_template(
        ...
        CLI syntax:
         ...
         ``aws quicksight update-template --aws-account-id 111122223333 --template-id reports_test_template
         --data-set-references
         DataSetPlaceholder=reports,DataSetArn=
             arn:aws:quicksight:us-west-2:111122223333:dataset/c684a204-d134-4c53-a63c-451f72c60c28
             DataSetPlaceholder=Elblogs,DataSetArn=
                 arn:aws:quicksight:us-west-2:111122223333:dataset/15840b7d-b542-4491-937b-602416b367b3
                 —source-entity
                 SourceAnalysis=’{Arn=
                     arn:aws:quicksight:us-west-2:111122223333:analysis/c5731fe9-4708-4598-8f6d-cf2a70875b6d}``
        ...
        **Request Syntax**
        ...
        :param SourceEntity: **[REQUIRED]**
          ...
          The source QuickSight entity from which this template is being created. Templates can be currently
    ...
    def update_template_permissions(
        ...
        * ``aws quicksight describe-template-permissions —aws-account-id 111122223333 —template-id
        reports_test_template``
        ...
        * The structure of ``update-permissions.json`` to add permissions:  ``{ "AwsAccountId":
        ...
        "Principal": "arn:aws:quicksight:us-east-1:196359894473:user/default/user3",``    ``"Actions": [``
         ``"quicksight:DescribeTemplate",``    ``"quicksight:ListTemplateVersions"``    ``] } ] }``   The
         structure of ``update-permissions.json`` to add permissions:  ``{ "AwsAccountId": "111122223333",``
            ``"DashboardId": "reports_test_template",``    ``"RevokePermissions": [``    ``{ "Principal":
            "arn:aws:quicksight:us-east-1:196359894473:user/default/user3",``    ``"Actions": [``
            ``"quicksight:DescribeTemplate",``    ``"quicksight:ListTemplateVersions"``    ``] } ] }``   To
            obtain the principal name of a QuickSight group or user, use user describe-group or
            describe-user. For example:  ``aws quicksight describe-user``    ``--aws-account-id
            111122223333``    ``--namespace default``    ``--user-name user2``    ``--region us-east-1``
            ``{``    ``"User": {``    ``"Arn":
        ...
        **Request Syntax**
        ...
        :param GrantPermissions:
          ...
          A list of resource permissions to be granted on the template. The following example shows the
          shorthand syntax:
        ...
        :param RevokePermissions:
          ...
          A list of resource permissions to be revoked from the template. Shorthand syntax: ``Shorthand
          Syntax: Principal=string,Actions=string,string ...``
    ...
    def update_user(
        ...
        The response is a user object that contains the user's Amazon QuickSight user name, email address,
        active or inactive status in Amazon QuickSight, Amazon QuickSight role, and Amazon Resource Name
        (ARN).
