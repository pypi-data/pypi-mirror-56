...
Mypy-friendly auto-generated type annotations for `boto3 quicksight 1.10.28` service.
...
session_client = session.client("quicksight")
...
```python
import boto3
from mypy_boto3.quicksight import Client
