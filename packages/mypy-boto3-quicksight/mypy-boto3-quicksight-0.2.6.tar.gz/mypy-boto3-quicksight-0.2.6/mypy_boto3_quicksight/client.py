...
class Client(BaseClient):
    ...
    def create_dashboard(
        ...
        reports from them. The ``CreateDashboard`` , ``DescribeDashboard`` and ``ListDashboardsByUser``
        APIs act on the dashboard entity. If you have the correct permissions, you can create a dashboard
        ...
        **Request Syntax**
        ...
        :param Permissions:
          ...
          - *(dict) --*
            ...
            - **Principal** *(string) --* **[REQUIRED]**
              ...
              sharing, this is the IAM ARN of an account root. Otherwise, it is the ARN of a QuickSight
              user or group. .
        ...
        :param SourceEntity: **[REQUIRED]**
          ...
          creating the template. The replacement datasets need to follow the same schema as the datasets
    ...
    def create_template(
        ...
        analysis that can be used to create dashboard. It adds a layer of abstraction by use placeholders
        to replace the dataset associated with the analysis. You can use templates to create dashboards by
        replacing dataset placeholders with datasets which follow the same schema that was used to create
        ...
        **Request Syntax**
        ...
        :param Permissions:
          ...
          A list of resource permissions to be set on the template. The shorthand syntax should look
          similar to this: ``Shorthand Syntax: Principal=string,Actions=string,string ...``
        ...
        :param VersionDescription:
          ...
          A description of the current template version being created. This API created the first version
          of the template. Every time UpdateTemplate is called a new version is created. Each version of
          the template maintains a description of the version in the VersionDescription field.
    ...
    def delete_template(
        ...
        * ``aws quicksight delete-template --aws-account-id 111122223333 —-template-id
        ...
        If version number which is an optional field is not passed the template (including all the
        versions) is deleted by the API, if version number is provided, the specific template version is
        deleted by the API.
    ...
    def delete_template_alias(
        ...
        **Request Syntax**
        ...
        :param AliasName: **[REQUIRED]**
          ...
          The alias of the template. If alias-name is provided, the version that the alias-name points to
          is deleted. Alias names that start with ``$`` are reserved by QuickSight and can't be deleted.”
    ...
    def delete_user(
        ...
        **Request Syntax**
        ...
        :param AwsAccountId: **[REQUIRED]**
          ...
          The ID for the AWS account that the user is in. Currently, you use the ID for the AWS account
          that contains your Amazon QuickSight account.
              ...
              - **PhysicalTableMap** *(dict) --*
                ...
                - *(string) --*
                  ...
                  - *(dict) --*
                    ...
                    underlying source. This is a variant type structure. No more than one of the attributes
                    can be non-null for this structure to be valid.
    ...
    def register_user(
        ...
        **Request Syntax**
        ...
        :param SessionName:
          ...
          You need to use this parameter only when you register one or more users using an assumed IAM
    ...
    def tag_resource(
        ...
        the TagResource action with a resource that already has tags. If you specify a new tag key for the
    ...
    def update_dashboard(
        ...
        **Request Syntax**
        ...
        :param SourceEntity: **[REQUIRED]**
          ...
          the Arn of the template and also references to replacement datasets for the placeholders set when
          creating the template. The replacement datasets need to follow the same schema as the datasets
          for which placeholders were created when creating the template.
    ...
    def update_template_permissions(
        ...
        * The structure of ``update-permissions.json`` to add permissions:  ``{ "AwsAccountId":
        ...
        [``    ``"quicksight:DescribeTemplate",``    ``"quicksight:ListTemplateVersions"``    ``] } ] }``
        The structure of ``update-permissions.json`` to add permissions:  ``{ "AwsAccountId":
        "111122223333",``    ``"DashboardId": "reports_test_template",``    ``"RevokePermissions": [``
        ``{ "Principal": "arn:aws:quicksight:us-east-1:196359894473:user/default/user3",``    ``"Actions":
        [``    ``"quicksight:DescribeTemplate",``    ``"quicksight:ListTemplateVersions"``    ``] } ] }``
        To obtain the principal name of a QuickSight group or user, use user describe-group or
        describe-user. For example:  ``aws quicksight describe-user``    ``--aws-account-id 111122223333``
          ``--namespace default``    ``--user-name user2``    ``--region us-east-1``    ``{``    ``"User":
          {``    ``"Arn": "arn:aws:quicksight:us-east-1:111122223333:user/default/user2",``    ``"Active":
          true,``    ``"Email": "user2@example.com",``    ``"Role": "ADMIN",``    ``"UserName": "user2",``
