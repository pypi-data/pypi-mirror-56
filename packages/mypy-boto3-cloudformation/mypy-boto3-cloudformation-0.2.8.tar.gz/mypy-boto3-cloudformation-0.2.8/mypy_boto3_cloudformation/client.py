...
class Client(BaseClient):
    ...
    def cancel_update_stack(self, StackName: str, ClientRequestToken: str = None) -> None:
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          to retry requests so that AWS CloudFormation knows that you're not attempting to cancel an
    ...
    def continue_update_rollback(
        ...
        A stack goes into the ``UPDATE_ROLLBACK_FAILED`` state when AWS CloudFormation cannot roll
        back all changes after a failed stack update. For example, you might have a stack that is
        rolling back to an old database instance that was deleted outside of AWS CloudFormation.
        Because AWS CloudFormation doesn't know the database was deleted, it assumes that the
        database instance still exists and attempts to roll back to it, causing the update rollback
        to fail.
        ...
        **Request Syntax**
        ...
        :param RoleARN:
          ...
          AWS CloudFormation assumes to roll back the stack. AWS CloudFormation uses the role's
        ...
        :param ResourcesToSkip:
          ...
          ``UPDATE_FAILED`` state because a rollback failed. You can't specify resources that are in
          the ``UPDATE_FAILED`` state for other reasons, for example, because an update was
          cancelled. To check why a resource update failed, use the  DescribeStackResources action,
          and view the resource status reason.
          ...
          .. warning::
            ...
            state of the resources in the stack template. Before performing another stack update,
          ...
          example, a failed resource update might cause dependent resources to fail. In this case,
        ...
        :param ClientRequestToken:
          ...
          plan to retry requests so that AWS CloudFormation knows that you're not attempting to
          continue the rollback to a stack with the same name. You might retry
          ``ContinueUpdateRollback`` requests to ensure that AWS CloudFormation successfully
          received them.
    ...
    def create_change_set(
        ...
        existing stack. If you create a change set for a stack that doesn't exist, the change set
        shows all of the resources that AWS CloudFormation will create. If you create a change set
        for an existing stack, AWS CloudFormation compares the stack's information with the
        ...
        specify ``CREATE`` . To create a change set for an existing stack, specify ``UPDATE`` for
        the ``ChangeSetType`` parameter. To create a change set for an import operation, specify
        ...
        status of the change set or to review it, use the  DescribeChangeSet action.

        When you are satisfied with the changes the change set will make, execute the change set by
        using the  ExecuteChangeSet action. AWS CloudFormation doesn't make changes until you
        ...
        **Request Syntax**
        ...
        :param TemplateBody:
          ...
          byte and a maximum length of 51,200 bytes. AWS CloudFormation generates the change set by
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_IAM`` and ``CAPABILITY_NAMED_IAM``   Some stack templates might include
          ...
          AWS Identity and Access Management (IAM) users. For those stacks, you must explicitly
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some template contain macros. Macros perform custom
          processing on templates; this can include simple actions like find-and-replace operations,
          all the way to extensive transformations of entire templates. Because of this, users
          typically create a change set from the processed template, so that they can review the
          changes resulting from the macros before actually creating the stack. If your stack
          template contains one or more macros, and you choose to create a stack directly from the
          processed template, without first reviewing the resulting changes in a change set, you
          must acknowledge this capability. This includes the `AWS\\:\\:Include
          ...
          .. note::
             ...
             change sets has no effect. Also, change sets do not currently support nested stacks. If
             you want to create a stack from a stack template that contains macros *and* nested
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that
          AWS CloudFormation assumes when executing the change set. AWS CloudFormation uses the
        ...
        :param NotificationARNs:
          ...
          that AWS CloudFormation associates with the stack. To remove all associated notification
        ...
        :param ChangeSetName: **[REQUIRED]**
          ...
          must start with an alphabetic character and cannot exceed 128 characters.

        :type ClientToken: string
        :param ClientToken:

          A unique identifier for this ``CreateChangeSet`` request. Specify this token if you plan
          to retry requests so that AWS CloudFormation knows that you're not attempting to create
          another change set with the same name. You might retry ``CreateChangeSet`` requests to
          ensure that AWS CloudFormation successfully received them.
        ...
        :param ChangeSetType:
          ...
          ``CREATE`` . To create a change set for an existing stack, specify ``UPDATE`` . To create
          a change set for an import operation, specify ``IMPORT`` .
    ...
    def create_stack(
        ...
        **Request Syntax**
        ...
        :param StackName: **[REQUIRED]**
          ...
          The name that is associated with the stack. The name must be unique in the region in which
        ...
        :param TemplateBody:
          ...
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__
          in the AWS CloudFormation User Guide.
        ...
        :param TemplateURL:
          ...
          460,800 bytes) that is located in an Amazon S3 bucket. For more information, go to the
          `Template Anatomy
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__
          in the AWS CloudFormation User Guide.
        ...
        :param NotificationARNs:
          ...
          The Simple Notification Service (SNS) topic ARNs to publish stack related events. You can
          find your SNS topic ARNs using the SNS console or your Command Line Interface (CLI).
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some template contain macros. Macros perform custom
          ...
          and `AWS\\:\\:Serverless
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html>`__
          transforms, which are macros hosted by AWS CloudFormation. Change sets do not currently
          support nested stacks. If you want to create a stack from a stack template that contains
          macros *and* nested stacks, you must create the stack directly from the template using
          this capability.

          .. warning::

             You should only create stacks directly from a stack template that contains macros if
             you know what processing the macro performs. Each macro relies on an underlying Lambda
             service function for processing stack templates. Be aware that the Lambda function
             owner can update the function operation without AWS CloudFormation being notified.

           For more information, see `Using AWS CloudFormation Macros to Perform Custom Processing
           on Templates
           <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html>`__ .
        ...
        :param ResourceTypes:
          ...
          action, such as ``AWS::EC2::Instance`` , ``AWS::EC2::*`` , or ``Custom::MyCustomInstance``
          . Use the following syntax to describe template resource types: ``AWS::*`` (for all AWS
          resource), ``Custom::*`` (for all custom resources), ``Custom::*logical_ID* `` (for a
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that
          AWS CloudFormation assumes to create the stack. AWS CloudFormation uses the role's
          credentials to make calls on your behalf. AWS CloudFormation always uses this role for all
          future operations on the stack. As long as users have permission to operate on the stack,
          AWS CloudFormation uses this role even if the users don't have permission to pass it.
          Ensure that the role grants least privilege.
        ...
        :param StackPolicyBody:
          ...
          in the *AWS CloudFormation User Guide* . You can specify either the ``StackPolicyBody`` or
        ...
        :param ClientRequestToken:
          ...
          retry requests so that AWS CloudFormation knows that you're not attempting to create a
          stack with the same name. You might retry ``CreateStack`` requests to ensure that AWS
        ...
        :param EnableTerminationProtection:
          ...
          remains unchanged. For more information, see `Protecting a Stack From Being Deleted
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-protect-stacks.html>`__
          in the *AWS CloudFormation User Guide* . Termination protection is disabled on stacks by
          default.
    ...
    def create_stack_instances(
        ...
        instance refers to a stack in a specific account and region. ``Accounts`` and ``Regions``
        ...
        **Request Syntax**
        ...
        :param ParameterOverrides:
          ...
          accounts and regions. When specifying parameters and their values, be aware of how AWS
          ...
          * To leave a parameter set to its present value, you can do one of the following:
            ...
            * Include the parameter and specify ``UsePreviousValue`` as ``true`` . (You cannot
          ...
          * To leave all parameters set to their present values, do not specify this property at
          all.
          ...
          You can only override the parameter *values* that are specified in the stack set; to add
          or delete a parameter itself, use `UpdateStackSet
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_UpdateStackSet.html>`__
    ...
    def create_stack_set(
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          (maximum size: 460,800 bytes) that's located in an Amazon S3 bucket. For more information,
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_IAM`` and ``CAPABILITY_NAMED_IAM``   Some stack templates might include
          resources that can affect permissions in your AWS account; for example, by creating new
          AWS Identity and Access Management (IAM) users. For those stack sets, you must explicitly
          acknowledge this by specifying one of these capabilities. The following IAM resources
          require you to specify either the ``CAPABILITY_IAM`` or ``CAPABILITY_NAMED_IAM``
          capability.
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some templates contain macros. If your stack template
          ...
          template, without first reviewing the resulting changes in a change set, you must
          acknowledge this capability. For more information, see `Using AWS CloudFormation Macros to
        ...
        :param Tags:
          ...
          If you specify tags as part of a ``CreateStackSet`` action, AWS CloudFormation checks to
        ...
        :param AdministrationRoleARN:
          ...
          more information, see `Prerequisites\\: Granting Permissions for Stack Set Operations
        ...
        :param ClientRequestToken:
          ...
          retry requests so that AWS CloudFormation knows that you're not attempting to create
    ...
    def delete_stack(
        ...
        **Request Syntax**
        ...
        :param RetainResources:
          ...
          associated with the resources you want to retain. During deletion, AWS CloudFormation
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that
          AWS CloudFormation assumes to delete the stack. AWS CloudFormation uses the role's
        ...
        :param ClientRequestToken:
          ...
          retry requests so that AWS CloudFormation knows that you're not attempting to delete a
          stack with the same name. You might retry ``DeleteStack`` requests to ensure that AWS
          CloudFormation successfully received them.
    ...
    def delete_stack_instances(
        ...
        **Request Syntax**
        ...
        :param OperationId:
          ...
          The operation ID also functions as an idempotency token, to ensure that AWS CloudFormation
          performs the stack set operation only once, even if you retry the request multiple times.
          You can retry stack set operation requests to ensure that AWS CloudFormation successfully
          received them.
    ...
    def deregister_type(
        ...
        """
        Removes a type or type version from active use in the CloudFormation registry. If a type or
        type version is deregistered, it cannot be used in CloudFormation operations.

        To deregister a type, you must individually deregister all registered versions of that type.
        If a type has only a single registered version, deregistering that version results in the
        type itself being deregistered.
    ...
    def describe_change_set(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A string (provided by the  DescribeChangeSet response output) that identifies the next
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'ExecutionStatus':
                'UNAVAILABLE'|'AVAILABLE'|'EXECUTE_IN_PROGRESS'|'EXECUTE_COMPLETE'
                |'EXECUTE_FAILED'|'OBSOLETE',
                'Status':
                'CREATE_PENDING'|'CREATE_IN_PROGRESS'|'CREATE_COMPLETE'|'DELETE_COMPLETE'
                |'FAILED',
                'StatusReason': 'string',
                'NotificationARNs': [
                    'string',
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ExecutionStatus** *(string) --*
              ...
              If you can’t execute the change set, the status indicates why. For example, a change
              set might be in an ``UNAVAILABLE`` state because AWS CloudFormation is still creating
              it or in an ``OBSOLETE`` state because the stack was already updated.
            ...
            - **RollbackConfiguration** *(dict) --*
              ...
              - **RollbackTriggers** *(list) --*
                ...
                * To specify new or updated rollback triggers, you must specify *all* the triggers
                that you want used for this stack, even triggers you've specifed before (for
              ...
              - *(dict) --*
                ...
                - **ResourceChange** *(dict) --*
                  ...
                  - **Action** *(string) --*
                    ...
                    a new resource), ``Modify`` (changes a resource), or ``Remove`` (deletes a
                    resource).
                    ...
                    - *(dict) --*
                      ...
                      - **Target** *(dict) --*
                        ...
                        - **Attribute** *(string) --*
                          ...
                          change in the resource attribute's ``Metadata`` , ``Properties`` , or
                          ``Tags`` .
                        ...
                        - **RequiresRecreation** *(string) --*
                          ...
                          conditions for a ``Conditionally`` recreation, see the update behavior for
                          that `property
                      ...
                      - **ChangeSource** *(string) --*
                        ...
                        * ``ResourceAttribute`` entities are ``Fn::GetAtt`` intrinsic functions that
                        get resource attribute values, such as ``{ "Fn::GetAtt" : [
    ...
    def describe_stack_drift_detection_status(
        ...
        returns a ``StackDriftDetectionId`` you can use to monitor the progress of the operation
        using ``DescribeStackDriftDetectionStatus`` . Once the drift detection operation has
        completed, use  DescribeStackResourceDrifts to return drift information about the stack and
        its resources.
          ...
          - *(dict) --*
            ...
            - **DetectionStatus** *(string) --*
              ...
              * ``DETECTION_COMPLETE`` : The stack drift detection operation has successfully
              ...
              do not currently support stack detection remain unchecked.) If you specified logical
              resource IDs for AWS CloudFormation to use as a filter for the stack drift detection
    ...
    def describe_stack_events(
        ...
        more information about a stack's event history, go to `Stacks
        <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/concept-stack.html>`__ in
                ...
                'StackEvents': [
                    {
                        ...
                        |'UPDATE_COMPLETE'|'IMPORT_FAILED'|'IMPORT_COMPLETE'
            ...
            - **StackEvents** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ClientRequestToken** *(string) --*
                  ...
                  request token, which you can use to track operations. For example, if you execute
                  a ``CreateStack`` operation with the token ``token1`` , then all the
                  ``StackEvents`` generated by that operation will have ``ClientRequestToken`` set
                  as ``token1`` .
            ...
            - **StackInstance** *(dict) --*
              ...
              - **DriftStatus** *(string) --*
                ...
                * ``DRIFTED`` : The stack differs from the expected template and parameter
                ...
                to have drifted if one or more of the resources in the associated stack have
                drifted.

                * ``NOT_CHECKED`` : AWS CloudFormation has not checked if the stack instance differs
                ...
                *drifted* , from its expected configuration, as defined in the stack template and
                ...
                - **StackResourceDriftStatus** *(string) --*
                  ...
                  * ``NOT_CHECKED`` : AWS CloudFormation has not checked if the resource differs
                  from its expected configuration. Any resources that do not currently support drift
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **StackResourceDrifts** *(list) --*
              ...
              stack. This includes actual and expected configuration values for resources where AWS
              CloudFormation detects drift.

              For a given stack, there will be one ``StackResourceDrift`` for each stack resource
              that has been checked for drift. Resources that have not yet been checked for drift
              are not included. Resources that do not currently support drift detection are not
              checked, and so not included. For a list of resources that support drift detection,
              ...
              - *(dict) --*
                ...
                CloudFormation has detected drift. Only resource properties explicitly defined in
                the stack template are checked for drift. For more information, see `Detecting
                Unregulated Configuration Changes to Stacks and Resources
                <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html>`__
                .
            ...
            - **NextToken** *(string) --*
              ...
              token. To retrieve the next set of results, call ``DescribeStackResourceDrifts`` again
    ...
    def describe_stack_resources(
        ...
        For deleted stacks, ``DescribeStackResources`` returns resource information for up to 90
        ...
        about resources, the ``LogicalResourceId`` and ``PhysicalResourceId`` , go to the `AWS
...

            {
                'StackSet': {
                    ...
                    'StackSetDriftDetectionDetails': {
                        ...
                        'COMPLETED'|'FAILED'|'PARTIAL_SUCCESS'|'IN_PROGRESS'
                        |'STOPPED',
                        'LastDriftCheckTimestamp': datetime(2015, 1, 1),
          ...
          - *(dict) --*
            ...
            - **StackSet** *(dict) --*
              ...
              - **Capabilities** *(list) --*
                ...
                see `Acknowledging IAM Resources in AWS CloudFormation Templates.
              ...
              - **AdministrationRoleARN** *(string) --*
                ...
                specific stack sets within the same administrator account. For more information, see
              ...
              - **StackSetDriftDetectionDetails** *(dict) --*
                ...
                - **LastDriftCheckTimestamp** *(datetime) --*
                  ...
                  Most recent time when CloudFormation performed a drift detection operation on the
                  stack set. This value will be ``NULL`` for any stack set on which drift detection
                ...
                - **DriftedStackInstancesCount** *(integer) --*
                  ...
                  drifted if one or more of the resources in the associated stack do not match their
                  expected configuration.
          ...
          - *(dict) --*
            ...
            - **StackSetOperation** *(dict) --*
              ...
              - **Action** *(string) --*
                ...
                and delete operations affect only the specified stack set instances that are
              ...
              - **Status** *(string) --*
                ...
                * ``FAILED`` : The operation exceeded the specified failure tolerance. The failure
                ...
                ``FAILED`` . This in turn sets the status of the operation as a whole to ``FAILED``
              ...
              - **OperationPreferences** *(dict) --*
                ...
                - **FailureToleranceCount** *(integer) --*
                  ...
                  a region, AWS CloudFormation doesn't attempt the operation in any subsequent
                  regions.
                ...
                - **FailureTolerancePercentage** *(integer) --*
                  ...
                  before AWS CloudFormation stops the operation in that region. If the operation is
                ...
                - **MaxConcurrentCount** *(integer) --*
                  ...
                  —``MaxConcurrentCount`` is at most one more than the ``FailureToleranceCount`` .
                ...
                - **MaxConcurrentPercentage** *(integer) --*
                  ...
                  When calculating the number of accounts based on the specified percentage, AWS
                  CloudFormation rounds down to the next whole number. This is true except in cases
              ...
              - **CreationTimestamp** *(datetime) --*
                ...
                themselves. This is because AWS CloudFormation needs to perform preparatory work for
                the operation, such as dispatching the work to the requested regions, before
              ...
              - *(dict) --*
                ...
                - **RollbackConfiguration** *(dict) --*
                  ...
                  - **RollbackTriggers** *(list) --*
                    ...
                    By default, AWS CloudFormation saves the rollback triggers specified for a stack
                    ...
                    * To specify new or updated rollback triggers, you must specify *all* the
                    triggers that you want used for this stack, even triggers you've specifed before
                    (for example, when creating the stack or during a previous stack update). Any
                  ...
                  - **MonitoringTimeInMinutes** *(integer) --*
                    ...
                    update (using `CancelUpdateStack
                    <https://docs.aws.amazon.com/AWSCloudFormation/latest/APIReference/API_CancelUpdateStack.html>`__
                    , for example) as necessary.
                ...
                - **RoleARN** *(string) --*
                  ...
                  that is associated with the stack. During a stack operation, AWS CloudFormation
                ...
                - **ParentId** *(string) --*
                  ...
                  the direct parent of this stack. For the first level of nested stacks, the root
                ...
                - **DriftInformation** *(dict) --*
                  ...
                  - **StackDriftStatus** *(string) --*
                    ...
                    * ``NOT_CHECKED`` : AWS CloudFormation has not checked if the stack differs from
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ProvisioningType** *(string) --*
              ...
              * ``FULLY_MUTABLE`` : The type includes an update handler to process updates to the
              type during stack update operations.

              * ``IMMUTABLE`` : The type does not include an update handler, so the type cannot be
            ...
            - **DeprecatedStatus** *(string) --*
              ...
              * ``DEPRECATED`` : The type has been deregistered and can no longer be used in
            ...
            - **ExecutionRoleArn** *(string) --*
              ...
              The Amazon Resource Name (ARN) of the IAM execution role used to register the type. If
              your resource type calls AWS APIs in any of its handlers, you must create an * `IAM
              execution role <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html>`__ *
              that includes the necessary permissions to call those AWS APIs, and provision that
              execution role in your account. CloudFormation then assumes that execution role to
    ...
    def describe_type_registration(
        ...
        """
        Returns information about a type's registration, including its current status and type and
        version identifiers.
    ...
    def detect_stack_drift(
        ...
        """
        Detects whether a stack's actual configuration differs, or has *drifted* , from it's
        expected configuration, as defined in the stack template and any values specified as
        template parameters. For each resource in the stack that supports drift detection, AWS
        CloudFormation compares the actual configuration of the resource with its expected template
        configuration. Only resource properties explicitly defined in the stack template are checked
        for drift. A stack is considered to have drifted if one or more of its resources differ from
        their expected template configurations. For more information, see `Detecting Unregulated
        Configuration Changes to Stacks and Resources
        <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html>`__
        .
        ...
        For a list of stack resources that currently support drift detection, see `Resources that
    ...
    def detect_stack_resource_drift(
        ...
        *drifted* , from it's expected configuration, as defined in the stack template and any
        values specified as template parameters. This information includes actual and expected
        property values for resources in which AWS CloudFormation detects drift. Only resource
        properties explicitly defined in the stack template are checked for drift. For more
        information about stack and resource drift, see `Detecting Unregulated Configuration Changes
            ...
            - **StackResourceDrift** *(dict) --*
              ...
              - **PropertyDifferences** *(list) --*
                ...
                - *(dict) --*
                  ...
                  parameters. These will be present only for resources whose
                  ``StackResourceDriftStatus`` is ``MODIFIED`` . For more information, see
                  `Detecting Unregulated Configuration Changes to Stacks and Resources
                  <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-stack-drift.html>`__
                  .
    ...
    def detect_stack_set_drift(
        ...
        For more information, see `How CloudFormation Performs Drift Detection on a Stack Set
        <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-drift.html>`__ .
         ...
         time, depending on the number of stack instances included in the stack set, as well as the
        ...
        * Use ``  ListStackInstances `` to return a list of stack instances belonging to the stack
    ...
    def estimate_template_cost(
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          located in an Amazon S3 bucket. For more information, go to `Template Anatomy
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__
          in the AWS CloudFormation User Guide.
    ...
    def execute_change_set(
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          to retry requests so that AWS CloudFormation knows that you're not attempting to execute a
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_template(
        self, StackName: str = None, ChangeSetName: str = None, TemplateStage: str = None
    ) -> ClientGetTemplateResponseTypeDef:
        """
        ...
        **Request Syntax**
        ...
        :param TemplateStage:
          ...
          after AWS CloudFormation has processed all transforms, specify ``Processed`` .
    ...
    def get_template_summary(
        ...
        For deleted stacks, ``GetTemplateSummary`` returns the template information for up to 90
        days after the stack has been deleted. If the template does not exist, a ``ValidationError``
        is returned.
        ...
        **Request Syntax**
        ...
        :param TemplateBody:
          ...
          Structure containing the template body with a minimum length of 1 byte and a maximum
          length of 51,200 bytes. For more information about templates, see `Template Anatomy
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__
          in the AWS CloudFormation User Guide.
        ...
        :param TemplateURL:
          ...
          Location of file containing the template body. The URL must point to a template (max size:
          460,800 bytes) that is located in an Amazon S3 bucket. For more information about
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Capabilities** *(list) --*
              ...
              when you use the  CreateStack or  UpdateStack actions with your template; otherwise,
            ...
            - **ResourceIdentifierSummaries** *(list) --*
              ...
              import operation and the properties you can provide during the import to identify the
              target resources. For example, ``BucketName`` is a possible identifier property for an
    ...
    def list_change_sets(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A string (provided by the  ListChangeSets response output) that identifies the next page
          of change sets that you want to retrieve.
              ...
              - *(dict) --*
                ...
                - **Status** *(string) --*
                  ...
                  * ``OUTDATED`` : The stack isn't currently up to date with the stack set because:
                    ...
                    * The stack was part of a ``CreateStackSet`` or ``UpdateStackSet`` operation
                  ...
                  *drifted* , from its expected configuration, as defined in the stack template and
                  ...
                  - **StackResourceDriftStatus** *(string) --*
                    ...
                    * ``NOT_CHECKED`` : AWS CloudFormation has not checked if the resource differs
                    ...
                    operations, see `Continue Rolling Back an Update
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Summaries** *(list) --*
              ...
              A list of ``StackSetOperationResultSummary`` structures that contain information about
              the specified operation results, for accounts and regions that are included in the
              operation.

              - *(dict) --*

                The structure that contains information about a specified operation's results for a
                given account in a given region.
                ...
                - **AccountGateResult** *(dict) --*
                  ...
                  - **Status** *(string) --*
                    ...
                    * ``SUCCEEDED`` : The account gate function has determined that the account and
                    region passes any requirements for a stack set operation to occur. AWS
                    ...
                    * ``FAILED`` : The account gate function has determined that the account and
                    region does not meet the requirements for a stack set operation to occur. AWS
            ...
            - **Summaries** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Action** *(string) --*
                  ...
                  specified stack set. Update operations affect both the stack set itself as well as
                ...
                - **Status** *(string) --*
                  ...
                  * ``FAILED`` : The operation exceeded the specified failure tolerance. The failure
                  ...
                  stack create and update operations. If the number of failed stacks within a region
                  exceeds the failure tolerance, the status of the operation in the region is set to
                  ``FAILED`` . This in turn sets the status of the operation as a whole to
                  ``FAILED`` , and AWS CloudFormation cancels the operation in any remaining
                  regions.
    ...
    def list_stacks(
        ...
        after the stack is deleted. If no StackStatusFilter is specified, summary information for
        all stacks is returned (including existing stacks and stacks that have been deleted).
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If the request doesn't return all of the remaining results, ``NextToken`` is set to a
              token. To retrieve the next set of results, call this action again and assign that
    ...
    def list_types(
        ...
        **Request Syntax**
        ...
        :param Visibility:
          ...
          * ``PRIVATE`` : The type is only visible and usable within the account in which it is
          registered. Currently, AWS CloudFormation marks any types you create as ``PRIVATE`` .
        ...
        :param ProvisioningType:
          ...
          during registration, based on the types of handlers in the schema handler package
          submitted.
        ...
        **Request Syntax**
        ::
          ...
          response = client.record_handler_progress(
              ...
              ErrorCode=
                  'NotUpdatable'|'InvalidRequest'|'AccessDenied'|'InvalidCredentials'
                  |'AlreadyExists'|'NotFound'|'ResourceConflict'|'Throttling'|'ServiceLimitExceeded'
                  |'NotStabilized'|'GeneralServiceException'|'ServiceInternalError'|'NetworkFailure'
                  |'InternalFailure',
    ...
    def register_type(
        ...
        """
        Registers a type with the CloudFormation service. Registering a type makes it available for
        use in CloudFormation templates in your AWS account, and includes:
        ...
        **Request Syntax**
        ...
        :param ExecutionRoleArn:
          ...
          The Amazon Resource Name (ARN) of the IAM execution role to use to register the type. If
          your resource type calls AWS APIs in any of its handlers, you must create an * `IAM
          execution role <https://docs.aws.amazon.com/IAM/latest/UserGuide/id_roles.html>`__ * that
          includes the necessary permissions to call those AWS APIs, and provision that execution
          role in your account. CloudFormation then assumes that execution role to provide your
        ...
        :param ClientRequestToken:
          ...
          version of a type from the same registeration request, even if the request is submitted
          multiple times.
    ...
    def set_type_default_version(
        ...
        """
        Specify the default version of a type. The default version of a type will be used in
        CloudFormation operations.
    ...
    def update_stack(
        ...
        **Request Syntax**
        ...
        :param StackPolicyDuringUpdateBody:
          ...
          the ``StackPolicyDuringUpdateBody`` or the ``StackPolicyDuringUpdateURL`` parameter, but
          not both.
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some template contain macros. Macros perform custom
          ...
          all the way to extensive transformations of entire templates. Because of this, users
          typically create a change set from the processed template, so that they can review the
          changes resulting from the macros before actually updating the stack. If your stack
          template contains one or more macros, and you choose to update a stack directly from the
          processed template, without first reviewing the resulting changes in a change set, you
          must acknowledge this capability. This includes the `AWS\\:\\:Include
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/create-reusable-transform-function-snippets-and-add-to-your-template-with-aws-include-transform.html>`__
          and `AWS\\:\\:Serverless
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/transform-aws-serverless.html>`__
          transforms, which are macros hosted by AWS CloudFormation. Change sets do not currently
          support nested stacks. If you want to update a stack from a stack template that contains
          macros *and* nested stacks, you must update the stack directly from the template using
          this capability.
        ...
        :param ResourceTypes:
          ...
          Identity and Access Management (IAM) uses this parameter for AWS CloudFormation-specific
          condition keys in IAM policies. For more information, see `Controlling Access with AWS
        ...
        :param RoleARN:
          ...
          The Amazon Resource Name (ARN) of an AWS Identity and Access Management (IAM) role that
          AWS CloudFormation assumes to update the stack. AWS CloudFormation uses the role's
          credentials to make calls on your behalf. AWS CloudFormation always uses this role for all
          future operations on the stack. As long as users have permission to operate on the stack,
          AWS CloudFormation uses this role even if the users don't have permission to pass it.
          Ensure that the role grants least privilege.
        ...
        :param StackPolicyBody:
          ...
          you created during a stack update. If you do not specify a stack policy, the current
        ...
        :param ClientRequestToken:
          ...
          retry requests so that AWS CloudFormation knows that you're not attempting to update a
          stack with the same name. You might retry ``UpdateStack`` requests to ensure that AWS
          CloudFormation successfully received them.
    ...
    def update_stack_instances(
        ...
        **Request Syntax**
        ...
        :param Accounts: **[REQUIRED]**
          ...
          The names of one or more AWS accounts for which you want to update parameter values for
        ...
        :param ParameterOverrides:
          ...
          * To leave all parameters set to their present values, do not specify this property at
          ...
          You can only override the parameter *values* that are specified in the stack set; to add
          or delete a parameter itself, use ``UpdateStackSet`` to update the stack set template. If
          you add a parameter to a template, before you can override the parameter value specified
    ...
    def update_stack_set(
        ...
        changes. Subsequent  CreateStackInstances calls on the specified stack set use the updated
        stack set.
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          The location of the file that contains the template body. The URL must point to a template
          (maximum size: 460,800 bytes) that is located in an Amazon S3 bucket. For more
        ...
        :param Capabilities:
          ...
          * ``CAPABILITY_IAM`` and ``CAPABILITY_NAMED_IAM``   Some stack templates might include
          resources that can affect permissions in your AWS account; for example, by creating new
          AWS Identity and Access Management (IAM) users. For those stacks sets, you must explicitly
          acknowledge this by specifying one of these capabilities. The following IAM resources
          require you to specify either the ``CAPABILITY_IAM`` or ``CAPABILITY_NAMED_IAM``
          capability.
          ...
          * ``CAPABILITY_AUTO_EXPAND``   Some templates contain macros. If your stack template
          contains one or more macros, and you choose to update a stack directly from the processed
          template, without first reviewing the resulting changes in a change set, you must
          acknowledge this capability. For more information, see `Using AWS CloudFormation Macros to
          Perform Custom Processing on Templates
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-macros.html>`__ .
        ...
        :param Tags:
          ...
          * If you specify *any* tags using this parameter, you must specify *all* the tags that you
          want associated with this stack set, even tags you've specifed before (for example, when
          creating the stack set or during a previous update of the stack set.). Any tags that you
          don't include in the updated list of tags are removed from the stack set, and therefore
          ...
          * If you specify an empty value, AWS CloudFormation removes all currently associated tags.
          ...
          If you specify new tags as part of an ``UpdateStackSet`` action, AWS CloudFormation checks
          to see if you have the required IAM permission to tag resources. If you omit tags that are
          currently associated with the stack set from the list of tags you specify, AWS
          CloudFormation assumes that you want to remove those tags from the stack set, and checks
        ...
        :param AdministrationRoleARN:
          ...
          Specify an IAM role only if you are using customized administrator roles to control which
          users or groups can manage specific stack sets within the same administrator account. For
          more information, see `Granting Permissions for Stack Set Operations
          <http://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/stacksets-prereqs.html>`__
          in the *AWS CloudFormation User Guide* .
        ...
        :param ExecutionRoleName:
          ...
          If you specify a customized execution role, AWS CloudFormation uses that role to update
          the stack. If you do not specify a customized execution role, AWS CloudFormation performs
          the update using the role previously associated with the stack set, so long as you have
        ...
        :param Accounts:
          ...
          The accounts in which to update associated stack instances. If you specify accounts, you
          ...
          or ``TemplateURL`` properties are specified), or the ``Parameters`` property, AWS
          CloudFormation marks all stack instances with a status of ``OUTDATED`` prior to updating
          the stack instances in the specified accounts and regions. If the stack set update does
          not include changes to the template or parameters, AWS CloudFormation updates the stack
    ...
    def update_termination_protection(
        ...
        with termination protection enabled, the operation fails and the stack remains unchanged.
        For more information, see `Protecting a Stack From Being Deleted
        <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/using-cfn-protect-stacks.html>`__
        in the *AWS CloudFormation User Guide* .
    ...
    def validate_template(
        ...
        **Request Syntax**
        ...
        :param TemplateURL:
          ...
          Location of file containing the template body. The URL must point to a template (max size:
          460,800 bytes) that is located in an Amazon S3 bucket. For more information, go to
          `Template Anatomy
          <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/template-anatomy.html>`__
          in the AWS CloudFormation User Guide.
