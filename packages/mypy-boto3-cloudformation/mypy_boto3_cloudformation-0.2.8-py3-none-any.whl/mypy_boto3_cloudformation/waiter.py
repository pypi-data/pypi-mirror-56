...
class ChangeSetCreateCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`CloudFormation.Client.describe_change_set` every 30 seconds until a
...
class StackCreateCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`CloudFormation.Client.describe_stacks` every 30 seconds until a successful
...
class StackExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`CloudFormation.Client.describe_stacks` every 5 seconds until a successful
