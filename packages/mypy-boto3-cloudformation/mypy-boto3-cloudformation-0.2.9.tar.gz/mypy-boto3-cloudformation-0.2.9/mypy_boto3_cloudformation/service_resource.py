"Main interface for cloudformation ServiceResource"
...
class Stack(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudformation-2010-05-15/None>`_
...
class StackResource(Boto3ServiceResource):
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`CloudFormation.Client.describe_stack_resource` to update the attributes of
        the StackResource resource. Note that the load and reload methods are the same method and
...
class StackEventsCollection(ResourceCollection):
    ...
    def filter(self, NextToken: str = None) -> List[service_resource_scope.Event]:
        """
        Creates an iterable of all Event resources in the collection filtered by kwargs passed to
        method.
...
class StackResourceSummariesCollection(ResourceCollection):
    ...
    def filter(self, NextToken: str = None) -> List[service_resource_scope.StackResourceSummary]:
        """
        Creates an iterable of all StackResourceSummary resources in the collection filtered by
    ...
    def limit(self, count: int) -> List[service_resource_scope.StackResourceSummary]:
        """
        Creates an iterable up to a specified amount of StackResourceSummary resources in the
        collection.
    ...
    def page_size(self, count: int) -> List[service_resource_scope.StackResourceSummary]:
        """
        Creates an iterable of all StackResourceSummary resources in the collection, but limits the
