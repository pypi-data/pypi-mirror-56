"Main interface for cloudformation Paginators"
...
class ListChangeSetsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        StackName: str,
        PaginationConfig: ListChangeSetsPaginatePaginationConfigTypeDef = None,
    ) -> ListChangeSetsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListImportsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ExportName: str,
        PaginationConfig: ListImportsPaginatePaginationConfigTypeDef = None,
    ) -> ListImportsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
