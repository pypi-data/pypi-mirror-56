...
setuptools.setup(
    ...
    \n# Example\
    \n#Obtain X data\
    \n#Spectroscopic data of EELS (Electron Energy Loss Spectroscopy) available in the zip file of this Pypi module (data_EELS.txt).\
    \n#Data contains 100 spectra acquired over 2048 energy levels.\
