...
STATESCOM = ['home', 'errands', 'escort', 'shopping', 'leisure', 'workplace']
STATESFREE = ['home', 'errands', 'escort', 'shopping', 'leisure']

TIME_FREQ = {24: {'f': 'H', 't': 1}, 48: {'f': '30min', 't': 0.5}, 96: {'f': '15min', 't': 0.25}}
