...
namespace pyxie
{
...

	{
		...
		case GL_GREEN: colorbuff[0] = green; break;
		case GL_BLUE: colorbuff[0] = blue; break;
		case GL_ALPHA: colorbuff[0] = alpha; break;
		...
		case GL_LUMINANCE: colorbuff[0] = red; break;
		case GL_LUMINANCE_ALPHA: colorbuff[0] = red; colorbuff[1] = alpha; break;
		}
