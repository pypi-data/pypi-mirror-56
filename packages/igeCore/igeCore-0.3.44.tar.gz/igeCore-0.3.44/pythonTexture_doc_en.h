...
PyDoc_STRVAR(texture_doc,
	...
	"Formula\n"\
	"----------\n"\
	"    tex = pyxie.texture(name)\n"\
	"        Create texture from image file.\n"\
	"    tex = pyxie.texture(name,width,height,format,depth,stencil,pixel)\n"\
	...
	"        GL_GREEN : 1 channel format (0,n,0,0)\n"\
	"        GL_BLUE : 1 channel format (0,0,n,0)\n"\
	"        GL_ALPHA : 1 channel format (0,0,0,n)\n"\
	"        GL_RGB : 3 channel format (n,m,l,0)\n"\
	"        GL_RGBA : 4 channel format (n,m,l,o)\n"\
	"        GL_LUMINANCE : 1 channel format (n,n,n,0)\n"\
	"        GL_LUMINANCE_ALPHA : 2 channel format (n,n,n,m)\n"\
	"    depth : bool\n"\
