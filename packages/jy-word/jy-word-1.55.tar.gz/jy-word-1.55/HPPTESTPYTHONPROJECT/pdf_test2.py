...
def parse_lt_objs (lt_objs, page_number, images_folder, text=[]):
    ...
    # if page_number in [20]:
    #     print page_number, page_text.keys()
        # print page_number, ''.join(v).replace('\n', '')
...
# pdf2img(u'H:\晶云公司\\1.需求文档\下载报告\晶苗\\3.新版\晶苗报告自动化文件晶苗 总.pdf')
# folder_name=u'H:\晶云公司\\1.需求文档\下载报告\多组学临床检测报告\数据\part0'
# C_PDFNAME=u'王其君100301检测报告.pdf'
folder_name=u'H:\晶云公司\\1.需求文档\下载报告\晶苗\\3.新版\图片3'
if os.path.exists(folder_name) is False:
    os.makedirs(folder_name)
pdf_path= u'H:\晶云公司\\1.需求文档\下载报告\晶苗\\3.新版\晶苗报告自动化文件\晶苗 总.pdf'
C_JPGNAME=u'img\王其君100301检测报告%s.jpg'
text_url = os.path.join(folder_name, 'test.txt')
import codecs
...
for i in pages:
    ...
    if i != '':
        ...
        if isinstance(i, str):
            ...
            if encoding != 'utf-8':
                try:
                    text = i.decode(encoding).encode('utf-8')
                except:
                    text = ''
            else:
                text = ''
