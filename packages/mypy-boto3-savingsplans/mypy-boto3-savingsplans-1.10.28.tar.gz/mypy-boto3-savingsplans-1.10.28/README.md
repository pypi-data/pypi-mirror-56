...
Mypy-friendly auto-generated type annotations for `boto3 savingsplans 1.10.28` service.
...
session_client = session.client("savingsplans")
...
```python
import boto3
from mypy_boto3.savingsplans import Client
