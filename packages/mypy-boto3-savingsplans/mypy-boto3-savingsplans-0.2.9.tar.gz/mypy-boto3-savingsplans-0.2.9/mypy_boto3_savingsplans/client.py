    ...
    def create_savings_plan(
        ...
        **Request Syntax**
        ...
        :param upfrontPaymentAmount:
          ...
          The up-front payment amount. This is a whole number between 50 and 99 percent of the total
          value of the Savings Plan. This parameter is supported only if the payment option is
          ``Partial Upfront`` .
        ...
        ::
          ...
          response = client.describe_savings_plan_rates(
              ...
              filters=[
                  {
                      'name':
                      'region'|'instanceType'|'productDescription'|'tenancy'
                      |'productType'|'serviceCode'|'usageType'|'operation',
                      'values': [
                          'string',
                      ]
                  },
                ...
                'searchResults': [
                    {
                        ...
                        'properties': [
                            {
                                'name':
                                'region'|'instanceType'|'instanceFamily'
                                |'productDescription'|'tenancy',
                                'value': 'string'
                            },
                        ]
                    },
        ...
        ::
          ...
          response = client.describe_savings_plans(
              ...
              filters=[
                  {
                      'name':
                      'region'|'ec2-instance-family'|'commitment'|'upfront'|'term'
                      |'savings-plan-type'|'payment-option'|'start'|'end',
                      'values': [
                          'string',
                      ]
                  },
        ...
        ::
          ...
          response = client.describe_savings_plans_offering_rates(
              ...
              filters=[
                  {
                      'name':
                      'region'|'instanceFamily'|'instanceType'|'productDescription'
                      |'tenancy'|'productId',
                      'values': [
                          'string',
                      ]
