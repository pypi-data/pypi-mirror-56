...
_ClientDescribeSavingsPlanRatesfiltersTypeDef = TypedDict(
    "_ClientDescribeSavingsPlanRatesfiltersTypeDef", {"name": str, "values": List[str]}, total=False
)
...
class ClientDescribeSavingsPlansOfferingRatesResponsesearchResultssavingsPlanOfferingTypeDef(
    ...
    """
    Type definition for `ClientDescribeSavingsPlansOfferingRatesResponsesearchResults`
    `savingsPlanOffering`
...
_ClientDescribeSavingsPlansfiltersTypeDef = TypedDict(
    "_ClientDescribeSavingsPlansfiltersTypeDef", {"name": str, "values": List[str]}, total=False
)
