...
class BusinessMediaFetcher:
  ...
  def init(self, logger, conf_file):
    try:
      self.logger = logger
      print('BusinessMediaFetcher set logger')
      print(self.logger)
...
def main_script(args):
  ...
  fetcher.init(logger, conf_file)
  # process all users
  fetcher.process_all(args)
...
def main_imported(args):
  ...
  # initialize Fetcher with package file
