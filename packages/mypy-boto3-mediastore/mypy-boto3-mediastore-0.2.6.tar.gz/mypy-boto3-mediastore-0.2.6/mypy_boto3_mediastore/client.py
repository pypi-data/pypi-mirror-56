"Main interface for mediastore Client"
...
class Client(BaseClient):
    ...
    def create_container(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          Typically, the tag key represents a category (such as "environment") and the tag value represents
          a specific value within that category (such as "test," "development," or "production"). You can
          add up to 50 tags to each container. For more information about tagging, including naming and
    ...
    def delete_container(self, ContainerName: str) -> Dict[str, Any]:
        ...
        in the container or in any folders in the container. You can delete only empty containers.
    ...
    def describe_container(
        ...
        created. A container's endpoint does not change after it has been assigned. The
    ...
    def get_cors_policy(self, ContainerName: str) -> ClientGetCorsPolicyResponseTypeDef:
        ...
        To use this operation, you must have permission to perform the ``MediaStore:GetCorsPolicy`` action.
        By default, the container owner has this permission and can grant it to others.
    ...
    def list_containers(
        ...
        parameter to receive a limited number of containers in each response. In this case, the response
        includes a token. To get the next set of containers, send the command again, this time with the
        ``NextToken`` parameter (with the returned token as its value). The next set of responses appears,
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          previous response) to obtain the next set of containers. This token is included in a response
          only if there actually are more containers to list.
    ...
    def put_container_policy(self, ContainerName: str, Policy: str) -> Dict[str, Any]:
        ...
        access it. For information about the data that is included in an access policy, see the `AWS
        Identity and Access Management User Guide <https://aws.amazon.com/documentation/iam/>`__ .
    ...
    def put_cors_policy(
        ...
        """
        Sets the cross-origin resource sharing (CORS) configuration on a container so that the container
        can service cross-origin requests. For example, you might want to enable a request whose origin is
        ...
        <https://docs.aws.amazon.com/mediastore/latest/ug/cors-policy.html>`__ .
    ...
    def tag_resource(
        ...
        """
        Adds tags to the specified AWS Elemental MediaStore container. Tags are key:value pairs that you
        can associate with AWS resources. For example, the tag key might be "customer" and the tag value
        might be "companyA." You can specify one or more tags to add to each container. You can add up to
        50 tags to each container. For more information about tagging, including naming and usage
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          An array of key:value pairs that you want to add to the container. You need to specify only the
          tags that you want to add or update. For example, suppose a container already has two tags
          (customer:CompanyA and priority:High). You want to change the priority tag and also add a third
          tag (type:Contract). For TagResource, you specify the following tags: priority:Medium,
          type:Contract. The result is that your container has three tags: customer:CompanyA,
    ...
    def untag_resource(self, Resource: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param TagKeys: **[REQUIRED]**
          ...
          A comma-separated list of keys for tags that you want to remove from the container. For example,
          if your container has two tags (customer:CompanyA and priority:High) and you want to remove one
