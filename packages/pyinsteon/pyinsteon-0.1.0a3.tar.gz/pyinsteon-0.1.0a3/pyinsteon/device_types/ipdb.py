...
from .dimmable_lighting_control import (DimmableLightingControl,
...
class IPDB():
    ...
    _products = [
        ...
        Product(0x05, 0x03, 0x00001F, 'Thermostat Adapter', '2441V', UnknownDevice),
        ...
        Product(0x05, 0x0F, None, 'Thermostat', '2732-422', UnknownDevice),
        Product(0x05, 0x10, None, 'Thermostat', '2732-522', UnknownDevice),
        Product(0x05, 0x11, None, 'Wireless Thermostat', '2732-432', UnknownDevice),
        Product(0x05, 0x12, None, 'Wireless Thermostat', '2732-532', UnknownDevice),
        Product(0x05, 0x13, None, 'Thermostat Heat Pump', '2732-232', UnknownDevice),
        Product(0x05, 0x14, None, 'Thermostat Heat Pump', '2732-432', UnknownDevice),
        Product(0x05, 0x15, None, 'Thermostat Heat Pump', '2732-532', UnknownDevice),
        # Product(0x05, 0x16, None, 'Insteon Thermostat', '2441TH', ClimateControl_2441th),
        Product(0x05, 0x17, None, 'Insteon Thermostat', '2732-422', UnknownDevice),
        Product(0x05, 0x18, None, 'Insteon Thermostat', '2732-522', UnknownDevice),
