...
class SetImConfigurationHandler(OutboundHandlerBase):
    ...
    def send(self, disable_auto_linking: bool, monitor_mode: bool,
             auto_led: bool, deadman: bool):
        """Send the Set IM Configuration command."""
        super().send(disable_auto_linking=disable_auto_linking, monitor_mode=monitor_mode,
                     auto_led=auto_led, deadman=deadman)

    #pylint: disable=arguments-differ
    async def async_send(self, disable_auto_linking: bool, monitor_mode: bool,
                         auto_led: bool, deadman: bool):
        """Send the Set IM Configuration command."""
