...
class Client(BaseClient):
    ...
    def create_app(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/CreateApp>`_
          ...
          ::

            {
                'appSummary': {
                    ...
                    'replicationStatus':
                    'READY_FOR_CONFIGURATION'|'CONFIGURATION_IN_PROGRESS'
                    |'CONFIGURATION_INVALID'|'READY_FOR_REPLICATION'
                    |'VALIDATION_IN_PROGRESS'|'REPLICATION_PENDING'
                    |'REPLICATION_IN_PROGRESS'|'REPLICATED'
                    |'DELTA_REPLICATION_IN_PROGRESS'|'DELTA_REPLICATED'
                    |'DELTA_REPLICATION_FAILED'|'REPLICATION_FAILED'
                    |'REPLICATION_STOPPING'|'REPLICATION_STOP_FAILED'
                    |'REPLICATION_STOPPED',
                    'replicationStatusMessage': 'string',
                    'latestReplicationTime': datetime(2015, 1, 1),
                    'launchStatus':
                    'READY_FOR_CONFIGURATION'|'CONFIGURATION_IN_PROGRESS'
                    |'CONFIGURATION_INVALID'|'READY_FOR_LAUNCH'|'VALIDATION_IN_PROGRESS'
                    |'LAUNCH_PENDING'|'LAUNCH_IN_PROGRESS'|'LAUNCHED'
                    |'DELTA_LAUNCH_IN_PROGRESS'|'DELTA_LAUNCH_FAILED'|'LAUNCH_FAILED'
                    |'TERMINATE_IN_PROGRESS'|'TERMINATE_FAILED'|'TERMINATED',
    ...
    def create_replication_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/CreateReplicationJob>`_
    ...
    def delete_app(
        ...
        """
        Deletes an existing application. Optionally deletes the launched stack associated with the
        application and all AWS SMS replication jobs for servers in the application.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/DeleteApp>`_
        ...
        **Request Syntax**
        ...
        :param forceStopAppReplication:
          ...
          While deleting the application, stop all replication jobs corresponding to the servers in
          the application.
    ...
    def delete_app_launch_configuration(self, appId: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/DeleteAppLaunchConfiguration>`_
    ...
    def delete_app_replication_configuration(self, appId: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/DeleteAppReplicationConfiguration>`_
    ...
    def delete_replication_job(self, replicationJobId: str) -> Dict[str, Any]:
        ...
        After you delete a replication job, there are no further replication runs. AWS deletes the
        contents of the Amazon S3 bucket used to store AWS SMS artifacts. The AMIs created by the
        replication runs are not deleted.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/DeleteReplicationJob>`_
    ...
    def delete_server_catalog(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/DeleteServerCatalog>`_
    ...
    def disassociate_connector(self, connectorId: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/DisassociateConnector>`_
    ...
    def generate_change_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GenerateChangeSet>`_
    ...
    def generate_template(
        ...
        """
        Generates an Amazon CloudFormation template based on the current launch configuration and
        writes it to an Amazon S3 object in the customer’s Amazon S3 bucket.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GenerateTemplate>`_
    ...
    def get_app(self, appId: str = None) -> ClientGetAppResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetApp>`_
    ...
    def get_app_launch_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetAppLaunchConfiguration>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **roleName** *(string) --*
              ...
              Name of the service role in the customer's account that Amazon CloudFormation uses to
    ...
    def get_app_replication_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetAppReplicationConfiguration>`_
    ...
    def get_connectors(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetConnectors>`_
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          The maximum number of results to return in a single call. The default value is 50. To
    ...
    def get_replication_jobs(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetReplicationJobs>`_
                ...
                'replicationJobList': [
                    {
                        ...
                        'latestAmiId': 'string',
                        'state':
                        'PENDING'|'ACTIVE'|'FAILED'|'DELETING'|'DELETED'|'COMPLETED'
                        |'PAUSED_ON_FAILURE'|'FAILING',
                        'statusMessage': 'string',
                        'description': 'string',
                        'numberOfRecentAmisToKeep': 123,
                        'encrypted': True|False,
                        ...
                        'replicationRunList': [
                            {
                                ...
                                'state':
                                'PENDING'|'MISSED'|'ACTIVE'|'FAILED'
                                |'COMPLETED'|'DELETING'|'DELETED',
    ...
    def get_replication_runs(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetReplicationRuns>`_
                    ...
                    'replicationRunList': [
                        {
                            'replicationRunId': 'string',
                            'state':
                            'PENDING'|'MISSED'|'ACTIVE'|'FAILED'|'COMPLETED'
                            |'DELETING'|'DELETED',
                            'type': 'ON_DEMAND'|'AUTOMATIC',
                            'stageDetails': {
                                'stage': 'string',
                ...
                'replicationRunList': [
                    {
                        'replicationRunId': 'string',
                        'state':
                        'PENDING'|'MISSED'|'ACTIVE'|'FAILED'|'COMPLETED'|'DELETING'
                        |'DELETED',
                        'type': 'ON_DEMAND'|'AUTOMATIC',
                        'stageDetails': {
                            'stage': 'string',
    ...
    def get_servers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/GetServers>`_
    ...
    def import_server_catalog(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/ImportServerCatalog>`_
    ...
    def launch_app(self, appId: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/LaunchApp>`_
    ...
    def list_apps(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/ListApps>`_
                ...
                'apps': [
                    {
                        ...
                        |'VALIDATION_IN_PROGRESS'|'LAUNCH_PENDING'
                        |'LAUNCH_IN_PROGRESS'|'LAUNCHED'|'DELTA_LAUNCH_IN_PROGRESS'
                        |'DELTA_LAUNCH_FAILED'|'LAUNCH_FAILED'
                        |'TERMINATE_IN_PROGRESS'|'TERMINATE_FAILED'|'TERMINATED',
                        'launchStatusMessage': 'string',
                        'launchDetails': {
                            'latestLaunchTime': datetime(2015, 1, 1),
    ...
    def put_app_launch_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/PutAppLaunchConfiguration>`_
        ...
        **Request Syntax**
        ...
        :param roleName:
          ...
          Name of service role in the customer's account that Amazon CloudFormation uses to launch
          the application.
    ...
    def put_app_replication_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/PutAppReplicationConfiguration>`_
    ...
    def start_app_replication(self, appId: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/StartAppReplication>`_
    ...
    def start_on_demand_replication_run(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/StartOnDemandReplicationRun>`_
    ...
    def stop_app_replication(self, appId: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/StopAppReplication>`_
    ...
    def terminate_app(self, appId: str = None) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/TerminateApp>`_
    ...
    def update_app(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/UpdateApp>`_
    ...
    def update_replication_job(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/sms-2016-10-24/UpdateReplicationJob>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_connectors` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_replication_jobs` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_replication_runs` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_servers` operation.
        """
