...
class TestErrorContent(unittest.TestCase):
    ...
    def testErrorContent(self):
        ...
        # model = sigfox_api_client.models.error_content.ErrorContent()  # noqa: E501
        pass
