...
class TestCommonDevice(unittest.TestCase):
    ...
    def testCommonDevice(self):
        """Test CommonDevice"""
        # FIXME: construct object with mandatory attributes with example values
        # model = sigfox_api_client.models.common_device.CommonDevice()  # noqa: E501
        pass
