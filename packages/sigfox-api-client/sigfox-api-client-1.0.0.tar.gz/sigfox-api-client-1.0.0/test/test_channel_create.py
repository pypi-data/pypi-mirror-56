...
class TestChannelCreate(unittest.TestCase):
    ...
    def testChannelCreate(self):
        ...
        # model = sigfox_api_client.models.channel_create.ChannelCreate()  # noqa: E501
        pass
