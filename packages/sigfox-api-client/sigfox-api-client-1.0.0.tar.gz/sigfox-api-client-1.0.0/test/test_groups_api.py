...
class TestGroupsApi(unittest.TestCase):
    ...
    def test_get_callback_messages_error_list_for_group(self):
        """Test case for get_callback_messages_error_list_for_group
    ...
    def test_list_geolocation_payload(self):
        """Test case for list_geolocation_payload
