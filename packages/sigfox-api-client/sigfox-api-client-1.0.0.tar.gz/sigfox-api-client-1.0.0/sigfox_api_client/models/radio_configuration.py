...
class RadioConfiguration(object):
    ...
    @property
    def id(self):
        """Gets the id of this RadioConfiguration.  # noqa: E501

        The radio configuration identifier   - 0 -> RC1   - 1 -> RC2   - 2 -> RC3   - 3 -> RC101   - 4 -> RC4   - 5 -> RC5   - 6 -> RC6   # noqa: E501

        :return: The id of this RadioConfiguration.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this RadioConfiguration.

        The radio configuration identifier   - 0 -> RC1   - 1 -> RC2   - 2 -> RC3   - 3 -> RC101   - 4 -> RC4   - 5 -> RC5   - 6 -> RC6   # noqa: E501

        :param id: The id of this RadioConfiguration.  # noqa: E501
        :type: int
        """
        if id is None:
