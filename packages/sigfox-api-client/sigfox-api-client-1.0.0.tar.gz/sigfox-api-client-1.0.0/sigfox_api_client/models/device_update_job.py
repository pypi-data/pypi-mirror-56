...
class DeviceUpdateJob(object):
    ...
    def __init__(self, name=None, *args, **kwargs):  # noqa: E501
        """DeviceUpdateJob - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this DeviceUpdateJob.  # noqa: E501

        The device's name  # noqa: E501

        :return: The name of this DeviceUpdateJob.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeviceUpdateJob.

        The device's name  # noqa: E501

        :param name: The name of this DeviceUpdateJob.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceUpdateJob, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceUpdateJob):
            return False
