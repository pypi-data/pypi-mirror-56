...
class TilesResponse(object):
    ...
    swagger_types = {
        'base_img_url': 'str',
        'tms_template_url': 'str',
        'bounds': 'Bounds'
    }

    attribute_map = {
        'base_img_url': 'baseImgUrl',
        'tms_template_url': 'tmsTemplateUrl',
        'bounds': 'bounds'
    }

    def __init__(self, base_img_url=None, tms_template_url=None, bounds=None):  # noqa: E501
        """TilesResponse - a model defined in Swagger"""  # noqa: E501
        self._base_img_url = None
        self._tms_template_url = None
        self._bounds = None
        self.discriminator = None
        if base_img_url is not None:
            self.base_img_url = base_img_url
        if tms_template_url is not None:
            self.tms_template_url = tms_template_url
        if bounds is not None:
            self.bounds = bounds

    @property
    def base_img_url(self):
        """Gets the base_img_url of this TilesResponse.  # noqa: E501

        The tiles base image url  # noqa: E501

        :return: The base_img_url of this TilesResponse.  # noqa: E501
        :rtype: str
        """
        return self._base_img_url

    @base_img_url.setter
    def base_img_url(self, base_img_url):
        """Sets the base_img_url of this TilesResponse.

        The tiles base image url  # noqa: E501

        :param base_img_url: The base_img_url of this TilesResponse.  # noqa: E501
        :type: str
        """
    ...
    @property
    def tms_template_url(self):
        """Gets the tms_template_url of this TilesResponse.  # noqa: E501

        The TMS template url  # noqa: E501

        :return: The tms_template_url of this TilesResponse.  # noqa: E501
        :rtype: str
        """
        return self._tms_template_url

    @tms_template_url.setter
    def tms_template_url(self, tms_template_url):
        """Sets the tms_template_url of this TilesResponse.

        The TMS template url  # noqa: E501

        :param tms_template_url: The tms_template_url of this TilesResponse.  # noqa: E501
        :type: str
        """

        self._tms_template_url = tms_template_url

    @property
    def bounds(self):
        """Gets the bounds of this TilesResponse.  # noqa: E501


        :return: The bounds of this TilesResponse.  # noqa: E501
        :rtype: Bounds
        """
        return self._bounds
    ...
    def bounds(self, bounds):
        """Sets the bounds of this TilesResponse.


        :param bounds: The bounds of this TilesResponse.  # noqa: E501
        :type: Bounds
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TilesResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TilesResponse):
            return False
