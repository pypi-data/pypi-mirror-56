...
class UserUpdate(object):
    ...
    def __init__(self, user_roles=None, base_stations=None, maintenances=None, *args, **kwargs):  # noqa: E501
        """UserUpdate - a model defined in Swagger"""  # noqa: E501
        self._user_roles = None
        self._base_stations = None
        self._maintenances = None
    ...
    @property
    def user_roles(self):
        """Gets the user_roles of this UserUpdate.  # noqa: E501

        Defines the rights of the user  # noqa: E501

        :return: The user_roles of this UserUpdate.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def user_roles(self, user_roles):
        """Sets the user_roles of this UserUpdate.

        Defines the rights of the user  # noqa: E501

        :param user_roles: The user_roles of this UserUpdate.  # noqa: E501
        :type: list[object]
        """
    ...
    def base_stations(self):
        """Gets the base_stations of this UserUpdate.  # noqa: E501

        list of base station ids (Comma-separated values in hexadecimal format) corresponding to the userRoles with tap limited access granted  # noqa: E501

        :return: The base_stations of this UserUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def base_stations(self, base_stations):
        """Sets the base_stations of this UserUpdate.

        list of base station ids (Comma-separated values in hexadecimal format) corresponding to the userRoles with tap limited access granted  # noqa: E501

        :param base_stations: The base_stations of this UserUpdate.  # noqa: E501
        :type: str
        """
    ...
    def maintenances(self):
        """Gets the maintenances of this UserUpdate.  # noqa: E501

        list of maintenance ids corresponding to the userRoles with site limited access granted  # noqa: E501

        :return: The maintenances of this UserUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def maintenances(self, maintenances):
        """Sets the maintenances of this UserUpdate.

        list of maintenance ids corresponding to the userRoles with site limited access granted  # noqa: E501

        :param maintenances: The maintenances of this UserUpdate.  # noqa: E501
        :type: str
        """
