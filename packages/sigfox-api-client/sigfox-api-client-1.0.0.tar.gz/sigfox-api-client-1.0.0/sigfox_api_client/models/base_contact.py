...
class BaseContact(object):
    ...
    def __init__(self, name=None, email=None, phone_number=None, mobile_phone_number=None, address=None, description=None):  # noqa: E501
    ...
    def email(self):
        ...
        The contact's email. This field can be unset when updating.  # noqa: E501
    ...
    def phone_number(self):
        """Gets the phone_number of this BaseContact.  # noqa: E501

        The contact's phone number must be in the international format with no spaces between numbers (+country code - number). This field can be unset when updating.  # noqa: E501

        :return: The phone_number of this BaseContact.  # noqa: E501
        :rtype: str
        """
    ...
    def phone_number(self, phone_number):
        """Sets the phone_number of this BaseContact.

        The contact's phone number must be in the international format with no spaces between numbers (+country code - number). This field can be unset when updating.  # noqa: E501

        :param phone_number: The phone_number of this BaseContact.  # noqa: E501
        :type: str
        """
    ...
    def mobile_phone_number(self):
        """Gets the mobile_phone_number of this BaseContact.  # noqa: E501

        The contact's mobile phone number must be in the international format with no spaces between numbers (+country code - number). This field can be unset when updating.  # noqa: E501

        :return: The mobile_phone_number of this BaseContact.  # noqa: E501
        :rtype: str
        """
    ...
    def mobile_phone_number(self, mobile_phone_number):
        """Sets the mobile_phone_number of this BaseContact.

        The contact's mobile phone number must be in the international format with no spaces between numbers (+country code - number). This field can be unset when updating.  # noqa: E501

        :param mobile_phone_number: The mobile_phone_number of this BaseContact.  # noqa: E501
        :type: str
        """
    ...
    @property
    def address(self):
        """Gets the address of this BaseContact.  # noqa: E501

        The contact's address  # noqa: E501

        :return: The address of this BaseContact.  # noqa: E501
        :rtype: str
        """
    ...
    def address(self, address):
        """Sets the address of this BaseContact.

        The contact's address  # noqa: E501

        :param address: The address of this BaseContact.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this BaseContact.  # noqa: E501

        The contact's description  # noqa: E501

        :return: The description of this BaseContact.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this BaseContact.

        The contact's description  # noqa: E501

        :param description: The description of this BaseContact.  # noqa: E501
        :type: str
        """
