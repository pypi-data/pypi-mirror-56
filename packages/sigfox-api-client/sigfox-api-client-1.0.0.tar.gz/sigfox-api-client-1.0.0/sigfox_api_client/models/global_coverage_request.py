...
class GlobalCoverageRequest(object):
    ...
    def __init__(self, locations=None, radius=None, group_id=None):  # noqa: E501
        """GlobalCoverageRequest - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def locations(self):
        """Gets the locations of this GlobalCoverageRequest.  # noqa: E501

        An array of positions. Valid locations have two properties, lat and lng.  # noqa: E501

        :return: The locations of this GlobalCoverageRequest.  # noqa: E501
        :rtype: list[object]
        """
    ...
    def locations(self, locations):
        """Sets the locations of this GlobalCoverageRequest.

        An array of positions. Valid locations have two properties, lat and lng.  # noqa: E501

        :param locations: The locations of this GlobalCoverageRequest.  # noqa: E501
        :type: list[object]
        """
    ...
    @property
    def radius(self):
        """Gets the radius of this GlobalCoverageRequest.  # noqa: E501

        The radius of the area in which the coverage results are averaged and returned for a selected location, in meters.  # noqa: E501

        :return: The radius of this GlobalCoverageRequest.  # noqa: E501
        :rtype: int
        """
        return self._radius
    ...
    def radius(self, radius):
        """Sets the radius of this GlobalCoverageRequest.

        The radius of the area in which the coverage results are averaged and returned for a selected location, in meters.  # noqa: E501

        :param radius: The radius of this GlobalCoverageRequest.  # noqa: E501
        :type: int
        """
    ...
    @property
    def group_id(self):
        """Gets the group_id of this GlobalCoverageRequest.  # noqa: E501

        The id of a group to include its operator in the global coverage, in case it is not a public operator.  # noqa: E501

        :return: The group_id of this GlobalCoverageRequest.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this GlobalCoverageRequest.

        The id of a group to include its operator in the global coverage, in case it is not a public operator.  # noqa: E501

        :param group_id: The group_id of this GlobalCoverageRequest.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(GlobalCoverageRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, GlobalCoverageRequest):
            return False
