...
class LocationWithStatus(object):
    ...
    def __init__(self, status=None, *args, **kwargs):  # noqa: E501
        """LocationWithStatus - a model defined in Swagger"""  # noqa: E501
        self._status = None
    ...
    @property
    def status(self):
        """Gets the status of this LocationWithStatus.  # noqa: E501

        the status of the computation made by the location service   - 00: No position   - 01: OK   - 02: Fallback of WiFi location   - 20: Invalid payload   # noqa: E501

        :return: The status of this LocationWithStatus.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this LocationWithStatus.

        the status of the computation made by the location service   - 00: No position   - 01: OK   - 02: Fallback of WiFi location   - 20: Invalid payload   # noqa: E501

        :param status: The status of this LocationWithStatus.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(LocationWithStatus, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LocationWithStatus):
            return False
