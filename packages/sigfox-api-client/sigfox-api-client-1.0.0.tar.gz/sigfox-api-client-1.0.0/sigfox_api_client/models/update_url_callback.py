...
class UpdateUrlCallback(object):
    ...
    if hasattr(UpdateCallback, "swagger_types"):
        swagger_types.update(UpdateCallback.swagger_types)
    ...
    if hasattr(UpdateCallback, "attribute_map"):
        attribute_map.update(UpdateCallback.attribute_map)
    ...
    def __init__(self, url=None, http_method=None, downlink_hook=None, headers=None, send_sni=None, body_template=None, *args, **kwargs):  # noqa: E501
        """UpdateUrlCallback - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this UpdateUrlCallback.  # noqa: E501

        The callback's url  # noqa: E501

        :return: The url of this UpdateUrlCallback.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this UpdateUrlCallback.

        The callback's url  # noqa: E501

        :param url: The url of this UpdateUrlCallback.  # noqa: E501
        :type: str
        """
    ...
    def http_method(self):
        """Gets the http_method of this UpdateUrlCallback.  # noqa: E501

        The http method used to send a callback  # noqa: E501

        :return: The http_method of this UpdateUrlCallback.  # noqa: E501
        :rtype: str
        """
    ...
    def http_method(self, http_method):
        """Sets the http_method of this UpdateUrlCallback.

        The http method used to send a callback  # noqa: E501

        :param http_method: The http_method of this UpdateUrlCallback.  # noqa: E501
        :type: str
        """
    ...
    def downlink_hook(self):
        """Gets the downlink_hook of this UpdateUrlCallback.  # noqa: E501

        True if this callback is used for downlink, else false.  # noqa: E501

        :return: The downlink_hook of this UpdateUrlCallback.  # noqa: E501
        :rtype: bool
        """
    ...
    def downlink_hook(self, downlink_hook):
        """Sets the downlink_hook of this UpdateUrlCallback.

        True if this callback is used for downlink, else false.  # noqa: E501

        :param downlink_hook: The downlink_hook of this UpdateUrlCallback.  # noqa: E501
        :type: bool
        """
    ...
    def headers(self, headers):
        """Sets the headers of this UpdateUrlCallback.

        The headers of the http request to send, as an object with key:value. This field can be unset when updating.  # noqa: E501

        :param headers: The headers of this UpdateUrlCallback.  # noqa: E501
        :type: object
        """
    ...
    def send_sni(self, send_sni):
        """Sets the send_sni of this UpdateUrlCallback.

        Send SNI (Server Name Indication) for SSL/TLS connections. Used by BATCH_URL and URL callbacks (optional).  # noqa: E501

        :param send_sni: The send_sni of this UpdateUrlCallback.  # noqa: E501
        :type: bool
        """
    ...
    def body_template(self):
        """Gets the body_template of this UpdateUrlCallback.  # noqa: E501
        ...
        :return: The body_template of this UpdateUrlCallback.  # noqa: E501
        :rtype: str
        """
    ...
    def body_template(self, body_template):
        """Sets the body_template of this UpdateUrlCallback.

        The body template of the request. Only if httpMethpd is set to POST or PUT. It can contain predefined and custom variables. Mandatory for URL callbacks. This field can be unset when updating.  # noqa: E501

        :param body_template: The body_template of this UpdateUrlCallback.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdateUrlCallback, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdateUrlCallback):
            return False
