...
class PartnersUpdate(object):
    ...
    if hasattr(CommonGroupUpdate, "swagger_types"):
        swagger_types.update(CommonGroupUpdate.swagger_types)
    ...
    if hasattr(CommonGroupUpdate, "attribute_map"):
        attribute_map.update(CommonGroupUpdate.attribute_map)

    def __init__(self, billable=None, technical_email=None, max_prototype_allowed=None, *args, **kwargs):  # noqa: E501
        """PartnersUpdate - a model defined in Swagger"""  # noqa: E501
        self._billable = None
        ...
        CommonGroupUpdate.__init__(self, *args, **kwargs)

    @property
    def billable(self):
        """Gets the billable of this PartnersUpdate.  # noqa: E501

        true if the group is billable  # noqa: E501

        :return: The billable of this PartnersUpdate.  # noqa: E501
        :rtype: bool
        """
    ...
    def billable(self, billable):
        """Sets the billable of this PartnersUpdate.

        true if the group is billable  # noqa: E501

        :param billable: The billable of this PartnersUpdate.  # noqa: E501
        :type: bool
        """
    ...
    def technical_email(self):
        """Gets the technical_email of this PartnersUpdate.  # noqa: E501

        The technical contact email  # noqa: E501

        :return: The technical_email of this PartnersUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def technical_email(self, technical_email):
        """Sets the technical_email of this PartnersUpdate.

        The technical contact email  # noqa: E501

        :param technical_email: The technical_email of this PartnersUpdate.  # noqa: E501
        :type: str
        """
    ...
    def max_prototype_allowed(self):
        """Gets the max_prototype_allowed of this PartnersUpdate.  # noqa: E501

        Number of prototypes allowed. Accessible only for groups under SO  # noqa: E501

        :return: The max_prototype_allowed of this PartnersUpdate.  # noqa: E501
        :rtype: int
        """
    ...
    def max_prototype_allowed(self, max_prototype_allowed):
        """Sets the max_prototype_allowed of this PartnersUpdate.

        Number of prototypes allowed. Accessible only for groups under SO  # noqa: E501

        :param max_prototype_allowed: The max_prototype_allowed of this PartnersUpdate.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartnersUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnersUpdate):
            return False
