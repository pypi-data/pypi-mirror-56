...
class RadioCertificate(object):
    ...
    def __init__(self, modes=None, input_sensitivity=None, *args, **kwargs):  # noqa: E501
        """RadioCertificate - a model defined in Swagger"""  # noqa: E501
        self._modes = None
    ...
    @property
    def modes(self):
        """Gets the modes of this RadioCertificate.  # noqa: E501

        The certificate's mode code (0 -> Uplink only, 1 -> Uplink and downlink)  # noqa: E501

        :return: The modes of this RadioCertificate.  # noqa: E501
        :rtype: list[int]
        """
        return self._modes
    ...
    def modes(self, modes):
        """Sets the modes of this RadioCertificate.

        The certificate's mode code (0 -> Uplink only, 1 -> Uplink and downlink)  # noqa: E501

        :param modes: The modes of this RadioCertificate.  # noqa: E501
        :type: list[int]
        """
    ...
    def input_sensitivity(self):
        """Gets the input_sensitivity of this RadioCertificate.  # noqa: E501

        The certificate's input sensitivity  # noqa: E501

        :return: The input_sensitivity of this RadioCertificate.  # noqa: E501
        :rtype: int
        """
    ...
    def input_sensitivity(self, input_sensitivity):
        """Sets the input_sensitivity of this RadioCertificate.

        The certificate's input sensitivity  # noqa: E501

        :param input_sensitivity: The input_sensitivity of this RadioCertificate.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(RadioCertificate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RadioCertificate):
            return False
