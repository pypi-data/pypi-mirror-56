...
class Contact(object):
    ...
    if hasattr(BaseContact, "swagger_types"):
        swagger_types.update(BaseContact.swagger_types)

    attribute_map = {
        'id': 'id'
    }
    if hasattr(BaseContact, "attribute_map"):
        attribute_map.update(BaseContact.attribute_map)
    ...
    def __init__(self, id=None, *args, **kwargs):  # noqa: E501
        ...
        if id is not None:
            self.id = id
        BaseContact.__init__(self, *args, **kwargs)
