...
class DeviceLocation(object):
    ...
    if hasattr(ComputedLocation, "swagger_types"):
        swagger_types.update(ComputedLocation.swagger_types)

    attribute_map = {
        'time': 'time',
        'valid': 'valid'
    }
    if hasattr(ComputedLocation, "attribute_map"):
        attribute_map.update(ComputedLocation.attribute_map)

    def __init__(self, time=None, valid=None, *args, **kwargs):  # noqa: E501
        """DeviceLocation - a model defined in Swagger"""  # noqa: E501
        self._time = None
        self._valid = None
        ...
        if valid is not None:
            self.valid = valid
        ComputedLocation.__init__(self, *args, **kwargs)

    @property
    def time(self):
        """Gets the time of this DeviceLocation.  # noqa: E501

        Timestamp of the message (in milliseconds since the Unix Epoch)  # noqa: E501

        :return: The time of this DeviceLocation.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this DeviceLocation.

        Timestamp of the message (in milliseconds since the Unix Epoch)  # noqa: E501

        :param time: The time of this DeviceLocation.  # noqa: E501
        :type: int
        """
    ...
    @property
    def valid(self):
        """Gets the valid of this DeviceLocation.  # noqa: E501

        true, if a valid estimation for this message is available (GPS or RSSI)  # noqa: E501

        :return: The valid of this DeviceLocation.  # noqa: E501
        :rtype: bool
        """
        return self._valid
    ...
    def valid(self, valid):
        """Sets the valid of this DeviceLocation.

        true, if a valid estimation for this message is available (GPS or RSSI)  # noqa: E501

        :param valid: The valid of this DeviceLocation.  # noqa: E501
        :type: bool
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceLocation, dict):
