...
class ModemCertificateRadioConfiguration(object):
    ...
    swagger_types = {
        'output_power': 'float',
        'balanced_link_budget': 'bool'
    }
    if hasattr(RadioConfiguration, "swagger_types"):
        swagger_types.update(RadioConfiguration.swagger_types)

    attribute_map = {
        'output_power': 'outputPower',
        'balanced_link_budget': 'balancedLinkBudget'
    }
    if hasattr(RadioConfiguration, "attribute_map"):
        attribute_map.update(RadioConfiguration.attribute_map)

    def __init__(self, output_power=None, balanced_link_budget=None, *args, **kwargs):  # noqa: E501
        """ModemCertificateRadioConfiguration - a model defined in Swagger"""  # noqa: E501
        self._output_power = None
        self._balanced_link_budget = None
        self.discriminator = None
        if output_power is not None:
            self.output_power = output_power
        if balanced_link_budget is not None:
            self.balanced_link_budget = balanced_link_budget
        RadioConfiguration.__init__(self, *args, **kwargs)

    @property
    def output_power(self):
        """Gets the output_power of this ModemCertificateRadioConfiguration.  # noqa: E501

        Output conducted power (dBm)  # noqa: E501

        :return: The output_power of this ModemCertificateRadioConfiguration.  # noqa: E501
        :rtype: float
        """
    ...
    def output_power(self, output_power):
        """Sets the output_power of this ModemCertificateRadioConfiguration.

        Output conducted power (dBm)  # noqa: E501

        :param output_power: The output_power of this ModemCertificateRadioConfiguration.  # noqa: E501
        :type: float
        """
    ...
    @property
    def balanced_link_budget(self):
        """Gets the balanced_link_budget of this ModemCertificateRadioConfiguration.  # noqa: E501

        Balanced link budget  # noqa: E501

        :return: The balanced_link_budget of this ModemCertificateRadioConfiguration.  # noqa: E501
        :rtype: bool
        """
        return self._balanced_link_budget

    @balanced_link_budget.setter
    def balanced_link_budget(self, balanced_link_budget):
        """Sets the balanced_link_budget of this ModemCertificateRadioConfiguration.

        Balanced link budget  # noqa: E501

        :param balanced_link_budget: The balanced_link_budget of this ModemCertificateRadioConfiguration.  # noqa: E501
        :type: bool
        """

        self._balanced_link_budget = balanced_link_budget
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModemCertificateRadioConfiguration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModemCertificateRadioConfiguration):
            return False
