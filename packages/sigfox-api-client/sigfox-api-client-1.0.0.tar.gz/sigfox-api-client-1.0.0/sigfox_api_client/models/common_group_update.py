...
class CommonGroupUpdate(object):
    ...
    discriminator_value_class_map = {
          'StarterUpdate': 'StarterUpdate',
'PartnerUpdate': 'PartnerUpdate',
'PartnersUpdate': 'PartnersUpdate',
'BasicUpdate': 'BasicUpdate',
'SOUpdate': 'SOUpdate',
'NIPUpdate': 'NIPUpdate',
'SVNOUpdate': 'SVNOUpdate',
'DISTUpdate': 'DISTUpdate',
'ChannelUpdate': 'ChannelUpdate'    }

    def __init__(self, name=None, description=None, type=None, timezone=None):  # noqa: E501
        """CommonGroupUpdate - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this CommonGroupUpdate.  # noqa: E501

        The group's name  # noqa: E501

        :return: The name of this CommonGroupUpdate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CommonGroupUpdate.

        The group's name  # noqa: E501

        :param name: The name of this CommonGroupUpdate.  # noqa: E501
        :type: str
        """
    ...
    def description(self):
        """Gets the description of this CommonGroupUpdate.  # noqa: E501

        The group's description  # noqa: E501

        :return: The description of this CommonGroupUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CommonGroupUpdate.

        The group's description  # noqa: E501

        :param description: The description of this CommonGroupUpdate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this CommonGroupUpdate.  # noqa: E501

        - Group's type - 0 -> SO - 2 -> Other - 5 -> SVNO - 6 -> Partners - 7 -> NIP - 8 -> DIST - 9 -> Channel - 10 -> Starter - 11 -> Partner   # noqa: E501

        :return: The type of this CommonGroupUpdate.  # noqa: E501
        :rtype: int
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CommonGroupUpdate.

        - Group's type - 0 -> SO - 2 -> Other - 5 -> SVNO - 6 -> Partners - 7 -> NIP - 8 -> DIST - 9 -> Channel - 10 -> Starter - 11 -> Partner   # noqa: E501

        :param type: The type of this CommonGroupUpdate.  # noqa: E501
        :type: int
        """
    ...
    @property
    def timezone(self):
        """Gets the timezone of this CommonGroupUpdate.  # noqa: E501

        The timezone (in Java TimeZone ID format, e.g.\"America/Costa_Rica\").  # noqa: E501

        :return: The timezone of this CommonGroupUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this CommonGroupUpdate.

        The timezone (in Java TimeZone ID format, e.g.\"America/Costa_Rica\").  # noqa: E501

        :param timezone: The timezone of this CommonGroupUpdate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommonGroupUpdate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommonGroupUpdate):
            return False
