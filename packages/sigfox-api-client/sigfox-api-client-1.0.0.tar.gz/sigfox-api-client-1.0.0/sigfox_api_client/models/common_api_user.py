...
class CommonApiUser(object):
    ...
    def __init__(self, name=None, timezone=None):  # noqa: E501
        """CommonApiUser - a model defined in Swagger"""  # noqa: E501
        self._name = None
        self._timezone = None
    ...
    @property
    def name(self):
        """Gets the name of this CommonApiUser.  # noqa: E501

        The API user name  # noqa: E501

        :return: The name of this CommonApiUser.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CommonApiUser.

        The API user name  # noqa: E501

        :param name: The name of this CommonApiUser.  # noqa: E501
        :type: str
        """
    ...
    @property
    def timezone(self):
        """Gets the timezone of this CommonApiUser.  # noqa: E501

        The API user timezone  # noqa: E501

        :return: The timezone of this CommonApiUser.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this CommonApiUser.

        The API user timezone  # noqa: E501

        :param timezone: The timezone of this CommonApiUser.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommonApiUser, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommonApiUser):
            return False
