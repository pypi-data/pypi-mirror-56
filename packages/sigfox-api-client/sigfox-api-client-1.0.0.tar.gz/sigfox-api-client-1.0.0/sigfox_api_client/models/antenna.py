...
class Antenna(object):
    ...
    swagger_types = {
        ...
        'azimuth': 'float',
        'attenuation': 'float',
        'attenuation_direct': 'float',
        'attenuation_indirect': 'float',
        'tilt': 'float'
    }
    ...
    attribute_map = {
        ...
        'attenuation_direct': 'attenuationDirect',
        'attenuation_indirect': 'attenuationIndirect',
        'tilt': 'tilt'
    }

    def __init__(self, model=None, azimuth=None, attenuation=None, attenuation_direct=None, attenuation_indirect=None, tilt=None):  # noqa: E501
        """Antenna - a model defined in Swagger"""  # noqa: E501
        self._model = None
        self._azimuth = None
    ...
    @property
    def model(self):
        """Gets the model of this Antenna.  # noqa: E501

        Antenna model of the station. E.g. \"CXL 900-3LW\", \"CXL 900-6LW\" , \"\" -> NONE ...  # noqa: E501

        :return: The model of this Antenna.  # noqa: E501
        :rtype: str
        """
        return self._model
    ...
    def model(self, model):
        """Sets the model of this Antenna.

        Antenna model of the station. E.g. \"CXL 900-3LW\", \"CXL 900-6LW\" , \"\" -> NONE ...  # noqa: E501

        :param model: The model of this Antenna.  # noqa: E501
        :type: str
        """
    ...
    @property
    def azimuth(self):
        """Gets the azimuth of this Antenna.  # noqa: E501

        The base station's azimuth (in °)  # noqa: E501

        :return: The azimuth of this Antenna.  # noqa: E501
        :rtype: float
        """
    ...
    def azimuth(self, azimuth):
        """Sets the azimuth of this Antenna.

        The base station's azimuth (in °)  # noqa: E501

        :param azimuth: The azimuth of this Antenna.  # noqa: E501
        :type: float
        """
    ...
    def attenuation(self):
        """Gets the attenuation of this Antenna.  # noqa: E501

        The base station's attenuation signal (in %)  # noqa: E501

        :return: The attenuation of this Antenna.  # noqa: E501
        :rtype: float
        """
    ...
    def attenuation(self, attenuation):
        """Sets the attenuation of this Antenna.

        The base station's attenuation signal (in %)  # noqa: E501

        :param attenuation: The attenuation of this Antenna.  # noqa: E501
        :type: float
        """
    ...
    @property
    def attenuation_direct(self):
        """Gets the attenuation_direct of this Antenna.  # noqa: E501

        The base station's attenuation direct (in °). This field can be unset when updating.  # noqa: E501

        :return: The attenuation_direct of this Antenna.  # noqa: E501
        :rtype: float
        """
        return self._attenuation_direct

    @attenuation_direct.setter
    def attenuation_direct(self, attenuation_direct):
        """Sets the attenuation_direct of this Antenna.

        The base station's attenuation direct (in °). This field can be unset when updating.  # noqa: E501

        :param attenuation_direct: The attenuation_direct of this Antenna.  # noqa: E501
        :type: float
        """

        self._attenuation_direct = attenuation_direct

    @property
    def attenuation_indirect(self):
        """Gets the attenuation_indirect of this Antenna.  # noqa: E501

        The base station's attenuation indirect (in °). This field can be unset when updating.  # noqa: E501

        :return: The attenuation_indirect of this Antenna.  # noqa: E501
        :rtype: float
        """
        return self._attenuation_indirect

    @attenuation_indirect.setter
    def attenuation_indirect(self, attenuation_indirect):
        """Sets the attenuation_indirect of this Antenna.

        The base station's attenuation indirect (in °). This field can be unset when updating.  # noqa: E501

        :param attenuation_indirect: The attenuation_indirect of this Antenna.  # noqa: E501
        :type: float
        """

        self._attenuation_indirect = attenuation_indirect

    @property
    def tilt(self):
        """Gets the tilt of this Antenna.  # noqa: E501

        The base station's tilt  # noqa: E501

        :return: The tilt of this Antenna.  # noqa: E501
        :rtype: float
        """
        return self._tilt
    ...
    @tilt.setter
    def tilt(self, tilt):
        """Sets the tilt of this Antenna.

        The base station's tilt  # noqa: E501

        :param tilt: The tilt of this Antenna.  # noqa: E501
        :type: float
        """
