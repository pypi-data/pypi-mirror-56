...
class UpdatebatchUrlCallback(object):
    ...
    def __init__(self, url=None, http_method=None, line_pattern=None, *args, **kwargs):  # noqa: E501
        """UpdatebatchUrlCallback - a model defined in Swagger"""  # noqa: E501
        self._url = None
    ...
    @property
    def url(self):
        """Gets the url of this UpdatebatchUrlCallback.  # noqa: E501

        The callback's url  # noqa: E501

        :return: The url of this UpdatebatchUrlCallback.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this UpdatebatchUrlCallback.

        The callback's url  # noqa: E501

        :param url: The url of this UpdatebatchUrlCallback.  # noqa: E501
        :type: str
        """
    ...
    def http_method(self):
        """Gets the http_method of this UpdatebatchUrlCallback.  # noqa: E501

        The http method used to send a callback  # noqa: E501

        :return: The http_method of this UpdatebatchUrlCallback.  # noqa: E501
        :rtype: str
        """
    ...
    def http_method(self, http_method):
        """Sets the http_method of this UpdatebatchUrlCallback.

        The http method used to send a callback  # noqa: E501

        :param http_method: The http_method of this UpdatebatchUrlCallback.  # noqa: E501
        :type: str
        """
    ...
    def line_pattern(self):
        """Gets the line_pattern of this UpdatebatchUrlCallback.  # noqa: E501

        The line pattern representing a message.  # noqa: E501

        :return: The line_pattern of this UpdatebatchUrlCallback.  # noqa: E501
        :rtype: str
        """
    ...
    def line_pattern(self, line_pattern):
        """Sets the line_pattern of this UpdatebatchUrlCallback.

        The line pattern representing a message.  # noqa: E501

        :param line_pattern: The line_pattern of this UpdatebatchUrlCallback.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(UpdatebatchUrlCallback, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UpdatebatchUrlCallback):
            return False
