...
class DeviceTypeCreate(object):
    ...
    def __init__(self, group_id=None, contract_id=None, contracts=None, geoloc_payload_config_id=None, *args, **kwargs):  # noqa: E501
        """DeviceTypeCreate - a model defined in Swagger"""  # noqa: E501
        self._group_id = None
    ...
    @property
    def group_id(self):
        """Gets the group_id of this DeviceTypeCreate.  # noqa: E501

        The device type's group identifier  # noqa: E501

        :return: The group_id of this DeviceTypeCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this DeviceTypeCreate.

        The device type's group identifier  # noqa: E501

        :param group_id: The group_id of this DeviceTypeCreate.  # noqa: E501
        :type: str
        """
        if group_id is None:
    ...
    def contract_id(self):
        """Gets the contract_id of this DeviceTypeCreate.  # noqa: E501

        The device type's contract identifier  # noqa: E501

        :return: The contract_id of this DeviceTypeCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def contract_id(self, contract_id):
        """Sets the contract_id of this DeviceTypeCreate.

        The device type's contract identifier  # noqa: E501

        :param contract_id: The contract_id of this DeviceTypeCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def contracts(self):
        """Gets the contracts of this DeviceTypeCreate.  # noqa: E501

        The device type's contract identifiers  # noqa: E501

        :return: The contracts of this DeviceTypeCreate.  # noqa: E501
    ...
    def contracts(self, contracts):
        """Sets the contracts of this DeviceTypeCreate.

        The device type's contract identifiers  # noqa: E501

        :param contracts: The contracts of this DeviceTypeCreate.  # noqa: E501
    ...
    def geoloc_payload_config_id(self):
        """Gets the geoloc_payload_config_id of this DeviceTypeCreate.  # noqa: E501

        The geoloc payload configuration identifier. Required if the payload type is Geolocation, else ignored.  # noqa: E501

        :return: The geoloc_payload_config_id of this DeviceTypeCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def geoloc_payload_config_id(self, geoloc_payload_config_id):
        """Sets the geoloc_payload_config_id of this DeviceTypeCreate.

        The geoloc payload configuration identifier. Required if the payload type is Geolocation, else ignored.  # noqa: E501

        :param geoloc_payload_config_id: The geoloc_payload_config_id of this DeviceTypeCreate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceTypeCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceTypeCreate):
            return False
