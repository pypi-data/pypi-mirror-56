...
class ProductCertificateRadioConfiguration(object):
    ...
    attribute_map = {
        'uplink_class': 'uplinkClass',
        'max_eirp': 'maxEirp'
    }
    if hasattr(RadioConfiguration, "attribute_map"):
        attribute_map.update(RadioConfiguration.attribute_map)

    def __init__(self, uplink_class=None, max_eirp=None, *args, **kwargs):  # noqa: E501
        """ProductCertificateRadioConfiguration - a model defined in Swagger"""  # noqa: E501
        self._uplink_class = None
        self._max_eirp = None
        self.discriminator = None
        if uplink_class is not None:
            self.uplink_class = uplink_class
        if max_eirp is not None:
            self.max_eirp = max_eirp
        RadioConfiguration.__init__(self, *args, **kwargs)

    @property
    def uplink_class(self):
        """Gets the uplink_class of this ProductCertificateRadioConfiguration.  # noqa: E501

        The device uplink class   - 0 -> U0   - 1 -> U1   - 2 -> U2   - 3 -> U3   - 4 -> D0   - 5 -> D1   - 6 -> D2   - 7 -> D3   # noqa: E501

        :return: The uplink_class of this ProductCertificateRadioConfiguration.  # noqa: E501
        :rtype: int
        """
        return self._uplink_class

    @uplink_class.setter
    def uplink_class(self, uplink_class):
        """Sets the uplink_class of this ProductCertificateRadioConfiguration.

        The device uplink class   - 0 -> U0   - 1 -> U1   - 2 -> U2   - 3 -> U3   - 4 -> D0   - 5 -> D1   - 6 -> D2   - 7 -> D3   # noqa: E501

        :param uplink_class: The uplink_class of this ProductCertificateRadioConfiguration.  # noqa: E501
        :type: int
        """

        self._uplink_class = uplink_class

    @property
    def max_eirp(self):
        """Gets the max_eirp of this ProductCertificateRadioConfiguration.  # noqa: E501

        Maximum radiated power EIRP (dBm)  # noqa: E501

        :return: The max_eirp of this ProductCertificateRadioConfiguration.  # noqa: E501
        :rtype: float
        """
    ...
    def max_eirp(self, max_eirp):
        """Sets the max_eirp of this ProductCertificateRadioConfiguration.

        Maximum radiated power EIRP (dBm)  # noqa: E501

        :param max_eirp: The max_eirp of this ProductCertificateRadioConfiguration.  # noqa: E501
        :type: float
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ProductCertificateRadioConfiguration, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ProductCertificateRadioConfiguration):
            return False
