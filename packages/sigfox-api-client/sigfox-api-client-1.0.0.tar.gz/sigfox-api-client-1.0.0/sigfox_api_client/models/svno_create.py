...
class SVNOCreate(object):
    ...
    """
    swagger_types = {
        'network_operator_id': 'str'
    }
    if hasattr(CommonGroupCreate, "swagger_types"):
        swagger_types.update(CommonGroupCreate.swagger_types)

    attribute_map = {
        'network_operator_id': 'networkOperatorId'
    }
    if hasattr(CommonGroupCreate, "attribute_map"):
        attribute_map.update(CommonGroupCreate.attribute_map)

    def __init__(self, network_operator_id=None, *args, **kwargs):  # noqa: E501
        """SVNOCreate - a model defined in Swagger"""  # noqa: E501
        self._network_operator_id = None
        self.discriminator = None
        if network_operator_id is not None:
            self.network_operator_id = network_operator_id
        CommonGroupCreate.__init__(self, *args, **kwargs)

    @property
    def network_operator_id(self):
        """Gets the network_operator_id of this SVNOCreate.  # noqa: E501

        SNO or NIP group id for a DIST & SVNO  group. This field is mandatory for DIST & SVNO group creation.  # noqa: E501

        :return: The network_operator_id of this SVNOCreate.  # noqa: E501
        :rtype: str
        """
        return self._network_operator_id

    @network_operator_id.setter
    def network_operator_id(self, network_operator_id):
        """Sets the network_operator_id of this SVNOCreate.

        SNO or NIP group id for a DIST & SVNO  group. This field is mandatory for DIST & SVNO group creation.  # noqa: E501

        :param network_operator_id: The network_operator_id of this SVNOCreate.  # noqa: E501
        :type: str
        """

        self._network_operator_id = network_operator_id
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SVNOCreate):
            return False
