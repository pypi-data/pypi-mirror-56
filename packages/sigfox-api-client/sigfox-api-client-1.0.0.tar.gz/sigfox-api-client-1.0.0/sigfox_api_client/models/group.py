...
'NIP': 'NIP'    }
    ...
    def __init__(self, name=None, description=None, type=None, timezone=None, id=None, name_ci=None, path=None):  # noqa: E501
    ...
    def type(self):
        ...
        Group's type - 0 -> SO - 2 -> Basic - 5 -> SVNO - 6 -> Partners - 7 -> NIP - 8 -> DIST - 9 -> Channel - 10 -> Starter - 11 -> Partner   # noqa: E501
    ...
    @property
    def timezone(self):
        """Gets the timezone of this Group.  # noqa: E501

        The timezone (in Java TimeZone ID format, e.g.\"America/Costa_Rica\").  # noqa: E501

        :return: The timezone of this Group.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        ...
        :param timezone: The timezone of this Group.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name_ci(self):
        """Gets the name_ci of this Group.  # noqa: E501

        The group's name to ascii and lowercase  # noqa: E501

        :return: The name_ci of this Group.  # noqa: E501
        :rtype: str
        """
        return self._name_ci

    @name_ci.setter
    def name_ci(self, name_ci):
        """Sets the name_ci of this Group.

        The group's name to ascii and lowercase  # noqa: E501

        :param name_ci: The name_ci of this Group.  # noqa: E501
        :type: str
        """

        self._name_ci = name_ci

    @property
    def path(self):
        """Gets the path of this Group.  # noqa: E501

        The group's path sorted by descending ancestor {id} (direct parent to farthest parent), restricted to the groups visible by the API user  # noqa: E501
