...
class HostCreation(object):
    ...
    if hasattr(BaseHost, "swagger_types"):
        swagger_types.update(BaseHost.swagger_types)

    attribute_map = {
        'group_id': 'groupId'
    }
    if hasattr(BaseHost, "attribute_map"):
        attribute_map.update(BaseHost.attribute_map)

    def __init__(self, group_id=None, *args, **kwargs):  # noqa: E501
        """HostCreation - a model defined in Swagger"""  # noqa: E501
        self._group_id = None
        self.discriminator = None
        self.group_id = group_id
        BaseHost.__init__(self, *args, **kwargs)

    @property
    def group_id(self):
        """Gets the group_id of this HostCreation.  # noqa: E501

        identifier of the group of this host  # noqa: E501

        :return: The group_id of this HostCreation.  # noqa: E501
        :rtype: str
        """
    ...
    def group_id(self, group_id):
        """Sets the group_id of this HostCreation.

        identifier of the group of this host  # noqa: E501

        :param group_id: The group_id of this HostCreation.  # noqa: E501
        :type: str
        """
        if group_id is None:
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(HostCreation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, HostCreation):
            return False
