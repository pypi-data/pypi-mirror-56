...
class CallbackHTTP(object):
    ...
    def __init__(self, url=None, headers=None, body=None, content_type=None, method=None, error=None):  # noqa: E501
        """CallbackHTTP - a model defined in Swagger"""  # noqa: E501
        self._url = None
        self._headers = None
        self._body = None
    ...
    @property
    def url(self):
        """Gets the url of this CallbackHTTP.  # noqa: E501

        The URL called when this message has been processed  # noqa: E501

        :return: The url of this CallbackHTTP.  # noqa: E501
        :rtype: str
        """
        return self._url
    ...
    @url.setter
    def url(self, url):
        """Sets the url of this CallbackHTTP.

        The URL called when this message has been processed  # noqa: E501

        :param url: The url of this CallbackHTTP.  # noqa: E501
        :type: str
        """
    ...
    @property
    def headers(self):
        """Gets the headers of this CallbackHTTP.  # noqa: E501

        The headers sent in the request. If no header is defined, this field is not present.  # noqa: E501

        :return: The headers of this CallbackHTTP.  # noqa: E501
        :rtype: object
        """
    ...
    def headers(self, headers):
        """Sets the headers of this CallbackHTTP.

        The headers sent in the request. If no header is defined, this field is not present.  # noqa: E501

        :param headers: The headers of this CallbackHTTP.  # noqa: E501
        :type: object
        """
    ...
    @property
    def body(self):
        """Gets the body of this CallbackHTTP.  # noqa: E501

        The body of the request, if any. It is only present if the request method is POST.  # noqa: E501

        :return: The body of this CallbackHTTP.  # noqa: E501
        :rtype: str
        """
        return self._body
    ...
    @body.setter
    def body(self, body):
        """Sets the body of this CallbackHTTP.

        The body of the request, if any. It is only present if the request method is POST.  # noqa: E501

        :param body: The body of this CallbackHTTP.  # noqa: E501
        :type: str
        """
    ...
    def content_type(self):
        """Gets the content_type of this CallbackHTTP.  # noqa: E501

        The content type of the request. It is only present if the request is a POST.  # noqa: E501

        :return: The content_type of this CallbackHTTP.  # noqa: E501
        :rtype: str
        """
    ...
    def content_type(self, content_type):
        """Sets the content_type of this CallbackHTTP.

        The content type of the request. It is only present if the request is a POST.  # noqa: E501

        :param content_type: The content_type of this CallbackHTTP.  # noqa: E501
        :type: str
        """
    ...
    @property
    def method(self):
        """Gets the method of this CallbackHTTP.  # noqa: E501

        The HTTP method, currently only GET, POST or PUT.  # noqa: E501

        :return: The method of this CallbackHTTP.  # noqa: E501
        :rtype: str
        """
        return self._method
    ...
    def method(self, method):
        """Sets the method of this CallbackHTTP.

        The HTTP method, currently only GET, POST or PUT.  # noqa: E501

        :param method: The method of this CallbackHTTP.  # noqa: E501
        :type: str
        """
    ...
    @property
    def error(self):
        """Gets the error of this CallbackHTTP.  # noqa: E501

        If there was an error, for instance if the body is JSON and could not be evaluated.  # noqa: E501

        :return: The error of this CallbackHTTP.  # noqa: E501
        :rtype: str
        """
        return self._error
    ...
    def error(self, error):
        """Sets the error of this CallbackHTTP.

        If there was an error, for instance if the body is JSON and could not be evaluated.  # noqa: E501

        :param error: The error of this CallbackHTTP.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CallbackHTTP, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CallbackHTTP):
            return False
