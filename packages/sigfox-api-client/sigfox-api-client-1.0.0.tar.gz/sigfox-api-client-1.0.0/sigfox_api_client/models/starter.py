...
class Starter(object):
    ...
    swagger_types = {
        'billable': 'bool',
        'technical_email': 'str',
        'max_prototype_allowed': 'int',
        'current_prototype_count': 'int'
    }
    ...
    attribute_map = {
        ...
        'max_prototype_allowed': 'maxPrototypeAllowed',
        'current_prototype_count': 'currentPrototypeCount'
    }
    if hasattr(Group, "attribute_map"):
        attribute_map.update(Group.attribute_map)

    def __init__(self, billable=None, technical_email=None, max_prototype_allowed=None, current_prototype_count=None, *args, **kwargs):  # noqa: E501
        """Starter - a model defined in Swagger"""  # noqa: E501
        self._billable = None
        self._technical_email = None
        self._max_prototype_allowed = None
        self._current_prototype_count = None
        self.discriminator = None
        if billable is not None:
            self.billable = billable
        if technical_email is not None:
            self.technical_email = technical_email
        if max_prototype_allowed is not None:
            self.max_prototype_allowed = max_prototype_allowed
        if current_prototype_count is not None:
            self.current_prototype_count = current_prototype_count
        Group.__init__(self, *args, **kwargs)

    @property
    def billable(self):
        """Gets the billable of this Starter.  # noqa: E501

        true if the group is billable  # noqa: E501

        :return: The billable of this Starter.  # noqa: E501
        :rtype: bool
        """
    ...
    def billable(self, billable):
        """Sets the billable of this Starter.

        true if the group is billable  # noqa: E501

        :param billable: The billable of this Starter.  # noqa: E501
        :type: bool
        """
    ...
    def technical_email(self):
        """Gets the technical_email of this Starter.  # noqa: E501

        The technical contact email  # noqa: E501

        :return: The technical_email of this Starter.  # noqa: E501
        :rtype: str
        """
        return self._technical_email

    @technical_email.setter
    def technical_email(self, technical_email):
        """Sets the technical_email of this Starter.

        The technical contact email  # noqa: E501

        :param technical_email: The technical_email of this Starter.  # noqa: E501
        :type: str
        """
    ...
    @property
    def max_prototype_allowed(self):
        """Gets the max_prototype_allowed of this Starter.  # noqa: E501

        Number of prototypes allowed. Accessible only for groups under SO  # noqa: E501

        :return: The max_prototype_allowed of this Starter.  # noqa: E501
        :rtype: int
        """
        return self._max_prototype_allowed

    @max_prototype_allowed.setter
    def max_prototype_allowed(self, max_prototype_allowed):
        """Sets the max_prototype_allowed of this Starter.

        Number of prototypes allowed. Accessible only for groups under SO  # noqa: E501

        :param max_prototype_allowed: The max_prototype_allowed of this Starter.  # noqa: E501
        :type: int
        """

        self._max_prototype_allowed = max_prototype_allowed

    @property
    def current_prototype_count(self):
        """Gets the current_prototype_count of this Starter.  # noqa: E501

        Number of prototype registered. Accessible only for groups under SO  # noqa: E501

        :return: The current_prototype_count of this Starter.  # noqa: E501
        :rtype: int
        """
        return self._current_prototype_count

    @current_prototype_count.setter
    def current_prototype_count(self, current_prototype_count):
        """Sets the current_prototype_count of this Starter.

        Number of prototype registered. Accessible only for groups under SO  # noqa: E501

        :param current_prototype_count: The current_prototype_count of this Starter.  # noqa: E501
        :type: int
        """

        self._current_prototype_count = current_prototype_count
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, Starter):
            return False
