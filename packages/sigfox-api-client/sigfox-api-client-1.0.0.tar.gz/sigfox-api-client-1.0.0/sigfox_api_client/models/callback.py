...
class Callback(object):
    ...
    discriminator_value_class_map = {
          'batchUrlCallback': 'BatchUrlCallback',
'urlCallback': 'UrlCallback',
'emailCallback': 'EmailCallback'    }

    def __init__(self, id=None, channel=None, callback_type=None, callback_subtype=None, payload_config=None, enabled=None, send_duplicate=None, dead=None):  # noqa: E501
        """Callback - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._channel = None
    ...
    @property
    def id(self):
        """Gets the id of this Callback.  # noqa: E501

        The callback's identifier  # noqa: E501

        :return: The id of this Callback.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    def id(self, id):
        ...
        :param id: The id of this Callback.  # noqa: E501
        :type: str
        """
    ...
    @property
    def channel(self):
        """Gets the channel of this Callback.  # noqa: E501

        The callback's channel. - URL - BATCH_URL - EMAIL   # noqa: E501

        :return: The channel of this Callback.  # noqa: E501
        :rtype: str
        """
    ...
    def channel(self, channel):
        """Sets the channel of this Callback.

        The callback's channel. - URL - BATCH_URL - EMAIL   # noqa: E501

        :param channel: The channel of this Callback.  # noqa: E501
        :type: str
        """
    ...
    def callback_type(self):
        """Gets the callback_type of this Callback.  # noqa: E501

        The callback's type.  # noqa: E501

        :return: The callback_type of this Callback.  # noqa: E501
        :rtype: int
        """
    ...
    def callback_type(self, callback_type):
        """Sets the callback_type of this Callback.

        The callback's type.  # noqa: E501

        :param callback_type: The callback_type of this Callback.  # noqa: E501
        :type: int
        """
    ...
    def callback_subtype(self):
        """Gets the callback_subtype of this Callback.  # noqa: E501
        ...
        :return: The callback_subtype of this Callback.  # noqa: E501
        :rtype: int
        """
    ...
    def callback_subtype(self, callback_subtype):
        """Sets the callback_subtype of this Callback.

        The callback's subtype. The subtype must be valid against its type. - 0 -> STATUS callback sending information about the status of a device (available for SERVICE callbacks) - 1 -> GEOLOC callback sent on a message that can be geolocated (available for SERVICE callbacks) ! Warning - From June 2019, the custom callback SERVICE/GEOLOC will be deprecated  ! - 2 -> UPLINK callback for an uplink message (available for DATA callbacks) - 3 -> BIDIR callback for a bidirectional message (available for DATA callbacks) - 4 -> ACKNOWLEDGE callback sent on a downlink acknowledged message (available for SERVICE callbacks) - 5 -> REPEATER callback triggered when a repeater sends an OOB (available for SERVICE callbacks) - 6 -> DATA_ADVANCED callback sent on a message that can be geolocated (available for SERVICE callbacks)   # noqa: E501

        :param callback_subtype: The callback_subtype of this Callback.  # noqa: E501
        :type: int
        """
    ...
    def payload_config(self, payload_config):
        """Sets the payload_config of this Callback.

        The custom payload configuration. Only for DATA callbacks. This field can be unset when updating.  # noqa: E501

        :param payload_config: The payload_config of this Callback.  # noqa: E501
        :type: str
        """
    ...
    @property
    def enabled(self):
        """Gets the enabled of this Callback.  # noqa: E501

        True to enable the callback, otherwise false  # noqa: E501

        :return: The enabled of this Callback.  # noqa: E501
        :rtype: bool
        """
    ...
    def enabled(self, enabled):
        """Sets the enabled of this Callback.

        True to enable the callback, otherwise false  # noqa: E501

        :param enabled: The enabled of this Callback.  # noqa: E501
        :type: bool
        """
    ...
    def send_duplicate(self):
        """Gets the send_duplicate of this Callback.  # noqa: E501

        True to duplicates callback, otherwise false  # noqa: E501

        :return: The send_duplicate of this Callback.  # noqa: E501
        :rtype: bool
        """
    ...
    def send_duplicate(self, send_duplicate):
        """Sets the send_duplicate of this Callback.

        True to duplicates callback, otherwise false  # noqa: E501

        :param send_duplicate: The send_duplicate of this Callback.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def dead(self):
        """Gets the dead of this Callback.  # noqa: E501

        True if last use of the callback fails, otherwise false  # noqa: E501

        :return: The dead of this Callback.  # noqa: E501
        :rtype: bool
        """
        return self._dead
    ...
    @dead.setter
    def dead(self, dead):
        """Sets the dead of this Callback.

        True if last use of the callback fails, otherwise false  # noqa: E501

        :param dead: The dead of this Callback.  # noqa: E501
        :type: bool
        """
