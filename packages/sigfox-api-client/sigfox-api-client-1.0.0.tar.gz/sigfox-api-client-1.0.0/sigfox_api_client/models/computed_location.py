...
class ComputedLocation(object):
    ...
    def __init__(self, lat=None, lng=None, radius=None, source=None, place_ids=None):  # noqa: E501
        """ComputedLocation - a model defined in Swagger"""  # noqa: E501
        self._lat = None
        self._lng = None
        self._radius = None
        self._source = None
    ...
    @property
    def lat(self):
        """Gets the lat of this ComputedLocation.  # noqa: E501

        The device's estimated latitude  # noqa: E501

        :return: The lat of this ComputedLocation.  # noqa: E501
        :rtype: float
        """
        return self._lat
    ...
    @lat.setter
    def lat(self, lat):
        """Sets the lat of this ComputedLocation.

        The device's estimated latitude  # noqa: E501

        :param lat: The lat of this ComputedLocation.  # noqa: E501
        :type: float
        """
    ...
    @property
    def lng(self):
        """Gets the lng of this ComputedLocation.  # noqa: E501

        The device's estimated longitude  # noqa: E501

        :return: The lng of this ComputedLocation.  # noqa: E501
        :rtype: float
        """
        return self._lng
    ...
    @lng.setter
    def lng(self, lng):
        """Sets the lng of this ComputedLocation.

        The device's estimated longitude  # noqa: E501

        :param lng: The lng of this ComputedLocation.  # noqa: E501
        :type: float
        """
    ...
    @property
    def radius(self):
        """Gets the radius of this ComputedLocation.  # noqa: E501

        The radius of the circle (meters)  # noqa: E501

        :return: The radius of this ComputedLocation.  # noqa: E501
        :rtype: int
        """
        return self._radius
    ...
    def radius(self, radius):
        """Sets the radius of this ComputedLocation.

        The radius of the circle (meters)  # noqa: E501

        :param radius: The radius of this ComputedLocation.  # noqa: E501
        :type: int
        """
    ...
    @property
    def source(self):
        """Gets the source of this ComputedLocation.  # noqa: E501

        Define how the location has been computed: - 0 -> computed using RSSI and position of the station (legacy) - 1 -> computed using the GPS data inside the payload - 2 -> computed using Network location - 3 -> computed using PoI location - 4 -> computed using HD network location - 5 -> computed using private database location - 6 -> computed using WiFi location   # noqa: E501

        :return: The source of this ComputedLocation.  # noqa: E501
        :rtype: int
        """
        return self._source
    ...
    def source(self, source):
        """Sets the source of this ComputedLocation.

        Define how the location has been computed: - 0 -> computed using RSSI and position of the station (legacy) - 1 -> computed using the GPS data inside the payload - 2 -> computed using Network location - 3 -> computed using PoI location - 4 -> computed using HD network location - 5 -> computed using private database location - 6 -> computed using WiFi location   # noqa: E501

        :param source: The source of this ComputedLocation.  # noqa: E501
        :type: int
        """
    ...
    @property
    def place_ids(self):
        """Gets the place_ids of this ComputedLocation.  # noqa: E501

        The place ids computed by the Sigfox Geolocation service  # noqa: E501

        :return: The place_ids of this ComputedLocation.  # noqa: E501
        :rtype: list[str]
        """
    ...
    def place_ids(self, place_ids):
        """Sets the place_ids of this ComputedLocation.

        The place ids computed by the Sigfox Geolocation service  # noqa: E501

        :param place_ids: The place_ids of this ComputedLocation.  # noqa: E501
        :type: list[str]
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ComputedLocation, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ComputedLocation):
            return False
