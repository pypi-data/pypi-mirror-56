...
class KmzStatusResponse(object):
    ...
    def __init__(self, job_done=None, time=None):  # noqa: E501
        """KmzStatusResponse - a model defined in Swagger"""  # noqa: E501
        self._job_done = None
        self._time = None
    ...
    @property
    def job_done(self):
        """Gets the job_done of this KmzStatusResponse.  # noqa: E501

        If the job is completed or not  # noqa: E501

        :return: The job_done of this KmzStatusResponse.  # noqa: E501
        :rtype: bool
        """
    ...
    def job_done(self, job_done):
        """Sets the job_done of this KmzStatusResponse.

        If the job is completed or not  # noqa: E501

        :param job_done: The job_done of this KmzStatusResponse.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def time(self):
        """Gets the time of this KmzStatusResponse.  # noqa: E501

        the kmz layer creation time (in milliseconds since the Unix Epoch)  # noqa: E501

        :return: The time of this KmzStatusResponse.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this KmzStatusResponse.

        the kmz layer creation time (in milliseconds since the Unix Epoch)  # noqa: E501

        :param time: The time of this KmzStatusResponse.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KmzStatusResponse, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KmzStatusResponse):
            return False
