...
class NIPUpdate(object):
    ...
    def __init__(self, country_iso_alpha3=None, *args, **kwargs):  # noqa: E501
        """NIPUpdate - a model defined in Swagger"""  # noqa: E501
    ...
    def country_iso_alpha3(self):
        """Gets the country_iso_alpha3 of this NIPUpdate.  # noqa: E501

        This is the country ISO code (3 letters from the ISO 3166-1 alpha-3 country code) where the operator manages its network. Only available for SO and NIP.  # noqa: E501

        :return: The country_iso_alpha3 of this NIPUpdate.  # noqa: E501
        :rtype: str
        """
    ...
    def country_iso_alpha3(self, country_iso_alpha3):
        """Sets the country_iso_alpha3 of this NIPUpdate.

        This is the country ISO code (3 letters from the ISO 3166-1 alpha-3 country code) where the operator manages its network. Only available for SO and NIP.  # noqa: E501

        :param country_iso_alpha3: The country_iso_alpha3 of this NIPUpdate.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, NIPUpdate):
            return False
