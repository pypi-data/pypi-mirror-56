...
class CommonGroupCreate(object):
...
'NIPCreate': 'NIPCreate',
'SOCreate': 'SOCreate',
'SVNOCreate': 'SVNOCreate',
'StarterCreate': 'StarterCreate'    }

    def __init__(self, name=None, description=None, type=None, timezone=None, parent_id=None):  # noqa: E501
        """CommonGroupCreate - a model defined in Swagger"""  # noqa: E501
        self._name = None
    ...
    @property
    def name(self):
        """Gets the name of this CommonGroupCreate.  # noqa: E501

        The group's name  # noqa: E501

        :return: The name of this CommonGroupCreate.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this CommonGroupCreate.

        The group's name  # noqa: E501

        :param name: The name of this CommonGroupCreate.  # noqa: E501
        :type: str
        """
        if name is None:
    ...
    def description(self):
        """Gets the description of this CommonGroupCreate.  # noqa: E501

        The group's description  # noqa: E501

        :return: The description of this CommonGroupCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def description(self, description):
        """Sets the description of this CommonGroupCreate.

        The group's description  # noqa: E501

        :param description: The description of this CommonGroupCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def type(self):
        """Gets the type of this CommonGroupCreate.  # noqa: E501

        Group's type: - 0 -> SO - 2 -> Other - 5 -> SVNO - 6 -> Partners - 7 -> NIP - 8 -> DIST - 9 -> Channel - 10 -> Starter - 11 -> Partner   # noqa: E501

        :return: The type of this CommonGroupCreate.  # noqa: E501
        :rtype: int
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this CommonGroupCreate.

        Group's type: - 0 -> SO - 2 -> Other - 5 -> SVNO - 6 -> Partners - 7 -> NIP - 8 -> DIST - 9 -> Channel - 10 -> Starter - 11 -> Partner   # noqa: E501

        :param type: The type of this CommonGroupCreate.  # noqa: E501
        :type: int
        """
        if type is None:
    ...
    @property
    def timezone(self):
        """Gets the timezone of this CommonGroupCreate.  # noqa: E501

        The group's timezone (in Java TimeZone ID format, e.g.\"America/Costa_Rica\").  # noqa: E501

        :return: The timezone of this CommonGroupCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def timezone(self, timezone):
        """Sets the timezone of this CommonGroupCreate.

        The group's timezone (in Java TimeZone ID format, e.g.\"America/Costa_Rica\").  # noqa: E501

        :param timezone: The timezone of this CommonGroupCreate.  # noqa: E501
        :type: str
        """
        if timezone is None:
    ...
    @property
    def parent_id(self):
        """Gets the parent_id of this CommonGroupCreate.  # noqa: E501

        The parent group id  # noqa: E501

        :return: The parent_id of this CommonGroupCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_id(self, parent_id):
        """Sets the parent_id of this CommonGroupCreate.

        The parent group id  # noqa: E501

        :param parent_id: The parent_id of this CommonGroupCreate.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(CommonGroupCreate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CommonGroupCreate):
            return False
