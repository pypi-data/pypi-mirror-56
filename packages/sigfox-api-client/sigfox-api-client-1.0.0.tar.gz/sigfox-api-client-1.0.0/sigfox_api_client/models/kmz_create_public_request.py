...
class KmzCreatePublicRequest(object):
    ...
    def __init__(self, coverage_mode=None):  # noqa: E501
        """KmzCreatePublicRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def coverage_mode(self):
        """Gets the coverage_mode of this KmzCreatePublicRequest.  # noqa: E501

        The coverage mode for coverage display.  Outdoor is for 0dB margin and Indoor for 20 dB margin U1, U2 and U3 are for product class (1U, 2U and 3U), 0U is considered by default.   # noqa: E501

        :return: The coverage_mode of this KmzCreatePublicRequest.  # noqa: E501
        :rtype: str
        """
        return self._coverage_mode

    @coverage_mode.setter
    def coverage_mode(self, coverage_mode):
        """Sets the coverage_mode of this KmzCreatePublicRequest.

        The coverage mode for coverage display.  Outdoor is for 0dB margin and Indoor for 20 dB margin U1, U2 and U3 are for product class (1U, 2U and 3U), 0U is considered by default.   # noqa: E501

        :param coverage_mode: The coverage_mode of this KmzCreatePublicRequest.  # noqa: E501
        :type: str
        """
        allowed_values = ["OVERLAP_INDOOR", "OVERLAP_OUTDOOR", "OVERLAP_INDOOR_U1", "OVERLAP_OUTDOOR_U1", "OVERLAP_INDOOR_U2", "OVERLAP_OUTDOOR_U2", "OVERLAP_INDOOR_U3", "OVERLAP_OUTDOOR_U3"]  # noqa: E501
        if coverage_mode not in allowed_values:
            raise ValueError(
                "Invalid value for `coverage_mode` ({0}), must be one of {1}"  # noqa: E501
                .format(coverage_mode, allowed_values)
            )
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(KmzCreatePublicRequest, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, KmzCreatePublicRequest):
            return False
