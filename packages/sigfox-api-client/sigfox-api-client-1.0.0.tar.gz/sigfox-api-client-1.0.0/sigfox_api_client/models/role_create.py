...
class RoleCreate(object):
    ...
    if hasattr(CommonRole, "swagger_types"):
        swagger_types.update(CommonRole.swagger_types)

    attribute_map = {
        'parent_role_id': 'parentRoleId',
        'perms': 'perms'
    }
    if hasattr(CommonRole, "attribute_map"):
        attribute_map.update(CommonRole.attribute_map)

    def __init__(self, parent_role_id=None, perms=None, *args, **kwargs):  # noqa: E501
        ...
        if perms is not None:
            self.perms = perms
        CommonRole.__init__(self, *args, **kwargs)

    @property
    def parent_role_id(self):
        """Gets the parent_role_id of this RoleCreate.  # noqa: E501

        The role's parent's identifier  # noqa: E501

        :return: The parent_role_id of this RoleCreate.  # noqa: E501
        :rtype: str
        """
    ...
    def parent_role_id(self, parent_role_id):
        """Sets the parent_role_id of this RoleCreate.

        The role's parent's identifier  # noqa: E501

        :param parent_role_id: The parent_role_id of this RoleCreate.  # noqa: E501
        :type: str
        """
    ...
    @property
    def perms(self):
        """Gets the perms of this RoleCreate.  # noqa: E501

        the permisions included in this role, if the role is not META or META_EMPTY type,  # noqa: E501

        :return: The perms of this RoleCreate.  # noqa: E501
        :rtype: list[int]
        """
        return self._perms
    ...
    def perms(self, perms):
        """Sets the perms of this RoleCreate.

        the permisions included in this role, if the role is not META or META_EMPTY type,  # noqa: E501

        :param perms: The perms of this RoleCreate.  # noqa: E501
        :type: list[int]
        """
