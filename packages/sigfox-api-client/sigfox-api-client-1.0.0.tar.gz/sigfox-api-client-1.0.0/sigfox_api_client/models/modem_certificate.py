...
class ModemCertificate(object):
    ...
    """
    swagger_types = {
        'radio_configurations': 'list[ModemCertificateRadioConfiguration]',
        'repeater_function': 'bool'
    }
    if hasattr(RadioCertificate, "swagger_types"):
        swagger_types.update(RadioCertificate.swagger_types)

    attribute_map = {
        'radio_configurations': 'radioConfigurations',
        'repeater_function': 'repeaterFunction'
    }
    if hasattr(RadioCertificate, "attribute_map"):
        attribute_map.update(RadioCertificate.attribute_map)

    def __init__(self, radio_configurations=None, repeater_function=None, *args, **kwargs):  # noqa: E501
        """ModemCertificate - a model defined in Swagger"""  # noqa: E501
        self._radio_configurations = None
        self._repeater_function = None
        self.discriminator = None
        if radio_configurations is not None:
            self.radio_configurations = radio_configurations
        if repeater_function is not None:
            self.repeater_function = repeater_function
        RadioCertificate.__init__(self, *args, **kwargs)

    @property
    def radio_configurations(self):
        """Gets the radio_configurations of this ModemCertificate.  # noqa: E501

        Radio configurations available for this certificate   # noqa: E501

        :return: The radio_configurations of this ModemCertificate.  # noqa: E501
        :rtype: list[ModemCertificateRadioConfiguration]
        """
        return self._radio_configurations

    @radio_configurations.setter
    def radio_configurations(self, radio_configurations):
        """Sets the radio_configurations of this ModemCertificate.

        Radio configurations available for this certificate   # noqa: E501

        :param radio_configurations: The radio_configurations of this ModemCertificate.  # noqa: E501
        :type: list[ModemCertificateRadioConfiguration]
        """

        self._radio_configurations = radio_configurations

    @property
    def repeater_function(self):
        """Gets the repeater_function of this ModemCertificate.  # noqa: E501

        The modem certificate has repeater function or not  # noqa: E501

        :return: The repeater_function of this ModemCertificate.  # noqa: E501
        :rtype: bool
        """
        return self._repeater_function

    @repeater_function.setter
    def repeater_function(self, repeater_function):
        """Sets the repeater_function of this ModemCertificate.

        The modem certificate has repeater function or not  # noqa: E501

        :param repeater_function: The repeater_function of this ModemCertificate.  # noqa: E501
        :type: bool
        """

        self._repeater_function = repeater_function
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ModemCertificate, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ModemCertificate):
            return False
