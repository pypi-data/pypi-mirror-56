...
class MinRole(object):
    ...
    def __init__(self, id=None, name=None, path=None):  # noqa: E501
        """MinRole - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        self._path = None
    ...
    @property
    def id(self):
        """Gets the id of this MinRole.  # noqa: E501

        The role's identifier  # noqa: E501

        :return: The id of this MinRole.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this MinRole.

        The role's identifier  # noqa: E501

        :param id: The id of this MinRole.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this MinRole.  # noqa: E501

        The role's name  # noqa: E501

        :return: The name of this MinRole.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MinRole.

        The role's name  # noqa: E501

        :param name: The name of this MinRole.  # noqa: E501
        :type: str
        """
    ...
    @property
    def path(self):
        """Gets the path of this MinRole.  # noqa: E501

        The roles's path sorted by descending ancestor (direct parent to farest parent)  # noqa: E501

        :return: The path of this MinRole.  # noqa: E501
        :rtype: list[MinMetaRole]
        """
        return self._path

    @path.setter
    def path(self, path):
        """Sets the path of this MinRole.

        The roles's path sorted by descending ancestor (direct parent to farest parent)  # noqa: E501

        :param path: The path of this MinRole.  # noqa: E501
        :type: list[MinMetaRole]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MinRole):
            return False
