...
class DeviceConsumption(object):
    ...
    swagger_types = {
        'id': 'int',
        'device_consumptions': 'list[object]'
    }

    attribute_map = {
        'id': 'id',
        'device_consumptions': 'deviceConsumptions'
    }

    def __init__(self, id=None, device_consumptions=None):  # noqa: E501
        """DeviceConsumption - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._device_consumptions = None
        self.discriminator = None
        if id is not None:
            self.id = id
        if device_consumptions is not None:
            self.device_consumptions = device_consumptions

    @property
    def id(self):
        """Gets the id of this DeviceConsumption.  # noqa: E501

        Identifier of the device consumption  # noqa: E501

        :return: The id of this DeviceConsumption.  # noqa: E501
        :rtype: int
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DeviceConsumption.

        Identifier of the device consumption  # noqa: E501

        :param id: The id of this DeviceConsumption.  # noqa: E501
        :type: int
        """
    ...
    @property
    def device_consumptions(self):
        """Gets the device_consumptions of this DeviceConsumption.  # noqa: E501

        Consumption of a device  # noqa: E501

        :return: The device_consumptions of this DeviceConsumption.  # noqa: E501
        :rtype: list[object]
        """
        return self._device_consumptions

    @device_consumptions.setter
    def device_consumptions(self, device_consumptions):
        """Sets the device_consumptions of this DeviceConsumption.

        Consumption of a device  # noqa: E501

        :param device_consumptions: The device_consumptions of this DeviceConsumption.  # noqa: E501
        :type: list[object]
        """

        self._device_consumptions = device_consumptions
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceConsumption, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceConsumption):
            return False
