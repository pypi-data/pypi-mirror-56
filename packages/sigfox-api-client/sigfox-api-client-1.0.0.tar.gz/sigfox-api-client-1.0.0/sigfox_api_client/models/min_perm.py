...
class MinPerm(object):
    ...
    def __init__(self, code=None, name=None):  # noqa: E501
        """MinPerm - a model defined in Swagger"""  # noqa: E501
        self._code = None
        self._name = None
    ...
    @property
    def code(self):
        """Gets the code of this MinPerm.  # noqa: E501

        The permission's code  # noqa: E501

        :return: The code of this MinPerm.  # noqa: E501
        :rtype: int
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this MinPerm.

        The permission's code  # noqa: E501

        :param code: The code of this MinPerm.  # noqa: E501
        :type: int
        """
    ...
    @property
    def name(self):
        """Gets the name of this MinPerm.  # noqa: E501

        The permission's name  # noqa: E501

        :return: The name of this MinPerm.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this MinPerm.

        The permission's name  # noqa: E501

        :param name: The name of this MinPerm.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, MinPerm):
            return False
