...
class TokenUnsubscribe(object):
    ...
    def __init__(self, unsubscription_time=None):  # noqa: E501
        """TokenUnsubscribe - a model defined in Swagger"""  # noqa: E501
    ...
    def unsubscription_time(self):
        """Gets the unsubscription_time of this TokenUnsubscribe.  # noqa: E501

        Timestamp of token unsubscription date (in milliseconds since the Unix Epoch)  # noqa: E501

        :return: The unsubscription_time of this TokenUnsubscribe.  # noqa: E501
        :rtype: int
        """
    ...
    def unsubscription_time(self, unsubscription_time):
        """Sets the unsubscription_time of this TokenUnsubscribe.

        Timestamp of token unsubscription date (in milliseconds since the Unix Epoch)  # noqa: E501

        :param unsubscription_time: The unsubscription_time of this TokenUnsubscribe.  # noqa: E501
        :type: int
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(TokenUnsubscribe, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, TokenUnsubscribe):
            return False
