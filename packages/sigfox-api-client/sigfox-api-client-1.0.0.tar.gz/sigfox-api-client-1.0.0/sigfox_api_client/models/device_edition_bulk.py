...
class DeviceEditionBulk(object):
    ...
    if hasattr(SingleDeviceFields, "swagger_types"):
        swagger_types.update(SingleDeviceFields.swagger_types)

    attribute_map = {
        'id': 'id',
        'name': 'name'
    }
    if hasattr(SingleDeviceFields, "attribute_map"):
        attribute_map.update(SingleDeviceFields.attribute_map)

    def __init__(self, id=None, name=None, *args, **kwargs):  # noqa: E501
        """DeviceEditionBulk - a model defined in Swagger"""  # noqa: E501
        self._id = None
        self._name = None
        ...
        if name is not None:
            self.name = name
        SingleDeviceFields.__init__(self, *args, **kwargs)

    @property
    def id(self):
        """Gets the id of this DeviceEditionBulk.  # noqa: E501

        The device's identifier (hexadecimal format)  # noqa: E501

        :return: The id of this DeviceEditionBulk.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this DeviceEditionBulk.

        The device's identifier (hexadecimal format)  # noqa: E501

        :param id: The id of this DeviceEditionBulk.  # noqa: E501
        :type: str
        """
        if id is None:
    ...
    @property
    def name(self):
        """Gets the name of this DeviceEditionBulk.  # noqa: E501

        The name of the device  # noqa: E501

        :return: The name of this DeviceEditionBulk.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this DeviceEditionBulk.

        The name of the device  # noqa: E501

        :param name: The name of this DeviceEditionBulk.  # noqa: E501
        :type: str
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(DeviceEditionBulk, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DeviceEditionBulk):
            return False
