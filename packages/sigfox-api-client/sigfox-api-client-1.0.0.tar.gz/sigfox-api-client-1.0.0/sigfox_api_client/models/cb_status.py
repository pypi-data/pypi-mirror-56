...
class CbStatus(object):
    ...
    def __init__(self, status=None, info=None, cb_def=None, time=None):  # noqa: E501
        """CbStatus - a model defined in Swagger"""  # noqa: E501
        self._status = None
        self._info = None
        self._cb_def = None
        self._time = None
    ...
    @property
    def status(self):
        """Gets the status of this CbStatus.  # noqa: E501

        http response status  # noqa: E501

        :return: The status of this CbStatus.  # noqa: E501
        :rtype: int
        """
        return self._status
    ...
    def status(self, status):
        """Sets the status of this CbStatus.

        http response status  # noqa: E501

        :param status: The status of this CbStatus.  # noqa: E501
        :type: int
        """
    ...
    @property
    def info(self):
        """Gets the info of this CbStatus.  # noqa: E501

        http response message  # noqa: E501

        :return: The info of this CbStatus.  # noqa: E501
        :rtype: str
        """
        return self._info
    ...
    @info.setter
    def info(self, info):
        """Sets the info of this CbStatus.

        http response message  # noqa: E501

        :param info: The info of this CbStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def cb_def(self):
        """Gets the cb_def of this CbStatus.  # noqa: E501

        callback definition triggered  # noqa: E501

        :return: The cb_def of this CbStatus.  # noqa: E501
        :rtype: str
        """
        return self._cb_def

    @cb_def.setter
    def cb_def(self, cb_def):
        """Sets the cb_def of this CbStatus.

        callback definition triggered  # noqa: E501

        :param cb_def: The cb_def of this CbStatus.  # noqa: E501
        :type: str
        """
    ...
    @property
    def time(self):
        """Gets the time of this CbStatus.  # noqa: E501

        time the callback was called (in milliseconds since the Unix Epoch)  # noqa: E501

        :return: The time of this CbStatus.  # noqa: E501
        :rtype: int
        """
        return self._time
    ...
    @time.setter
    def time(self, time):
        """Sets the time of this CbStatus.

        time the callback was called (in milliseconds since the Unix Epoch)  # noqa: E501

        :param time: The time of this CbStatus.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CbStatus):
            return False
