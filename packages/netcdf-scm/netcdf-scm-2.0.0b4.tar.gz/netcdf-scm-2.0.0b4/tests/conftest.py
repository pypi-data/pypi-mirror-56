...
TEST_CMIP6OUTPUT_HFDS_WITH_NLON_NLAT_COORDS_FILE = join(
    TEST_DATA_CMIP6OUTPUT_DIR,
    "CMIP6",
    "GeoMIP",
    "NCAR",
    ...
    "gn",
    "v20191001",
    "hfds_Omon_CESM2-WACCM_G6solar_r1i1p1f1_gn_202107-202109.nc",
)


@pytest.fixture
def test_cmip6_output_hfds_nlon_nlat_coords_file():
    return TEST_CMIP6OUTPUT_HFDS_WITH_NLON_NLAT_COORDS_FILE


TEST_CMIP6OUTPUT_HFDS_WITH_I_J_COORDS_FILE = join(
    TEST_DATA_CMIP6OUTPUT_DIR,
    "CMIP6",
    "ScenarioMIP",
    "CCCma",
    ...
    "gn",
    "v20190429",
    "hfds_Omon_CanESM5_ssp119_r1i1p1f1_gn_201707-201709.nc",
)


@pytest.fixture
def test_cmip6_output_hfds_i_j_coords_file():
    return TEST_CMIP6OUTPUT_HFDS_WITH_I_J_COORDS_FILE


TEST_CMIP6OUTPUT_HFDS_WITH_VERTEX_COORDS_FILE = join(
    TEST_DATA_CMIP6OUTPUT_DIR,
    "CMIP6",
    "DAMIP",
    "CCCma",
    ...
    "gn",
    "v20190429",
    "fgco2_Omon_CanESM5_hist-stratO3_r1i1p1f1_gn_185207-185209.nc",
)


@pytest.fixture
def test_cmip6_output_hfds_vertex_coords_file():
    return TEST_CMIP6OUTPUT_HFDS_WITH_VERTEX_COORDS_FILE


TEST_CMIP6OUTPUT_SFTLF_GN_FILE = join(
    TEST_DATA_CMIP6OUTPUT_DIR,
    "CMIP6",
    "CMIP",
    "NASA-GISS",
    ...
    "gn",
    "v20181002",
    "tas_Amon_GISS-E2-1-G_abrupt-4xCO2_r1i1p1f1_gn_185001-185412.nc",
)


@pytest.fixture
def test_cmip6_output_sftlf_gn_file():
    return TEST_CMIP6OUTPUT_SFTLF_GN_FILE
...
def test_cmip6_crunch_output(test_data_root_dir):
    return join(test_data_root_dir, "expected-crunching-output", "cmip6output")


@pytest.fixture
def test_cmip6_wrangle_output(test_data_root_dir):
    return join(test_data_root_dir, "expected-wrangling-output", "cmip6output")


@pytest.fixture
def test_cmip6_stitch_output(test_data_root_dir):
    return join(test_data_root_dir, "expected-stitch-output", "cmip6output")
    ...
    def _do_assertion(res_scmdf, exp_scmdf):
        ...
        for base, check in [(exp_scmdf, res_scmdf), (res_scmdf, exp_scmdf)]:
            for k, v in base.metadata.items():
                variable_keys = ("date", "crunch_netcdf_scm_version", "header")
                if any([vk in k for vk in variable_keys]):
