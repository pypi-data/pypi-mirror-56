...
class Bot:
    ...
    def send_attachment_file(self, sender_psid, file):
        ...
        logger.info('%s: %s' % ('send_attachment_file', self.post.send(Constant.send_api, response_text)))
    ...
    def send_button_template(self, logger, sender_psid, button_template):
        ...
        logger.info('%s: %s' % ('send_button_template', self.post.send(Constant.send_api, response_text)))
    ...
    def send_generic_template(self, logger, sender_psid, generic_template):
        ...
        logger.info('%s: %s' % ('send_generic_template', self.post.send(Constant.send_api, response_text)))
    ...
    def send_message(self, logger, sender_psid, text):
        ...
        logger.info('%s: %s' % ('send_message', resp))
    ...
    def send_quick_reply(self, logger, sender_psid, text, quick_reply):
        ...
        logger.info('%s: %s' % ('send_quick_reply', self.post.send(Constant.send_api, response_text)))
    ...
    def send_receipt(self, logger, sender_psid, receipt):
        ...
        logger.info('%s: %s' % ('send_receipt', self.post.send(Constant.send_api, response_text)))
    ...
    def send_sender_action(self, sender_psid, logger, sender_action):
        ...
        logger.info('%s: %s' % ('send_sender_action', self.post.send(Constant.send_api, response_text)))