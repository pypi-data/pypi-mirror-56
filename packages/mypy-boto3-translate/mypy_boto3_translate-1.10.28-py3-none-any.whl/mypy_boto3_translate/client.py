...
class Client(BaseClient):
    ...
    def import_terminology(
        ...
        If you import a terminology that overwrites an existing one, the new terminology take up to
        10 minutes to fully propagate and be available for use in a translation due to cache
        ...
        **Request Syntax**
        ...
        :param MergeStrategy: **[REQUIRED]**
          ...
          merge strategy is supported. In this case, the imported terminology will overwrite an
          existing terminology of the same name.
    ...
    def translate_text(
        ...
        combinations are supported by Amazon Translate. For more information, see `Supported
        Language Pairs <http://docs.aws.amazon.com/translate/latest/dg/pairs.html>`__ .
        ...
        * Turkish (tr)
        ...
        ``auto`` in the ``SourceLanguageCode`` field. If you specify ``auto`` , Amazon Translate
        ...
        **Request Syntax**
        ...
        :param TerminologyNames:
          ...
          The TerminologyNames list that is taken as input to the TranslateText request. This has a
          ...
          - *(dict) --*
            ...
            - **AppliedTerminologies** *(list) --*
              ...
              - *(dict) --*
                ...
                translated text response. This is optional in the response and will only be present
                if you specified terminology input in the request. Currently, only one terminology
                can be applied per TranslateText request.
                ...
                - **Terms** *(list) --*
                  ...
                  returned, and the specific terms applied will be the first 250 terms in the source
                  text.
