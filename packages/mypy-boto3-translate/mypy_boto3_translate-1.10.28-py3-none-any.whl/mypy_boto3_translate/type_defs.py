...
class ClientImportTerminologyEncryptionKeyTypeDef(_ClientImportTerminologyEncryptionKeyTypeDef):
    """
...
class ClientImportTerminologyTerminologyDataTypeDef(_ClientImportTerminologyTerminologyDataTypeDef):
    """
...
class ClientTranslateTextResponseAppliedTerminologiesTypeDef(
    ...
    - **Terms** *(list) --*
      ...
      The specific terms of the custom terminology applied to the input text by Amazon Translate for
      the translated text response. A maximum of 250 terms will be returned, and the specific terms
