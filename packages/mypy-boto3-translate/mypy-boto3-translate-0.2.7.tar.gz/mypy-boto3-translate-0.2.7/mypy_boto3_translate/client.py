"Main interface for translate Client"
...
class Client(BaseClient):
    ...
    def delete_terminology(self, Name: str) -> None:
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/translate-2017-07-01/DeleteTerminology>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_terminology(
        self, Name: str, TerminologyDataFormat: str
    ) -> ClientGetTerminologyResponseTypeDef:
        """
        Retrieves a custom terminology.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/translate-2017-07-01/GetTerminology>`_
    ...
    def import_terminology(
        ...
        Name: str,
        MergeStrategy: str,
        TerminologyData: ClientImportTerminologyTerminologyDataTypeDef,
        Description: str = None,
        EncryptionKey: ClientImportTerminologyEncryptionKeyTypeDef = None,
    ) -> ClientImportTerminologyResponseTypeDef:
        """
        Creates or updates a custom terminology, depending on whether or not one already exists for the
        given terminology name. Importing a terminology with the same name as an existing one will merge the
        terminologies based on the chosen merge strategy. Currently, the only supported merge strategy is
        OVERWRITE, and so the imported terminology will overwrite an existing terminology of the same name.

        If you import a terminology that overwrites an existing one, the new terminology take up to 10
        minutes to fully propagate and be available for use in a translation due to cache policies with the
        DataPlane service that performs the translations.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/translate-2017-07-01/ImportTerminology>`_
        ...
        **Request Syntax**
        ...
        :param MergeStrategy: **[REQUIRED]**
          ...
          strategy is supported. In this case, the imported terminology will overwrite an existing
    ...
    def list_terminologies(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/translate-2017-07-01/ListTerminologies>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the result of the request to ListTerminologies was truncated, include the NextToken to fetch
    ...
    def translate_text(
        ...
        """
        Translates input text from the source language to the target language. It is not necessary to use
        English (en) as either the source or the target language but not all language combinations are
        supported by Amazon Translate. For more information, see `Supported Language Pairs
        <http://docs.aws.amazon.com/translate/latest/dg/pairs.html>`__ .
        ...
        * Turkish (tr)
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/translate-2017-07-01/TranslateText>`_
        ...
        **Request Syntax**
        ...
        :param TerminologyNames:
          ...
          length of 0 and a maximum length of 1.
        ...
        :param SourceLanguageCode: **[REQUIRED]**
          ...
          The language code for the language of the source text. The language must be a language supported
          by Amazon Translate.

          To have Amazon Translate determine the source language of your text, you can specify ``auto`` in
          the ``SourceLanguageCode`` field. If you specify ``auto`` , Amazon Translate will call Amazon
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_terminologies` operation.
        """
