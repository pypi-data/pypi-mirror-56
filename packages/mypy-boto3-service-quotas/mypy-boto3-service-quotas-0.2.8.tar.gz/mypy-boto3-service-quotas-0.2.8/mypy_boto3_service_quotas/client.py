...
class Client(BaseClient):
    ...
    def associate_service_quota_template(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        """
        Associates the Service Quotas template with your organization so that when new accounts are
        created in your organization, the template submits increase requests for the specified
    ...
    def get_association_for_service_quota_template(
        ...
        """
        Retrieves the ``ServiceQuotaTemplateAssociationStatus`` value from the service. Use this
        action to determine if the Service Quota template is associated, or enabled.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ServiceQuotaTemplateAssociationStatus** *(string) --*
              ...
              template is ``ASSOCIATED`` , then it requests service quota increases for all new
              accounts created in your organization.
    ...
    def get_aws_default_service_quota(
        ...
        """
        Retrieves the default service quotas values. The Value returned for each quota is the AWS
...

            {
                'Quota': {
                    ...
                    'ErrorReason': {
                        ...
                        |'DEPENDENCY_THROTTLING_ERROR'|'DEPENDENCY_SERVICE_ERROR'
          ...
          - *(dict) --*
            ...
            - **RequestedQuota** *(dict) --*
              ...
              - **Created** *(datetime) --*
                ...
                The date and time when the service quota increase request was received and the case
                Id was created.
    ...
    def get_service_quota(
        ...
        Value than the ``GetAWSDefaultServiceQuota`` operation. This operation returns the applied
        value for each quota. ``GetAWSDefaultServiceQuota`` returns the default AWS value for each
        quota.
    ...
    def list_aws_default_service_quotas(
        ...
        ListAWSDefaultServiceQuotas is similar to  ListServiceQuotas except for the Value object.
        The Value object returned by ``ListAWSDefaultServiceQuotas`` is the default value assigned
        by AWS. This request returns a list of all service quotas for the specified service. The
        listing of each you'll see the default values are the values that AWS provides for the
        quotas.

        .. note::

          Always check the ``NextToken`` response parameter when calling any of the ``List*``
          operations. These operations can return an unexpected list of results, even when there are
          more results available. When this happens, the ``NextToken`` response parameter contains a
          value to pass the next call to the same API to request the next part of the list.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          output should continue from. If additional items exist beyond the specified maximum, the
          ``NextToken`` element is present and has a value (isn't null). Include that value as the
          ``NextToken`` request parameter in the call to the operation to get the next part of the
          results. You should check ``NextToken`` after every operation to ensure that you receive
          all of the results.
        ...
        :param MaxResults:
          ...
          request parameter in the call to the operation to get the next part of the results. You
          should check ``NextToken`` after every operation to ensure that you receive all of the
          results.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              (Optional) Use this parameter in a request if you receive a ``NextToken`` response in
              a previous request that indicates that there's more output available. In a subsequent
              call, set it to the value of the previous call's ``NextToken`` response to indicate
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              what's included in the current response. This can occur even when the response
    ...
    def list_requested_service_quota_change_history_by_quota(
        ...
        request has reached ``CASE_CLOSED, APPROVED,`` or ``DENIED`` , the history has been kept for
        90 days.
    ...
    def list_service_quota_increase_requests_in_template(
        ...
        **Request Syntax**
        ...
        :param ServiceCode:
          ...
          The identifier for a service. When performing an operation, use the ``ServiceCode`` to
    ...
    def list_service_quotas(
        ...
        """
        Lists all service quotas for the specified AWS service. This request returns a list of the
    ...
    def list_services(
        ...
        """
        Lists the AWS services available in Service Quotas. Not all AWS services are available in
    ...
    def put_service_quota_increase_request_into_template(
        ...
        """
        Defines and adds a quota to the service quota template. To add a quota to the template, you
        must provide the ``ServiceCode`` , ``QuotaCode`` , ``AwsRegion`` , and ``DesiredValue`` .
        Once you add a quota to the template, use  ListServiceQuotaIncreaseRequestsInTemplate to see
        the list of quotas in the template.
