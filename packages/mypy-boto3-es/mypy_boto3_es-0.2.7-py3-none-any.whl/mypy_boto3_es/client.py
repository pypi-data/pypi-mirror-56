...
class Client(BaseClient):
    ...
    def add_tags(self, ARN: str, TagList: List[ClientAddTagsTagListTypeDef]) -> None:
        ...
        An Elasticsearch domain may have up to 10 tags. See `Tagging Amazon Elasticsearch Service Domains
    ...
    def create_elasticsearch_domain(
        ...
        """
        Creates a new Elasticsearch domain. For more information, see `Creating Elasticsearch Domains
        ...
        **Request Syntax**
        ...
        :param ElasticsearchVersion:
          ...
          information, see `Creating Elasticsearch Domains
          <http://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-createupdatedomains.html#es-createdomains>`__
          in the *Amazon Elasticsearch Service Developer Guide* .
        ...
        :param AdvancedOptions:
          ...
          access to individual sub-resources. By default, the value is ``true`` . See `Configuration
          Advanced Options
        ...
        :param LogPublishingOptions:
          ...
          - *(string) --*
            ...
            * INDEX_SLOW_LOGS: Index slow logs contain insert requests that took more time than configured
            index query log threshold to execute.

            * SEARCH_SLOW_LOGS: Search slow logs contain search queries that took more time than configured
            search query log threshold to execute.
    ...
    def delete_elasticsearch_service_role(self, *args: Any, **kwargs: Any) -> None:
        ...
        Elasticsearch domains before deleting the role. See `Deleting Elasticsearch Service Role
    ...
    def describe_reserved_elasticsearch_instances(
        ...
        **Request Syntax**
        ...
        :param ReservedElasticsearchInstanceId:
          ...
          The reserved instance identifier filter value. Use this parameter to show only the reservation
    ...
    def list_elasticsearch_instance_types(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          Set this value to limit the number of results returned. Value provided must be greater than 30
          else it wont be honored.
    ...
    def list_elasticsearch_versions(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          Set this value to limit the number of results returned. Value provided must be greater than 10
          else it wont be honored.
    ...
    def remove_tags(self, ARN: str, TagKeys: List[str]) -> None:
        ...
        **Request Syntax**
        ...
        :param ARN: **[REQUIRED]**
          ...
          Specifies the ``ARN`` for the Elasticsearch domain from which you want to delete the specified
          tags.
    ...
    def update_elasticsearch_domain_config(
        ...
        **Request Syntax**
        ...
        :param AdvancedOptions:
          ...
          ``false`` when configuring access to individual sub-resources. By default, the value is ``true`` .
          See `Configuration Advanced Options
          <http://docs.aws.amazon.com/elasticsearch-service/latest/developerguide/es-createupdatedomains.html#es-createdomain-configure-advanced-options>`__
          for more information.
    ...
    def get_paginator(
        self,
        operation_name: Literal["describe_reserved_elasticsearch_instance_offerings"],
