...
class BaseConsumer(object):
    ...
    def __init__(self, identify, callback, logger=None, **kwargs):
        ...
        self._eventLoop = kwargs.get("eventLoop", False)
...
class Consumer(object):
    ...
    def _maybe_reconnect(self):
        if self._consumer.should_reconnect:
            ...
            self._consumer = BaseConsumer(*self._args, self.logger, **self._kwargs)
