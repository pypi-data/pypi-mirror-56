...
class Client(BaseClient):
    ...
    def associate_approval_rule_template_with_repository(
        ...
        template conditions is automatically created for that pull request. If no destination references
        are specified in the template, an approval rule that matches the template contents is created for
    ...
    def batch_describe_merge_conflicts(
        ...
        **Request Syntax**
        ...
        :param conflictDetailLevel:
          ...
          returns a not-mergeable result if the same file has differences in both branches. If LINE_LEVEL
          is specified, a conflict is considered not mergeable if the same file in both branches has
    ...
    def create_approval_rule_template(
        ...
        your AWS account. When you associate a template with a repository, AWS CodeCommit creates an
        approval rule that matches the conditions of the template for all pull requests that meet the
        conditions of the template. For more information, see  AssociateApprovalRuleTemplateWithRepository .
        ...
        **Request Syntax**
        ...
        :param approvalRuleTemplateName: **[REQUIRED]**
          ...
          The name of the approval rule template. Provide descriptive names, because this name is applied
        ...
        :param approvalRuleTemplateContent: **[REQUIRED]**
          ...
          The content of the approval rule that is created on pull requests in associated repositories. If
          ...
          .. note::
            ...
            When you create the content of the approval rule template, you can specify approvers in an
            approval pool in one of two ways:

            * **CodeCommitApprovers** : This option only requires an AWS account and a resource. It can be
            used for both IAM users and federated access users whose name matches the provided resource
            name. This is a very powerful option that offers a great deal of flexibility. For example, if
            you specify the AWS account *123456789012* and *Mary_Major* , all of the following are counted
            ...
            :assumed-role/CodeCommitReview/*Mary_Major* ) unless you include a wildcard (*Mary_Major).
        ...
        :param approvalRuleTemplateDescription:
          ...
          The description of the approval rule template. Consider providing a description that explains
          what this template does and when it might be appropriate to associate it with repositories.
    ...
    def create_commit(
        ...
        **Request Syntax**
        ...
        :param parentCommitId:
          ...
          The ID of the commit that is the parent of the commit you create. Not required if this is an
          empty repository.
        ...
        :param commitMessage:
          ...
          The commit message you want to include in the commit. Commit messages are limited to 256 KB. If
          no message is specified, a default message is used.
        ...
        :param keepEmptyFolders:
          ...
          leave the folders empty. If true, a ..gitkeep file is created for empty folders. The default is
          false.
    ...
    def create_pull_request(
        ...
        **Request Syntax**
        ...
        :param title: **[REQUIRED]**
          ...
          The title of the pull request. This title is used to identify the pull request to other users in
          the repository.
    ...
    def create_pull_request_approval_rule(
        ...
        **Request Syntax**
        ...
        :param approvalRuleContent: **[REQUIRED]**
          ...
          The content of the approval rule, including the number of approvals needed and the structure of
          an approval pool defined for approvals, if any. For more information about approval pools, see
          the AWS CodeCommit User Guide.

          .. note::

            When you create the content of the approval rule, you can specify approvers in an approval pool
            in one of two ways:

            * **CodeCommitApprovers** : This option only requires an AWS account and a resource. It can be
            used for both IAM users and federated access users whose name matches the provided resource
            name. This is a very powerful option that offers a great deal of flexibility. For example, if
            you specify the AWS account *123456789012* and *Mary_Major* , all of the following would be
        ...
        **Request Syntax**
        ...
        :param repositoryName: **[REQUIRED]**
          ...
          .. note::
            ...
            The repository name must be unique across the calling AWS account. Repository names are limited
            to 100 alphanumeric, dash, and underscore characters, and cannot include certain characters.
            For more information about the limits on repository names, see `Limits
    ...
    def create_unreferenced_merge_commit(
        ...
        used with the fast-forward merge strategy because that strategy does not create a merge commit.
        ...
        **Request Syntax**
        ...
        :param keepEmptyFolders:
          ...
          If the commit contains deletions, whether to keep a folder or folder structure if the changes
          leave the folders empty. If this is specified as true, a .gitkeep file is created for empty
    ...
    def delete_file(
        ...
        **Request Syntax**
        ...
        :param parentCommitId: **[REQUIRED]**
          ...
          The ID of the commit that is the tip of the branch where you want to create the commit that
        ...
        :param keepEmptyFolders:
          ...
          If a file is the only object in the folder or directory, specifies whether to delete the folder
          ...
          dir1/dir2/dir3/dir4, and dir2 and dir3 are empty, deleting the last file in dir4 also deletes the
    ...
    def evaluate_pull_request_approval_rules(
        ...
        **Request Syntax**
        ...
        :param revisionId: **[REQUIRED]**
          ...
          The system-generated ID for the pull request revision. To retrieve the most recent revision ID
          for a pull request, use  GetPullRequest .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **evaluation** *(dict) --*
              ...
              (if any), the names of the rules whose conditions have not been met (if any), whether the
              pull request is in the approved state, and whether the pull request approval rule has been
    ...
    def get_differences(
        ...
        **Request Syntax**
        ...
        :param beforeCommitSpecifier:
          ...
          The branch, tag, HEAD, or other fully qualified reference used to identify a commit (for example,
          the full commit ID). Optional. If not specified, all changes before the ``afterCommitSpecifier``
          value are shown. If you do not use ``beforeCommitSpecifier`` in your request, consider limiting
          the results with ``maxResults`` .
    ...
    def get_file(
        ...
        **Request Syntax**
        ...
        :param commitSpecifier:
          ...
          can specify a full commit ID, a tag, a branch name, or a reference such as refs/heads/master. If
    ...
    def get_folder(
        ...
        **Request Syntax**
        ...
        :param commitSpecifier:
          ...
          such as HEAD. If no specifier is provided, the folder content is returned as it exists in the
          HEAD commit.
        ...
        :param folderPath: **[REQUIRED]**
          ...
          For example, /examples is a fully-qualified path to a folder named examples that was created off
    ...
    def get_pull_request_override_state(
        ...
        **Request Syntax**
        ...
        :param pullRequestId: **[REQUIRED]**
          ...
          The ID of the pull request for which you want to get information about whether approval rules
          have been set aside (overridden).
    ...
    def list_approval_rule_templates(
        ...
        """
        Lists all approval rule templates in the specified AWS Region in your AWS account. If an AWS Region
        is not specified, the AWS Region where you are signed in is used.
    ...
    def override_pull_request_approval_rules(
        self, pullRequestId: str, revisionId: str, overrideStatus: str
    ) -> None:
        """
        ...
        **Request Syntax**
        ...
        :param revisionId: **[REQUIRED]**
          ...
          approval rules for anything but the most recent revision of a pull request. To get the revision
          ID, use GetPullRequest.

        :type overrideStatus: string
        :param overrideStatus: **[REQUIRED]**

          Whether you want to set aside approval rule requirements for the pull request (OVERRIDE) or
          revoke a previous override and apply approval rule requirements (REVOKE). REVOKE status is not
          stored.
    ...
    def post_comment_for_compared_commit(
        ...
        **Request Syntax**
        ...
        :param beforeCommitId:
          ...
          To establish the directionality of the comparison, the full commit ID of the before commit.
          Required for commenting on any commit unless that commit is the initial commit.
    ...
    def put_file(
        ...
        **Request Syntax**
        ...
        :param parentCommitId:
          ...
          The commit ID must match the ID of the head commit at the time of the operation. Otherwise, an
        ...
        :param name:
          ...
          The name of the person adding or updating the file. Although it is optional, a name makes the
          commit history for your repository more useful.
    ...
    def test_repository_triggers(
        ...
        real data is available in the repository, the test sends data from the last commit. If no data is
    ...
    def update_approval_rule_template_content(
        ...
        **Request Syntax**
        ...
        :param newRuleContent: **[REQUIRED]**
          ...
          The content that replaces the existing content of the rule. Content statements must be complete.
          You cannot provide only the changes.
        ...
        **Request Syntax**
        ...
        :param newRuleContent: **[REQUIRED]**
          ...
          .. note::
            ...
            When you update the content of the approval rule, you can specify approvers in an approval pool
            in one of two ways:
    ...
    def update_pull_request_approval_state(
        self, pullRequestId: str, revisionId: str, approvalState: str
    ) -> None:
        """
    ...
    def update_pull_request_status(
        ...
        **Request Syntax**
        ...
        :param pullRequestStatus: **[REQUIRED]**
          ...
          to ``OPEN`` , ``OPEN`` to ``CLOSED`` or from ``CLOSED`` to ``CLOSED`` .
    ...
    def update_repository_name(self, oldName: str, newName: str) -> None:
        """
        Renames a repository. The repository name must be unique across the calling AWS account. Repository
        names are limited to 100 alphanumeric, dash, and underscore characters, and cannot include certain
        characters. The suffix .git is prohibited. For more information about the limits on repository
        names, see `Limits <https://docs.aws.amazon.com/codecommit/latest/userguide/limits.html>`__ in the
