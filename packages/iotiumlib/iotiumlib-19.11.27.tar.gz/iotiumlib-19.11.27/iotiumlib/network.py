...
def add(network_name, cidr, start_ip, node_id, gateway_ip=None, end_ip=None, label=None, default_destination=None,
        connect_networks=None, firewall_selector=None, vlan_id=0, network_addressing="STATIC",
        firewall_policy=False, service_addressing="AUTO", static_routes=None):

    if connect_networks is None:
        connect_networks = []
    dd = list()
    if default_destination is not None and default_destination.title() != "None":
