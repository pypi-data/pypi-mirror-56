...
class node(object):
    ...
    def __init__(self, action, filters=None, payload=None, node_id=None):
        ...
        self.uri = {
            ...
            notifications_inode:'api/v1/notification/node/{nodeId}/event'
        }
...
def add(inode_name, serial_number, profile_id, org_id, standalone_expires=0, label=None, data_saving_mode="Fast"):
    """
    Add iNode
...
def edit(node_id, inode_name=None, label=None, standalone_expires=0, data_saving_mode=None):
...
def notifications(node_id, type=None):
    filters={}
