...
Mypy-friendly auto-generated type annotations for `boto3 firehose 1.10.28` service.
...
session_client = session.client("firehose")
...
```python
import boto3
from mypy_boto3.firehose import Client
