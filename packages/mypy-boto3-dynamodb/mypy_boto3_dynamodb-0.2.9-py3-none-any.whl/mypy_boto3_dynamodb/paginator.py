"Main interface for dynamodb Paginators"
...
class ListBackupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListBackups>`_
...
class ListTagsOfResourcePaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListTagsOfResource>`_
