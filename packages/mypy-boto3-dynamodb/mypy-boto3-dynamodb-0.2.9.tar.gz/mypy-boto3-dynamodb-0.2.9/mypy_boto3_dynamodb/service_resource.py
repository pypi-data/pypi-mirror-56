"Main interface for dynamodb ServiceResource"
...
class ServiceResource(Boto3ServiceResource):
    ...
    def batch_get_item(
        ...
        ``BatchGetItem`` returns a partial result if the response size limit is exceeded, the
        ...
        appropriate ``UnprocessedKeys`` value so you can get the next page of results. If desired,
        ...
        .. warning::
          ...
          items. However, *we strongly recommend that you use an exponential backoff algorithm* . If
          you retry the batch operation immediately, the underlying read or write requests can still
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ErrorHandling.html#BatchOperations>`__
        ...
        more information, see `Working with Tables
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#CapacityUnitCalculations>`__
        in the *Amazon DynamoDB Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/BatchGetItem>`_
        ...
        **Request Syntax**
        ...
        :param RequestItems: **[REQUIRED]**
          ...
          * ``ExpressionAttributeNames`` - One or more substitution tokens for attribute names in
          ...
          For more information about expression attribute names, see `Accessing Item Attributes
          ...
          * ``ProjectionExpression`` - A string that identifies one or more attributes to retrieve
          ...
          document. The attributes in the expression must be separated by commas. If no attribute
          names are specified, then all attributes are returned. If any of the requested attributes
          are not found, they do not appear in the result. For more information, see `Accessing Item
          Attributes
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.AccessingItemAttributes.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          * ``AttributesToGet`` - This is a legacy parameter. Use ``ProjectionExpression`` instead.
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributesToGet.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              For each primary key, you must provide *all* of the key attributes. For example, with
              a simple primary key, you only need to provide the partition key. For a composite
              ...
              - **ProjectionExpression** *(string) --*
                ...
                in the ``ProjectionExpression`` must be separated by commas.
        ...
        :param ReturnConsumedCapacity:
          ...
          * ``INDEXES`` - The response includes the aggregate ``ConsumedCapacity`` for the
          ...
          accessed. Note that some operations, such as ``GetItem`` and ``BatchGetItem`` , do not
          access any indexes at all. In these cases, specifying ``INDEXES`` will only return
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **UnprocessedKeys** *(dict) --*
              ...
              response. The ``UnprocessedKeys`` value is in the same form as ``RequestItems`` , so
              the value can be provided directly to a subsequent ``BatchGetItem`` operation. For
              ...
              * ``ProjectionExpression`` - One or more attributes to be retrieved from the table or
              ...
              * ``ConsistentRead`` - The consistency of a read operation. If set to ``true`` , then
              a strongly consistent read is used; otherwise, an eventually consistent read is used.
            ...
            - **ConsumedCapacity** *(list) --*
              ...
              * ``CapacityUnits`` - The total number of capacity units consumed.
              ...
              - *(dict) --*
                ...
                asked for it. For more information, see `Provisioned Throughput
    ...
    def batch_write_item(
        ...
        single call to ``BatchWriteItem`` can write up to 16 MB of data, which can comprise as many
        ...
        atomic; however ``BatchWriteItem`` as a whole is not. If any requested operations fail
        ...
        .. warning::
          ...
          For more information, see `Batch Operations and Error Handling
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ErrorHandling.html#Programming.Errors.BatchOperations>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        performance with these large-scale operations, ``BatchWriteItem`` does not behave in the
        same way as individual ``PutItem`` and ``DeleteItem`` calls would. For example, you cannot
        ...
        items in parallel. Your application must include the necessary logic to manage the threads.
        With languages that don't support threading, you must update or delete the specified items
        one at a time. In both situations, ``BatchWriteItem`` performs the specified put and delete
        ...
        * The total request size exceeds 16 MB.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/BatchWriteItem>`_
        ...
        **Request Syntax**
          ...
          * ``DeleteRequest`` - Perform a ``DeleteItem`` operation on the specified item. The item
          to be deleted is identified by a ``Key`` subelement:
            ...
            * ``Key`` - A map of primary key attribute values that uniquely identify the item. Each
            entry in this map consists of an attribute name and an attribute value. For each primary
            key, you must provide *all* of the key attributes. For example, with a simple primary
            key, you only need to provide a value for the partition key. For a composite primary
          ...
          * ``PutRequest`` - Perform a ``PutItem`` operation on the specified item. The item to be
          put is identified by an ``Item`` subelement:
            ...
            * ``Item`` - A map of attributes and their values. Each entry in this map consists of an
            ...
            binary type attributes must have lengths greater than zero; and set type attributes must
            not be empty. Requests that contain empty values are rejected with a
            ``ValidationException`` exception. If you specify any attributes that are part of an
            index key, then the data types for those attributes must match those of the schema in
          ...
          - *(string) --*
            ...
            - *(list) --*
              ...
              - *(dict) --*
                ...
                you do need to perform both of these operations, you need to provide two separate
        ...
        :param ReturnItemCollectionMetrics:
          ...
          operation are returned in the response. If set to ``NONE`` (the default), no statistics
          are returned.
          ...
          **Response Structure**
          ...
          - *(dict) --*
              ...
              * ``PutRequest`` - Perform a ``PutItem`` operation on the specified item. The item to
              be put is identified by an ``Item`` subelement:
                ...
                * ``Item`` - A map of attributes and their values. Each entry in this map consists
                ...
                string and binary type attributes must have lengths greater than zero; and set type
                attributes must not be empty. Requests that contain empty values will be rejected
                with a ``ValidationException`` exception. If you specify any attributes that are
                part of an index key, then the data types for those attributes must match those of
                  ...
                  - *(dict) --*
                    ...
                    - **PutRequest** *(dict) --*
                      ...
                      - **Item** *(dict) --*
                        ...
                        an item to be processed by ``PutItem`` . All of the table's primary key
                        attributes must be specified, and their data types must match those of the
                        table's key schema. If any attributes are present in the item that are part
            ...
            - **ItemCollectionMetrics** *(dict) --*
              ...
              * ``ItemCollectionKey`` - The partition key value of the item collection. This is the
              ...
              * ``SizeEstimateRangeGB`` - An estimate of item collection size, expressed in GB. This
              ...
              estimate to measure whether a local secondary index is approaching its size limit. The
              estimate is subject to change over time; therefore, do not rely on the precision or
    ...
    def create_table(
        ...
        you create the tables in different Regions.
         ...
         DynamoDB immediately returns a response with a ``TableStatus`` of ``CREATING`` . After the
         table is created, DynamoDB sets the ``TableStatus`` to ``ACTIVE`` . You can perform read
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/CreateTable>`_
        ...
        **Request Syntax**
        ...
        :param KeySchema: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataModel.html>`__ in
          ...
          * ``KeyType`` - The role that the key attribute will assume:
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithTables.html#WorkingWithTables.primary.key>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param LocalSecondaryIndexes:
          ...
          * ``Projection`` - Specifies attributes that are copied (projected) from the table into
          the index. These are in addition to the primary key attributes and index key attributes,
        ...
        :param BillingMode:
          ...
          * ``PROVISIONED`` - We recommend using ``PROVISIONED`` for predictable workloads.
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.ReadWriteCapacityMode.html#HowItWorks.ProvisionedThroughput.Manual>`__
          .

          * ``PAY_PER_REQUEST`` - We recommend using ``PAY_PER_REQUEST`` for unpredictable
          workloads. ``PAY_PER_REQUEST`` sets the billing mode to `On-Demand Mode
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.ReadWriteCapacityMode.html#HowItWorks.OnDemand>`__
          .
        ...
        :param SSESpecification:
          ...
          - **Enabled** *(boolean) --*
            ...
            owned CMK. If enabled (true), server-side encryption type is set to ``KMS`` and an AWS
            managed CMK is used (AWS KMS charges apply). If disabled (false) or not specified,
        ...
        :param Tags:
          ...
          DynamoDB
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Tagging.html>`__ .
          ...
          - *(dict) --*
            ...
            <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Tagging.html>`__ in
            the *Amazon DynamoDB Developer Guide* .

            - **Key** *(string) --* **[REQUIRED]**

              The key of the tag. Tag keys are case sensitive. Each DynamoDB table can only have up
...
class Table(Boto3ServiceResource):
    ...
    def delete(self, *args: Any, **kwargs: Any) -> TableDeleteResponseTypeDef:
        ...
        deletion. If the table is in the ``ACTIVE`` state, you can delete it. If a table is in
        ``CREATING`` or ``UPDATING`` states, then DynamoDB returns a ``ResourceInUseException`` . If
        the specified table does not exist, DynamoDB returns a ``ResourceNotFoundException`` . If
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DeleteTable>`_
                    ...
                    'Replicas': [
                        {
                            'RegionName': 'string',
                            'ReplicaStatus':
                            'CREATING'|'CREATION_FAILED'|'UPDATING'|'DELETING'
                            |'ACTIVE',
          ...
          - *(dict) --*
            ...
            - **TableDescription** *(dict) --*
              ...
              - **KeySchema** *(list) --*
                ...
                * ``KeyType`` - The role of the attribute:
                ...
                - *(dict) --*
                  ...
                  ``KeySchemaElement`` for the partition key, and another ``KeySchemaElement`` for
                  the sort key.
              ...
              - **TableStatus** *(string) --*
                ...
                * ``INACCESSIBLE_ENCRYPTION_CREDENTIALS`` - The AWS KMS key used to encrypt the
                table in inaccessible. Table operations may fail due to failure to use the AWS KMS
                key. DynamoDB will initiate the table archival process when a table's AWS KMS key
              ...
              - **ProvisionedThroughput** *(dict) --*
                ...
                - **NumberOfDecreasesToday** *(integer) --*
                  ...
                  `Limits
                  <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Limits.html>`__
                  in the *Amazon DynamoDB Developer Guide* .
              ...
              - **LocalSecondaryIndexes** *(list) --*
                ...
                Represents one or more local secondary indexes on the table. Each index is scoped to
                a given partition key value. Tables with one or more local secondary indexes are
                ...
                * ``Projection`` - Specifies attributes that are copied (projected) from the table
                ...
                composed of:
                  ...
                  * ``NonKeyAttributes`` - A list of one or more non-key attribute names that are
                  ...
                  20. If you project the same attribute into two different indexes, this counts as
                ...
                * ``ItemCount`` - Represents the number of items in the index. DynamoDB updates this
              ...
              - **GlobalSecondaryIndexes** *(list) --*
                ...
                * ``Backfilling`` - If true, then the index is currently in the backfilling phase.
                ...
                the ``Backfilling`` phase when ``IndexStatus`` is set to CREATING and
                ``Backfilling`` is true. You can't delete the index that is being created when
                ``IndexStatus`` is set to CREATING and ``Backfilling`` is false. (This attribute
                ...
                * ``ProvisionedThroughput`` - The provisioned throughput settings for the global
                ...
                - *(dict) --*
                  ...
                  - **Backfilling** *(boolean) --*
                    ...
                    when ``IndexStatus`` is set to CREATING and ``Backfilling`` is true. You can't
                    delete the index that is being created when ``IndexStatus`` is set to CREATING
                    and ``Backfilling`` is false.
              ...
              - **GlobalTableVersion** *(string) --*
                ...
                <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GlobalTables.html>`__
              ...
              - **SSEDescription** *(dict) --*
                ...
                - **SSEType** *(string) --*
                  ...
                  * ``KMS`` - Server-side encryption that uses AWS Key Management Service. The key
                ...
                - **InaccessibleEncryptionDateTime** *(datetime) --*
                  ...
                  table's AWS KMS key was inaccessible. This attribute will automatically be cleared
                  when DynamoDB detects that the table's AWS KMS key is accessible again. DynamoDB
                  will initiate the table archival process when table's AWS KMS key remains
              ...
              - **ArchivalSummary** *(dict) --*
                ...
                - **ArchivalBackupArn** *(string) --*
                  ...
                  applicable in the archival reason. If you wish to restore this backup to the same
                  table name, you will need to delete the original table.
    ...
    def delete_item(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/DeleteItem>`_
        ...
        **Request Syntax**
          ...
          response = table.delete_item(
              ...
              Expected={
                  'string': {
                      ...
                      'Exists': True|False,
                      'ComparisonOperator':
                      'EQ'|'NE'|'IN'|'LE'|'LT'|'GE'|'GT'|'BETWEEN'|'NOT_NULL'|'NULL'
        ...
        :param Expected:
          ...
          `Expected
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.Expected.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              used with ``DeleteItem`` , ``PutItem`` , or ``UpdateItem`` operations; if the
              comparison evaluates to true, the operation succeeds; if not, the operation fails. You
              ...
              * Use ``Value`` to specify a value that DynamoDB will compare against an attribute. If
              the values match, then ``ExpectedAttributeValue`` evaluates to true and the
              conditional operation succeeds. Optionally, you can also set ``Exists`` to false,
              indicating that you *do not* expect to find the attribute value in the table. In this
              ...
              - **Exists** *(boolean) --*
                ...
                * If ``Exists`` is ``false`` , DynamoDB assumes that the attribute value does not
                ...
                valid and the operation succeeds. If the value is found, despite the assumption that
                it does not exist, the operation fails with a ``ConditionCheckFailedException`` .

                The default setting for ``Exists`` is ``true`` . If you supply a ``Value`` all by
                itself, DynamoDB assumes the attribute exists: You don't have to set ``Exists`` to
              ...
              - **ComparisonOperator** *(string) --*
                ...
                * ``NE`` : Not equal. ``NE`` is supported for all data types, including lists and
                ...
                String, Number, Binary, String Set, Number Set, or Binary Set. If an item contains
                an ``AttributeValue`` of a different type than the one provided in the request, the
                ...
                * ``NOT_NULL`` : The attribute exists. ``NOT_NULL`` is supported for all data types,
                ...
                .. note::
                   ...
                   This operator tests for the existence of an attribute, not its data type. If the
                   data type of attribute "``a`` " is null, and you evaluate it using ``NOT_NULL`` ,
                ...
                * ``NULL`` : The attribute does not exist. ``NULL`` is supported for all data types,
                ...
                .. note::
                   ...
                   the data type of attribute "``a`` " is null, and you evaluate it using ``NULL`` ,
                ...
                * ``CONTAINS`` : Checks for a subsequence, or value in a set.
                ...
                evaluates to true if it finds an exact match with any member of the set. CONTAINS is
                supported for lists: When evaluating "``a CONTAINS b`` ", "``a`` " can be a list;
                however, "``b`` " cannot be a set, a map, or a list.

                * ``NOT_CONTAINS`` : Checks for absence of a subsequence, or absence of a value in a
                set.  ``AttributeValueList`` can contain only one ``AttributeValue`` element of type
                String, Number, or Binary (not a set type). If the target attribute of the
                ...
                the set. NOT_CONTAINS is supported for lists: When evaluating "``a NOT CONTAINS b``
                ...
                * ``BEGINS_WITH`` : Checks for a prefix.   ``AttributeValueList`` can contain only
                ...
                target attribute of the comparison must be of type String or Binary (not a Number or
                a set type).

                * ``IN`` : Checks for matching elements in a list.  ``AttributeValueList`` can
                contain one or more ``AttributeValue`` elements of type String, Number, or Binary.
                These attributes are compared against an existing attribute of an item. If any
                elements of the input are equal to the item attribute, the expression evaluates to
                true.

                * ``BETWEEN`` : Greater than or equal to the first value, and less than or equal to
                the second value.   ``AttributeValueList`` must contain two ``AttributeValue``
                ...
                the value does not match. For example, ``{"S":"6"}`` does not compare to
                ``{"N":"6"}`` . Also, ``{"N":"6"}`` does not compare to ``{"NS":["6", "2", "1"]}``
              ...
              - **AttributeValueList** *(list) --*
                ...
                character code values. For example, ``a`` is greater than ``A`` , and ``a`` is
                ...
                <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/DataFormat.html>`__
                in the *Amazon DynamoDB Developer Guide* .
        ...
        :param ConditionalOperator:
          ...
          This is a legacy parameter. Use ``ConditionExpression`` instead. For more information, see
          `ConditionalOperator
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ConditionalOperator.html>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param ConditionExpression:
          ...
          * Logical operators: ``AND | OR | NOT``
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.SpecifyingConditions.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ConsumedCapacity** *(dict) --*
              ...
              table and any indexes involved in the operation. ``ConsumedCapacity`` is only returned
              if the ``ReturnConsumedCapacity`` parameter was specified. For more information, see
              `Provisioned Mode
              <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ProvisionedThroughputIntro.html>`__
              in the *Amazon DynamoDB Developer Guide* .
            ...
            - **ItemCollectionMetrics** *(dict) --*
              ...
              * ``ItemCollectionKey`` - The partition key value of the item collection. This is the
              same as the partition key value of the item itself.

              * ``SizeEstimateRangeGB`` - An estimate of item collection size, in gigabytes. This
              value is a two-element array containing a lower bound and an upper bound for the
              estimate. The estimate includes the size of all the items in the table, plus the size
              of all attributes projected into all of the local secondary indexes on that table. Use
              this estimate to measure whether a local secondary index is approaching its size
              limit. The estimate is subject to change over time; therefore, do not rely on the
              precision or accuracy of the estimate.
    ...
    def get_item(
        ...
        key. If there is no matching item, ``GetItem`` does not return any data and there will be no
        ``Item`` element in the response.

         ``GetItem`` provides an eventually consistent read by default. If your application requires
         a strongly consistent read, set ``ConsistentRead`` to ``true`` . Although a strongly
         consistent read might take more time than an eventually consistent read, it always returns
         the last updated value.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/GetItem>`_
    ...
    def load(self, *args: Any, **kwargs: Any) -> None:
        """
        Calls :py:meth:`DynamoDB.Client.describe_table` to update the attributes of the Table
        resource. Note that the load and reload methods are the same method and can be used
        interchangeably.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/None>`_
    ...
    def put_item(
        ...
        .. warning::
          ...
          * `PutItem in the AWS Command Line Interface
          <http://docs.aws.amazon.com/goto/aws-cli/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for .NET
          <http://docs.aws.amazon.com/goto/DotNetSDKV3/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for C++
          <http://docs.aws.amazon.com/goto/SdkForCpp/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for Go
          <http://docs.aws.amazon.com/goto/SdkForGoV1/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for Java
          <http://docs.aws.amazon.com/goto/SdkForJava/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for JavaScript
          <http://docs.aws.amazon.com/goto/AWSJavaScriptSDK/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for PHP V3
          <http://docs.aws.amazon.com/goto/SdkForPHPV3/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for Python
          <http://docs.aws.amazon.com/goto/boto3/dynamodb-2012-08-10/PutItem>`__

          * `PutItem in the AWS SDK for Ruby V2
          <http://docs.aws.amazon.com/goto/SdkForRubyV2/dynamodb-2012-08-10/PutItem>`__

        When you add an item, the primary key attributes are the only required attributes. Attribute
        values cannot be null. String and Binary type attributes must have lengths greater than
        zero. Set type attributes cannot be empty. Requests with empty values will be rejected with
        ...
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/WorkingWithItems.html>`__
        in the *Amazon DynamoDB Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/PutItem>`_
        ...
        **Request Syntax**
        ...
        :param Item: **[REQUIRED]**
          ...
          For more information about primary keys, see `Primary Key
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/HowItWorks.CoreComponents.html#HowItWorks.CoreComponents.PrimaryKey>`__
          in the *Amazon DynamoDB Developer Guide* .
    ...
    def query(
        ...
        secondary index that has a composite primary key (a partition key and a sort key).

        Use the ``KeyConditionExpression`` parameter to provide a specific value for the partition
        key. The ``Query`` operation will return all of the items from the table or index with that
        partition key value. You can optionally narrow the scope of the ``Query`` operation by
        specifying a sort key value and a comparison operator in ``KeyConditionExpression`` . To
        further refine the ``Query`` results, you can optionally provide a ``FilterExpression`` . A
        ``FilterExpression`` determines which items within the results should be returned to you.
        All of the other results are discarded.

        A ``Query`` operation always returns a result set. If no matching items are found, the
        ...
        .. note::
          ...
          the amount of data that is returned to an application. The number of capacity units
        ...
        ``Limit`` parameter) or a maximum of 1 MB of data and then apply any filtering to the
        results using ``FilterExpression`` . If ``LastEvaluatedKey`` is present in the response, you
        will need to paginate the result set. For more information, see `Paginating the Results
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Query.html#Query.Pagination>`__
        in the *Amazon DynamoDB Developer Guide* .
        ...
        You can query a table, a local secondary index, or a global secondary index. For a query on
        a table or on a local secondary index, you can set the ``ConsistentRead`` parameter to
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/Query>`_
        ...
        **Request Syntax**
        ...
        :param Select:
          ...
          specific item attributes, the count of matching items, or in the case of an index, some or
          all of the attributes projected into the index.

          * ``ALL_ATTRIBUTES`` - Returns all of the item attributes from the specified table or
          index. If you query a local secondary index, then for each matching item in the index,
          DynamoDB fetches the entire item from the parent table. If the index is configured to
          ...
          * ``ALL_PROJECTED_ATTRIBUTES`` - Allowed only when querying an index. Retrieves all
          attributes that have been projected into the index. If the index is configured to project
          ...
          * ``SPECIFIC_ATTRIBUTES`` - Returns only the attributes listed in ``AttributesToGet`` .
          ...
          value for ``Select`` . If you query or scan a local secondary index and request only
          attributes that are projected into that index, the operation will read only the index and
          not the table. If any of the requested attributes are not projected into the local
          secondary index, DynamoDB fetches each of these attributes from the parent table. This
          extra fetching incurs additional throughput cost and latency. If you query or scan a
          global secondary index, you can only request attributes that are projected into the index.
        ...
        :param Limit:
          ...
          DynamoDB processes the number of items up to the limit while processing the results, it
          stops the operation and returns the matching values up to that point, and a key in
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html>`__ in
          the *Amazon DynamoDB Developer Guide* .
        ...
        :param KeyConditions:
          ...
          see `KeyConditions
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.KeyConditions.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              * For a ``Query`` operation, ``Condition`` is used for specifying the
              ...
              | GT |
              BEGINS_WITH
              | BETWEEN``    ``Condition`` is also used in a ``QueryFilter`` , which
        ...
        :param QueryFilter:
          ...
          `QueryFilter
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.QueryFilter.html>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param FilterExpression:
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html#FilteringResults>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param KeyConditionExpression:
          ...
          value. This allows ``Query`` to retrieve one item with a given partition key value and
          sort key value, or several items that have the same partition key value but different sort
          key values.
          ...
          * ``sortKeyName``  ``>=
              ``  ``:sortkeyval`` - true if the sort key value is greater than or
          equal to ``:sortkeyval`` .

          * ``sortKeyName``  ``BETWEEN``  ``:sortkeyval1``  ``AND``  ``:sortkeyval2`` - true if the
          sort key value is greater than or equal to ``:sortkeyval1`` , and less than or equal to
          ``:sortkeyval2`` .

          * ``begins_with (``  ``sortKeyName`` , ``:sortkeyval``  ``)`` - true if the sort key value
          begins with a particular operand. (You cannot use this function with a sort key that is of
          ...
          * ``#S = :myval``
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/ExpressionPlaceholders.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Count** *(integer) --*
              ...
              returned after the filter was applied, and ``ScannedCount`` is the number of matching
            ...
            - **ScannedCount** *(integer) --*
              ...
              ``Query`` operation. For more information, see `Count and ScannedCount
            ...
            - **LastEvaluatedKey** *(dict) --*
              ...
              data in the result set. The only way to know when you have reached the end of the
    ...
    def scan(
        ...
        scan stops and results are returned to the user as a ``LastEvaluatedKey`` value to continue
        the scan in a subsequent operation. The results also include the number of items exceeding
        the limit. A scan can result in no table data meeting the filter criteria.

        A single ``Scan`` operation reads up to the maximum number of items set (if using the
        ``Limit`` parameter) or a maximum of 1 MB of data and then apply any filtering to the
        results using ``FilterExpression`` . If ``LastEvaluatedKey`` is present in the response, you
        need to paginate the result set. For more information, see `Paginating the Results
        <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Scan.html#Scan.Pagination>`__
        in the *Amazon DynamoDB Developer Guide* .
         ...
         ``Segment`` and ``TotalSegments`` parameters. For more information, see `Parallel Scan
         <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Scan.html#Scan.ParallelScan>`__
         in the *Amazon DynamoDB Developer Guide* .

         ``Scan`` uses eventually consistent reads when accessing the data in a table; therefore,
         the result set might not include the changes to data in the table immediately before the
         operation began. If you need a consistent copy of the data, as of the time that the
         ``Scan`` begins, you can set the ``ConsistentRead`` parameter to ``true`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/Scan>`_
        ...
        **Request Syntax**
        ...
        :param Select:
          ...
          * ``SPECIFIC_ATTRIBUTES`` - Returns only the attributes listed in ``AttributesToGet`` .
          This return value is equivalent to specifying ``AttributesToGet`` without specifying any
          value for ``Select`` . If you query or scan a local secondary index and request only
          attributes that are projected into that index, the operation reads only the index and not
          the table. If any of the requested attributes are not projected into the local secondary
          index, DynamoDB fetches each of these attributes from the parent table. This extra
          fetching incurs additional throughput cost and latency. If you query or scan a global
          secondary index, you can only request attributes that are projected into the index. Global
        ...
        :param ScanFilter:
          ...
          This is a legacy parameter. Use ``FilterExpression`` instead. For more information, see
          `ScanFilter
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.ScanFilter.html>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param TotalSegments:
          ...
          example, if you want to use four application threads to scan a table or an index, specify
          a ``TotalSegments`` value of 4.
        ...
        :param ConsistentRead:
          ...
          * If ``ConsistentRead`` is ``true`` , then all of the write operations that completed
          ...
          The ``ConsistentRead`` parameter is not supported on global secondary indexes. If you scan
          a global secondary index with ``ConsistentRead`` set to true, you will receive a
          ``ValidationException`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ScannedCount** *(integer) --*
              ...
              ``ScannedCount`` value with few, or no, ``Count`` results indicates an inefficient
              ``Scan`` operation. For more information, see `Count and ScannedCount
              <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/QueryAndScan.html#Count>`__
              in the *Amazon DynamoDB Developer Guide* .
            ...
            - **ConsumedCapacity** *(dict) --*
              ...
              The capacity units consumed by the ``Scan`` operation. The data returned includes the
              total provisioned throughput consumed, along with statistics for the table and any
              indexes involved in the operation. ``ConsumedCapacity`` is only returned if the
              ``ReturnConsumedCapacity`` parameter was specified. For more information, see
              `Provisioned Throughput
    ...
    def update(
        ...
        * Create a new global secondary index on the table. After the index begins backfilling, you
        can use ``UpdateTable`` to perform other operations.

         ``UpdateTable`` is an asynchronous operation; while it is executing, the table status
         changes from ``ACTIVE`` to ``UPDATING`` . While it is ``UPDATING`` , you cannot issue
         another ``UpdateTable`` request. When the table returns to the ``ACTIVE`` state, the
         ``UpdateTable`` operation is complete.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateTable>`_
        ...
        **Request Syntax**
        ...
        :param AttributeDefinitions:
          ...
          adding a new global secondary index to the table, ``AttributeDefinitions`` must include
        ...
        :param GlobalSecondaryIndexUpdates:
          ...
          * ``Update`` - modify the provisioned throughput settings of an existing global secondary
          index.
          ...
          * ``Delete`` - remove a global secondary index from the table.
          ...
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/GSI.OnlineOps.html>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param StreamSpecification:
          ...
          .. note::
            ...
            You receive a ``ResourceInUseException`` if you try to enable a stream on a table that
        ...
        :param ReplicaUpdates:
          ...
          .. note::
            ...
            <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/globaltables.V2.html>`__
            of global tables.
          ...
          - *(dict) --*
            ...
            * A new replica to be added to an existing regional table or global table. This request
            invokes the ``CreateTableReplica`` action in the destination Region.
            ...
            * An existing replica to be deleted. The request invokes the ``DeleteTableReplica``
            ...
            - **Create** *(dict) --*
              ...
              - **KMSMasterKeyId** *(string) --*
                ...
                The AWS KMS customer master key (CMK) that should be used for AWS KMS encryption in
                the new replica. To specify a CMK, use its key ID, Amazon Resource Name (ARN), alias
    ...
    def update_item(
        ...
        You can also return the item's attribute values in the same ``UpdateItem`` operation using
        the ``ReturnValues`` parameter.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/UpdateItem>`_
        ...
        **Request Syntax**
        ...
        :param AttributeUpdates:
          ...
          `AttributeUpdates
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/LegacyConditionalParameters.AttributeUpdates.html>`__
          in the *Amazon DynamoDB Developer Guide* .
          ...
          - *(string) --*
            ...
            - *(dict) --*
              ...
              For the ``UpdateItem`` operation, represents the attributes to be modified, the action
              to perform on each, and the new value for each.

              .. note::

                You cannot use ``UpdateItem`` to update any primary key attributes. Instead, you
                will need to delete the item, and then use ``PutItem`` to create a new item with new
                attributes.
                ...
                ``ADD`` depends on the data type of the attribute:
                  ...
                  * If the existing attribute is a number, and if ``Value`` is also a number, then
                  ...
                  .. note::
                     ...
                     doesn't exist before the update, DynamoDB uses 0 as the initial value. In
                     ...
                     ``ADD`` the number ``3`` to this attribute anyway, even though it currently
                     does not exist. DynamoDB will create the *itemcount* attribute, set its initial
                  ...
                  * If the existing data type is a set, and if the ``Value`` is also a set, then the
                  ...
                  mathematical addition.) For example, if the attribute value was the set ``[1,2]``
                  , and the ``ADD`` action specified ``[3]`` , then the final attribute value would
                  be ``[1,2,3]`` . An error occurs if an Add action is specified for a set attribute
                  and the attribute type specified does not match the existing set type.  Both sets
                  must have the same primitive data type. For example, if the existing data type is
                  a set of strings, the ``Value`` must also be a set of strings. The same holds true
                  for number sets and binary sets.

                This action is only valid for an existing attribute whose data type is number or is
                a set. Do not use ``ADD`` for any other data types.
        ...
        :param UpdateExpression:
          ...
          * ``SET`` - Adds one or more attributes and values to an item. If any of these attributes
          already exist, they are replaced by the new values. You can also use ``SET`` to add or
          subtract from an attribute that is of type Number. For example: ``SET myNum = myNum +
          :val``    ``SET`` supports the following functions:
            ...
            * ``list_append (operand, operand)`` - evaluates to a list with a new element added to
            it. You can append the new element to the start or the end of the list by reversing the
          ...
          attribute:
            ...
            * If the existing attribute is a number, and if ``Value`` is also a number, then
            ...
            .. note::
               ...
               ``itemcount`` , but you decide to ``ADD`` the number ``3`` to this attribute anyway.
               DynamoDB will create the ``itemcount`` attribute, set its initial value to ``0`` ,
               and finally add ``3`` to it. The result will be a new ``itemcount`` attribute in the
            ...
            * If the existing data type is a set and if ``Value`` is also a set, then ``Value`` is
            ...
            attribute type specified does not match the existing set type.  Both sets must have the
            same primitive data type. For example, if the existing data type is a set of strings,
          ...
          * ``DELETE`` - Deletes an element from a set. If a set of values is specified, then those
          values are subtracted from the old set. For example, if the attribute value was the set
          ``[a,b,c]`` and the ``DELETE`` action specifies ``[a,c]`` , then the final attribute value
          ...
          You can have many actions in a single expression, such as the following: ``SET a=
              :value1,
          b=:value2 DELETE :value3, :value4, :value5``

          For more information on update expressions, see `Modifying Items and Attributes
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.Modifying.html>`__
          in the *Amazon DynamoDB Developer Guide* .
        ...
        :param ExpressionAttributeNames:
          ...
          * ``#P = :val``
          ...
          For more information about expression attribute names, see `Specifying Item Attributes
          <https://docs.aws.amazon.com/amazondynamodb/latest/developerguide/Expressions.AccessingItemAttributes.html>`__
          in the *Amazon DynamoDB Developer Guide* .
    ...
    def wait_until_exists(self, *args: Any, **kwargs: Any) -> None:
        ...
        :py:meth:`DynamoDB.Waiter.table_exists.wait` which polls.
        :py:meth:`DynamoDB.Client.describe_table` every 20 seconds until a successful state is
    ...
    def wait_until_not_exists(self, *args: Any, **kwargs: Any) -> None:
        ...
        :py:meth:`DynamoDB.Waiter.table_not_exists.wait` which polls.
        :py:meth:`DynamoDB.Client.describe_table` every 20 seconds until a successful state is
        reached. An error is returned after 25 failed checks.
...
class ServiceResourceTablesCollection(ResourceCollection):
    ...
    def all(self) -> List[service_resource_scope.Table]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dynamodb-2012-08-10/ListTables>`_
    ...
    def filter(
        ...
        """
        Creates an iterable of all Table resources in the collection filtered by kwargs passed to
        method.
