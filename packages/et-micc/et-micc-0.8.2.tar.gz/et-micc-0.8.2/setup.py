...
package_data = \
{'': ['*'],
 'et_micc': ['cmake_tools/F2pyAddModule.cmake',
             ...
             'cmake_tools/pybind11Tools.cmake',
             'cmake_tools/pybind11Tools.cmake',
             'templates/app-simple/{{cookiecutter.project_name}}/tests/test_{{cookiecutter.cli_app_name}}.{{cookiecutter.py}}',
...
entry_points = \
{'console_scripts': ['micc = et_micc:cli.main']}
