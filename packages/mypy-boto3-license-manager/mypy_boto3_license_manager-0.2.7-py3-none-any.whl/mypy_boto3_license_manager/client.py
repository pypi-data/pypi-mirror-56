...
class Client(BaseClient):
    ...
    def create_license_configuration(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          launch. The specified tags are applied to all instances or volumes that are created during launch.
    ...
    def list_associations_for_license_configuration(
        ...
        license (depending on the license rules). Use this operation to find all resources associated with a
    ...
    def update_license_specifications_for_resource(
        ...
        supports updating the license specifications of AMIs, instances, and hosts. Launch templates and AWS
        CloudFormation templates are not managed from this operation as those resources send the license
        configurations directly to a resource creation operation, such as ``RunInstances`` .
