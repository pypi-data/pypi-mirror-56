"Main interface for cloudsearch Client"
...
class Client(BaseClient):
    ...
    def build_suggesters(self, DomainName: str) -> ClientBuildSuggestersResponseTypeDef:
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-suggestions.html#configuring-suggesters>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/BuildSuggesters>`_
          ...
          - *(dict) --*
            ...
            - **FieldNames** *(list) --*
              ...
              - *(string) --*
                ...
                index fields as well as dynamic fields. A dynamic field's name defines a pattern
                that begins or ends with a wildcard. Any document fields that don't map to a regular
                index field but do match a dynamic field's pattern are configured with the dynamic
    ...
    def create_domain(self, DomainName: str) -> ClientCreateDomainResponseTypeDef:
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/creating-domains.html>`__ in
        the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/CreateDomain>`_
        ...
        **Request Syntax**
        ...
        :param DomainName: **[REQUIRED]**
          ...
          0-9, and hyphen (-). Domain names must start with a letter or number and be at least 3 and
          ...
          - *(dict) --*
            ...
            - **DomainStatus** *(dict) --*
              ...
              - **DomainName** *(string) --*
                ...
                domains owned by an account within an AWS region. Domain names start with a letter
                or number and can contain the following characters: a-z (lowercase), 0-9, and -
                (hyphen).
              ...
              - **ARN** *(string) --*
                ...
                Entities
                <http://docs.aws.amazon.com/IAM/latest/UserGuide/index.html?Using_Identifiers.html>`__
                in *Using AWS Identity and Access Management* for more information.

              - **Created** *(boolean) --*

                True if the search domain is created. It can take several minutes to initialize a
                domain when  CreateDomain is called. Newly created search domains are returned from
    ...
    def define_analysis_scheme(
        ...
        define language-specific text processing options. For more information, see `Configuring
        Analysis Schemes
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-analysis-schemes.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DefineAnalysisScheme>`_
        ...
        :param AnalysisScheme: **[REQUIRED]**
          ...
          - **AnalysisOptions** *(dict) --*
            ...
            - **Synonyms** *(string) --*
              ...
              the array of values specifies each of the aliases for that term. An alias is
...

            {
                'AnalysisScheme': {
                    'Options': {
                        'AnalysisSchemeName': 'string',
                        'AnalysisSchemeLanguage':
                        'ar'|'bg'|'ca'|'cs'|'da'|'de'|'el'|'en'|'es'|'eu'|'fa'|'fi'
                        |'fr'|'ga'|'gl'|'he'|'hi'|'hu'|'hy'|'id'|'it'|'ja'|'ko'|'lv'
                        |'mul'|'nl'|'no'|'pt'|'ro'|'ru'|'sv'|'th'|'tr'|'zh-Hans'
                        |'zh-Hant',
                        'AnalysisOptions': {
                            'Synonyms': 'string',
                            'Stopwords': 'string',
          ...
          - *(dict) --*
            ...
            - **AnalysisScheme** *(dict) --*
              ...
              - **Options** *(dict) --*
                ...
                can be configured for an analysis scheme: ``Synonyms`` , ``Stopwords`` ,
                ``StemmingDictionary`` , ``JapaneseTokenizationDictionary`` and
                ``AlgorithmicStemming`` .
                ...
                - **AnalysisSchemeLanguage** *(string) --*
                  ...
                  An `IETF RFC 4646 <http://tools.ietf.org/html/rfc4646>`__ language code or ``mul``
                ...
                - **AnalysisOptions** *(dict) --*
                  ...
                  - **AlgorithmicStemming** *(string) --*
                    ...
                    information, see `Language Specific Text Processing Settings
                    <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/text-processing.html#text-processing-settings>`__
                    in the *Amazon CloudSearch Developer Guide*
    ...
    def define_expression(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DefineExpression>`_
            ...
            - **Expression** *(dict) --*
              ...
              - **Options** *(dict) --*
                ...
                - **ExpressionValue** *(string) --*
                  ...
                  The expression to evaluate for sorting while processing a search request. The
                  ``Expression`` syntax is based on JavaScript expressions. For more information,
    ...
    def define_index_field(
        ...
        old one. For more information, see `Configuring Index Fields
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-index-fields.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DefineIndexField>`_
            ...
            - **IndexField** *(dict) --*
              ...
              - **Options** *(dict) --*
                ...
                - **IndexFieldName** *(string) --*
                  ...
                  A string that represents the name of an index field. CloudSearch supports regular
                  index fields as well as dynamic fields. A dynamic field's name defines a pattern
                  that begins or ends with a wildcard. Any document fields that don't map to a
                  regular index field but do match a dynamic field's pattern are configured with the
                  dynamic field's indexing options.

                  Regular field names begin with a letter and can contain the following characters:
                  a-z (lowercase), 0-9, and _ (underscore). Dynamic field names must begin or end
                  with a wildcard (*). The wildcard can also be the only character in a dynamic
                  field name. Multiple wildcards, and wildcards embedded within a string are not
                  supported.
                ...
                - **TextArrayOptions** *(dict) --*
                  ...
                  ``text-array`` field is always searchable. All options are enabled by default.
                ...
                - **DateArrayOptions** *(dict) --*
                  ...
                  Options for a field that contains an array of dates. Present if ``IndexFieldType``
                  specifies the field is of type ``date-array`` . All options are enabled by
                  default.
    ...
    def define_suggester(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DefineSuggester>`_
        ...
        :param Suggester: **[REQUIRED]**
          ...
          - **DocumentSuggesterOptions** *(dict) --* **[REQUIRED]**
            ...
            - **FuzzyMatching** *(string) --*
              ...
              With low, suggestions must differ from the specified string by no more than one
              character. With high, suggestions can differ by up to two characters. The default is
              none.

            - **SortExpression** *(string) --*

              An expression that computes a score for each suggestion to control how they are
              sorted. The scores are rounded to the nearest integer, with a floor of 0 and a ceiling
              of 2^31-1. A document's relevance score is not computed for suggestions, so sort
              expressions cannot reference the ``_score`` value. To sort suggestions using a numeric
              field or existing expression, simply specify the name of the field or expression. If
              no expression is configured for the suggester, the suggestions are sorted with the
          ...
          - *(dict) --*
            ...
            - **Suggester** *(dict) --*
              ...
              - **Options** *(dict) --*
                ...
                can be configured for a suggester: ``FuzzyMatching`` , ``SortExpression`` .
                ...
                - **DocumentSuggesterOptions** *(dict) --*
                  ...
                  - **FuzzyMatching** *(string) --*
                    ...
                    prefix. With low, suggestions must differ from the specified string by no more
                    than one character. With high, suggestions can differ by up to two characters.
                    The default is none.
    ...
    def delete_analysis_scheme(
        ...
        """
        Deletes an analysis scheme. For more information, see `Configuring Analysis Schemes
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-analysis-schemes.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DeleteAnalysisScheme>`_
    ...
    def delete_domain(self, DomainName: str) -> ClientDeleteDomainResponseTypeDef:
        ...
        cannot be recovered. For more information, see `Deleting a Search Domain
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/deleting-domains.html>`__ in
        the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DeleteDomain>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The result of a ``DeleteDomain`` request. Contains the status of a newly deleted domain,
    ...
    def delete_expression(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DeleteExpression>`_
    ...
    def delete_index_field(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DeleteIndexField>`_
    ...
    def delete_suggester(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DeleteSuggester>`_
    ...
    def describe_analysis_schemes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeAnalysisSchemes>`_
            ...
            - **AnalysisSchemes** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Options** *(dict) --*
                  ...
                  unique name and specifies the language of the text to be processed. The following
                  ...
                  - **AnalysisSchemeLanguage** *(string) --*
                    ...
                    An `IETF RFC 4646 <http://tools.ietf.org/html/rfc4646>`__ language code or
                  ...
                  - **AnalysisOptions** *(dict) --*
                    ...
                    - **Synonyms** *(string) --*
                      ...
                      information about specifying synonyms, see `Synonyms
                      <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-analysis-schemes.html#synonyms>`__
                      in the *Amazon CloudSearch Developer Guide* .
                    ...
                    - **StemmingDictionary** *(string) --*
                      ...
                      "stem3"}`` . The stemming dictionary is applied in addition to any algorithmic
                      stemming. This enables you to override the results of the algorithmic stemming
                      to correct specific cases of overstemming or understemming. The maximum size
                    ...
                    - **JapaneseTokenizationDictionary** *(string) --*
                      ...
                      A JSON array that contains a collection of terms, tokens, readings and part of
                      speech for Japanese Tokenizaiton. The Japanese tokenization dictionary enables
                      you to override the default tokenization for selected terms. This is only
                      valid for Japanese language fields.
                    ...
                    - **AlgorithmicStemming** *(string) --*
                      ...
                      For more information, see `Language Specific Text Processing Settings
                      <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/text-processing.html#text-processing-settings>`__
                      in the *Amazon CloudSearch Developer Guide*
                ...
                - **Status** *(dict) --*
                  ...
                  - **State** *(string) --*
                    ...
                    * ``FailedToValidate`` : the option value is not compatible with the domain's
                    ...
                    value or update or remove the incompatible documents.
    ...
    def describe_availability_options(
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-availability-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeAvailabilityOptions>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The result of a ``DescribeAvailabilityOptions`` request. Indicates whether or not the
            Multi-AZ option is enabled for the domain specified in the request.
    ...
    def describe_domain_endpoint_options(
        ...
        arrive over HTTPS. For more information, see `Configuring Domain Endpoint Options
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-domain-endpoint-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeDomainEndpointOptions>`_
    ...
    def describe_domains(
        ...
        Information about a Search Domain
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-domain-info.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeDomains>`_
        ...
        **Request Syntax**
        ...
        :param DomainNames:
          ...
          - *(string) --*
            ...
            A string that represents the name of a domain. Domain names are unique across the
            domains owned by an account within an AWS region. Domain names start with a letter or
            number and can contain the following characters: a-z (lowercase), 0-9, and - (hyphen).
            ...
            - **DomainStatusList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Created** *(boolean) --*
                  ...
                  True if the search domain is created. It can take several minutes to initialize a
                  domain when  CreateDomain is called. Newly created search domains are returned
    ...
    def describe_expressions(
        ...
        the configuration. Set the ``Deployed`` option to ``true`` to show the active configuration
        and exclude pending changes. For more information, see `Configuring Expressions
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-expressions.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeExpressions>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The result of a ``DescribeExpressions`` request. Contains the expressions configured for
    ...
    def describe_index_fields(
        ...
        the configuration. Set the ``Deployed`` option to ``true`` to show the active configuration
        and exclude pending changes. For more information, see `Getting Domain Information
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-domain-info.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeIndexFields>`_
        ...
        **Request Syntax**
        ...
        :param FieldNames:
          ...
          A list of the index fields you want to describe. If not specified, information is returned
          for all configured index fields.
                ...
                'IndexFields': [
                    {
                        'Options': {
                            ...
                            |'int-array'|'double-array'|'literal-array'
                            |'text-array'|'date-array',
                            'IntOptions': {
                                'DefaultValue': 123,
                                'SourceField': 'string',
                                'FacetEnabled': True|False,
              ...
              - *(dict) --*
                ...
                - **Options** *(dict) --*
                  ...
                  - **IntOptions** *(dict) --*
                    ...
                    - **DefaultValue** *(integer) --* A value to use for the field if the field
                    isn't specified for a document. This can be important if you are using the field
                    in an expression and that field is not present in every document.
                  ...
                  - **LiteralOptions** *(dict) --*
                    ...
                    - **SourceField** *(string) --*
                      ...
                      map to a regular index field but do match a dynamic field's pattern are
                      configured with the dynamic field's indexing options.

                      Regular field names begin with a letter and can contain the following
                      characters: a-z (lowercase), 0-9, and _ (underscore). Dynamic field names must
                      begin or end with a wildcard (*). The wildcard can also be the only character
                      in a dynamic field name. Multiple wildcards, and wildcards embedded within a
                  ...
                  - **TextOptions** *(dict) --*
                    ...
                    Options for text field. Present if ``IndexFieldType`` specifies the field is of
                    type ``text`` . A ``text`` field is always searchable. All options are enabled
                    by default.
                  ...
                  - **IntArrayOptions** *(dict) --*
                    ...
                    Options for a field that contains an array of 64-bit signed integers. Present if
                    ``IndexFieldType`` specifies the field is of type ``int-array`` . All options
                    are enabled by default.
    ...
    def describe_scaling_parameters(
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-scaling-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeScalingParameters>`_
          ...
          ::

            {
                'ScalingParameters': {
                    'Options': {
                        'DesiredInstanceType':
                        'search.m1.small'|'search.m1.large'|'search.m2.xlarge'
    ...
    def describe_service_access_policies(
        ...
        changes. For more information, see `Configuring Access for a Search Domain
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-access.html>`__ in
        the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeServiceAccessPolicies>`_
          ...
          - *(dict) --*
            ...
            - **AccessPolicies** *(dict) --*
              ...
              - **Options** *(string) --*
                ...
                information, see `Configuring Access for a Search Domain
    ...
    def describe_suggesters(
        ...
        exclude pending changes. For more information, see `Getting Search Suggestions
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-suggestions.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/DescribeSuggesters>`_
            ...
            - **Suggesters** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Options** *(dict) --*
                  ...
                  Configuration information for a search suggester. Each suggester has a unique name
                  and specifies the text field you want to use for suggestions. The following
                  ...
                  - **DocumentSuggesterOptions** *(dict) --*
                    ...
                    - **FuzzyMatching** *(string) --*
                      ...
                      The level of fuzziness allowed when suggesting matches for a string: ``none``
                      , ``low`` , or ``high`` . With none, the specified string is treated as an
                      exact prefix. With low, suggestions must differ from the specified string by
                      no more than one character. With high, suggestions can differ by up to two
                    ...
                    - **SortExpression** *(string) --*
                      ...
                      sort suggestions using a numeric field or existing expression, simply specify
    ...
    def index_documents(self, DomainName: str) -> ClientIndexDocumentsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/IndexDocuments>`_
    ...
    def list_domain_names(self, *args: Any, **kwargs: Any) -> ClientListDomainNamesResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/ListDomainNames>`_
    ...
    def update_availability_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/UpdateAvailabilityOptions>`_
        ...
        **Request Syntax**
        ...
        :param MultiAZ: **[REQUIRED]**
          ...
          option to true. Similarly, you can turn off the Multi-AZ option to downgrade the domain to
          a single Availability Zone by setting the Multi-AZ option to ``false`` .
    ...
    def update_domain_endpoint_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/UpdateDomainEndpointOptions>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            The result of a ``UpdateDomainEndpointOptions`` request. Contains the configuration and
            status of the domain's endpoint options.
    ...
    def update_scaling_parameters(
        ...
        control the resources used per Availability Zone. For more information, see `Configuring
        Scaling Options
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-scaling-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/UpdateScalingParameters>`_
    ...
    def update_service_access_policies(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudsearch-2013-01-01/UpdateServiceAccessPolicies>`_
