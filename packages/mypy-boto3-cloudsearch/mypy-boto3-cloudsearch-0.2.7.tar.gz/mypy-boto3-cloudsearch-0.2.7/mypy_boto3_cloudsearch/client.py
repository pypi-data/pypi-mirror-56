...
class Client(BaseClient):
    ...
    def build_suggesters(self, DomainName: str) -> ClientBuildSuggestersResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param DomainName: **[REQUIRED]**
          ...
          A string that represents the name of a domain. Domain names are unique across the domains owned by
          an account within an AWS region. Domain names start with a letter or number and can contain the
    ...
    def create_domain(self, DomainName: str) -> ClientCreateDomainResponseTypeDef:
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/creating-domains.html>`__ in the
          ...
          - *(dict) --*
            ...
            - **DomainStatus** *(dict) --*
              ...
              - **DomainName** *(string) --*
                ...
                owned by an account within an AWS region. Domain names start with a letter or number and can
    ...
    def define_analysis_scheme(
        self,
        DomainName: str,
        AnalysisScheme: ClientDefineAnalysisSchemeAnalysisSchemeTypeDef,
    ) -> ClientDefineAnalysisSchemeResponseTypeDef:
        """
        Configures an analysis scheme that can be applied to a ``text`` or ``text-array`` field to define
        language-specific text processing options. For more information, see `Configuring Analysis Schemes
        ...
        ::
          ...
          response = client.define_analysis_scheme(
              ...
              AnalysisScheme={
                  ...
                  'ar'|'bg'|'ca'|'cs'|'da'|'de'|'el'|'en'|'es'|'eu'|'fa'|'fi'|'fr'|'ga'|'gl'|'he'|'hi'|'hu'
                  |'hy'|'id'|'it'|'ja'|'ko'|'lv'|'mul'|'nl'|'no'|'pt'|'ro'|'ru'|'sv'|'th'|'tr'|'zh-Hans'
                  |'zh-Hant',
                  'AnalysisOptions': {
                      'Synonyms': 'string',
                      'Stopwords': 'string',
        ...
        :param AnalysisScheme: **[REQUIRED]**
          ...
          - **AnalysisOptions** *(dict) --*
            ...
            - **Synonyms** *(string) --*
              ...
              string:value pairs where the string specifies a term and the array of values specifies each of
              the aliases for that term. An alias is considered a synonym of the specified term, but the
              term is not considered a synonym of the alias. For more information about specifying synonyms,
              see `Synonyms
            ...
            - **AlgorithmicStemming** *(string) --*
              ...
              . The available levels vary depending on the language. For more information, see `Language
              Specific Text Processing Settings
...

            {
                'AnalysisScheme': {
                    'Options': {
                        'AnalysisSchemeName': 'string',
                        'AnalysisSchemeLanguage':
                        'ar'|'bg'|'ca'|'cs'|'da'|'de'|'el'|'en'|'es'|'eu'|'fa'|'fi'|'fr'|'ga'|'gl'|'he'|'hi'
                        |'hu'|'hy'|'id'|'it'|'ja'|'ko'|'lv'|'mul'|'nl'|'no'|'pt'|'ro'|'ru'|'sv'|'th'|'tr'
                        |'zh-Hans'|'zh-Hant',
                        'AnalysisOptions': {
                            'Synonyms': 'string',
                            'Stopwords': 'string',
              ...
              - **Options** *(dict) --*
                ...
                - **AnalysisOptions** *(dict) --*
                  ...
                  - **StemmingDictionary** *(string) --*
                    ...
                    stemming dictionary is applied in addition to any algorithmic stemming. This enables you
                    to override the results of the algorithmic stemming to correct specific cases of
    ...
    def define_expression(
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-expressions.html>`__ in
    ...
    def define_index_field(
        ...
        ones. You must specify the name of the domain you are configuring and an index field configuration.
        The index field configuration specifies a unique name, the index field type, and the options you
        want to configure for the field. The options you can specify depend on the `` IndexFieldType`` . If
        the field exists, the new configuration replaces the old one. For more information, see `Configuring
        Index Fields
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-index-fields.html>`__ in
        the *Amazon CloudSearch Developer Guide* .
        ...
        **Request Syntax**
        ::
          ...
          response = client.define_index_field(
              ...
              IndexField={
                  ...
                  'IndexFieldType':
                  'int'|'double'|'literal'|'text'|'date'|'latlon'|'int-array'|'double-array'|'literal-array'
        ...
        :param IndexField: **[REQUIRED]**
          ...
          - **LiteralOptions** *(dict) --*
            ...
            - **DefaultValue** *(string) --* A value to use for the field if the field isn't specified for a
            document.
...

            {
                'IndexField': {
                    'Options': {
                        'IndexFieldName': 'string',
                        'IndexFieldType':
                        'int'|'double'|'literal'|'text'|'date'|'latlon'|'int-array'|'double-array'
            ...
            - **IndexField** *(dict) --*
              ...
              - **Options** *(dict) --*
                ...
                - **LiteralOptions** *(dict) --*
                  ...
                  - **DefaultValue** *(string) --* A value to use for the field if the field isn't specified
                  for a document.
    ...
    def define_suggester(
        ...
        information, see `Getting Search Suggestions
        ...
        :param Suggester: **[REQUIRED]**
          ...
          - **DocumentSuggesterOptions** *(dict) --* **[REQUIRED]**
            ...
            - **SortExpression** *(string) --*
              ...
              expression, simply specify the name of the field or expression. If no expression is configured
              for the suggester, the suggestions are sorted with the closest matches listed first.
              ...
              - **Options** *(dict) --*
                ...
                - **DocumentSuggesterOptions** *(dict) --*
                  ...
                  - **FuzzyMatching** *(string) --*
                    ...
                    , or ``high`` . With none, the specified string is treated as an exact prefix. With low,
    ...
    def delete_domain(self, DomainName: str) -> ClientDeleteDomainResponseTypeDef:
        ...
        be recovered. For more information, see `Deleting a Search Domain
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/deleting-domains.html>`__ in the
        *Amazon CloudSearch Developer Guide* .
    ...
    def describe_analysis_schemes(
        ...
        more information, see `Configuring Analysis Schemes
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-analysis-schemes.html>`__
        in the *Amazon CloudSearch Developer Guide* .
                ...
                'AnalysisSchemes': [
                    {
                        'Options': {
                            'AnalysisSchemeName': 'string',
                            'AnalysisSchemeLanguage':
                            'ar'|'bg'|'ca'|'cs'|'da'|'de'|'el'|'en'|'es'|'eu'|'fa'|'fi'|'fr'|'ga'|'gl'|'he'
                            |'hi'|'hu'|'hy'|'id'|'it'|'ja'|'ko'|'lv'|'mul'|'nl'|'no'|'pt'|'ro'|'ru'|'sv'
    ...
    def describe_availability_options(
        ...
        pending changes. Set the ``Deployed`` option to ``true`` to show the active configuration and
        exclude pending changes. For more information, see `Configuring Availability Options
    ...
    def describe_domain_endpoint_options(
        ...
        over HTTPS. For more information, see `Configuring Domain Endpoint Options
    ...
    def describe_domains(
        ...
        about a Search Domain
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-domain-info.html>`__ in the
        *Amazon CloudSearch Developer Guide* .
    ...
    def describe_expressions(
        ...
        the ``Deployed`` option to ``true`` to show the active configuration and exclude pending changes.
    ...
    def describe_index_fields(
        ...
        changes. For more information, see `Getting Domain Information
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-domain-info.html>`__ in the
        *Amazon CloudSearch Developer Guide* .
          ...
          ::

            {
                'ScalingParameters': {
                    'Options': {
                        'DesiredInstanceType':
                        'search.m1.small'|'search.m1.large'|'search.m2.xlarge'|'search.m2.2xlarge'
                        |'search.m3.medium'|'search.m3.large'|'search.m3.xlarge'|'search.m3.2xlarge',
    ...
    def describe_service_access_policies(
        ...
        endpoints. By default, shows the configuration with any pending changes. Set the ``Deployed`` option
        ...
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-access.html>`__ in the
        *Amazon CloudSearch Developer Guide* .
    ...
    def describe_suggesters(
        ...
        shows all suggesters and includes any pending changes to the configuration. Set the ``Deployed``
        option to ``true`` to show the active configuration and exclude pending changes. For more
        information, see `Getting Search Suggestions
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/getting-suggestions.html>`__ in the
        *Amazon CloudSearch Developer Guide* .
    ...
    def update_availability_options(
        ...
        become active. For more information, see `Configuring Availability Options
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-availability-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .
    ...
    def update_scaling_parameters(
        ...
        Zone. For more information, see `Configuring Scaling Options
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-scaling-options.html>`__
        in the *Amazon CloudSearch Developer Guide* .
