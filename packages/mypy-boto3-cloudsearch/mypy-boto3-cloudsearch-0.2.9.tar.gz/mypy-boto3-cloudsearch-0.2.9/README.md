...
Mypy-friendly auto-generated type annotations for `boto3 cloudsearch 1.10.28` service.
...
session_client = session.client("cloudsearch")
...
```python
import boto3
from mypy_boto3.cloudsearch import Client
