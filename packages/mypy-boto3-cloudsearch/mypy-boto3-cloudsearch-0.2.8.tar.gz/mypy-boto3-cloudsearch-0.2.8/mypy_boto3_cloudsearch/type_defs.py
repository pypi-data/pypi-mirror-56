...
class ClientCreateDomainResponseDomainStatusTypeDef(_ClientCreateDomainResponseDomainStatusTypeDef):
    ...
    - **Created** *(boolean) --*
      ...
      CreateDomain is called. Newly created search domains are returned from  DescribeDomains with a
    ...
    - **Deleted** *(boolean) --*
      ...
      the search domain when  DeleteDomain is called. Newly deleted search domains are returned from
...
class ClientDefineAnalysisSchemeAnalysisSchemeTypeDef(
    ...
    - **AnalysisOptions** *(dict) --*
      ...
      - **Synonyms** *(string) --*
        ...
        arrays, where each sub-array is a group of terms where each term in the group is considered
        a synonym of every other term in the group. The aliases value is an object that contains a
        collection of string:value pairs where the string specifies a term and the array of values
        specifies each of the aliases for that term. An alias is considered a synonym of the
        specified term, but the term is not considered a synonym of the alias. For more information
        about specifying synonyms, see `Synonyms
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-analysis-schemes.html#synonyms>`__
        in the *Amazon CloudSearch Developer Guide* .
    ...
    - **Options** *(dict) --*
      ...
      - **AnalysisOptions** *(dict) --*
        ...
        - **Synonyms** *(string) --*
          ...
          considered a synonym of every other term in the group. The aliases value is an object that
          contains a collection of string:value pairs where the string specifies a term and the
          array of values specifies each of the aliases for that term. An alias is considered a
          synonym of the specified term, but the term is not considered a synonym of the alias. For
          more information about specifying synonyms, see `Synonyms
          <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-analysis-schemes.html#synonyms>`__
          in the *Amazon CloudSearch Developer Guide* .
        ...
        - **Stopwords** *(string) --*
          ...
          A JSON array of terms to ignore during indexing and searching. For example, ``["a", "an",
          "the", "of"]`` . The stopwords dictionary must explicitly list each word you want to
          ignore. Wildcards and regular expressions are not supported.

        - **StemmingDictionary** *(string) --*

          A JSON object that contains a collection of string:value pairs that each map a term to its
          stem. For example, ``{"term1": "stem1", "term2": "stem2", "term3": "stem3"}`` . The
...
_ClientDefineExpressionExpressionTypeDef = TypedDict(
    "_ClientDefineExpressionExpressionTypeDef", {"ExpressionName": str, "ExpressionValue": str}
)
...
class ClientDefineExpressionResponseExpressionTypeDef(
    ...
    - **Options** *(dict) --*
      ...
      - **ExpressionValue** *(string) --*
        ...
        The expression to evaluate for sorting while processing a search request. The ``Expression``
        syntax is based on JavaScript expressions. For more information, see `Configuring
        Expressions
        <http://docs.aws.amazon.com/cloudsearch/latest/developerguide/configuring-expressions.html>`__
        in the *Amazon CloudSearch Developer Guide* .
...
class ClientDefineIndexFieldIndexFieldTypeDef(
    ...
    - **IntOptions** *(dict) --*
      ...
      Options for a 64-bit signed integer field. Present if ``IndexFieldType`` specifies the field
      is of type ``int`` . All options are enabled by default.

      - **DefaultValue** *(integer) --* A value to use for the field if the field isn't specified
      for a document. This can be important if you are using the field in an expression and that
    ...
    - **DoubleArrayOptions** *(dict) --*
      ...
      Options for a field that contains an array of double-precision 64-bit floating point values.
      Present if ``IndexFieldType`` specifies the field is of type ``double-array`` . All options
      are enabled by default.

      - **DefaultValue** *(float) --* A value to use for the field if the field isn't specified for
      a document.
...
_RequiredClientDefineSuggesterSuggesterDocumentSuggesterOptionsTypeDef = TypedDict(
    "_RequiredClientDefineSuggesterSuggesterDocumentSuggesterOptionsTypeDef", {"SourceField": str}
)
...
class ClientDescribeAnalysisSchemesResponseAnalysisSchemesOptionsAnalysisOptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeAnalysisSchemesResponseAnalysisSchemesOptions`
    `AnalysisOptions`
...
_ClientDescribeScalingParametersResponseScalingParametersOptionsTypeDef = TypedDict(
    ...
    {"DesiredInstanceType": str, "DesiredReplicationCount": int, "DesiredPartitionCount": int},
    total=False,
)
...
class ClientDescribeSuggestersResponseSuggestersOptionsDocumentSuggesterOptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeSuggestersResponseSuggestersOptions`
