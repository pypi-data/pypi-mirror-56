...
def search_server(child, host=None):
    # global child
    ...
    if index_server <= 0:
        ...
        server_info_list = child_timeout(child)
...
def query_servers(child, host=None):
    # child = jumper_login()

    server_info_list, server_regex = search_server(child, host)
