"Main interface for medialive Paginators"
              ...
              - *(dict) --* Contains information on a single schedule action.
                ...
                - **ScheduleActionSettings** *(dict) --* Settings for this schedule action.
                  ...
                  message
                    ...
                    - **SpliceEventId** *(integer) --* The splice_event_id for the SCTE-35 splice_insert, as
                    defined in SCTE-35.
                ...
                channel.
                  ...
                  time for an action.
                    ...
                    (for example, mm might be 01) except for the two constants "T" for time and "Z" for "UTC
                    format".
                ...
                'Channels': [
                    {
                        ...
                        'RoleArn': 'string',
                        'State':
                        'CREATING'|'CREATE_FAILED'|'IDLE'|'STARTING'|'RUNNING'|'RECOVERING'|'STOPPING'
                        |'DELETING'|'DELETED'|'UPDATING'|'UPDATE_FAILED',
                        'Tags': {
                            'string': 'string'
                        }
                    },
                ...
                - **InputAttachments** *(list) --* List of input attachments for channel.
                  ...
                  - *(dict) --* Placeholder documentation for InputAttachment
                    ...
                    - **InputSettings** *(dict) --* Settings of an input (caption selector, etc.)
                        ...
                        about where streams should be distributed.
                          ...
                          - **SelectorSettings** *(dict) --* Caption selector settings.
                            ...
                            - **DvbSubSourceSettings** *(dict) --* Dvb Sub Source Settings
                              ...
                              PID for the source content. Unused for DVB-Sub passthrough. All DVB-Sub
                            ...
                            - **Scte27SourceSettings** *(dict) --* Scte27 Source Settings
                              ...
                              omit Language: Extracts the specified PID. - Omit PID and specify Language:
                              Extracts the specified language, whichever PID that happens to be. - Omit PID
                              and omit Language: Valid only if source is DVB-Sub that is being passed
                      ...
                      the deblocking filter enabled by default. 1) auto - filtering will be applied
          ...
          - *(dict) --* An array of inputs
            ...
            - **Inputs** *(list) --* Placeholder documentation for __listOfInput
              ...
              - *(dict) --* Placeholder documentation for Input
                ...
                is SINGLE_PIPELINE, only the first source will be ingested; the second source will always be
                ignored, even if the first source fails. SINGLE_PIPELINE - You can connect only one source
                to this input. If the ChannelClass is also SINGLE_PIPELINE, this value is valid. If the
                ChannelClass is STANDARD, this value is not valid because the channel requires two sources
                in the input.
