...
def ensure_leading_positive(A):
    ...
    :param A: Parameter matrix (3 or 4D)
    :return A_positive: Parameter matrix where the leading identity is
...
def ensure_leading_negative(A):
    ...
    :param A: Parameter matrix (3 or 4D)
    :return A_negative: Parameter matrix where the leading identity is
