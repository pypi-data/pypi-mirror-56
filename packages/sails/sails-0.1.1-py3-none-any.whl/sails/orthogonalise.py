...
def closest_orthogonal(A, verbose=False):
    ...
    :param A: [channels, samples]

    :rtype: list
    :return: List containing:
             1. numpy.ndarray [channels, samples] of orthogonalised data
             2. d
             3. rho
             4. W
    ...
    Key references:
        ...
        https://github.com/OHBA-analysis/MEG-ROI-nets
...
def symmetric_orthonormal(A, maintain_mag=False):
    ...
    A is channels|voxels by samples
