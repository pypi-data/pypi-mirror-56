...
def approx_model_selection_criteria(A, EF, method='ss'):
    ...
    Two approximations are available:
        ...
        in Burnham & Anderson 2004 and Chatfield 2003.
        'det': The determinant of the residual covariance matrix.

    The sum squares method is used as default.

    :param A: Array containing the parameters of a fitted model, of shape
              [channels x channels x maxorder]

    :param EF: Array containing the residuals of the fitted model, of shape
               [channels x samples x trials]

    :param method: string indicating which method should be used to approximate
                   the loglikelihood ('ss' or 'det')

    :returns: tuple of (aLL, AIC, BIC)
