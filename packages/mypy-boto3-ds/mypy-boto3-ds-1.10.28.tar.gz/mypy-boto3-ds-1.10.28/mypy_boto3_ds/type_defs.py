...
class ClientAcceptSharedDirectoryResponseSharedDirectoryTypeDef(
    ...
    - **ShareMethod** *(string) --*
      ...
      within your AWS organization (``ORGANIZATIONS`` ) or with any AWS account by sending a shared
...
class ClientConnectDirectoryConnectSettingsTypeDef(_ClientConnectDirectoryConnectSettingsTypeDef):
    """
...
class ClientCreateMicrosoftAdVpcSettingsTypeDef(_ClientCreateMicrosoftAdVpcSettingsTypeDef):
    """
...
class ClientDescribeCertificateResponseCertificateTypeDef(
    ...
    Information about the certificate, including registered date time, certificate state, the reason
    for the state, expiration date time, and certificate common name.
...
class ClientDescribeConditionalForwardersResponseConditionalForwardersTypeDef(
    ...
    - **ReplicationScope** *(string) --*
      ...
      which will replicate the conditional forwarder to all of the domain controllers for your AWS
      directory.
    """
...
class ClientDescribeDirectoriesResponseDirectoryDescriptionsOwnerDirectoryDescriptionRadiusSettingsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDirectoriesResponseDirectoryDescriptionsOwnerDirectoryDescription`
    `RadiusSettings`
...
class ClientDescribeDirectoriesResponseDirectoryDescriptionsOwnerDirectoryDescriptionVpcSettingsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeDirectoriesResponseDirectoryDescriptionsOwnerDirectoryDescription` `VpcSettings`
...
class ClientDescribeDirectoriesResponseDirectoryDescriptionsOwnerDirectoryDescriptionTypeDef(
    ...
    """
    Type definition for `ClientDescribeDirectoriesResponseDirectoryDescriptions`
...
class ClientDescribeDirectoriesResponseDirectoryDescriptionsVpcSettingsTypeDef(
    ...
    directory. This member is only present if the directory is a Simple AD or Managed AD directory.
...
class ClientDescribeDirectoriesResponseDirectoryDescriptionsTypeDef(
    ...
    - **ConnectSettings** *(dict) --*
      ...
      A  DirectoryConnectSettingsDescription object that contains additional information about an AD
      Connector directory. This member is only present if the directory is an AD Connector
      directory.
    ...
    - **OwnerDirectoryDescription** *(dict) --*
      ...
      - **RadiusSettings** *(dict) --*
        ...
        - **RadiusServers** *(list) --*
          ...
          An array of strings that contains the IP addresses of the RADIUS server endpoints, or the
...
class ClientDescribeEventTopicsResponseEventTopicsTypeDef(
    ...
    - **DirectoryId** *(string) --*
      ...
      The Directory ID of an AWS Directory Service directory that will publish status messages to an
      SNS topic.
...
_ClientDescribeLdapsSettingsResponseLDAPSSettingsInfoTypeDef = TypedDict(
    ...
    {"LDAPSStatus": str, "LDAPSStatusReason": str, "LastUpdatedDateTime": datetime},
    total=False,
)
...
class ClientDescribeLdapsSettingsResponseLDAPSSettingsInfoTypeDef(
    ...
    """
    Type definition for `ClientDescribeLdapsSettingsResponse` `LDAPSSettingsInfo`
...
class ClientDescribeLdapsSettingsResponseTypeDef(_ClientDescribeLdapsSettingsResponseTypeDef):
    """
    Type definition for `ClientDescribeLdapsSettings` `Response`
    ...
    - **NextToken** *(string) --*
      ...
      The next token used to retrieve the LDAPS settings if the number of setting types exceeds page
...
class ClientDescribeSharedDirectoriesResponseSharedDirectoriesTypeDef(
    ...
    Details about the shared directory in the directory owner account for which the share request in
    the directory consumer account has been accepted.
...
_ClientListCertificatesResponseCertificatesInfoTypeDef = TypedDict(
    ...
    {"CertificateId": str, "CommonName": str, "State": str},
    total=False,
)
...
class ClientListCertificatesResponseCertificatesInfoTypeDef(
    ...
    """
    Type definition for `ClientListCertificatesResponse` `CertificatesInfo`
...
class ClientUnshareDirectoryUnshareTargetTypeDef(_ClientUnshareDirectoryUnshareTargetTypeDef):
    """
...
class DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescriptionRadiusSettingsTypeDef(
    ...
    """
    Type definition for
    `DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescription`
    `RadiusSettings`
...
class DescribeDirectoriesPaginateResponseDirectoryDescriptionsOwnerDirectoryDescriptionTypeDef(
    ...
    """
    Type definition for `DescribeDirectoriesPaginateResponseDirectoryDescriptions`
    `OwnerDirectoryDescription`
