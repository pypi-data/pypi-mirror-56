    ...
    def create_log_subscription(self, DirectoryId: str, LogGroupName: str) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param DirectoryId: **[REQUIRED]**
          ...
          Identifier (ID) of the directory to which you want to subscribe and receive real-time logs
    ...
    def create_microsoft_ad(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          The fully qualified domain name for the directory, such as ``corp.example.com`` . This
          name will resolve inside your VPC only. It does not need to be publicly resolvable.
