...
class Client(BaseClient):
          ...
          ::

            {
                'SharedDirectory': {
                    ...
                    'SharedDirectoryId': 'string',
                    'ShareStatus':
                    'Shared'|'PendingAcceptance'|'Rejected'|'Rejecting'|'RejectFailed'|'Sharing'
                    |'ShareFailed'|'Deleted'|'Deleting',
                    'ShareNotes': 'string',
          ...
          - *(dict) --*
            ...
            - **SharedDirectory** *(dict) --*
              ...
              - **ShareMethod** *(string) --*
                ...
                The method used when sharing a directory to determine whether the directory should be shared
                within your AWS organization (``ORGANIZATIONS`` ) or with any AWS account by sending a
              ...
              - **ShareNotes** *(string) --*
                ...
                A directory share request that is sent by the directory owner to the directory consumer. The
                request includes a typed message to help the directory consumer administrator determine
    ...
    def add_ip_routes(
        ...
        """
        If the DNS server for your on-premises domain uses a publicly addressable IP address, you must add a
        CIDR address block to correctly route traffic to and from your Microsoft AD on Amazon Web Services.
        *AddIpRoutes* adds this address block. You can also use *AddIpRoutes* to facilitate routing traffic
        ...
        **Request Syntax**
        ...
        :param IpRoutes: **[REQUIRED]**
          ...
          IP address blocks, using CIDR format, of the traffic to route. This is often the IP address block
          of the DNS server used for your on-premises domain.
          ...
          - *(dict) --*
            ...
            - **CidrIp** *(string) --*
              ...
              of the DNS server used for your on-premises domain. For a single IP address use a CIDR address
        ...
        :param UpdateSecurityGroupForDirectoryControllers:
          ...
          description: "AWS created security group for *directory ID* directory controllers." Following are
          the new rules:
        ...
        :param Tags: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --* **[REQUIRED]**
              ...
              with "aws:". The string can contain only the set of Unicode letters, digits, white-space, '_',
    ...
    def create_alias(
        ...
        construct the access URL for the directory, such as ``http://<alias>.awsapps.com`` .

        .. warning::

          After an alias has been created, it cannot be deleted or reused, so this operation should only be
    ...
    def create_computer(
        ...
        **Request Syntax**
        ...
        :param OrganizationalUnitDistinguishedName:
          ...
          The fully-qualified distinguished name of the organizational unit to place the computer account
          in.
    ...
    def create_conditional_forwarder(
        ...
        """
        Creates a conditional forwarder associated with your AWS directory. Conditional forwarders are
        required in order to set up a trust relationship with another domain. The conditional forwarder
        ...
        **Request Syntax**
        ...
        :param VpcSettings:
          ...
          - **SubnetIds** *(list) --* **[REQUIRED]**
            ...
            Availability Zones. AWS Directory Service creates a directory server and a DNS server in each of
            these subnets.
    ...
    def create_log_subscription(
        ...
        specified CloudWatch log group in your AWS account.
    ...
    def create_microsoft_ad(
        ...
        **Request Syntax**
        ...
        :param ShortName:
          ...
          The NetBIOS name for your domain. A short identifier for your domain, such as ``CORP`` . If you
          don't specify a NetBIOS name, it will default to the first part of your directory DNS. For
          example, ``CORP`` for the directory DNS ``corp.example.com`` .
        ...
        :param Description:
          ...
          A textual description for the directory. This label will appear on the AWS console ``Directory
    ...
    def create_trust(
        ...
        For example, you can establish a trust between your AWS Managed Microsoft AD directory, and your
        existing on-premises Microsoft Active Directory. This would allow you to provide users and groups
        ...
        Microsoft AD directory and an external domain. You can create either a forest trust or an external
        trust.
    ...
    def delete_trust(
        ...
        """
        Deletes an existing trust relationship between your AWS Managed Microsoft AD directory and an
        external domain.
    ...
    def describe_conditional_forwarders(
        ...
        If no input parameters are provided for RemoteDomainNames, this request describes all conditional
            ...
            - **ConditionalForwarders** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DnsIpAddrs** *(list) --*
                  ...
                  The IP addresses of the remote DNS server associated with RemoteDomainName. This is the IP
    ...
    def describe_directories(
        ...
        contains a token that you pass in the next call to  DescribeDirectories to retrieve the next set of
        items.
        ...
        **Request Syntax**
        ...
        :param DirectoryIds:
          ...
          null, all directories that belong to the current account are returned.
                ...
                'DirectoryDescriptions': [
                    {
                        ...
                        'Stage':
                        'Requested'|'Creating'|'Created'|'Active'|'Inoperable'|'Impaired'|'Restoring'
                        |'RestoreFailed'|'Deleting'|'Deleted'|'Failed',
                        'ShareStatus':
                        'Shared'|'PendingAcceptance'|'Rejected'|'Rejecting'|'RejectFailed'|'Sharing'
                        |'ShareFailed'|'Deleted'|'Deleting',
                        'ShareMethod': 'ORGANIZATIONS'|'HANDSHAKE',
            ...
            - **DirectoryDescriptions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **AccessUrl** *(string) --*
                  ...
                  The access URL for the directory, such as ``http://<alias>.awsapps.com`` . If no alias has
                ...
                - **ConnectSettings** *(dict) --*
                  ...
                  an AD Connector directory. This member is only present if the directory is an AD Connector
                  directory.
    ...
    def describe_event_topics(
        ...
        If no input parameters are provided, such as DirectoryId or TopicName, this request describes all of
        the associations in the account.
    ...
    def describe_snapshots(
        ...
        If more results are available, the *DescribeSnapshots.NextToken* member contains a token that you
        pass in the next call to  DescribeSnapshots to retrieve the next set of items.
    ...
    def describe_trusts(
        ...
        If no input parameters are provided, such as DirectoryId or TrustIds, this request describes all the
        trust relationships belonging to the account.
        ...
        **Request Syntax**
        ...
        :param TrustIds:
          ...
          A list of identifiers of the trust relationships for which to obtain the information. If this
          member is null, all trust relationships that belong to the current account are returned.
                ...
                'Trusts': [
                    {
                        ...
                        'TrustDirection': 'One-Way: Outgoing'|'One-Way: Incoming'|'Two-Way',
                        'TrustState':
                        'Creating'|'Created'|'Verifying'|'VerifyFailed'|'Verified'|'Updating'|'UpdateFailed'
                        |'Updated'|'Deleting'|'Deleted'|'Failed',
                        'CreatedDateTime': datetime(2015, 1, 1),
                        'LastUpdatedDateTime': datetime(2015, 1, 1),
    ...
    def disable_sso(
        ...
        **Request Syntax**
        ...
        :param UserName:
          ...
          Connector directories. This account must have privileges to remove a service principal name.

          If the AD Connector service account does not have privileges to remove a service principal name,
          you can specify an alternate account with the *UserName* and *Password* parameters. These
    ...
    def enable_sso(
        ...
        **Request Syntax**
        ...
        :param UserName:
          ...
          If the AD Connector service account does not have privileges to add a service principal name, you
          can specify an alternate account with the *UserName* and *Password* parameters. These credentials
    ...
    def list_log_subscriptions(
        ...
        **Request Syntax**
        ...
        :param DirectoryId:
          ...
          If a *DirectoryID* is provided, lists only the log subscription associated with that directory. If
          no *DirectoryId* is provided, lists all log subscriptions associated with your AWS account. If
          there are no log subscriptions for the AWS account or the directory, an empty list will be
          returned.
                ...
                'SchemaExtensionsInfo': [
                    {
                        ...
                        'Initializing'|'CreatingSnapshot'|'UpdatingSchema'|'Replicating'|'CancelInProgress'
                        |'RollbackInProgress'|'Cancelled'|'Failed'|'Completed',
    ...
    def register_event_topic(self, DirectoryId: str, TopicName: str) -> Dict:
        ...
        specified SNS topic. You can then receive email or text (SMS) messages when the status of your
        directory changes. You get notified if your directory goes from an Active status to an Impaired or
        Inoperable status. You also receive a notification when the directory returns to an Active status.
        ...
        **Request Syntax**
        ...
        :param TopicName: **[REQUIRED]**
          ...
          The SNS topic name to which the directory will publish status messages. This SNS topic must be in
    ...
    def restore_from_snapshot(self, SnapshotId: str) -> Dict:
        ...
        When you restore a directory from a snapshot, any changes made to the directory after the snapshot
        date are overwritten.

        This action returns as soon as the restore operation is initiated. You can monitor the progress of
        the restore operation by calling the  DescribeDirectories operation with the directory identifier.
        When the **DirectoryDescription.Stage** value changes to ``Active`` , the restore operation is
        complete.
    ...
    def share_directory(
        ...
        """
        Shares a specified directory (``DirectoryId`` ) in your AWS account (directory owner) with another
        AWS account (directory consumer). With this operation you can use your directory from any AWS
        account and from any Amazon VPC within an AWS Region.

        When you share your AWS Managed Microsoft AD directory, AWS Directory Service creates a shared
        ...
        accounts inside the same AWS organization (``ORGANIZATIONS`` ). It also determines whether you can
        share the directory with any other AWS account either inside or outside of the organization
        (``HANDSHAKE`` ).
        ...
        **Request Syntax**
        ...
        :param ShareNotes:
          ...
          A directory share request that is sent by the directory owner to the directory consumer. The
          request includes a typed message to help the directory consumer administrator determine whether to
        ...
        :param ShareMethod: **[REQUIRED]**
          ...
          The method used when sharing a directory to determine whether the directory should be shared
          within your AWS organization (``ORGANIZATIONS`` ) or with any AWS account by sending a directory
    ...
    def unshare_directory(
        self,
        DirectoryId: str,
        UnshareTarget: ClientUnshareDirectoryUnshareTargetTypeDef,
    ) -> ClientUnshareDirectoryResponseTypeDef:
        """
