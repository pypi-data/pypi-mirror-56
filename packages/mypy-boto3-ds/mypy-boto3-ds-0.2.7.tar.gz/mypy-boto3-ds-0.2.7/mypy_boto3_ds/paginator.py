"Main interface for ds Paginators"
...
class DescribeSharedDirectoriesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`DirectoryService.Client.describe_shared_directories`.
...
class ListIpRoutesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        DirectoryId: str,
        PaginationConfig: ListIpRoutesPaginatePaginationConfigTypeDef = None,
    ) -> ListIpRoutesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListLogSubscriptionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`DirectoryService.Client.list_log_subscriptions`.
