...
#############################################################################
import sys
from commandLineInterface.ioMenuSpec import ioMenuSpec
from axes.Axes3D import axes3D
from tools.nullTool import nullTool
from tools.ultimusExtruder import ultimusExtruder
...
__rootDir__ = Path.cwd().parent / 'polychemprint3_pkg' / 'polychemprint3'
