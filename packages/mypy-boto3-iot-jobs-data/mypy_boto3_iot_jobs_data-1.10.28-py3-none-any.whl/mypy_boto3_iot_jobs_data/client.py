"Main interface for iot-jobs-data Client"
...
class Client(BaseClient):
    ...
    def describe_job_execution(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/iot-jobs-data-2017-09-29/DescribeJobExecution>`_
        ...
        **Request Syntax**
        ...
        :param executionNumber:
          ...
          Optional. A number that identifies a particular job execution on a particular device. If
          not specified, the latest job execution is returned.
    ...
    def get_pending_job_executions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/iot-jobs-data-2017-09-29/GetPendingJobExecutions>`_
    ...
    def start_next_pending_job_execution(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/iot-jobs-data-2017-09-29/StartNextPendingJobExecution>`_
        ...
        **Request Syntax**
        ...
        :param stepTimeoutInMinutes:
          ...
          timer is reset (by calling ``UpdateJobExecution`` , setting the status to ``IN_PROGRESS``
          and specifying a new timeout value in field ``stepTimeoutInMinutes`` ) the job execution
          status will be automatically set to ``TIMED_OUT`` . Note that setting this timeout has no
          effect on that job execution timeout which may have been specified when the job was
    ...
    def update_job_execution(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/iot-jobs-data-2017-09-29/UpdateJobExecution>`_
        ...
        **Request Syntax**
        ...
        :param status: **[REQUIRED]**
          ...
          The new status for the job execution (IN_PROGRESS, FAILED, SUCCESS, or REJECTED). This
        ...
        :param stepTimeoutInMinutes:
          ...
          ``IN_PROGRESS`` and specifying a new timeout value in this field) the job execution status
          will be automatically set to ``TIMED_OUT`` . Note that setting or resetting this timeout
