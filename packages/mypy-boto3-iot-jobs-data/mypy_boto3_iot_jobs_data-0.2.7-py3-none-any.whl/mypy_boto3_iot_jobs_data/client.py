    ...
    def start_next_pending_job_execution(
        ...
        **Request Syntax**
        ...
        :param stepTimeoutInMinutes:
          ...
          timeout value in field ``stepTimeoutInMinutes`` ) the job execution status will be automatically
          set to ``TIMED_OUT`` . Note that setting this timeout has no effect on that job execution timeout
    ...
    def update_job_execution(
        ...
        **Request Syntax**
        ...
        :param stepTimeoutInMinutes:
          ...
          timeout value in this field) the job execution status will be automatically set to ``TIMED_OUT`` .
          Note that setting or resetting this timeout has no effect on that job execution timeout which may
