...
Mypy-friendly auto-generated type annotations for `boto3 application-insights 1.10.28` service.
...
session_client = session.client("application-insights")
...
```python
import boto3
from mypy_boto3.application_insights import Client
