...
let PAIJobRestServer = class PAIJobRestServer extends clusterJobRestServer_1.ClusterJobRestServer {
    constructor() {
        super();
        this.parameterFileMetaList = [];
        this.paiTrainingService = component.get(paiTrainingService_1.PAITrainingService);
    }
...
__decorate([
    ...
    __metadata("design:type", paiTrainingService_1.PAITrainingService)
], PAIJobRestServer.prototype, "paiTrainingService", void 0);
PAIJobRestServer = __decorate([
    component.Singleton,
