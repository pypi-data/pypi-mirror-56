            ...
            def go(char):
                ...
                def _(event):
                    ...
                    if True:#not '"' in after_line and not "'" in after_line:
                        ...
                        header_commands={'\\co':'copy','\\da':'delete all','\\pa':'paste','\\ya':'yapf autoformat','\\gg':'go to top','\\GG':'go to bottom','\\vO':'vim open up','\\vo':'vim open down','\\tts':'tabs to spaces','\\de':'debug','\\pu':'pudb'}
                        ...
                        for command,header in header_commands.items():
                            ...
                            if before_line.endswith(chopped_command) and char==key:
                                ...
                                if header=='pudb':
                                    toggle_top_line_text(buffer,"pip_import('pudb').set_trace()\n")
