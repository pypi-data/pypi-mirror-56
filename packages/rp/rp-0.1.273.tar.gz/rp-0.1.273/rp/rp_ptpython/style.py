...
slight={
    ...
    Token.Toolbar.Completions.Arrow:                      '#bf95bf bold      noinherit',
    Token.Toolbar.Completions.Completion:                 '#bf95bf           noinherit',
    Token.Toolbar.Completions.Completion.Current:         '#fa516a           noinherit',
    Token.Menu.Completions.Completion:                    '#ff95ff           noinherit',
    Token.Menu.Completions.Completion.Current:            '#ffa0f0           noinherit',
