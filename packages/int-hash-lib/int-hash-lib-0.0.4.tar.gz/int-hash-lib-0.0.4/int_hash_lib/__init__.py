...
def make_hash_from_dict(data: typing.Dict, salt: str, region: str,
                        first_only_keys: (typing.List, typing.Tuple), mapping: typing.Dict) -> typing.Dict:
    item = {}
...
def make_hash_from_csv(in_file, salt: str, region: str, schema, mapping: typing.Dict):
    try:
    ...
    with StringIO() as f:
        for idx, row in enumerate(rd):
            ...
            data = make_hash_from_dict(row_dict, salt, region, mapping)
