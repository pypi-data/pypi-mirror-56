...
class Client(BaseClient):
    ...
    def create_cluster(
        ...
        **Request Syntax**
        ...
        :param resourcesVpcConfig: **[REQUIRED]**
          ...
          Guide* . You must specify at least two subnets. You can specify up to five security groups, but we
          recommend that you use a dedicated security group for your cluster control plane.
          ...
          - **endpointPrivateAccess** *(boolean) --*
            ...
            private access for your Kubernetes API server. For more information, see `Amazon EKS Cluster
        ...
        :param logging:
          ...
          see `Amazon EKS Cluster Control Plane Logs
          <https://docs.aws.amazon.com/eks/latest/userguide/control-plane-logs.html>`__ in the * *Amazon EKS
          User Guide* * .
        ...
        **Request Syntax**
        ...
        :param scalingConfig:
          ...
          - **minSize** *(integer) --*
            ...
            The minimum number of worker nodes that the managed node group can scale in to. This number must
        ...
        :param nodeRole: **[REQUIRED]**
          ...
          IAM instance profile and associated policies. Before you can launch worker nodes and register them
          into a cluster, you must create an IAM role for those worker nodes to use when they are launched.
          For more information, see `Amazon EKS Worker Node IAM Role
    ...
    def list_clusters(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          sending another ``ListClusters`` request with the returned ``nextToken`` value. This value can be
          between 1 and 100. If you don't use this parameter, ``ListClusters`` returns up to 100 results and
    ...
    def list_updates(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          this parameter, ``ListUpdates`` returns only ``maxResults`` results in a single page along with a
          ``nextToken`` response element. You can see the remaining results of the initial request by
          sending another ``ListUpdates`` request with the returned ``nextToken`` value. This value can be
          between 1 and 100. If you don't use this parameter, ``ListUpdates`` returns up to 100 results and
          a ``nextToken`` value if applicable.
    ...
    def tag_resource(self, resourceArn: str, tags: Dict[str, str]) -> Dict[str, Any]:
        ...
        deleted, the tags associated with that resource are deleted as well. Tags that you create for Amazon
        EKS resources do not propagate to any other resources associated with the cluster. For example, if
        you tag a cluster with this operation, that tag does not automatically propagate to the subnets and
    ...
    def update_cluster_config(
        ...
        You can also use this API operation to enable or disable public and private access to your cluster's
        Kubernetes API server endpoint. By default, public access is enabled, and private access is
        disabled. For more information, see `Amazon EKS Cluster Endpoint Access Control
        <https://docs.aws.amazon.com/eks/latest/userguide/cluster-endpoint.html>`__ in the * *Amazon EKS
        User Guide* * .
        ...
        Cluster updates are asynchronous, and they should finish within a few minutes. During an update, the
        cluster status moves to ``UPDATING`` (this status transition is eventually consistent). When the
        update is complete (either ``Failed`` or ``Successful`` ), the cluster status moves to ``Active`` .
    ...
    def update_cluster_version(
        ...
        If your cluster has managed node groups attached to it, all of your node groups’ Kubernetes versions
        must match the cluster’s Kubernetes version in order to update the cluster to a new Kubernetes
        version.
    ...
    def update_nodegroup_config(
        ...
        node group update with the  DescribeUpdate API operation. Currently you can update the Kubernetes
    ...
    def update_nodegroup_version(
        ...
        not specifying a Kubernetes version in the request. You can update to the latest AMI version of your
        ...
        <https://docs.aws.amazon.com/eks/latest/userguide/eks-linux-ami-versions.html>`__ in the *Amazon EKS
        User Guide* .
