...
class CompletedEntryTest(LucteriosTest):
    ...
    def test_costaccounting_change(self):
        ...
        self.assert_json_equal('', '#costaccounting/headers/@3/@4', "%s")
        ...
        self.assert_json_equal('', '#costaccounting/headers/@4/@4', "%s")
        ...
        self.assert_json_equal('', '#costaccounting/headers/@5/@4', "%s")
