...
class ChartsAccountTest(LucteriosTest):
    ...
    def test_asset(self):
        ...
        self.assert_json_equal('', '#chartsaccount/headers/@2/@4', '{[font color="green"]}Crédit: %s{[/font]};{[font color="blue"]}Débit: %s{[/font]};%s')
        self.assert_json_equal('', '#chartsaccount/headers/@3/@0', 'current_total')
        self.assert_json_equal('', '#chartsaccount/headers/@3/@2', "C2EUR")
        self.assert_json_equal('', '#chartsaccount/headers/@3/@4', '{[font color="green"]}Crédit: %s{[/font]};{[font color="blue"]}Débit: %s{[/font]};%s')
        self.assert_json_equal('', '#chartsaccount/headers/@4/@0', 'current_validated')
        self.assert_json_equal('', '#chartsaccount/headers/@4/@2', "C2EUR")
        self.assert_json_equal('', '#chartsaccount/headers/@4/@4', '{[font color="green"]}Crédit: %s{[/font]};{[font color="blue"]}Débit: %s{[/font]};%s')
    ...
    def test_budget(self):
        ...
        self.assert_json_equal('', '#budget_revenue/headers/@1/@4', '{[font color="green"]}Crédit: %s{[/font]};{[font color="blue"]}Débit: %s{[/font]};%s')
        ...
        self.assert_json_equal('', '#budget_expense/headers/@1/@4', '{[font color="green"]}Crédit: %s{[/font]};{[font color="blue"]}Débit: %s{[/font]};%s')
...
class FiscalYearWorkflowTest(PaymentTest):
    ...
    def test_close(self):
        ...
        self.assert_json_equal('', '#third/headers/@2/@4', "%s")
        ...
        self.assert_json_equal('', 'entryline/@3/debit', -125.97)
        ...
        self.assert_json_equal('', 'entryline/@4/credit', 125.97)
