...
_writer_map = {
    "moab": (h5m_io, (), {}),
    "ansys-ascii": (ansys_io, (), {"binary": False}),
    "ansys-binary": (ansys_io, (), {"binary": True}),
    "gmsh2-ascii": (msh_io, ("2",), {"binary": False}),
    "gmsh2-binary": (msh_io, ("2",), {"binary": True}),
    "gmsh4-ascii": (msh_io, ("4",), {"binary": False}),
    "gmsh4-binary": (msh_io, ("4",), {"binary": True}),
    "med": (med_io, (), {}),
    "medit": (medit_io, (), {}),
    "dolfin-xml": (dolfin_io, (), {}),
    "off": (off_io, (), {}),
    "permas": (permas_io, (), {}),
    "stl-ascii": (stl_io, (), {"binary": False}),
    "stl-binary": (stl_io, (), {"binary": True}),
    "vtu-ascii": (vtu_io, (), {"binary": False}),
    "vtu": (vtu_io, (), {"binary": True}),
    "vtu-binary": (vtu_io, (), {"binary": True}),
    "vtk-ascii": (vtk_io, (), {"binary": False}),
    "vtk": (vtk_io, (), {"binary": True}),
    "vtk-binary": (vtk_io, (), {"binary": True}),
    "xdmf": (xdmf_io, (), {}),
    "xdmf3": (xdmf_io, (), {}),
