"Main interface for managedblockchain Client"
...
class Client(BaseClient):
    ...
    def create_member(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/CreateMember>`_
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken: **[REQUIRED]**
          ...
          operation. An idempotent operation completes no more than one time. This identifier is
          required only if you make a service request directly using an HTTP client. It is generated
    ...
    def create_network(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/CreateNetwork>`_
        ...
        :param VotingPolicy: **[REQUIRED]**
          ...
          - **ApprovalThresholdPolicy** *(dict) --*
            ...
            - **ThresholdPercentage** *(integer) --*
              ...
              ``ThresholdComparator`` determines the precise comparison. If a
            ...
            - **ProposalDurationInHours** *(integer) --*
              ...
              cast neither the required number of ``YES`` votes to approve the proposal nor the
              number of ``NO`` votes required to reject it before the duration expires, the proposal
              is ``EXPIRED`` and ``ProposalActions`` are not carried out.
    ...
    def create_node(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/CreateNode>`_
    ...
    def create_proposal(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/CreateProposal>`_
        ...
        **Request Syntax**
        ...
        :param MemberId: **[REQUIRED]**
          ...
          The unique identifier of the member that is creating the proposal. This identifier is
          especially useful for identifying the member making the proposal when multiple members
          exist in a single AWS account.
        ...
        :param Actions: **[REQUIRED]**
          ...
          - **Invitations** *(list) --*
            ...
            - *(dict) --*
              ...
              The ``InviteAction`` is carried out when a ``Proposal`` is ``APPROVED`` .
    ...
    def delete_member(self, NetworkId: str, MemberId: str) -> Dict[str, Any]:
        ...
        network. ``DeleteMember`` can only be called for a specified ``MemberId`` if the principal
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/DeleteMember>`_
    ...
    def delete_node(self, NetworkId: str, MemberId: str, NodeId: str) -> Dict[str, Any]:
        """
        Deletes a peer node from a member that your AWS account owns. All data on the node is lost
        and cannot be recovered.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/DeleteNode>`_
    ...
    def get_member(self, NetworkId: str, MemberId: str) -> ClientGetMemberResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/GetMember>`_
            ...
            - **Member** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                * ``DELETING`` - The member and all associated resources are in the process of being
                deleted. Either the AWS account that owns the member deleted it, or the member is
                ...
                * ``DELETED`` - The member can no longer participate on the network and all
                associated resources are deleted. Either the AWS account that owns the member
    ...
    def get_network(self, NetworkId: str) -> ClientGetNetworkResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/GetNetwork>`_
          ...
          - *(dict) --*
            ...
            - **Network** *(dict) --*
              ...
              - **VpcEndpointServiceName** *(string) --*
                ...
                use the VPC endpoint service name to create a VPC endpoint to access network
                resources.
              ...
              - **VotingPolicy** *(dict) --*
                ...
                - **ApprovalThresholdPolicy** *(dict) --*
                  ...
                  of ``YES`` votes required for the proposal to be approved and the duration of the
                  ...
                  - **ThresholdPercentage** *(integer) --*
                    ...
                    be approved. For example, a ``ThresholdPercentage`` value of ``50`` indicates
                    50%. The ``ThresholdComparator`` determines the precise comparison. If a
    ...
    def get_node(self, NetworkId: str, MemberId: str, NodeId: str) -> ClientGetNodeResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/GetNode>`_
    ...
    def get_proposal(self, NetworkId: str, ProposalId: str) -> ClientGetProposalResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/GetProposal>`_
            ...
            - **Proposal** *(dict) --*
              ...
              - **Actions** *(dict) --*
                ...
                - **Removals** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    a removal proposal that is ``APPROVED`` . The member and all associated
              ...
              - **Status** *(string) --*
                ...
                * ``EXPIRED`` - Members did not cast the number of votes required to determine the
                proposal outcome before the proposal expired. The specified ``ProposalActions`` are
                not carried out.
              ...
              - **ExpirationDate** *(datetime) --*
                ...
                After this date and time, if members have not cast enough votes to determine the
              ...
              - **OutstandingVoteCount** *(integer) --*
                ...
                the number of members minus the sum of ``YES`` votes and ``NO`` votes.
    ...
    def list_invitations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/ListInvitations>`_
            ...
            - **Invitations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ExpirationDate** *(datetime) --*
                  ...
                  ``ProposalThresholdPolicy`` . After this date and time, the invitee can no longer
                  create a member and join the network using this ``InvitationId`` .
                ...
                - **Status** *(string) --*
                  ...
                  * ``ACCEPTING`` - The invitee has begun creating a member, and creation has not
                  yet completed.
    ...
    def list_members(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/ListMembers>`_
        ...
        **Request Syntax**
        ...
        :param IsOwned:
          ...
          An optional Boolean value. If provided, the request is limited either to members that the
          current AWS account owns (``true`` ) or that other AWS accounts own (``false`` ). If
              ...
              - *(dict) --*
                ...
                - **Status** *(string) --*
                  ...
                  * ``DELETING`` - The member and all associated resources are in the process of
                  being deleted. Either the AWS account that owns the member deleted it, or the
                  member is being deleted as the result of an ``APPROVED``  ``PROPOSAL`` to remove
                  the member.
    ...
    def list_networks(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/ListNetworks>`_
        ...
        **Request Syntax**
        ...
        :param Framework:
          ...
          An optional framework specifier. If provided, only networks of this framework type are
          listed.

        :type Status: string
        :param Status:

          An optional status specifier. If provided, only networks currently in this status are
          listed.
    ...
    def list_nodes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/ListNodes>`_
    ...
    def list_proposal_votes(
        ...
        """
        Returns the listing of votes for a specified proposal, including the value of each vote and
        the unique identifier of the member that cast the vote.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/ListProposalVotes>`_
    ...
    def list_proposals(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/ListProposals>`_
            ...
            - **Proposals** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ExpirationDate** *(datetime) --*
                  ...
                  ``ProposalDurationInHours`` that is specified in the ``ProposalThresholdPolicy`` .
                  After this date and time, if members have not cast enough votes to determine the
                  outcome according to the voting policy, the proposal is ``EXPIRED`` and
    ...
    def reject_invitation(self, InvitationId: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/RejectInvitation>`_
    ...
    def vote_on_proposal(
        ...
        specified by ``VoterMemberId`` , must be in the same AWS account as the principal that calls
        the action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/managedblockchain-2018-09-24/VoteOnProposal>`_
