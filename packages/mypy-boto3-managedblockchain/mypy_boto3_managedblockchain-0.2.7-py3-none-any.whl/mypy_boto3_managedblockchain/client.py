...
class Client(BaseClient):
    ...
    def create_member(
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken: **[REQUIRED]**
          ...
          make a service request directly using an HTTP client. It is generated automatically if you use an
    ...
    def create_proposal(
        ...
        example, a proposal to add a new member to the network. Any member can create a proposal.
        ...
        **Request Syntax**
        ...
        :param MemberId: **[REQUIRED]**
          ...
          useful for identifying the member making the proposal when multiple members exist in a single AWS
          account.
    ...
    def delete_member(self, NetworkId: str, MemberId: str) -> Dict[str, Any]:
        ...
        performing the action is associated with the AWS account that owns the member. In all other cases,
        the ``DeleteMember`` action is carried out as the result of an approved proposal to remove a member.
        If ``MemberId`` is the last member in a network specified by the last AWS account, the network is
        deleted also.
            ...
            - **Member** *(dict) --*
              ...
              - **FrameworkAttributes** *(dict) --*
                ...
                - **Fabric** *(dict) --*
                  ...
                  Attributes of Hyperledger Fabric relevant to a member on a Managed Blockchain network that
              ...
              - **Status** *(string) --*
                ...
                * ``DELETED`` - The member can no longer participate on the network and all associated
                resources are deleted. Either the AWS account that owns the member deleted it, or the member
                is being deleted as the result of an ``APPROVED``  ``PROPOSAL`` to remove the member.
          ...
          - *(dict) --*
            ...
            - **Proposal** *(dict) --*
              ...
              - **ExpirationDate** *(datetime) --*
                ...
                this date and time, if members have not cast enough votes to determine the outcome according
                to the voting policy, the proposal is ``EXPIRED`` and ``Actions`` are not carried out.
    ...
    def list_members(
        ...
        **Request Syntax**
        ...
        :param IsOwned:
          ...
          AWS account owns (``true`` ) or that other AWS accounts own (``false`` ). If omitted, all members
          are listed.
    ...
    def list_proposal_votes(
        ...
        """
        Returns the listing of votes for a specified proposal, including the value of each vote and the
    ...
    def vote_on_proposal(
        ...
        """
        Casts a vote for a specified ``ProposalId`` on behalf of a member. The member to vote as, specified
        by ``VoterMemberId`` , must be in the same AWS account as the principal that calls the action.
