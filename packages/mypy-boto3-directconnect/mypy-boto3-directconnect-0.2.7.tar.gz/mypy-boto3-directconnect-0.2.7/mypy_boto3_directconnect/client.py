...
class Client(BaseClient):
    ...
    def allocate_hosted_connection(
        ...
        for the specified capacity and the AWS Direct Connect Partner must also police the hosted connection
    ...
    def allocate_public_virtual_interface(
        ...
        The owner of a connection calls this function to provision a public virtual interface to be owned by
    ...
    def associate_connection_with_lag(
        ...
        and re-established as a member of the LAG (connectivity to AWS is interrupted). The connection must
        be hosted on the same AWS Direct Connect endpoint as the LAG, and its bandwidth must match the
        bandwidth for the LAG. You can re-associate a connection that's currently associated with a
        different LAG; however, if removing the connection would cause the original LAG to fall below its
    ...
    def create_interconnect(
        ...
        An interconnect is a connection that is capable of hosting other connections. The AWS Direct Connect
        partner can use an interconnect to provide AWS Direct Connect hosted connections to customers
        through their own network services. Like a standard connection, an interconnect links the partner's
        network to an AWS Direct Connect location over a standard Ethernet fiber-optic cable. One end is
        connected to the partner's router, the other to an AWS Direct Connect router.

        You can automatically add the new interconnect to a link aggregation group (LAG) by specifying a LAG
        ID in the request. This ensures that the new interconnect is allocated on the same AWS Direct
    ...
    def create_transit_virtual_interface(
        ...
        .. warning::
          ...
          For example, if you use the default ASN 64512 for both your the transit gateway and Direct Connect
    ...
    def delete_direct_connect_gateway_association(
        ...
        own virtual gateway and a Direct Connect gateway association, you can specify the
    ...
    def describe_connection_loa(
        ...
        **Request Syntax**
        ...
        :param providerName:
          ...
          you specify this parameter, the LOA-CFA lists the provider name alongside your company name as the
    ...
    def describe_direct_connect_gateway_associations(
        ...
        gateways associated with the virtual private gateway. If you specify both, the response contains the
        association between the Direct Connect gateway and the virtual private gateway.
    ...
    def describe_virtual_interfaces(
        ...
        before you make the request are also returned. If you specify a connection ID, only the virtual
        interfaces associated with the connection are returned. If you specify a virtual interface ID, then
    ...
    def disassociate_connection_from_lag(
        ...
        If disassociating the connection would cause the LAG to fall below its setting for minimum number of
        operational connections, the request fails, except when it's the last member of the LAG. If all
    ...
    def update_virtual_interface_attributes(
        ...
        network connectivity for all virtual interfaces associated with the connection for up to 30 seconds.
        To check whether your connection supports jumbo frames, call  DescribeConnections . To check whether
