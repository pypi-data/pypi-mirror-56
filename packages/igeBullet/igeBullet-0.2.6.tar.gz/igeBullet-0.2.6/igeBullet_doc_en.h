/////////////////////////////////////
/////////////////////////////////////
PyDoc_STRVAR(constraint_doc, "3d physics constraint");
...
PyDoc_STRVAR(rayTestOne_doc,
	...
	"         'hitPosition': tuple(x,y,z),\n"\
	"         'hitNormal' : tuple(x,y,z),\n"\
	"         'index' : int}");
...
PyDoc_STRVAR(contactTest_doc,
	...
	"      'localPosA' : tuple(x,y,z),\n"\
	"      'localPosB' : tuple(x,y,z),\n"\
	"      'worldPosA' : tuple(x,y,z),\n"\
	"      'worldPosB' : tuple(x,y,z),\n"\
	"      'normal' : tuple(x,y,z)}, {}, {},...)\n");
