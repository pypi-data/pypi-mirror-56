...
def get_model(config):
    ...
    temp_input = embeddings, hist_time_input, hist_time_gaps_input

    query_encoding = Attention(config)(temp_input)
    all_feature = layers.Concatenate(axis=-1)([query_encoding, cross_feature, user_feature])
