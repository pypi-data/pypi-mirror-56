...
class MQTest:
    ...
    def __copy_queue_output(self, copy_queue, msgflow):
        ...
        file.copy_dir_files(src_folder, dst_folder)
    ...
    def __save_queue_message(self, file, queue, content):
        ...
        file.write_file(abs_file, content)
    ...
    def __put_file(self, path_to_file, file):
        ...
        content = file.read_file_string(abs_file)
                ...
                for output_queue in self.output_queues:
                    ...
                    if output_amount == 1:
                        ...
                        for j in range(output_amount):
                            ...
                            self.__save_queue_message(file.add_suffix(input_file, j + 1), output_queue,
                                                      output_message)
