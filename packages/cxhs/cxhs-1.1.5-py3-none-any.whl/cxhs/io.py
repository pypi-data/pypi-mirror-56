...
import string
from cxhs.grid import HGridBuilder, HDictBuilder
from cxhs.val import HMarker, HBool, HStr, HNum, HDate, HRef, HTime, HTimeZone, HDateTime, HUri, is_id_char
...
def isSpecialUnit(c):
	if c == "":
		return False
	return c in SPECIAL_UNIT_CHARS
