...
class Client(BaseClient):
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **recentIntentSummaryView** *(list) --*
              ...
              An array of information about the intents used in the session. The array can contain a maximum
              of three summaries. If more than three intents are used in the session, the
    ...
    def post_content(
        ...
        **Request Syntax**
        ...
        :param userId: **[REQUIRED]**
          ...
          The ID of the client application user. Amazon Lex uses this to identify a user's conversation with
          your bot. At runtime, each request must contain the ``userID`` field.
          ...
          * A user can't have two independent conversations with two different versions of the same bot. For
          ...
          anticipate that a user will need to have conversation with two different versions, for example,
        ...
        :param requestAttributes:
          ...
          Request-specific information passed between Amazon Lex and a client application. The value must be
    ...
    def post_text(
        ...
        * After the user replies to a confirmation prompt with a "yes", Amazon Lex might return a conclusion
        ...
        might use to enhance client behavior, for example, to display the appropriate client user interface.
        These are the ``slotToElicit`` , ``dialogState`` , ``intentName`` , and ``slots`` fields in the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **dialogState** *(string) --*
              ...
              * ``ConfirmIntent`` - Amazon Lex is expecting a "yes" or "no" response.  For example, Amazon
              Lex wants user confirmation before fulfilling an intent.  Instead of a simple "yes" or "no," a
              user might respond with additional information. For example, "yes, but make it thick crust
              ...
              * ``ElicitSlot`` - Amazon Lex is expecting a slot value for the current intent.  For example,
              suppose that in the response Amazon Lex sends this message: "What size pizza would you like?".
              A user might reply with the slot value (e.g., "medium"). The user might also provide
            ...
            - **responseCard** *(dict) --*
              ...
              come from the bot configuration (in the Amazon Lex console, choose the settings button next to
              a slot) or from a code hook (Lambda function).
        ...
        **Request Syntax**
        ...
        :param recentIntentSummaryView:
          ...
          * ``slotToElict``
          ...
          the new summary view replaces the old summary view. For example, if a ``GetSession`` request
