...
class Client(BaseClient):
        ...
        **Request Syntax**
        ...
        :param configData: **[REQUIRED]**
          ...
          - **antennaDownlinkConfig** *(dict) --*
            ...
            Information about how AWS Ground Station should configure an antenna for downlink during
            a contact.
          ...
          - **trackingConfig** *(dict) --*
            ...
            this ``Config`` in the mission profile.
    ...
    def create_dataflow_endpoint_group(
        ...
        When a contact uses multiple ``DataflowEndpointConfig`` objects, each ``Config`` must match
        a ``DataflowEndpoint`` in the same group.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_config(self, configId: str, configType: str) -> ClientDeleteConfigResponseTypeDef:
        """
        Deletes a ``Config`` .
          ...
          **Response Syntax**
          ...
          ::

            {
                'contactId': 'string',
                'contactStatus':
                'AVAILABLE'|'AWS_CANCELLED'|'CANCELLED'|'COMPLETED'|'FAILED'
                |'FAILED_TO_SCHEDULE'|'PASS'|'POSTPASS'|'PREPASS'|'SCHEDULED'|'SCHEDULING',
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_config(self, configId: str, configType: str) -> ClientGetConfigResponseTypeDef:
        """
    ...
    def list_configs(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Next token returned in the request of a previous ``ListConfigs`` call. Used to get the
                ...
                'configList': [
                    {
                        ...
                        'configId': 'string',
                        'configType':
                        'antenna-downlink'|'antenna-downlink-demod-decode'
                        |'antenna-uplink'|'dataflow-endpoint'|'tracking'
                        |'uplink-echo',
                        'name': 'string'
                    },
                ],
    ...
    def list_contacts(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Next token returned in the request of a previous ``ListContacts`` call. Used to get the
          next page of results.
                ...
                'contactList': [
                    {
                        ...
                        'contactStatus':
                        'AVAILABLE'|'AWS_CANCELLED'|'CANCELLED'|'COMPLETED'|'FAILED'
                        |'FAILED_TO_SCHEDULE'|'PASS'|'POSTPASS'|'PREPASS'
    ...
    def list_dataflow_endpoint_groups(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Next token returned in the request of a previous ``ListDataflowEndpointGroups`` call. Used
    ...
    def list_mission_profiles(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          Next token returned in the request of a previous ``ListMissionProfiles`` call. Used to get
          the next page of results.
