...
class Client(BaseClient):
    ...
    def delete_tags(
        ...
        """
        Deletes the association between configuration items and one or more tags. This API accepts a list
                ...
                'descriptions': [
                    {
                        'exportId': 'string',
                        'status':
                        'START_IN_PROGRESS'|'START_FAILED'|'ACTIVE'|'ERROR'|'STOP_IN_PROGRESS'
                        |'STOP_FAILED'|'INACTIVE',
                        'statusDetail': 'string',
                        's3Bucket': 'string',
    ...
    def describe_export_tasks(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          When this parameter is used, ``DescribeExportTasks`` only returns ``maxResults`` results in a
    ...
    def describe_import_tasks(
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          ``DescribeImportTask`` request to a specific subset of results. Currently, wildcard values aren't
                ...
                'tasks': [
                    {
                        ...
                        'importUrl': 'string',
                        'status':
                        'IMPORT_IN_PROGRESS'|'IMPORT_COMPLETE'|'IMPORT_COMPLETE_WITH_ERRORS'
                        |'IMPORT_FAILED'|'IMPORT_FAILED_SERVER_LIMIT_EXCEEDED'
                        |'IMPORT_FAILED_RECORD_LIMIT_EXCEEDED'|'DELETE_IN_PROGRESS'|'DELETE_COMPLETE'
                        |'DELETE_FAILED'|'DELETE_FAILED_LIMIT_EXCEEDED'|'INTERNAL_ERROR',
    ...
    def describe_tags(
        ...
        """
        Retrieves a list of configuration items that have tags as specified by the key-value pairs, name
        and value, passed to the optional parameter ``filters`` .
    ...
    def get_discovery_summary(
        ...
        This API operation takes no request parameters and is called as is at the command prompt as shown
        in the example.
    ...
    def list_configurations(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          set of 10 results along with a token. Use that token in this query to get the next set of 10.
    ...
    def start_data_collection_by_agent_ids(
        ...
        **Request Syntax**
        ...
        :param agentIds: **[REQUIRED]**
          ...
          the service does not throw an exception. Instead, it returns the error in the *Description*
          field. If you send a request to multiple agents/connectors and you do not have permission to
          contact some of those agents/connectors, the system does not throw an exception. Instead, the
    ...
    def start_import_task(
        ...
        Connector or Discovery Agent. This gives you the option to perform migration assessment and
        planning directly from your imported data, including the ability to group your devices as
        ...
        * Use the console or the ``StartImportTask`` command with the AWS CLI or one of the AWS SDKs to
        ...
        <https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-import.html>`__ in
        ...
        .. note::
          ...
          <https://docs.aws.amazon.com/application-discovery/latest/userguide/ads_service_limits.html>`__
