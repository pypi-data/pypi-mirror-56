...
class Client(BaseClient):
    ...
    def batch_delete_import_data(
        ...
        contains records that were used to match, the information in those matched records that
    ...
    def create_tags(
        ...
        **Request Syntax**
        ...
        :param tags: **[REQUIRED]**
          ...
          that you want to create in a *key* -*value* format. For example:
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_tags(
        self, configurationIds: List[str], tags: List[ClientDeleteTagstagsTypeDef] = None
    ) -> Dict[str, Any]:
        """
        ...
        **Request Syntax**
        ...
        :param tags:
          ...
          you want to delete in a *key* -*value* format. For example:
    ...
    def describe_agents(
        ...
        **Request Syntax**
        ...
        :param agentIds:
          ...
          The agent or the Connector IDs for which you want information. If you specify no IDs, the
          system returns information about all agents/Connectors associated with your AWS user
          account.
                ...
                'agentsInfo': [
                    {
                        ...
                        'version': 'string',
                        'health':
                        'HEALTHY'|'UNHEALTHY'|'RUNNING'|'UNKNOWN'|'BLACKLISTED'
                        |'SHUTDOWN',
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **agentsInfo** *(list) --*
              ...
              agent/Connector IDs, IP addresses, media access control (MAC) addresses,
              agent/Connector health, host name where the agent/Connector resides, and the version
    ...
    def describe_continuous_exports(
        ...
        can be listed if you call ``DescribeContinuousExports`` as is without passing any
        parameters.
                ...
                'descriptions': [
                    {
                        'exportId': 'string',
                        'status':
                        'START_IN_PROGRESS'|'START_FAILED'|'ACTIVE'|'ERROR'
                        |'STOP_IN_PROGRESS'|'STOP_FAILED'|'INACTIVE',
                        'statusDetail': 'string',
                        's3Bucket': 'string',
              ...
              - *(dict) --*
                ...
                - **statusDetail** *(string) --*
                  ...
                  * ACCESS_DENIED - You don’t have permission to start Data Exploration in Amazon
                  Athena. Contact your AWS administrator for help. For more information, see
                  `Setting Up AWS Application Discovery Service
                  <http://docs.aws.amazon.com/application-discovery/latest/userguide/setting-up.html>`__
                  ...
                  * DELIVERY_STREAM_LIMIT_FAILURE - You reached the limit for Amazon Kinesis Data
                  ...
                  <http://docs.aws.amazon.com/streams/latest/dev/service-sizes-and-limits.html>`__
                  in the Amazon Kinesis Data Streams Developer Guide.

                  * FIREHOSE_ROLE_MISSING - The Data Exploration feature is in an error state
                  because your IAM User is missing the AWSApplicationDiscoveryServiceFirehose role.
                  Turn on Data Exploration in Amazon Athena and try again. For more information, see
                  `Step 3\\: Provide Application Discovery Service Access to Non-Administrator Users
                  ...
                  * INTERNAL_FAILURE - The Data Exploration feature is in an error state because of
                  an internal failure. Try again later. If this problem persists, contact AWS
                  Support.
                  ...
                  * S3_BUCKET_LIMIT_FAILURE - You reached the limit for Amazon S3 buckets. Reduce
                  ...
                  more information, see `Bucket Restrictions and Limitations
                  <http://docs.aws.amazon.com/AmazonS3/latest/dev/BucketRestrictions.html>`__ in the
        ...
        :param filters:
          ...
          * ``AgentId`` - ID of the agent whose collected data will be exported
          ...
          - *(dict) --*
            ...
            for export using the `StartExportTask
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **exportsInfo** *(list) --*
              ...
              ``SUCCEEDED`` , the response includes a URL for an Amazon S3 bucket where you can view
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          - *(dict) --*
            ...
            A name-values pair of elements you can use to filter the results when querying your
            import tasks. Currently, wildcards are not supported for filters.
                ...
                'tasks': [
                    {
                        ...
                        |'IMPORT_COMPLETE_WITH_ERRORS'|'IMPORT_FAILED'
            ...
            - **tasks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **clientRequestToken** *(string) --*
                  ...
                  once. If you didn't provide a token, a token was automatically generated when the
                  import task request was sent.

                - **name** *(string) --*

                  A descriptive name for an import task. You can use this name to filter future
                  requests related to this import task, such as identifying applications and servers
                  that were included in this import task. We recommend that you use a meaningful
                  name for each import task.
                ...
                - **errorsAndFailedEntriesZip** *(string) --*
                  ...
                  log and a file of failed records. You can use these two files to quickly identify
                  records that failed, why they failed, and correct those records. Afterward, you
                  can upload the corrected file to your Amazon S3 bucket and create another import
                  task request.
                  ...
                  the failed entries file and then imports that failed entries file. This prevents
                  you from having to correct and update the larger original file and attempt
                  importing it again.
    ...
    def describe_tags(
        ...
        * configurationId
        ...
        Also, all configuration items associated with your user account that have tags can be listed
        if you call ``DescribeTags`` as is without passing any parameters.
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          You can filter the list using a *key* -*value* format. You can separate these items by
    ...
    def export_configurations(
        ...
        enables you to view and evaluate the data. Data includes tags and tag associations,
        processes, connections, servers, and system performance. This API returns an export ID that
        you can query using the *DescribeExportConfigurations* API. The system imposes a limit of
    ...
    def list_configurations(
        ...
        paramater ``configurationType`` . Optional filtering may be applied to refine search
        results.
        ...
        **Request Syntax**
        ...
        :param orderBy:
          ...
          For a list of output characteristics for each filter, see `Using the ListConfigurations
          Action
          <http://docs.aws.amazon.com/application-discovery/latest/APIReference/discovery-api-queries.html#ListConfigurations>`__
          .
    ...
    def start_data_collection_by_agent_ids(
        ...
        **Request Syntax**
        ...
        :param agentIds: **[REQUIRED]**
          ...
          request to an agent/connector ID that you do not have permission to contact, according to
          your AWS account, the service does not throw an exception. Instead, it returns the error
          in the *Description* field. If you send a request to multiple agents/connectors and you do
          not have permission to contact some of those agents/connectors, the system does not throw
            ...
            - **agentsConfigurationStatus** *(list) --*
              ...
              - *(dict) --*
                ...
                - **operationSucceeded** *(boolean) --*
                  ...
                  operation. The agent/connector receives this command the next time it polls for a
                  new command.
    ...
    def start_export_task(
        ...
        performance details. A time range for exported agent data may be set by using ``startTime``
        and ``endTime`` . Export of detailed agent data is limited to five concurrently running
        exports.

        If you do not include an ``agentIds`` filter, summary data is exported that includes both
        AWS Agentless Discovery Connector data and summary data from AWS Discovery Agents. Export of
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          ignored and exported data includes both Agentless Discovery Connector data and summary
          data from Application Discovery agents.
        ...
        :param startTime:
          ...
          The start timestamp for exported data from the single Application Discovery Agent selected
          in the filters. If no value is specified, data is exported starting from the first data
    ...
    def start_import_task(
        ...
        directly into AWS without having to use the Application Discovery Service (ADS) tools such
        as the Discovery Connector or Discovery Agent. This gives you the option to perform
        ...
        * Download the specially formatted comma separated value (CSV) import template, which you
        can find here:
        ...
        * Upload your import file to an Amazon S3 bucket, and make a note of it's Object URL. Your
        import file must be in the CSV format.

        * Use the console or the ``StartImportTask`` command with the AWS CLI or one of the AWS SDKs
        to import the records from your file.

        For more information, including step-by-step procedures, see `Migration Hub Import
        <https://docs.aws.amazon.com/application-discovery/latest/userguide/discovery-import.html>`__
        in the *AWS Application Discovery Service User Guide* .

        .. note::

          There are limits to the number of import tasks you can create (and delete) in an AWS
          account. For more information, see `AWS Application Discovery Service Limits
          ...
          - *(dict) --*
            ...
            - **task** *(dict) --*
              ...
              - **name** *(string) --*
                ...
                A descriptive name for an import task. You can use this name to filter future
                requests related to this import task, such as identifying applications and servers
                that were included in this import task. We recommend that you use a meaningful name
              ...
              - **errorsAndFailedEntriesZip** *(string) --*
                ...
                and a file of failed records. You can use these two files to quickly identify
                records that failed, why they failed, and correct those records. Afterward, you can
                upload the corrected file to your Amazon S3 bucket and create another import task
                request.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def stop_continuous_export(self, exportId: str) -> ClientStopContinuousExportResponseTypeDef:
        """
