...
setup(
    name='p2api',
    version='0.97.3',
    # Note, version 0.97, 0.98, 0.98.1 & 0.98.2 can not be used on pypi
    # as they were already used, then deleted when version was "rolled back"
    # to 0.96.1
    # So logically, next api change version should go to 0.97.1...
    # then 0.98.3...
