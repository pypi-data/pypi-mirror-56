"Main interface for glue Paginators"
...
class GetCrawlersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Glue.Client.get_crawlers`.
...
class GetDatabasesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Glue.Client.get_databases`.
...
class GetJobRunsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        JobName: str,
        PaginationConfig: GetJobRunsPaginatePaginationConfigTypeDef = None,
    ) -> GetJobRunsPaginateResponseTypeDef:
        """
...
class GetJobsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Glue.Client.get_jobs`.
...
class GetPartitionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from :py:meth:`Glue.Client.get_partitions`.
