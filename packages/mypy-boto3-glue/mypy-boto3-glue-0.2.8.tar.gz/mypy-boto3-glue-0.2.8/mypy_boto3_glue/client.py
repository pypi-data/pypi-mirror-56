...
class Client(BaseClient):
        ...
        :param PartitionInputList: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              Amazon S3 prefix. Otherwise AWS Glue will add the values to the wrong keys.
    ...
    def batch_get_dev_endpoints(
        ...
        calling the ``ListDevEndpoints`` operation, you can call this operation to access the data
    ...
    def batch_get_jobs(self, JobNames: List[str]) -> ClientBatchGetJobsResponseTypeDef:
        ...
        ``ListJobs`` operation, you can call this operation to access the data to which you have
        been granted permissions. This operation supports all IAM permissions, including permission
        conditions that uses tags.
    ...
    def batch_get_workflows(
        ...
        ``ListWorkflows`` operation, you can call this operation to access the data to which you
        have been granted permissions. This operation supports all IAM permissions, including
                                ...
                                'Nodes': [
                                    {
                                        ...
                                        'TriggerDetails': {
                                            'Trigger': {
                                                ...
                                                'CREATING'
                                                |'CREATED'
                                                |'ACTIVATING'|'ACTIVATED'|'DEACTIVATING'|'DEACTIVATED'|'DELETING'
                                                |'UPDATING',
                                                'Description': 'string',
                                                'Schedule': 'string',
                                                'Actions': [
                            ...
                            - **Actions** *(list) --*
                              ...
                              - *(dict) --*
                                ...
                                - **Arguments** *(dict) --*
                                  ...
                                  to set up your job, see the `Special Parameters Used by AWS Glue
                                  <https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-etl-glue-arguments.html>`__
                                  topic in the developer guide.
                              ...
                              - **Conditions** *(list) --*
                                ...
                                - *(dict) --*
                                  ...
                                  - **JobName** *(string) --*
                                    ...
                                    The name of the job whose ``JobRuns`` this condition applies to,
                          ...
                          - **JobRuns** *(list) --*
                            ...
                            - *(dict) --*
                              ...
                              - **Arguments** *(dict) --*
                                ...
                                set up your job, see the `Special Parameters Used by AWS Glue
                                <https://docs.aws.amazon.com/glue/latest/dg/aws-glue-programming-etl-glue-arguments.html>`__
                                topic in the developer guide.
                              ...
                              - **MaxCapacity** *(float) --*
                                ...
                                * When you specify a Python shell job (``JobCommand.Name``
                                =
                                    "pythonshell"), you can allocate either 0.0625 or 1 DPU. The
                                default is 0.0625 DPU.

                                * When you specify an Apache Spark ETL job (``JobCommand.Name``
                                =
                                    "glueetl"), you can allocate from 2 to 100 DPUs. The default is 10
                              ...
                              - **WorkerType** *(string) --*
                                ...
                                * For the ``Standard`` worker type, each worker provides 4 vCPU, 16
                                GB of memory and a 50GB disk, and 2 executors per worker.

                                * For the ``G.1X`` worker type, each worker provides 4 vCPU, 16 GB
                                of memory and a 64GB disk, and 1 executor per worker.

                                * For the ``G.2X`` worker type, each worker provides 8 vCPU, 32 GB
                              ...
                              - **LogGroupName** *(string) --*
                                ...
                                ``NONE`` . If you add a role name and ``SecurityConfiguration`` name
                                (in other words,
                ...
                - **Graph** *(dict) --*
                        ...
                        - **JobRuns** *(list) --*
                          ...
                          - *(dict) --*
                            ...
                            - **AllocatedCapacity** *(integer) --*
                              ...
                              `AWS Glue pricing page <https://aws.amazon.com/glue/pricing/>`__ .
                            ...
                            - **LogGroupName** *(string) --*
                              ...
                              words, ``/aws-glue/jobs-yourRoleName-yourSecurityConfigurationName/``
                              ), then that security configuration is used to encrypt the log group.
                  ...
                  - **Edges** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      An edge represents a directed connection between two AWS Glue components which
        ...
        **Request Syntax**
        ...
        :param XMLClassifier:
          ...
          - **RowTag** *(string) --*
            ...
            tag (for example, ``<row item_a="A" item_b="B"></row>`` is okay, but ``<row item_a=
                "A"
            item_b="B" />`` is not).
        ...
        :param ConnectionInput: **[REQUIRED]**
          ...
          - **PhysicalConnectionRequirements** *(dict) --*
            ...
            - **AvailabilityZone** *(string) --*
              ...
              subnet implies the Availability Zone to be used. Currently the field must be
              populated, but it will be deprecated in the future.
    ...
    def create_crawler(
        ...
        least one crawl target must be specified, in the ``s3Targets`` field, the ``jdbcTargets``
        field, or the ``DynamoDBTargets`` field.
        ...
        **Request Syntax**
        ...
        :param Configuration:
          ...
          The crawler configuration information. This versioned JSON string allows users to specify
        ...
        :param Tags:
          ...
          crawler. For more information, see `AWS Tags in AWS Glue
        ...
        **Request Syntax**
        ...
        :param PublicKeys:
          ...
          .. note::
            ...
            able to set a list of public keys. Call the ``UpdateDevEndpoint`` API with the public
        ...
        :param Tags:
          ...
          DevEndpoint. For more information about tags in AWS Glue, see `AWS Tags in AWS Glue
          ...
          - *(dict) --*
            ...
            - **Arguments** *(dict) --*
              ...
              * ``"GLUE_PYTHON_VERSION": "2"``
              ...
              You can specify a version of Python support for development endpoints by using the
              ``Arguments`` parameter in the ``CreateDevEndpoint`` or ``UpdateDevEndpoint`` APIs. If
    ...
    def create_ml_transform(
        ...
        """
        Creates an AWS Glue machine learning transform. This operation creates the transform and all
        the necessary parameters to train it.
        ...
        You must also specify certain parameters for the tasks that AWS Glue runs on your behalf as
        part of learning from your data and creating a high-quality machine learning transform.
        These parameters include ``Role`` , and optionally, ``AllocatedCapacity`` , ``Timeout`` ,
        and ``MaxRetries`` . For more information, see `Jobs
        ...
        **Request Syntax**
        ...
        :param Role: **[REQUIRED]**
          ...
          required permissions include both AWS Glue service role permissions to AWS Glue resources,
        ...
        :param Timeout:
          ...
          The timeout of the task run for this transform in minutes. This is the maximum time that a
    ...
    def delete_database(self, Name: str, CatalogId: str = None) -> Dict[str, Any]:
        ...
        .. note::
          ...
          the deleted database. AWS Glue deletes these "orphaned" resources asynchronously in a
    ...
    def delete_table_version(
        ...
        **Request Syntax**
        ...
        :param VersionId: **[REQUIRED]**
          ...
          The ID of the table version to be deleted. A ``VersionID`` is a string representation of
          an integer. Each version is incremented by 1.
            ...
            - **Classifier** *(dict) --*
              ...
              - **GrokClassifier** *(dict) --*
                ...
                - **GrokPattern** *(string) --*
                  ...
                  see built-in patterns in `Writing Custom Classifiers
            ...
            - **Connection** *(dict) --*
              ...
              - **ConnectionProperties** *(dict) --*
                ...
                * ``SKIP_CUSTOM_JDBC_CERT_VALIDATION`` - By default, this is ``false`` . AWS Glue
                ...
                the key length must be at least 2048. You can set the value of this property to
                ``true`` to skip AWS Glue’s validation of the customer certificate.
          ...
          - *(dict) --*
            ...
            - **DataCatalogEncryptionSettings** *(dict) --*
              ...
              - **ConnectionPasswordEncryption** *(dict) --*
                ...
                ``UpdateConnection`` and store it in the ``ENCRYPTED_PASSWORD`` field in the
                connection properties. You can enable catalog encryption or only password
                encryption.

                - **ReturnConnectionPasswordEncrypted** *(boolean) --*

                  When the ``ReturnConnectionPasswordEncrypted`` flag is set to "true", passwords
                  remain encrypted in the responses of ``GetConnection`` and ``GetConnections`` .
                ...
                - **AwsKmsKeyId** *(string) --*
                  ...
                  specified AWS KMS key, to encrypt passwords before storing them in the Data
                  Catalog.
    ...
    def get_dev_endpoint(self, EndpointName: str) -> ClientGetDevEndpointResponseTypeDef:
        ...
        .. note::
          ...
          create a non-VPC development endpoint, AWS Glue returns only a public IP address.
          ...
          - *(dict) --*
            ...
            - **DevEndpoint** *(dict) --*
              ...
              - **PrivateAddress** *(string) --*
                ...
                A private IP address to access the ``DevEndpoint`` within a VPC if the
                ``DevEndpoint`` is created within one. The ``PrivateAddress`` field is present only
                when you create the ``DevEndpoint`` within your VPC.
              ...
              - **WorkerType** *(string) --*
                ...
                * For the ``Standard`` worker type, each worker provides 4 vCPU, 16 GB of memory and
                a 50GB disk, and 2 executors per worker.
              ...
              - **GlueVersion** *(string) --*
                ...
                You can specify a version of Python support for development endpoints by using the
                ``Arguments`` parameter in the ``CreateDevEndpoint`` or ``UpdateDevEndpoint`` APIs.
              ...
              - **PublicKeys** *(list) --*
                ...
                .. note::
                  ...
                  to be able to set a list of public keys. Call the ``UpdateDevEndpoint`` API
                  operation with the public key content in the ``deletePublicKeys`` attribute, and
                  the list of new keys in the ``addPublicKeys`` attribute.
    ...
    def get_job(self, JobName: str) -> ClientGetJobResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetJob>`_
          ...
          - *(dict) --*
            ...
            - **Job** *(dict) --*
              ...
              - **MaxCapacity** *(float) --*
                ...
                of compute capacity and 16 GB of memory. For more information, see the `AWS Glue
          ...
          - *(dict) --*
            ...
            - **JobRun** *(dict) --*
              ...
              - **AllocatedCapacity** *(integer) --*
                ...
                The number of AWS Glue data processing units (DPUs) allocated to this JobRun. From 2
                to 100 DPUs can be allocated; the default is 10. A DPU is a relative measure of
              ...
              - **MaxCapacity** *(float) --*
                ...
                job runs. A DPU is a relative measure of processing power that consists of 4 vCPUs
                of compute capacity and 16 GB of memory. For more information, see the `AWS Glue
                pricing page <https://docs.aws.amazon.com/https:/aws.amazon.com/glue/pricing/>`__ .
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'Properties': {
                    'TaskType':
                    'EVALUATION'|'LABELING_SET_GENERATION'|'IMPORT_LABELS'
                    |'EXPORT_LABELS'|'FIND_MATCHES',
    ...
    def get_ml_task_runs(
        ...
        ``GetMLTaskRuns`` with their parent transform's ``TransformID`` and other optional
                ...
                'TaskRuns': [
                    {
                        ...
                        'Properties': {
                            'TaskType':
                            'EVALUATION'|'LABELING_SET_GENERATION'
    ...
    def get_ml_transform(self, TransformId: str) -> ClientGetMlTransformResponseTypeDef:
        ...
        by humans. These transformations are then saved by AWS Glue. You can retrieve their metadata
        by calling ``GetMLTransform`` .
          ...
          - *(dict) --*
            ...
            - **Parameters** *(dict) --*
              ...
              - **FindMatchesParameters** *(dict) --*
                ...
                - **PrecisionRecallTradeoff** *(float) --*
                  ...
                  recall. A value of 0.5 means no preference; a value of 1.0 means a bias purely for
                  precision, and a value of 0.0 means a bias for recall. Because this is a tradeoff,
                  choosing values close to 1.0 means very low recall, and choosing values close to
                  0.0 results in very low precision.
                ...
                - **AccuracyCostTradeoff** *(float) --*
                  ...
                  in a higher cost, sometimes substantially higher. A value of 0.0 means a bias
                  purely for cost, which results in a less accurate ``FindMatches`` transform,
                ...
                - **EnforceProvidedLabels** *(boolean) --*
                  ...
                  from users. If the value is ``True`` , the ``find matches`` transform forces the
                  output to match the provided labels. The results override the normal conflation
                  results. If the value is ``False`` , the ``find matches`` transform does not
                  ensure all the labels provided are respected, and the results rely on the trained
                  model.
            ...
            - **Schema** *(list) --*
              ...
              - *(dict) --*
                ...
                against. The ``Schema`` parameter of the ``MLTransform`` may contain up to 100 of
                these structures.
            ...
            - **GlueVersion** *(string) --*
              ...
              the Glue compatibility defaults to Glue 0.9. For more information, see `AWS Glue
              Versions
              <https://docs.aws.amazon.com/glue/latest/dg/release-notes.html#release-notes-versions>`__
              in the developer guide.
            ...
            - **MaxCapacity** *(float) --*
              ...
              for this transform. You can allocate from 2 to 100 DPUs; the default is 10. A DPU is a
              relative measure of processing power that consists of 4 vCPUs of compute capacity and
        ...
        **Request Syntax**
        ...
        :param Filter:
          ...
          - **Schema** *(list) --*
            ...
            Filters on datasets with a specific schema. The ``Map<Column, Type>`` object is an array
            of key-value pairs representing the schema this transform accepts, where ``Column`` is
            the name of a column, and ``Type`` is the type of the data such as an integer or string.
            ...
            - **Transforms** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Parameters** *(dict) --*
                  ...
                  - **FindMatchesParameters** *(dict) --*
                    ...
                    - **PrecisionRecallTradeoff** *(float) --*
                      ...
                      is a tradeoff, choosing values close to 1.0 means very low recall, and
                    ...
                    - **AccuracyCostTradeoff** *(float) --*
                      ...
                      cost concerns. A value of 1.0 means a bias purely for accuracy, which
                      typically results in a higher cost, sometimes substantially higher. A value of
                      0.0 means a bias purely for cost, which results in a less accurate
                    ...
                    - **EnforceProvidedLabels** *(boolean) --*
                      ...
                      The value to switch on or off to force the output to match the provided labels
                      from users. If the value is ``True`` , the ``find matches`` transform forces
                      the output to match the provided labels. The results override the normal
                      conflation results. If the value is ``False`` , the ``find matches`` transform
                      does not ensure all the labels provided are respected, and the results rely on
                      the trained model.
                ...
                - **EvaluationMetrics** *(dict) --*
                  ...
                  - **FindMatchesMetrics** *(dict) --*
                    ...
                    - **AreaUnderPRCurve** *(float) --*
                      ...
                      for precision vs. recall. Higher values indicate that you have a more
                      attractive precision vs. recall tradeoff.
                    ...
                    - **F1** *(float) --*
                      ...
                      <https://en.wikipedia.org/wiki/F1_score>`__ in Wikipedia.
                ...
                - **LabelCount** *(integer) --*
                  ...
                  transform. As you create a better transform, you can iteratively download, label,
                  and upload the labeling file.
                ...
                - **Schema** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    A key-value pair representing a column and data type that this transform can run
                    against. The ``Schema`` parameter of the ``MLTransform`` may contain up to 100
                    of these structures.
                ...
                - **Role** *(string) --*
                  ...
                  * This role needs AWS Glue service role permissions to allow access to resources
                  in AWS Glue. See `Attach a Policy to IAM Users That Access AWS Glue
                  <https://docs.aws.amazon.com/glue/latest/dg/attach-policy-iam-user.html>`__ .

                  * This role needs permission to your Amazon Simple Storage Service (Amazon S3)
                  sources, targets, temporary directory, scripts, and any libraries used by the task
                  run for this transform.

                - **GlueVersion** *(string) --*

                  This value determines which version of AWS Glue this machine learning transform is
                  compatible with. Glue 1.0 is recommended for most customers. If the value is not
                  set, the Glue compatibility defaults to Glue 0.9. For more information, see `AWS
                  Glue Versions
                  <https://docs.aws.amazon.com/glue/latest/dg/release-notes.html#release-notes-versions>`__
                  in the developer guide.
                ...
                - **MaxCapacity** *(float) --*
                  ...
                  runs for this transform. You can allocate from 2 to 100 DPUs; the default is 10. A
    ...
    def get_plan(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetPlan>`_
    ...
    def get_tags(self, ResourceArn: str) -> ClientGetTagsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/glue-2017-03-31/GetTags>`_
              ...
              - **Graph** *(dict) --*
                ...
                - **Nodes** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    A node represents an AWS Glue component like Trigger, Job etc. which is part of
                    a workflow.
    ...
    def list_dev_endpoints(
        ...
        with the specified tag. This operation allows you to see which resources are available in
        your account, and their names.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DevEndpointNames** *(list) --*
              ...
              The names of all the ``DevEndpoint`` s in the account, or the ``DevEndpoint`` s with
              the specified tags.
        ...
        :param DataCatalogEncryptionSettings: **[REQUIRED]**
          ...
          - **ConnectionPasswordEncryption** *(dict) --*
            ...
            - **ReturnConnectionPasswordEncrypted** *(boolean) --* **[REQUIRED]**
              ...
              encrypted in the responses of ``GetConnection`` and ``GetConnections`` . This
            ...
            - **AwsKmsKeyId** *(string) --*
              ...
              ``UpdateConnection`` needs at least ``kms:Encrypt`` permission on the specified AWS
    ...
    def put_resource_policy(
        self, PolicyInJson: str, PolicyHashCondition: str = None, PolicyExistsCondition: str = None
    ) -> ClientPutResourcePolicyResponseTypeDef:
        """
        ...
        **Request Syntax**
        ...
        :param PolicyExistsCondition:
          ...
          create a new policy. If a value of ``NONE`` or a null value is used, the call will not
              ...
              Filters=[
                  {
                      ...
                      'Value': 'string',
                      'Comparator':
                      'EQUALS'|'GREATER_THAN'|'LESS_THAN'|'GREATER_THAN_EQUALS'
                      |'LESS_THAN_EQUALS'
                  },
              ],
              SearchText='string',
    ...
    def start_export_labels_task_run(
        ...
        You typically use ``StartExportLabelsTaskRun`` when you want to work with all of your
        existing labels at the same time, such as when you want to remove or change labels that were
        previously submitted as truth. This API operation accepts the ``TransformId`` whose labels
        you want to export and an Amazon Simple Storage Service (Amazon S3) path to export the
        labels to. The operation returns a ``TaskRunId`` . You can check on the status of your task
        run by calling the ``GetMLTaskRun`` API.
    ...
    def start_import_labels_task_run(
        ...
        the active learning workflow that starts with the ``StartMLLabelingSetGenerationTaskRun``
        call and that ultimately results in improving the quality of your machine learning
        transform.

        After the ``StartMLLabelingSetGenerationTaskRun`` finishes, AWS Glue machine learning will
        have generated a series of questions for humans to answer. (Answering these questions is
        often called 'labeling' in the machine learning workflows). In the case of the
        ``FindMatches`` transform, these questions are of the form, “What is the correct way to
        group these rows together into groups composed entirely of matching records?” After the
        labeling process is finished, users upload their answers/labels with a call to
        ``StartImportLabelsTaskRun`` . After ``StartImportLabelsTaskRun`` finishes, all future runs
        of the machine learning transform use the new and improved labels and perform a
    ...
    def start_job_run(
        ...
        **Request Syntax**
        ...
        :param AllocatedCapacity:
          ...
          The number of AWS Glue data processing units (DPUs) to allocate to this JobRun. From 2 to
    ...
    def start_ml_labeling_set_generation_task_run(
        ...
        When the ``StartMLLabelingSetGenerationTaskRun`` finishes, AWS Glue will have generated a
        ...
        ``StartImportLabelsTaskRun`` . After ``StartImportLabelsTaskRun`` finishes, all future runs
        of the machine learning transform will use the new and improved labels and perform a
        higher-quality transformation.
    ...
    def stop_crawler_schedule(self, CrawlerName: str) -> Dict[str, Any]:
        """
        Sets the schedule state of the specified crawler to ``NOT_SCHEDULED`` , but does not stop
        the crawler if it is already running.
    ...
    def tag_resource(self, ResourceArn: str, TagsToAdd: Dict[str, str]) -> Dict[str, Any]:
        ...
        `AWS Tags in AWS Glue <https://docs.aws.amazon.com/glue/latest/dg/monitor-tags.html>`__ .
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The ARN of the AWS Glue resource to which to add the tags. For more information about AWS
          Glue resource ARNs, see the `AWS Glue ARN string pattern
        ...
        **Request Syntax**
        ...
        :param CustomLibraries:
          ...
          - **ExtraPythonLibsS3Path** *(string) --*
            ...
            S3) bucket that should be loaded in your ``DevEndpoint`` . Multiple values must be
        ...
        :param UpdateEtlLibraries:
           ...
           to be updated, or ``False`` if otherwise.
        ...
        :param JobUpdate: **[REQUIRED]**
          ...
          - **Command** *(dict) --*
            ...
            - **PythonVersion** *(string) --*
              ...
              The Python version being used to execute a Python shell job. Allowed values are 2 or
              3.
          ...
          - **AllocatedCapacity** *(integer) --*
            ...
            The number of AWS Glue data processing units (DPUs) to allocate to this job. You can
            allocate from 2 to 100 DPUs; the default is 10. A DPU is a relative measure of
          ...
          - **MaxCapacity** *(float) --*
            ...
            compute capacity and 16 GB of memory. For more information, see the `AWS Glue pricing
            page <https://aws.amazon.com/glue/pricing/>`__ .
