...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        Classic FAQs <http://aws.amazon.com/cloudhsm/faqs-classic/>`__ , the `AWS CloudHSM Classic
        User Guide <http://docs.aws.amazon.com/cloudhsm/classic/userguide/>`__ , and the `AWS
        CloudHSM Classic API Reference
        <http://docs.aws.amazon.com/cloudhsm/classic/APIReference/>`__ .
         ...
         **For information about the current version of AWS CloudHSM** , see `AWS CloudHSM
         ...
         <http://docs.aws.amazon.com/cloudhsm/latest/userguide/>`__ , and the `AWS CloudHSM API
         Reference <http://docs.aws.amazon.com/cloudhsm/latest/APIReference/>`__ .
    ...
    def create_hsm(
        ...
        instance using the  DeleteHsm operation, go to the `AWS Support Center
        <https://console.aws.amazon.com/support/home>`__ , create a new case, and select **Account
        and Billing Support** .

        .. warning::

          It can take up to 20 minutes to create and provision an HSM. You can monitor the status of
          the HSM with the  DescribeHsm operation. The HSM is ready to be initialized when the
          ...
          **Response Syntax**
          ...
          ::

            {
                'HsmArn': 'string',
                'Status':
                'PENDING'|'RUNNING'|'UPDATING'|'SUSPENDED'|'TERMINATING'|'TERMINATED'
                |'DEGRADED',
    ...
    def list_hapgs(self, NextToken: str = None) -> ClientListHapgsResponseTypeDef:
        ...
        are available, the ``NextToken`` member of the response contains a token that you pass in
        the next call to ``ListHapgs`` to retrieve the next set of items.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If not null, more results are available. Pass this value to ``ListHapgs`` to retrieve
    ...
    def list_hsms(self, NextToken: str = None) -> ClientListHsmsResponseTypeDef:
        ...
        This operation supports pagination with the use of the ``NextToken`` member. If more results
        are available, the ``NextToken`` member of the response contains a token that you pass in
        the next call to ``ListHsms`` to retrieve the next set of items.
    ...
    def list_luna_clients(self, NextToken: str = None) -> ClientListLunaClientsResponseTypeDef:
        ...
        This operation supports pagination with the use of the ``NextToken`` member. If more results
        are available, the ``NextToken`` member of the response contains a token that you pass in
        the next call to ``ListLunaClients`` to retrieve the next set of items.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If not null, more results are available. Pass this to ``ListLunaClients`` to retrieve
              the next set of items.
    ...
    def modify_hsm(
        ...
        .. warning::
          ...
          that your AWS CloudHSM service is configured for high availability, and consider executing
