"Main interface for cloudhsm Client"
...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        """
        This is documentation for **AWS CloudHSM Classic** . For more information, see `AWS CloudHSM Classic
        FAQs <http://aws.amazon.com/cloudhsm/faqs-classic/>`__ , the `AWS CloudHSM Classic User Guide
        <http://docs.aws.amazon.com/cloudhsm/classic/userguide/>`__ , and the `AWS CloudHSM Classic API
        Reference <http://docs.aws.amazon.com/cloudhsm/classic/APIReference/>`__ .

         **For information about the current version of AWS CloudHSM** , see `AWS CloudHSM
         <http://aws.amazon.com/cloudhsm/>`__ , the `AWS CloudHSM User Guide
         <http://docs.aws.amazon.com/cloudhsm/latest/userguide/>`__ , and the `AWS CloudHSM API Reference
         <http://docs.aws.amazon.com/cloudhsm/latest/APIReference/>`__ .
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/AddTagsToResource>`_
    ...
    def create_hapg(self, Label: str) -> ClientCreateHapgResponseTypeDef:
        ...
        Creates a high-availability partition group. A high-availability partition group is a group of
        partitions that spans multiple physical HSMs.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/CreateHapg>`_
    ...
    def create_hsm(
        ...
        operation. If you accidentally provision an HSM and want to request a refund, delete the instance
        using the  DeleteHsm operation, go to the `AWS Support Center
        <https://console.aws.amazon.com/support/home>`__ , create a new case, and select **Account and
        Billing Support** .

        .. warning::

          It can take up to 20 minutes to create and provision an HSM. You can monitor the status of the HSM
          with the  DescribeHsm operation. The HSM is ready to be initialized when the status changes to
          ``RUNNING`` .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/CreateHsm>`_
        ...
        **Request Syntax**
        ...
        :param EniIp:
          ...
          If an IP address is not specified, an IP address will be randomly chosen from the CIDR range of
          the subnet.
    ...
    def create_luna_client(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/CreateLunaClient>`_
    ...
    def delete_hapg(self, HapgArn: str) -> ClientDeleteHapgResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/DeleteHapg>`_
    ...
    def delete_hsm(self, HsmArn: str) -> ClientDeleteHsmResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/DeleteHsm>`_
    ...
    def delete_luna_client(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/DeleteLunaClient>`_
    ...
    def describe_hapg(self, HapgArn: str) -> ClientDescribeHapgResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/DescribeHapg>`_
    ...
    def describe_hsm(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/DescribeHsm>`_
        ...
        **Request Syntax**
        ...
        :param HsmSerialNumber:
          ...
          The serial number of the HSM. Either the ``HsmArn`` or the ``HsmSerialNumber`` parameter must be
          specified.
    ...
    def describe_luna_client(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/DescribeLunaClient>`_
    ...
    def get_config(
        ...
        Gets the configuration files necessary to connect to all high availability partition groups the
        client is associated with.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/GetConfig>`_
    ...
    def list_available_zones(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/ListAvailableZones>`_
    ...
    def list_hapgs(self, NextToken: str = None) -> ClientListHapgsResponseTypeDef:
        ...
        available, the ``NextToken`` member of the response contains a token that you pass in the next call
        to ``ListHapgs`` to retrieve the next set of items.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If not null, more results are available. Pass this value to ``ListHapgs`` to retrieve the next
              set of items.
    ...
    def list_luna_clients(
        ...
        This operation supports pagination with the use of the ``NextToken`` member. If more results are
        available, the ``NextToken`` member of the response contains a token that you pass in the next call
        to ``ListLunaClients`` to retrieve the next set of items.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If not null, more results are available. Pass this to ``ListLunaClients`` to retrieve the next
              set of items.
    ...
    def list_tags_for_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/ListTagsForResource>`_
    ...
    def modify_hapg(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/ModifyHapg>`_
    ...
    def modify_hsm(
        ...
        .. warning::
          ...
          This operation can result in the HSM being offline for up to 15 minutes while the AWS CloudHSM
          service is reconfigured. If you are modifying a production HSM, you should ensure that your AWS
          CloudHSM service is configured for high availability, and consider executing this operation during
          a maintenance window.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/ModifyHsm>`_
        ...
        **Request Syntax**
        ...
        :param EniIp:
          ...
          If the HSM is moved to a different subnet, and an IP address is not specified, an IP address will
          be randomly chosen from the CIDR range of the new subnet.
    ...
    def modify_luna_client(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/ModifyLunaClient>`_
    ...
    def remove_tags_from_resource(
        ...
        To remove a tag, specify only the tag key to remove (not the value). To overwrite the value for an
        existing tag, use  AddTagsToResource .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsm-2014-05-30/RemoveTagsFromResource>`_
        ...
        **Request Syntax**
        ...
        :param TagKeyList: **[REQUIRED]**
          ...
          Specify only the tag key to remove (not the value). To overwrite the value for an existing tag,
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_hapgs` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_hsms` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_luna_clients` operation.
        """
