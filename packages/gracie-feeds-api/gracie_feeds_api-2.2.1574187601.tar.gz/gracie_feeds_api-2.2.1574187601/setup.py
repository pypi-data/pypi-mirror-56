...
long_description = '''gracie_feeds_api is an API wrapper for the Gracie AI platform'''
...
setup_info = dict(
    # Metadata
    name='gracie_feeds_api',
    version=VERSION,
    author='Darshan Gencarelle',
    author_email='darshan.gencarelle@toposlabs.com',
    url='https://gracie-feeds-api-documentation.readthedocs.io',
    download_url='https://pypi.org/project/gracie-feeds-api/',
    ...
    # Package info
    packages=create_package_list('gracie_feeds_api'),
