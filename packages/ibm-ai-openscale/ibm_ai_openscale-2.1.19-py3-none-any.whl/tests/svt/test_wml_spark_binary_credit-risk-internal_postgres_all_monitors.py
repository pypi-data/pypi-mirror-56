...
@unittest.skipIf(is_icp(), "No internal postgres on ICP")
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_02_check_if_db_credentials_are_hidden(self):
        dm_details = TestAIOpenScaleClient.ai_client.data_mart.get_details()
        print(dm_details)
    ...
    def test_11_score(self):
        ...
        for i in range(0, int(self.scoring_records/len(values))):
