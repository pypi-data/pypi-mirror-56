...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_09_get_application_details(self):
        application_details = wait_for_business_app(url_get_details=self.hrefs_v2.get_application_details_href(TestAIOpenScaleClient.b_app_uid),
                                 headers=TestAIOpenScaleClient.ai_client._get_headers())
        logger.info(application_details)
    ...
    def test_13_get_historical_kpi(self):
        ...
        response = request_session.get(url=metrics_url, headers=self.ai_client._get_headers())
        logger.debug("Status code: {}, response: {}".format(response.status_code, response.text))
    ...
    def test_17_check_correlations_metrics(self):
        ...
        logger.info("Final run details: {}".format(final_run_details))

        response = request_session.get(url=url, headers=self.ai_client._get_headers())
    ...
    def test_18_update_business_application(self):
    ...
    def test_19_delete_business_application(self):
