...
class TestAIOpenScaleClient(unittest.TestCase):
    ...
    def test_23_a_get_batch_ids(self):
    ...
    def test_24_wait_for_assurance_monitor_finish(self):
    ...
    def test_25_check_assurance_metrics_on_batch(self):
