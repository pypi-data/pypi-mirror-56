...
class Client(BaseClient):
    ...
    def describe_dimension_keys(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/pi-2018-02-27/DescribeDimensionKeys>`_
        ...
        **Request Syntax**
        ...
        :param ServiceType: **[REQUIRED]**
          ...
          The AWS service for which Performance Insights will return metrics. The only valid value
          for *ServiceType* is: ``RDS``
        ...
        :param StartTime: **[REQUIRED]**
          ...
          specify a ``StartTime`` that's earlier than 7 days ago. The value specified is *inclusive*
          - data points equal to or greater than ``StartTime`` will be returned.
        ...
        :param EndTime: **[REQUIRED]**
          ...
          specified is *exclusive* - data points less than (but not equal to) ``EndTime`` will be
          returned.
        ...
        :param GroupBy: **[REQUIRED]**
          ...
          a valid dimension group. Performance Insights will return all of the dimensions within
          that group, unless you provide the names of specific dimensions within that group. You can
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              An optional pagination token provided by a previous request. If this parameter is
              specified, the response includes only records beyond the token, up to the value
    ...
    def get_resource_metrics(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pi-2018-02-27/GetResourceMetrics>`_
        ...
        **Request Syntax**
        ...
        :param MetricQueries: **[REQUIRED]**
          ...
          metric, and can optionally specify aggregation and filtering criteria.

          - *(dict) --*

            A single query to be processed. You must provide the metric to query. If no other
            parameters are specified, Performance Insights returns all of the data points for that
            metric. You can optionally request that the data points be aggregated by dimension group
            ...
            - **GroupBy** *(dict) --*
              ...
              dimensions within that group, unless you provide the names of specific dimensions
              ...
              - **Dimensions** *(list) --*
                ...
                present, then it signifies that all of the dimensions in the group were requested,
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AlignedStartTime** *(datetime) --*
              ...
              specified by ``PeriodInSeconds`` ). ``AlignedStartTime`` will be less than or equal to
              the value of the user-specified ``StartTime`` .

            - **AlignedEndTime** *(datetime) --*

              The end time for the returned metrics, after alignment to a granular boundary (as
              specified by ``PeriodInSeconds`` ). ``AlignedEndTime`` will be greater than or equal
