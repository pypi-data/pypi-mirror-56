...
class Receiver(BaseClient):
    ...
    def __init__(self,
                 ...
                 threaded: bool = True):
        super().__init__(host, port, username, password, socket_timeout)
        # Internal
        self._threads = []
    ...
    def _start_consuming(self, logger):
        try:
    ...
    def start_consuming(self, threaded: bool, logger):
        ...
        the client"""
        if threaded:
            th = Thread(target=self._start_consuming, args=(logger,))
            th.start()
        else:
    ...
    def consume(self,
        ...
        self.start_consuming(self.threaded, logger)
