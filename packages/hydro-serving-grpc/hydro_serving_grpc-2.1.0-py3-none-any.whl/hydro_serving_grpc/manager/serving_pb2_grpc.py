...
class ServingDiscoveryStub(object):
  ...
  def __init__(self, channel):
    ...
    self.WatchApplications = channel.stream_stream(
        '/hydrosphere.discovery.ServingDiscovery/WatchApplications',
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=hydro__serving__grpc_dot_manager_dot_serving__pb2.ApplicationDiscoveryEvent.FromString,
        )
    self.WatchServables = channel.stream_stream(
        '/hydrosphere.discovery.ServingDiscovery/WatchServables',
        request_serializer=google_dot_protobuf_dot_empty__pb2.Empty.SerializeToString,
        response_deserializer=hydro__serving__grpc_dot_manager_dot_serving__pb2.ServableDiscoveryEvent.FromString,
        )
...
def add_ServingDiscoveryServicer_to_server(servicer, server):
  rpc_method_handlers = {
      'WatchApplications': grpc.stream_stream_rpc_method_handler(
          ...
          response_serializer=hydro__serving__grpc_dot_manager_dot_serving__pb2.ApplicationDiscoveryEvent.SerializeToString,
      ),
      'WatchServables': grpc.stream_stream_rpc_method_handler(
          servicer.WatchServables,
          request_deserializer=google_dot_protobuf_dot_empty__pb2.Empty.FromString,
          response_serializer=hydro__serving__grpc_dot_manager_dot_serving__pb2.ServableDiscoveryEvent.SerializeToString,
      ),
  }
