...
setup(
    ...
    name='scipion-em-phenix',  # Required
    ...
    url='https://github.com/scipion-em/scipion-em-phenix',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Roberto Marabini, Marta Martinez',  # Optional
    ...
    package_data={  # Optional
       'phenix': ['phenix.png', 'protocols.conf'],
    },
