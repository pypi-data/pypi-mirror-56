...
if __name__ == "__main__":
    ...
    import band
    from band.processors.classification_processor import ClassificationProcessor
    from band.embeddings import BareEmbedding

    processor = ClassificationProcessor(multi_label=False)
    embed = BareEmbedding(task=band.CLASSIFICATION, sequence_length=30, processor=processor)
