...
class Client(BaseClient):
    ...
    def create_pipeline(
        ...
        **Request Syntax**
        ...
        :param uniqueId: **[REQUIRED]**
          ...
          ``CreatePipeline`` does not succeed, you can pass in the same unique identifier and
          ...
          pipeline is not created. Instead, you'll receive the pipeline identifier from the previous
          attempt. The uniqueness of the name and unique identifier combination is scoped to the AWS
    ...
    def deactivate_pipeline(self, pipelineId: str, cancelActive: bool = None) -> Dict:
        ...
        from the last completed execution. Optionally, you can specify the date and time to resume
        the pipeline.
        ...
        **Request Syntax**
        ...
        :param cancelActive:
          ...
          Indicates whether to cancel any running objects. The default is true, which sets the state
          of any running objects to ``CANCELED`` . If this value is false, the pipeline is
    ...
    def describe_objects(
        ...
        **Request Syntax**
        ...
        :param objectIds: **[REQUIRED]**
          ...
          The IDs of the pipeline objects that contain the definitions to be described. You can pass
          ...
          - *(dict) --*
            ...
            - **pipelineObjects** *(list) --*
              ...
              - *(dict) --*
                ...
                physical attempt pipeline object. The complete set of components of a pipeline
            ...
            - **marker** *(string) --*
              ...
              call ``DescribeObjects`` again with this marker value. If the value is null, there are
              no more results.
                ...
                - **tags** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **value** *(string) --*
                      ...
                      see `Controlling User Access to Pipelines
                      <http://docs.aws.amazon.com/datapipeline/latest/DeveloperGuide/dp-control-access.html>`__
                      in the *AWS Data Pipeline Developer Guide* .
    ...
    def evaluate_expression(
        ...
        specified object. For example, a task runner can evaluate SQL queries stored in Amazon S3.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **pipelineIdList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **id** *(string) --*
                  ...
                  the form ``df-297EG78HU43EEXAMPLE`` .
            ...
            - **marker** *(string) --*
              ...
              The starting point for the next page of results. To view the next page of results,
              call ``ListPipelinesOutput`` again with this marker value. If the value is null, there
              are no more results.
    ...
    def poll_for_task(
        ...
        **Request Syntax**
        ...
        :param workerGroup: **[REQUIRED]**
          ...
          single value for ``workerGroup`` in the call to ``PollForTask`` . There are no wildcard
          values permitted in ``workerGroup`` ; the string must be an exact, case-sensitive, match.
        ...
        :param instanceIdentity:
          ...
          <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AESDG-chapter-instancedata.html>`__ in
          the *Amazon Elastic Compute Cloud User Guide.* Passing in this value proves that your task
          runner is running on an EC2 instance, and ensures the proper AWS Data Pipeline service
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **taskObject** *(dict) --*
              ...
              One of the fields returned in this object is ``taskId`` , which contains an identifier
          ...
          - *(dict) --*
            ...
            - **validationWarnings** *(list) --*
              ...
              - *(dict) --*
                ...
                activation. The set of validation warnings that can be returned are defined by AWS
                Data Pipeline.
            ...
            - *(dict) --*
              ...
              - **operator** *(dict) --*
                ...
                - **type** *(string) --*
                  ...
                  reference fields. The other comparison types can be used only with String fields.
                  The comparison types you can use apply only to certain object fields, as detailed
                  below.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **marker** *(string) --*
              ...
              The starting point for the next page of results. To view the next page of results,
              call ``QueryObjects`` again with this marker value. If the value is null, there are no
              more results.
    ...
    def report_task_progress(
        ...
        runner only needs to report progress every 15 minutes to maintain its ownership of the task.
        You can change this reporting time from 15 minutes by specifying a ``reportProgressTimeout``
    ...
    def report_task_runner_heartbeat(
        ...
        **Request Syntax**
        ...
        :param taskrunnerId: **[REQUIRED]**
          ...
          case of AWS Data Pipeline Task Runner launched on a resource managed by AWS Data Pipeline,
          the web service provides a unique identifier when it launches the application. If you have
          written a custom task runner, you should assign a unique identifier for the task runner.
        ...
        :param workerGroup:
          ...
          The type of task the task runner is configured to accept and process. The worker group is
          set as a field on objects in the pipeline when they are created. You can only specify a
          single value for ``workerGroup`` . There are no wildcard values permitted in
    ...
    def set_task_status(
        ...
        **Request Syntax**
        ...
        :param errorStackTrace:
          ...
          If an error occurred during the task, this value specifies the stack trace associated with
          the error. This value is set on the physical attempt object. It is used to display error
          information to the user. The web service does not parse this value.
