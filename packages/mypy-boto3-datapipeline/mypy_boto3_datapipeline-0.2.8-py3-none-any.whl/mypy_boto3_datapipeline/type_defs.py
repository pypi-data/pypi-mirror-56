...
class ClientActivatePipelineparameterValuesTypeDef(_ClientActivatePipelineparameterValuesTypeDef):
    """
...
_ClientAddTagstagsTypeDef = TypedDict("_ClientAddTagstagsTypeDef", {"key": str, "value": str})
...
class ClientDescribePipelinesResponsepipelineDescriptionListTypeDef(
    ...
    - **tags** *(list) --*
      ...
      A list of tags to associated with a pipeline. Tags let you control access to pipelines. For
        ...
        - *(dict) --*
          ...
          - **fields** *(list) --*
            ...
            - *(dict) --*
              ...
              specified as either a string value (``StringValue`` ) or a reference to another object
              (``RefValue`` ) but not as both.
...
_ClientPutPipelineDefinitionparameterObjectsTypeDef = TypedDict(
    ...
    {"id": str, "attributes": List[ClientPutPipelineDefinitionparameterObjectsattributesTypeDef]},
)
...
_ClientPutPipelineDefinitionparameterValuesTypeDef = TypedDict(
    "_ClientPutPipelineDefinitionparameterValuesTypeDef", {"id": str, "stringValue": str}
)
...
class ClientQueryObjectsqueryselectorsoperatorTypeDef(
    ...
    - **type** *(string) --*
      ...
      reference (``REF_EQ`` ) can be used only with reference fields. The other comparison types can
      be used only with String fields. The comparison types you can use apply only to certain object
      ...
      * @actualEndTime
      ...
      Note that fields beginning with the at sign (@) are read-only and set by the web service. When
      you name fields, you should choose names containing only alpha-numeric values, as symbols may
      be reserved by AWS Data Pipeline. User-defined fields that you add to a pipeline should prefix
...
class ClientQueryObjectsqueryselectorsTypeDef(_ClientQueryObjectsqueryselectorsTypeDef):
    ...
    - **fieldName** *(string) --*
      ...
      portion of the field definition in the pipeline definition syntax that is used by the AWS Data
      Pipeline API. If the field is not set on the object, the condition fails.
    ...
    - **operator** *(dict) --*
      ...
      - **type** *(string) --*
        ...
        can be used only with String fields. The comparison types you can use apply only to certain
        ...
        * @actualEndTime
        ...
        symbols may be reserved by AWS Data Pipeline. User-defined fields that you add to a pipeline
        ...
        - **operator** *(dict) --*
          ...
          - **type** *(string) --*
            ...
            * @actualEndTime
            ...
            values, as symbols may be reserved by AWS Data Pipeline. User-defined fields that you
...
_ClientValidatePipelineDefinitionparameterValuesTypeDef = TypedDict(
    "_ClientValidatePipelineDefinitionparameterValuesTypeDef", {"id": str, "stringValue": str}
)
...
_RequiredClientValidatePipelineDefinitionpipelineObjectsfieldsTypeDef = TypedDict(
    "_RequiredClientValidatePipelineDefinitionpipelineObjectsfieldsTypeDef", {"key": str}
)
