                ...
                - **events** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **condition** *(string) --*
                      ...
                      be performed. If not present, the actions are performed (=
                          TRUE); if the
          ...
          ::

            {
                'detectorModelConfiguration': {
                    ...
                    'status':
                    'ACTIVE'|'ACTIVATING'|'INACTIVE'|'DEPRECATED'|'DRAFT'|'PAUSED'
                    |'FAILED',
                    'key': 'string',
                    'evaluationMethod': 'BATCH'|'SERIAL'
                }
          ...
          - *(dict) --*
            ...
            - **detectorModelConfiguration** *(dict) --*
              ...
              - **key** *(string) --*
                ...
                appropriate detector (instance). This parameter uses a JSON-path expression to
                specify the attribute-value pair in the message payload of each input that is used
                to identify the device associated with the input.
...

            {
                'detectorModel': {
                    ...
                    'detectorModelConfiguration': {
                        ...
                        'lastUpdateTime': datetime(2015, 1, 1),
                        'status':
                        'ACTIVE'|'ACTIVATING'|'INACTIVE'|'DEPRECATED'|'DRAFT'
                        |'PAUSED'|'FAILED',
                        'key': 'string',
                        'evaluationMethod': 'BATCH'|'SERIAL'
                    }
            ...
            - **detectorModel** *(dict) --*
                            ...
                            - *(dict) --*
                              ...
                              - **setTimer** *(dict) --*
                                ...
                                - **seconds** *(integer) --*
                                  ...
                                  is 60 seconds to ensure accuracy.
              ...
              - **detectorModelConfiguration** *(dict) --*
                ...
                - **evaluationMethod** *(string) --*
                  ...
                  When set to ``SERIAL`` , variables are updated and event conditions evaluated in
                  the order that the events are defined. When set to ``BATCH`` , variables are
            ...
            - **input** *(dict) --*
              ...
              - **inputDefinition** *(dict) --*
                ...
                - **attributes** *(list) --*
                  ...
                  are derived from messages sent to the AWS IoT Events system using
                  ...
                  - *(dict) --*
                    ...
                    - **jsonPath** *(string) --*
                      ...
                      this to specify an attribute from the JSON payload that is made available by
                      the input. Inputs are derived from messages sent to the AWS IoT Events system
                      (``BatchPutMessage`` ). Each such message contains a JSON payload, and the
        ...
        :param loggingOptions: **[REQUIRED]**
          ...
          - **detectorDebugOptions** *(list) --*
            ...
            - *(dict) --*
              ...
              The detector model and the specific detectors (instances) for which the logging level
              is given.
              ...
              - **keyValue** *(string) --*
                ...
                The value of the input attribute key used to create the detector (the instance of
                the detector model).
