...
def get_upper_case_vars_or_protected_of(module: object,
                                        lower_keys: bool = True) -> Mapping:
  v = vars(module)
...
def config_to_mapping(C: object,
                      only_upper_case: bool = True) -> NOD:
  if only_upper_case:
