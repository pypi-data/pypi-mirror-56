...
UserMsg = _reflection.GeneratedProtocolMessageType('UserMsg', (_message.Message,), dict(
  DESCRIPTOR = _USERMSG,
  __module__ = 'messages_pb2'
...
C2CInitMessage = _reflection.GeneratedProtocolMessageType('C2CInitMessage', (_message.Message,), dict(
...
AgentsList = _reflection.GeneratedProtocolMessageType('AgentsList', (_message.Message,), dict(
...
AgentIdHitCountPair = _reflection.GeneratedProtocolMessageType('AgentIdHitCountPair', (_message.Message,), dict(
...
HitCountUpdateMessage = _reflection.GeneratedProtocolMessageType('HitCountUpdateMessage', (_message.Message,), dict(
