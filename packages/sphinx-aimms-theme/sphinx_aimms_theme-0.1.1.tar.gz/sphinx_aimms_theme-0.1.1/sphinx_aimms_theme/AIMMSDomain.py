...
class AIMMSDomain(Domain):
    ...
    roles = {
        ...
        'id':        AIMMSXRefRole(fix_parens=True),
        'mn':        AIMMSXRefRole(fix_parens=True),
        'class':     AIMMSXRefRole(fix_parens=True),
        'procedure':     AIMMSXRefRole(fix_parens=True),
        'librarymodule':     AIMMSXRefRole(fix_parens=False),
        'externalprocedure':     AIMMSXRefRole(fix_parens=True),
        'parameter': AIMMSXRefRole(fix_parens=True),
        'elementparameter': AIMMSXRefRole(fix_parens=True),
        'stringparameter': AIMMSXRefRole(fix_parens=True),
        'set': AIMMSXRefRole(fix_parens=True),
        'index': AIMMSXRefRole(fix_parens=False),
        'variable': AIMMSXRefRole(fix_parens=True),
