...
class DataTransformer(AutoMLTransformer, FeaturizationInfoProvider):
    ...
    def fit(self, df: DataInputType, y: DataSingleColumnInputType = None) -> "DataTransformer":
        ...
        if self._is_onnx_compatible and self.mapper is not None:
            try:
                ...
                logging_utilities.log_traceback(fit_exception, self.logger)
                raise fit_exception
        else:
    ...
    def transform(self, df):
        ...
        try:
            ...
            logging_utilities.log_traceback(transform_exception, self.logger)
    ...
    def _get_categorical_hash_transforms(
        ...
        try:
            ...
            if len(transformer_params) > 0:
                self._logger_wrapper("warning", "Ignoring unsupported parameters {0}"
    ...
    def _get_numeric_transforms(
        ...
        try:
            ...
            self._logger_wrapper("debug", "Creating {t} with customized parameter failed with error: {e}"
                                 .format(t=_SupportedTransformersInternal.Imputer, e=e))
