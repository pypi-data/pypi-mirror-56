...
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/cx-api", "1.17.1", __name__, "cx-api@1.17.1.jsii.tgz")
...
@jsii.data_type(jsii_type="@aws-cdk/cx-api.ContainerImageAssetMetadataEntry", jsii_struct_bases=[], name_mapping={'id': 'id', 'image_name_parameter': 'imageNameParameter', 'packaging': 'packaging', 'path': 'path', 'source_hash': 'sourceHash', 'build_args': 'buildArgs', 'repository_name': 'repositoryName', 'target': 'target'})
class ContainerImageAssetMetadataEntry():
    def __init__(self, *, id: str, image_name_parameter: str, packaging: str, path: str, source_hash: str, build_args: typing.Optional[typing.Mapping[str,str]]=None, repository_name: typing.Optional[str]=None, target: typing.Optional[str]=None):
        """
...
class VpcContextResponse():
    ...
    def subnet_groups(self) -> typing.Optional[typing.List["VpcSubnetGroup"]]:
        """The subnet groups discovered for the given VPC. Unlike the above properties, this will include asymmetric subnets, if the VPC has any. This property will only be populated if {@link VpcContextQuery.returnAsymmetricSubnets} is true.
...
@jsii.data_type(jsii_type="@aws-cdk/cx-api.VpcSubnet", jsii_struct_bases=[], name_mapping={'availability_zone': 'availabilityZone', 'route_table_id': 'routeTableId', 'subnet_id': 'subnetId'})
class VpcSubnet():
    def __init__(self, *, availability_zone: str, route_table_id: str, subnet_id: str):
...
class VpcSubnetGroup():
    def __init__(self, *, name: str, subnets: typing.List["VpcSubnet"], type: "VpcSubnetGroupType"):
        """A group of subnets returned by the VPC provider. The included subnets do NOT have to be symmetric!
...
class VpcSubnetGroupType(enum.Enum):
    """The type of subnet group. Same as SubnetType in the @aws-cdk/aws-ec2 package, but we can't use that because of cyclical dependencies.
