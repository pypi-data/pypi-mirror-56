...
class PMML(ind.PMML):
    """Represents a <PMML> tag in v4.1 and provides methods to convert to PFA."""
...
class Aggregate(ind.Aggregate):
    """Represents a <Aggregate> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Anova(ind.Anova):
    """Represents a <Anova> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class AnovaRow(ind.AnovaRow):
    """Represents a <AnovaRow> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class AnyDistribution(ind.AnyDistribution):
    """Represents a <AnyDistribution> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Application(ind.Application):
    """Represents a <Application> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Apply(ind.Apply):
    """Represents a <Apply> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class AssociationModel(ind.AssociationModel):
    """Represents a <AssociationModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class AssociationRule(ind.AssociationRule):
    """Represents a <AssociationRule> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Attribute(ind.Attribute):
    """Represents a <Attribute> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class BaseCumHazardTables(ind.BaseCumHazardTables):
    """Represents a <BaseCumHazardTables> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class BaselineCell(ind.BaselineCell):
    """Represents a <BaselineCell> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class BaselineModel(ind.BaselineModel):
    """Represents a <BaselineModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class BaselineStratum(ind.BaselineStratum):
    """Represents a <BaselineStratum> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class BayesInput(ind.BayesInput):
    """Represents a <BayesInput> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class BayesOutput(ind.BayesOutput):
    """Represents a <BayesOutput> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class CategoricalPredictor(ind.CategoricalPredictor):
    """Represents a <CategoricalPredictor> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Category(ind.Category):
    """Represents a <Category> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Characteristic(ind.Characteristic):
    """Represents a <Characteristic> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ChildParent(ind.ChildParent):
    """Represents a <ChildParent> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Cluster(ind.Cluster):
    """Represents a <Cluster> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ClusteringField(ind.ClusteringField):
    """Represents a <ClusteringField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ClusteringModel(ind.ClusteringModel):
    """Represents a <ClusteringModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
        ...
        self.numberOfClusters = None
        self.isScorable = None
        for key, value in attribs.items> tag in v4.1 and provides methods to convert to PFA."""
            setattr(self, key, value)
        self.Cluster = []
...
class ClusteringModelQuality(ind.ClusteringModelQuality):
    """Represents a <ClusteringModelQuality> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Coefficient(ind.Coefficient):
    """Represents a <Coefficient> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Coefficients(ind.Coefficients):
    """Represents a <Coefficients> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ComparisonMeasure(ind.ComparisonMeasure):
    """Represents a <ComparisonMeasure> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class CompoundPredicate(ind.CompoundPredicate):
    """Represents a <CompoundPredicate> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Con(ind.Con):
    """Represents a <Con> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Constant(ind.Constant):
    """Represents a <Constant> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Constraints(ind.Constraints):
    """Represents a <Constraints> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ContStats(ind.ContStats):
    """Represents a <ContStats> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Counts(ind.Counts):
    """Represents a <Counts> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DataDictionary(ind.DataDictionary):
    """Represents a <DataDictionary> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DataField(ind.DataField):
    """Represents a <DataField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Decision(ind.Decision):
    """Represents a <Decision> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DecisionTree(ind.DecisionTree):
    """Represents a <DecisionTree> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Decisions(ind.Decisions):
    """Represents a <Decisions> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DefineFunction(ind.DefineFunction):
    """Represents a <DefineFunction> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Delimiter(ind.Delimiter):
    """Represents a <Delimiter> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DerivedField(ind.DerivedField):
    """Represents a <DerivedField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DiscrStats(ind.DiscrStats):
    """Represents a <DiscrStats> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Discretize(ind.Discretize):
    """Represents a <Discretize> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class DiscretizeBin(ind.DiscretizeBin):
    """Represents a <DiscretizeBin> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ExponentialSmoothing(ind.ExponentialSmoothing):
    """Represents a <ExponentialSmoothing> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Extension(ind.Extension):
    """Represents a <Extension> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class FieldColumnPair(ind.FieldColumnPair):
    """Represents a <FieldColumnPair> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class FieldRef(ind.FieldRef):
    """Represents a <FieldRef> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class FieldValue(ind.FieldValue):
    """Represents a <FieldValue> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class FieldValueCount(ind.FieldValueCount):
    """Represents a <FieldValueCount> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class GaussianDistribution(ind.GaussianDistribution):
    """Represents a <GaussianDistribution> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class GeneralRegressionModel(ind.GeneralRegressionModel):
    """Represents a <GeneralRegressionModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Header(ind.Header):
    """Represents a <Header> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class INT_SparseArray(ind.INT_SparseArray):
    """Represents a <INT_SparseArray> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class InstanceField(ind.InstanceField):
    """Represents a <InstanceField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Interval(ind.Interval):
    """Represents a <Interval> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Item(ind.Item):
    """Represents a <Item> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ItemRef(ind.ItemRef):
    """Represents a <ItemRef> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Itemset(ind.Itemset):
    """Represents a <Itemset> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class KNNInput(ind.KNNInput):
    """Represents a <KNNInput> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Level(ind.Level):
    """Represents a <Level> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class LiftData(ind.LiftData):
    """Represents a <LiftData> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class LinearKernelType(ind.LinearKernelType):
    """Represents a <LinearKernelType> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class LinearNorm(ind.LinearNorm):
    """Represents a <LinearNorm> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class MapValues(ind.MapValues):
    """Represents a <MapValues> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class MatCell(ind.MatCell):
    """Represents a <MatCell> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Matrix(ind.Matrix):
    """Represents a <Matrix> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class MiningField(ind.MiningField):
    """Represents a <MiningField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class MiningModel(ind.MiningModel):
    """Represents a <MiningModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ModelVerification(ind.ModelVerification):
    """Represents a <ModelVerification> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class MultivariateStat(ind.MultivariateStat):
    """Represents a <MultivariateStat> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class MultivariateStats(ind.MultivariateStats):
    """Represents a <MultivariateStats> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NaiveBayesModel(ind.NaiveBayesModel):
    """Represents a <NaiveBayesModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NeuralInput(ind.NeuralInput):
    """Represents a <NeuralInput> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NeuralInputs(ind.NeuralInputs):
    """Represents a <NeuralInputs> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NeuralLayer(ind.NeuralLayer):
    """Represents a <NeuralLayer> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NeuralNetwork(ind.NeuralNetwork):
    """Represents a <NeuralNetwork> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NeuralOutput(ind.NeuralOutput):
    """Represents a <NeuralOutput> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NeuralOutputs(ind.NeuralOutputs):
    """Represents a <NeuralOutputs> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Neuron(ind.Neuron):
    """Represents a <Neuron> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Node(ind.Node):
    """Represents a <Node> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NormContinuous(ind.NormContinuous):
    """Represents a <NormContinuous> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NormDiscrete(ind.NormDiscrete):
    """Represents a <NormDiscrete> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NumericInfo(ind.NumericInfo):
    """Represents a <NumericInfo> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class NumericPredictor(ind.NumericPredictor):
    """Represents a <NumericPredictor> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class OutputField(ind.OutputField):
    """Represents a <OutputField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PCell(ind.PCell):
    """Represents a <PCell> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PCovCell(ind.PCovCell):
    """Represents a <PCovCell> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PCovMatrix(ind.PCovMatrix):
    """Represents a <PCovMatrix> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PPCell(ind.PPCell):
    """Represents a <PPCell> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PairCounts(ind.PairCounts):
    """Represents a <PairCounts> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Parameter(ind.Parameter):
    """Represents a <Parameter> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ParameterField(ind.ParameterField):
    """Represents a <ParameterField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Partition(ind.Partition):
    """Represents a <Partition> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PartitionFieldStats(ind.PartitionFieldStats):
    """Represents a <PartitionFieldStats> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PoissonDistribution(ind.PoissonDistribution):
    """Represents a <PoissonDistribution> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PolynomialKernelType(ind.PolynomialKernelType):
    """Represents a <PolynomialKernelType> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PredictiveModelQuality(ind.PredictiveModelQuality):
    """Represents a <PredictiveModelQuality> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Predictor(ind.Predictor):
    """Represents a <Predictor> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class PredictorTerm(ind.PredictorTerm):
    """Represents a <PredictorTerm> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Quantile(ind.Quantile):
    """Represents a <Quantile> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class REAL_SparseArray(ind.REAL_SparseArray):
    """Represents a <REAL_SparseArray> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ROC(ind.ROC):
    """Represents a <ROC> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class RadialBasisKernelType(ind.RadialBasisKernelType):
    """Represents a <RadialBasisKernelType> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Regression(ind.Regression):
    """Represents a <Regression> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class RegressionModel(ind.RegressionModel):
    """Represents a <RegressionModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class RegressionTable(ind.RegressionTable):
    """Represents a <RegressionTable> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ResultField(ind.ResultField):
    """Represents a <ResultField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class RuleSelectionMethod(ind.RuleSelectionMethod):
    """Represents a <RuleSelectionMethod> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class RuleSet(ind.RuleSet):
    """Represents a <RuleSet> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class RuleSetModel(ind.RuleSetModel):
    """Represents a <RuleSetModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class ScoreDistribution(ind.ScoreDistribution):
    """Represents a <ScoreDistribution> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Scorecard(ind.Scorecard):
    """Represents a <Scorecard> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Seasonality_ExpoSmooth(ind.Seasonality_ExpoSmooth):
    """Represents a <Seasonality_ExpoSmooth> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Segment(ind.Segment):
    """Represents a <Segment> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Segmentation(ind.Segmentation):
    """Represents a <Segmentation> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Sequence(ind.Sequence):
    """Represents a <Sequence> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SequenceModel(ind.SequenceModel):
    """Represents a <SequenceModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SequenceReference(ind.SequenceReference):
    """Represents a <SequenceReference> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SequenceRule(ind.SequenceRule):
    """Represents a <SequenceRule> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SetPredicate(ind.SetPredicate):
    """Represents a <SetPredicate> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SetReference(ind.SetReference):
    """Represents a <SetReference> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SigmoidKernelType(ind.SigmoidKernelType):
    """Represents a <SigmoidKernelType> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SimplePredicate(ind.SimplePredicate):
    """Represents a <SimplePredicate> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SimpleRule(ind.SimpleRule):
    """Represents a <SimpleRule> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SimpleSetPredicate(ind.SimpleSetPredicate):
    """Represents a <SimpleSetPredicate> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SupportVector(ind.SupportVector):
    """Represents a <SupportVector> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SupportVectorMachine(ind.SupportVectorMachine):
    """Represents a <SupportVectorMachine> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SupportVectorMachineModel(ind.SupportVectorMachineModel):
    """Represents a <SupportVectorMachineModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class SupportVectors(ind.SupportVectors):
    """Represents a <SupportVectors> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Target(ind.Target):
    """Represents a <Target> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TargetValue(ind.TargetValue):
    """Represents a <TargetValue> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TargetValueCount(ind.TargetValueCount):
    """Represents a <TargetValueCount> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Taxonomy(ind.Taxonomy):
    """Represents a <Taxonomy> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TestDistributions(ind.TestDistributions):
    """Represents a <TestDistributions> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TextDocument(ind.TextDocument):
    """Represents a <TextDocument> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TextModel(ind.TextModel):
    """Represents a <TextModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TextModelNormalization(ind.TextModelNormalization):
    """Represents a <TextModelNormalization> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TextModelSimiliarity(ind.TextModelSimiliarity):
    """Represents a <TextModelSimiliarity> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Time(ind.Time):
    """Represents a <Time> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TimeAnchor(ind.TimeAnchor):
    """Represents a <TimeAnchor> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TimeCycle(ind.TimeCycle):
    """Represents a <TimeCycle> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TimeException(ind.TimeException):
    """Represents a <TimeException> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TimeSeries(ind.TimeSeries):
    """Represents a <TimeSeries> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TimeSeriesModel(ind.TimeSeriesModel):
    """Represents a <TimeSeriesModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TimeValue(ind.TimeValue):
    """Represents a <TimeValue> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TrainingInstances(ind.TrainingInstances):
    """Represents a <TrainingInstances> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class TreeModel(ind.TreeModel):
    """Represents a <TreeModel> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Trend_ExpoSmooth(ind.Trend_ExpoSmooth):
    """Represents a <Trend_ExpoSmooth> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class UniformDistribution(ind.UniformDistribution):
    """Represents a <UniformDistribution> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class UnivariateStats(ind.UnivariateStats):
    """Represents a <UnivariateStats> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class Value(ind.Value):
    """Represents a <Value> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class VectorDictionary(ind.VectorDictionary):
    """Represents a <VectorDictionary> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class VectorFields(ind.VectorFields):
    """Represents a <VectorFields> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class VectorInstance(ind.VectorInstance):
    """Represents a <VectorInstance> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class VerificationField(ind.VerificationField):
    """Represents a <VerificationField> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class binarySimilarity(ind.binarySimilarity):
    """Represents a <binarySimilarity> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
...
class minkowski(ind.minkowski):
    """Represents a <minkowski> tag in v4.1 and provides methods to convert to PFA."""
    def __init__(self, attribs):
