...
class Client(BaseClient):
    ...
    def activate_gateway(
        ...
        zone for scheduled snapshots the gateway snapshot schedule window, an activation key, and a name for
        your gateway. The activation process also associates your gateway with your account; for more
        ...
        **Request Syntax**
        ...
        :param ActivationKey: **[REQUIRED]**
          ...
          provides you the activation key for your gateway in the query string parameter ``activationKey`` .
          It may also include other activation-related parameters, however, these are merely defaults -- the
        ...
        :param GatewayTimezone: **[REQUIRED]**
          ...
          format "GMT-hr:mm" or "GMT+hr:mm". For example, GMT-4:00 indicates the time is 4 hours behind GMT.
          GMT+2:00 indicates the time is 2 hours ahead of GMT. The time zone is used, for example, for
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          .. note::
            ...
            is 128 characters, and the maximum length for a tag's value is 256.
    ...
    def create_cached_iscsi_volume(
        ...
        In the request, you must specify the gateway, size of the volume in bytes, the iSCSI target name, an
        IP address on which to expose the target, and a unique client token. In response, the gateway
        ...
        **Request Syntax**
        ...
        :param SnapshotId:
          ...
          Specify this field if you want to create the iSCSI storage volume from a snapshot otherwise do not
          include this field. To list snapshots for your account use `DescribeSnapshots
        ...
        :param SourceVolumeARN:
          ...
          specified existing volume's latest recovery point. The ``VolumeSizeInBytes`` value for this new
    ...
    def create_nfs_file_share(
        ...
        .. warning::
          ...
          activate AWS STS, see Activating and Deactivating AWS STS in an AWS Region in the AWS Identity and
    ...
    def create_smb_file_share(
        ...
        .. warning::
          ...
          File gateways require AWS Security Token Service (AWS STS) to be activated to enable you to create
          a file share. Make sure that AWS STS is activated in the AWS Region you are creating your file
          gateway in. If AWS STS is not activated in this AWS Region, activate it. For information about how
          to activate AWS STS, see `Activating and Deactivating AWS STS in an AWS Region
    ...
    def create_snapshot_from_volume_recovery_point(
        ...
        takes a snapshot of the specified volume, the snapshot and its description appear in the AWS Storage
        Gateway console. In response, the gateway returns you a snapshot ID. You can use this snapshot ID to
    ...
    def create_stored_iscsi_volume(
        ...
        The size of the volume to create is inferred from the disk size. You can choose to preserve existing
        data on the disk, create volume from an existing snapshot, or create an empty volume. If you choose
        to create an empty gateway volume, then any existing data on the disk is erased.
    ...
    def delete_gateway(self, GatewayARN: str) -> ClientDeleteGatewayResponseTypeDef:
        ...
        not deleted upon deleting the gateway, however, pending snapshots will not complete. After you
        delete a gateway, your next step is to remove it from your environment.

        .. warning::

          You no longer pay software charges after the gateway is deleted; however, your existing Amazon EBS
          snapshots persist and you will continue to be billed for these snapshots. You can choose to remove
          all remaining Amazon EBS snapshots by canceling your Amazon EC2 subscription. If you prefer not to
          cancel your Amazon EC2 subscription, you can delete your snapshots using the Amazon EC2 console.
    ...
    def delete_snapshot_schedule(
        ...
        Snapshots <https://docs.aws.amazon.com/storagegateway/latest/userguide/WorkingWithSnapshots.html>`__
    ...
    def delete_volume(self, VolumeARN: str) -> ClientDeleteVolumeResponseTypeDef:
        ...
        Before you delete a volume, make sure there are no iSCSI connections to the volume you are deleting.
        You should also make sure there is no snapshot in progress. You can use the Amazon Elastic Compute
        Cloud (Amazon EC2) API to query snapshots on the volume you are deleting and check the snapshot
        status. For more information, go to `DescribeSnapshots
        <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/ApiReference-query-DescribeSnapshots.html>`__
        in the *Amazon Elastic Compute Cloud API Reference* .
    ...
    def describe_bandwidth_rate_limit(
        ...
        bandwidth rate limiting is in effect. This operation is supported for the stored volume, cached
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DiskIds** *(list) --*
              ...
              string have a minimum length of 1 and maximum length of 300. You can get the disk IDs from the
               ListLocalDisks API.
            ...
            - **CachediSCSIVolumes** *(list) --*
              ...
              - *(dict) --*
                ...
                - **VolumeAttachmentStatus** *(string) --*
                  ...
                  For more information, see `Moving Your Volumes to a Different Gateway
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ChapCredentials** *(list) --*
              ...
              contains CHAP credential information for one target-initiator pair. If no CHAP credentials are
              set, an empty array is returned. CHAP credential information is provided in a JSON object with
    ...
    def describe_gateway_information(
        ...
        state (whether the gateway is running or not). To specify which gateway to describe, use the Amazon
            ...
            - **NFSFileShareInfoList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **NFSFileShareDefaults** *(dict) --*
                  ...
                  them. Upon discovery in an S3 bucket by Storage Gateway, the S3 objects that represent
                ...
                - **Tags** *(list) --*
                  ...
                  Each tag is a key-value pair. For a gateway with more than 10 tags assigned, you can view
                  all tags using the ``ListTagsForResource`` API operation.
            ...
            - **SMBFileShareInfoList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SMBACLEnabled** *(boolean) --*
                  ...
                  If this value is set to "true", indicates that ACL (access control list) is enabled on the
                  SMB file share. If it is set to "false", it indicates that file and directory permissions
    ...
    def describe_stored_iscsi_volumes(
        ...
        in the request must be from one gateway. In the response Amazon Storage Gateway returns volume
        information sorted by volume ARNs. This operation is only supported in stored volume gateway type.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **StorediSCSIVolumes** *(list) --*
              ...
              * **NetworkInterfaceId** : The network interface ID of the stored volume that initiator use to
              map the stored volume as an iSCSI target.
              ...
              * **SourceSnapshotId** : If the stored volume was created from a snapshot, this field contains
              the snapshot ID used, e.g. snap-1122aabb. Otherwise, this field is not included.
              ...
              * **VolumeType** : One of the enumeration values describing the type of the volume. Currently,
              on STORED volumes are supported.
              ...
              - *(dict) --*
                ...
                - **VolumeAttachmentStatus** *(string) --*
                  ...
                  the process of detaching from a gateway. For more information, see `Moving Your Volumes to
                  a Different Gateway
                  <https://docs.aws.amazon.com/storagegateway/latest/userguide/managing-volumes.html#attach-detach-volume>`__
                  .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TapeArchives** *(list) --*
              ...
              Amazon Resource Names (ARNs) of the tapes, size of the tapes, status of the tapes, progress of
            ...
            - **Marker** *(string) --*
              ...
              description ended. Use this marker in your next request to fetch the next set of virtual tapes
              in the virtual tape shelf (VTS). If there are no more virtual tapes to describe, this field
    ...
    def describe_tape_recovery_points(
        ...
        A recovery point is a point-in-time view of a virtual tape at which all the data on the virtual tape
        ...
        **Request Syntax**
        ...
        :param VTLDeviceARNs:
          ...
          .. note::
            ...
            All of the specified VTL devices must be from the same gateway. If no VTL devices are specified,
            the result will contain all devices on the specified gateway.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Marker** *(string) --*
              ...
              description ended. Use the marker in your next request to fetch the next set of VTL devices in
              the list. If there are no more VTL devices to describe, this field does not appear in the
              response.
    ...
    def join_domain(
        ...
        **Request Syntax**
        ...
        :param DomainControllers:
          ...
          List of IPv4 addresses, NetBIOS names, or host names of your domain server. If you need to specify
          the port number include it after the colon (“:”). For example, ``mydc.mydomain.com:389`` .
        ...
        :param UserName: **[REQUIRED]**
          ...
          use the domain administrator account or an account with delegated permissions to join computers to
          the domain.
          ...
          - *(dict) --*
            ...
            *  ListTapesOutput$VolumeInfos
            ...
            - **Marker** *(string) --*
              ...
              the marker in your next request to continue pagination of tapes. If there are no more tapes to
    ...
    def list_volumes(
        ...
        or the  DescribeCachediSCSIVolumes API.

        The operation supports pagination. By default, the operation returns a maximum of up to 100 volumes.
        You can optionally specify the ``Limit`` field in the body to limit the number of volumes in the
        response. If the number of volumes returned in the response is truncated, the response includes a
        Marker field. You can use this Marker value in your subsequent request to retrieve the next set of
        volumes. This operation is only supported in the cached volume and stored volume gateway types.
    ...
    def notify_when_uploaded(
        ...
        """
        Sends you notification through CloudWatch Events when all files written to your file share have been
        ...
        configure CloudWatch Events to send the notification through event targets such as Amazon SNS or AWS
        Lambda function. This operation is only supported for file gateways.
    ...
    def refresh_cache(
        ...
        use the refresh-complete notification to determine that the operation has completed before you check
        for new files on the gateway file share. You can subscribe to be notified through an CloudWatch
        event when your ``RefreshCache`` operation completes.
        ...
        **Request Syntax**
        ...
        :param Recursive:
          ...
          Otherwise, subfolders listed in ``FolderList`` are not refreshed. Only objects that are in folders
          listed directly under ``FolderList`` are found and used for the update. The default is "true".
    ...
    def retrieve_tape_archive(
        ...
        Once a tape is successfully retrieved to a gateway, it cannot be retrieved again to another gateway.
        You must archive the tape again before you can retrieve it to another gateway. This operation is
        only supported in the tape gateway type.
    ...
    def shutdown_gateway(self, GatewayARN: str) -> ClientShutdownGatewayResponseTypeDef:
        ...
        The operation shuts down the gateway service component running in the gateway's virtual machine (VM)
        and not the host VM.
        ...
        .. note::
          ...
          it might take some time for the gateway to shut down. You can call the  DescribeGatewayInformation
          API to check the status. For more information, see  ActivateGateway .
    ...
    def start_gateway(self, GatewayARN: str) -> ClientStartGatewayResponseTypeDef:
        ...
        you can then make other API calls, your applications can read from or write to the gateway's storage
    ...
    def update_bandwidth_rate_limit(
        ...
        does not have any limitations on its bandwidth usage and could potentially use the maximum available
        bandwidth.
    ...
    def update_chap_credentials(
        ...
        it. This operation is supported in the volume and tape gateway types.

        .. warning::

          When you update CHAP credentials, all existing connections on the target are closed and initiators
    ...
    def update_gateway_software_now(
        ...
        .. warning::
          ...
          information about increasing iSCSI Initiator timeouts for Windows and Linux, see `Customizing Your
    ...
    def update_maintenance_start_time(
        ...
        **Request Syntax**
        ...
        :param DayOfMonth:
          ...
          1 to 28, where 1 represents the first day of the month and 28 represents the last day of the
          month.
    ...
    def update_smb_file_share(
        ...
        **Request Syntax**
        ...
        :param AdminUserList:
          ...
          must be prefixed with the @ character. For example ``@group1`` . Can only be set if Authentication
