...
LICENSE = "Apache 2.0"
PLATFORMS = "Any"
URL = "https://github.com/mballance/pyboolector"
...
#        package_dir={'': 'boolector/src/api/python'},
#        packages=['yaml'],
        ext_modules=[
...
# python3 ./boolector/src/api/python/mkoptions.py ./boolector/src/btortypes.h boolector/src/api/python/pyboolector_options.pxd
