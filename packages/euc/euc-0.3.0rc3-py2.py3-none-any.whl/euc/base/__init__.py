...
class BLEDevice:
    def __init__(self, system_bus, device_path):
    ...
    @classmethod
    def from_device(cls, system_bus, device_path, **kwargs):
        return cls(system_bus, device_path, **kwargs)
    ...
    async def connect(self):
        ...
        if not self.name:
            self.name = await device_itf.Name
...
class EUCBase(BLEDevice):
    def __init__(self, system_bus, device_path):
        super().__init__(system_bus, device_path)
