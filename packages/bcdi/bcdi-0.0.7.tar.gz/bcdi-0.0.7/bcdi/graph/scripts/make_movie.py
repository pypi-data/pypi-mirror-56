...
roi = [0, 516, 0, 516]  # ROI of the detector to be plotted [0, 516, 0, 516] Maxipix, [0, 2164, 0, 1030] Eiger2M
ccdfiletmp = os.path.join(datadir, "data_mpx4_%05d.edf.gz")  # ID01 template for the CCD file names
