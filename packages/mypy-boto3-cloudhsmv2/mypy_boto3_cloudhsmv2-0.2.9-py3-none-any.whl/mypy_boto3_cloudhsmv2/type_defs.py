...
class ClientCreateClusterResponseClusterCertificatesTypeDef(
    ...
    - **ClusterCsr** *(string) --*
      ...
      The cluster's certificate signing request (CSR). The CSR exists only when the cluster's state
      is ``UNINITIALIZED`` .
...
_ClientInitializeClusterResponseTypeDef = TypedDict(
    "_ClientInitializeClusterResponseTypeDef", {"State": str, "StateMessage": str}, total=False
)
