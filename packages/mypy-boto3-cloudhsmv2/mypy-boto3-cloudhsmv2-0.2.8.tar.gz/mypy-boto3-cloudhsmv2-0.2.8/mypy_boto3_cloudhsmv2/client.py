...
class Client(BaseClient):
          ...
          ::

            {
                'Cluster': {
                    ...
                    'Hsms': [
                        {
                            ...
                            'HsmId': 'string',
                            'State':
                            'CREATE_IN_PROGRESS'|'ACTIVE'|'DEGRADED'
                    ...
                    'SourceBackupId': 'string',
                    'State':
                    'CREATE_IN_PROGRESS'|'UNINITIALIZED'|'INITIALIZE_IN_PROGRESS'
          ...
          ::

            {
                'Hsm': {
                    ...
                    'HsmId': 'string',
                    'State':
                    'CREATE_IN_PROGRESS'|'ACTIVE'|'DEGRADED'|'DELETE_IN_PROGRESS'
                    |'DELETED',
                    'StateMessage': 'string'
                }
            }
    ...
    def delete_cluster(self, ClusterId: str) -> ClientDeleteClusterResponseTypeDef:
        """
        Deletes the specified AWS CloudHSM cluster. Before you can delete a cluster, you must delete
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              Use this value in a subsequent ``DescribeBackups`` request to get more backups.
    ...
    def describe_clusters(
        ...
        clusters. When you receive a response with no ``NextToken`` (or an empty or null value),
        that means there are no more clusters to get.
                ...
                'Clusters': [
                    {
                        ...
                        |'INITIALIZE_IN_PROGRESS'|'INITIALIZED'|'ACTIVE'
                        |'UPDATE_IN_PROGRESS'|'DELETE_IN_PROGRESS'|'DELETED'
                        |'DEGRADED',
                        'StateMessage': 'string',
                        'SubnetMapping': {
                            'string': 'string'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              Use this value in a subsequent ``DescribeClusters`` request to get more clusters.
    ...
    def initialize_cluster(
        ...
        **Request Syntax**
        ...
        :param TrustAnchor: **[REQUIRED]**
          ...
          The issuing certificate of the issuing certificate authority (CA) that issued (signed) the
          cluster certificate. This can be a root (self-signed) certificate or a certificate chain
        ...
        :returns:
          ...
          **Response Syntax**
          ...
          ::
            ...
            {
                'State':
                'CREATE_IN_PROGRESS'|'UNINITIALIZED'|'INITIALIZE_IN_PROGRESS'|'INITIALIZED'
                |'ACTIVE'|'UPDATE_IN_PROGRESS'|'DELETE_IN_PROGRESS'|'DELETED'|'DEGRADED',
                'StateMessage': 'string'
            }
          **Response Structure**
    ...
    def list_tags(
        ...
        value. Use this value in a subsequent ``ListTags`` request to get more tags. When you
        receive a response with no ``NextToken`` (or an empty or null value), that means there are
        no more tags to get.
