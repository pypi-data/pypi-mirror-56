"Main interface for cloudhsmv2 Client"
...
class Client(BaseClient):
    ...
    def copy_backup_to_region(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/CopyBackupToRegion>`_
    ...
    def create_cluster(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/CreateCluster>`_
        ...
        **Request Syntax**
        ...
        :param SubnetIds: **[REQUIRED]**
          ...
          one subnet. If you specify multiple subnets, they must meet the following criteria:
        ...
        :param SourceBackupId:
          ...
          backup instead of creating a new cluster. To find the backup ID, use  DescribeBackups .
          ...
          ::

            {
                'Cluster': {
                    ...
                    |'UPDATE_IN_PROGRESS'|'DELETE_IN_PROGRESS'|'DELETED'|'DEGRADED',
                    'StateMessage': 'string',
                    'SubnetMapping': {
                        'string': 'string'
                    },
    ...
    def create_hsm(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/CreateHsm>`_
        ...
        **Request Syntax**
        ...
        :param AvailabilityZone: **[REQUIRED]**
          ...
          The Availability Zone where you are creating the HSM. To find the cluster's Availability Zones,
    ...
    def delete_backup(self, BackupId: str) -> ClientDeleteBackupResponseTypeDef:
        ...
        DeleteBackup request. For more information on restoring a backup, see  RestoreBackup

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/DeleteBackup>`_
    ...
    def delete_cluster(self, ClusterId: str) -> ClientDeleteClusterResponseTypeDef:
        ...
        HSMs in the cluster. To see if the cluster contains any HSMs, use  DescribeClusters . To delete an
        HSM, use  DeleteHsm .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/DeleteCluster>`_
    ...
    def delete_hsm(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/DeleteHsm>`_
    ...
    def describe_backups(
        ...
        This is a paginated operation, which means that each response might contain only a subset of all the
        backups. When the response contains only a subset of backups, it includes a ``NextToken`` value. Use
        this value in a subsequent ``DescribeBackups`` request to get more backups. When you receive a
        response with no ``NextToken`` (or an empty or null value), that means there are no more backups to
        get.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/DescribeBackups>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of backups to return in the response. When there are more backups than the
    ...
    def describe_clusters(
        ...
        This is a paginated operation, which means that each response might contain only a subset of all the
        clusters. When the response contains only a subset of clusters, it includes a ``NextToken`` value.
        Use this value in a subsequent ``DescribeClusters`` request to get more clusters. When you receive a
        response with no ``NextToken`` (or an empty or null value), that means there are no more clusters to
        get.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/DescribeClusters>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              An opaque string that indicates that the response contains only a subset of clusters. Use this
    ...
    def initialize_cluster(
        ...
        certificate authority (CA) and the CA's root certificate. Before you can claim a cluster, you must
        sign the cluster's certificate signing request (CSR) with your issuing CA. To get the cluster's CSR,
        use  DescribeClusters .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/InitializeCluster>`_
        ...
        **Request Syntax**
        ...
        :param TrustAnchor: **[REQUIRED]**
          ...
          certificate. This can be a root (self-signed) certificate or a certificate chain that begins with
          the certificate that issued the cluster certificate and ends with a root certificate. The
          certificate or certificate chain must be in PEM format and can contain a maximum of 5000
          characters.
    ...
    def list_tags(
        ...
        This is a paginated operation, which means that each response might contain only a subset of all the
        tags. When the response contains only a subset of tags, it includes a ``NextToken`` value. Use this
        value in a subsequent ``ListTags`` request to get more tags. When you receive a response with no
        ``NextToken`` (or an empty or null value), that means there are no more tags to get.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/ListTags>`_
        ...
        **Request Syntax**
        ...
        :param ResourceId: **[REQUIRED]**
          ...
          The cluster identifier (ID) for the cluster whose tags you are getting. To find the cluster ID,
          use  DescribeClusters .
    ...
    def restore_backup(self, BackupId: str) -> ClientRestoreBackupResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/RestoreBackup>`_
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/TagResource>`_
    ...
    def untag_resource(self, ResourceId: str, TagKeyList: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cloudhsmv2-2017-04-28/UntagResource>`_
        ...
        **Request Syntax**
        ...
        :param ResourceId: **[REQUIRED]**
          ...
          The cluster identifier (ID) for the cluster whose tags you are removing. To find the cluster ID,
          use  DescribeClusters .
