...
```
python sentimentToExcel.py < input.txt > output.xlsx
```
"""
...
def main(args):
    ...
    with open(args.input, encoding='utf8') if args.input else sys.stdin as file:
        ...
        df = pd.DataFrame(records, columns=['docid', 'sentimentLabel', 'sentimentMean', 'sentimentPos', 'sentimentNeg'])
...
if __name__ == '__main__':
    ...
    argparser.add_argument("-o", "--output", help="The resulting excel file; columns: docid, sentimentLabel, sentimentMean, sentimentPos, sentimentNeg")
