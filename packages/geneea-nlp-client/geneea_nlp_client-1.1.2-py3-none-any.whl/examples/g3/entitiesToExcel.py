...
```
python entitiesToExcel.py < input.txt > output.xlsx
```
"""
...
if __name__ == '__main__':
    ...
    argparser.add_argument("-o", "--output", help="The resulting excel file; columns: docId, entityIndex, entityType, entityStdform")
