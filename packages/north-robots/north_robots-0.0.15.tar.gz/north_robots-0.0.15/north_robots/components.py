...
class GridTray(Tray):
    ...
    def __init__(self, location: Location, rows: int, columns: int, spacing: Tuple[int, int], order: int=ROW_COLUMN,
                 reverse_columns: bool=False, reverse_rows: bool=True):
        Tray.__init__(self)
