...
from src.RookieTools import __version__

setup(
    name='RookieTools',  # 包名称，之后如果上传到了pypi，则需要通过该名称下载
    version=__version__,  # version只能是数字，还有其他字符则会报错
    keywords=('setup', 'RookieTools'),
    description='setup RookieTools',
    long_description='',
    license='MIT',  # 遵循的协议
    install_requires=['requests', 'lxml', 'chardet', 'tldextract', 'urllib3'],  # 这里面填写项目用到的第三方依赖
    author='Rookie',
