...
class trainDataTransform():
    ...
    def extractAirpFeat(self, df):
        ...
        all_aircode = pd.read_csv('aircodes.csv')
        ...
        block_blob_service.get_blob_to_path('pai-data', 'airports_csv.csv', 'airports_csv.csv')
        airports_df = pd.read_csv('airports_csv.csv')
