...
class trainDataTransform():
    def __init__(self):
        ...
        self.block_blob_service = BlockBlobService(account_name='sasffpfraud', account_key='YP7R4YfmFW4uB84ORaAWj4q69fZJytWQulPi8umebDgLvedGaBtClYMHLM7jo7bsskzRjYz0Nl/A22g4bEDZAg==')
    ...
    def mail_group(self,  df):
        ...
        self.block_blob_service.get_blob_to_path('pai-data', 'validated_domains.csv', 'validated_domains.csv')
