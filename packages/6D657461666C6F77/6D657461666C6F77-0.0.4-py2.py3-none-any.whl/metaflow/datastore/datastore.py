...
class MetaflowDataStore(object):
    ...
    def get_log_location(self, logtype, attempt_override=None):
        """
        Return a string indicating the location of the log of the specified type.
        """
    ...
    @classmethod
    def get_datastore_root_from_config(cls):
        """
    ...
    def decode_gzip_data(cls, filename, fileobj=None):
        """
        Return the gzip data in file with `filename` or passed via `fileobj`.
        """
