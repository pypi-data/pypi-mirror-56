...
class ServiceMetadataProvider(MetadataProvider):
    ...
    def compute_info(cls, val):
        ...
        try:
            ...
            raise ValueError('Could not ping Metaflow service at %s' % v)
        return v
    ...
    def _request(cls, monitor, path, data=None):
        if cls.INFO is None:
            raise MetaflowException('Cannot find URL for Metaflow service -- did you properly set '
                                    'the METAFLOW_SERVICE_URL environment variable')
