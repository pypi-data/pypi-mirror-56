...
class Client(BaseClient):
    ...
    def associate_admin_account(self, AdminAccount: str) -> None:
        """
        Sets the AWS Firewall Manager administrator account. AWS Firewall Manager must be associated
        with the master account of your AWS organization or associated with a member account that
        has the appropriate permissions. If the account ID that you submit is not an AWS
        ...
        **Request Syntax**
        ...
        :param AdminAccount: **[REQUIRED]**
          ...
          account. For more information about AWS Organizations and master accounts, see `Managing
        ...
        **Request Syntax**
        ...
        :param DeleteAllPolicyResources:
          ...
          * Deletes the security group if it was created through Firewall Manager and if it's no
          ...
          Protection of out-of-scope resources remains unchanged. Scope is determined by tags that
          you create and accounts that you associate with the policy. When creating the policy, if
          you specify that only resources in specific accounts or with specific tags are in scope of
          the policy, those accounts and resources are handled by the policy. All others are out of
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_admin_account(self, *args: Any, **kwargs: Any) -> ClientGetAdminAccountResponseTypeDef:
        """
        Returns the AWS Organizations master account that is associated with AWS Firewall Manager as
    ...
    def get_compliance_detail(
        ...
        not been applied to them. Resources are considered noncompliant for security group policies
        if they are in scope of the policy, they violate one or more of the policy rules, and
          ...
          - *(dict) --*
            ...
            - **PolicyComplianceDetail** *(dict) --*
              ...
              - **IssueInfoMap** *(dict) --*
                ...
                are causing a resource to be noncompliant. The details include the name of the
                dependent service and the error message received that indicates the problem with the
                service.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_policy(self, PolicyId: str) -> ClientGetPolicyResponseTypeDef:
        """
...

            {
                'Policy': {
                    ...
                    'SecurityServicePolicyData': {
                        'Type':
                        'WAF'|'SHIELD_ADVANCED'|'SECURITY_GROUPS_COMMON'
          ...
          - *(dict) --*
            ...
            - **Policy** *(dict) --*
              ...
              - **PolicyUpdateToken** *(string) --*
                ...
                ``PolicyUpdateToken`` of the current policy version, use a ``GetPolicy`` request.
              ...
              - **SecurityServicePolicyData** *(dict) --*
                ...
                - **Type** *(string) --*
                  ...
                  type of policy that is created, either an AWS WAF policy, a Shield Advanced
                  policy, or a security group policy. For security group policies, Firewall Manager
                  supports one security group for each common policy and for each content audit
                  policy. This is an adjustable limit that you can increase by contacting AWS
                  Support.
                ...
                - **ManagedServiceData** *(string) --*
                  ...
                  * Example: ``WAF``    ``ManagedServiceData": "{\\"type\\": \\"WAF\\",
                  \\"ruleGroups\\": [{\\"id\\": \\"12345678-1bcd-9012-efga-0987654321ab\\",
                  ...
                  * Example: ``SECURITY_GROUPS_CONTENT_AUDIT``
                  ...
                  ``ALLOW`` , all in-scope security group rules must be within the allowed range of
                  the policy's security group rules. For ``DENY`` , all in-scope security group
                  rules must not contain a value or a range that matches a rule value or range in
                  the policy security group.
              ...
              - **ResourceType** *(string) --*
                ...
                shown in the `AWS Resource Types Reference
                <https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-template-resource-type-ref.html>`__
                ...
                ``AWS::EC2::NetworkInterface`` , and ``AWS::EC2::Instance`` . For a security group
                usage audit policy, the value is ``AWS::EC2::SecurityGroup`` .
              ...
              - **ResourceTags** *(list) --*
                ...
                - *(dict) --*
                  ...
                  resource should be included or excluded from the AWS Firewall Manager policy. Tags
                  enable you to categorize your AWS resources in different ways, for example, by
                  purpose, owner, or environment. Each tag consists of a key and an optional value.
                  Firewall Manager combines the tags with "AND" so that, if you add more than one
                  tag to a policy scope, a resource must have all the specified tags to be included
                  or excluded. For more information, see `Working with Tag Editor
              ...
              - **ExcludeResourceTags** *(boolean) --*
                ...
                ``ResourceTag`` array is not null, only resources with the specified tags are in
                scope of the policy.
              ...
              - **IncludeMap** *(dict) --*
                ...
                Specifies the AWS account IDs to include in the policy. If ``IncludeMap`` is null,
                all accounts in the organization in AWS Organizations are included in the policy. If
                ``IncludeMap`` is not null, only values listed in ``IncludeMap`` are included in the
                policy.
              ...
              - **ExcludeMap** *(dict) --*
                ...
                Specifies the AWS account IDs to exclude from the policy. The ``IncludeMap`` values
                are evaluated first, with all the appropriate account IDs added to the policy. Then
                the accounts listed in ``ExcludeMap`` are removed, resulting in the final list of
                accounts to add to the policy.
    ...
    def get_protection_status(
        ...
        **Request Syntax**
        ...
        :param StartTime:
          ...
          request syntax listing indicates a ``number`` type because the default used by AWS
        ...
        :param NextToken:
          ...
          you specify for ``MaxResults`` , AWS Firewall Manager returns a ``NextToken`` value in the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              request, the response includes a ``NextToken`` value. To list more objects, submit
              another ``GetProtectionStatus`` request, and specify the ``NextToken`` value from the
              ...
              subsequent request calls automatically on your behalf. However, this feature is not
    ...
    def list_compliance_status(
        ...
        ``PolicyComplianceStatus`` to get a summary of which member accounts are protected by the
        specified policy.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          objects than the number that you specify for ``MaxResults`` , AWS Firewall Manager returns
        ...
        :param MaxResults:
          ...
          Specifies the number of ``PolicyComplianceStatus`` objects that you want AWS Firewall
          Manager to return for this request. If you have more ``PolicyComplianceStatus`` objects
          ...
          - *(dict) --*
            ...
            - **PolicyComplianceStatusList** *(list) --*
              ...
              - *(dict) --*
                ...
                considered noncompliant if it includes resources that are not protected by the
                policy, for AWS WAF and Shield Advanced policies, or that are noncompliant with the
                policy, for security group policies.
                ...
                - **EvaluationResults** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **ViolatorCount** *(integer) --*
                      ...
                      it is not associated with the policy. For security group policies, a resource
            ...
            - **NextToken** *(string) --*
              ...
              If you have more ``PolicyComplianceStatus`` objects than the number that you specified
              for ``MaxResults`` in the request, the response includes a ``NextToken`` value. To
              list more ``PolicyComplianceStatus`` objects, submit another ``ListComplianceStatus``
    ...
    def list_member_accounts(
        ...
        The ``ListMemberAccounts`` must be submitted by the account that is set as the AWS Firewall
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          in the response that allows you to list another group of IDs. For the second and
          subsequent ``ListMemberAccountsRequest`` requests, specify the value of ``NextToken`` from
          the previous response to get information about another batch of member account IDs.

        :type MaxResults: integer
        :param MaxResults:

          Specifies the number of member account IDs that you want AWS Firewall Manager to return
          for this request. If you have more IDs than the number that you specify for ``MaxResults``
          , the response includes a ``NextToken`` value that you can use to get another batch of
          member account IDs.
    ...
    def list_policies(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          another batch of ``PolicySummary`` objects.

        :type MaxResults: integer
        :param MaxResults:

          Specifies the number of ``PolicySummary`` objects that you want AWS Firewall Manager to
          return for this request. If you have more ``PolicySummary`` objects than the number that
          you specify for ``MaxResults`` , the response includes a ``NextToken`` value that you can
            ...
            - **PolicyList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ResourceType** *(string) --*
                  ...
                  values are ``AWS::EC2::NetworkInterface`` and ``AWS::EC2::Instance`` . For a
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def put_policy(self, Policy: ClientPutPolicyPolicyTypeDef) -> ClientPutPolicyResponseTypeDef:
        """
        ...
        * An AWS WAF policy, which contains a rule group and defines which resources are to be
        protected by that rule group

        * A security group policy, which manages VPC security groups across your AWS organization.

        Each policy is specific to one of the three types. If you want to enforce more than one
        ...
        **Request Syntax**
        ...
        :param Policy: **[REQUIRED]**
          ...
          - **PolicyUpdateToken** *(string) --*
            ...
            current policy version. To get the ``PolicyUpdateToken`` of the current policy version,
            use a ``GetPolicy`` request.
          ...
          - **SecurityServicePolicyData** *(dict) --* **[REQUIRED]**
            ...
            - **Type** *(string) --* **[REQUIRED]**
              ...
              of policy that is created, either an AWS WAF policy, a Shield Advanced policy, or a
              security group policy. For security group policies, Firewall Manager supports one
          ...
          - **ResourceTags** *(list) --*
            ...
            - *(dict) --*
              ...
              to categorize your AWS resources in different ways, for example, by purpose, owner, or
              environment. Each tag consists of a key and an optional value. Firewall Manager
              combines the tags with "AND" so that, if you add more than one tag to a policy scope,
              a resource must have all the specified tags to be included or excluded. For more
          ...
          - **ExcludeMap** *(dict) --*
            ...
            accounts listed in ``ExcludeMap`` are removed, resulting in the final list of accounts
