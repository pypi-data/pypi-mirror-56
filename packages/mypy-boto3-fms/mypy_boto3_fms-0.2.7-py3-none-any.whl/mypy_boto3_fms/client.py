...
class Client(BaseClient):
    ...
    def get_admin_account(
        ...
        """
        Returns the AWS Organizations master account that is associated with AWS Firewall Manager as the AWS
                ...
                - **ManagedServiceData** *(string) --*
                  ...
                  * Example: ``SECURITY_GROUPS_CONTENT_AUDIT``
                  ...
                  \\"}],\\"securityGroupAction\\":{\\"type\\":\\"ALLOW\\"}}"},"RemediationEnabled":false,"ResourceType":"AWS::EC2::NetworkInterface"}``
                    ...
                    security group rules. For ``DENY`` , all in-scope security group rules must not contain
                    a value or a range that matches a rule value or range in the policy security group.
    ...
    def get_protection_status(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          ``GetProtectionStatus`` requests, specify the value of ``NextToken`` from the previous response to
    ...
    def list_compliance_status(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          than the number that you specify for ``MaxResults`` , AWS Firewall Manager returns a ``NextToken``
    ...
    def list_policies(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          the response that allows you to list another group of ``PolicySummary`` objects. For the second
          and subsequent ``ListPolicies`` requests, specify the value of ``NextToken`` from the previous
          response to get information about another batch of ``PolicySummary`` objects.

        :type MaxResults: integer
        :param MaxResults:

          Specifies the number of ``PolicySummary`` objects that you want AWS Firewall Manager to return for
    ...
    def put_notification_channel(self, SnsTopicArn: str, SnsRoleName: str) -> None:
        """
        Designates the IAM role and Amazon Simple Notification Service (SNS) topic that AWS Firewall Manager
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def put_policy(
        self, Policy: ClientPutPolicyPolicyTypeDef
    ) -> ClientPutPolicyResponseTypeDef:
        """
        ...
        :param Policy: **[REQUIRED]**
          ...
          - **ResourceTags** *(list) --*
            ...
            - *(dict) --*
              ...
              your AWS resources in different ways, for example, by purpose, owner, or environment. Each tag
              consists of a key and an optional value. Firewall Manager combines the tags with "AND" so
