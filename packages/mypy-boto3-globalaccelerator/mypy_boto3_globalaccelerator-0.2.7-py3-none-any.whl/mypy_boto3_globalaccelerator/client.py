...
class Client(BaseClient):
    ...
    def create_accelerator(
        ...
        such as Network Load Balancers. To see an AWS CLI example of creating an accelerator, scroll down to
        **Example** .
              ...
              - **EndpointDescriptions** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **Weight** *(integer) --*
                    ...
                    For example, you might specify endpoint weights of 4, 5, 5, and 6 (sum=20). The result
    ...
    def create_listener(
        ...
        **Request Syntax**
        ...
        :param ClientAffinity:
          ...
          stateful applications, regardless of the port and protocol of the client request. Clienty affinity
          gives you control over whether to always route each client to the same specific endpoint.

          AWS Global Accelerator uses a consistent-flow hashing algorithm to choose the optimal endpoint for
          a connection. If client affinity is ``NONE`` , Global Accelerator uses the "five-tuple" (5-tuple)
