"Main interface for globalaccelerator Paginators"
...
class ListAcceleratorsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        :py:meth:`GlobalAccelerator.Client.list_accelerators`.
...
class ListEndpointGroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`GlobalAccelerator.Client.list_endpoint_groups`.
...
class ListListenersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`GlobalAccelerator.Client.list_listeners`.
