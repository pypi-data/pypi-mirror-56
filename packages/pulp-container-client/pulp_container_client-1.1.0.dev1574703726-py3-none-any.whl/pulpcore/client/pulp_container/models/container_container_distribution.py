...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, pulp_created=None, pulp_href=None, base_path=None, content_guard=None, repository_version=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
