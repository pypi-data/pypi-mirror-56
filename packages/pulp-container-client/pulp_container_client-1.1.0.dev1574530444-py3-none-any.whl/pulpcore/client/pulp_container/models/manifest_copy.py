...
class ManifestCopy(object):
    ...
    def media_types(self, media_types):
        ...
        :type: list[str]
        """
        allowed_values = ["application/vnd.docker.distribution.manifest.v1+json", "application/vnd.docker.distribution.manifest.v2+json", "application/vnd.docker.distribution.manifest.list.v2+json"]  # noqa: E501
