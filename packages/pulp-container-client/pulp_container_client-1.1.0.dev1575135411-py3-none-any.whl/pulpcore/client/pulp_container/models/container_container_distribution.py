...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_href=None, name=None, pulp_created=None, repository=None, content_guard=None, repository_version=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
