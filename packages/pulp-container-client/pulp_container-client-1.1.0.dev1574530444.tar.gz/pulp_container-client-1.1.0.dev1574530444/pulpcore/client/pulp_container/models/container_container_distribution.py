...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, pulp_created=None, repository=None, repository_version=None, name=None, content_guard=None, pulp_href=None, base_path=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
