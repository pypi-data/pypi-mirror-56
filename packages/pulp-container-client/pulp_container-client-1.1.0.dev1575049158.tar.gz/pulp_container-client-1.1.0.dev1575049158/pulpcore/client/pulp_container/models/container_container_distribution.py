...
class ContainerContainerDistribution(object):
    ...
    def __init__(self, repository=None, content_guard=None, repository_version=None, pulp_created=None, base_path=None, pulp_href=None, name=None, registry_path=None, local_vars_configuration=None):  # noqa: E501
