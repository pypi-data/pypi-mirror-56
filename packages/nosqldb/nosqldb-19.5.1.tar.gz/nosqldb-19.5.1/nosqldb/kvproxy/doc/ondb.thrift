...
4 - KVProxy 4.4 adds 2 new service methods:
    - getOptions
    - getTableInfo
5 - KVProxy 19.1 adds an optional field into TWriteResult to represent the
    identity value of a table
    - JSON identityGeneratedValue
*/
const TInt PROTOCOL_VERSION = 5;
...
struct TWriteResult
{
    ...
    // a json string that represents the identity column name/value, which is
    // set by the putXXX methods if the table contains an identity column
    6:optional JSON identityGeneratedValue;
}
