import sqlconnection  # for __init__ loading
import os
import logging
import psycopg2
...
class Postgresql:
    ...
    def create_connection(self):
        ...
        try:
            ...
            raise Exception("Connection Error with Postgresql connection={}".format(str(self.connection)))
    ...
    def close_connection(self):
        if self.connection is not None and self.connection.closed == 0:
            try:
                ...
                logger.warning('connection={}'.format(str(self.connection)))
            self.connection = None
