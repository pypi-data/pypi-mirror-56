...
Mypy-friendly auto-generated type annotations for `boto3 textract 1.10.28` service.
...
session_client = session.client("textract")
...
```python
import boto3
from mypy_boto3.textract import Client
