"Main interface for textract Client"
...
class Client(BaseClient):
    ...
    def analyze_document(
        ...
        * Words and lines that are related to nearby lines and words. The related information is
        returned in two  Block objects each of type ``KEY_VALUE_SET`` : a KEY Block object and a
        VALUE Block object. For example, *Name: Ana Silva Carolina* contains a key and value.
        ...
        * Selectable elements such as checkboxes and radio buttons. A SELECTION_ELEMENT Block object
        contains information about a selectable element.
        ...
        * Lines and words of text. A LINE Block object contains one or more WORD Block objects.
        ...
        <https://docs.aws.amazon.com/textract/latest/dg/how-it-works-analyzing.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/AnalyzeDocument>`_
        ...
        **Request Syntax**
        ...
        :param Document: **[REQUIRED]**
          ...
          - **Bytes** *(bytes) --*
            ...
            A blob of base-64 encoded documents bytes. The maximum size of a document that's
            provided in a blob of bytes is 5 MB. The document bytes must be in PNG or JPG format.
          ...
          - **S3Object** *(dict) --*
            ...
            Identifies an S3 object as the document source. The maximum size of a document stored in
            an S3 bucket is 5 MB.
        ...
        :param FeatureTypes: **[REQUIRED]**
          ...
          about the tables detected in the input document. Add FORMS to return detected fields and
          the associated text. To perform both types of analysis, add TABLES and FORMS to
          ``FeatureTypes`` .
          ...
          ::

            {
                ...
                'Blocks': [
                    {
                        'BlockType':
                        'KEY_VALUE_SET'|'PAGE'|'LINE'|'WORD'|'TABLE'|'CELL'
                        |'SELECTION_ELEMENT',
                        'Confidence': ...,
                        'Text': 'string',
                        'RowIndex': 123,
          ...
          - *(dict) --*
            ...
            - **Blocks** *(list) --*
              ...
              - *(dict) --*
                ...
                pixels close to each other. The information returned in a ``Block`` depends on the
                type of operation. In document-text detection (for example  DetectDocumentText ),
                ...
                operations. In synchronous operations, such as  DetectDocumentText , the array of
                ``Block`` objects is the entire set of results. In asynchronous operations, such as
                ...
                - **BlockType** *(string) --*
                  ...
                  * *LINE* - A string of tab-delimited, contiguous words that's detected on a
                  document page.

                  In text analysis operations, the following types are returned:

                  * *PAGE* - Contains a list of child Block objects that are detected on a document
                  page.

                  * *KEY_VALUE_SET* - Stores the KEY and VALUE Block objects for a field that's
                  detected on a document page. Use the ``EntityType`` field to determine if a
                  KEY_VALUE_SET object is a KEY Block object or a VALUE Block object.

                  * *WORD* - A word detected on a document page. A word is one or more ISO basic
                  Latin script characters that aren't separated by spaces that's detected on a
                  document page.
                ...
                - **Geometry** *(dict) --*
                  ...
                  - **BoundingBox** *(dict) --*
                    ...
                    An axis-aligned coarse representation of the location of the recognized text on
                    the document page.
                  ...
                  - **Polygon** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      input document is 700 x 200 and the operation returns X=
                          0.5 and Y=0.25, then
                ...
                - **Relationships** *(list) --*
                  ...
                  blocks for each WORD block that's part of the line of text. There aren't
                  Relationship objects in the list for relationships that don't exist, such as when
                  the current block has no child blocks. The list size can be the following:
                ...
                - **Page** *(integer) --*
                  ...
                  document pages, is always considered to be a single-page document and the value of
                  ``Page`` is always 1. Synchronous operations don't return ``Page`` as every input
    ...
    def detect_document_text(
        ...
        that make up a line of text. The input document must be an image in JPG or PNG format.
        ...
        is the parent of LINE ``Block`` objects that represent the lines of detected text on a page.
        A LINE ``Block`` object is a parent for each word that makes up the line. Words are
        ...
        <https://docs.aws.amazon.com/textract/latest/dg/how-it-works-detecting.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/DetectDocumentText>`_
    ...
    def get_document_analysis(
        ...
        that's registered in the initial call to ``StartDocumentAnalysis`` . To get the results of
        the text-detection operation, first check that the status value published to the Amazon SNS
        ...
        * Lines and words of text. A LINE Block object contains one or more WORD Block objects.
        ...
        Use the ``MaxResults`` parameter to limit the number of blocks returned. If there are more
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/GetDocumentAnalysis>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results to return per paginated call. The largest value that you can
    ...
    def get_document_text_detection(
        ...
        You start asynchronous text detection by calling  StartDocumentTextDetection , which returns
        a job identifier (``JobId`` ). When the text detection operation finishes, Amazon Textract
        publishes a completion status to the Amazon Simple Notification Service (Amazon SNS) topic
        that's registered in the initial call to ``StartDocumentTextDetection`` . To get the results
        of the text-detection operation, first check that the status value published to the Amazon
        SNS topic is ``SUCCEEDED`` . If so, call ``GetDocumentTextDetection`` , and pass the job
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/GetDocumentTextDetection>`_
    ...
    def start_document_analysis(
        ...
        """
        Starts asynchronous analysis of an input document for relationships between detected items
        such as key and value pairs, tables, and selection elements.

         ``StartDocumentAnalysis`` can analyze text in documents that are in JPG, PNG, and PDF
         ...
         results of the operation. When text analysis is finished, Amazon Textract publishes a
         completion status to the Amazon Simple Notification Service (Amazon SNS) topic that you
         specify in ``NotificationChannel`` . To get the results of the text analysis operation,
         first check that the status value published to the Amazon SNS topic is ``SUCCEEDED`` . If
         so, call  GetDocumentAnalysis , and pass the job identifier (``JobId`` ) from the initial
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/StartDocumentAnalysis>`_
        ...
        **Request Syntax**
        ...
        :param FeatureTypes: **[REQUIRED]**
          ...
          fields and the associated text. To perform both types of analysis, add TABLES and FORMS to
          ``FeatureTypes`` . All selectable elements (``SELECTION_ELEMENT`` ) that are detected are
          returned, whatever the value of ``FeatureTypes`` .
        ...
        :param ClientRequestToken:
          ...
          with multiple ``StartDocumentAnalysis`` requests, the same ``JobId`` is returned. Use
        ...
        :param JobTag:
          ...
          document, such as a tax form or a receipt, that the completion notification corresponds
          to.

        :type NotificationChannel: dict
        :param NotificationChannel:

          The Amazon SNS topic ARN that you want Amazon Textract to publish the completion status of
          the operation to.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **JobId** *(string) --*
              ...
              The identifier for the document text detection job. Use ``JobId`` to identify the job
              in a subsequent call to ``GetDocumentAnalysis`` .
    ...
    def start_document_text_detection(
        ...
        text and the words that make up a line of text.
         ...
         ``StartDocumentTextDetection`` can analyze text in documents that are in JPG, PNG, and PDF
         format. The documents are stored in an Amazon S3 bucket. Use  DocumentLocation to specify
         the bucket name and file name of the document.
         ...
         completion status to the Amazon Simple Notification Service (Amazon SNS) topic that you
         specify in ``NotificationChannel`` . To get the results of the text detection operation,
         first check that the status value published to the Amazon SNS topic is ``SUCCEEDED`` . If
         so, call  GetDocumentTextDetection , and pass the job identifier (``JobId`` ) from the
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/textract-2018-06-27/StartDocumentTextDetection>`_
