...
class Client(BaseClient):
    ...
    def analyze_document(
        ...
        * Words and lines that are related to nearby lines and words. The related information is returned in
        two  Block objects each of type ``KEY_VALUE_SET`` : a KEY Block object and a VALUE Block object. For
        example, *Name: Ana Silva Carolina* contains a key and value. *Name:* is the key. *Ana Silva
        Carolina* is the value.

        * Table and table cell data. A TABLE Block object contains information about a detected table. A
        ...
        **Request Syntax**
        ...
        :param FeatureTypes: **[REQUIRED]**
          ...
          tables detected in the input document. Add FORMS to return detected fields and the associated
            ...
            - **Blocks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Geometry** *(dict) --*
                  ...
                  - **Polygon** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      The X and Y coordinates of a point on a document page. The X and Y values returned are
                      ratios of the overall document page size. For example, if the input document is 700 x
                      200 and the operation returns X=0.5 and Y=0.25, then the point is at the (350,50)
                ...
                - **Relationships** *(list) --*
                  ...
                  * 1 - The block has child blocks.
                  ...
                  - *(dict) --*
                    ...
                    Information about how blocks are related to each other. A ``Block`` object contains 0 or
                    more ``Relation`` objects in a list, ``Relationships`` . For more information, see
                    Block .
                    ...
                    - **Type** *(string) --*
                      ...
                      The relationship can be ``VALUE`` or ``CHILD`` .
                ...
                - **Page** *(integer) --*
                  ...
                  considered to be a single-page document and the value of ``Page`` is always 1. Synchronous
                  operations don't return ``Page`` as every input document is considered to be a single-page
                  document.
    ...
    def detect_document_text(
        ...
        up a line of text. The input document must be an image in JPG or PNG format. ``DetectDocumentText``
    ...
    def get_document_analysis(
        ...
        the initial call to ``StartDocumentAnalysis`` . To get the results of the text-detection operation,
        ...
        * Lines and words of text. A LINE Block object contains one or more WORD Block objects.
        ...
        Use the ``MaxResults`` parameter to limit the number of blocks returned. If there are more results
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the previous response was incomplete (because there are more blocks to retrieve), Amazon
          Textract returns a pagination token in the response. You can use this pagination token to retrieve
    ...
    def get_document_text_detection(
        ...
        completion status to the Amazon Simple Notification Service (Amazon SNS) topic that's registered in
        the initial call to ``StartDocumentTextDetection`` . To get the results of the text-detection
        operation, first check that the status value published to the Amazon SNS topic is ``SUCCEEDED`` . If
        so, call ``GetDocumentTextDetection`` , and pass the job identifier (``JobId`` ) from the initial
        ...
        call ``GetDocumentTextDetection`` , and populate the ``NextToken`` request parameter with the token
    ...
    def start_document_analysis(
        ...
        """
        Starts asynchronous analysis of an input document for relationships between detected items such as
        key and value pairs, tables, and selection elements.

         ``StartDocumentAnalysis`` can analyze text in documents that are in JPG, PNG, and PDF format. The
         documents are stored in an Amazon S3 bucket. Use  DocumentLocation to specify the bucket name and
         file name of the document.

         ``StartDocumentAnalysis`` returns a job identifier (``JobId`` ) that you use to get the results of
         the operation. When text analysis is finished, Amazon Textract publishes a completion status to the
         Amazon Simple Notification Service (Amazon SNS) topic that you specify in ``NotificationChannel`` .
         To get the results of the text analysis operation, first check that the status value published to
         the Amazon SNS topic is ``SUCCEEDED`` . If so, call  GetDocumentAnalysis , and pass the job
        ...
        **Request Syntax**
        ...
        :param FeatureTypes: **[REQUIRED]**
          ...
          A list of the types of analysis to perform. Add TABLES to the list to return information about the
          tables that are detected in the input document. Add FORMS to return detected fields and the
          associated text. To perform both types of analysis, add TABLES and FORMS to ``FeatureTypes`` . All
          selectable elements (``SELECTION_ELEMENT`` ) that are detected are returned, whatever the value of
          ``FeatureTypes`` .
        ...
        :param ClientRequestToken:
          ...
          multiple ``StartDocumentAnalysis`` requests, the same ``JobId`` is returned. Use
        ...
        :param JobTag:
          ...
          Amazon SNS topic. For example, you can use ``JobTag`` to identify the type of document, such as a
          tax form or a receipt, that the completion notification corresponds to.
    ...
    def start_document_text_detection(
        ...
        and the words that make up a line of text.
         ...
         ``StartDocumentTextDetection`` can analyze text in documents that are in JPG, PNG, and PDF format.
         The documents are stored in an Amazon S3 bucket. Use  DocumentLocation to specify the bucket name
         and file name of the document.

         ``StartTextDetection`` returns a job identifier (``JobId`` ) that you use to get the results of the
         operation. When text detection is finished, Amazon Textract publishes a completion status to the
         Amazon Simple Notification Service (Amazon SNS) topic that you specify in ``NotificationChannel`` .
         To get the results of the text detection operation, first check that the status value published to
         the Amazon SNS topic is ``SUCCEEDED`` . If so, call  GetDocumentTextDetection , and pass the job
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          multiple ``StartDocumentTextDetection`` requests, the same ``JobId`` is returned. Use
          ``ClientRequestToken`` to prevent the same job from being accidentally started more than once.
