# -*- coding: utf-8 -*-
"""Distribute 'yapyutils', a common enumeration library for Python syntax and
...
_packages = find_packages(include=['yapyutils', ])
"""Python packages to be installed."""

_packages_sdk = find_packages(include=['yapyutils'] )
"""Python packages to be installed."""
...
_url='https://sourceforge.net/projects/yapyutils/'
"""URL of this package"""

#_download_url="https://github.com/ArnoCan/yapyutils/"
_download_url="https://sourceforge.net/projects/yapyutils/files/"
...
class build_docx(BuildDocX):
    ...
    def join_sphinx_mod_sphinx(self, dirpath):
        ...
        * API
        ...
        yapyutils.files.utilities.sed(fn, pt, rp, re.MULTILINE)  # @UndefinedVariable
