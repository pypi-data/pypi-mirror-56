"Main interface for docdb Client"
...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/AddTagsToResource>`_
    ...
    def apply_pending_maintenance_action(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ApplyPendingMaintenanceAction>`_
    ...
    def copy_db_cluster_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CopyDBClusterParameterGroup>`_
    ...
    def copy_db_cluster_snapshot(
        ...
        To cancel the copy operation after it is in progress, delete the target DB cluster snapshot
        identified by ``TargetDBClusterSnapshotIdentifier`` while that DB cluster snapshot is in the
        *copying* status.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CopyDBClusterSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param SourceDBClusterSnapshotIdentifier: **[REQUIRED]**
          ...
          * If the source snapshot is in a different AWS Region than the copy, specify a valid DB cluster
          snapshot ARN.
        ...
        :param KmsKeyId:
          ...
          Name (ARN), AWS KMS key identifier, or the AWS KMS key alias for the AWS KMS encryption key.

          If you copy an encrypted DB cluster snapshot from your AWS account, you can specify a value for
          ``KmsKeyId`` to encrypt the copy with a new AWS KMS encryption key. If you don't specify a value
          for ``KmsKeyId`` , then the copy of the DB cluster snapshot is encrypted with the same AWS KMS key
          ...
          To copy an encrypted DB cluster snapshot to another AWS Region, set ``KmsKeyId`` to the AWS KMS
          key ID that you want to use to encrypt the copy of the DB cluster snapshot in the destination
          Region. AWS KMS encryption keys are specific to the AWS Region that they are created in, and you
        ...
        :param PreSignedUrl:
          ...
          ``PreSignedUrl`` parameter when copying an encrypted DB cluster snapshot from another AWS Region.

          The presigned URL must be a valid request for the ``CopyDBSClusterSnapshot`` API action that can
          be executed in the source AWS Region that contains the encrypted DB cluster snapshot to be copied.
          ...
          * ``DestinationRegion`` - The name of the AWS Region that the DB cluster snapshot will be created
          in.

          * ``SourceDBClusterSnapshotIdentifier`` - The DB cluster snapshot identifier for the encrypted DB
          cluster snapshot to be copied. This identifier must be in the Amazon Resource Name (ARN) format
          for the source AWS Region. For example, if you are copying an encrypted DB cluster snapshot from
          the us-west-2 AWS Region, then your ``SourceDBClusterSnapshotIdentifier`` looks like the following
          example: ``arn:aws:rds:us-west-2:123456789012:cluster-snapshot:my-cluster-snapshot-20161115`` .

        :type CopyTags: boolean
        :param CopyTags:

          Set to ``true`` to copy all tags from the source DB cluster snapshot to the target DB cluster
    ...
    def create_db_cluster(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CreateDBCluster>`_
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          you are creating a DB cluster using the same AWS account that owns the AWS KMS encryption key that
          is used to encrypt the new DB cluster, you can use the AWS KMS key alias instead of the ARN for
          the AWS KMS encryption key.

          If an encryption key is not specified in ``KmsKeyId`` :

          * If ``ReplicationSourceIdentifier`` identifies an encrypted source, then Amazon DocumentDB uses
          the encryption key that is used to encrypt the source. Otherwise, Amazon DocumentDB uses your
          ...
          - *(dict) --*
            ...
            - **DBCluster** *(dict) --*
              ...
              - **ReaderEndpoint** *(string) --*
                ...
                functionality can help balance your read workload across multiple Amazon DocumentDB replicas
                in your DB cluster.
    ...
    def create_db_cluster_parameter_group(
        ...
        associate it with your DB cluster. For the new DB cluster parameter group and associated settings to
        take effect, you must then reboot the DB instances in the DB cluster without failover.
        ...
        .. warning::
          ...
          This allows Amazon DocumentDB to fully complete the create action before the DB cluster parameter
          group is used as the default for a new DB cluster. This step is especially important for
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CreateDBClusterParameterGroup>`_
    ...
    def create_db_cluster_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CreateDBClusterSnapshot>`_
    ...
    def create_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CreateDBInstance>`_
        ...
        **Request Syntax**
        ...
        :param AvailabilityZone:
          ...
          set to ``true`` . The specified Availability Zone must be in the same AWS Region as the current
          endpoint.
          ...
          - *(dict) --*
            ...
            - **DBInstance** *(dict) --*
              ...
              - **DBSubnetGroup** *(dict) --*
                ...
                Specifies information on the subnet group that is associated with the DB instance, including
                the name, description, and subnets in the subnet group.
    ...
    def create_db_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/CreateDBSubnetGroup>`_
    ...
    def delete_db_cluster(
        ...
        """
        Deletes a previously provisioned DB cluster. When you delete a DB cluster, all automated backups for
        that DB cluster are deleted and can't be recovered. Manual DB cluster snapshots of the specified DB
        cluster are not deleted.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DeleteDBCluster>`_
    ...
    def delete_db_cluster_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DeleteDBClusterParameterGroup>`_
    ...
    def delete_db_cluster_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DeleteDBClusterSnapshot>`_
    ...
    def delete_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DeleteDBInstance>`_
    ...
    def delete_db_subnet_group(self, DBSubnetGroupName: str) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DeleteDBSubnetGroup>`_
    ...
    def describe_certificates(
        ...
        """
        Returns a list of certificate authority (CA) certificates provided by Amazon RDS for this AWS
        account.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeCertificates>`_
    ...
    def describe_db_cluster_parameter_groups(
        ...
        parameter is specified, the list contains only the description of the specified DB cluster parameter
        group.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBClusterParameterGroups>`_
    ...
    def describe_db_cluster_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBClusterParameters>`_
    ...
    def describe_db_cluster_snapshot_attributes(
        ...
        When you share snapshots with other AWS accounts, ``DescribeDBClusterSnapshotAttributes`` returns
        the ``restore`` attribute and a list of IDs for the AWS accounts that are authorized to copy or
        restore the manual DB cluster snapshot. If ``all`` is included in the list of values for the
        ``restore`` attribute, then the manual DB cluster snapshot is public and can be copied or restored
        by all AWS accounts.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBClusterSnapshotAttributes>`_
    ...
    def describe_db_cluster_snapshots(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBClusterSnapshots>`_
        ...
        **Request Syntax**
        ...
        :param DBClusterIdentifier:
          ...
          used with the ``DBClusterSnapshotIdentifier`` parameter. This parameter is not case sensitive.
        ...
        :param SnapshotType:
          ...
          * ``automated`` - Return all DB cluster snapshots that Amazon DocumentDB has automatically created
          for your AWS account.

          * ``manual`` - Return all DB cluster snapshots that you have manually created for your AWS
          account.
        ...
        :param IncludeShared:
          ...
          Set to ``true`` to include shared manual DB cluster snapshots from other AWS accounts that this
          AWS account has been given permission to copy or restore, and otherwise ``false`` . The default is
          ``false`` .

        :type IncludePublic: boolean
        :param IncludePublic:

          Set to ``true`` to include manual DB cluster snapshots that are public and can be copied or
    ...
    def describe_db_clusters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBClusters>`_
    ...
    def describe_db_engine_versions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBEngineVersions>`_
    ...
    def describe_db_instances(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``db-cluster-id`` - Accepts DB cluster identifiers and DB cluster Amazon Resource Names (ARNs).
          The results list includes only the information about the DB instances that are associated with the
          DB clusters that are identified by these ARNs.
    ...
    def describe_db_subnet_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeDBSubnetGroups>`_
    ...
    def describe_engine_default_cluster_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeEngineDefaultClusterParameters>`_
    ...
    def describe_event_categories(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeEventCategories>`_
    ...
    def describe_events(
        ...
        for the past 14 days. You can obtain events specific to a particular DB instance, DB security group,
        DB snapshot, or DB parameter group by providing the name as a parameter. By default, the events of
        the past hour are returned.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeEvents>`_
    ...
    def describe_orderable_db_instance_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribeOrderableDBInstanceOptions>`_
        ...
        **Request Syntax**
        ...
        :param Vpc:
          ...
          The virtual private cloud (VPC) filter value. Specify this parameter to show only the available
    ...
    def describe_pending_maintenance_actions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/DescribePendingMaintenanceActions>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``db-cluster-id`` - Accepts DB cluster identifiers and DB cluster Amazon Resource Names (ARNs).
          The results list includes only pending maintenance actions for the DB clusters identified by these
          ARNs.
    ...
    def failover_db_cluster(
        ...
        A failover for a DB cluster promotes one of the Amazon DocumentDB replicas (read-only instances) in
        the DB cluster to be the primary instance (the cluster writer).

        If the primary instance fails, Amazon DocumentDB automatically fails over to an Amazon DocumentDB
        replica, if one exists. You can force a failover when you want to simulate a failure of a primary
        instance for testing.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/FailoverDBCluster>`_
        ...
        **Request Syntax**
        ...
        :param TargetDBInstanceIdentifier:
          ...
          You must specify the instance identifier for an Amazon DocumentDB replica in the DB cluster. For
    ...
    def list_tags_for_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ListTagsForResource>`_
    ...
    def modify_db_cluster(
        ...
        """
        Modifies a setting for an Amazon DocumentDB DB cluster. You can change one or more database
        configuration parameters by specifying these parameters and the new values in the request.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyDBCluster>`_
        ...
        **Request Syntax**
        ...
        :param CloudwatchLogsExportConfiguration:
          ...
          The configuration setting for the log types to be enabled for export to Amazon CloudWatch Logs for
          a specific DB instance or DB cluster. The ``EnableLogTypes`` and ``DisableLogTypes`` arrays
    ...
    def modify_db_cluster_parameter_group(
        ...
        .. warning::
          ...
          After you create a DB cluster parameter group, you should wait at least 5 minutes before creating
          your first DB cluster that uses that DB cluster parameter group as the default parameter group.
          This allows Amazon DocumentDB to fully complete the create action before the parameter group is
          used as the default for a new DB cluster. This step is especially important for parameters that
          are critical when creating the default database for a DB cluster, such as the character set for
          the default database defined by the ``character_set_database`` parameter.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyDBClusterParameterGroup>`_
    ...
    def modify_db_cluster_snapshot_attribute(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyDBClusterSnapshotAttribute>`_
        ...
        **Request Syntax**
        ...
        :param ValuesToAdd:
          ...
          include one or more AWS account IDs. To make the manual DB cluster snapshot restorable by any AWS
          account, set it to ``all`` . Do not add the ``all`` value for any manual DB cluster snapshots that
          contain private information that you don't want to be available to all AWS accounts.
        ...
        :param ValuesToRemove:
          ...
          set this list to include one or more AWS account identifiers. To remove authorization for any AWS
          account to copy or restore the DB cluster snapshot, set it to ``all`` . If you specify ``all`` ,
          an AWS account whose account ID is explicitly added to the ``restore`` attribute can still copy or
    ...
    def modify_db_instance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyDBInstance>`_
        ...
        **Request Syntax**
        ...
        :param DBInstanceClass:
          ...
          The new compute and memory capacity of the DB instance; for example, ``db.r5.large`` . Not all DB
        ...
        :param PreferredMaintenanceWindow:
          ...
          the change is asynchronously applied as soon as possible. If there are pending actions that cause
          a reboot, and the maintenance window is changed to include the current time, changing this
          parameter causes a reboot of the DB instance. If you are moving this window to the current time,
          there must be at least 30 minutes between the current time and end of the window to ensure that
        ...
        :param AutoMinorVersionUpgrade:
          ...
          case, and the change is asynchronously applied as soon as possible. An outage results if this
          parameter is set to ``true`` during the maintenance window, and a newer minor version is
          available, and Amazon DocumentDB has enabled automatic patching for that engine version.
        ...
        :param NewDBInstanceIdentifier:
          ...
          the DB instance identifier, an instance reboot occurs immediately if you set ``Apply Immediately``
          to ``true`` . It occurs during the next maintenance window if you set ``Apply Immediately`` to
    ...
    def modify_db_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ModifyDBSubnetGroup>`_
    ...
    def reboot_db_instance(
        ...
        certain changes, or if you change the DB cluster parameter group that is associated with the DB
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/RebootDBInstance>`_
    ...
    def remove_tags_from_resource(self, ResourceName: str, TagKeys: List[str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/RemoveTagsFromResource>`_
    ...
    def reset_db_cluster_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/ResetDBClusterParameterGroup>`_
    ...
    def restore_db_cluster_from_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/RestoreDBClusterFromSnapshot>`_
        ...
        **Request Syntax**
        ...
        :param AvailabilityZones:
          ...
          Provides the list of Amazon EC2 Availability Zones that instances in the restored DB cluster can
          be created in.
        ...
        :param KmsKeyId:
          ...
          The AWS KMS key identifier is the Amazon Resource Name (ARN) for the AWS KMS encryption key. If
          you are restoring a DB cluster with the same AWS account that owns the AWS KMS encryption key used
          to encrypt the new DB cluster, then you can use the AWS KMS key alias instead of the ARN for the
          AWS KMS encryption key.

          If you do not specify a value for the ``KmsKeyId`` parameter, then the following occurs:

          * If the DB snapshot or DB cluster snapshot in ``SnapshotIdentifier`` is encrypted, then the
          restored DB cluster is encrypted using the AWS KMS key that was used to encrypt the DB snapshot or
          the DB cluster snapshot.

          * If the DB snapshot or the DB cluster snapshot in ``SnapshotIdentifier`` is not encrypted, then
    ...
    def restore_db_cluster_to_point_in_time(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/RestoreDBClusterToPointInTime>`_
        ...
        **Request Syntax**
        ...
        :param KmsKeyId:
          ...
          You can restore to a new DB cluster and encrypt the new DB cluster with an AWS KMS key that is
          different from the AWS KMS key used to encrypt the source DB cluster. The new DB cluster is
          encrypted with the AWS KMS key identified by the ``KmsKeyId`` parameter.

          If you do not specify a value for the ``KmsKeyId`` parameter, then the following occurs:

          * If the DB cluster is encrypted, then the restored DB cluster is encrypted using the AWS KMS key
          that was used to encrypt the source DB cluster.
    ...
    def start_db_cluster(
        ...
        <https://docs.aws.amazon.com/documentdb/latest/developerguide/db-cluster-stop-start.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/StartDBCluster>`_
    ...
    def stop_db_cluster(
        ...
        *available* state. For more information, see `Stopping and Starting an Amazon DocumentDB Cluster
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/docdb-2014-10-31/StopDBCluster>`_
