...
class Client(BaseClient):
          ...
          ::

            {
                'ComprehendMedicalAsyncJobProperties': {
                    ...
                    'JobName': 'string',
                    'JobStatus':
                    'SUBMITTED'|'IN_PROGRESS'|'COMPLETED'|'PARTIAL_SUCCESS'|'FAILED'
          ...
          - *(dict) --*
            ...
            - **ComprehendMedicalAsyncJobProperties** *(dict) --*
              ...
              - **ExpirationTime** *(datetime) --*
                ...
                appear in the results of the ``ListEntitiesDetectionV2Job`` or the
              ...
              - **InputDataConfig** *(dict) --*
                ...
                - **S3Bucket** *(string) --*
                  ...
                  Each file in the document collection must be less than 40 KB. You can store a
                  maximum of 30 GB in the bucket.
              ...
              - **OutputDataConfig** *(dict) --*
                ...
                - **S3Bucket** *(string) --*
                  ...
                  is used as the prefix for the actual location of the output.

                - **S3Key** *(string) --*

                  The path to the output data files in the S3 bucket. Amazon Comprehend Medical
                  creates an output directory using the job ID so that the output from one job does
              ...
              - **ModelVersion** *(string) --*
                ...
                like X.X.X. You can use this information to track the model used for a particular
                batch of documents.
                ...
                'Entities': [
                    {
                        ...
                        |'ANATOMY',
                        'Type':
                        'NAME'|'DOSAGE'|'ROUTE_OR_MODE'|'FORM'|'FREQUENCY'
                        |'DURATION'|'GENERIC_NAME'|'BRAND_NAME'|'STRENGTH'|'RATE'
                        ...
                        'Attributes': [
                            {
                                'Type':
                                'NAME'|'DOSAGE'|'ROUTE_OR_MODE'|'FORM'
                                |'FREQUENCY'|'DURATION'|'GENERIC_NAME'
                                |'BRAND_NAME'|'STRENGTH'|'RATE'|'ACUITY'
                                |'TEST_NAME'|'TEST_VALUE'|'TEST_UNITS'
                                |'PROCEDURE_NAME'|'TREATMENT_NAME'|'DATE'
                                |'AGE'|'CONTACT_POINT'|'EMAIL'|'IDENTIFIER'
                                |'URL'|'ADDRESS'|'PROFESSION'
                                |'SYSTEM_ORGAN_SITE'|'DIRECTION'|'QUALITY'
                                |'QUANTITY',
                                'Score': ...,
                                'RelationshipScore': ...,
                                'Id': 123,
                ...
                'UnmappedAttributes': [
                    {
                        ...
                        'Attribute': {
                            ...
                            |'RATE'|'ACUITY'|'TEST_NAME'|'TEST_VALUE'
                            |'TEST_UNITS'|'PROCEDURE_NAME'|'TREATMENT_NAME'
                            |'DATE'|'AGE'|'CONTACT_POINT'|'EMAIL'|'IDENTIFIER'
                            |'URL'|'ADDRESS'|'PROFESSION'|'SYSTEM_ORGAN_SITE'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Entities** *(list) --*
              ...
              information. For each entity, the response provides the entity text, the entity
              category, where the entity text begins and ends, and the level of confidence that
              Amazon Comprehend Medical has in the detection and analysis. Attributes and traits of
    ...
    def detect_entities_v2(self, Text: str) -> ClientDetectEntitiesV2ResponseTypeDef:
        ...
        The ``DetectEntitiesV2`` operation replaces the  DetectEntities operation. This new action
        uses a different model for determining the entities in your medical text and changes the way
        that some entities are returned in the output. You should use the ``DetectEntitiesV2``
        operation in all new applications.

        The ``DetectEntitiesV2`` operation returns the ``Acuity`` and ``Direction`` entities as
        attributes instead of types. It does not return the ``Quality`` or ``Quantity`` entities.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Entities** *(list) --*
              ...
              The collection of medical entities extracted from the input text and their associated
              information. For each entity, the response provides the entity text, the entity
              category, where the entity text begins and ends, and the level of confidence in the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Entities** *(list) --*
              ...
              information. For each entity, the response provides the entity text, the entity
              category, where the entity text begins and ends, and the level of confidence that
              Amazon Comprehend Medical has in its detection.
                ...
                'ComprehendMedicalAsyncJobPropertiesList': [
                    {
                        ...
                        'JobName': 'string',
                        'JobStatus':
                        'SUBMITTED'|'IN_PROGRESS'|'COMPLETED'|'PARTIAL_SUCCESS'
            ...
            - **ComprehendMedicalAsyncJobPropertiesList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ExpirationTime** *(datetime) --*
                  ...
                  your S3 bucket will not be deleted. After the metadata is deleted, the job will no
                  longer appear in the results of the ``ListEntitiesDetectionV2Job`` or the
                  ``ListPHIDetectionJobs`` operation.
    ...
    def start_entities_detection_v2_job(
        ...
        **Request Syntax**
        ...
        :param DataAccessRoleArn: **[REQUIRED]**
          ...
          grants Amazon Comprehend Medical read access to your input data. For more information, see
