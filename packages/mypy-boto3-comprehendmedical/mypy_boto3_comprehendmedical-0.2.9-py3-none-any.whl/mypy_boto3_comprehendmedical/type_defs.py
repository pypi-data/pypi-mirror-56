...
class ClientDescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobProperties`
    `InputDataConfig`
...
class ClientDescribeEntitiesDetectionV2JobResponseComprehendMedicalAsyncJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeEntitiesDetectionV2JobResponse`
    ...
    - **ExpirationTime** *(datetime) --*
      ...
      The date and time that job metadata is deleted from the server. Output files in your S3 bucket
      will not be deleted. After the metadata is deleted, the job will no longer appear in the
      results of the ``ListEntitiesDetectionV2Job`` or the ``ListPHIDetectionJobs`` operation.
    ...
    - **InputDataConfig** *(dict) --*
      ...
      - **S3Bucket** *(string) --*
        ...
        Each file in the document collection must be less than 40 KB. You can store a maximum of 30
        GB in the bucket.
    ...
    - **DataAccessRoleArn** *(string) --*
      ...
      The Amazon Resource Name (ARN) that gives Amazon Comprehend Medical read access to your input
      data.
...
class ClientDescribePhiDetectionJobResponseComprehendMedicalAsyncJobPropertiesInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribePhiDetectionJobResponseComprehendMedicalAsyncJobProperties`
    `InputDataConfig`
...
class ClientDescribePhiDetectionJobResponseComprehendMedicalAsyncJobPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribePhiDetectionJobResponse`
    `ComprehendMedicalAsyncJobProperties`
...
class ClientDetectEntitiesResponseEntitiesAttributesTypeDef(
    ...
    - **RelationshipScore** *(float) --*
      ...
      The level of confidence that Amazon Comprehend Medical has that this attribute is correctly
      related to this entity.

    - **Id** *(integer) --*

      The numeric identifier for this attribute. This is a monotonically increasing id unique within
...
_ClientDetectEntitiesResponseEntitiesTraitsTypeDef = TypedDict(
    "_ClientDetectEntitiesResponseEntitiesTraitsTypeDef", {"Name": str, "Score": float}, total=False
)
...
class ClientDetectEntitiesResponseEntitiesTypeDef(_ClientDetectEntitiesResponseEntitiesTypeDef):
    ...
    - **EndOffset** *(integer) --*
      ...
      The 0-based character offset in the input text that shows where the entity ends. The offset
      returns the UTF-8 code point in the string.
    ...
    - **Attributes** *(list) --*
      ...
      - *(dict) --*
        ...
        an entity, such as the dosage of a medication taken. It contains information about the
        attribute such as id, begin and end offset within the input text, and the segment of the
        input text.
...
_ClientDetectEntitiesResponseUnmappedAttributesTypeDef = TypedDict(
    ...
    {"Type": str, "Attribute": ClientDetectEntitiesResponseUnmappedAttributesAttributeTypeDef},
    total=False,
)
      ...
      - *(dict) --*
        ...
        - **Attributes** *(list) --*
          ...
          - *(dict) --*
            ...
            to an entity, such as the dosage of a medication taken. It contains information about
            the attribute such as id, begin and end offset within the input text, and the segment of
            the input text.
...
_ClientDetectEntitiesV2ResponseUnmappedAttributesTypeDef = TypedDict(
    ...
    {"Type": str, "Attribute": ClientDetectEntitiesV2ResponseUnmappedAttributesAttributeTypeDef},
    total=False,
)
...
_ClientDetectPhiResponseEntitiesTraitsTypeDef = TypedDict(
    "_ClientDetectPhiResponseEntitiesTraitsTypeDef", {"Name": str, "Score": float}, total=False
)
...
class ClientDetectPhiResponseTypeDef(_ClientDetectPhiResponseTypeDef):
    ...
    - **Entities** *(list) --*
      ...
      For each entity, the response provides the entity text, the entity category, where the entity
      text begins and ends, and the level of confidence that Amazon Comprehend Medical has in its
      detection.
...
class ClientListEntitiesDetectionV2JobsResponseComprehendMedicalAsyncJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for
    `ClientListEntitiesDetectionV2JobsResponseComprehendMedicalAsyncJobPropertiesList`
    `InputDataConfig`
...
class ClientListEntitiesDetectionV2JobsResponseComprehendMedicalAsyncJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListEntitiesDetectionV2JobsResponse`
...
class ClientListPhiDetectionJobsResponseComprehendMedicalAsyncJobPropertiesListInputDataConfigTypeDef(
    ...
    """
    Type definition for `ClientListPhiDetectionJobsResponseComprehendMedicalAsyncJobPropertiesList`
    `InputDataConfig`
...
class ClientListPhiDetectionJobsResponseComprehendMedicalAsyncJobPropertiesListTypeDef(
    ...
    """
    Type definition for `ClientListPhiDetectionJobsResponse`
    `ComprehendMedicalAsyncJobPropertiesList`
