...
class KGBuildPipeline:
    ...
    def check(self):
        ...
        """
        current_entities = set(self.__graph_data.get_all_labels())
        current_relations = self.__graph_data.get_all_relation_types()
        current_document_fields = set(self.__doc_collection.get_field_set())
