"Main interface for logs Paginators"
...
class DescribeQueriesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`CloudWatchLogs.Client.describe_queries`.
...
class DescribeResourcePoliciesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        PaginationConfig: DescribeResourcePoliciesPaginatePaginationConfigTypeDef = None,
    ) -> DescribeResourcePoliciesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
