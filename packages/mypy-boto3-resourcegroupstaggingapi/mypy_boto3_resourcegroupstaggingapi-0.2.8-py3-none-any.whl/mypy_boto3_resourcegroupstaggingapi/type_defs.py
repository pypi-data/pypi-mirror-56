...
class ClientGetResourcesResponseResourceTagMappingListTagsTypeDef(
    ...
    `Tag Basics <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-basics>`__
...
_ClientGetResourcesResponseResourceTagMappingListTypeDef = TypedDict(
    ...
    {"ResourceARN": str, "Tags": List[ClientGetResourcesResponseResourceTagMappingListTagsTypeDef]},
    total=False,
)
...
class ClientGetResourcesResponseResourceTagMappingListTypeDef(
    ...
    - **Tags** *(list) --*
      ...
      - *(dict) --*
        ...
        see `Tag Basics
        <http://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html#tag-basics>`__ in the
