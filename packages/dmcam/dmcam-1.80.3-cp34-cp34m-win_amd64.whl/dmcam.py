...
class camera_para_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    cx = _swig_property(_dmcam.camera_para_t_cx_get, _dmcam.camera_para_t_cx_set)
    cy = _swig_property(_dmcam.camera_para_t_cy_get, _dmcam.camera_para_t_cy_set)
    fx = _swig_property(_dmcam.camera_para_t_fx_get, _dmcam.camera_para_t_fx_set)
    fy = _swig_property(_dmcam.camera_para_t_fy_get, _dmcam.camera_para_t_fy_set)
    dcoeff = _swig_property(_dmcam.camera_para_t_dcoeff_get, _dmcam.camera_para_t_dcoeff_set)

    def __init__(self):
        _dmcam.camera_para_t_swiginit(self, _dmcam.new_camera_para_t())
    __swig_destroy__ = _dmcam.delete_camera_para_t
camera_para_t_swigregister = _dmcam.camera_para_t_swigregister
camera_para_t_swigregister(camera_para_t)
...
def path_cfg(path):
    return _dmcam.path_cfg(path)
path_cfg = _dmcam.path_cfg
...
def frame_get_pcl_xyzd(dev, pcl, dist, img_w, img_h, pseudo_color, p_cam_param):
    return _dmcam.frame_get_pcl_xyzd(dev, pcl, dist, img_w, img_h, pseudo_color, p_cam_param)
