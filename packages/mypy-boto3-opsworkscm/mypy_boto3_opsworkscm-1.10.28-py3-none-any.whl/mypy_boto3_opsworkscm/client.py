"Main interface for opsworkscm Client"
...
class Client(BaseClient):
    ...
    def associate_node(
        ...
        *MyManagedNode* --engine-attributes "Name=*CHEF_ORGANIZATION* ,Value=default"
        ...
        On a Puppet server, this command is an alternative to the ``puppet cert sign`` command that
        signs a Puppet node CSR.

        Example (Chef): ``aws opsworks-cm associate-node --server-name *MyServer* --node-name
        *MyManagedNode* --engine-attributes "Name=*PUPPET_NODE_CSR* ,Value=*csr-pem* "``

        A node can can only be associated with servers that are in a ``HEALTHY`` state. Otherwise,
        an ``InvalidStateException`` is thrown. A ``ResourceNotFoundException`` is thrown when the
        server does not exist. A ``ValidationException`` is raised when parameters of the request
        are not valid. The AssociateNode API call can be integrated into Auto Scaling
        configurations, AWS Cloudformation templates, or the user data of a server's instance.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/AssociateNode>`_
        ...
        **Request Syntax**
        ...
        :param EngineAttributes: **[REQUIRED]**
          ...
          * ``CHEF_ORGANIZATION`` : The Chef organization with which the node is associated. By
          ...
          * ``PUPPET_NODE_CSR`` : A PEM-formatted certificate-signing request (CSR) that is created
          by the node.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NodeAssociationStatusToken** *(string) --*
              ...
              Contains a token which can be passed to the ``DescribeNodeAssociationStatus`` API call
              to get the status of the association request.
    ...
    def create_backup(
        ...
        An ``InvalidStateException`` is thrown when the server is not in any of the following
        states: RUNNING, HEALTHY, or UNHEALTHY. A ``ResourceNotFoundException`` is thrown when the
        server is not found. A ``ValidationException`` is thrown when parameters of the request are
        not valid.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/CreateBackup>`_
    ...
    def create_server(
        ...
        A ``LimitExceededException`` is thrown when you have created the maximum number of servers
        (10). A ``ResourceAlreadyExistsException`` is thrown when a server with the same name
        already exists in the account. A ``ResourceNotFoundException`` is thrown when you specify a
        ...
        If you do not specify a security group by adding the ``SecurityGroupIds`` parameter, AWS
         ...
         *Puppet Enterprise:* The default security group opens TCP ports 22, 443, 4433, 8140, 8142,
         8143, and 8170. If a KeyName is present, AWS OpsWorks enables SSH access. SSH is also open
         to the world on TCP port 22.

        By default, your server is accessible from any IP address. We recommend that you update your
        security group rules to allow access from known IP addresses and address ranges only. To
        edit security group rules, open Security Groups in the navigation pane of the EC2 management
        console.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/CreateServer>`_
        ...
        **Request Syntax**
        ...
        :param CustomDomain:
          ...
          access the server, create a CNAME DNS record in your preferred DNS service that points the
          custom domain to the endpoint that is generated when the server is created (the value of
          the CreateServer Endpoint attribute). You cannot access the server by using the generated
          ``Endpoint`` value if the server is using a custom domain. If you specify a custom domain,
        ...
        :param CustomCertificate:
          ...
          or a certificate chain. If you specify a custom certificate, you must also specify values
          for ``CustomDomain`` and ``CustomPrivateKey`` . The following are requirements for the
          ...
          * The certificate must be valid at the time of upload. A certificate can't be used before
          its validity period begins (the certificate's ``NotBefore`` date), or after it expires
        ...
        :param CustomPrivateKey:
          ...
          A private key in PEM format for connecting to the server by using HTTPS. The private key
          must not be encrypted; it cannot be protected by a password or passphrase. If you specify
          a custom private key, you must also specify values for ``CustomDomain`` and
          ``CustomCertificate`` .
        ...
        :param EngineVersion:
          ...
          The major release version of the engine that you want to use. For a Chef server, the valid
          value for EngineVersion is currently ``12`` . For a Puppet server, the valid value is
          ``2017`` .
        ...
        :param EngineAttributes:
          ...
          * ``CHEF_AUTOMATE_PIVOTAL_KEY`` : A base64-encoded RSA public key. The corresponding
          private key is required to access the Chef API. When no CHEF_AUTOMATE_PIVOTAL_KEY is set,
          a private key is generated and returned in the response.
          ...
          * ``PUPPET_ADMIN_PASSWORD`` : To work with the Puppet Enterprise console, a password must
        ...
        :param BackupRetentionCount:
          ...
          AWS OpsWorks CM deletes the oldest backups if this number is exceeded. The default value
          is ``1`` .
        ...
        :param InstanceProfileArn: **[REQUIRED]**
          ...
          The ARN of the instance profile that your Amazon EC2 instances use. Although the AWS
          OpsWorks console typically creates the instance profile for you, if you are using API
          commands instead, run the service-role-creation.yaml AWS CloudFormation template, located
          at
        ...
        :param PreferredMaintenanceWindow:
          ...
          ``DDD:HH:MM`` . The specified time is in coordinated universal time (UTC). The default
        ...
        :param PreferredBackupWindow:
          ...
          application-level data on your server if automated backups are enabled. Valid values must
        ...
        :param SecurityGroupIds:
          ...
          parameter, the specified security groups must be within the VPC that is specified by
          ``SubnetIds`` .
        ...
        :param ServiceRoleArn: **[REQUIRED]**
          ...
          Although the AWS OpsWorks management console typically creates the service role for you,
          if you are using the AWS CLI or API commands, run the service-role-creation.yaml AWS
        ...
        :param SubnetIds:
          ...
          Amazon EC2-Classic customers: This field is required. All servers must run within a VPC.
          ...
          ::

            {
                'Server': {
                    ...
                    'ServiceRoleArn': 'string',
                    'Status':
                    'BACKING_UP'|'CONNECTION_LOST'|'CREATING'|'DELETING'|'MODIFYING'
                    |'FAILED'|'HEALTHY'|'RUNNING'|'RESTORING'|'SETUP'
                    |'UNDER_MAINTENANCE'|'UNHEALTHY'|'TERMINATED',
                    'StatusReason': 'string',
                    'SubnetIds': [
                        'string',
                    ],
          ...
          - *(dict) --*
            ...
            - **Server** *(dict) --*
              ...
              - **EngineAttributes** *(list) --*
                ...
                server in EngineAttributes. These credentials are not stored by AWS OpsWorks CM;
                they are returned only as part of the result of createServer().

                 **Attributes returned in a createServer response for Chef**

                * ``CHEF_AUTOMATE_PIVOTAL_KEY`` : A base64-encoded RSA private key that is generated
                ...
                * ``CHEF_STARTER_KIT`` : A base64-encoded ZIP file. The ZIP file contains a Chef
                ...
                private key. Save this file, unzip it, and then change to the directory where you've
                unzipped the file contents. From this directory, you can run Knife commands.
                ...
                * ``PUPPET_ADMIN_PASSWORD`` : An administrator password that you can use to sign in
                to the Puppet Enterprise console after the server is online.
              ...
              - **StatusReason** *(string) --*
                ...
                as a create or backup error), or an escaped block of JSON (used for health check
                results).
    ...
    def delete_backup(self, BackupId: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DeleteBackup>`_
        ...
        **Request Syntax**
        ...
        :param BackupId: **[REQUIRED]**
          ...
          IDs. Backup IDs are in the format ``ServerName-yyyyMMddHHmmssSSS`` .
    ...
    def delete_server(self, ServerName: str) -> Dict[str, Any]:
        ...
        instance). When you run this command, the server state is updated to ``DELETING`` . After
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DeleteServer>`_
    ...
    def describe_account_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DescribeAccountAttributes>`_
            ...
            - **Attributes** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Name** *(string) --*
                  ...
                  * *ServerLimit:* The number of current servers/maximum number of servers allowed.
    ...
    def describe_backups(
        ...
        """
        Describes backups. The results are ordered by time, with newest backups first. If you do not
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DescribeBackups>`_
    ...
    def describe_events(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DescribeEvents>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          NextToken is a string that is returned in some command responses. It indicates that not
          all entries have been returned, and that you must run at least one more request to get
          remaining items. To get remaining results, call ``DescribeEvents`` again, and assign the
          token from the previous results as the value of the ``nextToken`` parameter. If there are
          no more results, the response object's ``nextToken`` parameter value is ``null`` . Setting
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              not all entries have been returned, and that you must run at least one more request to
              get remaining items. To get remaining results, call ``DescribeEvents`` again, and
              assign the token from the previous results as the value of the ``nextToken``
              parameter. If there are no more results, the response object's ``nextToken`` parameter
              value is ``null`` . Setting a ``nextToken`` value that was not returned in your
    ...
    def describe_node_association_status(
        ...
        request with the specified token is found, or when the server does not exist. A
        ``ValidationException`` is raised when parameters of the request are not valid.
    ...
    def describe_servers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DescribeServers>`_
                ...
                'Servers': [
                    {
                        ...
                        'ServiceRoleArn': 'string',
                        'Status':
                        'BACKING_UP'|'CONNECTION_LOST'|'CREATING'|'DELETING'
                        |'MODIFYING'|'FAILED'|'HEALTHY'|'RUNNING'|'RESTORING'
          ...
          - *(dict) --*
            ...
            - **Servers** *(list) --*
               ...
               *For Puppet Server:*  ``DescribeServersResponse$Servers$EngineAttributes`` contains
               PUPPET_API_CA_CERT. This is the PEM-encoded CA certificate that is used by the Puppet
               API over TCP port number 8140. The CA certificate is also used to sign node
               certificates.
              ...
              - *(dict) --*
                ...
                - **Endpoint** *(string) --*
                  ...
                  A DNS name that can be used to access the engine. Example:
                  ``myserver-asdfghjkl.us-east-1.opsworks.io`` . You cannot access the server by
                  using the ``Endpoint`` value if the server has a ``CustomDomain`` specified.
                ...
                - **EngineAttributes** *(list) --*
                  ...
                  CM; they are returned only as part of the result of createServer().
                  ...
                  * ``PUPPET_STARTER_KIT`` : A base64-encoded ZIP file. The ZIP file contains a
                  Puppet starter kit, including a README and a required private key. Save this file,
    ...
    def disassociate_node(
        ...
        """
        Disassociates a node from an AWS OpsWorks CM server, and removes the node from the server's
        managed nodes. After a node is disassociated, the node key pair is no longer valid for
        accessing the configuration manager's API. For more information about how to associate a
        node, see  AssociateNode .

        A node can can only be disassociated from a server that is in a ``HEALTHY`` state.
        Otherwise, an ``InvalidStateException`` is thrown. A ``ResourceNotFoundException`` is thrown
        when the server does not exist. A ``ValidationException`` is raised when parameters of the
        request are not valid.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/DisassociateNode>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NodeAssociationStatusToken** *(string) --*
              ...
              Contains a token which can be passed to the ``DescribeNodeAssociationStatus`` API call
              to get the status of the disassociation request.
    ...
    def export_server_engine_attribute(
        ...
        """
        Exports a specified server engine attribute as a base64-encoded string. For example, you can
        export user data that you can use in EC2 to associate nodes with a server.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/ExportServerEngineAttribute>`_
        ...
        **Request Syntax**
        ...
        :param InputAttributes:
          ...
          ``EngineAttribute`` list item is a pair that includes an attribute name and its value. For
          the ``Userdata`` ExportAttributeName, the following are supported engine attribute names.

          * **RunList** In Chef, a list of roles or recipes that are run in the specified order. In
          ...
          * **NodeEnvironment** In Chef, a node environment (for example, development, staging, or
          one-box). In Puppet, this parameter is ignored.
    ...
    def restore_server(
        ...
        instance is deleted, and a new EC2 instance is configured. RestoreServer maintains the
        existing server endpoint, so configuration management of the server's client devices (nodes)
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/RestoreServer>`_
    ...
    def start_maintenance(
        ...
        server is in an ``UNDER_MAINTENANCE`` state while maintenance is in progress.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/StartMaintenance>`_
    ...
    def update_server(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/UpdateServer>`_
        ...
        **Request Syntax**
        ...
        :param PreferredMaintenanceWindow:
          ...
          Time windows always use coordinated universal time (UTC). Valid strings for day of week
          (``DDD`` ) are: ``Mon`` , ``Tue`` , ``Wed`` , ``Thr`` , ``Fri`` , ``Sat`` , or ``Sun`` .
    ...
    def update_server_engine_attributes(
        ...
        ``MODIFYING`` state when this operation is in progress. Only one update can occur at a time.
        You can use this command to reset a Chef server's public key (``CHEF_PIVOTAL_KEY`` ) or a
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/opsworkscm-2016-11-01/UpdateServerEngineAttributes>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_servers` operation.
        """
