...
setup(
  ...
  version = '3.9.2',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/WeiXuanChan/autoD/archive/v3.9.2.tar.gz',    # I explain this later on
