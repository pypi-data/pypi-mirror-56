...
# def test_admins(clever_api):
#
#     response = clever_api.get_users(user_filter='admins', group_filter='X')
#
#     print()
...
def test_get_users(requests_get, mock_many_students, mock_teacher, clever_api):
    ...
    mock_student_response = [get_mock_api_response(mock_many_students), empty_repsonse, empty_repsonse, empty_repsonse]
    mock_teacher_response = [get_mock_api_response(mock_teacher), empty_repsonse, empty_repsonse, empty_repsonse]
