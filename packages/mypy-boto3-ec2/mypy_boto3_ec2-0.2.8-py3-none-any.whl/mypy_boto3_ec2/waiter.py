...
class BundleTaskCompleteWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_bundle_tasks` every 15 seconds until a successful state
        is reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeBundleTasks>`_
...
class ConversionTaskCancelledWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_conversion_tasks` every 15 seconds until a successful
        state is reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeConversionTasks>`_
...
class CustomerGatewayAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_customer_gateways` every 15 seconds until a successful
        state is reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeCustomerGateways>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``ip-address`` - The IP address of the customer gateway's Internet-routable external
          interface.
...
class ExportTaskCancelledWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_export_tasks` every 15 seconds until a successful state
        is reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeExportTasks>`_
...
class ImageAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_images` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeImages>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``block-device-mapping.delete-on-termination`` - A Boolean value that indicates whether
          ...
          * ``block-device-mapping.encrypted`` - A Boolean that indicates whether the EBS volume is
          encrypted.
        ...
        :param Owners:
          ...
          Filters the images by the owner. Specify an AWS account ID, ``self`` (owner is the sender
          of the request), or an AWS owner alias (valid values are ``amazon``
          | ``aws-marketplace``
          | ``microsoft`` ). Omitting this option returns all images for which you have launch
...
class InstanceExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_instances` every 5 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          between 5 and 1000. You cannot specify this parameter and the instance IDs parameter in
          the same call.
...
class InstanceStatusOkWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_instance_status` every 15 seconds until a successful
        state is reached. An error is returned after 40 failed checks.
...
class KeyPairExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_key_pairs` every 5 seconds until a successful state is
        reached. An error is returned after 6 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeKeyPairs>`_
...
class NatGatewayAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_nat_gateways` every 15 seconds until a successful state
        is reached. An error is returned after 40 failed checks.
...
class NetworkInterfaceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_network_interfaces` every 20 seconds until a successful
        state is reached. An error is returned after 10 failed checks.
...
class PasswordDataAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.get_password_data` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GetPasswordData>`_
...
class SecurityGroupExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_security_groups` every 5 seconds until a successful
        state is reached. An error is returned after 6 failed checks.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of results to return in a single call. To retrieve the remaining
          results, make another request with the returned ``NextToken`` value. This value can be
          between 5 and 1000. If this parameter is not specified, then all results are returned.
    ...
    def wait(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          request with the returned ``NextToken`` value. This value can be between 5 and 1000; if
          ``MaxResults`` is given a value larger than 1000, only 1000 results are returned. If this
...
class SpotInstanceRequestFulfilledWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_spot_instance_requests` every 15 seconds until a
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The token to request the next set of results. This value is ``null`` when there are no
          more results to return.

        :type MaxResults: integer
        :param MaxResults:

          The maximum number of results to return in a single call. Specify a value between 5 and
          1000. To retrieve the remaining results, make another call with the returned ``NextToken``
          value.
...
class SubnetAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_subnets` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
...
class VolumeAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_volumes` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          When this parameter is used, ``DescribeVolumes`` only returns ``MaxResults`` results in a
          single page along with a ``NextToken`` response element. The remaining results of the
          initial request can be seen by sending another ``DescribeVolumes`` request with the
          returned ``NextToken`` value. This value can be between 5 and 500; if ``MaxResults`` is
          given a value larger than 500, only 500 results are returned. If this parameter is not
          used, then ``DescribeVolumes`` returns all results. You cannot specify this parameter and
          the volume IDs parameter in the same request.
...
class VpcAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_vpcs` every 15 seconds until a successful state is
        reached. An error is returned after 40 failed checks.
...
class VpcExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_vpcs` every 1 seconds until a successful state is
...
class VpcPeeringConnectionDeletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_vpc_peering_connections` every 15 seconds until a
        successful state is reached. An error is returned after 40 failed checks.
...
class VpnConnectionAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_vpn_connections` every 15 seconds until a successful
        state is reached. An error is returned after 40 failed checks.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpnConnections>`_
