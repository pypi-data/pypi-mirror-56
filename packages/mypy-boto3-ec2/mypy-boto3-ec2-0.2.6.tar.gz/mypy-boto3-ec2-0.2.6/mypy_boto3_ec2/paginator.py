"Main interface for ec2 Paginators"
...
class DescribeByoipCidrsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        :py:meth:`EC2.Client.describe_byoip_cidrs`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeByoipCidrs>`_
                ...
                'ByoipCidrs': [
                    {
                        ...
                        'State':
                        'advertised'|'deprovisioned'|'failed-deprovision'|'failed-provision'
...
class DescribeCapacityReservationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_capacity_reservations`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeCapacityReservations>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            as tags, attributes, or IDs. The filters supported by a describe operation are documented with
                ...
                'CapacityReservations': [
                    {
                        ...
                        'InstanceType': 'string',
                        'InstancePlatform': 'Linux/UNIX'|'Red Hat Enterprise Linux'|'SUSE
                        Linux'|'Windows'|'Windows with SQL Server'|'Windows with SQL Server
                        Enterprise'|'Windows with SQL Server Standard'|'Windows with SQL Server Web'|'Linux
                        with SQL Server Standard'|'Linux with SQL Server Web'|'Linux with SQL Server
                        Enterprise',
            ...
            - **CapacityReservations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **State** *(string) --*
                  ...
                  * ``cancelled`` - The Capacity Reservation was manually cancelled. The reserved capacity
                  is no longer available for your use.

                  * ``pending`` - The Capacity Reservation request was successful but the capacity
                  provisioning is still pending.

                  * ``failed`` - The Capacity Reservation request has failed. A request might fail due to
                  invalid request parameters, capacity constraints, or instance limit constraints. Failed
                ...
                - **EndDate** *(datetime) --*
                  ...
                  it. The Capacity Reservation's state changes to ``expired`` when it reaches its end date
                  and time.

                - **EndDateType** *(string) --*

                  Indicates the way in which the Capacity Reservation ends. A Capacity Reservation can have
...
class DescribeClassicLinkInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeClassicLinkInstances>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``tag`` :<key> - The key/value combination of a tag assigned to the resource. Use the tag key
          in the filter name and the tag value as the filter value. For example, to find all resources that
          have a tag with the key ``Owner`` and the value ``TeamA`` , specify ``tag:Owner`` for the filter
          name and ``TeamA`` for the filter value.

          * ``tag-key`` - The key of a tag assigned to the resource. Use this filter to find all resources
          assigned a tag with a specific key, regardless of the tag value.

          * ``vpc-id`` - The ID of the VPC to which the instance is linked.  ``vpc-id`` - The ID of the VPC
          that the instance is linked to.
...
class DescribeClientVpnAuthorizationRulesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_client_vpn_authorization_rules`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeClientVpnAuthorizationRules>`_
...
class DescribeClientVpnConnectionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_client_vpn_connections`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeClientVpnConnections>`_
            ...
            - **Connections** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Username** *(string) --*
                  ...
                  The username of the client who established the client connection. This information is
                  only provided if Active Directory client authentication is used.
...
class DescribeClientVpnEndpointsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_client_vpn_endpoints`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeClientVpnEndpoints>`_
              ...
              - *(dict) --*
                ...
                - **Status** *(dict) --*
                  ...
                  - **Code** *(string) --*
                    ...
                    * ``available`` - The Client VPN endpoint has been created and a target network has
                    been associated. The Client VPN endpoint can accept connections.
                ...
                - **SplitTunnel** *(boolean) --*
                  ...
                  Endpoint
                  <https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/split-tunnel-vpn.html>`__ in the
                ...
                - **AssociatedTargetNetworks** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    Describes a target network that is associated with a Client VPN endpoint. A target
                ...
                - **AuthenticationOptions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    Active Directory and mutual authentication. For more information, see `Authentication
                    <https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/authentication-authrization.html#client-authentication>`__
                ...
                - **ConnectionLogOptions** *(dict) --*
                  ...
                  - **CloudwatchLogGroup** *(string) --*
                    ...
                    The name of the Amazon CloudWatch Logs log group to which connection logging data is
                    published.

                  - **CloudwatchLogStream** *(string) --*

                    The name of the Amazon CloudWatch Logs log stream to which connection logging data is
                    published.
...
class DescribeClientVpnRoutesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_client_vpn_routes`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeClientVpnRoutes>`_
            ...
            - **Routes** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Origin** *(string) --*
                  ...
                  with the Client VPN endpoint. ``add-route`` indicates that the route was manually added
                  using the **CreateClientVpnRoute** action.
...
class DescribeClientVpnTargetNetworksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_client_vpn_target_networks`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeClientVpnTargetNetworks>`_
                ...
                'ClientVpnTargetNetworks': [
                    {
                        ...
                        'Status': {
                            'Code':
                            'associating'|'associated'|'association-failed'|'disassociating'
                            |'disassociated',
                            'Message': 'string'
                        },
                        'SecurityGroups': [
...
class DescribeDhcpOptionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeDhcpOptions>`_
...
class DescribeEgressOnlyInternetGatewaysPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeEgressOnlyInternetGateways>`_
...
class DescribeExportImageTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_export_image_tasks`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeExportImageTasks>`_
...
class DescribeFastSnapshotRestoresPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_fast_snapshot_restores`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFastSnapshotRestores>`_
...
class DescribeFleetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFleets>`_
                ...
                'Fleets': [
                    {
                        ...
                        'FleetId': 'string',
                        'FleetState':
                        'submitted'|'active'|'deleted'|'failed'|'deleted_running'|'deleted_terminating'
                        |'modifying',
                        'ClientToken': 'string',
                                ...
                                'Overrides': [
                                    {
                                        ...
                                        |'r5a.12xlarge'|'r5a.16xlarge'|'r5a.24xlarge'|'r5d.large'
                                        |'r5d.xlarge'|'r5d.2xlarge'|'r5d.4xlarge'|'r5d.8xlarge'
                                        ...
                                        |'i3.metal'|'i3en.large'|'i3en.xlarge'|'i3en.2xlarge'
                                        |'i3en.3xlarge'|'i3en.6xlarge'|'i3en.12xlarge'|'i3en.24xlarge'
                                        |'i3en.metal'|'hi1.4xlarge'|'hs1.8xlarge'|'c1.medium'|'c1.xlarge'
                                        |'c3.large'|'c3.xlarge'|'c3.2xlarge'|'c3.4xlarge'|'c3.8xlarge'
                                        |'c4.large'|'c4.xlarge'|'c4.2xlarge'|'c4.4xlarge'|'c4.8xlarge'
                                        |'c5.large'|'c5.xlarge'|'c5.2xlarge'|'c5.4xlarge'|'c5.9xlarge'
                                        |'c5.12xlarge'|'c5.18xlarge'|'c5.24xlarge'|'c5.metal'|'c5d.large'
                                        |'c5d.xlarge'|'c5d.2xlarge'|'c5d.4xlarge'|'c5d.9xlarge'
                                        |'c5d.18xlarge'|'c5n.large'|'c5n.xlarge'|'c5n.2xlarge'
                                        |'c5n.4xlarge'|'c5n.9xlarge'|'c5n.18xlarge'|'cc1.4xlarge'
                                        |'cc2.8xlarge'|'g2.2xlarge'|'g2.8xlarge'|'g3.4xlarge'|'g3.8xlarge'
                                        |'g3.16xlarge'|'g3s.xlarge'|'g4dn.xlarge'|'g4dn.2xlarge'
                                        |'g4dn.4xlarge'|'g4dn.8xlarge'|'g4dn.12xlarge'|'g4dn.16xlarge'
                                        |'cg1.4xlarge'|'p2.xlarge'|'p2.8xlarge'|'p2.16xlarge'|'p3.2xlarge'
                                        |'p3.8xlarge'|'p3.16xlarge'|'p3dn.24xlarge'|'d2.xlarge'
                                        |'d2.2xlarge'|'d2.4xlarge'|'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'
                                        |'f1.16xlarge'|'m5.large'|'m5.xlarge'|'m5.2xlarge'|'m5.4xlarge'
                                        |'m5.8xlarge'|'m5.12xlarge'|'m5.16xlarge'|'m5.24xlarge'|'m5.metal'
                                        |'m5a.large'|'m5a.xlarge'|'m5a.2xlarge'|'m5a.4xlarge'|'m5a.8xlarge'
                                        |'m5a.12xlarge'|'m5a.16xlarge'|'m5a.24xlarge'|'m5d.large'
                                        |'m5d.xlarge'|'m5d.2xlarge'|'m5d.4xlarge'|'m5d.8xlarge'
                                        ...
                                        |'h1.2xlarge'|'h1.4xlarge'|'h1.8xlarge'|'h1.16xlarge'|'z1d.large'
                                        |'z1d.xlarge'|'z1d.2xlarge'|'z1d.3xlarge'|'z1d.6xlarge'
                                        |'z1d.12xlarge'|'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'
                                        |'u-12tb1.metal'|'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'
                                        |'a1.large'|'a1.xlarge'|'a1.2xlarge'|'a1.4xlarge'|'a1.metal'
                                        |'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'|'m5dn.4xlarge'
                                        |'m5dn.8xlarge'|'m5dn.12xlarge'|'m5dn.16xlarge'|'m5dn.24xlarge'
                                        |'m5n.large'|'m5n.xlarge'|'m5n.2xlarge'|'m5n.4xlarge'|'m5n.8xlarge'
                                        |'m5n.12xlarge'|'m5n.16xlarge'|'m5n.24xlarge'|'r5dn.large'
                                        |'r5dn.xlarge'|'r5dn.2xlarge'|'r5dn.4xlarge'|'r5dn.8xlarge'
                                        |'r5dn.12xlarge'|'r5dn.16xlarge'|'r5dn.24xlarge'|'r5n.large'
                                        |'r5n.xlarge'|'r5n.2xlarge'|'r5n.4xlarge'|'r5n.8xlarge'
                        ...
                        'Instances': [
                            {
                                ...
                                |'m4.16xlarge'|'m2.xlarge'|'m2.2xlarge'|'m2.4xlarge'|'cr1.8xlarge'
                                |'r3.large'|'r3.xlarge'|'r3.2xlarge'|'r3.4xlarge'|'r3.8xlarge'|'r4.large'
                                |'r4.xlarge'|'r4.2xlarge'|'r4.4xlarge'|'r4.8xlarge'|'r4.16xlarge'
                                |'r5.large'|'r5.xlarge'|'r5.2xlarge'|'r5.4xlarge'|'r5.8xlarge'
                                |'r5.12xlarge'|'r5.16xlarge'|'r5.24xlarge'|'r5.metal'|'r5a.large'
                                |'r5a.xlarge'|'r5a.2xlarge'|'r5a.4xlarge'|'r5a.8xlarge'|'r5a.12xlarge'
                                |'r5a.16xlarge'|'r5a.24xlarge'|'r5d.large'|'r5d.xlarge'|'r5d.2xlarge'
                                |'r5d.4xlarge'|'r5d.8xlarge'|'r5d.12xlarge'|'r5d.16xlarge'|'r5d.24xlarge'
                                |'r5d.metal'|'r5ad.large'|'r5ad.xlarge'|'r5ad.2xlarge'|'r5ad.4xlarge'
                                |'r5ad.8xlarge'|'r5ad.12xlarge'|'r5ad.16xlarge'|'r5ad.24xlarge'
                                ...
                                |'i3en.24xlarge'|'i3en.metal'|'hi1.4xlarge'|'hs1.8xlarge'|'c1.medium'
                                ...
                                |'c5.18xlarge'|'c5.24xlarge'|'c5.metal'|'c5d.large'|'c5d.xlarge'
                                |'c5d.2xlarge'|'c5d.4xlarge'|'c5d.9xlarge'|'c5d.18xlarge'|'c5n.large'
                                |'c5n.xlarge'|'c5n.2xlarge'|'c5n.4xlarge'|'c5n.9xlarge'|'c5n.18xlarge'
                                |'cc1.4xlarge'|'cc2.8xlarge'|'g2.2xlarge'|'g2.8xlarge'|'g3.4xlarge'
                                |'g3.8xlarge'|'g3.16xlarge'|'g3s.xlarge'|'g4dn.xlarge'|'g4dn.2xlarge'
                                |'g4dn.4xlarge'|'g4dn.8xlarge'|'g4dn.12xlarge'|'g4dn.16xlarge'
                                |'cg1.4xlarge'|'p2.xlarge'|'p2.8xlarge'|'p2.16xlarge'|'p3.2xlarge'
                                |'p3.8xlarge'|'p3.16xlarge'|'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'
                                |'d2.4xlarge'|'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'|'f1.16xlarge'
                                |'m5.large'|'m5.xlarge'|'m5.2xlarge'|'m5.4xlarge'|'m5.8xlarge'
                                |'m5.12xlarge'|'m5.16xlarge'|'m5.24xlarge'|'m5.metal'|'m5a.large'
                                |'m5a.xlarge'|'m5a.2xlarge'|'m5a.4xlarge'|'m5a.8xlarge'|'m5a.12xlarge'
                                |'m5a.16xlarge'|'m5a.24xlarge'|'m5d.large'|'m5d.xlarge'|'m5d.2xlarge'
                                |'m5d.4xlarge'|'m5d.8xlarge'|'m5d.12xlarge'|'m5d.16xlarge'|'m5d.24xlarge'
                                |'m5d.metal'|'m5ad.large'|'m5ad.xlarge'|'m5ad.2xlarge'|'m5ad.4xlarge'
                                |'m5ad.8xlarge'|'m5ad.12xlarge'|'m5ad.16xlarge'|'m5ad.24xlarge'
                                |'h1.2xlarge'|'h1.4xlarge'|'h1.8xlarge'|'h1.16xlarge'|'z1d.large'
                                |'z1d.xlarge'|'z1d.2xlarge'|'z1d.3xlarge'|'z1d.6xlarge'|'z1d.12xlarge'
                                |'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'|'u-12tb1.metal'|'u-18tb1.metal'
                                |'u-24tb1.metal'|'a1.medium'|'a1.large'|'a1.xlarge'|'a1.2xlarge'
                                |'a1.4xlarge'|'a1.metal'|'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'
                                |'m5dn.4xlarge'|'m5dn.8xlarge'|'m5dn.12xlarge'|'m5dn.16xlarge'
            ...
            - **Fleets** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ActivityStatus** *(string) --*
                  ...
                  The progress of the EC2 Fleet. If there is an error, the status is ``error`` . After all
                  requests are placed, the status is ``pending_fulfillment`` . If the size of the EC2 Fleet
                  is equal to or greater than its target capacity, the status is ``fulfilled`` . If the
                  size of the EC2 Fleet is decreased, the status is ``pending_termination`` while instances
                  are terminating.
                ...
                - **ClientToken** *(string) --*
                  ...
                  <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html>`__
                  .
                    ...
                    - **Overrides** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        - **Priority** *(float) --*
                          ...
                          number, the higher the priority. If no number is set, the override has the lowest
                          priority.
                ...
                - **TargetCapacitySpecification** *(dict) --*
                  ...
                  such as vCPUs, memory, or I/O. If the request type is ``maintain`` , you can specify a
                ...
                - **Type** *(string) --*
                  ...
                  capacity, or also attempts to ``maintain`` it. If you request a certain target capacity,
                  EC2 Fleet only places the required requests; it does not attempt to replenish instances
                  if capacity is diminished, and does not submit requests in alternative capacity pools if
                  capacity is unavailable. To maintain a certain target capacity, EC2 Fleet places the
                  required requests to meet this target capacity. It also automatically replenishes any
                ...
                - **ValidUntil** *(datetime) --*
                  ...
                  T*HH* :*MM* :*SS* Z). At this point, no new instance requests are placed or able to
                ...
                - **SpotOptions** *(dict) --*
                  ...
                  - **AllocationStrategy** *(string) --*
                    ...
                    If the allocation strategy is ``lowest-price`` , EC2 Fleet launches instances from the
                    Spot Instance pools with the lowest price. This is the default allocation strategy.

                    If the allocation strategy is ``diversified`` , EC2 Fleet launches instances from all
                    the Spot Instance pools that you specify.
                  ...
                  - **InstancePoolsToUseCount** *(integer) --*
                    ...
                    when **AllocationStrategy** is set to ``lowest-price`` . EC2 Fleet selects the cheapest
                    Spot pools and evenly allocates your target Spot capacity across the number of Spot
                    pools that you specify.

                  - **SingleInstanceType** *(boolean) --*

                    Indicates that the fleet uses a single instance type to launch all Spot Instances in
                    the fleet.
                ...
                - **OnDemandOptions** *(dict) --*
                  ...
                  - **AllocationStrategy** *(string) --*
                    ...
                    first. If you do not specify a value, EC2 Fleet defaults to ``lowest-price`` .
                  ...
                  **Type** is set to ``instant`` .
                  ...
                  - *(dict) --*
                    ...
                    - **LaunchTemplateAndOverrides** *(dict) --*
                      ...
                      parameters that you specify in the Overrides override the same parameters in the
                      launch template.
                    ...
                    - **ErrorCode** *(string) --*
                      ...
                      <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/errors-overview.html.html>`__
                      .

                    - **ErrorMessage** *(string) --*

                      The error message that describes why the instance could not be launched. For more
                      information about error messages, see ee `Error Codes
                      <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/errors-overview.html.html>`__
                      .
...
class DescribeFlowLogsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFlowLogs>`_
            ...
            - **FlowLogs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DeliverLogsErrorMessage** *(string) --*
                  ...
                  reached the limit on the number of log groups that you can create. ``Access error``
                  indicates that the IAM role associated with the flow log does not have sufficient
                  permissions to publish to CloudWatch Logs. ``Unknown error`` indicates an internal error.
                ...
                - **LogDestinationType** *(string) --*
                  ...
                  Specifies the type of destination to which the flow log data is published. Flow log data
                ...
                - **LogDestination** *(string) --*
                  ...
                  published to an CloudWatch Logs log group or an Amazon S3 bucket. If the flow log
                  publishes to CloudWatch Logs, this element indicates the Amazon Resource Name (ARN) of
                  the CloudWatch Logs log group to which the data is published. If the flow log publishes
                  to Amazon S3, this element indicates the ARN of the Amazon S3 bucket to which the data is
                  published.
...
class DescribeFpgaImagesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeFpgaImages>`_
        ...
        **Request Syntax**
        ...
        :param Owners:
          ...
          Filters the AFI by owner. Specify an AWS account ID, ``self`` (owner is the sender of the
          request), or an AWS owner alias (valid values are ``amazon`` | ``aws-marketplace`` ).
...
class DescribeHostReservationOfferingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeHostReservationOfferings>`_
        ...
        **Request Syntax**
        ...
        :param MinDuration:
          ...
          Reservations are available in one-year and three-year terms. The number of seconds specified must
          be the number of seconds in a year (365x24x60x60) times one of the supported durations (1 or 3).
          For example, specify 31536000 for one year.
...
class DescribeHostReservationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeHostReservations>`_
...
class DescribeHostsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeHosts>`_
                ...
                'Hosts': [
                    {
                        ...
                        |'released-permanent-failure'|'pending',
            ...
            - **Hosts** *(list) --*
              ...
              - *(dict) --*
                ...
                - **AllowsMultipleInstanceTypes** *(string) --*
                  ...
                  instance family, or a specific instance type only. ``one`` indicates that the Dedicated
                  Host supports multiple instance types in the instance family. ``off`` indicates that the
...
class DescribeIamInstanceProfileAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeIamInstanceProfileAssociations>`_
...
class DescribeImportImageTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeImportImageTasks>`_
...
class DescribeImportSnapshotTasksPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeImportSnapshotTasks>`_
...
class DescribeInstanceCreditSpecificationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_instance_credit_specifications`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeInstanceCreditSpecifications>`_
...
class DescribeInstanceStatusPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeInstanceStatus>`_
            ...
            - **InstanceStatuses** *(list) --*
              ...
              - *(dict) --*
                ...
                - **InstanceState** *(dict) --*
                  ...
                  The intended state of the instance.  DescribeInstanceStatus requires that an instance be
                ...
                - **SystemStatus** *(dict) --*
                  ...
                  Reports impaired functionality that stems from issues related to the systems that support
                  an instance, such as hardware failures and network connectivity problems.
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``network-interface.source-dest-check`` - Whether the network interface performs
          ...
          means that checking is disabled. The value must be ``false`` for the network interface to perform
          ...
          * ``reservation-id`` - The ID of the instance's reservation. A reservation ID is created any time
          ...
          request, but can be associated with more than one instance if you launch multiple instances using
          the same launch request. For example, if you launch one instance, you get one reservation ID. If
          you launch ten instances using the same launch request, you also get one reservation ID.
          ...
          * ``source-dest-check`` - Indicates whether the instance performs source/destination checking. A
          ...
          The value must be ``false`` for the instance to perform network address translation (NAT) in your
          VPC.
                  ...
                  - *(dict) --*
                    ...
                    - **Placement** *(dict) --*
                      ...
                      - **Tenancy** *(string) --*
                        ...
                        a tenancy of ``dedicated`` runs on single-tenant hardware. The ``host`` tenancy is
                    ...
                    - **SourceDestCheck** *(boolean) --*
                      ...
                      <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_NAT_Instance.html>`__ in
                    ...
                    - **StateReason** *(dict) --*
                      ...
                      - **Message** *(string) --*
                        ...
                        * ``Server.SpotInstanceTermination`` : The instance was terminated because the
                        number of Spot requests with a maximum price equal to or higher than the Spot price
...
class DescribeLaunchTemplateVersionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_launch_template_versions`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeLaunchTemplateVersions>`_
        ...
        **Request Syntax**
        ...
        :param LaunchTemplateId:
          ...
          The ID of the launch template. You must specify either the launch template ID or launch template
          name in the request.

        :type LaunchTemplateName: string
        :param LaunchTemplateName:

          The name of the launch template. You must specify either the launch template ID or launch
                ...
                'LaunchTemplateVersions': [
                    {
                        ...
                        'LaunchTemplateData': {
                            ...
                            'ImageId': 'string',
                            'InstanceType':
                            't1.micro'|'t2.nano'|'t2.micro'|'t2.small'|'t2.medium'|'t2.large'|'t2.xlarge'
                            |'t2.2xlarge'|'t3.nano'|'t3.micro'|'t3.small'|'t3.medium'|'t3.large'
                            |'t3.xlarge'|'t3.2xlarge'|'t3a.nano'|'t3a.micro'|'t3a.small'|'t3a.medium'
                            |'t3a.large'|'t3a.xlarge'|'t3a.2xlarge'|'m1.small'|'m1.medium'|'m1.large'
                            |'m1.xlarge'|'m3.medium'|'m3.large'|'m3.xlarge'|'m3.2xlarge'|'m4.large'
                            |'m4.xlarge'|'m4.2xlarge'|'m4.4xlarge'|'m4.10xlarge'|'m4.16xlarge'|'m2.xlarge'
                            ...
                            |'r5.8xlarge'|'r5.12xlarge'|'r5.16xlarge'|'r5.24xlarge'|'r5.metal'|'r5a.large'
                            |'r5a.xlarge'|'r5a.2xlarge'|'r5a.4xlarge'|'r5a.8xlarge'|'r5a.12xlarge'
                            |'r5a.16xlarge'|'r5a.24xlarge'|'r5d.large'|'r5d.xlarge'|'r5d.2xlarge'
                            |'r5d.4xlarge'|'r5d.8xlarge'|'r5d.12xlarge'|'r5d.16xlarge'|'r5d.24xlarge'
                            |'r5d.metal'|'r5ad.large'|'r5ad.xlarge'|'r5ad.2xlarge'|'r5ad.4xlarge'
                            |'r5ad.8xlarge'|'r5ad.12xlarge'|'r5ad.16xlarge'|'r5ad.24xlarge'|'x1.16xlarge'
                            ...
                            |'p3.16xlarge'|'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'
                            |'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'|'f1.16xlarge'|'m5.large'|'m5.xlarge'
                            ...
                            |'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'|'a1.large'|'a1.xlarge'
                            |'a1.2xlarge'|'a1.4xlarge'|'a1.metal'|'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'
              ...
              - *(dict) --*
                ...
                - **LaunchTemplateData** *(dict) --*
                  ...
                  - **DisableApiTermination** *(boolean) --*
                    ...
                    If set to ``true`` , indicates that the instance cannot be terminated using the Amazon
                    EC2 console, command line tool, or API.
                  ...
                  - **InstanceMarketOptions** *(dict) --*
                    ...
                    - **SpotOptions** *(dict) --*
                      ...
                      - **ValidUntil** *(datetime) --*
                        ...
                        the request is persistent, it remains active until it is canceled or this date and
                        time is reached.
                  ...
                  - **CpuOptions** *(dict) --*
                    ...
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-optimize-cpu.html>`__ in
                  ...
                  - **HibernationOptions** *(dict) --*
                    ...
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Hibernate.html>`__ in the *Amazon
...
class DescribeLaunchTemplatesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_launch_templates`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeLaunchTemplates>`_
...
class DescribeMovingAddressesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeMovingAddresses>`_
...
class DescribeNatGatewaysPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeNatGateways>`_
            ...
            - **NatGateways** *(list) --*
              ...
              - *(dict) --*
                ...
                - **FailureMessage** *(string) --*
                  ...
                  * For InternalError: "Network interface eni-xxxxxxxx, created and used internally by this
                  NAT gateway is in an invalid state. Please try again."

                  * For InvalidSubnetID.NotFound: "The specified subnet subnet-xxxxxxxx does not exist or
                  could not be found."
                ...
                - **ProvisionedBandwidth** *(dict) --*
                  ...
                  <https://docs.aws.amazon.com/vpc/latest/userguide/vpc-nat-gateway.html>`__ , contact us
                  through the `Support Center <https://console.aws.amazon.com/support/home?>`__ .
                ...
                - **State** *(string) --*
                  ...
                  * ``available`` : The NAT gateway is able to process traffic. This status remains until
                  you delete the NAT gateway, and does not indicate the health of the NAT gateway.
...
class DescribeNetworkInterfacePermissionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeNetworkInterfacePermissions>`_
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``requester-managed`` - Indicates whether the network interface is being managed by an AWS
          ...
          * ``status`` - The status of the network interface. If the network interface is not attached to
          an instance, the status is ``available`` ; if a network interface is attached to an instance the
          status is ``in-use`` .
...
class DescribePrefixListsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribePrefixLists>`_
...
class DescribePrincipalIdFormatPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_principal_id_format`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribePrincipalIdFormat>`_
                ...
                - **Statuses** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Deadline** *(datetime) --*
                      ...
                      The date in UTC at which you are permanently switched over to using longer IDs. If a
                      deadline is not yet available for this resource type, this field is not returned.
...
class DescribePublicIpv4PoolsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_public_ipv4_pools`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribePublicIpv4Pools>`_
...
class DescribeReservedInstancesModificationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeReservedInstancesModifications>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``modification-result.target-configuration.platform`` - The network platform of the new
          Reserved Instances (``EC2-Classic`` | ``EC2-VPC`` ).
                        ...
                        'ModificationResults': [
                            {
                                ...
                                'TargetConfiguration': {
                                    ...
                                    |'t2.xlarge'|'t2.2xlarge'|'t3.nano'|'t3.micro'|'t3.small'|'t3.medium'
                                    |'t3.large'|'t3.xlarge'|'t3.2xlarge'|'t3a.nano'|'t3a.micro'|'t3a.small'
                                    |'t3a.medium'|'t3a.large'|'t3a.xlarge'|'t3a.2xlarge'|'m1.small'
                                    |'m1.medium'|'m1.large'|'m1.xlarge'|'m3.medium'|'m3.large'|'m3.xlarge'
                                    |'m3.2xlarge'|'m4.large'|'m4.xlarge'|'m4.2xlarge'|'m4.4xlarge'
                                    |'m4.10xlarge'|'m4.16xlarge'|'m2.xlarge'|'m2.2xlarge'|'m2.4xlarge'
                                    ...
                                    |'r5a.8xlarge'|'r5a.12xlarge'|'r5a.16xlarge'|'r5a.24xlarge'|'r5d.large'
                                    |'r5d.xlarge'|'r5d.2xlarge'|'r5d.4xlarge'|'r5d.8xlarge'|'r5d.12xlarge'
                                    |'r5d.16xlarge'|'r5d.24xlarge'|'r5d.metal'|'r5ad.large'|'r5ad.xlarge'
                                    ...
                                    |'g4dn.16xlarge'|'cg1.4xlarge'|'p2.xlarge'|'p2.8xlarge'|'p2.16xlarge'
                                    |'p3.2xlarge'|'p3.8xlarge'|'p3.16xlarge'|'p3dn.24xlarge'|'d2.xlarge'
                                    |'d2.2xlarge'|'d2.4xlarge'|'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'
                                    |'f1.16xlarge'|'m5.large'|'m5.xlarge'|'m5.2xlarge'|'m5.4xlarge'
                                    |'m5.8xlarge'|'m5.12xlarge'|'m5.16xlarge'|'m5.24xlarge'|'m5.metal'
                                    |'m5a.large'|'m5a.xlarge'|'m5a.2xlarge'|'m5a.4xlarge'|'m5a.8xlarge'
                                    |'m5a.12xlarge'|'m5a.16xlarge'|'m5a.24xlarge'|'m5d.large'|'m5d.xlarge'
                                    |'m5d.2xlarge'|'m5d.4xlarge'|'m5d.8xlarge'|'m5d.12xlarge'
                                    |'m5d.16xlarge'|'m5d.24xlarge'|'m5d.metal'|'m5ad.large'|'m5ad.xlarge'
                                    |'m5ad.2xlarge'|'m5ad.4xlarge'|'m5ad.8xlarge'|'m5ad.12xlarge'
                                    |'m5ad.16xlarge'|'m5ad.24xlarge'|'h1.2xlarge'|'h1.4xlarge'|'h1.8xlarge'
                                    |'h1.16xlarge'|'z1d.large'|'z1d.xlarge'|'z1d.2xlarge'|'z1d.3xlarge'
                                    |'z1d.6xlarge'|'z1d.12xlarge'|'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'
                                    |'u-12tb1.metal'|'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'|'a1.large'
                                    |'a1.xlarge'|'a1.2xlarge'|'a1.4xlarge'|'a1.metal'|'m5dn.large'
                                    |'m5dn.xlarge'|'m5dn.2xlarge'|'m5dn.4xlarge'|'m5dn.8xlarge'
                                    |'m5dn.12xlarge'|'m5dn.16xlarge'|'m5dn.24xlarge'|'m5n.large'
                                    |'m5n.xlarge'|'m5n.2xlarge'|'m5n.4xlarge'|'m5n.8xlarge'|'m5n.12xlarge'
                                    |'m5n.16xlarge'|'m5n.24xlarge'|'r5dn.large'|'r5dn.xlarge'
                                    |'r5dn.2xlarge'|'r5dn.4xlarge'|'r5dn.8xlarge'|'r5dn.12xlarge'
                                    |'r5dn.16xlarge'|'r5dn.24xlarge'|'r5n.large'|'r5n.xlarge'|'r5n.2xlarge'
                                    |'r5n.4xlarge'|'r5n.8xlarge'|'r5n.12xlarge'|'r5n.16xlarge'
                                    |'r5n.24xlarge',
                                    'Platform': 'string',
...
class DescribeReservedInstancesOfferingsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeReservedInstancesOfferings>`_
        ...
        **Request Syntax**
        ::
          ...
          response_iterator = paginator.paginate(
              ...
              InstanceType=
                  ...
                  |'x1e.16xlarge'|'x1e.32xlarge'|'i2.xlarge'|'i2.2xlarge'|'i2.4xlarge'|'i2.8xlarge'
                  |'i3.large'|'i3.xlarge'|'i3.2xlarge'|'i3.4xlarge'|'i3.8xlarge'|'i3.16xlarge'|'i3.metal'
                  |'i3en.large'|'i3en.xlarge'|'i3en.2xlarge'|'i3en.3xlarge'|'i3en.6xlarge'|'i3en.12xlarge'
                  |'i3en.24xlarge'|'i3en.metal'|'hi1.4xlarge'|'hs1.8xlarge'|'c1.medium'|'c1.xlarge'
                  |'c3.large'|'c3.xlarge'|'c3.2xlarge'|'c3.4xlarge'|'c3.8xlarge'|'c4.large'|'c4.xlarge'
                  |'c4.2xlarge'|'c4.4xlarge'|'c4.8xlarge'|'c5.large'|'c5.xlarge'|'c5.2xlarge'|'c5.4xlarge'
                  |'c5.9xlarge'|'c5.12xlarge'|'c5.18xlarge'|'c5.24xlarge'|'c5.metal'|'c5d.large'
                  ...
                  |'g3s.xlarge'|'g4dn.xlarge'|'g4dn.2xlarge'|'g4dn.4xlarge'|'g4dn.8xlarge'|'g4dn.12xlarge'
                  |'g4dn.16xlarge'|'cg1.4xlarge'|'p2.xlarge'|'p2.8xlarge'|'p2.16xlarge'|'p3.2xlarge'
                  |'p3.8xlarge'|'p3.16xlarge'|'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'
                  |'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'|'f1.16xlarge'|'m5.large'|'m5.xlarge'|'m5.2xlarge'
                  |'m5.4xlarge'|'m5.8xlarge'|'m5.12xlarge'|'m5.16xlarge'|'m5.24xlarge'|'m5.metal'
                  |'m5a.large'|'m5a.xlarge'|'m5a.2xlarge'|'m5a.4xlarge'|'m5a.8xlarge'|'m5a.12xlarge'
                  |'m5a.16xlarge'|'m5a.24xlarge'|'m5d.large'|'m5d.xlarge'|'m5d.2xlarge'|'m5d.4xlarge'
                  |'m5d.8xlarge'|'m5d.12xlarge'|'m5d.16xlarge'|'m5d.24xlarge'|'m5d.metal'|'m5ad.large'
                  |'m5ad.xlarge'|'m5ad.2xlarge'|'m5ad.4xlarge'|'m5ad.8xlarge'|'m5ad.12xlarge'
                  |'m5ad.16xlarge'|'m5ad.24xlarge'|'h1.2xlarge'|'h1.4xlarge'|'h1.8xlarge'|'h1.16xlarge'
              ...
              OfferingType='Heavy Utilization'|'Medium Utilization'|'Light Utilization'|'No
        ...
        :param Filters:
          ...
          * ``marketplace`` - Set to ``true`` to show only Reserved Instance Marketplace offerings. When
          this filter is not used, which is the default behavior, all offerings from both AWS and the
          ...
          * ``product-description`` - The Reserved Instance product platform description. Instances that
          ...
          (Amazon VPC)`` | ``SUSE Linux`` | ``SUSE Linux (Amazon VPC)`` | ``Red Hat Enterprise Linux`` |
          ``Red Hat Enterprise Linux (Amazon VPC)`` | ``Windows`` | ``Windows (Amazon VPC)`` | ``Windows
          with SQL Server Standard`` | ``Windows with SQL Server Standard (Amazon VPC)`` | ``Windows with
          SQL Server Web`` | ``Windows with SQL Server Web (Amazon VPC)`` | ``Windows with SQL Server
        ...
        :param InstanceType:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html>`__ in the *Amazon
          Elastic Compute Cloud User Guide* .
        ...
        :param ProductDescription:
          ...
          The Reserved Instance product platform description. Instances that include ``(Amazon VPC)`` in
                ...
                'ReservedInstancesOfferings': [
                    {
                        ...
                        't1.micro'|'t2.nano'|'t2.micro'|'t2.small'|'t2.medium'|'t2.large'|'t2.xlarge'
                        |'t2.2xlarge'|'t3.nano'|'t3.micro'|'t3.small'|'t3.medium'|'t3.large'|'t3.xlarge'
                        |'t3.2xlarge'|'t3a.nano'|'t3a.micro'|'t3a.small'|'t3a.medium'|'t3a.large'
                        |'t3a.xlarge'|'t3a.2xlarge'|'m1.small'|'m1.medium'|'m1.large'|'m1.xlarge'
                        |'m3.medium'|'m3.large'|'m3.xlarge'|'m3.2xlarge'|'m4.large'|'m4.xlarge'
                        |'m4.2xlarge'|'m4.4xlarge'|'m4.10xlarge'|'m4.16xlarge'|'m2.xlarge'|'m2.2xlarge'
                        |'m2.4xlarge'|'cr1.8xlarge'|'r3.large'|'r3.xlarge'|'r3.2xlarge'|'r3.4xlarge'
                        ...
                        |'r5.12xlarge'|'r5.16xlarge'|'r5.24xlarge'|'r5.metal'|'r5a.large'|'r5a.xlarge'
                        |'r5a.2xlarge'|'r5a.4xlarge'|'r5a.8xlarge'|'r5a.12xlarge'|'r5a.16xlarge'
                        |'r5a.24xlarge'|'r5d.large'|'r5d.xlarge'|'r5d.2xlarge'|'r5d.4xlarge'|'r5d.8xlarge'
                        |'r5d.12xlarge'|'r5d.16xlarge'|'r5d.24xlarge'|'r5d.metal'|'r5ad.large'
                        |'r5ad.xlarge'|'r5ad.2xlarge'|'r5ad.4xlarge'|'r5ad.8xlarge'|'r5ad.12xlarge'
                        |'r5ad.16xlarge'|'r5ad.24xlarge'|'x1.16xlarge'|'x1.32xlarge'|'x1e.xlarge'
                        |'x1e.2xlarge'|'x1e.4xlarge'|'x1e.8xlarge'|'x1e.16xlarge'|'x1e.32xlarge'
                        |'i2.xlarge'|'i2.2xlarge'|'i2.4xlarge'|'i2.8xlarge'|'i3.large'|'i3.xlarge'
                        |'i3.2xlarge'|'i3.4xlarge'|'i3.8xlarge'|'i3.16xlarge'|'i3.metal'|'i3en.large'
                        |'i3en.xlarge'|'i3en.2xlarge'|'i3en.3xlarge'|'i3en.6xlarge'|'i3en.12xlarge'
                        |'i3en.24xlarge'|'i3en.metal'|'hi1.4xlarge'|'hs1.8xlarge'|'c1.medium'|'c1.xlarge'
                        ...
                        |'c5.metal'|'c5d.large'|'c5d.xlarge'|'c5d.2xlarge'|'c5d.4xlarge'|'c5d.9xlarge'
                        |'c5d.18xlarge'|'c5n.large'|'c5n.xlarge'|'c5n.2xlarge'|'c5n.4xlarge'|'c5n.9xlarge'
                        |'c5n.18xlarge'|'cc1.4xlarge'|'cc2.8xlarge'|'g2.2xlarge'|'g2.8xlarge'|'g3.4xlarge'
                        |'g3.8xlarge'|'g3.16xlarge'|'g3s.xlarge'|'g4dn.xlarge'|'g4dn.2xlarge'
                        |'g4dn.4xlarge'|'g4dn.8xlarge'|'g4dn.12xlarge'|'g4dn.16xlarge'|'cg1.4xlarge'
                        |'p2.xlarge'|'p2.8xlarge'|'p2.16xlarge'|'p3.2xlarge'|'p3.8xlarge'|'p3.16xlarge'
                        |'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'|'d2.8xlarge'|'f1.2xlarge'
                        |'f1.4xlarge'|'f1.16xlarge'|'m5.large'|'m5.xlarge'|'m5.2xlarge'|'m5.4xlarge'
                        ...
                        |'z1d.6xlarge'|'z1d.12xlarge'|'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'
                        |'u-12tb1.metal'|'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'|'a1.large'|'a1.xlarge'
                        |'a1.2xlarge'|'a1.4xlarge'|'a1.metal'|'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'
                        |'m5dn.4xlarge'|'m5dn.8xlarge'|'m5dn.12xlarge'|'m5dn.16xlarge'|'m5dn.24xlarge'
                        |'m5n.large'|'m5n.xlarge'|'m5n.2xlarge'|'m5n.4xlarge'|'m5n.8xlarge'|'m5n.12xlarge'
                        |'m5n.16xlarge'|'m5n.24xlarge'|'r5dn.large'|'r5dn.xlarge'|'r5dn.2xlarge'
                        |'r5dn.4xlarge'|'r5dn.8xlarge'|'r5dn.12xlarge'|'r5dn.16xlarge'|'r5dn.24xlarge'
                        |'r5n.large'|'r5n.xlarge'|'r5n.2xlarge'|'r5n.4xlarge'|'r5n.8xlarge'|'r5n.12xlarge'
                        |'r5n.16xlarge'|'r5n.24xlarge',
                        'ProductDescription': 'Linux/UNIX'|'Linux/UNIX (Amazon VPC)'|'Windows'|'Windows
                        (Amazon VPC)',
            ...
            - **ReservedInstancesOfferings** *(list) --*
              ...
              - *(dict) --*
                ...
                - **CurrencyCode** *(string) --*
                  ...
                  ISO 4217 standard currency codes. At this time, the only supported currency is ``USD`` .
                ...
                - **Marketplace** *(boolean) --*
                  ...
                  (resale) or AWS. If it's a Reserved Instance Marketplace offering, this is ``true`` .

                - **OfferingClass** *(string) --*

                  If ``convertible`` it can be exchanged for Reserved Instances of the same or higher
                  monetary value, with different configurations. If ``standard`` , it is not possible to
                  perform an exchange.
                ...
                - **Routes** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **State** *(string) --*
                      ...
                      isn't available (for example, the specified gateway isn't attached to the VPC, or the
...
class DescribeScheduledInstanceAvailabilityPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeScheduledInstanceAvailability>`_
        ...
        **Request Syntax**
        ...
        :param Recurrence: **[REQUIRED]**
          ...
          - **Interval** *(integer) --*
            ...
            The interval quantity. The interval unit depends on the value of ``Frequency`` . For example,
          ...
          - **OccurrenceUnit** *(string) --*
            ...
            The unit for ``OccurrenceDays`` (``DayOfWeek`` or ``DayOfMonth`` ). This value is required for
            a monthly schedule. You can't specify ``DayOfWeek`` with a weekly schedule. You can't specify
              ...
              - *(dict) --*
                ...
                - **Recurrence** *(dict) --*
                  ...
                  - **OccurrenceDaySet** *(list) --*
                    ...
                    The days. For a monthly schedule, this is one or more days of the month (1-31). For a
                    weekly schedule, this is one or more days of the week (1-7, where 1 is Sunday).
...
class DescribeScheduledInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeScheduledInstances>`_
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``egress.ip-permission.prefix-list-id`` - The ID (prefix) of the AWS service to which a
                ...
                - **IpPermissions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **IpProtocol** *(string) --*
                      ...
                      `Protocol Numbers
                      <http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml>`__ ).

                      [VPC only] Use ``-1`` to specify all protocols. When authorizing security group
                      rules, specifying ``-1`` or a protocol number other than ``tcp`` , ``udp`` , ``icmp``
                      , or ``icmpv6`` allows traffic on all ports, regardless of any port range you
                      specify. For ``tcp`` , ``udp`` , and ``icmp`` , you must specify a port range. For
                      ``icmpv6`` , the port range is optional; if you omit the port range, traffic for all
                    ...
                    - **PrefixListIds** *(list) --*
                      ...
                      AWS service to access through a VPC endpoint from instances associated with the
                      security group.
                    ...
                    - **ToPort** *(integer) --*
                      ...
                      of ``-1`` indicates all ICMP/ICMPv6 codes. If you specify all ICMP/ICMPv6 types, you
                    ...
                    - **UserIdGroupPairs** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        - **UserId** *(string) --*
                          ...
                          security group is returned in the response. If the referenced security group is
                          deleted, this value is not returned.
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``owner-alias`` - Value from an Amazon-maintained list (``amazon`` | ``self`` | ``all`` |
            ...
            - **Snapshots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DataEncryptionKeyId** *(string) --*
                  ...
                  that corresponds to the data encryption key that was used to encrypt the original volume
                  or snapshot copy. Because data encryption keys are inherited by volumes created from
                  snapshots, and vice versa, if snapshots share the same data encryption key identifier,
                  then they belong to the same volume/snapshot lineage. This parameter is only returned by
                  DescribeSnapshots .
                ...
                - **KmsKeyId** *(string) --*
                  ...
                  master key (CMK) that was used to protect the volume encryption key for the parent volume.
                ...
                - **StateMessage** *(string) --*
                  ...
                  fails (for example, if the proper AWS Key Management Service (AWS KMS) permissions are
                  not obtained) this field displays error state details to help you diagnose why the error
                ...
                - **VolumeId** *(string) --*
                  ...
                  CopySnapshot action have an arbitrary volume ID that should not be used for any purpose.
...
class DescribeSpotFleetInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeSpotFleetInstances>`_
            ...
            - **ActiveInstances** *(list) --*
              ...
              - *(dict) --*
                ...
                - **InstanceHealth** *(string) --*
                  ...
                  The health status of the instance. If the status of either the instance status check or
                  the system status check is ``impaired`` , the health status of the instance is
...
class DescribeSpotFleetRequestsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeSpotFleetRequests>`_
                ...
                'SpotFleetRequestConfigs': [
                    {
                                    ...
                                    'TagSpecifications': [
                                        {
                                            ...
                                            |'volume'|'vpc'|'vpc-peering-connection'|'vpn-connection'
                                            |'vpn-gateway',
                                            'Tags': [
                                                {
                                                    'Key': 'string',
                                    ...
                                    'Overrides': [
                                        {
                                            ...
                                            |'r3.8xlarge'|'r4.large'|'r4.xlarge'|'r4.2xlarge'|'r4.4xlarge'
                                            |'r4.8xlarge'|'r4.16xlarge'|'r5.large'|'r5.xlarge'|'r5.2xlarge'
                                            |'r5.4xlarge'|'r5.8xlarge'|'r5.12xlarge'|'r5.16xlarge'
                                            |'r5.24xlarge'|'r5.metal'|'r5a.large'|'r5a.xlarge'
                                            |'r5a.2xlarge'|'r5a.4xlarge'|'r5a.8xlarge'|'r5a.12xlarge'
                                            |'r5a.16xlarge'|'r5a.24xlarge'|'r5d.large'|'r5d.xlarge'
                                            |'r5d.2xlarge'|'r5d.4xlarge'|'r5d.8xlarge'|'r5d.12xlarge'
                                            |'r5d.16xlarge'|'r5d.24xlarge'|'r5d.metal'|'r5ad.large'
                                            |'r5ad.xlarge'|'r5ad.2xlarge'|'r5ad.4xlarge'|'r5ad.8xlarge'
                                            |'r5ad.12xlarge'|'r5ad.16xlarge'|'r5ad.24xlarge'|'x1.16xlarge'
                                            |'x1.32xlarge'|'x1e.xlarge'|'x1e.2xlarge'|'x1e.4xlarge'
                                            |'x1e.8xlarge'|'x1e.16xlarge'|'x1e.32xlarge'|'i2.xlarge'
                                            |'i2.2xlarge'|'i2.4xlarge'|'i2.8xlarge'|'i3.large'|'i3.xlarge'
                                            |'i3.2xlarge'|'i3.4xlarge'|'i3.8xlarge'|'i3.16xlarge'
                                            |'i3.metal'|'i3en.large'|'i3en.xlarge'|'i3en.2xlarge'
                                            |'i3en.3xlarge'|'i3en.6xlarge'|'i3en.12xlarge'|'i3en.24xlarge'
                                            |'i3en.metal'|'hi1.4xlarge'|'hs1.8xlarge'|'c1.medium'
                                            ...
                                            |'c5.metal'|'c5d.large'|'c5d.xlarge'|'c5d.2xlarge'
                                            |'c5d.4xlarge'|'c5d.9xlarge'|'c5d.18xlarge'|'c5n.large'
                                            |'c5n.xlarge'|'c5n.2xlarge'|'c5n.4xlarge'|'c5n.9xlarge'
                                            |'c5n.18xlarge'|'cc1.4xlarge'|'cc2.8xlarge'|'g2.2xlarge'
                                            |'g2.8xlarge'|'g3.4xlarge'|'g3.8xlarge'|'g3.16xlarge'
                                            |'g3s.xlarge'|'g4dn.xlarge'|'g4dn.2xlarge'|'g4dn.4xlarge'
                                            |'g4dn.8xlarge'|'g4dn.12xlarge'|'g4dn.16xlarge'|'cg1.4xlarge'
                                            ...
                                            |'m5.4xlarge'|'m5.8xlarge'|'m5.12xlarge'|'m5.16xlarge'
                                            |'m5.24xlarge'|'m5.metal'|'m5a.large'|'m5a.xlarge'
                                            |'m5a.2xlarge'|'m5a.4xlarge'|'m5a.8xlarge'|'m5a.12xlarge'
                                            |'m5a.16xlarge'|'m5a.24xlarge'|'m5d.large'|'m5d.xlarge'
                                            |'m5d.2xlarge'|'m5d.4xlarge'|'m5d.8xlarge'|'m5d.12xlarge'
                                            |'m5d.16xlarge'|'m5d.24xlarge'|'m5d.metal'|'m5ad.large'
                                            |'m5ad.xlarge'|'m5ad.2xlarge'|'m5ad.4xlarge'|'m5ad.8xlarge'
                                            |'m5ad.12xlarge'|'m5ad.16xlarge'|'m5ad.24xlarge'|'h1.2xlarge'
                                            |'h1.4xlarge'|'h1.8xlarge'|'h1.16xlarge'|'z1d.large'
                                            |'z1d.xlarge'|'z1d.2xlarge'|'z1d.3xlarge'|'z1d.6xlarge'
                                            |'z1d.12xlarge'|'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'
                                            |'u-12tb1.metal'|'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'
                                            |'a1.large'|'a1.xlarge'|'a1.2xlarge'|'a1.4xlarge'|'a1.metal'
                                            ...
                                            |'m5n.8xlarge'|'m5n.12xlarge'|'m5n.16xlarge'|'m5n.24xlarge'
                                            |'r5dn.large'|'r5dn.xlarge'|'r5dn.2xlarge'|'r5dn.4xlarge'
                        ...
                        'submitted'|'active'|'cancelled'|'failed'|'cancelled_running'
            ...
            - **SpotFleetRequestConfigs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ActivityStatus** *(string) --*
                  ...
                  After all requests are placed, the status is ``pending_fulfillment`` . If the size of the
                  fleet is equal to or greater than its target capacity, the status is ``fulfilled`` . If
                  the size of the fleet is decreased, the status is ``pending_termination`` while Spot
                ...
                - **SpotFleetRequestConfig** *(dict) --*
                  ...
                  - **AllocationStrategy** *(string) --*
                    ...
                    If the allocation strategy is ``lowestPrice`` , Spot Fleet launches instances from the
                    Spot Instance pools with the lowest price. This is the default allocation strategy.

                    If the allocation strategy is ``diversified`` , Spot Fleet launches instances from all
                    the Spot Instance pools that you specify.
                  ...
                  - **ClientToken** *(string) --*
                    ...
                    listings. This helps to avoid duplicate listings. For more information, see `Ensuring
                    Idempotency
                    <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/Run_Instance_Idempotency.html>`__
                    .
                  ...
                  - **IamFleetRole** *(string) --*
                    ...
                    on your behalf. For more information, see `Spot Fleet Prerequisites
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-fleet-requests.html#spot-fleet-prerequisites>`__
                  ...
                  - **LaunchSpecifications** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_LaunchTemplateConfig.html>`__
                      .
                      ...
                      - **BlockDeviceMappings** *(list) --*
                        ...
                        - *(dict) --*
                          ...
                          - **VirtualName** *(string) --*
                            ...
                            specify mappings for ``ephemeral0`` and ``ephemeral1`` . The number of
                            ...
                            block device mapping for the instance. When you launch an M3 instance, we
                          ...
                          - **Ebs** *(dict) --*
                            ...
                            - **DeleteOnTermination** *(boolean) --*
                              ...
                              <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/terminating-instances.html#preserving-volumes-on-termination>`__
                              in the Amazon Elastic Compute Cloud User Guide.

                            - **Iops** *(integer) --*

                              The number of I/O operations per second (IOPS) that the volume supports. For
                              ``io1`` volumes, this represents the number of IOPS that are provisioned for
                              ...
                              bursting. For more information, see `Amazon EBS Volume Types
                              ...
                              <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances>`__
                              ...
                              it is not used in requests to create ``gp2`` , ``st1`` , ``sc1`` , or
                              ``standard`` volumes.
                            ...
                            - **Encrypted** *(boolean) --*
                              ...
                              state to ``true`` depends on the volume origin (new or from a snapshot),
                              starting encryption state, ownership, and whether encryption by default is
                              enabled. For more information, see `Amazon EBS Encryption
                              <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html#encryption-parameters>`__
                              in the *Amazon Elastic Compute Cloud User Guide* .
                            ...
                            - **KmsKeyId** *(string) --*
                              ...
                              `RunInstances
                              <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html>`__
                              , `RequestSpotFleet
                              <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RequestSpotFleet.html>`__
                              , and `RequestSpotInstances
                              <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RequestSpotInstances.html>`__
                              .
                      ...
                      - **EbsOptimized** *(boolean) --*
                        ...
                        provides dedicated throughput to Amazon EBS and an optimized configuration stack to
                        provide optimal EBS I/O performance. This optimization isn't available with all
                        instance types. Additional usage charges apply when using an EBS Optimized instance.
                      ...
                      - **NetworkInterfaces** *(list) --*
                        ...
                        - *(dict) --*
                          ...
                          - **InterfaceType** *(string) --*
                            ...
                            <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html>`__ in the
                      ...
                      - **Placement** *(dict) --*
                        ...
                        - **Tenancy** *(string) --*
                          ...
                          with a tenancy of ``dedicated`` runs on single-tenant hardware. The ``host``
                      ...
                      - **RamdiskId** *(string) --*
                        ...
                        disk. To find kernel requirements, refer to the AWS Resource Center and search for
                        the kernel ID.
                      ...
                      - **SpotPrice** *(string) --*
                        ...
                        To determine the Spot price per unit hour, divide the Spot price by the value of
                        ``WeightedCapacity`` .
                  ...
                  - **LaunchTemplateConfigs** *(list) --*
                    ...
                    The launch template and overrides. If you specify ``LaunchTemplateConfigs`` , you can't
                    specify ``LaunchSpecifications`` . If you include On-Demand capacity in your request,
                        ...
                        - *(dict) --*
                          ...
                          - **Priority** *(float) --*
                            ...
                            **OnDemandAllocationStrategy** is set to ``prioritized`` , Spot Fleet uses
                            ...
                            On-Demand capacity. The highest priority is launched first. Valid values are
                            whole numbers starting at ``0`` . The lower the number, the higher the
                  ...
                  - **OnDemandMaxTotalPrice** *(string) --*
                    ...
                    The maximum amount per hour for On-Demand Instances that you're willing to pay. You can
                    use the ``onDemandMaxTotalPrice`` parameter, the ``spotMaxTotalPrice`` parameter, or
                    both parameters to ensure that your fleet cost does not exceed your budget. If you set
                    a maximum price per hour for the On-Demand Instances and Spot Instances in your
                  ...
                  - **SpotMaxTotalPrice** *(string) --*
                    ...
                    the ``spotdMaxTotalPrice`` parameter, the ``onDemandMaxTotalPrice`` parameter, or both
                    parameters to ensure that your fleet cost does not exceed your budget. If you set a
                    maximum price per hour for the On-Demand Instances and Spot Instances in your request,
                    Spot Fleet will launch instances until it reaches the maximum amount you're willing to
                    pay. When the maximum amount you're willing to pay is reached, the fleet stops
                  ...
                  - **Type** *(string) --*
                    ...
                    or also attempts to maintain it. When this value is ``request`` , the Spot Fleet only
                    places the required requests. It does not attempt to replenish Spot Instances if
                    capacity is diminished, nor does it submit requests in alternative Spot pools if
                    capacity is not available. When this value is ``maintain`` , the Spot Fleet maintains
                    the target capacity. The Spot Fleet places the required requests to meet capacity and
                  ...
                  - **ValidFrom** *(datetime) --*
                    ...
                    :*SS* Z). By default, Amazon EC2 starts fulfilling the request immediately.

                  - **ValidUntil** *(datetime) --*

                    The end date and time of the request, in UTC format (*YYYY* -*MM* -*DD* T*HH* :*MM*
                    :*SS* Z). After the end date and time, no new Spot Instance requests are placed or able
                    to fulfill the request. If no value is specified, the Spot Fleet request remains until
                    you cancel it.
                  ...
                  - **LoadBalancersConfig** *(dict) --*
                    ...
                    request. Spot Fleet registers the running Spot Instances with the specified Classic
                  ...
                  - **InstancePoolsToUseCount** *(integer) --*
                    ...
                    The number of Spot pools across which to allocate your target Spot capacity. Valid only
                    when Spot **AllocationStrategy** is set to ``lowest-price`` . Spot Fleet selects the
                    cheapest Spot pools and evenly allocates your target Spot capacity across the number of
...
class DescribeSpotInstanceRequestsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeSpotInstanceRequests>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``launch.block-device-mapping.volume-type`` - The type of EBS volume: ``gp2`` for General
          Purpose SSD, ``io1`` for Provisioned IOPS SSD, ``st1`` for Throughput Optimized HDD, ``sc1`` for
          ...
          * ``state`` - The state of the Spot Instance request (``open`` | ``active`` | ``closed`` |
          ...
          Spot Instance requests. For more information, see `Spot Request Status
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-bid-status.html>`__ in the *Amazon EC2
            ...
            - **SpotInstanceRequests** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ActualBlockHourlyPrice** *(string) --*
                  ...
                  If you specified a duration and your Spot Instance request was fulfilled, this is the
                  fixed hourly price in effect for the Spot Instance while it runs.
                ...
                - **LaunchSpecification** *(dict) --*
                  ...
                  - **SecurityGroups** *(list) --*
                    ...
                    IDs of the security groups. When requesting instances in EC2-Classic, you can specify
                    the names or the IDs of the security groups.
                  ...
                  - **BlockDeviceMappings** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **VirtualName** *(string) --*
                        ...
                        device mapping for the instance. When you launch an M3 instance, we ignore any
                      ...
                      - **Ebs** *(dict) --*
                        ...
                        - **Iops** *(integer) --*
                          ...
                          volume. For ``gp2`` volumes, this represents the baseline performance of the
                          volume and the rate at which the volume accumulates I/O credits for bursting. For
                          more information, see `Amazon EBS Volume Types
                          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html>`__ in
                          the *Amazon Elastic Compute Cloud User Guide* .
                          ...
                          is not used in requests to create ``gp2`` , ``st1`` , ``sc1`` , or ``standard``
                          volumes.
                        ...
                        - **VolumeSize** *(integer) --*
                          ...
                          for Cold HDD (``sc1`` ), and 1-1024 for Magnetic (``standard`` ) volumes. If you
                  ...
                  - **NetworkInterfaces** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **AssociatePublicIpAddress** *(boolean) --*
                        ...
                        cannot specify more than one network interface in the request. If launching into a
                      ...
                      - **PrivateIpAddresses** *(list) --*
                        ...
                        One or more private IPv4 addresses to assign to the network interface. Only one
                        private IPv4 address can be designated as primary. You cannot specify this option
                      ...
                      - **SecondaryPrivateIpAddressCount** *(integer) --*
                        ...
                        cannot specify this option if you're launching more than one instance in a
                        `RunInstances
                        <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html>`__
                        request.
                      ...
                      - **InterfaceType** *(string) --*
                        ...
                        ``efa`` . For more information, see `Elastic Fabric Adapter
                        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/efa.html>`__ in the *Amazon
                        Elastic Compute Cloud User Guide* .
                  ...
                  - **Placement** *(dict) --*
                    ...
                    - **Tenancy** *(string) --*
                      ...
                      The tenancy of the instance (if the instance is running in a VPC). An instance with a
                      tenancy of ``dedicated`` runs on single-tenant hardware. The ``host`` tenancy is not
                ...
                - **State** *(string) --*
                  ...
                  Instance requests. For more information, see `Spot Status
                  <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-bid-status.html>`__ in the
                ...
                - **Status** *(dict) --*
                  ...
                  - **Code** *(string) --*
                    ...
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/spot-bid-status.html#spot-instance-bid-status-understand>`__
                  ...
                  - **UpdateTime** *(datetime) --*
                    ...
                    The date and time of the most recent status update, in UTC format (for example, *YYYY*
                    -*MM* -*DD* T*HH* :*MM* :*SS* Z).
                ...
                - **ValidFrom** *(datetime) --*
                  ...
                  The start date of the request, in UTC format (for example, *YYYY* -*MM* -*DD* T*HH* :*MM*
                  :*SS* Z). The request becomes active at this date and time.

                - **ValidUntil** *(datetime) --*

                  The end date of the request, in UTC format (for example, *YYYY* -*MM* -*DD* T*HH* :*MM*
                  :*SS* Z). If this is a one-time request, it remains active until all instances launch,
                  the request is canceled, or this date is reached. If the request is persistent, it
                  remains active until it is canceled or this date is reached. The default end date is 7
...
class DescribeSpotPriceHistoryPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeSpotPriceHistory>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``timestamp`` - The time stamp of the Spot price history, in UTC format (for example, *YYYY*
          -*MM* -*DD* T*HH* :*MM* :*SS* Z). You can use wildcards (* and ?). Greater than or less than
            ...
            - **SpotPriceHistory** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Timestamp** *(datetime) --*
                  ...
                  The date and time the request was created, in UTC format (for example, *YYYY* -*MM* -*DD*
                  T*HH* :*MM* :*SS* Z).
...
class DescribeStaleSecurityGroupsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeStaleSecurityGroups>`_
                ...
                - **StaleIpPermissions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **FromPort** *(integer) --*
                      ...
                      The start of the port range for the TCP and UDP protocols, or an ICMP type number. A
                      value of ``-1`` indicates all ICMP types.

                    - **IpProtocol** *(string) --*

                      The IP protocol name (for ``tcp`` , ``udp`` , and ``icmp`` ) or number (see `Protocol
                      Numbers) <http://www.iana.org/assignments/protocol-numbers/protocol-numbers.xhtml>`__
                      .
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``default-for-az`` - Indicates whether this is the default subnet for the Availability Zone.
          You can also use ``defaultForAz`` as the filter name.
                        ...
                        'Ipv6CidrBlockAssociationSet': [
                            {
                                ...
                                'Ipv6CidrBlockState': {
                                    'State':
                                    'associating'|'associated'|'disassociating'|'disassociated'|'failing'
                                    |'failed',
                                    'StatusMessage': 'string'
                                }
                            },
...
class DescribeTagsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTags>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``resource-type`` - The resource type (``customer-gateway`` | ``dedicated-host`` |
          ...
          ``host-reservation`` | ``internet-gateway`` | ``launch-template`` | ``natgateway`` |
          ``network-acl`` | ``network-interface`` | ``reserved-instances`` | ``route-table`` |
          ``security-group`` | ``snapshot`` | ``spot-instances-request`` | ``subnet`` | ``volume`` |
          ``vpc`` | ``vpc-peering-connection`` | ``vpn-connection`` | ``vpn-gateway`` ).

          * ``tag`` :<key> - The key/value combination of the tag. For example, specify "tag:Owner" for the
                ...
                'Tags': [
                    {
                        ...
                        'ResourceId': 'string',
                        'ResourceType':
                        'client-vpn-endpoint'|'customer-gateway'|'dedicated-host'|'dhcp-options'
                        |'elastic-ip'|'fleet'|'fpga-image'|'host-reservation'|'image'|'instance'
                        |'internet-gateway'|'launch-template'|'natgateway'|'network-acl'
...
class DescribeTrafficMirrorFiltersPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_traffic_mirror_filters`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTrafficMirrorFilters>`_
...
class DescribeTrafficMirrorSessionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_traffic_mirror_sessions`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTrafficMirrorSessions>`_
            ...
            - **TrafficMirrorSessions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **PacketLength** *(integer) --*
                  ...
                  The number of bytes in each packet to mirror. These are the bytes after the VXLAN header.
                  To mirror a subset, set this to the length (in bytes) to mirror. For example, if you set
                  this value to 100, then the first 100 bytes that meet the filter criteria are copied to
                  the target. Do not specify this parameter when you want to mirror the entire packet

                - **SessionNumber** *(integer) --*

                  The session number determines the order in which sessions are evaluated when an interface
                  is used by multiple sessions. The first session with a matching filter is the one that
                  mirrors the packets.
...
class DescribeTrafficMirrorTargetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_traffic_mirror_targets`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTrafficMirrorTargets>`_
...
class DescribeTransitGatewayAttachmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_transit_gateway_attachments`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTransitGatewayAttachments>`_
...
class DescribeTransitGatewayRouteTablesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_transit_gateway_route_tables`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTransitGatewayRouteTables>`_
...
class DescribeTransitGatewayVpcAttachmentsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_transit_gateway_vpc_attachments`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTransitGatewayVpcAttachments>`_
...
class DescribeTransitGatewaysPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_transit_gateways`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeTransitGateways>`_
...
class DescribeVolumeStatusPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVolumeStatus>`_
            ...
            - **Volumes** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Iops** *(integer) --*
                  ...
                  IOPS SSD volumes, this represents the number of IOPS that are provisioned for the volume.
                  For General Purpose SSD volumes, this represents the baseline performance of the volume
                  ...
                  *Amazon Elastic Compute Cloud User Guide* .
                  ...
                  ``io1`` volumes, in most Regions. The maximum IOPS for ``io1`` of 64,000 is guaranteed
                  only on `Nitro-based instances
                  <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/instance-types.html#ec2-nitro-instances>`__
...
class DescribeVolumesModificationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVolumesModifications>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          ``target-iops`` , ``target-volume-type`` , ``original-size`` , ``original-iops`` ,
...
class DescribeVpcClassicLinkDnsSupportPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcClassicLinkDnsSupport>`_
...
class DescribeVpcEndpointConnectionNotificationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_vpc_endpoint_connection_notifications`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpointConnectionNotifications>`_
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpointConnectionNotifications>`_
...
class DescribeVpcEndpointConnectionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_vpc_endpoint_connections`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpointConnections>`_
...
class DescribeVpcEndpointServiceConfigurationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_vpc_endpoint_service_configurations`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpointServiceConfigurations>`_
            ...
            - **ServiceConfigurations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ManagesVpcEndpoints** *(boolean) --*
                  ...
                  Indicates whether the service manages it's VPC endpoints. Management of the service VPC
...
class DescribeVpcEndpointServicePermissionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.describe_vpc_endpoint_service_permissions`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpointServicePermissions>`_
...
class DescribeVpcEndpointServicesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpointServices>`_
...
class DescribeVpcEndpointsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcEndpoints>`_
...
class DescribeVpcPeeringConnectionsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcPeeringConnections>`_
                ...
                'VpcPeeringConnections': [
                    {
                        ...
                        'Status': {
                            'Code':
                            'initiating-request'|'pending-acceptance'|'active'|'deleted'|'rejected'
                            |'failed'|'expired'|'provisioning'|'deleting',
                            'Message': 'string'
                        },
                        'Tags': [
                            {
...
class DescribeVpcsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/DescribeVpcs>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``cidr`` - The primary IPv4 CIDR block of the VPC. The CIDR block you specify must exactly
          match the VPC's CIDR block for information to be returned for the VPC. Must contain the slash
            ...
            - **Vpcs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DhcpOptionsId** *(string) --*
                  ...
                  The ID of the set of DHCP options you've associated with the VPC (or ``default`` if the
...
class GetTransitGatewayAttachmentPropagationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.get_transit_gateway_attachment_propagations`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GetTransitGatewayAttachmentPropagations>`_
...
class GetTransitGatewayRouteTableAssociationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.get_transit_gateway_route_table_associations`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GetTransitGatewayRouteTableAssociations>`_
...
class GetTransitGatewayRouteTablePropagationsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`EC2.Client.get_transit_gateway_route_table_propagations`.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/ec2-2016-11-15/GetTransitGatewayRouteTablePropagations>`_
