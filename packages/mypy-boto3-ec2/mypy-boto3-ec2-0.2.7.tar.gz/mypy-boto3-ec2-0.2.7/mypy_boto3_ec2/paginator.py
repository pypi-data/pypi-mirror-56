            ...
            - **CapacityReservations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **EndDate** *(datetime) --*
                  ...
                  expires, the reserved capacity is released and you can no longer launch instances into it.
              ...
              - *(dict) --*
                ...
                - **Status** *(dict) --*
                  ...
                  - **Code** *(string) --*
                    ...
                    * ``deleted`` - The Client VPN endpoint has been deleted. The Client VPN endpoint cannot
                    accept connections.
                ...
                - **SplitTunnel** *(boolean) --*
                  ...
                  Endpoint <https://docs.aws.amazon.com/vpn/latest/clientvpn-admin/split-tunnel-vpn.html>`__
                                ...
                                'Overrides': [
                                    {
                                        ...
                                        |'g3.8xlarge'|'g3.16xlarge'|'g3s.xlarge'|'g4dn.xlarge'
                                        |'g4dn.2xlarge'|'g4dn.4xlarge'|'g4dn.8xlarge'|'g4dn.12xlarge'
                                        |'g4dn.16xlarge'|'cg1.4xlarge'|'p2.xlarge'|'p2.8xlarge'
                                        |'p2.16xlarge'|'p3.2xlarge'|'p3.8xlarge'|'p3.16xlarge'
                                        |'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'|'d2.8xlarge'
                                        |'f1.2xlarge'|'f1.4xlarge'|'f1.16xlarge'|'m5.large'|'m5.xlarge'
                                        |'m5.2xlarge'|'m5.4xlarge'|'m5.8xlarge'|'m5.12xlarge'|'m5.16xlarge'
                                        |'m5.24xlarge'|'m5.metal'|'m5a.large'|'m5a.xlarge'|'m5a.2xlarge'
                                        ...
                                        |'m5d.metal'|'m5ad.large'|'m5ad.xlarge'|'m5ad.2xlarge'
                                        |'m5ad.4xlarge'|'m5ad.8xlarge'|'m5ad.12xlarge'|'m5ad.16xlarge'
                                        |'m5ad.24xlarge'|'h1.2xlarge'|'h1.4xlarge'|'h1.8xlarge'
                                        |'h1.16xlarge'|'z1d.large'|'z1d.xlarge'|'z1d.2xlarge'|'z1d.3xlarge'
                                        |'z1d.6xlarge'|'z1d.12xlarge'|'z1d.metal'|'u-6tb1.metal'
                                        |'u-9tb1.metal'|'u-12tb1.metal'|'u-18tb1.metal'|'u-24tb1.metal'
                                        |'a1.medium'|'a1.large'|'a1.xlarge'|'a1.2xlarge'|'a1.4xlarge'
                                        |'a1.metal'|'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'|'m5dn.4xlarge'
                        ...
                        'Instances': [
                            {
                                ...
                                |'r4.xlarge'|'r4.2xlarge'|'r4.4xlarge'|'r4.8xlarge'|'r4.16xlarge'|'r5.large'
                                |'r5.xlarge'|'r5.2xlarge'|'r5.4xlarge'|'r5.8xlarge'|'r5.12xlarge'
                                |'r5.16xlarge'|'r5.24xlarge'|'r5.metal'|'r5a.large'|'r5a.xlarge'
                                ...
                                |'r5ad.large'|'r5ad.xlarge'|'r5ad.2xlarge'|'r5ad.4xlarge'|'r5ad.8xlarge'
                                |'r5ad.12xlarge'|'r5ad.16xlarge'|'r5ad.24xlarge'|'x1.16xlarge'|'x1.32xlarge'
                                ...
                                |'i3.metal'|'i3en.large'|'i3en.xlarge'|'i3en.2xlarge'|'i3en.3xlarge'
                                |'i3en.6xlarge'|'i3en.12xlarge'|'i3en.24xlarge'|'i3en.metal'|'hi1.4xlarge'
                                |'hs1.8xlarge'|'c1.medium'|'c1.xlarge'|'c3.large'|'c3.xlarge'|'c3.2xlarge'
                                ...
                                |'g4dn.8xlarge'|'g4dn.12xlarge'|'g4dn.16xlarge'|'cg1.4xlarge'|'p2.xlarge'
                                |'p2.8xlarge'|'p2.16xlarge'|'p3.2xlarge'|'p3.8xlarge'|'p3.16xlarge'
                                |'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'|'d2.8xlarge'
                                |'f1.2xlarge'|'f1.4xlarge'|'f1.16xlarge'|'m5.large'|'m5.xlarge'|'m5.2xlarge'
                                |'m5.4xlarge'|'m5.8xlarge'|'m5.12xlarge'|'m5.16xlarge'|'m5.24xlarge'
                                |'m5.metal'|'m5a.large'|'m5a.xlarge'|'m5a.2xlarge'|'m5a.4xlarge'
                                ...
                                |'m5dn.2xlarge'|'m5dn.4xlarge'|'m5dn.8xlarge'|'m5dn.12xlarge'
                                |'m5dn.16xlarge'|'m5dn.24xlarge'|'m5n.large'|'m5n.xlarge'|'m5n.2xlarge'
                                |'m5n.4xlarge'|'m5n.8xlarge'|'m5n.12xlarge'|'m5n.16xlarge'|'m5n.24xlarge'
            ...
            - **Fleets** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ActivityStatus** *(string) --*
                  ...
                  is equal to or greater than its target capacity, the status is ``fulfilled`` . If the size
                  of the EC2 Fleet is decreased, the status is ``pending_termination`` while instances are
                  terminating.
                ...
                - **ExcessCapacityTerminationPolicy** *(string) --*
                  ...
                  Indicates whether running instances should be terminated if the target capacity of the EC2
                    ...
                    - **Overrides** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        - **Priority** *(float) --*
                          ...
                          ``prioritized`` , EC2 Fleet uses priority to determine which launch template
                ...
                - **Type** *(string) --*
                  ...
                  EC2 Fleet only places the required requests; it does not attempt to replenish instances if
                  capacity is diminished, and does not submit requests in alternative capacity pools if
                ...
                - **ValidUntil** *(datetime) --*
                  ...
                  :*MM* :*SS* Z). At this point, no new instance requests are placed or able to fulfill the
                ...
                - **SpotOptions** *(dict) --*
                  ...
                  - **AllocationStrategy** *(string) --*
                    ...
                    If the allocation strategy is ``capacity-optimized`` , EC2 Fleet launches instances from
            ...
            - **FlowLogs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DeliverLogsErrorMessage** *(string) --*
                  ...
                  throttling has been applied for one or more network interfaces, or that you've reached the
                  limit on the number of log groups that you can create. ``Access error`` indicates that the
                  IAM role associated with the flow log does not have sufficient permissions to publish to
                ...
                - **LogDestination** *(string) --*
                  ...
                  publishes to CloudWatch Logs, this element indicates the Amazon Resource Name (ARN) of the
                  CloudWatch Logs log group to which the data is published. If the flow log publishes to
                  Amazon S3, this element indicates the ARN of the Amazon S3 bucket to which the data is
                  published.
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param MaxDuration:
          ...
          are available in one-year and three-year terms. The number of seconds specified must be the number
          of seconds in a year (365x24x60x60) times one of the supported durations (1 or 3). For example,
            ...
            - **Hosts** *(list) --*
              ...
              - *(dict) --*
                ...
                - **AllowsMultipleInstanceTypes** *(string) --*
                  ...
                  family, or a specific instance type only. ``one`` indicates that the Dedicated Host
                  supports multiple instance types in the instance family. ``off`` indicates that the
            ...
            - **ImportImageTasks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **KmsKeyId** *(string) --*
                  ...
                  The identifier for the AWS Key Management Service (AWS KMS) customer master key (CMK) that
                  was used to create the encrypted image.
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``instance-state-code`` - The state of the instance, as a 16-bit unsigned integer. The high byte
          ...
          represented. The valid values are: 0 (pending), 16 (running), 32 (shutting-down), 48 (terminated),
          ...
          * ``metadata-http-tokens`` - The metadata request authorization state (``optional`` | ``required``
          )
                  ...
                  - *(dict) --*
                    ...
                    - **State** *(dict) --*
                      ...
                      - **Code** *(integer) --*
                        ...
                        values between 256 and 65,535. These numerical values are used for internal purposes
                    ...
                    - **StateReason** *(dict) --*
                      ...
                      - **Message** *(string) --*
                        ...
                        * ``Client.InstanceTerminated`` : The instance was terminated or rebooted during AMI
                        creation.
                ...
                'LaunchTemplateVersions': [
                    {
                        ...
                        'LaunchTemplateData': {
                            ...
                            |'c5.18xlarge'|'c5.24xlarge'|'c5.metal'|'c5d.large'|'c5d.xlarge'|'c5d.2xlarge'
                            ...
                            'TagSpecifications': [
                                {
                                    ...
                                    |'snapshot'|'spot-instances-request'|'subnet'|'traffic-mirror-filter'
                                    |'traffic-mirror-session'|'traffic-mirror-target'|'transit-gateway'
                                    |'transit-gateway-attachment'|'transit-gateway-route-table'|'volume'
            ...
            - **NatGateways** *(list) --*
              ...
              - *(dict) --*
                ...
                - **FailureMessage** *(string) --*
                  ...
                  * For InsufficientFreeAddressesInSubnet: "Subnet has insufficient free addresses to create
                  this NAT gateway"
                        ...
                        'ModificationResults': [
                            {
                                ...
                                'TargetConfiguration': {
                                    ...
                                    |'p3.16xlarge'|'p3dn.24xlarge'|'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'
                                    |'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'|'f1.16xlarge'|'m5.large'
                                    |'m5.xlarge'|'m5.2xlarge'|'m5.4xlarge'|'m5.8xlarge'|'m5.12xlarge'
                                    |'m5.16xlarge'|'m5.24xlarge'|'m5.metal'|'m5a.large'|'m5a.xlarge'
                                    ...
                                    |'h1.4xlarge'|'h1.8xlarge'|'h1.16xlarge'|'z1d.large'|'z1d.xlarge'
                                    |'z1d.2xlarge'|'z1d.3xlarge'|'z1d.6xlarge'|'z1d.12xlarge'|'z1d.metal'
                                    ...
                                    |'r5dn.xlarge'|'r5dn.2xlarge'|'r5dn.4xlarge'|'r5dn.8xlarge'
                                    |'r5dn.12xlarge'|'r5dn.16xlarge'|'r5dn.24xlarge'|'r5n.large'
                                    |'r5n.xlarge'|'r5n.2xlarge'|'r5n.4xlarge'|'r5n.8xlarge'|'r5n.12xlarge'
        ...
        **Request Syntax**
        ::
          ...
          response_iterator = paginator.paginate(
              ...
              InstanceType=
                  ...
                  |'m1.small'|'m1.medium'|'m1.large'|'m1.xlarge'|'m3.medium'|'m3.large'|'m3.xlarge'
                  |'m3.2xlarge'|'m4.large'|'m4.xlarge'|'m4.2xlarge'|'m4.4xlarge'|'m4.10xlarge'|'m4.16xlarge'
                  |'m2.xlarge'|'m2.2xlarge'|'m2.4xlarge'|'cr1.8xlarge'|'r3.large'|'r3.xlarge'|'r3.2xlarge'
                  |'r3.4xlarge'|'r3.8xlarge'|'r4.large'|'r4.xlarge'|'r4.2xlarge'|'r4.4xlarge'|'r4.8xlarge'
                  |'r4.16xlarge'|'r5.large'|'r5.xlarge'|'r5.2xlarge'|'r5.4xlarge'|'r5.8xlarge'|'r5.12xlarge'
                  |'r5.16xlarge'|'r5.24xlarge'|'r5.metal'|'r5a.large'|'r5a.xlarge'|'r5a.2xlarge'
                  |'r5a.4xlarge'|'r5a.8xlarge'|'r5a.12xlarge'|'r5a.16xlarge'|'r5a.24xlarge'|'r5d.large'
                  |'r5d.xlarge'|'r5d.2xlarge'|'r5d.4xlarge'|'r5d.8xlarge'|'r5d.12xlarge'|'r5d.16xlarge'
                  |'r5d.24xlarge'|'r5d.metal'|'r5ad.large'|'r5ad.xlarge'|'r5ad.2xlarge'|'r5ad.4xlarge'
                  ...
                  |'x1e.32xlarge'|'i2.xlarge'|'i2.2xlarge'|'i2.4xlarge'|'i2.8xlarge'|'i3.large'|'i3.xlarge'
                  ...
                  |'c5d.xlarge'|'c5d.2xlarge'|'c5d.4xlarge'|'c5d.9xlarge'|'c5d.12xlarge'|'c5d.18xlarge'
                  |'c5d.24xlarge'|'c5d.metal'|'c5n.large'|'c5n.xlarge'|'c5n.2xlarge'|'c5n.4xlarge'
                  ...
                  |'m5a.4xlarge'|'m5a.8xlarge'|'m5a.12xlarge'|'m5a.16xlarge'|'m5a.24xlarge'|'m5d.large'
                  |'m5d.xlarge'|'m5d.2xlarge'|'m5d.4xlarge'|'m5d.8xlarge'|'m5d.12xlarge'|'m5d.16xlarge'
                  |'m5d.24xlarge'|'m5d.metal'|'m5ad.large'|'m5ad.xlarge'|'m5ad.2xlarge'|'m5ad.4xlarge'
                  |'m5ad.8xlarge'|'m5ad.12xlarge'|'m5ad.16xlarge'|'m5ad.24xlarge'|'h1.2xlarge'|'h1.4xlarge'
                  |'h1.8xlarge'|'h1.16xlarge'|'z1d.large'|'z1d.xlarge'|'z1d.2xlarge'|'z1d.3xlarge'
                  |'z1d.6xlarge'|'z1d.12xlarge'|'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'|'u-12tb1.metal'
                  |'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'|'a1.large'|'a1.xlarge'|'a1.2xlarge'
                  |'a1.4xlarge'|'a1.metal'|'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'|'m5dn.4xlarge'
                  |'m5dn.8xlarge'|'m5dn.12xlarge'|'m5dn.16xlarge'|'m5dn.24xlarge'|'m5n.large'|'m5n.xlarge'
                  |'m5n.2xlarge'|'m5n.4xlarge'|'m5n.8xlarge'|'m5n.12xlarge'|'m5n.16xlarge'|'m5n.24xlarge'
                  |'r5dn.large'|'r5dn.xlarge'|'r5dn.2xlarge'|'r5dn.4xlarge'|'r5dn.8xlarge'|'r5dn.12xlarge'
                  |'r5dn.16xlarge'|'r5dn.24xlarge'|'r5n.large'|'r5n.xlarge'|'r5n.2xlarge'|'r5n.4xlarge'
                  |'r5n.8xlarge'|'r5n.12xlarge'|'r5n.16xlarge'|'r5n.24xlarge',
              MaxDuration=123,
        ...
        :param Filters:
          ...
          * ``product-description`` - The Reserved Instance product platform description. Instances that
          ...
          account holders and are for use with Amazon VPC. (``Linux/UNIX`` | ``Linux/UNIX (Amazon VPC)`` |
          ``SUSE Linux`` | ``SUSE Linux (Amazon VPC)`` | ``Red Hat Enterprise Linux`` | ``Red Hat Enterprise
          Linux (Amazon VPC)`` | ``Windows`` | ``Windows (Amazon VPC)`` | ``Windows with SQL Server
                ...
                'ReservedInstancesOfferings': [
                    {
                        ...
                        |'m4.4xlarge'|'m4.10xlarge'|'m4.16xlarge'|'m2.xlarge'|'m2.2xlarge'|'m2.4xlarge'
                        ...
                        |'g3.8xlarge'|'g3.16xlarge'|'g3s.xlarge'|'g4dn.xlarge'|'g4dn.2xlarge'|'g4dn.4xlarge'
                        |'g4dn.8xlarge'|'g4dn.12xlarge'|'g4dn.16xlarge'|'cg1.4xlarge'|'p2.xlarge'
                        |'p2.8xlarge'|'p2.16xlarge'|'p3.2xlarge'|'p3.8xlarge'|'p3.16xlarge'|'p3dn.24xlarge'
                        |'d2.xlarge'|'d2.2xlarge'|'d2.4xlarge'|'d2.8xlarge'|'f1.2xlarge'|'f1.4xlarge'
                        ...
                        |'m5dn.large'|'m5dn.xlarge'|'m5dn.2xlarge'|'m5dn.4xlarge'|'m5dn.8xlarge'
                        |'m5dn.12xlarge'|'m5dn.16xlarge'|'m5dn.24xlarge'|'m5n.large'|'m5n.xlarge'
                        |'m5n.2xlarge'|'m5n.4xlarge'|'m5n.8xlarge'|'m5n.12xlarge'|'m5n.16xlarge'
                        |'m5n.24xlarge'|'r5dn.large'|'r5dn.xlarge'|'r5dn.2xlarge'|'r5dn.4xlarge'
                        |'r5dn.8xlarge'|'r5dn.12xlarge'|'r5dn.16xlarge'|'r5dn.24xlarge'|'r5n.large'
                        |'r5n.xlarge'|'r5n.2xlarge'|'r5n.4xlarge'|'r5n.8xlarge'|'r5n.12xlarge'
                        |'r5n.16xlarge'|'r5n.24xlarge',
                ...
                - **IpPermissions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **IpProtocol** *(string) --*
                      ...
                      specifying ``-1`` or a protocol number other than ``tcp`` , ``udp`` , ``icmp`` , or
                      ``icmpv6`` allows traffic on all ports, regardless of any port range you specify. For
                      ``tcp`` , ``udp`` , and ``icmp`` , you must specify a port range. For ``icmpv6`` , the
            ...
            - **Snapshots** *(list) --*
              ...
              - *(dict) --*
                ...
                - **KmsKeyId** *(string) --*
                  ...
                  The Amazon Resource Name (ARN) of the AWS Key Management Service (AWS KMS) customer master
                  key (CMK) that was used to protect the volume encryption key for the parent volume.
                                    ...
                                    'Overrides': [
                                        {
                                            ...
                                            |'r5.24xlarge'|'r5.metal'|'r5a.large'|'r5a.xlarge'|'r5a.2xlarge'
                                            |'r5a.4xlarge'|'r5a.8xlarge'|'r5a.12xlarge'|'r5a.16xlarge'
                                            |'r5a.24xlarge'|'r5d.large'|'r5d.xlarge'|'r5d.2xlarge'
                                            |'r5d.4xlarge'|'r5d.8xlarge'|'r5d.12xlarge'|'r5d.16xlarge'
                                            |'r5d.24xlarge'|'r5d.metal'|'r5ad.large'|'r5ad.xlarge'
                                            |'r5ad.2xlarge'|'r5ad.4xlarge'|'r5ad.8xlarge'|'r5ad.12xlarge'
                                            |'r5ad.16xlarge'|'r5ad.24xlarge'|'x1.16xlarge'|'x1.32xlarge'
                                            |'x1e.xlarge'|'x1e.2xlarge'|'x1e.4xlarge'|'x1e.8xlarge'
                                            |'x1e.16xlarge'|'x1e.32xlarge'|'i2.xlarge'|'i2.2xlarge'
                                            ...
                                            |'i3en.12xlarge'|'i3en.24xlarge'|'i3en.metal'|'hi1.4xlarge'
                                            ...
                                            |'m5.24xlarge'|'m5.metal'|'m5a.large'|'m5a.xlarge'|'m5a.2xlarge'
                                            |'m5a.4xlarge'|'m5a.8xlarge'|'m5a.12xlarge'|'m5a.16xlarge'
                                            |'m5a.24xlarge'|'m5d.large'|'m5d.xlarge'|'m5d.2xlarge'
                                            |'m5d.4xlarge'|'m5d.8xlarge'|'m5d.12xlarge'|'m5d.16xlarge'
                                            |'m5d.24xlarge'|'m5d.metal'|'m5ad.large'|'m5ad.xlarge'
                                            |'m5ad.2xlarge'|'m5ad.4xlarge'|'m5ad.8xlarge'|'m5ad.12xlarge'
                                            |'m5ad.16xlarge'|'m5ad.24xlarge'|'h1.2xlarge'|'h1.4xlarge'
                                            |'h1.8xlarge'|'h1.16xlarge'|'z1d.large'|'z1d.xlarge'
                                            |'z1d.2xlarge'|'z1d.3xlarge'|'z1d.6xlarge'|'z1d.12xlarge'
                                            |'z1d.metal'|'u-6tb1.metal'|'u-9tb1.metal'|'u-12tb1.metal'
                                            |'u-18tb1.metal'|'u-24tb1.metal'|'a1.medium'|'a1.large'
                                            ...
                                            |'m5n.xlarge'|'m5n.2xlarge'|'m5n.4xlarge'|'m5n.8xlarge'
                                            |'m5n.12xlarge'|'m5n.16xlarge'|'m5n.24xlarge'|'r5dn.large'
                                            |'r5dn.xlarge'|'r5dn.2xlarge'|'r5dn.4xlarge'|'r5dn.8xlarge'
                                            |'r5dn.12xlarge'|'r5dn.16xlarge'|'r5dn.24xlarge'|'r5n.large'
                                            |'r5n.xlarge'|'r5n.2xlarge'|'r5n.4xlarge'|'r5n.8xlarge'
              ...
              - *(dict) --*
                ...
                - **SpotFleetRequestConfig** *(dict) --*
                  ...
                  - **AllocationStrategy** *(string) --*
                    ...
                    If the allocation strategy is ``capacityOptimized`` , Spot Fleet launches instances from
                    Spot Instance pools with optimal capacity for the number of instances that are
                    launching.
                  ...
                  - **IamFleetRole** *(string) --*
                    ...
                    your behalf. For more information, see `Spot Fleet Prerequisites
                  ...
                  - **LaunchSpecifications** *(list) --*
                    ...
                    - *(dict) --*
                        ...
                        - *(dict) --*
                          ...
                          - **Ebs** *(dict) --*
                            ...
                            - **Encrypted** *(boolean) --*
                              ...
                              to ``true`` depends on the volume origin (new or from a snapshot), starting
                      ...
                      - **RamdiskId** *(string) --*
                        ...
                        kernel requirements for information about whether you need to specify a RAM disk. To
                        find kernel requirements, refer to the AWS Resource Center and search for the kernel
                        ID.
                  ...
                  - **TargetCapacity** *(integer) --*
                    ...
                    application workload, such as vCPUs, memory, or I/O. If the request type is ``maintain``
                  ...
                  - **OnDemandTargetCapacity** *(integer) --*
                    ...
                    workload, such as vCPUs, memory, or I/O. If the request type is ``maintain`` , you can
                  ...
                  - **OnDemandMaxTotalPrice** *(string) --*
                    ...
                    pay. When the maximum amount you're willing to pay is reached, the fleet stops launching
                  ...
                  - **Type** *(string) --*
                    ...
                    automatically replenishes any interrupted instances. Default: ``maintain`` . ``instant``
            ...
            - **SpotInstanceRequests** *(list) --*
              ...
              - *(dict) --*
                  ...
                  - **NetworkInterfaces** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **AssociatePublicIpAddress** *(boolean) --*
                        ...
                        Indicates whether to assign a public IPv4 address to an instance you launch in a
                        VPC. The public IP address can only be assigned to a network interface for eth0, and
                        can only be assigned to a new network interface, not an existing one. You cannot
                        specify more than one network interface in the request. If launching into a default
                      ...
                      - **PrivateIpAddresses** *(list) --*
                        ...
                        One or more private IPv4 addresses to assign to the network interface. Only one
                        private IPv4 address can be designated as primary. You cannot specify this option if
                        you're launching more than one instance in a `RunInstances
                        <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_RunInstances.html>`__
                        request.
                ...
                - **ValidUntil** *(datetime) --*
                  ...
                  :*SS* Z). If this is a one-time request, it remains active until all instances launch, the
                  request is canceled, or this date is reached. If the request is persistent, it remains
                  active until it is canceled or this date is reached. The default end date is 7 days from
                  the current date.
                ...
                - **StaleIpPermissions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **UserIdGroupPairs** *(list) --*
                      ...
                      The security group pairs. Returns the ID of the referenced security group and VPC, and
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``default-for-az`` - Indicates whether this is the default subnet for the Availability Zone. You
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``network-load-balancer-arn`` : The Amazon Resource Name (ARN) of the Network Load Balancer that
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``state`` - The state of the attachment (``available`` | ``deleted`` | ``deleting`` | ``failed``
          | ``modifying`` | ``pendingAcceptance`` | ``pending`` | ``rollingBack`` | ``rejected`` |
          ``rejecting`` ).
                ...
                'VpcPeeringConnections': [
                    {
                        ...
                        'Status': {
                            'Code':
                            'initiating-request'|'pending-acceptance'|'active'|'deleted'|'rejected'|'failed'
