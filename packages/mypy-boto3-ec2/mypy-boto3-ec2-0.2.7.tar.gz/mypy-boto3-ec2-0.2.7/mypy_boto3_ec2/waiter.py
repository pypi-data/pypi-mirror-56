...
class ImageAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_images` every 15 seconds until a successful state is reached. An
        ...
        **Request Syntax**
        ...
        :param Owners:
          ...
          Filters the images by the owner. Specify an AWS account ID, ``self`` (owner is the sender of the
          request), or an AWS owner alias (valid values are ``amazon`` | ``aws-marketplace`` | ``microsoft``
          ). Omitting this option returns all images for which you have launch permissions, regardless of
          ownership.
...
class InstanceRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_instances` every 15 seconds until a successful state is reached.
        An error is returned after 40 failed checks.
...
class KeyPairExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        An error is returned after 6 failed checks.
...
class NetworkInterfaceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_network_interfaces` every 20 seconds until a successful state is
        reached. An error is returned after 10 failed checks.
...
class SecurityGroupExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_security_groups` every 5 seconds until a successful state is
...
class SnapshotCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`EC2.Client.describe_snapshots` every 15 seconds until a successful state is reached.
        An error is returned after 40 failed checks.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          this parameter is used, ``DescribeSnapshots`` only returns ``MaxResults`` results in a single page
          along with a ``NextToken`` response element. The remaining results of the initial request can be
          seen by sending another ``DescribeSnapshots`` request with the returned ``NextToken`` value. This
          value can be between 5 and 1000; if ``MaxResults`` is given a value larger than 1000, only 1000
          results are returned. If this parameter is not used, then ``DescribeSnapshots`` returns all
          results. You cannot specify this parameter and the snapshot IDs parameter in the same request.
    ...
    def wait(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The token to request the next set of results. This value is ``null`` when there are no more
          results to return.
        ...
        :param MaxResults:
          ...
          retrieve the remaining results, make another call with the returned ``NextToken`` value.
    ...
    def wait(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          results are returned. If this parameter is not used, then ``DescribeVolumes`` returns all results.
...
class VpcExistsWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        error is returned after 5 failed checks.
