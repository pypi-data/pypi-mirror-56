...
class Client(BaseClient):
    ...
    def add_tags(self, LoadBalancerNames: List[str], Tags: List[ClientAddTagsTagsTypeDef]) -> Dict:
        """
        ...
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/add-remove-tags.html>`__ in
    ...
    def attach_load_balancer_to_subnets(
        ...
        information, see `Add or Remove Subnets for Your Load Balancer in a VPC
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-manage-subnets.html>`__
        in the *Classic Load Balancers Guide* .
    ...
    def configure_health_check(
        ...
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-healthchecks.html>`__ in
        the *Classic Load Balancers Guide* .
    ...
    def create_app_cookie_stickiness_policy(
        ...
        This policy is similar to the policy created by  CreateLBCookieStickinessPolicy , except
        that the lifetime of the special Elastic Load Balancing cookie, ``AWSELB`` , follows the
    ...
    def create_lb_cookie_stickiness_policy(
        ...
        When a load balancer implements this policy, the load balancer uses a special cookie to
        track the instance for each request. When the load balancer receives a request, it first
        checks to see if this cookie is present in the request. If so, the load balancer sends the
    ...
    def create_load_balancer(
        ...
        balancer, or you can add them later using  CreateLoadBalancerListeners ,
        ...
        for the number of load balancers for your account. For more information, see `Limits for
        Your Classic Load Balancer
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-limits.html>`__ in the
        ...
        **Request Syntax**
        ...
        :param Listeners: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            see `Listeners for Your Classic Load Balancer
            <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-listener-config.html>`__
            in the *Classic Load Balancers Guide* .
            ...
            - **LoadBalancerPort** *(integer) --* **[REQUIRED]**
              ...
              from the range 1-65535. On EC2-Classic, you can specify any port from the following
            ...
            - **InstanceProtocol** *(string) --*
              ...
              If the front-end protocol is HTTP, HTTPS, TCP, or SSL, ``InstanceProtocol`` must be at
              the same protocol.
        ...
        :param Scheme:
          ...
          Internal load balancers, see `Load Balancer Scheme
        ...
        :param Tags:
          ...
          <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/add-remove-tags.html>`__
          in the *Classic Load Balancers Guide* .
    ...
    def delete_load_balancer(self, LoadBalancerName: str) -> Dict:
        ...
        If you are attempting to recreate a load balancer, you must reconfigure all settings. The
        DNS name associated with a deleted load balancer are no longer usable. The name and
        associated DNS record of the deleted load balancer no longer exist and traffic sent to any
        of its IP addresses is no longer delivered to your instances.
          ...
          - *(dict) --*
            ...
            - **LoadBalancerAttributes** *(dict) --*
              ...
              - **ConnectionSettings** *(dict) --*
                ...
                see `Configure Idle Connection Timeout
    ...
    def describe_load_balancer_policies(
        ...
        balancer, the action returns the description of that policy. If you don't specify a load
        balancer name, the action returns descriptions of the specified sample policies, or
            ...
            - **LoadBalancerDescriptions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SourceSecurityGroup** *(dict) --*
                  ...
                  balancers, add a security group rule that specifies this source security group as
                  the inbound source.
    ...
    def disable_availability_zones_for_load_balancer(
        ...
        are in the removed Availability Zone go into the ``OutOfService`` state. Then, the load
        balancer attempts to equally balance the traffic among its remaining Availability Zones.

        For more information, see `Add or Remove Availability Zones
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/enable-disable-az.html>`__
        in the *Classic Load Balancers Guide* .
    ...
    def modify_load_balancer_attributes(
        ...
        the load balancer attribute ``ConnectionSettings`` by specifying an idle connection timeout
    ...
    def register_instances_with_load_balancer(
        ...
        (EC2-Classic or the same VPC). If you have EC2-Classic instances and a load balancer in a
        VPC with ClassicLink enabled, you can link the EC2-Classic instances to that VPC and then
        ...
        registered. Instance registration takes a little time to complete. To check the state of the
        registered instances, use  DescribeLoadBalancers or  DescribeInstanceHealth .
        ...
        balancer is moved to the ``OutOfService`` state. If an Availability Zone is added to the
        load balancer later, any instances registered with the load balancer move to the
        ``InService`` state.
    ...
    def set_load_balancer_listener_ssl_certificate(
        ...
        For more information about updating your SSL certificate, see `Replace the SSL Certificate
        for Your Load Balancer
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/elb-update-ssl-cert.html>`__
        in the *Classic Load Balancers Guide* .
    ...
    def set_load_balancer_policies_for_backend_server(
        ...
        Back-end Instance Authentication
        ...
        <http://docs.aws.amazon.com/elasticloadbalancing/latest/classic/enable-proxy-protocol.html>`__
        in the *Classic Load Balancers Guide* .
        ...
        **Request Syntax**
        ...
        :param PolicyNames: **[REQUIRED]**
          ...
          The names of the policies. If the list is empty, then all current polices are removed from
          the EC2 instance.
