...
class ClientConfigureHealthCheckHealthCheckTypeDef(_ClientConfigureHealthCheckHealthCheckTypeDef):
    """
...
class ClientDescribeInstanceHealthResponseInstanceStatesTypeDef(
    ...
    - **ReasonCode** *(string) --*
      ...
      Information about the cause of ``OutOfService`` instances. Specifically, whether the cause is
    ...
    - **Description** *(string) --*
      ...
      * ``Instance is in the EC2 Availability Zone for which LoadBalancer is not configured to route
      traffic to.``
...
class ClientDescribeLoadBalancerAttributesResponseLoadBalancerAttributesAccessLogTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBalancerAttributesResponseLoadBalancerAttributes`
    `AccessLog`
...
class ClientDescribeLoadBalancerPoliciesResponsePolicyDescriptionsPolicyAttributeDescriptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBalancerPoliciesResponsePolicyDescriptions`
...
class ClientDescribeLoadBalancerPolicyTypesResponsePolicyTypeDescriptionsPolicyAttributeTypeDescriptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBalancerPolicyTypesResponsePolicyTypeDescriptions`
...
class ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsBackendServerDescriptionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBalancersResponseLoadBalancerDescriptions`
...
class ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsListenerDescriptionsListenerTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsListenerDescriptions` `Listener`
...
class ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsPoliciesAppCookieStickinessPoliciesTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsPolicies`
...
class ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsSourceSecurityGroupTypeDef(
    ...
    The security group for the load balancer, which you can use as part of your inbound rules for
    your registered instances. To only allow traffic from load balancers, add a security group rule
...
class ClientDescribeLoadBalancersResponseLoadBalancerDescriptionsTypeDef(
    ...
    - **SourceSecurityGroup** *(dict) --*
      ...
      The security group for the load balancer, which you can use as part of your inbound rules for
      your registered instances. To only allow traffic from load balancers, add a security group
      rule that specifies this source security group as the inbound source.
...
class ClientModifyLoadBalancerAttributesLoadBalancerAttributesAdditionalAttributesTypeDef(
    ...
    """
    Type definition for `ClientModifyLoadBalancerAttributesLoadBalancerAttributes`
    `AdditionalAttributes`
...
class ClientModifyLoadBalancerAttributesResponseLoadBalancerAttributesAccessLogTypeDef(
    ...
    """
    Type definition for `ClientModifyLoadBalancerAttributesResponseLoadBalancerAttributes`
    `AccessLog`
...
class DescribeLoadBalancersPaginateResponseLoadBalancerDescriptionsBackendServerDescriptionsTypeDef(
    ...
    """
    Type definition for `DescribeLoadBalancersPaginateResponseLoadBalancerDescriptions`
    `BackendServerDescriptions`
...
class DescribeLoadBalancersPaginateResponseLoadBalancerDescriptionsListenerDescriptionsListenerTypeDef(
    ...
    """
    Type definition for
    `DescribeLoadBalancersPaginateResponseLoadBalancerDescriptionsListenerDescriptions` `Listener`
...
class DescribeLoadBalancersPaginateResponseLoadBalancerDescriptionsPoliciesAppCookieStickinessPoliciesTypeDef(
    ...
    """
    Type definition for `DescribeLoadBalancersPaginateResponseLoadBalancerDescriptionsPolicies`
    `AppCookieStickinessPolicies`
