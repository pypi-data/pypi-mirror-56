...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'okta', 'v1.3.0-alpha.1574844985+ga8d762b'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource okta v1.3.0-alpha.1574844985+ga8d762b`
                """)
            else:
                raise
