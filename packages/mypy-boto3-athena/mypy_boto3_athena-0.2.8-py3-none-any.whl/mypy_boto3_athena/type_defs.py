...
class ClientBatchGetQueryExecutionResponseQueryExecutionsQueryExecutionContextTypeDef(
    ...
    """
    Type definition for `ClientBatchGetQueryExecutionResponseQueryExecutions`
...
class ClientBatchGetQueryExecutionResponseQueryExecutionsResultConfigurationEncryptionConfigurationTypeDef(
    ...
    """
    Type definition for `ClientBatchGetQueryExecutionResponseQueryExecutionsResultConfiguration`
    ...
    specified for the workgroup, and also uses the location for storing query results specified in
    the workgroup. See  WorkGroupConfiguration$EnforceWorkGroupConfiguration and `Workgroup Settings
...
class ClientBatchGetQueryExecutionResponseQueryExecutionsResultConfigurationTypeDef(
    ...
    The location in Amazon S3 where query results were stored and the encryption option, if any,
...
class ClientBatchGetQueryExecutionResponseQueryExecutionsStatisticsTypeDef(
    ...
    - **DataManifestLocation** *(string) --*
      ...
      The location and file name of a data manifest file. The manifest file is saved to the Athena
      query results location in Amazon S3. The manifest file tracks files that the query wrote to
      Amazon S3. If the query fails, the manifest file also tracks files that the query intended to
      write. The manifest is useful for identifying orphaned files resulting from a failed query.
    ...
    - **QueryQueueTimeInMillis** *(integer) --*
      ...
      The number of milliseconds that the query was in your query queue waiting for resources. Note
      that if transient errors occur, Athena might automatically add the query back to the queue.
...
class ClientBatchGetQueryExecutionResponseQueryExecutionsStatusTypeDef(
    ...
    The completion date, current state, submission time, and state change reason (if applicable) for
    the query execution.
    ...
    - **State** *(string) --*
      ...
      indicates that the query completed without errors. ``FAILED`` indicates that the query
      experienced an error and did not complete processing. ``CANCELLED`` indicates that a user
...
class ClientBatchGetQueryExecutionResponseQueryExecutionsTypeDef(
    ...
    - **Statistics** *(dict) --*
      ...
      - **DataManifestLocation** *(string) --*
        ...
        The location and file name of a data manifest file. The manifest file is saved to the Athena
        query results location in Amazon S3. The manifest file tracks files that the query wrote to
        Amazon S3. If the query fails, the manifest file also tracks files that the query intended
        to write. The manifest is useful for identifying orphaned files resulting from a failed
        query. For more information, see `Working with Query Results, Output Files, and Query
        History <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__ in the *Amazon
        Athena User Guide* .
      ...
      - **QueryPlanningTimeInMillis** *(integer) --*
        ...
        The number of milliseconds that Athena took to plan the query processing flow. This includes
        the time spent retrieving table partitions from the data source. Note that because the query
        engine performs the query planning, query planning time is a subset of engine processing
        time.
    ...
    - **QueryExecutions** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Statistics** *(dict) --*
          ...
          The amount of data scanned during the query execution and the amount of time that it took
          to execute, and the type of statement that was run.
          ...
          - **DataManifestLocation** *(string) --*
            ...
            resulting from a failed query. For more information, see `Working with Query Results,
            Output Files, and Query History
          ...
          - **QueryQueueTimeInMillis** *(integer) --*
            ...
            The number of milliseconds that the query was in your query queue waiting for resources.
            Note that if transient errors occur, Athena might automatically add the query back to
            the queue.
...
class ClientCreateWorkGroupConfigurationResultConfigurationEncryptionConfigurationTypeDef(
    ...
    """
    Type definition for `ClientCreateWorkGroupConfigurationResultConfiguration`
    `EncryptionConfiguration`
...
class ClientCreateWorkGroupConfigurationResultConfigurationTypeDef(
    ...
    you must specify the query results location using one of the ways: either in the workgroup using
    this setting, or for individual queries (client-side), using  ResultConfiguration$OutputLocation
    . If none of them is set, Athena issues an error that no output location is provided. For more
    information, see `Query Results <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__
    .
...
class ClientCreateWorkGroupTagsTypeDef(_ClientCreateWorkGroupTagsTypeDef):
    ...
    A tag that you can add to a resource. A tag is a label that you assign to an AWS Athena resource
    (a workgroup). Each tag consists of a key and an optional value, both of which you define. Tags
    enable you to categorize workgroups in Athena, for example, by purpose, owner, or environment.
    Use a consistent set of tag keys to make it easier to search and filter workgroups in your
    account. The maximum tag key length is 128 Unicode characters in UTF-8. The maximum tag value
    length is 256 Unicode characters in UTF-8. You can use letters and numbers representable in
...
class ClientGetQueryExecutionResponseQueryExecutionResultConfigurationEncryptionConfigurationTypeDef(
    ...
    """
    Type definition for `ClientGetQueryExecutionResponseQueryExecutionResultConfiguration`
    `EncryptionConfiguration`
...
class ClientGetQueryExecutionResponseTypeDef(_ClientGetQueryExecutionResponseTypeDef):
    ...
    - **QueryExecution** *(dict) --*
      ...
      - **ResultConfiguration** *(dict) --*
        ...
        The location in Amazon S3 where query results were stored and the encryption option, if any,
        used for query results. These are known as "client-side settings". If workgroup settings
        override client-side settings, then the query uses the location for the query results and
        ...
        - **OutputLocation** *(string) --*
          ...
          location using one of the ways: either for individual queries using either this setting
          (client-side), or in the workgroup, using  WorkGroupConfiguration . If none of them is
          set, Athena issues an error that no output location is provided. For more information, see
          `Query Results <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__ . If
          workgroup settings override client-side settings, then the query uses the settings
          specified for the workgroup. See  WorkGroupConfiguration$EnforceWorkGroupConfiguration .
      ...
      - **Status** *(dict) --*
        ...
        - **State** *(string) --*
          ...
          ``SUCCEEDED`` indicates that the query completed without errors. ``FAILED`` indicates that
          the query experienced an error and did not complete processing. ``CANCELLED`` indicates
      ...
      - **Statistics** *(dict) --*
        ...
        - **DataManifestLocation** *(string) --*
          ...
          wrote to Amazon S3. If the query fails, the manifest file also tracks files that the query
          intended to write. The manifest is useful for identifying orphaned files resulting from a
          failed query. For more information, see `Working with Query Results, Output Files, and
          Query History <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__ in the
...
class ClientGetQueryResultsResponseResultSetResultSetMetadataColumnInfoTypeDef(
    ...
    - **Scale** *(integer) --*
      ...
      For ``DECIMAL`` data types, specifies the total number of digits in the fractional part of the
      value. Defaults to 0.
...
class ClientGetWorkGroupResponseWorkGroupConfigurationResultConfigurationEncryptionConfigurationTypeDef(
    ...
    """
    Type definition for `ClientGetWorkGroupResponseWorkGroupConfigurationResultConfiguration`
    `EncryptionConfiguration`
...
class ClientGetWorkGroupResponseWorkGroupConfigurationTypeDef(
    ...
    are stored, the encryption configuration, if any, used for query results; whether the Amazon
    CloudWatch Metrics are enabled for the workgroup; whether workgroup settings override
...
class ClientGetWorkGroupResponseWorkGroupTypeDef(_ClientGetWorkGroupResponseWorkGroupTypeDef):
    ...
    - **Configuration** *(dict) --*
      ...
      results are stored, the encryption configuration, if any, used for query results; whether the
      Amazon CloudWatch Metrics are enabled for the workgroup; whether workgroup settings override
      client-side settings; and the data usage limits for the amount of data scanned per query or
      per workgroup. The workgroup settings override is specified in EnforceWorkGroupConfiguration
      (true/false) in the WorkGroupConfiguration. See
      WorkGroupConfiguration$EnforceWorkGroupConfiguration .
...
class ClientUpdateWorkGroupConfigurationUpdatesResultConfigurationUpdatesEncryptionConfigurationTypeDef(
    ...
    """
    Type definition for `ClientUpdateWorkGroupConfigurationUpdatesResultConfigurationUpdates`
    `EncryptionConfiguration`
...
class ClientUpdateWorkGroupConfigurationUpdatesResultConfigurationUpdatesTypeDef(
    ...
    - **OutputLocation** *(string) --*
      ...
      <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__ If workgroup settings override
...
class ClientUpdateWorkGroupConfigurationUpdatesTypeDef(
    ...
    - **ResultConfigurationUpdates** *(dict) --*
      ...
      - **OutputLocation** *(string) --*
        ...
        <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__ If workgroup settings
        override client-side settings, then the query uses the location for the query results and
        the encryption configuration that are specified for the workgroup. The "workgroup settings
        override" is specified in EnforceWorkGroupConfiguration (true/false) in the
        WorkGroupConfiguration. See  WorkGroupConfiguration$EnforceWorkGroupConfiguration .
