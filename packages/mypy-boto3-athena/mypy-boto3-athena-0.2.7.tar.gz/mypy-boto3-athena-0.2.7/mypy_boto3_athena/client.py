"Main interface for athena Client"
...
class Client(BaseClient):
    ...
    def create_named_query(
        ...
        <http://docs.aws.amazon.com/athena/latest/ug/code-samples.html>`__ in the *Amazon Athena User Guide*
        .
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          .. warning::
            ...
            auto-generate the token for users. If you are not using the AWS SDK or the AWS CLI, you must
    ...
    def create_work_group(
        ...
        **Request Syntax**
        ...
        :param Configuration:
          ...
          Amazon CloudWatch Metrics are enabled for the workgroup, the limit for the amount of bytes scanned
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --*
              ...
              letters and numbers representable in UTF-8, and the following characters: + - = . _ : / @. Tag
            ...
            - **QueryExecution** *(dict) --*
              ...
              - **Statistics** *(dict) --*
                ...
                - **DataManifestLocation** *(string) --*
                  ...
                  The location and file name of a data manifest file. The manifest file is saved to the
                  Athena query results location in Amazon S3. It tracks files that the query wrote to Amazon
                  S3. If the query fails, the manifest file also tracks files that the query intended to
                  write. The manifest is useful for identifying orphaned files resulting from a failed
                  query. For more information, see `Working with Query Output Files
    ...
    def get_query_results(
        ...
        query results location in Amazon S3. For more information, see `Query Results
        <https://docs.aws.amazon.com/athena/latest/ug/querying.html>`__ in the *Amazon Athena User Guide* .
        This request does not execute the query but returns results. Use  StartQueryExecution to run a
        query.

        To stream query results successfully, the IAM principal with permission to call ``GetQueryResults``
        also must have permissions to the Amazon S3 ``GetObject`` action for the Athena query results
        location.
    ...
    def list_named_queries(
        ...
        that you have access to the workgroup.
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          request, where the request lists the tags for the workgroup resource with the specified ARN.

        :type MaxResults: integer
        :param MaxResults:

          The maximum number of results to be returned per request that lists the tags for the workgroup
          resource.
        ...
        **Request Syntax**
        ...
        :param ResultConfiguration:
          ...
          - **OutputLocation** *(string) --*
            ...
            The location in Amazon S3 where your query results are stored, such as
            ``s3://path/to/query/bucket/`` . To run the query, you must specify the query results location
            using one of the ways: either for individual queries using either this setting (client-side), or
            in the workgroup, using  WorkGroupConfiguration . If none of them is set, Athena issues an error
            that no output location is provided. For more information, see `Query Results
    ...
    def tag_resource(
        ...
        """
        Adds one or more tags to the resource, such as a workgroup. A tag is a label that you assign to an
        AWS Athena resource (a workgroup). Each tag consists of a key and an optional value, both of which
        you define. Tags enable you to categorize resources (workgroups) in Athena, for example, by purpose,
        owner, or environment. Use a consistent set of tag keys to make it easier to search and filter
        workgroups in your account. For best practices, see `AWS Tagging Strategies
        <https://aws.amazon.com/answers/account-management/aws-tagging-strategies/>`__ . The key length is
        from 1 (minimum) to 128 (maximum) Unicode characters in UTF-8. The tag value length is from 0
        (minimum) to 256 (maximum) Unicode characters in UTF-8. You can use letters and numbers
        representable in UTF-8, and the following characters: + - = . _ : / @. Tag keys and values are
        case-sensitive. Tag keys must be unique per resource. If you specify more than one, separate them by
        commas.
        ...
        **Request Syntax**
        ...
        :param ResourceARN: **[REQUIRED]**
          ...
          Requests that one or more tags are added to the resource (such as a workgroup) for the specified
          ARN.
    ...
    def untag_resource(self, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        separated by commas, and removes their tags at the same time.
