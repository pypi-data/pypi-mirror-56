...
class Client(BaseClient):
    ...
    def create_cluster(
        ...
        **Request Syntax**
        ...
        :param ReplicationFactor: **[REQUIRED]**
          ...
          ``ReplicationFactor`` to a number between 3 (one primary and two read replicas) and 10
          (one primary and nine read replicas). ``If the AvailabilityZones`` parameter is provided,
          ...
          - *(dict) --*
            ...
            - **Cluster** *(dict) --*
              ...
              - **ClusterDiscoveryEndpoint** *(dict) --*
                ...
                number. Client applications can specify this endpoint, rather than an individual
    ...
    def describe_clusters(
        ...
        provisioned. When the DAX cluster state is *available* , the cluster is ready for use.
            ...
            - **Clusters** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ClusterDiscoveryEndpoint** *(dict) --*
                  ...
                  individual node endpoint, and allow the DAX client software to intelligently route
                ...
                - **Nodes** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Endpoint** *(dict) --*
                      ...
                      The endpoint for the node, consisting of a DNS name and a port number. Client
                      applications can connect directly to a node endpoint, if desired (as an
                      alternative to allowing DAX client software to intelligently route requests
            ...
            - **Parameters** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ChangeType** *(string) --*
                  ...
                  ``requires-reboot`` indicates that a new value for this parameter will only take
    ...
    def describe_events(
        ...
        to a particular DAX cluster or parameter group by providing the name as a parameter.

        By default, only the events occurring within the last 24 hours are returned; however, you
    ...
    def increase_replication_factor(
        ...
        **Request Syntax**
        ...
        :param AvailabilityZones:
          ...
          belonging to the cluster are placed in these Availability Zones. Use this parameter if you
          want to distribute the nodes across multiple AZs.
    ...
    def list_tags(self, ResourceName: str, NextToken: str = None) -> ClientListTagsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/ListTags>`_
          ...
          - *(dict) --*
            ...
            - **Tags** *(list) --*
              ...
              - *(dict) --*
                ...
                limit of 50. User-assigned tag names have the prefix ``user:`` .
            ...
            - **NextToken** *(string) --*
              ...
              them, call ``ListTags`` again, with ``NextToken`` set to this value.
    ...
    def update_cluster(
        ...
        **Request Syntax**
        ...
        :param SecurityGroupIds:
          ...
          cluster. If this parameter is not specified, DAX assigns the default VPC security group to
          each node.
