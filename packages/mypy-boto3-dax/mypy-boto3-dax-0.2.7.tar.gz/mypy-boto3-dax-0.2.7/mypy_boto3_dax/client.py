...
class Client(BaseClient):
    ...
    def create_cluster(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/CreateCluster>`_
        ...
        **Request Syntax**
        ...
        :param ReplicationFactor: **[REQUIRED]**
          ...
          cluster, without any read replicas. For additional fault tolerance, you can create a multiple node
          cluster with one or more read replicas. To do this, set ``ReplicationFactor`` to a number between
        ...
        :param PreferredMaintenanceWindow:
          ...
          * ``sat``
          ...
          .. note::
            ...
            If you don't specify a preferred maintenance window when you create or modify a cache cluster,
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --*
              ...
              the same key. If you try to add an existing tag (same key), the existing tag value will be
          ...
          - *(dict) --*
            ...
            - **Cluster** *(dict) --*
              ...
              - **ClusterDiscoveryEndpoint** *(dict) --*
                ...
                Client applications can specify this endpoint, rather than an individual node endpoint, and
                allow the DAX client software to intelligently route requests and responses to nodes in the
                DAX cluster.
    ...
    def create_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/CreateParameterGroup>`_
    ...
    def create_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/CreateSubnetGroup>`_
    ...
    def decrease_replication_factor(
        ...
        .. note::
          ...
          You cannot use ``DecreaseReplicationFactor`` to remove the last node in a DAX cluster. If you need
          to do this, use ``DeleteCluster`` instead.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DecreaseReplicationFactor>`_
    ...
    def delete_cluster(self, ClusterName: str) -> ClientDeleteClusterResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DeleteCluster>`_
    ...
    def delete_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DeleteParameterGroup>`_
    ...
    def delete_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DeleteSubnetGroup>`_
    ...
    def describe_clusters(
        ...
        about a specific DAX cluster if a cluster identifier is supplied.

        If the cluster is in the CREATING state, only cluster level information will be displayed until all
        of the nodes are successfully provisioned.

        If the cluster is in the DELETING state, only cluster level information will be displayed.

        If nodes are currently being added to the DAX cluster, node endpoint information and creation time
        for the additional nodes will not be displayed until they are completely provisioned. When the DAX
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DescribeClusters>`_
    ...
    def describe_default_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DescribeDefaultParameters>`_
    ...
    def describe_events(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DescribeEvents>`_
    ...
    def describe_parameter_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DescribeParameterGroups>`_
    ...
    def describe_parameters(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DescribeParameters>`_
    ...
    def describe_subnet_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/DescribeSubnetGroups>`_
    ...
    def increase_replication_factor(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/IncreaseReplicationFactor>`_
    ...
    def reboot_node(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/RebootNode>`_
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/TagResource>`_
    ...
    def untag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/UntagResource>`_
    ...
    def update_cluster(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/UpdateCluster>`_
        ...
        **Request Syntax**
        ...
        :param SecurityGroupIds:
          ...
          A list of user-specified security group IDs to be assigned to each node in the DAX cluster. If
          this parameter is not specified, DAX assigns the default VPC security group to each node.
    ...
    def update_parameter_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/UpdateParameterGroup>`_
        ...
        **Request Syntax**
        ...
        :param ParameterNameValues: **[REQUIRED]**
          ...
          An array of name-value pairs for the parameters in the group. Each element in the array represents
          a single parameter.
    ...
    def update_subnet_group(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/dax-2017-04-19/UpdateSubnetGroup>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_default_parameters` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_parameter_groups` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_subnet_groups` operation.
        """
