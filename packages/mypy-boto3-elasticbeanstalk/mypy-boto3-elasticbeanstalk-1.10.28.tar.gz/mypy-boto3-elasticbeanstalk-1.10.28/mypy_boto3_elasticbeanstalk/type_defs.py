...
class ClientComposeEnvironmentsResponseEnvironmentsEnvironmentLinksTypeDef(
    ...
    group. See `Environment Manifest (env.yaml)
...
class ClientComposeEnvironmentsResponseEnvironmentsResourcesLoadBalancerListenersTypeDef(
    ...
    """
    Type definition for `ClientComposeEnvironmentsResponseEnvironmentsResourcesLoadBalancer`
    `Listeners`
...
class ClientCreateApplicationResourceLifecycleConfigVersionLifecycleConfigMaxAgeRuleTypeDef(
    ...
    """
    Type definition for `ClientCreateApplicationResourceLifecycleConfigVersionLifecycleConfig`
    `MaxAgeRule`

    Specify a max age rule to restrict the length of time that application versions are retained for
    an application.
...
class ClientCreateApplicationResponseApplicationResourceLifecycleConfigVersionLifecycleConfigMaxAgeRuleTypeDef(
    ...
    """
    Type definition for
    `ClientCreateApplicationResponseApplicationResourceLifecycleConfigVersionLifecycleConfig`
    `MaxAgeRule`
...
class ClientCreateApplicationResponseApplicationResourceLifecycleConfigVersionLifecycleConfigTypeDef(
    ...
    """
    Type definition for `ClientCreateApplicationResponseApplicationResourceLifecycleConfig`
...
class ClientCreateApplicationVersionResponseApplicationVersionSourceBuildInformationTypeDef(
    ...
    """
    Type definition for `ClientCreateApplicationVersionResponseApplicationVersion`
    `SourceBuildInformation`

    If the version's source code was retrieved from AWS CodeCommit, the location of the source code
...
class ClientCreateApplicationVersionResponseApplicationVersionTypeDef(
    ...
    - **Status** *(string) --*
      ...
      version during its creation. Many of the values are only applicable if you specified ``True``
      for the ``Process`` parameter of the ``CreateApplicationVersion`` action. The following list
...
class ClientDescribeAccountAttributesResponseResourceQuotasApplicationVersionQuotaTypeDef(
    ...
    """
    Type definition for `ClientDescribeAccountAttributesResponseResourceQuotas`
...
class ClientDescribeApplicationVersionsResponseApplicationVersionsSourceBuildInformationTypeDef(
    ...
    """
    Type definition for `ClientDescribeApplicationVersionsResponseApplicationVersions`
    `SourceBuildInformation`
...
class ClientDescribeApplicationsResponseApplicationsResourceLifecycleConfigVersionLifecycleConfigMaxAgeRuleTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeApplicationsResponseApplicationsResourceLifecycleConfigVersionLifecycleConfig`
    `MaxAgeRule`
...
class ClientDescribeApplicationsResponseApplicationsResourceLifecycleConfigVersionLifecycleConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeApplicationsResponseApplicationsResourceLifecycleConfig`
    `VersionLifecycleConfig`
...
class ClientDescribeConfigurationOptionsResponseOptionsRegexTypeDef(
    ...
    - **Pattern** *(string) --*
      ...
      The regular expression pattern that a string configuration option value with this restriction
      must match.
...
class ClientDescribeConfigurationOptionsResponseOptionsTypeDef(
    ...
    - **ValueType** *(string) --*
      ...
      An indication of which type of values this option has and whether it is allowable to select
      one or more than one of the possible values:
...
class ClientDescribeConfigurationSettingsResponseConfigurationSettingsOptionSettingsTypeDef(
    ...
    """
    Type definition for `ClientDescribeConfigurationSettingsResponseConfigurationSettings`
    `OptionSettings`
...
class ClientDescribeEnvironmentHealthResponseApplicationMetricsStatusCodesTypeDef(
    ...
    - **Status2xx** *(integer) --*
      ...
      The percentage of requests over the last 10 seconds that resulted in a 2xx (200, 201, etc.)
      status code.

    - **Status3xx** *(integer) --*

      The percentage of requests over the last 10 seconds that resulted in a 3xx (300, 301, etc.)
      status code.

    - **Status4xx** *(integer) --*

      The percentage of requests over the last 10 seconds that resulted in a 4xx (400, 401, etc.)
      status code.

    - **Status5xx** *(integer) --*

      The percentage of requests over the last 10 seconds that resulted in a 5xx (500, 501, etc.)
      status code.
    """
...
class ClientDescribeEnvironmentHealthResponseInstancesHealthTypeDef(
    ...
    - **Unknown** *(integer) --*
       ...
       **Grey.** AWS Elastic Beanstalk and the health agent are reporting an insufficient amount of
       data on an instance.
    ...
    - **Degraded** *(integer) --*
       ...
       **Red.** The health agent is reporting a high number of request failures or other issues for
       an instance or environment.

    - **Severe** *(integer) --*

       **Red.** The health agent is reporting a very high number of request failures or other issues
...
class ClientDescribeEnvironmentManagedActionHistoryResponseManagedActionHistoryItemsTypeDef(
    ...
    """
    Type definition for `ClientDescribeEnvironmentManagedActionHistoryResponse`
...
class ClientDescribeEnvironmentResourcesResponseEnvironmentResourcesAutoScalingGroupsTypeDef(
    ...
    """
    Type definition for `ClientDescribeEnvironmentResourcesResponseEnvironmentResources`
    `AutoScalingGroups`
...
class ClientDescribeEnvironmentsResponseEnvironmentsResourcesLoadBalancerListenersTypeDef(
    ...
    """
    Type definition for `ClientDescribeEnvironmentsResponseEnvironmentsResourcesLoadBalancer`
    `Listeners`
...
class ClientDescribeInstancesHealthResponseInstanceHealthListApplicationMetricsLatencyTypeDef(
    ...
    """
    Type definition for `ClientDescribeInstancesHealthResponseInstanceHealthListApplicationMetrics`
    `Latency`
...
class ClientDescribeInstancesHealthResponseInstanceHealthListApplicationMetricsTypeDef(
    ...
    """
    Type definition for `ClientDescribeInstancesHealthResponseInstanceHealthList`
    `ApplicationMetrics`
...
class ClientDescribeInstancesHealthResponseInstanceHealthListDeploymentTypeDef(
    ...
    - **DeploymentId** *(integer) --*
      ...
      The ID of the deployment. This number increases by one each time that you deploy source code
      or change instance configuration settings.
...
class ClientDescribeInstancesHealthResponseInstanceHealthListSystemCPUUtilizationTypeDef(
    ...
    """
    Type definition for `ClientDescribeInstancesHealthResponseInstanceHealthListSystem`
    `CPUUtilization`
...
class ClientDescribePlatformVersionResponsePlatformDescriptionProgrammingLanguagesTypeDef(
    ...
    """
    Type definition for `ClientDescribePlatformVersionResponsePlatformDescription`
...
_ClientRetrieveEnvironmentInfoResponseEnvironmentInfoTypeDef = TypedDict(
    ...
    {"InfoType": str, "Ec2InstanceId": str, "SampleTimestamp": datetime, "Message": str},
    total=False,
)
...
class ClientRetrieveEnvironmentInfoResponseEnvironmentInfoTypeDef(
    ...
    - **Message** *(string) --*
      ...
      The retrieved information. Currently contains a presigned Amazon S3 URL. The files are deleted
      after 15 minutes.

      Anyone in possession of this URL can access the files before they are deleted. Make the URL
      available only to trusted parties.
    """
...
class ClientUpdateApplicationResourceLifecycleResourceLifecycleConfigVersionLifecycleConfigMaxAgeRuleTypeDef(
    ...
    """
    Type definition for
    `ClientUpdateApplicationResourceLifecycleResourceLifecycleConfigVersionLifecycleConfig`
    `MaxAgeRule`
...
class ClientUpdateApplicationResourceLifecycleResourceLifecycleConfigVersionLifecycleConfigTypeDef(
    ...
    """
    Type definition for `ClientUpdateApplicationResourceLifecycleResourceLifecycleConfig`
    `VersionLifecycleConfig`
...
class ClientUpdateApplicationResourceLifecycleResponseResourceLifecycleConfigVersionLifecycleConfigMaxAgeRuleTypeDef(
    ...
    """
    Type definition for
    `ClientUpdateApplicationResourceLifecycleResponseResourceLifecycleConfigVersionLifecycleConfig`
    `MaxAgeRule`
...
class ClientUpdateApplicationResourceLifecycleResponseResourceLifecycleConfigVersionLifecycleConfigTypeDef(
    ...
    """
    Type definition for `ClientUpdateApplicationResourceLifecycleResponseResourceLifecycleConfig`
    `VersionLifecycleConfig`
...
class ClientUpdateApplicationResponseApplicationResourceLifecycleConfigVersionLifecycleConfigMaxAgeRuleTypeDef(
    ...
    """
    Type definition for
    `ClientUpdateApplicationResponseApplicationResourceLifecycleConfigVersionLifecycleConfig`
    `MaxAgeRule`
...
class ClientUpdateApplicationResponseApplicationResourceLifecycleConfigVersionLifecycleConfigTypeDef(
    ...
    """
    Type definition for `ClientUpdateApplicationResponseApplicationResourceLifecycleConfig`
    `VersionLifecycleConfig`
...
class ClientUpdateApplicationVersionResponseApplicationVersionSourceBuildInformationTypeDef(
    ...
    """
    Type definition for `ClientUpdateApplicationVersionResponseApplicationVersion`
    `SourceBuildInformation`
...
class DescribeApplicationVersionsPaginateResponseApplicationVersionsSourceBuildInformationTypeDef(
    ...
    """
    Type definition for `DescribeApplicationVersionsPaginateResponseApplicationVersions`
    `SourceBuildInformation`
...
class DescribeEnvironmentManagedActionHistoryPaginateResponseManagedActionHistoryItemsTypeDef(
    ...
    """
    Type definition for `DescribeEnvironmentManagedActionHistoryPaginateResponse`
    `ManagedActionHistoryItems`
...
class DescribeEnvironmentsPaginateResponseEnvironmentsResourcesLoadBalancerListenersTypeDef(
    ...
    """
    Type definition for `DescribeEnvironmentsPaginateResponseEnvironmentsResourcesLoadBalancer`
    `Listeners`
