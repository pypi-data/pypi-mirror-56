...
class Client(BaseClient):
    ...
    def compose_environments(
        ...
        the source bundles in an environment manifest named ``env.yaml`` . See `Compose Environments
        <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-mgmt-compose.html>`__ for
        details.
        ...
        **Request Syntax**
        ...
        :param GroupName:
          ...
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-cfg-manifest.html>`__ for
          details.
        ...
        :param VersionLabels:
          ...
          target application. Each source bundle must include an environment manifest that specifies the
          name of the environment and the name of the solution stack to use, and optionally can specify
    ...
    def create_application(
        ...
        **Request Syntax**
        ...
        :param ApplicationName: **[REQUIRED]**
          ...
          Constraint: This name must be unique within your account. If the specified name already exists,
          the action returns an ``InvalidParameterValue`` error.
    ...
    def create_application_version(
        ...
        **Request Syntax**
        ...
        :param VersionLabel: **[REQUIRED]**
          ...
          Constraint: Must be unique per application. If an application version already exists with this
          label for the specified application, AWS Elastic Beanstalk returns an ``InvalidParameterValue``
          error.
        ...
        :param BuildConfiguration:
          ...
          - **ArtifactName** *(string) --*
            ...
            artifact in the S3 location *S3-bucket* /resources/*application-name*
          ...
          - **CodeBuildServiceRole** *(string) --* **[REQUIRED]**
            ...
            The Amazon Resource Name (ARN) of the AWS Identity and Access Management (IAM) role that enables
        ...
        :param Process:
          ...
          .. note::
            ...
            The ``Process`` option validates Elastic Beanstalk configuration files. It doesn't validate your
          ...
          - *(dict) --*
            ...
            - **ApplicationVersion** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                * ``Unprocessed`` – Application version wasn't pre-processed or validated. Elastic Beanstalk
                will validate configuration files during deployment of the application version to an
                environment.
    ...
    def create_configuration_template(
        ...
        **Request Syntax**
        ...
        :param ApplicationName: **[REQUIRED]**
          ...
          The name of the application to associate with this configuration template. If no application is
          found with this name, AWS Elastic Beanstalk returns an ``InvalidParameterValue`` error.
        ...
        :param TemplateName: **[REQUIRED]**
          ...
          Default: If a configuration template already exists with this name, AWS Elastic Beanstalk returns
          an ``InvalidParameterValue`` error.

        :type SolutionStackName: string
        :param SolutionStackName:

          The name of the solution stack used by this configuration. The solution stack specifies the
          operating system, architecture, and application server for a configuration template. It determines
          the set of configuration options as well as the possible and default values.
        ...
        :param OptionSettings:
          ...
          If specified, AWS Elastic Beanstalk sets the specified configuration option to the requested
          value. The new value overrides the value obtained from the solution stack or the source
          configuration template.

          - *(dict) --*

            A specification identifying an individual configuration option along with its current value. For
            a list of possible option values, go to `Option Values
    ...
    def create_environment(
        ...
        **Request Syntax**
        ...
        :param EnvironmentName:
          ...
          and hyphens. It cannot start or end with a hyphen. This name must be unique within a region in
          your account. If the specified name already exists in the region, AWS Elastic Beanstalk returns an
          ``InvalidParameterValue`` error.

          Default: If the CNAME parameter is not specified, the environment name becomes part of the CNAME,
        ...
        :param GroupName:
          ...
          parameter. See `Environment Manifest (env.yaml)
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-cfg-manifest.html>`__ for
          details.
        ...
        :param TemplateName:
          ...
          with this name, AWS Elastic Beanstalk returns an ``InvalidParameterValue`` error.
        ...
        :param OptionSettings:
          ...
          If specified, AWS Elastic Beanstalk sets the specified configuration options to the requested
    ...
    def create_platform_version(
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          Elastic Beanstalk applies these tags only to the platform version. Environments that you create
    ...
    def delete_configuration_template(
        ...
        .. note::
          ...
          When you launch an environment using a configuration template, the environment gets a copy of the
          template. You can delete or modify the environment's copy of the template without affecting the
          running environment.
    ...
    def delete_environment_configuration(
        ...
        Updating a running environment with any configuration changes creates a draft configuration set. You
        can get the draft configuration using  DescribeConfigurationSettings while the update is in progress
        or if the update fails. The ``DeploymentStatus`` for the draft configuration indicates whether the
    ...
    def describe_application_versions(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          For a paginated request. Specify a token from a previous response page to retrieve the next
          response page. All other parameter values must be identical to the ones specified in the initial
          request.
    ...
    def describe_configuration_options(
        ...
        **Request Syntax**
        ...
        :param ApplicationName:
          ...
          if you want to describe the configuration options associated with either the configuration
    ...
    def describe_configuration_settings(
        ...
        When describing the settings for the configuration set associated with a running environment, it is
        ...
        **Request Syntax**
        ...
        :param TemplateName:
          ...
          specify both, AWS Elastic Beanstalk returns an ``InvalidParameterCombination`` error. If you do
          not specify either, AWS Elastic Beanstalk returns a ``MissingRequiredParameter`` error.
        ...
        :param EnvironmentName:
          ...
          Elastic Beanstalk returns an ``InvalidParameterCombination`` error. If you do not specify either,
        ...
        **Request Syntax**
        ::
          ...
          response = client.describe_environment_health(
              ...
              EnvironmentId='string',
              AttributeNames=[
                  'Status'|'Color'|'Causes'|'ApplicationMetrics'|'InstancesHealth'|'All'|'HealthStatus'
                  |'RefreshedAt',
              ]
          )
        :type EnvironmentName: string
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **HealthStatus** *(string) --*
              ...
              The `health status
              <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-status.html>`__ of the
                ...
                'ManagedActionHistoryItems': [
                    {
                        ...
                        'ActionDescription': 'string',
                        'FailureType':
                        'UpdateCancelled'|'CancellationFailed'|'RollbackFailed'|'RollbackSuccessful'
        ...
        **Request Syntax**
        ::
          ...
          response = client.describe_instances_health(
              ...
              EnvironmentId='string',
              AttributeNames=[
                  'HealthStatus'|'Color'|'Causes'|'ApplicationMetrics'|'RefreshedAt'|'LaunchedAt'|'System'
                  |'Deployment'|'AvailabilityZone'|'InstanceType'|'All',
              ],
              NextToken='string'
          )
        :type EnvironmentName: string
    ...
    def list_platform_versions(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Operator** *(string) --*
              ...
              Valid Values: ``=`` (equal to) | ``!=`` (not equal to) | ``<`` (less than) | ``<=`` (less than
              or equal to) | ``>`` (greater than) | ``>=`` (greater than or equal to) | ``contains`` |
        ...
        :param NextToken:
          ...
          The starting index into the remaining list of platforms. Use the ``NextToken`` value from a
          previous ``ListPlatformVersion`` call.
    ...
    def list_tags_for_resource(
        ...
        """
        Returns the tags applied to an AWS Elastic Beanstalk resource. The response contains a list of tag
        key-value pairs.

        Currently, Elastic Beanstalk only supports tagging of Elastic Beanstalk environments. For details
        about environment tagging, see `Tagging Resources in Your Elastic Beanstalk Environment
    ...
    def request_environment_info(
        ...
        Setting the ``InfoType`` to ``tail`` compiles the last lines from the application server log files
        of every Amazon EC2 instance in your environment.

        Setting the ``InfoType`` to ``bundle`` compresses the application server log files for every Amazon
        EC2 instance into a ``.zip`` file. Legacy and .NET containers do not support bundle logs.
    ...
    def swap_environment_cnames(
        ...
        **Request Syntax**
        ...
        :param SourceEnvironmentId:
          ...
          . You may also specify both. If you specify the ``SourceEnvironmentId`` , you must specify the
        ...
        :param SourceEnvironmentName:
          ...
          Condition: You must specify at least the ``SourceEnvironmentID`` or the ``SourceEnvironmentName``
          . You may also specify both. If you specify the ``SourceEnvironmentName`` , you must specify the
    ...
    def terminate_environment(
        ...
        **Request Syntax**
        ...
        :param ForceTerminate:
          ...
          Terminates the target environment even if another environment in the same group is dependent on
          it.
    ...
    def update_configuration_template(
        ...
        .. note::
          ...
          If a property (for example, ``ApplicationName`` ) is not provided, its value remains unchanged. To
    ...
    def update_environment(
        ...
        Attempting to update both the release and configuration is not allowed and AWS Elastic Beanstalk
        ...
        **Request Syntax**
        ...
        :param GroupName:
          ...
          environment ID parameters. See `Environment Manifest (env.yaml)
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-cfg-manifest.html>`__ for
          details.
    ...
    def update_tags_for_resource(
        ...
        If you create a custom IAM user policy to control permission to this operation, specify one of the
