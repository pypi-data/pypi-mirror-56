"Main interface for elasticbeanstalk Client"
...
class Client(BaseClient):
    ...
    def abort_environment_update(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/AbortEnvironmentUpdate>`_
    ...
    def apply_environment_managed_action(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/ApplyEnvironmentManagedAction>`_
    ...
    def check_dns_availability(self, CNAMEPrefix: str) -> ClientCheckDnsAvailabilityResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CheckDNSAvailability>`_
    ...
    def compose_environments(
        ...
        <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-mgmt-compose.html>`__
        for details.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/ComposeEnvironments>`_
        ...
        **Request Syntax**
        ...
        :param GroupName:
          ...
          if the environment name defined in each target environment's manifest ends with a + (plus)
          character. See `Environment Manifest (env.yaml)
        ...
        :param VersionLabels:
          ...
          A list of version labels, specifying one or more application source bundles that belong to
          the target application. Each source bundle must include an environment manifest that
                ...
                'Environments': [
                    {
                        ...
                        'HealthStatus':
                        'NoData'|'Unknown'|'Pending'|'Ok'|'Info'|'Warning'
              ...
              - *(dict) --*
                ...
                - **Health** *(string) --*
                  ...
                  * ``Grey`` : Default health for a new environment. The environment is not fully
                  ...
                  an ``UpdateEnvironment`` or ``RestartEnvironment`` request.
    ...
    def create_application(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CreateApplication>`_
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          Elastic Beanstalk applies these tags only to the application. Environments that you create
          in the application don't inherit the tags.
            ...
            - **Application** *(dict) --*
              ...
              - **ResourceLifecycleConfig** *(dict) --*
                ...
                - **ServiceRole** *(string) --*
                  ...
                  Service Role with the application, and you don't need to specify it again in
                  subsequent ``UpdateApplicationResourceLifecycle`` calls. You can, however, specify
    ...
    def create_application_version(
        ...
        AWS CodeBuild build as follows:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CreateApplicationVersion>`_
        ...
        **Request Syntax**
        ...
        :param VersionLabel: **[REQUIRED]**
          ...
          Constraint: Must be unique per application. If an application version already exists with
          this label for the specified application, AWS Elastic Beanstalk returns an
        ...
        :param BuildConfiguration:
          ...
          - **ArtifactName** *(string) --*
            ...
            the build artifact in the S3 location *S3-bucket* /resources/*application-name*
            /codebuild/codebuild-*version-label* -*artifact-name* .zip. If not provided, Elastic
            Beanstalk stores the build artifact in the S3 location *S3-bucket*
            /resources/*application-name* /codebuild/codebuild-*version-label* .zip.
        ...
        :param AutoCreateApplication:
          ...
          Set to ``true`` to create an application with the specified name if it doesn't already
          exist.
          ...
          - *(dict) --*
            ...
            - **ApplicationVersion** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                application version during its creation. Many of the values are only applicable if
                you specified ``True`` for the ``Process`` parameter of the
    ...
    def create_configuration_template(
        ...
        """
        Creates a configuration template. Templates are associated with a specific application and
        are used to deploy different versions of the application with the same configuration
        settings.

        Templates aren't associated with any environment. The ``EnvironmentName`` response element
        is always ``null`` .
        ...
        *  ListAvailableSolutionStacks
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CreateConfigurationTemplate>`_
        ...
        **Request Syntax**
        ...
        :param SolutionStackName:
          ...
          A solution stack name or a source configuration parameter must be specified, otherwise AWS
        ...
        :param SourceConfiguration:
          ...
          parameters are specified, the solution stack of the source configuration template must
          ...
          - *(dict) --*
            ...
            - **OptionSettings** *(list) --*
              ...
              - *(dict) --*
                ...
                current value. For a list of possible option values, go to `Option Values
                <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/command-options.html>`__ in
    ...
    def create_environment(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CreateEnvironment>`_
        ...
        **Request Syntax**
        ...
        :param EnvironmentName:
          ...
          within a region in your account. If the specified name already exists in the region, AWS
          Elastic Beanstalk returns an ``InvalidParameterValue`` error.

          Default: If the CNAME parameter is not specified, the environment name becomes part of the
        ...
        :param GroupName:
          ...
          environment name parameter. See `Environment Manifest (env.yaml)
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-cfg-manifest.html>`__
          for details.
        ...
        :param CNAMEPrefix:
          ...
          If specified, the environment attempts to use this value as the prefix for the CNAME. If
          not specified, the CNAME is generated automatically by appending a random alphanumeric
        ...
        :param TemplateName:
          ...
          The name of the configuration template to use in deployment. If no configuration template
          is found with this name, AWS Elastic Beanstalk returns an ``InvalidParameterValue`` error.

        :type SolutionStackName: string
        :param SolutionStackName:

          This is an alternative to specifying a template name. If specified, AWS Elastic Beanstalk
          sets the configuration values to the default values associated with the specified solution
          stack.

          For a list of current solution stacks, see `Elastic Beanstalk Supported Platforms
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/concepts.platforms.html>`__ .
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'Health': 'Green'|'Yellow'|'Red'|'Grey',
                'HealthStatus':
                'NoData'|'Unknown'|'Pending'|'Ok'|'Info'|'Warning'|'Degraded'|'Severe'
                |'Suspended',
                'Resources': {
                    'LoadBalancer': {
                        'LoadBalancerName': 'string',
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Status** *(string) --*
              ...
              * ``Updating`` : Environment is in the process of updating its configuration settings
    ...
    def create_platform_version(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CreatePlatformVersion>`_
    ...
    def create_storage_location(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/CreateStorageLocation>`_
    ...
    def delete_application(self, ApplicationName: str, TerminateEnvByForce: bool = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DeleteApplication>`_
    ...
    def delete_application_version(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DeleteApplicationVersion>`_
    ...
    def delete_configuration_template(self, ApplicationName: str, TemplateName: str) -> None:
        ...
        .. note::
          ...
          of the template. You can delete or modify the environment's copy of the template without
          affecting the running environment.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DeleteConfigurationTemplate>`_
    ...
    def delete_environment_configuration(self, ApplicationName: str, EnvironmentName: str) -> None:
        ...
        set. You can get the draft configuration using  DescribeConfigurationSettings while the
        update is in progress or if the update fails. The ``DeploymentStatus`` for the draft
        configuration indicates whether the deployment is in process or has failed. The draft
        configuration remains in existence until it is deleted with this action.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DeleteEnvironmentConfiguration>`_
    ...
    def delete_platform_version(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DeletePlatformVersion>`_
    ...
    def describe_account_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeAccountAttributes>`_
    ...
    def describe_application_versions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeApplicationVersions>`_
    ...
    def describe_applications(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeApplications>`_
              ...
              - *(dict) --*
                ...
                - **ResourceLifecycleConfig** *(dict) --*
                  ...
                  - **ServiceRole** *(string) --*
                    ...
                    provide it once, in either one of the calls, Elastic Beanstalk persists the
                    Service Role with the application, and you don't need to specify it again in
                    subsequent ``UpdateApplicationResourceLifecycle`` calls. You can, however,
    ...
    def describe_configuration_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeConfigurationOptions>`_
    ...
    def describe_configuration_settings(
        ...
        configuration set, and the other is a draft configuration of an environment that is either
        in the process of deployment or that failed to deploy.
        ...
        *  DeleteEnvironmentConfiguration
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeConfigurationSettings>`_
        ...
        **Request Syntax**
        ...
        :param TemplateName:
          ...
          Conditional: You must specify either this parameter or an EnvironmentName, but not both.
        ...
        :param EnvironmentName:
          ...
          both, AWS Elastic Beanstalk returns an ``InvalidParameterCombination`` error. If you do
          not specify either, AWS Elastic Beanstalk returns ``MissingRequiredParameter`` error.
              ...
              - *(dict) --*
                ...
                - **OptionSettings** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    A specification identifying an individual configuration option along with its
                    current value. For a list of possible option values, go to `Option Values
                    <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/command-options.html>`__
    ...
    def describe_environment_health(
        ...
        **DescribeEnvironmentHealth** operation is only available with AWS Elastic Beanstalk
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeEnvironmentHealth>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.describe_environment_health(
              ...
              EnvironmentId='string',
              AttributeNames=[
                  'Status'|'Color'|'Causes'|'ApplicationMetrics'|'InstancesHealth'|'All'
                  |'HealthStatus'|'RefreshedAt',
              ]
          )
        :type EnvironmentName: string
        :param EnvironmentName:
        ...
        :param AttributeNames:
          ...
          Specify the response elements to return. To retrieve all attributes, set to ``All`` . If
    ...
    def describe_environment_managed_action_history(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeEnvironmentManagedActionHistory>`_
                ...
                'ManagedActionHistoryItems': [
                    {
                        ...
                        'ActionDescription': 'string',
                        'FailureType':
                        'UpdateCancelled'|'CancellationFailed'|'RollbackFailed'
                        |'RollbackSuccessful'|'InternalFailure'
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              A pagination token that you pass to  DescribeEnvironmentManagedActionHistory to get
    ...
    def describe_environment_managed_actions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeEnvironmentManagedActions>`_
    ...
    def describe_environment_resources(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeEnvironmentResources>`_
    ...
    def describe_environments(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeEnvironments>`_
    ...
    def describe_events(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeEvents>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              If returned, this indicates that there are more results to obtain. Use this token in
    ...
    def describe_instances_health(
        ...
        <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribeInstancesHealth>`_
        ...
        **Request Syntax**
        ::
          ...
          response = client.describe_instances_health(
              ...
              EnvironmentId='string',
              AttributeNames=[
                  'HealthStatus'|'Color'|'Causes'|'ApplicationMetrics'|'RefreshedAt'|'LaunchedAt'
                  |'System'|'Deployment'|'AvailabilityZone'|'InstanceType'|'All',
              ],
              NextToken='string'
          )
        :type EnvironmentName: string
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **InstanceHealthList** *(list) --*
              ...
              difference in the members that are supported under the ``<CPUUtilization>`` type.
              ...
              - *(dict) --*
                ...
                - **Color** *(string) --*
                  ...
                  EC2 instance. For more information, see `Health Colors and Statuses
                  <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/health-enhanced-status.html>`__
                  .
                ...
                - **ApplicationMetrics** *(dict) --*
                  ...
                  - **Duration** *(integer) --*
                    ...
                    The amount of time that the metrics cover (usually 10 seconds). For example, you
                    might have 5 requests (``request_count`` ) within the most recent time slice of
                    10 seconds (``duration`` ).
    ...
    def describe_platform_version(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/DescribePlatformVersion>`_
    ...
    def list_available_solution_stacks(
        ...
        """
        Returns a list of the available solution stack names, with the public version first and then
        in reverse chronological order.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/ListAvailableSolutionStacks>`_
    ...
    def list_platform_versions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/ListPlatformVersions>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The starting index into the remaining list of platforms. Use the ``NextToken`` value from
          a previous ``ListPlatformVersion`` call.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **PlatformSummaryList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **PlatformStatus** *(string) --*
                  ...
                  The status of the platform. You can create an environment from the platform once
                  it is ready.
            ...
            - **NextToken** *(string) --*
              ...
              , you can use it in a subsequent ``ListPlatformVersion`` call.
    ...
    def list_tags_for_resource(self, ResourceArn: str) -> ClientListTagsForResourceResponseTypeDef:
        """
        Returns the tags applied to an AWS Elastic Beanstalk resource. The response contains a list
        of tag key-value pairs.

        Currently, Elastic Beanstalk only supports tagging of Elastic Beanstalk environments. For
        details about environment tagging, see `Tagging Resources in Your Elastic Beanstalk
        Environment
        <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/using-features.tagging.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/ListTagsForResource>`_
    ...
    def rebuild_environment(self, EnvironmentId: str = None, EnvironmentName: str = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/RebuildEnvironment>`_
    ...
    def request_environment_info(
        ...
        *  RetrieveEnvironmentInfo
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/RequestEnvironmentInfo>`_
    ...
    def restart_app_server(self, EnvironmentId: str = None, EnvironmentName: str = None) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/RestartAppServer>`_
    ...
    def retrieve_environment_info(
        ...
        *  RequestEnvironmentInfo
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/RetrieveEnvironmentInfo>`_
    ...
    def swap_environment_cnames(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/SwapEnvironmentCNAMEs>`_
    ...
    def terminate_environment(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/TerminateEnvironment>`_
        ...
        **Request Syntax**
        ...
        :param TerminateResources:
          ...
          * ``false`` : AWS Elastic Beanstalk resource management is removed from the environment,
          ...
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/ug/>`__
    ...
    def update_application(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/UpdateApplication>`_
    ...
    def update_application_resource_lifecycle(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/UpdateApplicationResourceLifecycle>`_
          ...
          - *(dict) --*
            ...
            - **ResourceLifecycleConfig** *(dict) --*
              ...
              - **ServiceRole** *(string) --*
                ...
                ``VersionLifecycleConfig`` for the application in one of the supporting calls
                (``CreateApplication`` or ``UpdateApplicationResourceLifecycle`` ). After you
                provide it once, in either one of the calls, Elastic Beanstalk persists the Service
                Role with the application, and you don't need to specify it again in subsequent
    ...
    def update_application_version(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/UpdateApplicationVersion>`_
    ...
    def update_configuration_template(
        ...
        *  DescribeConfigurationOptions
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/UpdateConfigurationTemplate>`_
    ...
    def update_environment(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/UpdateEnvironment>`_
        ...
        **Request Syntax**
        ...
        :param GroupName:
          ...
          The name of the group to which the target environment belongs. Specify a group name only
          if the environment's name is specified in an environment manifest and not with the
          environment name or environment ID parameters. See `Environment Manifest (env.yaml)
          <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/environment-cfg-manifest.html>`__
          for details.
        ...
        :param SolutionStackName:
          ...
          This specifies the platform version that the environment will run after the environment is
          updated.
    ...
    def update_tags_for_resource(
        ...
        passed: ``TagsToAdd`` for tags to add or update, and ``TagsToRemove`` .
        ...
        Controls permission to call ``UpdateTagsForResource`` and pass a list of tag keys to remove
        in the ``TagsToRemove`` parameter.

        For details about creating a custom user policy, see `Creating a Custom User Policy
        <https://docs.aws.amazon.com/elasticbeanstalk/latest/dg/AWSHowTo.iam.managed-policies.html#AWSHowTo.iam.policies>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/UpdateTagsForResource>`_
    ...
    def validate_configuration_settings(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/elasticbeanstalk-2010-12-01/ValidateConfigurationSettings>`_
    ...
    ) -> paginator_scope.DescribeApplicationVersionsPaginator:
        """
        Get Paginator for `describe_application_versions` operation.
        """
    ...
    ) -> paginator_scope.DescribeEnvironmentManagedActionHistoryPaginator:
        """
        Get Paginator for `describe_environment_managed_action_history` operation.
        """
    ...
    ) -> paginator_scope.DescribeEnvironmentsPaginator:
        """
        Get Paginator for `describe_environments` operation.
        """
    ...
    ) -> paginator_scope.ListPlatformVersionsPaginator:
        """
        Get Paginator for `list_platform_versions` operation.
        """
