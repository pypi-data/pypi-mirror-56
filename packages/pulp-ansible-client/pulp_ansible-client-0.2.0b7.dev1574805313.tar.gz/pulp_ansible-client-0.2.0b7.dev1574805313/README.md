...
- API version: v3
- Package version: 0.2.0b7.dev01574805313
...
try:
    # List collections
    api_response = api_instance.list(namespace=namespace, name=name, limit=limit, offset=offset, fields=fields, exclude_fields=exclude_fields)
    pprint(api_response)
...
*RepositoriesAnsibleApi* | [**modify**](docs/RepositoriesAnsibleApi.md#modify) | **POST** {ansible_repository_href}modify/ | 
