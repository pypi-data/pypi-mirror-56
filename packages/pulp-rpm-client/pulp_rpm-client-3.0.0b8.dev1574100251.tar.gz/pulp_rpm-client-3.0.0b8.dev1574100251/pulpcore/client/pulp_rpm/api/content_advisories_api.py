...
class ContentAdvisoriesApi(object):
    ...
    def create(self, data, **kwargs):  # noqa: E501
        ...
        :param RpmUpdateRecord data: (required)
    ...
    def list_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'id__in', 'status', 'status__in', 'severity', 'severity__in', 'type', 'type__in', 'repository_version', 'repository_version_added', 'repository_version_removed', 'limit', 'offset', 'fields', 'exclude_fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
