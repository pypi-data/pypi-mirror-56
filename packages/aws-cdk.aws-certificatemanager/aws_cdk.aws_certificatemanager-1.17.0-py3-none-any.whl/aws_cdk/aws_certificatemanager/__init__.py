...
```ts lit=test/example.simple-request.lit.ts
...
```ts lit=test/example.dns-validated-request.lit.ts
...
import aws_cdk.core
__jsii_assembly__ = jsii.JSIIAssembly.load("@aws-cdk/aws-certificatemanager", "1.17.0", __name__, "aws-certificatemanager@1.17.0.jsii.tgz")
