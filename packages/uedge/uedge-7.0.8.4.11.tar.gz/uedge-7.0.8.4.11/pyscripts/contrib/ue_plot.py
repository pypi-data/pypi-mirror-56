...
def it(Y,s=None,ax=False,line='-',marker='o',color='k',linewidth=2,markersize=8,xlabel="Distance along IT [m]",ylabel=False,title="IT profile",xlim=False,ylim=False,yaxis="lin",legend=False):
    ...
    ret=radialplotter(com.yylb[:,0],Y,ax,line,marker,color,linewidth,markersize,xlabel,ylabel,title,xlim,ylim,yaxis,legend)

    if ax is False:
        ret.show()
        return ret

def ot(Y,s=None,ax=False,line='-',marker='o',color='k',linewidth=2,markersize=8,xlabel="Distance along OT [m]",ylabel=False,title="OT profile",xlim=False,ylim=False,yaxis="lin",legend=False):
    ...
    ret=radialplotter(com.yyrb[:,0],Y,ax,line,marker,color,linewidth,markersize,xlabel,ylabel,title,xlim,ylim,yaxis,legend)
...
def mp(Y,s=None,ax=False,line='-',marker='o',color='k',linewidth=2,markersize=8,xlabel="Distance along midplane [m]",ylabel=False,title="Midplane profile",xlim=False,ylim=False,yaxis="lin",legend=False):
    ...
    ret=radialplotter(com.yyc,Y,ax,line,marker,color,linewidth,markersize,xlabel,ylabel,title,xlim,ylim,yaxis,legend)

    if ax is False:
        ret.show()
        return ret

def row(Y,row,s=None,ax=False,line='-',marker='o',color='k',linewidth=2,markersize=8,xlabel=False,ylabel=False,title=False,xlim=False,ylim=False,yaxis="lin",projection="mp",legend=False):
...
def plot(X,Y,ax=False,linewidth=2,markersize=8,xlabel=False,ylabel=False,title=False,xlim=False,ylim=False,yaxis="lin",marker='',line='-',color='k',legend=False):
