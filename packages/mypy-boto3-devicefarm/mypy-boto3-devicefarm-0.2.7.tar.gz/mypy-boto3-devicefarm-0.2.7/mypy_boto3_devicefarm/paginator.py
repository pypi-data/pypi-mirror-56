"Main interface for devicefarm Paginators"
...
class ListDeviceInstancesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        PaginationConfig: ListDeviceInstancesPaginatePaginationConfigTypeDef = None,
    ) -> ListDeviceInstancesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`DeviceFarm.Client.list_device_instances`.
...
class ListInstanceProfilesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`DeviceFarm.Client.list_instance_profiles`.
...
class ListOfferingPromotionsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        PaginationConfig: ListOfferingPromotionsPaginatePaginationConfigTypeDef = None,
    ) -> ListOfferingPromotionsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListOfferingTransactionsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        PaginationConfig: ListOfferingTransactionsPaginatePaginationConfigTypeDef = None,
    ) -> ListOfferingTransactionsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListSamplesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        arn: str,
        PaginationConfig: ListSamplesPaginatePaginationConfigTypeDef = None,
    ) -> ListSamplesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListSuitesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        arn: str,
        PaginationConfig: ListSuitesPaginatePaginationConfigTypeDef = None,
    ) -> ListSuitesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListTestsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        arn: str,
        PaginationConfig: ListTestsPaginatePaginationConfigTypeDef = None,
    ) -> ListTestsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListUniqueProblemsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        arn: str,
        PaginationConfig: ListUniqueProblemsPaginatePaginationConfigTypeDef = None,
    ) -> ListUniqueProblemsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class ListVPCEConfigurationsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        PaginationConfig: ListVPCEConfigurationsPaginatePaginationConfigTypeDef = None,
    ) -> ListVPCEConfigurationsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`DeviceFarm.Client.list_vpce_configurations`.
