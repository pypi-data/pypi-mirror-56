...
class Client(BaseClient):
    ...
    def create_device_pool(
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_device_pool(
              ...
              rules=[
                  {
                      'attribute':
                      'ARN'|'PLATFORM'|'FORM_FACTOR'|'MANUFACTURER'|'REMOTE_ACCESS_ENABLED'
                      |'REMOTE_DEBUG_ENABLED'|'APPIUM_VERSION'|'INSTANCE_ARN'|'INSTANCE_LABELS'|'FLEET_TYPE'
                      |'OS_VERSION'|'MODEL'|'AVAILABILITY',
                      'operator':
        ...
        :param maxDevices:
          ...
          are available and that meet the criteria that you assign for the ``rules`` parameter. Depending on
                    ...
                    'rules': [
                        {
                            'attribute':
                            'ARN'|'PLATFORM'|'FORM_FACTOR'|'MANUFACTURER'|'REMOTE_ACCESS_ENABLED'
                            |'REMOTE_DEBUG_ENABLED'|'APPIUM_VERSION'|'INSTANCE_ARN'|'INSTANCE_LABELS'
          ...
          - *(dict) --*
            ...
            - **devicePool** *(dict) --*
              ...
              - **maxDevices** *(integer) --*
                ...
                The number of devices that Device Farm can add to your device pool. Device Farm adds devices
                that are available and that meet the criteria that you assign for the ``rules`` parameter.
                Depending on how many devices meet these constraints, your device pool might contain fewer
    ...
    def create_instance_profile(
        ...
        **Request Syntax**
        ...
        :param excludeAppPackagesFromCleanup:
          ...
          An array of strings specifying the list of app packages that should not be cleaned up from the
          device after a test run is over.
    ...
    def create_project(
        ...
        **Request Syntax**
        ...
        :param defaultJobTimeoutMinutes:
          ...
          Sets the execution timeout value (in minutes) for a project. All test runs in this project will
          use the specified execution timeout value unless overridden when scheduling a run.
          ...
          - *(dict) --*
            ...
            - **project** *(dict) --*
              ...
              - **defaultJobTimeoutMinutes** *(integer) --*
                ...
                The default number of minutes (at the project level) a test run will execute before it times
        ...
        **Request Syntax**
        ...
        :param sshPublicKey:
           ...
           *Ignored.* The public key of the ``ssh`` key pair you want to use for connecting to remote
           devices in your remote debugging session. This is only required if ``remoteDebugEnabled`` is set
           to ``true`` .
        ...
        :param clientId:
          ...
          should pass the same ``clientId`` value in each call to ``CreateRemoteAccessSession`` . This is
        ...
        :param skipAppResign:
          ...
          When set to ``true`` , for private devices, Device Farm will not sign your app again. For public
          ...
          - *(dict) --*
            ...
            - **remoteAccessSession** *(dict) --*
              ...
              - **billingMethod** *(string) --*
                ...
                ``UNMETERED`` . For more information about metered devices, see `AWS Device Farm terminology
              ...
              - **deviceUdid** *(string) --*
                ...
                Unique device identifier for the remote device. Only returned if remote debugging is enabled
    ...
    def create_upload(
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_upload(
              ...
              type=
                  ...
                  |'APPIUM_WEB_NODE_TEST_SPEC'|'APPIUM_WEB_RUBY_TEST_SPEC'|'INSTRUMENTATION_TEST_SPEC'
                  |'XCTEST_UI_TEST_SPEC',
              contentType='string'
          )
        :type projectArn: string
        ...
        :param name: **[REQUIRED]**
          ...
          The upload's file name. The name should not contain the '/' character. If uploading an iOS app,
          the file name needs to end with the ``.ipa`` extension. If uploading an Android app, the file name
          needs to end with the ``.apk`` extension. For all others, the file name must end with the ``.zip``
          file extension.
          ...
          - *(dict) --*
            ...
            - **accountSettings** *(dict) --*
              ...
              - **defaultJobTimeoutMinutes** *(integer) --*
                ...
                The default number of minutes (at the account level) a test run will execute before it times
                out. The default value is 150 minutes.
        ...
        **Request Syntax**
        ::
          ...
          response = client.get_device_pool_compatibility(
              ...
              testType=
                  ...
                  |'APPIUM_WEB_JAVA_TESTNG'|'APPIUM_WEB_PYTHON'|'APPIUM_WEB_NODE'|'APPIUM_WEB_RUBY'
        ...
        :param test:
          ...
          - **parameters** *(dict) --*
            ...
            * tags: You can limit execution to features or scenarios that have (or don't have) certain tags,
            for example, "@smoke" or "@smoke,~@wip".
    ...
    def get_offering_status(
        ...
        <mailto:aws-devicefarm-support@amazon.com>`__ if you believe that you should be able to invoke this
        operation.
                ...
                'run': {
                    ...
                    'deviceSelectionResult': {
                        'filters': [
                            {
                                'attribute':
                                'ARN'|'PLATFORM'|'OS_VERSION'|'MODEL'|'AVAILABILITY'|'FORM_FACTOR'
                                |'MANUFACTURER'|'REMOTE_ACCESS_ENABLED'|'REMOTE_DEBUG_ENABLED'
                                |'INSTANCE_ARN'|'INSTANCE_LABELS'|'FLEET_TYPE',
                                'operator':
                                'EQUALS'|'LESS_THAN'|'LESS_THAN_OR_EQUALS'|'GREATER_THAN'
                                |'GREATER_THAN_OR_EQUALS'|'IN'|'NOT_IN'|'CONTAINS',
                                'values': [
                ...
                'artifacts': [
                    {
                        ...
                        'name': 'string',
                        'type':
                        'UNKNOWN'|'SCREENSHOT'|'DEVICE_LOG'|'MESSAGE_LOG'|'VIDEO_LOG'|'RESULT_LOG'
                        |'SERVICE_LOG'|'WEBKIT_LOG'|'INSTRUMENTATION_OUTPUT'|'EXERCISER_MONKEY_OUTPUT'
                        |'CALABASH_JSON_OUTPUT'|'CALABASH_PRETTY_OUTPUT'|'CALABASH_STANDARD_OUTPUT'
                        |'CALABASH_JAVA_XML_OUTPUT'|'AUTOMATION_OUTPUT'|'APPIUM_SERVER_OUTPUT'
                        |'APPIUM_JAVA_OUTPUT'|'APPIUM_JAVA_XML_OUTPUT'|'APPIUM_PYTHON_OUTPUT'
                        |'APPIUM_PYTHON_XML_OUTPUT'|'EXPLORER_EVENT_LOG'|'EXPLORER_SUMMARY_LOG'
                        |'APPLICATION_CRASH_REPORT'|'XCTEST_LOG'|'VIDEO'|'CUSTOMER_ARTIFACT'
                        |'CUSTOMER_ARTIFACT_LOG'|'TESTSPEC_OUTPUT',
                        'extension': 'string',
                        'url': 'string'
                    },
                ],
            ...
            - **artifacts** *(list) --*
              ...
              - *(dict) --*
                ...
                - **url** *(string) --*
                  ...
                  The pre-signed Amazon S3 URL that can be used with a corresponding GET request to download
                  the artifact's file.

            - **nextToken** *(string) --*

              If the number of items that are returned is significantly large, this is an identifier that is
              also returned, which can be used in a subsequent call to this operation to return the next set
    ...
    def list_devices(
        ...
        **Request Syntax**
        ::
          ...
          response = client.list_devices(
              ...
              filters=[
                  {
                      'attribute':
                      'ARN'|'PLATFORM'|'OS_VERSION'|'MODEL'|'AVAILABILITY'|'FORM_FACTOR'|'MANUFACTURER'
                      |'REMOTE_ACCESS_ENABLED'|'REMOTE_DEBUG_ENABLED'|'INSTANCE_ARN'|'INSTANCE_LABELS'
                      |'FLEET_TYPE',
                      'operator':
                      'EQUALS'|'LESS_THAN'|'LESS_THAN_OR_EQUALS'|'GREATER_THAN'|'GREATER_THAN_OR_EQUALS'
                      |'IN'|'NOT_IN'|'CONTAINS',
        ...
        :param filters:
          ...
          * Attribute: The aspect of a device such as platform or model used as the selection criteria in a
          device filter. Allowed values include:
            ...
            * REMOTE_DEBUG_ENABLED: Whether the device is enabled for remote debugging. Valid values are
            "TRUE" or "FALSE". *This attribute will be ignored, as remote debugging is `no longer supported
            <https://docs.aws.amazon.com/devicefarm/latest/developerguide/history.html>`__ .*
          ...
          * Values: An array of one or more filter values.
          ...
          - *(dict) --*
            ...
            - **operator** *(string) --*
              ...
              Specifies how Device Farm compares the filter's attribute to the value. For the operators that
              are supported by each attribute, see the attribute descriptions.
                ...
                'jobs': [
                    {
                        ...
                        |'PREPARING'|'RUNNING'|'COMPLETED'|'STOPPING',
                        'result': 'PENDING'|'PASSED'|'WARNED'|'FAILED'|'SKIPPED'|'ERRORED'|'STOPPED',
                        'started': datetime(2015, 1, 1),
                        'stopped': datetime(2015, 1, 1),
                        'counters': {
    ...
    def list_offering_promotions(
        ...
        description of the promotion. The API returns a ``NotEligible`` error if the caller is not permitted
        to invoke the operation. Contact `aws-devicefarm-support@amazon.com
        <mailto:aws-devicefarm-support@amazon.com>`__ if you believe that you should be able to invoke this
        operation.
    ...
    def list_offering_transactions(
        ...
        first). The API returns a ``NotEligible`` error if the user is not permitted to invoke the
        operation. Please contact `aws-devicefarm-support@amazon.com
        <mailto:aws-devicefarm-support@amazon.com>`__ if you believe that you should be able to invoke this
        operation.
    ...
    def list_offerings(
        ...
        `aws-devicefarm-support@amazon.com <mailto:aws-devicefarm-support@amazon.com>`__ if you believe that
        you should be able to invoke this operation.
    ...
    def list_projects(
        ...
        **Request Syntax**
        ...
        :param arn:
          ...
          Optional. If no Amazon Resource Name (ARN) is specified, then AWS Device Farm returns a list of
          all projects for the AWS account. You can also specify a project ARN.
                ...
                'samples': [
                    {
                        'arn': 'string',
                        'type':
                        'CPU'|'MEMORY'|'THREADS'|'RX_RATE'|'TX_RATE'|'RX'|'TX'|'NATIVE_FRAMES'|'NATIVE_FPS'
                        |'NATIVE_MIN_DRAWTIME'|'NATIVE_AVG_DRAWTIME'|'NATIVE_MAX_DRAWTIME'|'OPENGL_FRAMES'
                        |'OPENGL_FPS'|'OPENGL_MIN_DRAWTIME'|'OPENGL_AVG_DRAWTIME'|'OPENGL_MAX_DRAWTIME',
                        'url': 'string'
                    },
                ],
                'nextToken': 'string'
            ...
            - **samples** *(list) --*
              ...
              - *(dict) --*
                ...
                - **type** *(string) --*
                  ...
                  * MEMORY: A memory usage sample type. This is expressed as the total proportional set size
                  of an app process, in kilobytes.
                  ...
                  * THREADS: A threads sample type. This is expressed as the total number of threads per app
                  process.
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param ResourceARN: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the resource(s) for which to list tags. You can associate tags
          with the following Device Farm resources: ``PROJECT`` , ``RUN`` , ``NETWORK_PROFILE`` ,
          ``INSTANCE_PROFILE`` , ``DEVICE_INSTANCE`` , ``SESSION`` , ``DEVICE_POOL`` , ``DEVICE`` , and
          ``VPCE_CONFIGURATION`` .
    ...
    def purchase_offering(
        ...
        quantity for an offering, unless the renewal was overridden. The API returns a ``NotEligible`` error
        ...
        **Request Syntax**
        ...
        :param deviceSelectionConfiguration:
          ...
          - **filters** *(list) --* **[REQUIRED]**
            ...
            Used to dynamically select a set of devices for a test run. A filter is made up of an attribute,
    ...
    def stop_job(self, arn: str) -> ClientStopJobResponseTypeDef:
        ...
        device where tests have not started executing, and you will not be billed for this device. On the
        device where tests have started executing, Setup Suite and Teardown Suite tests will run to
        completion before stopping execution on the device. You will be billed for Setup, Teardown, and any
    ...
    def stop_run(self, arn: str) -> ClientStopRunResponseTypeDef:
        ...
        devices where tests have not started executing, and you will not be billed for these devices. On
        devices where tests have started executing, Setup Suite and Teardown Suite tests will run to
        completion before stopping execution on those devices. You will be billed for Setup, Teardown, and
    ...
    def tag_resource(
        ...
        a resource are not specified in the request parameters, they are not changed. When a resource is
        ...
        **Request Syntax**
        ...
        :param ResourceARN: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the resource(s) to which to add tags. You can associate tags
          with the following Device Farm resources: ``PROJECT`` , ``RUN`` , ``NETWORK_PROFILE`` ,
          ``INSTANCE_PROFILE`` , ``DEVICE_INSTANCE`` , ``SESSION`` , ``DEVICE_POOL`` , ``DEVICE`` , and
          ``VPCE_CONFIGURATION`` .
    ...
    def untag_resource(self, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param ResourceARN: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the resource(s) from which to delete tags. You can associate
    ...
    def update_device_pool(
        ...
        **Request Syntax**
        ...
        :param rules:
          ...
          Represents the rules you wish to modify for the device pool. Updating rules is optional; however,
          if you choose to update rules for your request, the update will replace the existing rules.
        ...
        :param maxDevices:
          ...
          If you use this parameter in your request, you cannot use the ``clearMaxDevices`` parameter in the
          same request.
        ...
        :param clearMaxDevices:
          ...
          to ``true`` , the ``maxDevices`` parameter does not apply, and Device Farm does not limit the
          number of devices that it adds to your device pool. In this case, Device Farm adds all available
          devices that meet the criteria that are specified for the ``rules`` parameter.
    ...
    def update_upload(
        ...
        **Request Syntax**
        ...
        :param name:
          ...
          The upload's test spec file name. The name should not contain the '/' character. The test spec
    ...
    def update_vpce_configuration(
        ...
        **Request Syntax**
        ...
        :param serviceDnsName:
          ...
          The DNS (domain) name used to connect to your private service in your Amazon VPC. The DNS name
