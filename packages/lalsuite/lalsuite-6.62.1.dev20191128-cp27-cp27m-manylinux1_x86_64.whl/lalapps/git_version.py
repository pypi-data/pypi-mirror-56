...
id = "6d0f60cae1183a2a6c12a351f9af3d0ab76b4a4f"
date = "2019-11-27 23:48:50 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "6d0f60cae1183a2a6c12a351f9af3d0ab76b4a4f":
        return
    msg = "Program id (6d0f60cae1183a2a6c12a351f9af3d0ab76b4a4f) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
