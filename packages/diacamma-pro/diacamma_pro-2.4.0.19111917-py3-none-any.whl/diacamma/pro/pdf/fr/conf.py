...
for packname in ('pro', 'microbusiness'):
    create_link(pro_path, packname)
...
latex_documents = [
    (master_doc, 'DiacammaPro.tex', 'Diacamma Pro',
     'sd-libre', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "../../DiacammaPro.jpg"
...
man_pages = [
    (master_doc, 'DiacammaPro', 'Diacamma Pro',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DiacammaPro', 'Diacamma Pro',
     author, 'DiacammaPro', 'Manuel de Diacamma Pro.', 'Miscellaneous'),
]
