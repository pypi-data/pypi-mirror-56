...
class Client(BaseClient):
    ...
    def create_system_instance(
        ...
        **Request Syntax**
        ...
        :param s3BucketName:
          ...
          The name of the Amazon Simple Storage Service bucket that will be used to store and deploy
          the system instance's resource file. This value is required if the value of the ``target``
          ...
          ::

            {
                'summary': {
                    ...
                    |'UNDEPLOY_IN_PROGRESS'|'FAILED'|'PENDING_DELETE'
                    |'DELETED_IN_TARGET',
                    'target': 'GREENGRASS'|'CLOUD',
                    'greengrassGroupName': 'string',
                    'createdAt': datetime(2015, 1, 1),
    ...
    def deploy_system_instance(self, id: str = None) -> ClientDeploySystemInstanceResponseTypeDef:
        ...
        use this API, see `AWS IoT Things Graph and AWS IoT Greengrass
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def dissociate_entity_from_thing(self, thingName: str, entityType: str) -> Dict[str, Any]:
        """
                ...
                'descriptions': [
                    {
                        ...
                        'arn': 'string',
                        'type':
                        'DEVICE'|'SERVICE'|'DEVICE_MODEL'|'CAPABILITY'|'STATE'
...

            {
                'description': {
                    'summary': {
                        ...
                        'arn': 'string',
                        'status':
                        'NOT_DEPLOYED'|'BOOTSTRAP'|'DEPLOY_IN_PROGRESS'
                        |'DEPLOYED_IN_TARGET'|'UNDEPLOY_IN_PROGRESS'|'FAILED'
                        |'PENDING_DELETE'|'DELETED_IN_TARGET',
                        'target': 'GREENGRASS'|'CLOUD',
                        'greengrassGroupName': 'string',
                        'createdAt': datetime(2015, 1, 1),
                        'updatedAt': datetime(2015, 1, 1),
          ...
          - *(dict) --*
            ...
            - **description** *(dict) --*
              ...
              - **metricsConfiguration** *(dict) --*
                ...
                An object that specifies whether cloud metrics are collected in a deployment and, if
                so, what role is used to collect metrics.
              ...
              - **flowActionsRoleArn** *(string) --*
                ...
                permissionss to AWS Lambda and AWS IoT and to any other AWS services that the flow
                uses.
                ...
                'messages': [
                    {
                        ...
                        |'EXECUTION_SUCCEEDED'|'STEP_STARTED'|'STEP_FAILED'
                        |'STEP_SUCCEEDED'|'ACTIVITY_SCHEDULED'|'ACTIVITY_STARTED'
                        |'ACTIVITY_FAILED'|'ACTIVITY_SUCCEEDED'
                        |'START_FLOW_EXECUTION_TASK'
                        |'SCHEDULE_NEXT_READY_STEPS_TASK'|'THING_ACTION_TASK'
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          - *(dict) --*
            ...
            search. For example a search that includes a ``NAMESPACE`` and a
            ``REFERENCED_ENTITY_ID`` filter searches for entities in the specified namespace that
            use the entity specified by the value of ``REFERENCED_ENTITY_ID`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **summaries** *(list) --*
              ...
              An array of objects that contain summary information about each workflow execution in
              the result set.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **summaries** *(list) --*
              ...
              An array of objects that contain summary information about each workflow in the result
              set.
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          - *(dict) --*
            ...
            criteria in the search. For example a search that includes a GREENGRASS_GROUP_NAME and a
            STATUS filter searches for system instances in the specified Greengrass group that have
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **summaries** *(list) --*
              ...
              An array of objects that contain summary data abour the system instances in the result
              set.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **summaries** *(list) --*
              ...
              An array of objects that contain summary information about each system deployment in
              the result set.
    ...
    def untag_resource(self, resourceArn: str, tagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param tagKeys: **[REQUIRED]**
          ...
          A list of tag key names to remove from the resource. You don't specify the value. Both the
    ...
    def upload_entity_definitions(
        ...
        ``document`` parameter is required if ``syncWithPublicNamespace`` and
        ``deleteExistingEntites`` are false. If the ``syncWithPublicNamespace`` parameter is set to
        ``true`` , the user's namespace will synchronize with the latest version of the public
        namespace. If ``deprecateExistingEntities`` is set to true, all entities in the latest
        ...
        ``syncWithPublicNamespace`` parameter or the ``deprecateExistingEntities`` parameter to
        ``true`` .
        ...
        **Request Syntax**
        ...
        :param deprecateExistingEntities:
          ...
          uploading the new ``DefinitionDocument`` . If set to ``true`` , the upload will create a
