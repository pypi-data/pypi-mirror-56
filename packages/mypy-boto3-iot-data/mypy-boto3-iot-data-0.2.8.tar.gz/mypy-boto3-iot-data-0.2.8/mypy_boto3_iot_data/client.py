...
class Client(BaseClient):
    ...
    def delete_thing_shadow(self, thingName: str) -> Dict:
        ...
        <http://docs.aws.amazon.com/iot/latest/developerguide/API_DeleteThingShadow.html>`__ in the
    ...
    def get_thing_shadow(self, thingName: str) -> Dict:
        ...
        <http://docs.aws.amazon.com/iot/latest/developerguide/API_GetThingShadow.html>`__ in the
        *AWS IoT Developer Guide* .
    ...
    def publish(self, topic: str, qos: int = None, payload: Union[bytes, IO] = None) -> None:
        ...
        <http://docs.aws.amazon.com/iot/latest/developerguide/protocols.html#http>`__ in the *AWS
        IoT Developer Guide* .
    ...
    def update_thing_shadow(self, thingName: str, payload: Union[bytes, IO]) -> Dict:
        ...
        <http://docs.aws.amazon.com/iot/latest/developerguide/API_UpdateThingShadow.html>`__ in the
        *AWS IoT Developer Guide* .
