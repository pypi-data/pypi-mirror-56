...
def get_user_id_from_username(conninfo, credentials, username):
    username = util.check_unicode(username, 'user_name')
...
def get_user_id(conninfo, credentials, value):
    ...
    return get_user_id_from_username(conninfo, credentials, value)
