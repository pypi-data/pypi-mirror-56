...
class DBClusterSnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`RDS.Client.describe_db_cluster_snapshots` every 30 seconds until a
...
class DBInstanceAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`RDS.Client.describe_db_instances` every 30 seconds until a successful state
...
class DBSnapshotAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        Polls :py:meth:`RDS.Client.describe_db_snapshots` every 30 seconds until a successful state
        is reached. An error is returned after 60 failed checks.
...
class DBSnapshotCompletedWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        .. _https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html:
        https://docs.aws.amazon.com/aws-backup/latest/devguide/whatisbackup.html
        Polls :py:meth:`RDS.Client.describe_db_snapshots` every 15 seconds until a successful state
