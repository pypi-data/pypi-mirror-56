"Main interface for rds Paginators"
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param CustomAvailabilityZoneId:
          ...
          The custom AZ identifier. If this parameter is specified, information from only the specific
          custom AZ is returned.
        ...
        **Request Syntax**
        ...
        :param BacktrackIdentifier:
          ...
          * Must contain a valid universally unique identifier (UUID). For more information about UUIDs, see
          `A Universally Unique Identifier (UUID) URN Namespace <http://www.ietf.org/rfc/rfc4122.txt>`__ .
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          ,*endpoint_type2* ,...`` . ``Name`` can be one of: ``db-cluster-endpoint-type`` ,
          ``db-cluster-endpoint-custom-type`` , ``db-cluster-endpoint-id`` , ``db-cluster-endpoint-status``
          . ``Values`` for the ``db-cluster-endpoint-type`` filter can be one or more of: ``reader`` ,
          ``writer`` , ``custom`` . ``Values`` for the ``db-cluster-endpoint-custom-type`` filter can be one
          or more of: ``reader`` , ``any`` . ``Values`` for the ``db-cluster-endpoint-status`` filter can be
          one or more of: ``available`` , ``creating`` , ``deleting`` , ``modifying`` .
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param DefaultOnly:
          ...
          A value that indicates whether only the default version of the specified engine or engine and
        ...
        :param ListSupportedCharacterSets:
          ...
          If this parameter is enabled and the requested engine supports the ``CharacterSetName`` parameter
          for ``CreateDBInstance`` , the response includes a list of supported character sets for each
          engine version.
        ...
        :param ListSupportedTimezones:
          ...
          If this parameter is enabled and the requested engine supports the ``TimeZone`` parameter for
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param DbiResourceId:
          ...
          The resource ID of the DB instance that is the source of the automated backup. This parameter
          isn't case-sensitive.

        :type DBInstanceIdentifier: string
        :param DBInstanceIdentifier:

          (Optional) The user-supplied instance identifier. If this parameter is specified, it must match
          the identifier of an existing DB instance. It returns information from the specific DB instance'
        ...
        :param Filters:
          ...
          * ``db-instance-id`` - Accepts DB instance identifiers and Amazon Resource Names (ARNs) for DB
          instances. The results list includes only information about the DB instance automated backupss
          identified by these ARNs.

          * ``dbi-resource-id`` - Accepts DB instance resource identifiers and DB Amazon Resource Names
          (ARNs) for DB instances. The results list includes only information about the DB instance
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param SnapshotType:
          ...
          * ``awsbackup`` - Return the DB snapshots managed by the AWS Backup service. For information about
          AWS Backup, see the ` *AWS Backup Developer Guide.*
        ...
        :param IncludeShared:
          ...
          You can give an AWS account permission to restore a manual DB snapshot from another AWS account by
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``engine`` - Accepts database engines. The results list includes information about only the
          database engines identified by these identifiers. For more information about the valid engines for
          installation media, see  ImportInstallationMedia .
            ...
            - **OptionGroupOptions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Persistent** *(boolean) --*
                  ...
                  with the option group. If you disassociate all DB instances from the option group, your
                ...
                - **OptionGroupOptionSettings** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    Option group option settings are used to display settings available for each option with
                    their default values and other information. These values are used with the
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param EngineName:
          ...
          Filters the list of option groups to only include groups associated with a specific database
          engine.
        ...
        :param MajorEngineVersion:
          ...
          Filters the list of option groups to only include groups associated with a specific database
          engine version. If specified, then EngineName must also be specified.
    ...
    def paginate(
        ...
        **Request Syntax**
        ...
        :param OfferingType:
          ...
          The offering type filter value. Specify this parameter to show only the available offerings
        ...
        :param LeaseId:
          ...
          The lease identifier filter value. Specify this parameter to show only the reservation that
          matches the specified lease ID.
