"Main interface for workdocs Client"
...
class Client(BaseClient):
    ...
    def create_comment(
        ...
        **Request Syntax**
        ...
        :param Visibility:
          ...
          The visibility of the comment. Options are either PRIVATE, where the comment is visible only to
          ...
          - *(dict) --*
            ...
            - **Comment** *(dict) --*
              ...
              - **Visibility** *(string) --*
                ...
                The visibility of the comment. Options are either PRIVATE, where the comment is visible only
                to the comment author and document owner and co-owners, or PUBLIC, where the comment is
                visible to document owners, co-owners, and contributors.
    ...
    def create_notification_subscription(
        ...
        message, and must confirm the subscription.

        For more information, see `Subscribe to Notifications
        <https://docs.aws.amazon.com/workdocs/latest/developerguide/subscribe-notifications.html>`__ in the
        ...
        **Request Syntax**
        ...
        :param Protocol: **[REQUIRED]**
          ...
          The protocol to use. The supported value is https, which delivers JSON-encoded messages using
          HTTPS POST.
    ...
    def describe_activities(
        ...
        **Request Syntax**
        ...
        :param ActivityTypes:
          ...
          Specifies which activity types to include in the response. If this field is left empty, all
        ...
        :param UserId:
          ...
          user. This is an optional parameter and is only applicable for administrative API (SigV4)
          requests.
          ...
          ::

            {
                'UserActivities': [
                    {
                        'Type':
                        'DOCUMENT_CHECKED_IN'|'DOCUMENT_CHECKED_OUT'|'DOCUMENT_RENAMED'
                        |'DOCUMENT_VERSION_UPLOADED'|'DOCUMENT_VERSION_DELETED'|'DOCUMENT_VERSION_VIEWED'
                        |'DOCUMENT_VERSION_DOWNLOADED'|'DOCUMENT_RECYCLED'|'DOCUMENT_RESTORED'
                        |'DOCUMENT_REVERTED'|'DOCUMENT_SHARED'|'DOCUMENT_UNSHARED'
                        |'DOCUMENT_SHARE_PERMISSION_CHANGED'|'DOCUMENT_SHAREABLE_LINK_CREATED'
                        |'DOCUMENT_SHAREABLE_LINK_REMOVED'|'DOCUMENT_SHAREABLE_LINK_PERMISSION_CHANGED'
                        |'DOCUMENT_MOVED'|'DOCUMENT_COMMENT_ADDED'|'DOCUMENT_COMMENT_DELETED'
                        |'DOCUMENT_ANNOTATION_ADDED'|'DOCUMENT_ANNOTATION_DELETED'|'FOLDER_CREATED'
                        |'FOLDER_DELETED'|'FOLDER_RENAMED'|'FOLDER_RECYCLED'|'FOLDER_RESTORED'
                        |'FOLDER_SHARED'|'FOLDER_UNSHARED'|'FOLDER_SHARE_PERMISSION_CHANGED'
    ...
    def describe_folder_contents(
        ...
        By default, Amazon WorkDocs returns the first 100 active document and folder metadata items. If
        there are more results, the response includes a marker that you can use to request the next set of
        results. You can also request initialized documents.
    ...
    def describe_root_folders(
        ...
        ``RootFolder`` is the root of user's files and folders and ``RecycleBin`` is the root of recycled
        items. This is not a valid action for SigV4 (administrative API) clients.

        This action requires an authentication token. To get an authentication token, register an
        application with Amazon WorkDocs. For more information, see `Authentication and Access Control for
        User Applications <https://docs.aws.amazon.com/workdocs/latest/developerguide/wd-auth-user.html>`__
    ...
    def describe_users(
        ...
        By default, Amazon WorkDocs returns the first 24 active or pending users. If there are more results,
        the response includes a marker that you can use to request the next set of results.
    ...
    def get_document_path(
        ...
        By default, Amazon WorkDocs returns a maximum of 100 levels upwards from the requested document and
    ...
    def get_folder_path(
        ...
        By default, Amazon WorkDocs returns a maximum of 100 levels upwards from the requested folder and
        only includes the IDs of the parent folders in the path. You can limit the maximum number of levels.
        You can also request the parent folder names.
    ...
    def get_resources(
        ...
        **Request Syntax**
        ...
        :param AuthenticationToken:
          ...
          The Amazon WorkDocs authentication token. Do not set this field when using administrative API
          actions, as in accessing the API operation using AWS credentials.
    ...
    def initiate_document_version_upload(
        ...
        The client specifies the parent folder ID and name of the document to upload. The ID is optionally
        specified when creating a new version of an existing document. This is the first step to upload a
        document. Next, upload the document to the URL returned from the call, and then call
    ...
    def update_document_version(
        ...
        Amazon WorkDocs also sets its document container to ACTIVE. This is the last step in a document
