...
class NFLStatements:
    ...
    def _generate_all_statements(self, calculationsFilter=None, statsFilter=None):
        ...
        self._columns=['Interest', 'teamName', 'dimensions', 'statObject', 'statName', 'statValue', 'absFactor', 'rank', 'nItems', 'calculation', 'Sentiment', 'Text', 'Template']
...
def test():
    ...
    #nfls._generate_all_statements(calculationsFilter=['pct'], statsFilter=[])
    # Sort the sentences
