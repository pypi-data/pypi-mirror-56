"Main interface for pinpoint-email Client"
...
class Client(BaseClient):
    ...
    def create_configuration_set(
        ...
        including a reference to the configuration set in the headers of the email. When you apply a
        configuration set to an email, all of the rules in that configuration set are applied to the
        email.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/CreateConfigurationSet>`_
        ...
        **Request Syntax**
        ...
        :param TrackingOptions:
          ...
          An object that defines the open and click tracking options for emails that you send using
        ...
        :param SendingOptions:
          ...
          An object that defines whether or not Amazon Pinpoint can send email that you send using
          the configuration set.
        ...
        :param Tags:
          ...
          An array of objects that define the tags (keys and values) that you want to associate with
          the configuration set.

          - *(dict) --*

            An object that defines the tags that are associated with a resource. A *tag* is a label
            that you optionally define and associate with a resource in Amazon Pinpoint. Tags can
            ...
            * The ``aws:`` prefix is reserved for use by AWS; you can’t use it in any tag keys or
            ...
            use this prefix. Tags that use this prefix don’t count against the limit of 50 tags per
            resource.

            * You can associate tags with public or shared resources, but the tags are available
            only for your AWS account, not any other accounts that share the resource. In addition,
            the tags are available only for resources that are located in the specified AWS Region
            ...
            - **Value** *(string) --* **[REQUIRED]**
              ...
              resource to have a specific tag value, don’t specify a value for this parameter.
    ...
    def create_configuration_set_event_destination(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/CreateConfigurationSetEventDestination>`_
        ...
        **Request Syntax**
        ...
        :param EventDestination: **[REQUIRED]**
          ...
          - **MatchingEventTypes** *(list) --*
            ...
            An array that specifies which events Amazon Pinpoint should send to the destinations in
            ...
            - **DimensionConfigurations** *(list) --* **[REQUIRED]**
              ...
              - *(dict) --*
                ...
                - **DimensionValueSource** *(string) --* **[REQUIRED]**
                  ...
                  use your own email headers, choose ``emailHeader`` . If you want Amazon Pinpoint
    ...
    def create_dedicated_ip_pool(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/CreateDedicatedIpPool>`_
    ...
    def create_deliverability_test_report(
        ...
        the content that you plan to send to your customers. Amazon Pinpoint then sends that message
        to special email addresses spread across several major email providers. After about 24
        hours, the test is complete, and you can use the ``GetDeliverabilityTestReport`` operation
        to view the results of the test.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/CreateDeliverabilityTestReport>`_
        ...
        **Request Syntax**
        ...
        :param ReportName:
          ...
          A unique name that helps you to identify the predictive inbox placement test when you
        ...
        :param Content: **[REQUIRED]**
          ...
          - **Simple** *(dict) --*
            ...
            - **Subject** *(dict) --* **[REQUIRED]**
              ...
              <https://tools.ietf.org/html/rfc2047>`__ .
              ...
              - **Charset** *(string) --*
                ...
                of the ASCII range, you have to specify a character set. For example, you could
                specify ``UTF-8`` , ``ISO-8859-1`` , or ``Shift_JIS`` .
          ...
          - **Raw** *(dict) --*
            ...
            * If you include attachments, they must be in a file format that Amazon Pinpoint
            supports.
            ...
            * The length of any single line of text in the message can't exceed 1,000 characters.
            This restriction is defined in `RFC 5321 <https://tools.ietf.org/html/rfc5321>`__ .
            ...
            - **Data** *(bytes) --* **[REQUIRED]**
              ...
              * If any of the MIME parts in your message contain content that is outside of the
              7-bit ASCII character range, you should encode that content to ensure that recipients'
              email clients render the message properly.
          ...
          - **Template** *(dict) --*
            ...
            - **TemplateData** *(string) --*
              ...
              object is a set of key-value pairs. Each key defines a message variable in the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DeliverabilityTestStatus** *(string) --*
              ...
              placement tests are usually complete within 24 hours of creating the test. If the
              status is ``COMPLETE`` , then the test is finished, and you can use the
    ...
    def create_email_identity(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/CreateEmailIdentity>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **VerifiedForSendingStatus** *(boolean) --*
              ...
              send email from verified email addresses or domains. For more information about
              verifying identities, see the `Amazon Pinpoint User Guide
            ...
            - **DkimAttributes** *(dict) --*
              ...
              - **Tokens** *(list) --*
                ...
                in the DNS configuration for your domain, the DKIM authentication process is
                complete. Amazon Pinpoint usually detects these records within about 72 hours of
    ...
    def delete_configuration_set(self, ConfigurationSetName: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/DeleteConfigurationSet>`_
    ...
    def delete_configuration_set_event_destination(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/DeleteConfigurationSetEventDestination>`_
    ...
    def delete_dedicated_ip_pool(self, PoolName: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/DeleteDedicatedIpPool>`_
    ...
    def delete_email_identity(self, EmailIdentity: str) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/DeleteEmailIdentity>`_
    ...
    def get_account(self, *args: Any, **kwargs: Any) -> ClientGetAccountResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetAccount>`_
          ...
          - *(dict) --*
            ...
            - **SendQuota** *(dict) --*
              ...
              - **MaxSendRate** *(float) --*
                ...
                This value is also called your *maximum sending rate* or your *maximum TPS
            ...
            - **SendingEnabled** *(boolean) --*
              ...
              Indicates whether or not email sending is enabled for your Amazon Pinpoint account in
            ...
            - **EnforcementStatus** *(string) --*
              ...
              * ``SHUTDOWN`` – Your account's ability to send email is currently paused because of
              an issue with the email sent from your account. When you correct the issue, you can
              contact us and request that your account's ability to send email is resumed.
            ...
            - **ProductionAccessEnabled** *(boolean) --*
              ...
              is in the sandbox, you can only send email to verified identities. Additionally, the
              maximum number of emails you can send in a 24-hour period (your sending quota) is 200,
              and the maximum number of emails you can send per second (your maximum sending rate)
              is 1.

              If the value is ``true`` , then your account has production access. When your account
    ...
    def get_blacklist_reports(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetBlacklistReports>`_
        ...
        **Request Syntax**
        ...
        :param BlacklistItemNames: **[REQUIRED]**
          ...
          A list of IP addresses that you want to retrieve blacklist information about. You can only
          specify the dedicated IP addresses that you use to send email using Amazon Pinpoint or
          Amazon SES.
    ...
    def get_configuration_set(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetConfigurationSet>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ReputationOptions** *(dict) --*
              ...
              An object that defines whether or not Amazon Pinpoint collects reputation metrics for
              ...
              - **LastFreshStart** *(datetime) --*
                ...
                calculated starting from the date of the fresh start.
            ...
            - **Tags** *(list) --*
              ...
              - *(dict) --*
                ...
                purpose, owner, environment, or other criteria. A resource can have as many as 50
                tags.
                ...
                * You can associate tags with public or shared resources, but the tags are available
                only for your AWS account, not any other accounts that share the resource. In
    ...
    def get_configuration_set_event_destinations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetConfigurationSetEventDestinations>`_
              ...
              - *(dict) --*
                ...
                - **MatchingEventTypes** *(list) --*
                  ...
                  - *(string) --*
                    ...
                    An email sending event type. For example, email sends, opens, and bounces are
                    all email events.

                - **KinesisFirehoseDestination** *(dict) --*

                  An object that defines an Amazon Kinesis Data Firehose destination for email
                  events. You can use Amazon Kinesis Data Firehose to stream data to other services,
                  ...
                  - **DimensionConfigurations** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **DimensionValueSource** *(string) --*
                        ...
                        Pinpoint to use your own email headers, choose ``emailHeader`` . If you want
                ...
                - **PinpointDestination** *(dict) --*
                  ...
                  An object that defines a Amazon Pinpoint destination for email events. You can use
                  Amazon Pinpoint events to create attributes in Amazon Pinpoint projects. You can
    ...
    def get_dedicated_ip(self, Ip: str) -> ClientGetDedicatedIpResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetDedicatedIp>`_
        ...
        **Request Syntax**
        ...
        :param Ip: **[REQUIRED]**
          ...
          The IP address that you want to obtain more information about. The value you specify has
          to be a dedicated IP address that's assocaited with your Amazon Pinpoint account.
    ...
    def get_dedicated_ips(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetDedicatedIps>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``GetDedicatedIps`` to indicate the position of
          the dedicated IP pool in the list of IP pools.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              view additional addresses, issue another request to ``GetDedicatedIps`` , passing this
    ...
    def get_deliverability_dashboard_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetDeliverabilityDashboardOptions>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DashboardEnabled** *(boolean) --*
              ...
              account. If this value is ``true`` , the dashboard is enabled.
            ...
            - **SubscriptionExpiryDate** *(datetime) --*
              ...
              end of the current calendar month. This value is null if you have an active
            ...
            - **AccountStatus** *(string) --*
              ...
              ``PENDING_EXPIRATION`` , your subscription is scheduled to expire at the end of the
              current calendar month.

            - **ActiveSubscribedDomains** *(list) --*

              An array of objects, one for each verified domain that you use to send email and
              currently has an active Deliverability dashboard subscription that isn’t scheduled to
              ...
              - *(dict) --*
                ...
                Deliverability dashboard subscription. If a Deliverability dashboard subscription is
                active for a domain, you gain access to reputation, inbox placement, and other
            ...
            - **PendingExpirationSubscribedDomains** *(list) --*
              ...
              An array of objects, one for each verified domain that you use to send email and
              currently has an active Deliverability dashboard subscription that's scheduled to
              expire at the end of the current calendar month.
    ...
    def get_deliverability_test_report(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetDeliverabilityTestReport>`_
    ...
    def get_domain_deliverability_campaign(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetDomainDeliverabilityCampaign>`_
          ...
          - *(dict) --*
            ...
            - **DomainDeliverabilityCampaign** *(dict) --*
              ...
              - **FirstSeenDateTime** *(datetime) --*
                ...
                recipient's inbox. This value can help you determine how long it took for a campaign
              ...
              - **DeleteRate** *(float) --*
                ...
                opened first. Due to technical limitations, this value only includes recipients who
              ...
              - **ReadDeleteRate** *(float) --*
                ...
                Due to technical limitations, this value only includes recipients who opened the
    ...
    def get_domain_statistics_report(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetDomainStatisticsReport>`_
        ...
        **Request Syntax**
        ...
        :param EndDate: **[REQUIRED]**
          ...
          ``EndDate`` that you specify has to be less than or equal to 30 days after the
          ``StartDate`` .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DailyVolumes** *(list) --*
              ...
              object contains data for each day, starting on the ``StartDate`` and ending on the
              ``EndDate`` .
    ...
    def get_email_identity(self, EmailIdentity: str) -> ClientGetEmailIdentityResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/GetEmailIdentity>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **FeedbackForwardingStatus** *(boolean) --*
              ...
              or complaint events occur. Amazon Pinpoint sends this notification to the address that
              ...
              destination. You're required to have a method of tracking bounces and complaints. If
              you haven't set up another mechanism for receiving bounce or complaint notifications,
            ...
            - **MailFromAttributes** *(dict) --*
              ...
              - **BehaviorOnMxFailure** *(string) --*
                ...
                a custom MAIL FROM domain. When you set this value to ``UseDefaultValue`` , Amazon
                Pinpoint uses *amazonses.com* as the MAIL FROM domain. When you set this value to
                ``RejectMessage`` , Amazon Pinpoint returns a ``MailFromDomainNotVerified`` error,
    ...
    def list_configuration_sets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListConfigurationSets>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              additional configuration sets, issue another request to ``ListConfigurationSets`` ,
    ...
    def list_dedicated_ip_pools(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListDedicatedIpPools>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``ListDedicatedIpPools`` to indicate the position
          in the list of dedicated IP pools.

        :type PageSize: integer
        :param PageSize:

          The number of results to show in a single call to ``ListDedicatedIpPools`` . If the number
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              IP pools, issue another request to ``ListDedicatedIpPools`` , passing this token in
    ...
    def list_deliverability_test_reports(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListDeliverabilityTestReports>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``ListDeliverabilityTestReports`` to indicate the
          position in the list of predictive inbox placement tests.

        :type PageSize: integer
        :param PageSize:

          The number of results to show in a single call to ``ListDeliverabilityTestReports`` . If
            ...
            - **DeliverabilityTestReports** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DeliverabilityTestStatus** *(string) --*
                  ...
                  ``IN_PROGRESS`` , then the predictive inbox placement test is currently running.
                  Predictive inbox placement tests are usually complete within 24 hours of creating
                  the test. If the status is ``COMPLETE`` , then the test is finished, and you can
                  use the ``GetDeliverabilityTestReport`` to view the results of the test.

            - **NextToken** *(string) --*

              A token that indicates that there are additional predictive inbox placement tests to
              list. To view additional predictive inbox placement tests, issue another request to
    ...
    def list_domain_deliverability_campaigns(
        ...
        Deliverability dashboard (``PutDeliverabilityDashboardOption`` operation) for the domain.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListDomainDeliverabilityCampaigns>`_
        ...
        **Request Syntax**
        ...
        :param EndDate: **[REQUIRED]**
          ...
          The last day, in Unix time format, that you want to obtain deliverability data for. This
          value has to be less than or equal to 30 days after the value of the ``StartDate``
          parameter.
        ...
        :param PageSize:
          ...
          ``ListDomainDeliverabilityCampaigns`` operation. If the number of results is larger than
          the number that you specify in this parameter, the response includes a ``NextToken``
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DomainDeliverabilityCampaigns** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ReadRate** *(float) --*
                  ...
                  The percentage of email messages that were opened by recipients. Due to technical
                  limitations, this value only includes recipients who opened the message by using
            ...
            - **NextToken** *(string) --*
              ...
              ``ListDomainDeliverabilityCampaigns`` operation. This token indicates the position of
    ...
    def list_email_identities(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListEmailIdentities>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``ListEmailIdentities`` to indicate the position
          in the list of identities.

        :type PageSize: integer
        :param PageSize:

          The number of results to show in a single call to ``ListEmailIdentities`` . If the number
          of results is larger than the number you specified in this parameter, then the response
          includes a ``NextToken`` element, which you can use to obtain additional results.
            ...
            - **EmailIdentities** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SendingEnabled** *(boolean) --*
                  ...
                  own the identity, and that you authorize Amazon Pinpoint to send email from that
                  identity.

            - **NextToken** *(string) --*

              A token that indicates that there are additional configuration sets to list. To view
              additional configuration sets, issue another request to ``ListEmailIdentities`` , and
    ...
    def list_tags_for_resource(self, ResourceArn: str) -> ClientListTagsForResourceResponseTypeDef:
        ...
        A *tag* is a label that you optionally define and associate with a resource in Amazon
        Pinpoint. Each tag consists of a required *tag key* and an optional associated *tag value* .
        A tag key is a general label that acts as a category for more specific tag values. A tag
        value acts as a descriptor within a tag key.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/ListTagsForResource>`_
    ...
    def put_account_dedicated_ip_warmup_attributes(self, AutoWarmupEnabled: bool = None) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutAccountDedicatedIpWarmupAttributes>`_
        ...
        **Request Syntax**
        ...
        :param AutoWarmupEnabled:
          ...
          associated with your Amazon Pinpoint account in the current AWS Region. Set to ``true`` to
          enable the automatic warm-up feature, or set to ``false`` to disable it.
    ...
    def put_account_sending_attributes(self, SendingEnabled: bool = None) -> Dict:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutAccountSendingAttributes>`_
        ...
        **Request Syntax**
        ...
        :param SendingEnabled:
          ...
          Enables or disables your account's ability to send email. Set to ``true`` to enable email
          sending, or set to ``false`` to disable email sending.
    ...
    def put_configuration_set_delivery_options(
        self, ConfigurationSetName: str, TlsPolicy: str = None, SendingPoolName: str = None
    ) -> Dict:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutConfigurationSetDeliveryOptions>`_
    ...
    def put_configuration_set_reputation_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutConfigurationSetReputationOptions>`_
    ...
    def put_configuration_set_sending_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutConfigurationSetSendingOptions>`_
    ...
    def put_configuration_set_tracking_options(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutConfigurationSetTrackingOptions>`_
    ...
    def put_dedicated_ip_in_pool(self, Ip: str, DestinationPoolName: str) -> Dict:
        ...
        .. note::
          ...
          The dedicated IP address that you specify must already exist, and must be associated with
          your Amazon Pinpoint account.

          The dedicated IP pool you specify must already exist. You can create a new pool by using
          the ``CreateDedicatedIpPool`` operation.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutDedicatedIpInPool>`_
        ...
        **Request Syntax**
        ...
        :param Ip: **[REQUIRED]**
          ...
          The IP address that you want to move to the dedicated IP pool. The value you specify has
          to be a dedicated IP address that's associated with your Amazon Pinpoint account.
    ...
    def put_dedicated_ip_warmup_attributes(self, Ip: str, WarmupPercentage: int) -> Dict:
        """
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutDedicatedIpWarmupAttributes>`_
    ...
    def put_deliverability_dashboard_option(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutDeliverabilityDashboardOption>`_
        ...
        **Request Syntax**
        ...
        :param DashboardEnabled: **[REQUIRED]**
          ...
          To enable the dashboard, set this value to ``true`` .
        ...
        :param SubscribedDomains:
          ...
          - *(dict) --*
            ...
            An object that contains information about the Deliverability dashboard subscription for
            a verified domain that you use to send email and currently has an active Deliverability
    ...
    def put_email_identity_dkim_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutEmailIdentityDkimAttributes>`_
    ...
    def put_email_identity_feedback_attributes(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutEmailIdentityFeedbackAttributes>`_
    ...
    def put_email_identity_mail_from_attributes(
        self, EmailIdentity: str, MailFromDomain: str = None, BehaviorOnMxFailure: str = None
    ) -> Dict:
        """
        Used to enable or disable the custom Mail-From domain configuration for an email identity.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/PutEmailIdentityMailFromAttributes>`_
        ...
        **Request Syntax**
        ...
        :param BehaviorOnMxFailure:
          ...
          The action that you want Amazon Pinpoint to take if it can't read the required MX record
          when you send an email. When you set this value to ``UseDefaultValue`` , Amazon Pinpoint
    ...
    def send_email(
        ...
        * **Simple** – A standard email message. When you create this type of message, you specify
        the sender, the recipient, and the message body, and Amazon Pinpoint assembles the message
        for you.

        * **Raw** – A raw, MIME-formatted email message. When you send this type of email, you have
        to specify all of the message headers, as well as the message body. You can use this message
        type to send messages that contain attachments. The message that you specify has to be a
        valid MIME message.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/SendEmail>`_
        ...
        **Request Syntax**
        ...
        :param Destination: **[REQUIRED]**
          ...
          - **CcAddresses** *(list) --*
            ...
            An array that contains the email addresses of the "CC" (carbon copy) recipients for the
            email.
        ...
        :param Content: **[REQUIRED]**
          ...
          An object that contains the body of the message. You can send either a Simple message or a
          Raw message.
        ...
        :param EmailTags:
          ...
          the ``SendEmail`` operation. Tags correspond to characteristics of the email that you
          ...
          - *(dict) --*
            ...
            - **MessageId** *(string) --*
              ...
              .. note::
                ...
                check, or when you send a templated email that contains invalid personalization
                content, for example.
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/TagResource>`_
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          A list of the tags that you want to add to the resource. A tag consists of a required tag
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/UntagResource>`_
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the resource that you want to remove one or more tags
          from.
    ...
    def update_configuration_set_event_destination(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/pinpoint-email-2018-07-26/UpdateConfigurationSetEventDestination>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `get_dedicated_ips` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_dedicated_ip_pools` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_deliverability_test_reports` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_email_identities` operation.
        """
