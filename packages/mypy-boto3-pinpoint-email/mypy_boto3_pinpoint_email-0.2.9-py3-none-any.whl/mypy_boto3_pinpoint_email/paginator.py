"Main interface for pinpoint-email Paginators"
...
class GetDedicatedIpsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        :py:meth:`PinpointEmail.Client.get_dedicated_ips`.
...
class ListConfigurationSetsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`PinpointEmail.Client.list_configuration_sets`.
...
class ListDedicatedIpPoolsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`PinpointEmail.Client.list_dedicated_ip_pools`.
...
class ListDeliverabilityTestReportsPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`PinpointEmail.Client.list_deliverability_test_reports`.
...
class ListEmailIdentitiesPaginator(Boto3Paginator):
    ...
    def paginate(
        ...
        """
        Creates an iterator that will paginate through responses from
        :py:meth:`PinpointEmail.Client.list_email_identities`.
