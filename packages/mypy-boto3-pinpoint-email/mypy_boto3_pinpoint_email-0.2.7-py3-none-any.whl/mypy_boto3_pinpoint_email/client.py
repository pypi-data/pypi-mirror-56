...
class Client(BaseClient):
    ...
    def create_configuration_set(
        ...
        """
        Create a configuration set. *Configuration sets* are groups of rules that you can apply to the
        emails you send using Amazon Pinpoint. You apply a configuration set to an email by including a
        ...
        **Request Syntax**
        ...
        :param ReputationOptions:
          ...
          - **LastFreshStart** *(datetime) --*
            ...
            your account is given a fresh start, your reputation metrics are calculated starting from the
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            optionally define and associate with a resource in Amazon Pinpoint. Tags can help you categorize
            ...
            * You can associate tags with public or shared resources, but the tags are available only for
            ...
            - **Value** *(string) --* **[REQUIRED]**
              ...
              256 characters. The minimum length is 0 characters. If you don’t want a resource to have a
        ...
        :param EventDestination: **[REQUIRED]**
          ...
          - **KinesisFirehoseDestination** *(dict) --*
            ...
            - **DeliveryStreamArn** *(string) --* **[REQUIRED]**
              ...
              The Amazon Resource Name (ARN) of the Amazon Kinesis Data Firehose stream that Amazon Pinpoint
        ...
        :param Content: **[REQUIRED]**
          ...
          - **Template** *(dict) --*
            ...
            - **TemplateData** *(string) --*
              ...
              An object that defines the values to use for message variables in the template. This object is
              a set of key-value pairs. Each key defines a message variable in the template. The
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DeliverabilityTestStatus** *(string) --*
              ...
              predictive inbox placement test is currently running. Predictive inbox placement tests are
              usually complete within 24 hours of creating the test. If the status is ``COMPLETE`` , then
              the test is finished, and you can use the ``GetDeliverabilityTestReport`` to view the results
              of the test.
    ...
    def create_email_identity(
        ...
        When you verify an email address, Amazon Pinpoint sends an email to the address. Your email address
        is verified as soon as you follow the link in the verification email.

        When you verify a domain, this operation provides a set of DKIM tokens, which you can convert into
        CNAME tokens. You add these CNAME tokens to the DNS configuration for your domain. Your domain is
        verified when Amazon Pinpoint detects these records in the DNS configuration for your domain. It
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **VerifiedForSendingStatus** *(boolean) --*
              ...
              from verified email addresses or domains. For more information about verifying identities, see
            ...
            - **DkimAttributes** *(dict) --*
              ...
              includes the tokens that you use to create the CNAME records that are required to complete the
              ...
              - **Status** *(string) --*
                ...
                * ``PENDING`` – Amazon Pinpoint hasn't yet located the DKIM records in the DNS configuration
                ...
                * ``FAILED`` – Amazon Pinpoint was unable to locate the DKIM records in the DNS settings for
                ...
                * ``NOT_STARTED`` – Amazon Pinpoint hasn't yet started searching for the DKIM records in the
    ...
    def delete_configuration_set(self, ConfigurationSetName: str) -> Dict:
        ...
        In Amazon Pinpoint, *configuration sets* are groups of rules that you can apply to the emails you
        send. You apply a configuration set to an email by including a reference to the configuration set in
        the headers of the email. When you apply a configuration set to an email, all of the rules in that
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ProductionAccessEnabled** *(boolean) --*
              ...
              of emails you can send in a 24-hour period (your sending quota) is 200, and the maximum number
    ...
    def get_configuration_set(
        ...
        associated with, whether or not it's enabled for sending email, and more.
    ...
    def get_dedicated_ips(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``GetDedicatedIps`` to indicate the position of the
          dedicated IP pool in the list of IP pools.

        :type PageSize: integer
        :param PageSize:

          The number of results to show in a single call to ``GetDedicatedIpsRequest`` . If the number of
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              additional addresses, issue another request to ``GetDedicatedIps`` , passing this token in the
              ``NextToken`` parameter.
    ...
    def get_deliverability_dashboard_options(
        ...
        When you use the Deliverability dashboard, you pay a monthly subscription charge, in addition to any
        other fees that you accrue by using Amazon Pinpoint. For more information about the features and
        cost of a Deliverability dashboard subscription, see `Amazon Pinpoint Pricing
        <http://aws.amazon.com/pinpoint/pricing/>`__ .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DashboardEnabled** *(boolean) --*
              ...
              Specifies whether the Deliverability dashboard is enabled for your Amazon Pinpoint account. If
              this value is ``true`` , the dashboard is enabled.
            ...
            - **SubscriptionExpiryDate** *(datetime) --*
              ...
              calendar month. This value is null if you have an active subscription that isn’t due to expire
            ...
            - **ActiveSubscribedDomains** *(list) --*
              ...
              An array of objects, one for each verified domain that you use to send email and currently has
              an active Deliverability dashboard subscription that isn’t scheduled to expire at the end of
            ...
            - **PendingExpirationSubscribedDomains** *(list) --*
              ...
              An array of objects, one for each verified domain that you use to send email and currently has
              an active Deliverability dashboard subscription that's scheduled to expire at the end of the
    ...
    def get_domain_deliverability_campaign(
        ...
        **Request Syntax**
        ...
        :param CampaignId: **[REQUIRED]**
          ...
          identifier to a campaign. This value is not the same as the campaign identifier that Amazon
          Pinpoint assigns to campaigns that you create and manage by using the Amazon Pinpoint API or the
          ...
          - *(dict) --*
            ...
            - **DomainDeliverabilityCampaign** *(dict) --*
              ...
              - **FirstSeenDateTime** *(datetime) --*
                ...
                inbox. This value can help you determine how long it took for a campaign to deliver an email
                message.
    ...
    def get_domain_statistics_report(
        ...
        **Request Syntax**
        ...
        :param EndDate: **[REQUIRED]**
          ...
          ``EndDate`` that you specify has to be less than or equal to 30 days after the ``StartDate`` .
            ...
            - **OverallVolume** *(dict) --*
              ...
              - **DomainIspPlacements** *(list) --*
                ...
                - *(dict) --*
                  ...
                  An object that contains inbox placement data for email sent from one of your email domains
                  to a specific email provider.
    ...
    def list_configuration_sets(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          A token returned from a previous call to ``ListConfigurationSets`` to indicate the position in the
          list of configuration sets.

        :type PageSize: integer
        :param PageSize:

          The number of results to show in a single call to ``ListConfigurationSets`` . If the number of
          results is larger than the number you specified in this parameter, then the response includes a
          ``NextToken`` element, which you can use to obtain additional results.
    ...
    def list_dedicated_ip_pools(
        ...
        **Request Syntax**
        ...
        :param PageSize:
          ...
          The number of results to show in a single call to ``ListDedicatedIpPools`` . If the number of
          results is larger than the number you specified in this parameter, then the response includes a
          ``NextToken`` element, which you can use to obtain additional results.
    ...
    def list_deliverability_test_reports(
        ...
        **Request Syntax**
        ...
        :param PageSize:
          ...
          The number of results to show in a single call to ``ListDeliverabilityTestReports`` . If the
    ...
    def list_email_identities(
        ...
        **Request Syntax**
        ...
        :param PageSize:
          ...
          The number of results to show in a single call to ``ListEmailIdentities`` . If the number of
          results is larger than the number you specified in this parameter, then the response includes a
          ``NextToken`` element, which you can use to obtain additional results.
    ...
    def list_tags_for_resource(
        ...
        consists of a required *tag key* and an optional associated *tag value* . A tag key is a general
        label that acts as a category for more specific tag values. A tag value acts as a descriptor within
        a tag key.
    ...
    def put_account_dedicated_ip_warmup_attributes(
        ...
        **Request Syntax**
        ...
        :param AutoWarmupEnabled:
          ...
          with your Amazon Pinpoint account in the current AWS Region. Set to ``true`` to enable the
    ...
    def put_configuration_set_reputation_options(
        ...
        **Request Syntax**
        ...
        :param ConfigurationSetName: **[REQUIRED]**
          ...
          The name of the configuration set that you want to enable or disable reputation metric tracking
          for.
    ...
    def put_dedicated_ip_in_pool(self, Ip: str, DestinationPoolName: str) -> Dict:
        ...
        .. note::
          ...
          The dedicated IP address that you specify must already exist, and must be associated with your
        ...
        **Request Syntax**
        ...
        :param DestinationPoolName: **[REQUIRED]**
          ...
          The name of the IP pool that you want to add the dedicated IP address to. You have to specify an
          IP pool that already exists.
    ...
    def put_deliverability_dashboard_option(
        ...
        **Request Syntax**
        ...
        :param DashboardEnabled: **[REQUIRED]**
          ...
          Specifies whether to enable the Deliverability dashboard for your Amazon Pinpoint account. To
          ...
          - *(dict) --*
            ...
            - **InboxPlacementTrackingOption** *(dict) --*
              ...
              - **TrackedIsps** *(list) --*
                ...
                An array of strings, one for each major email provider that the inbox placement data applies
                to.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            A response that indicates whether the Deliverability dashboard is enabled for your Amazon
            Pinpoint account.
    ...
    def put_email_identity_dkim_attributes(
        ...
        **Request Syntax**
        ...
        :param SigningEnabled:
          ...
          When you set this value ``true`` , then the messages that Amazon Pinpoint sends from the identity
          are DKIM-signed. When you set this value to ``false`` , then the messages that Amazon Pinpoint
    ...
    def put_email_identity_feedback_attributes(
        ...
        **Request Syntax**
        ...
        :param EmailForwardingEnabled:
          ...
          When you set this value to ``false`` , Amazon Pinpoint sends notifications through other
          mechanisms, such as by notifying an Amazon SNS topic or another event destination. You're required
          to have a method of tracking bounces and complaints. If you haven't set up another mechanism for
          receiving bounce or complaint notifications, Amazon Pinpoint sends an email notification when
    ...
    def put_email_identity_mail_from_attributes(
        ...
        **Request Syntax**
        ...
        :param BehaviorOnMxFailure:
          ...
          send an email. When you set this value to ``UseDefaultValue`` , Amazon Pinpoint uses
          *amazonses.com* as the MAIL FROM domain. When you set this value to ``RejectMessage`` , Amazon
          Pinpoint returns a ``MailFromDomainNotVerified`` error, and doesn't attempt to deliver the email.
    ...
    def send_email(
        ...
        * **Simple** – A standard email message. When you create this type of message, you specify the
        sender, the recipient, and the message body, and Amazon Pinpoint assembles the message for you.

        * **Raw** – A raw, MIME-formatted email message. When you send this type of email, you have to
        specify all of the message headers, as well as the message body. You can use this message type to
        send messages that contain attachments. The message that you specify has to be a valid MIME message.
          ...
          - *(dict) --*
            ...
            - **MessageId** *(string) --*
              ...
              .. note::
                ...
                when the message you're trying to send has an attachment doesn't pass a virus check, or when
                you send a templated email that contains invalid personalization content, for example.
    ...
    def tag_resource(
        ...
        A tag key is a general label that acts as a category for more specific tag values. A tag value acts
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param TagKeys: **[REQUIRED]**
          ...
          To remove more than one tag from the resource, append the ``TagKeys`` parameter and argument for
          each additional tag to remove, separated by an ampersand. For example:
