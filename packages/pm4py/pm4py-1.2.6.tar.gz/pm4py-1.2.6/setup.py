...
setup(
    ...
    packages=['pm4py', 'pm4py.algo', 'pm4py.algo.discovery', 'pm4py.algo.discovery.dfg',
              ...
              'pm4py.util.lp.versions', 'pm4py.objects', 'pm4py.objects.dfg', 'pm4py.objects.dfg.utils',
              'pm4py.objects.dfg.filtering', 'pm4py.objects.log', 'pm4py.objects.log.util',
              ...
              'pm4py.statistics.passed_time.pandas.versions', 'pm4py.statistics.performance_spectrum',
              ...
              'pm4py.visualization.performance_spectrum', 'pm4py.visualization.performance_spectrum.versions', 'tests',
    ...
    install_requires=[
        ...
        'pulp',
        'pytz>=2019.3',
        "ortools; python_version < '3.8' and sys_platform != 'win32'",
        'sklearn',
        'intervaltree'
    ],
    project_urls={
