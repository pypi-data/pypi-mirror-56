...
class Client(BaseClient):
    ...
    def accept_portfolio_share(
        self, PortfolioId: str, AcceptLanguage: str = None, PortfolioShareType: str = None
    ) -> Dict[str, Any]:
        """
        ...
        **Request Syntax**
        ...
        :param PortfolioShareType:
          ...
          * ``AWS_ORGANIZATIONS`` - Accept portfolios shared by the master account of your
          organization.
                ...
                'FailedServiceActionAssociations': [
                    {
                        ...
                        'ProvisioningArtifactId': 'string',
                        'ErrorCode':
                        'DUPLICATE_RESOURCE'|'INTERNAL_FAILURE'|'LIMIT_EXCEEDED'
                        |'RESOURCE_NOT_FOUND'|'THROTTLING',
                        'ErrorMessage': 'string'
                    },
                ]
            }
    ...
    def create_portfolio_share(
        ...
        **Request Syntax**
        ...
        :param OrganizationNode:
          ...
          The organization node to whom you are going to share. If ``OrganizationNode`` is passed
          in, ``PortfolioShare`` will be created for the node and its children (when applies), and a
          ``PortfolioShareToken`` will be returned in the output in order for the administrator to
        ...
        **Request Syntax**
        ...
        :param ProvisioningArtifactParameters: **[REQUIRED]**
          ...
          - **Info** *(dict) --* **[REQUIRED]**
            ...
            The URL of the CloudFormation template in Amazon S3. Specify the URL in JSON format as
            follows:
    ...
    def create_provisioned_product_plan(
        ...
        **Request Syntax**
        ...
        :param ProvisionedProductName: **[REQUIRED]**
          ...
          A user-friendly name for the provisioned product. This value must be unique for the AWS
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **PortfolioShareToken** *(string) --*
              ...
              The portfolio share unique identifier. This will only be returned if delete is made to
    ...
    def delete_provisioning_artifact(
        ...
        You cannot delete a provisioning artifact associated with a product that was shared with
        you. You cannot delete the last provisioning artifact for a product, because a product must
            ...
            - **ProvisionedProductDetail** *(dict) --*
              ...
              - **Status** *(string) --*
                ...
                * ``TAINTED`` - Stable state, ready to perform any operation. The stack has
                ...
                example, a request to update to a new version failed and the stack rolled back to
                the current version.
                ...
                * ``PLAN_IN_PROGRESS`` - Transitive state. The plan operations were performed to
                ...
                the list of resources to be created, execute the plan. Wait for an ``AVAILABLE``
    ...
    def describe_provisioned_product_plan(
        ...
        **Request Syntax**
        ...
        :param PageToken:
          ...
          The page token for the next set of results. To retrieve the first set of results, use
          null.
          ...
          ::

            {
                'ProvisionedProductPlanDetails': {
                    ...
                    'ProvisioningArtifactId': 'string',
                    'Status':
                    'CREATE_IN_PROGRESS'|'CREATE_SUCCESS'|'CREATE_FAILED'
    ...
    def describe_provisioning_parameters(
        ...
        conflict for that key. The end user cannot take action to fix the conflict, and launch is
        not blocked. In subsequent calls to  ProvisionProduct , do not include conflicted TagOption
        keys as tags, or this causes the error "Parameter validation failed: Missing required
            ...
            - **ProvisioningArtifactParameters** *(list) --*
              ...
              - *(dict) --*
                ...
                - **IsNoEcho** *(boolean) --*
                  ...
                  the parameter is retrieved. This parameter is used to hide sensitive information.
    ...
    def describe_record(
        ...
        .. note::
          ...
          UpdateProvisionedProductProperties , the new owner will be able to describe all past
          records for that product. The previous owner will no longer be able to describe the
          records, but will be able to use  ListRecordHistory to see the product's history from when
          he was the owner.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **RecordOutputs** *(list) --*
              ...
              output for a CloudFormation-backed product that creates an S3 bucket would include the
              S3 bucket URL.
    ...
    def disable_aws_organizations_access(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        changes after calling this API. This API can only be called by the master account in the
        organization.
    ...
    def enable_aws_organizations_access(self, *args: Any, **kwargs: Any) -> Dict[str, Any]:
        ...
        current structure. This API can only be called by the master account in the organization.
    ...
    def list_accepted_portfolio_shares(
        ...
        **Request Syntax**
        ...
        :param PortfolioShareType:
          ...
          * ``AWS_ORGANIZATIONS`` - List portfolios shared by the master account of your
          organization
                ...
                'RecordDetails': [
                    {
                        ...
                        'ProvisionedProductName': 'string',
                        'Status':
                        'CREATED'|'IN_PROGRESS'|'IN_PROGRESS_IN_ERROR'|'SUCCEEDED'
                        |'FAILED',
                        'CreatedTime': datetime(2015, 1, 1),
                        'UpdatedTime': datetime(2015, 1, 1),
                        'ProvisionedProductType': 'string',
          ...
          - *(dict) --*
            ...
            - **StackInstances** *(list) --*
              ...
              - *(dict) --*
                ...
                stack set operation. A stack instance is a reference to an attempted or actual stack
                in a given account within a given region. A stack instance can exist without a
                stack—for example, if the stack couldn't be created for some reason. A stack
                instance is associated with only one stack set. Each stack instance contains the ID
                of its associated stack set, as well as the ID of the actual stack and the stack
                status.
                ...
                - **StackInstanceStatus** *(string) --*
                  ...
                  * ``INOPERABLE`` : A ``DeleteStackInstances`` operation has failed and left the
                  ...
                  ``DeleteStackInstances`` operation, with ``RetainStacks`` set to true, to delete
                  the stack instance, and then delete the stack manually.

                  * ``OUTDATED`` : The stack isn't currently up to date with the stack set because
                  either the associated stack failed during a ``CreateStackSet`` or
    ...
    def provision_product(
        ...
        product based on a CloudFormation template launches a CloudFormation stack and its
        ...
        **Request Syntax**
        ...
        :param ProvisioningPreferences:
          ...
          - **StackSetFailureTolerancePercentage** *(integer) --*
            ...
            AWS Service Catalog stops the operation in that region. If the operation is stopped in a
            region, AWS Service Catalog doesn't attempt the operation in any subsequent regions.
          ...
          - **StackSetMaxConcurrencyCount** *(integer) --*
            ...
            dependent on the value of ``StackSetFailureToleranceCount`` .
          ...
          - **StackSetMaxConcurrencyPercentage** *(integer) --*
            ...
            When calculating the number of accounts based on the specified percentage, AWS Service
            Catalog rounds down to the next whole number. This is true except in cases where
            rounding down would result is zero. In this case, AWS Service Catalog sets the number as
            ``1`` instead.
    ...
    def reject_portfolio_share(
        ...
        **Request Syntax**
        ...
        :param PortfolioShareType:
          ...
          * ``AWS_ORGANIZATIONS`` - Reject portfolios shared by the master account of your
          organization.
    ...
    def search_provisioned_products(
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          ``id`` , ``lastRecordId`` , ``idempotencyToken`` , ``name`` , ``physicalId`` ,
    ...
    def update_provisioned_product(
        ...
        **Request Syntax**
        ...
        :param PathId:
          ...
          The new path identifier. This value is optional if the product has a default path, and
        ...
        :param ProvisioningPreferences:
          ...
          - **StackSetOperationType** *(string) --*
            ...
            Creates a new stack instance in the stack set represented by the provisioned product. In
            this case, only new stack instances are created based on accounts and regions; if new
            ProductId or ProvisioningArtifactID are passed, they will be ignored.

              UPDATE

            Updates the stack set represented by the provisioned product and also its stack
            instances.
    ...
    def update_provisioned_product_properties(
        ...
        **Request Syntax**
        ...
        :param ProvisionedProductProperties: **[REQUIRED]**
          ...
          The ``OWNER`` key only accepts user ARNs. The owner is the user that is allowed to see,
          update, terminate, and execute service actions in the provisioned product.

          The administrator can change the owner of a provisioned product to another IAM user within
          the same account. Both end user owners and administrators can see ownership history of the
          provisioned product using the ``ListRecordHistory`` API. The new owner can describe all
          past records for the provisioned product using the ``DescribeRecord`` API. The previous
          owner can no longer use ``DescribeRecord`` , but can still see the product's history from
