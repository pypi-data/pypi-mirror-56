...
class startclass:
    ...
    # ----
        ...
        self.setupInfoLabel = tk.Label(self.frame, text="Click the buttons to install with these values:", fg="OrangeRed4", bg="salmon1",
                            font="Verdana 13",
                            justify="center", borderwidth=2, relief="groove")
        self.setupInfoLabel.grid(column=1, row=30, sticky=tk.E)
# start setup buttons:
        # run button setup database tables via function call makedb:
        self.dbBtn = tk.Button(master=self.frame, text="1. Make db-tables", width=15, bg="gold", activebackground="yellow",
...
# defs of Tests/ pytest scripts
    ...
    def runsetup_org(self):
        self.testempty()
        print("runsetup(self) wurde getriggert - soll nun: pytest Runsetups/ & pytest Tests/  -- bisher: pytest.main() - hat wieso auch immer funktioniert ...")
        pytest.main()
