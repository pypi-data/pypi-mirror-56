...
setup(
    ...
    entry_points={'console_scripts':[
        'setuptest=stpkg.ccssetuptest:starterclass.startclass',
        'setuptest.py=stpkg.ccssetuptest:main',
        'setuptestv2.py=stpkg.ccssetuptest:starterclass',
        'setuptestmain=stpkg.__main__:main',]},
)
