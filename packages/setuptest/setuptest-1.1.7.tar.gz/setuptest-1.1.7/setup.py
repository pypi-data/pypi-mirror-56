...
setup(
    ...
    description='The Selenium based setuptest for the CYBR CSCW-SUITE (CCS) - check the README.md to follow the steps for making it run from your PyCharm IDE',
    ...
    entry_points={'console_scripts':[
        'setuptest=stpkg.setuptest:starterclass.startclass',]},
)
