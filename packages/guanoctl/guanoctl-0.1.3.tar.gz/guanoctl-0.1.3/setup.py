""" Setup script for the guanoctl application.
...
_config = {
    "name": "guanoctl",
    "long_description": "A command-line tool for guano-py (https://github.com/riggsd/guano-py).",
    "url": "",
    "author": "Danny Squire",
    "author_email": "danny@el-fuego.net",
    "package_dir": {"": "src"},
    "packages": find_packages("src"),
    "entry_points": {
        "console_scripts": ("guanoctl = guanoctl.cli:main",),
    },
    "data_files": ("etc/",),
}
