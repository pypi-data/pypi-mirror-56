...
from .forms import UserForm, UserProfileParentsForm, UserAvatarForm, UserSearchForm, profile_inline_formset, \
    ...
    UserLevelUpRecordUpdateForm, UserLevelUpRecordSearchForm, CustomUserLevelUpRecordApplyForm
...
class ClassList(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['search_form'] = UserClassSearchForm(
            {"status": status, "class_name": class_name, "assistant_name": assistant_name, "lecturer_name": lecturer_name, "agent_name": agent_name})
        return context
