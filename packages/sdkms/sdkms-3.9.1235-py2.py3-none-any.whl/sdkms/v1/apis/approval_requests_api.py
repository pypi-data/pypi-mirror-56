...
class ApprovalRequestsApi(object):
    ...
    def approve(self, request_id, async_call=False, **kwargs):
        """
        ...
        if async_call:
            return self.approve_with_http_info(request_id, async_call=async_call, **kwargs)
        else:
            (data) = self.approve_with_http_info(request_id, async_call=async_call, **kwargs)
            return data

    def approve_with_http_info(self, request_id, async_call=False, **kwargs):
        """
