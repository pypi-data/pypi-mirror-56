...
class AuthConfigPassword(object):
    """
    ...
    def __init__(self, require_2fa=None, administrators_only=None):
        """
        AuthConfigPassword - a model defined in Swagger
        """

        self._require_2fa = None
    ...
    def require_2fa(self):
        """
        Gets the require_2fa of this AuthConfigPassword.
    ...
    def require_2fa(self, require_2fa):
        """
        Sets the require_2fa of this AuthConfigPassword.
        Reserved for future use, must be false.
        """
    ...
    def administrators_only(self):
        """
        Gets the administrators_only of this AuthConfigPassword.
        Reserved for future use, must be false.
    ...
    def administrators_only(self, administrators_only):
        """
        Sets the administrators_only of this AuthConfigPassword.
        Reserved for future use, must be false.
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, AuthConfigPassword):
            return False
