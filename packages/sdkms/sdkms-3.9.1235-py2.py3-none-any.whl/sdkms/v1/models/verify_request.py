...
class VerifyRequest(object):
    ...
    def __init__(self, hash_alg=None, hash=None, data=None, signature=None, mode=None):
        """
    ...
    def hash_alg(self):
        """
        Gets the hash_alg of this VerifyRequest.
    ...
    def hash_alg(self, hash_alg):
        """
        Sets the hash_alg of this VerifyRequest.
        """
    ...
    def hash(self):
        """
        Gets the hash of this VerifyRequest.
    ...
    def hash(self, hash):
        """
        Sets the hash of this VerifyRequest.
        The hash of the data on which the signature is being verified. Exactly one of `hash` and `data` is required. 
        """
    ...
    def data(self):
        """
        Gets the data of this VerifyRequest.
    ...
    def data(self, data):
        """
        Sets the data of this VerifyRequest.
        The data on which the signature is being verified. Exactly one of `hash` and `data` is required. To reduce request size and avoid reaching the request size limit, prefer `hash`. 
        """
    ...
    def mode(self):
        """
        Gets the mode of this VerifyRequest.
    ...
    def mode(self, mode):
        """
        Sets the mode of this VerifyRequest.
        """
