...
class VerifyRequestEx(object):
    ...
    def __init__(self, key=None, hash_alg=None, hash=None, data=None, signature=None, mode=None):
        """
        VerifyRequestEx - a model defined in Swagger
        """
    ...
    def key(self):
        """
        Gets the key of this VerifyRequestEx.
    ...
    def key(self, key):
        """
        Sets the key of this VerifyRequestEx.
        """
    ...
    def hash_alg(self):
        """
        Gets the hash_alg of this VerifyRequestEx.
    ...
    def hash_alg(self, hash_alg):
        """
        Sets the hash_alg of this VerifyRequestEx.
        """
    ...
    def hash(self):
        """
        Gets the hash of this VerifyRequestEx.
    ...
    def hash(self, hash):
        """
        Sets the hash of this VerifyRequestEx.
        The hash of the data on which the signature is being verified. Exactly one of `hash` and `data` is required. 
        """
    ...
    def data(self):
        """
        Gets the data of this VerifyRequestEx.
    ...
    def data(self, data):
        """
        Sets the data of this VerifyRequestEx.
        The data on which the signature is being verified. Exactly one of `hash` and `data` is required. To reduce request size and avoid reaching the request size limit, prefer `hash`. 
        """
    ...
    def signature(self):
        """
        Gets the signature of this VerifyRequestEx.
    ...
    def signature(self, signature):
        """
        Sets the signature of this VerifyRequestEx.
        A signature created with the private key corresponding to this public key.
        """

        if not isinstance(signature, bytearray):
            raise ValueError("Invalid value for `signature`, `signature` must be a bytearray")
        self._signature = signature

    @property
    def mode(self):
        """
        Gets the mode of this VerifyRequestEx.
    ...
    def mode(self, mode):
        """
        Sets the mode of this VerifyRequestEx.
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, VerifyRequestEx):
            return False
