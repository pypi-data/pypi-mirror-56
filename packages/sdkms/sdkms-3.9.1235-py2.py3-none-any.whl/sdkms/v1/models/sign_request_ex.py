...
class SignRequestEx(object):
    ...
    def __init__(self, key=None, hash_alg=None, hash=None, data=None, mode=None):
        """
        SignRequestEx - a model defined in Swagger
        """
    ...
    def key(self):
        """
        Gets the key of this SignRequestEx.
    ...
    def key(self, key):
        """
        Sets the key of this SignRequestEx.
        """
    ...
    def hash_alg(self):
        """
        Gets the hash_alg of this SignRequestEx.
    ...
    def hash_alg(self, hash_alg):
        """
        Sets the hash_alg of this SignRequestEx.
        """
    ...
    def hash(self):
        """
        Gets the hash of this SignRequestEx.
    ...
    def hash(self, hash):
        """
        Sets the hash of this SignRequestEx.
        Hash of the data to be signed. Exactly one of `hash` and `data` is required. 
        """
    ...
    def data(self):
        """
        Gets the data of this SignRequestEx.
    ...
    def data(self, data):
        """
        Sets the data of this SignRequestEx.
        Data to be signed. Exactly one of `hash` and `data` is required. To reduce request size and avoid reaching the request size limit, prefer `hash`. 
        """
    ...
    def mode(self):
        """
        Gets the mode of this SignRequestEx.
    ...
    def mode(self, mode):
        """
        Sets the mode of this SignRequestEx.
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, SignRequestEx):
            return False
