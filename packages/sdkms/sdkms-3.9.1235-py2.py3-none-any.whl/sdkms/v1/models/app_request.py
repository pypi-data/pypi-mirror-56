...
class AppRequest(object):
    ...
    def __init__(self, name=None, description=None, add_groups=None, del_groups=None, default_group=None, enabled=None, app_type=None, credential=None, secret_size=None):
        """
