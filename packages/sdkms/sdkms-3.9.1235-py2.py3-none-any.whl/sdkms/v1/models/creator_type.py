...
class CreatorType(object):
    ...
    def __init__(self, app=None, user=None):
        """
        CreatorType - a model defined in Swagger
        """
    ...
    def app(self):
        """
        Gets the app of this CreatorType.
    ...
    def app(self, app):
        """
        Sets the app of this CreatorType.
        The application ID of the application that created this entity, if this entity was created by an application.
        """
    ...
    def user(self):
        """
        Gets the user of this CreatorType.
    ...
    def user(self, user):
        """
        Sets the user of this CreatorType.
        The user ID of the user who created this entity, if this entity was created by a user.
        """
