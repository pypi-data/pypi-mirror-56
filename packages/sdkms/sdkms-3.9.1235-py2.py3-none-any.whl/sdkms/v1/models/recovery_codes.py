...
class RecoveryCodes(object):
    ...
    def __init__(self, recovery_codes=None):
        """
        RecoveryCodes - a model defined in Swagger
        """
    ...
    def recovery_codes(self):
        """
        Gets the recovery_codes of this RecoveryCodes.
    ...
    def recovery_codes(self, recovery_codes):
        """
        Sets the recovery_codes of this RecoveryCodes.
        """
    ...
    def __eq__(self, other):
        ...
        """
        if not isinstance(other, RecoveryCodes):
            return False
