...
from sdkms/v1.apis.approval_requests_api import ApprovalRequestsApi


class TestApprovalRequestsApi(unittest.TestCase):
    """ ApprovalRequestsApi unit test stubs """

    def setUp(self):
        self.api = sdkms/v1.apis.approval_requests_api.ApprovalRequestsApi()
