...
class Client(BaseClient):
                ...
                'jobs': [
                    {
                        ...
                        'name': 'string',
                        'status':
                        'Pending'|'Preparing'|'Running'|'Restarting'|'Completed'
                        |'Failed'|'RunningFailed'|'Terminating'|'Terminated'
                        |'Canceled',
                        'lastStartedAt': datetime(2015, 1, 1),
                        'lastUpdatedAt': datetime(2015, 1, 1),
                        'failureBehavior': 'Fail'|'Continue',
                        'failureCode':
                        'InternalServiceError'|'RobotApplicationCrash'
                        |'SimulationApplicationCrash'
                        |'BadPermissionsRobotApplication'
                        |'BadPermissionsSimulationApplication'
                        |'BadPermissionsS3Object'|'BadPermissionsS3Output'
                        |'BadPermissionsCloudwatchLogs'|'SubnetIpLimitExceeded'
                        |'ENILimitExceeded'|'BadPermissionsUserCredentials'
                        |'InvalidBundleRobotApplication'
                        |'InvalidBundleSimulationApplication'|'InvalidS3Resource'
                        |'MismatchedEtag'|'RobotApplicationVersionMismatchedEtag'
                        |'SimulationApplicationVersionMismatchedEtag'
                        |'ResourceNotFound'|'InvalidInput'|'WrongRegionS3Bucket'
                        |'WrongRegionS3Output'|'WrongRegionRobotApplication'
    ...
    def create_deployment_job(
        ...
        The robot application must have a numbered ``applicationVersion`` for consistency reasons.
        To create a new version, use ``CreateRobotApplicationVersion`` or see `Creating a Robot
        Application Version
        <https://docs.aws.amazon.com/robomaker/latest/dg/create-robot-application-version.html>`__ .
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                |'PreLaunchFileFailure'|'PostLaunchFileFailure'|'BadPermissionError'
                |'DownloadConditionFailed'|'InternalServerError',
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **failureCode** *(string) --*
              ...
              AWS Greengrass requires a service-level role permission to access other services. The
              role must include the ` ``AWSGreengrassResourceAccessRolePolicy`` managed policy
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def create_robot(
        self, name: str, architecture: str, greengrassGroupId: str, tags: Dict[str, str] = None
    ) -> ClientCreateRobotResponseTypeDef:
        """
        Creates a robot.
    ...
    def create_simulation_job(
        ...
        **Request Syntax**
        ...
        :param vpcConfig:
          ...
          the list of security group IDs and subnet IDs. These must belong to the same VPC. You must
          ...
          **Response Syntax**
          ...
          ::

            {
                'arn': 'string',
                'status':
                'Pending'|'Preparing'|'Running'|'Restarting'|'Completed'|'Failed'
                ...
                |'BadPermissionsS3Object'|'BadPermissionsS3Output'
                |'BadPermissionsCloudwatchLogs'|'SubnetIpLimitExceeded'|'ENILimitExceeded'
                |'BadPermissionsUserCredentials'|'InvalidBundleRobotApplication'
                |'InvalidBundleSimulationApplication'|'InvalidS3Resource'|'MismatchedEtag'
                |'RobotApplicationVersionMismatchedEtag'
                |'SimulationApplicationVersionMismatchedEtag'|'ResourceNotFound'
                |'InvalidInput'|'WrongRegionS3Bucket'|'WrongRegionS3Output'
                |'WrongRegionRobotApplication'|'WrongRegionSimulationApplication',
                'clientRequestToken': 'string',
                'outputLocation': {
                    's3Bucket': 'string',
                    's3Prefix': 'string'
                ...
                'robotDeploymentSummary': [
                    {
                        ...
                        'status':
                        'Available'|'Registered'|'PendingNewDeployment'|'Deploying'
                        |'Failed'|'InSync'|'NoResponse',
                        'progressDetail': {
                            'currentProgress':
                            'Validating'|'DownloadingExtracting'
                            |'ExecutingDownloadCondition'|'ExecutingPreLaunch'
                            |'Launching'|'ExecutingPostLaunch'|'Finished',
                            'percentDone': ...,
              ...
              - *(dict) --*
                ...
                - **progressDetail** *(dict) --*
                  ...
                  - **estimatedTimeRemainingSeconds** *(integer) --*
                    ...
                    applies to the ``Downloading/Extracting`` step of the deployment. It is empty
                    for other steps.
          ...
          **Response Syntax**
          ...
          ::

            {
                ...
                'fleetArn': 'string',
                'status':
                'Available'|'Registered'|'PendingNewDeployment'|'Deploying'|'Failed'
                |'InSync'|'NoResponse',
                'greengrassGroupId': 'string',
                'createdAt': datetime(2015, 1, 1),
                'architecture': 'X86_64'|'ARM64'|'ARMHF',
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **failureReason** *(string) --*
              ...
              <https://docs.aws.amazon.com/robomaker/latest/dg/troubleshooting.html>`__ .
    ...
    def list_deployment_jobs(
        ...
        **Request Syntax**
        ...
        :param filters:
          ...
          the complete value of the filtered item. You can use up to three filters, but they must be
        ...
        :param nextToken:
          ...
          The ``nextToken`` value returned from a previous paginated ``ListDeploymentJobs`` request
        ...
        :param maxResults:
          ...
          The maximum number of deployment job results returned by ``ListDeploymentJobs`` in
          paginated output. When this parameter is used, ``ListDeploymentJobs`` only returns
          ``maxResults`` results in a single page along with a ``nextToken`` response element. The
          remaining results of the initial request can be seen by sending another
          ``ListDeploymentJobs`` request with the returned ``nextToken`` value. This value can be
          between 1 and 100. If this parameter is not used, then ``ListDeploymentJobs`` returns up
                ...
                'deploymentJobs': [
                    {
                        ...
                        'fleet': 'string',
                        'status':
                        'Pending'|'Preparing'|'InProgress'|'Failed'|'Succeeded'
                        |'Canceled',
                        'deploymentApplicationConfigs': [
                            {
                                'application': 'string',
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              the results of a ``ListDeploymentJobs`` request exceed ``maxResults`` , this value can
              be used to retrieve the next page of results. This value is ``null`` when there are no
    ...
    def list_fleets(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          output. When this parameter is used, ``ListFleets`` only returns ``maxResults`` results in
          ...
          then ``ListFleets`` returns up to 100 results and a ``nextToken`` value if applicable.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              The ``nextToken`` value to include in a future ``ListDeploymentJobs`` request. When
              the results of a ``ListFleets`` request exceed ``maxResults`` , this value can be used
    ...
    def list_robot_applications(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          The maximum number of deployment job results returned by ``ListRobotApplications`` in
          paginated output. When this parameter is used, ``ListRobotApplications`` only returns
          ``maxResults`` results in a single page along with a ``nextToken`` response element. The
          remaining results of the initial request can be seen by sending another
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              the results of a ``ListRobotApplications`` request exceed ``maxResults`` , this value
    ...
    def list_robots(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          output. When this parameter is used, ``ListRobots`` only returns ``maxResults`` results in
          a single page along with a ``nextToken`` response element. The remaining results of the
          initial request can be seen by sending another ``ListRobots`` request with the returned
          ``nextToken`` value. This value can be between 1 and 100. If this parameter is not used,
          then ``ListRobots`` returns up to 100 results and a ``nextToken`` value if applicable.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **nextToken** *(string) --*
              ...
              The ``nextToken`` value to include in a future ``ListRobots`` request. When the
    ...
    def list_simulation_jobs(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          The maximum number of deployment job results returned by ``ListSimulationJobs`` in
          paginated output. When this parameter is used, ``ListSimulationJobs`` only returns
          ``maxResults`` results in a single page along with a ``nextToken`` response element. The
          remaining results of the initial request can be seen by sending another
          ``ListSimulationJobs`` request with the returned ``nextToken`` value. This value can be
          between 1 and 100. If this parameter is not used, then ``ListSimulationJobs`` returns up
          to 100 results and a ``nextToken`` value if applicable.
        ...
        :param filters:
          ...
          are supported. When filtering, you must use the complete value of the filtered item. You
          can use up to three filters, but they must be for the same named item. For example, if you
