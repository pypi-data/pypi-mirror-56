...
class Client(BaseClient):
    ...
    def create_deployment_job(
        ...
        The robot application must have a numbered ``applicationVersion`` for consistency reasons. To create
        a new version, use ``CreateRobotApplicationVersion`` or see `Creating a Robot Application Version
    ...
    def list_deployment_jobs(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          output. When this parameter is used, ``ListDeploymentJobs`` only returns ``maxResults`` results in
          a single page along with a ``nextToken`` response element. The remaining results of the initial
          request can be seen by sending another ``ListDeploymentJobs`` request with the returned
    ...
    def list_fleets(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          between 1 and 100. If this parameter is not used, then ``ListFleets`` returns up to 100 results
    ...
    def list_robot_applications(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          The ``nextToken`` value returned from a previous paginated ``ListRobotApplications`` request where
          ``maxResults`` was used and the results exceeded the value of that parameter. Pagination continues
          from the end of the previous results that returned the ``nextToken`` value.
        ...
        :param maxResults:
          ...
          output. When this parameter is used, ``ListRobotApplications`` only returns ``maxResults`` results
    ...
    def list_robots(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          between 1 and 100. If this parameter is not used, then ``ListRobots`` returns up to 100 results
          and a ``nextToken`` value if applicable.
    ...
    def list_simulation_jobs(
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          output. When this parameter is used, ``ListSimulationJobs`` only returns ``maxResults`` results in
          a single page along with a ``nextToken`` response element. The remaining results of the initial
        ...
        :param filters:
          ...
          supported. When filtering, you must use the complete value of the filtered item. You can use up to
          three filters, but they must be for the same named item. For example, if you are looking for items
          with the status ``Preparing`` or the status ``Running`` .
