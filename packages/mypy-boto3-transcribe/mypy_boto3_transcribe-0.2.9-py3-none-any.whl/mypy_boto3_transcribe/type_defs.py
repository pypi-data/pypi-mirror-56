...
class ClientGetTranscriptionJobResponseTranscriptionJobSettingsTypeDef(
    ...
    Optional settings for the transcription job. Use these settings to turn on speaker recognition,
    to set the maximum number of speakers that should be identified and to specify a custom
...
class ClientGetTranscriptionJobResponseTranscriptionJobTranscriptTypeDef(
    ...
    - **TranscriptFileUri** *(string) --*
      ...
      chose to store the transcription in Amazon Transcribe, this is a shareable URL that provides
...
class ClientGetTranscriptionJobResponseTranscriptionJobTypeDef(
    ...
    - **FailureReason** *(string) --*
      ...
      * ``The media format provided does not match the detected media format`` - The media format of
      the audio file doesn't match the format specified in the ``MediaFormat`` field in the request.
      Check the media format of your media file and make sure that the two values match.
      ...
      * ``Invalid number of channels: number of channels too large`` - Your audio contains more
      channels than Amazon Transcribe is configured to process. To request additional channels, see
    ...
    - **Settings** *(dict) --*
      ...
      recognition, to set the maximum number of speakers that should be identified and to specify a
      custom vocabulary to use when processing the transcription job.
      ...
      - **ShowSpeakerLabels** *(boolean) --*
        ...
        You can't set both ``ShowSpeakerLabels`` and ``ChannelIdentification`` in the same request.
      ...
      - **MaxSpeakerLabels** *(integer) --*
        ...
        The maximum number of speakers to identify in the input audio. If there are more speakers in
        the audio than this number, multiple speakers will be identified as a single speaker. If you
        specify the ``MaxSpeakerLabels`` field, you must set the ``ShowSpeakerLabels`` field to
        true.
...
class ClientListTranscriptionJobsResponseTranscriptionJobSummariesTypeDef(
    ...
    - **OutputLocationType** *(string) --*
      ...
      retrieved using the URI in the ``GetTranscriptionJob`` response's ``TranscriptFileUri`` field.
    """
...
class ClientListVocabulariesResponseVocabulariesTypeDef(
    ...
    - **VocabularyState** *(string) --*
      ...
      The processing state of the vocabulary. If the state is ``READY`` you can use the vocabulary
      in a ``StartTranscriptionJob`` request.
    """
