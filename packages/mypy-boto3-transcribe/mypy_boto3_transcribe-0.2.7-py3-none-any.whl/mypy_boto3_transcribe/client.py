"Main interface for transcribe Client"
...
class Client(BaseClient):
    ...
    def create_vocabulary(
        ...
        **Request Syntax**
        ::
          ...
          response = client.create_vocabulary(
              ...
              LanguageCode=
                  ...
                  |'en-IN'|'hi-IN'|'ar-SA'|'ru-RU'|'zh-CN'|'nl-NL'|'id-ID'|'ta-IN'|'fa-IR'|'en-IE'|'en-AB'
                  |'en-WL'|'pt-PT'|'te-IN'|'tr-TR'|'de-CH'|'he-IL'|'ms-MY'|'ja-JP'|'ar-AE',
              Phrases=[
                  'string',
              ],
        ...
        :param VocabularyFileUri:
          ...
          The S3 location of the text file that contains the definition of the custom vocabulary. The URI
          must be in the same region as the API endpoint that you are calling. The general form is
          ...
          <http://docs.aws.amazon.com/AmazonS3/latest/dev/UsingMetadata.html#object-keys>`__ in the *Amazon
          S3 Developer Guide* .
    ...
    def get_transcription_job(
        ...
        find the results at the location specified in the ``TranscriptionFileUri`` field.
            ...
            - **TranscriptionJob** *(dict) --*
              ...
              - **FailureReason** *(string) --*
                ...
                * ``The sample rate provided does not match the detected sample rate`` - The sample rate in
                the audio file doesn't match the sample rate specified in the ``MediaSampleRateHertz`` field
                in the request. Check the sample rate of your media file and make sure that the two values
                match.
    ...
    def list_transcription_jobs(
        ...
        **Request Syntax**
        ...
        :param Status:
          ...
          When specified, returns only transcription jobs with the specified status. Jobs are ordered by
          creation date, with the newest jobs returned first. If you don’t specify a status, Amazon
          Transcribe returns all transcription jobs ordered by creation date.
            ...
            - **TranscriptionJobSummaries** *(list) --*
              ...
              - *(dict) --*
                ...
                - **OutputLocationType** *(string) --*
                  ...
                  be retrieved using the URI in the ``GetTranscriptionJob`` response's ``TranscriptFileUri``
                  field.
    ...
    def list_vocabularies(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of vocabularies to return in the response. If there are fewer results in the
        ...
        :param NameContains:
          ...
          contains the specified string. The search is case-insensitive, ``ListVocabularies`` will return
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              request to the ``ListVocabularies`` operation to return in the next page of jobs.
    ...
    def start_transcription_job(
        ...
        **Request Syntax**
        ...
        :param TranscriptionJobName: **[REQUIRED]**
          ...
          The name of the job. Note that you can't use the strings "." or ".." by themselves as the job
          name. The name must also be unique within an AWS account.
        ...
        :param MediaSampleRateHertz:
          ...
          specify the sample rate, it must match the sample rate detected by Amazon Transcribe. In most
        ...
        :param OutputBucketName:
          ...
          Amazon Transcribe uses the default Amazon S3 key for server-side encryption of transcripts that
        ...
        :param OutputEncryptionKMSKeyId:
          ...
          output of the transcription job. The user calling the ``StartTranscriptionJob`` operation must
          ...
          * KMS Key Alias: "alias/ExampleAlias"
          ...
          You can use either of the following to identify a KMS key in the current account or another
          account:
        ...
        :param Settings:
          ...
          - **ShowSpeakerLabels** *(boolean) --*
            ...
            in the input audio. Speaker recognition labels individual speakers in the audio file. If you set
            the ``ShowSpeakerLabels`` field to true, you must also set the maximum number of speaker labels
          ...
          - **MaxSpeakerLabels** *(integer) --*
            ...
            audio than this number, multiple speakers will be identified as a single speaker. If you specify
            the ``MaxSpeakerLabels`` field, you must set the ``ShowSpeakerLabels`` field to true.
    ...
    def update_vocabulary(
        ...
        """
        Updates an existing vocabulary with new values. The ``UpdateVocabulary`` operation overwrites all of
