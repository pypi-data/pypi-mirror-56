...
class Client(BaseClient):
          ...
          ::

            {
                'TranscriptionJob': {
                    ...
                    'LanguageCode':
                    'en-US'|'es-US'|'en-AU'|'fr-CA'|'en-GB'|'de-DE'|'pt-BR'|'fr-FR'|'it-IT'|'ko-KR'|'es-ES'
                    |'en-IN'|'hi-IN'|'ar-SA'|'ru-RU'|'zh-CN'|'nl-NL'|'id-ID'|'ta-IN'|'fa-IR'|'en-IE'
                    |'en-AB'|'en-WL'|'pt-PT'|'te-IN'|'tr-TR'|'de-CH'|'he-IL'|'ms-MY'|'ja-JP'|'ar-AE',
    ...
    def list_transcription_jobs(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of jobs to return in the response. If there are fewer results in the list,
    ...
    def start_transcription_job(
        ...
        **Request Syntax**
        ...
        :param OutputBucketName:
          ...
          in the ``TranscriptFileUri`` field. The S3 bucket must have permissions that allow Amazon
          Transcribe to put files in the bucket. For more information, see `Permissions Required for IAM
          User Roles
    ...
    def update_vocabulary(
        ...
        """
        Updates an existing vocabulary with new values. The ``UpdateVocabulary`` operation overwrites all
        of the existing information with the values that you provide in the request.
