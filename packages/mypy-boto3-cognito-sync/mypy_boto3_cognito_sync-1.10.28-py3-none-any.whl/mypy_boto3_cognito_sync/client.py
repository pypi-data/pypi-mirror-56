"Main interface for cognito-sync Client"
...
class Client(BaseClient):
    ...
    def bulk_publish(self, IdentityPoolId: str) -> ClientBulkPublishResponseTypeDef:
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/BulkPublish>`_
    ...
    def delete_dataset(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/DeleteDataset>`_
        ...
        **Request Syntax**
        ...
        :param DatasetName: **[REQUIRED]** A string of up to 128 characters. Allowed characters are
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Response to a successful DeleteDataset request.
            ...
            can have multiple datasets. A dataset is per identity and can be general or associated
            with a particular entity in an application (like a saved game). Datasets are
            automatically created if they don't exist. Data is synced by dataset, and a dataset can
            hold up to 1MB of key-value pairs.
              ...
              - **DatasetName** *(string) --* A string of up to 128 characters. Allowed characters
              ...
              - **LastModifiedBy** *(string) --* The device that made the last change to this
              dataset.
    ...
    def describe_dataset(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/DescribeDataset>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Response to a successful DescribeDataset request.
            ...
            identity can have multiple datasets. A dataset can be general or associated with a
            particular entity in an application (like a saved game). Datasets are automatically
            created if they don't exist. Data is synced by dataset, and a dataset can hold up to 1MB
            of key-value pairs.
    ...
    def describe_identity_pool_usage(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/DescribeIdentityPoolUsage>`_
          ...
          **Response Structure**
          ...
          - *(dict) --* Response to a successful DescribeIdentityPoolUsage request.
            ...
            - **IdentityPoolUsage** *(dict) --* Information about the usage of the identity pool.
              ...
              - **LastModifiedDate** *(datetime) --* Date on which the identity pool was last
              modified.
    ...
    def describe_identity_usage(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/DescribeIdentityUsage>`_
    ...
    def get_bulk_publish_details(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/GetBulkPublishDetails>`_
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* The output for the GetBulkPublishDetails operation.
            ...
            - **BulkPublishStartTime** *(datetime) --* The date/time at which the last bulk publish
            was initiated.

            - **BulkPublishCompleteTime** *(datetime) --* If BulkPublishStatus is SUCCEEDED, the
            time the last bulk publish operation completed.

            - **BulkPublishStatus** *(string) --* Status of the last bulk publish operation, valid
            values are:
              ...
              FAILED - Some portion of the data has failed to publish, check FailureMessage for the
              cause.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_cognito_events(self, IdentityPoolId: str) -> ClientGetCognitoEventsResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/GetCognitoEvents>`_
    ...
    def get_identity_pool_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/GetIdentityPoolConfiguration>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            Cognito streams.
              ...
              - **StreamName** *(string) --* The name of the Cognito stream to receive updates. This
              stream must be in the developers account and in the same region as the identity pool.

              - **RoleArn** *(string) --* The ARN of the role Amazon Cognito can assume in order to
              publish to the stream. This role must grant access to Amazon Cognito (cognito-sync) to
    ...
    def list_datasets(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/ListDatasets>`_
          ...
          **Response Structure**
          ...
          - *(dict) --* Returned for a successful ListDatasets request.
            ...
            - **Datasets** *(list) --* A set of datasets.
              ...
              - *(dict) --* A collection of data for an identity pool. An identity pool can have
              multiple datasets. A dataset is per identity and can be general or associated with a
              particular entity in an application (like a saved game). Datasets are automatically
              created if they don't exist. Data is synced by dataset, and a dataset can hold up to
    ...
    def list_identity_pool_usage(
        ...
        API call with the temporary user credentials provided by Cognito Identity.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/ListIdentityPoolUsage>`_
          ...
          - *(dict) --* Returned for a successful ListIdentityPoolUsage request.
            ...
            - **IdentityPoolUsages** *(list) --* Usage information for the identity pools.
              ...
              - *(dict) --* Usage information for the identity pool.
                ...
                - **SyncSessionsCount** *(integer) --* Number of sync sessions for the identity
                pool.
    ...
    def list_records(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/ListRecords>`_
          ...
          - *(dict) --* Returned for a successful ListRecordsRequest.
            ...
            - **Records** *(list) --* A list of all records.
              ...
              - *(dict) --* The basic data structure of a dataset.
                ...
                - **LastModifiedDate** *(datetime) --* The date on which the record was last
                modified.

                - **LastModifiedBy** *(string) --* The user/device that made the last change to this
                record.

                - **DeviceLastModifiedDate** *(datetime) --* The last modified date of the client
                device.
            ...
            - **DatasetDeletedAfterRequestedSyncCount** *(boolean) --* A boolean value specifying
    ...
    def register_device(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/RegisterDevice>`_
    ...
    def set_cognito_events(self, IdentityPoolId: str, Events: Dict[str, str]) -> None:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/SetCognitoEvents>`_
    ...
    def set_identity_pool_configuration(
        self,
        IdentityPoolId: str,
        PushSync: ClientSetIdentityPoolConfigurationPushSyncTypeDef = None,
        CognitoStreams: ClientSetIdentityPoolConfigurationCognitoStreamsTypeDef = None,
    ) -> ClientSetIdentityPoolConfigurationResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/SetIdentityPoolConfiguration>`_
    ...
    def subscribe_to_dataset(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/SubscribeToDataset>`_
    ...
    def unsubscribe_from_dataset(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/UnsubscribeFromDataset>`_
    ...
    def update_records(
        ...
        DeviceId: str = None,
        RecordPatches: List[ClientUpdateRecordsRecordPatchesTypeDef] = None,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/cognito-sync-2014-06-30/UpdateRecords>`_
        ...
        **Request Syntax**
        ...
        :param RecordPatches: A list of patch operations.
          ...
          - *(dict) --* An update operation for a record.
            ...
            - **SyncCount** *(integer) --* **[REQUIRED]** Last known server sync count for this
            record. Set to 0 if unknown.

            - **DeviceLastModifiedDate** *(datetime) --* The last modified date of the client
            device.

        :type SyncSessionToken: string
        :param SyncSessionToken: **[REQUIRED]** The SyncSessionToken returned by a previous call to
