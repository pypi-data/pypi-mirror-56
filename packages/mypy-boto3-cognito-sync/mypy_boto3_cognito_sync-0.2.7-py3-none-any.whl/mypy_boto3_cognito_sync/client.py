...
class Client(BaseClient):
    ...
    def bulk_publish(self, IdentityPoolId: str) -> ClientBulkPublishResponseTypeDef:
        ...
        request, customers can see the status of the request via the GetBulkPublishDetails operation.

        This API can only be called with developer credentials. You cannot call this API with the temporary
        ...
        **Request Syntax**
        ...
        us-east-1:23EC4050-6AEA-7089-A2DD-08002EXAMPLE) created by Amazon Cognito. GUID generation is unique
        within a region.
    ...
    def delete_dataset(
        ...
        **Request Syntax**
        ...
        :param DatasetName: **[REQUIRED]** A string of up to 128 characters. Allowed characters are a-z,
          ...
          **Response Structure**
          ...
          - *(dict) --* Returned for a successful ListDatasets request.
            ...
            - **Datasets** *(list) --* A set of datasets.
              ...
              in an application (like a saved game). Datasets are automatically created if they don't exist.
              Data is synced by dataset, and a dataset can hold up to 1MB of key-value pairs.
    ...
    def list_identity_pool_usage(
        ...
        ListIdentityPoolUsage can only be called with developer credentials. You cannot make this API call
    ...
    def list_records(
        ...
        ListRecords can be called with temporary user credentials provided by Cognito Identity or with
        developer credentials. You should use Cognito Identity credentials to make this API call.
        ...
        :returns:
          ...
          **Response Structure**
          ...
          - *(dict) --* Returned for a successful ListRecordsRequest.
            ...
            - **DatasetDeletedAfterRequestedSyncCount** *(boolean) --* A boolean value specifying whether to
    ...
    def register_device(
        ...
        This API can only be called with temporary credentials provided by Cognito Identity. You cannot call
    ...
    def set_cognito_events(self, IdentityPoolId: str, Events: Dict[str, str]) -> None:
        ...
        pass a empty value for the particular key.
    ...
    def set_identity_pool_configuration(
        ...
        **Request Syntax**
        ...
        :param CognitoStreams: Options to apply to this identity pool for Amazon Cognito streams.
          ...
          - **StreamName** *(string) --* The name of the Cognito stream to receive updates. This stream must
          be in the developers account and in the same region as the identity pool.
    ...
    def update_records(
        ...
        The sync count in the record patch is your last known sync count for that record. The server will
        reject an UpdateRecords request with a ResourceConflictException if you try to patch a record with a
        new value but a stale sync count.

        For example, if the sync count on the server is 5 for a key called highScore and you try and submit
        a new highScore with sync count of 4, the request will be rejected. To obtain the current sync count
        for a record, call ListRecords. On a successful update of the record, the response returns the new
        sync count for that record. You should present that sync count the next time you try to update that
        same record. When the record does not exist, specify the sync count as 0.
        ...
        **Request Syntax**
        ...
        :param ClientContext: Intended to supply a device ID that will populate the lastModifiedBy field
