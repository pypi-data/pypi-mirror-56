...
templates = package_files('manhattan_users/manhattan/users/templates')
...
setup(
    ...
    url='https://git.getme.co.uk/manhattan/manhattan_users',
    ...
    keywords='flask manhattan user access controls',

    # You can just specify the packages manually here if your project is
    # simple. Or you can use find_packages().
    packages=find_packages('manhattan_users'),
    package_dir={'': 'manhattan_users'},
    ...
    install_requires=[
        'manhattan-chains>=0.0.11',
        'manhattan-comparable>=0.0.11',
        'manhattan-forms>=0.1.14',
        'manhattan-mail>=0.0.11',
        'manhattan-manage>=0.7.2',
        'manhattan-secure>=0.1.1',
        'manhattan-utils>=0.0.6',
        'MongoFrames>=1.3.4',
        'pyotp>=2.3.0',
        'qrcode>=6.1'
    ],
