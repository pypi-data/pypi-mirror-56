...
def read_module_contents():
    with open('txproductpages/__init__.py') as txproductpages_init:
        return txproductpages_init.read()
...
class BumpCommand(Command):
    ...
    def run(self):
        ...
        module_file = read_module_contents()
        with open('txproductpages/__init__.py', 'w') as fileh:
...
class ReleaseCommand(Command):
    ...
    def run(self):
        ...
        tarball = 'dist/%s-%s.tar.gz' % ('txproductpages', version)
...
class PyTest(TestCommand):
    ...
    def run_tests(self):
        ...
        import pytest
        args = 'txproductpages --flake8 ' + self.pytest_args
...
setup(
    name='txproductpages',
    description='Twisted API for Red Hat Product Pages',
    packages=['txproductpages'],
    author='Ken Dreyer',
    ...
    license='MIT',
    zip_safe=False,
    keywords='product pages, twisted',
