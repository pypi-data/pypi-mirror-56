...
Mypy-friendly auto-generated type annotations for `boto3 cur 1.10.28` service.
...
session_client = session.client("cur")
...
```python
import boto3
from mypy_boto3.cur import Client

from mypy_boto3.cur.paginator import DescribeReportDefinitionsPaginator
