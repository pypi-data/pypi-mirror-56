...
def subplot(
    ...
    Set *autolens.data_type.arrays.plotters.array_plotters* for a description of all innput parameters not described below.
    ...
    image_plane_pix_grid : ndarray or data_type.arrays.grid_stacks.PixGrid
...
def visibilities(
    ...
    Set *autolens.data_type.arrays.plotters.array_plotters* for a description of all input parameters not described below.
