...
class LexeeDoc:
    ...
    def __init__(self, symbols, params):
        ...
        self.imports = { symbol.identity[0] : symbol.load(**self.context)  for symbol in  [symbol for symbol in symbols if symbol.name == "import" ] }
        self.context["config"] = self.config
        self.context["import"] = self.imports
