...
x1=C.layers.Convolution2D((5, 5), 32, T.leaky_relu6, strides=1, pad=True)(input_var)
...
x2 = T.gcd_conv2d(x2, (3, 3), num_filters=384, strides=2, padding='valid', activation=None, divisor_rank=0)#8*13
x2=T.InstanceNormalization()(x2)
x2=T.leaky_relu6(x2)
...
for epoch in range(50):
    ...
    z.save('Models/model_ciifar.model')
