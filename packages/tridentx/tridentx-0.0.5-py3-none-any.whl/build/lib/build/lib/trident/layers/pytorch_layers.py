...
# def conv_wrapper(func):
#     def wrapper(*args, **kwargs):
#         x = args[0]
#         w = args[1]
#         if 'in_channels' in kwargs:
#             kwargs['input_filters']=kwargs['in_channels']
#         if 'out_channels' in kwargs:
#             kwargs['num']=kwargs['out_channels']
#
#
#         y = func(x, w, **kwargs)
#         return y
...
#         return getattr(self._convnd, attr)
#     # Forward all torch.optim.Optimizer methods
#     def __getstate__(self):
#         return self._convnd.__getstate__()
#     def __setstate__(self):
#         return self._convnd.__setstate__()
#     def __repr__(self):
#         return self._convnd.__repr__()
#     def state_dict(self):
#         return self._convnd.state_dict()
#     def load_state_dict(self, state_dict):
#         return self._convnd.load_state_dict(state_dict)
#     def add_param_group(self, param_group):
#         return self._convnd.add_param_group(param_group)
#
