...
# x=C.layers.Convolution2D((3, 3), num_filters=16, strides=1, activation=T.get_activation('h_swish'), pad=True)(input_var)
# x =MobileNetv3_Block(expand_filters=16,out_filters=16,kernal_size=3,strides= 1, activation='leaky_relu6', is_se=False,is_shortcut=True)(x)
# x =MobileNetv3_Block(expand_filters=64,out_filters=24,kernal_size=3,strides=1, activation='leaky_relu6', is_se=False)(x)
# x =MobileNetv3_Block(expand_filters=72, out_filters=24, kernal_size=3, strides=1, activation='leaky_relu6',is_se=False,is_shortcut=True)(x)
# x =MobileNetv3_Block(expand_filters=72, out_filters=40, kernal_size=3, strides=2, activation='leaky_relu6', is_se=True)(x)
# x =MobileNetv3_Block(expand_filters=72, out_filters=40, kernal_size=3, strides=1, activation='leaky_relu6', is_se=True,is_shortcut=True)(x)
# x =MobileNetv3_Block(expand_filters=120, out_filters=40, kernal_size=3, strides=1, activation='leaky_relu6', is_se=True, is_shortcut=True)(x)
# x=MobileNetv3_Block(expand_filters=184, out_filters=80, kernal_size=3, strides=2, activation='h_swish',is_se=False)(x)
# x=MobileNetv3_Block(expand_filters=480, out_filters=112, kernal_size=3, strides=1, activation='h_swish', is_se=False)(x)
# x=MobileNetv3_Block(expand_filters=960, out_filters=160, kernal_size=3, strides=1, activation='h_swish',  is_se=False)(x)
# x=T.Conv2d((1, 1), num_filters=960, strides=1, activation=None,  padding='same')(x)
# x =T.Classifier(num_classes=100,is_multiselect=False,classifier_type='global_avgpool')(x)


def baselineNet(input_var):
    global classifiertype
    return T.Sequential2(input_var,[
            T.Conv2d((3, 3), num_filters=32, strides=1, activation='h_swish', padding='same'),#16*2
            T.ShortCut({
                'left': [T.Conv2d((1, 1), num_filters=48, strides=1, activation=None, padding='same'),#16*3
                        T.Conv2d((3, 3), num_filters=80, strides=1, activation=None, padding='same'),#16*5
                         T.Conv2d((1, 1), num_filters=32, strides=1, activation=None, padding='same')]}),#16*7

                T.Conv2d_Block((3, 3), num_filters=88, strides=(1, 1), auto_pad=True, activation='leaky_relu6',normalization='instance'),#8*11
                T.Conv2d_Block((3, 3), num_filters=104, strides=(2, 2), auto_pad=True, activation=None,normalization=None),#8*13
                T.Conv2d_Block((3, 3), num_filters=112, strides=(1, 1), auto_pad=True, activation='leaky_relu6', normalization='instance'),#8*17

                 T.ShortCut({
                    'left': [T.Conv2d((1, 1), num_filters=328, strides=1, activation=None, padding='same'),#8*41
                            T.Conv2d((3, 3), num_filters=296, strides=1, activation=None, padding='same'),#8*37
                             T.Conv2d((1, 1), num_filters=112, strides=1, activation=None, padding='same')]}),#8*17

                T.Conv2d_Block((3, 3), num_filters=92, strides=(1, 1), auto_pad=True, activation='leaky_relu6',normalization='instance'),#4*23
                T.Conv2d_Block((3, 3), num_filters=116, strides=(2, 2), auto_pad=True, activation=None,normalization=None),#4*29
                T.Conv2d_Block((3, 3), num_filters=124, strides=(1, 1), auto_pad=True, activation='leaky_relu6', normalization='instance'),#4*31

                T.ShortCut({'left': [
                            T.Conv2d((3, 3), num_filters=589, strides=1, activation=None, padding='same'), #31*19
                             T.Conv2d((1, 1), num_filters=152, strides=1, activation=None, padding='same'), #8*19
                             T.Conv2d((3, 3), num_filters=124, strides=1, activation=None, padding='same')]}),#4*31
                T.ShortCut({'left': [
                                    T.Conv2d((1, 1), num_filters=224, strides=1, activation=None, padding='same'),#32*7
                                     T.Conv2d((3, 3), num_filters=608, strides=1, activation=None, padding='same'),#32*19
                                     T.Conv2d((1, 1), num_filters=124, strides=1, activation=None, padding='same')]}),#4*31

                T.Conv2d_Block((3, 3),num_filters= 296,strides=1, auto_pad=True, activation='leaky_relu6', normalization='instance'),#8*37
                T.Conv2d_Block((3, 3), num_filters=328, strides=2, auto_pad=True, activation=None,normalization=None),#8*41
                T.Conv2d_Block((3, 3), num_filters=344,strides=1, auto_pad=True, activation='leaky_relu6', normalization='instance'),#8*43

            T.Conv2d_Block((3, 3), num_filters=424,strides= 1, auto_pad=True, activation='leaky_relu6', normalization=None),#8*53
            T.Conv2d_Block((3, 3), num_filters=472, strides=1, auto_pad=True, activation='leaky_relu6', normalization=None),#8*59
            T.Conv2d_Block((3, 3), num_filters=488, strides=1, auto_pad=True, activation='leaky_relu6', normalization=None),#8*61
            T.Conv2d((1, 1), num_filters=184, strides=1, padding='same', activation=None),#這個活化函數必須拿掉，讓梯度好順利傳遞
...
def gcd_challengerNet(input_var):
    ...
    return T.Sequential2(input_var,[
            T.Conv2d((3, 3), num_filters=32, strides=1, activation='h_swish', padding='same'),#16*2
            T.ShortCut({
                'left': [T.GcdConv2d((3, 3), num_filters=48, strides=1, activation='h_swish', padding='same'),#16*3
                        T.GcdConv2d((3, 3), num_filters=80, strides=1, activation=None, padding='same'),#16*5
                         T.GcdConv2d((3, 3), num_filters=32, strides=1, activation='h_swish', padding='same')]}),#16*2

                T.GcdConv2d_Block((3, 3), num_filters=80, strides=1, auto_pad=True, activation='leaky_relu6',normalization=norm),#16*5
                T.GcdConv2d_Block((3, 3), num_filters=112, strides=1, auto_pad=True, activation='leaky_relu6',normalization=norm),#16*7
                T.GcdConv2d_Block((3, 3), num_filters=176, strides=2, auto_pad=True, activation='leaky_relu6', normalization=norm,dropout_rate=0.2),#16*11

                 T.ShortCut({
                    'left': [T.GcdConv2d((1, 1), num_filters=184, strides=1, activation='h_swish', padding='same'),#8*23
                            T.GcdConv2d((3, 3), num_filters=232, strides=1, activation=None, padding='same'),#8*29
                             T.GcdConv2d((1, 1), num_filters=176, strides=1, activation='h_swish', padding='same')]}),#16*11

                T.GcdConv2d_Block((3, 3), num_filters=92, strides=1, auto_pad=True, activation='leaky_relu6',normalization=norm),#4*23
                T.GcdConv2d_Block((3, 3), num_filters=116, strides=1, auto_pad=True, activation='leaky_relu6',normalization=norm),#4*29
                T.GcdConv2d_Block((3, 3), num_filters=124, strides=2, auto_pad=True, activation='leaky_relu6', normalization=norm),#4*31

                T.ShortCut({'left': [
                            T.GcdConv2d((1, 1), num_filters=403, strides=1, activation='h_swish', padding='same'), #31*13
                             T.GcdConv2d((3, 3), num_filters=124, strides=1, activation=None, padding='same'), #4*31
                             T.GcdConv2d((1, 1), num_filters=124, strides=1, activation='h_swish', padding='same')]}),#4*31
                T.ShortCut({'left': [
                                    T.GcdConv2d((1, 1), num_filters=224, strides=1, activation='h_swish', padding='same'),#32*7
                                     T.GcdConv2d((3, 3), num_filters=608, strides=1, activation=None, padding='same'),#32*19
                                     T.GcdConv2d((1, 1), num_filters=124, strides=1, activation='h_swish', padding='same')]}),#4*31

                T.GcdConv2d_Block((3, 3),num_filters= 148,strides=1, auto_pad=True, activation='leaky_relu6', normalization=norm),#4*37
                T.GcdConv2d_Block((3, 3), num_filters=164, strides=1, auto_pad=True, activation=None,normalization=norm),#4*41
                T.GcdConv2d_Block((3, 3), num_filters=172,strides=2, auto_pad=True, activation='leaky_relu6', normalization=norm),#4*43

            T.GcdConv2d_Block((3, 3), num_filters=212,strides= 1, auto_pad=True, activation='leaky_relu6', normalization=None),#4*53
            T.GcdConv2d_Block((3, 3), num_filters=236, strides=1, auto_pad=True, activation='leaky_relu6', normalization=None),#4*59
            T.GcdConv2d((1, 1), num_filters=250, strides=1, padding='same', activation=None),#這個活化函數必須拿掉，讓梯度好順利傳遞
...
#os.remove('model_log_cifar100_baseline_prime.txt')
f = codecs.open('model_log_cifar100_baseline_prime.txt', 'a', encoding='utf-8-sig')
...
for cls in ['dense']:
    ...
    for learning_rate in [5e-2]:
        ...
        #z3 =gcd_challengerNet(input_var,self_norm=False)
       ...
       # prefix3 = 'fmnist_model_{0}_{1}_{2}'.format(k3, cls, learning_rate).replace('.', '_')
        ...
        learner2 = C.adam(z2.parameters, lr=C.learning_rate_schedule([lr*10], C.UnitType.minibatch), momentum=C.momentum_schedule(0.75))
        ...
        #                   l1_regularization_weight=1e-6, momentum=C.momentum_schedule(0.75))
