...
def test(request):
    ...
    preuser = PreUser.objects.all().first()
    print preuser.id
    contract_list = preuser.preusercontract_set.filter(contract__type=2)
    print(contract_list)
