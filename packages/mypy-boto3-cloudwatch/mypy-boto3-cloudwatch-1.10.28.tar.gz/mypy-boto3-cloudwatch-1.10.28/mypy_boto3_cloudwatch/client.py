...
class Client(BaseClient):
    ...
    def delete_dashboards(self, DashboardNames: List[str]) -> Dict[str, Any]:
        """
        Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If
    ...
    def delete_insight_rules(self, RuleNames: List[str]) -> ClientDeleteInsightRulesResponseTypeDef:
        ...
        from the first time the rule was created may or may not be available.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/DeleteInsightRules>`_
    ...
    def describe_alarms(
        ...
        """
        Retrieves the specified alarms. If no alarms are specified, all alarms are returned. Alarms
        can be retrieved by using only a prefix for the alarm name, the alarm state, or a prefix for
        any action.
            ...
            - **MetricAlarms** *(list) --*
              ...
              - *(dict) --*
                ...
                - **EvaluateLowSampleCountPercentile** *(string) --*
                  ...
                  significant. If ``evaluate`` or this parameter is not used, the alarm is always
                ...
                - **Metrics** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    performing a math expression on metric data. A single ``GetMetricData`` call can
                    include up to 100 ``MetricDataQuery`` structures.
                    ...
                    single ``PutMetricAlarm`` call can include up to 20 ``MetricDataQuery``
                    ...
                    expression. Of those ``Expression`` structures, one must have ``True`` as the
                    ...
                    are using this structure in a ``GetMetricData`` operation or a
                    ...
                    - **Id** *(string) --*
                      ...
                      must be unique within a single call to ``GetMetricData`` . If you are
                    ...
                    - **MetricStat** *(dict) --*
                      ...
                      - **Unit** *(string) --*
                        ...
                        were specified when the data was reported to CloudWatch. If you specify a
                        unit, the operation returns only data data that was collected with that unit
                    ...
                    - **Expression** *(string) --*
                      ...
                      metrics to refer to those metrics, and can also use the ``Id`` of other
                      expressions to use the result of those expressions. For more information about
                    ...
                    - **ReturnData** *(boolean) --*
                      ...
                      just to do math expressions and do not also need the raw data returned, you
                      ...
                      result to use as the alarm. For all other metrics and expressions in the same
                    ...
                    - **Period** *(integer) --*
                      ...
                      If you are performing a ``GetMetricData`` operation, use this field only if
                      you are specifying an ``Expression`` . Do not use this field when you are
                      specifying a ``MetricStat`` in a ``GetMetricData`` operation.
    ...
    def describe_insight_rules(
        ...
        """
        Returns a list of all the Contributor Insights rules in your account. All rules in your
        account are returned with a single operation.

        For more information about Contributor Insights, see `Using Contributor Insights to Analyze
        High-Cardinality Data
        <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights.html>`__
        .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/DescribeInsightRules>`_
            ...
            - **InsightRules** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Schema** *(string) --*
                  ...
                  "Version": 1}`` . For built-in rules, this is ``{"Name": "ServiceLogRule",
                  "Version": 1}``
                ...
                - **Definition** *(string) --*
                  ...
                  <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights-RuleSyntax.html>`__
                  .
    ...
    def disable_insight_rules(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/DisableInsightRules>`_
    ...
    def enable_insight_rules(self, RuleNames: List[str]) -> ClientEnableInsightRulesResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/EnableInsightRules>`_
        ...
        **Request Syntax**
        ...
        :param RuleNames: **[REQUIRED]**
          ...
          An array of the rule names to enable. If you need to find out the names of your rules, use
          DescribeInsightRules .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **DashboardBody** *(string) --*
              ...
              their location on the dashboard. For more information about the ``DashboardBody``
    ...
    def get_insight_rule_report(
        ...
        * ``MaxContributorValue`` -- the value of the top contributor for each data point. The
        identity of the contributor may change for each data point in the graph. If this rule
        aggregates by COUNT, the top contributor for each data point is the contributor with the
        most occurrences in that period. If the rule aggregates by SUM, the top contributor is the
        contributor with the highest sum in the log field specified by the rule's ``Value`` , during
        that period.
        ...
        * ``Average`` -- the average value from all contributors during the time period represented
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/GetInsightRuleReport>`_
        ...
        **Request Syntax**
        ...
        :param Metrics:
          ...
          * ``MaxContributorValue`` -- the value of the top contributor for each data point. The
          ...
          aggregates by COUNT, the top contributor for each data point is the contributor with the
          most occurrences in that period. If the rule aggregates by SUM, the top contributor is the
          contributor with the highest sum in the log field specified by the rule's ``Value`` ,
          during that period.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **KeyLabels** *(list) --*
              ...
              used to classify contributors. If the rule contains more than one key, then each
              unique combination of values for the keys is counted as a unique contributor.
            ...
            - **Contributors** *(list) --*
              ...
              rule contains multiple keys, each combination of values for the keys counts as a
              unique contributor.

              - *(dict) --*

                One of the unique contributors found by a Contributor Insights rule. If the rule
                contains multiple keys, then a unique contributor is a unique combination of values
                from all the keys in the rule.
            ...
            - **MetricDatapoints** *(list) --*
              ...
              - *(dict) --*
                ...
                - **MaxContributorValue** *(float) --*
                  ...
                  timestamp is evaluated separately, so the identity of the max contributor could be
                  different for each timestamp.
    ...
    def get_metric_data(
        ...
        """
        You can use the ``GetMetricData`` API to retrieve as many as 100 different metrics in a
        single request, with a total of as many as 100,800 data points. You can also optionally
        perform math expressions on the values of the returned statistics, to create new time series
        that represent new insights into your data. For example, using Lambda metrics, you could
        divide the Errors metric by the Invocations metric to get an error rate time series. For
        ...
        * Data points with a period of 3600 seconds (1 hour) are available for 455 days (15 months).
        ...
        CloudWatch. If you specify a unit, the operation returns only data data that was collected
        with that unit specified. If you specify a unit that does not match the data collected, the
        ...
        **Request Syntax**
        ...
        :param MetricDataQueries: **[REQUIRED]**
          ...
          100 ``MetricDataQuery`` structures. Each of these structures can specify either a metric
          to retrieve, or a math expression to perform on retrieved data.
        ...
        :param NextToken:
          ...
          Include this value, if it was returned by the previous call, to get the next set of data
          points.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **MetricDataResults** *(list) --*
              ...
              - *(dict) --*
                ...
                - **StatusCode** *(string) --*
                  ...
                  The status of the returned data. ``Complete`` indicates that all data points in
                  the requested time range were returned. ``PartialData`` means that an incomplete
                  ...
                  returned if you are performing a math expression. ``InternalError`` indicates that
            ...
            - **Messages** *(list) --*
              ...
              Contains a message about this ``GetMetricData`` operation, if the operation results in
              such a message. An example of a message that may be returned is ``Maximum number of
              allowed metrics exceeded`` . If there is a message, as much of the operation as
              ...
              the ``MetricDataResult`` object returned for that metric.
    ...
    def get_metric_widget_image(
        ...
        Amazon CloudWatch metrics as a bitmap image. You can then embed this image into your
        services and products, such as wiki pages, reports, and documents. You could also retrieve
        images regularly, such as every minute, and create your own custom live dashboard.

        The graph you retrieve can include all CloudWatch metric graph features, including metric
        ...
        **Request Syntax**
        ...
        :param OutputFormat:
          ...
          the content-type set to ``text/xml`` . The image data is in a ``MetricWidgetImage`` field.
          For example:
          ...
          and all actions using an AWS SDK, you should use ``png`` . If you specify ``image/png`` ,
          the HTTP response has a content-type set to ``image/png`` , and the body of the response
          is a PNG image.
            ...
            - **DashboardEntries** *(list) --*
              ...
              - *(dict) --*
                ...
                - **LastModified** *(datetime) --*
                  ...
                  through the console. This number is expressed as the number of milliseconds since
    ...
    def list_metrics(
        ...
        After you create a metric, allow up to fifteen minutes before the metric appears. Statistics
        about the metric, however, are available sooner using  GetMetricData or  GetMetricStatistics
        .
    ...
    def list_tags_for_resource(self, ResourceARN: str) -> ClientListTagsForResourceResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param ResourceARN: **[REQUIRED]**
          ...
          The ARN of the CloudWatch resource that you want to view tags for. For more information on
          ARN format, see `Example ARNs
    ...
    def put_anomaly_detector(
        ...
        """
        Creates an anomaly detection model for a CloudWatch metric. You can use the model to display
        a band of expected normal values when the metric is graphed.
        ...
        **Request Syntax**
        ...
        :param Configuration:
          ...
          - **ExcludedTimeRanges** *(list) --*
            ...
            Use this to make sure that events that could cause unusual values for the metric, such
            as deployments, aren't used when CloudWatch creates the model.
    ...
    def put_dashboard(
        ...
        A simple way to create a dashboard using ``PutDashboard`` is to copy an existing dashboard.
        To copy an existing dashboard using the console, you can load the dashboard and then use the
        View/edit source command in the Actions menu to display the JSON block for that dashboard.
        Another way to copy a dashboard is to use ``GetDashboard`` , and then use the data returned
        within ``DashboardBody`` as the template for the new dashboard when you call
        ``PutDashboard`` .

        When you create a dashboard with ``PutDashboard`` , a good practice is to add a text widget
        at the top of the dashboard with a message that the dashboard was created by script and
        should not be changed in the console. This message could also point console users to the
        location of the ``DashboardBody`` script or the CloudFormation template used to create the
        dashboard.
        ...
        **Request Syntax**
        ...
        :param DashboardName: **[REQUIRED]**
          ...
          created. The maximum length is 255, and valid characters are A-Z, a-z, 0-9, "-", and "_".
    ...
    def put_insight_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/monitoring-2010-08-01/PutInsightRule>`_
    ...
    def put_metric_alarm(
        ...
        **Request Syntax**
        ...
        :param MetricName:
          ...
          parameter, or any of the ``Dimensions`` , ``Period`` , ``Namespace`` , ``Statistic`` , or
    ...
    def put_metric_data(
        ...
        **Request Syntax**
        ...
        :param Namespace: **[REQUIRED]**
          ...
          To avoid conflicts with AWS service namespaces, you should not specify a namespace that
          begins with ``AWS/``
        ...
        :param MetricData: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              ``Counts`` array specifies the number of times that value occurred during the period.
              You can include up to 150 unique values in each ``PutMetricData`` action that
              specifies a ``Values`` array.

              Although the ``Values`` array accepts numbers of type ``Double`` , CloudWatch rejects
              values that are either too small or too large. Values must be in the range of -2^360
              to 2^360. In addition, special values (for example, NaN, +Infinity, -Infinity) are not
              supported.
            ...
            - **Counts** *(list) --*
              ...
              count. If you include a ``Counts`` array, it must include the same amount of values as
              the ``Values`` array.
            ...
            - **StorageResolution** *(integer) --*
              ...
              regular-resolution metric, which CloudWatch stores at 1-minute resolution. Currently,
              high resolution is available only for custom metrics. For more information about
              high-resolution metrics, see `High-Resolution Metrics
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def set_alarm_state(
        self, AlarmName: str, StateValue: str, StateReason: str, StateReasonData: str = None
    ) -> None:
        """
    ...
    def untag_resource(self, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param ResourceARN: **[REQUIRED]**
          ...
          The ARN of the CloudWatch resource that you're removing tags from. For more information on
          ARN format, see `Example ARNs
          <https://docs.aws.amazon.com/general/latest/gr/aws-arns-and-namespaces.html#arn-syntax-cloudwatch>`__
          in the *Amazon Web Services General Reference* .
    ...
    @overload
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_waiter(self, waiter_name: Literal["alarm_exists"]) -> waiter_scope.AlarmExistsWaiter:
        """
