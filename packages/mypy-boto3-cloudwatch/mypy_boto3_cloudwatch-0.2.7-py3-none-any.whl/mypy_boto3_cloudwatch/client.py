...
class Client(BaseClient):
    ...
    def delete_dashboards(self, DashboardNames: List[str]) -> Dict[str, Any]:
        """
        Deletes all dashboards that you specify. You may specify up to 100 dashboards to delete. If there is
    ...
    def describe_anomaly_detectors(
        ...
        """
        Lists the anomaly detection models that you have created in your account. You can list all models in
        your account or filter the results to only the models that are related to a certain namespace,
          ...
          - *(dict) --*
            ...
            - **AnomalyDetectors** *(list) --*
              ...
              - *(dict) --*
                ...
                statistic. You can use the model to display a band of expected normal values when the metric
                is graphed.
    ...
    def get_metric_data(
        ...
        * Data points with a period of 3600 seconds (1 hour) are available for 455 days (15 months).
        ...
        retrievable only with a resolution of 5 minutes. After 63 days, the data is further aggregated and
        ...
        specify a unit, the operation returns only data data that was collected with that unit specified. If
        ...
        **Request Syntax**
        ...
        :param StartTime: **[REQUIRED]**
          ...
          * Start time less than 15 days ago - Round down to the nearest whole minute. For example, 12:32:34
          ...
          * Start time greater than 63 days ago - Round down to the nearest 1-hour clock interval. For
          ...
          nearest time that corresponds to even 5-, 10-, or 30-second divisions of a minute. For example, if
          you make a query at (HH:mm:ss) 01:05:23 for the previous 10-second period, the start time of your
          request is rounded down and you receive data from 01:05:10 to 01:05:20. If you make a query at
          15:07:17 for the previous 5 minutes of data, using a period of 5 seconds, you receive data
        ...
        :param ScanBy:
          ...
          first and paginates when the ``MaxDatapoints`` limit is reached. ``TimestampAscending`` returns
          the oldest data first and paginates when the ``MaxDatapoints`` limit is reached.
    ...
    def get_metric_statistics(
        ...
        the specified time range and make multiple requests across adjacent time ranges, or you can increase
        ...
        **Request Syntax**
        ...
        :param Dimensions:
          ...
          must specify the same dimensions that were used when the metrics were created. For an example, see
    ...
    def get_metric_widget_image(
        ...
        **Request Syntax**
        ...
        :param MetricWidget: **[REQUIRED]**
          ...
          include in the graph, statistics, annotations, title, axis limits, and so on. You can include only
          one ``MetricWidget`` parameter in each ``GetMetricWidgetImage`` call.
    ...
    def put_dashboard(
        ...
        source command in the Actions menu to display the JSON block for that dashboard. Another way to copy
        a dashboard is to use ``GetDashboard`` , and then use the data returned within ``DashboardBody`` as
        the template for the new dashboard when you call ``PutDashboard`` .
    ...
    def put_metric_alarm(
        ...
        * ``ec2:DescribeInstanceStatus`` and ``ec2:DescribeInstances`` for all alarms on EC2 instance status
        metrics
        ...
        * No specific permissions are needed for alarms with recover actions
        ...
        PutMetricAlarm API, CloudWatch creates the necessary service-linked role for you. The service-linked
        role is called ``AWSServiceRoleForCloudWatchEvents`` . For more information, see `AWS service-linked
        role
        ...
        **Request Syntax**
        ...
        :param MetricName:
          ...
          If you are creating an alarm based on a math expression, you cannot specify this parameter, or any
          of the ``Dimensions`` , ``Period`` , ``Namespace`` , ``Statistic`` , or ``ExtendedStatistic``
        ...
        :param ExtendedStatistic:
          ...
          The percentile statistic for the metric specified in ``MetricName`` . Specify a value between p0.0
          and p100. When you call ``PutMetricAlarm`` and specify a ``MetricName`` , you must specify either
        ...
        :param Period:
          ...
          one-minute data resolution, and the alarm may often lapse into INSUFFICENT_DATA status. Specifying
          10 or 30 also sets this alarm as a high-resolution alarm, which has a higher charge than other
          alarms. For more information about pricing, see `Amazon CloudWatch Pricing
          <https://aws.amazon.com/cloudwatch/pricing/>`__ .

          An alarm's total current evaluation period can be no longer than one day, so ``Period`` multiplied
          by ``EvaluationPeriods`` cannot be more than 86,400 seconds.
        ...
        :param EvaluationPeriods: **[REQUIRED]**
          ...
          an alarm that requires that a number of consecutive data points be breaching to trigger the alarm,
          this value specifies that number. If you are setting an "M out of N" alarm, this value is the N.
    ...
    def put_metric_data(
        ...
        are either too small or too large. Values must be in the range of 8.515920e-109 to 1.174271e+108
        (Base 10) or 2e-360 to 2e360 (Base 2). In addition, special values (for example, NaN, +Infinity,
        ...
        :param MetricData: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              1.174271e+108 (Base 10) or 2e-360 to 2e360 (Base 2). In addition, special values (for example,
    ...
    def set_alarm_state(
        ...
        """
        Temporarily sets the state of an alarm for testing purposes. When the updated state differs from the
        previous value, the action configured for the appropriate state is invoked. For example, if your
        alarm is configured to send an Amazon SNS message when an alarm is triggered, temporarily changing
        the alarm state to ``ALARM`` sends an SNS message. The alarm returns to its actual state (often
        within seconds). Because the alarm state change happens quickly, it is typically only visible in the
    ...
    def tag_resource(
        ...
        """
        Assigns one or more tags (key-value pairs) to the specified CloudWatch resource. Currently, the only
        CloudWatch resources that can be tagged are alarms.
        ...
        key for the alarm, this tag is appended to the list of tags associated with the alarm. If you
