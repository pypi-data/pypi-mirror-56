...
class ClientDeleteAnomalyDetectorDimensionsTypeDef(_ClientDeleteAnomalyDetectorDimensionsTypeDef):
    """
...
class ClientDeleteInsightRulesResponseFailuresTypeDef(
    ...
    """
    Type definition for `ClientDeleteInsightRulesResponse` `Failures`
...
class ClientDeleteInsightRulesResponseTypeDef(_ClientDeleteInsightRulesResponseTypeDef):
    """
    Type definition for `ClientDeleteInsightRules` `Response`
...
class ClientDescribeAlarmsForMetricResponseMetricAlarmsMetricsMetricStatMetricDimensionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeAlarmsForMetricResponseMetricAlarmsMetricsMetricStatMetric`
    `Dimensions`
...
class ClientDescribeAlarmsForMetricResponseMetricAlarmsMetricsMetricStatMetricTypeDef(
    ...
    """
    Type definition for `ClientDescribeAlarmsForMetricResponseMetricAlarmsMetricsMetricStat`
    `Metric`
...
class ClientDescribeAlarmsForMetricResponseMetricAlarmsMetricsMetricStatTypeDef(
    ...
    - **Period** *(integer) --*
      ...
      a period can be as short as one minute (60 seconds) and must be a multiple of 60. For
      high-resolution metrics that are collected at intervals of less than one minute, the period
      can be 1, 5, 10, 30, 60, or any multiple of 60. High-resolution metrics are those metrics
...
class ClientDescribeAlarmsForMetricResponseMetricAlarmsMetricsTypeDef(
    ...
    information, see `Metric Math Syntax and Functions
    ...
    - **Id** *(string) --*
      ...
      within a single call to ``GetMetricData`` . If you are performing math expressions on this set
      of data, this name represents that data and can serve as a variable in the mathematical
    ...
    - **MetricStat** *(dict) --*
      ...
      - **Period** *(integer) --*
        ...
        60. For high-resolution metrics that are collected at intervals of less than one minute, the
        period can be 1, 5, 10, 30, 60, or any multiple of 60. High-resolution metrics are those
        metrics stored by a ``PutMetricData`` call that includes a ``StorageResolution`` of 1
        second.
      ...
      - **Unit** *(string) --*
        ...
        reported to CloudWatch. If you specify a unit, the operation returns only data data that was
    ...
    - **Period** *(integer) --*
      ...
      If you are performing a ``GetMetricData`` operation, use this field only if you are specifying
      an ``Expression`` . Do not use this field when you are specifying a ``MetricStat`` in a
...
class ClientDescribeAlarmsForMetricResponseMetricAlarmsTypeDef(
    ...
    - **EvaluateLowSampleCountPercentile** *(string) --*
      ...
      this parameter is not used, the alarm is always evaluated and possibly changes state no matter
    ...
    - **Metrics** *(list) --*
      ...
      Each structure either retrieves a metric or performs a math expression. One item in the
      Metrics array is the math expression that the alarm watches. This expression by designated by
      having ``ReturnValue`` set to true.

      - *(dict) --*

        This structure is used in both ``GetMetricData`` and ``PutMetricAlarm`` . The supported use
        of this structure is different for those two operations.

        When used in ``GetMetricData`` , it indicates the metric data to return, and whether this
        ...
        When used in ``PutMetricAlarm`` , it enables you to create an alarm based on a metric math
        expression. Each ``MetricDataQuery`` in the array specifies either a metric to retrieve, or
        a math expression to be performed on retrieved metrics. A single ``PutMetricAlarm`` call can
        include up to 20 ``MetricDataQuery`` structures in the array. The 20 structures can include
        as many as 10 structures that contain a ``MetricStat`` parameter to retrieve a metric, and
        as many as 10 structures that contain the ``Expression`` parameter to perform a math
        expression. Of those ``Expression`` structures, one must have ``True`` as the value for
        ``ReturnData`` . The result of this expression is the value the alarm watches.
        ...
        - **Id** *(string) --*
          ...
          unique within a single call to ``GetMetricData`` . If you are performing math expressions
          on this set of data, this name represents that data and can serve as a variable in the
        ...
        - **MetricStat** *(dict) --*
          ...
          - **Unit** *(string) --*
            ...
            was reported to CloudWatch. If you specify a unit, the operation returns only data data
        ...
        - **Expression** *(string) --*
          ...
          math expression. This expression can use the ``Id`` of the other metrics to refer to those
        ...
        - **Label** *(string) --*
          ...
          A human-readable label for this metric or expression. This is especially useful if this is
          an expression, so that you know what the value represents. If the metric or expression is
          shown in a CloudWatch dashboard widget, the label is shown. If Label is omitted,
        ...
        - **Period** *(integer) --*
          ...
          those metrics stored by a ``PutMetricData`` operation that includes a ``StorageResolution
          of 1 second`` .
    ...
    - **MetricAlarms** *(list) --*
      ...
      - *(dict) --*
        ...
        - **EvaluateLowSampleCountPercentile** *(string) --*
          ...
          or this parameter is not used, the alarm is always evaluated and possibly changes state no
...
class ClientDescribeAlarmsResponseMetricAlarmsMetricsMetricStatMetricDimensionsTypeDef(
    ...
    """
    Type definition for `ClientDescribeAlarmsResponseMetricAlarmsMetricsMetricStatMetric`
    `Dimensions`
...
class ClientDescribeAnomalyDetectorsResponseAnomalyDetectorsConfigurationExcludedTimeRangesTypeDef(
    ...
    """
    Type definition for `ClientDescribeAnomalyDetectorsResponseAnomalyDetectorsConfiguration`
    `ExcludedTimeRanges`
...
class ClientDescribeAnomalyDetectorsResponseAnomalyDetectorsTypeDef(
    ...
    An anomaly detection model associated with a particular CloudWatch metric and statistic. You can
    use the model to display a band of expected normal values when the metric is graphed.
...
class ClientDescribeInsightRulesResponseInsightRulesTypeDef(
    ...
    """
    Type definition for `ClientDescribeInsightRulesResponse` `InsightRules`
    ...
    - **Definition** *(string) --*
      ...
      and the filters. For details on the valid syntax, see `Contributor Insights Rule Syntax
...
class ClientDescribeInsightRulesResponseTypeDef(_ClientDescribeInsightRulesResponseTypeDef):
    """
    Type definition for `ClientDescribeInsightRules` `Response`
    ...
    - **InsightRules** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Definition** *(string) --*
          ...
          The definition of the rule, as a JSON object. The definition contains the keywords used to
          define contributors, the value to aggregate on if this rule returns a sum instead of a
          count, and the filters. For details on the valid syntax, see `Contributor Insights Rule
          Syntax
          <https://docs.aws.amazon.com/AmazonCloudWatch/latest/monitoring/ContributorInsights-RuleSyntax.html>`__
          .
    """
...
class ClientDisableInsightRulesResponseFailuresTypeDef(
    ...
    """
    Type definition for `ClientDisableInsightRulesResponse` `Failures`
...
class ClientDisableInsightRulesResponseTypeDef(_ClientDisableInsightRulesResponseTypeDef):
    """
    Type definition for `ClientDisableInsightRules` `Response`
...
class ClientEnableInsightRulesResponseFailuresTypeDef(
    ...
    """
    Type definition for `ClientEnableInsightRulesResponse` `Failures`
...
class ClientEnableInsightRulesResponseTypeDef(_ClientEnableInsightRulesResponseTypeDef):
    """
    Type definition for `ClientEnableInsightRules` `Response`
...
class ClientGetInsightRuleReportResponseContributorsDatapointsTypeDef(
    ...
    """
    Type definition for `ClientGetInsightRuleReportResponseContributors` `Datapoints`
...
class ClientGetInsightRuleReportResponseContributorsTypeDef(
    ...
    """
    Type definition for `ClientGetInsightRuleReportResponse` `Contributors`
...
class ClientGetInsightRuleReportResponseMetricDatapointsTypeDef(
    ...
    """
    Type definition for `ClientGetInsightRuleReportResponse` `MetricDatapoints`
...
class ClientGetInsightRuleReportResponseTypeDef(_ClientGetInsightRuleReportResponseTypeDef):
    """
    Type definition for `ClientGetInsightRuleReport` `Response`
    ...
    - **Contributors** *(list) --*
      ...
      - *(dict) --*
        ...
        One of the unique contributors found by a Contributor Insights rule. If the rule contains
        multiple keys, then a unique contributor is a unique combination of values from all the keys
        in the rule.

        If the rule contains a single key, then each unique contributor is each unique value for
        this key.
...
_OptionalClientGetMetricDataMetricDataQueriesMetricStatTypeDef = TypedDict(
    "_OptionalClientGetMetricDataMetricDataQueriesMetricStatTypeDef", {"Unit": str}, total=False
)
...
class ClientGetMetricDataResponseMetricDataResultsTypeDef(
    ...
    - **StatusCode** *(string) --*
      ...
      ``InternalError`` indicates that an error occurred. Retry your request using ``NextToken`` ,
      if present.
...
class ClientGetMetricStatisticsDimensionsTypeDef(_ClientGetMetricStatisticsDimensionsTypeDef):
    """
...
class ClientPutAnomalyDetectorDimensionsTypeDef(_ClientPutAnomalyDetectorDimensionsTypeDef):
    """
...
_ClientPutMetricAlarmMetricsMetricStatMetricDimensionsTypeDef = TypedDict(
    "_ClientPutMetricAlarmMetricsMetricStatMetricDimensionsTypeDef", {"Name": str, "Value": str}
)
...
_RequiredClientPutMetricAlarmMetricsMetricStatTypeDef = TypedDict(
    ...
    {"Metric": ClientPutMetricAlarmMetricsMetricStatMetricTypeDef, "Period": int, "Stat": str},
)
...
class ClientPutMetricDataMetricDataTypeDef(
    ...
    - **Values** *(list) --*
      ...
      specifies the number of times that value occurred during the period. You can include up to 150
      unique values in each ``PutMetricData`` action that specifies a ``Values`` array.
...
class DescribeAlarmsPaginateResponseMetricAlarmsMetricsMetricStatMetricDimensionsTypeDef(
    ...
    """
    Type definition for `DescribeAlarmsPaginateResponseMetricAlarmsMetricsMetricStatMetric`
    `Dimensions`
...
_OptionalGetMetricDataPaginateMetricDataQueriesMetricStatTypeDef = TypedDict(
    "_OptionalGetMetricDataPaginateMetricDataQueriesMetricStatTypeDef", {"Unit": str}, total=False
)
...
_MetricPutAlarmMetricsMetricStatMetricDimensionsTypeDef = TypedDict(
    "_MetricPutAlarmMetricsMetricStatMetricDimensionsTypeDef", {"Name": str, "Value": str}
)
...
_RequiredMetricPutAlarmMetricsMetricStatTypeDef = TypedDict(
    ...
    {"Metric": MetricPutAlarmMetricsMetricStatMetricTypeDef, "Period": int, "Stat": str},
)
...
class MetricPutAlarmMetricsMetricStatTypeDef(
    _RequiredMetricPutAlarmMetricsMetricStatTypeDef, _OptionalMetricPutAlarmMetricsMetricStatTypeDef
):
    """
...
_MetricPutAlarmTagsTypeDef = TypedDict("_MetricPutAlarmTagsTypeDef", {"Key": str, "Value": str})
