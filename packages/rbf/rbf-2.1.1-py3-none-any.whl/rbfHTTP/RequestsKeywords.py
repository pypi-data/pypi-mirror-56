...
from rbfHTTP.compat import httplib, urlencode, PY3
...
class RequestsKeywords(object):
    """``rbfHTTP`` is a HTTP test library that uses the Requests HTTP client.
    ...
    def create_session(self, alias, url, headers={}, cookies={},
        ...
        """ *Creates a HTTP session to a server*
    ...
    def create_custom_session(
            ...
            backoff_factor=0.10,
            disable_warnings=0):
        """ *Create a HTTP custom session to a server*
    ...
    def create_ntlm_session(
            ...
            backoff_factor=0.10,
            disable_warnings=0):
        """ *Create a HTTP NTLM session to a server*
    ...
    def create_digest_session(self, alias, url, auth, headers={}, cookies={},
        ...
        """ *Create a HTTP digest session to a server*
    ...
    def create_client_cert_session(self, alias, url, headers={}, cookies={},
                       ...
                       verify=False, debug=0, max_retries=3, backoff_factor=0.10, disable_warnings=0):
        """ *Create a HTTP client cert session to a server*
