...
class ClientCreateCertificateAuthorityCertificateAuthorityConfigurationSubjectTypeDef(
    ...
    """
    Type definition for `ClientCreateCertificateAuthorityCertificateAuthorityConfiguration`
    `Subject`
...
class ClientCreateCertificateAuthorityRevocationConfigurationTypeDef(
    ...
    - **CrlConfiguration** *(dict) --*
      ...
      - **CustomCname** *(string) --*
        ...
        Name inserted into the certificate **CRL Distribution Points** extension that enables the
        use of an alias for the CRL distribution point. Use this value if you don't want the name of
...
_ClientDescribeCertificateAuthorityAuditReportResponseTypeDef = TypedDict(
    ...
    {"AuditReportStatus": str, "S3BucketName": str, "S3Key": str, "CreatedAt": datetime},
    total=False,
)
...
class ClientDescribeCertificateAuthorityResponseCertificateAuthorityCertificateAuthorityConfigurationSubjectTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeCertificateAuthorityResponseCertificateAuthorityCertificateAuthorityConfiguration`
    `Subject`
...
class ClientDescribeCertificateAuthorityResponseCertificateAuthorityCertificateAuthorityConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribeCertificateAuthorityResponseCertificateAuthority`
...
class ClientDescribeCertificateAuthorityResponseCertificateAuthorityRevocationConfigurationCrlConfigurationTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeCertificateAuthorityResponseCertificateAuthorityRevocationConfiguration`
    `CrlConfiguration`
...
class ClientDescribeCertificateAuthorityResponseCertificateAuthorityRevocationConfigurationTypeDef(
    ...
    Information about the certificate revocation list (CRL) created and maintained by your private
    CA.
...
class ClientDescribeCertificateAuthorityResponseCertificateAuthorityTypeDef(
    ...
    - **CertificateAuthorityConfiguration** *(dict) --*
      ...
      - **KeyAlgorithm** *(string) --*
        ...
        when it issues a certificate. When you create a subordinate CA, you must use a key algorithm
        supported by the parent CA.
    ...
    - **RevocationConfiguration** *(dict) --*
      ...
      - **CrlConfiguration** *(dict) --*
        ...
        - **S3BucketName** *(string) --*
          ...
          **CustomCname** argument, the name of your S3 bucket is placed into the **CRL Distribution
          Points** extension of the issued certificate. You can change the name of your bucket by
          calling the  UpdateCertificateAuthority action. You must specify a bucket policy that
...
class ClientListCertificateAuthoritiesResponseCertificateAuthoritiesCertificateAuthorityConfigurationSubjectTypeDef(
    ...
    """
    Type definition for
    `ClientListCertificateAuthoritiesResponseCertificateAuthoritiesCertificateAuthorityConfiguration`
    `Subject`
...
class ClientListCertificateAuthoritiesResponseCertificateAuthoritiesCertificateAuthorityConfigurationTypeDef(
    ...
    """
    Type definition for `ClientListCertificateAuthoritiesResponseCertificateAuthorities`
    `CertificateAuthorityConfiguration`
...
class ClientListCertificateAuthoritiesResponseCertificateAuthoritiesRevocationConfigurationCrlConfigurationTypeDef(
    ...
    """
    Type definition for
    `ClientListCertificateAuthoritiesResponseCertificateAuthoritiesRevocationConfiguration`
    `CrlConfiguration`
...
class ClientListCertificateAuthoritiesResponseCertificateAuthoritiesTypeDef(
    ...
    certificate **Subject** field owns or controls the public key contained in the **Subject Public
    Key Info** field. Call the  CreateCertificateAuthority action to create your private CA. You
    must then call the  GetCertificateAuthorityCertificate action to retrieve a private CA
...
class ClientListPermissionsResponsePermissionsTypeDef(
    ...
    Permissions designate which private CA actions can be performed by an AWS service or entity. In
    order for ACM to automatically renew private certificates, you must give the ACM service
...
class ListCertificateAuthoritiesPaginateResponseCertificateAuthoritiesCertificateAuthorityConfigurationSubjectTypeDef(
    ...
    """
    Type definition for
    `ListCertificateAuthoritiesPaginateResponseCertificateAuthoritiesCertificateAuthorityConfiguration`
    `Subject`
...
class ListCertificateAuthoritiesPaginateResponseCertificateAuthoritiesCertificateAuthorityConfigurationTypeDef(
    ...
    """
    Type definition for `ListCertificateAuthoritiesPaginateResponseCertificateAuthorities`
    `CertificateAuthorityConfiguration`
...
class ListCertificateAuthoritiesPaginateResponseCertificateAuthoritiesRevocationConfigurationCrlConfigurationTypeDef(
    ...
    """
    Type definition for
    `ListCertificateAuthoritiesPaginateResponseCertificateAuthoritiesRevocationConfiguration`
    `CrlConfiguration`
