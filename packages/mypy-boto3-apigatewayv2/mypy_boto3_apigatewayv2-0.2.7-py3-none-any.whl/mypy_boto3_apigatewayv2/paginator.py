"Main interface for apigatewayv2 Paginators"
...
class GetAuthorizersPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ApiId: str,
        PaginationConfig: GetAuthorizersPaginatePaginationConfigTypeDef = None,
    ) -> GetAuthorizersPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetDeploymentsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ApiId: str,
        PaginationConfig: GetDeploymentsPaginatePaginationConfigTypeDef = None,
    ) -> GetDeploymentsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetIntegrationsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ApiId: str,
        PaginationConfig: GetIntegrationsPaginatePaginationConfigTypeDef = None,
    ) -> GetIntegrationsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetModelsPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ApiId: str,
        PaginationConfig: GetModelsPaginatePaginationConfigTypeDef = None,
    ) -> GetModelsPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetRoutesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ApiId: str,
        PaginationConfig: GetRoutesPaginatePaginationConfigTypeDef = None,
    ) -> GetRoutesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
...
class GetStagesPaginator(Boto3Paginator):
    ...
    def paginate(
        self,
        ApiId: str,
        PaginationConfig: GetStagesPaginatePaginationConfigTypeDef = None,
    ) -> GetStagesPaginateResponseTypeDef:
        """
        Creates an iterator that will paginate through responses from
