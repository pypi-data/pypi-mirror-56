    ...
    def create_authorizer(
        ...
        **Request Syntax**
        ...
        :param IdentitySource: **[REQUIRED]**
          ...
          example, if an Auth header and a Name query string parameters are defined as identity sources,
          this value is method.request.header.Auth, method.request.querystring.Name. These parameters will
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AuthorizerResultTtlInSeconds** *(integer) --*
              ...
              responses. If this field is not set, the default value is 300. The maximum value is 3600, or 1
              hour.
        ...
        :param DomainNameConfigurations:
          ...
          - *(dict) --*
            ...
            - **CertificateName** *(string) --*
              ...
              The user-friendly name of the certificate that will be used by the edge-optimized endpoint for
              this domain name.
            ...
            - **DomainNameConfigurations** *(list) --*
              ...
              - *(dict) --*
                ...
                - **DomainNameStatus** *(string) --*
                  ...
                  the status is UPDATING, the domain cannot be modified further until the existing operation
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ConnectionType** *(string) --*
              ...
              The type of the network connection to the integration endpoint. Currently the only valid value
              is INTERNET, for connections through the public routable internet.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AuthorizationScopes** *(list) --*
              ...
              request. The method invocation is authorized if any route scope matches a claimed scope in the
              access token. Otherwise, the invocation is not authorized. When the route scope is configured,
              the client must provide an access token instead of an identity token for authorization
              purposes.
            ...
            - **Items** *(list) --*
              ...
              - *(dict) --*
                ...
                - **AuthorizationScopes** *(list) --*
                  ...
                  incoming request. The method invocation is authorized if any route scope matches a claimed
                  scope in the access token. Otherwise, the invocation is not authorized. When the route
                  scope is configured, the client must provide an access token instead of an identity token
