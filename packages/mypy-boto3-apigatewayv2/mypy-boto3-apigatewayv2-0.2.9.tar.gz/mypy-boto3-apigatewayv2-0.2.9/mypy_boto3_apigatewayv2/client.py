          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ApiEndpoint** *(string) --*
              ...
              name is typically appended to this URI to form a complete path to a deployed API
              stage.
            ...
            - **Tags** *(dict) --*
              ...
              The key-value map of strings. The valid character set is [a-zA-Z+-=
                  ._:/]. The tag key
              can be up to 128 characters and must not start with aws:. The tag value can be up to
              256 characters..
    ...
    def create_authorizer(
        ...
        **Request Syntax**
        ...
        :param AuthorizerUri: **[REQUIRED]**
          ...
          The authorizer's Uniform Resource Identifier (URI). For REQUEST authorizers, this must be
          ...
          the remaining substring in the URI should be treated as the path to the resource,
        ...
        :param IdentitySource: **[REQUIRED]**
          ...
          of the identity-related request parameters are present, not null, and non-empty. Only when
          this is true does the authorizer invoke the authorizer Lambda function, otherwise, it
          returns a 401 Unauthorized response without calling the Lambda function. The valid value
          is a string of comma-separated mapping expressions of the specified request parameters.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AuthorizerUri** *(string) --*
              ...
              arn:aws:apigateway:{region}:lambda:path/{service_api} , where {region} is the same as
              the region hosting the Lambda function, path indicates that the remaining substring in
              the URI should be treated as the path to the resource, including the initial /. For
            ...
            - **IdentitySource** *(list) --*
              ...
              The value is a comma-separated string of one or more mapping expressions of the
              specified request parameters. For example, if an Auth header and a Name query string
              parameters are defined as identity sources, this value is method.request.header.Auth,
    ...
    def create_integration(
        ...
        **Request Syntax**
        ...
        :param CredentialsArn:
          ...
          role's Amazon Resource Name (ARN). To require that the caller's identity be passed through
          from the request, specify the string arn:aws:iam::*:user/*. To use resource-based
        ...
        :param RequestParameters:
          ...
          quotes and pre-encoded as required by the backend. The method request parameter value must
          match the pattern of method.request.{location}.{name} , where {location} is querystring,
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IntegrationType** *(string) --*
              ...
              referred to as the Lambda custom integration. With any other AWS service action, this
              is known as AWS integration.
            ...
            - **RequestParameters** *(dict) --*
              ...
              value must match the pattern of method.request.{location}.{name} , where {location} is
    ...
    def create_integration_response(
        ...
        **Request Syntax**
        ...
        :param ResponseParameters:
          ...
          integration response header value, a static value enclosed within a pair of single quotes,
          or a JSON expression from the integration response body. The mapping key must match the
          pattern of method.response.header.{name}, where {name} is a valid and unique header name.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ResponseParameters** *(dict) --*
              ...
              key must match the pattern of method.response.header.{name}, where name is a valid and
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AuthorizationScopes** *(list) --*
              ...
              the incoming request. The method invocation is authorized if any route scope matches a
              claimed scope in the access token. Otherwise, the invocation is not authorized. When
              the route scope is configured, the client must provide an access token instead of an
            ...
            - **AuthorizationType** *(string) --*
              ...
              for using AWS IAM permissions, and CUSTOM for using a Lambda authorizer
    ...
    def update_authorizer(
        ...
        **Request Syntax**
        ...
        :param IdentitySource:
          ...
          For the REQUEST authorizer, this is required when authorization caching is enabled. The
          value is a comma-separated string of one or more mapping expressions of the specified
          request parameters. For example, if an Auth header, a Name query string parameter are
          defined as identity sources, this value is $method.request.header.Auth,
          $method.request.querystring.Name. These parameters will be used to derive the
