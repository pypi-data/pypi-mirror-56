...
class ClientBatchPutScheduledUpdateGroupActionResponseFailedScheduledUpdateGroupActionsTypeDef(
    ...
    """
    Type definition for `ClientBatchPutScheduledUpdateGroupActionResponse`
...
class ClientCreateAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationTypeDef(
    ...
    """
    Type definition for `ClientCreateAutoScalingGroupMixedInstancesPolicyLaunchTemplate`
...
class ClientCreateAutoScalingGroupMixedInstancesPolicyLaunchTemplateOverridesTypeDef(
    ...
    - **WeightedCapacity** *(string) --*
      ...
      instance types. For example, larger instance types are generally weighted more than smaller
      instance types. These are the same units that you chose to set the desired capacity in terms
      of instances, or a performance attribute such as vCPUs, memory, or I/O.
    ...
    *Amazon EC2 Auto Scaling User Guide* .
    ...
    - **InstancesDistribution** *(dict) --*
      ...
      - **OnDemandAllocationStrategy** *(string) --*
        ...
        The only valid value is ``prioritized`` , which is also the default value. This strategy
        uses the order of instance type overrides for the  LaunchTemplate to define the launch
        priority of each instance type. The first instance type in the array is prioritized higher
        than the last. If all your On-Demand capacity cannot be fulfilled using your highest
        priority instance, then the Auto Scaling groups launches the remaining capacity using the
      ...
      - **SpotAllocationStrategy** *(string) --*
        ...
        using the Spot pools with the lowest price, and evenly allocates your instances across the
        number of Spot pools that you specify. If the allocation strategy is ``capacity-optimized``
        , the Auto Scaling group launches instances using Spot pools that are optimally chosen based
        on the available Spot capacity.

        The default Spot allocation strategy for calls that you make through the API, the AWS CLI,
        or the AWS SDKs is ``lowest-price`` . The default Spot allocation strategy for the AWS
      ...
      - **SpotMaxPrice** *(string) --*
        ...
        leave the value of this parameter blank (which is the default), the maximum Spot price is
        set at the On-Demand price.
...
class ClientCreateLaunchConfigurationBlockDeviceMappingsEbsTypeDef(
    ...
    - **VolumeSize** *(integer) --*
      ...
      ``gp2`` , and 500-16,384 for ``st1`` and ``sc1`` . If you specify a snapshot, the volume size
    ...
    - **DeleteOnTermination** *(boolean) --*
      ...
      Indicates whether the volume is deleted on instance termination. For Amazon EC2 Auto Scaling,
      the default value is ``true`` .

    - **Iops** *(integer) --*

      The number of I/O operations per second (IOPS) to provision for the volume. The maximum ratio
      of IOPS to volume size (in GiB) is 50:1. For more information, see `Amazon EBS Volume Types
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html>`__ in the *Amazon
      EC2 User Guide for Linux Instances* .
    ...
    - **Encrypted** *(boolean) --*
      ...
      .. note::
        ...
        specify a custom CMK when you create the snapshot. The ability to encrypt a snapshot during
        copying also allows you to apply a new CMK to an already-encrypted snapshot. Volumes
      ...
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/AMIEncryption.html>`__ in the *Amazon EC2
      User Guide for Linux Instances* and `Required CMK Key Policy for Use with Encrypted Volumes
...
_RequiredClientCreateLaunchConfigurationBlockDeviceMappingsTypeDef = TypedDict(
    "_RequiredClientCreateLaunchConfigurationBlockDeviceMappingsTypeDef", {"DeviceName": str}
)
...
class ClientCreateOrUpdateTagsTagsTypeDef(
    _RequiredClientCreateOrUpdateTagsTagsTypeDef, _OptionalClientCreateOrUpdateTagsTagsTypeDef
):
    """
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsInstancesLaunchTemplateTypeDef(
    ...
    """
    Type definition for `ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsInstances`
    `LaunchTemplate`
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsInstancesTypeDef(
    ...
    - **HealthStatus** *(string) --*
      ...
      The last reported health status of the instance. "Healthy" means that the instance is healthy
      and should remain in service. "Unhealthy" means that the instance is unhealthy and that Amazon
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicyInstancesDistributionTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicy`
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicyLaunchTemplate`
    `LaunchTemplateSpecification`
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicyLaunchTemplateTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicy` `LaunchTemplate`
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsMixedInstancesPolicyTypeDef(
    ...
    """
    Type definition for `ClientDescribeAutoScalingGroupsResponseAutoScalingGroups`
...
class ClientDescribeAutoScalingGroupsResponseAutoScalingGroupsTypeDef(
    ...
    - **MixedInstancesPolicy** *(dict) --*
        ...
        - **Overrides** *(list) --*
          ...
          - *(dict) --*
            ...
            - **WeightedCapacity** *(string) --*
              ...
              The number of capacity units, which gives the instance type a proportional weight to
              other instance types. For example, larger instance types are generally weighted more
              than smaller instance types. These are the same units that you chose to set the
      ...
      - **InstancesDistribution** *(dict) --*
        ...
        - **SpotAllocationStrategy** *(string) --*
          ...
          If the allocation strategy is ``lowest-price`` , the Auto Scaling group launches instances
          using the Spot pools with the lowest price, and evenly allocates your instances across the
          number of Spot pools that you specify. If the allocation strategy is
          ``capacity-optimized`` , the Auto Scaling group launches instances using Spot pools that
    ...
    - **HealthCheckType** *(string) --*
      ...
      configure an Auto Scaling group to use ELB health checks, it considers the instance unhealthy
...
class ClientDescribeAutoScalingInstancesResponseAutoScalingInstancesLaunchTemplateTypeDef(
    ...
    """
    Type definition for `ClientDescribeAutoScalingInstancesResponseAutoScalingInstances`
    `LaunchTemplate`
...
class ClientDescribeAutoScalingInstancesResponseAutoScalingInstancesTypeDef(
    ...
    - **HealthStatus** *(string) --*
      ...
      The last reported health status of this instance. "Healthy" means that the instance is healthy
      and should remain in service. "Unhealthy" means that the instance is unhealthy and Amazon EC2
...
class ClientDescribeLaunchConfigurationsResponseLaunchConfigurationsBlockDeviceMappingsEbsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeLaunchConfigurationsResponseLaunchConfigurationsBlockDeviceMappings` `Ebs`
...
class ClientDescribeLaunchConfigurationsResponseLaunchConfigurationsBlockDeviceMappingsTypeDef(
    ...
    """
    Type definition for `ClientDescribeLaunchConfigurationsResponseLaunchConfigurations`
    `BlockDeviceMappings`
...
class ClientDescribeLaunchConfigurationsResponseLaunchConfigurationsTypeDef(
    ...
    - **ImageId** *(string) --*
      ...
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/finding-an-ami.html>`__ in the *Amazon
      EC2 User Guide for Linux Instances* .
    ...
    - **ClassicLinkVPCId** *(string) --*
      ...
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/vpc-classiclink.html>`__ in the *Amazon
      EC2 User Guide for Linux Instances* and `Linking EC2-Classic Instances to a VPC
      <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html#as-ClassicLink>`__ in
    ...
    - **BlockDeviceMappings** *(list) --*
      ...
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/block-device-mapping-concepts.html>`__ in
      ...
      - *(dict) --*
        ...
        - **Ebs** *(dict) --*
          ...
          - **SnapshotId** *(string) --*
            ...
            both ``SnapshotId`` and ``VolumeSize`` , ``VolumeSize`` must be equal or greater than
          ...
          - **VolumeType** *(string) --*
            ...
            SSD, ``gp2`` for General Purpose SSD, ``st1`` for Throughput Optimized HDD, or ``sc1``
          ...
          - **Iops** *(integer) --*
            ...
            The number of I/O operations per second (IOPS) to provision for the volume. The maximum
            ratio of IOPS to volume size (in GiB) is 50:1. For more information, see `Amazon EBS
            Volume Types
            <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSVolumeTypes.html>`__ in the
            *Amazon EC2 User Guide for Linux Instances* .
          ...
          - **Encrypted** *(boolean) --*
            ...
            *Amazon EC2 User Guide for Linux Instances* and `Required CMK Key Policy for Use with
            Encrypted Volumes
            <https://docs.aws.amazon.com/autoscaling/ec2/userguide/key-policy-requirements-EBS-encryption.html>`__
            in the *Amazon EC2 Auto Scaling User Guide* .
    ...
    - **SpotPrice** *(string) --*
      ...
      <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-launch-spot-instances.html>`__ in
      the *Amazon EC2 Auto Scaling User Guide* .
    ...
    - **EbsOptimized** *(boolean) --*
      ...
      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSOptimized.html>`__ in the *Amazon EC2
      User Guide for Linux Instances* .
    ...
    - **AssociatePublicIpAddress** *(boolean) --*
      ...
      <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html>`__ in the *Amazon EC2
      Auto Scaling User Guide* .
    ...
    - **PlacementTenancy** *(string) --*
      ...
      <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html#as-vpc-tenancy>`__ in
      the *Amazon EC2 Auto Scaling User Guide* .
    """
...
class ClientDescribeLifecycleHooksResponseLifecycleHooksTypeDef(
    ...
    - **NotificationMetadata** *(string) --*
      ...
      Additional information that is included any time Amazon EC2 Auto Scaling sends a message to
      the notification target.

    - **HeartbeatTimeout** *(integer) --*

      The maximum time, in seconds, that can elapse before the lifecycle hook times out. If the
      lifecycle hook times out, Amazon EC2 Auto Scaling performs the action that you specified in
    ...
    - **DefaultResult** *(string) --*
      ...
      Defines the action the Auto Scaling group should take when the lifecycle hook timeout elapses
      or if an unexpected failure occurs. The possible values are ``CONTINUE`` and ``ABANDON`` .
    """
...
class ClientDescribeLoadBalancerTargetGroupsResponseLoadBalancerTargetGroupsTypeDef(
    ...
    . The state transitions to ``Added`` after all Auto Scaling instances are registered with the
    target group. If Elastic Load Balancing health checks are enabled, the state transitions to
    ``InService`` after at least one Auto Scaling instance passes the health check. If EC2 health
    ...
    - **State** *(string) --*
      ...
      * ``Removing`` - The Auto Scaling instances are being deregistered from the target group. If
      connection draining is enabled, Elastic Load Balancing waits for in-flight requests to
...
class ClientDescribeLoadBalancersResponseLoadBalancersTypeDef(
    ...
    . The state transitions to ``Added`` after all instances in the group are registered with the
    load balancer. If Elastic Load Balancing health checks are enabled for the load balancer, the
    state transitions to ``InService`` after at least one instance in the group passes the health
    check. If EC2 health checks are enabled instead, the load balancer remains in the ``Added``
    state.
    ...
    - **State** *(string) --*
      ...
      * ``Removing`` - The instances in the group are being deregistered from the load balancer. If
      connection draining is enabled, Elastic Load Balancing waits for in-flight requests to
      complete before deregistering the instances.
...
class ClientDescribeNotificationConfigurationsResponseNotificationConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientDescribeNotificationConfigurationsResponse`
...
class ClientDescribePoliciesResponseScalingPoliciesTargetTrackingConfigurationCustomizedMetricSpecificationDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientDescribePoliciesResponseScalingPoliciesTargetTrackingConfigurationCustomizedMetricSpecification`
    `Dimensions`
...
class ClientDescribePoliciesResponseScalingPoliciesTargetTrackingConfigurationCustomizedMetricSpecificationTypeDef(
    ...
    """
    Type definition for `ClientDescribePoliciesResponseScalingPoliciesTargetTrackingConfiguration`
...
class ClientDescribePoliciesResponseScalingPoliciesTargetTrackingConfigurationTypeDef(
    ...
    """
    Type definition for `ClientDescribePoliciesResponseScalingPolicies`
    ...
    - **DisableScaleIn** *(boolean) --*
      ...
      group. Otherwise, the target tracking scaling policy can remove instances from the Auto
...
class ClientDescribePoliciesResponseScalingPoliciesTypeDef(
      ...
      - *(dict) --*
        ...
        * The upper and lower bound can't be null in the same step adjustment.
        ...
        - **MetricIntervalLowerBound** *(float) --*
          ...
          metric must be greater than or equal to the threshold plus the lower bound). Otherwise, it
          is exclusive (the metric must be greater than the threshold plus the lower bound). A null
    ...
    - **TargetTrackingConfiguration** *(dict) --*
      ...
      - **DisableScaleIn** *(boolean) --*
        ...
        Indicates whether scaling in by the target tracking scaling policy is disabled. If scaling
        in is disabled, the target tracking scaling policy doesn't remove instances from the Auto
...
class ClientPutScalingPolicyTargetTrackingConfigurationCustomizedMetricSpecificationDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientPutScalingPolicyTargetTrackingConfigurationCustomizedMetricSpecification` `Dimensions`
...
class ClientPutScalingPolicyTargetTrackingConfigurationCustomizedMetricSpecificationTypeDef(
    ...
    """
    Type definition for `ClientPutScalingPolicyTargetTrackingConfiguration`
    `CustomizedMetricSpecification`
...
_RequiredClientPutScalingPolicyTargetTrackingConfigurationTypeDef = TypedDict(
    "_RequiredClientPutScalingPolicyTargetTrackingConfigurationTypeDef", {"TargetValue": float}
)
...
class ClientUpdateAutoScalingGroupMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationTypeDef(
    ...
    """
    Type definition for `ClientUpdateAutoScalingGroupMixedInstancesPolicyLaunchTemplate`
    `LaunchTemplateSpecification`
...
class DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsEnabledMetricsTypeDef(
    ...
    """
    Type definition for `DescribeAutoScalingGroupsPaginateResponseAutoScalingGroups`
    `EnabledMetrics`
...
class DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsInstancesLaunchTemplateTypeDef(
    ...
    """
    Type definition for `DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsInstances`
    `LaunchTemplate`
...
class DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsMixedInstancesPolicyInstancesDistributionTypeDef(
    ...
    """
    Type definition for
    `DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsMixedInstancesPolicy`
    `InstancesDistribution`
...
class DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsMixedInstancesPolicyLaunchTemplateLaunchTemplateSpecificationTypeDef(
    ...
    """
    Type definition for
    `DescribeAutoScalingGroupsPaginateResponseAutoScalingGroupsMixedInstancesPolicyLaunchTemplate`
    `LaunchTemplateSpecification`
...
class DescribeAutoScalingInstancesPaginateResponseAutoScalingInstancesLaunchTemplateTypeDef(
    ...
    """
    Type definition for `DescribeAutoScalingInstancesPaginateResponseAutoScalingInstances`
    `LaunchTemplate`
...
class DescribeLaunchConfigurationsPaginateResponseLaunchConfigurationsBlockDeviceMappingsEbsTypeDef(
    ...
    """
    Type definition for
    `DescribeLaunchConfigurationsPaginateResponseLaunchConfigurationsBlockDeviceMappings` `Ebs`
...
class DescribeLaunchConfigurationsPaginateResponseLaunchConfigurationsBlockDeviceMappingsTypeDef(
    ...
    """
    Type definition for `DescribeLaunchConfigurationsPaginateResponseLaunchConfigurations`
    `BlockDeviceMappings`
...
class DescribeLoadBalancerTargetGroupsPaginateResponseLoadBalancerTargetGroupsTypeDef(
    ...
    """
    Type definition for `DescribeLoadBalancerTargetGroupsPaginateResponse`
...
class DescribeNotificationConfigurationsPaginateResponseNotificationConfigurationsTypeDef(
    ...
    """
    Type definition for `DescribeNotificationConfigurationsPaginateResponse`
    `NotificationConfigurations`
...
class DescribePoliciesPaginateResponseScalingPoliciesTargetTrackingConfigurationCustomizedMetricSpecificationDimensionsTypeDef(
    ...
    """
    Type definition for
    `DescribePoliciesPaginateResponseScalingPoliciesTargetTrackingConfigurationCustomizedMetricSpecification`
    `Dimensions`
...
class DescribePoliciesPaginateResponseScalingPoliciesTargetTrackingConfigurationCustomizedMetricSpecificationTypeDef(
    ...
    """
    Type definition for `DescribePoliciesPaginateResponseScalingPoliciesTargetTrackingConfiguration`
    `CustomizedMetricSpecification`
...
class DescribePoliciesPaginateResponseScalingPoliciesTargetTrackingConfigurationTypeDef(
    ...
    """
    Type definition for `DescribePoliciesPaginateResponseScalingPolicies`
    `TargetTrackingConfiguration`
