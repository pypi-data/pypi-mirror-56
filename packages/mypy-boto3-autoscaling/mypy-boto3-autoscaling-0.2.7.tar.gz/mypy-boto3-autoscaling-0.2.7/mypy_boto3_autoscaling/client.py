"Main interface for autoscaling Client"
...
class Client(BaseClient):
    ...
    def attach_instances(
        ...
        When you attach instances, Amazon EC2 Auto Scaling increases the desired capacity of the group by
        the number of instances being attached. If the number of instances being attached plus the desired
        capacity of the group exceeds the maximum size of the group, the operation fails.

        If there is a Classic Load Balancer attached to your Auto Scaling group, the instances are also
        registered with the load balancer. If there are target groups attached to your Auto Scaling group,
        the instances are also registered with the target groups.

        For more information, see `Attach EC2 Instances to Your Auto Scaling Group
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/attach-instance-asg.html>`__ in the *Amazon
    ...
    def attach_load_balancer_target_groups(
        ...
        To describe the target groups for an Auto Scaling group, use  DescribeLoadBalancerTargetGroups . To
        detach the target group from the Auto Scaling group, use  DetachLoadBalancerTargetGroups .

        With Application Load Balancers and Network Load Balancers, instances are registered as targets with
        a target group. With Classic Load Balancers, instances are registered with the load balancer. For
        more information, see `Attaching a Load Balancer to Your Auto Scaling Group
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/attach-load-balancer-asg.html>`__ in the
    ...
    def attach_load_balancers(
        ...
        To describe the load balancers for an Auto Scaling group, use  DescribeLoadBalancers . To detach the
        load balancer from the Auto Scaling group, use  DetachLoadBalancers .
    ...
    def complete_lifecycle_action(
        ...
        * (Optional) Create a Lambda function and a rule that allows CloudWatch Events to invoke your Lambda
        ...
        * **If you finish before the timeout period ends, complete the lifecycle action.**
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/lifecycle-hooks.html>`__ in the *Amazon EC2
        ...
        **Request Syntax**
        ...
        :param LifecycleActionToken:
          ...
          an instance. Amazon EC2 Auto Scaling sends this token to the notification target you specified
    ...
    def create_auto_scaling_group(
        ...
        If you exceed your maximum limit of Auto Scaling groups, the call fails. For information about
        viewing this limit, see  DescribeAccountLimits . For information about updating this limit, see
        `Amazon EC2 Auto Scaling Limits
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-account-limits.html>`__ in the *Amazon EC2
        Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param MixedInstancesPolicy:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/APIReference/API_MixedInstancesPolicy.html>`__ in the
          *Amazon EC2 Auto Scaling API Reference* and `Auto Scaling Groups with Multiple Instance Types and
          Purchase Options
          ...
          - **LaunchTemplate** *(dict) --*
            ...
            - **LaunchTemplateSpecification** *(dict) --*
              ...
              - **Version** *(string) --*
                ...
                the value is ``$Default`` , Amazon EC2 Auto Scaling selects the default version of the
            ...
            - **Overrides** *(list) --*
              ...
              - *(dict) --*
                ...
                - **WeightedCapacity** *(string) --*
                  ...
                  The number of capacity units, which gives the instance type a proportional weight to other
                  instance types. For example, larger instance types are generally weighted more than
          ...
          - **InstancesDistribution** *(dict) --*
            ...
            - **OnDemandBaseCapacity** *(integer) --*
              ...
              .. note::
                ...
                An update to this setting means a gradual replacement of instances to maintain the specified
                number of On-Demand Instances for your base capacity. When replacing instances, Amazon EC2
            ...
            - **OnDemandPercentageAboveBaseCapacity** *(integer) --*
              ...
              .. note::
                ...
                percentage of On-Demand Instances for your additional capacity above the base capacity. When
                replacing instances, Amazon EC2 Auto Scaling launches new instances before terminating the
                old ones.
            ...
            - **SpotInstancePools** *(integer) --*
              ...
              are determined from the different instance types in the Overrides array of  LaunchTemplate .
            ...
            - **SpotMaxPrice** *(string) --*
              ...
              the value of this parameter blank (which is the default), the maximum Spot price is set at the
              On-Demand price.
        ...
        :param InstanceId:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-asg-from-instance.html>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param DesiredCapacity:
          ...
          The number of Amazon EC2 instances that the Auto Scaling group attempts to maintain. This number
          must be greater than or equal to the minimum size of the group and less than or equal to the
          maximum size of the group. If you do not specify a desired capacity, the default is the minimum
          size of the group.
        ...
        :param DefaultCooldown:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html>`__ in the *Amazon EC2 Auto
          Scaling User Guide* .

        :type AvailabilityZones: list
        :param AvailabilityZones:

          One or more Availability Zones for the group. This parameter is optional if you specify one or
          more subnets for ``VPCZoneIdentifier`` .
        ...
        :param LoadBalancerNames:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-load-balancer.html>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param HealthCheckType:
          ...
          The service to use for the health checks. The valid values are ``EC2`` and ``ELB`` . The default
          value is ``EC2`` . If you configure an Auto Scaling group to use ELB health checks, it considers
          the instance unhealthy if it fails either the EC2 status checks or the load balancer health
          checks.

          For more information, see `Health Checks for Auto Scaling Instances
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/healthcheck.html>`__ in the *Amazon EC2
          Auto Scaling User Guide* .
        ...
        :param HealthCheckGracePeriod:
          ...
          status of an EC2 instance that has come into service. During this time, any health check failures
        ...
        :param PlacementGroup:
          ...
          The name of the placement group into which to launch your instances, if any. A placement group is
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html>`__ in the *Amazon EC2
        ...
        :param TerminationPolicies:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-instance-termination.html>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param LifecycleHookSpecificationList:
          ...
          - *(dict) --*
            ...
            * If you need more time, record the lifecycle action heartbeat to keep the instance in a pending
            state using  RecordLifecycleActionHeartbeat .
            ...
            * If you finish before the timeout period ends, complete the lifecycle action using
            ...
            can modify an existing lifecycle hook or create new lifecycle hooks using  PutLifecycleHook . If
            you are no longer using a lifecycle hook, you can delete it using  DeleteLifecycleHook .
        ...
        :param Tags:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-tagging.html>`__ in the *Amazon
          EC2 Auto Scaling User Guide* .
        ...
        :param ServiceLinkedRoleARN:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-service-linked-role.html>`__ in
    ...
    def create_launch_configuration(
        ...
        If you exceed your maximum limit of launch configurations, the call fails. For information about
        viewing this limit, see  DescribeAccountLimits . For information about updating this limit, see
        `Amazon EC2 Auto Scaling Limits
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-account-limits.html>`__ in the *Amazon EC2
        Auto Scaling User Guide* .
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/LaunchConfiguration.html>`__ in the *Amazon
        EC2 Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param ImageId:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/finding-an-ami.html>`__ in the *Amazon EC2
          User Guide for Linux Instances* .
        ...
        :param KeyName:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-key-pairs.html>`__ in the *Amazon EC2
          User Guide for Linux Instances* .
        ...
        :param SecurityGroups:
          ...
          <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_SecurityGroups.html>`__ in the *Amazon
        ...
        :param ClassicLinkVPCId:
          ...
          see `ClassicLink <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/vpc-classiclink.html>`__ in
          the *Amazon EC2 User Guide for Linux Instances* and `Linking EC2-Classic Instances to a VPC
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html#as-ClassicLink>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param ClassicLinkVPCSecurityGroups:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/vpc-classiclink.html>`__ in the *Amazon EC2
          User Guide for Linux Instances* and `Linking EC2-Classic Instances to a VPC
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html#as-ClassicLink>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param UserData:
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-instance-metadata.html>`__ in the *Amazon
          EC2 User Guide for Linux Instances* .

            **This value will be base64 encoded automatically. Do not base64 encode this value prior to
        ...
        :param InstanceId:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/create-lc-with-instanceID.html>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param BlockDeviceMappings:
          ...
          virtual devices and EBS volumes. For more information, see `Block Device Mapping
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/block-device-mapping-concepts.html>`__ in the
          *Amazon EC2 User Guide for Linux Instances* .
          ...
          - *(dict) --*
            ...
            - **DeviceName** *(string) --* **[REQUIRED]**
              ...
              <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/device_naming.html>`__ in the *Amazon EC2
              User Guide for Linux Instances* .
            ...
            - **Ebs** *(dict) --*
              ...
              - **SnapshotId** *(string) --*
                ...
                ``SnapshotId`` and ``VolumeSize`` , ``VolumeSize`` must be equal or greater than the size of
                the snapshot.
              ...
              - **Encrypted** *(boolean) --*
                ...
                to instances that support Amazon EBS encryption. For more information, see `Supported
                Instance Types
                ...
                .. note::
                  ...
                  Volumes that are created from encrypted snapshots are automatically encrypted, and volumes
                  that are created from unencrypted snapshots are automatically unencrypted. By default,
                  encrypted snapshots use the AWS managed CMK that is used for EBS encryption, but you can
                  specify a custom CMK when you create the snapshot. The ability to encrypt a snapshot
                  during copying also allows you to apply a new CMK to an already-encrypted snapshot.
        ...
        :param SpotPrice:
          ...
          information, see `Launching Spot Instances in Your Auto Scaling Group
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-launch-spot-instances.html>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
        ...
        :param IamInstanceProfile:
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/us-iam-role.html>`__ in the *Amazon EC2
          Auto Scaling User Guide* .
        ...
        :param EbsOptimized:
          ...
          not EBS-optimized by default. For more information, see `Amazon EBS-Optimized Instances
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSOptimized.html>`__ in the *Amazon EC2 User
        ...
        :param AssociatePublicIpAddress:
          ...
          assign a public IP address to the group's instances. If you specify ``true`` , each instance in
          the Auto Scaling group receives a unique public IP address. For more information, see `Launching
          Auto Scaling Instances in a VPC
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html>`__ in the *Amazon EC2 Auto
          Scaling User Guide* .
          ...
          .. note::
            ...
            unless you disabled the option to assign a public IP address on the subnet. If the instance is
            launched into a nondefault subnet, the default is not to assign a public IP address, unless you
        ...
        :param PlacementTenancy:
          ...
          attribute set to ``default`` ), you must set the value of this parameter to ``dedicated`` .
          ...
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/asg-in-vpc.html#as-vpc-tenancy>`__ in the
          *Amazon EC2 Auto Scaling User Guide* .
    ...
    def delete_auto_scaling_group(
        ...
        If the group has instances or scaling activities in progress, you must specify the option to force
        the deletion in order for it to succeed.

        If the group has policies, deleting the group deletes the policies, the underlying alarm actions,
        and any alarm that no longer has an associated action.

        To remove instances from the Auto Scaling group before deleting it, call  DetachInstances with the
        list of instances and the option to decrement the desired capacity. This ensures that Amazon EC2
        Auto Scaling does not launch replacement instances.

        To terminate all instances before deleting the Auto Scaling group, call  UpdateAutoScalingGroup and
        ...
        **Request Syntax**
        ...
        :param ForceDelete:
          ...
          without waiting for all instances to be terminated. This parameter also deletes any lifecycle
    ...
    def delete_launch_configuration(self, LaunchConfigurationName: str) -> None:
        ...
        The launch configuration must not be attached to an Auto Scaling group. When this call completes,
    ...
    def delete_policy(self, PolicyName: str, AutoScalingGroupName: str = None) -> None:
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/deleting-scaling-policy.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
    ...
    def describe_account_limits(
        ...
        For information about requesting an increase in these limits, see `Amazon EC2 Auto Scaling Limits
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-account-limits.html>`__ in the *Amazon EC2
        Auto Scaling User Guide* .
            ...
            - **LifecycleHooks** *(list) --*
              ...
              - *(dict) --*
                ...
                - **NotificationTargetARN** *(string) --*
                  ...
                  The ARN of the target that Amazon EC2 Auto Scaling sends notifications to when an instance
                  is in the transition state for the lifecycle hook. The notification target can be either
    ...
    def describe_load_balancers(
        ...
        This operation describes only Classic Load Balancers. If you have Application Load Balancers or
        Network Load Balancers, use  DescribeLoadBalancerTargetGroups instead.
          ...
          - *(dict) --*
            ...
            - **LoadBalancers** *(list) --*
              ...
              - *(dict) --*
                ...
                the load balancer, the state transitions to ``InService`` after at least one instance in the
                group passes the health check. If EC2 health checks are enabled instead, the load balancer
                ...
                - **State** *(string) --*
                  ...
                  * ``Removing`` - The instances in the group are being deregistered from the load balancer.
                  If connection draining is enabled, Elastic Load Balancing waits for in-flight requests to
                  complete before deregistering the instances.
    ...
    def describe_metric_collection_types(
        ...
        The ``GroupStandbyInstances`` metric is not returned by default. You must explicitly request this
        metric when calling  EnableMetricsCollection .
    ...
    def describe_scheduled_actions(
        ...
        """
        Describes the actions scheduled for your Auto Scaling group that haven't run or that have not
        reached their end time. To describe the actions that have already run, use
    ...
    def describe_tags(
        ...
        You can use filters to limit the results. For example, you can query for the tags for a specific
        Auto Scaling group. You can specify multiple values for a filter. A tag must match at least one of
        the specified values for it to be included in the results.

        You can also specify multiple filters. The result includes information for a particular tag only if
    ...
    def describe_termination_policy_types(
        ...
        For more information, see `Controlling Which Auto Scaling Instances Terminate During Scale In
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-instance-termination.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
    ...
    def detach_instances(
        ...
        deregistered from the load balancer. If there are target groups attached to the Auto Scaling group,
        the instances are deregistered from the target groups.

        For more information, see `Detach EC2 Instances from Your Auto Scaling Group
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/detach-instance-asg.html>`__ in the *Amazon
        EC2 Auto Scaling User Guide* .
    ...
    def detach_load_balancers(
        ...
        This operation detaches only Classic Load Balancers. If you have Application Load Balancers or
        Network Load Balancers, use  DetachLoadBalancerTargetGroups instead.

        When you detach a load balancer, it enters the ``Removing`` state while deregistering the instances
        in the group. When all instances are deregistered, then you can no longer describe the load balancer
        using  DescribeLoadBalancers . The instances remain running.
    ...
    def enable_metrics_collection(
        ...
        """
        Enables group metrics for the specified Auto Scaling group. For more information, see `Monitoring
        Your Auto Scaling Groups and Instances
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-instance-monitoring.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
    ...
    def enter_standby(
        ...
        standby as long as the desired capacity of the Auto Scaling group after the instances are placed
        into standby is equal to or greater than the minimum capacity of the group.

        If you choose not to decrement the desired capacity of the Auto Scaling group, the Auto Scaling
        group launches new instances to replace the instances on standby.

        For more information, see `Temporarily Removing Instances from Your Auto Scaling Group
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-enter-exit-standby.html>`__ in the *Amazon
        EC2 Auto Scaling User Guide* .
    ...
    def execute_policy(
        ...
        **Request Syntax**
        ...
        :param MetricValue:
          ...
          is 50 and you want to use a step adjustment with a lower bound of 0 and an upper bound of 10, you
          can set the metric value to 59.

          If you specify a metric value that doesn't correspond to a step adjustment for the policy, the
    ...
    def put_lifecycle_hook(
        ...
        * If you finish before the timeout period ends, complete the lifecycle action using
        ...
        You can view the lifecycle hooks for an Auto Scaling group using  DescribeLifecycleHooks . If you
        are no longer using a lifecycle hook, you can delete it using  DeleteLifecycleHook .
        ...
        **Request Syntax**
        ...
        :param LifecycleTransition:
          ...
          * autoscaling:EC2_INSTANCE_TERMINATING
          ...
          Conditional: This parameter is required for new lifecycle hooks, but optional when updating
          existing hooks.
        ...
        :param NotificationTargetARN:
          ...
          instance is in the transition state for the lifecycle hook. This target can be either an SQS queue
          or an SNS topic.
        ...
        :param HeartbeatTimeout:
          ...
          the ``DefaultResult`` parameter. You can prevent the lifecycle hook from timing out by calling
        ...
        :param DefaultResult:
          ...
          if an unexpected failure occurs. This parameter can be either ``CONTINUE`` or ``ABANDON`` . The
          default value is ``ABANDON`` .
    ...
    def put_notification_configuration(
        ...
        For more information, see `Getting Amazon SNS Notifications When Your Auto Scaling Group Scales
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/ASGettingNotifications.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param NotificationTypes: **[REQUIRED]**
          ...
          types supported by Amazon EC2 Auto Scaling, see  DescribeAutoScalingNotificationTypes .
    ...
    def put_scaling_policy(
        ...
        """
        Creates or updates a scaling policy for an Auto Scaling group. To update an existing scaling policy,
        use the existing policy name and set the parameters to change. Any existing parameter not changed in
        ...
        see `Dynamic Scaling
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-scale-based-on-demand.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param ScalingAdjustment:
          ...
          parameter (either an absolute number or a percentage). A positive value adds to the current
          capacity and a negative value subtracts from the current capacity. For exact capacity, you must
        ...
        :param Cooldown:
          ...
          scaling activities can start. If this parameter is not specified, the default cooldown period for
          the group applies.
        ...
        :param TargetTrackingConfiguration:
          ...
          - **PredefinedMetricSpecification** *(dict) --*
            ...
            - **ResourceLabel** *(string) --*
              ...
              unless the metric type is ``ALBRequestCountPerTarget`` and there is a target group attached to
    ...
    def put_scheduled_update_group_action(
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/schedule_time.html>`__ in the *Amazon EC2
        Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param StartTime:
          ...
          quotes (for example, ``"2019-06-01T00:00:00Z"`` ).
        ...
        :param Recurrence:
          ...
          The recurring schedule for this action, in Unix cron syntax format. This format consists of five
          fields separated by white spaces: [Minute] [Hour] [Day_of_Month] [Month_of_Year] [Day_of_Week].
          The value must be in quotes (for example, ``"30 0 1 1,6,12 *"`` ). For more information about this
          format, see `Crontab <http://crontab.org>`__ .
    ...
    def record_lifecycle_action_heartbeat(
        ...
        extends the timeout by the length of time defined using  PutLifecycleHook .
        ...
        * If you finish before the timeout period ends, complete the lifecycle action.
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/AutoScalingGroupLifecycle.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param LifecycleActionToken:
          ...
          A token that uniquely identifies a specific lifecycle action associated with an instance. Amazon
          EC2 Auto Scaling sends this token to the notification target that you specified when you created
          the lifecycle hook.
    ...
    def resume_processes(
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/as-suspend-resume-processes.html>`__ in the
        *Amazon EC2 Auto Scaling User Guide* .
    ...
    def set_desired_capacity(
        ...
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/what-is-amazon-ec2-auto-scaling.html>`__ in
        the *Amazon EC2 Auto Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param HonorCooldown:
          ...
          Indicates whether Amazon EC2 Auto Scaling waits for the cooldown period to complete before
          initiating a scaling activity to set your Auto Scaling group to its new capacity. By default,
          Amazon EC2 Auto Scaling does not honor the cooldown period during manual scaling activities.
    ...
    def set_instance_health(
        ...
        For more information, see `Health Checks for Auto Scaling Instances
        <https://docs.aws.amazon.com/autoscaling/ec2/userguide/healthcheck.html>`__ in the *Amazon EC2 Auto
        Scaling User Guide* .
        ...
        **Request Syntax**
        ...
        :param HealthStatus: **[REQUIRED]**
          ...
          The health status of the instance. Set to ``Healthy`` to have the instance remain in service. Set
          to ``Unhealthy`` to have the instance be out of service. Amazon EC2 Auto Scaling terminates and
        ...
        :param ShouldRespectGracePeriod:
          ...
          the group, by default, this call respects the grace period. Set this to ``False`` , to have the
          ...
          ::

            {
                'Activity': {
                    ...
                    |'MidLifecycleAction'|'WaitingForInstanceWarmup'|'Successful'|'Failed'|'Cancelled',
                    'StatusMessage': 'string',
                    'Progress': 123,
                    'Details': 'string'
                }
    ...
    def update_auto_scaling_group(
        ...
        change. Any parameters that you don't specify are not changed by this update request. The new
        settings take effect on any scaling activities after this call returns.
        ...
        configuration that they were originally launched with. When you update a group to specify a mixed
        instances policy instead of a launch configuration or template, existing instances may be replaced
        to match the new purchasing options that you specified in the policy. For example, if the group
        currently has 100% On-Demand capacity and the policy specifies 50% Spot capacity, this means that
        half of your instances will be gradually terminated and relaunched as Spot Instances. When replacing
        instances, Amazon EC2 Auto Scaling launches new instances before terminating the old ones, so that
        updating your group does not compromise the performance or availability of your application.

        Note the following about changing ``DesiredCapacity`` , ``MaxSize`` , or ``MinSize`` :

        * If a scale-in event occurs as a result of a new ``DesiredCapacity`` value that is lower than the
        current size of the group, the Auto Scaling group uses its termination policy to determine which
        ...
        * If you specify a new value for ``MaxSize`` without specifying a value for ``DesiredCapacity`` ,
        ...
        To see which parameters have been set, use  DescribeAutoScalingGroups . You can also view the
        scaling policies for an Auto Scaling group using  DescribePolicies . If the group has scaling
        policies, you can update them using  PutScalingPolicy .
        ...
        **Request Syntax**
        ...
        :param DesiredCapacity:
          ...
          greater than or equal to the minimum size of the group and less than or equal to the maximum size
          of the group.
        ...
        :param DefaultCooldown:
          ...
          The amount of time, in seconds, after a scaling activity completes before another scaling activity
          can start. The default value is ``300`` . This cooldown period is not used when a scaling-specific
          cooldown is specified.

          Cooldown periods are not supported for target tracking scaling policies, step scaling policies, or
          scheduled scaling. For more information, see `Scaling Cooldowns
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/Cooldown.html>`__ in the *Amazon EC2 Auto
          Scaling User Guide* .
        ...
        :param HealthCheckType:
          ...
          configure an Auto Scaling group to use ELB health checks, it considers the instance unhealthy if
        ...
        :param ServiceLinkedRoleARN:
          ...
          The Amazon Resource Name (ARN) of the service-linked role that the Auto Scaling group uses to call
          other AWS services on your behalf. For more information, see `Service-Linked Roles
          <https://docs.aws.amazon.com/autoscaling/ec2/userguide/autoscaling-service-linked-role.html>`__ in
          the *Amazon EC2 Auto Scaling User Guide* .
