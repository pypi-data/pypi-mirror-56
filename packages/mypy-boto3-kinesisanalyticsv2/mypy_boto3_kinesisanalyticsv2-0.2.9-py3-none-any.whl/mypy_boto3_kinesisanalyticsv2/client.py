"Main interface for kinesisanalyticsv2 Client"
...
class Client(BaseClient):
    ...
    def add_application_cloud_watch_logging_option(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/AddApplicationCloudWatchLoggingOption>`_
    ...
    def add_application_input(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/AddApplicationInput>`_
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          The current version of your application. You can use the  DescribeApplication operation to
    ...
    def add_application_input_processing_configuration(
        ...
        """
        Adds an  InputProcessingConfiguration to an SQL-based Kinesis Data Analytics application. An
        ...
        <https://aws.amazon.com/documentation/lambda/>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/AddApplicationInputProcessingConfiguration>`_
    ...
    def add_application_output(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/AddApplicationOutput>`_
          ...
          - *(dict) --*
            ...
            - **OutputDescriptions** *(list) --*
              ...
              - *(dict) --*
                ...
                For an SQL-based Amazon Kinesis Data Analytics application, describes the
                application output configuration, which includes the in-application stream name and
                the destination where the stream data is written. The destination can be a Kinesis
    ...
    def add_application_reference_data_source(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/AddApplicationReferenceDataSource>`_
        ...
        **Request Syntax**
        ...
        :param ReferenceDataSource: **[REQUIRED]**
          ...
          created. You provide an S3 bucket, object key name, and the resulting in-application table
          that is created.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ApplicationVersionId** *(integer) --*
              ...
              The updated application version ID. Amazon Kinesis Data Analytics increments this ID
    ...
    def add_application_vpc_configuration(
        ...
        VPCs to store and access resources securely.

        Note the following about VPC configurations for Kinesis Data Analytics applications:

        * VPC configurations are not supported for SQL applications.

        * When a VPC is added to a Kinesis Data Analytics application, the application can no longer
        be accessed from the Internet directly. To enable Internet access to the application, add an
        Internet gateway to your VPC.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/AddApplicationVpcConfiguration>`_
        ...
        **Request Syntax**
        ...
        :param VpcConfiguration: **[REQUIRED]**
          ...
          - **SubnetIds** *(list) --* **[REQUIRED]**
            ...
            The array of `Subnet
            <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Subnet.html>`__ IDs used by
          ...
          - **SecurityGroupIds** *(list) --* **[REQUIRED]**
            ...
            <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SecurityGroup.html>`__ IDs
          ...
          - *(dict) --*
            ...
            - **VpcConfigurationDescription** *(dict) --*
              ...
              - **SubnetIds** *(list) --*
                ...
                The array of `Subnet
                <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Subnet.html>`__ IDs used
              ...
              - **SecurityGroupIds** *(list) --*
                ...
                The array of `SecurityGroup
                <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_SecurityGroup.html>`__
    ...
    def create_application(
        ...
        <https://docs.aws.amazon.com/kinesisanalytics/latest/java/getting-started.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/CreateApplication>`_
        ...
        **Request Syntax**
          ...
          - **SqlApplicationConfiguration** *(dict) --*
            ...
            - **Inputs** *(list) --*
              ...
              - *(dict) --*
                ...
                Analytics application, you specify the streaming source, the in-application stream
            ...
            - **Outputs** *(list) --*
              ...
              - *(dict) --*
                ...
                where you want the in-application stream data to be written. The destination can be
            ...
            - **ReferenceDataSources** *(list) --*
              ...
              The array of  ReferenceDataSource objects describing the reference data sources used
              by the application.

              - *(dict) --*

                For an SQL-based Amazon Kinesis Data Analytics application, describes the reference
                data source by providing the source information (Amazon S3 bucket name and object
                key name), the resulting in-application table name that is created, and the
          ...
          - **FlinkApplicationConfiguration** *(dict) --*
            ...
            - **CheckpointConfiguration** *(dict) --*
              ...
              - **MinPauseBetweenCheckpoints** *(integer) --*
                ...
                than the ``CheckpointInterval`` , the application otherwise performs continual
                checkpoint operations. For more information, see `Tuning Checkpointing
            ...
            - **MonitoringConfiguration** *(dict) --*
              ...
              - **ConfigurationType** *(string) --* **[REQUIRED]**
                ...
                application. You must set this property to ``CUSTOM`` in order to set the
            ...
            - **ParallelismConfiguration** *(dict) --*
              ...
              - **ConfigurationType** *(string) --* **[REQUIRED]**
                ...
                Analytics service. You must set this property to ``CUSTOM`` in order to change your
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            resources. If you specify a tag that already exists, the tag value is replaced with the
            value that you specify in the request. Note that the maximum number of application tags
                ...
                - **SqlApplicationConfigurationDescription** *(dict) --*
                        ...
                        - **InputLambdaProcessorDescription** *(dict) --*
                          ...
                          - **RoleARN** *(string) --*
                            ...
                            .. note::
                              ...
                              Provided for backward compatibility. Applications that are created
                  ...
                  - **OutputDescriptions** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      name and the destination where the stream data is written. The destination can
                ...
                - **FlinkApplicationConfigurationDescription** *(dict) --*
                  ...
                  - **CheckpointConfigurationDescription** *(dict) --*
                    ...
                    - **CheckpointInterval** *(integer) --*
                      ...
                      .. note::
                        ...
                        If ``CheckpointConfiguration.ConfigurationType`` is ``DEFAULT`` , the
                        application will use a ``CheckpointInterval`` vaue of 60000, even if this
                    ...
                    - **MinPauseBetweenCheckpoints** *(integer) --*
                      ...
                      .. note::
                        ...
                        If ``CheckpointConfiguration.ConfigurationType`` is ``DEFAULT`` , the
                        application will use a ``MinPauseBetweenCheckpoints`` value of 5000, even if
                        this value is set using this API or in application code.
                  ...
                  - **ParallelismConfigurationDescription** *(dict) --*
                    ...
                    - **Parallelism** *(integer) --*
                      ...
                      up to the maximum parallelism, which is ``ParalellismPerKPU`` times the
                    ...
                    - **CurrentParallelism** *(integer) --*
                      ...
                      load. The service can increase this value up to the maximum parallelism, which
                  ...
                  - **JobPlanDescription** *(string) --*
                    ...
                    in the `Apache Flink Documentation
                    <https://ci.apache.org/projects/flink/flink-docs-release-1.6/>`__ . To retrieve
                    the job plan for the application, use the
                ...
                - **VpcConfigurationDescriptions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **SubnetIds** *(list) --*
                      ...
                      The array of `Subnet
                      <https://docs.aws.amazon.com/AWSEC2/latest/APIReference/API_Subnet.html>`__
                      IDs used by the VPC configuration.
    ...
    def create_application_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/CreateApplicationSnapshot>`_
    ...
    def delete_application(self, ApplicationName: str, CreateTimestamp: datetime) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplication>`_
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplicationCloudWatchLoggingOption>`_
    ...
    def delete_application_input_processing_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplicationInputProcessingConfiguration>`_
        ...
        **Request Syntax**
        ...
        :param InputId: **[REQUIRED]**
          ...
          You can get a list of the input IDs for an application by using the  DescribeApplication
          operation.
    ...
    def delete_application_output(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplicationOutput>`_
    ...
    def delete_application_reference_data_source(
        ...
        """
        Deletes a reference data source configuration from the specified SQL-based Amazon Kinesis
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplicationReferenceDataSource>`_
    ...
    def delete_application_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplicationSnapshot>`_
    ...
    def delete_application_vpc_configuration(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DeleteApplicationVpcConfiguration>`_
    ...
    def describe_application(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DescribeApplication>`_
        ...
        **Request Syntax**
        ...
        :param IncludeAdditionalDetails:
          ...
          Displays verbose information about a Kinesis Data Analytics application, including the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ApplicationDetail** *(dict) --*
              ...
              Provides a description of the application, such as the application's Amazon Resource
    ...
    def describe_application_snapshot(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DescribeApplicationSnapshot>`_
    ...
    def discover_input_schema(
        ...
        Firehose delivery stream) or Amazon S3 object. In the response, the operation returns the
        ...
        When you create an application using the Kinesis Data Analytics console, the console uses
        this operation to infer a schema and show it in the console user interface.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/DiscoverInputSchema>`_
            ...
            - **InputSchema** *(dict) --*
              ...
              - **RecordColumns** *(list) --*
                ...
                - *(dict) --*
                  ...
                  of each data element in the streaming source to the corresponding column in the
                  in-application stream.
    ...
    def list_applications(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If a previous command returned a pagination token, pass it into this value to retrieve the
          next set of results. For more information about pagination, see `Using the AWS Command
                ...
                'ApplicationSummaries': [
                    {
                        ...
                        'ApplicationARN': 'string',
                        'ApplicationStatus':
                        'DELETING'|'STARTING'|'STOPPING'|'READY'|'RUNNING'
                        |'UPDATING',
                        'ApplicationVersionId': 123,
                        'RuntimeEnvironment': 'SQL-1_0'|'FLINK-1_6'
                    },
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              additional results. Pass this token into a subsequent command to retrieve the next set
              of items For more information about pagination, see `Using the AWS Command Line
    ...
    def list_tags_for_resource(self, ResourceARN: str) -> ClientListTagsForResourceResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/ListTagsForResource>`_
          ...
          - *(dict) --*
            ...
            - **Tags** *(list) --*
              ...
              - *(dict) --*
                ...
                A key-value pair (the value is optional) that you can define and assign to AWS
                resources. If you specify a tag that already exists, the tag value is replaced with
                the value that you specify in the request. Note that the maximum number of
    ...
    def start_application(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/StartApplication>`_
          ...
          response = client.start_application(
              ...
              RunConfiguration={
                  ...
                  'ApplicationRestoreConfiguration': {
                      'ApplicationRestoreType':
                      'SKIP_RESTORE_FROM_SNAPSHOT'|'RESTORE_FROM_LATEST_SNAPSHOT'
                      |'RESTORE_FROM_CUSTOM_SNAPSHOT',
                      'SnapshotName': 'string'
                  }
              }
        ...
        :param RunConfiguration: **[REQUIRED]**
          ...
          - **FlinkRunConfiguration** *(dict) --*
            ...
            - **AllowNonRestoredState** *(boolean) --*
              ...
              When restoring from a savepoint, specifies whether the runtime is allowed to skip a
              state that cannot be mapped to the new program. This will happen if the program is
              updated between savepoints to remove stateful parameters, and state data in the
    ...
    def stop_application(self, ApplicationName: str) -> Dict[str, Any]:
        ...
        running state. You can use the  DescribeApplication operation to find the application state.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/StopApplication>`_
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/TagResource>`_
    ...
    def untag_resource(self, ResourceARN: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/UntagResource>`_
    ...
    def update_application(
        ...
        """
        Updates an existing Amazon Kinesis Data Analytics application. Using this operation, you can
        update application code, input configuration, and output configuration.

        Kinesis Data Analytics updates the ``ApplicationVersionId`` each time you update your
        application.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/kinesisanalyticsv2-2018-05-23/UpdateApplication>`_
          ...
          - **SqlApplicationConfigurationUpdate** *(dict) --*
            ...
            - **ReferenceDataSourceUpdates** *(list) --*
              ...
              - *(dict) --*
                ...
                source bucket name and object key name), the in-application table name that is
                created, and updated mapping information that maps the data in the Amazon S3 object
          ...
          - **FlinkApplicationConfigurationUpdate** *(dict) --*
            ...
            - **CheckpointConfigurationUpdate** *(dict) --*
              ...
              - **ConfigurationTypeUpdate** *(string) --*
                ...
                of Kinesis Data Analytics. You must set this property to ``CUSTOM`` in order to set
                the ``CheckpointingEnabled`` , ``CheckpointInterval`` , or
                ``MinPauseBetweenCheckpoints`` parameters.
            ...
            - **ParallelismConfigurationUpdate** *(dict) --*
              ...
              - **ConfigurationTypeUpdate** *(string) --*
                ...
                Kinesis Data Analytics service, or if a custom parallelism is used. You must set
                this property to ``CUSTOM`` in order to change your application's
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_application_snapshots` operation.
        """
