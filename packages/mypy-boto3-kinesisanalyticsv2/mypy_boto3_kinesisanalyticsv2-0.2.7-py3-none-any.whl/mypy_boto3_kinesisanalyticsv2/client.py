...
class Client(BaseClient):
    ...
    def add_application_cloud_watch_logging_option(
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          The version ID of the Kinesis Data Analytics application. You can retrieve the application version
    ...
    def add_application_input(
        ...
        You can add a streaming source when you create an application, or you can use this operation to add
        a streaming source after you create an application. For more information, see  CreateApplication .
          ...
          - *(dict) --*
            ...
            - **InputDescriptions** *(list) --*
              ...
              - *(dict) --*
                ...
                Describes the application input configuration for an SQL-based Amazon Kinesis Data Analytics
                application.
    ...
    def add_application_input_processing_configuration(
        ...
        **Request Syntax**
        ...
        :param CurrentApplicationVersionId: **[REQUIRED]**
          ...
          The version of the application to which you want to add the input processing configuration. You
          can use the  DescribeApplication operation to get the current application version. If the version
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **InputId** *(string) --*
              ...
              The input ID that is associated with the application input. This is the ID that Amazon Kinesis
              Data Analytics assigns to each input configuration that you add to your application.
    ...
    def add_application_output(
        ...
        to an external destination so that you can analyze the errors.
        ...
        **Request Syntax**
        ...
        :param Output: **[REQUIRED]**
          ...
          Kinesis Data Firehose delivery stream, or an AWS Lambda function), and record the formation to use
          ...
          - *(dict) --*
            ...
            - **OutputDescriptions** *(list) --*
              ...
              - *(dict) --*
                ...
                For an SQL-based Amazon Kinesis Data Analytics application, describes the application output
                configuration, which includes the in-application stream name and the destination where the
                stream data is written. The destination can be a Kinesis data stream or a Kinesis Data
            ...
            - **ReferenceDataSourceDescriptions** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ReferenceId** *(string) --*
                  ...
                  when you add the reference data source to your application using the  CreateApplication or
    ...
    def create_application(
        ...
        **Request Syntax**
          ...
          - **FlinkApplicationConfiguration** *(dict) --*
            ...
            - **CheckpointConfiguration** *(dict) --*
              ...
              - **MinPauseBetweenCheckpoints** *(integer) --*
                ...
                For more information, see `Tuning Checkpointing
        ...
        :param Tags:
          ...
          number of user-defined application tags is 50. For more information, see `Using Cost Allocation
          Tags <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html>`__ in the
          *AWS Billing and Cost Management Guide* .
          ...
          - *(dict) --*
            ...
            number of user-defined application tags is 50. For more information, see `Using Cost Allocation
            Tags <https://docs.aws.amazon.com/awsaccountbilling/latest/aboutv2/cost-alloc-tags.html>`__ in
    ...
    def delete_application(
        ...
        """
        Deletes the specified application. Kinesis Data Analytics halts application execution and deletes
        the application.
    ...
    def delete_application_cloud_watch_logging_option(
        ...
        **Request Syntax**
        ...
        :param CloudWatchLoggingOptionId: **[REQUIRED]**
          ...
          The ``CloudWatchLoggingOptionId`` of the Amazon CloudWatch logging option to delete. You can get
          the ``CloudWatchLoggingOptionId`` by using the  DescribeApplication operation.
    ...
    def delete_application_output(
        ...
        """
        Deletes the output destination configuration from your SQL-based Amazon Kinesis Data Analytics
        ...
        **Request Syntax**
        ...
        :param OutputId: **[REQUIRED]**
          ...
          unique ID. You need to provide the ID to uniquely identify the output configuration that you want
          to delete from the application configuration. You can use the  DescribeApplication operation to
    ...
    def delete_application_reference_data_source(
        ...
        """
        Deletes a reference data source configuration from the specified SQL-based Amazon Kinesis Data
        ...
        **Request Syntax**
        ...
        :param ReferenceId: **[REQUIRED]**
          ...
          The ID of the reference data source. When you add a reference data source to your application
          using the  AddApplicationReferenceDataSource , Kinesis Data Analytics assigns an ID. You can use
          the  DescribeApplication operation to get the reference ID.
    ...
    def discover_input_schema(
        ...
        """
        Infers a schema for an SQL-based Amazon Kinesis Data Analytics application by evaluating sample
        records on the specified streaming source (Kinesis data stream or Kinesis Data Firehose delivery
        stream) or Amazon S3 object. In the response, the operation returns the inferred schema and also the
        sample records that the operation used to infer the schema.

        You can use the inferred schema when configuring a streaming source for your application. When you
        create an application using the Kinesis Data Analytics console, the console uses this operation to
    ...
    def list_applications(
        ...
        """
        Returns a list of Amazon Kinesis Data Analytics applications in your account. For each application,
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If a previous command returned a pagination token, pass it into this value to retrieve the next
          set of results. For more information about pagination, see `Using the AWS Command Line Interface's
          Pagination Options <https://docs.aws.amazon.com/cli/latest/userguide/pagination.html>`__ .
    ...
    def start_application(
        self,
        ApplicationName: str,
        RunConfiguration: ClientStartApplicationRunConfigurationTypeDef,
    ) -> Dict[str, Any]:
        """
        Starts the specified Amazon Kinesis Data Analytics application. After creating an application, you
    ...
    def stop_application(self, ApplicationName: str) -> Dict[str, Any]:
        ...
        state. You can use the  DescribeApplication operation to find the application state.
    ...
    def update_application(
        ...
        """
        Updates an existing Amazon Kinesis Data Analytics application. Using this operation, you can update
          ...
          - **SqlApplicationConfigurationUpdate** *(dict) --*
            ...
            - **InputUpdates** *(list) --*
              ...
              - *(dict) --*
                ...
                - **KinesisStreamsInputUpdate** *(dict) --*
                  ...
                  If a Kinesis data stream is the streaming source to be updated, provides an updated stream
                ...
                - **KinesisFirehoseInputUpdate** *(dict) --*
                  ...
                  If a Kinesis Data Firehose delivery stream is the streaming source to be updated, provides
            ...
            - **ReferenceDataSourceUpdates** *(list) --*
              ...
              - *(dict) --*
                ...
                bucket name and object key name), the in-application table name that is created, and updated
                mapping information that maps the data in the Amazon S3 object to the in-application
          ...
          - **FlinkApplicationConfigurationUpdate** *(dict) --*
            ...
            - **CheckpointConfigurationUpdate** *(dict) --*
              ...
              - **MinPauseBetweenCheckpointsUpdate** *(integer) --*
                ...
                Describes updates to the minimum time in milliseconds after a checkpoint operation completes
