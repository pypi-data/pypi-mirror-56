...
class SocieteInfoClient(object):
    ...
    def autocomplete_companies(self, search, limit=10, include_inactive_companies=True, include_establishments=False):
        """
        ...
        :param int limit: Number of results per page, limited to 25.
