...
class Client(BaseClient):
    ...
    def create_group(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          The name of the group, which is the identifier of the group in other operations. A resource group
          name cannot be updated after it is created. A resource group name can have a maximum of 128
          characters, including letters, numbers, hyphens, dots, and underscores. The name cannot start with
        ...
        :param ResourceQuery: **[REQUIRED]**
          ...
          - **Type** *(string) --* **[REQUIRED]**
             ...
             * ``TAG_FILTERS_1_0:`` * A JSON syntax that lets you specify a collection of simple tag filters
             for resource types and tags, as supported by the AWS Tagging API `GetResources
             <https://docs.aws.amazon.com/resourcegroupstagging/latest/APIReference/API_GetResources.html>`__
             operation. If you specify more than one tag key, only resources that match all tag keys, and at
             least one value of each specified tag key, are returned in your query. If you specify more than
             one value for a tag key, a resource matches the filter if it has a tag key value that matches
        ...
        :param Tags:
          ...
          The tags to add to the group. A tag is a string-to-string map of key-value pairs. Tag keys can
    ...
    def delete_group(self, GroupName: str) -> ClientDeleteGroupResponseTypeDef:
        ...
        members of the group; it only deletes the group structure.
    ...
    def get_tags(self, Arn: str) -> ClientGetTagsResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param Arn: **[REQUIRED]**
          ...
          The ARN of the resource group for which you want a list of tags. The resource must exist within
    ...
    def list_group_resources(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The NextToken value that is returned in a paginated ListGroupResources request. To get the next
    ...
    def list_groups(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The NextToken value that is returned in a paginated ``ListGroups`` request. To get the next page
    ...
    def search_resources(
        ...
        """
        Returns a list of AWS resource identifiers that matches a specified query. The query uses the same
        format as a resource query in a CreateGroup or UpdateGroupQuery operation.
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of group member ARNs returned by ``SearchResources`` in paginated output. By
          default, this number is 50.

        :type NextToken: string
        :param NextToken:

          The NextToken value that is returned in a paginated ``SearchResources`` request. To get the next
          page of results, run the call again, add the NextToken parameter, and specify the NextToken value.
    ...
    def tag(self, Arn: str, Tags: List[str]) -> ClientTagResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          The tags to add to the specified resource. A tag is a string-to-string map of key-value pairs. Tag
