"Main interface for resource-groups Client"
...
class Client(BaseClient):
    ...
    def create_group(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/CreateGroup>`_
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          resource group name cannot be updated after it is created. A resource group name can have
          a maximum of 128 characters, including letters, numbers, hyphens, dots, and underscores.
        ...
        :param ResourceQuery: **[REQUIRED]**
          ...
          - **Type** *(string) --* **[REQUIRED]**
             ...
             * ``TAG_FILTERS_1_0:`` * A JSON syntax that lets you specify a collection of simple tag
             ...
             keys, and at least one value of each specified tag key, are returned in your query. If
             you specify more than one value for a tag key, a resource matches the filter if it has
             a tag key value that matches *any* of the specified values.
        ...
        :param Tags:
          ...
          The tags to add to the group. A tag is a string-to-string map of key-value pairs. Tag keys
            ...
            - **ResourceQuery** *(dict) --*
              ...
              - **Type** *(string) --*
                 ...
                 * ``TAG_FILTERS_1_0:`` * A JSON syntax that lets you specify a collection of simple
                 tag filters for resource types and tags, as supported by the AWS Tagging API
                 `GetResources
                 <https://docs.aws.amazon.com/resourcegroupstagging/latest/APIReference/API_GetResources.html>`__
                 operation. If you specify more than one tag key, only resources that match all tag
                ...
                * An S3 bucket that has the following two tags: {"Key":"Stage","Value":"Test"}, and
                ...
                instance does not have all tag keys specified in the filter, so it is rejected. The
                RDS database has all of the tag keys, but no values that match at least one of the
                specified tag key values in the filter.
                ...
                * An RDS database that has the following two tags:
                 ...
                 * ``CLOUDFORMATION_STACK_1_0:`` * A JSON syntax that lets you specify a
    ...
    def delete_group(self, GroupName: str) -> ClientDeleteGroupResponseTypeDef:
        """
        Deletes a specified resource group. Deleting a resource group does not delete resources that
        are members of the group; it only deletes the group structure.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/DeleteGroup>`_
    ...
    def get_group(self, GroupName: str) -> ClientGetGroupResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/GetGroup>`_
    ...
    def get_group_query(self, GroupName: str) -> ClientGetGroupQueryResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/GetGroupQuery>`_
              ...
              - **ResourceQuery** *(dict) --*
                ...
                - **Type** *(string) --*
                   ...
                   * ``TAG_FILTERS_1_0:`` * A JSON syntax that lets you specify a collection of
                   simple tag filters for resource types and tags, as supported by the AWS Tagging
                   API `GetResources
                   <https://docs.aws.amazon.com/resourcegroupstagging/latest/APIReference/API_GetResources.html>`__
                  ...
                  * An S3 bucket that has the following two tags: {"Key":"Stage","Value":"Test"},
                  ...
                  The query would not return the following results, however. The following EC2
                  instance does not have all tag keys specified in the filter, so it is rejected.
                  The RDS database has all of the tag keys, but no values that match at least one of
                  the specified tag key values in the filter.
    ...
    def get_tags(self, Arn: str) -> ClientGetTagsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/GetTags>`_
        ...
        **Request Syntax**
        ...
        :param Arn: **[REQUIRED]**
          ...
          The ARN of the resource group for which you want a list of tags. The resource must exist
    ...
    def list_group_resources(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/ListGroupResources>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of group member ARNs that are returned in a single call by
          ListGroupResources, in paginated output. By default, this number is 50.

        :type NextToken: string
        :param NextToken:

          The NextToken value that is returned in a paginated ListGroupResources request. To get the
          next page of results, run the call again, add the NextToken parameter, and specify the
          NextToken value.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              The NextToken value to include in a subsequent ``ListGroupResources`` request, to get
              more results.
            ...
            - **QueryErrors** *(list) --*
              ...
              - *(dict) --*
                ...
                does not necessarily mean that AWS Resource Groups could not complete the operation,
    ...
    def list_groups(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/ListGroups>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          * ``resource-type`` - Filter groups by resource type. Specify up to five resource types in
          the format AWS::ServiceCode::ResourceType. For example, AWS::EC2::Instance, or
          AWS::S3::Bucket.
        ...
        :param MaxResults:
          ...
          The maximum number of resource group results that are returned by ListGroups in paginated
          output. By default, this number is 50.

        :type NextToken: string
        :param NextToken:

          The NextToken value that is returned in a paginated ``ListGroups`` request. To get the
          next page of results, run the call again, add the NextToken parameter, and specify the
          NextToken value.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              The NextToken value to include in a subsequent ``ListGroups`` request, to get more
              results.
    ...
    def search_resources(
        ...
        """
        Returns a list of AWS resource identifiers that matches a specified query. The query uses
        the same format as a resource query in a CreateGroup or UpdateGroupQuery operation.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/SearchResources>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          The NextToken value that is returned in a paginated ``SearchResources`` request. To get
          the next page of results, run the call again, add the NextToken parameter, and specify the
          NextToken value.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              The NextToken value to include in a subsequent ``SearchResources`` request, to get
              more results.
    ...
    def tag(self, Arn: str, Tags: List[str]) -> ClientTagResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/Tag>`_
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          pairs. Tag keys can have a maximum character length of 128 characters, and tag values can
    ...
    def untag(self, Arn: str, Keys: List[str]) -> ClientUntagResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/Untag>`_
    ...
    def update_group(
        ...
        """
        Updates an existing group with a new or changed description. You cannot update the name of a
        resource group.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/UpdateGroup>`_
    ...
    def update_group_query(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/resource-groups-2017-11-27/UpdateGroupQuery>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_group_resources` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `search_resources` operation.
        """
