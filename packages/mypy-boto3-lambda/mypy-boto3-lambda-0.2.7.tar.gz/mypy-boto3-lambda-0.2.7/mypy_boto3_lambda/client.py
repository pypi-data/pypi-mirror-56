"Main interface for lambda Client"
...
class Client(BaseClient):
    ...
    def add_layer_version_permission(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ . Use this action to
    ...
    def add_permission(
        ...
        """
        Grants an AWS service or another account permission to use a function. You can apply the policy at
        the function level, or specify a qualifier to restrict access to a single version or alias. If you
        use a qualifier, the invoker must use the full Amazon Resource Name (ARN) of that version or alias
        ...
        ``s3.amazonaws.com`` or ``sns.amazonaws.com`` . For AWS services, you can also specify the ARN or
        owning account of the associated resource as the ``SourceArn`` or ``SourceAccount`` . If you grant
        permission to a service principal without specifying the source, other accounts could potentially
        ...
        **Request Syntax**
        ...
        :param SourceAccount:
          ...
          to grant permission to resources that are owned by another account (for example, all of an
          account's Amazon S3 buckets). Or use it together with ``SourceArn`` to ensure that the resource is
          owned by the specified account. For example, an Amazon S3 bucket could be deleted by its owner and
        ...
        :param RevisionId:
          ...
          Only update the policy if the revision ID matches the ID that's specified. Use this option to
    ...
    def create_alias(
        ...
        """
        Creates an `alias <https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html>`__ for a
        Lambda function version. Use aliases to provide clients with a function identifier that you can
    ...
    def create_function(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/deployment-package-v2.html>`__ and an `execution role
        ...
        permission to use AWS services, such as Amazon CloudWatch Logs for log streaming and AWS X-Ray for
        request tracing.
        ...
        version-specific settings later with  UpdateFunctionConfiguration . Function-level settings apply to
        ...
        If another account or an AWS service invokes your function, use  AddPermission to grant permission
        by creating a resource-based IAM policy. You can grant permissions at the function level, on a
        version, or on an alias.

        To invoke your function directly, use  Invoke . To invoke your function in response to events in
        other AWS services, create an event source mapping ( CreateEventSourceMapping ), or configure a
        function trigger in the other service. For more information, see `Invoking Functions
        <https://docs.aws.amazon.com/lambda/latest/dg/invoking-lambda-functions.html>`__ .
        ...
        **Request Syntax**
        ...
        :param Tags:
          ...
          A list of `tags <https://docs.aws.amazon.com/lambda/latest/dg/tagging.html>`__ to apply to the
          function.
    ...
    def delete_event_source_mapping(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/intro-invocation-modes.html>`__ . You can get the
    ...
    def delete_function(self, FunctionName: str, Qualifier: str = None) -> None:
        ...
        AWS services and resources that invoke your function directly, delete the trigger in the service
    ...
    def delete_layer_version(self, LayerName: str, VersionNumber: int) -> None:
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ . Deleted versions can
        no longer be viewed or added to functions. To avoid breaking functions, a copy of the version
    ...
    def get_layer_version_policy(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ . For more information,
    ...
    def get_policy(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/access-control-resource-based.html>`__ for a function,
        version, or alias.
    ...
    def invoke(
        ...
        the response body and headers. For either invocation type, you can find more information in the
        `execution log <https://docs.aws.amazon.com/lambda/latest/dg/monitoring-functions.html>`__ and
        `trace <https://docs.aws.amazon.com/lambda/latest/dg/dlq.html>`__ . To record function errors for
        asynchronous invocations, configure your function with a `dead letter queue
        <https://docs.aws.amazon.com/lambda/latest/dg/dlq.html>`__ .

        When an error occurs, your function may be invoked multiple times. Retry behavior varies by error
        type, client, event source, and invocation type. For example, if you invoke a function
        asynchronously and it returns an error, Lambda executes the function up to two more times. For more
        ...
        errors that prevent your function from executing, such as permissions errors, `limit errors
        <https://docs.aws.amazon.com/lambda/latest/dg/limits.html>`__ , or issues with your function's code
        and configuration. For example, Lambda returns ``TooManyRequestsException`` if executing the
        ...
        while it waits for a response. Configure your HTTP client, SDK, firewall, proxy, or operating system
    ...
    def list_aliases(
        ...
        """
        Returns a list of `aliases <https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html>`__
    ...
    def list_functions(
        ...
        the unpublished version. To get more information about a function or version, use  GetFunction .
        ...
        **Request Syntax**
        ...
        :param MasterRegion:
          ...
          For Lambda@Edge functions, the AWS Region of the master function. For example, ``us-east-2`` or
    ...
    def list_layer_versions(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ . Versions that have
        been deleted aren't listed. Specify a `runtime identifier
        <https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html>`__ to list only versions that
    ...
    def list_layers(
        ...
        """
        Lists `AWS Lambda layers <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__
        and shows information about the latest version of each. Specify a `runtime identifier
        <https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html>`__ to list only layers that
        indicate that they're compatible with that runtime.
    ...
    def publish_layer_version(
        ...
        <https://docs.aws.amazon.com/lambda/latest/dg/configuration-layers.html>`__ from a ZIP archive. Each
        time you call ``PublishLayerVersion`` with the same version name, a new version is created.
        ...
        **Request Syntax**
        ...
        :param CompatibleRuntimes:
          ...
          <https://docs.aws.amazon.com/lambda/latest/dg/lambda-runtimes.html>`__ . Used for filtering with
    ...
    def publish_version(
        ...
        """
        Creates a `version <https://docs.aws.amazon.com/lambda/latest/dg/versioning-aliases.html>`__ from
        the current code and configuration of a function. Use versions to create a snapshot of your function
        code and configuration that doesn't change.
    ...
    def put_function_concurrency(
        ...
        many functions as you like, as long as you leave at least 100 simultaneous executions unreserved for
        functions that aren't configured with a per-function limit. For more information, see `Managing
    ...
    def update_function_configuration(
        ...
        You can't modify the configuration of a published version, only the unpublished version.

        To configure function concurrency, use  PutFunctionConcurrency . To grant invoke permissions to an
        account or AWS service, use  AddPermission .
