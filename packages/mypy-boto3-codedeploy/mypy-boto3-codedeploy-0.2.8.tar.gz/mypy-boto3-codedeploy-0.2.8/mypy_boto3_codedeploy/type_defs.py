...
class ClientBatchGetApplicationRevisionsResponserevisionsgenericRevisionInfoTypeDef(
    ...
    Information about an application revision, including usage details and associated deployment
    groups.
...
class ClientBatchGetApplicationRevisionsResponserevisionsrevisionLocationappSpecContentTypeDef(
    ...
    """
    Type definition for `ClientBatchGetApplicationRevisionsResponserevisionsrevisionLocation`
    `appSpecContent`
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoalarmConfigurationalarmsTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoalarmConfiguration` `alarms`
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoalarmConfigurationTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfo`
    `alarmConfiguration`
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoblueGreenDeploymentConfigurationdeploymentReadyOptionTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoblueGreenDeploymentConfiguration`
    ...
    - **actionOnTimeout** *(string) --*
      ...
      * STOP_DEPLOYMENT: Do not register new instances with a load balancer unless traffic rerouting
      is started using  ContinueDeployment . If traffic rerouting is not started before the end of
      the specified wait period, the deployment status is changed to Stopped.
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoblueGreenDeploymentConfigurationTypeDef(
    ...
    - **terminateBlueInstancesOnDeploymentSuccess** *(dict) --*
      ...
      - **terminationWaitTimeInMinutes** *(integer) --*
        ...
        For an Amazon ECS deployment, the number of minutes before deleting the original (blue) task
        set. During an Amazon ECS deployment, CodeDeploy shifts traffic from the original (blue)
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoec2TagSetec2TagSetListTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoec2TagSet`
    `ec2TagSetList`
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoec2TagSetTypeDef(
    ...
    Information about groups of tags applied to an EC2 instance. The deployment group includes only
    EC2 instances identified by all of the tag groups. Cannot be used in the same call as
    ec2TagFilters.
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoloadBalancerInfoelbInfoListTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoloadBalancerInfo`
    `elbInfoList`
    ...
    - **name** *(string) --*
      ...
      original instances to replacement instances in a blue/green deployment. For in-place
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoloadBalancerInfotargetGroupPairInfoListprodTrafficRouteTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoloadBalancerInfotargetGroupPairInfoList`
    `prodTrafficRoute`
    ...
    - **listenerArns** *(list) --*
      ...
      The ARN of one listener. The listener identifies the route between a target group and a load
    ...
    - **elbInfoList** *(list) --*
      ...
      - *(dict) --*
        ...
        - **name** *(string) --*
          ...
          deployments, the name of the load balancer that instances are deregistered from so they
          are not serving traffic during a deployment, and then re-registered with after the
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoonPremisesTagSetonPremisesTagSetListTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoonPremisesTagSet`
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoonPremisesTagSetTypeDef(
    ...
    includes only on-premises instances identified by all the tag groups. Cannot be used in the same
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfotargetRevisionappSpecContentTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfotargetRevision`
    `appSpecContent`
...
class ClientBatchGetDeploymentGroupsResponsedeploymentGroupsInfoTypeDef(
    ...
    - **ec2TagFilters** *(list) --*
      ...
      The Amazon EC2 tags on which to filter. The deployment group includes EC2 instances with any
    ...
    - **serviceRoleArn** *(string) --*
      ...
      AWS services on your behalf. For more information, see `Create a Service Role for AWS
      CodeDeploy
    ...
    - **alarmConfiguration** *(dict) --*
      ...
      - **alarms** *(list) --*
        ...
        A list of alarms configured for the deployment group. A maximum of 10 alarms can be added to
        a deployment group.
      ...
      - **deploymentReadyOption** *(dict) --*
        ...
        - **actionOnTimeout** *(string) --*
          ...
          * STOP_DEPLOYMENT: Do not register new instances with a load balancer unless traffic
          ...
          before the end of the specified wait period, the deployment status is changed to Stopped.

        - **waitTimeInMinutes** *(integer) --*

          The number of minutes to wait before the status of a blue/green deployment is changed to
          Stopped if rerouting is not started manually. Applies only to the STOP_DEPLOYMENT option
          for actionOnTimeout
      ...
      - **elbInfoList** *(list) --*
        ...
        - *(dict) --*
          ...
          - **name** *(string) --*
            ...
            For blue/green deployments, the name of the load balancer that is used to route traffic
            from original instances to replacement instances in a blue/green deployment. For
        ...
        - *(dict) --*
          ...
          - **prodTrafficRoute** *(dict) --*
            ...
            - **listenerArns** *(list) --*
              ...
              The ARN of one listener. The listener identifies the route between a target group and
              a load balancer. This is an array of strings with a maximum size of one.
    ...
    - **ecsServices** *(list) --*
      ...
      The target Amazon ECS services in the deployment group. This applies only to deployment groups
      that use the Amazon ECS compute platform. A target Amazon ECS service is specified as an
      Amazon ECS cluster and service name pair using the format ``<clustername>:<servicename>`` .
...
class ClientBatchGetDeploymentInstancesResponseinstancesSummarylifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentInstancesResponseinstancesSummarylifecycleEvents`
    `diagnostics`
...
class ClientBatchGetDeploymentInstancesResponseinstancesSummarylifecycleEventsTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentInstancesResponseinstancesSummary`
    `lifecycleEvents`
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargetlifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargetlifecycleEvents` `diagnostics`
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargetlifecycleEventsTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTarget`
    `lifecycleEvents`
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargettaskSetsInfotargetGroupTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargettaskSetsInfo` `targetGroup`

    The target group associated with the task set. The target group is used by AWS CodeDeploy to
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargettaskSetsInfoTypeDef(
    ...
    Information about a set of Amazon ECS tasks in an AWS CodeDeploy deployment. An Amazon ECS task
    set includes details such as the desired number of tasks, how many tasks are running, and
    whether the task set serves production traffic. An AWS CodeDeploy application that uses the
    Amazon ECS compute platform deploys a containerized application in an Amazon ECS service as a
    task set.
    ...
    - **desiredCount** *(integer) --*
      ...
      CodeDeploy instructs Amazon ECS to create a new task set and uses this value to determine how
      many tasks to create. After the updated task set is created, CodeDeploy shifts traffic to the
      new task set.

    - **pendingCount** *(integer) --*

      The number of tasks in the task set that are in the ``PENDING`` status during an Amazon ECS
      deployment. A task in the ``PENDING`` state is preparing to enter the ``RUNNING`` state. A
      task set enters the ``PENDING`` status when it launches for the first time, or when it is
    ...
    - **status** *(string) --*
      ...
      * ``DRAINING`` : Indicates the tasks in the task set are being stopped and their corresponding
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsecsTargetTypeDef(
    ...
    - **taskSetsInfo** *(list) --*
      ...
      - *(dict) --*
        ...
        Information about a set of Amazon ECS tasks in an AWS CodeDeploy deployment. An Amazon ECS
        task set includes details such as the desired number of tasks, how many tasks are running,
        and whether the task set serves production traffic. An AWS CodeDeploy application that uses
        the Amazon ECS compute platform deploys a containerized application in an Amazon ECS service
        as a task set.
        ...
        - **pendingCount** *(integer) --*
          ...
          ECS deployment. A task in the ``PENDING`` state is preparing to enter the ``RUNNING``
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsinstanceTargetlifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentTargetsResponsedeploymentTargetsinstanceTargetlifecycleEvents`
    `diagnostics`
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetsinstanceTargetlifecycleEventsTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentTargetsResponsedeploymentTargetsinstanceTarget`
    `lifecycleEvents`
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetslambdaTargetlambdaFunctionInfoTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentTargetsResponsedeploymentTargetslambdaTarget`
    `lambdaFunctionInfo`
    ...
    - **targetVersion** *(string) --*
      ...
      The version of a Lambda function that production traffic points to after the Lambda function
      is deployed.
...
class ClientBatchGetDeploymentTargetsResponsedeploymentTargetslambdaTargetlifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentTargetsResponsedeploymentTargetslambdaTargetlifecycleEvents`
    `diagnostics`
    ...
    - **ecsTarget** *(dict) --*
      ...
      - **taskSetsInfo** *(list) --*
        ...
        - *(dict) --*
          ...
          Information about a set of Amazon ECS tasks in an AWS CodeDeploy deployment. An Amazon ECS
          task set includes details such as the desired number of tasks, how many tasks are running,
          and whether the task set serves production traffic. An AWS CodeDeploy application that
          uses the Amazon ECS compute platform deploys a containerized application in an Amazon ECS
...
class ClientBatchGetDeploymentTargetsResponseTypeDef(
    ...
    - **deploymentTargets** *(list) --*
      ...
      target, such as its status and lifecycle events. The type of the target objects depends on the
...
class ClientBatchGetDeploymentsResponsedeploymentsInfoautoRollbackConfigurationTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentsResponsedeploymentsInfo`
    `autoRollbackConfiguration`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfoblueGreenDeploymentConfigurationdeploymentReadyOptionTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentsResponsedeploymentsInfoblueGreenDeploymentConfiguration`
    `deploymentReadyOption`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfoerrorInformationTypeDef(
    ...
    - **code** *(string) --*
      ...
      * APPLICATION_MISSING: The application was missing. This error code is most likely raised if
      the application is deleted after the deployment is created, but before it is started.

      * DEPLOYMENT_GROUP_MISSING: The deployment group was missing. This error code is most likely
      raised if the deployment group is deleted after the deployment is created, but before it is
      started.

      * HEALTH_CONSTRAINTS: The deployment failed on too many instances to be successfully deployed
      within the instance health constraints specified.

      * HEALTH_CONSTRAINTS_INVALID: The revision cannot be successfully deployed within the instance
      ...
      * REVISION_MISSING: The revision ID was missing. This error code is most likely raised if the
...
class ClientBatchGetDeploymentsResponsedeploymentsInfoloadBalancerInfoelbInfoListTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentsResponsedeploymentsInfoloadBalancerInfo`
    `elbInfoList`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfoloadBalancerInfotargetGroupPairInfoListprodTrafficRouteTypeDef(
    ...
    """
    Type definition for
    `ClientBatchGetDeploymentsResponsedeploymentsInfoloadBalancerInfotargetGroupPairInfoList`
    `prodTrafficRoute`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfopreviousRevisionappSpecContentTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentsResponsedeploymentsInfopreviousRevision`
    `appSpecContent`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfopreviousRevisionTypeDef(
    ...
    Information about the application revision that was deployed to the deployment group before the
...
class ClientBatchGetDeploymentsResponsedeploymentsInfotargetInstancesec2TagSetec2TagSetListTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentsResponsedeploymentsInfotargetInstancesec2TagSet`
    `ec2TagSetList`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfotargetInstancesec2TagSetTypeDef(
    ...
    """
    Type definition for `ClientBatchGetDeploymentsResponsedeploymentsInfotargetInstances`
    `ec2TagSet`
...
class ClientBatchGetDeploymentsResponsedeploymentsInfoTypeDef(
    ...
    - **ignoreApplicationStopFailures** *(boolean) --*
      ...
      number of healthy hosts is not less than the minimum number of healthy hosts, then a
      ...
      from the previous successful deployment. (All other scripts are run from the AppSpec file in
      ...
      that the ``ApplicationStop`` , ``BeforeBlockTraffic`` , and ``AfterBlockTraffic`` failures
      should be ignored.
    ...
    - **updateOutdatedInstancesOnly** *(boolean) --*
      ...
      Indicates whether only instances that are not running the latest application revision are to
      be deployed to.
    ...
    - **targetInstances** *(dict) --*
      ...
      - **ec2TagSet** *(dict) --*
        ...
        Information about the groups of EC2 instance tags that an instance must be identified by in
        order for it to be included in the replacement environment for a blue/green deployment.
    ...
    - **instanceTerminationWaitTimeStarted** *(boolean) --*
      ...
      environment has started. Status is 'false' if the KEEP_ALIVE option is specified. Otherwise,
    ...
    - **deploymentsInfo** *(list) --*
      ...
      - *(dict) --*
        ...
        - **startTime** *(datetime) --*
          ...
          In some cases, the reported value of the start time might be later than the complete time.
          This is due to differences in the clock settings of backend servers that participate in
        ...
        - **ignoreApplicationStopFailures** *(boolean) --*
          ...
          fails, the deployment continues with DownloadBundle. If ``BeforeBlockTraffic`` fails, the
    ...
    - **type** *(string) --*
      ...
      * FLEET_PERCENT: The minimum number of healthy instance as a percentage of the total number of
      ...
      .. note::
        ...
        ensure that all instances but one are kept in a healthy state during the deployment.
        Although this allows one instance at a time to be taken offline for a new deployment, it
        also means that if the deployment to the last instance fails, the overall deployment is
        still successful.
...
class ClientCreateDeploymentGroupblueGreenDeploymentConfigurationdeploymentReadyOptionTypeDef(
    ...
    """
    Type definition for `ClientCreateDeploymentGroupblueGreenDeploymentConfiguration`
    `deploymentReadyOption`
...
class ClientCreateDeploymentGrouploadBalancerInfotargetGroupPairInfoListprodTrafficRouteTypeDef(
    ...
    """
    Type definition for `ClientCreateDeploymentGrouploadBalancerInfotargetGroupPairInfoList`
    `prodTrafficRoute`
...
class ClientGetDeploymentConfigResponsedeploymentConfigInfominimumHealthyHostsTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentConfigResponsedeploymentConfigInfo`
    `minimumHealthyHosts`
...
class ClientGetDeploymentConfigResponsedeploymentConfigInfotrafficRoutingConfigtimeBasedCanaryTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentConfigResponsedeploymentConfigInfotrafficRoutingConfig`
    `timeBasedCanary`
...
class ClientGetDeploymentConfigResponsedeploymentConfigInfotrafficRoutingConfigTypeDef(
    ...
    The configuration that specifies how the deployment traffic is routed. Only deployments with a
    Lambda compute platform can specify this.
...
class ClientGetDeploymentConfigResponsedeploymentConfigInfoTypeDef(
      ...
      - **type** *(string) --*
        ...
        * FLEET_PERCENT: The minimum number of healthy instance as a percentage of the total number
        ...
        .. note::
          ...
          In a call to the ``GetDeploymentConfig`` , CodeDeployDefault.OneAtATime returns a minimum
          healthy instance type of MOST_CONCURRENCY and a value of 1. This means a deployment to
          only one instance at a time. (You cannot set the type to MOST_CONCURRENCY, only to
          HOST_COUNT or FLEET_PERCENT.) In addition, with CodeDeployDefault.OneAtATime, AWS
          CodeDeploy attempts to ensure that all instances but one are kept in a healthy state
          during the deployment. Although this allows one instance at a time to be taken offline for
          a new deployment, it also means that if the deployment to the last instance fails, the
    ...
    - **trafficRoutingConfig** *(dict) --*
      ...
      - **timeBasedCanary** *(dict) --*
        ...
        A configuration that shifts traffic from one version of a Lambda function to another in two
        increments. The original and target Lambda function versions are specified in the
      ...
      - **timeBasedLinear** *(dict) --*
        ...
        equal increments, with an equal number of minutes between each increment. The original and
        target Lambda function versions are specified in the deployment's AppSpec file.
...
class ClientGetDeploymentConfigResponseTypeDef(_ClientGetDeploymentConfigResponseTypeDef):
    ...
    - **deploymentConfigInfo** *(dict) --*
      ...
      - **minimumHealthyHosts** *(dict) --*
        ...
        - **type** *(string) --*
          ...
          * FLEET_PERCENT: The minimum number of healthy instance as a percentage of the total
          ...
          In an example of nine instance, if a HOST_COUNT of six is specified, deploy to up to three
          instances at a time. The deployment is successful if six or more instances are deployed to
          successfully. Otherwise, the deployment fails. If a FLEET_PERCENT of 40 is specified,
          deploy to up to five instance at a time. The deployment is successful if four or more
      ...
      - **trafficRoutingConfig** *(dict) --*
        ...
        The configuration that specifies how the deployment traffic is routed. Only deployments with
        a Lambda compute platform can specify this.
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoalarmConfigurationalarmsTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentGroupResponsedeploymentGroupInfoalarmConfiguration`
    `alarms`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoautoRollbackConfigurationTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentGroupResponsedeploymentGroupInfo`
    `autoRollbackConfiguration`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoblueGreenDeploymentConfigurationdeploymentReadyOptionTypeDef(
    ...
    """
    Type definition for
    `ClientGetDeploymentGroupResponsedeploymentGroupInfoblueGreenDeploymentConfiguration`
    `deploymentReadyOption`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoec2TagSetec2TagSetListTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentGroupResponsedeploymentGroupInfoec2TagSet`
    `ec2TagSetList`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoloadBalancerInfoelbInfoListTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentGroupResponsedeploymentGroupInfoloadBalancerInfo`
    `elbInfoList`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoloadBalancerInfotargetGroupPairInfoListprodTrafficRouteTypeDef(
    ...
    """
    Type definition for
    `ClientGetDeploymentGroupResponsedeploymentGroupInfoloadBalancerInfotargetGroupPairInfoList`
    `prodTrafficRoute`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfoonPremisesTagSetonPremisesTagSetListTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentGroupResponsedeploymentGroupInfoonPremisesTagSet`
    `onPremisesTagSetList`
...
class ClientGetDeploymentGroupResponsedeploymentGroupInfotargetRevisionappSpecContentTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentGroupResponsedeploymentGroupInfotargetRevision`
    `appSpecContent`
...
class ClientGetDeploymentGroupResponseTypeDef(_ClientGetDeploymentGroupResponseTypeDef):
    ...
    - **deploymentGroupInfo** *(dict) --*
      ...
      - **ecsServices** *(list) --*
        ...
        The target Amazon ECS services in the deployment group. This applies only to deployment
        groups that use the Amazon ECS compute platform. A target Amazon ECS service is specified as
        an Amazon ECS cluster and service name pair using the format ``<clustername>:<servicename>``
        .
...
class ClientGetDeploymentInstanceResponseinstanceSummarylifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentInstanceResponseinstanceSummarylifecycleEvents`
    `diagnostics`
...
class ClientGetDeploymentResponsedeploymentInfoblueGreenDeploymentConfigurationdeploymentReadyOptionTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentResponsedeploymentInfoblueGreenDeploymentConfiguration`
    `deploymentReadyOption`
...
class ClientGetDeploymentResponsedeploymentInfoblueGreenDeploymentConfigurationTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentResponsedeploymentInfo`
    `blueGreenDeploymentConfiguration`
...
class ClientGetDeploymentResponsedeploymentInfoloadBalancerInfotargetGroupInfoListTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentResponsedeploymentInfoloadBalancerInfo`
    `targetGroupInfoList`
...
class ClientGetDeploymentResponsedeploymentInfoloadBalancerInfotargetGroupPairInfoListprodTrafficRouteTypeDef(
    ...
    """
    Type definition for
    `ClientGetDeploymentResponsedeploymentInfoloadBalancerInfotargetGroupPairInfoList`
    `prodTrafficRoute`
...
class ClientGetDeploymentResponsedeploymentInfotargetInstancesec2TagSetec2TagSetListTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentResponsedeploymentInfotargetInstancesec2TagSet`
    `ec2TagSetList`
    ...
    - **deploymentInfo** *(dict) --*
      ...
      - **targetInstances** *(dict) --*
        ...
        - **ec2TagSet** *(dict) --*
          ...
          Information about the groups of EC2 instance tags that an instance must be identified by
          in order for it to be included in the replacement environment for a blue/green deployment.
          Cannot be used in the same call as tagFilters.
...
class ClientGetDeploymentTargetResponsedeploymentTargetecsTargetlifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentTargetResponsedeploymentTargetecsTargetlifecycleEvents`
    `diagnostics`
...
class ClientGetDeploymentTargetResponsedeploymentTargetecsTargetlifecycleEventsTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentTargetResponsedeploymentTargetecsTarget`
    `lifecycleEvents`
...
class ClientGetDeploymentTargetResponsedeploymentTargetecsTargettaskSetsInfotargetGroupTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentTargetResponsedeploymentTargetecsTargettaskSetsInfo`
    `targetGroup`
...
class ClientGetDeploymentTargetResponsedeploymentTargetinstanceTargetlifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for
    `ClientGetDeploymentTargetResponsedeploymentTargetinstanceTargetlifecycleEvents` `diagnostics`
...
class ClientGetDeploymentTargetResponsedeploymentTargetinstanceTargetlifecycleEventsTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentTargetResponsedeploymentTargetinstanceTarget`
    `lifecycleEvents`
...
class ClientGetDeploymentTargetResponsedeploymentTargetlambdaTargetlambdaFunctionInfoTypeDef(
    ...
    """
    Type definition for `ClientGetDeploymentTargetResponsedeploymentTargetlambdaTarget`
    `lambdaFunctionInfo`
...
class ClientGetDeploymentTargetResponsedeploymentTargetlambdaTargetlifecycleEventsdiagnosticsTypeDef(
    ...
    """
    Type definition for
    `ClientGetDeploymentTargetResponsedeploymentTargetlambdaTargetlifecycleEvents` `diagnostics`
...
class ClientGetDeploymentTargetResponsedeploymentTargetTypeDef(
    ...
    deployment target metadata depends on the deployment target's type (``instanceTarget`` ,
...
class ClientListDeploymentGroupsResponseTypeDef(_ClientListDeploymentGroupsResponseTypeDef):
    ...
    - **nextToken** *(string) --*
      ...
      If a large amount of information is returned, an identifier is also returned. It can be used
      in a subsequent list deployment groups call to return the next set of deployment groups in the
      list.
    """
...
_ClientStopDeploymentResponseTypeDef = TypedDict(
    "_ClientStopDeploymentResponseTypeDef", {"status": str, "statusMessage": str}, total=False
)
...
class ClientUpdateDeploymentGroupblueGreenDeploymentConfigurationdeploymentReadyOptionTypeDef(
    ...
    """
    Type definition for `ClientUpdateDeploymentGroupblueGreenDeploymentConfiguration`
    `deploymentReadyOption`
...
class ClientUpdateDeploymentGrouploadBalancerInfotargetGroupPairInfoListprodTrafficRouteTypeDef(
    ...
    """
    Type definition for `ClientUpdateDeploymentGrouploadBalancerInfotargetGroupPairInfoList`
    `prodTrafficRoute`
