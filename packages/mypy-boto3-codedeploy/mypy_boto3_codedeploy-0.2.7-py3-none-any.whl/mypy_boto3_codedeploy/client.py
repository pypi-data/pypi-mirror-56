"Main interface for codedeploy Client"
...
class Client(BaseClient):
                        ...
                        'triggerConfigurations': [
                            {
                                ...
                                'triggerEvents': [
                                    ...
                                    |'DeploymentStop'|'DeploymentRollback'|'DeploymentReady'|'InstanceStart'
    ...
    def batch_get_deployment_instances(
        ...
        Returns an array of one or more instances associated with a deployment. This method works with
        EC2/On-premises and AWS Lambda compute platforms. The newer ``BatchGetDeploymentTargets`` works with
        all compute platforms. The maximum number of instances that can be returned is 25.
                        ...
                        'lifecycleEvents': [
                            {
                                ...
                                'diagnostics': {
                                    'errorCode':
                                    'Success'|'ScriptMissing'|'ScriptNotExecutable'|'ScriptTimedOut'
    ...
    def batch_get_deployment_targets(
        ...
        maximum number of targets that can be returned is 25.
        ...
        **Request Syntax**
        ...
        :param targetIds:
          ...
          type of the targets and their formats. The maximum number of deployment target IDs you can specify
          is 25.
          ...
          * For deployments that use the Amazon ECS compute platform, the target IDs are pairs of Amazon ECS
          clusters and services specified using the format ``<clustername>:<servicename>`` . Their target
          type is ``ecsTarget`` .
    ...
    def batch_get_deployments(
        ...
        **Request Syntax**
        ...
        :param deploymentIds: **[REQUIRED]**
          ...
          A list of deployment IDs, separated by spaces. The maximum number of deployment IDs you can
          specify is 25.
                ...
                'deploymentsInfo': [
                    {
                        ...
                        'errorInformation': {
                            ...
                            |'CUSTOMER_APPLICATION_UNHEALTHY'|'DEPLOYMENT_GROUP_MISSING'|'ECS_UPDATE_ERROR'
                            |'ELASTIC_LOAD_BALANCING_INVALID'|'ELB_INVALID_INSTANCE'|'HEALTH_CONSTRAINTS'
                            |'HEALTH_CONSTRAINTS_INVALID'|'HOOK_EXECUTION_FAILURE'|'IAM_ROLE_MISSING'
                            |'IAM_ROLE_PERMISSIONS'|'INTERNAL_ERROR'|'INVALID_ECS_SERVICE'
                            |'INVALID_LAMBDA_CONFIGURATION'|'INVALID_LAMBDA_FUNCTION'|'INVALID_REVISION'
                            |'MANUAL_STOP'|'MISSING_BLUE_GREEN_DEPLOYMENT_CONFIGURATION'
                            |'MISSING_ELB_INFORMATION'|'MISSING_GITHUB_TOKEN'|'NO_EC2_SUBSCRIPTION'
                            |'NO_INSTANCES'|'OVER_MAX_INSTANCES'|'RESOURCE_LIMIT_EXCEEDED'
    ...
    def continue_deployment(
        ...
        **Request Syntax**
        ...
        :param deploymentWaitType:
          ...
          The status of the deployment's waiting period. READY_WAIT indicates the deployment is ready to
          start shifting traffic. TERMINATION_WAIT indicates the traffic is shifted, but the original target
          is not terminated.
    ...
    def create_deployment_group(
        ...
        **Request Syntax**
        ...
        :param deploymentConfigName:
          ...
          <https://docs.aws.amazon.com/codedeploy/latest/userguide/deployment-configurations.html>`__ in the
          AWS CodeDeploy User Guide.

        :type ec2TagFilters: list
        :param ec2TagFilters:

          The Amazon EC2 tags on which to filter. The deployment group includes EC2 instances with any of
        ...
        :param serviceRoleArn: **[REQUIRED]**
          ...
          A service role ARN that allows AWS CodeDeploy to act on the user's behalf when interacting with
          AWS services.

        :type triggerConfigurations: list
        :param triggerConfigurations:

          Information about triggers to create when the deployment group is created. For examples, see
          `Create a Trigger for an AWS CodeDeploy Event
          <https://docs.aws.amazon.com/codedeploy/latest/userguide/how-to-notify-sns.html>`__ in the AWS
          CodeDeploy User Guide.
    ...
    def get_application_revision(
        self,
        applicationName: str,
        revision: ClientGetApplicationRevisionrevisionTypeDef,
    ) -> ClientGetApplicationRevisionResponseTypeDef:
        """
    ...
    def get_deployment(self, deploymentId: str) -> ClientGetDeploymentResponseTypeDef:
        ...
        .. note::
          ...
          The ``content`` property of the ``appSpecContent`` object in the returned revision is always null.
          Use ``GetApplicationRevision`` and the ``sha256`` property of the returned ``appSpecContent``
...

            {
                'deploymentInfo': {
                    ...
                    'errorInformation': {
                        ...
                        |'AUTO_SCALING_CONFIGURATION'|'AUTO_SCALING_IAM_ROLE_PERMISSIONS'
                        |'CODEDEPLOY_RESOURCE_CANNOT_BE_FOUND'|'CUSTOMER_APPLICATION_UNHEALTHY'
                        |'DEPLOYMENT_GROUP_MISSING'|'ECS_UPDATE_ERROR'|'ELASTIC_LOAD_BALANCING_INVALID'
                        |'ELB_INVALID_INSTANCE'|'HEALTH_CONSTRAINTS'|'HEALTH_CONSTRAINTS_INVALID'
                        |'HOOK_EXECUTION_FAILURE'|'IAM_ROLE_MISSING'|'IAM_ROLE_PERMISSIONS'|'INTERNAL_ERROR'
                        |'INVALID_ECS_SERVICE'|'INVALID_LAMBDA_CONFIGURATION'|'INVALID_LAMBDA_FUNCTION'
                        |'INVALID_REVISION'|'MANUAL_STOP'|'MISSING_BLUE_GREEN_DEPLOYMENT_CONFIGURATION'
                        |'MISSING_ELB_INFORMATION'|'MISSING_GITHUB_TOKEN'|'NO_EC2_SUBSCRIPTION'
                        |'NO_INSTANCES'|'OVER_MAX_INSTANCES'|'RESOURCE_LIMIT_EXCEEDED'|'REVISION_MISSING'
                        |'THROTTLED'|'TIMEOUT',
                        'message': 'string'
                    },
                    'createTime': datetime(2015, 1, 1),
    ...
    def list_application_revisions(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          An identifier returned from the previous ``ListApplicationRevisions`` call. It can be used to
    ...
    def list_deployment_instances(
        ...
        .. note::
          ...
          The newer BatchGetDeploymentTargets should be used instead because it works with all compute
          types. ``ListDeploymentInstances`` throws an exception if it is used with a compute platform other
          than EC2/On-premises or AWS Lambda.
        ...
        **Request Syntax**
        ...
        :param instanceTypeFilter:
          ...
          or those in the replacement environment ("GREEN"), for which you want to view instance
          information.
    ...
    def list_deployment_targets(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          A token identifier returned from the previous ``ListDeploymentTargets`` call. It can be used to
    ...
    def list_on_premises_instances(
        ...
        To list only registered or deregistered on-premises instance names, use the registration status
        parameter.
    ...
    def list_tags_for_resource(
        ...
        """
        Returns a list of tags for the resource identified by a specified ARN. Tags are used to organize and
        categorize your CodeDeploy resources.
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          An identifier returned from the previous ``ListTagsForResource`` call. It can be used to return
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        input parameter. The tags are identfied by the list of keys in the ``TagKeys`` input parameter.
        ...
        **Request Syntax**
        ...
        :param TagKeys: **[REQUIRED]**
          ...
          A list of keys of ``Tag`` objects. The ``Tag`` objects identified by the keys are disassociated
          from the resource specified by the ``ResourceArn`` input parameter.
    ...
    def update_deployment_group(
        ...
        **Request Syntax**
        ...
        :param onPremisesInstanceTagFilters:
          ...
          To keep the existing tags, enter their names. To remove tags, do not enter any tag names.
        ...
        :param autoScalingGroups:
          ...
          change them. To keep the Auto Scaling groups, enter their names. To remove Auto Scaling groups, do
        ...
        :param triggerConfigurations:
          ...
          Information about triggers to change when the deployment group is updated. For examples, see
          `Modify Triggers in an AWS CodeDeploy Deployment Group
          <https://docs.aws.amazon.com/codedeploy/latest/userguide/how-to-notify-edit.html>`__ in the AWS
          CodeDeploy User Guide.
