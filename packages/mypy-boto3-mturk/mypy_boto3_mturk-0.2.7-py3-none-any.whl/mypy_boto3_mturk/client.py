"Main interface for mturk Client"
...
class Client(BaseClient):
    ...
    def accept_qualification_request(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/AcceptQualificationRequest>`_
        ...
        **Request Syntax**
        ...
        :param IntegerValue:
          ...
          The value of the Qualification. You can omit this value if you are using the presence or absence
          of the Qualification as the basis for a HIT requirement.
    ...
    def approve_assignment(
        ...
        * Amazon Mechanical Turk fees are debited.
        ...
        optional feedback message with the approval, which the Worker can see in the Status section of the
        web site.

        You can also call this operation for assignments that were previous rejected and approve them by
        explicitly overriding the previous rejection. This only works on rejected assignments that were
        submitted within the previous 30 days and only if the assignment's related HIT has not been deleted.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ApproveAssignment>`_
    ...
    def associate_qualification_with_worker(
        ...
        .. note::
          ...
          Note: ``AssociateQualificationWithWorker`` does not affect any pending Qualification requests for
          the Qualification by the Worker. If you assign a Qualification to a Worker, then later grant a
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/AssociateQualificationWithWorker>`_
    ...
    def create_additional_assignments_for_hit(
        ...
        """
        The ``CreateAdditionalAssignmentsForHIT`` operation increases the maximum number of assignments of
        an existing HIT.
        ...
        .. note::
          ...
          * HITs created with fewer than 10 assignments cannot be extended to have 10 or more assignments.
          Attempting to add assignments in a way that brings the total number of assignments for a HIT from
          ...
          * HITs that were created before July 22, 2015 cannot be extended. Attempting to extend HITs that
          were created before July 22, 2015 will result in an ``AWS.MechanicalTurk.HITTooOldForExtension``
          exception.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/CreateAdditionalAssignmentsForHIT>`_
        ...
        **Request Syntax**
        ...
        :param UniqueRequestToken:
          ...
          extending the HIT multiple times. This is useful in cases such as network timeouts where it is
          unclear whether or not the call succeeded on the server. If the extend HIT already exists in the
          system from a previous call using the same ``UniqueRequestToken`` , subsequent calls will return
          an error with a message containing the request ID.
    ...
    def create_hit(
        ...
        UniqueRequestToken: str = None,
        AssignmentReviewPolicy: ClientCreateHitAssignmentReviewPolicyTypeDef = None,
        HITReviewPolicy: ClientCreateHitHITReviewPolicyTypeDef = None,
        HITLayoutId: str = None,
        HITLayoutParameters: List[ClientCreateHitHITLayoutParametersTypeDef] = None,
    ) -> ClientCreateHitResponseTypeDef:
        """
        ...
        This operation allows you to specify a new HIT by passing in values for the properties of the HIT,
        such as its title, reward amount and number of assignments. When you pass these values to
        ``CreateHIT`` , a new HIT is created for you, with a new ``HITTypeID`` . The HITTypeID can be used
        to create additional HITs in the future without needing to specify common parameters such as the
        ...
        .. note::
          ...
          If a HIT is created with 10 or more maximum assignments, there is an additional fee. For more
          information, see `Amazon Mechanical Turk Pricing <https://requester.mturk.com/pricing>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/CreateHIT>`_
        ...
        **Request Syntax**
        ...
        :param AutoApprovalDelayInSeconds:
          ...
          The number of seconds after an assignment for the HIT has been submitted, after which the
          assignment is considered Approved automatically unless the Requester explicitly rejects it.
        ...
        :param Description: **[REQUIRED]**
          ...
          A general description of the HIT. A description includes detailed information about the kind of
          task the HIT contains. On the Amazon Mechanical Turk web site, the HIT description appears in the
          expanded view of search results, and in the HIT and assignment screens. A good description gives
          the user enough information to evaluate the HIT before accepting it.
        ...
        :param Question:
          ...
          HTMLQuestion data structure. The XML question data must not be larger than 64 kilobytes (65,535
        ...
        :param RequesterAnnotation:
          ...
          to the Requester's application that corresponds with the HIT.
        ...
        :param UniqueRequestToken:
          ...
          duplicate HITs. This is useful in cases such as network timeouts where it is unclear whether or
          not the call succeeded on the server. If the HIT already exists in the system from a previous call
          ...
          .. note::
            ...
            Note: It is your responsibility to ensure uniqueness of the token. The unique token expires
            after 24 hours. Subsequent calls using the same UniqueRequestToken made after the 24 hour limit
    ...
    def create_hit_type(
        ...
        standard set of HIT properties to use when creating HITs. If you register a HIT type with values
        that match an existing HIT type, the HIT type ID of the existing type will be returned.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/CreateHITType>`_
    ...
    def create_hit_with_hit_type(
        ...
        RequesterAnnotation: str = None,
        UniqueRequestToken: str = None,
        AssignmentReviewPolicy: ClientCreateHitWithHitTypeAssignmentReviewPolicyTypeDef = None,
        HITReviewPolicy: ClientCreateHitWithHitTypeHITReviewPolicyTypeDef = None,
        HITLayoutId: str = None,
        ...
        CreateHITWithHITType also supports several ways to provide question data: by providing a value for
        the ``Question`` parameter that fully specifies the contents of the HIT, or by providing a
        ``HitLayoutId`` and associated ``HitLayoutParameters`` .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/CreateHITWithHITType>`_
    ...
    def create_qualification_type(
        ...
        a ``QualificationType`` data structure.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/CreateQualificationType>`_
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          The name you give to the Qualification type. The type name is used to represent the Qualification
          to Workers, and to find the type using a Qualification type search. It must be unique across all
          of your Qualification types.

        :type Keywords: string
        :param Keywords:

          One or more words or phrases that describe the Qualification type, separated by commas. The
        ...
        :param RetryDelayInSeconds:
          ...
          of this type only once, even if the Worker has not been granted the Qualification. It is not
          possible to disable retries for a Qualification type after it has been created with retries
          enabled. If you want to disable retries, you must delete existing retry-enabled Qualification type
        ...
        :param Test:
          ...
          of this type. If this parameter is specified, ``TestDurationInSeconds`` must also be specified.
          ...
          Constraints: None. If not specified, the Worker may request the Qualification without answering
          any questions.
        ...
        :param TestDurationInSeconds:
          ...
          The number of seconds the Worker has to complete the Qualification test, starting from the time
          the Worker requests the Qualification.

        :type AutoGranted: boolean
        :param AutoGranted:

          Specifies whether requests for the Qualification type are granted immediately, without prompting
        ...
        :param AutoGrantedValue:
          ...
          The Qualification value to use for automatically granted Qualifications. This parameter is used
    ...
    def create_worker_block(self, WorkerId: str, Reason: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/CreateWorkerBlock>`_
        ...
        **Request Syntax**
        ...
        :param Reason: **[REQUIRED]**
          ...
          A message explaining the reason for blocking the Worker. This parameter enables you to keep track
          of your Workers. The Worker does not see this message.
    ...
    def delete_hit(self, HITId: str) -> Dict[str, Any]:
        ...
        is not in the ``Reviewable`` state (for example, that has not expired, or still has active
        assignments), or on a HIT that is Reviewable but without all of its submitted assignments already
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/DeleteHIT>`_
    ...
    def delete_qualification_type(self, QualificationTypeId: str) -> Dict[str, Any]:
        ...
        This operation does not revoke Qualifications already assigned to Workers because the Qualifications
        might be needed for active HITs. If there are any pending requests for the Qualification type,
        Amazon Mechanical Turk rejects those requests. After you delete a Qualification type, you can no
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/DeleteQualificationType>`_
    ...
    def delete_worker_block(self, WorkerId: str, Reason: str = None) -> Dict[str, Any]:
        ...
        This operation reverses the effects of the CreateWorkerBlock operation. You need the Worker ID to
        use this operation. If the Worker ID is missing or invalid, this operation fails and returns the
        message “WorkerId is invalid.” If the specified Worker is not blocked, this operation returns
        successfully.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/DeleteWorkerBlock>`_
        ...
        **Request Syntax**
        ...
        :param Reason:
          ...
          A message that explains the reason for unblocking the Worker. The Worker does not see this
          message.
    ...
    def disassociate_qualification_from_worker(
        ...
        You can provide a text message explaining why the Qualification was revoked. The user who had the
        Qualification can see this message.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/DisassociateQualificationFromWorker>`_
    ...
    def get_account_balance(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/GetAccountBalance>`_
    ...
    def get_assignment(self, AssignmentId: str) -> ClientGetAssignmentResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/GetAssignment>`_
    ...
    def get_file_upload_url(
        ...
        """
        The ``GetFileUploadURL`` operation generates and returns a temporary URL. You use the temporary URL
        to retrieve a file uploaded by a Worker as an answer to a FileUploadAnswer question for a HIT. The
        ...
        December 12, 2017. The Answer Specification structure will no longer support the
        ``FileUploadAnswer`` element to be used for the QuestionForm data structure. Instead, we recommend
        that Requesters who want to create HITs asking Workers to upload files to use Amazon S3.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/GetFileUploadURL>`_
        ...
        **Request Syntax**
        ...
        :param QuestionIdentifier: **[REQUIRED]**
          ...
          The identifier of the question with a FileUploadAnswer, as specified in the QuestionForm of the
          HIT.
    ...
    def get_hit(self, HITId: str) -> ClientGetHitResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/GetHIT>`_
    ...
    def get_qualification_score(
        ...
        To get a Worker's Qualification, you must know the Worker's ID. The Worker's ID is included in the
        assignment data returned by the ``ListAssignmentsForHIT`` operation.

        Only the owner of a Qualification type can query the value of a Worker's Qualification of that type.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/GetQualificationScore>`_
    ...
    def get_qualification_type(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/GetQualificationType>`_
    ...
    def list_assignments_for_hit(
        ...
        NextToken: str = None,
        MaxResults: int = None,
        AssignmentStatuses: List[str] = None,
    ) -> ClientListAssignmentsForHitResponseTypeDef:
        """
        ...
        You can get assignments for a HIT at any time, even if the HIT is not yet Reviewable. If a HIT
        requested multiple assignments, and has received some results but has not yet become Reviewable, you
        ...
        ListAssignmentsForHIT operation can return submitted assignments awaiting approval, or it can return
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListAssignmentsForHIT>`_
    ...
    def list_bonus_payments(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListBonusPayments>`_
    ...
    def list_hits(
        ...
        status, except for HITs that have been deleted of with the DeleteHIT operation or that have been
        auto-deleted.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListHITs>`_
    ...
    def list_hits_for_qualification_type(
        ...
        type for a Qualification requirement. The operation returns HITs of any status, except for HITs that
        have been deleted with the ``DeleteHIT`` operation or that have been auto-deleted.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListHITsForQualificationType>`_
    ...
    def list_qualification_requests(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListQualificationRequests>`_
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          If the previous response was incomplete (because there is more data to retrieve), Amazon
          Mechanical Turk returns a pagination token in the response. You can use this pagination token to
    ...
    def list_qualification_types(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListQualificationTypes>`_
    ...
    def list_review_policy_results_for_hit(
        ...
        """
        The ``ListReviewPolicyResultsForHIT`` operation retrieves the computed results and the actions taken
        in the course of executing your Review Policies for a given HIT. For information about how to
        specify Review Policies when you call CreateHIT, see Review Policies. The
        ListReviewPolicyResultsForHIT operation can return results for both Assignment-level and HIT-level
        review results.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListReviewPolicyResultsForHIT>`_
    ...
    def list_reviewable_hits(
        ...
        """
        The ``ListReviewableHITs`` operation retrieves the HITs with Status equal to Reviewable or Status
        equal to Reviewing that belong to the Requester calling the operation.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListReviewableHITs>`_
    ...
    def list_worker_blocks(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListWorkerBlocks>`_
    ...
    def list_workers_with_qualification_type(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/ListWorkersWithQualificationType>`_
    ...
    def notify_workers(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/NotifyWorkers>`_
    ...
    def reject_assignment(
        ...
        You can include an optional feedback message with the rejection, which the Worker can see in the
        Status section of the web site. When you include a feedback message with the rejection, it helps the
        Worker understand why the assignment was rejected, and can improve the quality of the results the
        Worker submits in the future.

        Only the Requester who created the HIT can reject an assignment for the HIT.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/RejectAssignment>`_
    ...
    def reject_qualification_request(
        ...
        You can provide a text message explaining why the request was rejected. The Worker who made the
        request can see this message.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/RejectQualificationRequest>`_
    ...
    def send_bonus(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/SendBonus>`_
        ...
        **Request Syntax**
        ...
        :param UniqueRequestToken:
          ...
          not the call succeeded on the server. If the bonus already exists in the system from a previous
          call using the same UniqueRequestToken, subsequent calls will return an error with a message
    ...
    def send_test_event_notification(
        ...
        allows you to test notifications without setting up notifications for a real HIT type and trying to
        trigger them using the website. When you call this operation, the service attempts to send the test
        notification immediately.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/SendTestEventNotification>`_
        ...
        **Request Syntax**
          ...
          response = client.send_test_event_notification(
              Notification={
                  ...
                  'EventTypes': [
                      ...
                      |'AssignmentRejected'|'AssignmentApproved'|'HITCreated'|'HITExpired'|'HITReviewable'
                      |'HITExtended'|'HITDisposed'|'Ping',
                  ]
              },
              TestEventType=
                  'AssignmentAccepted'|'AssignmentAbandoned'|'AssignmentReturned'|'AssignmentSubmitted'
        ...
        :param Notification: **[REQUIRED]**
          ...
          - **EventTypes** *(list) --* **[REQUIRED]**
            ...
            The Ping event is only valid for the SendTestEventNotification operation.
    ...
    def update_expiration_for_hit(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/UpdateExpirationForHIT>`_
    ...
    def update_hit_review_status(
        ...
        """
        The ``UpdateHITReviewStatus`` operation updates the status of a HIT. If the status is Reviewable,
        this operation can update the status to Reviewing, or it can revert a Reviewing HIT back to the
        Reviewable status.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/UpdateHITReviewStatus>`_
    ...
    def update_hit_type_of_hit(self, HITId: str, HITTypeId: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/UpdateHITTypeOfHIT>`_
    ...
    def update_notification_settings(
        self,
        HITTypeId: str,
        Notification: ClientUpdateNotificationSettingsNotificationTypeDef = None,
        Active: bool = None,
    ) -> Dict[str, Any]:
        """
        The ``UpdateNotificationSettings`` operation creates, updates, disables or re-enables notifications
        for a HIT type. If you call the UpdateNotificationSettings operation for a HIT type that already has
        a notification specification, the operation replaces the old specification with a new one. You can
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/UpdateNotificationSettings>`_
    ...
    def update_qualification_type(
        ...
        Most attributes of a Qualification type can be changed after the type has been created. However, the
        Name and Keywords fields cannot be modified. The RetryDelayInSeconds parameter can be modified or
        added to change the delay or to enable retries, but RetryDelayInSeconds cannot be used to disable
        retries.

        You can use this operation to update the test for a Qualification type. The test is updated based on
        the values specified for the Test, TestDurationInSeconds and AnswerKey parameters. All three
        ...
        If you omit the Test parameter, the test for the Qualification type is unchanged. There is no way to
        remove a test from a Qualification type that has one. If the type already has a test, you cannot
        ...
        If you provide an updated Test but no AnswerKey, the new test will not have an answer key. Requests
        for such Qualifications must be granted manually.

        You can also update the AutoGranted and AutoGrantedValue attributes of the Qualification type.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/mturk-requester-2017-01-17/UpdateQualificationType>`_
        ...
        **Request Syntax**
        ...
        :param RetryDelayInSeconds:
          ...
          specified Qualification type before they can retry the Qualification request. It is not possible
          to disable retries for a Qualification type after it has been created with retries enabled. If you
          want to disable retries, you must dispose of the existing retry-enabled Qualification type using
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_assignments_for_hit` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_bonus_payments` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_hits` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_hits_for_qualification_type` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_qualification_requests` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_qualification_types` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_reviewable_hits` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_worker_blocks` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_workers_with_qualification_type` operation.
        """
