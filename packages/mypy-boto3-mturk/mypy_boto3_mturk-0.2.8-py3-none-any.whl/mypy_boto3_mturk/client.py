...
class Client(BaseClient):
    ...
    def associate_qualification_with_worker(
        ...
        **Request Syntax**
        ...
        :param WorkerId: **[REQUIRED]**
          ...
          The ID of the Worker to whom the Qualification is being assigned. Worker IDs are included
          with submitted HIT assignments and Qualification requests.
    ...
    def create_additional_assignments_for_hit(
        ...
        **Request Syntax**
        ...
        :param UniqueRequestToken:
          ...
          extending the HIT multiple times. This is useful in cases such as network timeouts where
          it is unclear whether or not the call succeeded on the server. If the extend HIT already
          exists in the system from a previous call using the same ``UniqueRequestToken`` ,
    ...
    def create_hit(
        ...
        QualificationRequirements: List[ClientCreateHitQualificationRequirementsTypeDef] = None,
        ...
        values to ``CreateHIT`` , a new HIT is created for you, with a new ``HITTypeID`` . The
        HITTypeID can be used to create additional HITs in the future without needing to specify
        common parameters such as the title, description and reward amount each time.

        An alternative way to create HITs is to first generate a HITTypeID using the
        ``CreateHITType`` operation and then call the ``CreateHITWithHITType`` operation. This is
        ...
        .. note::
          ...
          <https://requester.mturk.com/pricing>`__ .
        ...
        **Request Syntax**
              ...
              QualificationRequirements=[
                  {
                      ...
                      |'GreaterThanOrEqualTo'|'EqualTo'|'NotEqualTo'|'Exists'
                      |'DoesNotExist'|'In'|'NotIn',
                      'IntegerValues': [
                          123,
                      ],
                      'LocaleValues': [
        ...
        :param AutoApprovalDelayInSeconds:
          ...
          assignment is considered Approved automatically unless the Requester explicitly rejects
          it.
        ...
        :param AssignmentDurationInSeconds: **[REQUIRED]**
          ...
          If a Worker does not complete the assignment within the specified duration, the assignment
          is considered abandoned. If the HIT is still active (that is, its lifetime has not
          elapsed), the assignment becomes available for other users to find and accept.
        ...
        :param Description: **[REQUIRED]**
          ...
          kind of task the HIT contains. On the Amazon Mechanical Turk web site, the HIT description
          appears in the expanded view of search results, and in the HIT and assignment screens. A
          good description gives the user enough information to evaluate the HIT before accepting
          it.
        ...
        :param HITLayoutParameters:
          ...
          If the HITLayoutId is provided, any placeholder values must be filled in with values using
          the HITLayoutParameter structure. For more information, see HITLayout.
          ...
          - *(dict) --*
            ...
            - **HIT** *(dict) --*
              ...
              - **Keywords** *(string) --*
                ...
                terms similar to the keywords of a HIT are more likely to have the HIT in the search
                results.
              ...
              - **AutoApprovalDelayInSeconds** *(integer) --*
                ...
                amount of time the Requester has to reject an assignment submitted by a Worker
              ...
              - **QualificationRequirements** *(list) --*
                ...
                restricted using the ``ActionsGuarded`` field on each ``QualificationRequirement``
                structure.
                ...
                - *(dict) --*
                  ...
                  optionally state that a Worker must have the Qualification in order to preview the
                  HIT, or see the HIT in search results.
    ...
    def create_hit_type(
        ...
        AutoApprovalDelayInSeconds: int = None,
        Keywords: str = None,
        QualificationRequirements: List[ClientCreateHitTypeQualificationRequirementsTypeDef] = None,
    ) -> ClientCreateHitTypeResponseTypeDef:
        """
    ...
    def create_hit_with_hit_type(
        ...
        HITLayoutId: str = None,
        HITLayoutParameters: List[ClientCreateHitWithHitTypeHITLayoutParametersTypeDef] = None,
    ) -> ClientCreateHitWithHitTypeResponseTypeDef:
        """
    ...
    def create_qualification_type(
        ...
        **Request Syntax**
        ...
        :param RetryDelayInSeconds:
          ...
          been created with retries enabled. If you want to disable retries, you must delete
        ...
        :param TestDurationInSeconds:
          ...
          The number of seconds the Worker has to complete the Qualification test, starting from the
        ...
        :param AutoGrantedValue:
          ...
          The Qualification value to use for automatically granted Qualifications. This parameter is
          used only if the AutoGranted parameter is true.
          ...
          - *(dict) --*
            ...
            - **QualificationType** *(dict) --*
              ...
              - **Test** *(string) --*
                ...
                a user can take to obtain a Qualification of this type. This parameter must be
                specified if AnswerKey is present. A Qualification type cannot have both a specified
              ...
              - **AutoGranted** *(boolean) --*
                ...
                prompting the Worker with a Qualification test. Valid values are True
                | False.
    ...
    def create_worker_block(self, WorkerId: str, Reason: str) -> Dict[str, Any]:
        """
        The ``CreateWorkerBlock`` operation allows you to prevent a Worker from working on your
        HITs. For example, you can block a Worker who is producing poor quality work. You can block
    ...
    def delete_hit(self, HITId: str) -> Dict[str, Any]:
        ...
        expired, or still has active assignments), or on a HIT that is Reviewable but without all of
        its submitted assignments already approved or rejected, the service will return an error.
    ...
    def delete_worker_block(self, WorkerId: str, Reason: str = None) -> Dict[str, Any]:
        ...
        fails and returns the message “WorkerId is invalid.” If the specified Worker is not blocked,
          ...
          - *(dict) --*
            ...
            - **Assignment** *(dict) --*
              ...
              - **AutoApprovalTime** *(datetime) --*
                ...
                If results have been submitted, AutoApprovalTime is the date and time the results of
                the assignment results are considered Approved automatically if they have not
                already been explicitly approved or rejected by the Requester. This value is derived
                from the auto-approval delay specified by the Requester in the HIT. This value is
              ...
              - **Deadline** *(datetime) --*
                ...
                deadline specification for the HIT and the date and time the Worker accepted the
                HIT.
              ...
              - **Answer** *(string) --*
                ...
                answers, Answer may contain a QuestionFormAnswers document, or Answer may be empty.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              Amazon Mechanical Turk returns a pagination token in the response. You can use this
            ...
            - **Assignments** *(list) --*
              ...
              - *(dict) --*
                ...
                The assignment tracks the Worker's efforts to complete the HIT, and contains the
                ...
                - **AutoApprovalTime** *(datetime) --*
                  ...
                  of the assignment results are considered Approved automatically if they have not
                  already been explicitly approved or rejected by the Requester. This value is
                  derived from the auto-approval delay specified by the Requester in the HIT. This
                ...
                - **SubmitTime** *(datetime) --*
                  ...
                  assignment was submitted. This value is omitted from the assignment if the Worker
                  has not yet submitted results.

                - **ApprovalTime** *(datetime) --*

                  If the Worker has submitted results and the Requester has approved the results,
                  ApprovalTime is the date and time the Requester approved the results. This value
                  is omitted from the assignment if the Requester has not yet approved the results.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NumResults** *(integer) --*
              ...
              The number of bonus payments on this page in the filtered results list, equivalent to
              the number of bonus payments being returned by this call.
                ...
                'HITs': [
                    {
                        ...
                        'Keywords': 'string',
                        'HITStatus':
                        'Assignable'|'Unassignable'|'Reviewable'|'Reviewing'
                        |'Disposed',
                        'MaxAssignments': 123,
                        'Reward': 'string',
                        'AutoApprovalDelayInSeconds': 123,
                        ...
                        'QualificationRequirements': [
                            {
                                ...
                                'Comparator':
                                'LessThan'|'LessThanOrEqualTo'|'GreaterThan'
                                |'GreaterThanOrEqualTo'|'EqualTo'
                                |'NotEqualTo'|'Exists'|'DoesNotExist'|'In'
                                |'NotIn',
                                'IntegerValues': [
                                    123,
                                ],
            ...
            - **HITs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **QualificationRequirements** *(list) --*
                  ...
                  Conditions that a Worker's Qualifications must meet in order to accept the HIT. A
                  HIT can have between zero and ten Qualification requirements. All requirements
                  ...
                  - *(dict) --*
                    ...
                    - **Comparator** *(string) --*
                      ...
                      the IntegerValue. You can compare it to a LocaleValue to see if it is EqualTo,
                      or NotEqualTo the LocaleValue. You can check to see if the value is In or
                      NotIn a set of IntegerValue or LocaleValue values. Lastly, a Qualification
                      requirement can also test if a Qualification Exists or DoesNotExist in the
                    ...
                    - **IntegerValues** *(list) --*
                      ...
                      must not be present if Comparator is Exists or DoesNotExist. IntegerValue can
                      only be used if the Qualification type has an integer value; it cannot be used
                      with the Worker_Locale QualificationType ID. When performing a set comparison
                      by using the In or the NotIn comparator, you can use up to 15 IntegerValue
                    ...
                    - **LocaleValues** *(list) --*
                      ...
                      LocaleValue can only be used with the EqualTo, NotEqualTo, In, and NotIn
                      comparators. You must only use a single LocaleValue element when using the
                      EqualTo or NotEqualTo comparators. When performing a set comparison by using
                      the In or the NotIn comparator, you can use up to 30 LocaleValue elements in a
                      QualificationRequirement data structure.
                    ...
                    - **RequiredToPreview** *(boolean) --*
                      ...
                      DEPRECATED: Use the ``ActionsGuarded`` field instead. If RequiredToPreview is
                      true, the question data for the HIT will not be shown when a Worker whose
                      Qualifications do not meet this requirement tries to preview the HIT. That is,
                      a Worker's Qualifications must meet all of the requirements for which
                      RequiredToPreview is true in order to preview the HIT. If a Worker meets all
                      of the requirements where RequiredToPreview is true (or if there are no such
                      requirements), but does not meet all of the requirements for the HIT, the
                      Worker will be allowed to preview the HIT's question data, but will not be
                      allowed to accept and complete the HIT. The default is false. This should not
                      be used in combination with the ``ActionsGuarded`` field.
                    ...
                    - **ActionsGuarded** *(string) --*
                      ...
                      see it in their search results), "PreviewAndAccept" (Worker cannot accept or
                      preview the HIT, but can see the HIT in their search results), and
                      "DiscoverPreviewAndAccept" (Worker cannot accept, preview, or see the HIT in
                      their search results). It's possible for you to create a HIT with multiple
                      ...
                      the action. The actions in the order of least restrictive to most restrictive
                      are Discover, Preview and Accept. For example, if a Worker meets all
                      QualificationRequirements that are set to DiscoverPreviewAndAccept, but do not
                      meet all requirements that are set with PreviewAndAccept, then the Worker will
                      be able to Discover, i.e. see the HIT in their search result, but will not be
                      able to Preview or Accept the HIT. ActionsGuarded should not be used in
                      combination with the ``RequiredToPreview`` field.
            ...
            - **QualificationRequests** *(list) --*
              ...
              - *(dict) --*
                ...
                - **SubmitTime** *(datetime) --*
                  ...
                  either the time the Worker submitted answers for a Qualification test, or the time
                  the Worker requested the Qualification if the Qualification type does not have a
                  test.
    ...
    def list_qualification_types(
        ...
        **Request Syntax**
        ...
        :param MustBeOwnedByCaller:
          ...
          Specifies that only Qualification types that the Requester created are returned. If false,
          the operation returns all Qualification types.
          ...
          - *(dict) --*
            ...
            - **QualificationTypes** *(list) --*
              ...
              - *(dict) --*
                ...
                to be able to accept the HIT. The type also describes how a Worker can obtain a
                ...
                - **QualificationTypeStatus** *(string) --*
                  ...
                  The status of the Qualification type. A Qualification type's status determines if
                  users can apply to receive a Qualification of this type, and if HITs can be
                ...
                - **RetryDelayInSeconds** *(integer) --*
                  ...
                  The amount of time, in seconds, Workers must wait after taking the Qualification
                  test before they can take it again. Workers can take a Qualification test multiple
                  times if they were not granted the Qualification from a previous attempt, or if
                  the test offers a gradient score and they want a better score. If not specified,
                ...
                - **IsRequestable** *(boolean) --*
                  ...
                  the Amazon Mechanical Turk web site, such as by taking a Qualification test. This
                  value is False for Qualifications assigned automatically by the system. Valid
    ...
    def list_review_policy_results_for_hit(
        ...
        **Request Syntax**
        ...
        :param RetrieveActions:
          ...
          Specify if the operation should retrieve a list of the actions taken executing the Review
    ...
    def reject_assignment(self, AssignmentId: str, RequesterFeedback: str) -> Dict[str, Any]:
        ...
        the Status section of the web site. When you include a feedback message with the rejection,
        it helps the Worker understand why the assignment was rejected, and can improve the quality
    ...
    def reject_qualification_request(
        ...
        **Request Syntax**
        ...
        :param Reason:
          ...
          A text message explaining why the request was rejected, to be shown to the Worker who made
          the request.
    ...
    def send_bonus(
        ...
        as parameters to initiate payment of the bonus. You must include a message that explains the
        reason for the bonus payment, as the Worker may not be expecting the payment. Amazon
        Mechanical Turk collects a fee for bonus payments, similar to the HIT listing fee. This
        operation fails if your account does not have enough funds to pay for both the bonus and the
        fees.
        ...
        **Request Syntax**
        ...
        :param BonusAmount: **[REQUIRED]**
          ...
          represents $5.00 USD and "101.42" represents $101.42 USD). Do not include currency symbols
          or currency codes.
    ...
    def send_test_event_notification(
        self, Notification: ClientSendTestEventNotificationNotificationTypeDef, TestEventType: str
    ) -> Dict[str, Any]:
        """
          ...
          response = client.send_test_event_notification(
              Notification={
                  ...
                  'EventTypes': [
                      ...
                      |'HITExpired'|'HITReviewable'|'HITExtended'|'HITDisposed'|'Ping',
                  ]
              },
              TestEventType=
                  'AssignmentAccepted'|'AssignmentAbandoned'|'AssignmentReturned'
    ...
    def update_notification_settings(
        ...
        HIT type must already have a notification specification, or one must be provided in the same
    ...
    def update_qualification_type(
        ...
        test, you cannot update it to be AutoGranted. If the Qualification type does not have a test
        and one is provided by an update, the type will henceforth have a test.

        If you want to update the test duration or answer key for an existing test without changing
        the questions, you must specify a Test parameter with the original questions, along with the
        updated values.
        ...
        **Request Syntax**
        ...
        :param RetryDelayInSeconds:
          ...
          The amount of time, in seconds, that Workers must wait after requesting a Qualification of
          the specified Qualification type before they can retry the Qualification request. It is
          not possible to disable retries for a Qualification type after it has been created with
          retries enabled. If you want to disable retries, you must dispose of the existing
