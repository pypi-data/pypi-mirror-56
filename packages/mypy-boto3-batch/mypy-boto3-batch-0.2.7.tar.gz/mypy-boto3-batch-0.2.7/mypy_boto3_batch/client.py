"Main interface for batch Client"
...
class Client(BaseClient):
    ...
    def cancel_job(self, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        ``RUNNABLE`` state are cancelled. Jobs that have progressed to ``STARTING`` or ``RUNNING`` are not
        cancelled (but the API operation still succeeds, even if no job is cancelled); these jobs must be
        terminated with the  TerminateJob operation.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/CancelJob>`_
        ...
        **Request Syntax**
        ...
        :param reason: **[REQUIRED]**
          ...
          by future  DescribeJobs operations on the job. This message is also recorded in the AWS Batch
          activity logs.
    ...
    def create_compute_environment(
        ...
        serviceRole: str,
        state: str = None,
        computeResources: ClientCreateComputeEnvironmentcomputeResourcesTypeDef = None,
    ) -> ClientCreateComputeEnvironmentResponseTypeDef:
        """
        Creates an AWS Batch compute environment. You can create ``MANAGED`` or ``UNMANAGED`` compute
        environments.

        In a managed compute environment, AWS Batch manages the capacity and instance types of the compute
        resources within the environment. This is based on the compute resource specification that you
        define or the `launch template
        <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/ec2-launch-templates.html>`__ that you specify
        when you create the compute environment. You can choose to use Amazon EC2 On-Demand Instances or
        Spot Instances in your managed compute environment. You can optionally set a maximum price so that
        Spot Instances only launch when the Spot Instance price is below a specified percentage of the
        On-Demand price.
        ...
        In an unmanaged compute environment, you can manage your own compute resources. This provides more
        compute resource configuration options, such as using a custom AMI, but you must ensure that your
        AMI meets the Amazon ECS container instance AMI specification. For more information, see `Container
        Instance AMIs
        <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/container_instance_AMIs.html>`__ in the
        *Amazon Elastic Container Service Developer Guide* . After you have created your unmanaged compute
        environment, you can use the  DescribeComputeEnvironments operation to find the Amazon ECS cluster
        that is associated with it. Then, manually launch your container instances into that Amazon ECS
        cluster. For more information, see `Launching an Amazon ECS Container Instance
        <https://docs.aws.amazon.com/AmazonECS/latest/developerguide/launch_container_instance.html>`__ in
        the *Amazon Elastic Container Service Developer Guide* .

        .. note::

          AWS Batch does not upgrade the AMIs in a compute environment after it is created (for example,
          when a newer version of the Amazon ECS-optimized AMI is available). You are responsible for the
          management of the guest operating system (including updates and security patches) and any
          additional application software or utilities that you install on the compute resources. To use a
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/CreateComputeEnvironment>`_
        ...
        **Request Syntax**
        ...
        :param computeResources:
          ...
          - **allocationStrategy** *(string) --*
            ...
            fitting instance type can be allocated. This could be due to availability of the instance type
            ...
            not specified, the default is ``BEST_FIT`` , which will use only the best fitting instance type,
            waiting for additional capacity if it's not available. This allocation strategy keeps costs
            lower but can limit scaling. ``BEST_FIT_PROGRESSIVE`` will select an additional instance type
            that is large enough to meet the requirements of the jobs in the queue, with a preference for an
            instance type with a lower cost. ``SPOT_CAPACITY_OPTIMIZED`` is only available for Spot Instance
            compute resources and will select an additional instance type that is large enough to meet the
            requirements of the jobs in the queue, with a preference for an instance type that is less
          ...
          - **instanceTypes** *(list) --* **[REQUIRED]**
            ...
            pick instance types (from the C, M, and R instance families) on the fly that match the demand of
            your job queues.
          ...
          - **instanceRole** *(string) --* **[REQUIRED]**
            ...
            <https://docs.aws.amazon.com/batch/latest/userguide/instance_IAM_role.html>`__ in the *AWS Batch
            User Guide* .

          - **tags** *(dict) --*

            Key-value pair tags to be applied to resources that are launched in the compute environment. For
            AWS Batch, these take the form of "String1": "String2", where String1 is the tag key and String2
            is the tag value—for example, { "Name": "AWS Batch Instance - C4OnDemand" }.
          ...
          - **placementGroup** *(string) --*
            ...
            placement group and associate it with your compute resources. This keeps your multi-node
            parallel job on a logical grouping of instances within a single Availability Zone with high
            network flow potential. For more information, see `Placement Groups
          ...
          - **bidPercentage** *(integer) --*
            ...
            for that instance type before instances are launched. For example, if your maximum percentage is
            20%, then the Spot price must be below 20% of the current On-Demand price for that Amazon EC2
            instance. You always pay the lowest (market) price and never more than your maximum percentage.
    ...
    def create_job_queue(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/CreateJobQueue>`_
        ...
        **Request Syntax**
        ...
        :param priority: **[REQUIRED]**
          ...
          The priority of the job queue. Job queues with a higher priority (or a higher integer value for
    ...
    def delete_compute_environment(self, computeEnvironment: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DeleteComputeEnvironment>`_
    ...
    def delete_job_queue(self, jobQueue: str) -> Dict[str, Any]:
        ...
        UpdateJobQueue operation. All jobs in the queue are terminated when you delete a job queue.

        It is not necessary to disassociate compute environments from a queue before submitting a
        ``DeleteJobQueue`` request.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DeleteJobQueue>`_
    ...
    def deregister_job_definition(self, jobDefinition: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DeregisterJobDefinition>`_
    ...
    def describe_compute_environments(
        ...
        operation to determine the ``ecsClusterArn`` that you should launch your Amazon ECS container
        instances into.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DescribeComputeEnvironments>`_
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          initial request can be seen by sending another ``DescribeComputeEnvironments`` request with the
          returned ``nextToken`` value. This value can be between 1 and 100. If this parameter is not used,
          then ``DescribeComputeEnvironments`` returns up to 100 results and a ``nextToken`` value if
          applicable.

        :type nextToken: string
        :param nextToken:

          The ``nextToken`` value returned from a previous paginated ``DescribeComputeEnvironments`` request
            ...
            - **computeEnvironments** *(list) --*
              ...
              - *(dict) --*
                ...
                - **state** *(string) --*
                  ...
                  If the state is ``DISABLED`` , then the AWS Batch scheduler does not attempt to place jobs
                  within the environment. Jobs in a ``STARTING`` or ``RUNNING`` state continue to progress
                  normally. Managed compute environments in the ``DISABLED`` state do not scale out.
                ...
                - **computeResources** *(dict) --*
                  ...
                  - **allocationStrategy** *(string) --*
                    ...
                    will select an additional instance type that is large enough to meet the requirements of
                    the jobs in the queue, with a preference for an instance type with a lower cost.
                    ``SPOT_CAPACITY_OPTIMIZED`` is only available for Spot Instance compute resources and
                    will select an additional instance type that is large enough to meet the requirements of
                    the jobs in the queue, with a preference for an instance type that is less likely to be
                    interrupted.
                  ...
                  - **subnets** *(list) --*
                    ...
                    The VPC subnets into which the compute resources are launched. For more information, see
                    `VPCs and Subnets <https://docs.aws.amazon.com/vpc/latest/userguide/VPC_Subnets.html>`__
                  ...
                  - **placementGroup** *(string) --*
                    ...
                    Groups <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/placement-groups.html>`__ in
    ...
    def describe_job_definitions(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DescribeJobDefinitions>`_
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          The maximum number of results returned by ``DescribeJobDefinitions`` in paginated output. When
          this parameter is used, ``DescribeJobDefinitions`` only returns ``maxResults`` results in a single
          page along with a ``nextToken`` response element. The remaining results of the initial request can
          be seen by sending another ``DescribeJobDefinitions`` request with the returned ``nextToken``
              ...
              - *(dict) --*
                ...
                - **retryStrategy** *(dict) --*
                  ...
                  - **attempts** *(integer) --*
                    ...
                    and 10 attempts. If the value of ``attempts`` is greater than one, the job is retried on
                ...
                - **containerProperties** *(dict) --*
                  ...
                  - **image** *(string) --*
                    ...
                    are specified with `` *repository-url* /*image* :*tag* `` . Up to 255 letters (uppercase
                    and lowercase), numbers, hyphens, underscores, colons, periods, forward slashes, and
                    number signs are allowed. This parameter maps to ``Image`` in the `Create a container
                  ...
                  - **vcpus** *(integer) --*
                    ...
                    <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of the `Docker
                    Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--cpu-shares``
                    option to `docker run <https://docs.docker.com/engine/reference/run/>`__ . Each vCPU is
                  ...
                  - **privileged** *(boolean) --*
                    ...
                    in the `Create a container
                    <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of the `Docker
                    Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--privileged``
                  ...
                  - **nodeRangeProperties** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      - **targetNodes** *(string) --*
                        ...
                        index values of ``0`` through ``3`` . If the starting range value is omitted (``:n``
                        ), then ``0`` is used to start the range. If the ending range value is omitted
                        (``n:`` ), then the highest possible node index is used to end the range. Your
                        accumulative node ranges must account for all nodes (0:n). You may nest node ranges,
                        for example 0:10 and 4:5, in which case the 4:5 range properties override the 0:10
                        properties.
                      ...
                      - **container** *(dict) --*
                        ...
                        - **image** *(string) --*
                          ...
                          repositories are specified with `` *repository-url* /*image* :*tag* `` . Up to 255
                          letters (uppercase and lowercase), numbers, hyphens, underscores, colons, periods,
    ...
    def describe_job_queues(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DescribeJobQueues>`_
        ...
        **Request Syntax**
        ...
        :param maxResults:
          ...
          seen by sending another ``DescribeJobQueues`` request with the returned ``nextToken`` value. This
          value can be between 1 and 100. If this parameter is not used, then ``DescribeJobQueues`` returns
              ...
              - *(dict) --*
                ...
                - **computeEnvironmentOrder** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    environments are associated with a job queue, the compute environment with a lower order
    ...
    def describe_jobs(self, jobs: List[str]) -> ClientDescribeJobsResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/DescribeJobs>`_
            ...
            - **jobs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **attempts** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **stoppedAt** *(integer) --*
                      ...
                      (when the attempt transitioned from the ``RUNNING`` state to a terminal state, such as
                      ``SUCCEEDED`` or ``FAILED`` ).
                ...
                - **createdAt** *(integer) --*
                  ...
                  non-array jobs and parent array jobs, this is when the job entered the ``SUBMITTED`` state
                ...
                - **container** *(dict) --*
                  ...
                  - **reason** *(string) --*
                    ...
                    A short (255 max characters) human-readable string to provide additional details about a
                ...
                - **nodeDetails** *(dict) --*
                  ...
                  An object representing the details of a node that is associated with a multi-node parallel
                  job.
    ...
    def list_jobs(
        ...
        * an array job ID to return a list of that job's children
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/ListJobs>`_
        ...
        **Request Syntax**
        ...
        :param jobStatus:
          ...
          The job status with which to filter jobs in the specified queue. If you do not specify a status,
        ...
        :param maxResults:
          ...
          used, ``ListJobs`` only returns ``maxResults`` results in a single page along with a ``nextToken``
          response element. The remaining results of the initial request can be seen by sending another
          ``ListJobs`` request with the returned ``nextToken`` value. This value can be between 1 and 100.
          If this parameter is not used, then ``ListJobs`` returns up to 100 results and a ``nextToken``
          value if applicable.
            ...
            - **jobSummaryList** *(list) --*
              ...
              - *(dict) --*
                ...
                - **createdAt** *(integer) --*
                  ...
                  The Unix timestamp for when the job was created. For non-array jobs and parent array jobs,
    ...
    def register_job_definition(
        ...
        containerProperties: ClientRegisterJobDefinitioncontainerPropertiesTypeDef = None,
        nodeProperties: ClientRegisterJobDefinitionnodePropertiesTypeDef = None,
        retryStrategy: ClientRegisterJobDefinitionretryStrategyTypeDef = None,
        timeout: ClientRegisterJobDefinitiontimeoutTypeDef = None,
    ) -> ClientRegisterJobDefinitionResponseTypeDef:
        """
        Registers an AWS Batch job definition.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/RegisterJobDefinition>`_
        ...
        **Request Syntax**
        ...
        :param parameters:
          ...
          as a key-value pair mapping. Parameters in a ``SubmitJob`` request override any corresponding
        ...
        :param containerProperties:
          ...
          - **vcpus** *(integer) --*
            ...
            `Create a container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of
            the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--cpu-shares``
            option to `docker run <https://docs.docker.com/engine/reference/run/>`__ . Each vCPU is
            equivalent to 1,024 CPU shares. You must specify at least one vCPU.
          ...
          - **memory** *(integer) --*
            ...
            section of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the
            ``--memory`` option to `docker run <https://docs.docker.com/engine/reference/run/>`__ . You must
          ...
          - **mountPoints** *(list) --*
            ...
            `Create a container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of
            the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--volume``
            option to `docker run <https://docs.docker.com/engine/reference/run/>`__ .
          ...
          - **ulimits** *(list) --*
            ...
            A list of ``ulimits`` to set in the container. This parameter maps to ``Ulimits`` in the `Create
            a container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of the
            `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--ulimit`` option to
            `docker run <https://docs.docker.com/engine/reference/run/>`__ .
          ...
          - **linuxParameters** *(dict) --*
            ...
            - **devices** *(list) --*
              ...
              Any host devices to expose to the container. This parameter maps to ``Devices`` in the `Create
              a container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of the
              `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--device`` option
          ...
          - **nodeRangeProperties** *(list) --* **[REQUIRED]**
            ...
            - *(dict) --*
              ...
              - **targetNodes** *(string) --* **[REQUIRED]**
                ...
                values of ``0`` through ``3`` . If the starting range value is omitted (``:n`` ), then ``0``
                is used to start the range. If the ending range value is omitted (``n:`` ), then the highest
                possible node index is used to end the range. Your accumulative node ranges must account for
                all nodes (0:n). You may nest node ranges, for example 0:10 and 4:5, in which case the 4:5
              ...
              - **container** *(dict) --*
                ...
                - **memory** *(integer) --*
                  ...
                  <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__ section of the `Docker
                  Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``--memory`` option to
                  `docker run <https://docs.docker.com/engine/reference/run/>`__ . You must specify at least
                  4 MiB of memory for a job.
                ...
                - **command** *(list) --*
                  ...
                  the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the ``COMMAND``
                  ...
                  - *(dict) --*
                    ...
                    - **host** *(dict) --*
                      ...
                      - **sourcePath** *(string) --*
                        ...
                        path location does not exist on the host container instance, the Docker daemon
                    ...
                    - **name** *(string) --*
                      ...
                      and underscores are allowed. This name is referenced in the ``sourceVolume`` parameter
                ...
                - **mountPoints** *(list) --*
                  ...
                  The mount points for data volumes in your container. This parameter maps to ``Volumes`` in
                  the `Create a container <https://docs.docker.com/engine/api/v1.23/#create-a-container>`__
                  section of the `Docker Remote API <https://docs.docker.com/engine/api/v1.23/>`__ and the
        ...
        :param timeout:
          ...
          is not retried. The minimum value for the timeout is 60 seconds. Any timeout configuration that is
          specified during a  SubmitJob operation overrides the timeout configuration defined here. For more
    ...
    def submit_job(
        ...
        jobQueue: str,
        jobDefinition: str,
        arrayProperties: ClientSubmitJobarrayPropertiesTypeDef = None,
        dependsOn: List[ClientSubmitJobdependsOnTypeDef] = None,
        parameters: Dict[str, str] = None,
        containerOverrides: ClientSubmitJobcontainerOverridesTypeDef = None,
        nodeOverrides: ClientSubmitJobnodeOverridesTypeDef = None,
        retryStrategy: ClientSubmitJobretryStrategyTypeDef = None,
        timeout: ClientSubmitJobtimeoutTypeDef = None,
    ) -> ClientSubmitJobResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/SubmitJob>`_
        ...
        **Request Syntax**
        ...
        :param jobName: **[REQUIRED]**
          ...
          The name of the job. The first character must be alphanumeric, and up to 128 letters (uppercase
          and lowercase), numbers, hyphens, and underscores are allowed.

        :type jobQueue: string
        :param jobQueue: **[REQUIRED]**

          The job queue into which the job is submitted. You can specify either the name or the Amazon
        ...
        :param dependsOn:
          ...
          job completes sequentially, starting at index 0. You can also specify an ``N_TO_N`` type
        ...
        :param parameters:
          ...
          set in the job definition. Parameters are specified as a key and value pair mapping. Parameters in
          a ``SubmitJob`` request override any corresponding parameter defaults from the job definition.
        ...
        :param containerOverrides:
          ...
          container (that is specified in the job definition or the Docker image) with a ``command``
          override. You can also override existing environment variables (that are specified in the job
          ...
          - **command** *(list) --*
            ...
            The command to send to the container that overrides the default command from the Docker image or
            the job definition.
          ...
          - **environment** *(list) --*
            ...
            The environment variables to send to the container. You can add new environment variables, which
            are added to the container at launch, or you can override the existing environment variables
            ...
            - *(dict) --*
              ...
              - **containerOverrides** *(dict) --*
                ...
                - **resourceRequirements** *(list) --*
                  ...
                  The type and amount of a resource to assign to a container. This value overrides the value
                  set in the job definition. Currently, the only supported resource is ``GPU`` .
    ...
    def terminate_job(self, jobId: str, reason: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/TerminateJob>`_
    ...
    def update_compute_environment(
        ...
        state: str = None,
        computeResources: ClientUpdateComputeEnvironmentcomputeResourcesTypeDef = None,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/UpdateComputeEnvironment>`_
        ...
        **Request Syntax**
        ...
        :param state:
          ...
          The state of the compute environment. Compute environments in the ``ENABLED`` state can accept
    ...
    def update_job_queue(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/batch-2016-08-10/UpdateJobQueue>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_compute_environments` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_job_definitions` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `describe_job_queues` operation.
        """
