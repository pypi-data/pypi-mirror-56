"Main interface for codestar Client"
...
class Client(BaseClient):
    ...
    def associate_team_member(
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/AssociateTeamMember>`_
        ...
        **Request Syntax**
        ...
        :param projectRole: **[REQUIRED]**
          ...
          The AWS CodeStar project role that will apply to this user. This role determines what actions a
          user can take in an AWS CodeStar project.

        :type remoteAccessAllowed: boolean
        :param remoteAccessAllowed:

          Whether the team member is allowed to use an SSH public/private key pair to remotely access
          project resources, for example Amazon EC2 instances.
    ...
    def create_project(
        ...
        """
        Creates a project, including project resources. This action creates a project based on a submitted
        project request. A set of source code files and a toolchain template file can be included with the
        project request. If these are not provided, an empty project is created.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/CreateProject>`_
        ...
        :param sourceCode:
          ...
          - *(dict) --*
            ...
            - **destination** *(dict) --* **[REQUIRED]**
              ...
              The repository to be created in AWS CodeStar. Valid values are AWS CodeCommit or GitHub. After
              AWS CodeStar provisions the new repository, the source code files provided with the project
    ...
    def create_user_profile(
        ...
        """
        Creates a profile for a user that includes user preferences, such as the display name and email
        address assocciated with the user, in AWS CodeStar. The user profile is not project-specific.
        Information in the user profile is displayed wherever the user's information appears to other users
        in AWS CodeStar.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/CreateUserProfile>`_
        ...
        **Request Syntax**
        ...
        :param sshPublicKey:
          ...
          The SSH public key associated with the user in AWS CodeStar. If a project owner allows the user
          remote access to project resources, this public key will be used along with the user's private key
          for SSH access.
    ...
    def delete_project(
        ...
        """
        Deletes a project, including project resources. Does not delete users associated with the project,
        but does delete the IAM roles that allowed access to the project.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/DeleteProject>`_
        ...
        **Request Syntax**
        ...
        :param deleteStack:
          ...
          (except for any buckets in Amazon S3) as well as deleting the project itself. Recommended for most
          use cases.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **stackId** *(string) --*
              ...
              The ID of the primary stack in AWS CloudFormation that will be deleted as part of deleting the
    ...
    def delete_user_profile(
        ...
        """
        Deletes a user profile in AWS CodeStar, including all personal preference data associated with that
        profile, such as display name and email address. It does not delete the history of that user, for
        example the history of commits made by that user.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/DeleteUserProfile>`_
    ...
    def describe_project(self, id: str) -> ClientDescribeProjectResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/DescribeProject>`_
    ...
    def describe_user_profile(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/DescribeUserProfile>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **displayName** *(string) --*
              ...
              used to generate the initial icon associated with the user in AWS CodeStar projects. If spaces
              are included in the display name, the first character that appears after the space will be
              used as the second character in the user initial icon. The initial icon displays a maximum of
              two characters, so a display name with more than one space (for example "Mary Jane Major")
              would generate an initial icon using the first character and the first character after the
              space ("MJ", not "MM").
    ...
    def disassociate_team_member(self, projectId: str, userArn: str) -> Dict[str, Any]:
        ...
        that user that allowed access to the project and its resources. Disassociating a team member does
        not remove that user's profile from AWS CodeStar. It does not remove the user from IAM.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/DisassociateTeamMember>`_
    ...
    def list_projects(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/ListProjects>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          The continuation token to be used to return the next set of results, if the results cannot be
    ...
    def list_resources(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/ListResources>`_
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          The continuation token for the next set of results, if the results cannot be returned in one
          response.
    ...
    def list_tags_for_project(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/ListTagsForProject>`_
    ...
    def list_team_members(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/ListTeamMembers>`_
    ...
    def list_user_profiles(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/ListUserProfiles>`_
            ...
            - **userProfiles** *(list) --*
              ...
              - *(dict) --*
                ...
                - **displayName** *(string) --*
                  ...
                  generate the initial icon associated with the user in AWS CodeStar projects. If spaces are
                  included in the display name, the first character that appears after the space will be
                  used as the second character in the user initial icon. The initial icon displays a maximum
                  of two characters, so a display name with more than one space (for example "Mary Jane
                ...
                - **sshPublicKey** *(string) --*
                  ...
                  user remote access to project resources, this public key will be used along with the
    ...
    def tag_project(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/TagProject>`_
    ...
    def untag_project(self, id: str, tags: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/UntagProject>`_
    ...
    def update_project(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/UpdateProject>`_
    ...
    def update_team_member(
        ...
        """
        Updates a team member's attributes in an AWS CodeStar project. For example, you can change a team
        member's role in the project, or change whether they have remote access to project resources.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/UpdateTeamMember>`_
        ...
        **Request Syntax**
        ...
        :param projectRole:
          ...
          The role assigned to the user in the project. Project roles have different levels of access. For
          more information, see `Working with Teams
          <http://docs.aws.amazon.com/codestar/latest/userguide/working-with-teams.html>`__ in the *AWS
          CodeStar User Guide* .
        ...
        :param remoteAccessAllowed:
          ...
          associated with the user's profile. Even if this is set to True, the user must associate a public
    ...
    def update_user_profile(
        ...
        """
        Updates a user's profile in AWS CodeStar. The user profile is not project-specific. Information in
        the user profile is displayed wherever the user's information appears to other users in AWS
        CodeStar.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/codestar-2017-04-19/UpdateUserProfile>`_
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_team_members` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_user_profiles` operation.
        """
