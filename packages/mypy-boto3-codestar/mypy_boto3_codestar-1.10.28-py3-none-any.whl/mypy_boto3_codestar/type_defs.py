...
class ClientCreateProjectsourceCodedestinationgitHubTypeDef(
    ...
    Information about the GitHub repository to be created in AWS CodeStar. This is where the source
    ...
    - **description** *(string) --*
      ...
      Description for the GitHub repository to be created in AWS CodeStar. This description displays
      in GitHub after the repository is created.
    ...
    - **owner** *(string) --* **[REQUIRED]**
      ...
      The GitHub username for the owner of the GitHub repository to be created in AWS CodeStar. If
      this repository should be owned by a GitHub organization, provide its name.
...
class ClientListTeamMembersResponseteamMembersTypeDef(
    ...
    - **projectRole** *(string) --*
      ...
      The role assigned to the user in the project. Project roles have different levels of access.
      For more information, see `Working with Teams
...
class ClientListUserProfilesResponseuserProfilesTypeDef(
    ...
    - **displayName** *(string) --*
      ...
      the initial icon associated with the user in AWS CodeStar projects. If spaces are included in
