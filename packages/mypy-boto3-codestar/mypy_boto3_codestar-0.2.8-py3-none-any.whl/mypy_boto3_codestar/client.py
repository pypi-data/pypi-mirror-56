...
class Client(BaseClient):
          ...
          - *(dict) --*
            ...
            - **source** *(dict) --* **[REQUIRED]**
              ...
              - **s3** *(dict) --* **[REQUIRED]**
                ...
                Information about the Amazon S3 location where the source code files provided with
            ...
            - **destination** *(dict) --* **[REQUIRED]**
              ...
              - **gitHub** *(dict) --*
                ...
                the source code files provided with the project request will be uploaded after
                project creation.
                ...
                - **owner** *(string) --* **[REQUIRED]**
                  ...
                  CodeStar. If this repository should be owned by a GitHub organization, provide its
                  name.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **sshPublicKey** *(string) --*
              ...
              portion of the public/private keypair the user can use to access project resources if
              a project owner allows the user remote access to those resources.
    ...
    def delete_user_profile(self, userArn: str) -> ClientDeleteUserProfileResponseTypeDef:
        ...
        with that profile, such as display name and email address. It does not delete the history of
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **displayName** *(string) --*
              ...
              be set to both first and last name ("Mary Major") or a single name ("Mary"). The
              display name is also used to generate the initial icon associated with the user in AWS
              CodeStar projects. If spaces are included in the display name, the first character
              that appears after the space will be used as the second character in the user initial
              icon. The initial icon displays a maximum of two characters, so a display name with
              more than one space (for example "Mary Jane Major") would generate an initial icon
    ...
    def disassociate_team_member(self, projectId: str, userArn: str) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param userArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) of the IAM user or group whom you want to remove from the
          project.
    ...
    def list_projects(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          The continuation token to be used to return the next set of results, if the results cannot
    ...
    def list_resources(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          The continuation token for the next set of results, if the results cannot be returned in
          one response.
            ...
            - **teamMembers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **projectRole** *(string) --*
                  ...
                  of access. For more information, see `Working with Teams
                  <http://docs.aws.amazon.com/codestar/latest/userguide/working-with-teams.html>`__
            ...
            - **userProfiles** *(list) --*
              ...
              - *(dict) --*
                ...
                - **displayName** *(string) --*
                  ...
                  also used to generate the initial icon associated with the user in AWS CodeStar
                  projects. If spaces are included in the display name, the first character that
                  appears after the space will be used as the second character in the user initial
                  icon. The initial icon displays a maximum of two characters, so a display name
                  with more than one space (for example "Mary Jane Major") would generate an initial
                  icon using the first character and the first character after the space ("MJ", not
                  "MM").
    ...
    def update_team_member(
        ...
        **Request Syntax**
        ...
        :param remoteAccessAllowed:
          ...
          key associated with the user's profile. Even if this is set to True, the user must
