...
_roadrunner.SHARED_PTR_DISOWN_swigconstant(_roadrunner)
...
class ExecutableModel(_object):
    ...
    def getCompartmentIndexForFloatingSpecies(self, index):
...
class ExecutableModelFactory(_object):
    ...
    __swig_getmethods__["regenerateModel"] = lambda x: _roadrunner.ExecutableModelFactory_regenerateModel
    if _newclass:
        regenerateModel = staticmethod(_roadrunner.ExecutableModelFactory_regenerateModel)
...
def ExecutableModelFactory_regenerateModel(oldModel, doc, options):
    return _roadrunner.ExecutableModelFactory_regenerateModel(oldModel, doc, options)
ExecutableModelFactory_regenerateModel = _roadrunner.ExecutableModelFactory_regenerateModel


_roadrunner.VERSIONSTR_BASIC_swigconstant(_roadrunner)
VERSIONSTR_BASIC = _roadrunner.VERSIONSTR_BASIC

_roadrunner.VERSIONSTR_COMPILER_swigconstant(_roadrunner)
VERSIONSTR_COMPILER = _roadrunner.VERSIONSTR_COMPILER

_roadrunner.VERSIONSTR_DATE_swigconstant(_roadrunner)
VERSIONSTR_DATE = _roadrunner.VERSIONSTR_DATE

_roadrunner.VERSIONSTR_LIBSBML_swigconstant(_roadrunner)
VERSIONSTR_LIBSBML = _roadrunner.VERSIONSTR_LIBSBML

_roadrunner.VERSIONSTR_JITCOMPILER_swigconstant(_roadrunner)
VERSIONSTR_JITCOMPILER = _roadrunner.VERSIONSTR_JITCOMPILER

_roadrunner.VERSIONSTR_GIT_BRANCH_swigconstant(_roadrunner)
VERSIONSTR_GIT_BRANCH = _roadrunner.VERSIONSTR_GIT_BRANCH

_roadrunner.VERSIONSTR_GIT_COMMIT_swigconstant(_roadrunner)
...
class RoadRunner(_object):
    ...
    def saveState(self, *args):
        return _roadrunner.RoadRunner_saveState(self, *args)
    ...
    def getRatesOfChangeNamedArray(self):
    ...
    def getIndependentRatesOfChangeNamedArray(self):
    ...
    def getDependentRatesOfChangeNamedArray(self):
    ...
    def _addSpecies(self, *args):
        return _roadrunner.RoadRunner__addSpecies(self, *args)

    def addSpecies(self, *args):
        return _roadrunner.RoadRunner_addSpecies(self, *args)

    def removeSpecies(self, sid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeSpecies(self, sid, forceRegenerate)

    def setBoundary(self, sid, boundaryCondition, forceRegenerate=True):
        return _roadrunner.RoadRunner_setBoundary(self, sid, boundaryCondition, forceRegenerate)

    def setHasOnlySubstanceUnits(self, sid, hasOnlySubstanceUnits, forceRegenerate=True):
        return _roadrunner.RoadRunner_setHasOnlySubstanceUnits(self, sid, hasOnlySubstanceUnits, forceRegenerate)

    def setInitAmount(self, sid, initAmount, forceRegenerate=True):
        return _roadrunner.RoadRunner_setInitAmount(self, sid, initAmount, forceRegenerate)

    def setInitConcentration(self, sid, initConcentration, forceRegenerate=True):
        return _roadrunner.RoadRunner_setInitConcentration(self, sid, initConcentration, forceRegenerate)

    def setConstant(self, sid, constant, forceRegenerate=True):
        return _roadrunner.RoadRunner_setConstant(self, sid, constant, forceRegenerate)

    def _addReaction(self, rid, reactants, products, kineticLaw, forceRegenerate=True):
        return _roadrunner.RoadRunner__addReaction(self, rid, reactants, products, kineticLaw, forceRegenerate)

    def addReaction(self, rid, reactants, products, kineticLaw, forceRegenerate=True):
        return _roadrunner.RoadRunner_addReaction(self, rid, reactants, products, kineticLaw, forceRegenerate)

    def removeReaction(self, rid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeReaction(self, rid, forceRegenerate)

    def setReversible(self, rid, reversible, forceRegenerate=True):
        return _roadrunner.RoadRunner_setReversible(self, rid, reversible, forceRegenerate)

    def setKineticLaw(self, rid, kineticLaw, forceRegenerate=True):
        return _roadrunner.RoadRunner_setKineticLaw(self, rid, kineticLaw, forceRegenerate)

    def _addParameter(self, pid, value, forceRegenerate=True):
        return _roadrunner.RoadRunner__addParameter(self, pid, value, forceRegenerate)

    def addParameter(self, pid, value, forceRegenerate=True):
        return _roadrunner.RoadRunner_addParameter(self, pid, value, forceRegenerate)

    def removeParameter(self, pid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeParameter(self, pid, forceRegenerate)

    def _addCompartment(self, cid, initVolume, forceRegenerate=True):
        return _roadrunner.RoadRunner__addCompartment(self, cid, initVolume, forceRegenerate)

    def addCompartment(self, cid, initVolume, forceRegenerate=True):
        return _roadrunner.RoadRunner_addCompartment(self, cid, initVolume, forceRegenerate)

    def removeCompartment(self, cid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeCompartment(self, cid, forceRegenerate)

    def addAssignmentRule(self, vid, formula, forceRegenerate=True):
        return _roadrunner.RoadRunner_addAssignmentRule(self, vid, formula, forceRegenerate)

    def addRateRule(self, vid, formula, forceRegenerate=True):
        return _roadrunner.RoadRunner_addRateRule(self, vid, formula, forceRegenerate)

    def removeRules(self, vid, useInitialValue=False, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeRules(self, vid, useInitialValue, forceRegenerate)

    def addInitialAssignment(self, vid, formula, forceRegenerate=True):
        return _roadrunner.RoadRunner_addInitialAssignment(self, vid, formula, forceRegenerate)

    def removeInitialAssignment(self, vid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeInitialAssignment(self, vid, forceRegenerate)

    def addEvent(self, eid, useValuesFromTriggerTime, trigger, forceRegenerate=True):
        return _roadrunner.RoadRunner_addEvent(self, eid, useValuesFromTriggerTime, trigger, forceRegenerate)

    def addTrigger(self, eid, trigger, forceRegenerate=True):
        return _roadrunner.RoadRunner_addTrigger(self, eid, trigger, forceRegenerate)

    def setPersistent(self, eid, persistent, forceRegenerate=True):
        return _roadrunner.RoadRunner_setPersistent(self, eid, persistent, forceRegenerate)

    def setTriggerInitialValue(self, eid, initValue, forceRegenerate=True):
        return _roadrunner.RoadRunner_setTriggerInitialValue(self, eid, initValue, forceRegenerate)

    def addPriority(self, eid, priority, forceRegenerate=True):
        return _roadrunner.RoadRunner_addPriority(self, eid, priority, forceRegenerate)

    def addDelay(self, eid, delay, forceRegenerate=True):
        return _roadrunner.RoadRunner_addDelay(self, eid, delay, forceRegenerate)

    def addEventAssignment(self, eid, vid, formula, forceRegenerate=True):
        return _roadrunner.RoadRunner_addEventAssignment(self, eid, vid, formula, forceRegenerate)

    def removeEventAssignments(self, eid, vid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeEventAssignments(self, eid, vid, forceRegenerate)

    def removeEvent(self, eid, forceRegenerate=True):
        return _roadrunner.RoadRunner_removeEvent(self, eid, forceRegenerate)

    def validateCurrentSBML(self):
...
class Solver(_object):
    ...
    def getValueAsDoubleVector(self, key):
        return _roadrunner.Solver_getValueAsDoubleVector(self, key)
...
_roadrunner.VALIDATE_UNITS_swigconstant(_roadrunner)
VALIDATE_UNITS = _roadrunner.VALIDATE_UNITS

_roadrunner.VALIDATE_IDENTIFIER_swigconstant(_roadrunner)
VALIDATE_IDENTIFIER = _roadrunner.VALIDATE_IDENTIFIER

_roadrunner.VALIDATE_MATHML_swigconstant(_roadrunner)
VALIDATE_MATHML = _roadrunner.VALIDATE_MATHML

_roadrunner.VALIDATE_SBO_swigconstant(_roadrunner)
VALIDATE_SBO = _roadrunner.VALIDATE_SBO

_roadrunner.VALIDATE_OVERDETERMINED_swigconstant(_roadrunner)
VALIDATE_OVERDETERMINED = _roadrunner.VALIDATE_OVERDETERMINED

_roadrunner.VALIDATE_MODELING_PRACTICE_swigconstant(_roadrunner)
VALIDATE_MODELING_PRACTICE = _roadrunner.VALIDATE_MODELING_PRACTICE

_roadrunner.VALIDATE_GENERAL_swigconstant(_roadrunner)
...
class SBMLReader(_object):
    ...
    __swig_getmethods__["is_sbml"] = lambda x: _roadrunner.SBMLReader_is_sbml
    if _newclass:
