...
class Client(BaseClient):
    ...
    def associate_vpc_with_hosted_zone(
        ...
        .. warning::
          ...
          To perform the association, the VPC and the private hosted zone must already exist. You
        ...
        .. note::
          ...
          the private hosted zone must first submit a ``CreateVPCAssociationAuthorization`` request.
          Then the account that created the VPC must submit an ``AssociateVPCWithHostedZone``
          request.
        ...
        **Request Syntax**
        ::
          ...
          response = client.associate_vpc_with_hosted_zone(
              ...
              VPC={
                  ...
                  |'eu-west-3'|'eu-central-1'|'ap-east-1'|'me-south-1'|'ap-southeast-1'
                  |'ap-southeast-2'|'ap-south-1'|'ap-northeast-1'|'ap-northeast-2'
                  |'ap-northeast-3'|'eu-north-1'|'sa-east-1'|'ca-central-1'|'cn-north-1',
                  'VPCId': 'string'
              },
              Comment='string'
          )
        ...
        :param VPC: **[REQUIRED]**
          ...
          A complex type that contains information about the VPC that you want to associate with a
          private hosted zone.
          ...
          - *(dict) --*
            ...
            - **ChangeInfo** *(dict) --*
              ...
              - **SubmittedAt** *(datetime) --*
                ...
                <https://en.wikipedia.org/wiki/ISO_8601>`__ and Coordinated Universal Time (UTC).
              ...
              - **Comment** *(string) --*
                ...
                <https://docs.aws.amazon.com/Route53/latest/APIReference/API_GetChange.html>`__
    ...
    def change_resource_record_sets(
        ...
        are considered transactional changes. When using the Amazon Route 53 API to change resource
        record sets, Route 53 either makes all or none of the changes in a change batch request.
        This ensures that Route 53 never partially implements the intended changes to the resource
        record sets in a hosted zone.

        For example, a change batch request that deletes the ``CNAME`` record for www.example.com
        and creates an alias resource record set for www.example.com. Route 53 deletes the first
        resource record set and creates the second resource record set in a single operation. If
        either the ``DELETE`` or the ``CREATE`` action fails, then both changes (plus any other
        changes in the batch) fail, and the original ``CNAME`` record continues to exist.

        .. warning::

          Due to the nature of transactional changes, you can't delete the same resource record set
          more than once in a single change batch. If you attempt to delete the same change batch
          more than once, Route 53 returns an ``InvalidChangeBatch`` error.

         **Traffic Flow**

        To create resource record sets for complex routing configurations, use either the traffic
        flow visual editor in the Route 53 console or the API actions for traffic policies and
        ...
        the updates if the new configuration isn't performing as expected. For more information, see
        `Using Traffic Flow to Route DNS Traffic
        <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/traffic-flow.html>`__ in the
        ...
        * ``UPSERT`` : If a resource record set does not already exist, AWS creates it. If a
        ...
        Don't refer to the syntax in the "Parameter Syntax" section, which includes all of the
        ...
        When you submit a ``ChangeResourceRecordSets`` request, Route 53 propagates your changes to
        all of the Route 53 authoritative DNS servers. While your changes are propagating,
        ``GetChange`` returns a status of ``PENDING`` . When propagation is complete, ``GetChange``
        returns a status of ``INSYNC`` . Changes generally propagate to all Route 53 name servers
        ...
        <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DNSLimitations.html>`__ in the
        *Amazon Route 53 Developer Guide* .
                  ...
                  'Changes': [
                      {
                          ...
                          'ResourceRecordSet': {
                              'Name': 'string',
                              'Type':
                              'SOA'|'A'|'TXT'|'NS'|'CNAME'|'MX'|'NAPTR'|'PTR'
                              |'SRV'|'SPF'|'AAAA'|'CAA',
                              ...
                              |'eu-west-3'|'eu-central-1'|'ap-southeast-1'
            ...
            - *(dict) --*
              ...
              - **Action** *(string) --* **[REQUIRED]**
                ...
                * ``UPSERT`` : If a resource record set doesn't already exist, Route 53 creates it.
                If a resource record set does exist, Route 53 updates it with the values in the
                request.
              ...
              - **ResourceRecordSet** *(dict) --* **[REQUIRED]**
                ...
                - **Name** *(string) --* **[REQUIRED]**
                  ...
                  assumes that the domain name that you specify is fully qualified. This means that
                  ...
                  Name Format
                  <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DomainNameFormat.html>`__
                  ...
                  * If you include * in any position other than the leftmost label in a domain name,
                ...
                - **Type** *(string) --* **[REQUIRED]**
                  ...
                  encoded for them, see `Supported DNS Resource Record Types
                  <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/ResourceRecordTypes.html>`__
                  in the *Amazon Route 53 Developer Guide* .
                  ...
                  ``A`` | ``AAAA`` | ``CAA`` | ``CNAME`` | ``MX`` | ``NAPTR`` | ``PTR``
                  | ``SPF`` |
                  ``SRV``
                  | ``TXT`` . When creating a group of weighted, latency, geolocation, or
                  ...
                  .. note::
                    ...
                    for which the value of ``Type`` is ``SPF`` . RFC 7208, *Sender Policy Framework
                    (SPF) for Authorizing Use of Domains in Email, Version 1* , has been updated to
                    say, "...[I]ts existence and mechanism defined in [RFC4408] have led to some
                    ...
                    `The SPF DNS Record Type <http://tools.ietf.org/html/rfc7208#section-14.1>`__ .
                  ...
                  * **CloudFront distributions:**  ``A``   If IPv6 is enabled for the distribution,
                  create two resource record sets to route traffic to your distribution, one with a
                  ...
                  * **Another resource record set in this hosted zone:** Specify the type of the
                  ...
                  .. note::
                     ...
                     value of ``Type`` is ``CNAME`` . This is because the alias record must have the
                     same type as the record you're routing traffic to, and creating a CNAME record
                     for the zone apex isn't supported even for an alias record.
                ...
                - **SetIdentifier** *(string) --*
                   ...
                   *Resource record sets that have a routing policy other than simple:* An
                   ...
                   same combination of name and type, such as multiple weighted resource record sets
                   named acme.example.com that have a type of A. In a group of resource record sets
                   that have the same name and type, the value of ``SetIdentifier`` must be unique
                   for each resource record set.

                  For information about routing policies, see `Choosing a Routing Policy
                  <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-policy.html>`__
                  in the *Amazon Route 53 Developer Guide* .
                ...
                - **Weight** *(integer) --*
                   ...
                   *Weighted resource record sets only:* Among resource record sets that have the
                   ...
                   set. Route 53 calculates the sum of the weights for the resource record sets that
                   have the same combination of DNS name and type. Route 53 then responds to queries
                  ...
                  * You can create a maximum of 100 weighted resource record sets that have the same
                  ...
                  * For weighted (but not weighted alias) resource record sets, if you set
                  ...
                  DNS name and type, traffic is routed to all resources with equal probability. The
                  effect of setting ``Weight`` to ``0`` is different when you associate health
                  checks with weighted resource record sets. For more information, see `Options for
                ...
                - **Region** *(string) --*
                   ...
                   *Latency-based resource record sets only:* The Amazon EC2 Region where you
                   ...
                   and is referred to by an IP address or a DNS domain name, depending on the record
                   type.
                  ...
                  have created latency resource record sets, Route 53 selects the latency resource
                  record set that has the lowest latency between the end user and the associated
                  Amazon EC2 Region. Route 53 then returns the value that is associated with the
                  ...
                  * You can't create non-latency resource record sets that have the same values for
                  the ``Name`` and ``Type`` elements as latency resource record sets.
                ...
                - **GeoLocation** *(dict) --*
                  ...
                  (for example, one resource record set for a continent and one for a country on the
                  same continent), priority goes to the smallest geographic region. This allows you
                  to route most queries for a continent to one resource and to route queries for a
                  country on that continent to a different resource.
                  ...
                  .. warning::
                    ...
                    haven't created geolocation resource record sets and queries from IP addresses
                    that aren't mapped to a location. If you don't create a ``*`` resource record
                    set, Route 53 returns a "no answer" response for queries from those locations.
                ...
                - **Failover** *(string) --*
                   ...
                   *Failover resource record sets only:* To configure failover, you add the
                   ``Failover`` element to two resource record sets. For one resource record set,
                   ...
                   ``HealthCheckId`` element and specify the health check that you want Amazon Route
                  ...
                  * When the primary resource record set is healthy, Route 53 responds to DNS
                  ...
                  of the health of the secondary resource record set.

                  * When the primary resource record set is unhealthy and the secondary resource
                  record set is healthy, Route 53 responds to DNS queries with the applicable value
                ...
                - **MultiValueAnswer** *(boolean) --*
                   ...
                   *Multivalue answer resource record sets only* : To route traffic approximately
                   ...
                   record for each resource and specify ``true`` for ``MultiValueAnswer`` . Note the
                   following:
                  ...
                  * If you don't associate a health check with a multivalue answer record, Route 53
                  always considers the record to be healthy.

                  * Route 53 responds to DNS queries with up to eight healthy records; if you have
                  eight or fewer healthy records, Route 53 responds to all DNS queries with all the
                  healthy records.
                ...
                - **TTL** *(integer) --*
                  ...
                  * All of the resource record sets in a group of weighted resource record sets must
                  have the same value for ``TTL`` .
                  ...
                  * If a group of weighted resource record sets includes one or more weighted alias
                  ...
                  recommend that you specify a ``TTL`` of 60 seconds for all of the non-alias
                  weighted resource record sets that have the same name and type. Values other than
                  60 seconds (the TTL for load balancers) will change the effect of the values that
                ...
                - **ResourceRecords** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Value** *(string) --* **[REQUIRED]**
                      ...
                      for different record types, see `Supported DNS Resource Record Types
                ...
                - **AliasTarget** *(dict) --*
                  ...
                  * You can't create an alias resource record set in a private hosted zone to route
                  ...
                  * For information about creating failover resource record sets in a private hosted
                  ...
                  - **HostedZoneId** *(string) --* **[REQUIRED]**
                    ...
                    * For edge-optimized APIs, specify the value of ``distributionHostedZoneId`` .
                    ...
                    <http://docs.aws.amazon.com/general/latest/gr/rande.html#elasticbeanstalk_region>`__
                    ...
                    * `Elastic Load Balancing
                    <https://docs.aws.amazon.com/general/latest/gr/rande.html#elb_region>`__ table
                    in the "AWS Regions and Endpoints" chapter of the *Amazon Web Services General
                    Reference* : Use the value that corresponds with the region that you created
                    ...
                    * **AWS Management Console** : Go to the Amazon EC2 page, choose **Load
                    Balancers** in the navigation pane, select the load balancer, and get the value
                    ...
                    * **AWS CLI** : Use ``describe-load-balancers`` to get the applicable value. For
                    ...
                    more information about valid values, see the `Amazon Simple Storage Service
                    Website Endpoints
                    <http://docs.aws.amazon.com/general/latest/gr/rande.html#s3_region>`__ table in
                    the "AWS Regions and Endpoints" chapter of the *Amazon Web Services General
                    Reference* .
                  ...
                  - **DNSName** *(string) --* **[REQUIRED]**
                    ...
                    * For edge-optimized APIs, specify the value of ``distributionDomainName`` .
                    This is the name of the associated CloudFront distribution, such as
                    ...
                    *acme.example.com* as one of the alternate domain names. For more information,
                    ...
                    <http://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/CNAMEs.html>`__
                    in the *Amazon CloudFront Developer Guide* .

                    You can't create a resource record set in a private hosted zone to route traffic
                    ...
                    ``my-environment.*us-west-2* .elasticbeanstalk.com`` is a regionalized domain
                    name.
                    ...
                    .. warning::
                      ...
                      example.com, you can create a record that routes traffic for acme.example.com
                      to your Elastic Beanstalk environment, but you can't create a record that
                    ...
                    * *AWS Management Console* : For information about how to get the value by using
                    ...
                    <http://docs.aws.amazon.com/elasticbeanstalk/latest/dg/customdomains.html>`__ in
                    ...
                    * *AWS CLI* : Use the ``describe-environments`` command to get the value of the
                    ...
                    Specify the DNS name that is associated with the load balancer. Get the DNS name
                    by using the AWS Management Console, the ELB API, or the AWS CLI.

                    * **AWS Management Console** : Go to the EC2 page, choose **Load Balancers** in
                    the navigation pane, choose the load balancer, choose the **Description** tab,
                    and get the value of the **DNS name** field.  If you're routing traffic to a
                    Classic Load Balancer, get the value that begins with **dualstack** . If you're
                    routing traffic to another type of load balancer, get the value that applies to
                    ...
                    * **AWS CLI** : Use ``describe-load-balancers`` to get the value of ``DNSName``
                    ...
                    Specify the domain name of the Amazon S3 website endpoint that you created the
                    bucket in, for example, ``s3-website.us-east-2.amazonaws.com`` . For more
                    information about valid values, see the table `Amazon Simple Storage Service
                    (S3) Website Endpoints
                    <http://docs.aws.amazon.com/general/latest/gr/rande.html#s3_region>`__ in the
                    *Amazon Web Services General Reference* . For more information about using S3
                    buckets for websites, see `Getting Started with Amazon Route 53
                    <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/getting-started.html>`__
                    in the *Amazon Route 53 Developer Guide.*
                    ...
                    .. note::
                      ...
                      which the value of ``Type`` is ``CNAME`` . This is because the alias record
                  ...
                  - **EvaluateTargetHealth** *(boolean) --* **[REQUIRED]**
                     ...
                     *Applies only to alias, failover alias, geolocation alias, latency alias, and
                     weighted alias resource record sets:* When ``EvaluateTargetHealth`` is ``true``
                     , an alias resource record set inherits the health of the referenced AWS
                    ...
                    environment contains an ELB load balancer, Elastic Load Balancing routes queries
                    only to the healthy Amazon EC2 instances that are registered with the load
                    balancer. (An environment automatically contains an ELB load balancer if it
                    ...
                    itself is unhealthy, Route 53 routes queries to other available resources that
                    are healthy, if any.
                    ...
                    * **Classic Load Balancers** : If you specify an ELB Classic Load Balancer in
                    ``DNSName`` , Elastic Load Balancing routes queries only to the healthy Amazon
                    EC2 instances that are registered with the load balancer. If you set
                    ``EvaluateTargetHealth`` to ``true`` and either no EC2 instances are healthy or
                    the load balancer itself is unhealthy, Route 53 routes queries to other
                    resources.

                    * **Application and Network Load Balancers** : If you specify an ELB Application
                    or Network Load Balancer and you set ``EvaluateTargetHealth`` to ``true`` ,
                    Route 53 routes queries to the load balancer based on the health of the target
                ...
                - **HealthCheckId** *(string) --*
                  ...
                  * By determining the current state of a CloudWatch alarm (CloudWatch metric health
                  checks)
                  ...
                  .. warning::
                    ...
                    the ``Value`` element. When you add a ``HealthCheckId`` element to a resource
                    record set, Route 53 checks the health of the endpoint that you specified in the
                    health check.
                  ...
                  * **Non-alias resource record sets** : You're checking the health of a group of
                  ...
                  (such as multiple weighted records named www.example.com with a type of A) and you
                  specify health check IDs for all the resource record sets.  If the health check
                  status for a resource record set is healthy, Route 53 includes the record among
                  the records that it responds to DNS queries with. If the health check status for a
                  resource record set is unhealthy, Route 53 stops responding to DNS queries using
                  the value for that resource record set. If the health check status for all
                  resource record sets in the group is unhealthy, Route 53 considers all resource
                  ...
                  * **Alias resource record sets** : You specify the following settings:
                  ...
                  for a resource record set for the larger, associated geographic region. For
                  example, suppose you have resource record sets for a state in the United States,
                  for the entire United States, for North America, and a resource record set that
                  has ``*`` for ``CountryCode`` is ``*`` , which applies to all locations. If the
                ...
                - **TrafficPolicyInstanceId** *(string) --*
                  ...
                  resource record set. ``TrafficPolicyInstanceId`` is the ID of the traffic policy
                  ...
                  .. warning::
                    ...
                    using ``ChangeResourceRecordSets`` , Route 53 doesn't automatically delete the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **ChangeInfo** *(dict) --*
              ...
              This element contains an ID that you use when performing a `GetChange
              <https://docs.aws.amazon.com/Route53/latest/APIReference/API_GetChange.html>`__ action
    ...
    def change_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param AddTags:
          ...
          health check or hosted zone and/or the tags that you want to edit ``Value`` for.
    ...
    def create_health_check(
        ...
        instance with a load balancer, you configure settings for an ELB health check, which
        ...
        * You can create a CloudWatch metric, associate an alarm with the metric, and then create a
        ...
        console, see the `Amazon CloudWatch User Guide
        ...
        **Request Syntax**
          ...
          response = client.create_health_check(
              ...
              HealthCheckConfig={
                  ...
                  'AlarmIdentifier': {
                      ...
                      |'eu-central-1'|'eu-west-1'|'eu-west-2'|'eu-west-3'|'ap-east-1'
                      |'me-south-1'|'ap-south-1'|'ap-southeast-1'|'ap-southeast-2'
                      |'ap-northeast-1'|'ap-northeast-2'|'ap-northeast-3'|'eu-north-1'
        ...
        :param CallerReference: **[REQUIRED]**
          ...
          * If you send a ``CreateHealthCheck`` request with the same ``CallerReference`` and
          ...
          creates the health check. If the health check does exist, Route 53 returns the settings
                ...
                'HealthCheck': {
                    ...
                    'HealthCheckConfig': {
                        ...
                        'AlarmIdentifier': {
                            ...
                            |'eu-west-2'|'eu-west-3'|'ap-east-1'|'me-south-1'
                            |'ap-south-1'|'ap-southeast-1'|'ap-southeast-2'
                            |'ap-northeast-1'|'ap-northeast-2'|'ap-northeast-3'
                            |'eu-north-1'|'sa-east-1'|'cn-northwest-1'
                            |'cn-north-1',
                            'Name': 'string'
                        },
                        'InsufficientDataHealthStatus': 'Healthy'|'Unhealthy'|'LastKnownStatus'
            ...
            - **HealthCheck** *(dict) --*
              ...
              - **LinkedService** *(dict) --*
                ...
                - **Description** *(string) --*
                  ...
                  description that can be provided by the other service. When a resource is created
              ...
              - **HealthCheckConfig** *(dict) --*
                ...
                - **IPAddress** *(string) --*
                  ...
                  perform health checks on. If you don't specify a value for ``IPAddress`` , Route
                  53 sends a DNS request to resolve the domain name that you specify in
                  ``FullyQualifiedDomainName`` at the interval that you specify in
                  ``RequestInterval`` . Using an IP address returned by DNS, Route 53 then checks
                  ...
                  * **IPv6 address** : eight groups of four hexadecimal values, separated by colons
                  ...
                  is in local, private, non-routable, or multicast ranges. For more information
                  about IP addresses for which you can't create health checks, see the following
                  documents:
                ...
                - **Type** *(string) --*
                  ...
                  * **HTTP_STR_MATCH** : Route 53 tries to establish a TCP connection. If
                  successful, Route 53 submits an HTTP request and searches the first 5,120 bytes of
                  ...
                  * **CALCULATED** : For health checks that monitor the status of other health
                  checks, Route 53 adds up the number of health checks that Route 53 health checkers
                ...
                - **FullyQualifiedDomainName** *(string) --*
                  ...
                  and passes the value of ``FullyQualifiedDomainName`` in the ``Host`` header for
                  ...
                  * If you specify a value of ``80`` for ``Port`` and ``HTTP`` or ``HTTP_STR_MATCH``
                  ...
                  * If you specify another value for ``Port`` and any value except ``TCP`` for
                  ...
                  ``RequestInterval`` . Using an IPv4 address that DNS returns, Route 53 then checks
                  the health of the endpoint.
                  ...
                  .. note::
                    ...
                    A for the name that you specify for ``FullyQualifiedDomainName`` , the health
                  ...
                  www.example.com. For the value of ``FullyQualifiedDomainName`` , specify the
                ...
                - **RequestInterval** *(integer) --*
                  ...
                  your endpoint and the time that it sends the next health check request. Each Route
                ...
                - **Disabled** *(boolean) --*
                  ...
                  * **Health checks that monitor CloudWatch alarms:** Route 53 stops monitoring the
                  ...
                  check to always be healthy. If you configured DNS failover, Route 53 continues to
                  route traffic to the corresponding resources. If you want to stop routing traffic
                  to a resource, change the value of `Inverted
                  <https://docs.aws.amazon.com/Route53/latest/APIReference/API_UpdateHealthCheck.html#Route53-UpdateHealthCheck-request-Inverted>`__
                  .
                ...
                - **HealthThreshold** *(integer) --*
                  ...
                  to associate with a ``CALCULATED`` health check, use the `ChildHealthChecks
                  <https://docs.aws.amazon.com/Route53/latest/APIReference/API_UpdateHealthCheck.html#Route53-UpdateHealthCheck-request-ChildHealthChecks>`__
                  element.
                ...
                - **ChildHealthChecks** *(list) --*
                  ...
                  ``ChildHealthCheck`` element for each health check that you want to associate with
                  a ``CALCULATED`` health check.
                ...
                - **EnableSNI** *(boolean) --*
                  ...
                  during TLS negotiation. This allows the endpoint to respond to ``HTTPS`` health
                  ...
                  for other reasons. If SNI is enabled and you're still getting the error, check the
                  ...
                  One of the domain names in the certificate should match the value that you specify
                  for ``FullyQualifiedDomainName`` . If the endpoint responds to the
                  ``client_hello`` message with a certificate that does not include the domain name
                  that you specified in ``FullyQualifiedDomainName`` , a health checker will retry
                  the handshake. In the second attempt, the health checker will omit
                ...
                - **Regions** *(list) --*
                  ...
                  ensure that some health checkers are always checking the endpoint (for example, if
                  you replace three regions with four different regions).
                ...
                - **AlarmIdentifier** *(dict) --*
                  ...
                  - **Region** *(string) --*
                    ...
                    For the current list of CloudWatch regions, see `Amazon CloudWatch
                    <http://docs.aws.amazon.com/general/latest/gr/rande.html#cw_region>`__ in the
                    *AWS Regions and Endpoints* chapter of the *Amazon Web Services General
                    Reference* .
                  ...
                  - **Name** *(string) --*
                    ...
                    .. note::
                      ...
                      * Standard-resolution metrics. High-resolution metrics aren't supported. For
                      more information, see `High-Resolution Metrics
                      <http://docs.aws.amazon.com/AmazonCloudWatch/latest/DeveloperGuide/publishingMetrics.html#high-resolution-metrics>`__
                      in the *Amazon CloudWatch User Guide* .
    ...
    def create_hosted_zone(
        ...
        .. warning::
          ...
          you must create a new hosted zone with the same name and create new resource record sets.
        ...
        * For public hosted zones, Amazon Route 53 automatically creates a default SOA record and
        four NS records for the zone. For more information about SOA and NS records, see `NS and SOA
        Records that Route 53 Creates for a Hosted Zone
        <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/SOA-NSrecords.html>`__ in the
        *Amazon Route 53 Developer Guide* . If you want to use the same name servers for multiple
        public hosted zones, you can optionally associate a reusable delegation set with the hosted
        ...
        * If your domain is registered with a registrar other than Route 53, you must update the
        ...
        information, see `Migrating DNS Service for an Existing Domain to Amazon Route 53
        <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/MigratingDNS.html>`__ in the
        *Amazon Route 53 Developer Guide* .
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          *www.example.com* . The trailing dot is optional; Amazon Route 53 assumes that the domain
          ...
          change the name servers for your domain to the set of ``NameServers`` that
          ``CreateHostedZone`` returns in ``DelegationSet`` .

        :type VPC: dict
        :param VPC:

          (Private hosted zones only) A complex type that contains information about the Amazon VPC
          that you're associating with this hosted zone.
        ...
        :param CallerReference: **[REQUIRED]**
          ...
          unique ``CallerReference`` string every time you submit a ``CreateHostedZone`` request.
        ...
        :param DelegationSetId:
          ...
          information about reusable delegation sets, see `CreateReusableDelegationSet
          ...
          ::

            {
                ...
                'VPC': {
                    ...
                    |'eu-west-2'|'eu-west-3'|'eu-central-1'|'ap-east-1'|'me-south-1'
                    |'ap-southeast-1'|'ap-southeast-2'|'ap-south-1'|'ap-northeast-1'
                    |'ap-northeast-2'|'ap-northeast-3'|'eu-north-1'|'sa-east-1'
          ...
          - *(dict) --*
            ...
            - **HostedZone** *(dict) --*
              ...
              - **Config** *(dict) --*
                ...
                ``Config`` and ``Comment`` elements don't appear in the response.
    ...
    def create_query_logging_config(
        ...
        * Create a CloudWatch Logs log group, and make note of the ARN, which you specify when you
        create a query logging configuration. Note the following:
          ...
          * You must use the same AWS account to create the log group and the hosted zone that you
          ...
          * When you create log groups for query logging, we recommend that you use a consistent
          ...
          create a resource policy, which controls access to one or more log groups and the
          associated AWS resources, such as Route 53 hosted zones. There's a limit on the number of
        ...
        * Create a CloudWatch Logs resource policy, and give it the permissions that Route 53 needs
        ...
        .. note::
           ...
           You can't use the CloudWatch console to create or edit a resource policy. You must use
           the CloudWatch API, one of the AWS SDKs, or the AWS CLI.
        ...
        * Begins to send query logs to the applicable log stream.
        ...
        Global Network" on the `Route 53 Product Details <http://aws.amazon.com/route53/details/>`__
        page.

          Queries That Are Logged

        Query logs contain only the queries that DNS resolvers forward to Route 53. If a DNS
        resolver has already cached the response to a query (such as the IP address for a load
        ...
        DNS. For more information about how DNS works, see `Routing Internet Traffic to Your Website
        or Web Application
        <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/welcome-dns-service.html>`__ in
        the *Amazon Route 53 Developer Guide* .

          Log File Format

        For a list of the values in each query log and the format of each value, see `Logging DNS
        Queries <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/query-logs.html>`__ in
        the *Amazon Route 53 Developer Guide* .
        ...
        **Request Syntax**
        ...
        :param CloudWatchLogsLogGroupArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) for the log group that you want to Amazon Route 53 to send
          query logs to. This is the format of the ARN:
          ...
          <https://docs.aws.amazon.com/cli/latest/reference/logs/describe-log-groups.html>`__
    ...
    def create_reusable_delegation_set(
        ...
        hosted zones. If a hosted zoned ID is specified, ``CreateReusableDelegationSet`` marks the
        delegation set associated with that zone as reusable.
        ...
        see `Configuring White Label Name Servers
        ...
        * Change TTLs back to their original values.
        ...
        set. If one or more hosted zones do use one or more name servers that are assigned to the
        ...
        * For larger numbers of hosted zones, you can also migrate hosted zones that have
        ...
        **Request Syntax**
        ...
        :param CallerReference: **[REQUIRED]**
          ...
          ``CreateReusableDelegationSet`` request. ``CallerReference`` can be any unique string, for
          example a date/time stamp.

        :type HostedZoneId: string
        :param HostedZoneId:

          If you want to mark the delegation set for an existing hosted zone as reusable, the ID for
          that hosted zone.
    ...
    def create_traffic_policy(
        ...
        **Request Syntax**
        ...
        :param Document: **[REQUIRED]**
          ...
          The definition of this traffic policy in JSON format. For more information, see `Traffic
    ...
    def create_traffic_policy_instance(
        ...
        **Request Syntax**
        ...
        :param HostedZoneId: **[REQUIRED]**
          ...
          The ID of the hosted zone that you want Amazon Route 53 to create resource record sets in
        ...
        :param Name: **[REQUIRED]**
          ...
          which Amazon Route 53 responds to DNS queries by using the resource record sets that Route
          53 creates for this traffic policy instance.

        :type TTL: integer
        :param TTL: **[REQUIRED]**

          (Optional) The TTL that you want Amazon Route 53 to assign to all of the resource record
          sets that it creates in the specified hosted zone.

        :type TrafficPolicyId: string
        :param TrafficPolicyId: **[REQUIRED]**

          The ID of the traffic policy that you want to use to create resource record sets in the
          specified hosted zone.

        :type TrafficPolicyVersion: integer
        :param TrafficPolicyVersion: **[REQUIRED]**

          The version of the traffic policy that you want to use to create resource record sets in
          ...
          - *(dict) --*
            ...
            - **TrafficPolicyInstance** *(dict) --*
              ...
              - **Name** *(string) --*
                ...
                by using the resource record sets that are associated with this traffic policy
                instance.
    ...
    def create_traffic_policy_version(
        ...
        **Request Syntax**
        ...
        :param Document: **[REQUIRED]**
          ...
          The definition of this version of the traffic policy, in JSON format. You specified the
          JSON in the ``CreateTrafficPolicyVersion`` request. For more information about the JSON
          format, see `CreateTrafficPolicy
    ...
    def create_vpc_association_authorization(
        ...
        ``AssociateVPCWithHostedZone`` request to associate the VPC with a specified hosted zone
        that was created by a different account. To submit a ``CreateVPCAssociationAuthorization``
        ...
        .. note::
          ...
          If you want to associate multiple VPCs that you created by using one account with a hosted
    ...
    def delete_health_check(self, HealthCheckId: str) -> Dict:
        ...
        .. warning::
          ...
          is associated with one or more resource record sets. If you delete a health check and you
          don't update the associated resource record sets, the future status of the health check
          can't be predicted and may change. This will affect the routing of DNS queries for your
          DNS failover configuration. For more information, see `Replacing and Deleting Health
          Checks
    ...
    def delete_hosted_zone(self, Id: str) -> ClientDeleteHostedZoneResponseTypeDef:
        ...
        If the hosted zone was created by another service, such as AWS Cloud Map, see `Deleting
        Public Hosted Zones That Were Created by Another Service
        ...
        in the *Amazon Route 53 Developer Guide* for information about how to delete it. (The
        process is the same for public and private hosted zones that were created by another
        service.)
        ...
        .. warning::
          ...
          take effect. (If you delegated responsibility for a subdomain to a hosted zone and you
          delete the child hosted zone, you must update the name servers in the parent hosted zone.)
          In addition, if you delete a hosted zone, someone could hijack the domain and route
          traffic to their own resources using your domain name.
        ...
        name servers for the domain registration. If the domain is registered with Route 53, see
    ...
    def delete_traffic_policy_instance(self, Id: str) -> Dict:
        ...
        created when you created the instance.
    ...
    def delete_vpc_association_authorization(
        ...
        account that created the hosted zone to submit a ``DeleteVPCAssociationAuthorization``
        request.
        ...
        .. warning::
          ...
          associated with the hosted zone, ``DeleteVPCAssociationAuthorization`` won't disassociate
          the VPC from the hosted zone. If you want to delete an existing association, use
        ...
        **Request Syntax**
        ...
        :param HostedZoneId: **[REQUIRED]**
          ...
          When removing authorization to associate a VPC that was created by one AWS account with a
          hosted zone that was created with a different AWS account, the ID of the hosted zone.

        :type VPC: dict
        :param VPC: **[REQUIRED]**

          When removing authorization to associate a VPC that was created by one AWS account with a
          hosted zone that was created with a different AWS account, a complex type that includes
    ...
    def disassociate_vpc_from_hosted_zone(
        ...
        * You can submit a ``DisassociateVPCFromHostedZone`` request using either the account that
        created the hosted zone or the account that created the VPC.
    ...
    def get_account_limit(self, Type: str) -> ClientGetAccountLimitResponseTypeDef:
        ...
        *Amazon Route 53 Developer Guide* . To request a higher limit, `open a case
        ...
        .. note::
          ...
          Console and open the Trusted Advisor console at
    ...
    def get_change(self, Id: str) -> ClientGetChangeResponseTypeDef:
        ...
        * ``PENDING`` indicates that the changes in this request have not propagated to all Amazon
        Route 53 DNS servers. This is the initial status of all change batch requests.
    ...
    def get_checker_ip_ranges(
        ...
        .. warning::
           ...
           which includes IP address ranges for all AWS services. For more information, see `IP
           Address Ranges of Amazon Route 53 Servers
           <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/route-53-ip-addresses.html>`__
           in the *Amazon Route 53 Developer Guide* .
    ...
    def get_geo_location(
        ...
        **Request Syntax**
        ...
        :param CountryCode:
          ...
          3166-1 alpha-2 <https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2>`__ .
        ...
        :param SubdivisionCode:
          ...
          standard 3166-1 alpha-2 <https://en.wikipedia.org/wiki/ISO_3166-1_alpha-2>`__ . Route 53
    ...
    def get_health_check(self, HealthCheckId: str) -> ClientGetHealthCheckResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param HealthCheckId: **[REQUIRED]**
          ...
          The identifier that Amazon Route 53 assigned to the health check when you created it. When
              ...
              - *(dict) --*
                ...
                - **StatusReport** *(dict) --*
                  ...
                  - **CheckedTime** *(datetime) --*
                    ...
                    8601 format <https://en.wikipedia.org/wiki/ISO_8601>`__ and Coordinated
                ...
                'VPCs': [
                    {
                        'VPCRegion':
                        'us-east-1'|'us-east-2'|'us-west-1'|'us-west-2'|'eu-west-1'
                        |'eu-west-2'|'eu-west-3'|'eu-central-1'|'ap-east-1'
                        |'me-south-1'|'ap-southeast-1'|'ap-southeast-2'|'ap-south-1'
                        |'ap-northeast-1'|'ap-northeast-2'|'ap-northeast-3'
                        |'eu-north-1'|'sa-east-1'|'ca-central-1'|'cn-north-1',
                        'VPCId': 'string'
                    },
                ]
            }
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Limit** *(dict) --*
              ...
              ``Limit`` is the maximum number of records that you can create in the specified hosted
              zone.
            ...
            - **Count** *(integer) --*
              ...
              request, the value of ``Count`` is the current number of records that you have created
    ...
    def get_query_logging_config(self, Id: str) -> ClientGetQueryLoggingConfigResponseTypeDef:
        ...
        <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/query-logs.html>`__ .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **QueryLoggingConfig** *(dict) --*
              ...
              you specified in a `GetQueryLoggingConfig
    ...
    def get_reusable_delegation_set_limit(
        ...
        **Request Syntax**
        ...
        :param Type: **[REQUIRED]**
          ...
          Specify ``MAX_ZONES_BY_REUSABLE_DELEGATION_SET`` to get the maximum number of hosted zones
    ...
    def list_geo_locations(
        ...
        subdivisions for a country (for example, states or provinces), the subdivisions for that
        country are listed in alphabetical order immediately after the corresponding country.
        ...
        **Request Syntax**
        ...
        :param StartContinentCode:
          ...
          results, if ``IsTruncated`` is true, and if ``NextContinentCode`` from the previous
          response has a value, enter that value in ``startcontinentcode`` to return the next page
          of results.
        ...
        :param StartCountryCode:
          ...
          The code for the country with which you want to start listing locations that Amazon Route
          53 supports for geolocation. If Route 53 has already returned a page or more of results,
          if ``IsTruncated`` is ``true`` , and if ``NextCountryCode`` from the previous response has
          a value, enter that value in ``startcountrycode`` to return the next page of results.
        ...
        :param StartSubdivisionCode:
          ...
          The code for the subdivision (for example, state or province) with which you want to start
          listing locations that Amazon Route 53 supports for geolocation. If Route 53 has already
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IsTruncated** *(boolean) --*
              ...
              location in this response. If so, the value of ``IsTruncated`` is ``true`` . To get
            ...
            - **NextCountryCode** *(string) --*
              ...
              If ``IsTruncated`` is ``true`` , you can make a follow-up request to display more
              locations. Enter the value of ``NextCountryCode`` in the ``startcountrycode``
              parameter in another ``ListGeoLocations`` request.
    ...
    def list_health_checks(
        ...
        **Request Syntax**
        ...
        :param MaxItems:
          ...
          response to the current request. Amazon Route 53 returns a maximum of 100 items. If you
                ...
                'HealthChecks': [
                    {
                        ...
                        'HealthCheckConfig': {
                            ...
                            'AlarmIdentifier': {
                                ...
                                |'us-west-2'|'ca-central-1'|'eu-central-1'
                                |'eu-west-1'|'eu-west-2'|'eu-west-3'
                                |'ap-east-1'|'me-south-1'|'ap-south-1'
                                |'ap-southeast-1'|'ap-southeast-2'
                                |'ap-northeast-1'|'ap-northeast-2'
                                |'ap-northeast-3'|'eu-north-1'|'sa-east-1'
          ...
          **Response Structure**
          ...
          - *(dict) --*
                ...
                - **HealthCheckConfig** *(dict) --*
                  ...
                  - **IPAddress** *(string) --*
                    ...
                    * **IPv6 address** : eight groups of four hexadecimal values, separated by
                    colons (:), for example, ``2001:0db8:85a3:0000:0000:abcd:0001:2345`` . You can
                  ...
                  - **Type** *(string) --*
                    ...
                    * **HTTP** : Route 53 tries to establish a TCP connection. If successful, Route
                    53 submits an HTTP request and waits for an HTTP status code of 200 or greater
                    and less than 400.
                    ...
                    * **CLOUDWATCH_METRIC** : The health check is associated with a CloudWatch
                    ...
                    If CloudWatch doesn't have sufficient data to determine whether the state is
                  ...
                  - **FullyQualifiedDomainName** *(string) --*
                    ...
                    header for all health checks except TCP health checks. This is typically the
                    fully qualified DNS name of the endpoint on which you want Route 53 to perform
                    health checks.
                    ...
                    * If you specify another value for ``Port`` and any value except ``TCP`` for
                    ...
                    In addition, if the value that you specify for ``Type`` is ``HTTP`` , ``HTTPS``
                    , ``HTTP_STR_MATCH`` , or ``HTTPS_STR_MATCH`` , Route 53 passes the value of
                    ``FullyQualifiedDomainName`` in the ``Host`` header, as it does when you specify
                    a value for ``IPAddress`` . If the value of ``Type`` is ``TCP`` , Route 53
                  ...
                  - **HealthThreshold** *(integer) --*
                    ...
                    health check to be considered healthy. To specify the child health checks that
                    you want to associate with a ``CALCULATED`` health check, use the
                    `ChildHealthChecks
                    <https://docs.aws.amazon.com/Route53/latest/APIReference/API_UpdateHealthCheck.html#Route53-UpdateHealthCheck-request-ChildHealthChecks>`__
                    element.
                  ...
                  - **EnableSNI** *(boolean) --*
                    ...
                    that status for other reasons. If SNI is enabled and you're still getting the
                    error, check the SSL/TLS configuration on your endpoint and confirm that your
                    certificate is valid.

                    The SSL/TLS certificate on your endpoint includes a domain name in the ``Common
                    Name`` field and possibly several more in the ``Subject Alternative Names``
                    field. One of the domain names in the certificate should match the value that
                    you specify for ``FullyQualifiedDomainName`` . If the endpoint responds to the
                    ``client_hello`` message with a certificate that does not include the domain
                    name that you specified in ``FullyQualifiedDomainName`` , a health checker will
                    retry the handshake. In the second attempt, the health checker will omit
                    ``FullyQualifiedDomainName`` from the ``client_hello`` message.
                  ...
                  - **InsufficientDataHealthStatus** *(string) --*
                    ...
                    * ``LastKnownStatus`` : Route 53 uses the status of the health check from the
                    last time that CloudWatch had sufficient data to determine the alarm state. For
            ...
            - **IsTruncated** *(boolean) --*
              ...
              another ``ListHealthChecks`` request and specifying the value of ``NextMarker`` in the
              ``marker`` parameter.
    ...
    def list_hosted_zones(
        ...
        AWS account. The response includes a ``HostedZones`` child element for each hosted zone.
        ...
        **Request Syntax**
        ...
        :param Marker:
          ...
          For the value of ``marker`` , specify the value of ``NextMarker`` from the previous
          response, which is the ID of the first hosted zone that Amazon Route 53 will return if you
        ...
        :param MaxItems:
          ...
          (Optional) The maximum number of hosted zones that you want Amazon Route 53 to return. If
          you have more than ``maxitems`` hosted zones, the value of ``IsTruncated`` in the response
          is ``true`` , and the value of ``NextMarker`` is the hosted zone ID of the first hosted
        ...
        :param DelegationSetId:
          ...
          are associated with a reusable delegation set, specify the ID of that reusable delegation
          set.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IsTruncated** *(boolean) --*
              ...
              was truncated, you can get more hosted zones by submitting another ``ListHostedZones``
    ...
    def list_hosted_zones_by_name(
        ...
        you specify ex\\344mple.com for the domain name. ``ListHostedZonesByName`` alphabetizes it
        as:

         ``com.ex\\344mple.``

        The labels are reversed and alphabetized using the escaped value. For more information about
        valid domain name formats, including internationalized domain names, see `DNS Domain Name
        Format <http://docs.aws.amazon.com/Route53/latest/DeveloperGuide/DomainNameFormat.html>`__
        in the *Amazon Route 53 Developer Guide* .

        Route 53 returns up to 100 items in each response. If you have a lot of hosted zones, use
        the ``MaxItems`` parameter to list them in groups of up to 100. The response includes values
        ...
        * The ``MaxItems`` element in the response contains the value, if any, that you specified
        for the ``maxitems`` parameter in the request that produced the current response.
        ...
        * If the value of ``IsTruncated`` in the response is true, there are more hosted zones
        ...
        includes the last hosted zone that is associated with the current account. The
        ``NextDNSName`` element and ``NextHostedZoneId`` elements are omitted from the response.

        * The ``NextDNSName`` and ``NextHostedZoneId`` elements in the response contain the domain
        name and the hosted zone ID of the next hosted zone that is associated with the current AWS
        ...
        **Request Syntax**
        ...
        :param DNSName:
          ...
          If you don't include the ``dnsname`` parameter, Amazon Route 53 returns all of the hosted
          zones that were created by the current AWS account, in ASCII order. For subsequent
          requests, include both ``dnsname`` and ``hostedzoneid`` parameters. For ``dnsname`` ,
        ...
        :param HostedZoneId:
          ...
          ``dnsname`` and ``hostedzoneid`` parameters. For the value of ``hostedzoneid`` , specify
        ...
        :param MaxItems:
          ...
          If you have more than ``maxitems`` hosted zones, then the value of the ``IsTruncated``
          element in the response is true, and the values of ``NextDNSName`` and
    ...
    def list_query_logging_configs(
        ...
        For more information about DNS query logs, see `CreateQueryLoggingConfig
        <https://docs.aws.amazon.com/Route53/latest/APIReference/API_CreateQueryLoggingConfig.html>`__
        . Additional information, including the format of DNS query logs, appears in `Logging DNS
        Queries <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/query-logs.html>`__ in
        the *Amazon Route 53 Developer Guide* .
        ...
        **Request Syntax**
        ...
        :param HostedZoneId:
          ...
          (Optional) If you want to list the query logging configuration that is associated with a
          hosted zone, specify the ID in ``HostedZoneId`` .
        ...
        :param MaxResults:
          ...
          (Optional) The maximum number of query logging configurations that you want Amazon Route
          53 to return in response to the current request. If the current AWS account has more than
          ``MaxResults`` configurations, use the value of `NextToken
            ...
            - **QueryLoggingConfigs** *(list) --*
              ...
              - *(dict) --*
                ...
                - **CloudWatchLogsLogGroupArn** *(string) --*
                  ...
                  The Amazon Resource Name (ARN) of the CloudWatch Logs log group that Amazon Route
                  53 is publishing logs to.

            - **NextToken** *(string) --*

              If a response includes the last of the query logging configurations that are
              associated with the current AWS account, ``NextToken`` doesn't appear in the response.
    ...
    def list_resource_record_sets(
         ...
         **Sort order**
         ...
         ``ListResourceRecordSets`` sorts results first by DNS name with the labels reversed, for
         example:

         ``com.example.www.``

        Note the trailing dot, which can change the sort order when the record name contains
        characters that appear before ``.`` (decimal 46) in the ASCII table. These characters
        include the following: ``! " # $ % & ' ( ) * + , -``

        When multiple records have the same DNS name, ``ListResourceRecordSets`` sorts results by
        the record type.

         **Specifying where to start listing records**

        You can use the name and type elements to specify the resource record set that the list
        begins with:
        ...
        display results without the latest changes while other pages display results with the latest
        changes.
        ...
        response. Then submit another ``ListResourceRecordSets`` request, and specify those values
        for ``StartRecordName`` , ``StartRecordType`` , and ``StartRecordIdentifier`` .
        ...
        **Request Syntax**
        ...
        :param StartRecordIdentifier:
           ...
           *Resource record sets that have a routing policy other than simple:* If results were
           truncated for a given DNS name and type, specify the value of ``NextRecordIdentifier``
           from the previous response to get the next resource record set that has the current DNS
           name and type.

        :type MaxItems: string
        :param MaxItems:

          (Optional) The maximum number of resource records sets to include in the response body for
          this request. If the response includes more than ``maxitems`` resource record sets, the
          value of the ``IsTruncated`` element in the response is ``true`` , and the values of the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextRecordIdentifier** *(string) --*
              ...
              For information about routing policies, see `Choosing a Routing Policy
              <https://docs.aws.amazon.com/Route53/latest/DeveloperGuide/routing-policy.html>`__ in
              the *Amazon Route 53 Developer Guide* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Marker** *(string) --*
              ...
              the value that you specified for the ``marker`` parameter in the request that produced
              the current response.
                ...
                - *(dict) --*
                  ...
                  - **Key** *(string) --*
                    ...
                    * **Give a name to a health check** : Edit the default ``Name`` tag. In the
                    Amazon Route 53 console, the list of your health checks includes a **Name**
    ...
    def list_tags_for_resources(
        ...
        **Request Syntax**
        ...
        :param ResourceIds: **[REQUIRED]**
          ...
          A complex type that contains the ResourceId element for each resource for which you want
                ...
                - **Tags** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **Key** *(string) --*
                      ...
                      * **Add a tag to a health check or hosted zone** : ``Key`` is the name that
                      you want to give the new tag.
    ...
    def list_traffic_policies(
        ...
        the current AWS account. Policies are listed in the order that they were created in.
        ...
        **Request Syntax**
        ...
        :param MaxItems:
          ...
          (Optional) The maximum number of traffic policies that you want Amazon Route 53 to return
          in response to this request. If you have more than ``MaxItems`` traffic policies, the
          value of ``IsTruncated`` in the response is ``true`` , and the value of
          ``TrafficPolicyIdMarker`` is the ID of the first traffic policy that Route 53 will return
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TrafficPolicySummaries** *(list) --*
              ...
              A list that contains one ``TrafficPolicySummary`` element for each traffic policy that
    ...
    def list_traffic_policy_instances(
        ...
        .. note::
          ...
          After you submit an ``UpdateTrafficPolicyInstance`` request, there's a brief delay while
          Amazon Route 53 creates the resource record sets that are specified in the traffic policy
        ...
        policy instances, you can use the ``MaxItems`` parameter to list them in groups of up to
        100.
        ...
        **Request Syntax**
        ...
        :param HostedZoneIdMarker:
          ...
          value of ``HostedZoneIdMarker`` from the previous response, which is the hosted zone ID of
        ...
        :param TrafficPolicyInstanceNameMarker:
          ...
          specify the value of ``TrafficPolicyInstanceNameMarker`` from the previous response, which
          is the name of the first traffic policy instance in the next group of traffic policy
          instances.
        ...
        :param TrafficPolicyInstanceTypeMarker:
          ...
          specify the value of ``TrafficPolicyInstanceTypeMarker`` from the previous response, which
          is the type of the first traffic policy instance in the next group of traffic policy
          instances.
        ...
        :param MaxItems:
          ...
          The maximum number of traffic policy instances that you want Amazon Route 53 to return in
          response to a ``ListTrafficPolicyInstances`` request. If you have more than ``MaxItems``
          traffic policy instances, the value of the ``IsTruncated`` element in the response is
          ``true`` , and the values of ``HostedZoneIdMarker`` , ``TrafficPolicyInstanceNameMarker``
          , and ``TrafficPolicyInstanceTypeMarker`` represent the first traffic policy instance in
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TrafficPolicyInstances** *(list) --*
              ...
              - *(dict) --*
                ...
                - **State** *(string) --*
                  ...
                  of ``State`` is ``Failed`` , see ``Message`` for an explanation of what caused the
                  request to fail.
            ...
            - **HostedZoneIdMarker** *(string) --*
              ...
              If ``IsTruncated`` is ``true`` , ``HostedZoneIdMarker`` is the ID of the hosted zone
              of the first traffic policy instance that Route 53 will return if you submit another
              ``ListTrafficPolicyInstances`` request.

            - **TrafficPolicyInstanceNameMarker** *(string) --*

              If ``IsTruncated`` is ``true`` , ``TrafficPolicyInstanceNameMarker`` is the name of
            ...
            - **TrafficPolicyInstanceTypeMarker** *(string) --*
              ...
              of the resource record sets that are associated with the first traffic policy instance
              that Amazon Route 53 will return if you submit another ``ListTrafficPolicyInstances``
              request.
    ...
    def list_traffic_policy_instances_by_hosted_zone(
        ...
        **Request Syntax**
        ...
        :param TrafficPolicyInstanceNameMarker:
          ...
          If the value of ``IsTruncated`` in the previous response is true, you have more traffic
        ...
        :param MaxItems:
          ...
          this request. If you have more than ``MaxItems`` traffic policy instances, the value of
          the ``IsTruncated`` element in the response is ``true`` , and the values of
          ``HostedZoneIdMarker`` , ``TrafficPolicyInstanceNameMarker`` , and
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TrafficPolicyInstanceTypeMarker** *(string) --*
              ...
              resource record sets that are associated with the first traffic policy instance in the
            ...
            - **IsTruncated** *(boolean) --*
              ...
              submitting another ``ListTrafficPolicyInstancesByHostedZone`` request and specifying
              the values of ``HostedZoneIdMarker`` , ``TrafficPolicyInstanceNameMarker`` , and
              ``TrafficPolicyInstanceTypeMarker`` in the corresponding request parameters.
    ...
    def list_traffic_policy_instances_by_policy(
        ...
        **Request Syntax**
        ...
        :param TrafficPolicyVersion: **[REQUIRED]**
          ...
          The version of the traffic policy for which you want to list traffic policy instances. The
          version must be associated with the traffic policy that is specified by
          ``TrafficPolicyId`` .
        ...
        :param TrafficPolicyInstanceNameMarker:
          ...
          ``TrafficPolicyInstanceNameMarker`` from the previous response, which is the name of the
        ...
        :param TrafficPolicyInstanceTypeMarker:
          ...
          ``TrafficPolicyInstanceTypeMarker`` from the previous response, which is the name of the
          first traffic policy instance that Amazon Route 53 will return if you submit another
          request.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IsTruncated** *(boolean) --*
              ...
              A flag that indicates whether there are more traffic policy instances to be listed. If
              the response was truncated, you can get the next group of traffic policy instances by
              calling ``ListTrafficPolicyInstancesByPolicy`` again and specifying the values of the
              ``HostedZoneIdMarker`` , ``TrafficPolicyInstanceNameMarker`` , and
    ...
    def list_traffic_policy_versions(
        ...
        **Request Syntax**
        ...
        :param TrafficPolicyVersionMarker:
          ...
          get more traffic policy versions, submit another ``ListTrafficPolicyVersions`` request.
          For the value of ``TrafficPolicyVersionMarker`` , specify the value of
          ``TrafficPolicyVersionMarker`` in the previous response.

        :type MaxItems: string
        :param MaxItems:

          The maximum number of traffic policy versions that you want Amazon Route 53 to include in
          the response body for this request. If the specified traffic policy has more than
          ``MaxItems`` versions, the value of ``IsTruncated`` in the response is ``true`` , and the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **TrafficPolicyVersionMarker** *(string) --*
              ...
              another request. Call ``ListTrafficPolicyVersions`` again and specify the value of
    ...
    def list_vpc_association_authorizations(
        ...
        The response includes a ``VPCs`` element with a ``VPC`` child element for each VPC that can
        ...
        **Request Syntax**
        ...
        :param HostedZoneId: **[REQUIRED]**
          ...
          The ID of the hosted zone for which you want a list of VPCs that can be associated with
          the hosted zone.

        :type NextToken: string
        :param NextToken:

           *Optional* : If a response includes a ``NextToken`` element, there are more VPCs that can
           be associated with the specified hosted zone. To get the next page of results, submit
           another request, and include the value of ``NextToken`` from the response in the
           ``nexttoken`` parameter in another ``ListVPCAssociationAuthorizations`` request.

        :type MaxResults: string
        :param MaxResults:

           *Optional* : An integer that specifies the maximum number of VPCs that you want Amazon
           Route 53 to return. If you don't specify a value for ``MaxResults`` , Route 53 returns up
           to 50 VPCs per page.
    ...
    def test_dns_answer(
        ...
        **Request Syntax**
        ...
        :param ResolverIP:
          ...
          If you want to simulate a request from a specific DNS resolver, specify the IP address for
          that resolver. If you omit this value, ``TestDnsAnswer`` uses the IP address of a DNS
          resolver in the AWS US East (N. Virginia) Region (``us-east-1`` ).

        :type EDNS0ClientSubnetIP: string
        :param EDNS0ClientSubnetIP:

          If the resolver that you specified for resolverip supports EDNS0, specify the IPv4 or IPv6
          address of a client in the applicable location, for example, ``192.0.2.44`` or
        ...
        :param EDNS0ClientSubnetMask:
          ...
          number of bits of the IP address that you want the checking tool to include in the DNS
          query. For example, if you specify ``192.0.2.44`` for ``edns0clientsubnetip`` and ``24``
          for ``edns0clientsubnetmask`` , the checking tool will simulate a request from
          ...
          - *(dict) --*
            ...
            - **RecordData** *(list) --*
              ...
              - *(string) --*
                ...
                * For non-alias resource record sets, a ``RecordDataEntry`` element contains one
                value in the resource record set. If the resource record set contains multiple
                values, the response includes one ``RecordDataEntry`` element for each value.

                * For multiple resource record sets that have the same name and type, which includes
                weighted, latency, geolocation, and failover, a ``RecordDataEntry`` element contains
                the value from the appropriate resource record set based on the request.

                * For alias resource record sets that refer to AWS resources other than another
                resource record set, the ``RecordDataEntry`` element contains an IP address or a
                domain name for the AWS resource, depending on the type of resource.

                * For alias resource record sets that refer to other resource record sets, a
                ``RecordDataEntry`` element contains one value from the referenced resource record
                set. If the referenced resource record set contains multiple values, the response
            ...
            - **ResponseCode** *(string) --*
              ...
              code is ``NOERROR`` , meaning that the request is valid. If the response is not valid,
              Amazon Route 53 returns a response code that describes the error. For a list of
              possible response codes, see `DNS RCODES
              <http://www.iana.org/assignments/dns-parameters/dns-parameters.xhtml#dns-parameters-6>`__
              on the IANA website.
    ...
    def update_health_check(
        ...
        For more information about updating health checks, see `Creating, Updating, and Deleting
        Health Checks
        ...
        **Request Syntax**
        ...
        :param HealthCheckId: **[REQUIRED]**
          ...
          The ID for the health check for which you want detailed information. When you created the
          health check, ``CreateHealthCheck`` returned the ID in the response, in the
          ``HealthCheckId`` element.
        ...
        :param IPAddress:
          ...
          interval that you specify in ``RequestInterval`` . Using an IP address that is returned by
          DNS, Route 53 then checks the health of the endpoint.
          ...
          * Linux: `Elastic IP Addresses (EIP)
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/elastic-ip-addresses-eip.html>`__ in
          the *Amazon EC2 User Guide for Linux Instances*

          * Windows: `Elastic IP Addresses (EIP)
          <https://docs.aws.amazon.com/AWSEC2/latest/WindowsGuide/elastic-ip-addresses-eip.html>`__
        ...
        :param ResourcePath:
          ...
          The path that you want Amazon Route 53 to request when performing health checks. The path
          can be any value for which your endpoint will return an HTTP status code of 2xx or 3xx
          when the endpoint is healthy, for example the file /docs/route53-health-check.html. You
        ...
        :param FullyQualifiedDomainName:
          ...
          value of ``FullyQualifiedDomainName`` in the ``Host`` header for all health checks except
          TCP health checks. This is typically the fully qualified DNS name of the endpoint on which
        ...
        :param SearchString:
          ...
          If the value of ``Type`` is ``HTTP_STR_MATCH`` or ``HTTP_STR_MATCH`` , the string that you
          want Amazon Route 53 to search for in the response body from the specified resource. If
          the string appears in the response body, Route 53 considers the resource healthy. (You
        ...
        :param HealthThreshold:
          ...
          healthy. To specify the child health checks that you want to associate with a
          ``CALCULATED`` health check, use the ``ChildHealthChecks`` and ``ChildHealthCheck``
          elements.
        ...
        :param ChildHealthChecks:
          ...
          A complex type that contains one ``ChildHealthCheck`` element for each health check that
        ...
        :param EnableSNI:
          ...
          to the endpoint in the ``client_hello`` message during ``TLS`` negotiation. This allows
        ...
        :param Regions:
          ...
          A complex type that contains one ``Region`` element for each region that you want Amazon
        ...
        :param ResetElements:
          ...
          A complex type that contains one ``ResettableElementName`` element for each element that
          you want to reset to the default value. Valid values for ``ResettableElementName`` include
          the following:
    ...
    def update_hosted_zone_comment(
        ...
        **Request Syntax**
        ...
        :param Comment:
          ...
          The new comment for the hosted zone. If you don't specify a value for ``Comment`` , Amazon
          Route 53 deletes the existing value of the ``Comment`` element, if any.
    ...
    def update_traffic_policy_instance(
        ...
        queries for the root resource record set name (such as example.com) while it replaces one
        group of resource record sets with another. Route 53 performs the following operations:
        ...
        * Route 53 creates a new group of resource record sets based on the specified traffic
        ...
        resource record sets and the new resource record sets.

        * When all of the new resource record sets have been created, Route 53 starts to respond to
