...
class Client(BaseClient):
    ...
    def describe_affected_entities(
        ...
        or any other construct, depending on the AWS service. Events that have impact beyond that of the
        affected entities, or where the extent of impact is unknown, include at least one entity indicating
        this.
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          reissue the search request and include the returned token. When all results have been returned,
    ...
    def describe_entity_aggregates(
        ...
        specified, the counts of all affected entities are returned.
    ...
    def describe_event_aggregates(
        ...
        If no filter is specified, the counts of all events in each category are returned.
    ...
    def describe_event_details(
        ...
        data (region, service, etc., as returned by  DescribeEvents ), a detailed event description, and
        possible additional metadata that depends upon the nature of the event. Affected entities are not
        included; to retrieve those, use the  DescribeAffectedEntities operation.
