...
_ClientDescribeAffectedEntitiesResponseTypeDef = TypedDict(
    ...
    {
        "entities": List[ClientDescribeAffectedEntitiesResponseentitiesTypeDef],
        "nextToken": str,
    },
    total=False,
)
...
class ClientDescribeAffectedEntitiesResponseTypeDef(
    _ClientDescribeAffectedEntitiesResponseTypeDef
):
    """
...
class ClientDescribeEntityAggregatesResponseTypeDef(
    _ClientDescribeEntityAggregatesResponseTypeDef
):
    """
...
class ClientDescribeEventDetailsResponseTypeDef(
    _ClientDescribeEventDetailsResponseTypeDef
):
    """
...
_DescribeAffectedEntitiesPaginateResponseTypeDef = TypedDict(
    ...
    {
        "entities": List[DescribeAffectedEntitiesPaginateResponseentitiesTypeDef],
        "NextToken": str,
    },
    total=False,
)
