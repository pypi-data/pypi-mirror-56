"Main interface for route53resolver Client"
...
class Client(BaseClient):
    ...
    def associate_resolver_endpoint_ip_address(
        ...
        """
        Adds IP addresses to an inbound or an outbound resolver endpoint. If you want to adding more
        ...
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/AssociateResolverEndpointIpAddress>`_
        ...
        **Request Syntax**
        ...
        :param IpAddress: **[REQUIRED]**
          ...
          - **IpId** *(string) --*
             ...
             *Only when removing an IP address from a resolver endpoint* : The ID of the IP address
             that you want to remove. To get this ID, use  GetResolverEndpoint .

          - **SubnetId** *(string) --*

            The ID of the subnet that includes the IP address that you want to update. To get this
            ID, use  GetResolverEndpoint .
          ...
          ::

            {
                'ResolverEndpoint': {
                    ...
                    'HostVPCId': 'string',
                    'Status':
                    'CREATING'|'OPERATIONAL'|'UPDATING'|'AUTO_RECOVERING'
                    |'ACTION_NEEDED'|'DELETING',
          ...
          - *(dict) --*
            ...
            - **ResolverEndpoint** *(dict) --*
              ...
              - **CreatorRequestId** *(string) --*
                ...
                ``CreatorRequestId`` allows failed requests to be retried without the risk of
    ...
    def associate_resolver_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/AssociateResolverRule>`_
        ...
        **Request Syntax**
        ...
        :param ResolverRuleId: **[REQUIRED]**
          ...
          resolver rules, use  ListResolverRules .
          ...
          - *(dict) --*
            ...
            - **ResolverRuleAssociation** *(dict) --*
              ...
              - **Id** *(string) --*
                ...
                value when you submit an  AssociateResolverRule request.
    ...
    def create_resolver_endpoint(
        ...
        * An *outbound resolver endpoint* forwards DNS queries from the DNS service for a VPC to
        your network or another VPC.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/CreateResolverEndpoint>`_
        ...
        **Request Syntax**
        ...
        :param SecurityGroupIds: **[REQUIRED]**
          ...
          resolver endpoints) or outbound rules (for outbound resolver endpoints).
        ...
        :param IpAddresses: **[REQUIRED]**
          ...
          The subnets and IP addresses in your VPC that you want DNS queries to pass through on the
          way from your VPCs to your network (for outbound endpoints) or on the way from your
          network to your VPCs (for inbound resolver endpoints).

          - *(dict) --*

            In an  CreateResolverEndpoint request, a subnet and IP address that you want to use for
            DNS queries.
        ...
        :param Tags:
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --*
              ...
              the account IDs of your customers for billing purposes, the value of ``Key`` might be
              ``account-id`` .
    ...
    def create_resolver_rule(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/CreateResolverRule>`_
    ...
    def delete_resolver_endpoint(
        ...
        * **Inbound** : DNS queries from your network or another VPC are no longer routed to the DNS
        service for the specified VPC.

        * **Outbound** : DNS queries from a VPC are no longer routed to your network or to another
        VPC.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/DeleteResolverEndpoint>`_
    ...
    def delete_resolver_rule(self, ResolverRuleId: str) -> ClientDeleteResolverRuleResponseTypeDef:
        ...
        from all the VPCs that you associated the resolver rule with. For more infomation, see
        DisassociateResolverRule .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/DeleteResolverRule>`_
    ...
    def disassociate_resolver_endpoint_ip_address(
        ...
        more than one IP address, submit one ``DisassociateResolverEndpointIpAddress`` request for
        each IP address.

        To add an IP address to an endpoint, see  AssociateResolverEndpointIpAddress .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/DisassociateResolverEndpointIpAddress>`_
    ...
    def disassociate_resolver_rule(
        ...
        .. warning::
          ...
          If you disassociate a resolver rule from a VPC, Resolver stops forwarding DNS queries for
          the domain name that you specified in the resolver rule.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/DisassociateResolverRule>`_
    ...
    def get_resolver_endpoint(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/GetResolverEndpoint>`_
    ...
    def get_resolver_rule(self, ResolverRuleId: str) -> ClientGetResolverRuleResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/GetResolverRule>`_
    ...
    def get_resolver_rule_association(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/GetResolverRuleAssociation>`_
    ...
    def get_resolver_rule_policy(self, Arn: str) -> ClientGetResolverRulePolicyResponseTypeDef:
        """
        Gets information about a resolver rule policy. A resolver rule policy specifies the Resolver
        operations and resources that you want to allow another AWS account to be able to use.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/GetResolverRulePolicy>`_
    ...
    def list_resolver_endpoint_ip_addresses(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/ListResolverEndpointIpAddresses>`_
                ...
                'IpAddresses': [
                    {
                        ...
                        'Ip': 'string',
                        'Status':
                        'CREATING'|'FAILED_CREATION'|'ATTACHING'|'ATTACHED'
                        |'REMAP_DETACHING'|'REMAP_ATTACHING'|'DETACHING'
                        |'FAILED_RESOURCE_GONE'|'DELETING'
    ...
    def list_resolver_endpoints(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/ListResolverEndpoints>`_
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``ListResolverEndpoints`` request. If you don't specify a value for ``MaxResults`` ,
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            For ``List`` operations, an optional specification to return a subset of objects, such
            as resolver endpoints or resolver rules.

            - **Name** *(string) --*

              When you're using a ``List`` operation and you want the operation to return a subset
              of objects, such as resolver endpoints or resolver rules, the name of the parameter
              that you want to use to filter objects. For example, to list only inbound resolver
              endpoints, specify ``Direction`` for the value of ``Name`` .
            ...
            - **Values** *(list) --*
              ...
              that you want to use to filter objects. For example, to list only inbound resolver
              endpoints, specify ``INBOUND`` for the value of ``Values`` .
    ...
    def list_resolver_rule_associations(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/ListResolverRuleAssociations>`_
    ...
    def list_resolver_rules(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/ListResolverRules>`_
        ...
        **Request Syntax**
        ...
        :param Filters:
          ...
          An optional specification to return a subset of resolver rules, such as all resolver rules
          that are associated with the same resolver endpoint.
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **NextToken** *(string) --*
              ...
              submit another ``ListResolverRules`` request to get the next group of results. In the
              next request, specify the value of ``NextToken`` from the previous response.
    ...
    def put_resolver_rule_policy(
        ...
        """
        Specifies the Resolver operations and resources that you want to allow another AWS account
        to be able to use.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/PutResolverRulePolicy>`_
        ...
        **Request Syntax**
        ...
        :param ResolverRulePolicy: **[REQUIRED]**
          ...
          An AWS Identity and Access Management policy statement that lists the permissions that you
          want to grant to another AWS account.
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/TagResource>`_
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/UntagResource>`_
    ...
    def update_resolver_endpoint(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/UpdateResolverEndpoint>`_
    ...
    def update_resolver_rule(
        ...
        """
        Updates settings for a specified resolver rule. ``ResolverRuleId`` is required, and all
        other parameters are optional. If you don't specify a parameter, it retains its current
        value.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/route53resolver-2018-04-01/UpdateResolverRule>`_
