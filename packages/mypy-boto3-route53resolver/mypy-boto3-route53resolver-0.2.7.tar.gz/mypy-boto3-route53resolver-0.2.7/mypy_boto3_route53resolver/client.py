...
class Client(BaseClient):
    ...
    def associate_resolver_endpoint_ip_address(
        ...
        """
        Adds IP addresses to an inbound or an outbound resolver endpoint. If you want to adding more than
        ...
        **Request Syntax**
        ...
        :param IpAddress: **[REQUIRED]**
          ...
          Either the IPv4 address that you want to add to a resolver endpoint or a subnet ID. If you specify
          a subnet ID, Resolver chooses an IP address for you from the available IPs in the specified
          subnet.

          - **IpId** *(string) --*

             *Only when removing an IP address from a resolver endpoint* : The ID of the IP address that you
             want to remove. To get this ID, use  GetResolverEndpoint .
    ...
    def create_resolver_endpoint(
        ...
        **Request Syntax**
        ...
        :param CreatorRequestId: **[REQUIRED]**
          ...
          the risk of executing the operation twice. ``CreatorRequestId`` can be any unique string, for
          example, a date/time stamp.

        :type Name: string
        :param Name:

          A friendly name that lets you easily find a configuration in the Resolver dashboard in the Route
          53 console.
        ...
        :param Direction: **[REQUIRED]**
          ...
          * ``INBOUND`` : Resolver forwards DNS queries to the DNS service for a VPC from your network or
          another VPC

          * ``OUTBOUND`` : Resolver forwards DNS queries from the DNS service for a VPC to your network or
          another VPC
          ...
          - *(dict) --*
            ...
            - **ResolverRule** *(dict) --*
              ...
              - **ShareStatus** *(string) --*
                ...
                Whether the rules is shared and, if so, whether the current account is sharing the rule with
    ...
    def delete_resolver_endpoint(
        ...
        * **Inbound** : DNS queries from your network or another VPC are no longer routed to the DNS service
    ...
    def delete_resolver_rule(
        ...
        the VPCs that you associated the resolver rule with. For more infomation, see
    ...
    def disassociate_resolver_endpoint_ip_address(
        ...
        than one IP address, submit one ``DisassociateResolverEndpointIpAddress`` request for each IP
        address.
                ...
                'IpAddresses': [
                    {
                        ...
                        'Ip': 'string',
                        'Status':
                        'CREATING'|'FAILED_CREATION'|'ATTACHING'|'ATTACHED'|'REMAP_DETACHING'
                        |'REMAP_ATTACHING'|'DETACHING'|'FAILED_RESOURCE_GONE'|'DELETING'
        ...
        :param Filters:
          ...
          - *(dict) --*
            ...
            - **Name** *(string) --*
              ...
              objects, such as resolver endpoints or resolver rules, the name of the parameter that you want
              to use to filter objects. For example, to list only inbound resolver endpoints, specify
          ...
          - *(dict) --*
            ...
            - **ResolverEndpoints** *(list) --*
              ...
              - *(dict) --*
                ...
                GetResolverEndpoint ,  ListResolverEndpoints , or  UpdateResolverEndpoint request, a complex
    ...
    def list_resolver_rules(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          ``ListResolverRules`` request. If you don't specify a value for ``MaxResults`` , Resolver returns
        ...
        :param NextToken:
          ...
          request to get the next group of resolver rules. In the next request, specify the value of
          ``NextToken`` from the previous response.

        :type Filters: list
        :param Filters:

          An optional specification to return a subset of resolver rules, such as all resolver rules that
          are associated with the same resolver endpoint.

          .. note::

            If you submit a second or subsequent ``ListResolverRules`` request and specify the ``NextToken``
            parameter, you must use the same values for ``Filters`` , if any, as in the previous request.
          ...
          - *(dict) --*
            ...
            - **ResolverRules** *(list) --*
              ...
              - *(dict) --*
                ...
                specifies how to route DNS queries out of the VPC. The ``ResolverRule`` parameter appears in
                the response to a  CreateResolverRule ,  DeleteResolverRule ,  GetResolverRule ,
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param NextToken:
          ...
          to get the next group of tags for the resource. In the next request, specify the value of
          ``NextToken`` from the previous response.
    ...
    def put_resolver_rule_policy(
        ...
        """
        Specifies the Resolver operations and resources that you want to allow another AWS account to be
        able to use.
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param ResourceArn: **[REQUIRED]**
          ...
          for a resource, use the applicable ``Get`` or ``List`` command:
        ...
        **Request Syntax**
        ...
        :param Config: **[REQUIRED]**
          ...
          - **TargetIps** *(list) --*
            ...
            For DNS queries that originate in your VPC, the new IP addresses that you want to route outbound
            DNS queries to.
