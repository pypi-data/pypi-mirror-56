...
def termination_start_status_service(service: str):
    can_start_termination = _service_termination_start_policy.can_start_termination(service_name=service)
    return str(can_start_termination), 200
