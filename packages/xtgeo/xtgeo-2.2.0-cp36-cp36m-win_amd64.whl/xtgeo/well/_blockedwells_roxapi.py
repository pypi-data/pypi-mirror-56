...
# Import from ROX api
# -------------------------------------------------------------------------
def import_bwells_roxapi(self, project, gname, bwname,
    ...
    _roxapi_import_bwells(self, rox, gname, bwname, lognames,
                          ijk, realisation)

    rox.safe_close()


def _roxapi_import_bwells(self, rox, gname, bwname, lnames,
                          ijk, realisation):
    ...
    for wname in wnames:
        ...
        bwtmp = BlockedWell()
        bwtmp.from_roxar(rox.project, gname, bwname, wname,
                         lognames=lnames, ijk=ijk,
