...
from radware.sdk.api import BaseDeviceConnection, BaseDevice
...
class AlteonDevice(BaseDevice):
    def __init__(self, connection):
        super(AlteonDevice, self).__init__(connection)

    @property
    def _rest(self) -> AlteonRest:
