...
class SettingDialog(QtGui.QDialog, Ui_SettingDialog):
    def __init__(self, settings, nvm_bytes, custom_enums,
        ...
        b = self.buttonBox.button(QtGui.QDialogButtonBox.RestoreDefaults)
    ...
    def add_setting_widgets(self):
        ...
        for tab_name, widgets in setting_tabs:
            ...
            form_layout = QtGui.QFormLayout(tab_widget)
