...
class ClientDescribeReservedCacheNodesResponseReservedCacheNodesRecurringChargesTypeDef(
    ...
    """
    Type definition for `ClientDescribeReservedCacheNodesResponseReservedCacheNodes` `RecurringCharges`
...
class DescribeReservedCacheNodesPaginateResponseReservedCacheNodesRecurringChargesTypeDef(
    ...
    """
    Type definition for `DescribeReservedCacheNodesPaginateResponseReservedCacheNodes` `RecurringCharges`
