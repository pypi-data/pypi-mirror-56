...
class Client(BaseClient):
    ...
    def add_tags_to_resource(
        ...
        where the key and value are case-sensitive. You can use cost allocation tags to categorize and track
        your AWS costs.
    ...
    def copy_snapshot(
        ...
        .. warning::
          ...
          Amazon S3 buckets and copy snapshots to it. To control access to your snapshots, use an IAM policy
          to control who has the ability to use the ``CopySnapshot`` operation. For more information about
          using IAM to control the use of ElastiCache operations, see `Exporting Snapshots
        ...
        **Request Syntax**
        ...
        :param TargetBucket:
          ...
          The Amazon S3 bucket to which the snapshot is exported. This parameter is used only when exporting
          a snapshot for external access.
    ...
    def create_cache_cluster(
        ...
        **Request Syntax**
        ...
        :param ReplicationGroupId:
          ...
          If the specified replication group is Multi-AZ enabled and the Availability Zone is not specified,
          the cluster is created in Availability Zones that provide the best spread of read replicas across
          Availability Zones.
    ...
    def create_replication_group(
        ...
        one or more read replicas to it, up to a total of 5 read replicas. You cannot alter a Redis (cluster
        mode enabled) replication group after it has been created. However, if you need to increase or
        decrease the number of node groups (console: shards), you can avail yourself of ElastiCache for
        Redis' enhanced backup and restore. For more information, see `Restoring From a Backup with Cluster
        Resizing <https://docs.aws.amazon.com/AmazonElastiCache/latest/red-ug/backups-restoring.html>`__ in
        ...
        **Request Syntax**
        ...
        :param NodeGroupConfiguration:
          ...
          file, you must configure each node group (shard) using this parameter because you must specify the
    ...
    def describe_cache_clusters(
        ...
        specific cache cluster if a cluster identifier is supplied.
        ...
        *ShowCacheNodeInfo* flag to retrieve detailed information about the cache nodes associated with the
        ...
        If cache nodes are currently being added to the cluster, node endpoint information and creation time
        for the additional nodes are not displayed until they are completely provisioned. When the cluster
        state is *available* , the cluster is ready for use.

        If cache nodes are currently being removed from the cluster, no endpoint information for the removed
        nodes is displayed.
    ...
    def list_allowed_node_type_modifications(
        ...
        **Request Syntax**
        ...
        :param CacheClusterId:
          ...
          cluster id to identify the current node type of this cluster and from that to create a list of
        ...
        **Request Syntax**
        ...
        :param NumCacheNodes:
          ...
          .. note::
            ...
            Zones with flexible cache node placement, a request to add nodes does not automatically override
            a previous pending operation to add nodes. The customer can modify the previous pending
            operation to add more nodes or explicitly cancel the pending request and retry the new request.
            To cancel pending operations to modify the number of cache nodes in a cluster, use the
        ...
        :param CacheNodeIdsToRemove:
          ...
          parameter is only valid when ``NumCacheNodes`` is less than the existing number of cache nodes.
          The number of cache node IDs supplied in this parameter must match the difference between the
          existing number of cache nodes in the cluster or pending cache nodes, whichever is greater, and
        ...
        :param AZMode:
          ...
          Zone or created across multiple Availability Zones.
        ...
        :param NewAvailabilityZones:
          ...
          * **Scenario 3:** You want to cancel all pending operations. Specify ``NumCacheNodes=3`` to cancel
            ...
            * Result: The new create is added to the pending create.
            ...
            .. warning::
                ...
                **Important:** If the new create request is **Apply Immediately - Yes** , all creates are
                performed immediately. If the new create request is **Apply Immediately - No** , all creates
                are pending.
        ...
        :param CacheParameterGroupName:
          ...
          applied as soon as possible for parameters when the ``ApplyImmediately`` parameter is specified as
    ...
    def modify_replication_group(
        ...
        **Request Syntax**
        ...
        :param PrimaryClusterId:
          ...
          the specified cluster in the specified replication group to the primary role. The nodes of all
    ...
    def modify_replication_group_shard_configuration(
        ...
        rebalance the keyspaces among exisiting shards.
        ...
        **Request Syntax**
        ...
        :param NodeGroupsToRemove:
          ...
          ElastiCache for Redis will attempt to remove all node groups listed by ``NodeGroupsToRemove`` from
          the cluster.
        ...
        **Request Syntax**
        ...
        :param ReservedCacheNodeId:
          ...
          .. note::
            ...
            If this parameter is not specified, ElastiCache automatically generates an identifier for the
            reservation.
    ...
    def reboot_cache_cluster(
        ...
        If you make changes to parameters that require a Redis (cluster mode enabled) cluster reboot for the
        changes to be applied, see `Rebooting a Cluster
    ...
    def test_failover(
        ...
        * A customer can use this operation to test automatic failover on up to 5 shards (called node groups
        in the ElastiCache API and AWS CLI) in any rolling 24-hour period.
        ...
        * If calling this operation multiple times on different shards in the same Redis (cluster mode
        enabled) replication group, the first node replacement must complete before a subsequent call can be
        made.
