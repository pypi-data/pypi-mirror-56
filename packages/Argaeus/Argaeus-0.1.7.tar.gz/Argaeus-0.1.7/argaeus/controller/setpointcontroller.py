...
class SetPointController(AController):
    ...
    def _topic_handler_down(self, value):
        ...
        if value.decode("utf-8") == self._command_down:
            ...
            set_to = self._mode_controller.current_setpoint.set_point - self._step_size
    ...
    def _post_topic_handler(self, set_to):
        ...
        self._logger.info("SetPointController._topic_handler - set temp to '{}'.".
                          format(self._mode_controller.current_setpoint.name))
        self._mode_controller.current_setpoint.set_point = set_to
        self._mode_controller.current_setpoint.publish()
