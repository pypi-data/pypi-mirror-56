...
class Client(BaseClient):
    ...
    def invoke_endpoint(
        ...
        Calls to ``InvokeEndpoint`` are authenticated by using AWS Signature Version 4. For
        information, see `Authenticating Requests (AWS Signature Version 4)
        <http://docs.aws.amazon.com/AmazonS3/latest/API/sig-v4-authenticating-requests.html>`__ in
        ...
        your model is going to take 50-60 seconds of processing time, the SDK socket timeout should
        ...
        **Request Syntax**
        ...
        :param CustomAttributes:
          ...
          use to track a request or to provide other metadata that a service endpoint was programmed
          to process. The value must consist of no more than 1024 visible US-ASCII characters as
          specified in `Section 3.3.6. Field Value Components
          <https://tools.ietf.org/html/rfc7230#section-3.2.6>`__ of the Hypertext Transfer Protocol
          (HTTP/1.1). This feature is currently supported in the AWS SDKs but not in the Amazon
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CustomAttributes** *(string) --*
              ...
              in the ``CustomAttributes`` header of a request or other metadata that a service
              endpoint was programmed to produce. The value must consist of no more than 1024
              visible US-ASCII characters as specified in `Section 3.3.6. Field Value Components
              <https://tools.ietf.org/html/rfc7230#section-3.2.6>`__ of the Hypertext Transfer
              Protocol (HTTP/1.1). If the customer wants the custom attribute returned, the model
