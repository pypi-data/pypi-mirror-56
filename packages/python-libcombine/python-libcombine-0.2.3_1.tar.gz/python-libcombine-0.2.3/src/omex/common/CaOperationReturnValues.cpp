/**
 * @file CaOperationReturnValues.cpp
 * @brief Implementation of the CaOperationReturnValues class.
 * @author DEVISER
 *
 * <!--------------------------------------------------------------------------
...
static CaOperationReturnValues_t OMEX_OPERATION_RETURN_VALUES_INDICES[] = 
{
    LIBCOMBINE_OPERATION_SUCCESS
  , LIBCOMBINE_INDEX_EXCEEDS_SIZE
  , LIBCOMBINE_UNEXPECTED_ATTRIBUTE
  , LIBCOMBINE_OPERATION_FAILED
  , LIBCOMBINE_INVALID_ATTRIBUTE_VALUE
  , LIBCOMBINE_INVALID_OBJECT
  , LIBCOMBINE_DUPLICATE_OBJECT_ID
  , LIBCOMBINE_LEVEL_MISMATCH
  , LIBCOMBINE_VERSION_MISMATCH
  , LIBCOMBINE_INVALID_XML_OPERATION
  , LIBCOMBINE_NAMESPACES_MISMATCH
  , LIBCOMBINE_DUPLICATE_ANNOTATION_NS
  , LIBCOMBINE_ANNOTATION_NAME_NOT_FOUND
  , LIBCOMBINE_ANNOTATION_NS_NOT_FOUND
  , LIBCOMBINE_MISSING_METAID
  , LIBCOMBINE_DEPRECATED_ATTRIBUTE
};

static const char* OMEX_OPERATION_RETURN_VALUES_STRINGS[] =
{
...
{
  int length = sizeof(OMEX_OPERATION_RETURN_VALUES_INDICES)/sizeof(CaOperationReturnValues_t);
  for (int i = 0; i < length; ++i)
  {
    if (OMEX_OPERATION_RETURN_VALUES_INDICES[i] == returnValue)
      return OMEX_OPERATION_RETURN_VALUES_STRINGS[i];
  }
