...
AST_PLUS = _libcombine.AST_PLUS
AST_MINUS = _libcombine.AST_MINUS
AST_TIMES = _libcombine.AST_TIMES
AST_DIVIDE = _libcombine.AST_DIVIDE
AST_POWER = _libcombine.AST_POWER
AST_INTEGER = _libcombine.AST_INTEGER
AST_REAL = _libcombine.AST_REAL
AST_REAL_E = _libcombine.AST_REAL_E
AST_RATIONAL = _libcombine.AST_RATIONAL
AST_NAME = _libcombine.AST_NAME
AST_NAME_AVOGADRO = _libcombine.AST_NAME_AVOGADRO
AST_NAME_TIME = _libcombine.AST_NAME_TIME
AST_CONSTANT_E = _libcombine.AST_CONSTANT_E
AST_CONSTANT_FALSE = _libcombine.AST_CONSTANT_FALSE
AST_CONSTANT_PI = _libcombine.AST_CONSTANT_PI
AST_CONSTANT_TRUE = _libcombine.AST_CONSTANT_TRUE
AST_LAMBDA = _libcombine.AST_LAMBDA
AST_FUNCTION = _libcombine.AST_FUNCTION
AST_FUNCTION_ABS = _libcombine.AST_FUNCTION_ABS
AST_FUNCTION_ARCCOS = _libcombine.AST_FUNCTION_ARCCOS
AST_FUNCTION_ARCCOSH = _libcombine.AST_FUNCTION_ARCCOSH
AST_FUNCTION_ARCCOT = _libcombine.AST_FUNCTION_ARCCOT
AST_FUNCTION_ARCCOTH = _libcombine.AST_FUNCTION_ARCCOTH
AST_FUNCTION_ARCCSC = _libcombine.AST_FUNCTION_ARCCSC
AST_FUNCTION_ARCCSCH = _libcombine.AST_FUNCTION_ARCCSCH
AST_FUNCTION_ARCSEC = _libcombine.AST_FUNCTION_ARCSEC
AST_FUNCTION_ARCSECH = _libcombine.AST_FUNCTION_ARCSECH
AST_FUNCTION_ARCSIN = _libcombine.AST_FUNCTION_ARCSIN
AST_FUNCTION_ARCSINH = _libcombine.AST_FUNCTION_ARCSINH
AST_FUNCTION_ARCTAN = _libcombine.AST_FUNCTION_ARCTAN
AST_FUNCTION_ARCTANH = _libcombine.AST_FUNCTION_ARCTANH
AST_FUNCTION_CEILING = _libcombine.AST_FUNCTION_CEILING
AST_FUNCTION_COS = _libcombine.AST_FUNCTION_COS
AST_FUNCTION_COSH = _libcombine.AST_FUNCTION_COSH
AST_FUNCTION_COT = _libcombine.AST_FUNCTION_COT
AST_FUNCTION_COTH = _libcombine.AST_FUNCTION_COTH
AST_FUNCTION_CSC = _libcombine.AST_FUNCTION_CSC
AST_FUNCTION_CSCH = _libcombine.AST_FUNCTION_CSCH
AST_FUNCTION_DELAY = _libcombine.AST_FUNCTION_DELAY
AST_FUNCTION_EXP = _libcombine.AST_FUNCTION_EXP
AST_FUNCTION_FACTORIAL = _libcombine.AST_FUNCTION_FACTORIAL
AST_FUNCTION_FLOOR = _libcombine.AST_FUNCTION_FLOOR
AST_FUNCTION_LN = _libcombine.AST_FUNCTION_LN
AST_FUNCTION_LOG = _libcombine.AST_FUNCTION_LOG
AST_FUNCTION_PIECEWISE = _libcombine.AST_FUNCTION_PIECEWISE
AST_FUNCTION_POWER = _libcombine.AST_FUNCTION_POWER
AST_FUNCTION_ROOT = _libcombine.AST_FUNCTION_ROOT
AST_FUNCTION_SEC = _libcombine.AST_FUNCTION_SEC
AST_FUNCTION_SECH = _libcombine.AST_FUNCTION_SECH
AST_FUNCTION_SIN = _libcombine.AST_FUNCTION_SIN
AST_FUNCTION_SINH = _libcombine.AST_FUNCTION_SINH
AST_FUNCTION_TAN = _libcombine.AST_FUNCTION_TAN
AST_FUNCTION_TANH = _libcombine.AST_FUNCTION_TANH
AST_LOGICAL_AND = _libcombine.AST_LOGICAL_AND
AST_LOGICAL_NOT = _libcombine.AST_LOGICAL_NOT
AST_LOGICAL_OR = _libcombine.AST_LOGICAL_OR
AST_LOGICAL_XOR = _libcombine.AST_LOGICAL_XOR
AST_RELATIONAL_EQ = _libcombine.AST_RELATIONAL_EQ
AST_RELATIONAL_GEQ = _libcombine.AST_RELATIONAL_GEQ
AST_RELATIONAL_GT = _libcombine.AST_RELATIONAL_GT
AST_RELATIONAL_LEQ = _libcombine.AST_RELATIONAL_LEQ
AST_RELATIONAL_LT = _libcombine.AST_RELATIONAL_LT
AST_RELATIONAL_NEQ = _libcombine.AST_RELATIONAL_NEQ
AST_FUNCTION_MAX = _libcombine.AST_FUNCTION_MAX
AST_FUNCTION_MIN = _libcombine.AST_FUNCTION_MIN
AST_FUNCTION_QUOTIENT = _libcombine.AST_FUNCTION_QUOTIENT
AST_FUNCTION_RATE_OF = _libcombine.AST_FUNCTION_RATE_OF
AST_FUNCTION_REM = _libcombine.AST_FUNCTION_REM
AST_LOGICAL_IMPLIES = _libcombine.AST_LOGICAL_IMPLIES
AST_CSYMBOL_FUNCTION = _libcombine.AST_CSYMBOL_FUNCTION
AST_UNKNOWN = _libcombine.AST_UNKNOWN
...
class L3ParserSettings(_object):
    ...
    def setPlugins(self, sbmlns):
        """setPlugins(L3ParserSettings self, SBMLNamespaces const * sbmlns)"""
        return _libcombine.L3ParserSettings_setPlugins(self, sbmlns)
