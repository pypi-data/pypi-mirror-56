...
def _1337x(search):
    ...
    for row in soup.find_all("tr"):
        ...
        if seed < min_seeds:  # Seeds should be greater than/equal to 10
            continue
...
def idope(search):
    ...
    for div in soup.find_all("div", attrs={"class": "resultdiv"}):
        ...
        if int(seed.text) < min_seeds:  # Seeds should be greater than/equal to 10
            continue
...
def piratebay(search):
    ...
    for tr in soup.find_all("tr"):
        ...
        if int(td[-2].text) < min_seeds:  # Seeds should be greater than/equal to 10
            continue
