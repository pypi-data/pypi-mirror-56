...
from fleet.version import fleet_version
...
setup(
    name='paddle-fleet',
    version=fleet_version.replace('-', ''),
    description=
    ('Distributed Training Package Based on PaddlePaddle'),
    long_description=open("fleet/README.md").read(),
    ...
    license='Apache 2.0',
    keywords=('online-training batch-training easy-to-use distributed-training'))
