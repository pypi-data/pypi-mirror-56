...
class ServicesInactiveWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`ECS.Client.describe_services` every 15 seconds until a successful state is
...
class TasksRunningWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`ECS.Client.describe_tasks` every 6 seconds until a successful state is
