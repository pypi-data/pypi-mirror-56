...
class Main(FramelessWindow):
    ...
    def _uiInit(self):
        ...
        self.molNameLine = InputLine(self, db=self.dbSolids)
        self.ui.molInputLayout.insertWidget(0, self.molNameLine)
        ...
        self.dilNameLine = InputLine(self, db=self.dbSolutions)
        self.ui.dilInputLayout.insertWidget(0, self.dilNameLine)
