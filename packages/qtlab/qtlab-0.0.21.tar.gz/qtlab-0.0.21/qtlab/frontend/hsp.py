...
class Main(QtWidgets.QMainWindow):
    def __init__(self, parent):
        ...
        self.worker.addItem.connect(self.searchTree.addItem)
    ...
    def _uiInit(self):
        ...
        self.searchTree = SearchTree(self)
        self.groupTree = GroupTree(self)
        self.s1Line = InputLine(self)
        self.s2Line = InputLine(self)
        self.s1Line.setObjectName("s1Line")
        self.s2Line.setObjectName("s2Line")
        self.ui.searchTreeLayout.insertWidget(0, self.searchTree)
        self.ui.groupTreeLayout.insertWidget(0, self.groupTree)
        self.ui.inputLayout.insertWidget(0, self.s1Line)
        self.ui.inputLayout.insertWidget(1, self.s2Line)
    ...
    def _updateStatus(self, working):
        if working:
            self.timer.start()
            self.ui.statusBar().showMessage("Calculation in progress...")
        else:
