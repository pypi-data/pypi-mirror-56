...
class ClientCreateLifecyclePolicyPolicyDetailsParametersTypeDef(
    ...
    - **ExcludeBootVolume** *(boolean) --*
      ...
      When executing an EBS Snapshot Management – Instance policy, execute all CreateSnapshots calls
      with the ``excludeBootVolume`` set to the supplied field. Defaults to false. Only valid for
...
_RequiredClientCreateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef = TypedDict(
    "_RequiredClientCreateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef",
    {"AvailabilityZones": List[str]},
)
_OptionalClientCreateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef = TypedDict(
    "_OptionalClientCreateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef",
    {"Count": int, "Interval": int, "IntervalUnit": str},
    total=False,
)
...
class ClientCreateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef(
    ...
    """
    Type definition for `ClientCreateLifecyclePolicyPolicyDetailsSchedules` `FastRestoreRule`
...
class ClientCreateLifecyclePolicyPolicyDetailsSchedulesRetainRuleTypeDef(
    ...
    - **Interval** *(integer) --*
      ...
      The amount of time to retain each snapshot. The maximum is 100 years. This is equivalent to
...
_ClientCreateLifecyclePolicyPolicyDetailsSchedulesTagsToAddTypeDef = TypedDict(
    "_ClientCreateLifecyclePolicyPolicyDetailsSchedulesTagsToAddTypeDef", {"Key": str, "Value": str}
)
...
class ClientCreateLifecyclePolicyPolicyDetailsSchedulesTypeDef(
    ...
    - **VariableTags** *(list) --*
      ...
      executed. Keys may be any valid Amazon EC2 tag key. Values must be in one of the two following
      formats: ``$(instance-id)`` or ``$(timestamp)`` . Variable tags are only valid for EBS
...
_ClientCreateLifecyclePolicyPolicyDetailsTargetTagsTypeDef = TypedDict(
    "_ClientCreateLifecyclePolicyPolicyDetailsTargetTagsTypeDef", {"Key": str, "Value": str}
)
...
class ClientCreateLifecyclePolicyPolicyDetailsTypeDef(
    ...
    - **Parameters** *(dict) --*
      ...
      - **ExcludeBootVolume** *(boolean) --*
        ...
        calls with the ``excludeBootVolume`` set to the supplied field. Defaults to false. Only
...
_ClientGetLifecyclePolicyResponsePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef = TypedDict(
    ...
    {"Count": int, "Interval": int, "IntervalUnit": str, "AvailabilityZones": List[str]},
    total=False,
)
...
class ClientGetLifecyclePolicyResponsePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef(
    ...
    """
    Type definition for `ClientGetLifecyclePolicyResponsePolicyPolicyDetailsSchedules`
    `FastRestoreRule`
...
_RequiredClientUpdateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef = TypedDict(
    "_RequiredClientUpdateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef",
    {"AvailabilityZones": List[str]},
)
_OptionalClientUpdateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef = TypedDict(
    "_OptionalClientUpdateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef",
    {"Count": int, "Interval": int, "IntervalUnit": str},
    total=False,
)
...
class ClientUpdateLifecyclePolicyPolicyDetailsSchedulesFastRestoreRuleTypeDef(
    ...
    """
    Type definition for `ClientUpdateLifecyclePolicyPolicyDetailsSchedules` `FastRestoreRule`
...
_ClientUpdateLifecyclePolicyPolicyDetailsSchedulesTagsToAddTypeDef = TypedDict(
    "_ClientUpdateLifecyclePolicyPolicyDetailsSchedulesTagsToAddTypeDef", {"Key": str, "Value": str}
)
...
_ClientUpdateLifecyclePolicyPolicyDetailsTargetTagsTypeDef = TypedDict(
    "_ClientUpdateLifecyclePolicyPolicyDetailsTargetTagsTypeDef", {"Key": str, "Value": str}
)
