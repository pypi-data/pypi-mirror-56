          ...
          - **Schedules** *(list) --*
            ...
            - *(dict) --*
              ...
              - **VariableTags** *(list) --*
                ...
                two following formats: ``$(instance-id)`` or ``$(timestamp)`` . Variable tags are
              ...
              - **CreateRule** *(dict) --*
                ...
                - **Interval** *(integer) --* **[REQUIRED]**
                  ...
                  The interval between snapshots. The supported values are 2, 3, 4, 6, 8, 12, and
                  24.
            ...
            - **Policy** *(dict) --*
              ...
              - **PolicyDetails** *(dict) --*
                ...
                - **PolicyType** *(string) --*
                  ...
                  This field determines the valid target resource types and actions a policy can
                  manage. This field defaults to EBS_SNAPSHOT_MANAGEMENT if not present.
                ...
                - **Schedules** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **VariableTags** *(list) --*
                      ...
                      in one of the two following formats: ``$(instance-id)`` or ``$(timestamp)`` .
