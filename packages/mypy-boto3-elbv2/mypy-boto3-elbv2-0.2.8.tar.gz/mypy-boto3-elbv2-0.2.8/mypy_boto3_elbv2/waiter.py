...
class LoadBalancerAvailableWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`ElasticLoadBalancingv2.Client.describe_load_balancers` every 15 seconds
...
class TargetDeregisteredWaiter(Boto3Waiter):
    ...
    def wait(
        ...
        """
        Polls :py:meth:`ElasticLoadBalancingv2.Client.describe_target_health` every 15 seconds until
        a successful state is reached. An error is returned after 40 failed checks.
