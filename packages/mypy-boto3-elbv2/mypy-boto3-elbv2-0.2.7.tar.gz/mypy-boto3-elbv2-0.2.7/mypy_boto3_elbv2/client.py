...
class Client(BaseClient):
    ...
    def add_listener_certificates(
        ...
        If the certificate in already in the certificate list, the call is successful but the certificate is
        not added again.
    ...
    def add_tags(
        ...
        To list the current tags for your resources, use  DescribeTags . To remove tags from your resources,
        use  RemoveTags .
    ...
    def create_listener(
        ...
        To update a listener, use  ModifyListener . When you are finished with a listener, you can delete it
        using  DeleteListener . If you are finished with both the listener and the load balancer, you can
        delete them both using  DeleteLoadBalancer .
        ...
        <https://docs.aws.amazon.com/elasticloadbalancing/latest/network/load-balancer-listeners.html>`__ in
    ...
    def create_load_balancer(
        ...
        **Request Syntax**
        ...
        :param Name: **[REQUIRED]**
          ...
          only alphanumeric characters or hyphens, must not begin or end with a hyphen, and must not begin
          with "internal-".
    ...
    def create_target_group(
        ...
        **Request Syntax**
        ...
        :param HealthCheckProtocol:
          ...
          Balancers, the default is HTTP. For Network Load Balancers, the default is TCP. The TCP protocol
          is supported for health checks only if the protocol of the target group is TCP, TLS, UDP, or
        ...
        :param HealthyThresholdCount:
          ...
          with a protocol of TCP or TLS, the default is 3. If the target type is ``lambda`` , the default is
          5.
        ...
        :param Matcher:
          ...
          - **HttpCode** *(string) --* **[REQUIRED]**
            ...
            value is 200. You can specify multiple values (for example, "200,202") or a range of values (for
            example, "200-299").
    ...
    def modify_listener(
        ...
        the entire list. For example, to add an action, specify a list with the current actions plus the new
        action.
        ...
        **Request Syntax**
        ...
        :param Protocol:
          ...
          the HTTP and HTTPS protocols. Network Load Balancers support the TCP, TLS, UDP, and TCP_UDP
          protocols.
    ...
    def set_security_groups(
        ...
        """
        Associates the specified security groups with the specified Application Load Balancer. The specified
