...
_RequiredClientCreateListenerDefaultActionsFixedResponseConfigTypeDef = TypedDict(
    "_RequiredClientCreateListenerDefaultActionsFixedResponseConfigTypeDef", {"StatusCode": str}
)
...
class ClientCreateListenerDefaultActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientCreateListenerDefaultActionsForwardConfig`
    ...
    - **DurationSeconds** *(integer) --*
      ...
      target group. The range is 1-604800 seconds (7 days).
    """
...
class ClientCreateListenerDefaultActionsForwardConfigTypeDef(
    ...
    ``forward`` . If you specify both ``ForwardConfig`` and ``TargetGroupArn`` , you can specify
...
_RequiredClientCreateListenerDefaultActionsRedirectConfigTypeDef = TypedDict(
    "_RequiredClientCreateListenerDefaultActionsRedirectConfigTypeDef", {"StatusCode": str}
)
...
class ClientCreateListenerDefaultActionsRedirectConfigTypeDef(
    ...
    - **Protocol** *(string) --*
      ...
      The protocol. You can specify HTTP, HTTPS, or #{protocol}. You can redirect HTTP to HTTP, HTTP
      to HTTPS, and HTTPS to HTTPS. You cannot redirect HTTPS to HTTP.
    ...
    - **Path** *(string) --*
      ...
      The absolute path, starting with the leading "/". This component is not percent-encoded. The
...
class ClientCreateListenerResponseListenersDefaultActionsAuthenticateCognitoConfigTypeDef(
    ...
    """
    Type definition for `ClientCreateListenerResponseListenersDefaultActions`
...
class ClientCreateListenerResponseListenersDefaultActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientCreateListenerResponseListenersDefaultActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
_ClientCreateListenerResponseListenersDefaultActionsRedirectConfigTypeDef = TypedDict(
    ...
    {"Protocol": str, "Port": str, "Host": str, "Path": str, "Query": str, "StatusCode": str},
    total=False,
)
    ...
    - **DefaultActions** *(list) --*
      ...
      - *(dict) --*
        ...
        - **Order** *(integer) --*
          ...
          action with the lowest value for order is performed first. The last action to be performed
          must be one of the following types of actions: a ``forward`` , ``fixed-response`` , or
          ``redirect`` .
        ...
        - **ForwardConfig** *(dict) --*
          ...
          groups. For Network Load Balancers, you can specify a single target group. Specify only
          when ``Type`` is ``forward`` . If you specify both ``ForwardConfig`` and
...
class ClientCreateLoadBalancerResponseLoadBalancersAvailabilityZonesLoadBalancerAddressesTypeDef(
    ...
    """
    Type definition for `ClientCreateLoadBalancerResponseLoadBalancersAvailabilityZones`
    ...
    - **AvailabilityZones** *(list) --*
      ...
      - *(dict) --*
        ...
        - **LoadBalancerAddresses** *(list) --*
          ...
          [Network Load Balancers] If you need static IP addresses for your load balancer, you can
          specify one Elastic IP address per Availability Zone when you create an internal-facing
          load balancer. For internal load balancers, you can specify a private IP address from the
...
class ClientCreateRuleConditionsHttpHeaderConfigTypeDef(
    ...
    - **Values** *(list) --*
      ...
      One or more strings to compare against the value of the HTTP header. The maximum size of each
      string is 128 characters. The comparison strings are case insensitive. The following wildcard
...
class ClientCreateRuleConditionsHttpRequestMethodConfigTypeDef(
    ...
    - **Values** *(list) --*
      ...
      A-Z, hyphen (-), and underscore (_). The comparison is case sensitive. Wildcards are not
      supported; therefore, the method name must be an exact match.

      If you specify multiple strings, the condition is satisfied if one of the strings matches the
      HTTP request method. We recommend that you route GET and HEAD requests in the same way,
...
class ClientCreateRuleConditionsPathPatternConfigTypeDef(
    ...
    - **Values** *(list) --*
      ...
      One or more path patterns to compare against the request URL. The maximum size of each string
      is 128 characters. The comparison is case sensitive. The following wildcard characters are
      ...
      URL. The path pattern is compared only to the path of the URL, not to its query string. To
      compare against the query string, use  QueryStringConditionConfig .
...
class ClientCreateRuleConditionsSourceIpConfigTypeDef(
    ...
    - **Values** *(list) --*
      ...
      request matches one of the CIDR blocks. This condition is not satisfied by the addresses in
      the X-Forwarded-For header. To search for addresses in the X-Forwarded-For header, use
...
class ClientCreateRuleResponseRulesActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientCreateRuleResponseRulesActionsForwardConfig`
    `TargetGroupStickinessConfig`
      ...
      - *(dict) --*
        ...
        - **HostHeaderConfig** *(dict) --*
          ...
          - **Values** *(list) --*
            ...
            is case insensitive. The following wildcard characters are supported: * (matches 0 or
        ...
        - **QueryStringConfig** *(dict) --*
          ...
          - **Values** *(list) --*
            ...
            you must escape these characters in ``Values`` using a '\\' character.
        ...
        - **HttpRequestMethodConfig** *(dict) --*
          ...
          - **Values** *(list) --*
            ...
            If you specify multiple strings, the condition is satisfied if one of the strings
            matches the HTTP request method. We recommend that you route GET and HEAD requests in
            the same way, because the response to a HEAD request may be cached.
...
class ClientDeregisterTargetsTargetsTypeDef(
    ...
    - **AvailabilityZone** *(string) --*
      ...
      An Availability Zone or ``all`` . This determines whether the target receives traffic from the
      load balancer nodes in the specified Availability Zone or from all enabled Availability Zones
      for the load balancer.
...
class ClientDescribeListenersResponseListenersDefaultActionsAuthenticateCognitoConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeListenersResponseListenersDefaultActions`
    `AuthenticateCognitoConfig`
...
class ClientDescribeListenersResponseListenersDefaultActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeListenersResponseListenersDefaultActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
class ClientDescribeLoadBalancersResponseLoadBalancersAvailabilityZonesLoadBalancerAddressesTypeDef(
    ...
    """
    Type definition for `ClientDescribeLoadBalancersResponseLoadBalancersAvailabilityZones`
    `LoadBalancerAddresses`
...
class ClientDescribeRulesResponseRulesActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeRulesResponseRulesActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
class ClientDescribeTargetHealthResponseTargetHealthDescriptionsTargetHealthTypeDef(
    ...
    - **Reason** *(string) --*
      ...
      * ``Elb.RegistrationInProgress`` - The target is in the process of being registered with the
      load balancer.

      * ``Elb.InitialHealthChecking`` - The load balancer is still sending the target the minimum
      ...
      * ``Target.Timeout`` - The health check requests timed out. Applies only to Application Load
      Balancers.

      * ``Target.FailedHealthChecks`` - The load balancer received an error while establishing a
      connection to the target or the target response was malformed.

      * ``Elb.InternalError`` - The health checks failed due to an internal error. Applies only to
      Application Load Balancers.
      ...
      * ``Target.NotInUse`` - The target group is not used by any load balancer or the target is in
      ...
      * ``Target.DeregistrationInProgress`` - The target is in the process of being deregistered and
      the deregistration delay period has not expired.

      If the target state is ``unavailable`` , the reason code can be the following value:

      * ``Target.HealthCheckDisabled`` - Health checks are disabled for the target group. Applies
      only to Application Load Balancers.

      * ``Elb.InternalError`` - Target health is unavailable due to an internal error. Applies only
...
class ClientDescribeTargetHealthResponseTargetHealthDescriptionsTypeDef(
    ...
    - **Target** *(dict) --*
      ...
      - **AvailabilityZone** *(string) --*
        ...
        If the target type is ``lambda`` , this parameter is optional and the only supported value
        is ``all`` .
    ...
    - **TargetHealth** *(dict) --*
      ...
      - **Reason** *(string) --*
        ...
        * ``Target.NotInUse`` - The target group is not used by any load balancer or the target is
        in an Availability Zone that is not enabled for its load balancer.
        ...
        * ``Target.DeregistrationInProgress`` - The target is in the process of being deregistered
        ...
        * ``Elb.InternalError`` - Target health is unavailable due to an internal error. Applies
      ...
      - *(dict) --*
        ...
        - **Target** *(dict) --*
          ...
          - **Id** *(string) --*
            ...
            an instance ID. If the target type is ``ip`` , specify an IP address. If the target type
            is ``lambda`` , specify the ARN of the Lambda function.
          ...
          - **AvailabilityZone** *(string) --*
            ...
            If the target type is ``ip`` and the IP address is in a subnet of the VPC for the target
            group, the Availability Zone is automatically detected and this parameter is optional.
        ...
        - **TargetHealth** *(dict) --*
          ...
          - **Reason** *(string) --*
            ...
            * ``Elb.RegistrationInProgress`` - The target is in the process of being registered with
            the load balancer.
            ...
            * ``Target.FailedHealthChecks`` - The load balancer received an error while establishing
...
_RequiredClientModifyListenerDefaultActionsFixedResponseConfigTypeDef = TypedDict(
    "_RequiredClientModifyListenerDefaultActionsFixedResponseConfigTypeDef", {"StatusCode": str}
)
...
class ClientModifyListenerDefaultActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientModifyListenerDefaultActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
_RequiredClientModifyListenerDefaultActionsRedirectConfigTypeDef = TypedDict(
    "_RequiredClientModifyListenerDefaultActionsRedirectConfigTypeDef", {"StatusCode": str}
)
...
class ClientModifyListenerResponseListenersDefaultActionsAuthenticateCognitoConfigTypeDef(
    ...
    """
    Type definition for `ClientModifyListenerResponseListenersDefaultActions`
    `AuthenticateCognitoConfig`
...
class ClientModifyListenerResponseListenersDefaultActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientModifyListenerResponseListenersDefaultActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
class ClientModifyRuleResponseRulesActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientModifyRuleResponseRulesActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
class ClientSetRulePrioritiesResponseRulesActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `ClientSetRulePrioritiesResponseRulesActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
class DescribeListenersPaginateResponseListenersDefaultActionsAuthenticateCognitoConfigTypeDef(
    ...
    """
    Type definition for `DescribeListenersPaginateResponseListenersDefaultActions`
    `AuthenticateCognitoConfig`
...
class DescribeListenersPaginateResponseListenersDefaultActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `DescribeListenersPaginateResponseListenersDefaultActionsForwardConfig`
    `TargetGroupStickinessConfig`
...
class DescribeLoadBalancersPaginateResponseLoadBalancersAvailabilityZonesLoadBalancerAddressesTypeDef(
    ...
    """
    Type definition for `DescribeLoadBalancersPaginateResponseLoadBalancersAvailabilityZones`
    `LoadBalancerAddresses`
...
class DescribeRulesPaginateResponseRulesActionsForwardConfigTargetGroupStickinessConfigTypeDef(
    ...
    """
    Type definition for `DescribeRulesPaginateResponseRulesActionsForwardConfig`
    `TargetGroupStickinessConfig`
