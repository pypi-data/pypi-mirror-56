...
class Client(BaseClient):
    ...
    def add_listener_certificates(
        ...
        certificates from the certificate list for a listener, use  RemoveListenerCertificates . To
            ...
            - **Certificates** *(list) --*
              ...
              - *(dict) --*
                ...
                - **IsDefault** *(boolean) --*
                  ...
                  value when specifying a certificate as an input. This value is not included in the
                  output when describing a listener, but is included when describing listener
                  certificates.
    ...
    def create_listener(
        ...
        To update a listener, use  ModifyListener . When you are finished with a listener, you can
        delete it using  DeleteListener . If you are finished with both the listener and the load
        balancer, you can delete them both using  DeleteLoadBalancer .
        ...
        **Request Syntax**
        ...
        :param DefaultActions: **[REQUIRED]**
          ...
          If the action type is ``forward`` , you specify one or more target groups. The protocol of
          the target group must be HTTP or HTTPS for an Application Load Balancer. The protocol of
          the target group must be TCP, TLS, UDP, or TCP_UDP for a Network Load Balancer.

          [HTTPS listeners] If the action type is ``authenticate-oidc`` , you authenticate users
          through an identity provider that is OpenID Connect (OIDC) compliant.
          ...
          [Application Load Balancer] If the action type is ``redirect`` , you redirect specified
          client requests from one URL to another.
          ...
          - *(dict) --*
            ...
            - **ForwardConfig** *(dict) --*
              ...
              ``TargetGroupArn`` , you can specify only one target group using ``ForwardConfig`` and
              it must be the same target group specified in ``TargetGroupArn`` .
                ...
                'Listeners': [
                    {
                        ...
                        'DefaultActions': [
                            {
                                'Type':
                                'forward'|'authenticate-oidc'
                                |'authenticate-cognito'|'redirect'
                                |'fixed-response',
                                'TargetGroupArn': 'string',
                                'AuthenticateOidcConfig': {
                                    'Issuer': 'string',
                ...
                - **Certificates** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **IsDefault** *(boolean) --*
                      ...
                      the output when describing a listener, but is included when describing
                ...
                - **DefaultActions** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **ForwardConfig** *(dict) --*
                      ...
                      ``ForwardConfig`` and ``TargetGroupArn`` , you can specify only one target
                      group using ``ForwardConfig`` and it must be the same target group specified
                      in ``TargetGroupArn`` .
    ...
    def create_load_balancer(
        ...
        type, and tags. Otherwise, you could do so later using  SetSecurityGroups ,  SetSubnets ,
        SetIpAddressType , and  AddTags .

        To create listeners for your load balancer, use  CreateListener . To describe your current
        load balancers, see  DescribeLoadBalancers . When you are finished with a load balancer, you
        ...
        <https://docs.aws.amazon.com/elasticloadbalancing/latest/network/load-balancer-limits.html>`__
        in the *Network Load Balancers Guide* .
        ...
        <https://docs.aws.amazon.com/elasticloadbalancing/latest/network/network-load-balancers.html>`__
        in the *Network Load Balancers Guide* .
        ...
        **Request Syntax**
        ...
        :param Scheme:
          ...
          Internet-facing load balancer is publicly resolvable to the public IP addresses of the
        ...
        :param IpAddressType:
          ...
          balancer. The possible values are ``ipv4`` (for IPv4 addresses) and ``dualstack`` (for
            ...
            - **LoadBalancers** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Scheme** *(string) --*
                  ...
                  addresses of the nodes. Therefore, internal load balancers can route requests only
                ...
                - **AvailabilityZones** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **LoadBalancerAddresses** *(list) --*
                      ...
                      you create an internal-facing load balancer. For internal load balancers, you
                ...
                - **IpAddressType** *(string) --*
                  ...
                  values are ``ipv4`` (for IPv4 addresses) and ``dualstack`` (for IPv4 and IPv6
                  addresses).
    ...
    def create_rule(
        ...
        met, the actions for the default rule are performed. For more information, see `Listener
        Rules
        <https://docs.aws.amazon.com/elasticloadbalancing/latest/application/load-balancer-listeners.html#listener-rules>`__
        in the *Application Load Balancers Guide* .

        To view your current rules, use  DescribeRules . To update a rule, use  ModifyRule . To set
        the priorities of your rules, use  SetRulePriorities . To delete a rule, use  DeleteRule .
        ...
        **Request Syntax**
          ...
          - *(dict) --*
            ...
            - **Values** *(list) --*
              ...
              * ? (matches exactly 1 character)
              ...
              /img/*). A path pattern is case-sensitive, can be up to 128 characters in length, and
            ...
            - **SourceIpConfig** *(dict) --*
              ...
              - **Values** *(list) --*
                ...
                satisfied by the addresses in the X-Forwarded-For header. To search for addresses in
        ...
        :param Actions: **[REQUIRED]**
          ...
          ``forward`` , ``fixed-response`` , or ``redirect`` , and it must be the last action to be
          performed.
            ...
            - **Rules** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Conditions** *(list) --*
                  ...
                  and zero or more of the following conditions: ``http-header`` and ``query-string``
                  .
                ...
                - **Actions** *(list) --*
                  ...
                  The actions. Each rule must include exactly one of the following types of actions:
                  ``forward`` , ``redirect`` , or ``fixed-response`` , and it must be the last
    ...
    def create_target_group(
        ...
        settings for the target group, use  ModifyTargetGroup . To monitor the health of targets in
        the target group, use  DescribeTargetHealth .

        To route traffic to the targets in a target group, specify the target group in an action
        using  CreateListener or  CreateRule .
        ...
        **Request Syntax**
        ...
        :param Protocol:
          ...
          protocols are TCP, TLS, UDP, or TCP_UDP. A TCP_UDP listener must be associated with a
          TCP_UDP target group. If the target is a Lambda function, this parameter does not apply.

        :type Port: integer
        :param Port:

          The port on which the targets receive traffic. This port is used unless you specify a port
          override when registering the target. If the target is a Lambda function, this parameter
          does not apply.
        ...
        :param HealthCheckProtocol:
          ...
          is TCP. The TCP protocol is supported for health checks only if the protocol of the target
          group is TCP, TLS, UDP, or TCP_UDP. The TLS, UDP, and TCP_UDP protocols are not supported
          for health checks.
        ...
        :param HealthCheckEnabled:
          ...
          checks are disabled by default but can be enabled. If the target type is ``instance`` or
        ...
        :param HealthCheckIntervalSeconds:
          ...
          For HTTP and HTTPS health checks, the range is 5–300 seconds. For TCP health checks, the
          supported values are 10 and 30 seconds. If the target type is ``instance`` or ``ip`` , the
          default is 30 seconds. If the target type is ``lambda`` , the default is 35 seconds.
        ...
        :param HealthyThresholdCount:
          ...
          target groups with a protocol of TCP or TLS, the default is 3. If the target type is
        ...
        :param TargetType:
          ...
          * ``instance`` - Targets are specified by instance ID. This is the default value. If the
          target group protocol is UDP or TCP_UDP, the target type must be ``instance`` .

          * ``ip`` - Targets are specified by IP address. You can specify IP addresses from the
            ...
            - **TargetGroups** *(list) --*
              ...
              - *(dict) --*
                ...
                - **TargetType** *(string) --*
                  ...
                  group. The possible values are ``instance`` (targets are specified by instance ID)
                  or ``ip`` (targets are specified by IP address).
    ...
    def delete_listener(self, ListenerArn: str) -> Dict[str, Any]:
        ...
        attached, using  DeleteLoadBalancer .
              ...
              - *(dict) --*
                ...
                - **Key** *(string) --*
                  ...
                  * ``load_balancing.cross_zone.enabled`` - Indicates whether cross-zone load
                  balancing is enabled. The value is ``true`` or ``false`` . The default is
                  ``false`` .
    ...
    def describe_load_balancers(
        ...
        To describe the listeners for a load balancer, use  DescribeListeners . To describe the
        attributes for a load balancer, use  DescribeLoadBalancerAttributes .
              ...
              - *(dict) --*
                ...
                - **Key** *(string) --*
                  ...
                  * ``slow_start.duration_seconds`` - The time period, in seconds, during which a
                  newly registered target receives a linearly increasing share of the traffic to the
                  target group. After this time period ends, the target receives its full share of
                  traffic. The range is 30-900 seconds (15 minutes). Slow start mode is disabled by
                  default.
                  ...
                  * ``lambda.multi_value_headers.enabled`` - Indicates whether the request and
                  ...
                  include arrays of values or strings. The value is ``true`` or ``false`` . The
                  default is ``false`` . If the value is ``false`` and the request contains a
    ...
    def describe_target_groups(
        ...
        To describe the targets for a target group, use  DescribeTargetHealth . To describe the
                ...
                'TargetHealthDescriptions': [
                    {
                        ...
                        'TargetHealth': {
                            ...
                            |'Target.InvalidState'|'Target.IpUnusable'
              ...
              - *(dict) --*
                ...
                - **Target** *(dict) --*
                  ...
                  - **Id** *(string) --*
                    ...
                    the target type is ``lambda`` , specify the ARN of the Lambda function.
                  ...
                  - **AvailabilityZone** *(string) --*
                    ...
                    parameter is optional. If the IP address is outside the VPC, this parameter is
                    required.
    ...
    def modify_listener(
        ...
        TCP to TLS, you must add the security policy and default certificate properties.

        To add an item to a list, remove an item from a list, or update an item in a list, you must
        provide the entire list. For example, to add an action, specify a list with the current
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --*
              ...
              * ``access_logs.s3.bucket`` - The name of the S3 bucket for the access logs. This
              ...
              region as the load balancer and have a bucket policy that grants Elastic Load
              Balancing permissions to write to the bucket.
    ...
    def modify_target_group(
        ...
        **Request Syntax**
        ...
        :param HealthCheckProtocol:
          ...
          protocol is supported for health checks only if the protocol of the target group is TCP,
          TLS, UDP, or TCP_UDP. The TLS, UDP, and TCP_UDP protocols are not supported for health
          checks.
        ...
        :param HealthCheckIntervalSeconds:
          ...
          The approximate amount of time, in seconds, between health checks of an individual target.
          For Application Load Balancers, the range is 5 to 300 seconds. For Network Load Balancers,
        ...
        :param HealthCheckTimeoutSeconds:
          ...
          [HTTP/HTTPS health checks] The amount of time, in seconds, during which no response means
        ...
        :param Attributes: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **Key** *(string) --*
              ...
              * ``deregistration_delay.timeout_seconds`` - The amount of time, in seconds, for
              Elastic Load Balancing to wait before changing the state of a deregistering target
              from ``draining`` to ``unused`` . The range is 0-3600 seconds. The default value is
              300 seconds. If the target is a Lambda function, this attribute is not supported.
    ...
    def register_targets(
        ...
        following instance types: C1, CC1, CC2, CG1, CG2, CR1, CS1, G1, G2, HI1, HS1, M1, M2, M3,
        ...
        **Request Syntax**
        ...
        :param Targets: **[REQUIRED]**
          ...
          To register a target by instance ID, specify the instance ID. To register a target by IP
          address, specify the IP address. To register a Lambda function, specify the ARN of the
          Lambda function.
    ...
    def set_subnets(
        ...
        """
        Enables the Availability Zones for the specified public subnets for the specified load
        balancer. The specified subnets replace the previously enabled subnets.

        When you specify subnets for a Network Load Balancer, you must include all subnets that were
        ...
        **Request Syntax**
        ...
        :param SubnetMappings:
          ...
          [Network Load Balancers] You can specify subnets from one or more Availability Zones. If
          you need static IP addresses for your internet-facing load balancer, you can specify one
          Elastic IP address per subnet. For internal load balancers, you can specify one private IP
          address per subnet from the IPv4 range of the subnet.
