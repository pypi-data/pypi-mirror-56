...
class Experiment(CnvrgJob):
    ...
    @staticmethod
    def run(command=None, arguments: dict=None, grid: dict=None, title: str=None, project: Project=None, compute: str=None, computes: List=None, datasets: List=None, dataset: str=None, local: bool=False, library: str=None, working_directory: str=None, sync_before: bool=True, sync_after: bool=True, prerun: bool=True, requirements: bool=True, image: str=None, **kwargs):
        ...
        if local:
            ...
            e = project.run_task(command, arguments=arguments, title=title, templates=computes, datasets=datasets, library=library,  prerun=prerun, requirements=requirements, grid=grid, image=image, **kwargs)
