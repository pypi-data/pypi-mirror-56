...
class Experiment(CnvrgJob):
    ...
    def run(command=None, arguments: dict=None, grid: dict=None, title: str=None, project: Project=None, compute: str=None, output_dir: str=None, computes: List=None,
            ...
            prerun: bool=True, requirements: bool=True, image: str=None, schedule: str=None, recurring: str=None, **kwargs):
        ...
        if project.git:
            git_commit = project.get_git_commit()
            output_dir = output_dir or "output"
            git_branch = project.get_git_branch()
        ...
        if local:
            ...
            e = project.run_task(command, arguments=arguments, title=title, templates=computes, datasets=datasets,
                                 ...
                                 grid=grid,git_branch=git_branch, git_commit=git_commit, output_dir=output_dir, image=image, schedule=schedule, recurring=recurring, **kwargs)
