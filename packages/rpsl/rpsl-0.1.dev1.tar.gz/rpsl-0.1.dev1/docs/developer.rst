...
.. warning::
   ...
   `rpsl` package. If you just want to write code that uses it
...
In your terminal, change to the directory where you cloned `rpsl`, and type::

    conda env create -f environment.yml

This will create a conda virtual environment called `rpsl-dev` with all
the Raspberry Pi Sensor Library dependencies and a few useful packages for development and
interaction.
...
* On Windows, in your Anaconda Prompt, run ``activate rpsl-dev``
* On MacOSX and Linux, in your Terminal, run ``source activate rpsl-dev``
...
type::
    ...
    conda list -n rpsl-dev

If later you want to leave the `rpsl-dev` virtual environment:
...
then on, all the Raspberry Pi Sensor Library binaries and the library itself will be
...
.. _available on GitHub: https://gitlab.com/jdhp/rpi-sensor-lib
...
.. _TODO.md: https://gitlab.com/jdhp/rpi-sensor-lib/blob/master/TODO.md
