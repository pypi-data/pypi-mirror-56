...
class GetApprovedMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_token_id).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_token_id) = self.validate_and_normalize_inputs(_token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_token_id).transact(tx_params.as_dict())
    ...
    def build_transaction(
        ...
        (_token_id) = self.validate_and_normalize_inputs(_token_id)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_token_id).buildTransaction(
            tx_params.as_dict()
        )
...
class ApproveMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_approved, _token_id).call(
            tx_params.as_dict()
        )
...
class TransferFromMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_from, _to, _token_id).call(
            tx_params.as_dict()
        )
...
class MintMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_to, _token_id).call(
            tx_params.as_dict()
        )
...
class BalanceOfMethod(ContractMethod):
    ...
    def call(self, _owner: str, tx_params: Optional[TxParams] = None) -> int:
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner).call(tx_params.as_dict())
    ...
    def send_transaction(
        ...
        (_owner) = self.validate_and_normalize_inputs(_owner)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner).transact(tx_params.as_dict())
    ...
    def build_transaction(
        ...
        (_owner) = self.validate_and_normalize_inputs(_owner)
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner).buildTransaction(
            tx_params.as_dict()
        )
...
class BurnMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _token_id).call(
            tx_params.as_dict()
        )
...
class SetApprovalForAllMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_operator, _approved).call(
            tx_params.as_dict()
        )
...
class SafeTransferFrom2Method(ContractMethod):
    ...
    def validate_and_normalize_inputs(
        self, _from: str, _to: str, _token_id: int, _data: bytes
    ):
        """Validate the inputs to the safeTransferFrom method."""
        self.validator.assert_valid(
            method_name="safeTransferFrom",
        ...
        _data = bytes.fromhex(_data.decode("utf-8"))
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_from, _to, _token_id, _data).call(
            tx_params.as_dict()
        )
...
class IsApprovedForAllMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _operator).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _operator).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _operator).buildTransaction(
            tx_params.as_dict()
        )
...
class DummyERC721Token:
    ...
    def __init__(
        ...
        if not validator:
            validator = DummyERC721TokenValidator(provider, contract_address)
        ...
        self.name = NameMethod(
            provider, contract_address, functions.name, validator
        )

        self.get_approved = GetApprovedMethod(
            provider, contract_address, functions.getApproved, validator
        )

        self.approve = ApproveMethod(
            provider, contract_address, functions.approve, validator
        )
        ...
        self.mint = MintMethod(
            provider, contract_address, functions.mint, validator
        )

        self.safe_transfer_from1 = SafeTransferFrom1Method(
            provider, contract_address, functions.safeTransferFrom, validator
        )

        self.owner_of = OwnerOfMethod(
            provider, contract_address, functions.ownerOf, validator
        )

        self.balance_of = BalanceOfMethod(
            provider, contract_address, functions.balanceOf, validator
        )
        ...
        self.symbol = SymbolMethod(
            provider, contract_address, functions.symbol, validator
        )

        self.burn = BurnMethod(
            provider, contract_address, functions.burn, validator
        )

        self.set_approval_for_all = SetApprovalForAllMethod(
            provider, contract_address, functions.setApprovalForAll, validator
        )
        ...
        self.is_approved_for_all = IsApprovedForAllMethod(
            provider, contract_address, functions.isApprovedForAll, validator
        )
