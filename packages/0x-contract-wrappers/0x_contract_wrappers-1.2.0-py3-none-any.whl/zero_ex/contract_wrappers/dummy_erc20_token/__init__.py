...
class ApproveMethod(ContractMethod):
    ...
    def call(
    ...
    ) -> Union[bool, Union[HexBytes, bytes]]:
        """Execute underlying contract method via eth_call.
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_spender, _value).call(
            tx_params.as_dict()
        )
...
class TransferFromMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_from, _to, _value).call(
            tx_params.as_dict()
        )
...
class MintMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_value).call(tx_params.as_dict())
...
class TransferMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_to, _value).call(tx_params.as_dict())
...
class AllowanceMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _spender).call(
            tx_params.as_dict()
        )
    ...
    def send_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _spender).transact(
            tx_params.as_dict()
        )
    ...
    def build_transaction(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_owner, _spender).buildTransaction(
            tx_params.as_dict()
        )
...
class SetBalanceMethod(ContractMethod):
    ...
    def call(
        ...
        tx_params = super().normalize_tx_params(tx_params)
        return self._underlying_method(_target, _value).call(
            tx_params.as_dict()
        )
...
class DummyERC20Token:
    ...
    def __init__(
        ...
        if not validator:
            validator = DummyERC20TokenValidator(provider, contract_address)
        ...
        self.total_supply = TotalSupplyMethod(
            provider, contract_address, functions.totalSupply, validator
        )
        ...
        self.decimals = DecimalsMethod(
            provider, contract_address, functions.decimals, validator
        )
        ...
        self.transfer = TransferMethod(
            provider, contract_address, functions.transfer, validator
        )

        self.allowance = AllowanceMethod(
            provider, contract_address, functions.allowance, validator
        )

        self.set_balance = SetBalanceMethod(
            provider, contract_address, functions.setBalance, validator
        )
        ...
        self.max_mint_amount = MaxMintAmountMethod(
            provider, contract_address, functions.MAX_MINT_AMOUNT, validator
        )
