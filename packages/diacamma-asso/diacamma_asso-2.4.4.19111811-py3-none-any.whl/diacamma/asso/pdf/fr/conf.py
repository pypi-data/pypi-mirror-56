...
htmlhelp_basename = 'DiacammaAsso'
...
latex_documents = [
    (master_doc, 'DiacammaAsso.tex', 'Diacamma Asso',
     'sd-libre', 'manual'),
]

# The name of an image file (relative to this directory) to place at the top of
# the title page.
latex_logo = "../../DiacammaAsso.jpg"
...
man_pages = [
    (master_doc, 'DiacammaAsso', 'Diacamma Asso',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'DiacammaAsso', 'Diacamma Asso',
     author, 'DiacammaAsso', 'Manuel de Diacamma Asso.', 'Miscellaneous'),
]
