...
class TestRailAPIClient(object):
    ...
    def __init__(self, server, user, password, run_id, protocol='http'):
        ...
        *Args:*\n
        ...
        """
        self._url = '{protocol}://{server}/index.php?/api/v2/'\
            .format(protocol=protocol, server=server)
        self._user = user
    ...
    def _send_get(self, uri, headers=None, params=None):
        ...
        *Returns:* \n
        ...
        response = get(url, headers=headers, params=params,
                       auth=(self._user, self._password), verify=False)
        response.raise_for_status()
        return response.json()
    ...
    def add_result_for_case(self, run_id, case_id,
        ...
        *Supported request fields for test result:*\n
        ...
        | Custom fields are supported as well and must be submitted with their system name,
        ...
        *Example:*\n
        | Add Result For Case | run_id=321 | case_id=123| test_result={'status_id': 3,
           'comment': 'This test is untested', 'defects': 'DEF-123'} |
        """
    ...
    def update_case(self, case_id, request_fields):
        ...
        *Example:*\n
        | Update Case | case_id=213 | request_fields={'title': name, 'type_id': 1,
    ...
    def add_section(self, project_id, name, suite_id=None, parent_id=None,
                    description=None):
    ...
    def get_sections(self, project_id, suite_id):
        ...
        *Returns:* \n
        ...
        uri = 'get_sections/{project_id}&suite_id={suite_id}'\
            .format(project_id=project_id, suite_id=suite_id)
        response = self._send_get(uri=uri, headers=DEFAULT_TESTRAIL_HEADERS)
        return response
    ...
    def add_case(self, section_id, title, steps, description, refs,
                 type_id, priority_id, **additional_data):
