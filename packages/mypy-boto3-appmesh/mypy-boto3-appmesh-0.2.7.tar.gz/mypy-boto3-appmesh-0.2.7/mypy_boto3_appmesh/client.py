...
class Client(BaseClient):
    ...
    def create_mesh(
        ...
        After you create your service mesh, you can create virtual services, virtual nodes, virtual routers,
    ...
    def create_route(
        ...
        For example, if your virtual service name is ``my-service.local`` and you want the route to match
    ...
    def create_virtual_node(
        ...
        for your task group's Envoy proxy container in your task definition or pod spec. This is then mapped
        ...
        **Request Syntax**
        ...
        :param spec: **[REQUIRED]**
          ...
          - **listeners** *(list) --*
            ...
            The listeners that the virtual node is expected to receive inbound traffic from. You can specify
            one listener.
    ...
    def create_virtual_service(
        ...
        A virtual service is an abstraction of a real service that is provided by a virtual node directly or
    ...
    def list_meshes(
        ...
        **Request Syntax**
        ...
        :param limit:
          ...
          between 1 and 100. If you don't use this parameter, ``ListMeshes`` returns up to 100 results and a
    ...
    def list_routes(
        ...
        **Request Syntax**
        ...
        :param limit:
          ...
          between 1 and 100. If you don't use this parameter, ``ListRoutes`` returns up to 100 results and a
          ``nextToken`` value if applicable.
    ...
    def list_tags_for_resource(
        ...
        **Request Syntax**
        ...
        :param nextToken:
          ...
          ``limit`` was used and the results exceeded the value of that parameter. Pagination continues from
    ...
    def list_virtual_nodes(
        ...
        **Request Syntax**
        ...
        :param limit:
          ...
          ``nextToken`` response element. You can see the remaining results of the initial request by
          sending another ``ListVirtualNodes`` request with the returned ``nextToken`` value. This value can
          be between 1 and 100. If you don't use this parameter, ``ListVirtualNodes`` returns up to 100
    ...
    def list_virtual_routers(
        ...
        **Request Syntax**
        ...
        :param limit:
          ...
          The maximum number of results returned by ``ListVirtualRouters`` in paginated output. When you use
          this parameter, ``ListVirtualRouters`` returns only ``limit`` results in a single page along with
          a ``nextToken`` response element. You can see the remaining results of the initial request by
          sending another ``ListVirtualRouters`` request with the returned ``nextToken`` value. This value
          can be between 1 and 100. If you don't use this parameter, ``ListVirtualRouters`` returns up to
    ...
    def list_virtual_services(
        ...
        **Request Syntax**
        ...
        :param limit:
          ...
          sending another ``ListVirtualServices`` request with the returned ``nextToken`` value. This value
          can be between 1 and 100. If you don't use this parameter, ``ListVirtualServices`` returns up to
          100 results and a ``nextToken`` value if applicable.
