...
class ClientCreateRouteResponseroutespecgrpcRouteactionweightedTargetsTypeDef(
    ...
    weight of 50 receives five times as much traffic as one with a relative weight of 10. The total
...
class ClientCreateRouteResponseroutespechttp2RoutematchTypeDef(
    ...
    - **prefix** *(string) --*
      ...
      Specifies the path to match requests with. This parameter must always start with ``/`` , which
      by itself matches all requests to the virtual service name. You can also match for path-based
      routing of requests. For example, if your virtual service name is ``my-service.local`` and you
      want the route to match requests to ``my-service.local/metrics`` , your prefix should be
      ``/metrics`` .
        ...
        - **action** *(dict) --*
          ...
          - **weightedTargets** *(list) --*
            ...
            - *(dict) --*
              ...
              An object that represents a target and its relative weight. Traffic is distributed
              across targets according to their relative weight. For example, a weighted target with
              a relative weight of 50 receives five times as much traffic as one with a relative
              weight of 10. The total weight for all targets combined must be less than or equal to
              100.
        ...
        - **http2Route** *(dict) --*
          ...
          - **match** *(dict) --*
            ...
            - **prefix** *(string) --*
              ...
              for path-based routing of requests. For example, if your virtual service name is
              ``my-service.local`` and you want the route to match requests to
              ``my-service.local/metrics`` , your prefix should be ``/metrics`` .
...
_ClientCreateRoutespecgrpcRoutematchmetadatamatchrangeTypeDef = TypedDict(
    "_ClientCreateRoutespecgrpcRoutematchmetadatamatchrangeTypeDef", {"end": int, "start": int}
)
...
_OptionalClientCreateRoutespecgrpcRouteretryPolicyTypeDef = TypedDict(
    ...
    {"grpcRetryEvents": List[str], "httpRetryEvents": List[str], "tcpRetryEvents": List[str]},
    total=False,
)
...
_ClientCreateRoutespechttp2RoutematchheadersmatchrangeTypeDef = TypedDict(
    "_ClientCreateRoutespechttp2RoutematchheadersmatchrangeTypeDef", {"end": int, "start": int}
)
...
class ClientCreateRoutespechttp2RouteTypeDef(
    _RequiredClientCreateRoutespechttp2RouteTypeDef, _OptionalClientCreateRoutespechttp2RouteTypeDef
):
    """
...
_ClientCreateRoutespechttpRoutematchheadersmatchrangeTypeDef = TypedDict(
    "_ClientCreateRoutespechttpRoutematchheadersmatchrangeTypeDef", {"end": int, "start": int}
)
...
class ClientCreateRoutespechttpRouteTypeDef(
    _RequiredClientCreateRoutespechttpRouteTypeDef, _OptionalClientCreateRoutespechttpRouteTypeDef
):
    """
...
_ClientCreateRoutespectcpRouteTypeDef = TypedDict(
    "_ClientCreateRoutespectcpRouteTypeDef", {"action": ClientCreateRoutespectcpRouteactionTypeDef}
)
...
class ClientCreateVirtualNodeResponsevirtualNodespeclistenershealthCheckTypeDef(
    ...
    - **port** *(integer) --*
      ...
      The destination port for the health check request. This port must match the port defined in
...
class ClientCreateVirtualNodeResponsevirtualNodespecloggingaccessLogfileTypeDef(
    ...
    - **path** *(string) --*
      ...
      export the access logs to a log storage service such as Amazon CloudWatch Logs. You can also
      specify a path in the Envoy container's file system to write the files to disk.
...
class ClientCreateVirtualNodeResponsevirtualNodespecloggingaccessLogTypeDef(
    ...
    - **file** *(dict) --*
      ...
      - **path** *(string) --*
        ...
        to export the access logs to a log storage service such as Amazon CloudWatch Logs. You can
        also specify a path in the Envoy container's file system to write the files to disk.
...
class ClientCreateVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapattributesTypeDef(
    ...
    """
    Type definition for `ClientCreateVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMap`
    `attributes`
...
class ClientCreateVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapTypeDef(
    ...
    """
    Type definition for `ClientCreateVirtualNodeResponsevirtualNodespecserviceDiscovery`
    `awsCloudMap`
    ...
    - **attributes** *(list) --*
      ...
      custom attribute that you specified when you registered the instance. Only instances that
      ...
      - **accessLog** *(dict) --*
        ...
        - **file** *(dict) --*
          ...
          - **path** *(string) --*
            ...
            The file path to write access logs to. You can use ``/dev/stdout`` to send access logs
            to standard out and configure your Envoy container to use a log driver, such as
            ``awslogs`` , to export the access logs to a log storage service such as Amazon
            CloudWatch Logs. You can also specify a path in the Envoy container's file system to
...
_ClientCreateVirtualNodeResponsevirtualNodestatusTypeDef = TypedDict(
    "_ClientCreateVirtualNodeResponsevirtualNodestatusTypeDef", {"status": str}, total=False
)
...
_ClientCreateVirtualNodespeclistenersportMappingTypeDef = TypedDict(
    "_ClientCreateVirtualNodespeclistenersportMappingTypeDef", {"port": int, "protocol": str}
)
...
_ClientCreateVirtualRouterResponsevirtualRouterstatusTypeDef = TypedDict(
    "_ClientCreateVirtualRouterResponsevirtualRouterstatusTypeDef", {"status": str}, total=False
)
...
_ClientCreateVirtualRouterspeclistenersportMappingTypeDef = TypedDict(
    "_ClientCreateVirtualRouterspeclistenersportMappingTypeDef", {"port": int, "protocol": str}
)
...
class ClientCreateVirtualServiceResponsevirtualServicespecprovidervirtualRouterTypeDef(
    ...
    """
    Type definition for `ClientCreateVirtualServiceResponsevirtualServicespecprovider`
    `virtualRouter`
...
_ClientCreateVirtualServiceResponsevirtualServicestatusTypeDef = TypedDict(
    "_ClientCreateVirtualServiceResponsevirtualServicestatusTypeDef", {"status": str}, total=False
)
...
_ClientCreateVirtualServicespecprovidervirtualRouterTypeDef = TypedDict(
    "_ClientCreateVirtualServicespecprovidervirtualRouterTypeDef", {"virtualRouterName": str}
)
...
class ClientDeleteVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapattributesTypeDef(
    ...
    """
    Type definition for `ClientDeleteVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMap`
    `attributes`
...
class ClientDeleteVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapTypeDef(
    ...
    """
    Type definition for `ClientDeleteVirtualNodeResponsevirtualNodespecserviceDiscovery`
    `awsCloudMap`
...
_ClientDeleteVirtualNodeResponsevirtualNodestatusTypeDef = TypedDict(
    "_ClientDeleteVirtualNodeResponsevirtualNodestatusTypeDef", {"status": str}, total=False
)
...
_ClientDeleteVirtualRouterResponsevirtualRouterstatusTypeDef = TypedDict(
    "_ClientDeleteVirtualRouterResponsevirtualRouterstatusTypeDef", {"status": str}, total=False
)
...
class ClientDeleteVirtualServiceResponsevirtualServicespecprovidervirtualRouterTypeDef(
    ...
    """
    Type definition for `ClientDeleteVirtualServiceResponsevirtualServicespecprovider`
    `virtualRouter`
...
_ClientDeleteVirtualServiceResponsevirtualServicestatusTypeDef = TypedDict(
    "_ClientDeleteVirtualServiceResponsevirtualServicestatusTypeDef", {"status": str}, total=False
)
...
class ClientDescribeRouteResponseroutespechttp2RouteretryPolicyperRetryTimeoutTypeDef(
    ...
    """
    Type definition for `ClientDescribeRouteResponseroutespechttp2RouteretryPolicy`
    `perRetryTimeout`
...
class ClientDescribeVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapattributesTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMap` `attributes`
...
class ClientDescribeVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapTypeDef(
    ...
    """
    Type definition for `ClientDescribeVirtualNodeResponsevirtualNodespecserviceDiscovery`
    `awsCloudMap`
...
_ClientDescribeVirtualNodeResponsevirtualNodestatusTypeDef = TypedDict(
    "_ClientDescribeVirtualNodeResponsevirtualNodestatusTypeDef", {"status": str}, total=False
)
...
class ClientDescribeVirtualRouterResponsevirtualRouterspeclistenersportMappingTypeDef(
    ...
    """
    Type definition for `ClientDescribeVirtualRouterResponsevirtualRouterspeclisteners`
    `portMapping`
...
_ClientDescribeVirtualRouterResponsevirtualRouterstatusTypeDef = TypedDict(
    "_ClientDescribeVirtualRouterResponsevirtualRouterstatusTypeDef", {"status": str}, total=False
)
...
class ClientDescribeVirtualServiceResponsevirtualServicespecprovidervirtualNodeTypeDef(
    ...
    """
    Type definition for `ClientDescribeVirtualServiceResponsevirtualServicespecprovider`
    `virtualNode`
...
_ClientDescribeVirtualServiceResponsevirtualServicestatusTypeDef = TypedDict(
    "_ClientDescribeVirtualServiceResponsevirtualServicestatusTypeDef", {"status": str}, total=False
)
...
_ClientUpdateRoutespecgrpcRoutematchmetadatamatchrangeTypeDef = TypedDict(
    "_ClientUpdateRoutespecgrpcRoutematchmetadatamatchrangeTypeDef", {"end": int, "start": int}
)
...
_ClientUpdateRoutespechttp2RoutematchheadersmatchrangeTypeDef = TypedDict(
    "_ClientUpdateRoutespechttp2RoutematchheadersmatchrangeTypeDef", {"end": int, "start": int}
)
...
class ClientUpdateRoutespechttp2RouteTypeDef(
    _RequiredClientUpdateRoutespechttp2RouteTypeDef, _OptionalClientUpdateRoutespechttp2RouteTypeDef
):
    """
...
_ClientUpdateRoutespechttpRoutematchheadersmatchrangeTypeDef = TypedDict(
    "_ClientUpdateRoutespechttpRoutematchheadersmatchrangeTypeDef", {"end": int, "start": int}
)
...
class ClientUpdateRoutespechttpRouteTypeDef(
    _RequiredClientUpdateRoutespechttpRouteTypeDef, _OptionalClientUpdateRoutespechttpRouteTypeDef
):
    """
...
_ClientUpdateRoutespectcpRouteTypeDef = TypedDict(
    "_ClientUpdateRoutespectcpRouteTypeDef", {"action": ClientUpdateRoutespectcpRouteactionTypeDef}
)
...
class ClientUpdateVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapattributesTypeDef(
    ...
    """
    Type definition for `ClientUpdateVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMap`
    `attributes`
...
class ClientUpdateVirtualNodeResponsevirtualNodespecserviceDiscoveryawsCloudMapTypeDef(
    ...
    """
    Type definition for `ClientUpdateVirtualNodeResponsevirtualNodespecserviceDiscovery`
    `awsCloudMap`
...
_ClientUpdateVirtualNodeResponsevirtualNodestatusTypeDef = TypedDict(
    "_ClientUpdateVirtualNodeResponsevirtualNodestatusTypeDef", {"status": str}, total=False
)
...
_ClientUpdateVirtualNodespeclistenersportMappingTypeDef = TypedDict(
    "_ClientUpdateVirtualNodespeclistenersportMappingTypeDef", {"port": int, "protocol": str}
)
...
_ClientUpdateVirtualRouterResponsevirtualRouterstatusTypeDef = TypedDict(
    "_ClientUpdateVirtualRouterResponsevirtualRouterstatusTypeDef", {"status": str}, total=False
)
...
_ClientUpdateVirtualRouterspeclistenersportMappingTypeDef = TypedDict(
    "_ClientUpdateVirtualRouterspeclistenersportMappingTypeDef", {"port": int, "protocol": str}
)
...
class ClientUpdateVirtualServiceResponsevirtualServicespecprovidervirtualRouterTypeDef(
    ...
    """
    Type definition for `ClientUpdateVirtualServiceResponsevirtualServicespecprovider`
    `virtualRouter`
...
_ClientUpdateVirtualServiceResponsevirtualServicestatusTypeDef = TypedDict(
    "_ClientUpdateVirtualServiceResponsevirtualServicestatusTypeDef", {"status": str}, total=False
)
...
_ClientUpdateVirtualServicespecprovidervirtualRouterTypeDef = TypedDict(
    "_ClientUpdateVirtualServicespecprovidervirtualRouterTypeDef", {"virtualRouterName": str}
)
