...
class Client(BaseClient):
        ...
        **Request Syntax**
        ...
        :param InstanceFleet: **[REQUIRED]**
          ...
          - **TargetOnDemandCapacity** *(integer) --*
            ...
            provisions instances until the target capacity is totally fulfilled, even if this
            results in an overage. For example, if there are 2 units remaining to fulfill capacity,
            and Amazon EMR can only provision an instance with a ``WeightedCapacity`` of 5 units,
          ...
          - **LaunchSpecifications** *(dict) --*
            ...
            - **SpotSpecification** *(dict) --* **[REQUIRED]**
              ...
              - **BlockDurationMinutes** *(integer) --*
                ...
                180, 240, 300, or 360. The duration period starts as soon as a Spot instance
                receives its instance ID. At the end of the duration, Amazon EC2 marks the Spot
                  ...
                  - **Action** *(dict) --* **[REQUIRED]**
                    ...
                    - **SimpleScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
                      ...
                      - **AdjustmentType** *(string) --*
                        ...
                        ``ScalingAdjustment`` , which should be expressed as an integer. For
                      ...
                      - **ScalingAdjustment** *(integer) --* **[REQUIRED]**
                        ...
                        ``AdjustmentType`` is set to ``EXACT_CAPACITY`` , the number should only be
                        a positive integer. If ``AdjustmentType`` is set to
    ...
    def add_job_flow_steps(
        ...
        ways, including using SSH to connect to the master node and submitting queries directly to
        the software running on the master node, such as Hive and Hadoop. For more information on
        how to do this, see `Add More than 256 Steps to a Cluster
        <https://docs.aws.amazon.com/emr/latest/ManagementGuide/AddMoreThan256Steps.html>`__ in the
        *Amazon EMR Management Guide* .

        A step specifies the location of a JAR file stored either on the master node of the cluster
        or in Amazon S3. Each step is performed by the main function of the main class of the JAR
        file. The main class can be specified either in the manifest of the JAR or by using the
    ...
    def add_tags(self, ResourceId: str, Tags: List[ClientAddTagsTagsTypeDef]) -> Dict:
        ...
        ways, such as grouping clusters to track your Amazon EMR resource allocation costs. For more
        ...
        **Request Syntax**
        ...
        :param Tags: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            EMR resource. Tags make it easier to associate clusters in various ways, such as
    ...
    def cancel_steps(
        ...
        CancelSteps request. CancelSteps is idempotent but asynchronous; it does not guarantee a
        step will be canceled, even if the request is successfully submitted. You can only cancel
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **CancelStepsInfoList** *(list) --*
              ...
              A list of  CancelStepsInfo , which shows the status of specified cancel requests for
              each ``StepID`` specified.
    ...
    def create_security_configuration(
        ...
        **Request Syntax**
        ...
        :param SecurityConfiguration: **[REQUIRED]**
          ...
          <https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-security-configurations.html>`__
                ...
                'Cluster': {
                    ...
                    'Status': {
                        ...
                        'StateChangeReason': {
                            ...
                            |'INSTANCE_FAILURE'|'INSTANCE_FLEET_TIMEOUT'
            ...
            - **Cluster** *(dict) --*
              ...
              - **Ec2InstanceAttributes** *(dict) --*
                ...
                - **RequestedEc2SubnetIds** *(list) --*
                  ...
                  unique identifier of one or more Amazon EC2 subnets in which to launch EC2 cluster
                  ...
                  then launches all cluster instances within that Subnet. If this value is not
              ...
              - **ReleaseLabel** *(string) --*
                ...
                <https://docs.aws.amazon.com/emr/latest/ReleaseGuide/>`__ . The release label
              ...
              - **VisibleToAllUsers** *(boolean) --*
                ...
                the  SetVisibleToAllUsers action. You can override the default value of ``true``
                when you create a cluster by using the ``VisibleToAllUsers`` parameter of the
                ``RunJobFlow`` action.
              ...
              - **Tags** *(list) --*
                ...
                - *(dict) --*
                  ...
                  such as grouping clusters to track your Amazon EMR resource allocation costs. For
              ...
              - **NormalizedInstanceHours** *(integer) --*
                ...
                expensive would result in the normalized instance hours being incremented by four.
              ...
              - **ScaleDownBehavior** *(string) --*
                ...
                of when the request to terminate the instance was submitted. This option is only
                available with Amazon EMR 5.1.0 and later and is the default for clusters created
                using that version. ``TERMINATE_AT_TASK_COMPLETION`` indicates that Amazon EMR
                ...
                the least active nodes first and blocks instance termination if it could lead to
                HDFS corruption. ``TERMINATE_AT_TASK_COMPLETION`` is available only in Amazon EMR
                version 4.1.0 and later, and is the default for versions of Amazon EMR earlier than
                5.1.0.
              ...
              - **RepoUpgradeOnBoot** *(string) --*
                ...
                applied from the Amazon Linux AMI package repositories when an instance boots using
                the AMI.

              - **KerberosAttributes** *(dict) --*

                Attributes for Kerberos configuration when Kerberos authentication is enabled using
                a security configuration. For more information see `Use Kerberos Authentication
                <https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-kerberos.html>`__ in the
                *EMR Management Guide* .
                ...
                - **KdcAdminPassword** *(string) --*
                  ...
                  cluster-dedicated KDC, which maintains Kerberos principals, password policies, and
                  keytabs for the cluster.

                - **CrossRealmTrustPrincipalPassword** *(string) --*

                  Required only when establishing a cross-realm trust with a KDC in a different
                  realm. The cross-realm principal password, which must be identical across realms.
            ...
            - **JobFlows** *(list) --*
              ...
              - *(dict) --*
                ...
                - **Instances** *(dict) --*
                  ...
                  - **Placement** *(dict) --*
                    ...
                    - **AvailabilityZones** *(list) --*
                      ...
                      used for instance fleets, while ``AvailabilityZone`` (singular) is used for
                ...
                - **SupportedProducts** *(list) --*
                  ...
                  you are not using third party software to manage the job flow this value is empty.
                ...
                - **VisibleToAllUsers** *(boolean) --*
                  ...
                  associated with the cluster. The default value, ``true`` , indicates that all IAM
                  users in the AWS account can perform cluster actions if they have the proper IAM
                  policy permissions. If this value is ``false`` , only the IAM user that created
                  the cluster can perform actions. This value can be changed on a running cluster by
                  using the  SetVisibleToAllUsers action. You can override the default value of
                  ``true`` when you create a cluster by using the ``VisibleToAllUsers`` parameter of
                  the ``RunJobFlow`` action.
                ...
                - **ScaleDownBehavior** *(string) --*
                  ...
                  option is only available with Amazon EMR 5.1.0 and later and is the default for
                  clusters created using that version. ``TERMINATE_AT_TASK_COMPLETION`` indicates
                  that Amazon EMR blacklists and drains tasks from nodes before terminating the
                  Amazon EC2 instances, regardless of the instance-hour boundary. With either
                  behavior, Amazon EMR removes the least active nodes first and blocks instance
          ...
          ::

            {
                'Step': {
                    ...
                    'Status': {
                        'State':
                        'PENDING'|'CANCEL_PENDING'|'RUNNING'|'COMPLETED'|'CANCELLED'
                        |'FAILED'|'INTERRUPTED',
                        'StateChangeReason': {
                            'Code': 'NONE',
                            'Message': 'string'
    ...
    def get_block_public_access_configuration(
        ...
        """
        Returns the Amazon EMR block public access configuration for your AWS account in the current
        Region. For more information see `Configure Block Public Access for Amazon EMR
        <https://docs.aws.amazon.com/emr/latest/ManagementGuide/configure-block-public-access.html>`__
        in the *Amazon EMR Management Guide* .
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **BlockPublicAccessConfiguration** *(dict) --*
              ...
              ``PermittedPublicSecurityGroupRuleRanges`` in the ``BlockPublicAccessConfiguration`` .
              By default, Port 22 (SSH) is an exception, and public access is allowed on this port.
              You can change this by updating the block public access configuration to remove the
              exception.
              ...
              - **PermittedPublicSecurityGroupRuleRanges** *(list) --*
                ...
                in the list of ``PermittedPublicSecurityGroupRuleRanges`` .

                - *(dict) --*

                  A list of port ranges that are permitted to allow inbound traffic from all public
                  IP addresses. To specify a single port, use the same value for ``MinRange`` and
                  ``MaxRange`` .
            ...
            - **BlockPublicAccessConfigurationMetadata** *(dict) --*
              ...
              action as well as the date and time that the configuration was created. Each time a
              configuration for block public access is updated, Amazon EMR updates this metadata.
                ...
                'Clusters': [
                    {
                        ...
                        'Status': {
                            ...
                            'StateChangeReason': {
                                ...
                                'INTERNAL_ERROR'|'VALIDATION_ERROR'
                                |'INSTANCE_FAILURE'|'INSTANCE_FLEET_TIMEOUT'
                                |'BOOTSTRAP_FAILURE'|'USER_REQUEST'
                                |'STEP_FAILURE'|'ALL_STEPS_COMPLETED',
                                'Message': 'string'
                            },
                            'Timeline': {
                                'CreationDateTime': datetime(2015, 1, 1),
              ...
              - *(dict) --*
                ...
                - **Status** *(dict) --*
                  ...
                  - **State** *(string) --*
                    ...
                    * ``PROVISIONING`` —The instance fleet is provisioning EC2 resources and is not
                    yet ready to run jobs.

                    * ``BOOTSTRAPPING`` —EC2 instances and other resources have been provisioned and
                    the bootstrap actions specified for the instances are underway.
                ...
                - **TargetOnDemandCapacity** *(integer) --*
                  ...
                  an overage. For example, if there are 2 units remaining to fulfill capacity, and
                  Amazon EMR can only provision an instance with a ``WeightedCapacity`` of 5 units,
                  the instance is provisioned, and the target capacity is exceeded by 3 units. You
                  can use  InstanceFleet$ProvisionedOnDemandCapacity to determine the Spot capacity
                ...
                - **InstanceTypeSpecifications** *(list) --*
                  ...
                  - *(dict) --*
                    ...
                    - **BidPriceAsPercentageOfOnDemandPrice** *(float) --*
                      ...
                      as defined by ``InstanceType`` . Expressed as a number (for example, 20
                      specifies 20%).
                ...
                - **LaunchSpecifications** *(dict) --*
                  ...
                  - **SpotSpecification** *(dict) --*
                    ...
                    - **TimeoutAction** *(string) --*
                      ...
                      specifies that if no Spot instances are available, On-Demand Instances should
                      be provisioned to fulfill any remaining Spot capacity.
                    ...
                    - **BlockDurationMinutes** *(integer) --*
                      ...
                      applies. Valid values are 60, 120, 180, 240, 300, or 360. The duration period
                      starts as soon as a Spot instance receives its instance ID. At the end of the
                      duration, Amazon EC2 marks the Spot instance for termination and provides a
                      Spot instance termination notice, which gives the instance a two-minute
                ...
                'InstanceGroups': [
                    {
                        ...
                        'Status': {
                            ...
                            |'RECONFIGURING'|'RESIZING'|'SUSPENDED'
                        ...
                        'AutoScalingPolicy': {
                            'Status': {
                                'State':
                                'PENDING'|'ATTACHING'|'ATTACHED'|'DETACHING'
                                |'DETACHED'|'FAILED',
                                'StateChangeReason': {
                            ...
                            'Rules': [
                                {
                                    ...
                                    'Trigger': {
                                        'CloudWatchAlarmDefinition': {
                                            ...
                                            |'PERCENT'|'COUNT'
                                            |'BYTES_PER_SECOND'
                                            |'KILO_BYTES_PER_SECOND'|'MEGA_BYTES_PER_SECOND'|'GIGA_BYTES_PER_SECOND'|'TERA_BYTES_PER_SECOND'|'BITS_PER_SECOND'|'KILO_BITS_PER_SECOND'|'MEGA_BITS_PER_SECOND'|'GIGA_BITS_PER_SECOND'|'TERA_BITS_PER_SECOND'
                                            |'COUNT_PER_SECOND',
                                            'Dimensions': [
                                                {
                                                    'Key': 'string',
                ...
                - **AutoScalingPolicy** *(dict) --*
                  ...
                  - **Constraints** *(dict) --*
                    ...
                    - **MaxCapacity** *(integer) --*
                      ...
                      The upper boundary of EC2 instances in an instance group beyond which scaling
                      activities are not allowed to grow. Scale-out activities will not add
                  ...
                  - **Rules** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      A scale-in or scale-out rule that defines scaling activity, including the
                      CloudWatch metric alarm that triggers activity, how EC2 instances are added or
                      removed, and the periodicity of adjustments. The automatic scaling policy for
                      an instance group can comprise one or more automatic scaling rules.
                      ...
                      - **Action** *(dict) --*
                        ...
                        - **SimpleScalingPolicyConfiguration** *(dict) --*
                          ...
                          - **AdjustmentType** *(string) --*
                            ...
                            increase in 20% increments of cluster capacity. ``EXACT_CAPACITY``
                      ...
                      - **Trigger** *(dict) --*
                        ...
                        - **CloudWatchAlarmDefinition** *(dict) --*
                          ...
                          - **Unit** *(string) --*
                            ...
                            The value specified for ``Unit`` must correspond to the units specified
                          ...
                          - **Dimensions** *(list) --*
                            ...
                            - *(dict) --*
                              ...
                              This enables the rule to bootstrap when the cluster ID becomes
                              available.
                ...
                'Instances': [
                    {
                        ...
                        'Status': {
                            ...
                            |'BOOTSTRAPPING'|'RUNNING'|'TERMINATED',
                            'StateChangeReason': {
                                'Code':
                                'INTERNAL_ERROR'|'VALIDATION_ERROR'
                                |'INSTANCE_FAILURE'|'BOOTSTRAP_FAILURE'
                                |'CLUSTER_TERMINATED',
                                'Message': 'string'
                            },
                            'Timeline': {
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Marker** *(string) --*
              ...
              marker in the next ListSecurityConfiguration call to retrieve the next page of
              results, if required.
    ...
    def list_steps(
        ...
        with the request of filter by ``StepStates`` . You can specify a maximum of ten ``stepIDs``
        .
            ...
            - **Steps** *(list) --*
              ...
              - *(dict) --*
                ...
                - **ActionOnFailure** *(string) --*
                  ...
                  The action to take when the cluster step fails. Possible values are
                  TERMINATE_CLUSTER, CANCEL_AND_WAIT, and CONTINUE. TERMINATE_JOB_FLOW is available
                  ...
                  'Rules': [
                      {
                          ...
                          'Trigger': {
                              'CloudWatchAlarmDefinition': {
                                  ...
                                  'Threshold': 123.0,
                                  'Unit':
                                  'NONE'|'SECONDS'|'MICRO_SECONDS'
                                  |'MILLI_SECONDS'|'BYTES'|'KILO_BYTES'
                                  |'MEGA_BYTES'|'GIGA_BYTES'|'TERA_BYTES'
                                  |'BITS'|'KILO_BITS'|'MEGA_BITS'
                                  |'GIGA_BITS'|'TERA_BITS'|'PERCENT'
                                  |'COUNT'|'BYTES_PER_SECOND'
                                  |'KILO_BYTES_PER_SECOND'
                                  |'MEGA_BYTES_PER_SECOND'
                                  |'GIGA_BYTES_PER_SECOND'
                                  |'TERA_BYTES_PER_SECOND'
                    ...
                    'Rules': [
                        {
                            ...
                            'Trigger': {
                                'CloudWatchAlarmDefinition': {
                                    ...
                                    |'GIGA_BYTES'|'TERA_BYTES'|'BITS'
                                    |'KILO_BITS'|'MEGA_BITS'|'GIGA_BITS'
                                    |'TERA_BITS'|'PERCENT'|'COUNT'
                                    |'BYTES_PER_SECOND'
                                    |'KILO_BYTES_PER_SECOND'
                                    |'MEGA_BYTES_PER_SECOND'
                                    |'GIGA_BYTES_PER_SECOND'
    ...
    def put_block_public_access_configuration(
        ...
        **Request Syntax**
        ...
        :param BlockPublicAccessConfiguration: **[REQUIRED]**
          ...
          change this by updating ``BlockPublicSecurityGroupRules`` to remove the exception.
          ...
          - **BlockPublicSecurityGroupRules** *(boolean) --* **[REQUIRED]**
            ...
            ). By default, the value is ``false`` for accounts that have created EMR clusters before
            July 2019. For accounts created after this, the default is ``true`` .
    ...
    def run_job_flow(
        ...
        , the cluster transitions to the WAITING state rather than shutting down after the steps
        have completed.
        ...
        **Request Syntax**
                              ...
                              'Rules': [
                                  {
                                      ...
                                      'Trigger': {
                                          'CloudWatchAlarmDefinition': {
                                              ...
                                              |'PERCENT'
                                              |'COUNT'
                                              |'BYTES_PER_SECOND'|'KILO_BYTES_PER_SECOND'|'MEGA_BYTES_PER_SECOND'|'GIGA_BYTES_PER_SECOND'|'TERA_BYTES_PER_SECOND'|'BITS_PER_SECOND'|'KILO_BITS_PER_SECOND'|'MEGA_BITS_PER_SECOND'|'GIGA_BITS_PER_SECOND'|'TERA_BITS_PER_SECOND'
                                              |'COUNT_PER_SECOND',
                                              'Dimensions': [
                                                  {
                                                      'Key': 'string',
        ...
        :param Instances: **[REQUIRED]**
                    ...
                    - **Action** *(dict) --* **[REQUIRED]**
                      ...
                      - **SimpleScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
                        ...
                        - **AdjustmentType** *(string) --*
                          ...
                          instances specified by ``ScalingAdjustment`` , which should be expressed
          ...
          - **InstanceFleets** *(list) --*
            ...
            - *(dict) --*
              ...
              - **TargetOnDemandCapacity** *(integer) --*
                ...
                tries to provision On-Demand instances as specified by  InstanceTypeConfig . Each
                ...
                .. note::
                  ...
                  only one of ``TargetSpotCapacity`` and ``TargetOnDemandCapacity`` can be
                  specified, and its value must be 1.
              ...
              - **InstanceTypeConfigs** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **BidPriceAsPercentageOfOnDemandPrice** *(float) --*
                    ...
                    The bid price, as a percentage of On-Demand price, for each EC2 Spot instance as
                    defined by ``InstanceType`` . Expressed as a number (for example, 20 specifies
                    20%). If neither ``BidPrice`` nor ``BidPriceAsPercentageOfOnDemandPrice`` is
                  ...
                  - **Configurations** *(list) --*
                    ...
                    - *(dict) --*
                      ...
                      to change in that file. For more information, see `Configuring Applications
                      <https://docs.aws.amazon.com/emr/latest/ReleaseGuide/emr-configure-apps.html>`__
                      .
          ...
          - **HadoopVersion** *(string) --*
            ...
            cluster. Valid inputs are "0.18" (deprecated), "0.20" (deprecated), "0.20.205"
            (deprecated), "1.0.3", "2.2.0", or "2.4.0". If you do not set this value, the default of
            0.18 is used, unless the ``AmiVersion`` parameter is set in the RunJobFlow call, in
        ...
        :param SupportedProducts:
          ...
          <https://docs.aws.amazon.com/emr/latest/DeveloperGuide/emr-dg.pdf>`__ . Currently
        ...
        :param NewSupportedProducts:
          ...
          <https://docs.aws.amazon.com/emr/latest/DeveloperGuide/emr-dg.pdf>`__ . Supported values
          are:
        ...
        :param Applications:
          ...
          Amazon EMR to install and configure when launching the cluster. For a list of applications
          available for each Amazon EMR release version, see the `Amazon EMR Release Guide
          ...
          - *(dict) --*
            ...
            indicates the software to use with the cluster and accepts a user argument list. Amazon
            EMR accepts and forwards the argument list to the corresponding installation script as
        ...
        :param VisibleToAllUsers:
          ...
          A value of ``true`` indicates that all IAM users in the AWS account can perform cluster
          actions if they have the proper IAM policy permissions. This is the default. A value of
          ``false`` indicates that only the IAM user who created the cluster can perform actions.
        ...
        :param ScaleDownBehavior:
          ...
          version. ``TERMINATE_AT_TASK_COMPLETION`` indicates that Amazon EMR blacklists and drains
          ...
          ``TERMINATE_AT_TASK_COMPLETION`` available only in Amazon EMR version 4.1.0 and later, and
        ...
        :param CustomAmiId:
          ...
          For more information about custom AMIs in Amazon EMR, see `Using a Custom AMI
          <https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-custom-ami.html>`__ in the
          *Amazon EMR Management Guide* . If omitted, the cluster uses the base Linux AMI for the
          ...
          <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/creating-an-ami-ebs.html>`__ in the
          *Amazon Elastic Compute Cloud User Guide for Linux Instances* . For information about
    ...
    def set_termination_protection(self, JobFlowIds: List[str], TerminationProtected: bool) -> None:
        ...
        To terminate a cluster that has been locked by setting ``SetTerminationProtection`` to
        ...
        <https://docs.aws.amazon.com/emr/latest/ManagementGuide/UsingEMR_TerminationProtection.html>`__
        in the *Amazon EMR Management Guide* .
    ...
    def set_visible_to_all_users(self, JobFlowIds: List[str], VisibleToAllUsers: bool) -> None:
        """
        Sets the  Cluster$VisibleToAllUsers value, which determines whether the cluster is visible
        to all IAM users of the AWS account associated with the cluster. Only the IAM user who
        created the cluster or the AWS account root user can call this action. The default value,
        ``true`` , indicates that all IAM users in the AWS account can perform cluster actions if
        they have the proper IAM policy permissions. If set to ``false`` , only the IAM user that
        created the cluster can perform actions. This action works on running clusters. You can
        override the default ``true`` setting when you create a cluster by using the
    ...
    def terminate_job_flows(self, JobFlowIds: List[str]) -> None:
        ...
        any step not yet completed is canceled and the EC2 instances on which the cluster is running
        ...
        asynchronous. Depending on the configuration of the cluster, it may take up to 1-5 minutes
        for the cluster to completely terminate and release allocated resources, such as Amazon EC2
        instances.
