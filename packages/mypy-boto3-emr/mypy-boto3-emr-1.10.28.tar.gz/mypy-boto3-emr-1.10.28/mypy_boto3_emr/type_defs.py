...
class ClientAddInstanceFleetInstanceFleetInstanceTypeConfigsConfigurationsTypeDef(
    ...
    you want to change in that file. For more information, see `Configuring Applications
...
class ClientAddInstanceFleetInstanceFleetInstanceTypeConfigsEbsConfigurationEbsBlockDeviceConfigsVolumeSpecificationTypeDef(
    ...
    """
    Type definition for
    `ClientAddInstanceFleetInstanceFleetInstanceTypeConfigsEbsConfigurationEbsBlockDeviceConfigs`
    `VolumeSpecification`
...
class ClientAddInstanceFleetInstanceFleetInstanceTypeConfigsEbsConfigurationEbsBlockDeviceConfigsTypeDef(
    ...
    """
    Type definition for `ClientAddInstanceFleetInstanceFleetInstanceTypeConfigsEbsConfiguration`
    ...
    - **VolumeSpecification** *(dict) --* **[REQUIRED]**
      ...
      - **SizeInGB** *(integer) --* **[REQUIRED]**
        ...
        The volume size, in gibibytes (GiB). This can be a number from 1 - 1024. If the volume type
        is EBS-optimized, the minimum value is 10.
...
_RequiredClientAddInstanceFleetInstanceFleetInstanceTypeConfigsTypeDef = TypedDict(
    "_RequiredClientAddInstanceFleetInstanceFleetInstanceTypeConfigsTypeDef", {"InstanceType": str}
)
...
class ClientAddInstanceFleetInstanceFleetLaunchSpecificationsSpotSpecificationTypeDef(
    ...
    """
    Type definition for `ClientAddInstanceFleetInstanceFleetLaunchSpecifications`
    `SpotSpecification`
    ...
    - **TimeoutDurationMinutes** *(integer) --* **[REQUIRED]**
      ...
      The spot provisioning timeout period in minutes. If Spot instances are not provisioned within
      this time period, the ``TimeOutAction`` is taken. Minimum value is 5 and maximum value is
      1440. The timeout applies only during initial provisioning, when the cluster is first created.
    ...
    - **BlockDurationMinutes** *(integer) --*
      ...
      defined duration pricing for Spot instances applies. Valid values are 60, 120, 180, 240, 300,
      or 360. The duration period starts as soon as a Spot instance receives its instance ID. At the
      end of the duration, Amazon EC2 marks the Spot instance for termination and provides a Spot
      instance termination notice, which gives the instance a two-minute warning before it
      terminates.
    """
...
class ClientAddInstanceFleetInstanceFleetLaunchSpecificationsTypeDef(
    ...
    - **SpotSpecification** *(dict) --* **[REQUIRED]**
      ...
      - **BlockDurationMinutes** *(integer) --*
        ...
        At the end of the duration, Amazon EC2 marks the Spot instance for termination and provides
        a Spot instance termination notice, which gives the instance a two-minute warning before it
        terminates.
    """
...
class ClientAddInstanceFleetInstanceFleetTypeDef(
    ...
    - **TargetOnDemandCapacity** *(integer) --*
      ...
      provisions instances until the target capacity is totally fulfilled, even if this results in
      an overage. For example, if there are 2 units remaining to fulfill capacity, and Amazon EMR
    ...
    - **InstanceTypeConfigs** *(list) --*
      ...
      - *(dict) --*
        ...
        - **BidPriceAsPercentageOfOnDemandPrice** *(float) --*
          ...
          by ``InstanceType`` . Expressed as a number (for example, 20 specifies 20%). If neither
          ``BidPrice`` nor ``BidPriceAsPercentageOfOnDemandPrice`` is provided,
          ``BidPriceAsPercentageOfOnDemandPrice`` defaults to 100%.
...
class ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesActionSimpleScalingPolicyConfigurationTypeDef(
    ...
    """
    Type definition for `ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesAction`
    ...
    - **AdjustmentType** *(string) --*
      ...
      triggered. ``CHANGE_IN_CAPACITY`` is the default. ``CHANGE_IN_CAPACITY`` indicates that the
      EC2 instance count increments or decrements by ``ScalingAdjustment`` , which should be
      expressed as an integer. ``PERCENT_CHANGE_IN_CAPACITY`` indicates the instance count
      increments or decrements by the percentage specified by ``ScalingAdjustment`` , which should
      be expressed as an integer. For example, 20 indicates an increase in 20% increments of cluster
      capacity. ``EXACT_CAPACITY`` indicates the scaling activity results in an instance group with
      the number of EC2 instances specified by ``ScalingAdjustment`` , which should be expressed as
      a positive integer.
    ...
    - **ScalingAdjustment** *(integer) --* **[REQUIRED]**
      ...
      instances. If ``AdjustmentType`` is set to ``EXACT_CAPACITY`` , the number should only be a
      positive integer. If ``AdjustmentType`` is set to ``PERCENT_CHANGE_IN_CAPACITY`` , the value
...
class ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesActionTypeDef(
    ...
    - **SimpleScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
      ...
      - **AdjustmentType** *(string) --*
        ...
        expressed as an integer. ``PERCENT_CHANGE_IN_CAPACITY`` indicates the instance count
        increments or decrements by the percentage specified by ``ScalingAdjustment`` , which should
        be expressed as an integer. For example, 20 indicates an increase in 20% increments of
        cluster capacity. ``EXACT_CAPACITY`` indicates the scaling activity results in an instance
        group with the number of EC2 instances specified by ``ScalingAdjustment`` , which should be
        expressed as a positive integer.

      - **ScalingAdjustment** *(integer) --* **[REQUIRED]**

        The amount by which to scale in or scale out, based on the specified ``AdjustmentType`` . A
        positive value adds to the instance group's EC2 instance count while a negative number
        removes instances. If ``AdjustmentType`` is set to ``EXACT_CAPACITY`` , the number should
        only be a positive integer. If ``AdjustmentType`` is set to ``PERCENT_CHANGE_IN_CAPACITY`` ,
        the value should express the percentage as an integer. For example, -20 indicates a decrease
...
class ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinition`
    `Dimensions`
    ...
    ``Value`` is a variable representing the cluster ID, which is ``${emr.clusterId}`` . This
...
class ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionTypeDef(
    ...
    """
    Type definition for `ClientAddInstanceGroupsInstanceGroupsAutoScalingPolicyRulesTrigger`
    `CloudWatchAlarmDefinition`

    The definition of a CloudWatch metric alarm. When the defined alarm conditions are met along
    with other trigger parameters, scaling activity begins.
    ...
    - **Period** *(integer) --* **[REQUIRED]**
      ...
      emitted every five minutes (300 seconds), so if an EMR CloudWatch metric is specified, specify
      ``300`` .
    ...
    - **Unit** *(string) --*
      ...
      The unit of measure associated with the CloudWatch metric being watched. The value specified
      for ``Unit`` must correspond to the units specified in the CloudWatch metric.
    ...
    - **Action** *(dict) --* **[REQUIRED]**
      ...
      - **SimpleScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
        ...
        - **AdjustmentType** *(string) --*
          ...
          The way in which EC2 instances are added (if ``ScalingAdjustment`` is a positive number)
          or terminated (if ``ScalingAdjustment`` is a negative number) each time the scaling
          ...
          which should be expressed as an integer. ``PERCENT_CHANGE_IN_CAPACITY`` indicates the
          instance count increments or decrements by the percentage specified by
          ``ScalingAdjustment`` , which should be expressed as an integer. For example, 20 indicates
          an increase in 20% increments of cluster capacity. ``EXACT_CAPACITY`` indicates the
          scaling activity results in an instance group with the number of EC2 instances specified
          by ``ScalingAdjustment`` , which should be expressed as a positive integer.

        - **ScalingAdjustment** *(integer) --* **[REQUIRED]**

          The amount by which to scale in or scale out, based on the specified ``AdjustmentType`` .
          A positive value adds to the instance group's EC2 instance count while a negative number
          removes instances. If ``AdjustmentType`` is set to ``EXACT_CAPACITY`` , the number should
          only be a positive integer. If ``AdjustmentType`` is set to ``PERCENT_CHANGE_IN_CAPACITY``
          , the value should express the percentage as an integer. For example, -20 indicates a
    ...
    - **Trigger** *(dict) --* **[REQUIRED]**
      ...
      - **CloudWatchAlarmDefinition** *(dict) --* **[REQUIRED]**
        ...
        - **ComparisonOperator** *(string) --* **[REQUIRED]**
          ...
          Determines how the metric specified by ``MetricName`` is compared to the value specified
          by ``Threshold`` .
        ...
        - **Action** *(dict) --* **[REQUIRED]**
          ...
          - **SimpleScalingPolicyConfiguration** *(dict) --* **[REQUIRED]**
            ...
            - **AdjustmentType** *(string) --*
              ...
              by the percentage specified by ``ScalingAdjustment`` , which should be expressed as an
              integer. For example, 20 indicates an increase in 20% increments of cluster capacity.
              ``EXACT_CAPACITY`` indicates the scaling activity results in an instance group with
              the number of EC2 instances specified by ``ScalingAdjustment`` , which should be
              expressed as a positive integer.
            ...
            - **ScalingAdjustment** *(integer) --* **[REQUIRED]**
              ...
              the percentage as an integer. For example, -20 indicates a decrease in 20% increments
              of cluster capacity.
        ...
        - **Trigger** *(dict) --* **[REQUIRED]**
          ...
          - **CloudWatchAlarmDefinition** *(dict) --* **[REQUIRED]**
            ...
            - **EvaluationPeriods** *(integer) --*
              ...
              must exist before the alarm triggers automatic scaling activity. The default value is
              ``1`` .
...
class ClientAddInstanceGroupsInstanceGroupsEbsConfigurationEbsBlockDeviceConfigsVolumeSpecificationTypeDef(
    ...
    """
    Type definition for `ClientAddInstanceGroupsInstanceGroupsEbsConfigurationEbsBlockDeviceConfigs`
    `VolumeSpecification`
...
class ClientAddInstanceGroupsInstanceGroupsEbsConfigurationEbsBlockDeviceConfigsTypeDef(
    ...
    """
    Type definition for `ClientAddInstanceGroupsInstanceGroupsEbsConfiguration`
    `EbsBlockDeviceConfigs`
...
class ClientAddJobFlowStepsStepsHadoopJarStepTypeDef(
    ...
    - **MainClass** *(string) --*
      ...
      The name of the main class in the specified Java file. If not specified, the JAR file should
...
class ClientCancelStepsResponseCancelStepsInfoListTypeDef(
    ...
    Specification of the status of a CancelSteps request. Available only in Amazon EMR version 4.8.0
    and later, excluding version 5.0.0.
...
class ClientDescribeClusterResponseClusterApplicationsTypeDef(
    ...
    With earlier Amazon EMR releases, the application is any Amazon or third-party software that you
    can add to the cluster. This structure contains a list of strings that indicates the software to
    use with the cluster and accepts a user argument list. Amazon EMR accepts and forwards the
...
class ClientDescribeClusterResponseClusterEc2InstanceAttributesTypeDef(
    ...
    Provides information about the EC2 instances in a cluster grouped by category. For example, key
    name, subnet ID, IAM instance profile, and so on.

    - **Ec2KeyName** *(string) --*

      The name of the Amazon EC2 key pair to use when connecting with SSH into the master node as a
      user named "hadoop".

    - **Ec2SubnetId** *(string) --*

      Set this parameter to the identifier of the Amazon VPC subnet where you want the cluster to
      launch. If you do not specify this value, and your account supports EC2-Classic, the cluster
    ...
    - **RequestedEc2SubnetIds** *(list) --*
      ...
      identifier of one or more Amazon EC2 subnets in which to launch EC2 cluster instances. Subnets
      must exist within the same VPC. Amazon EMR chooses the EC2 subnet with the best fit from among
      the list of ``RequestedEc2SubnetIds`` , and then launches all cluster instances within that
      ...
      ``RequestedEc2AvailabilityZones`` instead of this setting. If EC2-Classic is not supported,
      and no Subnet is specified, Amazon EMR chooses the subnet for you. ``RequestedEc2SubnetIDs``
      and ``RequestedEc2AvailabilityZones`` cannot be specified together.
    ...
    - **RequestedEc2AvailabilityZones** *(list) --*
      ...
      among the list of ``RequestedEc2AvailabilityZones`` , and then launches all cluster instances
      within that Availability Zone. If you do not specify this value, Amazon EMR chooses the
      Availability Zone for you. ``RequestedEc2SubnetIDs`` and ``RequestedEc2AvailabilityZones``
...
class ClientDescribeClusterResponseClusterTypeDef(_ClientDescribeClusterResponseClusterTypeDef):
    ...
    - **Ec2InstanceAttributes** *(dict) --*
      ...
      - **RequestedEc2SubnetIds** *(list) --*
        ...
        from among the list of ``RequestedEc2SubnetIds`` , and then launches all cluster instances
        within that Subnet. If this value is not specified, and the account and Region support
        EC2-Classic networks, the cluster launches instances in the EC2-Classic network and uses
        ``RequestedEc2AvailabilityZones`` instead of this setting. If EC2-Classic is not supported,
        and no Subnet is specified, Amazon EMR chooses the subnet for you. ``RequestedEc2SubnetIDs``
        and ``RequestedEc2AvailabilityZones`` cannot be specified together.
    ...
    - **ReleaseLabel** *(string) --*
      ...
      installed on the cluster. Release labels are in the form ``emr-x.x.x`` , where x.x.x is an
      Amazon EMR release version such as ``emr-5.14.0`` . For more information about Amazon EMR
    ...
    - **VisibleToAllUsers** *(boolean) --*
      ...
      the cluster. The default value, ``true`` , indicates that all IAM users in the AWS account can
      perform cluster actions if they have the proper IAM policy permissions. If this value is
      ``false`` , only the IAM user that created the cluster can perform actions. This value can be
      changed on a running cluster by using the  SetVisibleToAllUsers action. You can override the
      default value of ``true`` when you create a cluster by using the ``VisibleToAllUsers``
    ...
    - **Tags** *(list) --*
      ...
      - *(dict) --*
        ...
        clusters to track your Amazon EMR resource allocation costs. For more information, see `Tag
    ...
    - **NormalizedInstanceHours** *(integer) --*
      ...
      incremented one time for every hour an m1.small instance runs. Larger instances are weighted
      more, so an EC2 instance that is roughly four times more expensive would result in the
      normalized instance hours being incremented by four. This result is only an approximation and
    ...
    - **Configurations** *(list) --*
      ...
      Applies only to Amazon EMR releases 4.x and later. The list of Configurations supplied to the
      EMR cluster.
    ...
    - **ScaleDownBehavior** *(string) --*
      ...
      occurs or an instance group is resized. ``TERMINATE_AT_INSTANCE_HOUR`` indicates that Amazon
      EMR terminates nodes at the instance-hour boundary, regardless of when the request to
      ...
      termination if it could lead to HDFS corruption. ``TERMINATE_AT_TASK_COMPLETION`` is available
    ...
    - **RepoUpgradeOnBoot** *(string) --*
      ...
      Applies only when ``CustomAmiID`` is used. Specifies the type of updates that are applied from
...
class ClientDescribeClusterResponseTypeDef(_ClientDescribeClusterResponseTypeDef):
    ...
    - **Cluster** *(dict) --*
      ...
      - **VisibleToAllUsers** *(boolean) --*
        ...
        Indicates whether the cluster is visible to all IAM users of the AWS account associated with
        the cluster. The default value, ``true`` , indicates that all IAM users in the AWS account
        can perform cluster actions if they have the proper IAM policy permissions. If this value is
        ``false`` , only the IAM user that created the cluster can perform actions. This value can
        be changed on a running cluster by using the  SetVisibleToAllUsers action. You can override
      ...
      - **ScaleDownBehavior** *(string) --*
        ...
        occurs or an instance group is resized. ``TERMINATE_AT_INSTANCE_HOUR`` indicates that Amazon
        EMR terminates nodes at the instance-hour boundary, regardless of when the request to
        terminate the instance was submitted. This option is only available with Amazon EMR 5.1.0
        and later and is the default for clusters created using that version.
        ``TERMINATE_AT_TASK_COMPLETION`` indicates that Amazon EMR blacklists and drains tasks from
        nodes before terminating the Amazon EC2 instances, regardless of the instance-hour boundary.
        With either behavior, Amazon EMR removes the least active nodes first and blocks instance
        termination if it could lead to HDFS corruption. ``TERMINATE_AT_TASK_COMPLETION`` is
        available only in Amazon EMR version 4.1.0 and later, and is the default for versions of
...
class ClientDescribeJobFlowsResponseJobFlowsBootstrapActionsBootstrapActionConfigScriptBootstrapActionTypeDef(
    ...
    """
    Type definition for
    `ClientDescribeJobFlowsResponseJobFlowsBootstrapActionsBootstrapActionConfig`
    ...
    - **Path** *(string) --*
      ...
      Location of the script to run during a bootstrap action. Can be either a location in Amazon S3
      or on a local file system.
...
class ClientDescribeJobFlowsResponseJobFlowsBootstrapActionsBootstrapActionConfigTypeDef(
    ...
    """
    Type definition for `ClientDescribeJobFlowsResponseJobFlowsBootstrapActions`
...
class ClientDescribeJobFlowsResponseJobFlowsInstancesPlacementTypeDef(
    ...
    - **AvailabilityZones** *(list) --*
      ...
      instances in the optimal Availability Zone. ``AvailabilityZones`` is used for instance fleets,
      while ``AvailabilityZone`` (singular) is used for uniform instance groups.
...
class ClientDescribeJobFlowsResponseJobFlowsInstancesTypeDef(
    ...
    - **InstanceCount** *(integer) --*
      ...
      The number of Amazon EC2 instances in the cluster. If the value is 1, the same instance serves
      as both the master and core and task node. If the value is greater than 1, one instance is the
    ...
    - **NormalizedInstanceHours** *(integer) --*
      ...
      An approximation of the cost of the cluster, represented in m1.small/hours. This value is
      incremented one time for every hour that an m1.small runs. Larger instances are weighted more,
      so an Amazon EC2 instance that is roughly four times more expensive would result in the
      normalized instance hours being incremented by four. This result is only an approximation and
      does not reflect the actual billing rate.
    ...
    - **TerminationProtected** *(boolean) --*
      ...
      Specifies whether the Amazon EC2 instances in the cluster are protected from termination by
      API calls, user intervention, or in the event of a job-flow error.
...
class ClientDescribeJobFlowsResponseJobFlowsStepsStepConfigHadoopJarStepPropertiesTypeDef(
    ...
    """
    Type definition for `ClientDescribeJobFlowsResponseJobFlowsStepsStepConfigHadoopJarStep`
    `Properties`
...
class ClientDescribeJobFlowsResponseJobFlowsTypeDef(_ClientDescribeJobFlowsResponseJobFlowsTypeDef):
    ...
    - **Instances** *(dict) --*
      ...
      - **NormalizedInstanceHours** *(integer) --*
        ...
        An approximation of the cost of the cluster, represented in m1.small/hours. This value is
        incremented one time for every hour that an m1.small runs. Larger instances are weighted
        more, so an Amazon EC2 instance that is roughly four times more expensive would result in
    ...
    - **SupportedProducts** *(list) --*
      ...
      A list of strings set by third party software when the job flow is launched. If you are not
      using third party software to manage the job flow this value is empty.
    ...
    - **JobFlowRole** *(string) --*
      ...
      The IAM role that was specified when the job flow was launched. The EC2 instances of the job
    ...
    - **AutoScalingRole** *(string) --*
      ...
      feature to get the required permissions it needs to launch and terminate EC2 instances in an
      instance group.
...
class ClientDescribeStepResponseStepStatusFailureDetailsTypeDef(
    ...
    The details for the step failure including reason, message, and log file path where the root
    cause was identified.

    - **Reason** *(string) --*

      The reason for the step failure. In the case where the service cannot successfully determine
      the root cause of the failure, it returns "Unknown Error" as a reason.

    - **Message** *(string) --*

      The descriptive message including the error the EMR service has identified as the cause of
...
class ClientDescribeStepResponseStepStatusStateChangeReasonTypeDef(
    ...
    - **Code** *(string) --*
      ...
      The programmable code for the state change reason. Note: Currently, the service provides no
...
class ClientGetBlockPublicAccessConfigurationResponseBlockPublicAccessConfigurationMetadataTypeDef(
    ...
    """
    Type definition for `ClientGetBlockPublicAccessConfigurationResponse`
    `BlockPublicAccessConfigurationMetadata`

    Properties that describe the AWS principal that created the ``BlockPublicAccessConfiguration``
    using the ``PutBlockPublicAccessConfiguration`` action as well as the date and time that the
    configuration was created. Each time a configuration for block public access is updated, Amazon
    EMR updates this metadata.
...
class ClientGetBlockPublicAccessConfigurationResponseBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangesTypeDef(
    ...
    """
    Type definition for
    `ClientGetBlockPublicAccessConfigurationResponseBlockPublicAccessConfiguration`
...
class ClientGetBlockPublicAccessConfigurationResponseBlockPublicAccessConfigurationTypeDef(
    ...
    access is allowed on this port. You can change this by updating the block public access
...
class ClientGetBlockPublicAccessConfigurationResponseTypeDef(
    ...
    - **BlockPublicAccessConfiguration** *(dict) --*
      ...
      - **PermittedPublicSecurityGroupRuleRanges** *(list) --*
        ...
        security group associated with the cluster has a rule that allows inbound traffic on Port 23
        from IPv4 0.0.0.0/0 or IPv6 port ::/0 as the source.
    ...
    - **BlockPublicAccessConfigurationMetadata** *(dict) --*
      ...
      Properties that describe the AWS principal that created the ``BlockPublicAccessConfiguration``
      using the ``PutBlockPublicAccessConfiguration`` action as well as the date and time that the
      configuration was created. Each time a configuration for block public access is updated,
...
class ClientListInstanceFleetsResponseInstanceFleetsInstanceTypeSpecificationsConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientListInstanceFleetsResponseInstanceFleetsInstanceTypeSpecifications`
    `Configurations`
...
class ClientListInstanceFleetsResponseInstanceFleetsInstanceTypeSpecificationsEbsBlockDevicesVolumeSpecificationTypeDef(
    ...
    """
    Type definition for
    `ClientListInstanceFleetsResponseInstanceFleetsInstanceTypeSpecificationsEbsBlockDevices`
    `VolumeSpecification`
...
class ClientListInstanceFleetsResponseInstanceFleetsInstanceTypeSpecificationsTypeDef(
    ...
    """
    Type definition for `ClientListInstanceFleetsResponseInstanceFleets`
    ...
    - **WeightedCapacity** *(integer) --*
      ...
      The number of units that a provisioned instance of this type provides toward fulfilling the
      target capacities defined in  InstanceFleetConfig . Capacity values represent performance
...
class ClientListInstanceFleetsResponseInstanceFleetsLaunchSpecificationsSpotSpecificationTypeDef(
    ...
    """
    Type definition for `ClientListInstanceFleetsResponseInstanceFleetsLaunchSpecifications`
    `SpotSpecification`
...
class ClientListInstanceFleetsResponseInstanceFleetsStatusTypeDef(
    ...
    - **State** *(string) --*
      ...
      * ``PROVISIONING`` —The instance fleet is provisioning EC2 resources and is not yet ready to
      run jobs.

      * ``BOOTSTRAPPING`` —EC2 instances and other resources have been provisioned and the bootstrap
      actions specified for the instances are underway.

      * ``RUNNING`` —EC2 instances and other resources are running. They are either executing jobs
      or waiting to execute jobs.

      * ``RESIZING`` —A resize operation is underway. EC2 instances are either being added or
      removed.

      * ``SUSPENDED`` —A resize operation could not complete. Existing EC2 instances are running,
      but instances can't be added or removed.

      * ``TERMINATING`` —The instance fleet is terminating EC2 instances.

      * ``TERMINATED`` —The instance fleet is no longer active, and all EC2 instances have been
      terminated.
    ...
    - **Timeline** *(dict) --*
      ...
      Provides historical timestamps for the instance fleet, including the time of creation, the
      time it became ready to run jobs, and the time of termination.
...
class ClientListInstanceFleetsResponseInstanceFleetsTypeDef(
    ...
    Describes an instance fleet, which is a group of EC2 instances that host a particular node type
    (master, core, or task) in an Amazon EMR cluster. Instance fleets can consist of a mix of
    ...
    - **TargetSpotCapacity** *(integer) --*
      ...
      remaining to fulfill capacity, and Amazon EMR can only provision an instance with a
      ``WeightedCapacity`` of 5 units, the instance is provisioned, and the target capacity is
      exceeded by 3 units. You can use  InstanceFleet$ProvisionedSpotCapacity to determine the Spot
    ...
    - **InstanceTypeSpecifications** *(list) --*
      ...
      The specification for the instance types that comprise an instance fleet. Up to five unique
      instance specifications may be defined for each instance fleet.
        ...
        - **InstanceTypeSpecifications** *(list) --*
          ...
          - *(dict) --*
            ...
            - **WeightedCapacity** *(integer) --*
              ...
              represent performance characteristics such as vCPUs, memory, or I/O. If not specified,
...
class ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyConstraintsTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicy`
    `Constraints`
...
class ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesActionSimpleScalingPolicyConfigurationTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesAction`
    `SimpleScalingPolicyConfiguration`
...
class ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesActionTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRules`
    `Action`
...
class ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinition`
    `Dimensions`
...
class ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionTypeDef(
    ...
    """
    Type definition for
    `ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyRulesTrigger`
    `CloudWatchAlarmDefinition`
...
class ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyStatusStateChangeReasonTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroupsAutoScalingPolicyStatus`
    `StateChangeReason`
    ...
    - **Code** *(string) --*
      ...
      change was because the policy failed to provision. ``CLEANUP_FAILURE`` indicates an error.
    ...
    - **Status** *(dict) --*
      ...
      - **StateChangeReason** *(dict) --*
        ...
        - **Code** *(string) --*
          ...
          the scaling policy status was changed by a user. ``PROVISION_FAILURE`` indicates that the
...
class ClientListInstanceGroupsResponseInstanceGroupsEbsBlockDevicesVolumeSpecificationTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroupsEbsBlockDevices`
    `VolumeSpecification`
...
class ClientListInstanceGroupsResponseInstanceGroupsLastSuccessfullyAppliedConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroups`
...
class ClientListInstanceGroupsResponseInstanceGroupsShrinkPolicyInstanceResizePolicyTypeDef(
    ...
    """
    Type definition for `ClientListInstanceGroupsResponseInstanceGroupsShrinkPolicy`
              ...
              - **Action** *(dict) --*
                ...
                - **SimpleScalingPolicyConfiguration** *(dict) --*
                  ...
                  - **AdjustmentType** *(string) --*
                    ...
                    be expressed as an integer. For example, 20 indicates an increase in 20%
                    increments of cluster capacity. ``EXACT_CAPACITY`` indicates the scaling
                    activity results in an instance group with the number of EC2 instances specified
                    by ``ScalingAdjustment`` , which should be expressed as a positive integer.
...
class ClientListStepsResponseStepsTypeDef(_ClientListStepsResponseStepsTypeDef):
    ...
    - **ActionOnFailure** *(string) --*
      ...
      The action to take when the cluster step fails. Possible values are TERMINATE_CLUSTER,
      CANCEL_AND_WAIT, and CONTINUE. TERMINATE_JOB_FLOW is available for backward compatibility. We
      recommend using TERMINATE_CLUSTER instead.
...
class ClientModifyInstanceGroupsInstanceGroupsShrinkPolicyInstanceResizePolicyTypeDef(
    ...
    """
    Type definition for `ClientModifyInstanceGroupsInstanceGroupsShrinkPolicy`
    `InstanceResizePolicy`
...
class ClientPutAutoScalingPolicyAutoScalingPolicyRulesActionSimpleScalingPolicyConfigurationTypeDef(
    ...
    """
    Type definition for `ClientPutAutoScalingPolicyAutoScalingPolicyRulesAction`
    `SimpleScalingPolicyConfiguration`
...
class ClientPutAutoScalingPolicyAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientPutAutoScalingPolicyAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinition` `Dimensions`
...
class ClientPutAutoScalingPolicyAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionTypeDef(
    ...
    """
    Type definition for `ClientPutAutoScalingPolicyAutoScalingPolicyRulesTrigger`
    `CloudWatchAlarmDefinition`
...
class ClientPutAutoScalingPolicyResponseAutoScalingPolicyRulesActionSimpleScalingPolicyConfigurationTypeDef(
    ...
    """
    Type definition for `ClientPutAutoScalingPolicyResponseAutoScalingPolicyRulesAction`
    `SimpleScalingPolicyConfiguration`
...
class ClientPutAutoScalingPolicyResponseAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientPutAutoScalingPolicyResponseAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinition`
    `Dimensions`
...
class ClientPutAutoScalingPolicyResponseAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionTypeDef(
    ...
    """
    Type definition for `ClientPutAutoScalingPolicyResponseAutoScalingPolicyRulesTrigger`
    `CloudWatchAlarmDefinition`
...
class ClientPutAutoScalingPolicyResponseAutoScalingPolicyStatusStateChangeReasonTypeDef(
    ...
    """
    Type definition for `ClientPutAutoScalingPolicyResponseAutoScalingPolicyStatus`
    `StateChangeReason`
...
class ClientPutBlockPublicAccessConfigurationBlockPublicAccessConfigurationPermittedPublicSecurityGroupRuleRangesTypeDef(
    ...
    """
    Type definition for `ClientPutBlockPublicAccessConfigurationBlockPublicAccessConfiguration`
    `PermittedPublicSecurityGroupRuleRanges`
...
_RequiredClientRunJobFlowBootstrapActionsScriptBootstrapActionTypeDef = TypedDict(
    "_RequiredClientRunJobFlowBootstrapActionsScriptBootstrapActionTypeDef", {"Path": str}
)
...
class ClientRunJobFlowInstancesInstanceFleetsInstanceTypeConfigsConfigurationsTypeDef(
    ...
    """
    Type definition for `ClientRunJobFlowInstancesInstanceFleetsInstanceTypeConfigs`
    `Configurations`
...
class ClientRunJobFlowInstancesInstanceFleetsInstanceTypeConfigsEbsConfigurationEbsBlockDeviceConfigsVolumeSpecificationTypeDef(
    ...
    """
    Type definition for
    `ClientRunJobFlowInstancesInstanceFleetsInstanceTypeConfigsEbsConfigurationEbsBlockDeviceConfigs`
    `VolumeSpecification`
...
class ClientRunJobFlowInstancesInstanceFleetsInstanceTypeConfigsEbsConfigurationEbsBlockDeviceConfigsTypeDef(
    ...
    """
    Type definition for `ClientRunJobFlowInstancesInstanceFleetsInstanceTypeConfigsEbsConfiguration`
    `EbsBlockDeviceConfigs`
...
class ClientRunJobFlowInstancesInstanceFleetsLaunchSpecificationsSpotSpecificationTypeDef(
    ...
    """
    Type definition for `ClientRunJobFlowInstancesInstanceFleetsLaunchSpecifications`
    `SpotSpecification`
...
_RequiredClientRunJobFlowInstancesInstanceFleetsTypeDef = TypedDict(
    "_RequiredClientRunJobFlowInstancesInstanceFleetsTypeDef", {"InstanceFleetType": str}
)
...
class ClientRunJobFlowInstancesInstanceGroupsAutoScalingPolicyRulesActionSimpleScalingPolicyConfigurationTypeDef(
    ...
    """
    Type definition for `ClientRunJobFlowInstancesInstanceGroupsAutoScalingPolicyRulesAction`
    `SimpleScalingPolicyConfiguration`
...
class ClientRunJobFlowInstancesInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionDimensionsTypeDef(
    ...
    """
    Type definition for
    `ClientRunJobFlowInstancesInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinition`
    `Dimensions`
...
class ClientRunJobFlowInstancesInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionTypeDef(
    ...
    """
    Type definition for `ClientRunJobFlowInstancesInstanceGroupsAutoScalingPolicyRulesTrigger`
    `CloudWatchAlarmDefinition`
...
class ClientRunJobFlowInstancesInstanceGroupsEbsConfigurationEbsBlockDeviceConfigsVolumeSpecificationTypeDef(
    ...
    """
    Type definition for
    `ClientRunJobFlowInstancesInstanceGroupsEbsConfigurationEbsBlockDeviceConfigs`
    `VolumeSpecification`
...
class ClientRunJobFlowInstancesInstanceGroupsEbsConfigurationEbsBlockDeviceConfigsTypeDef(
    ...
    """
    Type definition for `ClientRunJobFlowInstancesInstanceGroupsEbsConfiguration`
    `EbsBlockDeviceConfigs`
...
class ClientRunJobFlowInstancesTypeDef(_ClientRunJobFlowInstancesTypeDef):
        ...
        - **InstanceTypeConfigs** *(list) --*
          ...
          - *(dict) --*
            ...
            - **WeightedCapacity** *(integer) --*
              ...
              The number of units that a provisioned instance of this type provides toward
              fulfilling the target capacities defined in  InstanceFleetConfig . This value is 1 for
    ...
    - **HadoopVersion** *(string) --*
      ...
      "1.0.3", "2.2.0", or "2.4.0". If you do not set this value, the default of 0.18 is used,
      unless the ``AmiVersion`` parameter is set in the RunJobFlow call, in which case the default
      version of Hadoop for that AMI version is used.

    - **Ec2SubnetId** *(string) --*

      Applies to clusters that use the uniform instance group configuration. To launch the cluster
      in Amazon Virtual Private Cloud (Amazon VPC), set this parameter to the identifier of the
      Amazon VPC subnet where you want the cluster to launch. If you do not specify this value and
      your account supports EC2-Classic, the cluster launches in EC2-Classic.

    - **Ec2SubnetIds** *(list) --*

      Applies to clusters that use the instance fleet configuration. When multiple EC2 subnet IDs
      are specified, Amazon EMR evaluates them and launches instances in the optimal subnet.
...
_RequiredClientRunJobFlowKerberosAttributesTypeDef = TypedDict(
    "_RequiredClientRunJobFlowKerberosAttributesTypeDef", {"Realm": str, "KdcAdminPassword": str}
)
...
class ListInstanceFleetsPaginateResponseInstanceFleetsInstanceTypeSpecificationsConfigurationsTypeDef(
    ...
    """
    Type definition for `ListInstanceFleetsPaginateResponseInstanceFleetsInstanceTypeSpecifications`
    `Configurations`
...
class ListInstanceFleetsPaginateResponseInstanceFleetsInstanceTypeSpecificationsEbsBlockDevicesVolumeSpecificationTypeDef(
    ...
    """
    Type definition for
    `ListInstanceFleetsPaginateResponseInstanceFleetsInstanceTypeSpecificationsEbsBlockDevices`
    `VolumeSpecification`
...
class ListInstanceFleetsPaginateResponseInstanceFleetsInstanceTypeSpecificationsTypeDef(
    ...
    """
    Type definition for `ListInstanceFleetsPaginateResponseInstanceFleets`
    `InstanceTypeSpecifications`
...
class ListInstanceFleetsPaginateResponseInstanceFleetsLaunchSpecificationsSpotSpecificationTypeDef(
    ...
    """
    Type definition for `ListInstanceFleetsPaginateResponseInstanceFleetsLaunchSpecifications`
    `SpotSpecification`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyConstraintsTypeDef(
    ...
    """
    Type definition for `ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicy`
    `Constraints`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesActionSimpleScalingPolicyConfigurationTypeDef(
    ...
    """
    Type definition for
    `ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesAction`
    `SimpleScalingPolicyConfiguration`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesActionTypeDef(
    ...
    """
    Type definition for `ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRules`
    `Action`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionDimensionsTypeDef(
    ...
    """
    Type definition for
    `ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinition`
    `Dimensions`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesTriggerCloudWatchAlarmDefinitionTypeDef(
    ...
    """
    Type definition for
    `ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyRulesTrigger`
    `CloudWatchAlarmDefinition`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyStatusStateChangeReasonTypeDef(
    ...
    """
    Type definition for `ListInstanceGroupsPaginateResponseInstanceGroupsAutoScalingPolicyStatus`
    `StateChangeReason`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsEbsBlockDevicesVolumeSpecificationTypeDef(
    ...
    """
    Type definition for `ListInstanceGroupsPaginateResponseInstanceGroupsEbsBlockDevices`
    `VolumeSpecification`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsLastSuccessfullyAppliedConfigurationsTypeDef(
    ...
    """
    Type definition for `ListInstanceGroupsPaginateResponseInstanceGroups`
    `LastSuccessfullyAppliedConfigurations`
...
class ListInstanceGroupsPaginateResponseInstanceGroupsShrinkPolicyInstanceResizePolicyTypeDef(
    ...
    """
    Type definition for `ListInstanceGroupsPaginateResponseInstanceGroupsShrinkPolicy`
    `InstanceResizePolicy`
