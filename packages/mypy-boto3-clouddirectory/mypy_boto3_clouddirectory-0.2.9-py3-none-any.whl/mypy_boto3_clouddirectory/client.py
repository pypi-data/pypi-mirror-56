"Main interface for clouddirectory Client"
...
class Client(BaseClient):
    ...
    def add_facet_to_object(
        self,
        DirectoryArn: str,
        SchemaFacet: ClientAddFacetToObjectSchemaFacetTypeDef,
        ObjectReference: ClientAddFacetToObjectObjectReferenceTypeDef,
        ObjectAttributeList: List[ClientAddFacetToObjectObjectAttributeListTypeDef] = None,
    ) -> Dict[str, Any]:
        """
        Adds a new  Facet to an object. An object can have more than one facet applied on it.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/AddFacetToObject>`_
    ...
    def apply_schema(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/ApplySchema>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AppliedSchemaArn** *(string) --*
              ...
              You can use this ARN to describe the schema information applied on this directory. For
    ...
    def attach_object(
        self,
        DirectoryArn: str,
        ParentReference: ClientAttachObjectParentReferenceTypeDef,
        ChildReference: ClientAttachObjectChildReferenceTypeDef,
        LinkName: str,
    ) -> ClientAttachObjectResponseTypeDef:
        """
        ...
        * Using ``ObjectIdentifier``
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/AttachObject>`_
    ...
    def attach_policy(
        self,
        DirectoryArn: str,
        PolicyReference: ClientAttachPolicyPolicyReferenceTypeDef,
        ObjectReference: ClientAttachPolicyObjectReferenceTypeDef,
    ) -> Dict[str, Any]:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/AttachPolicy>`_
    ...
    def attach_to_index(
        self,
        DirectoryArn: str,
        IndexReference: ClientAttachToIndexIndexReferenceTypeDef,
        TargetReference: ClientAttachToIndexTargetReferenceTypeDef,
    ) -> ClientAttachToIndexResponseTypeDef:
        """
        Attaches the specified object to the specified index.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/AttachToIndex>`_
    ...
    def attach_typed_link(
        self,
        DirectoryArn: str,
        SourceObjectReference: ClientAttachTypedLinkSourceObjectReferenceTypeDef,
        TargetObjectReference: ClientAttachTypedLinkTargetObjectReferenceTypeDef,
        TypedLinkFacet: ClientAttachTypedLinkTypedLinkFacetTypeDef,
        Attributes: List[ClientAttachTypedLinkAttributesTypeDef],
    ) -> ClientAttachTypedLinkResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/AttachTypedLink>`_
    ...
    def batch_read(
        self,
        DirectoryArn: str,
        Operations: List[ClientBatchReadOperationsTypeDef],
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/BatchRead>`_
                ...
                'Responses': [
                    {
                        ...
                        'ExceptionResponse': {
                            ...
                            |'NotIndexException'|'NotPolicyException'
              ...
              - *(dict) --*
                ...
                - **SuccessfulResponse** *(dict) --*
                    ...
                    - **SchemaFacets** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        - **SchemaArn** *(string) --*
                          ...
                          arns and `In-Place Schema Upgrade
                          <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/schemas_inplaceschemaupgrade.html>`__
                          for a description of when to provide minor versions.
                  ...
                  - **LookupPolicy** *(dict) --*
                    ...
                    ``ObjectIdentifier`` , ``policyId`` , and ``policyType`` . Paths that don't lead
                      ...
                      - *(dict) --*
                        ...
                        - **Policies** *(list) --*
                          ...
                          - *(dict) --*
                            ...
                            Contains the ``PolicyType`` , ``PolicyId`` , and the
                            ``ObjectIdentifier`` to which it is attached. For more information, see
                            `Policies
                            <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directory.html#key_concepts_policies>`__
                            .
                  ...
                  - **ListOutgoingTypedLinks** *(dict) --*
                    ...
                    - **TypedLinkSpecifiers** *(list) --*
                      ...
                      - *(dict) --*
                        ...
                        specifier while the  DetachTypedLink API accepts one as input. Similarly,
                        the  ListIncomingTypedLinks and  ListOutgoingTypedLinks API operations
                        ...
                        - **SourceObjectReference** *(dict) --*
                          ...
                          - **Selector** *(string) --*
                            ...
                            links leading to it from the directory root. Use the link names from
                            each parent/child link to construct the path. Path selectors start with
                            a slash (/) and link names are separated by slashes. For more
                            ...
                            * *$ObjectIdentifier* - An object identifier is an opaque string
                            ...
                            will provide you with the identifier of the created object. An object’s
                            identifier is immutable and no two objects will ever share the same
                            object identifier
    ...
    def batch_write(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/BatchWrite>`_
                  ...
                  - **TypedLinkSpecifier** *(dict) --*
                    ...
                    - **SourceObjectReference** *(dict) --*
                      ...
                      - **Selector** *(string) --*
                        ...
                        paths, see `Access Objects
                        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_access_objects.html>`__
                        . You can identify an object in one of the following ways:

                        * *$ObjectIdentifier* - An object identifier is an opaque string provided by
                        Amazon Cloud Directory. When creating objects, the system will provide you
                        with the identifier of the created object. An object’s identifier is
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def create_directory(self, Name: str, SchemaArn: str) -> ClientCreateDirectoryResponseTypeDef:
        """
        ...
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/schemas_managed.html>`__
        in the *Amazon Cloud Directory Developer Guide* .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/CreateDirectory>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AppliedSchemaArn** *(string) --*
              ...
              The ARN of the published schema in the  Directory . Once a published schema is copied
    ...
    def create_facet(
        ...
        SchemaArn: str,
        Name: str,
        Attributes: List[ClientCreateFacetAttributesTypeDef] = None,
        ObjectType: str = None,
        FacetStyle: str = None,
    ) -> Dict[str, Any]:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/CreateFacet>`_
        ...
        **Request Syntax**
        ...
        :param ObjectType:
          ...
          * Policy: Allows you to store a policy document and policy type. For more information, see
          `Policies
          <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directory.html#key_concepts_policies>`__
          .
    ...
    def create_index(
        self,
        DirectoryArn: str,
        OrderedIndexedAttributeList: List[ClientCreateIndexOrderedIndexedAttributeListTypeDef],
        IsUnique: bool,
        ParentReference: ClientCreateIndexParentReferenceTypeDef = None,
        LinkName: str = None,
    ) -> ClientCreateIndexResponseTypeDef:
        """
        Creates an index object. See `Indexing and search
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/indexing_search.html>`__
        for more information.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/CreateIndex>`_
    ...
    def create_object(
        self,
        DirectoryArn: str,
        SchemaFacets: List[ClientCreateObjectSchemaFacetsTypeDef],
        ObjectAttributeList: List[ClientCreateObjectObjectAttributeListTypeDef] = None,
        ParentReference: ClientCreateObjectParentReferenceTypeDef = None,
        LinkName: str = None,
    ) -> ClientCreateObjectResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/CreateObject>`_
    ...
    def create_schema(self, Name: str) -> ClientCreateSchemaResponseTypeDef:
        ...
        * *Applied:* Applied schemas are mutable in a way that allows you to add new schema facets.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/CreateSchema>`_
    ...
    def create_typed_link_facet(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/CreateTypedLinkFacet>`_
        ...
        **Request Syntax**
        ...
        :param Facet: **[REQUIRED]**
          ...
          - **Attributes** *(list) --* **[REQUIRED]**
            ...
            A set of key-value pairs associated with the typed link. Typed link attributes are used
            when you have data values that are related to the link itself, and not to one of the two
            objects being linked. Identity attributes also serve to distinguish the link from others
          ...
          - **IdentityAttributeOrder** *(list) --* **[REQUIRED]**
            ...
            The set of attributes that distinguish links made from this facet from each other, in
            the order of significance. Listing typed links can filter on the values of these
            attributes. See  ListOutgoingTypedLinks and  ListIncomingTypedLinks for details.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_directory(self, DirectoryArn: str) -> ClientDeleteDirectoryResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DeleteDirectory>`_
    ...
    def delete_facet(self, SchemaArn: str, Name: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DeleteFacet>`_
        ...
        **Request Syntax**
        ...
        :param SchemaArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that is associated with the  Facet . For more information,
          see  arns .
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def delete_object(
        self, DirectoryArn: str, ObjectReference: ClientDeleteObjectObjectReferenceTypeDef
    ) -> Dict[str, Any]:
        """
        ...
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/limits.html>`__ .

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DeleteObject>`_
    ...
    def delete_schema(self, SchemaArn: str) -> ClientDeleteSchemaResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DeleteSchema>`_
    ...
    def delete_typed_link_facet(self, SchemaArn: str, Name: str) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DeleteTypedLinkFacet>`_
    ...
    def detach_from_index(
        self,
        DirectoryArn: str,
        IndexReference: ClientDetachFromIndexIndexReferenceTypeDef,
        TargetReference: ClientDetachFromIndexTargetReferenceTypeDef,
    ) -> ClientDetachFromIndexResponseTypeDef:
        """
        Detaches the specified object from the specified index.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DetachFromIndex>`_
    ...
    def detach_object(
        self,
        DirectoryArn: str,
        ParentReference: ClientDetachObjectParentReferenceTypeDef,
        LinkName: str,
    ) -> ClientDetachObjectResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DetachObject>`_
    ...
    def detach_policy(
        self,
        DirectoryArn: str,
        PolicyReference: ClientDetachPolicyPolicyReferenceTypeDef,
        ObjectReference: ClientDetachPolicyObjectReferenceTypeDef,
    ) -> Dict[str, Any]:
        """
        Detaches a policy from an object.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DetachPolicy>`_
    ...
    def detach_typed_link(
        self, DirectoryArn: str, TypedLinkSpecifier: ClientDetachTypedLinkTypedLinkSpecifierTypeDef
    ) -> None:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DetachTypedLink>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def disable_directory(self, DirectoryArn: str) -> ClientDisableDirectoryResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/DisableDirectory>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def enable_directory(self, DirectoryArn: str) -> ClientEnableDirectoryResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/EnableDirectory>`_
    ...
    def get_applied_schema_version(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetAppliedSchemaVersion>`_
    ...
    def get_directory(self, DirectoryArn: str) -> ClientGetDirectoryResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetDirectory>`_
    ...
    def get_facet(self, SchemaArn: str, Name: str) -> ClientGetFacetResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetFacet>`_
    ...
    def get_link_attributes(
        self,
        DirectoryArn: str,
        TypedLinkSpecifier: ClientGetLinkAttributesTypedLinkSpecifierTypeDef,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetLinkAttributes>`_
        ...
        **Request Syntax**
        ...
        :param DirectoryArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that is associated with the Directory where the typed link
    ...
    def get_object_attributes(
        self,
        DirectoryArn: str,
        ObjectReference: ClientGetObjectAttributesObjectReferenceTypeDef,
        SchemaFacet: ClientGetObjectAttributesSchemaFacetTypeDef,
        AttributeNames: List[str],
        ConsistencyLevel: str = None,
    ) -> ClientGetObjectAttributesResponseTypeDef:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetObjectAttributes>`_
    ...
    def get_object_information(
        self,
        DirectoryArn: str,
        ObjectReference: ClientGetObjectInformationObjectReferenceTypeDef,
        ConsistencyLevel: str = None,
    ) -> ClientGetObjectInformationResponseTypeDef:
        """
        Retrieves metadata about an object.
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetObjectInformation>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **SchemaFacets** *(list) --*
              ...
              minor version information, the most recently applied minor version of each Facet is in
              effect. See  GetAppliedSchemaVersion for details.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def get_schema_as_json(self, SchemaArn: str) -> ClientGetSchemaAsJsonResponseTypeDef:
        """
        Retrieves a JSON representation of the schema. See `JSON Schema Format
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/schemas_jsonformat.html#schemas_json>`__
        for more information.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetSchemaAsJson>`_
    ...
    def get_typed_link_facet_information(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/GetTypedLinkFacetInformation>`_
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **IdentityAttributeOrder** *(list) --*
              ...
              significant. The ability to filter typed links considers the order that the attributes
              are defined on the typed link facet. When providing ranges to typed link selection,
              any inexact ranges must be specified at the end. Any attributes that do not have a
              range specified are presumed to match the entire range. Filters are interpreted in the
              order of the attributes on the typed link facet, not the order in which they are
              supplied to any API calls. For more information about identity attributes, see `Typed
              Links
              <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__
              .
    ...
    def list_attached_indices(
        self,
        DirectoryArn: str,
        TargetReference: ClientListAttachedIndicesTargetReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
    ) -> ClientListAttachedIndicesResponseTypeDef:
    ...
    def list_incoming_typed_links(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListIncomingTypedLinksObjectReferenceTypeDef,
        FilterAttributeRanges: List[
            ClientListIncomingTypedLinksFilterAttributeRangesTypeDef
        ] = None,
        FilterTypedLink: ClientListIncomingTypedLinksFilterTypedLinkTypeDef = None,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
    ) -> ClientListIncomingTypedLinksResponseTypeDef:
    ...
    def list_index(
        self,
        DirectoryArn: str,
        IndexReference: ClientListIndexIndexReferenceTypeDef,
        RangesOnIndexedValues: List[ClientListIndexRangesOnIndexedValuesTypeDef] = None,
        MaxResults: int = None,
        NextToken: str = None,
        ConsistencyLevel: str = None,
    ) -> ClientListIndexResponseTypeDef:
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          request. For more information, see `Amazon Cloud Directory Limits
          <http://docs.aws.amazon.com/clouddirectory/latest/developerguide/limits.html>`__ .
    ...
    def list_object_attributes(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListObjectAttributesObjectReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
        FacetFilter: ClientListObjectAttributesFacetFilterTypeDef = None,
    ) -> ClientListObjectAttributesResponseTypeDef:
        """
        Lists all attributes that are associated with an object.
    ...
    def list_object_children(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListObjectChildrenObjectReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
    ) -> ClientListObjectChildrenResponseTypeDef:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/ListObjectChildren>`_
    ...
    def list_object_parent_paths(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListObjectParentPathsObjectReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
    ) -> ClientListObjectParentPathsResponseTypeDef:
        """
        ...
        on user-defined ``MaxResults`` , in case there are multiple paths to the parent. The order
        of the paths and nodes returned is consistent among multiple API calls unless the objects
        are deleted or moved. Paths not leading to the directory root are ignored from the target
        object.
    ...
    def list_object_parents(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListObjectParentsObjectReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/ListObjectParents>`_
        ...
        **Request Syntax**
        ...
        :param IncludeAllLinksToEachParent:
          ...
          When set to True, returns all  ListObjectParentsResponse$ParentLinks . There could be
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **Parents** *(dict) --*
              ...
              The parent structure, which is a map with key as the ``ObjectIdentifier`` and LinkName
              as the value.
    ...
    def list_object_policies(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListObjectPoliciesObjectReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
    ) -> ClientListObjectPoliciesResponseTypeDef:
    ...
    def list_outgoing_typed_links(
        self,
        DirectoryArn: str,
        ObjectReference: ClientListOutgoingTypedLinksObjectReferenceTypeDef,
        FilterAttributeRanges: List[
            ClientListOutgoingTypedLinksFilterAttributeRangesTypeDef
        ] = None,
        FilterTypedLink: ClientListOutgoingTypedLinksFilterTypedLinkTypeDef = None,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
    ) -> ClientListOutgoingTypedLinksResponseTypeDef:
    ...
    def list_policy_attachments(
        self,
        DirectoryArn: str,
        PolicyReference: ClientListPolicyAttachmentsPolicyReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
        ConsistencyLevel: str = None,
    ) -> ClientListPolicyAttachmentsResponseTypeDef:
    ...
    def lookup_policy(
        self,
        DirectoryArn: str,
        ObjectReference: ClientLookupPolicyObjectReferenceTypeDef,
        NextToken: str = None,
        MaxResults: int = None,
    ) -> ClientLookupPolicyResponseTypeDef:
        """
    ...
    def publish_schema(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/PublishSchema>`_
        ...
        **Request Syntax**
        ...
        :param DevelopmentSchemaArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that is associated with the development schema. For more
          information, see  arns .

        :type Version: string
        :param Version: **[REQUIRED]**

          The major version under which the schema will be published. Schemas have both a major and
    ...
    def put_schema_from_json(
        ...
        """
        Allows a schema to be updated using JSON upload. Only available for development schemas. See
        `JSON Schema Format
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/schemas_jsonformat.html#schemas_json>`__
        for more information.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/PutSchemaFromJson>`_
    ...
    def remove_facet_from_object(
        self,
        DirectoryArn: str,
        SchemaFacet: ClientRemoveFacetFromObjectSchemaFacetTypeDef,
        ObjectReference: ClientRemoveFacetFromObjectObjectReferenceTypeDef,
    ) -> Dict[str, Any]:
        """
        Removes the specified facet from the specified object.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/RemoveFacetFromObject>`_
    ...
    def tag_resource(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/TagResource>`_
    ...
    def untag_resource(self, ResourceArn: str, TagKeys: List[str]) -> Dict[str, Any]:
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UntagResource>`_
    ...
    def update_facet(
        ...
        SchemaArn: str,
        Name: str,
        AttributeUpdates: List[ClientUpdateFacetAttributeUpdatesTypeDef] = None,
        ObjectType: str = None,
    ) -> Dict[str, Any]:
        """
        Does the following:
        ...
        * Deletes existing ``Attributes`` , ``Rules`` , or ``ObjectTypes`` .
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpdateFacet>`_
        ...
        **Request Syntax**
        ...
        :param AttributeUpdates:
          ...
          List of attributes that need to be updated in a given schema  Facet . Each attribute is
          followed by ``AttributeAction`` , which specifies the type of update operation to perform.
    ...
    def update_link_attributes(
        self,
        DirectoryArn: str,
        TypedLinkSpecifier: ClientUpdateLinkAttributesTypedLinkSpecifierTypeDef,
        AttributeUpdates: List[ClientUpdateLinkAttributesAttributeUpdatesTypeDef],
    ) -> Dict[str, Any]:
        """
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpdateLinkAttributes>`_
    ...
    def update_object_attributes(
        self,
        DirectoryArn: str,
        ObjectReference: ClientUpdateObjectAttributesObjectReferenceTypeDef,
        AttributeUpdates: List[ClientUpdateObjectAttributesAttributeUpdatesTypeDef],
    ) -> ClientUpdateObjectAttributesResponseTypeDef:
        """
        Updates a given object's attributes.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpdateObjectAttributes>`_
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def update_schema(self, SchemaArn: str, Name: str) -> ClientUpdateSchemaResponseTypeDef:
        """
        Updates the schema name with a new name. Only development schema names can be updated.

        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpdateSchema>`_
    ...
    def update_typed_link_facet(
        ...
        SchemaArn: str,
        Name: str,
        AttributeUpdates: List[ClientUpdateTypedLinkFacetAttributeUpdatesTypeDef],
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpdateTypedLinkFacet>`_
        ...
        **Request Syntax**
        ...
        :param IdentityAttributeOrder: **[REQUIRED]**
          ...
          The order of identity attributes for the facet, from most significant to least
          significant. The ability to filter typed links considers the order that the attributes are
          defined on the typed link facet. When providing ranges to a typed link selection, any
          inexact ranges must be specified at the end. Any attributes that do not have a range
          specified are presumed to match the entire range. Filters are interpreted in the order of
          the attributes on the typed link facet, not the order in which they are supplied to any
          API calls. For more information about identity attributes, see `Typed Links
          <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__
          .
    ...
    def upgrade_applied_schema(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpgradeAppliedSchema>`_
        ...
        **Request Syntax**
        ...
        :param DryRun:
          ...
          Used for testing whether the major version schemas are backward compatible or not. If
          schema compatibility fails, an exception would be thrown else the call would succeed but
    ...
    def upgrade_published_schema(
        ...
        See also: `AWS API Documentation
        <https://docs.aws.amazon.com/goto/WebAPI/clouddirectory-2017-01-11/UpgradePublishedSchema>`_
        ...
        **Request Syntax**
        ...
        :param DryRun:
          ...
          Used for testing whether the Development schema provided is backwards compatible, or not,
          with the publish schema provided by the user to be upgraded. If schema compatibility
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_applied_schema_arns` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_attached_indices` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_development_schema_arns` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_directories` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_facet_attributes` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_facet_names` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_incoming_typed_links` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_index` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_managed_schema_arns` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_object_attributes` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_object_parent_paths` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_object_policies` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_outgoing_typed_links` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_policy_attachments` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_published_schema_arns` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_typed_link_facet_attributes` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `list_typed_link_facet_names` operation.
        """
    ...
    def get_paginator(
        ...
        """
        Get Paginator for `lookup_policy` operation.
        """
