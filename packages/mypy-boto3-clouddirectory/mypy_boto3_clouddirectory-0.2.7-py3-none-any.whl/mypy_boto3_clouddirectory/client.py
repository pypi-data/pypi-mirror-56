...
class Client(BaseClient):
    ...
    def attach_object(
        ...
        **Request Syntax**
        ...
        :param DirectoryArn: **[REQUIRED]**
          ...
          Amazon Resource Name (ARN) that is associated with the  Directory where both objects reside. For
        ...
        :param Operations: **[REQUIRED]**
          ...
          - *(dict) --*
            ...
            - **ListObjectParentPaths** *(dict) --*
              ...
              Retrieves all available parent paths for any object type such as node, leaf node, policy node,
              and index node objects. For more information about objects, see `Directory Structure
            ...
            - **ListOutgoingTypedLinks** *(dict) --*
              ...
              also supports filtering by typed link facet and identity attributes. For more information, see
              `Typed Links
              <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__
              .
                ...
                'Responses': [
                    {
                        ...
                        'ExceptionResponse': {
                            'Type':
                            'ValidationException'|'InvalidArnException'|'ResourceNotFoundException'
                            |'InvalidNextTokenException'|'AccessDeniedException'|'NotNodeException'
                            |'FacetValidationException'|'CannotListParentOfRootException'
                            |'NotIndexException'|'NotPolicyException'|'DirectoryNotEnabledException'
              ...
              - *(dict) --*
                ...
                - **SuccessfulResponse** *(dict) --*
                  ...
                  - **ListObjectParentPaths** *(dict) --*
                    ...
                    node, and index node objects. For more information about objects, see `Directory
                    Structure
                    <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/key_concepts_directorystructure.html>`__
                    .
                  ...
                  - **LookupPolicy** *(dict) --*
                    ...
                    no policies present, an empty list is returned. If policies are present, and if some
                    ...
                    ``policyType`` . Paths that don't lead to the root from the target object are ignored.
                  ...
                  - **TypedLinkSpecifier** *(dict) --*
                    ...
                    - **SourceObjectReference** *(dict) --*
                      ...
                      - **Selector** *(string) --*
                        ...
                        A path selector supports easy selection of an object by the parent/child links
                        leading to it from the directory root. Use the link names from each parent/child
                        link to construct the path. Path selectors start with a slash (/) and link names are
                        separated by slashes. For more information about paths, see `Access Objects
                        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_access_objects.html>`__
                        . You can identify an object in one of the following ways:
    ...
    def create_directory(
        ...
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/schemas_managed.html>`__ in the
          ...
          **Response Structure**
          ...
          - *(dict) --*
            ...
            - **AppliedSchemaArn** *(string) --*
              ...
              directory, it has its own ARN, which is referred to applied schema ARN. For more information,
              see  arns .
          ...
          - *(dict) --*
            ...
            - **AttributeReference** *(dict) --*
              ...
              - **TargetFacetName** *(string) --* **[REQUIRED]**
                ...
                The target facet name that is associated with the facet reference. See `Attribute References
                <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/schemas_attributereferences.html>`__
                for more information.
    ...
    def create_index(
        ...
        """
        Creates an index object. See `Indexing and search
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/indexing_search.html>`__ for more
        information.
    ...
    def create_object(
        ...
        reference and ``LinkName`` is specified. An object is simply a collection of  Facet attributes. You
        can also use this API call to create a policy object, if the facet from which you create the object
        is a policy facet.
    ...
    def create_schema(self, Name: str) -> ClientCreateSchemaResponseTypeDef:
        ...
        * *Development:* This is a mutable phase of the schema. All new schemas are in the development
        phase. Once the schema is finalized, it can be published.

        * *Published:* Published schemas are immutable and have a version associated with them.

        * *Applied:* Applied schemas are mutable in a way that allows you to add new schema facets. You can
        also add new, nonrequired attributes to existing schema facets. You can apply only published schemas
        to directories.
    ...
    def delete_facet(self, SchemaArn: str, Name: str) -> Dict[str, Any]:
        ...
        **Request Syntax**
        ...
        :param SchemaArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that is associated with the  Facet . For more information, see
          arns .
    ...
    def delete_object(
        self,
        DirectoryArn: str,
        ObjectReference: ClientDeleteObjectObjectReferenceTypeDef,
    ) -> Dict[str, Any]:
        """
    ...
    def detach_object(
        ...
        **Request Syntax**
        ...
        :param DirectoryArn: **[REQUIRED]**
          ...
          The Amazon Resource Name (ARN) that is associated with the  Directory where objects reside. For
          more information, see  arns .
    ...
    def get_typed_link_facet_information(
        ...
        """
        Returns the identity attribute order for a specific  TypedLinkFacet . For more information, see
        `Typed Links
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__
        .
    ...
    def list_applied_schema_arns(
        ...
        **Request Syntax**
        ...
        :param SchemaArn:
          ...
          The response for ``ListAppliedSchemaArns`` when this parameter is used will list all minor version
    ...
    def list_index(
        ...
        **Request Syntax**
        ...
        :param MaxResults:
          ...
          The maximum number of objects in a single page to retrieve from the index during a request. For
          more information, see `Amazon Cloud Directory Limits
    ...
    def list_object_parent_paths(
        ...
        Use this API to evaluate all parents for an object. The call returns all objects from the root of
        the directory up to the requested object. The API returns the number of paths based on user-defined
        ``MaxResults`` , in case there are multiple paths to the parent. The order of the paths and nodes
        returned is consistent among multiple API calls unless the objects are deleted or moved. Paths not
    ...
    def list_published_schema_arns(
        ...
        **Request Syntax**
        ...
        :param SchemaArn:
          ...
          The response for ``ListPublishedSchemaArns`` when this parameter is used will list all minor
    ...
    def list_typed_link_facet_names(
        ...
        """
        Returns a paginated list of ``TypedLink`` facet names for a particular schema. For more information,
        see `Typed Links
        <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__
        .
    ...
    def lookup_policy(
        ...
        returns ``ObjectIdentifier`` , ``policyId`` , and ``policyType`` . Paths that don't lead to the root
    ...
    def update_facet(
        ...
        **Request Syntax**
        ...
        :param AttributeUpdates:
          ...
          by ``AttributeAction`` , which specifies the type of update operation to perform.
    ...
    def update_typed_link_facet(
        ...
        **Request Syntax**
        ...
        :param IdentityAttributeOrder: **[REQUIRED]**
          ...
          ability to filter typed links considers the order that the attributes are defined on the typed
          link facet. When providing ranges to a typed link selection, any inexact ranges must be specified
          at the end. Any attributes that do not have a range specified are presumed to match the entire
          range. Filters are interpreted in the order of the attributes on the typed link facet, not the
          order in which they are supplied to any API calls. For more information about identity attributes,
          see `Typed Links
          <https://docs.aws.amazon.com/clouddirectory/latest/developerguide/directory_objects_links.html#directory_objects_links_typedlink>`__
          .
    ...
    def upgrade_applied_schema(
        ...
        ``MinorVersion`` . Backwards-compatible minor version upgrades are instantaneously available for
        readers on all objects in the directory. Note: This is a synchronous API call and upgrades only one
        schema on a given directory per call. To upgrade multiple directories from one schema, you would
        ...
        **Request Syntax**
        ...
        :param DryRun:
          ...
          compatibility fails, an exception would be thrown else the call would succeed but no changes will
          be saved. This parameter is optional.
