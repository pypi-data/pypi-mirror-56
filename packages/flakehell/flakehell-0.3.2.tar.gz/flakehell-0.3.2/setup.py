...
setup(
    ...
    package_data={},
    install_requires=[
        'entrypoints', 'flake8>=3.7.5', 'pygments', 'pylint', 'termcolor',
        'toml', 'urllib3'
    ],
    extras_require={
        "dev": [
            ...
            "flake8-mutable", "flake8-pep3101", "flake8-pie", "flake8-print",
            "flake8-pytest", "flake8-quotes", "flake8-rst-docstrings",
            "flake8-scrapy", "flake8-strict", "flake8-string-format",
            "flake8-variables-names", "mccabe", "pep8-naming", "pytest",
