...
class Client(BaseClient):
    ...
    def begin_transaction(
        ...
        Starts a SQL transaction.
         ...
         ``<important> <p>A transaction can run for a maximum of 24 hours. A transaction is
         terminated and rolled back automatically after 24 hours.</p> <p>A transaction times out if
         no calls use its transaction ID in three minutes. If a transaction times out before it's
         committed, it's rolled back automatically.</p> <p>DDL statements inside a transaction cause
         an implicit commit. We recommend that you run each DDL statement in a separate
    ...
    def execute_statement(
        ...
        The response size limit is 1 MB or 1,000 records. If the call returns more than 1 MB of
        response data or over 1,000 records, the call is terminated.
        ...
        **Request Syntax**
        ...
        :param continueAfterTimeout:
          ...
          By default, the statement stops running when the call times out.
        ...
        :param resultSetOptions:
          ...
          - **decimalReturnType** *(string) --*
            ...
            The value of ``STRING`` , the default, specifies that it is converted to a String value.
            The value of ``DOUBLE_OR_LONG`` specifies that it is converted to a Long value if its
            scale is 0, or to a Double value otherwise.
          ...
          - *(dict) --*
            ...
            - **generatedFields** *(list) --*
              ...
              Values for fields generated during the request.
               ...
               href=
                   "https://www.postgresql.org/docs/10/dml-returning.html">Returning Data From
