...
class ClientBatchExecuteStatementResponseupdateResultsgeneratedFieldsarrayValueTypeDef(
    ...
    """
    Type definition for `ClientBatchExecuteStatementResponseupdateResultsgeneratedFields`
    `arrayValue`
...
_ClientBatchExecuteStatementparameterSetsTypeDef = TypedDict(
    ...
    {"name": str, "typeHint": str, "value": ClientBatchExecuteStatementparameterSetsvalueTypeDef},
    total=False,
)
...
class ClientExecuteSqlResponsesqlStatementResultsresultFramerecordsvaluesstructValueTypeDef(
    ...
    """
    Type definition for `ClientExecuteSqlResponsesqlStatementResultsresultFramerecordsvalues`
    `structValue`
...
class ClientExecuteSqlResponsesqlStatementResultsresultFrameresultSetMetadatacolumnMetadataTypeDef(
    ...
    """
    Type definition for `ClientExecuteSqlResponsesqlStatementResultsresultFrameresultSetMetadata`
    `columnMetadata`
...
_ClientExecuteStatementparametersTypeDef = TypedDict(
    ...
    {"name": str, "typeHint": str, "value": ClientExecuteStatementparametersvalueTypeDef},
    total=False,
)
...
_ClientExecuteStatementresultSetOptionsTypeDef = TypedDict(
    "_ClientExecuteStatementresultSetOptionsTypeDef", {"decimalReturnType": str}, total=False
)
