...
Mypy-friendly auto-generated type annotations for `boto3 rds-data 1.10.28` service.
...
session_client = session.client("rds-data")
...
```python
import boto3
from mypy_boto3.rds_data import Client
