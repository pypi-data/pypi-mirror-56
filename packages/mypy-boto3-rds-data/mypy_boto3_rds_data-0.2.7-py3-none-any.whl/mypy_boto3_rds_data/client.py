...
class Client(BaseClient):
    ...
    def begin_transaction(
        ...
        Starts a SQL transaction.
         ...
         automatically.</p> <p>DDL statements inside a transaction cause an implicit commit. We recommend
        ...
        **Request Syntax**
        ...
        :param resultSetOptions:
          ...
          - **decimalReturnType** *(string) --*
            ...
            A value that indicates how a field of ``DECIMAL`` type is represented in the response. The value
