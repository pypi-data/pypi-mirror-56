...
/*-----------------------------------------------
  ...
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__ccista

#else
#  define SWIG_init    init_ccista

#endif
#define SWIG_name    "_ccista"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_ccista(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OOOOOOOOO:ccista",&obj0,&obj1,&obj2,&obj3,&obj4,&obj5,&obj6,&obj7,&obj8)) SWIG_fail;
  {
    npy_intp size[2] = {
      -1, -1 
    };
  ...
  ecode16 = SWIG_AsVal_double(obj4, &val16);
  if (!SWIG_IsOK(ecode16)) {
    SWIG_exception_fail(SWIG_ArgError(ecode16), "in method '" "ccista" "', argument " "16"" of type '" "double""'");
  } 
  arg16 = static_cast< double >(val16);
  ecode17 = SWIG_AsVal_double(obj5, &val17);
  if (!SWIG_IsOK(ecode17)) {
    SWIG_exception_fail(SWIG_ArgError(ecode17), "in method '" "ccista" "', argument " "17"" of type '" "double""'");
  } 
  arg17 = static_cast< double >(val17);
  ecode18 = SWIG_AsVal_double(obj6, &val18);
  if (!SWIG_IsOK(ecode18)) {
    SWIG_exception_fail(SWIG_ArgError(ecode18), "in method '" "ccista" "', argument " "18"" of type '" "double""'");
  } 
  arg18 = static_cast< double >(val18);
  ecode19 = SWIG_AsVal_int(obj7, &val19);
  if (!SWIG_IsOK(ecode19)) {
    SWIG_exception_fail(SWIG_ArgError(ecode19), "in method '" "ccista" "', argument " "19"" of type '" "int""'");
  } 
  arg19 = static_cast< int >(val19);
  ecode20 = SWIG_AsVal_int(obj8, &val20);
  if (!SWIG_IsOK(ecode20)) {
    SWIG_exception_fail(SWIG_ArgError(ecode20), "in method '" "ccista" "', argument " "20"" of type '" "int""'");
  } 
  arg20 = static_cast< int >(val20);
  {
    errno = 0;
    ccista(arg1,arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14,arg15,arg16,arg17,arg18,arg19,arg20);
  ...
  }
  {
    ...
    PyObject* obj = PyArray_SimpleNewFromData(1, dims, NPY_INT, (void*)(*arg12));
    PyArrayObject* array = (PyArrayObject*) obj;
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"ccista", _wrap_ccista, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
