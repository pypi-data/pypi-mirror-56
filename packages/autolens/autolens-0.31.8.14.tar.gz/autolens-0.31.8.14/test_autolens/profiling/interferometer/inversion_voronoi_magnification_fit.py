...
interferometer = al.interferometer(visibilities=visibilities, noise_map=noise_map, uv_wavelengths=uv_wavelengths)
...
masked_interferometer = al.masked.interferometer(interferometer=interferometer, real_space_mask=mask)

print("Number of points = " + str(masked_interferometer.grid.sub_shape_1d) + "\n")
print("Number of visibilities = " + str(masked_interferometer.visibilities.shape_1d) + "\n")
...
diff = time.time() - start
print("Time to compute mapped real visibility reconstruction = {}".format(diff / repeats))
...
diff = time.time() - start
print("Time to compute mapped imaginary visibility reconstruction = {}".format(diff / repeats))
