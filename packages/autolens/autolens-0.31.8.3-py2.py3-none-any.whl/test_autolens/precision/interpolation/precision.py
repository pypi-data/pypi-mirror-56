...
for data_resolution in ["hst_up"]:
    ...
    true_deflections_y_2d = masked_imaging.grid.array_from_sub_array_1d(
        sub_array_1d=true_deflections[:, 0]
    )
    true_deflections_x_2d = masked_imaging.grid.array_from_sub_array_1d(
    ...
    difference_y_2d = masked_imaging.grid.array_from_sub_array_1d(
        sub_array_1d=difference_y
    )
    difference_x_2d = masked_imaging.grid.array_from_sub_array_1d(
        sub_array_1d=difference_x
    )

    al.plot.array(array=true_deflections_y_2d)
    al.plot.array(array=difference_y_2d)

    al.plot.array(array=true_deflections_x_2d)
    ...
    #
    # al.plot.array(arrays=difference_percent_y_2d)
    # al.plot.array(arrays=difference_percent_x_2d)
