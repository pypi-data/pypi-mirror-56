...
class SKLearn(_FrameworkBaseEstimator):
    ...
    .. remarks::
            ...
            The following example shows how to use the SKLearn estimator to launch a SKLearn training
            ...
            For an example of how to use the SKLearn class for training a simple logistic regression using the MNIST
            dataset and scikit-learn, see the tutorial
            `Train image classification models with MNIST data and scikit-learn using Azure Machine Learning
            <https://docs.microsoft.com/azure/machine-learning/service/tutorial-train-models-with-aml>`_.
