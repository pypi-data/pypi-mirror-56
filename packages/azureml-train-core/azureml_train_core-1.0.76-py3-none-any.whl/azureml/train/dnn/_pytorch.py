...
class PyTorch(_FrameworkBaseEstimator):
    ...
    .. remarks::
            ...
            | Dependencies | PyTorch 1.0/1.1/1.2/1.3     |
            | ---------------------- | ----------------- |
            | Python                 | 3.6.2             |
            | CUDA  (GPU image only) | 10.0              |
            | cuDNN (GPU image only) | 7.6.3             |
            | NCCL  (GPU image only) | 2.4.8             |
            | azureml-defaults       | Latest            |
            | OpenMpi                | 3.1.2             |
            | horovod                | 0.18.1            |
            | miniconda              | 4.5.11            |
            | torch                  | 1.0/1.1/1.2/1.3.1 |
            | torchvision            | 0.4.1             |
            | git                    | 2.7.4             |
            | tensorboard            | 1.14              |
            | future                 | 0.17.1            |
            ...
            The following example shows how to use the PyTorch estimator to launch a PyTorch training
            ...
            https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/ml-frameworks/pytorch/deployment/train-hyperparameter-tune-deploy-with-pytorch/train-hyperparameter-tune-deploy-with-pytorch.ipynb
            ...
            <https://docs.microsoft.com/azure/machine-learning/service/how-to-train-pytorch>`_.
    ...
    :type distributed_training: azureml.train.dnn.Mpi, azureml.train.dnn.Gloo,
