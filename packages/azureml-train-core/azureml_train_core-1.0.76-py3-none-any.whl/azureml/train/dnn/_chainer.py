...
class Chainer(_FrameworkBaseEstimator):
    ...
    .. remarks::
            ...
            https://github.com/Azure/MachineLearningNotebooks/blob/master/how-to-use-azureml/ml-frameworks/chainer/deployment/train-hyperparameter-tune-deploy-with-chainer/train-hyperparameter-tune-deploy-with-chainer.ipynb
    ...
    :param distributed_training: Parameters for running a distributed training job.
        ...
        For running a distributed job with MPI backend, use the :class:`azureml.train.dnn.Mpi`
        object to specify ``process_count_per_node``.
    :type distributed_training: azureml.train.dnn.Mpi
    ...
    def __init__(self,
        ...
        if self._estimator_config.communicator.lower() in ["intelmpi", "mpi"]:
