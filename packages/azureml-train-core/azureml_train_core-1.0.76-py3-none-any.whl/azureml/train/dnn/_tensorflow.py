...
class TensorFlow(_FrameworkBaseEstimator):
    ...
    Supported versions: 1.10, 1.12, 1.13, 2.0
    ...
    .. remarks::
            ...
            | Dependencies           | TensorFlow 1.10/1.12 | TensorFlow 1.13      | TensorFlow 2.0       |
            | ---------------------- | -------------------- | -------------------- | -------------------- |
            ...
            | tensorflow             | 1.10.0/1.12.0        | 1.13.1               | 2.0.0                |
            ...
            * Native `distributed TensorFlow <https://www.tensorflow.org/deploy/distributed>`_ using the
            ...
            <https://docs.microsoft.com/azure/machine-learning/service/how-to-train-tensorflow>`_.
