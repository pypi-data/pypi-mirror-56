...
class Client(BaseClient):
    ...
    def create_backup(
        ...
        backups for your file system is a best practice that complements the replication that Amazon FSx for
        Windows File Server performs for your file system. It also enables you to restore from user
        modification of data.

        If a backup with the specified client request token exists, and the parameters match, this operation
        returns the description of the existing backup. If a backup specified client request token exists,
        and the parameters don't match, this operation returns ``IncompatibleParameterError`` . If a backup
        ...
        * Returns the description of the backup.
        ...
        creating an extra backup. This approach can be useful when an initial call fails in a way that makes
        it unclear whether a backup was created. If you use the same client request token and the initial
        call created a backup, the operation returns a successful result because all the parameters are the
        same.
    ...
    def create_file_system(
        ...
        * Returns the description of the file system.
        ...
        request token has no effect. By using the idempotent operation, you can retry a ``CreateFileSystem``
        operation without the risk of creating an extra file system. This approach can be useful when an
        initial call fails in a way that makes it unclear whether a file system was created. Examples are if
        a transport level timeout occurred, or your connection was reset. If you use the same client request
        token and the initial call created a file system, the client receives success as long as the
        ...
        **Request Syntax**
        ...
        :param StorageCapacity: **[REQUIRED]**
          ...
          For Lustre file systems, valid values are 1,200, 2,400, 3,600, then continuing in increments of
          3600 GiB.
        ...
        :param SubnetIds: **[REQUIRED]**
          ...
          file server and one for the standy file server. You specify one of these subnets as the preferred
          subnet using the ``WindowsConfiguration > PreferredSubnetID`` property.

          For Windows ``SINGLE_AZ_1`` file system deployment types and Lustre file systems, provide exactly
        ...
        :param WindowsConfiguration:
          ...
          - **PreferredSubnetId** *(string) --*
            ...
            you want the preferred file server to be located. For in-AWS applications, we recommend that you
          ...
          - **CopyTagsToBackups** *(boolean) --*
            ...
            and you specify one or more tags, only the specified tags are copied to backups.
        ...
        :param LustreConfiguration:
          ...
          - **ImportedFileChunkSize** *(integer) --*
            ...
            disks that a single file can be striped across is limited by the total number of disks that make
            up the file system.
    ...
    def describe_backups(
        ...
        number of backups in a response. If more backups remain, Amazon FSx returns a ``NextToken`` value in
    ...
    def describe_file_systems(
        ...
        remain, Amazon FSx returns a ``NextToken`` value in the response. In this case, send a later request
