            ...
            - **FileSystem** *(dict) --*
              ...
              - **WindowsConfiguration** *(dict) --*
                ...
                - **PreferredSubnetId** *(string) --*
                  ...
                  For ``MULTI_AZ_1`` deployment types, it specifies the ID of the subnet where the
                  preferred file server is located. Must be one of the two subnet IDs specified in
                  ``SubnetIds`` property. Amazon FSx serves traffic from this subnet except in the event of
                  a failover to the secondary file server.
                ...
                - **FileSystem** *(dict) --*
                  ...
                  - **WindowsConfiguration** *(dict) --*
                    ...
                    - **DeploymentType** *(string) --*
                      ...
                      * ``SINGLE_AZ_1`` - (Default) Specifies a file system that is configured for single
                      AZ redundancy.
                    ...
                    - **PreferredFileServerIp** *(string) --*
                      ...
                      ``SINGLE_AZ_1`` and ``MULTI_AZ_1`` deployment types. This IP address is temporarily
                      unavailable when the file system is undergoing maintenance. For Linux and Windows SMB
                      clients that are joined to an Active Directory, use the file system's DNSName
                      instead. For more information and instruction on mapping and mounting file shares,
                      see `https\\://docs.aws.amazon.com/fsx/latest/WindowsGuide/accessing-file-shares.html
                      <https://docs.aws.amazon.com/fsx/latest/WindowsGuide/accessing-file-shares.html>`__ .
