...
class Client(BaseClient):
    ...
    def create_backup(
        ...
        that Amazon FSx for Windows File Server performs for your file system. It also enables you
        to restore from user modification of data.

        If a backup with the specified client request token exists, and the parameters match, this
        operation returns the description of the existing backup. If a backup specified client
        ...
        * Returns the description of the backup.
        ...
        By using the idempotent operation, you can retry a ``CreateBackup`` operation without the
        risk of creating an extra backup. This approach can be useful when an initial call fails in
        a way that makes it unclear whether a backup was created. If you use the same client request
        token and the initial call created a backup, the operation returns a successful result
        ...
        **Request Syntax**
        ...
        :param ClientRequestToken:
          ...
          creation. This string is automatically filled on your behalf when you use the AWS Command
        ...
        :param Tags:
          ...
          The tags to apply to the backup at backup creation. The key value of the ``Name`` tag
          appears in the console as the backup name.
...

            {
                'Backup': {
                    ...
                    'FileSystem': {
                        ...
                        'Lifecycle':
                        'AVAILABLE'|'CREATING'|'FAILED'|'DELETING'|'MISCONFIGURED'
                        |'UPDATING',
                        'FailureDetails': {
                            'Message': 'string'
                        },
            ...
            - **Backup** *(dict) --*
              ...
              - **Tags** *(list) --*
                ...
                - *(dict) --*
                  ...
                  - **Value** *(string) --*
                    ...
                    tag set. For example, you can have a key-value pair in a tag set of ``finances :
              ...
              - **FileSystem** *(dict) --*
                ...
                - **OwnerId** *(string) --*
                  ...
                  AWS Identity and Access Management (IAM) user, the AWS account to which the IAM
                ...
                - **SubnetIds** *(list) --*
                  ...
                  - *(string) --*
                    ...
                    private cloud (VPC). For more information, see `VPC and Subnets
                    <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Subnets.html>`__ in
                    the *Amazon VPC User Guide.*

                - **NetworkInterfaceIds** *(list) --*

                  The IDs of the elastic network interface from which a specific file system is
                  accessible. The elastic network interface is automatically created in the same VPC
                  that the Amazon FSx file system was created in. For more information, see `Elastic
                  Network Interfaces
                  ...
                  *Amazon EC2 User Guide.*
                  ...
                  - *(string) --*
                    ...
                    An elastic network interface ID. An elastic network interface is a logical
                    networking component in a virtual private cloud (VPC) that represents a virtual
                    network card. For more information, see `Elastic Network Interfaces
                    <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html>`__ in the
                ...
                - **Tags** *(list) --*
                  ...
                  <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/Using_Tags.html>`__ in the
                  *Amazon EC2 User Guide* .
                ...
                - **WindowsConfiguration** *(dict) --*
                  ...
                  - **PreferredSubnetId** *(string) --*
                    ...
                    For ``SINGLE_AZ_1`` deployment types, this value is the same as that for
                    ``SubnetIDs`` .
                  ...
                  - **PreferredFileServerIp** *(string) --*
                    ...
                    Directory, use the file system's DNSName instead. For more information and
                    instruction on mapping and mounting file shares, see
                    `https\\://docs.aws.amazon.com/fsx/latest/WindowsGuide/accessing-file-shares.html
                    <https://docs.aws.amazon.com/fsx/latest/WindowsGuide/accessing-file-shares.html>`__
                    .
    ...
    def create_file_system(
        ...
        doesn't exist, ``CreateFileSystem`` does the following:
        ...
        * Returns the description of the file system.
        ...
        ``CreateFileSystem`` operation without the risk of creating an extra file system. This
        ...
        a file system, the client receives success as long as the parameters are the same.
        ...
        **Request Syntax**
        ...
        :param SubnetIds: **[REQUIRED]**
          ...
          preferred file server and one for the standy file server. You specify one of these subnets
          as the preferred subnet using the ``WindowsConfiguration > PreferredSubnetID`` property.

          For Windows ``SINGLE_AZ_1`` file system deployment types and Lustre file systems, provide
        ...
        :param SecurityGroupIds:
          ...
          - *(string) --*
            ...
            The ID of your Amazon EC2 security group. This ID is used to control network access to
            the endpoint that Amazon FSx creates on your behalf in each subnet. For more
        ...
        :param Tags:
          ...
          The tags to apply to the file system being created. The key value of the ``Name`` tag
        ...
        :param KmsKeyId:
          ...
          The ID of your AWS Key Management Service (AWS KMS) key. This ID is used to encrypt the
          data in your file system at rest. For more information, see `Encrypt
        ...
        :param WindowsConfiguration:
          ...
          The Microsoft Windows configuration for the file system being created. This value is
          ...
          - **SelfManagedActiveDirectoryConfiguration** *(dict) --*
            ...
            - **FileSystemAdministratorsGroup** *(string) --*
              ...
              administering the file system remotely by using the FSx Remote PowerShell. The group
              that you specify must already exist in your domain. If you don't provide one, your AD
            ...
            - **DnsIps** *(list) --* **[REQUIRED]**
              ...
              A list of up to two IP addresses of DNS servers or domain controllers in the
              self-managed AD directory. The IP addresses need to be either in the same VPC CIDR
              range as the one in which your Amazon FSx file system is being created, or in the
              private IP version 4 (Iv4) address ranges, as specified in `RFC 1918
              <http://www.faqs.org/rfcs/rfc1918.html>`__ :
          ...
          - **DeploymentType** *(string) --*
            ...
            * SINGLE_AZ_1 - (Default) Choose to deploy a file system that is configured for single
            ...
            To learn more about high availability Multi-AZ file systems, see `High Availability for
            Amazon FSx for Windows File Server
            <https://docs.aws.amazon.com/fsx/latest/WindowsGuide/high-availability-multiAZ.html>`__
            .

          - **PreferredSubnetId** *(string) --*

            Required when ``DeploymentType`` is set to ``MULTI_AZ_1`` . This specifies the subnet in
            which you want the preferred file server to be located. For in-AWS applications, we
            recommend that you launch your clients in the same Availability Zone (AZ) as your
            preferred file server to reduce cross-AZ data transfer costs and minimize latency.
        ...
        :param LustreConfiguration:
          ...
          - **ImportPath** *(string) --*
            ...
            using as the data repository for your Amazon FSx for Lustre file system. The root of
            your FSx for Lustre file system will be mapped to the root of the Amazon S3 bucket you
            select. An example is ``s3://import-bucket/optional-prefix`` . If you specify a prefix
          ...
          - **ExportPath** *(string) --*
            ...
            exported. The path must use the same Amazon S3 bucket as specified in ImportPath. You
            can provide an optional prefix to which new and changed data is to be exported from your
            Amazon FSx for Lustre file system. If an ``ExportPath`` value is not provided, Amazon
            FSx sets a default export path, ``s3://import-bucket/FSxLustre[creation-timestamp]`` .
            ...
            ``ImportPath`` . If you only specify a bucket name, such as ``s3://import-bucket`` , you
            get a 1:1 mapping of file system objects to S3 bucket objects. This mapping means that
            ...
            - **FileSystem** *(dict) --*
              ...
              - **WindowsConfiguration** *(dict) --*
                ...
                - **PreferredFileServerIp** *(string) --*
                  ...
                  SMB clients that are not joined to a Microsoft Active Directory. Applicable for
                  both ``SINGLE_AZ_1`` and ``MULTI_AZ_1`` deployment types. This IP address is
                  temporarily unavailable when the file system is undergoing maintenance. For Linux
                  and Windows SMB clients that are joined to an Active Directory, use the file
    ...
    def create_file_system_from_backup(
        ...
        If a file system with the specified client request token exists and the parameters match,
        this operation returns the description of the file system. If a client request token
        specified by the file system exists and the parameters don't match, this call returns
        ``IncompatibleParameterError`` . If a file system with the specified client request token
        doesn't exist, this operation does the following:
        ...
        * Returns the description of the file system.
        ...
        explicitly supply other settings.
        ...
        Examples are if a transport level timeout occurred, or your connection was reset. If you use
        the same client request token and the initial call created a file system, the client
        ...
        **Request Syntax**
        ...
        :param SubnetIds: **[REQUIRED]**
          ...
          A list of IDs for the subnets that the file system will be accessible from. Currently, you
          can specify only one subnet. The file server is also launched in that subnet's
          Availability Zone.
    ...
    def delete_backup(
        ...
        """
        Deletes an Amazon FSx for Windows File Server backup, deleting its contents. After deletion,
    ...
    def delete_file_system(
        ...
        The ``DeleteFileSystem`` action returns while the file system has the ``DELETING`` status.
        You can check the file system deletion status by calling the  DescribeFileSystems action,
        which returns a list of file systems in your account. If you pass the file system ID for a
        deleted file system, the  DescribeFileSystems returns a ``FileSystemNotFound`` error.
        ...
        **Request Syntax**
        ...
        :param WindowsConfiguration:
          ...
          - **SkipFinalBackup** *(boolean) --*
            ...
            ``DeleteFileSystem`` operation is invoked. Doing this helps protect you from data loss,
            and we highly recommend taking the final backup. If you want to skip this backup, use
            this flag to do so.
    ...
    def describe_backups(
        ...
        ``BackupIds`` value is provided for that backup. Otherwise, it returns all backups owned by
        your AWS account in the AWS Region of the endpoint that you're calling.

        When retrieving all backups, you can optionally specify the ``MaxResults`` parameter to
        limit the number of backups in a response. If more backups remain, Amazon FSx returns a
        ...
        ``DescribeBackups`` is called first without a ``NextToken`` value. Then the action continues
        to be called with the ``NextToken`` parameter set to the value of the last ``NextToken``
        value until a response has no ``NextToken`` .

        When using this action, keep the following in mind:

        * The implementation might return fewer than ``MaxResults`` file system descriptions while
        still including a ``NextToken`` value.

        * The order of backups returned in the response of one ``DescribeBackups`` call and the
        order of backups returned across the responses of a multi-call iteration is unspecified.
        ...
        **Request Syntax**
        ...
        :param BackupIds:
          ...
          - *(string) --*
            ...
            The ID of the backup. Specifies the backup to use if you're creating a file system from
            an existing backup.
        ...
        :param MaxResults:
          ...
          of the ``MaxResults`` parameter specified in the request and the service's internal
                ...
                'Backups': [
                    {
                        ...
                        'FileSystem': {
                            ...
                            'FileSystemType': 'WINDOWS'|'LUSTRE',
                            'Lifecycle':
                            'AVAILABLE'|'CREATING'|'FAILED'|'DELETING'
          ...
          **Response Structure**
          ...
          - *(dict) --*
              ...
              - *(dict) --*
                ...
                - **FileSystem** *(dict) --*
                  ...
                  - **SubnetIds** *(list) --*
                    ...
                    The ID of the subnet to contain the endpoint for the file system. One and only
                    one is supported. The file system is launched in the Availability Zone
                    ...
                    - *(string) --*
                      ...
                      The ID for a subnet. A *subnet* is a range of IP addresses in your virtual
                      private cloud (VPC). For more information, see `VPC and Subnets
                      <https://docs.aws.amazon.com/AmazonVPC/latest/UserGuide/VPC_Subnets.html>`__
                  ...
                  - **NetworkInterfaceIds** *(list) --*
                    ...
                    *Amazon EC2 User Guide.*
                    ...
                    - *(string) --*
                      ...
                      An elastic network interface ID. An elastic network interface is a logical
                      networking component in a virtual private cloud (VPC) that represents a
                      virtual network card. For more information, see `Elastic Network Interfaces
                      <https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/using-eni.html>`__ in the
                      *Amazon EC2 User Guide for Linux Instances* .
                  ...
                  - **WindowsConfiguration** *(dict) --*
                    ...
                    - **PreferredSubnetId** *(string) --*
                      ...
                      the preferred file server is located. Must be one of the two subnet IDs
                      specified in ``SubnetIds`` property. Amazon FSx serves traffic from this
                      subnet except in the event of a failover to the secondary file server.
                    ...
                    - **PreferredFileServerIp** *(string) --*
                      ...
                      Use this IP address when mounting the file system on Linux SMB clients or
                      Windows SMB clients that are not joined to a Microsoft Active Directory.
                      Applicable for both ``SINGLE_AZ_1`` and ``MULTI_AZ_1`` deployment types. This
                    ...
                    - **CopyTagsToBackups** *(boolean) --*
                      ...
                      A boolean flag indicating whether tags on the file system should be copied to
                      backups. This value defaults to false. If it's set to true, all tags on the
                      file system are copied to all automatic backups and any user-initiated backups
                      where the user doesn't specify any tags. If this value is true, and you
            ...
            - **NextToken** *(string) --*
              ...
              This is present if there are more backups than returned in the response (String). You
              can use the ``NextToken`` value in the later request to fetch the backups.
    ...
    def describe_file_systems(
        ...
        descriptions remain, Amazon FSx returns a ``NextToken`` value in the response. In this case,
        send a later request with the ``NextToken`` request parameter set to the value of
        ``NextToken`` from the last response.

        This action is used in an iterative process to retrieve a list of your file system
        descriptions. ``DescribeFileSystems`` is called first without a ``NextToken`` value. Then
        the action continues to be called with the ``NextToken`` parameter set to the value of the
        ...
        * The order of file systems returned in the response of one ``DescribeFileSystems`` call and
        the order of file systems returned across the responses of a multicall iteration is
        unspecified.
    ...
    def list_tags_for_resource(
        ...
        When retrieving all tags, you can optionally specify the ``MaxResults`` parameter to limit
        the number of tags in a response. If more tags remain, Amazon FSx returns a ``NextToken``
        ...
        * The order of tags returned in the response of one ``ListTagsForResource`` call and the
        order of tags returned across the responses of a multi-call iteration is unspecified.
    ...
    # pylint: disable=arguments-differ,redefined-outer-name,redefined-builtin
    def tag_resource(self, ResourceARN: str, Tags: List[ClientTagResourceTagsTypeDef]) -> Dict:
        """
        ...
        **Request Syntax**
        ...
        :param TagKeys: **[REQUIRED]**
          ...
          - *(string) --*
            ...
            A string of 1 to 128 characters that specifies the key for a tag. Tag keys must be
            unique for the resource to which they are attached.
    ...
    def update_file_system(
        ...
        **Request Syntax**
        ...
        :param WindowsConfiguration:
          ...
          options are for backup and maintenance and for self-managed Active Directory
          configuration.
