...
class Client(BaseClient):
    ...
    def create_case(
        ...
        * **issueType.** The type of issue for the case. You can specify either "customer-service" or
        ...
        .. note::
           ...
           increase requests in `Support Center <https://console.aws.amazon.com/support>`__ . The ``caseId``
           is not the ``displayId`` that appears in `Support Center
        ...
        * **categoryCode.** The category for the service defined for the ``serviceCode`` value. You also get
        the category code for a service by calling  DescribeServices . Each AWS service defines its own set
        of category codes.
    ...
    def describe_services(
        ...
        You then use service names and categories in your  CreateCase requests. Each AWS service has its own
        set of categories.
        ...
        ``DescribeServices`` request. Always use the service codes and categories obtained programmatically.
        This practice ensures that you always have the most recent set of service and category codes.
    ...
    def describe_trusted_advisor_check_refresh_statuses(
        ...
        **Request Syntax**
        ...
        :param checkIds: **[REQUIRED]**
          ...
          check that is automatically refreshed causes an ``InvalidParameterValue`` error.
    ...
    def refresh_trusted_advisor_check(
        ...
        .. note::
          ...
          of the ``RefreshTrustedAdvisorCheck`` operation for these checks causes an
