...
EXCLUSIONS = [r'.*_confDb\.py$', r'InstallArea.*\.cmake$',
...
def filesToIndex(path):
    ...
    def isGenConfOutput(path):
        ...
        return (path.endswith('Conf.py') and
            'Automatically generated.' in open(path).readline())
    ...
    for root, dirs, files in os.walk(path):
        ...
        for filename in files:
            ...
            if (_isFileWanted(relname) and isNotEmpty(filename) and
                   not isGenConfOutput(filename)):
...
class Script(BaseScript):
    ...
    def main(self):
        ...
        for proj in self.slot.activeProjects:
            ...
            pack([proj.baseDir], join(self.artifacts_dir, 'packs', 'index',
                                      self.packname(proj)),
