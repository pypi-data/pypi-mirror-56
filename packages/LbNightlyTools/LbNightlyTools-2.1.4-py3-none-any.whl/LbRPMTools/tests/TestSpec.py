...
'''
        ...
        nl = list(map(str.strip, newspectxt.splitlines()))
        ol = list(map(str.strip, oldspectxt.splitlines()))
...
'''
    ...
    def testSharedSpecBuilder(self):
        ...
        spec = LHCbSharedRpmSpec(project, version, "/tmp/toto.zip", rpmbuildarea)
