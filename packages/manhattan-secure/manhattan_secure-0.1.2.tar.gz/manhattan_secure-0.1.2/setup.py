...
setup(
    ...
    description='A set of functions and utilties that broadly fall under the '
                'topic of security for manhattan.',
    long_description=long_description,
    long_description_content_type='text/markdown',

    # The project's main homepage (@@ add github url once public)
    url='https://git.getme.co.uk/manhattan/manhattan_secure',
    ...
    packages=find_packages('manhattan_secure'),
    package_dir={'': 'manhattan_secure'},
