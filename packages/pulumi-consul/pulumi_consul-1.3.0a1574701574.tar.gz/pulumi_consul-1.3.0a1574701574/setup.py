...
class InstallPluginCommand(install):
    def run(self):
        install.run(self)
        try:
            check_call(['pulumi', 'plugin', 'install', 'resource', 'consul', 'v1.3.0-alpha.1574701574+g220cf3d'])
            ...
            if error.errno == errno.ENOENT:
                ...
                `pulumi plugin install resource consul v1.3.0-alpha.1574701574+g220cf3d`
                """)
            else:
                raise
